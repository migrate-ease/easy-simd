 ...
 *    improvements.
 *  * If you expose it publicly, please change the EASYSIMD_ prefix to
...
#if !defined(EASYSIMD_DETECT_CLANG_H)
#define EASYSIMD_DETECT_CLANG_H 1
...
#if defined(__clang__) && !defined(EASYSIMD_DETECT_CLANG_VERSION)
#  if __has_warning("-Wformat-insufficient-args")
#    define EASYSIMD_DETECT_CLANG_VERSION 120000
#  elif __has_warning("-Wimplicit-const-int-float-conversion")
#    define EASYSIMD_DETECT_CLANG_VERSION 110000
#  elif __has_warning("-Wmisleading-indentation")
#    define EASYSIMD_DETECT_CLANG_VERSION 100000
#  elif defined(__FILE_NAME__)
#    define EASYSIMD_DETECT_CLANG_VERSION 90000
#  elif __has_warning("-Wextra-semi-stmt") || __has_builtin(__builtin_rotateleft32)
#    define EASYSIMD_DETECT_CLANG_VERSION 80000
#  elif __has_warning("-Wc++98-compat-extra-semi")
#    define EASYSIMD_DETECT_CLANG_VERSION 70000
#  elif __has_warning("-Wpragma-pack")
#    define EASYSIMD_DETECT_CLANG_VERSION 60000
#  elif __has_warning("-Wbitfield-enum-conversion")
#    define EASYSIMD_DETECT_CLANG_VERSION 50000
#  elif __has_attribute(diagnose_if)
#    define EASYSIMD_DETECT_CLANG_VERSION 40000
#  elif __has_warning("-Wcomma")
#    define EASYSIMD_DETECT_CLANG_VERSION 39000
#  elif __has_warning("-Wdouble-promotion")
#    define EASYSIMD_DETECT_CLANG_VERSION 38000
#  elif __has_warning("-Wshift-negative-value")
#    define EASYSIMD_DETECT_CLANG_VERSION 37000
#  elif __has_warning("-Wambiguous-ellipsis")
#    define EASYSIMD_DETECT_CLANG_VERSION 36000
#  else
#    define EASYSIMD_DETECT_CLANG_VERSION 1
#  endif
#endif /* defined(__clang__) && !defined(EASYSIMD_DETECT_CLANG_VERSION) */

/* The EASYSIMD_DETECT_CLANG_VERSION_CHECK macro is pretty
...
#if defined(EASYSIMD_DETECT_CLANG_VERSION)
#  define EASYSIMD_DETECT_CLANG_VERSION_CHECK(major, minor, revision) (EASYSIMD_DETECT_CLANG_VERSION >= ((major * 10000) + (minor * 1000) + (revision)))
#  define EASYSIMD_DETECT_CLANG_VERSION_NOT(major, minor, revision) (EASYSIMD_DETECT_CLANG_VERSION < ((major * 10000) + (minor * 1000) + (revision)))
#else
#  define EASYSIMD_DETECT_CLANG_VERSION_CHECK(major, minor, revision) (0)
#  define EASYSIMD_DETECT_CLANG_VERSION_NOT(major, minor, revision) (0)
#endif

#endif /* !defined(EASYSIMD_DETECT_CLANG_H) */
