#if !defined(EASYSIMD_X86_AVX512_DPBUSDS_H)
#define EASYSIMD_X86_AVX512_DPBUSDS_H
...
easysimd__m128i
easysimd_mm_dpbusds_epi32(easysimd__m128i src, easysimd__m128i a, easysimd__m128i b) {
    ...
    easysimd__m128i_private
      ...
      uint32_t au EASYSIMD_VECTOR(16) =
      ...
      uint32_t bu EASYSIMD_VECTOR(16) = HEDLEY_REINTERPRET_CAST(__typeof__(bu), src_.i32);
  ...
  #define _mm_dpbusds_epi32(src, a, b) easysimd_mm_dpbusds_epi32(src, a, b)
#endif

EASYSIMD_FUNCTION_ATTRIBUTES
easysimd__m128i
easysimd_mm_mask_dpbusds_epi32(easysimd__m128i src, easysimd__mmask8 k, easysimd__m128i a, easysimd__m128i b) {
  #if defined(EASYSIMD_X86_AVX512VL_NATIVE) && defined(EASYSIMD_X86_AVX512VNNI_NATIVE)
    return _mm_mask_dpbusds_epi32(src, k, a, b);
  #else
    return easysimd_mm_mask_mov_epi32(src, k, easysimd_mm_dpbusds_epi32(src, a, b));
  #endif
}
#if defined(EASYSIMD_X86_AVX512VL_ENABLE_NATIVE_ALIASES) && defined(EASYSIMD_X86_AVX512VNNI_ENABLE_NATIVE_ALIASES)
  #undef _mm_mask_dpbusds_epi32
  #define _mm_mask_dpbusds_epi32(src, k, a, b) easysimd_mm_mask_dpbusds_epi32(src, k, a, b)
#endif

EASYSIMD_FUNCTION_ATTRIBUTES
easysimd__m128i
easysimd_mm_maskz_dpbusds_epi32(easysimd__mmask8 k, easysimd__m128i src, easysimd__m128i a, easysimd__m128i b) {
  #if defined(EASYSIMD_X86_AVX512VL_NATIVE) && defined(EASYSIMD_X86_AVX512VNNI_NATIVE)
    return _mm_maskz_dpbusds_epi32(k, src, a, b);
  #else
    return easysimd_mm_maskz_mov_epi32(k, easysimd_mm_dpbusds_epi32(src, a, b));
  #endif
}
#if defined(EASYSIMD_X86_AVX512VL_ENABLE_NATIVE_ALIASES) && defined(EASYSIMD_X86_AVX512VNNI_ENABLE_NATIVE_ALIASES)
  #undef _mm_maskz_dpbusds_epi32
  #define _mm_maskz_dpbusds_epi32(k, src, a, b) easysimd_mm_maskz_dpbusds_epi32(k, src, a, b)
#endif

EASYSIMD_FUNCTION_ATTRIBUTES
easysimd__m256i
easysimd_mm256_dpbusds_epi32(easysimd__m256i src, easysimd__m256i a, easysimd__m256i b) {
  #if defined(EASYSIMD_X86_AVX512VL_NATIVE) && defined(EASYSIMD_X86_AVX512VNNI_NATIVE)
    ...
    easysimd__m256i_private
      ...
      src_.m128i[0] = easysimd_mm_dpbusds_epi32(src_.m128i[0], a_.m128i[0], b_.m128i[0]);
      src_.m128i[1] = easysimd_mm_dpbusds_epi32(src_.m128i[1], a_.m128i[1], b_.m128i[1]);
    #elif defined(EASYSIMD_SHUFFLE_VECTOR_) && defined(EASYSIMD_CONVERT_VECTOR_) && defined(EASYSIMD_VECTOR_SUBSCRIPT_SCALAR)
      ...
      uint32_t au EASYSIMD_VECTOR(32) =
        HEDLEY_REINTERPRET_CAST(
          __typeof__(au),
          (HEDLEY_REINTERPRET_CAST(__typeof__(a_.i32), r1_[0].u32) * r2_[0].i32) +
          (HEDLEY_REINTERPRET_CAST(__typeof__(a_.i32), r1_[1].u32) * r2_[1].i32) +
      ...
      uint32_t bu EASYSIMD_VECTOR(32) = HEDLEY_REINTERPRET_CAST(__typeof__(bu), src_.i32);
  ...
  #define _mm256_dpbusds_epi32(src, a, b) easysimd_mm256_dpbusds_epi32(src, a, b)
#endif

EASYSIMD_FUNCTION_ATTRIBUTES
easysimd__m256i
easysimd_mm256_mask_dpbusds_epi32(easysimd__m256i src, easysimd__mmask8 k, easysimd__m256i a, easysimd__m256i b) {
  #if defined(EASYSIMD_X86_AVX512VL_NATIVE) && defined(EASYSIMD_X86_AVX512VNNI_NATIVE)
    return _mm256_mask_dpbusds_epi32(src, k, a, b);
  #else
    return easysimd_mm256_mask_mov_epi32(src, k, easysimd_mm256_dpbusds_epi32(src, a, b));
  #endif
}
#if defined(EASYSIMD_X86_AVX512VL_ENABLE_NATIVE_ALIASES) && defined(EASYSIMD_X86_AVX512VNNI_ENABLE_NATIVE_ALIASES)
  #undef _mm256_mask_dpbusds_epi32
  #define _mm256_mask_dpbusds_epi32(src, k, a, b) easysimd_mm256_mask_dpbusds_epi32(src, k, a, b)
#endif

EASYSIMD_FUNCTION_ATTRIBUTES
easysimd__m256i
easysimd_mm256_maskz_dpbusds_epi32(easysimd__mmask8 k, easysimd__m256i src, easysimd__m256i a, easysimd__m256i b) {
  #if defined(EASYSIMD_X86_AVX512VL_NATIVE) && defined(EASYSIMD_X86_AVX512VNNI_NATIVE)
    return _mm256_maskz_dpbusds_epi32(k, src, a, b);
  #else
    return easysimd_mm256_maskz_mov_epi32(k, easysimd_mm256_dpbusds_epi32(src, a, b));
  #endif
}
#if defined(EASYSIMD_X86_AVX512VL_ENABLE_NATIVE_ALIASES) && defined(EASYSIMD_X86_AVX512VNNI_ENABLE_NATIVE_ALIASES)
  #undef _mm256_maskz_dpbusds_epi32
  #define _mm256_maskz_dpbusds_epi32(k, src, a, b) easysimd_mm256_maskz_dpbusds_epi32(k, src, a, b)
#endif

EASYSIMD_FUNCTION_ATTRIBUTES
easysimd__m512i
easysimd_mm512_dpbusds_epi32(easysimd__m512i src, easysimd__m512i a, easysimd__m512i b) {
    ...
    easysimd__m512i_private
      ...
      src_.m256i[0] = easysimd_mm256_dpbusds_epi32(src_.m256i[0], a_.m256i[0], b_.m256i[0]);
      src_.m256i[1] = easysimd_mm256_dpbusds_epi32(src_.m256i[1], a_.m256i[1], b_.m256i[1]);
    #elif defined(EASYSIMD_SHUFFLE_VECTOR_) && defined(EASYSIMD_CONVERT_VECTOR_) && defined(EASYSIMD_VECTOR_SUBSCRIPT_SCALAR)
      ...
      uint32_t au EASYSIMD_VECTOR(64) =
        HEDLEY_REINTERPRET_CAST(
          __typeof__(au),
          (HEDLEY_REINTERPRET_CAST(__typeof__(a_.i32), r1_[0].u32) * r2_[0].i32) +
          (HEDLEY_REINTERPRET_CAST(__typeof__(a_.i32), r1_[1].u32) * r2_[1].i32) +
      ...
      uint32_t bu EASYSIMD_VECTOR(64) = HEDLEY_REINTERPRET_CAST(__typeof__(bu), src_.i32);
  ...
  #define _mm512_dpbusds_epi32(src, a, b) easysimd_mm512_dpbusds_epi32(src, a, b)
#endif

EASYSIMD_FUNCTION_ATTRIBUTES
easysimd__m512i
easysimd_mm512_mask_dpbusds_epi32(easysimd__m512i src, easysimd__mmask16 k, easysimd__m512i a, easysimd__m512i b) {
  #if defined(EASYSIMD_X86_AVX512VNNI_NATIVE)
    return _mm512_mask_dpbusds_epi32(src, k, a, b);
  #else
    return easysimd_mm512_mask_mov_epi32(src, k, easysimd_mm512_dpbusds_epi32(src, a, b));
  #endif
}
#if defined(EASYSIMD_X86_AVX512VNNI_ENABLE_NATIVE_ALIASES)
  #undef _mm512_mask_dpbusds_epi32
  #define _mm512_mask_dpbusds_epi32(src, k, a, b) easysimd_mm512_mask_dpbusds_epi32(src, k, a, b)
#endif

EASYSIMD_FUNCTION_ATTRIBUTES
easysimd__m512i
easysimd_mm512_maskz_dpbusds_epi32(easysimd__mmask16 k, easysimd__m512i src, easysimd__m512i a, easysimd__m512i b) {
  #if defined(EASYSIMD_X86_AVX512VNNI_NATIVE)
    return _mm512_maskz_dpbusds_epi32(k, src, a, b);
  #else
    return easysimd_mm512_maskz_mov_epi32(k, easysimd_mm512_dpbusds_epi32(src, a, b));
  #endif
}
#if defined(EASYSIMD_X86_AVX512VNNI_ENABLE_NATIVE_ALIASES)
  #undef _mm512_maskz_dpbusds_epi32
  #define _mm512_maskz_dpbusds_epi32(k, src, a, b) easysimd_mm512_maskz_dpbusds_epi32(k, src, a, b)
#endif

EASYSIMD_END_DECLS_
HEDLEY_DIAGNOSTIC_POP

#endif /* !defined(EASYSIMD_X86_AVX512_DPBUSDS_H) */
