#define EASYSIMD_TEST_ARM_NEON_INSN aba

#include "test-neon.h"
#include "../../../easysimd/arm/neon/aba.h"
...
static int
test_easysimd_vaba_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int8_t a[8];
    int8_t b[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int8x8_t r = easysimd_vaba_s8(a, b, c);
...
static int
test_easysimd_vaba_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int16_t a[4];
    int16_t b[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int16x4_t r = easysimd_vaba_s16(a, b, c);
...
static int
test_easysimd_vaba_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t a[2];
    int32_t b[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x2_t r = easysimd_vaba_s32(a, b, c);
...
static int
test_easysimd_vaba_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint8_t a[8];
    uint8_t b[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x8_t r = easysimd_vaba_u8(a, b, c);
...
static int
test_easysimd_vaba_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint16_t a[4];
    uint16_t b[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x4_t r = easysimd_vaba_u16(a, b, c);
...
static int
test_easysimd_vaba_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint32_t a[2];
    uint32_t b[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x2_t r = easysimd_vaba_u32(a, b, c);
...
static int
test_easysimd_vabaq_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int8_t a[16];
    int8_t b[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int8x16_t r = easysimd_vabaq_s8(a, b, c);
...
static int
test_easysimd_vabaq_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int16_t a[8];
    int16_t b[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int16x8_t r = easysimd_vabaq_s16(a, b, c);
...
static int
test_easysimd_vabaq_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t a[4];
    int32_t b[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x4_t r = easysimd_vabaq_s32(a, b, c);
...
static int
test_easysimd_vabaq_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint8_t a[16];
    uint8_t b[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x16_t r = easysimd_vabaq_u8(a, b, c);
...
static int
test_easysimd_vabaq_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint16_t a[8];
    uint16_t b[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x8_t r = easysimd_vabaq_u16(a, b, c);
...
#if !defined(TEST_EASYSIMD_VABD_NO_TEST_32)
static int
test_easysimd_vabaq_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint32_t a[4];
    uint32_t b[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x4_t r = easysimd_vabaq_u32(a, b, c);
...
EASYSIMD_TEST_FUNC_LIST_ENTRY(vaba_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vaba_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vaba_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vaba_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vaba_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vabaq_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vabaq_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vabaq_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vabaq_u16)
#if !defined(TEST_EASYSIMD_VABD_NO_TEST_32)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(vabaq_s32)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(vabaq_u32)
#endif
