#define EASYSIMD_TEST_ARM_NEON_INSN abd

#include "test-neon.h"
#include "../../../easysimd/arm/neon/abd.h"

/* https://community.intel.com/t5/Intel-C-Compiler/ICC-generates-incorrect-code/td-p/1199261 */
#if defined(HEDLEY_INTEL_VERSION)
#  define TEST_EASYSIMD_VABD_NO_TEST_32
#endif

static int
test_easysimd_vabds_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    easysimd_float32 a;
    easysimd_float32 b;
    ...
    { EASYSIMD_FLOAT32_C(   531.62),
      EASYSIMD_FLOAT32_C(  -312.36),
      EASYSIMD_FLOAT32_C(   843.98) },
    { EASYSIMD_FLOAT32_C(  -308.11),
      EASYSIMD_FLOAT32_C(   992.42),
      EASYSIMD_FLOAT32_C(  1300.53) },
    { EASYSIMD_FLOAT32_C(   -79.01),
      EASYSIMD_FLOAT32_C(   594.71),
      EASYSIMD_FLOAT32_C(   673.72) },
    { EASYSIMD_FLOAT32_C(   -32.15),
      EASYSIMD_FLOAT32_C(   114.85),
      EASYSIMD_FLOAT32_C(   147.00) },
    { EASYSIMD_FLOAT32_C(   290.28),
      EASYSIMD_FLOAT32_C(   100.33),
      EASYSIMD_FLOAT32_C(   189.95) },
    { EASYSIMD_FLOAT32_C(  -384.37),
      EASYSIMD_FLOAT32_C(  -271.65),
      EASYSIMD_FLOAT32_C(   112.72) },
    { EASYSIMD_FLOAT32_C(   810.73),
      EASYSIMD_FLOAT32_C(  -621.11),
      EASYSIMD_FLOAT32_C(  1431.84) },
    { EASYSIMD_FLOAT32_C(  -383.51),
      EASYSIMD_FLOAT32_C(   354.85),
      EASYSIMD_FLOAT32_C(   738.36) }
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float32_t r = easysimd_vabds_f32(test_vec[i].a, test_vec[i].b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_float32_t r = easysimd_vabds_f32(a, b);
...
static int
test_easysimd_vabdd_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    easysimd_float64 a;
    easysimd_float64 b;
    ...
    { EASYSIMD_FLOAT64_C(   779.86),
      EASYSIMD_FLOAT64_C(   261.91),
      EASYSIMD_FLOAT64_C(   517.95) },
    { EASYSIMD_FLOAT64_C(   645.51),
      EASYSIMD_FLOAT64_C(   275.82),
      EASYSIMD_FLOAT64_C(   369.69) },
    { EASYSIMD_FLOAT64_C(   482.58),
      EASYSIMD_FLOAT64_C(  -380.95),
      EASYSIMD_FLOAT64_C(   863.53) },
    { EASYSIMD_FLOAT64_C(   670.99),
      EASYSIMD_FLOAT64_C(   240.67),
      EASYSIMD_FLOAT64_C(   430.32) },
    { EASYSIMD_FLOAT64_C(  -761.70),
      EASYSIMD_FLOAT64_C(  -217.28),
      EASYSIMD_FLOAT64_C(   544.42) },
    { EASYSIMD_FLOAT64_C(  -965.81),
      EASYSIMD_FLOAT64_C(  -145.22),
      EASYSIMD_FLOAT64_C(   820.59) },
    { EASYSIMD_FLOAT64_C(   857.99),
      EASYSIMD_FLOAT64_C(  -115.73),
      EASYSIMD_FLOAT64_C(   973.72) },
    { EASYSIMD_FLOAT64_C(   -75.93),
      EASYSIMD_FLOAT64_C(   547.42),
      EASYSIMD_FLOAT64_C(   623.35) }
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float64_t r = easysimd_vabdd_f64(test_vec[i].a, test_vec[i].b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_float64_t r = easysimd_vabdd_f64(a, b);
...
static int
test_easysimd_vabd_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    ...
    { { EASYSIMD_FLOAT32_C(  -378.92), EASYSIMD_FLOAT32_C(  -620.80) },
      { EASYSIMD_FLOAT32_C(   475.93), EASYSIMD_FLOAT32_C(   308.98) },
      { EASYSIMD_FLOAT32_C(   854.85), EASYSIMD_FLOAT32_C(   929.78) } },
    { { EASYSIMD_FLOAT32_C(   159.45), EASYSIMD_FLOAT32_C(  -785.12) },
      { EASYSIMD_FLOAT32_C(  -745.18), EASYSIMD_FLOAT32_C(  -374.75) },
      { EASYSIMD_FLOAT32_C(   904.63), EASYSIMD_FLOAT32_C(   410.37) } },
    { { EASYSIMD_FLOAT32_C(  -423.39), EASYSIMD_FLOAT32_C(    68.89) },
      { EASYSIMD_FLOAT32_C(   583.57), EASYSIMD_FLOAT32_C(   386.20) },
      { EASYSIMD_FLOAT32_C(  1006.96), EASYSIMD_FLOAT32_C(   317.31) } },
    { { EASYSIMD_FLOAT32_C(  -153.15), EASYSIMD_FLOAT32_C(  -120.40) },
      { EASYSIMD_FLOAT32_C(   555.60), EASYSIMD_FLOAT32_C(  -702.70) },
      { EASYSIMD_FLOAT32_C(   708.75), EASYSIMD_FLOAT32_C(   582.30) } },
    { { EASYSIMD_FLOAT32_C(   380.05), EASYSIMD_FLOAT32_C(   448.15) },
      { EASYSIMD_FLOAT32_C(   736.37), EASYSIMD_FLOAT32_C(  -447.93) },
      { EASYSIMD_FLOAT32_C(   356.32), EASYSIMD_FLOAT32_C(   896.08) } },
    { { EASYSIMD_FLOAT32_C(  -910.48), EASYSIMD_FLOAT32_C(  -966.37) },
      { EASYSIMD_FLOAT32_C(  -441.23), EASYSIMD_FLOAT32_C(   -21.68) },
      { EASYSIMD_FLOAT32_C(   469.25), EASYSIMD_FLOAT32_C(   944.69) } },
    { { EASYSIMD_FLOAT32_C(  -684.24), EASYSIMD_FLOAT32_C(   -42.78) },
      { EASYSIMD_FLOAT32_C(   785.07), EASYSIMD_FLOAT32_C(  -505.67) },
      { EASYSIMD_FLOAT32_C(  1469.31), EASYSIMD_FLOAT32_C(   462.89) } },
    { { EASYSIMD_FLOAT32_C(   169.60), EASYSIMD_FLOAT32_C(   497.90) },
      { EASYSIMD_FLOAT32_C(    36.47), EASYSIMD_FLOAT32_C(   790.68) },
      { EASYSIMD_FLOAT32_C(   133.13), EASYSIMD_FLOAT32_C(   292.78) } }
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float32x2_t a = easysimd_vld1_f32(test_vec[i].a);
    easysimd_float32x2_t b = easysimd_vld1_f32(test_vec[i].b);
    easysimd_float32x2_t r = easysimd_vabd_f32(a, b);
...
static int
test_easysimd_vabd_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
   ...
   { { EASYSIMD_FLOAT64_C(   877.10) },
      { EASYSIMD_FLOAT64_C(  -487.60) },
      { EASYSIMD_FLOAT64_C(  1364.70) } },
    { { EASYSIMD_FLOAT64_C(    99.66) },
      { EASYSIMD_FLOAT64_C(    36.55) },
      { EASYSIMD_FLOAT64_C(    63.11) } },
    { { EASYSIMD_FLOAT64_C(  -272.72) },
      { EASYSIMD_FLOAT64_C(   354.48) },
      { EASYSIMD_FLOAT64_C(   627.20) } },
    { { EASYSIMD_FLOAT64_C(   661.80) },
      { EASYSIMD_FLOAT64_C(   303.89) },
      { EASYSIMD_FLOAT64_C(   357.91) } },
    { { EASYSIMD_FLOAT64_C(  -576.63) },
      { EASYSIMD_FLOAT64_C(   245.37) },
      { EASYSIMD_FLOAT64_C(   822.00) } },
    { { EASYSIMD_FLOAT64_C(  -309.90) },
      { EASYSIMD_FLOAT64_C(   270.22) },
      { EASYSIMD_FLOAT64_C(   580.12) } },
    { { EASYSIMD_FLOAT64_C(  -875.02) },
      { EASYSIMD_FLOAT64_C(  -754.31) },
      { EASYSIMD_FLOAT64_C(   120.71) } },
    { { EASYSIMD_FLOAT64_C(   567.52) },
      { EASYSIMD_FLOAT64_C(   505.03) },
      { EASYSIMD_FLOAT64_C(    62.49) } }
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float64x1_t a = easysimd_vld1_f64(test_vec[i].a);
    easysimd_float64x1_t b = easysimd_vld1_f64(test_vec[i].b);
    easysimd_float64x1_t r = easysimd_vabd_f64(a, b);
...
static int
test_easysimd_vabd_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int8_t a[8];
    int8_t b[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int8x8_t r = easysimd_vabd_s8(a, b);
...
static int
test_easysimd_vabd_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int16_t a[4];
    int16_t b[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int16x4_t r = easysimd_vabd_s16(a, b);
...
#if !defined(TEST_EASYSIMD_VABD_NO_TEST_32)
static int
test_easysimd_vabd_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t a[2];
    int32_t b[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x2_t r = easysimd_vabd_s32(a, b);
...
static int
test_easysimd_vabd_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint8_t a[8];
    uint8_t b[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x8_t r = easysimd_vabd_u8(a, b);
...
static int
test_easysimd_vabd_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint16_t a[4];
    uint16_t b[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x4_t r = easysimd_vabd_u16(a, b);
...
#if !defined(TEST_EASYSIMD_VABD_NO_TEST_32)
static int
test_easysimd_vabd_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint32_t a[2];
    uint32_t b[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x2_t r = easysimd_vabd_u32(a, b);
...
static int
test_easysimd_vabdq_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    ...
    { { EASYSIMD_FLOAT32_C(   965.83), EASYSIMD_FLOAT32_C(  -857.34), EASYSIMD_FLOAT32_C(  -560.13), EASYSIMD_FLOAT32_C(  -970.93) },
      { EASYSIMD_FLOAT32_C(  -821.69), EASYSIMD_FLOAT32_C(  -283.01), EASYSIMD_FLOAT32_C(  -858.66), EASYSIMD_FLOAT32_C(  -780.80) },
      { EASYSIMD_FLOAT32_C(  1787.52), EASYSIMD_FLOAT32_C(   574.33), EASYSIMD_FLOAT32_C(   298.53), EASYSIMD_FLOAT32_C(   190.13) } },
    { { EASYSIMD_FLOAT32_C(   655.57), EASYSIMD_FLOAT32_C(    38.23), EASYSIMD_FLOAT32_C(   268.19), EASYSIMD_FLOAT32_C(   578.23) },
      { EASYSIMD_FLOAT32_C(   673.43), EASYSIMD_FLOAT32_C(   933.63), EASYSIMD_FLOAT32_C(  -513.03), EASYSIMD_FLOAT32_C(   540.19) },
      { EASYSIMD_FLOAT32_C(    17.86), EASYSIMD_FLOAT32_C(   895.40), EASYSIMD_FLOAT32_C(   781.22), EASYSIMD_FLOAT32_C(    38.04) } },
    { { EASYSIMD_FLOAT32_C(   559.01), EASYSIMD_FLOAT32_C(  -436.66), EASYSIMD_FLOAT32_C(  -201.42), EASYSIMD_FLOAT32_C(  -191.00) },
      { EASYSIMD_FLOAT32_C(   509.73), EASYSIMD_FLOAT32_C(   509.25), EASYSIMD_FLOAT32_C(    60.09), EASYSIMD_FLOAT32_C(   510.96) },
      { EASYSIMD_FLOAT32_C(    49.28), EASYSIMD_FLOAT32_C(   945.91), EASYSIMD_FLOAT32_C(   261.51), EASYSIMD_FLOAT32_C(   701.96) } },
    { { EASYSIMD_FLOAT32_C(  -928.29), EASYSIMD_FLOAT32_C(  -315.21), EASYSIMD_FLOAT32_C(   729.47), EASYSIMD_FLOAT32_C(   -38.60) },
      { EASYSIMD_FLOAT32_C(  -141.89), EASYSIMD_FLOAT32_C(  -957.64), EASYSIMD_FLOAT32_C(  -323.78), EASYSIMD_FLOAT32_C(  -176.06) },
      { EASYSIMD_FLOAT32_C(   786.40), EASYSIMD_FLOAT32_C(   642.43), EASYSIMD_FLOAT32_C(  1053.25), EASYSIMD_FLOAT32_C(   137.46) } },
    { { EASYSIMD_FLOAT32_C(  -814.98), EASYSIMD_FLOAT32_C(   116.09), EASYSIMD_FLOAT32_C(  -146.99), EASYSIMD_FLOAT32_C(  -636.67) },
      { EASYSIMD_FLOAT32_C(   833.08), EASYSIMD_FLOAT32_C(    -5.65), EASYSIMD_FLOAT32_C(  -417.47), EASYSIMD_FLOAT32_C(   488.65) },
      { EASYSIMD_FLOAT32_C(  1648.06), EASYSIMD_FLOAT32_C(   121.74), EASYSIMD_FLOAT32_C(   270.48), EASYSIMD_FLOAT32_C(  1125.32) } },
    { { EASYSIMD_FLOAT32_C(  -967.42), EASYSIMD_FLOAT32_C(   850.72), EASYSIMD_FLOAT32_C(    66.88), EASYSIMD_FLOAT32_C(   706.02) },
      { EASYSIMD_FLOAT32_C(   784.35), EASYSIMD_FLOAT32_C(   553.85), EASYSIMD_FLOAT32_C(   246.21), EASYSIMD_FLOAT32_C(   343.36) },
      { EASYSIMD_FLOAT32_C(  1751.77), EASYSIMD_FLOAT32_C(   296.87), EASYSIMD_FLOAT32_C(   179.33), EASYSIMD_FLOAT32_C(   362.66) } },
    { { EASYSIMD_FLOAT32_C(  -882.81), EASYSIMD_FLOAT32_C(  -955.21), EASYSIMD_FLOAT32_C(  -847.64), EASYSIMD_FLOAT32_C(   626.92) },
      { EASYSIMD_FLOAT32_C(   554.03), EASYSIMD_FLOAT32_C(   212.45), EASYSIMD_FLOAT32_C(   137.88), EASYSIMD_FLOAT32_C(   625.74) },
      { EASYSIMD_FLOAT32_C(  1436.84), EASYSIMD_FLOAT32_C(  1167.66), EASYSIMD_FLOAT32_C(   985.52), EASYSIMD_FLOAT32_C(     1.18) } },
    { { EASYSIMD_FLOAT32_C(   897.23), EASYSIMD_FLOAT32_C(  -132.65), EASYSIMD_FLOAT32_C(  -412.85), EASYSIMD_FLOAT32_C(  -244.66) },
      { EASYSIMD_FLOAT32_C(   -90.29), EASYSIMD_FLOAT32_C(   263.37), EASYSIMD_FLOAT32_C(   579.28), EASYSIMD_FLOAT32_C(    94.73) },
      { EASYSIMD_FLOAT32_C(   987.52), EASYSIMD_FLOAT32_C(   396.02), EASYSIMD_FLOAT32_C(   992.13), EASYSIMD_FLOAT32_C(   339.39) } }
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float32x4_t a = easysimd_vld1q_f32(test_vec[i].a);
    easysimd_float32x4_t b = easysimd_vld1q_f32(test_vec[i].b);
    easysimd_float32x4_t r = easysimd_vabdq_f32(a, b);
...
static int
test_easysimd_vabdq_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    ...
    { { EASYSIMD_FLOAT64_C(  -620.54), EASYSIMD_FLOAT64_C(  -567.71) },
      { EASYSIMD_FLOAT64_C(   458.06), EASYSIMD_FLOAT64_C(  -787.46) },
      { EASYSIMD_FLOAT64_C(  1078.60), EASYSIMD_FLOAT64_C(   219.75) } },
    { { EASYSIMD_FLOAT64_C(   426.64), EASYSIMD_FLOAT64_C(  -959.41) },
      { EASYSIMD_FLOAT64_C(   701.18), EASYSIMD_FLOAT64_C(   459.23) },
      { EASYSIMD_FLOAT64_C(   274.54), EASYSIMD_FLOAT64_C(  1418.64) } },
    { { EASYSIMD_FLOAT64_C(   891.32), EASYSIMD_FLOAT64_C(  -231.93) },
      { EASYSIMD_FLOAT64_C(   165.24), EASYSIMD_FLOAT64_C(   675.67) },
      { EASYSIMD_FLOAT64_C(   726.08), EASYSIMD_FLOAT64_C(   907.60) } },
    { { EASYSIMD_FLOAT64_C(  -678.09), EASYSIMD_FLOAT64_C(  -588.55) },
      { EASYSIMD_FLOAT64_C(    19.03), EASYSIMD_FLOAT64_C(  -560.89) },
      { EASYSIMD_FLOAT64_C(   697.12), EASYSIMD_FLOAT64_C(    27.66) } },
    { { EASYSIMD_FLOAT64_C(  -543.76), EASYSIMD_FLOAT64_C(   171.38) },
      { EASYSIMD_FLOAT64_C(  -933.97), EASYSIMD_FLOAT64_C(  -989.73) },
      { EASYSIMD_FLOAT64_C(   390.21), EASYSIMD_FLOAT64_C(  1161.11) } },
    { { EASYSIMD_FLOAT64_C(  -616.17), EASYSIMD_FLOAT64_C(   203.91) },
      { EASYSIMD_FLOAT64_C(   636.01), EASYSIMD_FLOAT64_C(  -718.93) },
      { EASYSIMD_FLOAT64_C(  1252.18), EASYSIMD_FLOAT64_C(   922.84) } },
    { { EASYSIMD_FLOAT64_C(  -928.74), EASYSIMD_FLOAT64_C(  -776.84) },
      { EASYSIMD_FLOAT64_C(    36.41), EASYSIMD_FLOAT64_C(   -19.03) },
      { EASYSIMD_FLOAT64_C(   965.15), EASYSIMD_FLOAT64_C(   757.81) } },
    { { EASYSIMD_FLOAT64_C(   486.53), EASYSIMD_FLOAT64_C(  -384.31) },
      { EASYSIMD_FLOAT64_C(  -924.30), EASYSIMD_FLOAT64_C(   865.99) },
      { EASYSIMD_FLOAT64_C(  1410.83), EASYSIMD_FLOAT64_C(  1250.30) } }
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float64x2_t a = easysimd_vld1q_f64(test_vec[i].a);
    easysimd_float64x2_t b = easysimd_vld1q_f64(test_vec[i].b);
    easysimd_float64x2_t r = easysimd_vabdq_f64(a, b);
...
static int
test_easysimd_vabdq_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int8_t a[16];
    int8_t b[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int8x16_t r = easysimd_vabdq_s8(a, b);
...
static int
test_easysimd_vabdq_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int16_t a[8];
    int16_t b[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int16x8_t r = easysimd_vabdq_s16(a, b);
...
#if !defined(TEST_EASYSIMD_VABD_NO_TEST_32)
static int
test_easysimd_vabdq_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t a[4];
    int32_t b[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x4_t r = easysimd_vabdq_s32(a, b);
...
static int
test_easysimd_vabdq_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint8_t a[16];
    uint8_t b[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x16_t r = easysimd_vabdq_u8(a, b);
...
static int
test_easysimd_vabdq_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint16_t a[8];
    uint16_t b[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x8_t r = easysimd_vabdq_u16(a, b);
...
#if !defined(TEST_EASYSIMD_VABD_NO_TEST_32)
static int
test_easysimd_vabdq_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint32_t a[4];
    uint32_t b[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x4_t r = easysimd_vabdq_u32(a, b);
...
EASYSIMD_TEST_FUNC_LIST_ENTRY(vabds_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vabdd_f64)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vabd_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vabd_f64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vabd_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vabd_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vabd_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vabd_u16)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vabdq_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vabdq_f64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vabdq_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vabdq_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vabdq_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vabdq_u16)

#if !defined(TEST_EASYSIMD_VABD_NO_TEST_32)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(vabd_s32)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(vabd_u32)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(vabdq_u32)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(vabdq_s32)
#endif
