#define EASYSIMD_TEST_ARM_NEON_INSN abs

#include "test-neon.h"
#include "../../../easysimd/arm/neon/abs.h"

static int
test_easysimd_vabsd_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int64_t a;
    int64_t r;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    int64_t r = easysimd_vabsd_s64(test_vec[i].a);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    int64_t r = easysimd_vabsd_s64(a);
...
static int
test_easysimd_vabs_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
  static const struct {
    easysimd_float32 a[2];
    easysimd_float32 r[2];
  } test_vec[] = {
    { { EASYSIMD_FLOAT32_C(   240.57), EASYSIMD_FLOAT32_C(   605.25) },
      { EASYSIMD_FLOAT32_C(   240.57), EASYSIMD_FLOAT32_C(   605.25) } },
    { { EASYSIMD_FLOAT32_C(  -896.34), EASYSIMD_FLOAT32_C(  -983.98) },
      { EASYSIMD_FLOAT32_C(   896.34), EASYSIMD_FLOAT32_C(   983.98) } },
    { { EASYSIMD_FLOAT32_C(   435.53), EASYSIMD_FLOAT32_C(  -284.04) },
      { EASYSIMD_FLOAT32_C(   435.53), EASYSIMD_FLOAT32_C(   284.04) } },
    { { EASYSIMD_FLOAT32_C(   659.95), EASYSIMD_FLOAT32_C(  -108.19) },
      { EASYSIMD_FLOAT32_C(   659.95), EASYSIMD_FLOAT32_C(   108.19) } },
    { { EASYSIMD_FLOAT32_C(  -501.15), EASYSIMD_FLOAT32_C(   711.09) },
      { EASYSIMD_FLOAT32_C(   501.15), EASYSIMD_FLOAT32_C(   711.09) } },
    { { EASYSIMD_FLOAT32_C(   552.72), EASYSIMD_FLOAT32_C(  -497.32) },
      { EASYSIMD_FLOAT32_C(   552.72), EASYSIMD_FLOAT32_C(   497.32) } },
    { { EASYSIMD_FLOAT32_C(   568.44), EASYSIMD_FLOAT32_C(  -896.02) },
      { EASYSIMD_FLOAT32_C(   568.44), EASYSIMD_FLOAT32_C(   896.02) } },
    { { EASYSIMD_FLOAT32_C(   997.23), EASYSIMD_FLOAT32_C(  -515.53) },
      { EASYSIMD_FLOAT32_C(   997.23), EASYSIMD_FLOAT32_C(   515.53) } }
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float32x2_t a = easysimd_vld1_f32(test_vec[i].a);
    easysimd_float32x2_t r = easysimd_vabs_f32(a);

    easysimd_test_arm_neon_assert_equal_f32x2(r, easysimd_vld1_f32(test_vec[i].r), INT_MAX);
  }
...
static int
test_easysimd_vabs_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
  static const struct {
    easysimd_float64 a[1];
    easysimd_float64 r[1];
  } test_vec[] = {
    { { EASYSIMD_FLOAT64_C(   526.66) },
      { EASYSIMD_FLOAT64_C(   526.66) } },
    { { EASYSIMD_FLOAT64_C(    52.02) },
      { EASYSIMD_FLOAT64_C(    52.02) } },
    { { EASYSIMD_FLOAT64_C(   169.50) },
      { EASYSIMD_FLOAT64_C(   169.50) } },
    { { EASYSIMD_FLOAT64_C(   466.20) },
      { EASYSIMD_FLOAT64_C(   466.20) } },
    { { EASYSIMD_FLOAT64_C(  -862.24) },
      { EASYSIMD_FLOAT64_C(   862.24) } },
    { { EASYSIMD_FLOAT64_C(   411.84) },
      { EASYSIMD_FLOAT64_C(   411.84) } },
    { { EASYSIMD_FLOAT64_C(  -921.62) },
      { EASYSIMD_FLOAT64_C(   921.62) } },
    { { EASYSIMD_FLOAT64_C(   -55.03) },
      { EASYSIMD_FLOAT64_C(    55.03) } }
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float64x1_t a = easysimd_vld1_f64(test_vec[i].a);
    easysimd_float64x1_t r = easysimd_vabs_f64(a);

    easysimd_test_arm_neon_assert_equal_f64x1(r, easysimd_vld1_f64(test_vec[i].r), INT_MAX);
  }
...
static int
test_easysimd_vabs_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
  static const struct {
    int8_t a[8];
    int8_t r[8];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int8x8_t r = easysimd_vabs_s8(a);
...
static int
test_easysimd_vabs_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
  static const struct {
    int16_t a[4];
    int16_t r[4];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int16x4_t r = easysimd_vabs_s16(a);
...
static int
test_easysimd_vabs_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
  static const struct {
    int32_t a[2];
    int32_t r[2];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x2_t r = easysimd_vabs_s32(a);
...
static int
test_easysimd_vabs_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
  static const struct {
    int64_t a[1];
    int64_t r[1];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int64x1_t r = easysimd_vabs_s64(a);
...
static int
test_easysimd_vabsq_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
  static const struct {
    easysimd_float32 a[4];
    easysimd_float32 r[4];
  } test_vec[] = {
    { { EASYSIMD_FLOAT32_C(   462.30), EASYSIMD_FLOAT32_C(   260.51), EASYSIMD_FLOAT32_C(  -298.75), EASYSIMD_FLOAT32_C(   -90.05) },
      { EASYSIMD_FLOAT32_C(   462.30), EASYSIMD_FLOAT32_C(   260.51), EASYSIMD_FLOAT32_C(   298.75), EASYSIMD_FLOAT32_C(    90.05) } },
    { { EASYSIMD_FLOAT32_C(   349.12), EASYSIMD_FLOAT32_C(   972.04), EASYSIMD_FLOAT32_C(     3.43), EASYSIMD_FLOAT32_C(  -624.53) },
      { EASYSIMD_FLOAT32_C(   349.12), EASYSIMD_FLOAT32_C(   972.04), EASYSIMD_FLOAT32_C(     3.43), EASYSIMD_FLOAT32_C(   624.53) } },
    { { EASYSIMD_FLOAT32_C(   653.64), EASYSIMD_FLOAT32_C(   788.52), EASYSIMD_FLOAT32_C(   687.80), EASYSIMD_FLOAT32_C(   756.52) },
      { EASYSIMD_FLOAT32_C(   653.64), EASYSIMD_FLOAT32_C(   788.52), EASYSIMD_FLOAT32_C(   687.80), EASYSIMD_FLOAT32_C(   756.52) } },
    { { EASYSIMD_FLOAT32_C(   163.46), EASYSIMD_FLOAT32_C(  -327.92), EASYSIMD_FLOAT32_C(   337.82), EASYSIMD_FLOAT32_C(   394.49) },
      { EASYSIMD_FLOAT32_C(   163.46), EASYSIMD_FLOAT32_C(   327.92), EASYSIMD_FLOAT32_C(   337.82), EASYSIMD_FLOAT32_C(   394.49) } },
    { { EASYSIMD_FLOAT32_C(   977.72), EASYSIMD_FLOAT32_C(   437.45), EASYSIMD_FLOAT32_C(   808.81), EASYSIMD_FLOAT32_C(   750.24) },
      { EASYSIMD_FLOAT32_C(   977.72), EASYSIMD_FLOAT32_C(   437.45), EASYSIMD_FLOAT32_C(   808.81), EASYSIMD_FLOAT32_C(   750.24) } },
    { { EASYSIMD_FLOAT32_C(   458.56), EASYSIMD_FLOAT32_C(  -377.89), EASYSIMD_FLOAT32_C(   748.70), EASYSIMD_FLOAT32_C(  -697.44) },
      { EASYSIMD_FLOAT32_C(   458.56), EASYSIMD_FLOAT32_C(   377.89), EASYSIMD_FLOAT32_C(   748.70), EASYSIMD_FLOAT32_C(   697.44) } },
    { { EASYSIMD_FLOAT32_C(  -708.39), EASYSIMD_FLOAT32_C(   955.88), EASYSIMD_FLOAT32_C(    31.34), EASYSIMD_FLOAT32_C(  -575.79) },
      { EASYSIMD_FLOAT32_C(   708.39), EASYSIMD_FLOAT32_C(   955.88), EASYSIMD_FLOAT32_C(    31.34), EASYSIMD_FLOAT32_C(   575.79) } },
    { { EASYSIMD_FLOAT32_C(  -270.33), EASYSIMD_FLOAT32_C(   422.59), EASYSIMD_FLOAT32_C(   310.75), EASYSIMD_FLOAT32_C(  -808.03) },
      { EASYSIMD_FLOAT32_C(   270.33), EASYSIMD_FLOAT32_C(   422.59), EASYSIMD_FLOAT32_C(   310.75), EASYSIMD_FLOAT32_C(   808.03) } }
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float32x4_t a = easysimd_vld1q_f32(test_vec[i].a);
    easysimd_float32x4_t r = easysimd_vabsq_f32(a);
    easysimd_test_arm_neon_assert_equal_f32x4(r, easysimd_vld1q_f32(test_vec[i].r), INT_MAX);
  }
...
static int
test_easysimd_vabsq_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
  static const struct {
    easysimd_float64 a[2];
    easysimd_float64 r[2];
  } test_vec[] = {
    { { EASYSIMD_FLOAT64_C(   142.01), EASYSIMD_FLOAT64_C(   892.18) },
      { EASYSIMD_FLOAT64_C(   142.01), EASYSIMD_FLOAT64_C(   892.18) } },
    { { EASYSIMD_FLOAT64_C(    77.64), EASYSIMD_FLOAT64_C(   556.98) },
      { EASYSIMD_FLOAT64_C(    77.64), EASYSIMD_FLOAT64_C(   556.98) } },
    { { EASYSIMD_FLOAT64_C(   117.55), EASYSIMD_FLOAT64_C(   172.99) },
      { EASYSIMD_FLOAT64_C(   117.55), EASYSIMD_FLOAT64_C(   172.99) } },
    { { EASYSIMD_FLOAT64_C(  -701.87), EASYSIMD_FLOAT64_C(  -246.57) },
      { EASYSIMD_FLOAT64_C(   701.87), EASYSIMD_FLOAT64_C(   246.57) } },
    { { EASYSIMD_FLOAT64_C(   -27.40), EASYSIMD_FLOAT64_C(    39.73) },
      { EASYSIMD_FLOAT64_C(    27.40), EASYSIMD_FLOAT64_C(    39.73) } },
    { { EASYSIMD_FLOAT64_C(  -558.82), EASYSIMD_FLOAT64_C(  -689.88) },
      { EASYSIMD_FLOAT64_C(   558.82), EASYSIMD_FLOAT64_C(   689.88) } },
    { { EASYSIMD_FLOAT64_C(  -566.76), EASYSIMD_FLOAT64_C(   -58.12) },
      { EASYSIMD_FLOAT64_C(   566.76), EASYSIMD_FLOAT64_C(    58.12) } },
    { { EASYSIMD_FLOAT64_C(  -718.46), EASYSIMD_FLOAT64_C(   966.37) },
      { EASYSIMD_FLOAT64_C(   718.46), EASYSIMD_FLOAT64_C(   966.37) } }
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float64x2_t a = easysimd_vld1q_f64(test_vec[i].a);
    easysimd_float64x2_t r = easysimd_vabsq_f64(a);

    easysimd_test_arm_neon_assert_equal_f64x2(r, easysimd_vld1q_f64(test_vec[i].r), INT_MAX);
  }
...
static int
test_easysimd_vabsq_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
  static const struct {
    int8_t a[16];
    int8_t r[16];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int8x16_t r = easysimd_vabsq_s8(a);
...
static int
test_easysimd_vabsq_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
  static const struct {
    int16_t a[8];
    int16_t r[8];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int16x8_t r = easysimd_vabsq_s16(a);
...
static int
test_easysimd_vabsq_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
  static const struct {
    int32_t a[4];
    int32_t r[4];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x4_t r = easysimd_vabsq_s32(a);
...
static int
test_easysimd_vabsq_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
  static const struct {
    int64_t a[2];
    int64_t r[2];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int64x2_t r = easysimd_vabsq_s64(a);
...
EASYSIMD_TEST_FUNC_LIST_ENTRY(vabsd_s64)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vabs_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vabs_f64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vabs_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vabs_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vabs_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vabs_s64)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vabsq_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vabsq_f64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vabsq_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vabsq_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vabsq_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vabsq_s64)
