#define EASYSIMD_TEST_ARM_NEON_INSN add

#include "test-neon.h"
#include "../../../easysimd/arm/neon/add.h"

static int
test_easysimd_vaddh_f16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  struct {
    easysimd_float16 a;
    easysimd_float16 b;
    ...
    { EASYSIMD_FLOAT16_VALUE(   167.25),
      EASYSIMD_FLOAT16_VALUE(  -952.00),
      EASYSIMD_FLOAT16_VALUE(  -785.00) },
    { EASYSIMD_FLOAT16_VALUE(  -942.50),
      EASYSIMD_FLOAT16_VALUE(   623.50),
      EASYSIMD_FLOAT16_VALUE(  -319.00) },
    { EASYSIMD_FLOAT16_VALUE(    -1.52),
      EASYSIMD_FLOAT16_VALUE(  -118.88),
      EASYSIMD_FLOAT16_VALUE(  -120.38) },
    { EASYSIMD_FLOAT16_VALUE(  -734.00),
      EASYSIMD_FLOAT16_VALUE(   -63.38),
      EASYSIMD_FLOAT16_VALUE(  -797.50) },
    { EASYSIMD_FLOAT16_VALUE(  -352.00),
      EASYSIMD_FLOAT16_VALUE(   409.00),
      EASYSIMD_FLOAT16_VALUE(    57.00) },
    { EASYSIMD_FLOAT16_VALUE(   191.75),
      EASYSIMD_FLOAT16_VALUE(  -388.75),
      EASYSIMD_FLOAT16_VALUE(  -197.00) },
    { EASYSIMD_FLOAT16_VALUE(   835.50),
      EASYSIMD_FLOAT16_VALUE(  -550.50),
      EASYSIMD_FLOAT16_VALUE(   285.00) },
    { EASYSIMD_FLOAT16_VALUE(  -529.00),
      EASYSIMD_FLOAT16_VALUE(  -873.50),
      EASYSIMD_FLOAT16_VALUE( -1402.00) }
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float16 r = easysimd_vaddh_f16(test_vec[i].a, test_vec[i].b);

    easysimd_assert_equal_f16(r, test_vec[i].r, 1);
  }
  ...
  fputc('\n', stdout);
  for (int i = 0 ; i < 8 ; i++) {
    easysimd_float16 a = easysimd_test_codegen_random_f16(-1000.0f, 1000.0f);
    easysimd_float16 b = easysimd_test_codegen_random_f16(-1000.0f, 1000.0f);
    easysimd_float16 r = easysimd_vaddh_f16(a, b);
    ...
    easysimd_test_codegen_write_f16(2, r, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
#endif
}
...
static int
test_easysimd_vaddd_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int64_t a;
    int64_t b;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    int64_t r = easysimd_vaddd_s64(test_vec[i].a, test_vec[i].b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    int64_t r = easysimd_vaddd_s64(a, b);
...
static int
test_easysimd_vaddd_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint64_t a;
    uint64_t b;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    uint64_t r = easysimd_vaddd_u64(test_vec[i].a, test_vec[i].b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    uint64_t r = easysimd_vaddd_u64(a, b);
...
static int
test_easysimd_vadd_f16 (EASYSIMD_MUNIT_TEST_ARGS) {
  #if 1
    struct {
      ...
      { { EASYSIMD_FLOAT16_VALUE(   -49.28), EASYSIMD_FLOAT16_VALUE(  -109.00), EASYSIMD_FLOAT16_VALUE(  -626.50), EASYSIMD_FLOAT16_VALUE(  -567.00) },
      { EASYSIMD_FLOAT16_VALUE(  -178.88), EASYSIMD_FLOAT16_VALUE(    10.22), EASYSIMD_FLOAT16_VALUE(   976.50), EASYSIMD_FLOAT16_VALUE(   -31.19) },
      { EASYSIMD_FLOAT16_VALUE(  -228.12), EASYSIMD_FLOAT16_VALUE(   -98.75), EASYSIMD_FLOAT16_VALUE(   350.00), EASYSIMD_FLOAT16_VALUE(  -598.00) } },
    { { EASYSIMD_FLOAT16_VALUE(  -226.00), EASYSIMD_FLOAT16_VALUE(  -520.50), EASYSIMD_FLOAT16_VALUE(  -252.38), EASYSIMD_FLOAT16_VALUE(  -407.50) },
      { EASYSIMD_FLOAT16_VALUE(    89.44), EASYSIMD_FLOAT16_VALUE(  -200.50), EASYSIMD_FLOAT16_VALUE(  -439.75), EASYSIMD_FLOAT16_VALUE(  -450.75) },
      { EASYSIMD_FLOAT16_VALUE(  -136.50), EASYSIMD_FLOAT16_VALUE(  -721.00), EASYSIMD_FLOAT16_VALUE(  -692.00), EASYSIMD_FLOAT16_VALUE(  -858.00) } },
    { { EASYSIMD_FLOAT16_VALUE(  -833.00), EASYSIMD_FLOAT16_VALUE(  -714.00), EASYSIMD_FLOAT16_VALUE(   428.50), EASYSIMD_FLOAT16_VALUE(   871.50) },
      { EASYSIMD_FLOAT16_VALUE(  -157.12), EASYSIMD_FLOAT16_VALUE(   972.50), EASYSIMD_FLOAT16_VALUE(   298.75), EASYSIMD_FLOAT16_VALUE(  -919.50) },
      { EASYSIMD_FLOAT16_VALUE(  -990.00), EASYSIMD_FLOAT16_VALUE(   258.50), EASYSIMD_FLOAT16_VALUE(   727.00), EASYSIMD_FLOAT16_VALUE(   -48.00) } },
    { { EASYSIMD_FLOAT16_VALUE(   488.00), EASYSIMD_FLOAT16_VALUE(   112.56), EASYSIMD_FLOAT16_VALUE(    58.66), EASYSIMD_FLOAT16_VALUE(   879.50) },
      { EASYSIMD_FLOAT16_VALUE(   129.00), EASYSIMD_FLOAT16_VALUE(  -858.50), EASYSIMD_FLOAT16_VALUE(  -133.88), EASYSIMD_FLOAT16_VALUE(  -920.50) },
      { EASYSIMD_FLOAT16_VALUE(   617.00), EASYSIMD_FLOAT16_VALUE(  -746.00), EASYSIMD_FLOAT16_VALUE(   -75.25), EASYSIMD_FLOAT16_VALUE(   -41.00) } },
    { { EASYSIMD_FLOAT16_VALUE(    32.59), EASYSIMD_FLOAT16_VALUE(   239.50), EASYSIMD_FLOAT16_VALUE(  -487.50), EASYSIMD_FLOAT16_VALUE(   853.50) },
      { EASYSIMD_FLOAT16_VALUE(  -750.50), EASYSIMD_FLOAT16_VALUE(  -510.75), EASYSIMD_FLOAT16_VALUE(  -177.50), EASYSIMD_FLOAT16_VALUE(    23.77) },
      { EASYSIMD_FLOAT16_VALUE(  -718.00), EASYSIMD_FLOAT16_VALUE(  -271.25), EASYSIMD_FLOAT16_VALUE(  -665.00), EASYSIMD_FLOAT16_VALUE(   877.50) } },
    { { EASYSIMD_FLOAT16_VALUE(   -31.45), EASYSIMD_FLOAT16_VALUE(   570.00), EASYSIMD_FLOAT16_VALUE(   616.00), EASYSIMD_FLOAT16_VALUE(  -942.00) },
      { EASYSIMD_FLOAT16_VALUE(  -630.50), EASYSIMD_FLOAT16_VALUE(  -823.50), EASYSIMD_FLOAT16_VALUE(  -392.75), EASYSIMD_FLOAT16_VALUE(  -463.25) },
      { EASYSIMD_FLOAT16_VALUE(  -662.00), EASYSIMD_FLOAT16_VALUE(  -253.50), EASYSIMD_FLOAT16_VALUE(   223.25), EASYSIMD_FLOAT16_VALUE( -1405.00) } },
    { { EASYSIMD_FLOAT16_VALUE(  -537.50), EASYSIMD_FLOAT16_VALUE(  -964.50), EASYSIMD_FLOAT16_VALUE(  -592.00), EASYSIMD_FLOAT16_VALUE(   305.50) },
      { EASYSIMD_FLOAT16_VALUE(  -992.00), EASYSIMD_FLOAT16_VALUE(   707.00), EASYSIMD_FLOAT16_VALUE(   386.00), EASYSIMD_FLOAT16_VALUE(   496.00) },
      { EASYSIMD_FLOAT16_VALUE( -1530.00), EASYSIMD_FLOAT16_VALUE(  -257.50), EASYSIMD_FLOAT16_VALUE(  -206.00), EASYSIMD_FLOAT16_VALUE(   801.50) } },
    { { EASYSIMD_FLOAT16_VALUE(  -180.50), EASYSIMD_FLOAT16_VALUE(  -555.50), EASYSIMD_FLOAT16_VALUE(   375.50), EASYSIMD_FLOAT16_VALUE(   948.50) },
      { EASYSIMD_FLOAT16_VALUE(  -413.75), EASYSIMD_FLOAT16_VALUE(  -758.50), EASYSIMD_FLOAT16_VALUE(  -972.00), EASYSIMD_FLOAT16_VALUE(   619.00) },
      { EASYSIMD_FLOAT16_VALUE(  -594.00), EASYSIMD_FLOAT16_VALUE( -1314.00), EASYSIMD_FLOAT16_VALUE(  -596.50), EASYSIMD_FLOAT16_VALUE(  1568.00) } }
    };

    for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
      easysimd_float16x4_t a, b, r;

      a = easysimd_vld1_f16(test_vec[i].a);
      b = easysimd_vld1_f16(test_vec[i].b);
      r = easysimd_vadd_f16(a, b);
    ...
    for (int i = 0 ; i < 8 ; i++) {
      ...
      easysimd_float16x4_t r = easysimd_vadd_f16(a, b);
...
static int
test_easysimd_vadd_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    easysimd_float32 a[2];
    easysimd_float32 b[2];
    easysimd_float32 r[2];
  } test_vec[] = {
    { { EASYSIMD_FLOAT32_C(  -645.65), EASYSIMD_FLOAT32_C(   153.94) },
      { EASYSIMD_FLOAT32_C(   112.49), EASYSIMD_FLOAT32_C(  -617.76) },
      { EASYSIMD_FLOAT32_C(  -533.16), EASYSIMD_FLOAT32_C(  -463.81) } },
    { { EASYSIMD_FLOAT32_C(  -544.46), EASYSIMD_FLOAT32_C(   -10.20) },
      { EASYSIMD_FLOAT32_C(   -53.36), EASYSIMD_FLOAT32_C(  -475.60) },
      { EASYSIMD_FLOAT32_C(  -597.83), EASYSIMD_FLOAT32_C(  -485.80) } },
    { { EASYSIMD_FLOAT32_C(   567.70), EASYSIMD_FLOAT32_C(   173.84) },
      { EASYSIMD_FLOAT32_C(   812.81), EASYSIMD_FLOAT32_C(   166.74) },
      { EASYSIMD_FLOAT32_C(  1380.51), EASYSIMD_FLOAT32_C(   340.59) } },
    { { EASYSIMD_FLOAT32_C(  -854.69), EASYSIMD_FLOAT32_C(  -924.50) },
      { EASYSIMD_FLOAT32_C(   -17.33), EASYSIMD_FLOAT32_C(  -405.57) },
      { EASYSIMD_FLOAT32_C(  -872.02), EASYSIMD_FLOAT32_C( -1330.07) } },
    { { EASYSIMD_FLOAT32_C(   507.20), EASYSIMD_FLOAT32_C(  -886.90) },
      { EASYSIMD_FLOAT32_C(   991.64), EASYSIMD_FLOAT32_C(   755.28) },
      { EASYSIMD_FLOAT32_C(  1498.84), EASYSIMD_FLOAT32_C(  -131.62) } },
    { { EASYSIMD_FLOAT32_C(  -419.88), EASYSIMD_FLOAT32_C(   108.98) },
      { EASYSIMD_FLOAT32_C(   853.76), EASYSIMD_FLOAT32_C(   233.89) },
      { EASYSIMD_FLOAT32_C(   433.88), EASYSIMD_FLOAT32_C(   342.87) } },
    { { EASYSIMD_FLOAT32_C(  -196.90), EASYSIMD_FLOAT32_C(   244.58) },
      { EASYSIMD_FLOAT32_C(   298.75), EASYSIMD_FLOAT32_C(   867.12) },
      { EASYSIMD_FLOAT32_C(   101.85), EASYSIMD_FLOAT32_C(  1111.70) } },
    { { EASYSIMD_FLOAT32_C(    32.51), EASYSIMD_FLOAT32_C(  -749.49) },
      { EASYSIMD_FLOAT32_C(  -783.09), EASYSIMD_FLOAT32_C(   386.86) },
      { EASYSIMD_FLOAT32_C(  -750.58), EASYSIMD_FLOAT32_C(  -362.63) } }
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float32x2_t a, b, r;

    a = easysimd_vld1_f32(test_vec[i].a);
    b = easysimd_vld1_f32(test_vec[i].b);
    r = easysimd_vadd_f32(a, b);
...
static int
test_easysimd_vadd_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    easysimd_float64 a[1];
    easysimd_float64 b[1];
    easysimd_float64 r[1];
  } test_vec[] = {
    { { EASYSIMD_FLOAT64_C(   404.45) },
      { EASYSIMD_FLOAT64_C(   329.40) },
      { EASYSIMD_FLOAT64_C(   733.85) } },
    { { EASYSIMD_FLOAT64_C(   769.10) },
      { EASYSIMD_FLOAT64_C(   859.99) },
      { EASYSIMD_FLOAT64_C(  1629.09) } },
    { { EASYSIMD_FLOAT64_C(  -680.80) },
      { EASYSIMD_FLOAT64_C(  -284.26) },
      { EASYSIMD_FLOAT64_C(  -965.06) } },
    { { EASYSIMD_FLOAT64_C(  -615.61) },
      { EASYSIMD_FLOAT64_C(   886.90) },
      { EASYSIMD_FLOAT64_C(   271.29) } },
    { { EASYSIMD_FLOAT64_C(   889.58) },
      { EASYSIMD_FLOAT64_C(  -802.80) },
      { EASYSIMD_FLOAT64_C(    86.78) } },
    { { EASYSIMD_FLOAT64_C(    53.64) },
      { EASYSIMD_FLOAT64_C(  -965.11) },
      { EASYSIMD_FLOAT64_C(  -911.46) } },
    { { EASYSIMD_FLOAT64_C(  -727.30) },
      { EASYSIMD_FLOAT64_C(  -963.68) },
      { EASYSIMD_FLOAT64_C( -1690.98) } },
    { { EASYSIMD_FLOAT64_C(  -370.68) },
      { EASYSIMD_FLOAT64_C(   779.90) },
      { EASYSIMD_FLOAT64_C(   409.22) } }
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float64x1_t a = easysimd_vld1_f64(test_vec[i].a);
    easysimd_float64x1_t b = easysimd_vld1_f64(test_vec[i].b);
    easysimd_float64x1_t r = easysimd_vadd_f64(a, b);
...
static int
test_easysimd_vadd_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int8_t a[8];
    int8_t b[8];
    int8_t r[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int8x8_t r = easysimd_vadd_s8(a, b);
...
static int
test_easysimd_vadd_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int16_t a[4];
    int16_t b[4];
    int16_t r[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int16x4_t r = easysimd_vadd_s16(a, b);
...
static int
test_easysimd_vadd_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int32_t a[2];
    int32_t b[2];
    int32_t r[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x2_t r = easysimd_vadd_s32(a, b);
...
static int
test_easysimd_vadd_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int64_t a[1];
    int64_t b[1];
    int64_t r[1];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int64x1_t r = easysimd_vadd_s64(a, b);
...
static int
test_easysimd_vadd_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint8_t a[16];
    uint8_t b[16];
    uint8_t r[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x8_t r = easysimd_vadd_u8(a, b);
...
static int
test_easysimd_vadd_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint16_t a[4];
    uint16_t b[4];
    uint16_t r[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x4_t r = easysimd_vadd_u16(a, b);
...
static int
test_easysimd_vadd_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint32_t a[2];
    uint32_t b[2];
    uint32_t r[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x2_t r = easysimd_vadd_u32(a, b);
...
static int
test_easysimd_vadd_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint64_t a[1];
    uint64_t b[1];
    uint64_t r[1];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint64x1_t r = easysimd_vadd_u64(a, b);
...
static int
test_easysimd_vaddq_f16 (EASYSIMD_MUNIT_TEST_ARGS) {
  #if 1
    struct {
      ...
      { { EASYSIMD_FLOAT16_VALUE(   441.00), EASYSIMD_FLOAT16_VALUE(   861.50), EASYSIMD_FLOAT16_VALUE(    98.06), EASYSIMD_FLOAT16_VALUE(   896.00),
        EASYSIMD_FLOAT16_VALUE(  -918.50), EASYSIMD_FLOAT16_VALUE(  -717.00), EASYSIMD_FLOAT16_VALUE(  -823.00), EASYSIMD_FLOAT16_VALUE(  -581.00) },
      { EASYSIMD_FLOAT16_VALUE(   684.00), EASYSIMD_FLOAT16_VALUE(   563.00), EASYSIMD_FLOAT16_VALUE(    15.31), EASYSIMD_FLOAT16_VALUE(  -786.50),
        EASYSIMD_FLOAT16_VALUE(   891.00), EASYSIMD_FLOAT16_VALUE(   859.50), EASYSIMD_FLOAT16_VALUE(   387.25), EASYSIMD_FLOAT16_VALUE(   969.00) },
      { EASYSIMD_FLOAT16_VALUE(  1125.00), EASYSIMD_FLOAT16_VALUE(  1424.00), EASYSIMD_FLOAT16_VALUE(   113.38), EASYSIMD_FLOAT16_VALUE(   109.50),
        EASYSIMD_FLOAT16_VALUE(   -27.50), EASYSIMD_FLOAT16_VALUE(   142.50), EASYSIMD_FLOAT16_VALUE(  -435.75), EASYSIMD_FLOAT16_VALUE(   388.00) } },
    { { EASYSIMD_FLOAT16_VALUE(    -6.45), EASYSIMD_FLOAT16_VALUE(    29.20), EASYSIMD_FLOAT16_VALUE(  -856.00), EASYSIMD_FLOAT16_VALUE(   267.25),
        EASYSIMD_FLOAT16_VALUE(  -302.00), EASYSIMD_FLOAT16_VALUE(   526.50), EASYSIMD_FLOAT16_VALUE(   713.00), EASYSIMD_FLOAT16_VALUE(   -14.83) },
      { EASYSIMD_FLOAT16_VALUE(  -848.00), EASYSIMD_FLOAT16_VALUE(   815.50), EASYSIMD_FLOAT16_VALUE(  -672.50), EASYSIMD_FLOAT16_VALUE(   274.50),
        EASYSIMD_FLOAT16_VALUE(   933.00), EASYSIMD_FLOAT16_VALUE(  -952.50), EASYSIMD_FLOAT16_VALUE(   426.00), EASYSIMD_FLOAT16_VALUE(   373.75) },
      { EASYSIMD_FLOAT16_VALUE(  -854.50), EASYSIMD_FLOAT16_VALUE(   844.50), EASYSIMD_FLOAT16_VALUE( -1528.00), EASYSIMD_FLOAT16_VALUE(   542.00),
        EASYSIMD_FLOAT16_VALUE(   631.00), EASYSIMD_FLOAT16_VALUE(  -426.00), EASYSIMD_FLOAT16_VALUE(  1139.00), EASYSIMD_FLOAT16_VALUE(   359.00) } },
    { { EASYSIMD_FLOAT16_VALUE(   909.00), EASYSIMD_FLOAT16_VALUE(  -475.75), EASYSIMD_FLOAT16_VALUE(   269.75), EASYSIMD_FLOAT16_VALUE(   991.00),
        EASYSIMD_FLOAT16_VALUE(  -192.62), EASYSIMD_FLOAT16_VALUE(   446.50), EASYSIMD_FLOAT16_VALUE(  -590.00), EASYSIMD_FLOAT16_VALUE(  -508.50) },
      { EASYSIMD_FLOAT16_VALUE(     9.56), EASYSIMD_FLOAT16_VALUE(   425.25), EASYSIMD_FLOAT16_VALUE(  -294.75), EASYSIMD_FLOAT16_VALUE(   -99.19),
        EASYSIMD_FLOAT16_VALUE(   284.50), EASYSIMD_FLOAT16_VALUE(  -907.50), EASYSIMD_FLOAT16_VALUE(  -130.00), EASYSIMD_FLOAT16_VALUE(  -722.00) },
      { EASYSIMD_FLOAT16_VALUE(   918.50), EASYSIMD_FLOAT16_VALUE(   -50.50), EASYSIMD_FLOAT16_VALUE(   -25.00), EASYSIMD_FLOAT16_VALUE(   892.00),
        EASYSIMD_FLOAT16_VALUE(    91.88), EASYSIMD_FLOAT16_VALUE(  -461.00), EASYSIMD_FLOAT16_VALUE(  -720.00), EASYSIMD_FLOAT16_VALUE( -1230.00) } },
    { { EASYSIMD_FLOAT16_VALUE(   121.69), EASYSIMD_FLOAT16_VALUE(    14.28), EASYSIMD_FLOAT16_VALUE(   545.00), EASYSIMD_FLOAT16_VALUE(   819.50),
        EASYSIMD_FLOAT16_VALUE(  -459.00), EASYSIMD_FLOAT16_VALUE(   258.50), EASYSIMD_FLOAT16_VALUE(  -195.12), EASYSIMD_FLOAT16_VALUE(  -307.00) },
      { EASYSIMD_FLOAT16_VALUE(    73.81), EASYSIMD_FLOAT16_VALUE(   132.25), EASYSIMD_FLOAT16_VALUE(   967.50), EASYSIMD_FLOAT16_VALUE(     6.60),
        EASYSIMD_FLOAT16_VALUE(   179.88), EASYSIMD_FLOAT16_VALUE(   393.50), EASYSIMD_FLOAT16_VALUE(  -619.50), EASYSIMD_FLOAT16_VALUE(    89.12) },
      { EASYSIMD_FLOAT16_VALUE(   195.50), EASYSIMD_FLOAT16_VALUE(   146.50), EASYSIMD_FLOAT16_VALUE(  1512.00), EASYSIMD_FLOAT16_VALUE(   826.00),
        EASYSIMD_FLOAT16_VALUE(  -279.00), EASYSIMD_FLOAT16_VALUE(   652.00), EASYSIMD_FLOAT16_VALUE(  -814.50), EASYSIMD_FLOAT16_VALUE(  -217.88) } },
    { { EASYSIMD_FLOAT16_VALUE(   918.00), EASYSIMD_FLOAT16_VALUE(   650.00), EASYSIMD_FLOAT16_VALUE(    80.00), EASYSIMD_FLOAT16_VALUE(  -275.00),
        EASYSIMD_FLOAT16_VALUE(    96.56), EASYSIMD_FLOAT16_VALUE(   489.75), EASYSIMD_FLOAT16_VALUE(   216.50), EASYSIMD_FLOAT16_VALUE(  -894.00) },
      { EASYSIMD_FLOAT16_VALUE(   -85.06), EASYSIMD_FLOAT16_VALUE(   921.50), EASYSIMD_FLOAT16_VALUE(     6.98), EASYSIMD_FLOAT16_VALUE(  -800.50),
        EASYSIMD_FLOAT16_VALUE(  -986.00), EASYSIMD_FLOAT16_VALUE(   877.00), EASYSIMD_FLOAT16_VALUE(  -522.50), EASYSIMD_FLOAT16_VALUE(   135.75) },
      { EASYSIMD_FLOAT16_VALUE(   833.00), EASYSIMD_FLOAT16_VALUE(  1572.00), EASYSIMD_FLOAT16_VALUE(    87.00), EASYSIMD_FLOAT16_VALUE( -1076.00),
        EASYSIMD_FLOAT16_VALUE(  -889.50), EASYSIMD_FLOAT16_VALUE(  1367.00), EASYSIMD_FLOAT16_VALUE(  -306.00), EASYSIMD_FLOAT16_VALUE(  -758.00) } },
    { { EASYSIMD_FLOAT16_VALUE(  -108.69), EASYSIMD_FLOAT16_VALUE(  -977.50), EASYSIMD_FLOAT16_VALUE(   -44.56), EASYSIMD_FLOAT16_VALUE(   432.25),
        EASYSIMD_FLOAT16_VALUE(   281.00), EASYSIMD_FLOAT16_VALUE(   760.00), EASYSIMD_FLOAT16_VALUE(  -874.50), EASYSIMD_FLOAT16_VALUE(  -645.00) },
      { EASYSIMD_FLOAT16_VALUE(  -107.50), EASYSIMD_FLOAT16_VALUE(  -907.00), EASYSIMD_FLOAT16_VALUE(   361.50), EASYSIMD_FLOAT16_VALUE(  -927.50),
        EASYSIMD_FLOAT16_VALUE(   486.50), EASYSIMD_FLOAT16_VALUE(   742.00), EASYSIMD_FLOAT16_VALUE(   161.50), EASYSIMD_FLOAT16_VALUE(   404.25) },
      { EASYSIMD_FLOAT16_VALUE(  -216.25), EASYSIMD_FLOAT16_VALUE( -1884.00), EASYSIMD_FLOAT16_VALUE(   317.00), EASYSIMD_FLOAT16_VALUE(  -495.25),
        EASYSIMD_FLOAT16_VALUE(   767.50), EASYSIMD_FLOAT16_VALUE(  1502.00), EASYSIMD_FLOAT16_VALUE(  -713.00), EASYSIMD_FLOAT16_VALUE(  -240.75) } },
    { { EASYSIMD_FLOAT16_VALUE(   392.00), EASYSIMD_FLOAT16_VALUE(  -758.50), EASYSIMD_FLOAT16_VALUE(  -870.50), EASYSIMD_FLOAT16_VALUE(  -511.25),
        EASYSIMD_FLOAT16_VALUE(   731.50), EASYSIMD_FLOAT16_VALUE(   345.75), EASYSIMD_FLOAT16_VALUE(  -405.25), EASYSIMD_FLOAT16_VALUE(  -353.75) },
      { EASYSIMD_FLOAT16_VALUE(   267.50), EASYSIMD_FLOAT16_VALUE(   602.00), EASYSIMD_FLOAT16_VALUE(  -154.25), EASYSIMD_FLOAT16_VALUE(   281.75),
        EASYSIMD_FLOAT16_VALUE(   478.75), EASYSIMD_FLOAT16_VALUE(   323.25), EASYSIMD_FLOAT16_VALUE(  -582.50), EASYSIMD_FLOAT16_VALUE(  -630.00) },
      { EASYSIMD_FLOAT16_VALUE(   659.50), EASYSIMD_FLOAT16_VALUE(  -156.50), EASYSIMD_FLOAT16_VALUE( -1025.00), EASYSIMD_FLOAT16_VALUE(  -229.50),
        EASYSIMD_FLOAT16_VALUE(  1210.00), EASYSIMD_FLOAT16_VALUE(   669.00), EASYSIMD_FLOAT16_VALUE(  -988.00), EASYSIMD_FLOAT16_VALUE(  -984.00) } },
    { { EASYSIMD_FLOAT16_VALUE(   345.75), EASYSIMD_FLOAT16_VALUE(   372.75), EASYSIMD_FLOAT16_VALUE(   802.50), EASYSIMD_FLOAT16_VALUE(  -373.00),
        EASYSIMD_FLOAT16_VALUE(   133.12), EASYSIMD_FLOAT16_VALUE(   928.00), EASYSIMD_FLOAT16_VALUE(   -18.17), EASYSIMD_FLOAT16_VALUE(  -974.50) },
      { EASYSIMD_FLOAT16_VALUE(  -979.50), EASYSIMD_FLOAT16_VALUE(  -656.50), EASYSIMD_FLOAT16_VALUE(  -902.00), EASYSIMD_FLOAT16_VALUE(   507.00),
        EASYSIMD_FLOAT16_VALUE(  -914.50), EASYSIMD_FLOAT16_VALUE(   259.50), EASYSIMD_FLOAT16_VALUE(   -88.69), EASYSIMD_FLOAT16_VALUE(   477.25) },
      { EASYSIMD_FLOAT16_VALUE(  -634.00), EASYSIMD_FLOAT16_VALUE(  -283.75), EASYSIMD_FLOAT16_VALUE(   -99.50), EASYSIMD_FLOAT16_VALUE(   134.00),
        EASYSIMD_FLOAT16_VALUE(  -781.50), EASYSIMD_FLOAT16_VALUE(  1188.00), EASYSIMD_FLOAT16_VALUE(  -106.88), EASYSIMD_FLOAT16_VALUE(  -497.25) } }
    };

    for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
      easysimd_float16x8_t a, b, r;

      a = easysimd_vld1q_f16(test_vec[i].a);
      b = easysimd_vld1q_f16(test_vec[i].b);
      r = easysimd_vaddq_f16(a, b);
    ...
    for (int i = 0 ; i < 8 ; i++) {
      ...
      easysimd_float16x8_t r = easysimd_vaddq_f16(a, b);
...
static int
test_easysimd_vaddq_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    easysimd_float32 a[4];
    easysimd_float32 b[4];
    easysimd_float32 r[4];
  } test_vec[] = {
    { { EASYSIMD_FLOAT32_C(  -476.88), EASYSIMD_FLOAT32_C(   -38.10), EASYSIMD_FLOAT32_C(   469.39), EASYSIMD_FLOAT32_C(  -664.80) },
      { EASYSIMD_FLOAT32_C(   181.43), EASYSIMD_FLOAT32_C(  -154.03), EASYSIMD_FLOAT32_C(  -345.56), EASYSIMD_FLOAT32_C(  -102.63) },
      { EASYSIMD_FLOAT32_C(  -295.46), EASYSIMD_FLOAT32_C(  -192.12), EASYSIMD_FLOAT32_C(   123.83), EASYSIMD_FLOAT32_C(  -767.44) } },
    { { EASYSIMD_FLOAT32_C(  -103.40), EASYSIMD_FLOAT32_C(   661.42), EASYSIMD_FLOAT32_C(  -336.65), EASYSIMD_FLOAT32_C(   536.30) },
      { EASYSIMD_FLOAT32_C(   318.30), EASYSIMD_FLOAT32_C(  -387.41), EASYSIMD_FLOAT32_C(   435.33), EASYSIMD_FLOAT32_C(  -961.83) },
      { EASYSIMD_FLOAT32_C(   214.90), EASYSIMD_FLOAT32_C(   274.01), EASYSIMD_FLOAT32_C(    98.69), EASYSIMD_FLOAT32_C(  -425.53) } },
    { { EASYSIMD_FLOAT32_C(   203.44), EASYSIMD_FLOAT32_C(  -916.52), EASYSIMD_FLOAT32_C(  -867.20), EASYSIMD_FLOAT32_C(    66.23) },
      { EASYSIMD_FLOAT32_C(  -667.27), EASYSIMD_FLOAT32_C(  -968.66), EASYSIMD_FLOAT32_C(   101.74), EASYSIMD_FLOAT32_C(   202.05) },
      { EASYSIMD_FLOAT32_C(  -463.83), EASYSIMD_FLOAT32_C( -1885.18), EASYSIMD_FLOAT32_C(  -765.47), EASYSIMD_FLOAT32_C(   268.28) } },
    { { EASYSIMD_FLOAT32_C(  -612.77), EASYSIMD_FLOAT32_C(  -920.83), EASYSIMD_FLOAT32_C(    82.14), EASYSIMD_FLOAT32_C(  -930.15) },
      { EASYSIMD_FLOAT32_C(  -763.40), EASYSIMD_FLOAT32_C(  -818.04), EASYSIMD_FLOAT32_C(   -97.96), EASYSIMD_FLOAT32_C(  -240.29) },
      { EASYSIMD_FLOAT32_C( -1376.18), EASYSIMD_FLOAT32_C( -1738.88), EASYSIMD_FLOAT32_C(   -15.82), EASYSIMD_FLOAT32_C( -1170.43) } },
    { { EASYSIMD_FLOAT32_C(   143.86), EASYSIMD_FLOAT32_C(  -628.57), EASYSIMD_FLOAT32_C(    94.91), EASYSIMD_FLOAT32_C(  -674.71) },
      { EASYSIMD_FLOAT32_C(   217.40), EASYSIMD_FLOAT32_C(   749.35), EASYSIMD_FLOAT32_C(   222.65), EASYSIMD_FLOAT32_C(  -886.00) },
      { EASYSIMD_FLOAT32_C(   361.26), EASYSIMD_FLOAT32_C(   120.77), EASYSIMD_FLOAT32_C(   317.56), EASYSIMD_FLOAT32_C( -1560.71) } },
    { { EASYSIMD_FLOAT32_C(   410.77), EASYSIMD_FLOAT32_C(   886.01), EASYSIMD_FLOAT32_C(   650.30), EASYSIMD_FLOAT32_C(  -270.93) },
      { EASYSIMD_FLOAT32_C(  -501.41), EASYSIMD_FLOAT32_C(    85.64), EASYSIMD_FLOAT32_C(  -232.77), EASYSIMD_FLOAT32_C(   702.03) },
      { EASYSIMD_FLOAT32_C(   -90.64), EASYSIMD_FLOAT32_C(   971.64), EASYSIMD_FLOAT32_C(   417.54), EASYSIMD_FLOAT32_C(   431.10) } },
    { { EASYSIMD_FLOAT32_C(   169.12), EASYSIMD_FLOAT32_C(   -99.97), EASYSIMD_FLOAT32_C(  -231.73), EASYSIMD_FLOAT32_C(   501.86) },
      { EASYSIMD_FLOAT32_C(   -68.63), EASYSIMD_FLOAT32_C(   870.00), EASYSIMD_FLOAT32_C(  -296.10), EASYSIMD_FLOAT32_C(   318.59) },
      { EASYSIMD_FLOAT32_C(   100.49), EASYSIMD_FLOAT32_C(   770.03), EASYSIMD_FLOAT32_C(  -527.83), EASYSIMD_FLOAT32_C(   820.45) } },
    { { EASYSIMD_FLOAT32_C(   949.17), EASYSIMD_FLOAT32_C(   786.05), EASYSIMD_FLOAT32_C(   388.45), EASYSIMD_FLOAT32_C(  -814.23) },
      { EASYSIMD_FLOAT32_C(   968.00), EASYSIMD_FLOAT32_C(  -709.52), EASYSIMD_FLOAT32_C(   -54.52), EASYSIMD_FLOAT32_C(   111.86) },
      { EASYSIMD_FLOAT32_C(  1917.17), EASYSIMD_FLOAT32_C(    76.53), EASYSIMD_FLOAT32_C(   333.93), EASYSIMD_FLOAT32_C(  -702.37) } }
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float32x4_t a = easysimd_vld1q_f32(test_vec[i].a);
    easysimd_float32x4_t b = easysimd_vld1q_f32(test_vec[i].b);
    easysimd_float32x4_t r = easysimd_vaddq_f32(a, b);
...
static int
test_easysimd_vaddq_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    easysimd_float64 a[2];
    easysimd_float64 b[2];
    easysimd_float64 r[2];
  } test_vec[] = {
    { { EASYSIMD_FLOAT64_C(  -338.09), EASYSIMD_FLOAT64_C(  -959.61) },
      { EASYSIMD_FLOAT64_C(   437.15), EASYSIMD_FLOAT64_C(   879.31) },
      { EASYSIMD_FLOAT64_C(    99.06), EASYSIMD_FLOAT64_C(   -80.30) } },
    { { EASYSIMD_FLOAT64_C(   789.73), EASYSIMD_FLOAT64_C(  -340.20) },
      { EASYSIMD_FLOAT64_C(   993.31), EASYSIMD_FLOAT64_C(   200.50) },
      { EASYSIMD_FLOAT64_C(  1783.05), EASYSIMD_FLOAT64_C(  -139.70) } },
    { { EASYSIMD_FLOAT64_C(  -454.19), EASYSIMD_FLOAT64_C(   643.62) },
      { EASYSIMD_FLOAT64_C(   929.57), EASYSIMD_FLOAT64_C(    44.40) },
      { EASYSIMD_FLOAT64_C(   475.38), EASYSIMD_FLOAT64_C(   688.02) } },
    { { EASYSIMD_FLOAT64_C(  -270.75), EASYSIMD_FLOAT64_C(  -303.20) },
      { EASYSIMD_FLOAT64_C(  -253.57), EASYSIMD_FLOAT64_C(   898.38) },
      { EASYSIMD_FLOAT64_C(  -524.31), EASYSIMD_FLOAT64_C(   595.18) } },
    { { EASYSIMD_FLOAT64_C(   596.83), EASYSIMD_FLOAT64_C(   514.70) },
      { EASYSIMD_FLOAT64_C(   400.23), EASYSIMD_FLOAT64_C(  -471.80) },
      { EASYSIMD_FLOAT64_C(   997.06), EASYSIMD_FLOAT64_C(    42.90) } },
    { { EASYSIMD_FLOAT64_C(   384.71), EASYSIMD_FLOAT64_C(  -895.87) },
      { EASYSIMD_FLOAT64_C(   846.79), EASYSIMD_FLOAT64_C(   333.88) },
      { EASYSIMD_FLOAT64_C(  1231.50), EASYSIMD_FLOAT64_C(  -561.99) } },
    { { EASYSIMD_FLOAT64_C(   890.18), EASYSIMD_FLOAT64_C(   235.24) },
      { EASYSIMD_FLOAT64_C(   519.64), EASYSIMD_FLOAT64_C(   858.18) },
      { EASYSIMD_FLOAT64_C(  1409.82), EASYSIMD_FLOAT64_C(  1093.42) } },
    { { EASYSIMD_FLOAT64_C(   525.73), EASYSIMD_FLOAT64_C(  -534.88) },
      { EASYSIMD_FLOAT64_C(   -29.96), EASYSIMD_FLOAT64_C(  -812.36) },
      { EASYSIMD_FLOAT64_C(   495.77), EASYSIMD_FLOAT64_C( -1347.24) } }
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float64x2_t a = easysimd_vld1q_f64(test_vec[i].a);
    easysimd_float64x2_t b = easysimd_vld1q_f64(test_vec[i].b);
    easysimd_float64x2_t r = easysimd_vaddq_f64(a, b);
...
static int
test_easysimd_vaddq_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int8_t a[16];
    int8_t b[16];
    int8_t r[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int8x16_t r = easysimd_vaddq_s8(a, b);
...
static int
test_easysimd_vaddq_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int16_t a[8];
    int16_t b[8];
    int16_t r[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int16x8_t r = easysimd_vaddq_s16(a, b);
...
static int
test_easysimd_vaddq_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int32_t a[4];
    int32_t b[4];
    int32_t r[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x4_t r = easysimd_vaddq_s32(a, b);
...
static int
test_easysimd_vaddq_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int64_t a[2];
    int64_t b[2];
    int64_t r[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int64x2_t r = easysimd_vaddq_s64(a, b);
...
static int
test_easysimd_vaddq_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint8_t a[16];
    uint8_t b[16];
    uint8_t r[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x16_t r = easysimd_vaddq_u8(a, b);
...
static int
test_easysimd_vaddq_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint16_t a[8];
    uint16_t b[8];
    uint16_t r[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x8_t r = easysimd_vaddq_u16(a, b);
...
static int
test_easysimd_vaddq_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint32_t a[4];
    uint32_t b[4];
    uint32_t r[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x4_t r = easysimd_vaddq_u32(a, b);
...
static int
test_easysimd_vaddq_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint64_t a[2];
    uint64_t b[2];
    uint64_t r[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint64x2_t r = easysimd_vaddq_u64(a, b);
...
EASYSIMD_TEST_FUNC_LIST_ENTRY(vaddh_f16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vaddd_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vaddd_u64)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vadd_f16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vadd_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vadd_f64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vadd_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vadd_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vadd_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vadd_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vadd_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vadd_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vadd_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vadd_u64)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vaddq_f16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vaddq_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vaddq_f64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vaddq_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vaddq_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vaddq_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vaddq_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vaddq_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vaddq_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vaddq_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vaddq_u64)
