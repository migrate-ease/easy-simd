#define EASYSIMD_TEST_ARM_NEON_INSN addhn

#include "test-neon.h"
#include "../../../easysimd/arm/neon/addhn.h"

static int
test_easysimd_vaddhn_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int16_t a[8];
    int16_t b[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int8x8_t r = easysimd_vaddhn_s16(a, b);
...
static int
test_easysimd_vaddhn_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t a[4];
    int32_t b[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int16x4_t r = easysimd_vaddhn_s32(a, b);
...
static int
test_easysimd_vaddhn_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int64_t a[2];
    int64_t b[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x2_t r = easysimd_vaddhn_s64(a, b);
...
static int
test_easysimd_vaddhn_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint16_t a[8];
    uint16_t b[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x8_t r = easysimd_vaddhn_u16(a, b);
...
static int
test_easysimd_vaddhn_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint32_t a[4];
    uint32_t b[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x4_t r = easysimd_vaddhn_u32(a, b);
...
static int
test_easysimd_vaddhn_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint64_t a[2];
    uint64_t b[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x2_t r = easysimd_vaddhn_u64(a, b);
...
EASYSIMD_TEST_FUNC_LIST_ENTRY(vaddhn_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vaddhn_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vaddhn_s64)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vaddhn_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vaddhn_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vaddhn_u64)
