#define EASYSIMD_TEST_ARM_NEON_INSN addl_high

#include "test-neon.h"
#include <easysimd/arm/neon/addl_high.h>

static int
test_easysimd_vaddl_high_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int8_t a[16];
    int8_t b[16];
    int16_t r[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int16x8_t r = easysimd_vaddl_high_s8(a, b);
...
static int
test_easysimd_vaddl_high_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int16_t a[8];
    int16_t b[8];
    int32_t r[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x4_t r = easysimd_vaddl_high_s16(a, b);
...
static int
test_easysimd_vaddl_high_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int32_t a[4];
    int32_t b[4];
    int64_t r[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int64x2_t r = easysimd_vaddl_high_s32(a, b);
...
static int
test_easysimd_vaddl_high_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint8_t a[16];
    uint8_t b[16];
    uint16_t r[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x8_t r = easysimd_vaddl_high_u8(a, b);
...
static int
test_easysimd_vaddl_high_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint16_t a[8];
    uint16_t b[8];
    uint32_t r[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x4_t r = easysimd_vaddl_high_u16(a, b);
...
static int
test_easysimd_vaddl_high_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint32_t a[4];
    uint32_t b[4];
    uint64_t r[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint64x2_t r = easysimd_vaddl_high_u32(a, b);
...
EASYSIMD_TEST_FUNC_LIST_ENTRY(vaddl_high_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vaddl_high_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vaddl_high_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vaddl_high_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vaddl_high_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vaddl_high_u32)
