#define EASYSIMD_TEST_ARM_NEON_INSN addlv

#include "test-neon.h"
#include "../../../easysimd/arm/neon/addlv.h"

static int
test_easysimd_vaddlv_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int8_t a[8];
    int16_t r;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    int16_t r = easysimd_vaddlv_s8(a);
...
static int
test_easysimd_vaddlv_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int16_t a[4];
    int32_t r;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    int32_t r = easysimd_vaddlv_s16(a);
...
static int
test_easysimd_vaddlv_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t a[2];
    int64_t r;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    int64_t r = easysimd_vaddlv_s32(a);
...
static int
test_easysimd_vaddlv_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint8_t a[8];
    uint16_t r;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    uint16_t r = easysimd_vaddlv_u8(a);
...
static int
test_easysimd_vaddlv_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint16_t a[4];
    uint32_t r;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    uint32_t r = easysimd_vaddlv_u16(a);
...
static int
test_easysimd_vaddlv_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint32_t a[2];
    uint64_t r;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    uint64_t r = easysimd_vaddlv_u32(a);
...
static int
test_easysimd_vaddlvq_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int8_t a[16];
    int16_t r;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    int16_t r = easysimd_vaddlvq_s8(a);
...
static int
test_easysimd_vaddlvq_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int16_t a[8];
    int32_t r;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    int32_t r = easysimd_vaddlvq_s16(a);
...
static int
test_easysimd_vaddlvq_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t a[4];
    int64_t r;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    int64_t r = easysimd_vaddlvq_s32(a);
...
static int
test_easysimd_vaddlvq_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint8_t a[16];
    uint16_t r;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    uint16_t r = easysimd_vaddlvq_u8(a);
...
static int
test_easysimd_vaddlvq_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint16_t a[8];
    uint32_t r;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    uint32_t r = easysimd_vaddlvq_u16(a);
...
static int
test_easysimd_vaddlvq_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint32_t a[4];
    uint64_t r;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    uint64_t r = easysimd_vaddlvq_u32(a);
...
EASYSIMD_TEST_FUNC_LIST_ENTRY(vaddlv_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vaddlv_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vaddlv_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vaddlv_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vaddlv_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vaddlv_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vaddlvq_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vaddlvq_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vaddlvq_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vaddlvq_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vaddlvq_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vaddlvq_u32)
