#define EASYSIMD_TEST_ARM_NEON_INSN addv

#include "test-neon.h"
#include "../../../easysimd/arm/neon/addv.h"

static int
test_easysimd_vaddv_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    easysimd_float32_t a[2];
    easysimd_float32_t r;
  } test_vec[] = {
    { { EASYSIMD_FLOAT32_C(  -235.05), EASYSIMD_FLOAT32_C(  -904.04) },
      EASYSIMD_FLOAT32_C( -1139.09) },
    { { EASYSIMD_FLOAT32_C(   272.68), EASYSIMD_FLOAT32_C(   622.28) },
      EASYSIMD_FLOAT32_C(   894.96) },
    { { EASYSIMD_FLOAT32_C(  -525.30), EASYSIMD_FLOAT32_C(  -528.82) },
      EASYSIMD_FLOAT32_C( -1054.12) },
    { { EASYSIMD_FLOAT32_C(    29.65), EASYSIMD_FLOAT32_C(  -351.94) },
      EASYSIMD_FLOAT32_C(  -322.29) },
    { { EASYSIMD_FLOAT32_C(   961.57), EASYSIMD_FLOAT32_C(   223.98) },
      EASYSIMD_FLOAT32_C(  1185.55) },
    { { EASYSIMD_FLOAT32_C(  -664.36), EASYSIMD_FLOAT32_C(   112.82) },
      EASYSIMD_FLOAT32_C(  -551.54) },
    { { EASYSIMD_FLOAT32_C(  -605.37), EASYSIMD_FLOAT32_C(  -434.90) },
      EASYSIMD_FLOAT32_C( -1040.27) },
    { { EASYSIMD_FLOAT32_C(  -227.61), EASYSIMD_FLOAT32_C(  -769.47) },
      EASYSIMD_FLOAT32_C(  -997.08) }
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float32x2_t a = easysimd_vld1_f32(test_vec[i].a);
    easysimd_float32_t r = easysimd_vaddv_f32(a);
...
static int
test_easysimd_vaddv_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int8_t a[8];
    int8_t r;
...
static int
test_easysimd_vaddv_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int16_t a[4];
    int16_t r;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    int16_t r = easysimd_vaddv_s16(a);
...
static int
test_easysimd_vaddv_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t a[2];
    int32_t r;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    int32_t r = easysimd_vaddv_s32(a);
...
static int
test_easysimd_vaddv_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint8_t a[8];
    uint8_t r;
...
static int
test_easysimd_vaddv_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint16_t a[4];
    uint16_t r;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    uint16_t r = easysimd_vaddv_u16(a);
...
static int
test_easysimd_vaddv_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint32_t a[2];
    uint32_t r;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    uint32_t r = easysimd_vaddv_u32(a);
...
static int
test_easysimd_vaddvq_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    easysimd_float32_t a[4];
    easysimd_float32_t r;
  } test_vec[] = {
    { { EASYSIMD_FLOAT32_C(  -654.47), EASYSIMD_FLOAT32_C(  -946.98), EASYSIMD_FLOAT32_C(  -606.16), EASYSIMD_FLOAT32_C(   426.64) },
      EASYSIMD_FLOAT32_C( -1780.97) },
    { { EASYSIMD_FLOAT32_C(   868.73), EASYSIMD_FLOAT32_C(  -655.12), EASYSIMD_FLOAT32_C(   -15.45), EASYSIMD_FLOAT32_C(   495.29) },
      EASYSIMD_FLOAT32_C(   693.45) },
    { { EASYSIMD_FLOAT32_C(  -337.86), EASYSIMD_FLOAT32_C(  -244.89), EASYSIMD_FLOAT32_C(    98.86), EASYSIMD_FLOAT32_C(   743.11) },
      EASYSIMD_FLOAT32_C(   259.22) },
    { { EASYSIMD_FLOAT32_C(  -546.07), EASYSIMD_FLOAT32_C(   748.90), EASYSIMD_FLOAT32_C(  -734.79), EASYSIMD_FLOAT32_C(   726.97) },
      EASYSIMD_FLOAT32_C(   195.01) },
    { { EASYSIMD_FLOAT32_C(  -248.73), EASYSIMD_FLOAT32_C(   463.88), EASYSIMD_FLOAT32_C(   495.61), EASYSIMD_FLOAT32_C(  -608.95) },
      EASYSIMD_FLOAT32_C(   101.81) },
    { { EASYSIMD_FLOAT32_C(   490.96), EASYSIMD_FLOAT32_C(    76.01), EASYSIMD_FLOAT32_C(  -900.59), EASYSIMD_FLOAT32_C(    34.68) },
      EASYSIMD_FLOAT32_C(  -298.94) },
    { { EASYSIMD_FLOAT32_C(   663.94), EASYSIMD_FLOAT32_C(   660.23), EASYSIMD_FLOAT32_C(   682.64), EASYSIMD_FLOAT32_C(  -644.47) },
      EASYSIMD_FLOAT32_C(  1362.34) },
    { { EASYSIMD_FLOAT32_C(  -909.10), EASYSIMD_FLOAT32_C(    23.60), EASYSIMD_FLOAT32_C(  -382.13), EASYSIMD_FLOAT32_C(  -563.57) },
      EASYSIMD_FLOAT32_C( -1831.20) }
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float32x4_t a = easysimd_vld1q_f32(test_vec[i].a);
    easysimd_float32_t r = easysimd_vaddvq_f32(a);
...
static int
test_easysimd_vaddvq_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    easysimd_float64_t a[4];
    easysimd_float64_t r;
  } test_vec[] = {
    { { EASYSIMD_FLOAT64_C(  -439.88), EASYSIMD_FLOAT64_C(   593.77) },
      EASYSIMD_FLOAT64_C(   153.89) },
    { { EASYSIMD_FLOAT64_C(   555.36), EASYSIMD_FLOAT64_C(   -41.81) },
      EASYSIMD_FLOAT64_C(   513.55) },
    { { EASYSIMD_FLOAT64_C(  -578.35), EASYSIMD_FLOAT64_C(  -756.91) },
      EASYSIMD_FLOAT64_C( -1335.26) },
    { { EASYSIMD_FLOAT64_C(   564.48), EASYSIMD_FLOAT64_C(  -445.40) },
      EASYSIMD_FLOAT64_C(   119.08) },
    { { EASYSIMD_FLOAT64_C(   762.82), EASYSIMD_FLOAT64_C(  -204.54) },
      EASYSIMD_FLOAT64_C(   558.28) },
    { { EASYSIMD_FLOAT64_C(   674.09), EASYSIMD_FLOAT64_C(   291.13) },
      EASYSIMD_FLOAT64_C(   965.22) },
    { { EASYSIMD_FLOAT64_C(  -929.06), EASYSIMD_FLOAT64_C(   684.47) },
      EASYSIMD_FLOAT64_C(  -244.59) },
    { { EASYSIMD_FLOAT64_C(   -72.52), EASYSIMD_FLOAT64_C(   177.81) },
      EASYSIMD_FLOAT64_C(   105.29) }
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float64x2_t a = easysimd_vld1q_f64(test_vec[i].a);
    easysimd_float64_t r = easysimd_vaddvq_f64(a);
...
static int
test_easysimd_vaddvq_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int8_t a[16];
    int8_t r;
...
static int
test_easysimd_vaddvq_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int16_t a[8];
    int16_t r;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    int16_t r = easysimd_vaddvq_s16(a);
...
static int
test_easysimd_vaddvq_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t a[4];
    int32_t r;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    int32_t r = easysimd_vaddvq_s32(a);
...
static int
test_easysimd_vaddvq_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int64_t a[8];
    int64_t r;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    int64_t r = easysimd_vaddvq_s64(a);
...
static int
test_easysimd_vaddvq_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint8_t a[16];
    uint8_t r;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    uint8_t r = easysimd_vaddvq_u8(a);
...
static int
test_easysimd_vaddvq_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint16_t a[8];
    uint16_t r;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    uint16_t r = easysimd_vaddvq_u16(a);
...
static int
test_easysimd_vaddvq_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint32_t a[4];
    uint32_t r;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    uint32_t r = easysimd_vaddvq_u32(a);
...
static int
test_easysimd_vaddvq_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint64_t a[8];
    uint64_t r;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    uint64_t r = easysimd_vaddvq_u64(a);
...
EASYSIMD_TEST_FUNC_LIST_ENTRY(vaddv_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vaddv_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vaddv_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vaddv_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vaddv_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vaddv_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vaddv_u32)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vaddvq_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vaddvq_f64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vaddvq_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vaddvq_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vaddvq_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vaddvq_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vaddvq_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vaddvq_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vaddvq_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vaddvq_u64)
