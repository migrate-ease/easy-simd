#define EASYSIMD_TEST_ARM_NEON_INSN and

#include "test-neon.h"
#include "../../../easysimd/arm/neon/and.h"

static int
test_easysimd_vand_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int8_t a[8];
    int8_t b[8];
    int8_t r[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int8x8_t r = easysimd_vand_s8(a, b);
...
static int
test_easysimd_vand_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int16_t a[4];
    int16_t b[4];
    int16_t r[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int16x4_t r = easysimd_vand_s16(a, b);
...
static int
test_easysimd_vand_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int32_t a[2];
    int32_t b[2];
    int32_t r[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x2_t r = easysimd_vand_s32(a, b);
...
static int
test_easysimd_vand_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int64_t a[1];
    int64_t b[1];
    int64_t r[1];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int64x1_t r = easysimd_vand_s64(a, b);
...
static int
test_easysimd_vand_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint8_t a[16];
    uint8_t b[16];
    uint8_t r[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x8_t r = easysimd_vand_u8(a, b);
...
static int
test_easysimd_vand_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint16_t a[4];
    uint16_t b[4];
    uint16_t r[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x4_t r = easysimd_vand_u16(a, b);
...
static int
test_easysimd_vand_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint32_t a[2];
    uint32_t b[2];
    uint32_t r[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x2_t r = easysimd_vand_u32(a, b);
...
static int
test_easysimd_vand_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint64_t a[1];
    uint64_t b[1];
    uint64_t r[1];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint64x1_t r = easysimd_vand_u64(a, b);
...
static int
test_easysimd_vandq_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int8_t a[16];
    int8_t b[16];
    int8_t r[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int8x16_t r = easysimd_vandq_s8(a, b);
...
static int
test_easysimd_vandq_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int16_t a[8];
    int16_t b[8];
    int16_t r[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int16x8_t r = easysimd_vandq_s16(a, b);
...
static int
test_easysimd_vandq_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int32_t a[4];
    int32_t b[4];
    int32_t r[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x4_t r = easysimd_vandq_s32(a, b);
...
static int
test_easysimd_vandq_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int64_t a[2];
    int64_t b[2];
    int64_t r[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int64x2_t r = easysimd_vandq_s64(a, b);
...
static int
test_easysimd_vandq_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint8_t a[16];
    uint8_t b[16];
    uint8_t r[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x16_t r = easysimd_vandq_u8(a, b);
...
static int
test_easysimd_vandq_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint16_t a[8];
    uint16_t b[8];
    uint16_t r[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x8_t r = easysimd_vandq_u16(a, b);
...
static int
test_easysimd_vandq_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint32_t a[4];
    uint32_t b[4];
    uint32_t r[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x4_t r = easysimd_vandq_u32(a, b);
...
static int
test_easysimd_vandq_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint64_t a[2];
    uint64_t b[2];
    uint64_t r[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint64x2_t r = easysimd_vandq_u64(a, b);
...
EASYSIMD_TEST_FUNC_LIST_ENTRY(vand_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vand_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vand_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vand_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vand_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vand_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vand_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vand_u64)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vandq_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vandq_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vandq_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vandq_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vandq_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vandq_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vandq_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vandq_u64)
