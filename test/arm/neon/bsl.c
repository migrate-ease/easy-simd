#define EASYSIMD_TEST_ARM_NEON_INSN bsl

#include "test-neon.h"
#include "../../../easysimd/arm/neon/bsl.h"

static int
test_easysimd_vbsl_f16 (EASYSIMD_MUNIT_TEST_ARGS) {
  #if 1
    struct {
      uint16_t a[4];
      easysimd_float16 b[4];
      easysimd_float16 c[4];
      easysimd_float16 r[4];
    } test_vec[] = {
      { { UINT16_C(62834), UINT16_C( 2915), UINT16_C(15044), UINT16_C(55669) },
      { EASYSIMD_FLOAT16_VALUE(   430.50), EASYSIMD_FLOAT16_VALUE(  -815.50), EASYSIMD_FLOAT16_VALUE(  -364.00), EASYSIMD_FLOAT16_VALUE(  -185.75) },
      { EASYSIMD_FLOAT16_VALUE(  -861.50), EASYSIMD_FLOAT16_VALUE(   384.50), EASYSIMD_FLOAT16_VALUE(   249.50), EASYSIMD_FLOAT16_VALUE(  -701.50) },
      { EASYSIMD_FLOAT16_VALUE(   107.69), EASYSIMD_FLOAT16_VALUE(   100.19), EASYSIMD_FLOAT16_VALUE(   177.00), EASYSIMD_FLOAT16_VALUE(-43456.00) } },
    { { UINT16_C(51556), UINT16_C(12796), UINT16_C(49577), UINT16_C(41056) },
      { EASYSIMD_FLOAT16_VALUE(  -689.50), EASYSIMD_FLOAT16_VALUE(  -776.00), EASYSIMD_FLOAT16_VALUE(   144.75), EASYSIMD_FLOAT16_VALUE(  -410.75) },
      { EASYSIMD_FLOAT16_VALUE(   129.50), EASYSIMD_FLOAT16_VALUE(  -774.50), EASYSIMD_FLOAT16_VALUE(   261.25), EASYSIMD_FLOAT16_VALUE(   222.25) },
      { EASYSIMD_FLOAT16_VALUE(   -43.25), EASYSIMD_FLOAT16_VALUE(  -776.50), EASYSIMD_FLOAT16_VALUE(   293.00), EASYSIMD_FLOAT16_VALUE(  -222.25) } },
    { { UINT16_C( 6398), UINT16_C(50024), UINT16_C(56659), UINT16_C(39836) },
      { EASYSIMD_FLOAT16_VALUE(   910.00), EASYSIMD_FLOAT16_VALUE(   941.00), EASYSIMD_FLOAT16_VALUE(  -945.00), EASYSIMD_FLOAT16_VALUE(  -951.50) },
      { EASYSIMD_FLOAT16_VALUE(   325.50), EASYSIMD_FLOAT16_VALUE(   304.50), EASYSIMD_FLOAT16_VALUE(  -653.00), EASYSIMD_FLOAT16_VALUE(  -645.50) },
      { EASYSIMD_FLOAT16_VALUE(     5.11), EASYSIMD_FLOAT16_VALUE(   498.50), EASYSIMD_FLOAT16_VALUE(  -677.00), EASYSIMD_FLOAT16_VALUE(  -903.50) } },
    { { UINT16_C(18704), UINT16_C(47545), UINT16_C( 6410), UINT16_C(57433) },
      { EASYSIMD_FLOAT16_VALUE(  -614.50), EASYSIMD_FLOAT16_VALUE(  -671.50), EASYSIMD_FLOAT16_VALUE(  -876.00), EASYSIMD_FLOAT16_VALUE(   515.00) },
      { EASYSIMD_FLOAT16_VALUE(  -446.00), EASYSIMD_FLOAT16_VALUE(   385.00), EASYSIMD_FLOAT16_VALUE(  -263.00), EASYSIMD_FLOAT16_VALUE(  -438.00) },
      { EASYSIMD_FLOAT16_VALUE(  -110.50), EASYSIMD_FLOAT16_VALUE( -1853.00), EASYSIMD_FLOAT16_VALUE(    -4.11),            EASYSIMD_NANHF } },
    { { UINT16_C(26238), UINT16_C(53664), UINT16_C(15427), UINT16_C(34924) },
      { EASYSIMD_FLOAT16_VALUE(  -877.00), EASYSIMD_FLOAT16_VALUE(  -613.50), EASYSIMD_FLOAT16_VALUE(   868.50), EASYSIMD_FLOAT16_VALUE(   448.50) },
      { EASYSIMD_FLOAT16_VALUE(   691.00), EASYSIMD_FLOAT16_VALUE(  -784.50), EASYSIMD_FLOAT16_VALUE(   803.00), EASYSIMD_FLOAT16_VALUE(   -89.88) },
      { EASYSIMD_FLOAT16_VALUE(   941.00), EASYSIMD_FLOAT16_VALUE(  -832.50), EASYSIMD_FLOAT16_VALUE(   802.50), EASYSIMD_FLOAT16_VALUE(   356.50) } },
    { { UINT16_C(22596), UINT16_C(20143), UINT16_C( 2161), UINT16_C(10030) },
      { EASYSIMD_FLOAT16_VALUE(   377.50), EASYSIMD_FLOAT16_VALUE(  -730.00), EASYSIMD_FLOAT16_VALUE(   624.00), EASYSIMD_FLOAT16_VALUE(   931.50) },
      { EASYSIMD_FLOAT16_VALUE(   655.50), EASYSIMD_FLOAT16_VALUE(  -638.50), EASYSIMD_FLOAT16_VALUE(  -506.50), EASYSIMD_FLOAT16_VALUE(   -63.97) },
      { EASYSIMD_FLOAT16_VALUE( 44000.00), EASYSIMD_FLOAT16_VALUE(  -634.00), EASYSIMD_FLOAT16_VALUE(  -126.62), EASYSIMD_FLOAT16_VALUE(-16056.00) } },
    { { UINT16_C(15150), UINT16_C(29075), UINT16_C(65400), UINT16_C(27641) },
      { EASYSIMD_FLOAT16_VALUE(  -255.00), EASYSIMD_FLOAT16_VALUE(  -855.00), EASYSIMD_FLOAT16_VALUE(   123.38), EASYSIMD_FLOAT16_VALUE(  -564.00) },
      { EASYSIMD_FLOAT16_VALUE(  -639.50), EASYSIMD_FLOAT16_VALUE(   -73.75), EASYSIMD_FLOAT16_VALUE(   346.25), EASYSIMD_FLOAT16_VALUE(   748.00) },
      { EASYSIMD_FLOAT16_VALUE(  -255.12), EASYSIMD_FLOAT16_VALUE( -1166.00), EASYSIMD_FLOAT16_VALUE(   115.06), EASYSIMD_FLOAT16_VALUE(   564.00) } },
    { { UINT16_C( 9849), UINT16_C(59957), UINT16_C(25647), UINT16_C( 3346) },
      { EASYSIMD_FLOAT16_VALUE(  -224.12), EASYSIMD_FLOAT16_VALUE(   947.00), EASYSIMD_FLOAT16_VALUE(   569.00), EASYSIMD_FLOAT16_VALUE(  -569.00) },
      { EASYSIMD_FLOAT16_VALUE(  -691.50), EASYSIMD_FLOAT16_VALUE(  -937.50), EASYSIMD_FLOAT16_VALUE(   367.25), EASYSIMD_FLOAT16_VALUE(  -145.50) },
      { EASYSIMD_FLOAT16_VALUE(    -3.51), EASYSIMD_FLOAT16_VALUE(   947.00), EASYSIMD_FLOAT16_VALUE( 46656.00), EASYSIMD_FLOAT16_VALUE(   -36.94) } }
    };

    for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
      easysimd_uint16x4_t a = easysimd_vld1_u16(test_vec[i].a);
      easysimd_float16x4_t b = easysimd_vld1_f16(test_vec[i].b);
      easysimd_float16x4_t c = easysimd_vld1_f16(test_vec[i].c);
      easysimd_float16x4_t r = easysimd_vbsl_f16(a, b, c);
    ...
    for (int i = 0 ; i < 8 ; i++) {
      ...
      easysimd_float16x4_t c = easysimd_test_arm_neon_random_f16x4(-1000.0f, 1000.0f);
      easysimd_float16x4_t r = easysimd_vbsl_f16(a, b, c);
      ...
      easysimd_test_arm_neon_write_f16x4(2, c, EASYSIMD_TEST_VEC_POS_MIDDLE);
...
static int
test_easysimd_vbsl_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint32_t a[2];
    ...
    { { UINT32_C(2674418426), UINT32_C(3777353220) },
      { EASYSIMD_FLOAT32_C(   405.65), EASYSIMD_FLOAT32_C(   927.47) },
      { EASYSIMD_FLOAT32_C(   560.08), EASYSIMD_FLOAT32_C(   314.53) },
      { EASYSIMD_FLOAT32_C(   204.28), EASYSIMD_FLOAT32_C(    94.92) } },
    { { UINT32_C(2013377052), UINT32_C(3455611233) },
      { EASYSIMD_FLOAT32_C(  -536.59), EASYSIMD_FLOAT32_C(   460.49) },
      { EASYSIMD_FLOAT32_C(   342.29), EASYSIMD_FLOAT32_C(   371.78) },
      { EASYSIMD_FLOAT32_C(   340.29), EASYSIMD_FLOAT32_C(   451.40) } },
    { { UINT32_C(3025790568), UINT32_C(2349671826) },
      { EASYSIMD_FLOAT32_C(   788.79), EASYSIMD_FLOAT32_C(  -926.62) },
      { EASYSIMD_FLOAT32_C(  -581.67), EASYSIMD_FLOAT32_C(   594.40) },
      { EASYSIMD_FLOAT32_C(   772.66), EASYSIMD_FLOAT32_C(  -598.96) } },
    { { UINT32_C(3060552012), UINT32_C(4153264603) },
      { EASYSIMD_FLOAT32_C(  -460.00), EASYSIMD_FLOAT32_C(  -480.26) },
      { EASYSIMD_FLOAT32_C(  -404.52), EASYSIMD_FLOAT32_C(   864.59) },
      { EASYSIMD_FLOAT32_C(  -460.02), EASYSIMD_FLOAT32_C(  -416.29) } },
    { { UINT32_C(1772709632), UINT32_C(1083407319) },
      { EASYSIMD_FLOAT32_C(  -513.91), EASYSIMD_FLOAT32_C(  -140.44) },
      { EASYSIMD_FLOAT32_C(   -53.49), EASYSIMD_FLOAT32_C(   -77.23) },
      { EASYSIMD_FLOAT32_C(   -53.24), EASYSIMD_FLOAT32_C(   -34.11) } },
    { { UINT32_C(2558525713), UINT32_C(3273960567) },
      { EASYSIMD_FLOAT32_C(  -353.14), EASYSIMD_FLOAT32_C(  -890.91) },
      { EASYSIMD_FLOAT32_C(   522.94), EASYSIMD_FLOAT32_C(   387.01) },
      { EASYSIMD_FLOAT32_C( -1045.91), EASYSIMD_FLOAT32_C(    -6.18) } },
    { { UINT32_C(3587114586), UINT32_C(2494709396) },
      { EASYSIMD_FLOAT32_C(  -250.58), EASYSIMD_FLOAT32_C(   789.87) },
      { EASYSIMD_FLOAT32_C(  -999.31), EASYSIMD_FLOAT32_C(   725.63) },
      { EASYSIMD_FLOAT32_C(   -15.68), EASYSIMD_FLOAT32_C(   533.86) } },
    { { UINT32_C( 951947479), UINT32_C(2368516476) },
      { EASYSIMD_FLOAT32_C(  -889.18), EASYSIMD_FLOAT32_C(   581.78) },
      { EASYSIMD_FLOAT32_C(   860.56), EASYSIMD_FLOAT32_C(   106.82) },
      { EASYSIMD_FLOAT32_C(   888.55), EASYSIMD_FLOAT32_C( 26777.97) } },
  };
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_float32x2_t r = easysimd_vbsl_f32(a, b, c);
...
static int
test_easysimd_vbsl_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint64_t a[1];
    ...
    { { UINT64_C(11051150815757923623) },
      { EASYSIMD_FLOAT64_C(  -588.66) },
      { EASYSIMD_FLOAT64_C(  -849.95) },
      { EASYSIMD_FLOAT64_C(  -577.69) } },
    { { UINT64_C( 3459855493406248467) },
      { EASYSIMD_FLOAT64_C(  -254.41) },
      { EASYSIMD_FLOAT64_C(  -342.68) },
      { EASYSIMD_FLOAT64_C(  -380.68) } },
    { { UINT64_C( 8499033952931220346) },
      { EASYSIMD_FLOAT64_C(   598.37) },
      { EASYSIMD_FLOAT64_C(  -678.68) },
      { EASYSIMD_FLOAT64_C(  -758.93) } },
    { { UINT64_C( 4453775121523365047) },
      { EASYSIMD_FLOAT64_C(  -983.29) },
      { EASYSIMD_FLOAT64_C(  -133.31) },
      { EASYSIMD_FLOAT64_C( -3932.65) } },
    { { UINT64_C( 2741489458384578945) },
      { EASYSIMD_FLOAT64_C(  -672.98) },
      { EASYSIMD_FLOAT64_C(  -225.94) },
      { EASYSIMD_FLOAT64_C(  -168.19) } },
    { { UINT64_C(  649913727035663599) },
      { EASYSIMD_FLOAT64_C(   665.07) },
      { EASYSIMD_FLOAT64_C(  -836.34) },
      { EASYSIMD_FLOAT64_C(  -984.34) } },
    { { UINT64_C( 3156572937688261107) },
      { EASYSIMD_FLOAT64_C(  -862.48) },
      { EASYSIMD_FLOAT64_C(   875.24) },
      { EASYSIMD_FLOAT64_C(   879.50) } },
    { { UINT64_C( 6490021655321781721) },
      { EASYSIMD_FLOAT64_C(  -306.99) },
      { EASYSIMD_FLOAT64_C(   894.38) },
      { EASYSIMD_FLOAT64_C(  1784.82) } },
  };
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_float64x1_t r = easysimd_vbsl_f64(a, b, c);
...
static int
test_easysimd_vbsl_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint8_t a[8];
    int8_t b[8];
    int8_t c[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int8x8_t r = easysimd_vbsl_s8(a, b, c);
...
static int
test_easysimd_vbsl_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint16_t a[4];
    int16_t b[4];
    int16_t c[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int16x4_t r = easysimd_vbsl_s16(a, b, c);
...
static int
test_easysimd_vbsl_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint32_t a[2];
    int32_t b[2];
    int32_t c[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x2_t r = easysimd_vbsl_s32(a, b, c);
...
static int
test_easysimd_vbsl_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint64_t a[1];
    int64_t b[1];
    int64_t c[1];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int64x1_t r = easysimd_vbsl_s64(a, b, c);
...
static int
test_easysimd_vbsl_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint8_t a[8];
    uint8_t b[8];
    uint8_t c[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x8_t r = easysimd_vbsl_u8(a, b, c);
...
static int
test_easysimd_vbsl_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint16_t a[4];
    uint16_t b[4];
    uint16_t c[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x4_t r = easysimd_vbsl_u16(a, b, c);
...
static int
test_easysimd_vbsl_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint32_t a[2];
    uint32_t b[2];
    uint32_t c[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x2_t r = easysimd_vbsl_u32(a, b, c);
...
static int
test_easysimd_vbsl_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint64_t a[1];
    uint64_t b[1];
    uint64_t c[1];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint64x1_t r = easysimd_vbsl_u64(a, b, c);
...
static int
test_easysimd_vbslq_f16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint16_t a[8];
    easysimd_float16 b[8];
    easysimd_float16 c[8];
    ...
    { { UINT16_C(37688), UINT16_C(35401), UINT16_C(27742), UINT16_C(58401), UINT16_C(50272), UINT16_C(49953), UINT16_C(15249), UINT16_C(43869) },
      { EASYSIMD_FLOAT16_VALUE(  -660.00), EASYSIMD_FLOAT16_VALUE(  -281.00), EASYSIMD_FLOAT16_VALUE(  -589.00), EASYSIMD_FLOAT16_VALUE(  -492.25),
        EASYSIMD_FLOAT16_VALUE(   484.00), EASYSIMD_FLOAT16_VALUE(   115.50), EASYSIMD_FLOAT16_VALUE(    18.55), EASYSIMD_FLOAT16_VALUE(  -919.50) },
      { EASYSIMD_FLOAT16_VALUE(   971.00), EASYSIMD_FLOAT16_VALUE(   210.25), EASYSIMD_FLOAT16_VALUE(   343.25), EASYSIMD_FLOAT16_VALUE(    28.61),
        EASYSIMD_FLOAT16_VALUE(  -981.50), EASYSIMD_FLOAT16_VALUE(    37.84), EASYSIMD_FLOAT16_VALUE(   972.00), EASYSIMD_FLOAT16_VALUE(   958.00) },
      { EASYSIMD_FLOAT16_VALUE(  -727.00), EASYSIMD_FLOAT16_VALUE(  -154.25), EASYSIMD_FLOAT16_VALUE( 10456.00), EASYSIMD_FLOAT16_VALUE(   -28.61),
        EASYSIMD_FLOAT16_VALUE(  1931.00), EASYSIMD_FLOAT16_VALUE(    61.81), EASYSIMD_FLOAT16_VALUE(     9.07), EASYSIMD_FLOAT16_VALUE(  -918.50) } },
    { { UINT16_C(27765), UINT16_C(54208), UINT16_C(57817), UINT16_C(14775), UINT16_C(55462), UINT16_C(14332), UINT16_C(23059), UINT16_C(57315) },
      { EASYSIMD_FLOAT16_VALUE(  -799.50), EASYSIMD_FLOAT16_VALUE(   964.50), EASYSIMD_FLOAT16_VALUE(  -361.25), EASYSIMD_FLOAT16_VALUE(   684.50),
        EASYSIMD_FLOAT16_VALUE(    80.12), EASYSIMD_FLOAT16_VALUE(   657.00), EASYSIMD_FLOAT16_VALUE(   764.50), EASYSIMD_FLOAT16_VALUE(    51.31) },
      { EASYSIMD_FLOAT16_VALUE(  -132.62), EASYSIMD_FLOAT16_VALUE(   108.00), EASYSIMD_FLOAT16_VALUE(  -920.00), EASYSIMD_FLOAT16_VALUE(  -114.00),
        EASYSIMD_FLOAT16_VALUE(  -854.00), EASYSIMD_FLOAT16_VALUE(  -948.00), EASYSIMD_FLOAT16_VALUE(  -156.00), EASYSIMD_FLOAT16_VALUE(  -337.50) },
      { EASYSIMD_FLOAT16_VALUE( -8616.00), EASYSIMD_FLOAT16_VALUE(     7.50), EASYSIMD_FLOAT16_VALUE(    -3.81), EASYSIMD_FLOAT16_VALUE( -1809.00),
        EASYSIMD_FLOAT16_VALUE( 12368.00), EASYSIMD_FLOAT16_VALUE(  -656.00), EASYSIMD_FLOAT16_VALUE(    -2.47), EASYSIMD_FLOAT16_VALUE(    51.19) } },
    { { UINT16_C(19268), UINT16_C( 7523), UINT16_C( 6701), UINT16_C(54103), UINT16_C(21490), UINT16_C( 1290), UINT16_C(60845), UINT16_C(22756) },
      { EASYSIMD_FLOAT16_VALUE(   546.50), EASYSIMD_FLOAT16_VALUE(   662.50), EASYSIMD_FLOAT16_VALUE(  -687.50), EASYSIMD_FLOAT16_VALUE(  -373.25),
        EASYSIMD_FLOAT16_VALUE(   319.75), EASYSIMD_FLOAT16_VALUE(  -923.00), EASYSIMD_FLOAT16_VALUE(   678.00), EASYSIMD_FLOAT16_VALUE(  -812.50) },
      { EASYSIMD_FLOAT16_VALUE(   185.00), EASYSIMD_FLOAT16_VALUE(   758.00), EASYSIMD_FLOAT16_VALUE(    73.25), EASYSIMD_FLOAT16_VALUE(   330.75),
        EASYSIMD_FLOAT16_VALUE(   810.50), EASYSIMD_FLOAT16_VALUE(   917.50), EASYSIMD_FLOAT16_VALUE(   993.50), EASYSIMD_FLOAT16_VALUE(   301.25) },
      { EASYSIMD_FLOAT16_VALUE(    38.38), EASYSIMD_FLOAT16_VALUE(   726.50), EASYSIMD_FLOAT16_VALUE(     4.61), EASYSIMD_FLOAT16_VALUE(  -351.25),
        EASYSIMD_FLOAT16_VALUE( 10168.00), EASYSIMD_FLOAT16_VALUE(   913.50), EASYSIMD_FLOAT16_VALUE(   935.00), EASYSIMD_FLOAT16_VALUE(     4.32) } },
    { { UINT16_C(39569), UINT16_C(48865), UINT16_C(14516), UINT16_C(42641), UINT16_C(40075), UINT16_C(14763), UINT16_C(36745), UINT16_C( 3217) },
      { EASYSIMD_FLOAT16_VALUE(   720.50), EASYSIMD_FLOAT16_VALUE(  -893.50), EASYSIMD_FLOAT16_VALUE(   726.50), EASYSIMD_FLOAT16_VALUE(    40.28),
        EASYSIMD_FLOAT16_VALUE(  -816.50), EASYSIMD_FLOAT16_VALUE(   404.75), EASYSIMD_FLOAT16_VALUE(   227.50), EASYSIMD_FLOAT16_VALUE(   368.25) },
      { EASYSIMD_FLOAT16_VALUE(   163.00), EASYSIMD_FLOAT16_VALUE(  -699.00), EASYSIMD_FLOAT16_VALUE(  -300.75), EASYSIMD_FLOAT16_VALUE(   -26.78),
        EASYSIMD_FLOAT16_VALUE(  -782.00), EASYSIMD_FLOAT16_VALUE(  -307.50), EASYSIMD_FLOAT16_VALUE(  -725.50), EASYSIMD_FLOAT16_VALUE(   478.25) },
      { EASYSIMD_FLOAT16_VALUE(     2.77), EASYSIMD_FLOAT16_VALUE( -1019.50), EASYSIMD_FLOAT16_VALUE( -1191.00), EASYSIMD_FLOAT16_VALUE(     8.27),
        EASYSIMD_FLOAT16_VALUE(  -778.50), EASYSIMD_FLOAT16_VALUE(  -273.75), EASYSIMD_FLOAT16_VALUE(  3668.00), EASYSIMD_FLOAT16_VALUE(   506.25) } },
    { { UINT16_C(26640), UINT16_C(50419), UINT16_C(33952), UINT16_C(11114), UINT16_C( 5408), UINT16_C(43620), UINT16_C(62885), UINT16_C(55222) },
      { EASYSIMD_FLOAT16_VALUE(   612.00), EASYSIMD_FLOAT16_VALUE(   866.50), EASYSIMD_FLOAT16_VALUE(  -682.00), EASYSIMD_FLOAT16_VALUE(   795.50),
        EASYSIMD_FLOAT16_VALUE(   271.25), EASYSIMD_FLOAT16_VALUE(   545.50), EASYSIMD_FLOAT16_VALUE(   163.75), EASYSIMD_FLOAT16_VALUE(  -566.00) },
      { EASYSIMD_FLOAT16_VALUE(   846.00), EASYSIMD_FLOAT16_VALUE(   863.00), EASYSIMD_FLOAT16_VALUE(   407.50), EASYSIMD_FLOAT16_VALUE(  -936.00),
        EASYSIMD_FLOAT16_VALUE(  -444.75), EASYSIMD_FLOAT16_VALUE(   682.00), EASYSIMD_FLOAT16_VALUE(   542.50), EASYSIMD_FLOAT16_VALUE(   842.00) },
      { EASYSIMD_FLOAT16_VALUE(   838.00), EASYSIMD_FLOAT16_VALUE(   870.50), EASYSIMD_FLOAT16_VALUE(  -203.75), EASYSIMD_FLOAT16_VALUE(  -793.00),
        EASYSIMD_FLOAT16_VALUE(  -444.75), EASYSIMD_FLOAT16_VALUE(   680.00), EASYSIMD_FLOAT16_VALUE(    40.88), EASYSIMD_FLOAT16_VALUE(  -530.00) } },
    { { UINT16_C(57334), UINT16_C(38623), UINT16_C(19043), UINT16_C(33986), UINT16_C( 9823), UINT16_C( 1070), UINT16_C(58396), UINT16_C(52187) },
      { EASYSIMD_FLOAT16_VALUE(   164.62), EASYSIMD_FLOAT16_VALUE(   284.50), EASYSIMD_FLOAT16_VALUE(  -327.00), EASYSIMD_FLOAT16_VALUE(  -564.00),
        EASYSIMD_FLOAT16_VALUE(  -170.12), EASYSIMD_FLOAT16_VALUE(   836.50), EASYSIMD_FLOAT16_VALUE(  -130.00), EASYSIMD_FLOAT16_VALUE(  -324.00) },
      { EASYSIMD_FLOAT16_VALUE(   699.50), EASYSIMD_FLOAT16_VALUE(  -722.50), EASYSIMD_FLOAT16_VALUE(  -259.75), EASYSIMD_FLOAT16_VALUE(  -745.00),
        EASYSIMD_FLOAT16_VALUE(   959.00), EASYSIMD_FLOAT16_VALUE(  -717.00), EASYSIMD_FLOAT16_VALUE(  -903.50), EASYSIMD_FLOAT16_VALUE(   656.00) },
      { EASYSIMD_FLOAT16_VALUE( 42144.00), EASYSIMD_FLOAT16_VALUE( 22304.00), EASYSIMD_FLOAT16_VALUE(  -259.00), EASYSIMD_FLOAT16_VALUE(  -680.00),
        EASYSIMD_FLOAT16_VALUE(     2.72), EASYSIMD_FLOAT16_VALUE(  -716.00), EASYSIMD_FLOAT16_VALUE(    -3.54), EASYSIMD_FLOAT16_VALUE( -2656.00) } },
    { { UINT16_C(30015), UINT16_C(41645), UINT16_C(28607), UINT16_C( 7718), UINT16_C(21653), UINT16_C(45347), UINT16_C(65081), UINT16_C(32637) },
      { EASYSIMD_FLOAT16_VALUE(   -32.66), EASYSIMD_FLOAT16_VALUE(   785.00), EASYSIMD_FLOAT16_VALUE(  -794.00), EASYSIMD_FLOAT16_VALUE(   797.00),
        EASYSIMD_FLOAT16_VALUE(   621.50), EASYSIMD_FLOAT16_VALUE(    75.69), EASYSIMD_FLOAT16_VALUE(  -526.50), EASYSIMD_FLOAT16_VALUE(   321.00) },
      { EASYSIMD_FLOAT16_VALUE(   353.00), EASYSIMD_FLOAT16_VALUE(   213.62), EASYSIMD_FLOAT16_VALUE(   576.00), EASYSIMD_FLOAT16_VALUE(   312.25),
        EASYSIMD_FLOAT16_VALUE(   496.50), EASYSIMD_FLOAT16_VALUE(   672.50), EASYSIMD_FLOAT16_VALUE(   -31.95), EASYSIMD_FLOAT16_VALUE(  -105.12) },
      { EASYSIMD_FLOAT16_VALUE(   146.62), EASYSIMD_FLOAT16_VALUE( 50176.00), EASYSIMD_FLOAT16_VALUE(   794.00), EASYSIMD_FLOAT16_VALUE(     3.44),
        EASYSIMD_FLOAT16_VALUE(    15.65), EASYSIMD_FLOAT16_VALUE(    35.09), EASYSIMD_FLOAT16_VALUE(  -750.50), EASYSIMD_FLOAT16_VALUE(  -353.50) } },
    { { UINT16_C(50389), UINT16_C(37897), UINT16_C(12083), UINT16_C(51635), UINT16_C(54916), UINT16_C(48506), UINT16_C(63444), UINT16_C(49980) },
      { EASYSIMD_FLOAT16_VALUE(   434.25), EASYSIMD_FLOAT16_VALUE(   -38.09), EASYSIMD_FLOAT16_VALUE(    23.38), EASYSIMD_FLOAT16_VALUE(    55.78),
        EASYSIMD_FLOAT16_VALUE(  -962.50), EASYSIMD_FLOAT16_VALUE(   496.75), EASYSIMD_FLOAT16_VALUE(  -623.00), EASYSIMD_FLOAT16_VALUE(   390.50) },
      { EASYSIMD_FLOAT16_VALUE(  -289.75), EASYSIMD_FLOAT16_VALUE(   953.00), EASYSIMD_FLOAT16_VALUE(  -297.25), EASYSIMD_FLOAT16_VALUE(  -793.50),
        EASYSIMD_FLOAT16_VALUE(   625.50), EASYSIMD_FLOAT16_VALUE(   671.00), EASYSIMD_FLOAT16_VALUE(   101.56), EASYSIMD_FLOAT16_VALUE(   561.50) },
      { EASYSIMD_FLOAT16_VALUE(   304.75), EASYSIMD_FLOAT16_VALUE(-15256.00), EASYSIMD_FLOAT16_VALUE(  -357.00), EASYSIMD_FLOAT16_VALUE(   856.50),
        EASYSIMD_FLOAT16_VALUE(  -883.50), EASYSIMD_FLOAT16_VALUE(   337.50), EASYSIMD_FLOAT16_VALUE(  -622.50), EASYSIMD_FLOAT16_VALUE(   813.50) } }
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint16x8_t a = easysimd_vld1q_u16(test_vec[i].a);
    easysimd_float16x8_t b = easysimd_vld1q_f16(test_vec[i].b);
    easysimd_float16x8_t c = easysimd_vld1q_f16(test_vec[i].c);
    easysimd_float16x8_t r = easysimd_vbslq_f16(a, b, c);
...
static int
test_easysimd_vbslq_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint32_t a[4];
    ...
    { { UINT32_C(2050512422), UINT32_C(1891785275), UINT32_C(3601774981), UINT32_C( 108127079) },
      { EASYSIMD_FLOAT32_C(   726.27), EASYSIMD_FLOAT32_C(  -285.01), EASYSIMD_FLOAT32_C(   100.31), EASYSIMD_FLOAT32_C(  -361.34) },
      { EASYSIMD_FLOAT32_C(   922.89), EASYSIMD_FLOAT32_C(   266.21), EASYSIMD_FLOAT32_C(   203.26), EASYSIMD_FLOAT32_C(   423.67) },
      { EASYSIMD_FLOAT32_C(   986.89), EASYSIMD_FLOAT32_C(   270.01), EASYSIMD_FLOAT32_C(   403.71), EASYSIMD_FLOAT32_C(   357.43) } },
    { { UINT32_C(3614509257), UINT32_C( 280160490), UINT32_C(2039147070), UINT32_C(3404352837) },
      { EASYSIMD_FLOAT32_C(   -48.71), EASYSIMD_FLOAT32_C(   -96.93), EASYSIMD_FLOAT32_C(   765.30), EASYSIMD_FLOAT32_C(  -365.42) },
      { EASYSIMD_FLOAT32_C(    51.72), EASYSIMD_FLOAT32_C(   310.81), EASYSIMD_FLOAT32_C(   707.75), EASYSIMD_FLOAT32_C(  -222.02) },
      { EASYSIMD_FLOAT32_C(   -51.72), EASYSIMD_FLOAT32_C(   275.62), EASYSIMD_FLOAT32_C(   745.28), EASYSIMD_FLOAT32_C(  -364.04) } },
    { { UINT32_C(1311624492), UINT32_C(2429832391), UINT32_C(1046955348), UINT32_C(1800345901) },
      { EASYSIMD_FLOAT32_C(   173.43), EASYSIMD_FLOAT32_C(   396.70), EASYSIMD_FLOAT32_C(  -158.88), EASYSIMD_FLOAT32_C(   270.13) },
      { EASYSIMD_FLOAT32_C(   511.35), EASYSIMD_FLOAT32_C(  -236.38), EASYSIMD_FLOAT32_C(  -423.74), EASYSIMD_FLOAT32_C(  -537.35) },
      { EASYSIMD_FLOAT32_C(   510.85), EASYSIMD_FLOAT32_C(   472.82), EASYSIMD_FLOAT32_C(  -301.72), EASYSIMD_FLOAT32_C(-34646.40) } },
    { { UINT32_C(3818566759), UINT32_C(4063432390), UINT32_C(2722128091), UINT32_C(   3347628) },
      { EASYSIMD_FLOAT32_C(   968.99), EASYSIMD_FLOAT32_C(   614.68), EASYSIMD_FLOAT32_C(  -913.19), EASYSIMD_FLOAT32_C(   634.92) },
      { EASYSIMD_FLOAT32_C(   -20.17), EASYSIMD_FLOAT32_C(  -778.48), EASYSIMD_FLOAT32_C(   528.43), EASYSIMD_FLOAT32_C(  -846.74) },
      { EASYSIMD_FLOAT32_C(     2.80), EASYSIMD_FLOAT32_C(   838.42), EASYSIMD_FLOAT32_C(  -785.42), EASYSIMD_FLOAT32_C(  -842.94) } },
    { { UINT32_C(2382485607), UINT32_C( 247141543), UINT32_C(2415023561), UINT32_C(1065493860) },
      { EASYSIMD_FLOAT32_C(   927.69), EASYSIMD_FLOAT32_C(   298.66), EASYSIMD_FLOAT32_C(  -205.27), EASYSIMD_FLOAT32_C(   460.63) },
      { EASYSIMD_FLOAT32_C(  -702.09), EASYSIMD_FLOAT32_C(  -280.47), EASYSIMD_FLOAT32_C(   122.07), EASYSIMD_FLOAT32_C(  -733.10) },
      { EASYSIMD_FLOAT32_C(   703.21), EASYSIMD_FLOAT32_C(  -298.47), EASYSIMD_FLOAT32_C(  -196.40), EASYSIMD_FLOAT32_C(  -366.52) } },
    { { UINT32_C(1673032367), UINT32_C(1729866496), UINT32_C( 720706691), UINT32_C(4198084657) },
      { EASYSIMD_FLOAT32_C(  -540.17), EASYSIMD_FLOAT32_C(   251.09), EASYSIMD_FLOAT32_C(   225.13), EASYSIMD_FLOAT32_C(   954.24) },
      { EASYSIMD_FLOAT32_C(  -734.26), EASYSIMD_FLOAT32_C(  -103.09), EASYSIMD_FLOAT32_C(    61.68), EASYSIMD_FLOAT32_C(  -806.57) },
      { EASYSIMD_FLOAT32_C(  -542.04), EASYSIMD_FLOAT32_C(  -446.06), EASYSIMD_FLOAT32_C(    56.91), EASYSIMD_FLOAT32_C(   930.07) } },
    { { UINT32_C(2768866254), UINT32_C(1356217504), UINT32_C(2931003054), UINT32_C(3172323130) },
      { EASYSIMD_FLOAT32_C(  -417.88), EASYSIMD_FLOAT32_C(  -357.81), EASYSIMD_FLOAT32_C(  -174.77), EASYSIMD_FLOAT32_C(   472.44) },
      { EASYSIMD_FLOAT32_C(  -587.42), EASYSIMD_FLOAT32_C(  -441.94), EASYSIMD_FLOAT32_C(  -296.02), EASYSIMD_FLOAT32_C(  -127.59) },
      { EASYSIMD_FLOAT32_C(    -9.18), EASYSIMD_FLOAT32_C(  -309.79), EASYSIMD_FLOAT32_C(  -166.52), EASYSIMD_FLOAT32_C(   476.31) } },
    { { UINT32_C(2620104780), UINT32_C(2037634475), UINT32_C(  18775136), UINT32_C(1716647096) },
      { EASYSIMD_FLOAT32_C(   -62.34), EASYSIMD_FLOAT32_C(   454.95), EASYSIMD_FLOAT32_C(  -901.11), EASYSIMD_FLOAT32_C(    30.12) },
      { EASYSIMD_FLOAT32_C(   146.40), EASYSIMD_FLOAT32_C(  -437.09), EASYSIMD_FLOAT32_C(   -77.62), EASYSIMD_FLOAT32_C(   728.52) },
      { EASYSIMD_FLOAT32_C(  -185.27), EASYSIMD_FLOAT32_C(  -470.72), EASYSIMD_FLOAT32_C(   -64.63), EASYSIMD_FLOAT32_C(     3.86) } },
  };
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_float32x4_t r = easysimd_vbslq_f32(a, b, c);
...
static int
test_easysimd_vbslq_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint64_t a[2];
    ...
    { { UINT64_C(13764238683935597897), UINT64_C(16898862026458326254) },
      { EASYSIMD_FLOAT64_C(  -774.89), EASYSIMD_FLOAT64_C(  -747.47) },
      { EASYSIMD_FLOAT64_C(  -332.23), EASYSIMD_FLOAT64_C(   521.67) },
      { EASYSIMD_FLOAT64_C(  -266.47), EASYSIMD_FLOAT64_C(  -651.66) } },
    { { UINT64_C(13223275955338830799), UINT64_C( 7046989072648393554) },
      { EASYSIMD_FLOAT64_C(   994.41), EASYSIMD_FLOAT64_C(   822.45) },
      { EASYSIMD_FLOAT64_C(  -294.88), EASYSIMD_FLOAT64_C(  -105.01) },
      { EASYSIMD_FLOAT64_C( 75509.48), EASYSIMD_FLOAT64_C( -1640.90) } },
    { { UINT64_C(11175800480316490419), UINT64_C( 9412372685746910188) },
      { EASYSIMD_FLOAT64_C(   757.22), EASYSIMD_FLOAT64_C(  -233.80) },
      { EASYSIMD_FLOAT64_C(   -54.26), EASYSIMD_FLOAT64_C(   966.12) },
      { EASYSIMD_FLOAT64_C(    38.32), EASYSIMD_FLOAT64_C(    -3.65) } },
    { { UINT64_C(13983593746892684661), UINT64_C(  316639219210923907) },
      { EASYSIMD_FLOAT64_C(  -380.48), EASYSIMD_FLOAT64_C(   397.51) },
      { EASYSIMD_FLOAT64_C(   -87.86), EASYSIMD_FLOAT64_C(   -48.58) },
      { EASYSIMD_FLOAT64_C(   -95.11), EASYSIMD_FLOAT64_C(  -198.32) } },
    { { UINT64_C(11225398681450588207), UINT64_C(16926446589552624066) },
      { EASYSIMD_FLOAT64_C(   635.25), EASYSIMD_FLOAT64_C(   381.12) },
      { EASYSIMD_FLOAT64_C(  -832.41), EASYSIMD_FLOAT64_C(  -124.32) },
      { EASYSIMD_FLOAT64_C(   592.41), EASYSIMD_FLOAT64_C(   509.34) } },
    { { UINT64_C(18076222544372871973), UINT64_C( 4870150017706326817) },
      { EASYSIMD_FLOAT64_C(  -197.71), EASYSIMD_FLOAT64_C(  -523.67) },
      { EASYSIMD_FLOAT64_C(   628.41), EASYSIMD_FLOAT64_C(   -93.61) },
      { EASYSIMD_FLOAT64_C(   -49.31), EASYSIMD_FLOAT64_C( -8890.06) } },
    { { UINT64_C( 2218233479757940575), UINT64_C(14533229422664185268) },
      { EASYSIMD_FLOAT64_C(   537.41), EASYSIMD_FLOAT64_C(   -64.67) },
      { EASYSIMD_FLOAT64_C(  -883.30), EASYSIMD_FLOAT64_C(  -802.50) },
      { EASYSIMD_FLOAT64_C(  -625.43), EASYSIMD_FLOAT64_C(    -6.30) } },
    { { UINT64_C( 2444631349764358662), UINT64_C( 3147906818953694066) },
      { EASYSIMD_FLOAT64_C(   483.18), EASYSIMD_FLOAT64_C(   409.15) },
      { EASYSIMD_FLOAT64_C(  -524.40), EASYSIMD_FLOAT64_C(   755.41) },
      { EASYSIMD_FLOAT64_C(  -227.58), EASYSIMD_FLOAT64_C(    12.79) } },
  };
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_float64x2_t r = easysimd_vbslq_f64(a, b, c);
...
static int
test_easysimd_vbslq_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint8_t a[16];
    int8_t b[16];
    int8_t c[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int8x16_t r = easysimd_vbslq_s8(a, b, c);
...
static int
test_easysimd_vbslq_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint16_t a[8];
    int16_t b[8];
    int16_t c[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int16x8_t r = easysimd_vbslq_s16(a, b, c);
...
static int
test_easysimd_vbslq_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint32_t a[4];
    int32_t b[4];
    int32_t c[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x4_t r = easysimd_vbslq_s32(a, b, c);
...
static int
test_easysimd_vbslq_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint64_t a[2];
    int64_t b[2];
    int64_t c[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int64x2_t r = easysimd_vbslq_s64(a, b, c);
...
static int
test_easysimd_vbslq_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint8_t a[16];
    uint8_t b[16];
    uint8_t c[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x16_t r = easysimd_vbslq_u8(a, b, c);
...
static int
test_easysimd_vbslq_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint16_t a[8];
    uint16_t b[8];
    uint16_t c[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x8_t r = easysimd_vbslq_u16(a, b, c);
...
static int
test_easysimd_vbslq_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint32_t a[4];
    uint32_t b[4];
    uint32_t c[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x4_t r = easysimd_vbslq_u32(a, b, c);
...
static int
test_easysimd_vbslq_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint64_t a[2];
    uint64_t b[2];
    uint64_t c[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint64x2_t r = easysimd_vbslq_u64(a, b, c);
...
EASYSIMD_TEST_FUNC_LIST_ENTRY(vbsl_f16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vbsl_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vbsl_f64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vbsl_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vbsl_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vbsl_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vbsl_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vbsl_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vbsl_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vbsl_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vbsl_u64)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vbslq_f16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vbslq_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vbslq_f64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vbslq_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vbslq_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vbslq_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vbslq_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vbslq_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vbslq_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vbslq_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vbslq_u64)
