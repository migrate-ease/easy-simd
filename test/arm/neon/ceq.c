#define EASYSIMD_TEST_ARM_NEON_INSN ceq

#include "test-neon.h"
#include "../../../easysimd/arm/neon/ceq.h"

static int
test_easysimd_vceqs_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    easysimd_float32 a;
    easysimd_float32 b;
    ...
    {            EASYSIMD_MATH_NANF,
      EASYSIMD_FLOAT32_C(     3.14),
                               0 },
    { EASYSIMD_FLOAT32_C(     1.62),
                 EASYSIMD_MATH_NANF,
                               0 },
    {            EASYSIMD_MATH_NANF,
                 EASYSIMD_MATH_NANF,
    ...
    { EASYSIMD_FLOAT32_C(   -56.05),
      EASYSIMD_FLOAT32_C(   -39.63),
      UINT32_C(         0) },
    { EASYSIMD_FLOAT32_C(   841.90),
      EASYSIMD_FLOAT32_C(   841.90),
                UINT32_MAX },
    { EASYSIMD_FLOAT32_C(  -705.13),
      EASYSIMD_FLOAT32_C(  -696.24),
      UINT32_C(         0) },
    { EASYSIMD_FLOAT32_C(   -60.94),
      EASYSIMD_FLOAT32_C(   -60.94),
                UINT32_MAX },
    { EASYSIMD_FLOAT32_C(   769.23),
      EASYSIMD_FLOAT32_C(  -998.79),
      UINT32_C(         0) },
    { EASYSIMD_FLOAT32_C(   -11.03),
      EASYSIMD_FLOAT32_C(   -11.03),
                UINT32_MAX },
    { EASYSIMD_FLOAT32_C(   173.25),
      EASYSIMD_FLOAT32_C(   724.98),
      UINT32_C(         0) },
    { EASYSIMD_FLOAT32_C(   709.16),
      EASYSIMD_FLOAT32_C(   709.16),
                UINT32_MAX }
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    uint32_t r = easysimd_vceqs_f32(test_vec[i].a, test_vec[i].b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_float32_t b = (i & 1) ? a : easysimd_test_codegen_random_f32(-1000.0f, 1000.0f);
    uint32_t r = easysimd_vceqs_f32(a, b);
...
static int
test_easysimd_vceqd_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    easysimd_float64 a;
    easysimd_float64 b;
    ...
    #if !defined(EASYSIMD_FAST_NANS)
    {             EASYSIMD_MATH_NAN,
      EASYSIMD_FLOAT64_C(     3.14),
                               0 },
    { EASYSIMD_FLOAT64_C(     1.62),
                  EASYSIMD_MATH_NAN,
                               0 },
    {             EASYSIMD_MATH_NAN,
                  EASYSIMD_MATH_NAN,
    ...
    { EASYSIMD_FLOAT64_C(  -577.65),
      EASYSIMD_FLOAT64_C(  -703.85),
      UINT64_C(                   0) },
    { EASYSIMD_FLOAT64_C(   325.12),
      EASYSIMD_FLOAT64_C(   325.12),
                         UINT64_MAX },
    { EASYSIMD_FLOAT64_C(  -527.91),
      EASYSIMD_FLOAT64_C(  -305.80),
      UINT64_C(                   0) },
    { EASYSIMD_FLOAT64_C(  -646.92),
      EASYSIMD_FLOAT64_C(  -646.92),
                         UINT64_MAX },
    { EASYSIMD_FLOAT64_C(   438.65),
      EASYSIMD_FLOAT64_C(  -673.26),
      UINT64_C(                   0) },
    { EASYSIMD_FLOAT64_C(  -155.60),
      EASYSIMD_FLOAT64_C(  -155.60),
                         UINT64_MAX },
    { EASYSIMD_FLOAT64_C(  -252.03),
      EASYSIMD_FLOAT64_C(  -719.74),
      UINT64_C(                   0) },
    { EASYSIMD_FLOAT64_C(     6.27),
      EASYSIMD_FLOAT64_C(     6.27),
                         UINT64_MAX },
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    uint64_t r = easysimd_vceqd_f64(test_vec[i].a, test_vec[i].b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_float64_t b = (i & 1) ? a : easysimd_test_codegen_random_f64(-1000.0, 1000.0);
    uint64_t r = easysimd_vceqd_f64(a, b);
...
static int
test_easysimd_vceqd_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int64_t a;
    int64_t b;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    uint64_t r = easysimd_vceqd_s64(test_vec[i].a, test_vec[i].b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    int64_t b = (i & 1) ? a : easysimd_test_codegen_random_i64();
    uint64_t r = easysimd_vceqd_s64(a, b);
...
static int
test_easysimd_vceqd_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint64_t a;
    uint64_t b;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    uint64_t r = easysimd_vceqd_u64(test_vec[i].a, test_vec[i].b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    uint64_t b = (i & 1) ? a : easysimd_test_codegen_random_u64();
    uint64_t r = easysimd_vceqd_u64(a, b);
...
static int
test_easysimd_vceq_f16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  struct {
    ...
    { { EASYSIMD_FLOAT16_VALUE(  -304.25), EASYSIMD_FLOAT16_VALUE(  -310.25), EASYSIMD_FLOAT16_VALUE(  -816.50), EASYSIMD_FLOAT16_VALUE(  -947.50) },
      { EASYSIMD_FLOAT16_VALUE(  -304.25), EASYSIMD_FLOAT16_VALUE(  -310.25), EASYSIMD_FLOAT16_VALUE(  -446.25), EASYSIMD_FLOAT16_VALUE(  -947.50) },
      {      UINT16_MAX,      UINT16_MAX, UINT16_C(    0),      UINT16_MAX } },
    { { EASYSIMD_FLOAT16_VALUE(   271.50), EASYSIMD_FLOAT16_VALUE(  -723.50), EASYSIMD_FLOAT16_VALUE(   595.00), EASYSIMD_FLOAT16_VALUE(   684.00) },
      { EASYSIMD_FLOAT16_VALUE(   271.50), EASYSIMD_FLOAT16_VALUE(  -723.50), EASYSIMD_FLOAT16_VALUE(  -921.50), EASYSIMD_FLOAT16_VALUE(   684.00) },
      {      UINT16_MAX,      UINT16_MAX, UINT16_C(    0),      UINT16_MAX } },
    { { EASYSIMD_FLOAT16_VALUE(   -22.67), EASYSIMD_FLOAT16_VALUE(  -950.50), EASYSIMD_FLOAT16_VALUE(  -523.50), EASYSIMD_FLOAT16_VALUE(   976.00) },
      { EASYSIMD_FLOAT16_VALUE(   791.00), EASYSIMD_FLOAT16_VALUE(   509.50), EASYSIMD_FLOAT16_VALUE(  -974.50), EASYSIMD_FLOAT16_VALUE(   976.00) },
      { UINT16_C(    0), UINT16_C(    0), UINT16_C(    0),      UINT16_MAX } },
    { { EASYSIMD_FLOAT16_VALUE(   251.00), EASYSIMD_FLOAT16_VALUE(  -497.25), EASYSIMD_FLOAT16_VALUE(  -357.25), EASYSIMD_FLOAT16_VALUE(   809.50) },
      { EASYSIMD_FLOAT16_VALUE(   251.00), EASYSIMD_FLOAT16_VALUE(  -594.50), EASYSIMD_FLOAT16_VALUE(   126.00), EASYSIMD_FLOAT16_VALUE(   809.50) },
      {      UINT16_MAX, UINT16_C(    0), UINT16_C(    0),      UINT16_MAX } },
    { { EASYSIMD_FLOAT16_VALUE(    -2.75), EASYSIMD_FLOAT16_VALUE(   669.50), EASYSIMD_FLOAT16_VALUE(   425.75), EASYSIMD_FLOAT16_VALUE(  -866.50) },
      { EASYSIMD_FLOAT16_VALUE(  -554.00), EASYSIMD_FLOAT16_VALUE(   669.50), EASYSIMD_FLOAT16_VALUE(   425.75), EASYSIMD_FLOAT16_VALUE(   423.50) },
      { UINT16_C(    0),      UINT16_MAX,      UINT16_MAX, UINT16_C(    0) } },
    { { EASYSIMD_FLOAT16_VALUE(   411.75), EASYSIMD_FLOAT16_VALUE(  -339.50), EASYSIMD_FLOAT16_VALUE(   896.00), EASYSIMD_FLOAT16_VALUE(   768.50) },
      { EASYSIMD_FLOAT16_VALUE(  -130.50), EASYSIMD_FLOAT16_VALUE(   435.00), EASYSIMD_FLOAT16_VALUE(   896.00), EASYSIMD_FLOAT16_VALUE(   768.50) },
      { UINT16_C(    0), UINT16_C(    0),      UINT16_MAX,      UINT16_MAX } },
    { { EASYSIMD_FLOAT16_VALUE(   -55.66), EASYSIMD_FLOAT16_VALUE(  -630.50), EASYSIMD_FLOAT16_VALUE(  -780.00), EASYSIMD_FLOAT16_VALUE(   946.50) },
      { EASYSIMD_FLOAT16_VALUE(   511.25), EASYSIMD_FLOAT16_VALUE(  -630.50), EASYSIMD_FLOAT16_VALUE(  -780.00), EASYSIMD_FLOAT16_VALUE(  -491.50) },
      { UINT16_C(    0),      UINT16_MAX,      UINT16_MAX, UINT16_C(    0) } },
    { { EASYSIMD_FLOAT16_VALUE(   847.50), EASYSIMD_FLOAT16_VALUE(  -675.50), EASYSIMD_FLOAT16_VALUE(   689.50), EASYSIMD_FLOAT16_VALUE(   381.75) },
      { EASYSIMD_FLOAT16_VALUE(   970.00), EASYSIMD_FLOAT16_VALUE(  -675.50), EASYSIMD_FLOAT16_VALUE(    76.06), EASYSIMD_FLOAT16_VALUE(   381.75) },
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x4_t r = easysimd_vceq_f16(a, b);
  ...
  fputc('\n', stdout);
  for (int i = 0 ; i < 8 ; i++) {
    easysimd_float16 a_[4], b_[4];
    easysimd_test_codegen_random_vf16(sizeof(a_) / sizeof(a_[0]), a_, -1000.0, 1000.0);
    easysimd_test_codegen_random_vf16(sizeof(b_) / sizeof(b_[0]), b_, -1000.0, 1000.0);
    for (size_t j = 0 ; j < (sizeof(a_) / sizeof(a_[0])) ; j++) {
      if (easysimd_test_codegen_random_i8() & 1) {
        a_[j] = b_[j];
      }
    }
    easysimd_uint16x4_t r = easysimd_vceq_f16(easysimd_vld1_f16(a_), easysimd_vld1_f16(b_));

    easysimd_test_codegen_write_vf16(2, sizeof(a_) / sizeof(a_[0]), a_, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_codegen_write_vf16(2, sizeof(b_) / sizeof(b_[0]), b_, EASYSIMD_TEST_VEC_POS_MIDDLE);
...
static int
test_easysimd_vceq_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    ...
    { { EASYSIMD_FLOAT32_C(    83.80), EASYSIMD_FLOAT32_C(   475.91) },
      { EASYSIMD_FLOAT32_C(    83.80), EASYSIMD_FLOAT32_C(   475.91) },
      {           UINT32_MAX,           UINT32_MAX } },
    { { EASYSIMD_FLOAT32_C(   315.96), EASYSIMD_FLOAT32_C(    49.13) },
      { EASYSIMD_FLOAT32_C(   315.96), EASYSIMD_FLOAT32_C(    49.13) },
      {           UINT32_MAX,           UINT32_MAX } },
    { { EASYSIMD_FLOAT32_C(   275.23), EASYSIMD_FLOAT32_C(  -410.87) },
      { EASYSIMD_FLOAT32_C(   275.23), EASYSIMD_FLOAT32_C(   115.66) },
      {           UINT32_MAX, UINT32_C(         0) } },
    { { EASYSIMD_FLOAT32_C(   336.04), EASYSIMD_FLOAT32_C(  -887.79) },
      { EASYSIMD_FLOAT32_C(   336.04), EASYSIMD_FLOAT32_C(   388.16) },
      {           UINT32_MAX, UINT32_C(         0) } },
    { { EASYSIMD_FLOAT32_C(   612.02), EASYSIMD_FLOAT32_C(   443.88) },
      { EASYSIMD_FLOAT32_C(   612.02), EASYSIMD_FLOAT32_C(   786.43) },
      {           UINT32_MAX, UINT32_C(         0) } },
    { { EASYSIMD_FLOAT32_C(  -252.76), EASYSIMD_FLOAT32_C(   831.05) },
      { EASYSIMD_FLOAT32_C(   465.97), EASYSIMD_FLOAT32_C(   831.05) },
      { UINT32_C(         0),           UINT32_MAX } },
    { { EASYSIMD_FLOAT32_C(  -686.12), EASYSIMD_FLOAT32_C(   807.98) },
      { EASYSIMD_FLOAT32_C(  -686.12), EASYSIMD_FLOAT32_C(   169.08) },
      {           UINT32_MAX, UINT32_C(         0) } },
    { { EASYSIMD_FLOAT32_C(  -388.06), EASYSIMD_FLOAT32_C(   887.17) },
      { EASYSIMD_FLOAT32_C(  -568.13), EASYSIMD_FLOAT32_C(   887.17) },
      { UINT32_C(         0),           UINT32_MAX } }
  };
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x2_t r = easysimd_vceq_f32(a, b);
  ...
  fputc('\n', stdout);
  for (int i = 0 ; i < 8 ; i++) {
    easysimd_float32 a_[2], b_[2];
    easysimd_test_codegen_random_vf32(sizeof(a_) / sizeof(a_[0]), a_, -1000.0, 1000.0);
    easysimd_test_codegen_random_vf32(sizeof(b_) / sizeof(b_[0]), b_, -1000.0, 1000.0);
    for (size_t j = 0 ; j < (sizeof(a_) / sizeof(a_[0])) ; j++) {
      if (easysimd_test_codegen_random_i8() & 1) {
        a_[j] = b_[j];
      }
    }
    easysimd_uint32x2_t r = easysimd_vceq_f32(easysimd_vld1_f32(a_), easysimd_vld1_f32(b_));

    easysimd_test_codegen_write_vf32(2, sizeof(a_) / sizeof(a_[0]), a_, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_codegen_write_vf32(2, sizeof(b_) / sizeof(b_[0]), b_, EASYSIMD_TEST_VEC_POS_MIDDLE);
...
static int
test_easysimd_vceq_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    ...
    { { EASYSIMD_FLOAT64_C(   885.81) },
      { EASYSIMD_FLOAT64_C(   885.81) },
      {                    UINT64_MAX } },
    { { EASYSIMD_FLOAT64_C(    40.20) },
      { EASYSIMD_FLOAT64_C(    40.20) },
      {                    UINT64_MAX } },
    { { EASYSIMD_FLOAT64_C(  -943.53) },
      { EASYSIMD_FLOAT64_C(  -943.53) },
      {                    UINT64_MAX } },
    { { EASYSIMD_FLOAT64_C(   766.97) },
      { EASYSIMD_FLOAT64_C(   766.97) },
      {                    UINT64_MAX } },
    { { EASYSIMD_FLOAT64_C(   492.60) },
      { EASYSIMD_FLOAT64_C(  -737.06) },
      { UINT64_C(                   0) } },
    { { EASYSIMD_FLOAT64_C(   465.88) },
      { EASYSIMD_FLOAT64_C(   465.88) },
      {                    UINT64_MAX } },
    { { EASYSIMD_FLOAT64_C(  -665.29) },
      { EASYSIMD_FLOAT64_C(  -902.43) },
      { UINT64_C(                   0) } },
    { { EASYSIMD_FLOAT64_C(  -382.78) },
      { EASYSIMD_FLOAT64_C(  -377.85) },
      { UINT64_C(                   0) } }
  };
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint64x1_t r = easysimd_vceq_f64(a, b);
  ...
  fputc('\n', stdout);
  for (int i = 0 ; i < 8 ; i++) {
    easysimd_float64 a_[1], b_[1];
    easysimd_test_codegen_random_vf64(sizeof(a_) / sizeof(a_[0]), a_, -1000.0, 1000.0);
    easysimd_test_codegen_random_vf64(sizeof(b_) / sizeof(b_[0]), b_, -1000.0, 1000.0);
    for (size_t j = 0 ; j < (sizeof(a_) / sizeof(a_[0])) ; j++) {
      if (easysimd_test_codegen_random_i8() & 1) {
        a_[j] = b_[j];
      }
    }
    easysimd_uint64x1_t r = easysimd_vceq_f64(easysimd_vld1_f64(a_), easysimd_vld1_f64(b_));

    easysimd_test_codegen_write_vf64(2, sizeof(a_) / sizeof(a_[0]), a_, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_codegen_write_vf64(2, sizeof(b_) / sizeof(b_[0]), b_, EASYSIMD_TEST_VEC_POS_MIDDLE);
...
static int
test_easysimd_vceq_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int8_t a[8];
    int8_t b[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x8_t r = easysimd_vceq_s8(a, b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_uint8x8_t r = easysimd_vceq_s8(easysimd_vld1_s8(a_), easysimd_vld1_s8(b_));

    easysimd_test_codegen_write_vi8(2, sizeof(a_) / sizeof(a_[0]), a_, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_codegen_write_vi8(2, sizeof(b_) / sizeof(b_[0]), b_, EASYSIMD_TEST_VEC_POS_MIDDLE);
...
static int
test_easysimd_vceq_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int16_t a[4];
    int16_t b[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x4_t r = easysimd_vceq_s16(a, b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_uint16x4_t r = easysimd_vceq_s16(easysimd_vld1_s16(a_), easysimd_vld1_s16(b_));

    easysimd_test_codegen_write_vi16(2, sizeof(a_) / sizeof(a_[0]), a_, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_codegen_write_vi16(2, sizeof(b_) / sizeof(b_[0]), b_, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_u16x4(2, r, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
#endif
...
static int
test_easysimd_vceq_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t a[2];
    int32_t b[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x2_t r = easysimd_vceq_s32(a, b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_uint32x2_t r = easysimd_vceq_s32(easysimd_vld1_s32(a_), easysimd_vld1_s32(b_));

    easysimd_test_codegen_write_vi32(2, sizeof(a_) / sizeof(a_[0]), a_, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_codegen_write_vi32(2, sizeof(b_) / sizeof(b_[0]), b_, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_u32x2(2, r, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
#endif
...
static int
test_easysimd_vceq_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int64_t a[1];
    int64_t b[1];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint64x1_t r = easysimd_vceq_s64(a, b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_uint64x1_t r = easysimd_vceq_s64(easysimd_vld1_s64(a_), easysimd_vld1_s64(b_));

    easysimd_test_codegen_write_vi64(2, sizeof(a_) / sizeof(a_[0]), a_, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_codegen_write_vi64(2, sizeof(b_) / sizeof(b_[0]), b_, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_u64x1(2, r, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
#endif
...
static int
test_easysimd_vceq_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint8_t a[8];
    uint8_t b[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x8_t r = easysimd_vceq_u8(a, b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_uint8x8_t r = easysimd_vceq_u8(easysimd_vld1_u8(a_), easysimd_vld1_u8(b_));

    easysimd_test_codegen_write_vu8(2, sizeof(a_) / sizeof(a_[0]), a_, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_codegen_write_vu8(2, sizeof(b_) / sizeof(b_[0]), b_, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_u8x8(2, r, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
#endif
...
static int
test_easysimd_vceq_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint16_t a[4];
    uint16_t b[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x4_t r = easysimd_vceq_u16(a, b);
    easysimd_test_arm_neon_assert_equal_u16x4(r, easysimd_vld1_u16(test_vec[i].r));
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_uint16x4_t r = easysimd_vceq_u16(easysimd_vld1_u16(a_), easysimd_vld1_u16(b_));

    easysimd_test_codegen_write_vu16(2, sizeof(a_) / sizeof(a_[0]), a_, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_codegen_write_vu16(2, sizeof(b_) / sizeof(b_[0]), b_, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_u16x4(2, r, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
#endif
...
static int
test_easysimd_vceq_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint32_t a[2];
    uint32_t b[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x2_t r = easysimd_vceq_u32(a, b);
    easysimd_test_arm_neon_assert_equal_u32x2(r, easysimd_vld1_u32(test_vec[i].r));
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_uint32x2_t r = easysimd_vceq_u32(easysimd_vld1_u32(a_), easysimd_vld1_u32(b_));

    easysimd_test_codegen_write_vu32(2, sizeof(a_) / sizeof(a_[0]), a_, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_codegen_write_vu32(2, sizeof(b_) / sizeof(b_[0]), b_, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_u32x2(2, r, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
#endif
...
static int
test_easysimd_vceq_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint64_t a[1];
    uint64_t b[1];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint64x1_t r = easysimd_vceq_u64(a, b);
    easysimd_test_arm_neon_assert_equal_u64x1(r, easysimd_vld1_u64(test_vec[i].r));
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_uint64x1_t r = easysimd_vceq_u64(easysimd_vld1_u64(a_), easysimd_vld1_u64(b_));

    easysimd_test_codegen_write_vu64(2, sizeof(a_) / sizeof(a_[0]), a_, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_codegen_write_vu64(2, sizeof(b_) / sizeof(b_[0]), b_, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_u64x1(2, r, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
#endif
...
static int
test_easysimd_vceqq_f16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  struct {
    ...
    { { EASYSIMD_FLOAT16_VALUE(  -258.75), EASYSIMD_FLOAT16_VALUE(   657.50), EASYSIMD_FLOAT16_VALUE(  -817.50), EASYSIMD_FLOAT16_VALUE(   764.00),
        EASYSIMD_FLOAT16_VALUE(  -975.00), EASYSIMD_FLOAT16_VALUE(  -855.00), EASYSIMD_FLOAT16_VALUE(   492.50), EASYSIMD_FLOAT16_VALUE(   -36.75) },
      { EASYSIMD_FLOAT16_VALUE(   179.62), EASYSIMD_FLOAT16_VALUE(   657.50), EASYSIMD_FLOAT16_VALUE(  -817.50), EASYSIMD_FLOAT16_VALUE(   929.50),
        EASYSIMD_FLOAT16_VALUE(   787.50), EASYSIMD_FLOAT16_VALUE(  -855.00), EASYSIMD_FLOAT16_VALUE(   492.50), EASYSIMD_FLOAT16_VALUE(   -36.75) },
      { UINT16_C(    0),      UINT16_MAX,      UINT16_MAX, UINT16_C(    0), UINT16_C(    0),      UINT16_MAX,      UINT16_MAX,      UINT16_MAX } },
    { { EASYSIMD_FLOAT16_VALUE(   591.00), EASYSIMD_FLOAT16_VALUE(  -247.50), EASYSIMD_FLOAT16_VALUE(   330.50), EASYSIMD_FLOAT16_VALUE(   616.00),
        EASYSIMD_FLOAT16_VALUE(   690.50), EASYSIMD_FLOAT16_VALUE(   316.00), EASYSIMD_FLOAT16_VALUE(  -955.50), EASYSIMD_FLOAT16_VALUE(  -568.00) },
      { EASYSIMD_FLOAT16_VALUE(   591.00), EASYSIMD_FLOAT16_VALUE(  -247.50), EASYSIMD_FLOAT16_VALUE(  -804.00), EASYSIMD_FLOAT16_VALUE(   616.00),
        EASYSIMD_FLOAT16_VALUE(  -906.00), EASYSIMD_FLOAT16_VALUE(   316.00), EASYSIMD_FLOAT16_VALUE(   -83.75), EASYSIMD_FLOAT16_VALUE(   273.75) },
      {      UINT16_MAX,      UINT16_MAX, UINT16_C(    0),      UINT16_MAX, UINT16_C(    0),      UINT16_MAX, UINT16_C(    0), UINT16_C(    0) } },
    { { EASYSIMD_FLOAT16_VALUE(  -796.50), EASYSIMD_FLOAT16_VALUE(   659.00), EASYSIMD_FLOAT16_VALUE(  -852.00), EASYSIMD_FLOAT16_VALUE(   197.25),
        EASYSIMD_FLOAT16_VALUE(   932.00), EASYSIMD_FLOAT16_VALUE(   900.50), EASYSIMD_FLOAT16_VALUE(  -671.50), EASYSIMD_FLOAT16_VALUE(  -740.00) },
      { EASYSIMD_FLOAT16_VALUE(  -796.50), EASYSIMD_FLOAT16_VALUE(   659.00), EASYSIMD_FLOAT16_VALUE(   855.50), EASYSIMD_FLOAT16_VALUE(   894.00),
        EASYSIMD_FLOAT16_VALUE(   718.00), EASYSIMD_FLOAT16_VALUE(   900.50), EASYSIMD_FLOAT16_VALUE(  -673.50), EASYSIMD_FLOAT16_VALUE(   309.25) },
      {      UINT16_MAX,      UINT16_MAX, UINT16_C(    0), UINT16_C(    0), UINT16_C(    0),      UINT16_MAX, UINT16_C(    0), UINT16_C(    0) } },
    { { EASYSIMD_FLOAT16_VALUE(  -187.50), EASYSIMD_FLOAT16_VALUE(   223.62), EASYSIMD_FLOAT16_VALUE(   127.12), EASYSIMD_FLOAT16_VALUE(  -255.38),
        EASYSIMD_FLOAT16_VALUE(  -969.00), EASYSIMD_FLOAT16_VALUE(   455.50), EASYSIMD_FLOAT16_VALUE(     4.81), EASYSIMD_FLOAT16_VALUE(   930.00) },
      { EASYSIMD_FLOAT16_VALUE(  -187.50), EASYSIMD_FLOAT16_VALUE(    78.31), EASYSIMD_FLOAT16_VALUE(   127.12), EASYSIMD_FLOAT16_VALUE(  -255.38),
        EASYSIMD_FLOAT16_VALUE(  -969.00), EASYSIMD_FLOAT16_VALUE(   455.50), EASYSIMD_FLOAT16_VALUE(     4.81), EASYSIMD_FLOAT16_VALUE(  -765.50) },
      {      UINT16_MAX, UINT16_C(    0),      UINT16_MAX,      UINT16_MAX,      UINT16_MAX,      UINT16_MAX,      UINT16_MAX, UINT16_C(    0) } },
    { { EASYSIMD_FLOAT16_VALUE(   -23.00), EASYSIMD_FLOAT16_VALUE(    66.69), EASYSIMD_FLOAT16_VALUE(  -839.50), EASYSIMD_FLOAT16_VALUE(   323.50),
        EASYSIMD_FLOAT16_VALUE(  -504.50), EASYSIMD_FLOAT16_VALUE(  -819.50), EASYSIMD_FLOAT16_VALUE(   626.50), EASYSIMD_FLOAT16_VALUE(   308.00) },
      { EASYSIMD_FLOAT16_VALUE(   404.25), EASYSIMD_FLOAT16_VALUE(   199.00), EASYSIMD_FLOAT16_VALUE(  -968.00), EASYSIMD_FLOAT16_VALUE(   323.50),
        EASYSIMD_FLOAT16_VALUE(  -504.50), EASYSIMD_FLOAT16_VALUE(   -38.09), EASYSIMD_FLOAT16_VALUE(   253.38), EASYSIMD_FLOAT16_VALUE(   308.00) },
      { UINT16_C(    0), UINT16_C(    0), UINT16_C(    0),      UINT16_MAX,      UINT16_MAX, UINT16_C(    0), UINT16_C(    0),      UINT16_MAX } },
    { { EASYSIMD_FLOAT16_VALUE(   918.00), EASYSIMD_FLOAT16_VALUE(  -747.50), EASYSIMD_FLOAT16_VALUE(   783.00), EASYSIMD_FLOAT16_VALUE(   899.00),
        EASYSIMD_FLOAT16_VALUE(  -111.38), EASYSIMD_FLOAT16_VALUE(  -692.50), EASYSIMD_FLOAT16_VALUE(  -908.00), EASYSIMD_FLOAT16_VALUE(   865.50) },
      { EASYSIMD_FLOAT16_VALUE(    -8.81), EASYSIMD_FLOAT16_VALUE(  -747.50), EASYSIMD_FLOAT16_VALUE(  -319.25), EASYSIMD_FLOAT16_VALUE(   899.00),
        EASYSIMD_FLOAT16_VALUE(  -567.00), EASYSIMD_FLOAT16_VALUE(  -692.50), EASYSIMD_FLOAT16_VALUE(   747.00), EASYSIMD_FLOAT16_VALUE(   837.50) },
      { UINT16_C(    0),      UINT16_MAX, UINT16_C(    0),      UINT16_MAX, UINT16_C(    0),      UINT16_MAX, UINT16_C(    0), UINT16_C(    0) } },
    { { EASYSIMD_FLOAT16_VALUE(   591.00), EASYSIMD_FLOAT16_VALUE(   362.50), EASYSIMD_FLOAT16_VALUE(    16.50), EASYSIMD_FLOAT16_VALUE(  -520.00),
        EASYSIMD_FLOAT16_VALUE(  -580.00), EASYSIMD_FLOAT16_VALUE(   108.62), EASYSIMD_FLOAT16_VALUE(  -654.50), EASYSIMD_FLOAT16_VALUE(  -662.00) },
      { EASYSIMD_FLOAT16_VALUE(   591.00), EASYSIMD_FLOAT16_VALUE(   364.50), EASYSIMD_FLOAT16_VALUE(    16.50), EASYSIMD_FLOAT16_VALUE(  -520.00),
        EASYSIMD_FLOAT16_VALUE(   289.00), EASYSIMD_FLOAT16_VALUE(   108.62), EASYSIMD_FLOAT16_VALUE(  -654.50), EASYSIMD_FLOAT16_VALUE(  -720.00) },
      {      UINT16_MAX, UINT16_C(    0),      UINT16_MAX,      UINT16_MAX, UINT16_C(    0),      UINT16_MAX,      UINT16_MAX, UINT16_C(    0) } },
    { { EASYSIMD_FLOAT16_VALUE(   705.50), EASYSIMD_FLOAT16_VALUE(  -207.62), EASYSIMD_FLOAT16_VALUE(  -158.12), EASYSIMD_FLOAT16_VALUE(  -553.50),
        EASYSIMD_FLOAT16_VALUE(   206.75), EASYSIMD_FLOAT16_VALUE(  -786.00), EASYSIMD_FLOAT16_VALUE(  -728.00), EASYSIMD_FLOAT16_VALUE(  -171.88) },
      { EASYSIMD_FLOAT16_VALUE(   514.50), EASYSIMD_FLOAT16_VALUE(  -920.50), EASYSIMD_FLOAT16_VALUE(  -367.25), EASYSIMD_FLOAT16_VALUE(   934.00),
        EASYSIMD_FLOAT16_VALUE(   237.00), EASYSIMD_FLOAT16_VALUE(  -786.00), EASYSIMD_FLOAT16_VALUE(  -728.00), EASYSIMD_FLOAT16_VALUE(  -171.88) },
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x8_t r = easysimd_vceqq_f16(a, b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_uint16x8_t r = easysimd_vceqq_f16(easysimd_vld1q_f16(a_), easysimd_vld1q_f16(b_));
...
static int
test_easysimd_vceqq_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    ...
    { { EASYSIMD_FLOAT32_C(   151.95), EASYSIMD_FLOAT32_C(   801.55), EASYSIMD_FLOAT32_C(   470.19), EASYSIMD_FLOAT32_C(   494.12) },
      { EASYSIMD_FLOAT32_C(  -614.47), EASYSIMD_FLOAT32_C(   801.55), EASYSIMD_FLOAT32_C(   128.44), EASYSIMD_FLOAT32_C(   494.12) },
      { UINT32_C(         0),           UINT32_MAX, UINT32_C(         0),           UINT32_MAX } },
    { { EASYSIMD_FLOAT32_C(  -211.99), EASYSIMD_FLOAT32_C(   401.96), EASYSIMD_FLOAT32_C(  -113.21), EASYSIMD_FLOAT32_C(    64.60) },
      { EASYSIMD_FLOAT32_C(  -211.99), EASYSIMD_FLOAT32_C(    68.77), EASYSIMD_FLOAT32_C(  -113.21), EASYSIMD_FLOAT32_C(    64.60) },
      {           UINT32_MAX, UINT32_C(         0),           UINT32_MAX,           UINT32_MAX } },
    { { EASYSIMD_FLOAT32_C(   843.56), EASYSIMD_FLOAT32_C(   416.97), EASYSIMD_FLOAT32_C(    36.69), EASYSIMD_FLOAT32_C(   -30.43) },
      { EASYSIMD_FLOAT32_C(    54.01), EASYSIMD_FLOAT32_C(   416.97), EASYSIMD_FLOAT32_C(    36.69), EASYSIMD_FLOAT32_C(  -794.04) },
      { UINT32_C(         0),           UINT32_MAX,           UINT32_MAX, UINT32_C(         0) } },
    { { EASYSIMD_FLOAT32_C(   264.61), EASYSIMD_FLOAT32_C(  -269.86), EASYSIMD_FLOAT32_C(  -951.46), EASYSIMD_FLOAT32_C(  -765.17) },
      { EASYSIMD_FLOAT32_C(   264.61), EASYSIMD_FLOAT32_C(   341.73), EASYSIMD_FLOAT32_C(  -453.78), EASYSIMD_FLOAT32_C(  -765.17) },
      {           UINT32_MAX, UINT32_C(         0), UINT32_C(         0),           UINT32_MAX } },
    { { EASYSIMD_FLOAT32_C(  -863.16), EASYSIMD_FLOAT32_C(   964.02), EASYSIMD_FLOAT32_C(  -403.70), EASYSIMD_FLOAT32_C(   980.39) },
      { EASYSIMD_FLOAT32_C(  -863.16), EASYSIMD_FLOAT32_C(  -832.51), EASYSIMD_FLOAT32_C(  -252.53), EASYSIMD_FLOAT32_C(   980.39) },
      {           UINT32_MAX, UINT32_C(         0), UINT32_C(         0),           UINT32_MAX } },
    { { EASYSIMD_FLOAT32_C(  -506.48), EASYSIMD_FLOAT32_C(   986.65), EASYSIMD_FLOAT32_C(   541.36), EASYSIMD_FLOAT32_C(  -198.05) },
      { EASYSIMD_FLOAT32_C(  -506.48), EASYSIMD_FLOAT32_C(   852.79), EASYSIMD_FLOAT32_C(   541.36), EASYSIMD_FLOAT32_C(  -198.05) },
      {           UINT32_MAX, UINT32_C(         0),           UINT32_MAX,           UINT32_MAX } },
    { { EASYSIMD_FLOAT32_C(   -68.37), EASYSIMD_FLOAT32_C(  -248.88), EASYSIMD_FLOAT32_C(  -917.64), EASYSIMD_FLOAT32_C(  -455.58) },
      { EASYSIMD_FLOAT32_C(  -886.61), EASYSIMD_FLOAT32_C(   159.60), EASYSIMD_FLOAT32_C(   207.02), EASYSIMD_FLOAT32_C(  -455.58) },
      { UINT32_C(         0), UINT32_C(         0), UINT32_C(         0),           UINT32_MAX } },
    { { EASYSIMD_FLOAT32_C(   970.82), EASYSIMD_FLOAT32_C(  -809.19), EASYSIMD_FLOAT32_C(   240.85), EASYSIMD_FLOAT32_C(   -38.07) },
      { EASYSIMD_FLOAT32_C(   332.11), EASYSIMD_FLOAT32_C(  -809.19), EASYSIMD_FLOAT32_C(     7.05), EASYSIMD_FLOAT32_C(  -849.83) },
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x4_t r = easysimd_vceqq_f32(a, b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_uint32x4_t r = easysimd_vceqq_f32(easysimd_vld1q_f32(a_), easysimd_vld1q_f32(b_));
...
static int
test_easysimd_vceqq_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    ...
    { { EASYSIMD_FLOAT64_C(   211.07), EASYSIMD_FLOAT64_C(  -652.68) },
      { EASYSIMD_FLOAT64_C(  -764.13), EASYSIMD_FLOAT64_C(  -652.68) },
      { UINT64_C(                   0),                    UINT64_MAX } },
    { { EASYSIMD_FLOAT64_C(  -650.75), EASYSIMD_FLOAT64_C(  -819.92) },
      { EASYSIMD_FLOAT64_C(  -825.40), EASYSIMD_FLOAT64_C(  -295.90) },
      { UINT64_C(                   0), UINT64_C(                   0) } },
    { { EASYSIMD_FLOAT64_C(   934.40), EASYSIMD_FLOAT64_C(  -562.53) },
      { EASYSIMD_FLOAT64_C(   934.40), EASYSIMD_FLOAT64_C(   790.23) },
      {                    UINT64_MAX, UINT64_C(                   0) } },
    { { EASYSIMD_FLOAT64_C(  -625.41), EASYSIMD_FLOAT64_C(    22.91) },
      { EASYSIMD_FLOAT64_C(  -625.41), EASYSIMD_FLOAT64_C(    22.91) },
      {                    UINT64_MAX,                    UINT64_MAX } },
    { { EASYSIMD_FLOAT64_C(   523.75), EASYSIMD_FLOAT64_C(   311.54) },
      { EASYSIMD_FLOAT64_C(   286.95), EASYSIMD_FLOAT64_C(   311.54) },
      { UINT64_C(                   0),                    UINT64_MAX } },
    { { EASYSIMD_FLOAT64_C(    41.17), EASYSIMD_FLOAT64_C(   277.04) },
      { EASYSIMD_FLOAT64_C(   630.41), EASYSIMD_FLOAT64_C(   277.04) },
      { UINT64_C(                   0),                    UINT64_MAX } },
    { { EASYSIMD_FLOAT64_C(  -701.97), EASYSIMD_FLOAT64_C(  -163.42) },
      { EASYSIMD_FLOAT64_C(  -701.97), EASYSIMD_FLOAT64_C(   980.64) },
      {                    UINT64_MAX, UINT64_C(                   0) } },
    { { EASYSIMD_FLOAT64_C(   144.09), EASYSIMD_FLOAT64_C(  -754.88) },
      { EASYSIMD_FLOAT64_C(  -879.09), EASYSIMD_FLOAT64_C(    78.48) },
      { UINT64_C(                   0), UINT64_C(                   0) } }
  };
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint64x2_t r = easysimd_vceqq_f64(a, b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_uint64x2_t r = easysimd_vceqq_f64(easysimd_vld1q_f64(a_), easysimd_vld1q_f64(b_));
...
static int
test_easysimd_vceqq_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int8_t a[16];
    int8_t b[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x16_t r = easysimd_vceqq_s8(a, b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_uint8x16_t r = easysimd_vceqq_s8(easysimd_vld1q_s8(a_), easysimd_vld1q_s8(b_));
...
static int
test_easysimd_vceqq_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int16_t a[8];
    int16_t b[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x8_t r = easysimd_vceqq_s16(a, b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_uint16x8_t r = easysimd_vceqq_s16(easysimd_vld1q_s16(a_), easysimd_vld1q_s16(b_));
...
static int
test_easysimd_vceqq_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t a[4];
    int32_t b[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x4_t r = easysimd_vceqq_s32(a, b);
    easysimd_test_arm_neon_assert_equal_u32x4(r, easysimd_vld1q_u32(test_vec[i].r));
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_uint32x4_t r = easysimd_vceqq_s32(easysimd_vld1q_s32(a_), easysimd_vld1q_s32(b_));
...
static int
test_easysimd_vceqq_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int64_t a[2];
    int64_t b[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint64x2_t r = easysimd_vceqq_s64(a, b);
    easysimd_test_arm_neon_assert_equal_u64x2(r, easysimd_vld1q_u64(test_vec[i].r));
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_uint64x2_t r = easysimd_vceqq_s64(easysimd_vld1q_s64(a_), easysimd_vld1q_s64(b_));
...
static int
test_easysimd_vceqq_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint8_t a[16];
    uint8_t b[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x16_t r = easysimd_vceqq_u8(a, b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_uint8x16_t r = easysimd_vceqq_u8(easysimd_vld1q_u8(a_), easysimd_vld1q_u8(b_));
...
static int
test_easysimd_vceqq_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint16_t a[8];
    uint16_t b[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x8_t r = easysimd_vceqq_u16(a, b);
    easysimd_test_arm_neon_assert_equal_u16x8(r, easysimd_vld1q_u16(test_vec[i].r));
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_uint16x8_t r = easysimd_vceqq_u16(easysimd_vld1q_u16(a_), easysimd_vld1q_u16(b_));
...
static int
test_easysimd_vceqq_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint32_t a[4];
    uint32_t b[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x4_t r = easysimd_vceqq_u32(a, b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_uint32x4_t r = easysimd_vceqq_u32(easysimd_vld1q_u32(a_), easysimd_vld1q_u32(b_));
...
static int
test_easysimd_vceqq_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint64_t a[2];
    uint64_t b[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint64x2_t r = easysimd_vceqq_u64(a, b);
    easysimd_test_arm_neon_assert_equal_u64x2(r, easysimd_vld1q_u64(test_vec[i].r));
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_uint64x2_t r = easysimd_vceqq_u64(easysimd_vld1q_u64(a_), easysimd_vld1q_u64(b_));
...
EASYSIMD_TEST_FUNC_LIST_ENTRY(vceqs_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vceqd_f64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vceqd_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vceqd_u64)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vceq_f16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vceq_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vceq_f64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vceq_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vceq_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vceq_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vceq_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vceq_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vceq_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vceq_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vceq_u64)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vceqq_f16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vceqq_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vceqq_f64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vceqq_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vceqq_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vceqq_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vceqq_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vceqq_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vceqq_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vceqq_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vceqq_u64)
