#define EASYSIMD_TEST_ARM_NEON_INSN ceqz

#include "test-neon.h"
#include <easysimd/arm/neon/ceqz.h>
#include <stdlib.h>

static int
test_easysimd_vceqz_f16 (EASYSIMD_MUNIT_TEST_ARGS) {
  #if 1
  struct {
    easysimd_float16 a[4];
    uint16_t r[4];
  } test_vec[] = {
    { { EASYSIMD_FLOAT16_VALUE(   288.00), EASYSIMD_FLOAT16_VALUE(   217.88), EASYSIMD_FLOAT16_VALUE(   992.00), EASYSIMD_FLOAT16_VALUE(  -163.88) },
      { UINT16_C(    0), UINT16_C(    0), UINT16_C(    0), UINT16_C(    0) } },
    { { EASYSIMD_FLOAT16_VALUE(   253.88), EASYSIMD_FLOAT16_VALUE(    43.75), EASYSIMD_FLOAT16_VALUE(   -87.38), EASYSIMD_FLOAT16_VALUE(  -653.50) },
      { UINT16_C(    0), UINT16_C(    0), UINT16_C(    0), UINT16_C(    0) } },
    { { EASYSIMD_FLOAT16_VALUE(  -944.50), EASYSIMD_FLOAT16_VALUE(    25.94), EASYSIMD_FLOAT16_VALUE(   256.75), EASYSIMD_FLOAT16_VALUE(  -255.75) },
      { UINT16_C(    0), UINT16_C(    0), UINT16_C(    0), UINT16_C(    0) } },
    { { EASYSIMD_FLOAT16_VALUE(   770.50), EASYSIMD_FLOAT16_VALUE(   141.50), EASYSIMD_FLOAT16_VALUE(   616.50), EASYSIMD_FLOAT16_VALUE(  -261.25) },
      { UINT16_C(    0), UINT16_C(    0), UINT16_C(    0), UINT16_C(    0) } },
    { { EASYSIMD_FLOAT16_VALUE(  -674.50), EASYSIMD_FLOAT16_VALUE(  -461.00), EASYSIMD_FLOAT16_VALUE(  -235.50), EASYSIMD_FLOAT16_VALUE(  -111.38) },
      { UINT16_C(    0), UINT16_C(    0), UINT16_C(    0), UINT16_C(    0) } },
    { { EASYSIMD_FLOAT16_VALUE(   996.00), EASYSIMD_FLOAT16_VALUE(  -204.38), EASYSIMD_FLOAT16_VALUE(  -877.50), EASYSIMD_FLOAT16_VALUE(   514.50) },
      { UINT16_C(    0), UINT16_C(    0), UINT16_C(    0), UINT16_C(    0) } },
    { { EASYSIMD_FLOAT16_VALUE(  -850.50), EASYSIMD_FLOAT16_VALUE(   569.50), EASYSIMD_FLOAT16_VALUE(  -261.50), EASYSIMD_FLOAT16_VALUE(   174.38) },
      { UINT16_C(    0), UINT16_C(    0), UINT16_C(    0), UINT16_C(    0) } },
    { { EASYSIMD_FLOAT16_VALUE(   983.00), EASYSIMD_FLOAT16_VALUE(   651.00), EASYSIMD_FLOAT16_VALUE(  -853.00), EASYSIMD_FLOAT16_VALUE(   270.75) },
      { UINT16_C(    0), UINT16_C(    0), UINT16_C(    0), UINT16_C(    0) } }
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float16x4_t a = easysimd_vld1_f16(test_vec[i].a);
    easysimd_uint16x4_t r = easysimd_vceqz_f16(a);
...
static int
test_easysimd_vceqz_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    ...
    { { EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(  -327.33) },
      {           UINT32_MAX, UINT32_C(         0) } },
    { { EASYSIMD_FLOAT32_C(  -721.62), EASYSIMD_FLOAT32_C(   916.22) },
      { UINT32_C(         0), UINT32_C(         0) } },
    { { EASYSIMD_FLOAT32_C(  -765.93), EASYSIMD_FLOAT32_C(     0.00) },
      { UINT32_C(         0),           UINT32_MAX } },
    { { EASYSIMD_FLOAT32_C(   995.55), EASYSIMD_FLOAT32_C(   510.58) },
      { UINT32_C(         0), UINT32_C(         0) } },
    { { EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(     0.00) },
      {           UINT32_MAX,           UINT32_MAX } },
    { { EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(  -157.84) },
      {           UINT32_MAX, UINT32_C(         0) } },
    { { EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(     0.00) },
      {           UINT32_MAX,           UINT32_MAX } },
  };
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x2_t r = easysimd_vceqz_f32(a);
...
static int
test_easysimd_vceqz_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    easysimd_float64 a[1];
    uint64_t r[1];
  } test_vec[] = {
    { { EASYSIMD_FLOAT64_C(   -60.46) },
      { UINT64_C(                   0) } },
    { { EASYSIMD_FLOAT64_C(  -469.42) },
      { UINT64_C(                   0) } },
    { { EASYSIMD_FLOAT64_C(  -384.64) },
      { UINT64_C(                   0) } },
    { { EASYSIMD_FLOAT64_C(   -89.50) },
      { UINT64_C(                   0) } },
    { { EASYSIMD_FLOAT64_C(   584.35) },
      { UINT64_C(                   0) } },
    { { EASYSIMD_FLOAT64_C(  -326.83) },
      { UINT64_C(                   0) } },
    { { EASYSIMD_FLOAT64_C(   994.82) },
      { UINT64_C(                   0) } },
    { { EASYSIMD_FLOAT64_C(   158.46) },
      { UINT64_C(                   0) } },
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float64x1_t a = easysimd_vld1_f64(test_vec[i].a);
    easysimd_uint64x1_t r = easysimd_vceqz_f64(a);
...
static int
test_easysimd_vceqz_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int8_t a[8];
    uint8_t r[8];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x8_t r = easysimd_vceqz_s8(a);
...
static int
test_easysimd_vceqz_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int16_t a[4];
    uint16_t r[4];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x4_t r = easysimd_vceqz_s16(a);
...
static int
test_easysimd_vceqz_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int32_t a[2];
    uint32_t r[2];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x2_t r = easysimd_vceqz_s32(a);
...
static int
test_easysimd_vceqz_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int64_t a[1];
    uint64_t r[1];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint64x1_t r = easysimd_vceqz_s64(a);
...
static int
test_easysimd_vceqz_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint8_t a[8];
    uint8_t r[8];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x8_t r = easysimd_vceqz_u8(a);
...
static int
test_easysimd_vceqz_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint16_t a[4];
    uint16_t r[4];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x4_t r = easysimd_vceqz_u16(a);
    easysimd_test_arm_neon_assert_equal_u16x4(r, easysimd_vld1_u16(test_vec[i].r));
  }
...
static int
test_easysimd_vceqz_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint32_t a[2];
    uint32_t r[2];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x2_t r = easysimd_vceqz_u32(a);
    easysimd_test_arm_neon_assert_equal_u32x2(r, easysimd_vld1_u32(test_vec[i].r));
  }
...
static int
test_easysimd_vceqz_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint64_t a[1];
    uint64_t r[1];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint64x1_t r = easysimd_vceqz_u64(a);
    easysimd_test_arm_neon_assert_equal_u64x1(r, easysimd_vld1_u64(test_vec[i].r));
  }
...
static int
test_easysimd_vceqzq_f16 (EASYSIMD_MUNIT_TEST_ARGS) {
  #if 1
    struct {
      easysimd_float16 a[8];
      uint16_t r[8];
    } test_vec[] = {
      { { EASYSIMD_FLOAT16_VALUE(   732.00), EASYSIMD_FLOAT16_VALUE(  -455.50), EASYSIMD_FLOAT16_VALUE(   260.75), EASYSIMD_FLOAT16_VALUE(   765.00),
        EASYSIMD_FLOAT16_VALUE(  -305.50), EASYSIMD_FLOAT16_VALUE(  -960.00), EASYSIMD_FLOAT16_VALUE(   373.50), EASYSIMD_FLOAT16_VALUE(   448.00) },
      { UINT16_C(    0), UINT16_C(    0), UINT16_C(    0), UINT16_C(    0), UINT16_C(    0), UINT16_C(    0), UINT16_C(    0), UINT16_C(    0) } },
    { { EASYSIMD_FLOAT16_VALUE(  -775.00), EASYSIMD_FLOAT16_VALUE(    50.47), EASYSIMD_FLOAT16_VALUE(   449.75), EASYSIMD_FLOAT16_VALUE(  -198.50),
        EASYSIMD_FLOAT16_VALUE(  -134.62), EASYSIMD_FLOAT16_VALUE(   689.00), EASYSIMD_FLOAT16_VALUE(  -391.25), EASYSIMD_FLOAT16_VALUE(  -461.50) },
      { UINT16_C(    0), UINT16_C(    0), UINT16_C(    0), UINT16_C(    0), UINT16_C(    0), UINT16_C(    0), UINT16_C(    0), UINT16_C(    0) } },
    { { EASYSIMD_FLOAT16_VALUE(   302.50), EASYSIMD_FLOAT16_VALUE(   622.50), EASYSIMD_FLOAT16_VALUE(  -242.62), EASYSIMD_FLOAT16_VALUE(  -533.50),
        EASYSIMD_FLOAT16_VALUE(   145.00), EASYSIMD_FLOAT16_VALUE(   305.25), EASYSIMD_FLOAT16_VALUE(  -211.88), EASYSIMD_FLOAT16_VALUE(  -968.00) },
      { UINT16_C(    0), UINT16_C(    0), UINT16_C(    0), UINT16_C(    0), UINT16_C(    0), UINT16_C(    0), UINT16_C(    0), UINT16_C(    0) } },
    { { EASYSIMD_FLOAT16_VALUE(  -971.00), EASYSIMD_FLOAT16_VALUE(  -691.50), EASYSIMD_FLOAT16_VALUE(   874.50), EASYSIMD_FLOAT16_VALUE(  -996.50),
        EASYSIMD_FLOAT16_VALUE(  -325.25), EASYSIMD_FLOAT16_VALUE(   380.00), EASYSIMD_FLOAT16_VALUE(   544.00), EASYSIMD_FLOAT16_VALUE(  -593.50) },
      { UINT16_C(    0), UINT16_C(    0), UINT16_C(    0), UINT16_C(    0), UINT16_C(    0), UINT16_C(    0), UINT16_C(    0), UINT16_C(    0) } },
    { { EASYSIMD_FLOAT16_VALUE(   924.50), EASYSIMD_FLOAT16_VALUE(  -195.50), EASYSIMD_FLOAT16_VALUE(  -828.50), EASYSIMD_FLOAT16_VALUE(  -381.25),
        EASYSIMD_FLOAT16_VALUE(  -155.62), EASYSIMD_FLOAT16_VALUE(   545.00), EASYSIMD_FLOAT16_VALUE(  -933.00), EASYSIMD_FLOAT16_VALUE(    69.38) },
      { UINT16_C(    0), UINT16_C(    0), UINT16_C(    0), UINT16_C(    0), UINT16_C(    0), UINT16_C(    0), UINT16_C(    0), UINT16_C(    0) } },
    { { EASYSIMD_FLOAT16_VALUE(  -404.75), EASYSIMD_FLOAT16_VALUE(   516.50), EASYSIMD_FLOAT16_VALUE(   871.00), EASYSIMD_FLOAT16_VALUE(   460.75),
        EASYSIMD_FLOAT16_VALUE(   205.75), EASYSIMD_FLOAT16_VALUE(  -520.50), EASYSIMD_FLOAT16_VALUE(   999.00), EASYSIMD_FLOAT16_VALUE(  -491.75) },
      { UINT16_C(    0), UINT16_C(    0), UINT16_C(    0), UINT16_C(    0), UINT16_C(    0), UINT16_C(    0), UINT16_C(    0), UINT16_C(    0) } },
    { { EASYSIMD_FLOAT16_VALUE(  -898.00), EASYSIMD_FLOAT16_VALUE(  -243.50), EASYSIMD_FLOAT16_VALUE(   -25.36), EASYSIMD_FLOAT16_VALUE(   247.25),
        EASYSIMD_FLOAT16_VALUE(  -938.00), EASYSIMD_FLOAT16_VALUE(   763.00), EASYSIMD_FLOAT16_VALUE(   279.25), EASYSIMD_FLOAT16_VALUE(  -909.00) },
      { UINT16_C(    0), UINT16_C(    0), UINT16_C(    0), UINT16_C(    0), UINT16_C(    0), UINT16_C(    0), UINT16_C(    0), UINT16_C(    0) } },
    { { EASYSIMD_FLOAT16_VALUE(  -928.50), EASYSIMD_FLOAT16_VALUE(   153.75), EASYSIMD_FLOAT16_VALUE(  -905.50), EASYSIMD_FLOAT16_VALUE(  -254.00),
        EASYSIMD_FLOAT16_VALUE(  -466.25), EASYSIMD_FLOAT16_VALUE(   638.50), EASYSIMD_FLOAT16_VALUE(   152.50), EASYSIMD_FLOAT16_VALUE(  -542.00) },
      { UINT16_C(    0), UINT16_C(    0), UINT16_C(    0), UINT16_C(    0), UINT16_C(    0), UINT16_C(    0), UINT16_C(    0), UINT16_C(    0) } }      
    };

    for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
      easysimd_float16x8_t a = easysimd_vld1q_f16(test_vec[i].a);
      easysimd_uint16x8_t r = easysimd_vceqzq_f16(a);
...
static int
test_easysimd_vceqzq_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    easysimd_float32 a[4];
    uint32_t r[4];
  } test_vec[] = {
    { { EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(  -765.96), EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(  -158.27) },
      {           UINT32_MAX, UINT32_C(         0),           UINT32_MAX, UINT32_C(         0) } },
    { { EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(  -383.93), EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(     0.00) },
      {           UINT32_MAX, UINT32_C(         0),           UINT32_MAX,           UINT32_MAX } },
    { { EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(  -833.58), EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(     0.00) },
      {           UINT32_MAX, UINT32_C(         0),           UINT32_MAX,           UINT32_MAX } },
    { { EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(  -556.99) },
      {           UINT32_MAX,           UINT32_MAX,           UINT32_MAX, UINT32_C(         0) } },
    { { EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(  -216.78), EASYSIMD_FLOAT32_C(  -123.11), EASYSIMD_FLOAT32_C(     0.00) },
      {           UINT32_MAX, UINT32_C(         0), UINT32_C(         0),           UINT32_MAX } },
    { { EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(   892.89), EASYSIMD_FLOAT32_C(     0.00) },
      {           UINT32_MAX,           UINT32_MAX, UINT32_C(         0),           UINT32_MAX } },
    { { EASYSIMD_FLOAT32_C(  -117.11), EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(  -727.26) },
      { UINT32_C(         0),           UINT32_MAX,           UINT32_MAX, UINT32_C(         0) } },
    { { EASYSIMD_FLOAT32_C(  -788.65), EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(     0.00) },
      { UINT32_C(         0),           UINT32_MAX,           UINT32_MAX,           UINT32_MAX } },
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float32x4_t a = easysimd_vld1q_f32(test_vec[i].a);
    easysimd_uint32x4_t r = easysimd_vceqzq_f32(a);
...
static int
test_easysimd_vceqzq_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    easysimd_float64 a[2];
    uint64_t r[2];
  } test_vec[] = {
    { { EASYSIMD_FLOAT64_C(     0.00), EASYSIMD_FLOAT64_C(   962.42) },
      {                    UINT64_MAX, UINT64_C(                   0) } },
    { { EASYSIMD_FLOAT64_C(     0.00), EASYSIMD_FLOAT64_C(     0.00) },
      {                    UINT64_MAX,                    UINT64_MAX } },
    { { EASYSIMD_FLOAT64_C(     0.00), EASYSIMD_FLOAT64_C(    85.69) },
      {                    UINT64_MAX, UINT64_C(                   0) } },
    { { EASYSIMD_FLOAT64_C(   551.75), EASYSIMD_FLOAT64_C(     0.00) },
      { UINT64_C(                   0),                    UINT64_MAX } },
    { { EASYSIMD_FLOAT64_C(     0.00), EASYSIMD_FLOAT64_C(     0.00) },
      {                    UINT64_MAX,                    UINT64_MAX } },
    { { EASYSIMD_FLOAT64_C(    36.19), EASYSIMD_FLOAT64_C(   -43.32) },
      { UINT64_C(                   0), UINT64_C(                   0) } },
    { { EASYSIMD_FLOAT64_C(  -973.94), EASYSIMD_FLOAT64_C(  -254.74) },
      { UINT64_C(                   0), UINT64_C(                   0) } },
    { { EASYSIMD_FLOAT64_C(   779.02), EASYSIMD_FLOAT64_C(   185.84) },
      { UINT64_C(                   0), UINT64_C(                   0) } },
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float64x2_t a = easysimd_vld1q_f64(test_vec[i].a);
    easysimd_uint64x2_t r = easysimd_vceqzq_f64(a);
...
static int
test_easysimd_vceqzq_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int8_t a[16];
    uint8_t r[16];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x16_t r = easysimd_vceqzq_s8(a);
...
static int
test_easysimd_vceqzq_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int16_t a[8];
    uint16_t r[8];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x8_t r = easysimd_vceqzq_s16(a);
...
static int
test_easysimd_vceqzq_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int32_t a[4];
    uint32_t r[4];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x4_t r = easysimd_vceqzq_s32(a);
    easysimd_test_arm_neon_assert_equal_u32x4(r, easysimd_vld1q_u32(test_vec[i].r));
  }
...
static int
test_easysimd_vceqzq_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int64_t a[2];
    uint64_t r[2];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint64x2_t r = easysimd_vceqzq_s64(a);
    easysimd_test_arm_neon_assert_equal_u64x2(r, easysimd_vld1q_u64(test_vec[i].r));
  }
...
static int
test_easysimd_vceqzq_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint8_t a[16];
    uint8_t r[16];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x16_t r = easysimd_vceqzq_u8(a);
...
static int
test_easysimd_vceqzq_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint16_t a[8];
    uint16_t r[8];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x8_t r = easysimd_vceqzq_u16(a);
    easysimd_test_arm_neon_assert_equal_u16x8(r, easysimd_vld1q_u16(test_vec[i].r));
  }
...
static int
test_easysimd_vceqzq_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint32_t a[4];
    uint32_t r[4];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x4_t r = easysimd_vceqzq_u32(a);
...
static int
test_easysimd_vceqzq_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint64_t a[2];
    uint64_t r[2];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint64x2_t r = easysimd_vceqzq_u64(a);
    easysimd_test_arm_neon_assert_equal_u64x2(r, easysimd_vld1q_u64(test_vec[i].r));
  }
...
static int
test_easysimd_vceqzd_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int64_t a;
    uint64_t r;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    uint64_t r = easysimd_vceqzd_s64(test_vec[i].a);
  ...
  fputc('\n', stdout);
  for (int i = 0 ; i < 8 ; i++) {
    int64_t a = (i & 1) ? INT64_C(0) : easysimd_test_codegen_random_i64();
    uint64_t r = easysimd_vceqzd_s64(a);
...
static int
test_easysimd_vceqzd_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint64_t a;
    uint64_t r;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    uint64_t r = easysimd_vceqzd_u64(test_vec[i].a);
  ...
  fputc('\n', stdout);
  for (int i = 0 ; i < 8 ; i++) {
    uint64_t a = (i & 1) ? UINT64_C(0) : easysimd_test_codegen_random_u64();
    uint64_t r = easysimd_vceqzd_u64(a);
...
static int
test_easysimd_vceqzd_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    easysimd_float64_t a;
    uint64_t r;
  } test_vec[] = {
    { EASYSIMD_FLOAT64_C(   696.29),
      UINT64_C(                   0) },
    { EASYSIMD_FLOAT64_C(     0.00),
                         UINT64_MAX },
    { EASYSIMD_FLOAT64_C(  -651.65),
      UINT64_C(                   0) },
    { EASYSIMD_FLOAT64_C(     0.00),
                         UINT64_MAX },
    { EASYSIMD_FLOAT64_C(   -50.42),
      UINT64_C(                   0) },
    { EASYSIMD_FLOAT64_C(     0.00),
                         UINT64_MAX },
    { EASYSIMD_FLOAT64_C(  -102.47),
      UINT64_C(                   0) },
    { EASYSIMD_FLOAT64_C(     0.00),
                         UINT64_MAX },
  };
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    uint64_t r = easysimd_vceqzd_f64(test_vec[i].a);
  ...
  fputc('\n', stdout);
  for (int i = 0 ; i < 8 ; i++) {
    easysimd_float64_t a = (i & 1) ? EASYSIMD_FLOAT64_C(0.0) : easysimd_test_codegen_random_f64(-1000, 1000);
    uint64_t r = easysimd_vceqzd_f64(a);
...
static int
test_easysimd_vceqzh_f16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  struct {
    easysimd_float16_t a;
    uint16_t r;
  } test_vec[] = {
    { EASYSIMD_FLOAT16_VALUE(   484.25),
      UINT16_C(    0) },
    { EASYSIMD_FLOAT16_VALUE(     0.00),
           UINT16_MAX },
    { EASYSIMD_FLOAT16_VALUE(   792.50),
      UINT16_C(    0) },
    { EASYSIMD_FLOAT16_VALUE(     0.00),
           UINT16_MAX },
    { EASYSIMD_FLOAT16_VALUE(   -25.38),
      UINT16_C(    0) },
    { EASYSIMD_FLOAT16_VALUE(     0.00),
           UINT16_MAX },
    { EASYSIMD_FLOAT16_VALUE(   -64.69),
      UINT16_C(    0) },
    { EASYSIMD_FLOAT16_VALUE(     0.00),
           UINT16_MAX }
  };
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    uint16_t r = easysimd_vceqzh_f16(test_vec[i].a);
  ...
  fputc('\n', stdout);
  for (int i = 0 ; i < 8 ; i++) {
    easysimd_float16_t a = (i & 1) ? EASYSIMD_FLOAT16_VALUE(0.0) : easysimd_test_codegen_random_f16(-1000, 1000);
    uint16_t r = easysimd_vceqzh_f16(a);
...
static int
test_easysimd_vceqzs_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    easysimd_float32_t a;
    uint32_t r;
  } test_vec[] = {
    { EASYSIMD_FLOAT32_C(    30.96),
      UINT32_C(         0) },
    { EASYSIMD_FLOAT32_C(     0.00),
                UINT32_MAX },
    { EASYSIMD_FLOAT32_C(    83.44),
      UINT32_C(         0) },
    { EASYSIMD_FLOAT32_C(     0.00),
                UINT32_MAX },
    { EASYSIMD_FLOAT32_C(  -314.27),
      UINT32_C(         0) },
    { EASYSIMD_FLOAT32_C(     0.00),
                UINT32_MAX },
    { EASYSIMD_FLOAT32_C(  -517.55),
      UINT32_C(         0) },
    { EASYSIMD_FLOAT32_C(     0.00),
                UINT32_MAX },
  };
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    uint32_t r = easysimd_vceqzs_f32(test_vec[i].a);
  ...
  fputc('\n', stdout);
  for (int i = 0 ; i < 8 ; i++) {
    easysimd_float32_t a = (i & 1) ? EASYSIMD_FLOAT32_C(0.0) : easysimd_test_codegen_random_f32(-1000, 1000);
    uint32_t r = easysimd_vceqzs_f32(a);
...
EASYSIMD_TEST_FUNC_LIST_ENTRY(vceqz_f16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vceqz_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vceqz_f64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vceqz_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vceqz_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vceqz_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vceqz_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vceqz_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vceqz_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vceqz_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vceqz_u64)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vceqzq_f16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vceqzq_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vceqzq_f64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vceqzq_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vceqzq_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vceqzq_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vceqzq_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vceqzq_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vceqzq_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vceqzq_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vceqzq_u64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vceqzd_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vceqzd_u64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vceqzd_f64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vceqzh_f16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vceqzs_f32)
