#define EASYSIMD_TEST_ARM_NEON_INSN cge

#include "test-neon.h"

/* Check that both of these work */
#if defined(__cplusplus)
  #include "../../../easysimd/arm/neon/cge.h"
#else
  #include "../../../easysimd/arm/neon.h"
#endif

static int
test_easysimd_vcge_f16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  struct {
    ...
    { { EASYSIMD_FLOAT16_VALUE(  -632.50), EASYSIMD_FLOAT16_VALUE(   581.50), EASYSIMD_FLOAT16_VALUE(  -412.25), EASYSIMD_FLOAT16_VALUE(  -375.00) },
      { EASYSIMD_FLOAT16_VALUE(  -320.00), EASYSIMD_FLOAT16_VALUE(   581.50), EASYSIMD_FLOAT16_VALUE(  -412.25), EASYSIMD_FLOAT16_VALUE(  -252.00) },
      { UINT16_C(    0),      UINT16_MAX,      UINT16_MAX, UINT16_C(    0) } },
    { { EASYSIMD_FLOAT16_VALUE(   498.25), EASYSIMD_FLOAT16_VALUE(   -49.16), EASYSIMD_FLOAT16_VALUE(   377.00), EASYSIMD_FLOAT16_VALUE(  -585.50) },
      { EASYSIMD_FLOAT16_VALUE(   818.00), EASYSIMD_FLOAT16_VALUE(   -49.16), EASYSIMD_FLOAT16_VALUE(   377.00), EASYSIMD_FLOAT16_VALUE(  -206.25) },
      { UINT16_C(    0),      UINT16_MAX,      UINT16_MAX, UINT16_C(    0) } },
    { { EASYSIMD_FLOAT16_VALUE(  -391.50), EASYSIMD_FLOAT16_VALUE(  -258.50), EASYSIMD_FLOAT16_VALUE(   -94.44), EASYSIMD_FLOAT16_VALUE(   439.25) },
      { EASYSIMD_FLOAT16_VALUE(  -122.81), EASYSIMD_FLOAT16_VALUE(  -113.81), EASYSIMD_FLOAT16_VALUE(  -782.00), EASYSIMD_FLOAT16_VALUE(   244.50) },
      { UINT16_C(    0), UINT16_C(    0),      UINT16_MAX,      UINT16_MAX } },
    { { EASYSIMD_FLOAT16_VALUE(  -363.50), EASYSIMD_FLOAT16_VALUE(  -600.00), EASYSIMD_FLOAT16_VALUE(  -807.00), EASYSIMD_FLOAT16_VALUE(   732.00) },
      { EASYSIMD_FLOAT16_VALUE(   -32.78), EASYSIMD_FLOAT16_VALUE(  -600.00), EASYSIMD_FLOAT16_VALUE(   -52.06), EASYSIMD_FLOAT16_VALUE(  -534.50) },
      { UINT16_C(    0),      UINT16_MAX, UINT16_C(    0),      UINT16_MAX } },
    { { EASYSIMD_FLOAT16_VALUE(   177.00), EASYSIMD_FLOAT16_VALUE(  -742.50), EASYSIMD_FLOAT16_VALUE(   795.50), EASYSIMD_FLOAT16_VALUE(   171.12) },
      { EASYSIMD_FLOAT16_VALUE(  -437.50), EASYSIMD_FLOAT16_VALUE(  -183.50), EASYSIMD_FLOAT16_VALUE(   795.50), EASYSIMD_FLOAT16_VALUE(   171.12) },
      {      UINT16_MAX, UINT16_C(    0),      UINT16_MAX,      UINT16_MAX } },
    { { EASYSIMD_FLOAT16_VALUE(   884.00), EASYSIMD_FLOAT16_VALUE(  -171.25), EASYSIMD_FLOAT16_VALUE(   797.00), EASYSIMD_FLOAT16_VALUE(  -648.00) },
      { EASYSIMD_FLOAT16_VALUE(   884.00), EASYSIMD_FLOAT16_VALUE(   549.00), EASYSIMD_FLOAT16_VALUE(   797.00), EASYSIMD_FLOAT16_VALUE(  -479.50) },
      {      UINT16_MAX, UINT16_C(    0),      UINT16_MAX, UINT16_C(    0) } },
    { { EASYSIMD_FLOAT16_VALUE(   426.25), EASYSIMD_FLOAT16_VALUE(  -681.00), EASYSIMD_FLOAT16_VALUE(   439.00), EASYSIMD_FLOAT16_VALUE(  -738.00) },
      { EASYSIMD_FLOAT16_VALUE(   426.25), EASYSIMD_FLOAT16_VALUE(  -681.00), EASYSIMD_FLOAT16_VALUE(   951.50), EASYSIMD_FLOAT16_VALUE(  -396.50) },
      {      UINT16_MAX,      UINT16_MAX, UINT16_C(    0), UINT16_C(    0) } },
    { { EASYSIMD_FLOAT16_VALUE(   251.25), EASYSIMD_FLOAT16_VALUE(   324.75), EASYSIMD_FLOAT16_VALUE(  -690.00), EASYSIMD_FLOAT16_VALUE(  -190.88) },
      { EASYSIMD_FLOAT16_VALUE(  -974.50), EASYSIMD_FLOAT16_VALUE(   -79.31), EASYSIMD_FLOAT16_VALUE(   244.25), EASYSIMD_FLOAT16_VALUE(   612.50) },
      {      UINT16_MAX,      UINT16_MAX, UINT16_C(    0), UINT16_C(    0) } }
  };
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x4_t r = easysimd_vcge_f16(a, b);
  ...
  fputc('\n', stdout);
  for (int i = 0 ; i < 8 ; i++) {
    easysimd_float16x4_private a_ = easysimd_float16x4_to_private(easysimd_test_arm_neon_random_f16x4(-1000.0, 1000.0));
    easysimd_float16x4_private b_ = easysimd_float16x4_to_private(easysimd_test_arm_neon_random_f16x4(-1000.0, 1000.0));
    ...
    easysimd_float16x4_t a = easysimd_float16x4_from_private(a_);
    easysimd_float16x4_t b = easysimd_float16x4_from_private(b_);
...
static int
test_easysimd_vcge_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    ...
    { { EASYSIMD_FLOAT32_C(  -762.79), EASYSIMD_FLOAT32_C(   278.49) },
      { EASYSIMD_FLOAT32_C(   573.76), EASYSIMD_FLOAT32_C(   673.25) },
      { UINT32_C(         0), UINT32_C(         0) } },
    { { EASYSIMD_FLOAT32_C(   768.48), EASYSIMD_FLOAT32_C(   971.82) },
      { EASYSIMD_FLOAT32_C(   811.98), EASYSIMD_FLOAT32_C(  -395.22) },
      { UINT32_C(         0),           UINT32_MAX } },
    { { EASYSIMD_FLOAT32_C(  -590.44), EASYSIMD_FLOAT32_C(   152.23) },
      { EASYSIMD_FLOAT32_C(  -590.44), EASYSIMD_FLOAT32_C(   152.23) },
      {           UINT32_MAX,           UINT32_MAX } },
    { { EASYSIMD_FLOAT32_C(   824.17), EASYSIMD_FLOAT32_C(   743.68) },
      { EASYSIMD_FLOAT32_C(  -356.79), EASYSIMD_FLOAT32_C(   242.15) },
      {           UINT32_MAX,           UINT32_MAX } },
    { { EASYSIMD_FLOAT32_C(   141.44), EASYSIMD_FLOAT32_C(  -148.44) },
      { EASYSIMD_FLOAT32_C(   -47.53), EASYSIMD_FLOAT32_C(  -906.36) },
      {           UINT32_MAX,           UINT32_MAX } },
    { { EASYSIMD_FLOAT32_C(  -221.36), EASYSIMD_FLOAT32_C(  -647.60) },
      { EASYSIMD_FLOAT32_C(   150.33), EASYSIMD_FLOAT32_C(  -647.60) },
      { UINT32_C(         0),           UINT32_MAX } },
    { { EASYSIMD_FLOAT32_C(  -973.68), EASYSIMD_FLOAT32_C(   554.40) },
      { EASYSIMD_FLOAT32_C(  -973.68), EASYSIMD_FLOAT32_C(  -148.92) },
      {           UINT32_MAX,           UINT32_MAX } },
    { { EASYSIMD_FLOAT32_C(   829.76), EASYSIMD_FLOAT32_C(  -725.20) },
      { EASYSIMD_FLOAT32_C(   365.78), EASYSIMD_FLOAT32_C(  -760.67) },
      {           UINT32_MAX,           UINT32_MAX } },
  };
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x2_t r = easysimd_vcge_f32(a, b);
  ...
  fputc('\n', stdout);
  for (int i = 0 ; i < 8 ; i++) {
    easysimd_float32x2_private a_ = easysimd_float32x2_to_private(easysimd_test_arm_neon_random_f32x2(-1000.0, 1000.0));
    easysimd_float32x2_private b_ = easysimd_float32x2_to_private(easysimd_test_arm_neon_random_f32x2(-1000.0, 1000.0));
    ...
    easysimd_float32x2_t a = easysimd_float32x2_from_private(a_);
    easysimd_float32x2_t b = easysimd_float32x2_from_private(b_);
...
static int
test_easysimd_vcge_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    ...
    { { EASYSIMD_FLOAT64_C(   130.39) },
      { EASYSIMD_FLOAT64_C(   996.42) },
      { UINT64_C(                   0) } },
    { { EASYSIMD_FLOAT64_C(    35.94) },
      { EASYSIMD_FLOAT64_C(    35.94) },
      {                    UINT64_MAX } },
    { { EASYSIMD_FLOAT64_C(  -578.02) },
      { EASYSIMD_FLOAT64_C(   669.25) },
      { UINT64_C(                   0) } },
    { { EASYSIMD_FLOAT64_C(   105.77) },
      { EASYSIMD_FLOAT64_C(   591.27) },
      { UINT64_C(                   0) } },
    { { EASYSIMD_FLOAT64_C(  -682.67) },
      { EASYSIMD_FLOAT64_C(  -705.46) },
      {                    UINT64_MAX } },
    { { EASYSIMD_FLOAT64_C(   880.87) },
      { EASYSIMD_FLOAT64_C(   -97.20) },
      {                    UINT64_MAX } },
    { { EASYSIMD_FLOAT64_C(   338.18) },
      { EASYSIMD_FLOAT64_C(   925.14) },
      { UINT64_C(                   0) } },
    { { EASYSIMD_FLOAT64_C(   626.85) },
      { EASYSIMD_FLOAT64_C(  -403.18) },
      {                    UINT64_MAX } },
  };
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint64x1_t r = easysimd_vcge_f64(a, b);
  ...
  fputc('\n', stdout);
  for (int i = 0 ; i < 8 ; i++) {
    easysimd_float64x1_private a_ = easysimd_float64x1_to_private(easysimd_test_arm_neon_random_f64x1(-1000.0, 1000.0));
    easysimd_float64x1_private b_ = easysimd_float64x1_to_private(easysimd_test_arm_neon_random_f64x1(-1000.0, 1000.0));
    ...
    easysimd_float64x1_t a = easysimd_float64x1_from_private(a_);
    easysimd_float64x1_t b = easysimd_float64x1_from_private(b_);
...
static int
test_easysimd_vcge_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int8_t a[8];
    int8_t b[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x8_t r = easysimd_vcge_s8(a, b);
  ...
  fputc('\n', stdout);
  for (int i = 0 ; i < 8 ; i++) {
    easysimd_int8x8_private a_ = easysimd_int8x8_to_private(easysimd_test_arm_neon_random_i8x8());
    easysimd_int8x8_private b_ = easysimd_int8x8_to_private(easysimd_test_arm_neon_random_i8x8());
    ...
    easysimd_int8x8_t a = easysimd_int8x8_from_private(a_);
    easysimd_int8x8_t b = easysimd_int8x8_from_private(b_);
...
static int
test_easysimd_vcge_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int16_t a[4];
    int16_t b[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x4_t r = easysimd_vcge_s16(a, b);
  ...
  fputc('\n', stdout);
  for (int i = 0 ; i < 8 ; i++) {
    easysimd_int16x4_private a_ = easysimd_int16x4_to_private(easysimd_test_arm_neon_random_i16x4());
    easysimd_int16x4_private b_ = easysimd_int16x4_to_private(easysimd_test_arm_neon_random_i16x4());
    ...
    easysimd_int16x4_t a = easysimd_int16x4_from_private(a_);
    easysimd_int16x4_t b = easysimd_int16x4_from_private(b_);
...
static int
test_easysimd_vcge_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t a[2];
    int32_t b[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x2_t r = easysimd_vcge_s32(a, b);
  ...
  fputc('\n', stdout);
  for (int i = 0 ; i < 8 ; i++) {
    easysimd_int32x2_private a_ = easysimd_int32x2_to_private(easysimd_test_arm_neon_random_i32x2());
    easysimd_int32x2_private b_ = easysimd_int32x2_to_private(easysimd_test_arm_neon_random_i32x2());
    ...
    easysimd_int32x2_t a = easysimd_int32x2_from_private(a_);
    easysimd_int32x2_t b = easysimd_int32x2_from_private(b_);
...
static int
test_easysimd_vcge_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int64_t a[1];
    int64_t b[1];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint64x1_t r = easysimd_vcge_s64(a, b);
  ...
  fputc('\n', stdout);
  for (int i = 0 ; i < 8 ; i++) {
    easysimd_int64x1_private a_ = easysimd_int64x1_to_private(easysimd_test_arm_neon_random_i64x1());
    easysimd_int64x1_private b_ = easysimd_int64x1_to_private(easysimd_test_arm_neon_random_i64x1());
    ...
    easysimd_int64x1_t a = easysimd_int64x1_from_private(a_);
    easysimd_int64x1_t b = easysimd_int64x1_from_private(b_);
...
static int
test_easysimd_vcge_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint8_t a[8];
    uint8_t b[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x8_t r = easysimd_vcge_u8(a, b);
  ...
  fputc('\n', stdout);
  for (int i = 0 ; i < 8 ; i++) {
    easysimd_uint8x8_private a_ = easysimd_uint8x8_to_private(easysimd_test_arm_neon_random_u8x8());
    easysimd_uint8x8_private b_ = easysimd_uint8x8_to_private(easysimd_test_arm_neon_random_u8x8());
    ...
    easysimd_uint8x8_t a = easysimd_uint8x8_from_private(a_);
    easysimd_uint8x8_t b = easysimd_uint8x8_from_private(b_);
...
static int
test_easysimd_vcge_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint16_t a[4];
    uint16_t b[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x4_t r = easysimd_vcge_u16(a, b);
  ...
  fputc('\n', stdout);
  for (int i = 0 ; i < 8 ; i++) {
    easysimd_uint16x4_private a_ = easysimd_uint16x4_to_private(easysimd_test_arm_neon_random_u16x4());
    easysimd_uint16x4_private b_ = easysimd_uint16x4_to_private(easysimd_test_arm_neon_random_u16x4());
    ...
    easysimd_uint16x4_t a = easysimd_uint16x4_from_private(a_);
    easysimd_uint16x4_t b = easysimd_uint16x4_from_private(b_);
...
static int
test_easysimd_vcge_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint32_t a[2];
    uint32_t b[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x2_t r = easysimd_vcge_u32(a, b);
  ...
  fputc('\n', stdout);
  for (int i = 0 ; i < 8 ; i++) {
    easysimd_uint32x2_private a_ = easysimd_uint32x2_to_private(easysimd_test_arm_neon_random_u32x2());
    easysimd_uint32x2_private b_ = easysimd_uint32x2_to_private(easysimd_test_arm_neon_random_u32x2());
    ...
    easysimd_uint32x2_t a = easysimd_uint32x2_from_private(a_);
    easysimd_uint32x2_t b = easysimd_uint32x2_from_private(b_);
...
static int
test_easysimd_vcge_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint64_t a[1];
    uint64_t b[1];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint64x1_t r = easysimd_vcge_u64(a, b);
  ...
  fputc('\n', stdout);
  for (int i = 0 ; i < 8 ; i++) {
    easysimd_uint64x1_private a_ = easysimd_uint64x1_to_private(easysimd_test_arm_neon_random_u64x1());
    easysimd_uint64x1_private b_ = easysimd_uint64x1_to_private(easysimd_test_arm_neon_random_u64x1());
    ...
    easysimd_uint64x1_t a = easysimd_uint64x1_from_private(a_);
    easysimd_uint64x1_t b = easysimd_uint64x1_from_private(b_);
...
static int
test_easysimd_vcgeq_f16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  struct {
    ...
    { { EASYSIMD_FLOAT16_VALUE(   489.75), EASYSIMD_FLOAT16_VALUE(  -920.50), EASYSIMD_FLOAT16_VALUE(   574.50), EASYSIMD_FLOAT16_VALUE(  -427.25),
        EASYSIMD_FLOAT16_VALUE(   798.50), EASYSIMD_FLOAT16_VALUE(   208.00), EASYSIMD_FLOAT16_VALUE(  -401.00), EASYSIMD_FLOAT16_VALUE(   154.25) },
      { EASYSIMD_FLOAT16_VALUE(   489.75), EASYSIMD_FLOAT16_VALUE(  -920.50), EASYSIMD_FLOAT16_VALUE(  -251.88), EASYSIMD_FLOAT16_VALUE(  -511.75),
        EASYSIMD_FLOAT16_VALUE(   825.00), EASYSIMD_FLOAT16_VALUE(  -212.00), EASYSIMD_FLOAT16_VALUE(   433.00), EASYSIMD_FLOAT16_VALUE(   154.25) },
      {      UINT16_MAX,      UINT16_MAX,      UINT16_MAX,      UINT16_MAX, UINT16_C(    0),      UINT16_MAX, UINT16_C(    0),      UINT16_MAX } },
    { { EASYSIMD_FLOAT16_VALUE(  -312.25), EASYSIMD_FLOAT16_VALUE(  -493.75), EASYSIMD_FLOAT16_VALUE(   637.50), EASYSIMD_FLOAT16_VALUE(   377.75),
        EASYSIMD_FLOAT16_VALUE(  -880.50), EASYSIMD_FLOAT16_VALUE(  -229.50), EASYSIMD_FLOAT16_VALUE(   -68.12), EASYSIMD_FLOAT16_VALUE(  -443.75) },
      { EASYSIMD_FLOAT16_VALUE(  -837.00), EASYSIMD_FLOAT16_VALUE(  -493.75), EASYSIMD_FLOAT16_VALUE(   128.88), EASYSIMD_FLOAT16_VALUE(   961.50),
        EASYSIMD_FLOAT16_VALUE(   714.00), EASYSIMD_FLOAT16_VALUE(   728.00), EASYSIMD_FLOAT16_VALUE(   310.50), EASYSIMD_FLOAT16_VALUE(   203.88) },
      {      UINT16_MAX,      UINT16_MAX,      UINT16_MAX, UINT16_C(    0), UINT16_C(    0), UINT16_C(    0), UINT16_C(    0), UINT16_C(    0) } },
    { { EASYSIMD_FLOAT16_VALUE(   -36.62), EASYSIMD_FLOAT16_VALUE(   773.50), EASYSIMD_FLOAT16_VALUE(  -561.50), EASYSIMD_FLOAT16_VALUE(    82.81),
        EASYSIMD_FLOAT16_VALUE(   553.50), EASYSIMD_FLOAT16_VALUE(   871.00), EASYSIMD_FLOAT16_VALUE(   145.50), EASYSIMD_FLOAT16_VALUE(   716.50) },
      { EASYSIMD_FLOAT16_VALUE(   -36.62), EASYSIMD_FLOAT16_VALUE(  -216.75), EASYSIMD_FLOAT16_VALUE(   191.00), EASYSIMD_FLOAT16_VALUE(    82.81),
        EASYSIMD_FLOAT16_VALUE(   553.50), EASYSIMD_FLOAT16_VALUE(  -877.00), EASYSIMD_FLOAT16_VALUE(   639.00), EASYSIMD_FLOAT16_VALUE(   716.50) },
      {      UINT16_MAX,      UINT16_MAX, UINT16_C(    0),      UINT16_MAX,      UINT16_MAX,      UINT16_MAX, UINT16_C(    0),      UINT16_MAX } },
    { { EASYSIMD_FLOAT16_VALUE(  -504.00), EASYSIMD_FLOAT16_VALUE(   844.00), EASYSIMD_FLOAT16_VALUE(   936.00), EASYSIMD_FLOAT16_VALUE(   621.50),
        EASYSIMD_FLOAT16_VALUE(  -635.50), EASYSIMD_FLOAT16_VALUE(  -277.50), EASYSIMD_FLOAT16_VALUE(   405.25), EASYSIMD_FLOAT16_VALUE(   543.00) },
      { EASYSIMD_FLOAT16_VALUE(  -504.00), EASYSIMD_FLOAT16_VALUE(   844.00), EASYSIMD_FLOAT16_VALUE(  -463.25), EASYSIMD_FLOAT16_VALUE(   621.50),
        EASYSIMD_FLOAT16_VALUE(   715.50), EASYSIMD_FLOAT16_VALUE(   682.00), EASYSIMD_FLOAT16_VALUE(   434.75), EASYSIMD_FLOAT16_VALUE(  -321.25) },
      {      UINT16_MAX,      UINT16_MAX,      UINT16_MAX,      UINT16_MAX, UINT16_C(    0), UINT16_C(    0), UINT16_C(    0),      UINT16_MAX } },
    { { EASYSIMD_FLOAT16_VALUE(  -492.50), EASYSIMD_FLOAT16_VALUE(   414.25), EASYSIMD_FLOAT16_VALUE(   721.00), EASYSIMD_FLOAT16_VALUE(  -128.12),
        EASYSIMD_FLOAT16_VALUE(   626.00), EASYSIMD_FLOAT16_VALUE(   268.25), EASYSIMD_FLOAT16_VALUE(   -32.38), EASYSIMD_FLOAT16_VALUE(   450.75) },
      { EASYSIMD_FLOAT16_VALUE(  -492.50), EASYSIMD_FLOAT16_VALUE(   -96.62), EASYSIMD_FLOAT16_VALUE(   345.25), EASYSIMD_FLOAT16_VALUE(  -128.12),
        EASYSIMD_FLOAT16_VALUE(   626.00), EASYSIMD_FLOAT16_VALUE(  -249.50), EASYSIMD_FLOAT16_VALUE(  -585.00), EASYSIMD_FLOAT16_VALUE(  -878.00) },
      {      UINT16_MAX,      UINT16_MAX,      UINT16_MAX,      UINT16_MAX,      UINT16_MAX,      UINT16_MAX,      UINT16_MAX,      UINT16_MAX } },
    { { EASYSIMD_FLOAT16_VALUE(   804.00), EASYSIMD_FLOAT16_VALUE(  -249.88), EASYSIMD_FLOAT16_VALUE(   -16.62), EASYSIMD_FLOAT16_VALUE(  -328.50),
        EASYSIMD_FLOAT16_VALUE(   -79.88), EASYSIMD_FLOAT16_VALUE(  -145.62), EASYSIMD_FLOAT16_VALUE(  -877.50), EASYSIMD_FLOAT16_VALUE(  -681.00) },
      { EASYSIMD_FLOAT16_VALUE(  -731.50), EASYSIMD_FLOAT16_VALUE(   652.00), EASYSIMD_FLOAT16_VALUE(   -16.62), EASYSIMD_FLOAT16_VALUE(  -328.50),
        EASYSIMD_FLOAT16_VALUE(   -79.88), EASYSIMD_FLOAT16_VALUE(   951.00), EASYSIMD_FLOAT16_VALUE(  -877.50), EASYSIMD_FLOAT16_VALUE(   427.75) },
      {      UINT16_MAX, UINT16_C(    0),      UINT16_MAX,      UINT16_MAX,      UINT16_MAX, UINT16_C(    0),      UINT16_MAX, UINT16_C(    0) } },
    { { EASYSIMD_FLOAT16_VALUE(   666.50), EASYSIMD_FLOAT16_VALUE(  -481.25), EASYSIMD_FLOAT16_VALUE(   881.00), EASYSIMD_FLOAT16_VALUE(    11.91),
        EASYSIMD_FLOAT16_VALUE(   373.00), EASYSIMD_FLOAT16_VALUE(   811.50), EASYSIMD_FLOAT16_VALUE(   400.00), EASYSIMD_FLOAT16_VALUE(   328.25) },
      { EASYSIMD_FLOAT16_VALUE(  -138.75), EASYSIMD_FLOAT16_VALUE(  -481.25), EASYSIMD_FLOAT16_VALUE(   881.00), EASYSIMD_FLOAT16_VALUE(    11.91),
        EASYSIMD_FLOAT16_VALUE(   373.00), EASYSIMD_FLOAT16_VALUE(   811.50), EASYSIMD_FLOAT16_VALUE(   331.00), EASYSIMD_FLOAT16_VALUE(   641.50) },
      {      UINT16_MAX,      UINT16_MAX,      UINT16_MAX,      UINT16_MAX,      UINT16_MAX,      UINT16_MAX,      UINT16_MAX, UINT16_C(    0) } },
    { { EASYSIMD_FLOAT16_VALUE(   903.00), EASYSIMD_FLOAT16_VALUE(  -889.00), EASYSIMD_FLOAT16_VALUE(  -207.12), EASYSIMD_FLOAT16_VALUE(  -928.00),
        EASYSIMD_FLOAT16_VALUE(  -174.38), EASYSIMD_FLOAT16_VALUE(  -798.00), EASYSIMD_FLOAT16_VALUE(   -66.38), EASYSIMD_FLOAT16_VALUE(    28.64) },
      { EASYSIMD_FLOAT16_VALUE(  -452.25), EASYSIMD_FLOAT16_VALUE(  -944.00), EASYSIMD_FLOAT16_VALUE(  -207.12), EASYSIMD_FLOAT16_VALUE(  -928.00),
        EASYSIMD_FLOAT16_VALUE(  -832.50), EASYSIMD_FLOAT16_VALUE(  -807.00), EASYSIMD_FLOAT16_VALUE(   400.00), EASYSIMD_FLOAT16_VALUE(    28.64) },
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x8_t r = easysimd_vcgeq_f16(a, b);
  ...
  fputc('\n', stdout);
  for (int i = 0 ; i < 8 ; i++) {
    easysimd_float16x8_private a_ = easysimd_float16x8_to_private(easysimd_test_arm_neon_random_f16x8(-1000.0, 1000.0));
    easysimd_float16x8_private b_ = easysimd_float16x8_to_private(easysimd_test_arm_neon_random_f16x8(-1000.0, 1000.0));
    ...
    easysimd_float16x8_t a = easysimd_float16x8_from_private(a_);
    easysimd_float16x8_t b = easysimd_float16x8_from_private(b_);
...
static int
test_easysimd_vcgeq_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    ...
    { { EASYSIMD_FLOAT32_C(  -645.35), EASYSIMD_FLOAT32_C(   906.68), EASYSIMD_FLOAT32_C(   619.69), EASYSIMD_FLOAT32_C(   579.13) },
      { EASYSIMD_FLOAT32_C(  -888.20), EASYSIMD_FLOAT32_C(   906.68), EASYSIMD_FLOAT32_C(  -502.35), EASYSIMD_FLOAT32_C(   579.13) },
      {           UINT32_MAX,           UINT32_MAX,           UINT32_MAX,           UINT32_MAX } },
    { { EASYSIMD_FLOAT32_C(   247.32), EASYSIMD_FLOAT32_C(   296.45), EASYSIMD_FLOAT32_C(   752.07), EASYSIMD_FLOAT32_C(   130.33) },
      { EASYSIMD_FLOAT32_C(    35.16), EASYSIMD_FLOAT32_C(     1.82), EASYSIMD_FLOAT32_C(   752.07), EASYSIMD_FLOAT32_C(  -668.20) },
      {           UINT32_MAX,           UINT32_MAX,           UINT32_MAX,           UINT32_MAX } },
    { { EASYSIMD_FLOAT32_C(   180.85), EASYSIMD_FLOAT32_C(   267.89), EASYSIMD_FLOAT32_C(   986.47), EASYSIMD_FLOAT32_C(   541.82) },
      { EASYSIMD_FLOAT32_C(   880.72), EASYSIMD_FLOAT32_C(  -827.97), EASYSIMD_FLOAT32_C(   567.27), EASYSIMD_FLOAT32_C(  -764.64) },
      { UINT32_C(         0),           UINT32_MAX,           UINT32_MAX,           UINT32_MAX } },
    { { EASYSIMD_FLOAT32_C(    93.64), EASYSIMD_FLOAT32_C(   529.98), EASYSIMD_FLOAT32_C(   399.13), EASYSIMD_FLOAT32_C(   278.11) },
      { EASYSIMD_FLOAT32_C(  -969.21), EASYSIMD_FLOAT32_C(  -931.35), EASYSIMD_FLOAT32_C(   399.13), EASYSIMD_FLOAT32_C(   278.11) },
      {           UINT32_MAX,           UINT32_MAX,           UINT32_MAX,           UINT32_MAX } },
    { { EASYSIMD_FLOAT32_C(   175.35), EASYSIMD_FLOAT32_C(  -839.50), EASYSIMD_FLOAT32_C(  -267.94), EASYSIMD_FLOAT32_C(  -643.81) },
      { EASYSIMD_FLOAT32_C(   175.35), EASYSIMD_FLOAT32_C(    52.39), EASYSIMD_FLOAT32_C(   966.24), EASYSIMD_FLOAT32_C(  -643.81) },
      {           UINT32_MAX, UINT32_C(         0), UINT32_C(         0),           UINT32_MAX } },
    { { EASYSIMD_FLOAT32_C(  -875.26), EASYSIMD_FLOAT32_C(   465.28), EASYSIMD_FLOAT32_C(  -563.64), EASYSIMD_FLOAT32_C(  -189.26) },
      { EASYSIMD_FLOAT32_C(  -347.77), EASYSIMD_FLOAT32_C(   468.68), EASYSIMD_FLOAT32_C(   608.55), EASYSIMD_FLOAT32_C(   745.87) },
      { UINT32_C(         0), UINT32_C(         0), UINT32_C(         0), UINT32_C(         0) } },
    { { EASYSIMD_FLOAT32_C(  -945.88), EASYSIMD_FLOAT32_C(  -284.00), EASYSIMD_FLOAT32_C(  -692.44), EASYSIMD_FLOAT32_C(    92.60) },
      { EASYSIMD_FLOAT32_C(  -840.71), EASYSIMD_FLOAT32_C(  -284.00), EASYSIMD_FLOAT32_C(   819.48), EASYSIMD_FLOAT32_C(    92.60) },
      { UINT32_C(         0),           UINT32_MAX, UINT32_C(         0),           UINT32_MAX } },
    { { EASYSIMD_FLOAT32_C(   603.93), EASYSIMD_FLOAT32_C(  -693.95), EASYSIMD_FLOAT32_C(  -874.81), EASYSIMD_FLOAT32_C(   462.62) },
      { EASYSIMD_FLOAT32_C(   337.88), EASYSIMD_FLOAT32_C(  -693.95), EASYSIMD_FLOAT32_C(  -874.81), EASYSIMD_FLOAT32_C(   462.62) },
      {           UINT32_MAX,           UINT32_MAX,           UINT32_MAX,           UINT32_MAX } },
  };
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x4_t r = easysimd_vcgeq_f32(a, b);
  ...
  fputc('\n', stdout);
  for (int i = 0 ; i < 8 ; i++) {
    easysimd_float32x4_private a_ = easysimd_float32x4_to_private(easysimd_test_arm_neon_random_f32x4(-1000.0, 1000.0));
    easysimd_float32x4_private b_ = easysimd_float32x4_to_private(easysimd_test_arm_neon_random_f32x4(-1000.0, 1000.0));
    ...
    easysimd_float32x4_t a = easysimd_float32x4_from_private(a_);
    easysimd_float32x4_t b = easysimd_float32x4_from_private(b_);
...
static int
test_easysimd_vcgeq_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    ...
    { { EASYSIMD_FLOAT64_C(   109.93), EASYSIMD_FLOAT64_C(  -385.27) },
      { EASYSIMD_FLOAT64_C(   133.89), EASYSIMD_FLOAT64_C(   181.08) },
      { UINT64_C(                   0), UINT64_C(                   0) } },
    { { EASYSIMD_FLOAT64_C(   530.41), EASYSIMD_FLOAT64_C(  -444.63) },
      { EASYSIMD_FLOAT64_C(   530.41), EASYSIMD_FLOAT64_C(  -444.63) },
      {                    UINT64_MAX,                    UINT64_MAX } },
    { { EASYSIMD_FLOAT64_C(  -131.75), EASYSIMD_FLOAT64_C(   898.49) },
      { EASYSIMD_FLOAT64_C(   524.05), EASYSIMD_FLOAT64_C(   898.49) },
      { UINT64_C(                   0),                    UINT64_MAX } },
    { { EASYSIMD_FLOAT64_C(    -9.19), EASYSIMD_FLOAT64_C(   -76.59) },
      { EASYSIMD_FLOAT64_C(    -9.19), EASYSIMD_FLOAT64_C(   -76.59) },
      {                    UINT64_MAX,                    UINT64_MAX } },
    { { EASYSIMD_FLOAT64_C(   751.31), EASYSIMD_FLOAT64_C(    63.65) },
      { EASYSIMD_FLOAT64_C(   403.25), EASYSIMD_FLOAT64_C(  -261.55) },
      {                    UINT64_MAX,                    UINT64_MAX } },
    { { EASYSIMD_FLOAT64_C(  -195.23), EASYSIMD_FLOAT64_C(   820.28) },
      { EASYSIMD_FLOAT64_C(   857.78), EASYSIMD_FLOAT64_C(   938.65) },
      { UINT64_C(                   0), UINT64_C(                   0) } },
    { { EASYSIMD_FLOAT64_C(   569.69), EASYSIMD_FLOAT64_C(   100.11) },
      { EASYSIMD_FLOAT64_C(   861.54), EASYSIMD_FLOAT64_C(   100.11) },
      { UINT64_C(                   0),                    UINT64_MAX } },
    { { EASYSIMD_FLOAT64_C(    58.64), EASYSIMD_FLOAT64_C(  -798.26) },
      { EASYSIMD_FLOAT64_C(    58.64), EASYSIMD_FLOAT64_C(  -185.24) },
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint64x2_t r = easysimd_vcgeq_f64(a, b);
  ...
  fputc('\n', stdout);
  for (int i = 0 ; i < 8 ; i++) {
    easysimd_float64x2_private a_ = easysimd_float64x2_to_private(easysimd_test_arm_neon_random_f64x2(-1000.0, 1000.0));
    easysimd_float64x2_private b_ = easysimd_float64x2_to_private(easysimd_test_arm_neon_random_f64x2(-1000.0, 1000.0));
    ...
    easysimd_float64x2_t a = easysimd_float64x2_from_private(a_);
    easysimd_float64x2_t b = easysimd_float64x2_from_private(b_);
...
static int
test_easysimd_vcgeq_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int8_t a[16];
    int8_t b[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x16_t r = easysimd_vcgeq_s8(a, b);
  ...
  fputc('\n', stdout);
  for (int i = 0 ; i < 8 ; i++) {
    easysimd_int8x16_private a_ = easysimd_int8x16_to_private(easysimd_test_arm_neon_random_i8x16());
    easysimd_int8x16_private b_ = easysimd_int8x16_to_private(easysimd_test_arm_neon_random_i8x16());
    ...
    easysimd_int8x16_t a = easysimd_int8x16_from_private(a_);
    easysimd_int8x16_t b = easysimd_int8x16_from_private(b_);
...
static int
test_easysimd_vcgeq_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int16_t a[8];
    int16_t b[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x8_t r = easysimd_vcgeq_s16(a, b);
  ...
  fputc('\n', stdout);
  for (int i = 0 ; i < 8 ; i++) {
    easysimd_int16x8_private a_ = easysimd_int16x8_to_private(easysimd_test_arm_neon_random_i16x8());
    easysimd_int16x8_private b_ = easysimd_int16x8_to_private(easysimd_test_arm_neon_random_i16x8());
    ...
    easysimd_int16x8_t a = easysimd_int16x8_from_private(a_);
    easysimd_int16x8_t b = easysimd_int16x8_from_private(b_);
...
static int
test_easysimd_vcgeq_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t a[4];
    int32_t b[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x4_t r = easysimd_vcgeq_s32(a, b);
  ...
  fputc('\n', stdout);
  for (int i = 0 ; i < 8 ; i++) {
    easysimd_int32x4_private a_ = easysimd_int32x4_to_private(easysimd_test_arm_neon_random_i32x4());
    easysimd_int32x4_private b_ = easysimd_int32x4_to_private(easysimd_test_arm_neon_random_i32x4());
    ...
    easysimd_int32x4_t a = easysimd_int32x4_from_private(a_);
    easysimd_int32x4_t b = easysimd_int32x4_from_private(b_);
...
static int
test_easysimd_vcgeq_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int64_t a[2];
    int64_t b[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint64x2_t r = easysimd_vcgeq_s64(a, b);
  ...
  fputc('\n', stdout);
  for (int i = 0 ; i < 8 ; i++) {
    easysimd_int64x2_private a_ = easysimd_int64x2_to_private(easysimd_test_arm_neon_random_i64x2());
    easysimd_int64x2_private b_ = easysimd_int64x2_to_private(easysimd_test_arm_neon_random_i64x2());
    ...
    easysimd_int64x2_t a = easysimd_int64x2_from_private(a_);
    easysimd_int64x2_t b = easysimd_int64x2_from_private(b_);
...
static int
test_easysimd_vcgeq_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint8_t a[16];
    uint8_t b[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x16_t r = easysimd_vcgeq_u8(a, b);
  ...
  fputc('\n', stdout);
  for (int i = 0 ; i < 8 ; i++) {
    easysimd_uint8x16_private a_ = easysimd_uint8x16_to_private(easysimd_test_arm_neon_random_u8x16());
    easysimd_uint8x16_private b_ = easysimd_uint8x16_to_private(easysimd_test_arm_neon_random_u8x16());
    ...
    easysimd_uint8x16_t a = easysimd_uint8x16_from_private(a_);
    easysimd_uint8x16_t b = easysimd_uint8x16_from_private(b_);
...
static int
test_easysimd_vcgeq_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint16_t a[8];
    uint16_t b[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x8_t r = easysimd_vcgeq_u16(a, b);
  ...
  fputc('\n', stdout);
  for (int i = 0 ; i < 8 ; i++) {
    easysimd_uint16x8_private a_ = easysimd_uint16x8_to_private(easysimd_test_arm_neon_random_u16x8());
    easysimd_uint16x8_private b_ = easysimd_uint16x8_to_private(easysimd_test_arm_neon_random_u16x8());
    ...
    easysimd_uint16x8_t a = easysimd_uint16x8_from_private(a_);
    easysimd_uint16x8_t b = easysimd_uint16x8_from_private(b_);
...
static int
test_easysimd_vcgeq_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint32_t a[4];
    uint32_t b[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x4_t r = easysimd_vcgeq_u32(a, b);
  ...
  fputc('\n', stdout);
  for (int i = 0 ; i < 8 ; i++) {
    easysimd_uint32x4_private a_ = easysimd_uint32x4_to_private(easysimd_test_arm_neon_random_u32x4());
    easysimd_uint32x4_private b_ = easysimd_uint32x4_to_private(easysimd_test_arm_neon_random_u32x4());
    ...
    easysimd_uint32x4_t a = easysimd_uint32x4_from_private(a_);
    easysimd_uint32x4_t b = easysimd_uint32x4_from_private(b_);
...
static int
test_easysimd_vcgeq_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint64_t a[2];
    uint64_t b[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint64x2_t r = easysimd_vcgeq_u64(a, b);
  ...
  fputc('\n', stdout);
  for (int i = 0 ; i < 8 ; i++) {
    easysimd_uint64x2_private a_ = easysimd_uint64x2_to_private(easysimd_test_arm_neon_random_u64x2());
    easysimd_uint64x2_private b_ = easysimd_uint64x2_to_private(easysimd_test_arm_neon_random_u64x2());
    ...
    easysimd_uint64x2_t a = easysimd_uint64x2_from_private(a_);
    easysimd_uint64x2_t b = easysimd_uint64x2_from_private(b_);
...
static int
test_easysimd_vcged_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    ...
    { EASYSIMD_FLOAT64_C(  -955.88),
      EASYSIMD_FLOAT64_C(  -521.65),
      UINT64_C(                   0) },
    { EASYSIMD_FLOAT64_C(  -897.79),
      EASYSIMD_FLOAT64_C(   470.54),
      UINT64_C(                   0) },
    { EASYSIMD_FLOAT64_C(  -745.84),
      EASYSIMD_FLOAT64_C(   428.02),
      UINT64_C(                   0) },
    { EASYSIMD_FLOAT64_C(   -40.46),
      EASYSIMD_FLOAT64_C(  -507.83),
                          UINT64_MAX },
    { EASYSIMD_FLOAT64_C(  -316.79),
      EASYSIMD_FLOAT64_C(  -212.59),
      UINT64_C(                   0) },
    { EASYSIMD_FLOAT64_C(   310.98),
      EASYSIMD_FLOAT64_C(   416.70),
      UINT64_C(                   0) },
    { EASYSIMD_FLOAT64_C(  -618.79),
      EASYSIMD_FLOAT64_C(  -147.59),
      UINT64_C(                   0) },
    { EASYSIMD_FLOAT64_C(   -21.02),
      EASYSIMD_FLOAT64_C(   -49.79),
                          UINT64_MAX }
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    uint64_t r = easysimd_vcged_f64(test_vec[i].a, test_vec[i].b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    uint64_t r = easysimd_vcged_f64(a, b);
...
static int
test_easysimd_vcged_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int64_t a;
    int64_t b;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    uint64_t r = easysimd_vcged_s64(test_vec[i].a, test_vec[i].b);
    easysimd_assert_equal_u64(r, test_vec[i].r);
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    int64_t b = easysimd_test_codegen_random_i64();
    uint64_t r = easysimd_vcged_s64(a, b);

    easysimd_test_codegen_write_i64(2, a, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_codegen_write_i64(2, b, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_codegen_write_u64(2, r, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
#endif
...
static int
test_easysimd_vcged_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint64_t a;
    uint64_t b;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    uint64_t r = easysimd_vcged_u64(test_vec[i].a, test_vec[i].b);
    easysimd_assert_equal_u64(r, test_vec[i].r);
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    uint64_t b = easysimd_test_codegen_random_u64();
    uint64_t r = easysimd_vcged_u64(a, b);

    easysimd_test_codegen_write_u64(2, a, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_codegen_write_u64(2, b, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_codegen_write_u64(2, r, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
#endif
...
static int
test_easysimd_vcgeh_f16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  struct {
    easysimd_float16_t a;
    easysimd_float16_t b;
    uint16_t r;
  } test_vec[] = {
    { EASYSIMD_FLOAT16_VALUE(   897.00),
      EASYSIMD_FLOAT16_VALUE(   715.00),
           UINT16_MAX },
    { EASYSIMD_FLOAT16_VALUE(   564.50),
      EASYSIMD_FLOAT16_VALUE(   345.75),
           UINT16_MAX },
    { EASYSIMD_FLOAT16_VALUE(  -134.25),
      EASYSIMD_FLOAT16_VALUE(   360.75),
      UINT16_C(    0) },
    { EASYSIMD_FLOAT16_VALUE(  -867.00),
      EASYSIMD_FLOAT16_VALUE(  -405.75),
      UINT16_C(    0) },
    { EASYSIMD_FLOAT16_VALUE(  -559.50),
      EASYSIMD_FLOAT16_VALUE(   946.50),
      UINT16_C(    0) },
    { EASYSIMD_FLOAT16_VALUE(   518.50),
      EASYSIMD_FLOAT16_VALUE(  -917.00),
           UINT16_MAX },
    { EASYSIMD_FLOAT16_VALUE(  -144.12),
      EASYSIMD_FLOAT16_VALUE(   -37.66),
      UINT16_C(    0) },
    { EASYSIMD_FLOAT16_VALUE(  -184.62),
      EASYSIMD_FLOAT16_VALUE(    14.89),
      UINT16_C(    0) },
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    uint16_t r = easysimd_vcgeh_f16(test_vec[i].a, test_vec[i].b);
  ...
  fputc('\n', stdout);
  for (int i = 0 ; i < 8 ; i++) {
    easysimd_float16_t a = easysimd_test_codegen_random_f16(-1000, 1000);
    easysimd_float16_t b = easysimd_test_codegen_random_f16(-1000, 1000);
    uint16_t r = easysimd_vcgeh_f16(a, b);
...
static int
test_easysimd_vcges_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    ...
    { EASYSIMD_FLOAT32_C(   -21.21),
      EASYSIMD_FLOAT32_C(   300.24),
      UINT32_C(         0) },
    { EASYSIMD_FLOAT32_C(   438.56),
      EASYSIMD_FLOAT32_C(   495.77),
      UINT32_C(         0) },
    { EASYSIMD_FLOAT32_C(   -26.88),
      EASYSIMD_FLOAT32_C(  -737.02),
                UINT32_MAX },
    { EASYSIMD_FLOAT32_C(  -990.02),
      EASYSIMD_FLOAT32_C(  -429.89),
      UINT32_C(         0) },
    { EASYSIMD_FLOAT32_C(  -168.07),
      EASYSIMD_FLOAT32_C(   593.84),
      UINT32_C(         0) },
    { EASYSIMD_FLOAT32_C(  -467.82),
      EASYSIMD_FLOAT32_C(  -348.61),
      UINT32_C(         0) },
    { EASYSIMD_FLOAT32_C(   492.16),
      EASYSIMD_FLOAT32_C(   -45.04),
                UINT32_MAX },
    { EASYSIMD_FLOAT32_C(   -31.77),
      EASYSIMD_FLOAT32_C(  -566.37),
                UINT32_MAX }
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    uint32_t r = easysimd_vcges_f32(test_vec[i].a, test_vec[i].b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    uint32_t r = easysimd_vcges_f32(a, b);
...
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcge_f16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcge_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcge_f64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcge_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcge_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcge_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcge_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcge_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcge_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcge_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcge_u64)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vcgeq_f16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcgeq_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcgeq_f64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcgeq_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcgeq_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcgeq_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcgeq_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcgeq_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcgeq_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcgeq_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcgeq_u64)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vcged_f64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcged_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcged_u64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcgeh_f16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcges_f32)
