#define EASYSIMD_TEST_ARM_NEON_INSN cgez

#include "test-neon.h"

/* Check that both of these work */
#if defined(__cplusplus)
  #include "../../../easysimd/arm/neon/cgez.h"
#else
  #include "../../../easysimd/arm/neon.h"
#endif

static int
test_easysimd_vcgez_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    easysimd_float32 a[2];
    uint32_t r[2];
  } test_vec[] = {
    { { EASYSIMD_FLOAT32_C(  -133.39), EASYSIMD_FLOAT32_C(   805.67) },
      { UINT32_C(         0),           UINT32_MAX } },
    { { EASYSIMD_FLOAT32_C(  -910.74), EASYSIMD_FLOAT32_C(   710.63) },
      { UINT32_C(         0),           UINT32_MAX } },
    { { EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(   230.14) },
      {           UINT32_MAX,           UINT32_MAX } },
    { { EASYSIMD_FLOAT32_C(   994.82), EASYSIMD_FLOAT32_C(  -639.98) },
      {           UINT32_MAX, UINT32_C(         0) } },
    { { EASYSIMD_FLOAT32_C(   -48.27), EASYSIMD_FLOAT32_C(     0.00) },
      { UINT32_C(         0),           UINT32_MAX } },
    { { EASYSIMD_FLOAT32_C(    98.24), EASYSIMD_FLOAT32_C(     0.00) },
      {           UINT32_MAX,           UINT32_MAX } },
    { { EASYSIMD_FLOAT32_C(   -63.24), EASYSIMD_FLOAT32_C(   224.59) },
      { UINT32_C(         0),           UINT32_MAX } },
    { { EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(    43.88) },
      {           UINT32_MAX,           UINT32_MAX } },
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float32x2_t a = easysimd_vld1_f32(test_vec[i].a);
    easysimd_uint32x2_t r = easysimd_vcgez_f32(a);
...
static int
test_easysimd_vcgez_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    easysimd_float64 a[1];
    uint64_t r[1];
  } test_vec[] = {
    { { EASYSIMD_FLOAT64_C(   625.39) },
      {                    UINT64_MAX } },
    { { EASYSIMD_FLOAT64_C(   786.84) },
      {                    UINT64_MAX } },
    { { EASYSIMD_FLOAT64_C(   381.01) },
      {                    UINT64_MAX } },
    { { EASYSIMD_FLOAT64_C(     0.00) },
      {                    UINT64_MAX } },
    { { EASYSIMD_FLOAT64_C(  -664.71) },
      { UINT64_C(                   0) } },
    { { EASYSIMD_FLOAT64_C(   389.46) },
      {                    UINT64_MAX } },
    { { EASYSIMD_FLOAT64_C(  -675.33) },
      { UINT64_C(                   0) } },
    { { EASYSIMD_FLOAT64_C(   539.16) },
      {                    UINT64_MAX } },
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float64x1_t a = easysimd_vld1_f64(test_vec[i].a);
    easysimd_uint64x1_t r = easysimd_vcgez_f64(a);
...
static int
test_easysimd_vcgez_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int8_t a[8];
    uint8_t r[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x8_t r = easysimd_vcgez_s8(a);
...
static int
test_easysimd_vcgez_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int16_t a[4];
    uint16_t r[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x4_t r = easysimd_vcgez_s16(a);
...
static int
test_easysimd_vcgez_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t a[2];
    uint32_t r[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x2_t r = easysimd_vcgez_s32(a);
...
static int
test_easysimd_vcgez_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int64_t a[1];
    uint64_t r[1];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint64x1_t r = easysimd_vcgez_s64(a);
...
static int
test_easysimd_vcgezq_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    easysimd_float32 a[4];
    uint32_t r[4];
  } test_vec[] = {
    { { EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(  -369.77), EASYSIMD_FLOAT32_C(     0.00) },
      {           UINT32_MAX,           UINT32_MAX, UINT32_C(         0),           UINT32_MAX } },
    { { EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(   -41.03), EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(     0.00) },
      {           UINT32_MAX, UINT32_C(         0),           UINT32_MAX,           UINT32_MAX } },
    { { EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(   522.70), EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(     0.00) },
      {           UINT32_MAX,           UINT32_MAX,           UINT32_MAX,           UINT32_MAX } },
    { { EASYSIMD_FLOAT32_C(    98.50), EASYSIMD_FLOAT32_C(   454.13), EASYSIMD_FLOAT32_C(   842.39), EASYSIMD_FLOAT32_C(    35.69) },
      {           UINT32_MAX,           UINT32_MAX,           UINT32_MAX,           UINT32_MAX } },
    { { EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(   843.79), EASYSIMD_FLOAT32_C(  -966.00), EASYSIMD_FLOAT32_C(    39.60) },
      {           UINT32_MAX,           UINT32_MAX, UINT32_C(         0),           UINT32_MAX } },
    { { EASYSIMD_FLOAT32_C(   717.22), EASYSIMD_FLOAT32_C(   165.47), EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(   907.07) },
      {           UINT32_MAX,           UINT32_MAX,           UINT32_MAX,           UINT32_MAX } },
    { { EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(  -252.33), EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(   684.67) },
      {           UINT32_MAX, UINT32_C(         0),           UINT32_MAX,           UINT32_MAX } },
    { { EASYSIMD_FLOAT32_C(    57.60), EASYSIMD_FLOAT32_C(   844.67), EASYSIMD_FLOAT32_C(  -357.97), EASYSIMD_FLOAT32_C(  -478.05) },
      {           UINT32_MAX,           UINT32_MAX, UINT32_C(         0), UINT32_C(         0) } },
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float32x4_t a = easysimd_vld1q_f32(test_vec[i].a);
    easysimd_uint32x4_t r = easysimd_vcgezq_f32(a);
...
static int
test_easysimd_vcgezq_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    easysimd_float64 a[2];
    uint64_t r[2];
  } test_vec[] = {
    { { EASYSIMD_FLOAT64_C(   254.72), EASYSIMD_FLOAT64_C(   721.02) },
      {                    UINT64_MAX,                    UINT64_MAX } },
    { { EASYSIMD_FLOAT64_C(  -171.93), EASYSIMD_FLOAT64_C(     0.00) },
      { UINT64_C(                   0),                    UINT64_MAX } },
    { { EASYSIMD_FLOAT64_C(     0.00), EASYSIMD_FLOAT64_C(   341.16) },
      {                    UINT64_MAX,                    UINT64_MAX } },
    { { EASYSIMD_FLOAT64_C(    18.66), EASYSIMD_FLOAT64_C(     0.00) },
      {                    UINT64_MAX,                    UINT64_MAX } },
    { { EASYSIMD_FLOAT64_C(     0.00), EASYSIMD_FLOAT64_C(     0.00) },
      {                    UINT64_MAX,                    UINT64_MAX } },
    { { EASYSIMD_FLOAT64_C(  -339.50), EASYSIMD_FLOAT64_C(    60.07) },
      { UINT64_C(                   0),                    UINT64_MAX } },
    { { EASYSIMD_FLOAT64_C(   298.41), EASYSIMD_FLOAT64_C(  -244.46) },
      {                    UINT64_MAX, UINT64_C(                   0) } },
    { { EASYSIMD_FLOAT64_C(  -617.84), EASYSIMD_FLOAT64_C(  -233.87) },
      { UINT64_C(                   0), UINT64_C(                   0) } },
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float64x2_t a = easysimd_vld1q_f64(test_vec[i].a);
    easysimd_uint64x2_t r = easysimd_vcgezq_f64(a);
...
static int
test_easysimd_vcgezq_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int8_t a[16];
    uint8_t r[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x16_t r = easysimd_vcgezq_s8(a);
...
static int
test_easysimd_vcgezq_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int16_t a[8];
    uint16_t r[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x8_t r = easysimd_vcgezq_s16(a);
...
static int
test_easysimd_vcgezq_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t a[4];
    uint32_t r[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x4_t r = easysimd_vcgezq_s32(a);
...
static int
test_easysimd_vcgezq_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int64_t a[2];
    uint64_t r[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint64x2_t r = easysimd_vcgezq_s64(a);
...
static int
test_easysimd_vcgezd_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    easysimd_float64_t a;
    uint64_t r;
  } test_vec[] = {
    { EASYSIMD_FLOAT64_C(   126.90),
                          UINT64_MAX },
    { EASYSIMD_FLOAT64_C(  -382.51),
      UINT64_C(                   0) },
    { EASYSIMD_FLOAT64_C(   304.15),
                          UINT64_MAX },
    { EASYSIMD_FLOAT64_C(  -202.88),
      UINT64_C(                   0) },
    { EASYSIMD_FLOAT64_C(   860.05),
                          UINT64_MAX },
    { EASYSIMD_FLOAT64_C(   642.60),
                          UINT64_MAX },
    { EASYSIMD_FLOAT64_C(   832.24),
                          UINT64_MAX },
    { EASYSIMD_FLOAT64_C(   684.01),
                          UINT64_MAX }
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    uint64_t r = easysimd_vcgezd_f64(test_vec[i].a);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    uint64_t r = easysimd_vcgezd_f64(a);
...
static int
test_easysimd_vcgezd_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int64_t a;
    uint64_t r;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    uint64_t r = easysimd_vcgezd_s64(test_vec[i].a);
    easysimd_assert_equal_u64(r, test_vec[i].r);
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    uint64_t r = easysimd_vcgezd_s64(a);
...
static int
test_easysimd_vcgezs_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    easysimd_float32_t a;
    uint32_t r;
  } test_vec[] = {
    { EASYSIMD_FLOAT32_C(   176.04),
                UINT32_MAX },
    { EASYSIMD_FLOAT32_C(  -536.84),
      UINT32_C(         0) },
    { EASYSIMD_FLOAT32_C(  -169.81),
      UINT32_C(         0) },
    { EASYSIMD_FLOAT32_C(   537.49),
                UINT32_MAX },
    { EASYSIMD_FLOAT32_C(  -441.18),
      UINT32_C(         0) },
    { EASYSIMD_FLOAT32_C(  -995.79),
      UINT32_C(         0) },
    { EASYSIMD_FLOAT32_C(  -666.46),
      UINT32_C(         0) },
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    uint32_t r = easysimd_vcgezs_f32(test_vec[i].a);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    uint32_t r = easysimd_vcgezs_f32(a);
...
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcgez_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcgez_f64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcgez_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcgez_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcgez_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcgez_s64)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vcgezq_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcgezq_f64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcgezq_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcgezq_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcgezq_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcgezq_s64)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vcgezd_f64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcgezd_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcgezs_f32)
