#define EASYSIMD_TEST_ARM_NEON_INSN cgt

#include "test-neon.h"

/* Check that both of these work */
#if defined(__cplusplus)
  #include "../../../easysimd/arm/neon/cgt.h"
#else
  #include "../../../easysimd/arm/neon.h"
#endif

static int
test_easysimd_vcgt_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    ...
    { { EASYSIMD_FLOAT32_C(  -594.36), EASYSIMD_FLOAT32_C(  -430.71) },
      { EASYSIMD_FLOAT32_C(    66.10), EASYSIMD_FLOAT32_C(   318.22) },
      { UINT32_C(         0), UINT32_C(         0) } },
    { { EASYSIMD_FLOAT32_C(   895.57), EASYSIMD_FLOAT32_C(   -28.91) },
      { EASYSIMD_FLOAT32_C(   945.51), EASYSIMD_FLOAT32_C(   -28.91) },
      { UINT32_C(         0), UINT32_C(         0) } },
    { { EASYSIMD_FLOAT32_C(  -484.25), EASYSIMD_FLOAT32_C(  -208.16) },
      { EASYSIMD_FLOAT32_C(   869.60), EASYSIMD_FLOAT32_C(  -208.16) },
      { UINT32_C(         0), UINT32_C(         0) } },
    { { EASYSIMD_FLOAT32_C(  -169.59), EASYSIMD_FLOAT32_C(   957.55) },
      { EASYSIMD_FLOAT32_C(  -169.59), EASYSIMD_FLOAT32_C(   126.36) },
      { UINT32_C(         0),           UINT32_MAX } },
    { { EASYSIMD_FLOAT32_C(   853.75), EASYSIMD_FLOAT32_C(  -413.58) },
      { EASYSIMD_FLOAT32_C(   784.06), EASYSIMD_FLOAT32_C(  -413.58) },
      {           UINT32_MAX, UINT32_C(         0) } },
    { { EASYSIMD_FLOAT32_C(  -413.85), EASYSIMD_FLOAT32_C(   334.07) },
      { EASYSIMD_FLOAT32_C(  -413.85), EASYSIMD_FLOAT32_C(  -621.67) },
      { UINT32_C(         0),           UINT32_MAX } },
    { { EASYSIMD_FLOAT32_C(  -664.52), EASYSIMD_FLOAT32_C(  -452.14) },
      { EASYSIMD_FLOAT32_C(  -360.16), EASYSIMD_FLOAT32_C(  -719.02) },
      { UINT32_C(         0),           UINT32_MAX } },
    { { EASYSIMD_FLOAT32_C(  -452.99), EASYSIMD_FLOAT32_C(  -583.39) },
      { EASYSIMD_FLOAT32_C(    29.10), EASYSIMD_FLOAT32_C(  -583.39) },
      { UINT32_C(         0), UINT32_C(         0) } },
  };
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x2_t r = easysimd_vcgt_f32(a, b);
...
static int
test_easysimd_vcgt_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    ...
    { { EASYSIMD_FLOAT64_C(   -24.01) },
      { EASYSIMD_FLOAT64_C(   -24.01) },
      { UINT64_C(                   0) } },
    { { EASYSIMD_FLOAT64_C(  -765.41) },
      { EASYSIMD_FLOAT64_C(  -856.24) },
      {                    UINT64_MAX } },
    { { EASYSIMD_FLOAT64_C(  -723.94) },
      { EASYSIMD_FLOAT64_C(   639.04) },
      { UINT64_C(                   0) } },
    { { EASYSIMD_FLOAT64_C(  -780.40) },
      { EASYSIMD_FLOAT64_C(  -780.40) },
      { UINT64_C(                   0) } },
    { { EASYSIMD_FLOAT64_C(   140.87) },
      { EASYSIMD_FLOAT64_C(   140.87) },
      { UINT64_C(                   0) } },
    { { EASYSIMD_FLOAT64_C(   -29.24) },
      { EASYSIMD_FLOAT64_C(   -30.09) },
      {                    UINT64_MAX } },
    { { EASYSIMD_FLOAT64_C(  -911.69) },
      { EASYSIMD_FLOAT64_C(  -396.28) },
      { UINT64_C(                   0) } },
    { { EASYSIMD_FLOAT64_C(    20.33) },
      { EASYSIMD_FLOAT64_C(    20.33) },
      { UINT64_C(                   0) } },
  };
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint64x1_t r = easysimd_vcgt_f64(a, b);
...
static int
test_easysimd_vcgt_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int8_t a[8];
    int8_t b[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x8_t r = easysimd_vcgt_s8(a, b);
...
static int
test_easysimd_vcgt_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int16_t a[4];
    int16_t b[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x4_t r = easysimd_vcgt_s16(a, b);
...
static int
test_easysimd_vcgt_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t a[2];
    int32_t b[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x2_t r = easysimd_vcgt_s32(a, b);
...
static int
test_easysimd_vcgt_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int64_t a[1];
    int64_t b[1];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint64x1_t r = easysimd_vcgt_s64(a, b);
...
static int
test_easysimd_vcgt_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint8_t a[8];
    uint8_t b[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x8_t r = easysimd_vcgt_u8(a, b);
...
static int
test_easysimd_vcgt_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint16_t a[4];
    uint16_t b[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x4_t r = easysimd_vcgt_u16(a, b);
...
static int
test_easysimd_vcgt_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint32_t a[2];
    uint32_t b[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x2_t r = easysimd_vcgt_u32(a, b);
...
static int
test_easysimd_vcgt_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint64_t a[1];
    uint64_t b[1];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint64x1_t r = easysimd_vcgt_u64(a, b);
...
static int
test_easysimd_vcgtq_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    ...
    { { EASYSIMD_FLOAT32_C(  -259.46), EASYSIMD_FLOAT32_C(  -774.65), EASYSIMD_FLOAT32_C(   628.16), EASYSIMD_FLOAT32_C(  -992.75) },
      { EASYSIMD_FLOAT32_C(  -259.46), EASYSIMD_FLOAT32_C(  -774.65), EASYSIMD_FLOAT32_C(   628.16), EASYSIMD_FLOAT32_C(  -707.60) },
      { UINT32_C(         0), UINT32_C(         0), UINT32_C(         0), UINT32_C(         0) } },
    { { EASYSIMD_FLOAT32_C(   127.08), EASYSIMD_FLOAT32_C(    51.79), EASYSIMD_FLOAT32_C(   966.55), EASYSIMD_FLOAT32_C(   -31.51) },
      { EASYSIMD_FLOAT32_C(    36.37), EASYSIMD_FLOAT32_C(    73.30), EASYSIMD_FLOAT32_C(   646.26), EASYSIMD_FLOAT32_C(   -31.51) },
      {           UINT32_MAX, UINT32_C(         0),           UINT32_MAX, UINT32_C(         0) } },
    { { EASYSIMD_FLOAT32_C(   466.70), EASYSIMD_FLOAT32_C(   282.12), EASYSIMD_FLOAT32_C(  -570.04), EASYSIMD_FLOAT32_C(  -866.16) },
      { EASYSIMD_FLOAT32_C(  -215.26), EASYSIMD_FLOAT32_C(  -475.25), EASYSIMD_FLOAT32_C(  -570.04), EASYSIMD_FLOAT32_C(  -866.16) },
      {           UINT32_MAX,           UINT32_MAX, UINT32_C(         0), UINT32_C(         0) } },
    { { EASYSIMD_FLOAT32_C(  -574.22), EASYSIMD_FLOAT32_C(    -2.51), EASYSIMD_FLOAT32_C(  -310.68), EASYSIMD_FLOAT32_C(  -504.85) },
      { EASYSIMD_FLOAT32_C(  -574.22), EASYSIMD_FLOAT32_C(    -2.51), EASYSIMD_FLOAT32_C(  -697.28), EASYSIMD_FLOAT32_C(   552.86) },
      { UINT32_C(         0), UINT32_C(         0),           UINT32_MAX, UINT32_C(         0) } },
    { { EASYSIMD_FLOAT32_C(   342.57), EASYSIMD_FLOAT32_C(   504.54), EASYSIMD_FLOAT32_C(   219.24), EASYSIMD_FLOAT32_C(  -326.34) },
      { EASYSIMD_FLOAT32_C(  -190.21), EASYSIMD_FLOAT32_C(   504.54), EASYSIMD_FLOAT32_C(   219.24), EASYSIMD_FLOAT32_C(  -723.52) },
      {           UINT32_MAX, UINT32_C(         0), UINT32_C(         0),           UINT32_MAX } },
    { { EASYSIMD_FLOAT32_C(  -280.95), EASYSIMD_FLOAT32_C(   -30.91), EASYSIMD_FLOAT32_C(   705.25), EASYSIMD_FLOAT32_C(  -225.48) },
      { EASYSIMD_FLOAT32_C(  -240.87), EASYSIMD_FLOAT32_C(   846.33), EASYSIMD_FLOAT32_C(  -227.65), EASYSIMD_FLOAT32_C(  -225.48) },
      { UINT32_C(         0), UINT32_C(         0),           UINT32_MAX, UINT32_C(         0) } },
    { { EASYSIMD_FLOAT32_C(   841.66), EASYSIMD_FLOAT32_C(   572.39), EASYSIMD_FLOAT32_C(   594.22), EASYSIMD_FLOAT32_C(  -491.55) },
      { EASYSIMD_FLOAT32_C(   841.66), EASYSIMD_FLOAT32_C(   110.40), EASYSIMD_FLOAT32_C(   594.11), EASYSIMD_FLOAT32_C(   184.23) },
      { UINT32_C(         0),           UINT32_MAX,           UINT32_MAX, UINT32_C(         0) } },
    { { EASYSIMD_FLOAT32_C(   152.78), EASYSIMD_FLOAT32_C(    77.13), EASYSIMD_FLOAT32_C(   510.85), EASYSIMD_FLOAT32_C(   939.45) },
      { EASYSIMD_FLOAT32_C(   271.42), EASYSIMD_FLOAT32_C(   898.23), EASYSIMD_FLOAT32_C(   510.85), EASYSIMD_FLOAT32_C(   990.47) },
      { UINT32_C(         0), UINT32_C(         0), UINT32_C(         0), UINT32_C(         0) } },
  };
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x4_t r = easysimd_vcgtq_f32(a, b);
...
static int
test_easysimd_vcgtq_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    ...
    { { EASYSIMD_FLOAT64_C(  -768.50), EASYSIMD_FLOAT64_C(   422.43) },
      { EASYSIMD_FLOAT64_C(  -768.50), EASYSIMD_FLOAT64_C(   422.43) },
      { UINT64_C(                   0), UINT64_C(                   0) } },
    { { EASYSIMD_FLOAT64_C(  -374.33), EASYSIMD_FLOAT64_C(   705.75) },
      { EASYSIMD_FLOAT64_C(  -374.33), EASYSIMD_FLOAT64_C(   418.62) },
      { UINT64_C(                   0),                    UINT64_MAX } },
    { { EASYSIMD_FLOAT64_C(   918.51), EASYSIMD_FLOAT64_C(   204.70) },
      { EASYSIMD_FLOAT64_C(   951.02), EASYSIMD_FLOAT64_C(   727.05) },
      { UINT64_C(                   0), UINT64_C(                   0) } },
    { { EASYSIMD_FLOAT64_C(   838.32), EASYSIMD_FLOAT64_C(   700.06) },
      { EASYSIMD_FLOAT64_C(   987.36), EASYSIMD_FLOAT64_C(  -654.73) },
      { UINT64_C(                   0),                    UINT64_MAX } },
    { { EASYSIMD_FLOAT64_C(   461.26), EASYSIMD_FLOAT64_C(  -727.20) },
      { EASYSIMD_FLOAT64_C(   461.26), EASYSIMD_FLOAT64_C(  -199.48) },
      { UINT64_C(                   0), UINT64_C(                   0) } },
    { { EASYSIMD_FLOAT64_C(   305.36), EASYSIMD_FLOAT64_C(   231.22) },
      { EASYSIMD_FLOAT64_C(   305.36), EASYSIMD_FLOAT64_C(  -216.90) },
      { UINT64_C(                   0),                    UINT64_MAX } },
    { { EASYSIMD_FLOAT64_C(   305.13), EASYSIMD_FLOAT64_C(  -986.91) },
      { EASYSIMD_FLOAT64_C(   240.23), EASYSIMD_FLOAT64_C(   930.80) },
      {                    UINT64_MAX, UINT64_C(                   0) } },
    { { EASYSIMD_FLOAT64_C(   601.87), EASYSIMD_FLOAT64_C(   350.21) },
      { EASYSIMD_FLOAT64_C(  -113.14), EASYSIMD_FLOAT64_C(   552.89) },
      {                    UINT64_MAX, UINT64_C(                   0) } },
  };
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint64x2_t r = easysimd_vcgtq_f64(a, b);
...
static int
test_easysimd_vcgtq_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int8_t a[16];
    int8_t b[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x16_t r = easysimd_vcgtq_s8(a, b);
...
static int
test_easysimd_vcgtq_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int16_t a[8];
    int16_t b[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x8_t r = easysimd_vcgtq_s16(a, b);
...
static int
test_easysimd_vcgtq_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t a[4];
    int32_t b[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x4_t r = easysimd_vcgtq_s32(a, b);
...
static int
test_easysimd_vcgtq_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int64_t a[2];
    int64_t b[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint64x2_t r = easysimd_vcgtq_s64(a, b);
...
static int
test_easysimd_vcgtq_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint8_t a[16];
    uint8_t b[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x16_t r = easysimd_vcgtq_u8(a, b);
...
static int
test_easysimd_vcgtq_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint16_t a[8];
    uint16_t b[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x8_t r = easysimd_vcgtq_u16(a, b);
...
static int
test_easysimd_vcgtq_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint32_t a[4];
    uint32_t b[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x4_t r = easysimd_vcgtq_u32(a, b);
...
static int
test_easysimd_vcgtq_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint64_t a[2];
    uint64_t b[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint64x2_t r = easysimd_vcgtq_u64(a, b);
...
static int
test_easysimd_vcgtd_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    ...
    { EASYSIMD_FLOAT64_C(  -338.51),
      EASYSIMD_FLOAT64_C(  -290.63),
      UINT64_C(                   0) },
    { EASYSIMD_FLOAT64_C(   378.78),
      EASYSIMD_FLOAT64_C(   968.82),
      UINT64_C(                   0) },
    { EASYSIMD_FLOAT64_C(   400.89),
      EASYSIMD_FLOAT64_C(  -741.17),
                          UINT64_MAX },
    { EASYSIMD_FLOAT64_C(   390.78),
      EASYSIMD_FLOAT64_C(   851.36),
      UINT64_C(                   0) },
    { EASYSIMD_FLOAT64_C(   468.59),
      EASYSIMD_FLOAT64_C(   825.38),
      UINT64_C(                   0) },
    { EASYSIMD_FLOAT64_C(  -711.58),
      EASYSIMD_FLOAT64_C(  -597.70),
      UINT64_C(                   0) },
    { EASYSIMD_FLOAT64_C(   820.67),
      EASYSIMD_FLOAT64_C(    66.72),
                          UINT64_MAX },
    { EASYSIMD_FLOAT64_C(   998.60),
      EASYSIMD_FLOAT64_C(  -553.87),
                          UINT64_MAX }
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    uint64_t r = easysimd_vcgtd_f64(test_vec[i].a, test_vec[i].b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    uint64_t r = easysimd_vcgtd_f64(a, b);
...
static int
test_easysimd_vcgtd_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int64_t a;
    int64_t b;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    uint64_t r = easysimd_vcgtd_s64(test_vec[i].a, test_vec[i].b);
    easysimd_assert_equal_u64(r, test_vec[i].r);
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    uint64_t r = easysimd_vcgtd_s64(a, b);
...
static int
test_easysimd_vcgtd_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint64_t a;
    uint64_t b;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    uint64_t r = easysimd_vcgtd_u64(test_vec[i].a, test_vec[i].b);
    easysimd_assert_equal_u64(r, test_vec[i].r);
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    uint64_t r = easysimd_vcgtd_u64(a, b);
...
static int
test_easysimd_vcgts_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    ...
    { EASYSIMD_FLOAT32_C(    42.41),
      EASYSIMD_FLOAT32_C(  -519.18),
                UINT32_MAX },
    { EASYSIMD_FLOAT32_C(   512.73),
      EASYSIMD_FLOAT32_C(  -533.01),
                UINT32_MAX },
    { EASYSIMD_FLOAT32_C(   642.14),
      EASYSIMD_FLOAT32_C(  -632.93),
                UINT32_MAX },
    { EASYSIMD_FLOAT32_C(  -879.36),
      EASYSIMD_FLOAT32_C(  -755.01),
      UINT32_C(         0) },
    { EASYSIMD_FLOAT32_C(   239.01),
      EASYSIMD_FLOAT32_C(  -834.06),
                UINT32_MAX },
    { EASYSIMD_FLOAT32_C(   801.80),
      EASYSIMD_FLOAT32_C(   819.51),
      UINT32_C(         0) },
    { EASYSIMD_FLOAT32_C(   937.03),
      EASYSIMD_FLOAT32_C(   232.56),
                UINT32_MAX },
    { EASYSIMD_FLOAT32_C(  -334.43),
      EASYSIMD_FLOAT32_C(   174.66),
      UINT32_C(         0) }
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    uint32_t r = easysimd_vcgts_f32(test_vec[i].a, test_vec[i].b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    uint32_t r = easysimd_vcgts_f32(a, b);
...
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcgt_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcgt_f64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcgt_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcgt_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcgt_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcgt_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcgt_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcgt_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcgt_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcgt_u64)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vcgtq_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcgtq_f64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcgtq_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcgtq_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcgtq_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcgtq_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcgtq_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcgtq_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcgtq_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcgtq_u64)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vcgtd_f64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcgtd_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcgtd_u64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcgts_f32)
