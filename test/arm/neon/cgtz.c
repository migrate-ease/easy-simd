#define EASYSIMD_TEST_ARM_NEON_INSN cgtz

#include "test-neon.h"

/* Check that both of these work */
#if defined(__cplusplus)
  #include "../../../easysimd/arm/neon/cgtz.h"
#else
  #include "../../../easysimd/arm/neon.h"
#endif

static int
test_easysimd_vcgtz_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    easysimd_float32 a[2];
    uint32_t r[2];
  } test_vec[] = {
    { { EASYSIMD_FLOAT32_C(   857.35), EASYSIMD_FLOAT32_C(     0.00) },
      {           UINT32_MAX, UINT32_C(         0) } },
    { { EASYSIMD_FLOAT32_C(   563.25), EASYSIMD_FLOAT32_C(  -646.04) },
      {           UINT32_MAX, UINT32_C(         0) } },
    { { EASYSIMD_FLOAT32_C(  -282.49), EASYSIMD_FLOAT32_C(   166.97) },
      { UINT32_C(         0),           UINT32_MAX } },
    { { EASYSIMD_FLOAT32_C(   481.87), EASYSIMD_FLOAT32_C(   349.86) },
      {           UINT32_MAX,           UINT32_MAX } },
    { { EASYSIMD_FLOAT32_C(   616.03), EASYSIMD_FLOAT32_C(     0.00) },
      {           UINT32_MAX, UINT32_C(         0) } },
    { { EASYSIMD_FLOAT32_C(  -725.00), EASYSIMD_FLOAT32_C(     0.00) },
      { UINT32_C(         0), UINT32_C(         0) } },
    { { EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(     0.00) },
      { UINT32_C(         0), UINT32_C(         0) } },
    { { EASYSIMD_FLOAT32_C(   440.03), EASYSIMD_FLOAT32_C(   616.59) },
      {           UINT32_MAX,           UINT32_MAX } },
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float32x2_t a = easysimd_vld1_f32(test_vec[i].a);
    easysimd_uint32x2_t r = easysimd_vcgtz_f32(a);
...
static int
test_easysimd_vcgtz_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    easysimd_float64 a[1];
    uint64_t r[1];
  } test_vec[] = {
    { { EASYSIMD_FLOAT64_C(  -862.57) },
      { UINT64_C(                   0) } },
    { { EASYSIMD_FLOAT64_C(   383.63) },
      {                    UINT64_MAX } },
    { { EASYSIMD_FLOAT64_C(  -377.66) },
      { UINT64_C(                   0) } },
    { { EASYSIMD_FLOAT64_C(  -519.74) },
      { UINT64_C(                   0) } },
    { { EASYSIMD_FLOAT64_C(   357.37) },
      {                    UINT64_MAX } },
    { { EASYSIMD_FLOAT64_C(     0.00) },
      { UINT64_C(                   0) } },
    { { EASYSIMD_FLOAT64_C(  -484.99) },
      { UINT64_C(                   0) } },
    { { EASYSIMD_FLOAT64_C(  -884.47) },
      { UINT64_C(                   0) } },
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float64x1_t a = easysimd_vld1_f64(test_vec[i].a);
    easysimd_uint64x1_t r = easysimd_vcgtz_f64(a);
...
static int
test_easysimd_vcgtz_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int8_t a[8];
    uint8_t r[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x8_t r = easysimd_vcgtz_s8(a);
...
static int
test_easysimd_vcgtz_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int16_t a[4];
    uint16_t r[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x4_t r = easysimd_vcgtz_s16(a);
...
static int
test_easysimd_vcgtz_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t a[2];
    uint32_t r[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x2_t r = easysimd_vcgtz_s32(a);
...
static int
test_easysimd_vcgtz_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int64_t a[1];
    uint64_t r[1];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint64x1_t r = easysimd_vcgtz_s64(a);
...
static int
test_easysimd_vcgtzq_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    easysimd_float32 a[4];
    uint32_t r[4];
  } test_vec[] = {
    { { EASYSIMD_FLOAT32_C(   610.80), EASYSIMD_FLOAT32_C(  -604.76), EASYSIMD_FLOAT32_C(   570.85), EASYSIMD_FLOAT32_C(   181.79) },
      {           UINT32_MAX, UINT32_C(         0),           UINT32_MAX,           UINT32_MAX } },
    { { EASYSIMD_FLOAT32_C(  -781.68), EASYSIMD_FLOAT32_C(   808.07), EASYSIMD_FLOAT32_C(  -280.25), EASYSIMD_FLOAT32_C(   389.37) },
      { UINT32_C(         0),           UINT32_MAX, UINT32_C(         0),           UINT32_MAX } },
    { { EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(  -848.94) },
      { UINT32_C(         0), UINT32_C(         0), UINT32_C(         0), UINT32_C(         0) } },
    { { EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(   883.90), EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(  -623.70) },
      { UINT32_C(         0),           UINT32_MAX, UINT32_C(         0), UINT32_C(         0) } },
    { { EASYSIMD_FLOAT32_C(  -968.78), EASYSIMD_FLOAT32_C(  -829.47), EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(    43.73) },
      { UINT32_C(         0), UINT32_C(         0), UINT32_C(         0),           UINT32_MAX } },
    { { EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(    64.92), EASYSIMD_FLOAT32_C(     0.00) },
      { UINT32_C(         0), UINT32_C(         0),           UINT32_MAX, UINT32_C(         0) } },
    { { EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(   931.44), EASYSIMD_FLOAT32_C(  -717.64), EASYSIMD_FLOAT32_C(   921.07) },
      { UINT32_C(         0),           UINT32_MAX, UINT32_C(         0),           UINT32_MAX } },
    { { EASYSIMD_FLOAT32_C(  -374.65), EASYSIMD_FLOAT32_C(   314.40), EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(  -187.17) },
      { UINT32_C(         0),           UINT32_MAX, UINT32_C(         0), UINT32_C(         0) } },
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float32x4_t a = easysimd_vld1q_f32(test_vec[i].a);
    easysimd_uint32x4_t r = easysimd_vcgtzq_f32(a);
...
static int
test_easysimd_vcgtzq_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    easysimd_float64 a[2];
    uint64_t r[2];
  } test_vec[] = {
    { { EASYSIMD_FLOAT64_C(  -919.27), EASYSIMD_FLOAT64_C(   975.16) },
      { UINT64_C(                   0),                    UINT64_MAX } },
    { { EASYSIMD_FLOAT64_C(     0.00), EASYSIMD_FLOAT64_C(   -36.67) },
      { UINT64_C(                   0), UINT64_C(                   0) } },
    { { EASYSIMD_FLOAT64_C(   540.59), EASYSIMD_FLOAT64_C(     0.00) },
      {                    UINT64_MAX, UINT64_C(                   0) } },
    { { EASYSIMD_FLOAT64_C(     0.00), EASYSIMD_FLOAT64_C(   839.91) },
      { UINT64_C(                   0),                    UINT64_MAX } },
    { { EASYSIMD_FLOAT64_C(   293.38), EASYSIMD_FLOAT64_C(     0.00) },
      {                    UINT64_MAX, UINT64_C(                   0) } },
    { { EASYSIMD_FLOAT64_C(     0.00), EASYSIMD_FLOAT64_C(  -105.76) },
      { UINT64_C(                   0), UINT64_C(                   0) } },
    { { EASYSIMD_FLOAT64_C(  -155.06), EASYSIMD_FLOAT64_C(     0.00) },
      { UINT64_C(                   0), UINT64_C(                   0) } },
    { { EASYSIMD_FLOAT64_C(  -532.89), EASYSIMD_FLOAT64_C(     0.00) },
      { UINT64_C(                   0), UINT64_C(                   0) } },
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float64x2_t a = easysimd_vld1q_f64(test_vec[i].a);
    easysimd_uint64x2_t r = easysimd_vcgtzq_f64(a);
...
static int
test_easysimd_vcgtzq_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int8_t a[16];
    uint8_t r[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x16_t r = easysimd_vcgtzq_s8(a);
...
static int
test_easysimd_vcgtzq_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int16_t a[8];
    uint16_t r[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x8_t r = easysimd_vcgtzq_s16(a);
...
static int
test_easysimd_vcgtzq_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t a[4];
    uint32_t r[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x4_t r = easysimd_vcgtzq_s32(a);
...
static int
test_easysimd_vcgtzq_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int64_t a[2];
    uint64_t r[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint64x2_t r = easysimd_vcgtzq_s64(a);
...
static int
test_easysimd_vcgtzd_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int64_t a;
    uint64_t r;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    uint64_t r = easysimd_vcgtzd_s64(test_vec[i].a);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    uint64_t r = easysimd_vcgtzd_s64(a);
...
static int
test_easysimd_vcgtzd_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    easysimd_float64_t a;
    uint64_t r;
  } test_vec[] = {
    { EASYSIMD_FLOAT64_C(  -807.76),
      UINT64_C(                   0) },
    { EASYSIMD_FLOAT64_C(   173.20),
                          UINT64_MAX },
    { EASYSIMD_FLOAT64_C(   642.73),
                          UINT64_MAX },
    { EASYSIMD_FLOAT64_C(   628.29),
                          UINT64_MAX },
    { EASYSIMD_FLOAT64_C(  -508.17),
      UINT64_C(                   0) },
    { EASYSIMD_FLOAT64_C(   480.29),
                          UINT64_MAX },
    { EASYSIMD_FLOAT64_C(  -490.40),
      UINT64_C(                   0) },
    { EASYSIMD_FLOAT64_C(   174.42),
                          UINT64_MAX }
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    uint64_t r = easysimd_vcgtzd_f64(test_vec[i].a);
    easysimd_assert_equal_u64(r, test_vec[i].r);
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    uint64_t r = easysimd_vcgtzd_f64(a);
...
static int
test_easysimd_vcgtzs_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    easysimd_float32_t a;
    uint32_t r;
  } test_vec[] = {
    { EASYSIMD_FLOAT32_C(   278.45),
                UINT32_MAX },
    { EASYSIMD_FLOAT32_C(  -325.45),
      UINT32_C(         0) },
    { EASYSIMD_FLOAT32_C(  -203.78),
      UINT32_C(         0) },
    { EASYSIMD_FLOAT32_C(  -992.26),
      UINT32_C(         0) },
    { EASYSIMD_FLOAT32_C(   215.89),
                UINT32_MAX },
    { EASYSIMD_FLOAT32_C(   908.52),
                UINT32_MAX },
    { EASYSIMD_FLOAT32_C(  -860.21),
      UINT32_C(         0) },
    { EASYSIMD_FLOAT32_C(  -813.65),
      UINT32_C(         0) }
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    uint32_t r = easysimd_vcgtzs_f32(test_vec[i].a);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    uint32_t r = easysimd_vcgtzs_f32(a);
...
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcgtz_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcgtz_f64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcgtz_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcgtz_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcgtz_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcgtz_s64)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vcgtzq_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcgtzq_f64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcgtzq_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcgtzq_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcgtzq_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcgtzq_s64)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vcgtzd_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcgtzd_f64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcgtzs_f32)
