#define EASYSIMD_TEST_ARM_NEON_INSN cle

#include "test-neon.h"

/* Check that both of these work */
#if defined(__cplusplus)
  #include "../../../easysimd/arm/neon/cle.h"
#else
  #include "../../../easysimd/arm/neon.h"
#endif

static int
test_easysimd_vcle_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    ...
    { { EASYSIMD_FLOAT32_C(   791.10), EASYSIMD_FLOAT32_C(   796.86) },
      { EASYSIMD_FLOAT32_C(   791.10), EASYSIMD_FLOAT32_C(   796.86) },
      {           UINT32_MAX,           UINT32_MAX } },
    { { EASYSIMD_FLOAT32_C(  -191.39), EASYSIMD_FLOAT32_C(  -320.84) },
      { EASYSIMD_FLOAT32_C(   186.39), EASYSIMD_FLOAT32_C(  -320.84) },
      {           UINT32_MAX,           UINT32_MAX } },
    { { EASYSIMD_FLOAT32_C(   401.94), EASYSIMD_FLOAT32_C(  -653.44) },
      { EASYSIMD_FLOAT32_C(  -526.24), EASYSIMD_FLOAT32_C(   298.37) },
      { UINT32_C(         0),           UINT32_MAX } },
    { { EASYSIMD_FLOAT32_C(   452.25), EASYSIMD_FLOAT32_C(   434.09) },
      { EASYSIMD_FLOAT32_C(   -83.69), EASYSIMD_FLOAT32_C(   224.54) },
      { UINT32_C(         0), UINT32_C(         0) } },
    { { EASYSIMD_FLOAT32_C(   828.36), EASYSIMD_FLOAT32_C(   113.27) },
      { EASYSIMD_FLOAT32_C(  -845.96), EASYSIMD_FLOAT32_C(   459.19) },
      { UINT32_C(         0),           UINT32_MAX } },
    { { EASYSIMD_FLOAT32_C(   705.27), EASYSIMD_FLOAT32_C(  -712.20) },
      { EASYSIMD_FLOAT32_C(   705.27), EASYSIMD_FLOAT32_C(   140.77) },
      {           UINT32_MAX,           UINT32_MAX } },
    { { EASYSIMD_FLOAT32_C(   640.57), EASYSIMD_FLOAT32_C(  -173.03) },
      { EASYSIMD_FLOAT32_C(   839.60), EASYSIMD_FLOAT32_C(  -173.03) },
      {           UINT32_MAX,           UINT32_MAX } },
    { { EASYSIMD_FLOAT32_C(   -38.70), EASYSIMD_FLOAT32_C(   -25.63) },
      { EASYSIMD_FLOAT32_C(   -38.70), EASYSIMD_FLOAT32_C(   357.76) },
      {           UINT32_MAX,           UINT32_MAX } },
  };
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x2_t r = easysimd_vcle_f32(a, b);
...
static int
test_easysimd_vcle_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    ...
    { { EASYSIMD_FLOAT64_C(  -975.50) },
      { EASYSIMD_FLOAT64_C(   222.47) },
      {                    UINT64_MAX } },
    { { EASYSIMD_FLOAT64_C(   986.68) },
      { EASYSIMD_FLOAT64_C(   986.68) },
      {                    UINT64_MAX } },
    { { EASYSIMD_FLOAT64_C(   852.29) },
      { EASYSIMD_FLOAT64_C(   445.48) },
      { UINT64_C(                   0) } },
    { { EASYSIMD_FLOAT64_C(  -413.29) },
      { EASYSIMD_FLOAT64_C(   220.80) },
      {                    UINT64_MAX } },
    { { EASYSIMD_FLOAT64_C(    33.63) },
      { EASYSIMD_FLOAT64_C(  -513.00) },
      { UINT64_C(                   0) } },
    { { EASYSIMD_FLOAT64_C(  -232.79) },
      { EASYSIMD_FLOAT64_C(  -316.14) },
      { UINT64_C(                   0) } },
    { { EASYSIMD_FLOAT64_C(  -848.20) },
      { EASYSIMD_FLOAT64_C(  -848.20) },
      {                    UINT64_MAX } },
    { { EASYSIMD_FLOAT64_C(   855.66) },
      { EASYSIMD_FLOAT64_C(   630.93) },
      { UINT64_C(                   0) } },
  };
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint64x1_t r = easysimd_vcle_f64(a, b);
...
static int
test_easysimd_vcle_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int8_t a[8];
    int8_t b[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x8_t r = easysimd_vcle_s8(a, b);
...
static int
test_easysimd_vcle_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int16_t a[4];
    int16_t b[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x4_t r = easysimd_vcle_s16(a, b);
...
static int
test_easysimd_vcle_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t a[2];
    int32_t b[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x2_t r = easysimd_vcle_s32(a, b);
...
static int
test_easysimd_vcle_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int64_t a[1];
    int64_t b[1];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint64x1_t r = easysimd_vcle_s64(a, b);
...
static int
test_easysimd_vcle_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint8_t a[8];
    uint8_t b[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x8_t r = easysimd_vcle_u8(a, b);
...
static int
test_easysimd_vcle_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint16_t a[4];
    uint16_t b[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x4_t r = easysimd_vcle_u16(a, b);
...
static int
test_easysimd_vcle_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint32_t a[2];
    uint32_t b[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x2_t r = easysimd_vcle_u32(a, b);
...
static int
test_easysimd_vcle_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint64_t a[1];
    uint64_t b[1];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint64x1_t r = easysimd_vcle_u64(a, b);
...
static int
test_easysimd_vcleq_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    ...
    { { EASYSIMD_FLOAT32_C(  -668.90), EASYSIMD_FLOAT32_C(   928.96), EASYSIMD_FLOAT32_C(   525.27), EASYSIMD_FLOAT32_C(   244.82) },
      { EASYSIMD_FLOAT32_C(   811.79), EASYSIMD_FLOAT32_C(   687.37), EASYSIMD_FLOAT32_C(   277.72), EASYSIMD_FLOAT32_C(   244.82) },
      {           UINT32_MAX, UINT32_C(         0), UINT32_C(         0),           UINT32_MAX } },
    { { EASYSIMD_FLOAT32_C(   696.43), EASYSIMD_FLOAT32_C(  -857.84), EASYSIMD_FLOAT32_C(   965.32), EASYSIMD_FLOAT32_C(   876.96) },
      { EASYSIMD_FLOAT32_C(  -631.72), EASYSIMD_FLOAT32_C(  -857.84), EASYSIMD_FLOAT32_C(  -893.87), EASYSIMD_FLOAT32_C(   876.96) },
      { UINT32_C(         0),           UINT32_MAX, UINT32_C(         0),           UINT32_MAX } },
    { { EASYSIMD_FLOAT32_C(  -771.07), EASYSIMD_FLOAT32_C(   967.77), EASYSIMD_FLOAT32_C(   429.01), EASYSIMD_FLOAT32_C(   260.39) },
      { EASYSIMD_FLOAT32_C(   702.86), EASYSIMD_FLOAT32_C(   636.28), EASYSIMD_FLOAT32_C(   429.01), EASYSIMD_FLOAT32_C(  -966.04) },
      {           UINT32_MAX, UINT32_C(         0),           UINT32_MAX, UINT32_C(         0) } },
    { { EASYSIMD_FLOAT32_C(  -358.35), EASYSIMD_FLOAT32_C(   497.18), EASYSIMD_FLOAT32_C(  -378.16), EASYSIMD_FLOAT32_C(   420.17) },
      { EASYSIMD_FLOAT32_C(  -508.71), EASYSIMD_FLOAT32_C(  -602.79), EASYSIMD_FLOAT32_C(   676.13), EASYSIMD_FLOAT32_C(  -812.29) },
      { UINT32_C(         0), UINT32_C(         0),           UINT32_MAX, UINT32_C(         0) } },
    { { EASYSIMD_FLOAT32_C(  -521.08), EASYSIMD_FLOAT32_C(  -618.79), EASYSIMD_FLOAT32_C(   530.55), EASYSIMD_FLOAT32_C(  -292.15) },
      { EASYSIMD_FLOAT32_C(  -521.08), EASYSIMD_FLOAT32_C(  -618.79), EASYSIMD_FLOAT32_C(   223.55), EASYSIMD_FLOAT32_C(  -292.15) },
      {           UINT32_MAX,           UINT32_MAX, UINT32_C(         0),           UINT32_MAX } },
    { { EASYSIMD_FLOAT32_C(  -808.90), EASYSIMD_FLOAT32_C(   397.25), EASYSIMD_FLOAT32_C(   133.37), EASYSIMD_FLOAT32_C(    -6.83) },
      { EASYSIMD_FLOAT32_C(  -648.47), EASYSIMD_FLOAT32_C(  -694.75), EASYSIMD_FLOAT32_C(   133.37), EASYSIMD_FLOAT32_C(    -6.83) },
      {           UINT32_MAX, UINT32_C(         0),           UINT32_MAX,           UINT32_MAX } },
    { { EASYSIMD_FLOAT32_C(   730.94), EASYSIMD_FLOAT32_C(  -785.96), EASYSIMD_FLOAT32_C(    91.33), EASYSIMD_FLOAT32_C(   514.55) },
      { EASYSIMD_FLOAT32_C(   730.94), EASYSIMD_FLOAT32_C(  -785.96), EASYSIMD_FLOAT32_C(    91.33), EASYSIMD_FLOAT32_C(   514.55) },
      {           UINT32_MAX,           UINT32_MAX,           UINT32_MAX,           UINT32_MAX } },
    { { EASYSIMD_FLOAT32_C(  -626.37), EASYSIMD_FLOAT32_C(   818.81), EASYSIMD_FLOAT32_C(   403.89), EASYSIMD_FLOAT32_C(   352.06) },
      { EASYSIMD_FLOAT32_C(  -626.37), EASYSIMD_FLOAT32_C(   207.79), EASYSIMD_FLOAT32_C(   403.89), EASYSIMD_FLOAT32_C(  -435.27) },
      {           UINT32_MAX, UINT32_C(         0),           UINT32_MAX, UINT32_C(         0) } },
  };
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x4_t r = easysimd_vcleq_f32(a, b);
...
static int
test_easysimd_vcleq_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    ...
    { { EASYSIMD_FLOAT64_C(   680.17), EASYSIMD_FLOAT64_C(  -515.06) },
      { EASYSIMD_FLOAT64_C(   718.41), EASYSIMD_FLOAT64_C(  -515.06) },
      {                    UINT64_MAX,                    UINT64_MAX } },
    { { EASYSIMD_FLOAT64_C(   113.48), EASYSIMD_FLOAT64_C(  -153.24) },
      { EASYSIMD_FLOAT64_C(  -711.61), EASYSIMD_FLOAT64_C(  -153.24) },
      { UINT64_C(                   0),                    UINT64_MAX } },
    { { EASYSIMD_FLOAT64_C(  -988.69), EASYSIMD_FLOAT64_C(   305.46) },
      { EASYSIMD_FLOAT64_C(   833.43), EASYSIMD_FLOAT64_C(   305.46) },
      {                    UINT64_MAX,                    UINT64_MAX } },
    { { EASYSIMD_FLOAT64_C(   993.85), EASYSIMD_FLOAT64_C(  -613.57) },
      { EASYSIMD_FLOAT64_C(   -18.63), EASYSIMD_FLOAT64_C(  -132.48) },
      { UINT64_C(                   0),                    UINT64_MAX } },
    { { EASYSIMD_FLOAT64_C(   720.10), EASYSIMD_FLOAT64_C(  -120.39) },
      { EASYSIMD_FLOAT64_C(   800.59), EASYSIMD_FLOAT64_C(  -120.39) },
      {                    UINT64_MAX,                    UINT64_MAX } },
    { { EASYSIMD_FLOAT64_C(   850.21), EASYSIMD_FLOAT64_C(   642.71) },
      { EASYSIMD_FLOAT64_C(   850.21), EASYSIMD_FLOAT64_C(  -236.33) },
      {                    UINT64_MAX, UINT64_C(                   0) } },
    { { EASYSIMD_FLOAT64_C(  -275.07), EASYSIMD_FLOAT64_C(   271.93) },
      { EASYSIMD_FLOAT64_C(  -275.07), EASYSIMD_FLOAT64_C(   271.93) },
      {                    UINT64_MAX,                    UINT64_MAX } },
    { { EASYSIMD_FLOAT64_C(   897.28), EASYSIMD_FLOAT64_C(  -900.81) },
      { EASYSIMD_FLOAT64_C(    83.69), EASYSIMD_FLOAT64_C(   730.71) },
      { UINT64_C(                   0),                    UINT64_MAX } },
  };
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint64x2_t r = easysimd_vcleq_f64(a, b);
...
static int
test_easysimd_vcleq_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int8_t a[16];
    int8_t b[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x16_t r = easysimd_vcleq_s8(a, b);
...
static int
test_easysimd_vcleq_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int16_t a[8];
    int16_t b[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x8_t r = easysimd_vcleq_s16(a, b);
...
static int
test_easysimd_vcleq_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t a[4];
    int32_t b[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x4_t r = easysimd_vcleq_s32(a, b);
...
static int
test_easysimd_vcleq_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int64_t a[2];
    int64_t b[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint64x2_t r = easysimd_vcleq_s64(a, b);
...
static int
test_easysimd_vcleq_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint8_t a[16];
    uint8_t b[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x16_t r = easysimd_vcleq_u8(a, b);
...
static int
test_easysimd_vcleq_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint16_t a[8];
    uint16_t b[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x8_t r = easysimd_vcleq_u16(a, b);
...
static int
test_easysimd_vcleq_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint32_t a[4];
    uint32_t b[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x4_t r = easysimd_vcleq_u32(a, b);
...
static int
test_easysimd_vcleq_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint64_t a[2];
    uint64_t b[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint64x2_t r = easysimd_vcleq_u64(a, b);
...
static int
test_easysimd_vcled_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    ...
    { EASYSIMD_FLOAT64_C(  -305.11),
      EASYSIMD_FLOAT64_C(  -236.09),
                          UINT64_MAX },
    { EASYSIMD_FLOAT64_C(   921.92),
      EASYSIMD_FLOAT64_C(   733.85),
      UINT64_C(                   0) },
    { EASYSIMD_FLOAT64_C(  -486.91),
      EASYSIMD_FLOAT64_C(   623.76),
                          UINT64_MAX },
    { EASYSIMD_FLOAT64_C(  -463.48),
      EASYSIMD_FLOAT64_C(  -725.12),
      UINT64_C(                   0) },
    { EASYSIMD_FLOAT64_C(  -340.50),
      EASYSIMD_FLOAT64_C(   856.54),
                          UINT64_MAX },
    { EASYSIMD_FLOAT64_C(  -716.95),
      EASYSIMD_FLOAT64_C(    55.73),
                          UINT64_MAX },
    { EASYSIMD_FLOAT64_C(  -230.29),
      EASYSIMD_FLOAT64_C(  -777.07),
      UINT64_C(                   0) },
    { EASYSIMD_FLOAT64_C(  -322.84),
      EASYSIMD_FLOAT64_C(   432.77),
                          UINT64_MAX }
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    uint64_t r = easysimd_vcled_f64(test_vec[i].a, test_vec[i].b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    uint64_t r = easysimd_vcled_f64(a, b);
...
static int
test_easysimd_vcled_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int64_t a;
    int64_t b;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    uint64_t r = easysimd_vcled_s64(test_vec[i].a, test_vec[i].b);
    easysimd_assert_equal_u64(r, test_vec[i].r);
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    uint64_t r = easysimd_vcled_s64(a, b);
...
static int
test_easysimd_vcled_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint64_t a;
    uint64_t b;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    uint64_t r = easysimd_vcled_u64(test_vec[i].a, test_vec[i].b);
    easysimd_assert_equal_u64(r, test_vec[i].r);
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    uint64_t r = easysimd_vcled_u64(a, b);
...
static int
test_easysimd_vcles_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    ...
    { EASYSIMD_FLOAT32_C(  -462.77),
      EASYSIMD_FLOAT32_C(  -563.18),
      UINT32_C(         0) },
    { EASYSIMD_FLOAT32_C(  -590.17),
      EASYSIMD_FLOAT32_C(   687.19),
                UINT32_MAX },
    { EASYSIMD_FLOAT32_C(   198.94),
      EASYSIMD_FLOAT32_C(  -270.32),
      UINT32_C(         0) },
    { EASYSIMD_FLOAT32_C(   -57.87),
      EASYSIMD_FLOAT32_C(  -211.45),
      UINT32_C(         0) },
    { EASYSIMD_FLOAT32_C(  -623.27),
      EASYSIMD_FLOAT32_C(   512.37),
                UINT32_MAX },
    { EASYSIMD_FLOAT32_C(  -869.47),
      EASYSIMD_FLOAT32_C(    30.49),
                UINT32_MAX },
    { EASYSIMD_FLOAT32_C(   837.56),
      EASYSIMD_FLOAT32_C(   837.84),
                UINT32_MAX },
    { EASYSIMD_FLOAT32_C(    98.31),
      EASYSIMD_FLOAT32_C(  -717.52),
      UINT32_C(         0) }
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    uint32_t r = easysimd_vcles_f32(test_vec[i].a, test_vec[i].b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    uint32_t r = easysimd_vcles_f32(a, b);
...
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcle_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcle_f64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcle_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcle_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcle_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcle_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcle_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcle_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcle_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcle_u64)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vcleq_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcleq_f64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcleq_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcleq_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcleq_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcleq_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcleq_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcleq_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcleq_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcleq_u64)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vcled_f64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcled_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcled_u64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcles_f32)
