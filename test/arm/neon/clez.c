#define EASYSIMD_TEST_ARM_NEON_INSN clez

#include "test-neon.h"

/* Check that both of these work */
#if defined(__cplusplus)
  #include "../../../easysimd/arm/neon/clez.h"
#else
  #include "../../../easysimd/arm/neon.h"
#endif

static int
test_easysimd_vclez_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    easysimd_float32 a[2];
    uint32_t r[2];
  } test_vec[] = {
    { { EASYSIMD_FLOAT32_C(    70.04), EASYSIMD_FLOAT32_C(  -657.90) },
      { UINT32_C(         0),           UINT32_MAX } },
    { { EASYSIMD_FLOAT32_C(  -994.42), EASYSIMD_FLOAT32_C(  -790.82) },
      {           UINT32_MAX,           UINT32_MAX } },
    { { EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(     0.00) },
      {           UINT32_MAX,           UINT32_MAX } },
    { { EASYSIMD_FLOAT32_C(  -581.92), EASYSIMD_FLOAT32_C(     0.00) },
      {           UINT32_MAX,           UINT32_MAX } },
    { { EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(     0.00) },
      {           UINT32_MAX,           UINT32_MAX } },
    { { EASYSIMD_FLOAT32_C(   327.30), EASYSIMD_FLOAT32_C(  -480.97) },
      { UINT32_C(         0),           UINT32_MAX } },
    { { EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(   126.99) },
      {           UINT32_MAX, UINT32_C(         0) } },
    { { EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(  -661.81) },
      {           UINT32_MAX,           UINT32_MAX } },
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float32x2_t a = easysimd_vld1_f32(test_vec[i].a);
    easysimd_uint32x2_t r = easysimd_vclez_f32(a);
...
static int
test_easysimd_vclez_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    easysimd_float64 a[1];
    uint64_t r[1];
  } test_vec[] = {
    { { EASYSIMD_FLOAT64_C(  -670.22) },
      {                    UINT64_MAX } },
    { { EASYSIMD_FLOAT64_C(     0.00) },
      {                    UINT64_MAX } },
    { { EASYSIMD_FLOAT64_C(   680.93) },
      { UINT64_C(                   0) } },
    { { EASYSIMD_FLOAT64_C(   487.28) },
      { UINT64_C(                   0) } },
    { { EASYSIMD_FLOAT64_C(  -782.87) },
      {                    UINT64_MAX } },
    { { EASYSIMD_FLOAT64_C(     0.00) },
      {                    UINT64_MAX } },
    { { EASYSIMD_FLOAT64_C(   891.09) },
      { UINT64_C(                   0) } },
    { { EASYSIMD_FLOAT64_C(  -949.37) },
      {                    UINT64_MAX } },
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float64x1_t a = easysimd_vld1_f64(test_vec[i].a);
    easysimd_uint64x1_t r = easysimd_vclez_f64(a);
...
static int
test_easysimd_vclez_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int8_t a[8];
    uint8_t r[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x8_t r = easysimd_vclez_s8(a);
...
static int
test_easysimd_vclez_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int16_t a[4];
    uint16_t r[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x4_t r = easysimd_vclez_s16(a);
...
static int
test_easysimd_vclez_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t a[2];
    uint32_t r[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x2_t r = easysimd_vclez_s32(a);
...
static int
test_easysimd_vclez_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int64_t a[1];
    uint64_t r[1];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint64x1_t r = easysimd_vclez_s64(a);
...
static int
test_easysimd_vclezq_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    easysimd_float32 a[4];
    uint32_t r[4];
  } test_vec[] = {
    { { EASYSIMD_FLOAT32_C(   221.89), EASYSIMD_FLOAT32_C(   155.65), EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(   633.13) },
      { UINT32_C(         0), UINT32_C(         0),           UINT32_MAX, UINT32_C(         0) } },
    { { EASYSIMD_FLOAT32_C(   746.23), EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(     0.00) },
      { UINT32_C(         0),           UINT32_MAX,           UINT32_MAX,           UINT32_MAX } },
    { { EASYSIMD_FLOAT32_C(  -515.28), EASYSIMD_FLOAT32_C(   795.42), EASYSIMD_FLOAT32_C(    99.50), EASYSIMD_FLOAT32_C(   505.39) },
      {           UINT32_MAX, UINT32_C(         0), UINT32_C(         0), UINT32_C(         0) } },
    { { EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(  -866.96), EASYSIMD_FLOAT32_C(  -299.73), EASYSIMD_FLOAT32_C(   234.99) },
      {           UINT32_MAX,           UINT32_MAX,           UINT32_MAX, UINT32_C(         0) } },
    { { EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(  -414.75), EASYSIMD_FLOAT32_C(   514.89), EASYSIMD_FLOAT32_C(     0.00) },
      {           UINT32_MAX,           UINT32_MAX, UINT32_C(         0),           UINT32_MAX } },
    { { EASYSIMD_FLOAT32_C(   730.51), EASYSIMD_FLOAT32_C(   656.06), EASYSIMD_FLOAT32_C(   193.33), EASYSIMD_FLOAT32_C(     0.00) },
      { UINT32_C(         0), UINT32_C(         0), UINT32_C(         0),           UINT32_MAX } },
    { { EASYSIMD_FLOAT32_C(   486.26), EASYSIMD_FLOAT32_C(   910.33), EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(   406.26) },
      { UINT32_C(         0), UINT32_C(         0),           UINT32_MAX, UINT32_C(         0) } },
    { { EASYSIMD_FLOAT32_C(   440.42), EASYSIMD_FLOAT32_C(   247.26), EASYSIMD_FLOAT32_C(   185.90), EASYSIMD_FLOAT32_C(  -899.71) },
      { UINT32_C(         0), UINT32_C(         0), UINT32_C(         0),           UINT32_MAX } },
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float32x4_t a = easysimd_vld1q_f32(test_vec[i].a);
    easysimd_uint32x4_t r = easysimd_vclezq_f32(a);
...
static int
test_easysimd_vclezq_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    easysimd_float64 a[2];
    uint64_t r[2];
  } test_vec[] = {
    { { EASYSIMD_FLOAT64_C(  -407.08), EASYSIMD_FLOAT64_C(     0.00) },
      {                    UINT64_MAX,                    UINT64_MAX } },
    { { EASYSIMD_FLOAT64_C(   119.73), EASYSIMD_FLOAT64_C(    73.59) },
      { UINT64_C(                   0), UINT64_C(                   0) } },
    { { EASYSIMD_FLOAT64_C(   337.70), EASYSIMD_FLOAT64_C(     0.00) },
      { UINT64_C(                   0),                    UINT64_MAX } },
    { { EASYSIMD_FLOAT64_C(   629.77), EASYSIMD_FLOAT64_C(     0.00) },
      { UINT64_C(                   0),                    UINT64_MAX } },
    { { EASYSIMD_FLOAT64_C(   105.66), EASYSIMD_FLOAT64_C(  -580.38) },
      { UINT64_C(                   0),                    UINT64_MAX } },
    { { EASYSIMD_FLOAT64_C(   -14.53), EASYSIMD_FLOAT64_C(   483.80) },
      {                    UINT64_MAX, UINT64_C(                   0) } },
    { { EASYSIMD_FLOAT64_C(   424.55), EASYSIMD_FLOAT64_C(   -35.62) },
      { UINT64_C(                   0),                    UINT64_MAX } },
    { { EASYSIMD_FLOAT64_C(   -74.95), EASYSIMD_FLOAT64_C(   -62.26) },
      {                    UINT64_MAX,                    UINT64_MAX } },
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float64x2_t a = easysimd_vld1q_f64(test_vec[i].a);
    easysimd_uint64x2_t r = easysimd_vclezq_f64(a);
...
static int
test_easysimd_vclezq_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int8_t a[16];
    uint8_t r[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x16_t r = easysimd_vclezq_s8(a);
...
static int
test_easysimd_vclezq_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int16_t a[8];
    uint16_t r[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x8_t r = easysimd_vclezq_s16(a);
...
static int
test_easysimd_vclezq_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t a[4];
    uint32_t r[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x4_t r = easysimd_vclezq_s32(a);
...
static int
test_easysimd_vclezq_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int64_t a[2];
    uint64_t r[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint64x2_t r = easysimd_vclezq_s64(a);
...
static int
test_easysimd_vclezd_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int64_t a;
    uint64_t r;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    uint64_t r = easysimd_vclezd_s64(test_vec[i].a);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    uint64_t r = easysimd_vclezd_s64(a);
...
static int
test_easysimd_vclezd_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    easysimd_float64_t a;
    uint64_t r;
  } test_vec[] = {
    { EASYSIMD_FLOAT64_C(  -339.74),
                         UINT64_MAX },
   { EASYSIMD_FLOAT64_C(   -68.07),
                         UINT64_MAX },
   { EASYSIMD_FLOAT64_C(  -628.28),
                         UINT64_MAX },
   { EASYSIMD_FLOAT64_C(   764.54),
     UINT64_C(                   0) },
   { EASYSIMD_FLOAT64_C(   552.63),
     UINT64_C(                   0) },
   { EASYSIMD_FLOAT64_C(  -265.81),
                         UINT64_MAX },
   { EASYSIMD_FLOAT64_C(  -985.62),
                         UINT64_MAX },
   { EASYSIMD_FLOAT64_C(    59.35),
     UINT64_C(                   0) }
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    uint64_t r = easysimd_vclezd_f64(test_vec[i].a);
    easysimd_assert_equal_u64(r, test_vec[i].r);
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    uint64_t r = easysimd_vclezd_f64(a);
...
static int
test_easysimd_vclezs_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    easysimd_float32_t a;
    uint32_t r;
  } test_vec[] = {
    { EASYSIMD_FLOAT32_C(   683.74),
     UINT32_C(         0) },
   { EASYSIMD_FLOAT32_C(  -775.03),
               UINT32_MAX },
   { EASYSIMD_FLOAT32_C(   360.39),
     UINT32_C(         0) },
   { EASYSIMD_FLOAT32_C(   691.68),
     UINT32_C(         0) },
   { EASYSIMD_FLOAT32_C(   549.89),
     UINT32_C(         0) },
   { EASYSIMD_FLOAT32_C(  -850.76),
               UINT32_MAX },
   { EASYSIMD_FLOAT32_C(   828.85),
     UINT32_C(         0) },
   { EASYSIMD_FLOAT32_C(   571.99),
     UINT32_C(         0) }
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    uint32_t r = easysimd_vclezs_f32(test_vec[i].a);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    uint32_t r = easysimd_vclezs_f32(a);
...
EASYSIMD_TEST_FUNC_LIST_ENTRY(vclez_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vclez_f64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vclez_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vclez_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vclez_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vclez_s64)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vclezq_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vclezq_f64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vclezq_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vclezq_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vclezq_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vclezq_s64)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vclezd_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vclezd_f64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vclezs_f32)
