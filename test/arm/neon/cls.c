#define EASYSIMD_TEST_ARM_NEON_INSN cls

#include "test-neon.h"
#include "../../../easysimd/arm/neon/cls.h"
...
static int
test_easysimd_vcls_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int8_t a[8];
    int8_t r[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int8x8_t r = easysimd_vcls_s8(a);
...
static int
test_easysimd_vcls_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int16_t a[4];
    int16_t r[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int16x4_t r = easysimd_vcls_s16(a);
...
static int
test_easysimd_vcls_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t a[2];
    int32_t r[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x2_t r = easysimd_vcls_s32(a);
...
static int
test_easysimd_vcls_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint8_t a[8];
    int8_t r[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int8x8_t r = easysimd_vcls_u8(a);
...
static int
test_easysimd_vcls_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint16_t a[4];
    int16_t r[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int16x4_t r = easysimd_vcls_u16(a);
...
static int
test_easysimd_vcls_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint32_t a[2];
    int32_t r[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x2_t r = easysimd_vcls_u32(a);
...
static int
test_easysimd_vclsq_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int8_t a[16];
    int8_t r[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int8x16_t r = easysimd_vclsq_s8(a);
...
static int
test_easysimd_vclsq_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int16_t a[8];
    int16_t r[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int16x8_t r = easysimd_vclsq_s16(a);
...
static int
test_easysimd_vclsq_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t a[4];
    int32_t r[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x4_t r = easysimd_vclsq_s32(a);
...
static int
test_easysimd_vclsq_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint8_t a[16];
    int8_t r[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int8x16_t r = easysimd_vclsq_u8(a);
...
static int
test_easysimd_vclsq_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint16_t a[8];
    int16_t r[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int16x8_t r = easysimd_vclsq_u16(a);
...
static int
test_easysimd_vclsq_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint32_t a[4];
    int32_t r[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x4_t r = easysimd_vclsq_u32(a);
...
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcls_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcls_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcls_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vclsq_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vclsq_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vclsq_s32)

#if !defined(EASYSIMD_NATIVE_ALIASES_TESTING)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcls_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcls_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcls_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vclsq_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vclsq_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vclsq_u32)
#endif
