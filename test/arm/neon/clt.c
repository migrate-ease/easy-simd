#define EASYSIMD_TEST_ARM_NEON_INSN clt

#include "test-neon.h"

/* Check that both of these work */
#if defined(__cplusplus)
  #include "../../../easysimd/arm/neon/clt.h"
#else
  #include "../../../easysimd/arm/neon.h"
#endif

static int
test_easysimd_vclt_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    ...
    { { EASYSIMD_FLOAT32_C(  -878.13), EASYSIMD_FLOAT32_C(   253.04) },
      { EASYSIMD_FLOAT32_C(  -138.52), EASYSIMD_FLOAT32_C(   520.27) },
      {           UINT32_MAX,           UINT32_MAX } },
    { { EASYSIMD_FLOAT32_C(   216.41), EASYSIMD_FLOAT32_C(  -277.45) },
      { EASYSIMD_FLOAT32_C(   216.41), EASYSIMD_FLOAT32_C(  -277.45) },
      { UINT32_C(         0), UINT32_C(         0) } },
    { { EASYSIMD_FLOAT32_C(  -520.65), EASYSIMD_FLOAT32_C(    69.98) },
      { EASYSIMD_FLOAT32_C(  -520.65), EASYSIMD_FLOAT32_C(  -666.76) },
      { UINT32_C(         0), UINT32_C(         0) } },
    { { EASYSIMD_FLOAT32_C(  -131.97), EASYSIMD_FLOAT32_C(  -253.40) },
      { EASYSIMD_FLOAT32_C(  -131.97), EASYSIMD_FLOAT32_C(  -253.40) },
      { UINT32_C(         0), UINT32_C(         0) } },
    { { EASYSIMD_FLOAT32_C(  -732.59), EASYSIMD_FLOAT32_C(    16.82) },
      { EASYSIMD_FLOAT32_C(  -576.18), EASYSIMD_FLOAT32_C(  -841.89) },
      {           UINT32_MAX, UINT32_C(         0) } },
    { { EASYSIMD_FLOAT32_C(    59.37), EASYSIMD_FLOAT32_C(  -991.99) },
      { EASYSIMD_FLOAT32_C(    59.37), EASYSIMD_FLOAT32_C(  -991.99) },
      { UINT32_C(         0), UINT32_C(         0) } },
    { { EASYSIMD_FLOAT32_C(  -436.42), EASYSIMD_FLOAT32_C(   163.54) },
      { EASYSIMD_FLOAT32_C(  -436.42), EASYSIMD_FLOAT32_C(   163.54) },
      { UINT32_C(         0), UINT32_C(         0) } },
    { { EASYSIMD_FLOAT32_C(   442.39), EASYSIMD_FLOAT32_C(   921.75) },
      { EASYSIMD_FLOAT32_C(   696.88), EASYSIMD_FLOAT32_C(   921.75) },
      {           UINT32_MAX, UINT32_C(         0) } },
  };
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x2_t r = easysimd_vclt_f32(a, b);
...
static int
test_easysimd_vclt_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    ...
    { { EASYSIMD_FLOAT64_C(   904.65) },
      { EASYSIMD_FLOAT64_C(  -973.46) },
      { UINT64_C(                   0) } },
    { { EASYSIMD_FLOAT64_C(  -826.64) },
      { EASYSIMD_FLOAT64_C(   314.00) },
      {                    UINT64_MAX } },
    { { EASYSIMD_FLOAT64_C(   685.96) },
      { EASYSIMD_FLOAT64_C(   685.96) },
      { UINT64_C(                   0) } },
    { { EASYSIMD_FLOAT64_C(  -419.20) },
      { EASYSIMD_FLOAT64_C(   659.33) },
      {                    UINT64_MAX } },
    { { EASYSIMD_FLOAT64_C(   424.09) },
      { EASYSIMD_FLOAT64_C(   -15.82) },
      { UINT64_C(                   0) } },
    { { EASYSIMD_FLOAT64_C(   280.79) },
      { EASYSIMD_FLOAT64_C(  -594.35) },
      { UINT64_C(                   0) } },
    { { EASYSIMD_FLOAT64_C(  -595.16) },
      { EASYSIMD_FLOAT64_C(   567.93) },
      {                    UINT64_MAX } },
    { { EASYSIMD_FLOAT64_C(   -45.66) },
      { EASYSIMD_FLOAT64_C(   -45.66) },
      { UINT64_C(                   0) } },
  };
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint64x1_t r = easysimd_vclt_f64(a, b);
...
static int
test_easysimd_vclt_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int8_t a[8];
    int8_t b[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x8_t r = easysimd_vclt_s8(a, b);
...
static int
test_easysimd_vclt_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int16_t a[4];
    int16_t b[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x4_t r = easysimd_vclt_s16(a, b);
...
static int
test_easysimd_vclt_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t a[2];
    int32_t b[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x2_t r = easysimd_vclt_s32(a, b);
...
static int
test_easysimd_vclt_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int64_t a[1];
    int64_t b[1];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint64x1_t r = easysimd_vclt_s64(a, b);
...
static int
test_easysimd_vclt_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint8_t a[8];
    uint8_t b[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x8_t r = easysimd_vclt_u8(a, b);
...
static int
test_easysimd_vclt_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint16_t a[4];
    uint16_t b[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x4_t r = easysimd_vclt_u16(a, b);
...
static int
test_easysimd_vclt_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint32_t a[2];
    uint32_t b[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x2_t r = easysimd_vclt_u32(a, b);
...
static int
test_easysimd_vclt_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint64_t a[1];
    uint64_t b[1];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint64x1_t r = easysimd_vclt_u64(a, b);
...
static int
test_easysimd_vcltq_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    ...
    { { EASYSIMD_FLOAT32_C(   371.77), EASYSIMD_FLOAT32_C(  -175.93), EASYSIMD_FLOAT32_C(    59.24), EASYSIMD_FLOAT32_C(   306.18) },
      { EASYSIMD_FLOAT32_C(   371.77), EASYSIMD_FLOAT32_C(   169.92), EASYSIMD_FLOAT32_C(   324.63), EASYSIMD_FLOAT32_C(   -35.16) },
      { UINT32_C(         0),           UINT32_MAX,           UINT32_MAX, UINT32_C(         0) } },
    { { EASYSIMD_FLOAT32_C(  -350.88), EASYSIMD_FLOAT32_C(  -974.36), EASYSIMD_FLOAT32_C(   869.28), EASYSIMD_FLOAT32_C(   571.35) },
      { EASYSIMD_FLOAT32_C(  -726.73), EASYSIMD_FLOAT32_C(  -430.55), EASYSIMD_FLOAT32_C(   869.28), EASYSIMD_FLOAT32_C(   -89.77) },
      { UINT32_C(         0),           UINT32_MAX, UINT32_C(         0), UINT32_C(         0) } },
    { { EASYSIMD_FLOAT32_C(   348.81), EASYSIMD_FLOAT32_C(  -407.57), EASYSIMD_FLOAT32_C(   461.12), EASYSIMD_FLOAT32_C(  -973.57) },
      { EASYSIMD_FLOAT32_C(  -318.44), EASYSIMD_FLOAT32_C(  -380.83), EASYSIMD_FLOAT32_C(  -918.31), EASYSIMD_FLOAT32_C(  -593.83) },
      { UINT32_C(         0),           UINT32_MAX, UINT32_C(         0),           UINT32_MAX } },
    { { EASYSIMD_FLOAT32_C(  -689.15), EASYSIMD_FLOAT32_C(    36.98), EASYSIMD_FLOAT32_C(   779.85), EASYSIMD_FLOAT32_C(  -534.89) },
      { EASYSIMD_FLOAT32_C(  -173.57), EASYSIMD_FLOAT32_C(     1.89), EASYSIMD_FLOAT32_C(   942.20), EASYSIMD_FLOAT32_C(   475.55) },
      {           UINT32_MAX, UINT32_C(         0),           UINT32_MAX,           UINT32_MAX } },
    { { EASYSIMD_FLOAT32_C(   705.44), EASYSIMD_FLOAT32_C(   -83.83), EASYSIMD_FLOAT32_C(   878.57), EASYSIMD_FLOAT32_C(  -104.10) },
      { EASYSIMD_FLOAT32_C(  -306.85), EASYSIMD_FLOAT32_C(  -435.11), EASYSIMD_FLOAT32_C(   878.57), EASYSIMD_FLOAT32_C(  -958.04) },
      { UINT32_C(         0), UINT32_C(         0), UINT32_C(         0), UINT32_C(         0) } },
    { { EASYSIMD_FLOAT32_C(   958.86), EASYSIMD_FLOAT32_C(  -849.92), EASYSIMD_FLOAT32_C(  -782.88), EASYSIMD_FLOAT32_C(   402.11) },
      { EASYSIMD_FLOAT32_C(   291.01), EASYSIMD_FLOAT32_C(   957.42), EASYSIMD_FLOAT32_C(  -782.88), EASYSIMD_FLOAT32_C(   601.87) },
      { UINT32_C(         0),           UINT32_MAX, UINT32_C(         0),           UINT32_MAX } },
    { { EASYSIMD_FLOAT32_C(    -1.14), EASYSIMD_FLOAT32_C(  -990.83), EASYSIMD_FLOAT32_C(   296.38), EASYSIMD_FLOAT32_C(  -973.62) },
      { EASYSIMD_FLOAT32_C(   145.16), EASYSIMD_FLOAT32_C(  -656.73), EASYSIMD_FLOAT32_C(   327.18), EASYSIMD_FLOAT32_C(  -149.41) },
      {           UINT32_MAX,           UINT32_MAX,           UINT32_MAX,           UINT32_MAX } },
    { { EASYSIMD_FLOAT32_C(   -35.24), EASYSIMD_FLOAT32_C(   625.06), EASYSIMD_FLOAT32_C(    99.32), EASYSIMD_FLOAT32_C(   260.43) },
      { EASYSIMD_FLOAT32_C(   -35.24), EASYSIMD_FLOAT32_C(  -937.06), EASYSIMD_FLOAT32_C(    99.32), EASYSIMD_FLOAT32_C(   -76.38) },
      { UINT32_C(         0), UINT32_C(         0), UINT32_C(         0), UINT32_C(         0) } },
  };
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x4_t r = easysimd_vcltq_f32(a, b);
...
static int
test_easysimd_vcltq_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    ...
    { { EASYSIMD_FLOAT64_C(  -541.42), EASYSIMD_FLOAT64_C(   483.82) },
      { EASYSIMD_FLOAT64_C(   242.04), EASYSIMD_FLOAT64_C(  -298.53) },
      {                    UINT64_MAX, UINT64_C(                   0) } },
    { { EASYSIMD_FLOAT64_C(   586.91), EASYSIMD_FLOAT64_C(  -140.81) },
      { EASYSIMD_FLOAT64_C(  -913.70), EASYSIMD_FLOAT64_C(  -140.81) },
      { UINT64_C(                   0), UINT64_C(                   0) } },
    { { EASYSIMD_FLOAT64_C(   257.61), EASYSIMD_FLOAT64_C(   978.00) },
      { EASYSIMD_FLOAT64_C(   491.76), EASYSIMD_FLOAT64_C(  -666.72) },
      {                    UINT64_MAX, UINT64_C(                   0) } },
    { { EASYSIMD_FLOAT64_C(   302.40), EASYSIMD_FLOAT64_C(  -658.81) },
      { EASYSIMD_FLOAT64_C(  -712.21), EASYSIMD_FLOAT64_C(  -658.81) },
      { UINT64_C(                   0), UINT64_C(                   0) } },
    { { EASYSIMD_FLOAT64_C(   285.48), EASYSIMD_FLOAT64_C(   825.49) },
      { EASYSIMD_FLOAT64_C(  -902.92), EASYSIMD_FLOAT64_C(   825.49) },
      { UINT64_C(                   0), UINT64_C(                   0) } },
    { { EASYSIMD_FLOAT64_C(  -855.34), EASYSIMD_FLOAT64_C(   506.60) },
      { EASYSIMD_FLOAT64_C(  -855.34), EASYSIMD_FLOAT64_C(  -668.79) },
      { UINT64_C(                   0), UINT64_C(                   0) } },
    { { EASYSIMD_FLOAT64_C(   494.95), EASYSIMD_FLOAT64_C(   794.97) },
      { EASYSIMD_FLOAT64_C(   494.95), EASYSIMD_FLOAT64_C(  -961.51) },
      { UINT64_C(                   0), UINT64_C(                   0) } },
    { { EASYSIMD_FLOAT64_C(    17.44), EASYSIMD_FLOAT64_C(   697.82) },
      { EASYSIMD_FLOAT64_C(    17.44), EASYSIMD_FLOAT64_C(   697.82) },
      { UINT64_C(                   0), UINT64_C(                   0) } },
  };
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint64x2_t r = easysimd_vcltq_f64(a, b);
...
static int
test_easysimd_vcltq_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int8_t a[16];
    int8_t b[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x16_t r = easysimd_vcltq_s8(a, b);
...
static int
test_easysimd_vcltq_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int16_t a[8];
    int16_t b[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x8_t r = easysimd_vcltq_s16(a, b);
...
static int
test_easysimd_vcltq_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t a[4];
    int32_t b[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x4_t r = easysimd_vcltq_s32(a, b);
...
static int
test_easysimd_vcltq_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int64_t a[2];
    int64_t b[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint64x2_t r = easysimd_vcltq_s64(a, b);
...
static int
test_easysimd_vcltq_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint8_t a[16];
    uint8_t b[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x16_t r = easysimd_vcltq_u8(a, b);
...
static int
test_easysimd_vcltq_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint16_t a[8];
    uint16_t b[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x8_t r = easysimd_vcltq_u16(a, b);
...
static int
test_easysimd_vcltq_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint32_t a[4];
    uint32_t b[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x4_t r = easysimd_vcltq_u32(a, b);
...
static int
test_easysimd_vcltq_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint64_t a[2];
    uint64_t b[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint64x2_t r = easysimd_vcltq_u64(a, b);
...
static int
test_easysimd_vcltd_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    ...
    { EASYSIMD_FLOAT64_C(   533.95),
      EASYSIMD_FLOAT64_C(   746.90),
                          UINT64_MAX },
    { EASYSIMD_FLOAT64_C(   573.36),
      EASYSIMD_FLOAT64_C(   889.97),
                          UINT64_MAX },
    { EASYSIMD_FLOAT64_C(  -468.38),
      EASYSIMD_FLOAT64_C(  -287.97),
                          UINT64_MAX },
    { EASYSIMD_FLOAT64_C(  -620.98),
      EASYSIMD_FLOAT64_C(   535.88),
                          UINT64_MAX },
    { EASYSIMD_FLOAT64_C(   425.47),
      EASYSIMD_FLOAT64_C(    98.32),
      UINT64_C(                   0) },
    { EASYSIMD_FLOAT64_C(  -160.48),
      EASYSIMD_FLOAT64_C(   423.53),
                          UINT64_MAX },
    { EASYSIMD_FLOAT64_C(  -851.46),
      EASYSIMD_FLOAT64_C(  -635.13),
                          UINT64_MAX },
    { EASYSIMD_FLOAT64_C(   951.90),
      EASYSIMD_FLOAT64_C(  -927.56),
      UINT64_C(                   0) }
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    uint64_t r = easysimd_vcltd_f64(test_vec[i].a, test_vec[i].b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    uint64_t r = easysimd_vcltd_f64(a, b);
...
static int
test_easysimd_vcltd_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int64_t a;
    int64_t b;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    uint64_t r = easysimd_vcltd_s64(test_vec[i].a, test_vec[i].b);
    easysimd_assert_equal_u64(r, test_vec[i].r);
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    uint64_t r = easysimd_vcltd_s64(a, b);
...
static int
test_easysimd_vcltd_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint64_t a;
    uint64_t b;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    uint64_t r = easysimd_vcltd_u64(test_vec[i].a, test_vec[i].b);
    easysimd_assert_equal_u64(r, test_vec[i].r);
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    uint64_t r = easysimd_vcltd_u64(a, b);
...
static int
test_easysimd_vclts_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    ...
    { EASYSIMD_FLOAT32_C(  -190.08),
      EASYSIMD_FLOAT32_C(   833.00),
                UINT32_MAX },
    { EASYSIMD_FLOAT32_C(   896.69),
      EASYSIMD_FLOAT32_C(   900.72),
                UINT32_MAX },
    { EASYSIMD_FLOAT32_C(  -980.09),
      EASYSIMD_FLOAT32_C(  -878.50),
                UINT32_MAX },
    { EASYSIMD_FLOAT32_C(  -545.23),
      EASYSIMD_FLOAT32_C(  -846.74),
      UINT32_C(         0) },
    { EASYSIMD_FLOAT32_C(  -227.24),
      EASYSIMD_FLOAT32_C(  -583.33),
      UINT32_C(         0) },
    { EASYSIMD_FLOAT32_C(  -329.70),
      EASYSIMD_FLOAT32_C(   600.18),
                UINT32_MAX },
    { EASYSIMD_FLOAT32_C(  -438.24),
      EASYSIMD_FLOAT32_C(   847.23),
                UINT32_MAX },
    { EASYSIMD_FLOAT32_C(   716.84),
      EASYSIMD_FLOAT32_C(  -704.38),
      UINT32_C(         0) }
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    uint32_t r = easysimd_vclts_f32(test_vec[i].a, test_vec[i].b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    uint32_t r = easysimd_vclts_f32(a, b);
...
EASYSIMD_TEST_FUNC_LIST_ENTRY(vclt_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vclt_f64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vclt_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vclt_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vclt_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vclt_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vclt_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vclt_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vclt_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vclt_u64)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vcltq_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcltq_f64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcltq_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcltq_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcltq_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcltq_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcltq_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcltq_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcltq_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcltq_u64)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vcltd_f64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcltd_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcltd_u64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vclts_f32)
