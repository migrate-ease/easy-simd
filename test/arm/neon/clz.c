#define EASYSIMD_TEST_ARM_NEON_INSN clz

#include "test-neon.h"
#include "../../../easysimd/arm/neon/clz.h"
...
static int
test_easysimd_x_vclzb_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int8_t a;
    int8_t r;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    int8_t r = easysimd_x_vclzb_s8(test_vec[i].a);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    int8_t r = easysimd_x_vclzb_s8(a);
...
static int
test_easysimd_x_vclzh_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int16_t a;
    int16_t r;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    int16_t r = easysimd_x_vclzh_s16(test_vec[i].a);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    int16_t r = easysimd_x_vclzh_s16(a);
...
static int
test_easysimd_x_vclzs_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t a;
    int32_t r;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    int32_t r = easysimd_x_vclzs_s32(test_vec[i].a);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    int32_t r = easysimd_x_vclzs_s32(a);
...
static int
test_easysimd_x_vclzb_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint8_t a;
    uint8_t r;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    uint8_t r = easysimd_x_vclzb_u8(test_vec[i].a);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    uint8_t r = easysimd_x_vclzb_u8(a);
...
static int
test_easysimd_x_vclzh_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint16_t a;
    uint16_t r;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    uint16_t r = easysimd_x_vclzh_u16(test_vec[i].a);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    uint16_t r = easysimd_x_vclzh_u16(a);
...
static int
test_easysimd_x_vclzs_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint32_t a;
    uint32_t r;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    uint32_t r = easysimd_x_vclzs_u32(test_vec[i].a);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    uint32_t r = easysimd_x_vclzs_u32(a);
...
static int
test_easysimd_vclz_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int8_t a[8];
    int8_t r[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int8x8_t r = easysimd_vclz_s8(a);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    if (i == 0) {
      a = easysimd_vset_lane_s8( INT8_C(0), a, 0);
      a = easysimd_vset_lane_s8(-INT8_C(1), a, 1);
    }
    easysimd_int8x8_t r = easysimd_vclz_s8(a);
...
static int
test_easysimd_vclz_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int16_t a[4];
    int16_t r[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int16x4_t r = easysimd_vclz_s16(a);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    if (i == 0) {
      a = easysimd_vset_lane_s16( INT16_C(0), a, 0);
      a = easysimd_vset_lane_s16(-INT16_C(1), a, 1);
    }
    easysimd_int16x4_t r = easysimd_vclz_s16(a);
...
static int
test_easysimd_vclz_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t a[2];
    int32_t r[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x2_t r = easysimd_vclz_s32(a);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    if (i == 0) {
      a = easysimd_vset_lane_s32( INT32_C(0), a, 0);
      a = easysimd_vset_lane_s32(-INT32_C(1), a, 1);
    }
    easysimd_int32x2_t r = easysimd_vclz_s32(a);
...
static int
test_easysimd_vclz_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint8_t a[8];
    uint8_t r[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x8_t r = easysimd_vclz_u8(a);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    if (i == 0) {
      a = easysimd_vset_lane_u8(UINT8_C(0), a, 0);
      a = easysimd_vset_lane_u8( UINT8_MAX, a, 1);
    }
    easysimd_uint8x8_t r = easysimd_vclz_u8(a);
...
static int
test_easysimd_vclz_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint16_t a[4];
    uint16_t r[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x4_t r = easysimd_vclz_u16(a);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    if (i == 0) {
      a = easysimd_vset_lane_u16(UINT16_C(0), a, 0);
      a = easysimd_vset_lane_u16( UINT16_MAX, a, 1);
    }
    easysimd_uint16x4_t r = easysimd_vclz_u16(a);
...
static int
test_easysimd_vclz_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint32_t a[2];
    uint32_t r[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x2_t r = easysimd_vclz_u32(a);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    if (i == 0) {
      a = easysimd_vset_lane_u32(UINT32_C(0), a, 0);
      a = easysimd_vset_lane_u32( UINT32_MAX, a, 1);
    }
    easysimd_uint32x2_t r = easysimd_vclz_u32(a);
...
static int
test_easysimd_vclzq_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int8_t a[16];
    int8_t r[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int8x16_t r = easysimd_vclzq_s8(a);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    if (i == 0) {
      a = easysimd_vsetq_lane_s8( INT8_C(0), a, 0);
      a = easysimd_vsetq_lane_s8(-INT8_C(1), a, 1);
    }
    easysimd_int8x16_t r = easysimd_vclzq_s8(a);
...
static int
test_easysimd_vclzq_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int16_t a[8];
    int16_t r[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int16x8_t r = easysimd_vclzq_s16(a);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    if (i == 0) {
      a = easysimd_vsetq_lane_s16( INT16_C(0), a, 0);
      a = easysimd_vsetq_lane_s16(-INT16_C(1), a, 1);
    }
    easysimd_int16x8_t r = easysimd_vclzq_s16(a);
...
static int
test_easysimd_vclzq_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t a[4];
    int32_t r[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x4_t r = easysimd_vclzq_s32(a);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    if (i == 0) {
      a = easysimd_vsetq_lane_s32( INT32_C(0), a, 0);
      a = easysimd_vsetq_lane_s32(-INT32_C(1), a, 1);
    }
    easysimd_int32x4_t r = easysimd_vclzq_s32(a);
...
static int
test_easysimd_vclzq_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint8_t a[16];
    uint8_t r[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x16_t r = easysimd_vclzq_u8(a);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    if (i == 0) {
      a = easysimd_vsetq_lane_u8(UINT8_C(0), a, 0);
      a = easysimd_vsetq_lane_u8( UINT8_MAX, a, 1);
    }
    easysimd_uint8x16_t r = easysimd_vclzq_u8(a);
...
static int
test_easysimd_vclzq_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint16_t a[8];
    uint16_t r[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x8_t r = easysimd_vclzq_u16(a);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    if (i == 0) {
      a = easysimd_vsetq_lane_u16(UINT16_C(0), a, 0);
      a = easysimd_vsetq_lane_u16( UINT16_MAX, a, 1);
    }
    easysimd_uint16x8_t r = easysimd_vclzq_u16(a);
...
static int
test_easysimd_vclzq_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint32_t a[4];
    uint32_t r[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x4_t r = easysimd_vclzq_u32(a);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    if (i == 0) {
      a = easysimd_vsetq_lane_u32(UINT32_C(0), a, 0);
      a = easysimd_vsetq_lane_u32( UINT32_MAX, a, 1);
    }
    easysimd_uint32x4_t r = easysimd_vclzq_u32(a);
...
EASYSIMD_TEST_FUNC_LIST_ENTRY(x_vclzb_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(x_vclzh_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(x_vclzs_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(x_vclzb_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(x_vclzh_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(x_vclzs_u32)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vclz_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vclz_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vclz_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vclz_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vclz_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vclz_u32)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vclzq_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vclzq_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vclzq_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vclzq_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vclzq_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vclzq_u32)
