#define EASYSIMD_TEST_ARM_NEON_INSN combine

#include "test-neon.h"
#include "../../../easysimd/arm/neon/combine.h"

static int
test_easysimd_vcombine_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    ...
    { { EASYSIMD_FLOAT32_C(   -53.98), EASYSIMD_FLOAT32_C(  -106.66) },
      { EASYSIMD_FLOAT32_C(   -75.22), EASYSIMD_FLOAT32_C(   554.40) },
      { EASYSIMD_FLOAT32_C(   -53.98), EASYSIMD_FLOAT32_C(  -106.66), EASYSIMD_FLOAT32_C(   -75.22), EASYSIMD_FLOAT32_C(   554.40) } },
    { { EASYSIMD_FLOAT32_C(   653.50), EASYSIMD_FLOAT32_C(   983.28) },
      { EASYSIMD_FLOAT32_C(    26.88), EASYSIMD_FLOAT32_C(   397.84) },
      { EASYSIMD_FLOAT32_C(   653.50), EASYSIMD_FLOAT32_C(   983.28), EASYSIMD_FLOAT32_C(    26.88), EASYSIMD_FLOAT32_C(   397.84) } },
    { { EASYSIMD_FLOAT32_C(  -890.56), EASYSIMD_FLOAT32_C(   449.15) },
      { EASYSIMD_FLOAT32_C(  -645.05), EASYSIMD_FLOAT32_C(   760.45) },
      { EASYSIMD_FLOAT32_C(  -890.56), EASYSIMD_FLOAT32_C(   449.15), EASYSIMD_FLOAT32_C(  -645.05), EASYSIMD_FLOAT32_C(   760.45) } },
    { { EASYSIMD_FLOAT32_C(  -595.29), EASYSIMD_FLOAT32_C(  -601.12) },
      { EASYSIMD_FLOAT32_C(   312.34), EASYSIMD_FLOAT32_C(  -100.77) },
      { EASYSIMD_FLOAT32_C(  -595.29), EASYSIMD_FLOAT32_C(  -601.12), EASYSIMD_FLOAT32_C(   312.34), EASYSIMD_FLOAT32_C(  -100.77) } },
    { { EASYSIMD_FLOAT32_C(  -983.11), EASYSIMD_FLOAT32_C(   886.29) },
      { EASYSIMD_FLOAT32_C(  -371.66), EASYSIMD_FLOAT32_C(   376.19) },
      { EASYSIMD_FLOAT32_C(  -983.11), EASYSIMD_FLOAT32_C(   886.29), EASYSIMD_FLOAT32_C(  -371.66), EASYSIMD_FLOAT32_C(   376.19) } },
    { { EASYSIMD_FLOAT32_C(   421.16), EASYSIMD_FLOAT32_C(  -941.17) },
      { EASYSIMD_FLOAT32_C(  -980.32), EASYSIMD_FLOAT32_C(    53.73) },
      { EASYSIMD_FLOAT32_C(   421.16), EASYSIMD_FLOAT32_C(  -941.17), EASYSIMD_FLOAT32_C(  -980.32), EASYSIMD_FLOAT32_C(    53.73) } },
    { { EASYSIMD_FLOAT32_C(  -450.56), EASYSIMD_FLOAT32_C(  -313.93) },
      { EASYSIMD_FLOAT32_C(  -837.06), EASYSIMD_FLOAT32_C(  -183.56) },
      { EASYSIMD_FLOAT32_C(  -450.56), EASYSIMD_FLOAT32_C(  -313.93), EASYSIMD_FLOAT32_C(  -837.06), EASYSIMD_FLOAT32_C(  -183.56) } },
    { { EASYSIMD_FLOAT32_C(   591.39), EASYSIMD_FLOAT32_C(   270.71) },
      { EASYSIMD_FLOAT32_C(  -178.56), EASYSIMD_FLOAT32_C(  -462.59) },
      { EASYSIMD_FLOAT32_C(   591.39), EASYSIMD_FLOAT32_C(   270.71), EASYSIMD_FLOAT32_C(  -178.56), EASYSIMD_FLOAT32_C(  -462.59) } },
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float32x2_t a = easysimd_vld1_f32(test_vec[i].a);
    easysimd_float32x2_t b = easysimd_vld1_f32(test_vec[i].b);
    easysimd_float32x4_t r = easysimd_vcombine_f32(a, b);
...
static int
test_easysimd_vcombine_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    ...
    { { EASYSIMD_FLOAT64_C(   425.89) },
      { EASYSIMD_FLOAT64_C(   679.01) },
      { EASYSIMD_FLOAT64_C(   425.89), EASYSIMD_FLOAT64_C(   679.01) } },
    { { EASYSIMD_FLOAT64_C(    46.20) },
      { EASYSIMD_FLOAT64_C(  -599.79) },
      { EASYSIMD_FLOAT64_C(    46.20), EASYSIMD_FLOAT64_C(  -599.79) } },
    { { EASYSIMD_FLOAT64_C(   -92.67) },
      { EASYSIMD_FLOAT64_C(   654.91) },
      { EASYSIMD_FLOAT64_C(   -92.67), EASYSIMD_FLOAT64_C(   654.91) } },
    { { EASYSIMD_FLOAT64_C(   643.92) },
      { EASYSIMD_FLOAT64_C(   238.58) },
      { EASYSIMD_FLOAT64_C(   643.92), EASYSIMD_FLOAT64_C(   238.58) } },
    { { EASYSIMD_FLOAT64_C(   715.59) },
      { EASYSIMD_FLOAT64_C(  -916.05) },
      { EASYSIMD_FLOAT64_C(   715.59), EASYSIMD_FLOAT64_C(  -916.05) } },
    { { EASYSIMD_FLOAT64_C(  -885.97) },
      { EASYSIMD_FLOAT64_C(   112.56) },
      { EASYSIMD_FLOAT64_C(  -885.97), EASYSIMD_FLOAT64_C(   112.56) } },
    { { EASYSIMD_FLOAT64_C(   319.99) },
      { EASYSIMD_FLOAT64_C(  -850.11) },
      { EASYSIMD_FLOAT64_C(   319.99), EASYSIMD_FLOAT64_C(  -850.11) } },
    { { EASYSIMD_FLOAT64_C(  -588.46) },
      { EASYSIMD_FLOAT64_C(   182.96) },
      { EASYSIMD_FLOAT64_C(  -588.46), EASYSIMD_FLOAT64_C(   182.96) } },
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float64x1_t a = easysimd_vld1_f64(test_vec[i].a);
    easysimd_float64x1_t b = easysimd_vld1_f64(test_vec[i].b);
    easysimd_float64x2_t r = easysimd_vcombine_f64(a, b);
...
static int
test_easysimd_vcombine_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int8_t a[8];
    int8_t b[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int8x16_t r = easysimd_vcombine_s8(a, b);
...
static int
test_easysimd_vcombine_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int16_t a[4];
    int16_t b[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int16x8_t r = easysimd_vcombine_s16(a, b);
...
static int
test_easysimd_vcombine_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t a[2];
    int32_t b[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x4_t r = easysimd_vcombine_s32(a, b);
...
static int
test_easysimd_vcombine_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int64_t a[1];
    int64_t b[1];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int64x2_t r = easysimd_vcombine_s64(a, b);
...
static int
test_easysimd_vcombine_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint8_t a[8];
    uint8_t b[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x16_t r = easysimd_vcombine_u8(a, b);
...
static int
test_easysimd_vcombine_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint16_t a[4];
    uint16_t b[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x8_t r = easysimd_vcombine_u16(a, b);
...
static int
test_easysimd_vcombine_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint32_t a[2];
    uint32_t b[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x4_t r = easysimd_vcombine_u32(a, b);
...
static int
test_easysimd_vcombine_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint64_t a[1];
    uint64_t b[1];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint64x2_t r = easysimd_vcombine_u64(a, b);
...
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcombine_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcombine_f64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcombine_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcombine_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcombine_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcombine_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcombine_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcombine_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcombine_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vcombine_u64)
