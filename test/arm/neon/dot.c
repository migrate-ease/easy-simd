#define EASYSIMD_TEST_ARM_NEON_INSN dot

#include "test-neon.h"
#include "../../../easysimd/arm/neon/dot.h"


static int
test_easysimd_vdot_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t a[2];
    int8_t b[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x2_t r = easysimd_vdot_s32(a, b, c);
...
static int
test_easysimd_vdot_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint32_t a[2];
    uint8_t b[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x2_t r = easysimd_vdot_u32(a, b, c);
...
static int
test_easysimd_vdotq_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t a[4];
    int8_t b[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x4_t r = easysimd_vdotq_s32(a, b, c);
...
static int
test_easysimd_vdotq_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint32_t a[4];
    uint8_t b[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x4_t r = easysimd_vdotq_u32(a, b, c);
...
EASYSIMD_TEST_FUNC_LIST_ENTRY(vdot_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vdot_u32)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vdotq_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vdotq_u32)
