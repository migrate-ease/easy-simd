#define EASYSIMD_TEST_ARM_NEON_INSN dot_lane

#include "test-neon.h"
#include "../../../easysimd/arm/neon/dot_lane.h"
#include "../../../easysimd/arm/neon/dup_n.h"

static int
test_easysimd_vdot_lane_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t r_[2];
    int8_t a[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_int32x2_t r_ = easysimd_vld1_s32(test_vec[i].r_);
    easysimd_int8x8_t a = easysimd_vld1_s8(test_vec[i].a);
    easysimd_int8x8_t b = easysimd_vld1_s8(test_vec[i].b);
    easysimd_int32x2_t r;

    EASYSIMD_CONSTIFY_2_(easysimd_vdot_lane_s32, r, (HEDLEY_UNREACHABLE(), easysimd_vdup_n_s32(INT32_C(0))), test_vec[i].lane, r_, a, b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    easysimd_int32x2_t r_ = easysimd_test_arm_neon_random_i32x2();
    easysimd_int8x8_t a = easysimd_test_arm_neon_random_i8x8();
    easysimd_int8x8_t b = easysimd_test_arm_neon_random_i8x8();
    easysimd_int32x2_t r = easysimd_vdot_lane_s32(r_, a, b, lanes[i]);

    easysimd_test_arm_neon_write_i32x2(2, r_, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_arm_neon_write_i8x8(2, a, EASYSIMD_TEST_VEC_POS_MIDDLE);
...
static int
test_easysimd_vdot_lane_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint32_t r_[2];
    uint8_t a[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint32x2_t r_ = easysimd_vld1_u32(test_vec[i].r_);
    ...
    EASYSIMD_CONSTIFY_2_(easysimd_vdot_lane_u32, r, (HEDLEY_UNREACHABLE(), easysimd_vdup_n_u32(UINT32_C(0))), test_vec[i].lane, r_, a, b);
  ...
  const int lanes[] = { 0, 1, 0, 1, 0, 1, 0, 1 };
  for (int i = 0 ; i < 8 ; i++) {
    easysimd_uint32x2_t r_ = easysimd_test_arm_neon_random_u32x2();
    easysimd_uint8x8_t a = easysimd_test_arm_neon_random_u8x8();
    easysimd_uint8x8_t b = easysimd_test_arm_neon_random_u8x8();
    easysimd_uint32x2_t r = easysimd_vdot_lane_u32(r_, a, b, lanes[i]);

    easysimd_test_arm_neon_write_u32x2(2, r_, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_arm_neon_write_u8x8(2, a, EASYSIMD_TEST_VEC_POS_MIDDLE);
...
static int
test_easysimd_vdot_laneq_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t r_[2];
    int8_t a[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    EASYSIMD_CONSTIFY_4_(easysimd_vdot_laneq_s32, r, (HEDLEY_UNREACHABLE(), easysimd_vdup_n_s32(INT32_C(0))), test_vec[i].lane, r_, a, b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_int32x2_t r = easysimd_vdot_laneq_s32(r_, a, b, lanes[i]);
...
static int
test_easysimd_vdot_laneq_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint32_t r_[2];
    uint8_t a[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    EASYSIMD_CONSTIFY_4_(easysimd_vdot_laneq_u32, r, (HEDLEY_UNREACHABLE(), easysimd_vdup_n_u32(INT32_C(0))), test_vec[i].lane, r_, a, b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_uint32x2_t r = easysimd_vdot_laneq_u32(r_, a, b, lanes[i]);
...
static int
test_easysimd_vdotq_laneq_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint32_t r_[4];
    uint8_t a[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint32x4_t r_ = easysimd_vld1q_u32(test_vec[i].r_);
    easysimd_uint8x16_t a = easysimd_vld1q_u8(test_vec[i].a);
    easysimd_uint8x16_t b = easysimd_vld1q_u8(test_vec[i].b);
    easysimd_uint32x4_t r;

    EASYSIMD_CONSTIFY_4_(easysimd_vdotq_laneq_u32, r, (HEDLEY_UNREACHABLE(), easysimd_vdupq_n_u32(INT32_C(0))), test_vec[i].lane, r_, a, b);
  ...
  const int lanes[] = { 0, 1, 2, 3, 0, 1, 2, 3 };
  for (int i = 0 ; i < 8 ; i++) {
    easysimd_uint32x4_t r_ = easysimd_test_arm_neon_random_u32x4();
    easysimd_uint8x16_t a = easysimd_test_arm_neon_random_u8x16();
    easysimd_uint8x16_t b = easysimd_test_arm_neon_random_u8x16();
    easysimd_uint32x4_t r = easysimd_vdotq_laneq_u32(r_, a, b, lanes[i]);

    easysimd_test_arm_neon_write_u32x4(2, r_, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_arm_neon_write_u8x16(2, a, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_u8x16(2, b, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_codegen_write_i32(2, lanes[i], EASYSIMD_TEST_VEC_POS_MIDDLE);
...
static int
test_easysimd_vdotq_laneq_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t r_[4];
    int8_t a[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_int32x4_t r_ = easysimd_vld1q_s32(test_vec[i].r_);
    easysimd_int8x16_t a = easysimd_vld1q_s8(test_vec[i].a);
    easysimd_int8x16_t b = easysimd_vld1q_s8(test_vec[i].b);
    easysimd_int32x4_t r;

    EASYSIMD_CONSTIFY_4_(easysimd_vdotq_laneq_s32, r, (HEDLEY_UNREACHABLE(), easysimd_vdupq_n_s32(INT32_C(0))), test_vec[i].lane, r_, a, b);
  ...
  const int lanes[] = { 0, 1, 2, 3, 0, 1, 2, 3 };
  for (int i = 0 ; i < 8 ; i++) {
    easysimd_int32x4_t r_ = easysimd_test_arm_neon_random_i32x4();
    easysimd_int8x16_t a = easysimd_test_arm_neon_random_i8x16();
    easysimd_int8x16_t b = easysimd_test_arm_neon_random_i8x16();
    easysimd_int32x4_t r = easysimd_vdotq_laneq_s32(r_, a, b, lanes[i]);

    easysimd_test_arm_neon_write_i32x4(2, r_, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_arm_neon_write_i8x16(2, a, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_i8x16(2, b, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_codegen_write_i32(2, lanes[i], EASYSIMD_TEST_VEC_POS_MIDDLE);
...
static int
test_easysimd_vdotq_lane_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint32_t r_[4];
    uint8_t a[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    EASYSIMD_CONSTIFY_2_(easysimd_vdotq_lane_u32, r, (HEDLEY_UNREACHABLE(), easysimd_vdupq_n_u32(UINT32_C(0))), test_vec[i].lane, r_, a, b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_uint8x16_t a = easysimd_test_arm_neon_random_u8x16();
    easysimd_uint8x8_t b = easysimd_test_arm_neon_random_u8x8();
    easysimd_uint32x4_t r = easysimd_vdotq_lane_u32(r_, a, b, lanes[i]);
...
static int
test_easysimd_vdotq_lane_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t r_[4];
    int8_t a[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    EASYSIMD_CONSTIFY_2_(easysimd_vdotq_lane_s32, r, (HEDLEY_UNREACHABLE(), easysimd_vdupq_n_s32(INT32_C(0))), test_vec[i].lane, r_, a, b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_int8x16_t a = easysimd_test_arm_neon_random_i8x16();
    easysimd_int8x8_t b = easysimd_test_arm_neon_random_i8x8();
    easysimd_int32x4_t r = easysimd_vdotq_lane_s32(r_, a, b, lanes[i]);
...
EASYSIMD_TEST_FUNC_LIST_ENTRY(vdot_lane_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vdot_lane_u32)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vdot_laneq_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vdot_laneq_u32)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vdotq_laneq_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vdotq_laneq_s32)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vdotq_lane_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vdotq_lane_s32)
