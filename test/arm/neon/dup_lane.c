#define EASYSIMD_TEST_ARM_NEON_INSN dup_lane

#include "test-neon.h"
#include "../../../easysimd/arm/neon/dup_n.h"
#include "../../../easysimd/arm/neon/dup_lane.h"

HEDLEY_DIAGNOSTIC_PUSH
EASYSIMD_DIAGNOSTIC_DISABLE_UNREACHABLE_

static int
test_easysimd_vdup_lane_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  struct {
    easysimd_float32 vec[2];
    int lane;
    easysimd_float32 r[2];
  } test_vec[] = {
    { { EASYSIMD_FLOAT32_C(  -787.13), EASYSIMD_FLOAT32_C(   -15.07) },
       INT8_C(   1),
      { EASYSIMD_FLOAT32_C(   -15.07), EASYSIMD_FLOAT32_C(   -15.07) } },
    { { EASYSIMD_FLOAT32_C(    46.30), EASYSIMD_FLOAT32_C(   346.17) },
       INT8_C(   1),
      { EASYSIMD_FLOAT32_C(   346.17), EASYSIMD_FLOAT32_C(   346.17) } },
    { { EASYSIMD_FLOAT32_C(  -139.62), EASYSIMD_FLOAT32_C(   486.64) },
       INT8_C(   0),
      { EASYSIMD_FLOAT32_C(  -139.62), EASYSIMD_FLOAT32_C(  -139.62) } },
    { { EASYSIMD_FLOAT32_C(   -65.92), EASYSIMD_FLOAT32_C(   539.38) },
       INT8_C(   0),
      { EASYSIMD_FLOAT32_C(   -65.92), EASYSIMD_FLOAT32_C(   -65.92) } },
    { { EASYSIMD_FLOAT32_C(  -303.01), EASYSIMD_FLOAT32_C(   704.85) },
       INT8_C(   0),
      { EASYSIMD_FLOAT32_C(  -303.01), EASYSIMD_FLOAT32_C(  -303.01) } },
    { { EASYSIMD_FLOAT32_C(   135.71), EASYSIMD_FLOAT32_C(   169.99) },
       INT8_C(   1),
      { EASYSIMD_FLOAT32_C(   169.99), EASYSIMD_FLOAT32_C(   169.99) } },
    { { EASYSIMD_FLOAT32_C(   262.13), EASYSIMD_FLOAT32_C(   264.53) },
       INT8_C(   1),
      { EASYSIMD_FLOAT32_C(   264.53), EASYSIMD_FLOAT32_C(   264.53) } },
    { { EASYSIMD_FLOAT32_C(   988.58), EASYSIMD_FLOAT32_C(  -848.75) },
       INT8_C(   0),
      { EASYSIMD_FLOAT32_C(   988.58), EASYSIMD_FLOAT32_C(   988.58) } }
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float32x2_t vec;
    easysimd_float32x2_t r;

    vec = easysimd_vld1_f32(test_vec[i].vec);
    EASYSIMD_CONSTIFY_2_(easysimd_vdup_lane_f32, r, (HEDLEY_UNREACHABLE(), easysimd_vdup_n_f32(0.0f)), test_vec[i].lane, vec);
  ...
  fputc('\n', stdout);
  for (int i = 0 ; i < 8 ; i++) {
    easysimd_float32x2_t vec = easysimd_test_arm_neon_random_f32x2(-1000.0, 1000.0);
    int lane = easysimd_test_codegen_random_i8() & 1;

    easysimd_float32x2_t r;
    EASYSIMD_CONSTIFY_2_(easysimd_vdup_lane_f32, r, (HEDLEY_UNREACHABLE(), easysimd_vdup_n_f32(0.0f)), lane, vec);

    easysimd_test_arm_neon_write_f32x2(2, vec, EASYSIMD_TEST_VEC_POS_FIRST);
...
static int
test_easysimd_vdup_lane_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  struct {
    easysimd_float64 vec[1];
    easysimd_float64 r[1];
  } test_vec[] = {
    { { EASYSIMD_FLOAT64_C(   101.54) },
      { EASYSIMD_FLOAT64_C(   101.54) } },
    { { EASYSIMD_FLOAT64_C(   798.61) },
      { EASYSIMD_FLOAT64_C(   798.61) } },
    { { EASYSIMD_FLOAT64_C(   273.92) },
      { EASYSIMD_FLOAT64_C(   273.92) } },
    { { EASYSIMD_FLOAT64_C(   -17.48) },
      { EASYSIMD_FLOAT64_C(   -17.48) } },
    { { EASYSIMD_FLOAT64_C(   458.09) },
      { EASYSIMD_FLOAT64_C(   458.09) } },
    { { EASYSIMD_FLOAT64_C(   541.19) },
      { EASYSIMD_FLOAT64_C(   541.19) } },
    { { EASYSIMD_FLOAT64_C(  -316.84) },
      { EASYSIMD_FLOAT64_C(  -316.84) } },
    { { EASYSIMD_FLOAT64_C(   934.37) },
      { EASYSIMD_FLOAT64_C(   934.37) } }
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float64x1_t vec;
    easysimd_float64x1_t r;

    vec = easysimd_vld1_f64(test_vec[i].vec);
    r = easysimd_vdup_lane_f64(vec, 0);
  ...
  fputc('\n', stdout);
  for (int i = 0 ; i < 8 ; i++) {
    easysimd_float64x1_t vec = easysimd_test_arm_neon_random_f64x1(-1000.0, 1000.0);
    easysimd_float64x1_t r = easysimd_vdup_lane_f64(vec, 0);

    easysimd_test_arm_neon_write_f64x1(2, vec, EASYSIMD_TEST_VEC_POS_FIRST);
...
static int
test_easysimd_vdup_lane_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  struct {
    int8_t vec[8];
    int lane;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_int8x8_t vec;
    easysimd_int8x8_t r;

    vec = easysimd_vld1_s8(test_vec[i].vec);
    EASYSIMD_CONSTIFY_8_(easysimd_vdup_lane_s8, r, (HEDLEY_UNREACHABLE(), easysimd_vdup_n_s8(INT8_C(0))), test_vec[i].lane, vec);
  ...
  fputc('\n', stdout);
  for (int i = 0 ; i < 8 ; i++) {
    easysimd_int8x8_t vec = easysimd_test_arm_neon_random_i8x8();
    int lane = easysimd_test_codegen_random_i8() & 7;

    easysimd_int8x8_t r;
    EASYSIMD_CONSTIFY_8_(easysimd_vdup_lane_s8, r, (HEDLEY_UNREACHABLE(), easysimd_vdup_n_s8(INT8_C(0))), lane, vec);

    easysimd_test_arm_neon_write_i8x8(2, vec, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_codegen_write_i8(2, HEDLEY_STATIC_CAST(int8_t, lane), EASYSIMD_TEST_VEC_POS_MIDDLE);
...
static int
test_easysimd_vdup_lane_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  struct {
    int16_t vec[4];
    int lane;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_int16x4_t vec;
    easysimd_int16x4_t r;

    vec = easysimd_vld1_s16(test_vec[i].vec);
    EASYSIMD_CONSTIFY_4_(easysimd_vdup_lane_s16, r, (HEDLEY_UNREACHABLE(), easysimd_vdup_n_s16(INT16_C(0))), test_vec[i].lane, vec);
  ...
  fputc('\n', stdout);
  for (int i = 0 ; i < 8 ; i++) {
    easysimd_int16x4_t vec = easysimd_test_arm_neon_random_i16x4();
    int lane = easysimd_test_codegen_random_i8() & 3;

    easysimd_int16x4_t r;
    EASYSIMD_CONSTIFY_4_(easysimd_vdup_lane_s16, r, (HEDLEY_UNREACHABLE(), easysimd_vdup_n_s16(INT8_C(0))), lane, vec);

    easysimd_test_arm_neon_write_i16x4(2, vec, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_codegen_write_i8(2, HEDLEY_STATIC_CAST(int8_t, lane), EASYSIMD_TEST_VEC_POS_MIDDLE);
...
static int
test_easysimd_vdup_lane_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  struct {
    int32_t vec[2];
    int lane;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_int32x2_t vec;
    easysimd_int32x2_t r;

    vec = easysimd_vld1_s32(test_vec[i].vec);
    EASYSIMD_CONSTIFY_2_(easysimd_vdup_lane_s32, r, (HEDLEY_UNREACHABLE(), easysimd_vdup_n_s32(INT32_C(0))), test_vec[i].lane, vec);
  ...
  fputc('\n', stdout);
  for (int i = 0 ; i < 8 ; i++) {
    easysimd_int32x2_t vec = easysimd_test_arm_neon_random_i32x2();
    int lane = easysimd_test_codegen_random_i8() & 1;

    easysimd_int32x2_t r;
    EASYSIMD_CONSTIFY_2_(easysimd_vdup_lane_s32, r, (HEDLEY_UNREACHABLE(), easysimd_vdup_n_s32(INT8_C(0))), lane, vec);

    easysimd_test_arm_neon_write_i32x2(2, vec, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_codegen_write_i8(2, HEDLEY_STATIC_CAST(int8_t, lane), EASYSIMD_TEST_VEC_POS_MIDDLE);
...
static int
test_easysimd_vdup_lane_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  struct {
    int64_t vec[1];
    int64_t r[1];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_int64x1_t vec;
    easysimd_int64x1_t r;

    vec = easysimd_vld1_s64(test_vec[i].vec);
    r = easysimd_vdup_lane_s64(vec, 0);
  ...
  fputc('\n', stdout);
  for (int i = 0 ; i < 8 ; i++) {
    easysimd_int64x1_t vec = easysimd_test_arm_neon_random_i64x1();

    easysimd_int64x1_t r = easysimd_vdup_lane_s64(vec, 0);

    easysimd_test_arm_neon_write_i64x1(2, vec, EASYSIMD_TEST_VEC_POS_FIRST);
...
static int
test_easysimd_vdup_lane_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  struct {
    uint8_t vec[8];
    int lane;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint8x8_t vec;
    easysimd_uint8x8_t r;

    vec = easysimd_vld1_u8(test_vec[i].vec);
    EASYSIMD_CONSTIFY_8_(easysimd_vdup_lane_u8, r, (HEDLEY_UNREACHABLE(), easysimd_vdup_n_u8(UINT8_C(0))), test_vec[i].lane, vec);
  ...
  fputc('\n', stdout);
  for (int i = 0 ; i < 8 ; i++) {
    easysimd_uint8x8_t vec = easysimd_test_arm_neon_random_u8x8();
    int lane = easysimd_test_codegen_random_u8() & 7;

    easysimd_uint8x8_t r;
    EASYSIMD_CONSTIFY_8_(easysimd_vdup_lane_u8, r, (HEDLEY_UNREACHABLE(), easysimd_vdup_n_u8(UINT8_C(0))), lane, vec);

    easysimd_test_arm_neon_write_u8x8(2, vec, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_codegen_write_u8(2, HEDLEY_STATIC_CAST(uint8_t, lane), EASYSIMD_TEST_VEC_POS_MIDDLE);
...
static int
test_easysimd_vdup_lane_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  struct {
    uint16_t vec[4];
    int lane;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint16x4_t vec;
    easysimd_uint16x4_t r;

    vec = easysimd_vld1_u16(test_vec[i].vec);
    EASYSIMD_CONSTIFY_4_(easysimd_vdup_lane_u16, r, (HEDLEY_UNREACHABLE(), easysimd_vdup_n_u16(UINT16_C(0))), test_vec[i].lane, vec);
  ...
  fputc('\n', stdout);
  for (int i = 0 ; i < 8 ; i++) {
    easysimd_uint16x4_t vec = easysimd_test_arm_neon_random_u16x4();
    int lane = easysimd_test_codegen_random_u8() & 3;

    easysimd_uint16x4_t r;
    EASYSIMD_CONSTIFY_4_(easysimd_vdup_lane_u16, r, (HEDLEY_UNREACHABLE(), easysimd_vdup_n_u16(UINT8_C(0))), lane, vec);

    easysimd_test_arm_neon_write_u16x4(2, vec, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_codegen_write_u8(2, HEDLEY_STATIC_CAST(uint8_t, lane), EASYSIMD_TEST_VEC_POS_MIDDLE);
...
static int
test_easysimd_vdup_lane_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  struct {
    uint32_t vec[2];
    int lane;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint32x2_t vec;
    easysimd_uint32x2_t r;

    vec = easysimd_vld1_u32(test_vec[i].vec);
    EASYSIMD_CONSTIFY_2_(easysimd_vdup_lane_u32, r, (HEDLEY_UNREACHABLE(), easysimd_vdup_n_u32(UINT32_C(0))), test_vec[i].lane, vec);
  ...
  fputc('\n', stdout);
  for (int i = 0 ; i < 8 ; i++) {
    easysimd_uint32x2_t vec = easysimd_test_arm_neon_random_u32x2();
    int lane = easysimd_test_codegen_random_u8() & 1;

    easysimd_uint32x2_t r;
    EASYSIMD_CONSTIFY_2_(easysimd_vdup_lane_u32, r, (HEDLEY_UNREACHABLE(), easysimd_vdup_n_u32(UINT8_C(0))), lane, vec);

    easysimd_test_arm_neon_write_u32x2(2, vec, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_codegen_write_u8(2, HEDLEY_STATIC_CAST(uint8_t, lane), EASYSIMD_TEST_VEC_POS_MIDDLE);
...
static int
test_easysimd_vdup_lane_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  struct {
    uint64_t vec[1];
    uint64_t r[1];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint64x1_t vec;
    easysimd_uint64x1_t r;

    vec = easysimd_vld1_u64(test_vec[i].vec);
    r = easysimd_vdup_lane_u64(vec, 0);
  ...
  fputc('\n', stdout);
  for (int i = 0 ; i < 8 ; i++) {
    easysimd_uint64x1_t vec = easysimd_test_arm_neon_random_u64x1();

    easysimd_uint64x1_t r = easysimd_vdup_lane_u64(vec, 0);

    easysimd_test_arm_neon_write_u64x1(2, vec, EASYSIMD_TEST_VEC_POS_FIRST);
...
static int
test_easysimd_vdup_laneq_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  struct {
    easysimd_float32 vec[4];
    int lane;
    easysimd_float32 r[2];
  } test_vec[] = {
    { { EASYSIMD_FLOAT32_C(   757.85), EASYSIMD_FLOAT32_C(  -809.44), EASYSIMD_FLOAT32_C(  -135.68), EASYSIMD_FLOAT32_C(  -140.81) },
       INT8_C(   0),
      { EASYSIMD_FLOAT32_C(   757.85), EASYSIMD_FLOAT32_C(   757.85) } },
    { { EASYSIMD_FLOAT32_C(  -948.46), EASYSIMD_FLOAT32_C(   482.38), EASYSIMD_FLOAT32_C(   971.59), EASYSIMD_FLOAT32_C(  -845.91) },
       INT8_C(   0),
      { EASYSIMD_FLOAT32_C(  -948.46), EASYSIMD_FLOAT32_C(  -948.46) } },
    { { EASYSIMD_FLOAT32_C(   656.44), EASYSIMD_FLOAT32_C(  -574.13), EASYSIMD_FLOAT32_C(  -306.48), EASYSIMD_FLOAT32_C(   302.94) },
       INT8_C(   1),
      { EASYSIMD_FLOAT32_C(  -574.13), EASYSIMD_FLOAT32_C(  -574.13) } },
    { { EASYSIMD_FLOAT32_C(  -419.88), EASYSIMD_FLOAT32_C(   844.59), EASYSIMD_FLOAT32_C(  -860.06), EASYSIMD_FLOAT32_C(   931.61) },
       INT8_C(   2),
      { EASYSIMD_FLOAT32_C(  -860.06), EASYSIMD_FLOAT32_C(  -860.06) } },
    { { EASYSIMD_FLOAT32_C(   -45.34), EASYSIMD_FLOAT32_C(   773.65), EASYSIMD_FLOAT32_C(   451.92), EASYSIMD_FLOAT32_C(  -733.20) },
       INT8_C(   1),
      { EASYSIMD_FLOAT32_C(   773.65), EASYSIMD_FLOAT32_C(   773.65) } },
    { { EASYSIMD_FLOAT32_C(   845.90), EASYSIMD_FLOAT32_C(  -853.55), EASYSIMD_FLOAT32_C(  -684.75), EASYSIMD_FLOAT32_C(   154.60) },
       INT8_C(   2),
      { EASYSIMD_FLOAT32_C(  -684.75), EASYSIMD_FLOAT32_C(  -684.75) } },
    { { EASYSIMD_FLOAT32_C(  -651.35), EASYSIMD_FLOAT32_C(   -87.55), EASYSIMD_FLOAT32_C(  -854.44), EASYSIMD_FLOAT32_C(   212.97) },
       INT8_C(   1),
      { EASYSIMD_FLOAT32_C(   -87.55), EASYSIMD_FLOAT32_C(   -87.55) } },
    { { EASYSIMD_FLOAT32_C(  -829.33), EASYSIMD_FLOAT32_C(   264.52), EASYSIMD_FLOAT32_C(   254.03), EASYSIMD_FLOAT32_C(  -857.74) },
       INT8_C(   3),
      { EASYSIMD_FLOAT32_C(  -857.74), EASYSIMD_FLOAT32_C(  -857.74) } }
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float32x4_t vec;
    easysimd_float32x2_t r;

    vec = easysimd_vld1q_f32(test_vec[i].vec);
    EASYSIMD_CONSTIFY_4_(easysimd_vdup_laneq_f32, r, (HEDLEY_UNREACHABLE(), easysimd_vdup_n_f32(0.0f)), test_vec[i].lane, vec);
  ...
  fputc('\n', stdout);
  for (int i = 0 ; i < 8 ; i++) {
    easysimd_float32x4_t vec = easysimd_test_arm_neon_random_f32x4(-1000.0, 1000.0);
    int lane = easysimd_test_codegen_random_i8() & 3;

    easysimd_float32x2_t r;
    EASYSIMD_CONSTIFY_4_(easysimd_vdup_laneq_f32, r, (HEDLEY_UNREACHABLE(), easysimd_vdup_n_f32(0.0f)), lane, vec);

    easysimd_test_arm_neon_write_f32x4(2, vec, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_codegen_write_i8(2, HEDLEY_STATIC_CAST(int8_t, lane), EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_f32x2(2, r, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
...
static int
test_easysimd_vdup_laneq_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  struct {
    easysimd_float64 vec[2];
    int lane;
    easysimd_float64 r[1];
  } test_vec[] = {
    { { EASYSIMD_FLOAT64_C(  -964.14), EASYSIMD_FLOAT64_C(   302.49) },
       INT8_C(   0),
      { EASYSIMD_FLOAT64_C(  -964.14) } },
    { { EASYSIMD_FLOAT64_C(   621.68), EASYSIMD_FLOAT64_C(   488.00) },
       INT8_C(   0),
      { EASYSIMD_FLOAT64_C(   621.68) } },
    { { EASYSIMD_FLOAT64_C(   950.70), EASYSIMD_FLOAT64_C(  -572.96) },
       INT8_C(   1),
      { EASYSIMD_FLOAT64_C(  -572.96) } },
    { { EASYSIMD_FLOAT64_C(   188.34), EASYSIMD_FLOAT64_C(  -751.64) },
       INT8_C(   1),
      { EASYSIMD_FLOAT64_C(  -751.64) } },
    { { EASYSIMD_FLOAT64_C(    97.41), EASYSIMD_FLOAT64_C(  -734.30) },
       INT8_C(   1),
      { EASYSIMD_FLOAT64_C(  -734.30) } },
    { { EASYSIMD_FLOAT64_C(   499.67), EASYSIMD_FLOAT64_C(  -413.57) },
       INT8_C(   1),
      { EASYSIMD_FLOAT64_C(  -413.57) } },
    { { EASYSIMD_FLOAT64_C(   766.87), EASYSIMD_FLOAT64_C(   -42.42) },
       INT8_C(   0),
      { EASYSIMD_FLOAT64_C(   766.87) } },
    { { EASYSIMD_FLOAT64_C(  -881.52), EASYSIMD_FLOAT64_C(  -131.16) },
       INT8_C(   1),
      { EASYSIMD_FLOAT64_C(  -131.16) } }
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float64x2_t vec;
    easysimd_float64x1_t r;

    vec = easysimd_vld1q_f64(test_vec[i].vec);
    EASYSIMD_CONSTIFY_2_(easysimd_vdup_laneq_f64, r, (HEDLEY_UNREACHABLE(), easysimd_vdup_n_f64(0.0)), test_vec[i].lane, vec);
  ...
  fputc('\n', stdout);
  for (int i = 0 ; i < 8 ; i++) {
    easysimd_float64x2_t vec = easysimd_test_arm_neon_random_f64x2(-1000.0, 1000.0);
    int lane = easysimd_test_codegen_random_i8() & 1;

    easysimd_float64x1_t r;
    EASYSIMD_CONSTIFY_2_(easysimd_vdup_laneq_f64, r, (HEDLEY_UNREACHABLE(), easysimd_vdup_n_f64(0.0)), lane, vec);

    easysimd_test_arm_neon_write_f64x2(2, vec, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_codegen_write_i8(2, HEDLEY_STATIC_CAST(int8_t, lane), EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_f64x1(2, r, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
...
static int
test_easysimd_vdup_laneq_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  struct {
    int8_t vec[16];
    int lane;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_int8x16_t vec;
    easysimd_int8x8_t r;

    vec = easysimd_vld1q_s8(test_vec[i].vec);
    EASYSIMD_CONSTIFY_16_(easysimd_vdup_laneq_s8, r, (HEDLEY_UNREACHABLE(), easysimd_vdup_n_s8(INT8_C(0))), test_vec[i].lane, vec);
  ...
  fputc('\n', stdout);
  for (int i = 0 ; i < 8 ; i++) {
    easysimd_int8x16_t vec = easysimd_test_arm_neon_random_i8x16();
    int lane = easysimd_test_codegen_random_i8() & 15;

    easysimd_int8x8_t r;
    EASYSIMD_CONSTIFY_16_(easysimd_vdup_laneq_s8, r, (HEDLEY_UNREACHABLE(), easysimd_vdup_n_s8(INT8_C(0))), lane, vec);

    easysimd_test_arm_neon_write_i8x16(2, vec, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_codegen_write_i8(2, HEDLEY_STATIC_CAST(int8_t, lane), EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_i8x8(2, r, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
...
static int
test_easysimd_vdup_laneq_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  struct {
    int16_t vec[8];
    int lane;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_int16x8_t vec;
    easysimd_int16x4_t r;

    vec = easysimd_vld1q_s16(test_vec[i].vec);
    EASYSIMD_CONSTIFY_8_(easysimd_vdup_laneq_s16, r, (HEDLEY_UNREACHABLE(), easysimd_vdup_n_s16(INT16_C(0))), test_vec[i].lane, vec);
  ...
  fputc('\n', stdout);
  for (int i = 0 ; i < 8 ; i++) {
    easysimd_int16x8_t vec = easysimd_test_arm_neon_random_i16x8();
    int lane = easysimd_test_codegen_random_i8() & 7;

    easysimd_int16x4_t r;
    EASYSIMD_CONSTIFY_8_(easysimd_vdup_laneq_s16, r, (HEDLEY_UNREACHABLE(), easysimd_vdup_n_s16(INT8_C(0))), lane, vec);

    easysimd_test_arm_neon_write_i16x8(2, vec, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_codegen_write_i8(2, HEDLEY_STATIC_CAST(int8_t, lane), EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_i16x4(2, r, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
...
static int
test_easysimd_vdup_laneq_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  struct {
    int32_t vec[4];
    int lane;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_int32x4_t vec;
    easysimd_int32x2_t r;

    vec = easysimd_vld1q_s32(test_vec[i].vec);
    EASYSIMD_CONSTIFY_4_(easysimd_vdup_laneq_s32, r, (HEDLEY_UNREACHABLE(), easysimd_vdup_n_s32(INT32_C(0))), test_vec[i].lane, vec);
  ...
  fputc('\n', stdout);
  for (int i = 0 ; i < 8 ; i++) {
    easysimd_int32x4_t vec = easysimd_test_arm_neon_random_i32x4();
    int lane = easysimd_test_codegen_random_i8() & 3;

    easysimd_int32x2_t r;
    EASYSIMD_CONSTIFY_4_(easysimd_vdup_laneq_s32, r, (HEDLEY_UNREACHABLE(), easysimd_vdup_n_s32(INT32_C(0))), lane, vec);

    easysimd_test_arm_neon_write_i32x4(2, vec, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_codegen_write_i8(2, HEDLEY_STATIC_CAST(int8_t, lane), EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_i32x2(2, r, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
...
static int
test_easysimd_vdup_laneq_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  struct {
    int64_t vec[2];
    int lane;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_int64x2_t vec;
    easysimd_int64x1_t r;

    vec = easysimd_vld1q_s64(test_vec[i].vec);
    EASYSIMD_CONSTIFY_2_(easysimd_vdup_laneq_s64, r, (HEDLEY_UNREACHABLE(), easysimd_vdup_n_s64(INT64_C(0))), test_vec[i].lane, vec);
  ...
  fputc('\n', stdout);
  for (int i = 0 ; i < 8 ; i++) {
    easysimd_int64x2_t vec = easysimd_test_arm_neon_random_i64x2();
    int lane = easysimd_test_codegen_random_i8() & 1;

    easysimd_int64x1_t r;
    EASYSIMD_CONSTIFY_2_(easysimd_vdup_laneq_s64, r, (HEDLEY_UNREACHABLE(), easysimd_vdup_n_s64(INT64_C(0))), lane, vec);

    easysimd_test_arm_neon_write_i64x2(2, vec, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_codegen_write_i8(2, HEDLEY_STATIC_CAST(int8_t, lane), EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_i64x1(2, r, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
...
static int
test_easysimd_vdup_laneq_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  struct {
    uint8_t vec[16];
    int lane;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint8x16_t vec;
    easysimd_uint8x8_t r;

    vec = easysimd_vld1q_u8(test_vec[i].vec);
    EASYSIMD_CONSTIFY_16_(easysimd_vdup_laneq_u8, r, (HEDLEY_UNREACHABLE(), easysimd_vdup_n_u8(UINT8_C(0))), test_vec[i].lane, vec);
  ...
  fputc('\n', stdout);
  for (int i = 0 ; i < 8 ; i++) {
    easysimd_uint8x16_t vec = easysimd_test_arm_neon_random_u8x16();
    int lane = easysimd_test_codegen_random_u8() & 15;

    easysimd_uint8x8_t r;
    EASYSIMD_CONSTIFY_16_(easysimd_vdup_laneq_u8, r, (HEDLEY_UNREACHABLE(), easysimd_vdup_n_u8(UINT8_C(0))), lane, vec);

    easysimd_test_arm_neon_write_u8x16(2, vec, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_codegen_write_u8(2, HEDLEY_STATIC_CAST(uint8_t, lane), EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_u8x8(2, r, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
...
static int
test_easysimd_vdup_laneq_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  struct {
    uint16_t vec[8];
    int lane;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint16x8_t vec;
    easysimd_uint16x4_t r;

    vec = easysimd_vld1q_u16(test_vec[i].vec);
    EASYSIMD_CONSTIFY_8_(easysimd_vdup_laneq_u16, r, (HEDLEY_UNREACHABLE(), easysimd_vdup_n_u16(UINT16_C(0))), test_vec[i].lane, vec);
  ...
  fputc('\n', stdout);
  for (int i = 0 ; i < 8 ; i++) {
    easysimd_uint16x8_t vec = easysimd_test_arm_neon_random_u16x8();
    int lane = easysimd_test_codegen_random_u8() & 7;

    easysimd_uint16x4_t r;
    EASYSIMD_CONSTIFY_8_(easysimd_vdup_laneq_u16, r, (HEDLEY_UNREACHABLE(), easysimd_vdup_n_u16(UINT16_C(0))), lane, vec);

    easysimd_test_arm_neon_write_u16x8(2, vec, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_codegen_write_u8(2, HEDLEY_STATIC_CAST(uint8_t, lane), EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_u16x4(2, r, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
...
static int
test_easysimd_vdup_laneq_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  struct {
    uint32_t vec[8];
    int lane;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint32x4_t vec;
    easysimd_uint32x2_t r;

    vec = easysimd_vld1q_u32(test_vec[i].vec);
    EASYSIMD_CONSTIFY_4_(easysimd_vdup_laneq_u32, r, (HEDLEY_UNREACHABLE(), easysimd_vdup_n_u32(UINT32_C(0))), test_vec[i].lane, vec);
  ...
  fputc('\n', stdout);
  for (int i = 0 ; i < 8 ; i++) {
    easysimd_uint32x4_t vec = easysimd_test_arm_neon_random_u32x4();
    int lane = easysimd_test_codegen_random_u8() & 3;

    easysimd_uint32x2_t r;
    EASYSIMD_CONSTIFY_4_(easysimd_vdup_laneq_u32, r, (HEDLEY_UNREACHABLE(), easysimd_vdup_n_u32(UINT32_C(0))), lane, vec);

    easysimd_test_arm_neon_write_u32x4(2, vec, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_codegen_write_u8(2, HEDLEY_STATIC_CAST(uint8_t, lane), EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_u32x2(2, r, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
...
static int
test_easysimd_vdup_laneq_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  struct {
    uint64_t vec[2];
    int lane;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint64x2_t vec;
    easysimd_uint64x1_t r;

    vec = easysimd_vld1q_u64(test_vec[i].vec);
    EASYSIMD_CONSTIFY_2_(easysimd_vdup_laneq_u64, r, (HEDLEY_UNREACHABLE(), easysimd_vdup_n_u64(UINT64_C(0))), test_vec[i].lane, vec);
  ...
  fputc('\n', stdout);
  for (int i = 0 ; i < 8 ; i++) {
    easysimd_uint64x2_t vec = easysimd_test_arm_neon_random_u64x2();
    int lane = easysimd_test_codegen_random_u8() & 1;

    easysimd_uint64x1_t r;
    EASYSIMD_CONSTIFY_2_(easysimd_vdup_laneq_u64, r, (HEDLEY_UNREACHABLE(), easysimd_vdup_n_u64(UINT64_C(0))), lane, vec);

    easysimd_test_arm_neon_write_u64x2(2, vec, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_codegen_write_u8(2, HEDLEY_STATIC_CAST(uint8_t, lane), EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_u64x1(2, r, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
...
static int
test_easysimd_vdupq_lane_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  struct {
    easysimd_float32 vec[2];
    int lane;
    ...
    { { EASYSIMD_FLOAT32_C(   870.88), EASYSIMD_FLOAT32_C(    24.01) },
       INT8_C(   0),
      { EASYSIMD_FLOAT32_C(   870.88), EASYSIMD_FLOAT32_C(   870.88), EASYSIMD_FLOAT32_C(   870.88), EASYSIMD_FLOAT32_C(   870.88) } },
    { { EASYSIMD_FLOAT32_C(   113.79), EASYSIMD_FLOAT32_C(  -108.45) },
       INT8_C(   1),
      { EASYSIMD_FLOAT32_C(  -108.45), EASYSIMD_FLOAT32_C(  -108.45), EASYSIMD_FLOAT32_C(  -108.45), EASYSIMD_FLOAT32_C(  -108.45) } },
    { { EASYSIMD_FLOAT32_C(   134.60), EASYSIMD_FLOAT32_C(  -240.11) },
       INT8_C(   1),
      { EASYSIMD_FLOAT32_C(  -240.11), EASYSIMD_FLOAT32_C(  -240.11), EASYSIMD_FLOAT32_C(  -240.11), EASYSIMD_FLOAT32_C(  -240.11) } },
    { { EASYSIMD_FLOAT32_C(   494.89), EASYSIMD_FLOAT32_C(  -490.91) },
       INT8_C(   0),
      { EASYSIMD_FLOAT32_C(   494.89), EASYSIMD_FLOAT32_C(   494.89), EASYSIMD_FLOAT32_C(   494.89), EASYSIMD_FLOAT32_C(   494.89) } },
    { { EASYSIMD_FLOAT32_C(  -252.90), EASYSIMD_FLOAT32_C(  -790.94) },
       INT8_C(   1),
      { EASYSIMD_FLOAT32_C(  -790.94), EASYSIMD_FLOAT32_C(  -790.94), EASYSIMD_FLOAT32_C(  -790.94), EASYSIMD_FLOAT32_C(  -790.94) } },
    { { EASYSIMD_FLOAT32_C(   232.02), EASYSIMD_FLOAT32_C(  -102.81) },
       INT8_C(   0),
      { EASYSIMD_FLOAT32_C(   232.02), EASYSIMD_FLOAT32_C(   232.02), EASYSIMD_FLOAT32_C(   232.02), EASYSIMD_FLOAT32_C(   232.02) } },
    { { EASYSIMD_FLOAT32_C(   759.52), EASYSIMD_FLOAT32_C(   383.73) },
       INT8_C(   0),
      { EASYSIMD_FLOAT32_C(   759.52), EASYSIMD_FLOAT32_C(   759.52), EASYSIMD_FLOAT32_C(   759.52), EASYSIMD_FLOAT32_C(   759.52) } },
    { { EASYSIMD_FLOAT32_C(  -169.79), EASYSIMD_FLOAT32_C(  -403.21) },
       INT8_C(   1),
      { EASYSIMD_FLOAT32_C(  -403.21), EASYSIMD_FLOAT32_C(  -403.21), EASYSIMD_FLOAT32_C(  -403.21), EASYSIMD_FLOAT32_C(  -403.21) } },
  };
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    vec = easysimd_vld1_f32(test_vec[i].vec);
    EASYSIMD_CONSTIFY_2_(easysimd_vdupq_lane_f32, r, (HEDLEY_UNREACHABLE(), easysimd_vdupq_n_f32(0.0f)), test_vec[i].lane, vec);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_float32x4_t r;
    EASYSIMD_CONSTIFY_4_(easysimd_vdupq_lane_f32, r, (HEDLEY_UNREACHABLE(), easysimd_vdupq_n_f32(0.0f)), lane, vec);
...
static int
test_easysimd_vdupq_lane_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  struct {
    easysimd_float64 vec[1];
    int lane;
    ...
    { { EASYSIMD_FLOAT64_C(    23.83) },
       INT8_C(   0),
      { EASYSIMD_FLOAT64_C(    23.83), EASYSIMD_FLOAT64_C(    23.83) } },
    { { EASYSIMD_FLOAT64_C(   360.45) },
       INT8_C(   0),
      { EASYSIMD_FLOAT64_C(   360.45), EASYSIMD_FLOAT64_C(   360.45) } },
    { { EASYSIMD_FLOAT64_C(  -969.45) },
       INT8_C(   0),
      { EASYSIMD_FLOAT64_C(  -969.45), EASYSIMD_FLOAT64_C(  -969.45) } },
    { { EASYSIMD_FLOAT64_C(   206.91) },
       INT8_C(   0),
      { EASYSIMD_FLOAT64_C(   206.91), EASYSIMD_FLOAT64_C(   206.91) } },
    { { EASYSIMD_FLOAT64_C(   953.07) },
       INT8_C(   0),
      { EASYSIMD_FLOAT64_C(   953.07), EASYSIMD_FLOAT64_C(   953.07) } },
    { { EASYSIMD_FLOAT64_C(  -531.18) },
       INT8_C(   0),
      { EASYSIMD_FLOAT64_C(  -531.18), EASYSIMD_FLOAT64_C(  -531.18) } },
    { { EASYSIMD_FLOAT64_C(    31.72) },
       INT8_C(   0),
      { EASYSIMD_FLOAT64_C(    31.72), EASYSIMD_FLOAT64_C(    31.72) } },
    { { EASYSIMD_FLOAT64_C(  -358.35) },
       INT8_C(   0),
      { EASYSIMD_FLOAT64_C(  -358.35), EASYSIMD_FLOAT64_C(  -358.35) } }
  };
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    vec = easysimd_vld1_f64(test_vec[i].vec);
    r = easysimd_vdupq_lane_f64(vec, 0);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_float64x2_t r = easysimd_vdupq_lane_f64(vec, 0);
...
static int
test_easysimd_vdupq_lane_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  struct {
    int8_t vec[8];
    int lane;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    vec = easysimd_vld1_s8(test_vec[i].vec);
    EASYSIMD_CONSTIFY_8_(easysimd_vdupq_lane_s8, r, (HEDLEY_UNREACHABLE(), easysimd_vdupq_n_s8(0)), test_vec[i].lane, vec);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_int8x16_t r;
    EASYSIMD_CONSTIFY_8_(easysimd_vdupq_lane_s8, r, (HEDLEY_UNREACHABLE(), easysimd_vdupq_n_s8(0)), lane, vec);
...
static int
test_easysimd_vdupq_lane_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  struct {
    int16_t vec[4];
    int lane;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    vec = easysimd_vld1_s16(test_vec[i].vec);
    EASYSIMD_CONSTIFY_4_(easysimd_vdupq_lane_s16, r, (HEDLEY_UNREACHABLE(), easysimd_vdupq_n_s16(0)), test_vec[i].lane, vec);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_int16x8_t r;
    EASYSIMD_CONSTIFY_4_(easysimd_vdupq_lane_s16, r, (HEDLEY_UNREACHABLE(), easysimd_vdupq_n_s16(0)), lane, vec);
...
static int
test_easysimd_vdupq_lane_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  struct {
    int32_t vec[2];
    int lane;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    vec = easysimd_vld1_s32(test_vec[i].vec);
    EASYSIMD_CONSTIFY_2_(easysimd_vdupq_lane_s32, r, (HEDLEY_UNREACHABLE(), easysimd_vdupq_n_s32(0)), test_vec[i].lane, vec);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_int32x4_t r;
    EASYSIMD_CONSTIFY_2_(easysimd_vdupq_lane_s32, r, (HEDLEY_UNREACHABLE(), easysimd_vdupq_n_s32(0)), lane, vec);
...
static int
test_easysimd_vdupq_lane_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  struct {
    int64_t vec[1];
    int lane;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    vec = easysimd_vld1_s64(test_vec[i].vec);
    r = easysimd_vdupq_lane_s64(vec, 0);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    easysimd_int64x1_t vec = easysimd_test_arm_neon_random_i64x1();
    int lane = easysimd_test_codegen_random_i8() & 0;
...
static int
test_easysimd_vdupq_lane_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  struct {
    uint8_t vec[8];
    int lane;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    vec = easysimd_vld1_u8(test_vec[i].vec);
    EASYSIMD_CONSTIFY_8_(easysimd_vdupq_lane_u8, r, (HEDLEY_UNREACHABLE(), easysimd_vdupq_n_u8(0)), test_vec[i].lane, vec);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_uint8x16_t r;
    EASYSIMD_CONSTIFY_8_(easysimd_vdupq_lane_u8, r, (HEDLEY_UNREACHABLE(), easysimd_vdupq_n_u8(0)), lane, vec);
...
static int
test_easysimd_vdupq_lane_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  struct {
    uint16_t vec[4];
    int lane;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    vec = easysimd_vld1_u16(test_vec[i].vec);
    EASYSIMD_CONSTIFY_4_(easysimd_vdupq_lane_u16, r, (HEDLEY_UNREACHABLE(), easysimd_vdupq_n_u16(0)), test_vec[i].lane, vec);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_uint16x8_t r;
    EASYSIMD_CONSTIFY_4_(easysimd_vdupq_lane_u16, r, (HEDLEY_UNREACHABLE(), easysimd_vdupq_n_u16(0)), lane, vec);
...
static int
test_easysimd_vdupq_lane_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  struct {
    uint32_t vec[2];
    int lane;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    vec = easysimd_vld1_u32(test_vec[i].vec);
    EASYSIMD_CONSTIFY_2_(easysimd_vdupq_lane_u32, r, (HEDLEY_UNREACHABLE(), easysimd_vdupq_n_u32(0)), test_vec[i].lane, vec);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_uint32x4_t r;
    EASYSIMD_CONSTIFY_2_(easysimd_vdupq_lane_u32, r, (HEDLEY_UNREACHABLE(), easysimd_vdupq_n_u32(0)), lane, vec);
...
static int
test_easysimd_vdupq_lane_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  struct {
    uint64_t vec[1];
    int lane;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    vec = easysimd_vld1_u64(test_vec[i].vec);
    r = easysimd_vdupq_lane_u64(vec, 0);
...
static int
test_easysimd_vdupq_laneq_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  struct {
    easysimd_float32 vec[4];
    int lane;
    ...
    { { EASYSIMD_FLOAT32_C(   841.63), EASYSIMD_FLOAT32_C(   -49.45), EASYSIMD_FLOAT32_C(   261.67), EASYSIMD_FLOAT32_C(  -350.53) },
       INT8_C(   2),
      { EASYSIMD_FLOAT32_C(   261.67), EASYSIMD_FLOAT32_C(   261.67), EASYSIMD_FLOAT32_C(   261.67), EASYSIMD_FLOAT32_C(   261.67) } },
    { { EASYSIMD_FLOAT32_C(   242.12), EASYSIMD_FLOAT32_C(   896.58), EASYSIMD_FLOAT32_C(  -122.58), EASYSIMD_FLOAT32_C(  -914.43) },
       INT8_C(   3),
      { EASYSIMD_FLOAT32_C(  -914.43), EASYSIMD_FLOAT32_C(  -914.43), EASYSIMD_FLOAT32_C(  -914.43), EASYSIMD_FLOAT32_C(  -914.43) } },
    { { EASYSIMD_FLOAT32_C(  -903.27), EASYSIMD_FLOAT32_C(   -11.67), EASYSIMD_FLOAT32_C(  -137.96), EASYSIMD_FLOAT32_C(  -521.79) },
       INT8_C(   1),
      { EASYSIMD_FLOAT32_C(   -11.67), EASYSIMD_FLOAT32_C(   -11.67), EASYSIMD_FLOAT32_C(   -11.67), EASYSIMD_FLOAT32_C(   -11.67) } },
    { { EASYSIMD_FLOAT32_C(  -946.62), EASYSIMD_FLOAT32_C(  -205.01), EASYSIMD_FLOAT32_C(  -121.41), EASYSIMD_FLOAT32_C(   159.32) },
       INT8_C(   0),
      { EASYSIMD_FLOAT32_C(  -946.62), EASYSIMD_FLOAT32_C(  -946.62), EASYSIMD_FLOAT32_C(  -946.62), EASYSIMD_FLOAT32_C(  -946.62) } },
    { { EASYSIMD_FLOAT32_C(   334.52), EASYSIMD_FLOAT32_C(  -142.22), EASYSIMD_FLOAT32_C(  -498.68), EASYSIMD_FLOAT32_C(  -830.99) },
       INT8_C(   0),
      { EASYSIMD_FLOAT32_C(   334.52), EASYSIMD_FLOAT32_C(   334.52), EASYSIMD_FLOAT32_C(   334.52), EASYSIMD_FLOAT32_C(   334.52) } },
    { { EASYSIMD_FLOAT32_C(   855.02), EASYSIMD_FLOAT32_C(  -765.81), EASYSIMD_FLOAT32_C(  -476.10), EASYSIMD_FLOAT32_C(   738.65) },
       INT8_C(   2),
      { EASYSIMD_FLOAT32_C(  -476.10), EASYSIMD_FLOAT32_C(  -476.10), EASYSIMD_FLOAT32_C(  -476.10), EASYSIMD_FLOAT32_C(  -476.10) } },
    { { EASYSIMD_FLOAT32_C(    85.00), EASYSIMD_FLOAT32_C(   580.28), EASYSIMD_FLOAT32_C(   330.74), EASYSIMD_FLOAT32_C(  -653.33) },
       INT8_C(   3),
      { EASYSIMD_FLOAT32_C(  -653.33), EASYSIMD_FLOAT32_C(  -653.33), EASYSIMD_FLOAT32_C(  -653.33), EASYSIMD_FLOAT32_C(  -653.33) } },
    { { EASYSIMD_FLOAT32_C(  -767.25), EASYSIMD_FLOAT32_C(   588.80), EASYSIMD_FLOAT32_C(  -873.67), EASYSIMD_FLOAT32_C(   110.16) },
       INT8_C(   3),
      { EASYSIMD_FLOAT32_C(   110.16), EASYSIMD_FLOAT32_C(   110.16), EASYSIMD_FLOAT32_C(   110.16), EASYSIMD_FLOAT32_C(   110.16) } }
  };
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    vec = easysimd_vld1q_f32(test_vec[i].vec);
    EASYSIMD_CONSTIFY_4_(easysimd_vdupq_laneq_f32, r, (HEDLEY_UNREACHABLE(), easysimd_vdupq_n_f32(0.0f)), test_vec[i].lane, vec);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_float32x4_t r;
    EASYSIMD_CONSTIFY_4_(easysimd_vdupq_laneq_f32, r, (HEDLEY_UNREACHABLE(), easysimd_vdupq_n_f32(0.0f)), lane, vec);
...
static int
test_easysimd_vdupq_laneq_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  struct {
    easysimd_float64 vec[2];
    int lane;
    ...
    { { EASYSIMD_FLOAT64_C(  -955.26), EASYSIMD_FLOAT64_C(  -551.38) },
       INT8_C(   0),
      { EASYSIMD_FLOAT64_C(  -955.26), EASYSIMD_FLOAT64_C(  -955.26) } },
    { { EASYSIMD_FLOAT64_C(    53.53), EASYSIMD_FLOAT64_C(   970.21) },
       INT8_C(   1),
      { EASYSIMD_FLOAT64_C(   970.21), EASYSIMD_FLOAT64_C(   970.21) } },
    { { EASYSIMD_FLOAT64_C(  -594.72), EASYSIMD_FLOAT64_C(   118.44) },
       INT8_C(   1),
      { EASYSIMD_FLOAT64_C(   118.44), EASYSIMD_FLOAT64_C(   118.44) } },
    { { EASYSIMD_FLOAT64_C(   499.85), EASYSIMD_FLOAT64_C(   930.54) },
       INT8_C(   0),
      { EASYSIMD_FLOAT64_C(   499.85), EASYSIMD_FLOAT64_C(   499.85) } },
    { { EASYSIMD_FLOAT64_C(   858.61), EASYSIMD_FLOAT64_C(   351.33) },
       INT8_C(   1),
      { EASYSIMD_FLOAT64_C(   351.33), EASYSIMD_FLOAT64_C(   351.33) } },
    { { EASYSIMD_FLOAT64_C(   558.39), EASYSIMD_FLOAT64_C(  -964.87) },
       INT8_C(   0),
      { EASYSIMD_FLOAT64_C(   558.39), EASYSIMD_FLOAT64_C(   558.39) } },
    { { EASYSIMD_FLOAT64_C(  -858.49), EASYSIMD_FLOAT64_C(   914.99) },
       INT8_C(   0),
      { EASYSIMD_FLOAT64_C(  -858.49), EASYSIMD_FLOAT64_C(  -858.49) } },
    { { EASYSIMD_FLOAT64_C(   745.32), EASYSIMD_FLOAT64_C(  -258.32) },
       INT8_C(   1),
      { EASYSIMD_FLOAT64_C(  -258.32), EASYSIMD_FLOAT64_C(  -258.32) } }
  };
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    vec = easysimd_vld1q_f64(test_vec[i].vec);
    EASYSIMD_CONSTIFY_2_(easysimd_vdupq_laneq_f64, r, (HEDLEY_UNREACHABLE(), easysimd_vdupq_n_f64(0.0)), test_vec[i].lane, vec);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_float64x2_t r;
    EASYSIMD_CONSTIFY_2_(easysimd_vdupq_laneq_f64, r, (HEDLEY_UNREACHABLE(), easysimd_vdupq_n_f64(0.0)), lane, vec);
...
static int
test_easysimd_vdupq_laneq_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  struct {
    int8_t vec[16];
    int lane;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    vec = easysimd_vld1q_s8(test_vec[i].vec);
    EASYSIMD_CONSTIFY_16_(easysimd_vdupq_laneq_s8, r, (HEDLEY_UNREACHABLE(), easysimd_vdupq_n_s8(INT8_C(0))), test_vec[i].lane, vec);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_int8x16_t r;
    EASYSIMD_CONSTIFY_16_(easysimd_vdupq_laneq_s8, r, (HEDLEY_UNREACHABLE(), easysimd_vdupq_n_s8(INT8_C(0))), lane, vec);
...
static int
test_easysimd_vdupq_laneq_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  struct {
    int16_t vec[8];
    int lane;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    vec = easysimd_vld1q_s16(test_vec[i].vec);
    EASYSIMD_CONSTIFY_8_(easysimd_vdupq_laneq_s16, r, (HEDLEY_UNREACHABLE(), easysimd_vdupq_n_s16(INT16_C(0))), test_vec[i].lane, vec);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_int16x8_t r;
    EASYSIMD_CONSTIFY_8_(easysimd_vdupq_laneq_s16, r, (HEDLEY_UNREACHABLE(), easysimd_vdupq_n_s16(INT8_C(0))), lane, vec);
...
static int
test_easysimd_vdupq_laneq_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  struct {
    int32_t vec[4];
    int lane;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    vec = easysimd_vld1q_s32(test_vec[i].vec);
    EASYSIMD_CONSTIFY_4_(easysimd_vdupq_laneq_s32, r, (HEDLEY_UNREACHABLE(), easysimd_vdupq_n_s32(INT32_C(0))), test_vec[i].lane, vec);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_int32x4_t r;
    EASYSIMD_CONSTIFY_4_(easysimd_vdupq_laneq_s32, r, (HEDLEY_UNREACHABLE(), easysimd_vdupq_n_s32(INT32_C(0))), lane, vec);
...
static int
test_easysimd_vdupq_laneq_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  struct {
    int64_t vec[2];
    int lane;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    vec = easysimd_vld1q_s64(test_vec[i].vec);
    EASYSIMD_CONSTIFY_2_(easysimd_vdupq_laneq_s64, r, (HEDLEY_UNREACHABLE(), easysimd_vdupq_n_s64(INT64_C(0))), test_vec[i].lane, vec);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_int64x2_t r;
    EASYSIMD_CONSTIFY_2_(easysimd_vdupq_laneq_s64, r, (HEDLEY_UNREACHABLE(), easysimd_vdupq_n_s64(INT64_C(0))), lane, vec);
...
static int
test_easysimd_vdupq_laneq_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  struct {
    uint8_t vec[16];
    int lane;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    vec = easysimd_vld1q_u8(test_vec[i].vec);
    EASYSIMD_CONSTIFY_16_(easysimd_vdupq_laneq_u8, r, (HEDLEY_UNREACHABLE(), easysimd_vdupq_n_u8(UINT8_C(0))), test_vec[i].lane, vec);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_uint8x16_t r;
    EASYSIMD_CONSTIFY_16_(easysimd_vdupq_laneq_u8, r, (HEDLEY_UNREACHABLE(), easysimd_vdupq_n_u8(UINT8_C(0))), lane, vec);
...
static int
test_easysimd_vdupq_laneq_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  struct {
    uint16_t vec[8];
    int lane;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    vec = easysimd_vld1q_u16(test_vec[i].vec);
    EASYSIMD_CONSTIFY_8_(easysimd_vdupq_laneq_u16, r, (HEDLEY_UNREACHABLE(), easysimd_vdupq_n_u16(UINT16_C(0))), test_vec[i].lane, vec);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_uint16x8_t r;
    EASYSIMD_CONSTIFY_8_(easysimd_vdupq_laneq_u16, r, (HEDLEY_UNREACHABLE(), easysimd_vdupq_n_u16(UINT16_C(0))), lane, vec);
...
static int
test_easysimd_vdupq_laneq_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  struct {
    uint32_t vec[4];
    int lane;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    vec = easysimd_vld1q_u32(test_vec[i].vec);
    EASYSIMD_CONSTIFY_4_(easysimd_vdupq_laneq_u32, r, (HEDLEY_UNREACHABLE(), easysimd_vdupq_n_u32(UINT32_C(0))), test_vec[i].lane, vec);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_uint32x4_t r;
    EASYSIMD_CONSTIFY_4_(easysimd_vdupq_laneq_u32, r, (HEDLEY_UNREACHABLE(), easysimd_vdupq_n_u32(UINT32_C(0))), lane, vec);
...
static int
test_easysimd_vdupq_laneq_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  struct {
    uint64_t vec[2];
    int lane;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    vec = easysimd_vld1q_u64(test_vec[i].vec);
    EASYSIMD_CONSTIFY_2_(easysimd_vdupq_laneq_u64, r, (HEDLEY_UNREACHABLE(), easysimd_vdupq_n_u64(UINT64_C(0))), test_vec[i].lane, vec);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_uint64x2_t r;
    EASYSIMD_CONSTIFY_2_(easysimd_vdupq_laneq_u64, r, (HEDLEY_UNREACHABLE(), easysimd_vdupq_n_u64(UINT64_C(0))), lane, vec);
...
EASYSIMD_TEST_FUNC_LIST_ENTRY(vdup_lane_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vdup_lane_f64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vdup_lane_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vdup_lane_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vdup_lane_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vdup_lane_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vdup_lane_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vdup_lane_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vdup_lane_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vdup_lane_u64)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vdup_laneq_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vdup_laneq_f64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vdup_laneq_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vdup_laneq_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vdup_laneq_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vdup_laneq_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vdup_laneq_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vdup_laneq_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vdup_laneq_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vdup_laneq_u64)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vdupq_lane_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vdupq_lane_f64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vdupq_lane_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vdupq_lane_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vdupq_lane_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vdupq_lane_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vdupq_lane_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vdupq_lane_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vdupq_lane_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vdupq_lane_u64)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vdupq_laneq_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vdupq_laneq_f64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vdupq_laneq_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vdupq_laneq_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vdupq_laneq_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vdupq_laneq_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vdupq_laneq_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vdupq_laneq_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vdupq_laneq_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vdupq_laneq_u64)
