#define EASYSIMD_TEST_ARM_NEON_INSN dup_n

#include "test-neon.h"
#include "../../../easysimd/arm/neon/dup_n.h"

static int
test_easysimd_vdup_n_f16 (EASYSIMD_MUNIT_TEST_ARGS) {
  #if 1
    struct {
      easysimd_float16 a;
      easysimd_float16 r[4];
    } test_vec[] = {
      { EASYSIMD_FLOAT16_VALUE(  -930.50),
      { EASYSIMD_FLOAT16_VALUE(  -930.50), EASYSIMD_FLOAT16_VALUE(  -930.50), EASYSIMD_FLOAT16_VALUE(  -930.50), EASYSIMD_FLOAT16_VALUE(  -930.50) } },
    { EASYSIMD_FLOAT16_VALUE(   789.00),
      { EASYSIMD_FLOAT16_VALUE(   789.00), EASYSIMD_FLOAT16_VALUE(   789.00), EASYSIMD_FLOAT16_VALUE(   789.00), EASYSIMD_FLOAT16_VALUE(   789.00) } },
    { EASYSIMD_FLOAT16_VALUE(  -706.00),
      { EASYSIMD_FLOAT16_VALUE(  -706.00), EASYSIMD_FLOAT16_VALUE(  -706.00), EASYSIMD_FLOAT16_VALUE(  -706.00), EASYSIMD_FLOAT16_VALUE(  -706.00) } },
    { EASYSIMD_FLOAT16_VALUE(   626.50),
      { EASYSIMD_FLOAT16_VALUE(   626.50), EASYSIMD_FLOAT16_VALUE(   626.50), EASYSIMD_FLOAT16_VALUE(   626.50), EASYSIMD_FLOAT16_VALUE(   626.50) } },
    { EASYSIMD_FLOAT16_VALUE(  -321.75),
      { EASYSIMD_FLOAT16_VALUE(  -321.75), EASYSIMD_FLOAT16_VALUE(  -321.75), EASYSIMD_FLOAT16_VALUE(  -321.75), EASYSIMD_FLOAT16_VALUE(  -321.75) } },
    { EASYSIMD_FLOAT16_VALUE(    91.50),
      { EASYSIMD_FLOAT16_VALUE(    91.50), EASYSIMD_FLOAT16_VALUE(    91.50), EASYSIMD_FLOAT16_VALUE(    91.50), EASYSIMD_FLOAT16_VALUE(    91.50) } },
    { EASYSIMD_FLOAT16_VALUE(   479.25),
      { EASYSIMD_FLOAT16_VALUE(   479.25), EASYSIMD_FLOAT16_VALUE(   479.25), EASYSIMD_FLOAT16_VALUE(   479.25), EASYSIMD_FLOAT16_VALUE(   479.25) } },
    { EASYSIMD_FLOAT16_VALUE(  -428.00),
      { EASYSIMD_FLOAT16_VALUE(  -428.00), EASYSIMD_FLOAT16_VALUE(  -428.00), EASYSIMD_FLOAT16_VALUE(  -428.00), EASYSIMD_FLOAT16_VALUE(  -428.00) } }
    };

    for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
      easysimd_float16 a;
      easysimd_float16x4_t r;

      a = test_vec[i].a;
      r = easysimd_vdup_n_f16(a);
    ...
    for (int i = 0 ; i < 8 ; i++) {
      ...
      easysimd_float16x4_t r = easysimd_vdup_n_f16(a);
...
static int
test_easysimd_vdup_n_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    easysimd_float32 a;
    easysimd_float32 r[2];
  } test_vec[] = {
    { EASYSIMD_FLOAT32_C(   891.26),
      { EASYSIMD_FLOAT32_C(   891.26), EASYSIMD_FLOAT32_C(   891.26) } },
    { EASYSIMD_FLOAT32_C(  -212.41),
      { EASYSIMD_FLOAT32_C(  -212.41), EASYSIMD_FLOAT32_C(  -212.41) } },
    { EASYSIMD_FLOAT32_C(   467.72),
      { EASYSIMD_FLOAT32_C(   467.72), EASYSIMD_FLOAT32_C(   467.72) } },
    { EASYSIMD_FLOAT32_C(  -459.92),
      { EASYSIMD_FLOAT32_C(  -459.92), EASYSIMD_FLOAT32_C(  -459.92) } },
    { EASYSIMD_FLOAT32_C(   178.65),
      { EASYSIMD_FLOAT32_C(   178.65), EASYSIMD_FLOAT32_C(   178.65) } },
    { EASYSIMD_FLOAT32_C(   923.96),
      { EASYSIMD_FLOAT32_C(   923.96), EASYSIMD_FLOAT32_C(   923.96) } },
    { EASYSIMD_FLOAT32_C(  -720.22),
      { EASYSIMD_FLOAT32_C(  -720.22), EASYSIMD_FLOAT32_C(  -720.22) } },
    { EASYSIMD_FLOAT32_C(  -919.57),
      { EASYSIMD_FLOAT32_C(  -919.57), EASYSIMD_FLOAT32_C(  -919.57) } },
  };
...
static int
test_easysimd_vdup_n_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    double a;
    easysimd_float64 r[1];
  } test_vec[] = {
    { EASYSIMD_FLOAT64_C(  -118.53),
      { EASYSIMD_FLOAT64_C(  -118.53) } },
    { EASYSIMD_FLOAT64_C(  -542.12),
      { EASYSIMD_FLOAT64_C(  -542.12) } },
    { EASYSIMD_FLOAT64_C(  -633.36),
      { EASYSIMD_FLOAT64_C(  -633.36) } },
    { EASYSIMD_FLOAT64_C(  -497.58),
      { EASYSIMD_FLOAT64_C(  -497.58) } },
    { EASYSIMD_FLOAT64_C(   313.94),
      { EASYSIMD_FLOAT64_C(   313.94) } },
    { EASYSIMD_FLOAT64_C(   244.08),
      { EASYSIMD_FLOAT64_C(   244.08) } },
    { EASYSIMD_FLOAT64_C(   138.92),
      { EASYSIMD_FLOAT64_C(   138.92) } },
    { EASYSIMD_FLOAT64_C(  -906.24),
      { EASYSIMD_FLOAT64_C(  -906.24) } },
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float64 a = test_vec[i].a;
    easysimd_float64x1_t r = easysimd_vdup_n_f64(a);
...
static int
test_easysimd_vdup_n_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int8_t a;
    int8_t r[8];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int8x8_t r = easysimd_vdup_n_s8(a);
...
static int
test_easysimd_vdup_n_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int16_t a;
    int16_t r[4];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int16x4_t r = easysimd_vdup_n_s16(a);
...
static int
test_easysimd_vdup_n_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int32_t a;
    int32_t r[2];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x2_t r = easysimd_vdup_n_s32(a);
...
static int
test_easysimd_vdup_n_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int64_t a;
    int64_t r[1];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int64x1_t r = easysimd_vdup_n_s64(a);
...
static int
test_easysimd_vdup_n_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint8_t a;
    uint8_t r[16];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x8_t r = easysimd_vdup_n_u8(a);
...
static int
test_easysimd_vdup_n_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint16_t a;
    uint16_t r[4];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x4_t r = easysimd_vdup_n_u16(a);
...
static int
test_easysimd_vdup_n_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint32_t a;
    uint32_t r[2];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x2_t r = easysimd_vdup_n_u32(a);
...
static int
test_easysimd_vdup_n_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint64_t a;
    uint64_t r[1];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint64x1_t r = easysimd_vdup_n_u64(a);
...
static int
test_easysimd_vdupq_n_f16 (EASYSIMD_MUNIT_TEST_ARGS) {
  #if 1
    struct {
      easysimd_float16 a;
      easysimd_float16 r[8];
    } test_vec[] = {
      { EASYSIMD_FLOAT16_VALUE(   189.12),
      { EASYSIMD_FLOAT16_VALUE(   189.12), EASYSIMD_FLOAT16_VALUE(   189.12), EASYSIMD_FLOAT16_VALUE(   189.12), EASYSIMD_FLOAT16_VALUE(   189.12),
        EASYSIMD_FLOAT16_VALUE(   189.12), EASYSIMD_FLOAT16_VALUE(   189.12), EASYSIMD_FLOAT16_VALUE(   189.12), EASYSIMD_FLOAT16_VALUE(   189.12) } },
    { EASYSIMD_FLOAT16_VALUE(  -419.50),
      { EASYSIMD_FLOAT16_VALUE(  -419.50), EASYSIMD_FLOAT16_VALUE(  -419.50), EASYSIMD_FLOAT16_VALUE(  -419.50), EASYSIMD_FLOAT16_VALUE(  -419.50),
        EASYSIMD_FLOAT16_VALUE(  -419.50), EASYSIMD_FLOAT16_VALUE(  -419.50), EASYSIMD_FLOAT16_VALUE(  -419.50), EASYSIMD_FLOAT16_VALUE(  -419.50) } },
    { EASYSIMD_FLOAT16_VALUE(   560.50),
      { EASYSIMD_FLOAT16_VALUE(   560.50), EASYSIMD_FLOAT16_VALUE(   560.50), EASYSIMD_FLOAT16_VALUE(   560.50), EASYSIMD_FLOAT16_VALUE(   560.50),
        EASYSIMD_FLOAT16_VALUE(   560.50), EASYSIMD_FLOAT16_VALUE(   560.50), EASYSIMD_FLOAT16_VALUE(   560.50), EASYSIMD_FLOAT16_VALUE(   560.50) } },
    { EASYSIMD_FLOAT16_VALUE(   578.00),
      { EASYSIMD_FLOAT16_VALUE(   578.00), EASYSIMD_FLOAT16_VALUE(   578.00), EASYSIMD_FLOAT16_VALUE(   578.00), EASYSIMD_FLOAT16_VALUE(   578.00),
        EASYSIMD_FLOAT16_VALUE(   578.00), EASYSIMD_FLOAT16_VALUE(   578.00), EASYSIMD_FLOAT16_VALUE(   578.00), EASYSIMD_FLOAT16_VALUE(   578.00) } },
    { EASYSIMD_FLOAT16_VALUE(   722.50),
      { EASYSIMD_FLOAT16_VALUE(   722.50), EASYSIMD_FLOAT16_VALUE(   722.50), EASYSIMD_FLOAT16_VALUE(   722.50), EASYSIMD_FLOAT16_VALUE(   722.50),
        EASYSIMD_FLOAT16_VALUE(   722.50), EASYSIMD_FLOAT16_VALUE(   722.50), EASYSIMD_FLOAT16_VALUE(   722.50), EASYSIMD_FLOAT16_VALUE(   722.50) } },
    { EASYSIMD_FLOAT16_VALUE(   298.00),
      { EASYSIMD_FLOAT16_VALUE(   298.00), EASYSIMD_FLOAT16_VALUE(   298.00), EASYSIMD_FLOAT16_VALUE(   298.00), EASYSIMD_FLOAT16_VALUE(   298.00),
        EASYSIMD_FLOAT16_VALUE(   298.00), EASYSIMD_FLOAT16_VALUE(   298.00), EASYSIMD_FLOAT16_VALUE(   298.00), EASYSIMD_FLOAT16_VALUE(   298.00) } },
    { EASYSIMD_FLOAT16_VALUE(  -351.50),
      { EASYSIMD_FLOAT16_VALUE(  -351.50), EASYSIMD_FLOAT16_VALUE(  -351.50), EASYSIMD_FLOAT16_VALUE(  -351.50), EASYSIMD_FLOAT16_VALUE(  -351.50),
        EASYSIMD_FLOAT16_VALUE(  -351.50), EASYSIMD_FLOAT16_VALUE(  -351.50), EASYSIMD_FLOAT16_VALUE(  -351.50), EASYSIMD_FLOAT16_VALUE(  -351.50) } },
    { EASYSIMD_FLOAT16_VALUE(   245.62),
      { EASYSIMD_FLOAT16_VALUE(   245.62), EASYSIMD_FLOAT16_VALUE(   245.62), EASYSIMD_FLOAT16_VALUE(   245.62), EASYSIMD_FLOAT16_VALUE(   245.62),
        EASYSIMD_FLOAT16_VALUE(   245.62), EASYSIMD_FLOAT16_VALUE(   245.62), EASYSIMD_FLOAT16_VALUE(   245.62), EASYSIMD_FLOAT16_VALUE(   245.62) } }
    };

    for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
      easysimd_float16 a;
      easysimd_float16x8_t r;

      a = test_vec[i].a;
      r = easysimd_vdupq_n_f16(a);
    ...
    for (int i = 0 ; i < 8 ; i++) {
      easysimd_float16 a = easysimd_test_codegen_random_f16(-1000.0f, 1000.0f);
      easysimd_float16x8_t r = easysimd_vdupq_n_f16(a);
...
static int
test_easysimd_vdupq_n_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    easysimd_float32 a;
    easysimd_float32 r[4];
  } test_vec[] = {
    { EASYSIMD_FLOAT32_C(  -253.37),
      { EASYSIMD_FLOAT32_C(  -253.37), EASYSIMD_FLOAT32_C(  -253.37), EASYSIMD_FLOAT32_C(  -253.37), EASYSIMD_FLOAT32_C(  -253.37) } },
    { EASYSIMD_FLOAT32_C(   678.81),
      { EASYSIMD_FLOAT32_C(   678.81), EASYSIMD_FLOAT32_C(   678.81), EASYSIMD_FLOAT32_C(   678.81), EASYSIMD_FLOAT32_C(   678.81) } },
    { EASYSIMD_FLOAT32_C(   287.86),
      { EASYSIMD_FLOAT32_C(   287.86), EASYSIMD_FLOAT32_C(   287.86), EASYSIMD_FLOAT32_C(   287.86), EASYSIMD_FLOAT32_C(   287.86) } },
    { EASYSIMD_FLOAT32_C(   -23.55),
      { EASYSIMD_FLOAT32_C(   -23.55), EASYSIMD_FLOAT32_C(   -23.55), EASYSIMD_FLOAT32_C(   -23.55), EASYSIMD_FLOAT32_C(   -23.55) } },
    { EASYSIMD_FLOAT32_C(   255.34),
      { EASYSIMD_FLOAT32_C(   255.34), EASYSIMD_FLOAT32_C(   255.34), EASYSIMD_FLOAT32_C(   255.34), EASYSIMD_FLOAT32_C(   255.34) } },
    { EASYSIMD_FLOAT32_C(  -331.64),
      { EASYSIMD_FLOAT32_C(  -331.64), EASYSIMD_FLOAT32_C(  -331.64), EASYSIMD_FLOAT32_C(  -331.64), EASYSIMD_FLOAT32_C(  -331.64) } },
    { EASYSIMD_FLOAT32_C(   507.10),
      { EASYSIMD_FLOAT32_C(   507.10), EASYSIMD_FLOAT32_C(   507.10), EASYSIMD_FLOAT32_C(   507.10), EASYSIMD_FLOAT32_C(   507.10) } },
    { EASYSIMD_FLOAT32_C(   555.78),
      { EASYSIMD_FLOAT32_C(   555.78), EASYSIMD_FLOAT32_C(   555.78), EASYSIMD_FLOAT32_C(   555.78), EASYSIMD_FLOAT32_C(   555.78) } },
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float32 a = test_vec[i].a;
    easysimd_float32x4_t r = easysimd_vdupq_n_f32(a);
...
static int
test_easysimd_vdupq_n_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    easysimd_float64 a;
    easysimd_float64 r[2];
  } test_vec[] = {
    { EASYSIMD_FLOAT64_C(  -118.41),
      { EASYSIMD_FLOAT64_C(  -118.41), EASYSIMD_FLOAT64_C(  -118.41) } },
    { EASYSIMD_FLOAT64_C(  -822.94),
      { EASYSIMD_FLOAT64_C(  -822.94), EASYSIMD_FLOAT64_C(  -822.94) } },
    { EASYSIMD_FLOAT64_C(  -264.09),
      { EASYSIMD_FLOAT64_C(  -264.09), EASYSIMD_FLOAT64_C(  -264.09) } },
    { EASYSIMD_FLOAT64_C(  -893.94),
      { EASYSIMD_FLOAT64_C(  -893.94), EASYSIMD_FLOAT64_C(  -893.94) } },
    { EASYSIMD_FLOAT64_C(   267.56),
      { EASYSIMD_FLOAT64_C(   267.56), EASYSIMD_FLOAT64_C(   267.56) } },
    { EASYSIMD_FLOAT64_C(  -972.95),
      { EASYSIMD_FLOAT64_C(  -972.95), EASYSIMD_FLOAT64_C(  -972.95) } },
    { EASYSIMD_FLOAT64_C(  -132.42),
      { EASYSIMD_FLOAT64_C(  -132.42), EASYSIMD_FLOAT64_C(  -132.42) } },
    { EASYSIMD_FLOAT64_C(   -34.49),
      { EASYSIMD_FLOAT64_C(   -34.49), EASYSIMD_FLOAT64_C(   -34.49) } },
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float64 a = test_vec[i].a;
    easysimd_float64x2_t r = easysimd_vdupq_n_f64(a);
...
static int
test_easysimd_vdupq_n_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int8_t a;
    int8_t r[16];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    int8_t a = test_vec[i].a;
    easysimd_int8x16_t r = easysimd_vdupq_n_s8(a);
...
static int
test_easysimd_vdupq_n_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int16_t a;
    int16_t r[8];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    int16_t a = test_vec[i].a;
    easysimd_int16x8_t r = easysimd_vdupq_n_s16(a);
...
static int
test_easysimd_vdupq_n_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int32_t a;
    int32_t r[4];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    int32_t a = test_vec[i].a;
    easysimd_int32x4_t r = easysimd_vdupq_n_s32(a);
...
static int
test_easysimd_vdupq_n_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int64_t a;
    int64_t r[2];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    int64_t a = test_vec[i].a;
    easysimd_int64x2_t r = easysimd_vdupq_n_s64(a);
...
static int
test_easysimd_vdupq_n_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint8_t a;
    uint8_t r[16];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    uint8_t a = test_vec[i].a;
    easysimd_uint8x16_t r = easysimd_vdupq_n_u8(a);
...
static int
test_easysimd_vdupq_n_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint16_t a;
    uint16_t r[8];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    uint16_t a = test_vec[i].a;
    easysimd_uint16x8_t r = easysimd_vdupq_n_u16(a);
...
static int
test_easysimd_vdupq_n_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint32_t a;
    uint32_t r[4];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    uint32_t a = test_vec[i].a;
    easysimd_uint32x4_t r = easysimd_vdupq_n_u32(a);
...
static int
test_easysimd_vdupq_n_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint64_t a;
    uint64_t r[2];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    uint64_t a = test_vec[i].a;
    easysimd_uint64x2_t r = easysimd_vdupq_n_u64(a);
...
EASYSIMD_TEST_FUNC_LIST_ENTRY(vdup_n_f16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vdup_n_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vdup_n_f64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vdup_n_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vdup_n_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vdup_n_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vdup_n_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vdup_n_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vdup_n_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vdup_n_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vdup_n_u64)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vdupq_n_f16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vdupq_n_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vdupq_n_f64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vdupq_n_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vdupq_n_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vdupq_n_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vdupq_n_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vdupq_n_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vdupq_n_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vdupq_n_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vdupq_n_u64)
