#define EASYSIMD_TEST_ARM_NEON_INSN ext

#include "test-neon.h"
#include "../../../easysimd/arm/neon/ext.h"

HEDLEY_DIAGNOSTIC_PUSH
EASYSIMD_DIAGNOSTIC_DISABLE_UNREACHABLE_

static int
test_easysimd_vext_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    ...
    { { EASYSIMD_FLOAT32_C(  -687.45), EASYSIMD_FLOAT32_C(   362.88) },
      { EASYSIMD_FLOAT32_C(   244.11), EASYSIMD_FLOAT32_C(   675.58) },
       INT32_C(           0),
      { EASYSIMD_FLOAT32_C(  -687.45), EASYSIMD_FLOAT32_C(   362.88) } },
    { { EASYSIMD_FLOAT32_C(   707.43), EASYSIMD_FLOAT32_C(   -78.71) },
      { EASYSIMD_FLOAT32_C(   610.46), EASYSIMD_FLOAT32_C(  -912.57) },
       INT32_C(           1),
      { EASYSIMD_FLOAT32_C(   -78.71), EASYSIMD_FLOAT32_C(   610.46) } },
    { { EASYSIMD_FLOAT32_C(   754.89), EASYSIMD_FLOAT32_C(   993.62) },
      { EASYSIMD_FLOAT32_C(  -570.81), EASYSIMD_FLOAT32_C(  -534.46) },
       INT32_C(           0),
      { EASYSIMD_FLOAT32_C(   754.89), EASYSIMD_FLOAT32_C(   993.62) } },
    { { EASYSIMD_FLOAT32_C(  -147.63), EASYSIMD_FLOAT32_C(  -385.01) },
      { EASYSIMD_FLOAT32_C(   570.33), EASYSIMD_FLOAT32_C(  -977.64) },
       INT32_C(           1),
      { EASYSIMD_FLOAT32_C(  -385.01), EASYSIMD_FLOAT32_C(   570.33) } },
    { { EASYSIMD_FLOAT32_C(  -414.19), EASYSIMD_FLOAT32_C(  -824.34) },
      { EASYSIMD_FLOAT32_C(  -892.91), EASYSIMD_FLOAT32_C(  -280.78) },
       INT32_C(           0),
      { EASYSIMD_FLOAT32_C(  -414.19), EASYSIMD_FLOAT32_C(  -824.34) } },
    { { EASYSIMD_FLOAT32_C(  -659.90), EASYSIMD_FLOAT32_C(   892.24) },
      { EASYSIMD_FLOAT32_C(  -796.45), EASYSIMD_FLOAT32_C(  -383.54) },
       INT32_C(           1),
      { EASYSIMD_FLOAT32_C(   892.24), EASYSIMD_FLOAT32_C(  -796.45) } },
    { { EASYSIMD_FLOAT32_C(   -29.63), EASYSIMD_FLOAT32_C(  -636.99) },
      { EASYSIMD_FLOAT32_C(   -37.62), EASYSIMD_FLOAT32_C(   -62.96) },
       INT32_C(           0),
      { EASYSIMD_FLOAT32_C(   -29.63), EASYSIMD_FLOAT32_C(  -636.99) } },
    { { EASYSIMD_FLOAT32_C(  -107.40), EASYSIMD_FLOAT32_C(   234.54) },
      { EASYSIMD_FLOAT32_C(   866.55), EASYSIMD_FLOAT32_C(   205.15) },
       INT32_C(           1),
      { EASYSIMD_FLOAT32_C(   234.54), EASYSIMD_FLOAT32_C(   866.55) } },
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    EASYSIMD_CONSTIFY_2_(easysimd_vext_f32, r, (HEDLEY_UNREACHABLE(), a), n, a, b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_float32x2_t r = easysimd_vext_f32(a, b, lanes[i]);
    ...
    easysimd_test_codegen_write_i32(2, lanes[i], EASYSIMD_TEST_VEC_POS_MIDDLE);
...
static int
test_easysimd_vext_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    ...
    { { EASYSIMD_FLOAT64_C(  -680.82) },
      { EASYSIMD_FLOAT64_C(    28.23) },
      { EASYSIMD_FLOAT64_C(  -680.82) } },
    { { EASYSIMD_FLOAT64_C(   422.94) },
      { EASYSIMD_FLOAT64_C(  -433.13) },
      { EASYSIMD_FLOAT64_C(   422.94) } },
    { { EASYSIMD_FLOAT64_C(  -224.72) },
      { EASYSIMD_FLOAT64_C(  -962.86) },
      { EASYSIMD_FLOAT64_C(  -224.72) } },
    { { EASYSIMD_FLOAT64_C(   366.48) },
      { EASYSIMD_FLOAT64_C(  -406.43) },
      { EASYSIMD_FLOAT64_C(   366.48) } },
    { { EASYSIMD_FLOAT64_C(   712.41) },
      { EASYSIMD_FLOAT64_C(   528.86) },
      { EASYSIMD_FLOAT64_C(   712.41) } },
    { { EASYSIMD_FLOAT64_C(   609.88) },
      { EASYSIMD_FLOAT64_C(  -935.77) },
      { EASYSIMD_FLOAT64_C(   609.88) } },
    { { EASYSIMD_FLOAT64_C(   202.19) },
      { EASYSIMD_FLOAT64_C(   313.38) },
      { EASYSIMD_FLOAT64_C(   202.19) } },
    { { EASYSIMD_FLOAT64_C(  -424.80) },
      { EASYSIMD_FLOAT64_C(   680.39) },
      { EASYSIMD_FLOAT64_C(  -424.80) } },
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_float64x1_t r = easysimd_vext_f64(a, b, 0);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_test_codegen_write_i32(2, n, EASYSIMD_TEST_VEC_POS_MIDDLE);
...
static int
test_easysimd_vext_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int8_t a[8];
    int8_t b[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    int n = test_vec[i].n;
    easysimd_int8x8_t r;
    EASYSIMD_CONSTIFY_8_(easysimd_vext_s8, r, (HEDLEY_UNREACHABLE(), a), n, a, b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_int8x8_t r = easysimd_vext_s8(a, b, lanes[i]);
...
static int
test_easysimd_vext_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int16_t a[4];
    int16_t b[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    EASYSIMD_CONSTIFY_4_(easysimd_vext_s16, r, (HEDLEY_UNREACHABLE(), a), n, a, b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_int16x4_t r = easysimd_vext_s16(a, b, lanes[i]);
...
static int
test_easysimd_vext_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t a[2];
    int32_t b[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    EASYSIMD_CONSTIFY_2_(easysimd_vext_s32, r, (HEDLEY_UNREACHABLE(), a), n, a, b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_int32x2_t r = easysimd_vext_s32(a, b, lanes[i]);
...
static int
test_easysimd_vext_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int64_t a[1];
    int64_t b[1];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int64x1_t r = easysimd_vext_s64(a, b, 0);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_test_codegen_write_i32(2, 0, EASYSIMD_TEST_VEC_POS_MIDDLE);
...
static int
test_easysimd_vext_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint8_t a[8];
    uint8_t b[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    EASYSIMD_CONSTIFY_8_(easysimd_vext_u8, r, (HEDLEY_UNREACHABLE(), a), n, a, b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_uint8x8_t r = easysimd_vext_u8(a, b, lanes[i]);
...
static int
test_easysimd_vext_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint16_t a[4];
    uint16_t b[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    EASYSIMD_CONSTIFY_4_(easysimd_vext_u16, r, (HEDLEY_UNREACHABLE(), a), n, a, b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_uint16x4_t r = easysimd_vext_u16(a, b, lanes[i]);
...
static int
test_easysimd_vext_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint32_t a[2];
    uint32_t b[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    EASYSIMD_CONSTIFY_2_(easysimd_vext_u32, r, (HEDLEY_UNREACHABLE(), a), n, a, b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_uint32x2_t r = easysimd_vext_u32(a, b, lanes[i]);
...
static int
test_easysimd_vext_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint64_t a[1];
    uint64_t b[1];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint64x1_t r = easysimd_vext_u64(a, b, 0);
...
static int
test_easysimd_vextq_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    ...
    { { EASYSIMD_FLOAT32_C(   -11.82), EASYSIMD_FLOAT32_C(  -542.24), EASYSIMD_FLOAT32_C(   904.95), EASYSIMD_FLOAT32_C(   599.34) },
      { EASYSIMD_FLOAT32_C(  -323.53), EASYSIMD_FLOAT32_C(   591.26), EASYSIMD_FLOAT32_C(  -753.72), EASYSIMD_FLOAT32_C(    19.62) },
       INT32_C(           0),
      { EASYSIMD_FLOAT32_C(   -11.82), EASYSIMD_FLOAT32_C(  -542.24), EASYSIMD_FLOAT32_C(   904.95), EASYSIMD_FLOAT32_C(   599.34) } },
    { { EASYSIMD_FLOAT32_C(  -246.51), EASYSIMD_FLOAT32_C(  -600.23), EASYSIMD_FLOAT32_C(  -164.99), EASYSIMD_FLOAT32_C(  -616.01) },
      { EASYSIMD_FLOAT32_C(  -788.95), EASYSIMD_FLOAT32_C(  -648.59), EASYSIMD_FLOAT32_C(   630.30), EASYSIMD_FLOAT32_C(   886.86) },
       INT32_C(           1),
      { EASYSIMD_FLOAT32_C(  -600.23), EASYSIMD_FLOAT32_C(  -164.99), EASYSIMD_FLOAT32_C(  -616.01), EASYSIMD_FLOAT32_C(  -788.95) } },
    { { EASYSIMD_FLOAT32_C(   -83.54), EASYSIMD_FLOAT32_C(  -412.91), EASYSIMD_FLOAT32_C(   -86.28), EASYSIMD_FLOAT32_C(   790.95) },
      { EASYSIMD_FLOAT32_C(   194.71), EASYSIMD_FLOAT32_C(  -239.80), EASYSIMD_FLOAT32_C(  -880.77), EASYSIMD_FLOAT32_C(  -974.84) },
       INT32_C(           2),
      { EASYSIMD_FLOAT32_C(   -86.28), EASYSIMD_FLOAT32_C(   790.95), EASYSIMD_FLOAT32_C(   194.71), EASYSIMD_FLOAT32_C(  -239.80) } },
    { { EASYSIMD_FLOAT32_C(   572.07), EASYSIMD_FLOAT32_C(   171.25), EASYSIMD_FLOAT32_C(   700.50), EASYSIMD_FLOAT32_C(  -266.41) },
      { EASYSIMD_FLOAT32_C(   107.61), EASYSIMD_FLOAT32_C(  -395.18), EASYSIMD_FLOAT32_C(  -409.82), EASYSIMD_FLOAT32_C(  -904.21) },
       INT32_C(           3),
      { EASYSIMD_FLOAT32_C(  -266.41), EASYSIMD_FLOAT32_C(   107.61), EASYSIMD_FLOAT32_C(  -395.18), EASYSIMD_FLOAT32_C(  -409.82) } },
    { { EASYSIMD_FLOAT32_C(    62.58), EASYSIMD_FLOAT32_C(  -504.88), EASYSIMD_FLOAT32_C(   695.13), EASYSIMD_FLOAT32_C(   739.05) },
      { EASYSIMD_FLOAT32_C(  -913.62), EASYSIMD_FLOAT32_C(   941.41), EASYSIMD_FLOAT32_C(  -241.33), EASYSIMD_FLOAT32_C(  -160.12) },
       INT32_C(           0),
      { EASYSIMD_FLOAT32_C(    62.58), EASYSIMD_FLOAT32_C(  -504.88), EASYSIMD_FLOAT32_C(   695.13), EASYSIMD_FLOAT32_C(   739.05) } },
    { { EASYSIMD_FLOAT32_C(  -658.83), EASYSIMD_FLOAT32_C(   593.68), EASYSIMD_FLOAT32_C(   223.86), EASYSIMD_FLOAT32_C(  -447.78) },
      { EASYSIMD_FLOAT32_C(   945.09), EASYSIMD_FLOAT32_C(  -145.84), EASYSIMD_FLOAT32_C(  -560.91), EASYSIMD_FLOAT32_C(  -138.45) },
       INT32_C(           1),
      { EASYSIMD_FLOAT32_C(   593.68), EASYSIMD_FLOAT32_C(   223.86), EASYSIMD_FLOAT32_C(  -447.78), EASYSIMD_FLOAT32_C(   945.09) } },
    { { EASYSIMD_FLOAT32_C(   441.26), EASYSIMD_FLOAT32_C(   352.81), EASYSIMD_FLOAT32_C(  -347.49), EASYSIMD_FLOAT32_C(  -364.04) },
      { EASYSIMD_FLOAT32_C(  -887.00), EASYSIMD_FLOAT32_C(  -228.26), EASYSIMD_FLOAT32_C(  -338.88), EASYSIMD_FLOAT32_C(   685.07) },
       INT32_C(           2),
      { EASYSIMD_FLOAT32_C(  -347.49), EASYSIMD_FLOAT32_C(  -364.04), EASYSIMD_FLOAT32_C(  -887.00), EASYSIMD_FLOAT32_C(  -228.26) } },
    { { EASYSIMD_FLOAT32_C(   942.99), EASYSIMD_FLOAT32_C(  -638.38), EASYSIMD_FLOAT32_C(  -581.34), EASYSIMD_FLOAT32_C(    50.60) },
      { EASYSIMD_FLOAT32_C(   -33.56), EASYSIMD_FLOAT32_C(     8.84), EASYSIMD_FLOAT32_C(   146.38), EASYSIMD_FLOAT32_C(  -970.98) },
       INT32_C(           3),
      { EASYSIMD_FLOAT32_C(    50.60), EASYSIMD_FLOAT32_C(   -33.56), EASYSIMD_FLOAT32_C(     8.84), EASYSIMD_FLOAT32_C(   146.38) } },
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    EASYSIMD_CONSTIFY_4_(easysimd_vextq_f32, r, (HEDLEY_UNREACHABLE(), a), n, a, b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_float32x4_t r = easysimd_vextq_f32(a, b, lanes[i]);
...
static int
test_easysimd_vextq_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    ...
    { { EASYSIMD_FLOAT64_C(   223.42), EASYSIMD_FLOAT64_C(  -836.30) },
      { EASYSIMD_FLOAT64_C(  -552.33), EASYSIMD_FLOAT64_C(   -75.69) },
       INT32_C(           0),
      { EASYSIMD_FLOAT64_C(   223.42), EASYSIMD_FLOAT64_C(  -836.30) } },
    { { EASYSIMD_FLOAT64_C(   756.82), EASYSIMD_FLOAT64_C(  -550.05) },
      { EASYSIMD_FLOAT64_C(   687.41), EASYSIMD_FLOAT64_C(   804.17) },
       INT32_C(           0),
      { EASYSIMD_FLOAT64_C(   756.82), EASYSIMD_FLOAT64_C(  -550.05) } },
    { { EASYSIMD_FLOAT64_C(  -230.29), EASYSIMD_FLOAT64_C(  -327.40) },
      { EASYSIMD_FLOAT64_C(   614.24), EASYSIMD_FLOAT64_C(  -107.90) },
       INT32_C(           0),
      { EASYSIMD_FLOAT64_C(  -230.29), EASYSIMD_FLOAT64_C(  -327.40) } },
    { { EASYSIMD_FLOAT64_C(  -177.24), EASYSIMD_FLOAT64_C(  -842.50) },
      { EASYSIMD_FLOAT64_C(   773.97), EASYSIMD_FLOAT64_C(   644.31) },
       INT32_C(           0),
      { EASYSIMD_FLOAT64_C(  -177.24), EASYSIMD_FLOAT64_C(  -842.50) } },
    { { EASYSIMD_FLOAT64_C(  -485.54), EASYSIMD_FLOAT64_C(  -253.40) },
      { EASYSIMD_FLOAT64_C(  -930.32), EASYSIMD_FLOAT64_C(   677.29) },
       INT32_C(           0),
      { EASYSIMD_FLOAT64_C(  -485.54), EASYSIMD_FLOAT64_C(  -253.40) } },
    { { EASYSIMD_FLOAT64_C(   819.98), EASYSIMD_FLOAT64_C(   883.30) },
      { EASYSIMD_FLOAT64_C(  -760.51), EASYSIMD_FLOAT64_C(   669.54) },
       INT32_C(           0),
      { EASYSIMD_FLOAT64_C(   819.98), EASYSIMD_FLOAT64_C(   883.30) } },
    { { EASYSIMD_FLOAT64_C(  -349.64), EASYSIMD_FLOAT64_C(   465.41) },
      { EASYSIMD_FLOAT64_C(  -828.45), EASYSIMD_FLOAT64_C(  -240.64) },
       INT32_C(           0),
      { EASYSIMD_FLOAT64_C(  -349.64), EASYSIMD_FLOAT64_C(   465.41) } },
    { { EASYSIMD_FLOAT64_C(  -629.75), EASYSIMD_FLOAT64_C(   891.13) },
      { EASYSIMD_FLOAT64_C(  -550.52), EASYSIMD_FLOAT64_C(   593.67) },
       INT32_C(           0),
      { EASYSIMD_FLOAT64_C(  -629.75), EASYSIMD_FLOAT64_C(   891.13) } },
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    EASYSIMD_CONSTIFY_2_(easysimd_vextq_f64, r, (HEDLEY_UNREACHABLE(), a), n, a, b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_float64x2_t r = easysimd_vextq_f64(a, b, 0);
...
static int
test_easysimd_vextq_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int8_t a[16];
    int8_t b[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    EASYSIMD_CONSTIFY_16_(easysimd_vextq_s8, r, (HEDLEY_UNREACHABLE(), a), n, a, b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_int8x16_t r = easysimd_vextq_s8(a, b, lanes[i]);
...
static int
test_easysimd_vextq_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int16_t a[8];
    int16_t b[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    EASYSIMD_CONSTIFY_8_(easysimd_vextq_s16, r, (HEDLEY_UNREACHABLE(), a), n, a, b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_int16x8_t r = easysimd_vextq_s16(a, b, lanes[i]);
...
static int
test_easysimd_vextq_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t a[4];
    int32_t b[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    EASYSIMD_CONSTIFY_4_(easysimd_vextq_s32, r, (HEDLEY_UNREACHABLE(), a), n, a, b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_int32x4_t r = easysimd_vextq_s32(a, b, lanes[i]);
...
static int
test_easysimd_vextq_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int64_t a[2];
    int64_t b[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    EASYSIMD_CONSTIFY_2_(easysimd_vextq_s64, r, (HEDLEY_UNREACHABLE(), a), n, a, b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_int64x2_t r = easysimd_vextq_s64(a, b, lanes[i]);
...
static int
test_easysimd_vextq_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint8_t a[16];
    uint8_t b[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    EASYSIMD_CONSTIFY_16_(easysimd_vextq_u8, r, (HEDLEY_UNREACHABLE(), a), n, a, b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_uint8x16_t r = easysimd_vextq_u8(a, b, lanes[i]);
...
static int
test_easysimd_vextq_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint16_t a[8];
    uint16_t b[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    EASYSIMD_CONSTIFY_8_(easysimd_vextq_u16, r, (HEDLEY_UNREACHABLE(), a), n, a, b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_uint16x8_t r = easysimd_vextq_u16(a, b, lanes[i]);
...
static int
test_easysimd_vextq_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint32_t a[4];
    uint32_t b[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    EASYSIMD_CONSTIFY_4_(easysimd_vextq_u32, r, (HEDLEY_UNREACHABLE(), a), n, a, b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_uint32x4_t r = easysimd_vextq_u32(a, b, lanes[i]);
...
static int
test_easysimd_vextq_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint64_t a[2];
    uint64_t b[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    EASYSIMD_CONSTIFY_2_(easysimd_vextq_u64, r, (HEDLEY_UNREACHABLE(), a), n, a, b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_uint64x2_t r = easysimd_vextq_u64(a, b, lanes[i]);
...
EASYSIMD_TEST_FUNC_LIST_ENTRY(vext_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vext_f64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vext_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vext_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vext_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vext_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vext_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vext_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vext_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vext_u64)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vextq_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vextq_f64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vextq_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vextq_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vextq_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vextq_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vextq_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vextq_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vextq_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vextq_u64)
