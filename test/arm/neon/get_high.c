#define EASYSIMD_TEST_ARM_NEON_INSN get_high

#include "test-neon.h"
#include "../../../easysimd/arm/neon/get_high.h"

static int
test_easysimd_vget_high_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    easysimd_float32 a[4];
    easysimd_float32 r[2];
  } test_vec[] = {
    { { EASYSIMD_FLOAT32_C(  -342.02), EASYSIMD_FLOAT32_C(  -700.14), EASYSIMD_FLOAT32_C(   232.12), EASYSIMD_FLOAT32_C(  -101.83) },
      { EASYSIMD_FLOAT32_C(   232.12), EASYSIMD_FLOAT32_C(  -101.83) } },
    { { EASYSIMD_FLOAT32_C(  -988.11), EASYSIMD_FLOAT32_C(   147.79), EASYSIMD_FLOAT32_C(   871.85), EASYSIMD_FLOAT32_C(  -252.38) },
      { EASYSIMD_FLOAT32_C(   871.85), EASYSIMD_FLOAT32_C(  -252.38) } },
    { { EASYSIMD_FLOAT32_C(   182.44), EASYSIMD_FLOAT32_C(   926.75), EASYSIMD_FLOAT32_C(  -990.47), EASYSIMD_FLOAT32_C(  -507.70) },
      { EASYSIMD_FLOAT32_C(  -990.47), EASYSIMD_FLOAT32_C(  -507.70) } },
    { { EASYSIMD_FLOAT32_C(  -332.88), EASYSIMD_FLOAT32_C(   248.48), EASYSIMD_FLOAT32_C(   962.27), EASYSIMD_FLOAT32_C(   190.23) },
      { EASYSIMD_FLOAT32_C(   962.27), EASYSIMD_FLOAT32_C(   190.23) } },
    { { EASYSIMD_FLOAT32_C(   530.12), EASYSIMD_FLOAT32_C(  -559.75), EASYSIMD_FLOAT32_C(   -68.78), EASYSIMD_FLOAT32_C(  -625.03) },
      { EASYSIMD_FLOAT32_C(   -68.78), EASYSIMD_FLOAT32_C(  -625.03) } },
    { { EASYSIMD_FLOAT32_C(  -696.26), EASYSIMD_FLOAT32_C(   343.99), EASYSIMD_FLOAT32_C(   875.39), EASYSIMD_FLOAT32_C(   507.32) },
      { EASYSIMD_FLOAT32_C(   875.39), EASYSIMD_FLOAT32_C(   507.32) } },
    { { EASYSIMD_FLOAT32_C(  -239.21), EASYSIMD_FLOAT32_C(   714.53), EASYSIMD_FLOAT32_C(  -233.95), EASYSIMD_FLOAT32_C(    96.87) },
      { EASYSIMD_FLOAT32_C(  -233.95), EASYSIMD_FLOAT32_C(    96.87) } },
    { { EASYSIMD_FLOAT32_C(   751.96), EASYSIMD_FLOAT32_C(  -235.16), EASYSIMD_FLOAT32_C(  -766.29), EASYSIMD_FLOAT32_C(  -590.06) },
      { EASYSIMD_FLOAT32_C(  -766.29), EASYSIMD_FLOAT32_C(  -590.06) } },
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float32x4_t a;
    easysimd_float32x2_t r;

    a = easysimd_vld1q_f32(test_vec[i].a);
    r = easysimd_vget_high_f32(a);
...
static int
test_easysimd_vget_high_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    easysimd_float64 a[2];
    easysimd_float64 r[1];
  } test_vec[] = {
    { { EASYSIMD_FLOAT64_C(  -496.87), EASYSIMD_FLOAT64_C(  -513.71) },
      { EASYSIMD_FLOAT64_C(  -513.71) } },
    { { EASYSIMD_FLOAT64_C(   305.86), EASYSIMD_FLOAT64_C(   676.57) },
      { EASYSIMD_FLOAT64_C(   676.57) } },
    { { EASYSIMD_FLOAT64_C(   -67.25), EASYSIMD_FLOAT64_C(  -986.11) },
      { EASYSIMD_FLOAT64_C(  -986.11) } },
    { { EASYSIMD_FLOAT64_C(   582.35), EASYSIMD_FLOAT64_C(   984.12) },
      { EASYSIMD_FLOAT64_C(   984.12) } },
    { { EASYSIMD_FLOAT64_C(  -936.12), EASYSIMD_FLOAT64_C(  -999.04) },
      { EASYSIMD_FLOAT64_C(  -999.04) } },
    { { EASYSIMD_FLOAT64_C(  -427.34), EASYSIMD_FLOAT64_C(   114.37) },
      { EASYSIMD_FLOAT64_C(   114.37) } },
    { { EASYSIMD_FLOAT64_C(  -340.67), EASYSIMD_FLOAT64_C(   719.32) },
      { EASYSIMD_FLOAT64_C(   719.32) } },
    { { EASYSIMD_FLOAT64_C(  -609.36), EASYSIMD_FLOAT64_C(  -653.25) },
      { EASYSIMD_FLOAT64_C(  -653.25) } },
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float64x2_t a = easysimd_vld1q_f64(test_vec[i].a);
    easysimd_float64x1_t r = easysimd_vget_high_f64(a);
...
static int
test_easysimd_vget_high_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int8_t a[16];
    int8_t r[8];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int8x8_t r = easysimd_vget_high_s8(a);
...
static int
test_easysimd_vget_high_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int16_t a[8];
    int16_t r[4];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int16x4_t r = easysimd_vget_high_s16(a);
...
static int
test_easysimd_vget_high_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int32_t a[4];
    int32_t r[2];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x2_t r = easysimd_vget_high_s32(a);
...
static int
test_easysimd_vget_high_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int64_t a[2];
    int64_t r[1];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int64x1_t r = easysimd_vget_high_s64(a);
...
static int
test_easysimd_vget_high_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint8_t a[16];
    uint8_t r[8];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x8_t r = easysimd_vget_high_u8(a);
...
static int
test_easysimd_vget_high_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint16_t a[8];
    uint16_t r[4];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x4_t r = easysimd_vget_high_u16(a);
...
static int
test_easysimd_vget_high_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint32_t a[4];
    uint32_t r[2];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x2_t r = easysimd_vget_high_u32(a);
...
static int
test_easysimd_vget_high_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint64_t a[2];
    uint64_t r[1];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint64x1_t r = easysimd_vget_high_u64(a);
...
EASYSIMD_TEST_FUNC_LIST_ENTRY(vget_high_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vget_high_f64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vget_high_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vget_high_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vget_high_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vget_high_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vget_high_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vget_high_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vget_high_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vget_high_u64)
