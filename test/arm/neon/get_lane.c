#define EASYSIMD_TEST_ARM_NEON_INSN get_lane
...
static int
test_easysimd_vget_lane_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    easysimd_float32 a[2];
    int b;
    easysimd_float32 r;
  } test_vec[] = {
    { { EASYSIMD_FLOAT32_C(   410.64), EASYSIMD_FLOAT32_C(   344.10) },
       INT8_C(   1),
      EASYSIMD_FLOAT32_C(   344.10) },
    { { EASYSIMD_FLOAT32_C(  -838.05), EASYSIMD_FLOAT32_C(  -800.70) },
       INT8_C(   1),
      EASYSIMD_FLOAT32_C(  -800.70) },
    { { EASYSIMD_FLOAT32_C(   546.78), EASYSIMD_FLOAT32_C(   198.96) },
       INT8_C(   0),
      EASYSIMD_FLOAT32_C(   546.78) },
    { { EASYSIMD_FLOAT32_C(  -101.20), EASYSIMD_FLOAT32_C(  -135.04) },
       INT8_C(   1),
      EASYSIMD_FLOAT32_C(  -135.04) },
    { { EASYSIMD_FLOAT32_C(   -61.99), EASYSIMD_FLOAT32_C(   998.55) },
       INT8_C(   1),
      EASYSIMD_FLOAT32_C(   998.55) },
    { { EASYSIMD_FLOAT32_C(  -663.21), EASYSIMD_FLOAT32_C(  -581.66) },
       INT8_C(   0),
      EASYSIMD_FLOAT32_C(  -663.21) },
    { { EASYSIMD_FLOAT32_C(  -515.64), EASYSIMD_FLOAT32_C(  -101.75) },
       INT8_C(   1),
      EASYSIMD_FLOAT32_C(  -101.75) },
    { { EASYSIMD_FLOAT32_C(   909.95), EASYSIMD_FLOAT32_C(  -480.35) },
       INT8_C(   0),
      EASYSIMD_FLOAT32_C(   909.95) },
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    int b = test_vec[i].b;
    easysimd_float32 r;
    EASYSIMD_CONSTIFY_2_(easysimd_vget_lane_f32, r, (HEDLEY_UNREACHABLE(), EASYSIMD_FLOAT32_C(0.0)), b, a);
...
static int
test_easysimd_vget_lane_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    easysimd_float64 a[1];
    easysimd_float64 r;
  } test_vec[] = {
    { { EASYSIMD_FLOAT64_C(  -475.46) },
      EASYSIMD_FLOAT64_C(  -475.46) },
    { { EASYSIMD_FLOAT64_C(    40.13) },
      EASYSIMD_FLOAT64_C(    40.13) },
    { { EASYSIMD_FLOAT64_C(   577.68) },
      EASYSIMD_FLOAT64_C(   577.68) },
    { { EASYSIMD_FLOAT64_C(  -438.44) },
      EASYSIMD_FLOAT64_C(  -438.44) },
    { { EASYSIMD_FLOAT64_C(   564.06) },
      EASYSIMD_FLOAT64_C(   564.06) },
    { { EASYSIMD_FLOAT64_C(  -519.34) },
      EASYSIMD_FLOAT64_C(  -519.34) },
    { { EASYSIMD_FLOAT64_C(  -449.22) },
      EASYSIMD_FLOAT64_C(  -449.22) },
    { { EASYSIMD_FLOAT64_C(  -456.94) },
      EASYSIMD_FLOAT64_C(  -456.94) },
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_float64 r = easysimd_vget_lane_f64(a, 0);
...
static int
test_easysimd_vget_lane_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int8_t a[8];
    int b;
    int8_t r;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    int b = test_vec[i].b;
    int8_t r;
    EASYSIMD_CONSTIFY_8_(easysimd_vget_lane_s8, r, (HEDLEY_UNREACHABLE(), 0), b, a);
...
static int
test_easysimd_vget_lane_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int16_t a[4];
    int b;
    int16_t r;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    int b = test_vec[i].b;
    int16_t r;
    EASYSIMD_CONSTIFY_4_(easysimd_vget_lane_s16, r, (HEDLEY_UNREACHABLE(), 0), b, a);
...
static int
test_easysimd_vget_lane_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int32_t a[2];
    int b;
    int32_t r;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    int b = test_vec[i].b;
    int32_t r;
    EASYSIMD_CONSTIFY_2_(easysimd_vget_lane_s32, r, (HEDLEY_UNREACHABLE(), 0), b, a);
...
static int
test_easysimd_vget_lane_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int64_t a[1];
    int64_t r;
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    int64_t r = easysimd_vget_lane_s64(a, 0);
...
static int
test_easysimd_vget_lane_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint8_t a[16];
    int b;
    uint8_t r;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    int b = test_vec[i].b;
    uint8_t r;
    EASYSIMD_CONSTIFY_8_(easysimd_vget_lane_u8, r, (HEDLEY_UNREACHABLE(), 0), b, a);
...
static int
test_easysimd_vget_lane_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint16_t a[4];
    int b;
    uint16_t r;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    int b = test_vec[i].b;
    uint16_t r;
    EASYSIMD_CONSTIFY_4_(easysimd_vget_lane_u16, r, (HEDLEY_UNREACHABLE(), 0), b, a);
...
static int
test_easysimd_vget_lane_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint32_t a[2];
    int b;
    uint32_t r;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    int b = test_vec[i].b;
    uint32_t r;
    EASYSIMD_CONSTIFY_2_(easysimd_vget_lane_u32, r, (HEDLEY_UNREACHABLE(), 0), b, a);
...
static int
test_easysimd_vget_lane_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint64_t a[1];
    uint64_t r;
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    uint64_t r = easysimd_vget_lane_u64(a, 0);
...
static int
test_easysimd_vgetq_lane_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    easysimd_float32 a[4];
    int b;
    easysimd_float32 r;
  } test_vec[] = {
    { { EASYSIMD_FLOAT32_C(   273.12), EASYSIMD_FLOAT32_C(   753.68), EASYSIMD_FLOAT32_C(   -47.15), EASYSIMD_FLOAT32_C(   832.55) },
       INT8_C(   1),
      EASYSIMD_FLOAT32_C(   753.68) },
    { { EASYSIMD_FLOAT32_C(   -32.75), EASYSIMD_FLOAT32_C(    69.02), EASYSIMD_FLOAT32_C(   834.09), EASYSIMD_FLOAT32_C(   613.18) },
       INT8_C(   3),
      EASYSIMD_FLOAT32_C(   613.18) },
    { { EASYSIMD_FLOAT32_C(  -409.75), EASYSIMD_FLOAT32_C(  -293.91), EASYSIMD_FLOAT32_C(  -958.18), EASYSIMD_FLOAT32_C(  -184.72) },
       INT8_C(   3),
      EASYSIMD_FLOAT32_C(  -184.72) },
    { { EASYSIMD_FLOAT32_C(  -957.69), EASYSIMD_FLOAT32_C(   993.98), EASYSIMD_FLOAT32_C(   264.51), EASYSIMD_FLOAT32_C(  -192.93) },
       INT8_C(   3),
      EASYSIMD_FLOAT32_C(  -192.93) },
    { { EASYSIMD_FLOAT32_C(   970.45), EASYSIMD_FLOAT32_C(   778.50), EASYSIMD_FLOAT32_C(   196.11), EASYSIMD_FLOAT32_C(   650.20) },
       INT8_C(   1),
      EASYSIMD_FLOAT32_C(   778.50) },
    { { EASYSIMD_FLOAT32_C(  -845.53), EASYSIMD_FLOAT32_C(  -889.17), EASYSIMD_FLOAT32_C(  -363.16), EASYSIMD_FLOAT32_C(   770.16) },
       INT8_C(   3),
      EASYSIMD_FLOAT32_C(   770.16) },
    { { EASYSIMD_FLOAT32_C(   532.17), EASYSIMD_FLOAT32_C(    43.28), EASYSIMD_FLOAT32_C(    39.43), EASYSIMD_FLOAT32_C(  -514.98) },
       INT8_C(   1),
      EASYSIMD_FLOAT32_C(    43.28) },
    { { EASYSIMD_FLOAT32_C(    35.67), EASYSIMD_FLOAT32_C(   452.27), EASYSIMD_FLOAT32_C(   944.85), EASYSIMD_FLOAT32_C(  -130.24) },
       INT8_C(   3),
      EASYSIMD_FLOAT32_C(  -130.24) },
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    int b = test_vec[i].b;
    easysimd_float32 r;
    EASYSIMD_CONSTIFY_4_(easysimd_vgetq_lane_f32, r, (HEDLEY_UNREACHABLE(), EASYSIMD_FLOAT32_C(0.0)), b, a);
...
static int
test_easysimd_vgetq_lane_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    easysimd_float64 a[2];
    int b;
    easysimd_float64 r;
  } test_vec[] = {
    { { EASYSIMD_FLOAT64_C(   629.36), EASYSIMD_FLOAT64_C(  -547.88) },
       INT8_C(   1),
      EASYSIMD_FLOAT64_C(  -547.88) },
    { { EASYSIMD_FLOAT64_C(  -917.95), EASYSIMD_FLOAT64_C(  -153.86) },
       INT8_C(   1),
      EASYSIMD_FLOAT64_C(  -153.86) },
    { { EASYSIMD_FLOAT64_C(   233.05), EASYSIMD_FLOAT64_C(  -687.76) },
       INT8_C(   1),
      EASYSIMD_FLOAT64_C(  -687.76) },
    { { EASYSIMD_FLOAT64_C(   358.76), EASYSIMD_FLOAT64_C(   -20.52) },
       INT8_C(   1),
      EASYSIMD_FLOAT64_C(   -20.52) },
    { { EASYSIMD_FLOAT64_C(   501.06), EASYSIMD_FLOAT64_C(  -830.23) },
       INT8_C(   1),
      EASYSIMD_FLOAT64_C(  -830.23) },
    { { EASYSIMD_FLOAT64_C(  -204.70), EASYSIMD_FLOAT64_C(  -481.76) },
       INT8_C(   1),
      EASYSIMD_FLOAT64_C(  -481.76) },
    { { EASYSIMD_FLOAT64_C(  -746.83), EASYSIMD_FLOAT64_C(   -28.88) },
       INT8_C(   1),
      EASYSIMD_FLOAT64_C(   -28.88) },
    { { EASYSIMD_FLOAT64_C(   935.21), EASYSIMD_FLOAT64_C(  -696.96) },
       INT8_C(   1),
      EASYSIMD_FLOAT64_C(  -696.96) },
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    int b = test_vec[i].b;
    easysimd_float64 r;
    EASYSIMD_CONSTIFY_2_(easysimd_vgetq_lane_f64, r, (HEDLEY_UNREACHABLE(), EASYSIMD_FLOAT64_C(0.0)), b, a);
...
static int
test_easysimd_vgetq_lane_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int8_t a[16];
    int b;
    int8_t r;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    int b = test_vec[i].b;
    int8_t r;
    EASYSIMD_CONSTIFY_16_(easysimd_vgetq_lane_s8, r, (HEDLEY_UNREACHABLE(), 0), b, a);
...
static int
test_easysimd_vgetq_lane_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int16_t a[8];
    int b;
    int16_t r;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    int b = test_vec[i].b;
    int16_t r;
    EASYSIMD_CONSTIFY_8_(easysimd_vgetq_lane_s16, r, (HEDLEY_UNREACHABLE(), 0), b, a);
...
static int
test_easysimd_vgetq_lane_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int32_t a[4];
    int b;
    int32_t r;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    int b = test_vec[i].b;
    int32_t r;
    EASYSIMD_CONSTIFY_4_(easysimd_vgetq_lane_s32, r, (HEDLEY_UNREACHABLE(), 0), b, a);
    easysimd_assert_equal_i32(r, test_vec[i].r);
  }
...
static int
test_easysimd_vgetq_lane_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int64_t a[2];
    int b;
    int64_t r;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    int b = test_vec[i].b;
    int64_t r;
    EASYSIMD_CONSTIFY_2_(easysimd_vgetq_lane_s64, r, (HEDLEY_UNREACHABLE(), 0), b, a);
    easysimd_assert_equal_i64(r, test_vec[i].r);
  }
...
static int
test_easysimd_vgetq_lane_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint8_t a[16];
    int b;
    uint8_t r;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    int b = test_vec[i].b;
    uint8_t r;
    EASYSIMD_CONSTIFY_16_(easysimd_vgetq_lane_u8, r, (HEDLEY_UNREACHABLE(), 0), b, a);
...
static int
test_easysimd_vgetq_lane_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint16_t a[8];
    int b;
    uint16_t r;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    int b = test_vec[i].b;
    uint16_t r;
    EASYSIMD_CONSTIFY_8_(easysimd_vgetq_lane_u16, r, (HEDLEY_UNREACHABLE(), 0), b, a);
    easysimd_assert_equal_u16(r, test_vec[i].r);
  }
...
static int
test_easysimd_vgetq_lane_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint32_t a[4];
    int b;
    uint32_t r;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    int b = test_vec[i].b;
    uint32_t r;
    EASYSIMD_CONSTIFY_4_(easysimd_vgetq_lane_u32, r, (HEDLEY_UNREACHABLE(), 0), b, a);
...
static int
test_easysimd_vgetq_lane_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint64_t a[2];
    int b;
    uint64_t r;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    int b = test_vec[i].b;
    uint64_t r;
    EASYSIMD_CONSTIFY_2_(easysimd_vgetq_lane_u64, r, (HEDLEY_UNREACHABLE(), 0), b, a);
    easysimd_assert_equal_u64(r, test_vec[i].r);
  }
...
EASYSIMD_TEST_FUNC_LIST_ENTRY(vget_lane_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vget_lane_f64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vget_lane_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vget_lane_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vget_lane_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vget_lane_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vget_lane_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vget_lane_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vget_lane_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vget_lane_u64)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vgetq_lane_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vgetq_lane_f64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vgetq_lane_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vgetq_lane_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vgetq_lane_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vgetq_lane_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vgetq_lane_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vgetq_lane_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vgetq_lane_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vgetq_lane_u64)
