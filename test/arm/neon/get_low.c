#define EASYSIMD_TEST_ARM_NEON_INSN get_low

#include "test-neon.h"
#include "../../../easysimd/arm/neon/get_low.h"

static int
test_easysimd_vget_low_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    easysimd_float32 a[4];
    easysimd_float32 r[2];
  } test_vec[] = {
    { { EASYSIMD_FLOAT32_C(  -618.44), EASYSIMD_FLOAT32_C(  -264.56), EASYSIMD_FLOAT32_C(   635.79), EASYSIMD_FLOAT32_C(   558.25) },
      { EASYSIMD_FLOAT32_C(  -618.44), EASYSIMD_FLOAT32_C(  -264.56) } },
    { { EASYSIMD_FLOAT32_C(  -758.55), EASYSIMD_FLOAT32_C(   584.32), EASYSIMD_FLOAT32_C(   478.21), EASYSIMD_FLOAT32_C(  -463.12) },
      { EASYSIMD_FLOAT32_C(  -758.55), EASYSIMD_FLOAT32_C(   584.32) } },
    { { EASYSIMD_FLOAT32_C(  -948.98), EASYSIMD_FLOAT32_C(  -867.33), EASYSIMD_FLOAT32_C(   729.13), EASYSIMD_FLOAT32_C(   324.50) },
      { EASYSIMD_FLOAT32_C(  -948.98), EASYSIMD_FLOAT32_C(  -867.33) } },
    { { EASYSIMD_FLOAT32_C(  -385.61), EASYSIMD_FLOAT32_C(  -150.04), EASYSIMD_FLOAT32_C(  -341.48), EASYSIMD_FLOAT32_C(  -404.96) },
      { EASYSIMD_FLOAT32_C(  -385.61), EASYSIMD_FLOAT32_C(  -150.04) } },
    { { EASYSIMD_FLOAT32_C(   568.77), EASYSIMD_FLOAT32_C(   261.80), EASYSIMD_FLOAT32_C(   803.98), EASYSIMD_FLOAT32_C(  -772.87) },
      { EASYSIMD_FLOAT32_C(   568.77), EASYSIMD_FLOAT32_C(   261.80) } },
    { { EASYSIMD_FLOAT32_C(   656.21), EASYSIMD_FLOAT32_C(   633.91), EASYSIMD_FLOAT32_C(  -959.69), EASYSIMD_FLOAT32_C(   161.89) },
      { EASYSIMD_FLOAT32_C(   656.21), EASYSIMD_FLOAT32_C(   633.91) } },
    { { EASYSIMD_FLOAT32_C(   160.28), EASYSIMD_FLOAT32_C(  -927.68), EASYSIMD_FLOAT32_C(   797.28), EASYSIMD_FLOAT32_C(   950.20) },
      { EASYSIMD_FLOAT32_C(   160.28), EASYSIMD_FLOAT32_C(  -927.68) } },
    { { EASYSIMD_FLOAT32_C(    50.38), EASYSIMD_FLOAT32_C(   496.87), EASYSIMD_FLOAT32_C(   994.83), EASYSIMD_FLOAT32_C(   431.94) },
      { EASYSIMD_FLOAT32_C(    50.38), EASYSIMD_FLOAT32_C(   496.87) } },
  };
...
static int
test_easysimd_vget_low_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    easysimd_float64 a[2];
    easysimd_float64 r[1];
  } test_vec[] = {
    { { EASYSIMD_FLOAT64_C(   587.42), EASYSIMD_FLOAT64_C(  -708.35) },
      { EASYSIMD_FLOAT64_C(   587.42) } },
    { { EASYSIMD_FLOAT64_C(   444.89), EASYSIMD_FLOAT64_C(  -898.30) },
      { EASYSIMD_FLOAT64_C(   444.89) } },
    { { EASYSIMD_FLOAT64_C(   950.88), EASYSIMD_FLOAT64_C(   657.56) },
      { EASYSIMD_FLOAT64_C(   950.88) } },
    { { EASYSIMD_FLOAT64_C(   -17.67), EASYSIMD_FLOAT64_C(  -677.48) },
      { EASYSIMD_FLOAT64_C(   -17.67) } },
    { { EASYSIMD_FLOAT64_C(  -738.88), EASYSIMD_FLOAT64_C(   843.84) },
      { EASYSIMD_FLOAT64_C(  -738.88) } },
    { { EASYSIMD_FLOAT64_C(   933.98), EASYSIMD_FLOAT64_C(   432.45) },
      { EASYSIMD_FLOAT64_C(   933.98) } },
    { { EASYSIMD_FLOAT64_C(   713.24), EASYSIMD_FLOAT64_C(  -937.79) },
      { EASYSIMD_FLOAT64_C(   713.24) } },
    { { EASYSIMD_FLOAT64_C(  -634.19), EASYSIMD_FLOAT64_C(  -779.71) },
      { EASYSIMD_FLOAT64_C(  -634.19) } },
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float64x2_t a = easysimd_vld1q_f64(test_vec[i].a);
    easysimd_float64x1_t r = easysimd_vget_low_f64(a);
...
static int
test_easysimd_vget_low_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int8_t a[16];
    int8_t r[8];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int8x8_t r = easysimd_vget_low_s8(a);
...
static int
test_easysimd_vget_low_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int16_t a[8];
    int16_t r[4];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int16x4_t r = easysimd_vget_low_s16(a);
...
static int
test_easysimd_vget_low_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int32_t a[4];
    int32_t r[2];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x2_t r = easysimd_vget_low_s32(a);
...
static int
test_easysimd_vget_low_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int64_t a[2];
    int64_t r[1];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int64x1_t r = easysimd_vget_low_s64(a);
...
static int
test_easysimd_vget_low_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint8_t a[16];
    uint8_t r[8];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x8_t r = easysimd_vget_low_u8(a);
...
static int
test_easysimd_vget_low_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint16_t a[8];
    uint16_t r[4];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x4_t r = easysimd_vget_low_u16(a);
...
static int
test_easysimd_vget_low_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint32_t a[4];
    uint32_t r[2];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x2_t r = easysimd_vget_low_u32(a);
...
static int
test_easysimd_vget_low_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint64_t a[2];
    uint64_t r[1];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint64x1_t r = easysimd_vget_low_u64(a);
...
EASYSIMD_TEST_FUNC_LIST_ENTRY(vget_low_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vget_low_f64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vget_low_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vget_low_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vget_low_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vget_low_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vget_low_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vget_low_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vget_low_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vget_low_u64)
