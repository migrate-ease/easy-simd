#define EASYSIMD_TEST_ARM_NEON_INSN hsub

#include "test-neon.h"
#include "../../../easysimd/arm/neon/hsub.h"

static int
test_easysimd_vhsub_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int8_t a[8];
    int8_t b[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int8x8_t r = easysimd_vhsub_s8(a, b);
...
static int
test_easysimd_vhsub_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int16_t a[4];
    int16_t b[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int16x4_t r = easysimd_vhsub_s16(a, b);
...
static int
test_easysimd_vhsub_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t a[2];
    int32_t b[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x2_t r = easysimd_vhsub_s32(a, b);
...
static int
test_easysimd_vhsub_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint8_t a[8];
    uint8_t b[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x8_t r = easysimd_vhsub_u8(a, b);
...
static int
test_easysimd_vhsub_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint16_t a[4];
    uint16_t b[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x4_t r = easysimd_vhsub_u16(a, b);
...
static int
test_easysimd_vhsub_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint32_t a[2];
    uint32_t b[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x2_t r = easysimd_vhsub_u32(a, b);
...
static int
test_easysimd_vhsubq_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int8_t a[16];
    int8_t b[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int8x16_t r = easysimd_vhsubq_s8(a, b);
...
static int
test_easysimd_vhsubq_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int16_t a[8];
    int16_t b[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int16x8_t r = easysimd_vhsubq_s16(a, b);
...
static int
test_easysimd_vhsubq_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t a[4];
    int32_t b[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x4_t r = easysimd_vhsubq_s32(a, b);
...
static int
test_easysimd_vhsubq_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint8_t a[16];
    uint8_t b[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x16_t r = easysimd_vhsubq_u8(a, b);
...
static int
test_easysimd_vhsubq_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint16_t a[8];
    uint16_t b[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x8_t r = easysimd_vhsubq_u16(a, b);
...
static int
test_easysimd_vhsubq_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint32_t a[4];
    uint32_t b[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x4_t r = easysimd_vhsubq_u32(a, b);
...
EASYSIMD_TEST_FUNC_LIST_ENTRY(vhsub_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vhsub_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vhsub_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vhsub_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vhsub_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vhsub_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vhsubq_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vhsubq_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vhsubq_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vhsubq_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vhsubq_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vhsubq_u32)
