#define EASYSIMD_TEST_ARM_NEON_INSN max

#include "test-neon.h"
#include "../../../easysimd/arm/neon/max.h"

static int
test_easysimd_vmax_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    ...
    { {            EASYSIMD_MATH_NANF, EASYSIMD_FLOAT32_C(  -464.60) },
      { EASYSIMD_FLOAT32_C(   866.05),            EASYSIMD_MATH_NANF },
      {            EASYSIMD_MATH_NANF,            EASYSIMD_MATH_NANF } },
    { {            EASYSIMD_MATH_NANF, EASYSIMD_FLOAT32_C(   861.67) },
      {            EASYSIMD_MATH_NANF, EASYSIMD_FLOAT32_C(   861.67) },
      {            EASYSIMD_MATH_NANF, EASYSIMD_FLOAT32_C(   861.67) } },
    #endif
    { { EASYSIMD_FLOAT32_C(   378.04), EASYSIMD_FLOAT32_C(  -897.72) },
      { EASYSIMD_FLOAT32_C(  -584.86), EASYSIMD_FLOAT32_C(   922.34) },
      { EASYSIMD_FLOAT32_C(   378.04), EASYSIMD_FLOAT32_C(   922.34) } },
    { { EASYSIMD_FLOAT32_C(   169.18), EASYSIMD_FLOAT32_C(   164.66) },
      { EASYSIMD_FLOAT32_C(   295.66), EASYSIMD_FLOAT32_C(  -857.49) },
      { EASYSIMD_FLOAT32_C(   295.66), EASYSIMD_FLOAT32_C(   164.66) } },
    { { EASYSIMD_FLOAT32_C(  -597.22), EASYSIMD_FLOAT32_C(  -740.42) },
      { EASYSIMD_FLOAT32_C(  -439.12), EASYSIMD_FLOAT32_C(  -673.24) },
      { EASYSIMD_FLOAT32_C(  -439.12), EASYSIMD_FLOAT32_C(  -673.24) } },
    { { EASYSIMD_FLOAT32_C(   693.53), EASYSIMD_FLOAT32_C(  -114.27) },
      { EASYSIMD_FLOAT32_C(   599.27), EASYSIMD_FLOAT32_C(   359.67) },
      { EASYSIMD_FLOAT32_C(   693.53), EASYSIMD_FLOAT32_C(   359.67) } },
    { { EASYSIMD_FLOAT32_C(  -598.01), EASYSIMD_FLOAT32_C(   -64.73) },
      { EASYSIMD_FLOAT32_C(   384.43), EASYSIMD_FLOAT32_C(   446.35) },
      { EASYSIMD_FLOAT32_C(   384.43), EASYSIMD_FLOAT32_C(   446.35) } },
    { { EASYSIMD_FLOAT32_C(   449.76), EASYSIMD_FLOAT32_C(   326.28) },
      { EASYSIMD_FLOAT32_C(   146.92), EASYSIMD_FLOAT32_C(  -725.29) },
      { EASYSIMD_FLOAT32_C(   449.76), EASYSIMD_FLOAT32_C(   326.28) } }
  };
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_float32x2_t r = easysimd_vmax_f32(a, b);
  ...
  easysimd_test_arm_neon_random_f32x2_full(8, 2, values, -1000.0f, 1000.0f, EASYSIMD_TEST_VEC_FLOAT_NAN | EASYSIMD_TEST_VEC_FLOAT_EQUAL);
...
static int
test_easysimd_vmax_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    ...
    #if !defined(EASYSIMD_FAST_NANS)
    { {             EASYSIMD_MATH_NAN },
      { EASYSIMD_FLOAT64_C(   170.12) },
      {             EASYSIMD_MATH_NAN } },
    { { EASYSIMD_FLOAT64_C(   -24.73) },
      {             EASYSIMD_MATH_NAN },
      {             EASYSIMD_MATH_NAN } },
    { {             EASYSIMD_MATH_NAN },
      {             EASYSIMD_MATH_NAN },
    ...
    { { EASYSIMD_FLOAT64_C(  -928.88) },
      { EASYSIMD_FLOAT64_C(  -928.88) },
      { EASYSIMD_FLOAT64_C(  -928.88) } },
    { { EASYSIMD_FLOAT64_C(   148.48) },
      { EASYSIMD_FLOAT64_C(  -665.54) },
      { EASYSIMD_FLOAT64_C(   148.48) } },
    { { EASYSIMD_FLOAT64_C(   367.73) },
      { EASYSIMD_FLOAT64_C(  -686.85) },
      { EASYSIMD_FLOAT64_C(   367.73) } },
    { { EASYSIMD_FLOAT64_C(   630.12) },
      { EASYSIMD_FLOAT64_C(   510.24) },
      { EASYSIMD_FLOAT64_C(   630.12) } },
    { { EASYSIMD_FLOAT64_C(  -284.08) },
      { EASYSIMD_FLOAT64_C(   889.70) },
      { EASYSIMD_FLOAT64_C(   889.70) } }
  };
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_float64x1_t r = easysimd_vmax_f64(a, b);
  ...
  easysimd_test_arm_neon_random_f64x1_full(8, 2, values, -1000.0, 1000.0, EASYSIMD_TEST_VEC_FLOAT_NAN | EASYSIMD_TEST_VEC_FLOAT_EQUAL);
...
static int
test_easysimd_vmax_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int8_t a[8];
    int8_t b[8];
    int8_t r[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int8x8_t r = easysimd_vmax_s8(a, b);
...
static int
test_easysimd_vmax_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int16_t a[4];
    int16_t b[4];
    int16_t r[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int16x4_t r = easysimd_vmax_s16(a, b);
...
static int
test_easysimd_vmax_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int32_t a[2];
    int32_t b[2];
    int32_t r[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x2_t r = easysimd_vmax_s32(a, b);
...
static int
test_easysimd_x_vmax_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int64_t a[1];
    int64_t b[1];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int64x1_t r = easysimd_x_vmax_s64(a, b);
...
static int
test_easysimd_vmax_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint8_t a[8];
    uint8_t b[8];
    uint8_t r[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x8_t r = easysimd_vmax_u8(a, b);
...
static int
test_easysimd_vmax_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint16_t a[4];
    uint16_t b[4];
    uint16_t r[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x4_t r = easysimd_vmax_u16(a, b);
...
static int
test_easysimd_vmax_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint32_t a[2];
    uint32_t b[2];
    uint32_t r[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x2_t r = easysimd_vmax_u32(a, b);
...
static int
test_easysimd_x_vmax_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint64_t a[1];
    uint64_t b[1];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint64x1_t r = easysimd_x_vmax_u64(a, b);
...
static int
test_easysimd_vmaxq_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    ...
    #if !defined(EASYSIMD_FAST_NANS)
    { {            EASYSIMD_MATH_NANF, EASYSIMD_FLOAT32_C(  -785.97),            EASYSIMD_MATH_NANF, EASYSIMD_FLOAT32_C(  -762.23) },
      { EASYSIMD_FLOAT32_C(    56.78),            EASYSIMD_MATH_NANF,            EASYSIMD_MATH_NANF, EASYSIMD_FLOAT32_C(  -762.23) },
      {            EASYSIMD_MATH_NANF,            EASYSIMD_MATH_NANF,            EASYSIMD_MATH_NANF, EASYSIMD_FLOAT32_C(  -762.23) } },
    #endif
    { { EASYSIMD_FLOAT32_C(  -535.38), EASYSIMD_FLOAT32_C(   845.15), EASYSIMD_FLOAT32_C(   396.86), EASYSIMD_FLOAT32_C(   355.47) },
      { EASYSIMD_FLOAT32_C(   -18.38), EASYSIMD_FLOAT32_C(   855.51), EASYSIMD_FLOAT32_C(   739.43), EASYSIMD_FLOAT32_C(  -523.81) },
      { EASYSIMD_FLOAT32_C(   -18.38), EASYSIMD_FLOAT32_C(   855.51), EASYSIMD_FLOAT32_C(   739.43), EASYSIMD_FLOAT32_C(   355.47) } },
    { { EASYSIMD_FLOAT32_C(  -446.27), EASYSIMD_FLOAT32_C(  -422.02), EASYSIMD_FLOAT32_C(   105.64), EASYSIMD_FLOAT32_C(  -885.46) },
      { EASYSIMD_FLOAT32_C(  -799.73), EASYSIMD_FLOAT32_C(  -894.49), EASYSIMD_FLOAT32_C(   406.48), EASYSIMD_FLOAT32_C(   471.13) },
      { EASYSIMD_FLOAT32_C(  -446.27), EASYSIMD_FLOAT32_C(  -422.02), EASYSIMD_FLOAT32_C(   406.48), EASYSIMD_FLOAT32_C(   471.13) } },
    { { EASYSIMD_FLOAT32_C(  -440.41), EASYSIMD_FLOAT32_C(  -725.47), EASYSIMD_FLOAT32_C(  -111.15), EASYSIMD_FLOAT32_C(   220.63) },
      { EASYSIMD_FLOAT32_C(   187.92), EASYSIMD_FLOAT32_C(    -3.17), EASYSIMD_FLOAT32_C(  -134.93), EASYSIMD_FLOAT32_C(   247.43) },
      { EASYSIMD_FLOAT32_C(   187.92), EASYSIMD_FLOAT32_C(    -3.17), EASYSIMD_FLOAT32_C(  -111.15), EASYSIMD_FLOAT32_C(   247.43) } },
    { { EASYSIMD_FLOAT32_C(   210.87), EASYSIMD_FLOAT32_C(  -846.16), EASYSIMD_FLOAT32_C(   468.46), EASYSIMD_FLOAT32_C(  -732.35) },
      { EASYSIMD_FLOAT32_C(  -405.02), EASYSIMD_FLOAT32_C(   -75.46), EASYSIMD_FLOAT32_C(   125.81), EASYSIMD_FLOAT32_C(    59.60) },
      { EASYSIMD_FLOAT32_C(   210.87), EASYSIMD_FLOAT32_C(   -75.46), EASYSIMD_FLOAT32_C(   468.46), EASYSIMD_FLOAT32_C(    59.60) } },
    { { EASYSIMD_FLOAT32_C(  -230.31), EASYSIMD_FLOAT32_C(  -477.34), EASYSIMD_FLOAT32_C(  -584.93), EASYSIMD_FLOAT32_C(   751.31) },
      { EASYSIMD_FLOAT32_C(  -621.83), EASYSIMD_FLOAT32_C(  -845.50), EASYSIMD_FLOAT32_C(  -772.50), EASYSIMD_FLOAT32_C(   -68.10) },
      { EASYSIMD_FLOAT32_C(  -230.31), EASYSIMD_FLOAT32_C(  -477.34), EASYSIMD_FLOAT32_C(  -584.93), EASYSIMD_FLOAT32_C(   751.31) } },
    { { EASYSIMD_FLOAT32_C(  -267.52), EASYSIMD_FLOAT32_C(   333.13), EASYSIMD_FLOAT32_C(    46.43), EASYSIMD_FLOAT32_C(   -67.25) },
      { EASYSIMD_FLOAT32_C(   438.64), EASYSIMD_FLOAT32_C(  -547.09), EASYSIMD_FLOAT32_C(  -596.12), EASYSIMD_FLOAT32_C(   998.23) },
      { EASYSIMD_FLOAT32_C(   438.64), EASYSIMD_FLOAT32_C(   333.13), EASYSIMD_FLOAT32_C(    46.43), EASYSIMD_FLOAT32_C(   998.23) } },
    { { EASYSIMD_FLOAT32_C(  -272.56), EASYSIMD_FLOAT32_C(   292.73), EASYSIMD_FLOAT32_C(   218.86), EASYSIMD_FLOAT32_C(   915.36) },
      { EASYSIMD_FLOAT32_C(  -710.44), EASYSIMD_FLOAT32_C(  -916.07), EASYSIMD_FLOAT32_C(   162.80), EASYSIMD_FLOAT32_C(   500.43) },
      { EASYSIMD_FLOAT32_C(  -272.56), EASYSIMD_FLOAT32_C(   292.73), EASYSIMD_FLOAT32_C(   218.86), EASYSIMD_FLOAT32_C(   915.36) } }
  };
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_float32x4_t r = easysimd_vmaxq_f32(a, b);
  ...
  easysimd_test_arm_neon_random_f32x4_full(8, 2, values, -1000.0f, 1000.0f, EASYSIMD_TEST_VEC_FLOAT_NAN | EASYSIMD_TEST_VEC_FLOAT_EQUAL);
...
static int
test_easysimd_vmaxq_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    ...
    #if !defined(EASYSIMD_FAST_NANS)
    { {             EASYSIMD_MATH_NAN, EASYSIMD_FLOAT64_C(   768.08) },
      { EASYSIMD_FLOAT64_C(  -167.25),             EASYSIMD_MATH_NAN },
      {             EASYSIMD_MATH_NAN,             EASYSIMD_MATH_NAN } },
    { {             EASYSIMD_MATH_NAN, EASYSIMD_FLOAT64_C(   381.84) },
      {             EASYSIMD_MATH_NAN, EASYSIMD_FLOAT64_C(   381.84) },
      {             EASYSIMD_MATH_NAN, EASYSIMD_FLOAT64_C(   381.84) } },
    #endif
    { { EASYSIMD_FLOAT64_C(  -692.58), EASYSIMD_FLOAT64_C(  -923.20) },
      { EASYSIMD_FLOAT64_C(   794.72), EASYSIMD_FLOAT64_C(  -538.08) },
      { EASYSIMD_FLOAT64_C(   794.72), EASYSIMD_FLOAT64_C(  -538.08) } },
    { { EASYSIMD_FLOAT64_C(  -695.71), EASYSIMD_FLOAT64_C(  -273.38) },
      { EASYSIMD_FLOAT64_C(   194.40), EASYSIMD_FLOAT64_C(   637.43) },
      { EASYSIMD_FLOAT64_C(   194.40), EASYSIMD_FLOAT64_C(   637.43) } },
    { { EASYSIMD_FLOAT64_C(   773.05), EASYSIMD_FLOAT64_C(  -872.85) },
      { EASYSIMD_FLOAT64_C(    76.07), EASYSIMD_FLOAT64_C(  -774.04) },
      { EASYSIMD_FLOAT64_C(   773.05), EASYSIMD_FLOAT64_C(  -774.04) } },
    { { EASYSIMD_FLOAT64_C(  -468.97), EASYSIMD_FLOAT64_C(    74.30) },
      { EASYSIMD_FLOAT64_C(   -46.60), EASYSIMD_FLOAT64_C(   823.76) },
      { EASYSIMD_FLOAT64_C(   -46.60), EASYSIMD_FLOAT64_C(   823.76) } },
    { { EASYSIMD_FLOAT64_C(  -706.84), EASYSIMD_FLOAT64_C(  -131.24) },
      { EASYSIMD_FLOAT64_C(  -886.68), EASYSIMD_FLOAT64_C(  -622.90) },
      { EASYSIMD_FLOAT64_C(  -706.84), EASYSIMD_FLOAT64_C(  -131.24) } },
    { { EASYSIMD_FLOAT64_C(  -968.44), EASYSIMD_FLOAT64_C(   613.76) },
      { EASYSIMD_FLOAT64_C(  -385.13), EASYSIMD_FLOAT64_C(  -337.18) },
      { EASYSIMD_FLOAT64_C(  -385.13), EASYSIMD_FLOAT64_C(   613.76) } }
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float64x2_t a = easysimd_vld1q_f64(test_vec[i].a);
    easysimd_float64x2_t b = easysimd_vld1q_f64(test_vec[i].b);
    easysimd_float64x2_t r = easysimd_vmaxq_f64(a, b);
  ...
  easysimd_test_arm_neon_random_f64x2_full(8, 2, values, -1000.0, 1000.0, EASYSIMD_TEST_VEC_FLOAT_NAN | EASYSIMD_TEST_VEC_FLOAT_EQUAL);
...
static int
test_easysimd_vmaxq_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int8_t a[16];
    int8_t b[16];
    int8_t r[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int8x16_t r = easysimd_vmaxq_s8(a, b);
...
static int
test_easysimd_vmaxq_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int16_t a[8];
    int16_t b[8];
    int16_t r[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int16x8_t r = easysimd_vmaxq_s16(a, b);
...
static int
test_easysimd_vmaxq_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int32_t a[4];
    int32_t b[4];
    int32_t r[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x4_t r = easysimd_vmaxq_s32(a, b);
...
static int
test_easysimd_x_vmaxq_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int64_t a[2];
    int64_t b[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int64x2_t r = easysimd_x_vmaxq_s64(a, b);
...
static int
test_easysimd_vmaxq_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint8_t a[16];
    uint8_t b[16];
    uint8_t r[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x16_t r = easysimd_vmaxq_u8(a, b);
...
static int
test_easysimd_vmaxq_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint16_t a[8];
    uint16_t b[8];
    uint16_t r[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x8_t r = easysimd_vmaxq_u16(a, b);
...
static int
test_easysimd_vmaxq_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint32_t a[4];
    uint32_t b[4];
    uint32_t r[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x4_t r = easysimd_vmaxq_u32(a, b);
...
static int
test_easysimd_x_vmaxq_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint64_t a[2];
    uint64_t b[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint64x2_t r = easysimd_x_vmaxq_u64(a, b);
...
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmax_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmax_f64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmax_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmax_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmax_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(x_vmax_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmax_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmax_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmax_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(x_vmax_u64)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vmaxq_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmaxq_f64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmaxq_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmaxq_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmaxq_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(x_vmaxq_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmaxq_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmaxq_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmaxq_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(x_vmaxq_u64)
