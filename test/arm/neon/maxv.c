#define EASYSIMD_TEST_ARM_NEON_INSN maxv

#include "test-neon.h"
#include "../../../easysimd/arm/neon/maxv.h"

static int
test_easysimd_vmaxv_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    easysimd_float32_t a[2];
    easysimd_float32_t r;
  } test_vec[] = {
    { { EASYSIMD_FLOAT32_C(   498.24), EASYSIMD_FLOAT32_C(   700.18) },
      EASYSIMD_FLOAT32_C(   700.18) },
    { { EASYSIMD_FLOAT32_C(  -550.14), EASYSIMD_FLOAT32_C(  -372.82) },
      EASYSIMD_FLOAT32_C(  -372.82) },
    { { EASYSIMD_FLOAT32_C(  -184.85), EASYSIMD_FLOAT32_C(   347.23) },
      EASYSIMD_FLOAT32_C(   347.23) },
    { { EASYSIMD_FLOAT32_C(  -183.13), EASYSIMD_FLOAT32_C(   910.25) },
      EASYSIMD_FLOAT32_C(   910.25) },
    { { EASYSIMD_FLOAT32_C(   995.08), EASYSIMD_FLOAT32_C(   458.35) },
      EASYSIMD_FLOAT32_C(   995.08) },
    { { EASYSIMD_FLOAT32_C(   954.33), EASYSIMD_FLOAT32_C(   629.96) },
      EASYSIMD_FLOAT32_C(   954.33) },
    { { EASYSIMD_FLOAT32_C(   -93.64), EASYSIMD_FLOAT32_C(   684.43) },
      EASYSIMD_FLOAT32_C(   684.43) },
    { { EASYSIMD_FLOAT32_C(   -76.95), EASYSIMD_FLOAT32_C(  -360.35) },
      EASYSIMD_FLOAT32_C(   -76.95) }
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float32x2_t a = easysimd_vld1_f32(test_vec[i].a);
    easysimd_float32_t r = easysimd_vmaxv_f32(a);
...
static int
test_easysimd_vmaxv_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int8_t a[8];
    int8_t r;
...
static int
test_easysimd_vmaxv_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int16_t a[4];
    int16_t r;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    int16_t r = easysimd_vmaxv_s16(a);
...
static int
test_easysimd_vmaxv_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t a[2];
    int32_t r;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    int32_t r = easysimd_vmaxv_s32(a);
...
static int
test_easysimd_vmaxv_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint8_t a[8];
    uint8_t r;
...
static int
test_easysimd_vmaxv_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint16_t a[4];
    uint16_t r;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    uint16_t r = easysimd_vmaxv_u16(a);
...
static int
test_easysimd_vmaxv_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint32_t a[2];
    uint32_t r;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    uint32_t r = easysimd_vmaxv_u32(a);
...
static int
test_easysimd_vmaxvq_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    easysimd_float32_t a[4];
    easysimd_float32_t r;
  } test_vec[] = {
    { { EASYSIMD_FLOAT32_C(  -913.17), EASYSIMD_FLOAT32_C(  -110.66), EASYSIMD_FLOAT32_C(   975.06), EASYSIMD_FLOAT32_C(   216.37) },
      EASYSIMD_FLOAT32_C(   975.06) },
    { { EASYSIMD_FLOAT32_C(   803.46), EASYSIMD_FLOAT32_C(   420.85), EASYSIMD_FLOAT32_C(  -602.65), EASYSIMD_FLOAT32_C(  -768.35) },
      EASYSIMD_FLOAT32_C(   803.46) },
    { { EASYSIMD_FLOAT32_C(   208.72), EASYSIMD_FLOAT32_C(   938.55), EASYSIMD_FLOAT32_C(  -166.98), EASYSIMD_FLOAT32_C(  -194.96) },
      EASYSIMD_FLOAT32_C(   938.55) },
    { { EASYSIMD_FLOAT32_C(   658.71), EASYSIMD_FLOAT32_C(  -102.67), EASYSIMD_FLOAT32_C(  -344.04), EASYSIMD_FLOAT32_C(   -91.55) },
      EASYSIMD_FLOAT32_C(   658.71) },
    { { EASYSIMD_FLOAT32_C(  -612.74), EASYSIMD_FLOAT32_C(  -313.43), EASYSIMD_FLOAT32_C(   -63.59), EASYSIMD_FLOAT32_C(   951.39) },
      EASYSIMD_FLOAT32_C(   951.39) },
    { { EASYSIMD_FLOAT32_C(   -79.23), EASYSIMD_FLOAT32_C(   283.94), EASYSIMD_FLOAT32_C(   381.77), EASYSIMD_FLOAT32_C(   496.29) },
      EASYSIMD_FLOAT32_C(   496.29) },
    { { EASYSIMD_FLOAT32_C(   588.86), EASYSIMD_FLOAT32_C(  -488.36), EASYSIMD_FLOAT32_C(   652.93), EASYSIMD_FLOAT32_C(  -868.04) },
      EASYSIMD_FLOAT32_C(   652.93) },
    { { EASYSIMD_FLOAT32_C(  -913.85), EASYSIMD_FLOAT32_C(  -606.06), EASYSIMD_FLOAT32_C(  -892.31), EASYSIMD_FLOAT32_C(  -827.02) },
      EASYSIMD_FLOAT32_C(  -606.06) }
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float32x4_t a = easysimd_vld1q_f32(test_vec[i].a);
    easysimd_float32_t r = easysimd_vmaxvq_f32(a);
...
static int
test_easysimd_vmaxvq_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    easysimd_float64_t a[4];
    easysimd_float64_t r;
  } test_vec[] = {
    { { EASYSIMD_FLOAT64_C(   283.28), EASYSIMD_FLOAT64_C(  -917.25) },
      EASYSIMD_FLOAT64_C(   283.28) },
    { { EASYSIMD_FLOAT64_C(   389.34), EASYSIMD_FLOAT64_C(    86.75) },
      EASYSIMD_FLOAT64_C(   389.34) },
    { { EASYSIMD_FLOAT64_C(   503.60), EASYSIMD_FLOAT64_C(   786.70) },
      EASYSIMD_FLOAT64_C(   786.70) },
    { { EASYSIMD_FLOAT64_C(   318.40), EASYSIMD_FLOAT64_C(  -287.68) },
      EASYSIMD_FLOAT64_C(   318.40) },
    { { EASYSIMD_FLOAT64_C(   725.25), EASYSIMD_FLOAT64_C(  -848.58) },
      EASYSIMD_FLOAT64_C(   725.25) },
    { { EASYSIMD_FLOAT64_C(   517.36), EASYSIMD_FLOAT64_C(   383.96) },
      EASYSIMD_FLOAT64_C(   517.36) },
    { { EASYSIMD_FLOAT64_C(    48.75), EASYSIMD_FLOAT64_C(  -826.68) },
      EASYSIMD_FLOAT64_C(    48.75) },
    { { EASYSIMD_FLOAT64_C(  -707.59), EASYSIMD_FLOAT64_C(   436.01) },
      EASYSIMD_FLOAT64_C(   436.01) }
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float64x2_t a = easysimd_vld1q_f64(test_vec[i].a);
    easysimd_float64_t r = easysimd_vmaxvq_f64(a);
...
static int
test_easysimd_vmaxvq_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int8_t a[16];
    int8_t r;
...
static int
test_easysimd_vmaxvq_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int16_t a[8];
    int16_t r;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    int16_t r = easysimd_vmaxvq_s16(a);
...
static int
test_easysimd_vmaxvq_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t a[4];
    int32_t r;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    int32_t r = easysimd_vmaxvq_s32(a);
...
static int
test_easysimd_vmaxvq_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint8_t a[16];
    uint8_t r;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    uint8_t r = easysimd_vmaxvq_u8(a);
...
static int
test_easysimd_vmaxvq_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint16_t a[8];
    uint16_t r;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    uint16_t r = easysimd_vmaxvq_u16(a);
...
static int
test_easysimd_vmaxvq_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint32_t a[4];
    uint32_t r;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    uint32_t r = easysimd_vmaxvq_u32(a);
...
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmaxv_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmaxv_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmaxv_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmaxv_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmaxv_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmaxv_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmaxv_u32)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vmaxvq_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmaxvq_f64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmaxvq_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmaxvq_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmaxvq_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmaxvq_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmaxvq_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmaxvq_u32)
