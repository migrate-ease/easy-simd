#define EASYSIMD_TEST_ARM_NEON_INSN min

#include "test-neon.h"
#include "../../../easysimd/arm/neon/min.h"

static int
test_easysimd_vmin_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    ...
    { {            EASYSIMD_MATH_NANF, EASYSIMD_FLOAT32_C(  -974.49) },
      { EASYSIMD_FLOAT32_C(  -353.04),            EASYSIMD_MATH_NANF },
      {            EASYSIMD_MATH_NANF,            EASYSIMD_MATH_NANF } },
    { {            EASYSIMD_MATH_NANF, EASYSIMD_FLOAT32_C(    -0.00) },
      {            EASYSIMD_MATH_NANF, EASYSIMD_FLOAT32_C(     0.00) },
      {            EASYSIMD_MATH_NANF, EASYSIMD_FLOAT32_C(    -0.00) } },
    #endif
    { { EASYSIMD_FLOAT32_C(   870.11), EASYSIMD_FLOAT32_C(  -974.49) },
      { EASYSIMD_FLOAT32_C(  -353.04), EASYSIMD_FLOAT32_C(   662.92) },
      { EASYSIMD_FLOAT32_C(  -353.04), EASYSIMD_FLOAT32_C(  -974.49) } },
    { { EASYSIMD_FLOAT32_C(   946.40), EASYSIMD_FLOAT32_C(  -326.23) },
      { EASYSIMD_FLOAT32_C(   849.15), EASYSIMD_FLOAT32_C(   339.51) },
      { EASYSIMD_FLOAT32_C(   849.15), EASYSIMD_FLOAT32_C(  -326.23) } },
    { { EASYSIMD_FLOAT32_C(   856.22), EASYSIMD_FLOAT32_C(  -534.53) },
      { EASYSIMD_FLOAT32_C(  -798.27), EASYSIMD_FLOAT32_C(  -412.33) },
      { EASYSIMD_FLOAT32_C(  -798.27), EASYSIMD_FLOAT32_C(  -534.53) } },
    { { EASYSIMD_FLOAT32_C(  -329.92), EASYSIMD_FLOAT32_C(  -939.01) },
      { EASYSIMD_FLOAT32_C(  -706.34), EASYSIMD_FLOAT32_C(  -531.75) },
      { EASYSIMD_FLOAT32_C(  -706.34), EASYSIMD_FLOAT32_C(  -939.01) } },
    { { EASYSIMD_FLOAT32_C(   284.60), EASYSIMD_FLOAT32_C(  -551.94) },
      { EASYSIMD_FLOAT32_C(   834.19), EASYSIMD_FLOAT32_C(    83.26) },
      { EASYSIMD_FLOAT32_C(   284.60), EASYSIMD_FLOAT32_C(  -551.94) } },
    { { EASYSIMD_FLOAT32_C(  -426.40), EASYSIMD_FLOAT32_C(  -458.52) },
      { EASYSIMD_FLOAT32_C(  -893.69), EASYSIMD_FLOAT32_C(    62.76) },
      { EASYSIMD_FLOAT32_C(  -893.69), EASYSIMD_FLOAT32_C(  -458.52) } },
    { { EASYSIMD_FLOAT32_C(  -401.07), EASYSIMD_FLOAT32_C(   123.39) },
      { EASYSIMD_FLOAT32_C(    83.17), EASYSIMD_FLOAT32_C(   -66.65) },
      { EASYSIMD_FLOAT32_C(  -401.07), EASYSIMD_FLOAT32_C(   -66.65) } },
    { { EASYSIMD_FLOAT32_C(  -936.03), EASYSIMD_FLOAT32_C(   382.28) },
      { EASYSIMD_FLOAT32_C(   186.03), EASYSIMD_FLOAT32_C(   934.09) },
      { EASYSIMD_FLOAT32_C(  -936.03), EASYSIMD_FLOAT32_C(   382.28) } }
  };
...
static int
test_easysimd_vmin_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    ...
    #if !defined(EASYSIMD_FAST_NANS)
    { {             EASYSIMD_MATH_NAN },
      { EASYSIMD_FLOAT64_C(  -211.23) },
      {             EASYSIMD_MATH_NAN } },
    { { EASYSIMD_FLOAT64_C(   680.38) },
      {             EASYSIMD_MATH_NAN },
      {             EASYSIMD_MATH_NAN } },
    { {             EASYSIMD_MATH_NAN },
      {             EASYSIMD_MATH_NAN },
    ...
    { { EASYSIMD_FLOAT64_C(   680.38) },
      { EASYSIMD_FLOAT64_C(  -211.23) },
      { EASYSIMD_FLOAT64_C(  -211.23) } },
    { { EASYSIMD_FLOAT64_C(   566.20) },
      { EASYSIMD_FLOAT64_C(   596.88) },
      { EASYSIMD_FLOAT64_C(   566.20) } },
    { { EASYSIMD_FLOAT64_C(   823.29) },
      { EASYSIMD_FLOAT64_C(  -604.90) },
      { EASYSIMD_FLOAT64_C(  -604.90) } },
    { { EASYSIMD_FLOAT64_C(  -329.55) },
      { EASYSIMD_FLOAT64_C(   536.46) },
      { EASYSIMD_FLOAT64_C(  -329.55) } },
    { { EASYSIMD_FLOAT64_C(  -444.45) },
      { EASYSIMD_FLOAT64_C(   107.94) },
      { EASYSIMD_FLOAT64_C(  -444.45) } },
    { { EASYSIMD_FLOAT64_C(   -45.21) },
      { EASYSIMD_FLOAT64_C(   257.74) },
      { EASYSIMD_FLOAT64_C(   -45.21) } },
    { { EASYSIMD_FLOAT64_C(  -270.43) },
      { EASYSIMD_FLOAT64_C(    26.80) },
      { EASYSIMD_FLOAT64_C(  -270.43) } },
    { { EASYSIMD_FLOAT64_C(   904.46) },
      { EASYSIMD_FLOAT64_C(   832.39) },
      { EASYSIMD_FLOAT64_C(   832.39) } }
  };
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_float64x1_t r = easysimd_vmin_f64(a, b);
...
static int
test_easysimd_vmin_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int8_t a[8];
    int8_t b[8];
    int8_t r[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int8x8_t r = easysimd_vmin_s8(a, b);
...
static int
test_easysimd_vmin_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int16_t a[4];
    int16_t b[4];
    int16_t r[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int16x4_t r = easysimd_vmin_s16(a, b);
...
static int
test_easysimd_vmin_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int32_t a[2];
    int32_t b[2];
    int32_t r[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x2_t r = easysimd_vmin_s32(a, b);
...
static int
test_easysimd_x_vmin_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int64_t a[1];
    int64_t b[1];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int64x1_t r = easysimd_x_vmin_s64(a, b);
...
static int
test_easysimd_vmin_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint8_t a[16];
    uint8_t b[16];
    uint8_t r[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x8_t r = easysimd_vmin_u8(a, b);
...
static int
test_easysimd_vmin_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint16_t a[4];
    uint16_t b[4];
    uint16_t r[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x4_t r = easysimd_vmin_u16(a, b);
...
static int
test_easysimd_vmin_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint32_t a[2];
    uint32_t b[2];
    uint32_t r[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x2_t r = easysimd_vmin_u32(a, b);
...
static int
test_easysimd_x_vmin_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint64_t a[1];
    uint64_t b[1];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint64x1_t r = easysimd_x_vmin_u64(a, b);
...
static int
test_easysimd_vminq_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    ...
    #if !defined(EASYSIMD_FAST_NANS)
    { { EASYSIMD_FLOAT32_C(   680.38),            EASYSIMD_MATH_NANF,            EASYSIMD_MATH_NANF, EASYSIMD_FLOAT32_C(     0.00) },
      {            EASYSIMD_MATH_NANF, EASYSIMD_FLOAT32_C(  -604.90),            EASYSIMD_MATH_NANF, EASYSIMD_FLOAT32_C(    -0.00) },
    ...
    { { EASYSIMD_FLOAT32_C(   680.38), EASYSIMD_FLOAT32_C(  -211.23), EASYSIMD_FLOAT32_C(   566.20), EASYSIMD_FLOAT32_C(   596.88) },
      ...
      { EASYSIMD_FLOAT32_C(   680.38), EASYSIMD_FLOAT32_C(  -604.90), EASYSIMD_FLOAT32_C(  -329.55), EASYSIMD_FLOAT32_C(   536.46) } },
    { { EASYSIMD_FLOAT32_C(  -444.45), EASYSIMD_FLOAT32_C(   107.94), EASYSIMD_FLOAT32_C(   -45.21), EASYSIMD_FLOAT32_C(   257.74) },
      ...
      { EASYSIMD_FLOAT32_C(  -444.45), EASYSIMD_FLOAT32_C(    26.80), EASYSIMD_FLOAT32_C(   -45.21), EASYSIMD_FLOAT32_C(   257.74) } },
    { { EASYSIMD_FLOAT32_C(   271.42), EASYSIMD_FLOAT32_C(   434.59), EASYSIMD_FLOAT32_C(  -716.79), EASYSIMD_FLOAT32_C(   213.94) },
      ...
      { EASYSIMD_FLOAT32_C(  -967.40), EASYSIMD_FLOAT32_C(  -514.23), EASYSIMD_FLOAT32_C(  -725.54), EASYSIMD_FLOAT32_C(   213.94) } },
    { { EASYSIMD_FLOAT32_C(  -686.64), EASYSIMD_FLOAT32_C(  -198.11), EASYSIMD_FLOAT32_C(  -740.42), EASYSIMD_FLOAT32_C(  -782.38) },
      ...
      { EASYSIMD_FLOAT32_C(  -686.64), EASYSIMD_FLOAT32_C(  -563.49), EASYSIMD_FLOAT32_C(  -740.42), EASYSIMD_FLOAT32_C(  -782.38) } },
    { { EASYSIMD_FLOAT32_C(   225.28), EASYSIMD_FLOAT32_C(  -407.94), EASYSIMD_FLOAT32_C(   275.10), EASYSIMD_FLOAT32_C(    48.57) },
      ...
      { EASYSIMD_FLOAT32_C(   -12.83), EASYSIMD_FLOAT32_C(  -407.94), EASYSIMD_FLOAT32_C(  -414.97), EASYSIMD_FLOAT32_C(    48.57) } },
    { { EASYSIMD_FLOAT32_C(    53.49), EASYSIMD_FLOAT32_C(   539.83), EASYSIMD_FLOAT32_C(  -199.54), EASYSIMD_FLOAT32_C(   783.06) },
      ...
      { EASYSIMD_FLOAT32_C(  -433.37), EASYSIMD_FLOAT32_C(  -295.08), EASYSIMD_FLOAT32_C(  -199.54), EASYSIMD_FLOAT32_C(   783.06) } },
    { { EASYSIMD_FLOAT32_C(  -860.49), EASYSIMD_FLOAT32_C(   898.65), EASYSIMD_FLOAT32_C(    51.99), EASYSIMD_FLOAT32_C(  -827.89) },
      ...
      { EASYSIMD_FLOAT32_C(  -860.49), EASYSIMD_FLOAT32_C(   326.45), EASYSIMD_FLOAT32_C(    51.99), EASYSIMD_FLOAT32_C(  -827.89) } },
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_float32x4_t r = easysimd_vminq_f32(a, b);
...
static int
test_easysimd_vminq_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
...
static int
test_easysimd_vminq_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int8_t a[16];
    int8_t b[16];
    int8_t r[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int8x16_t r = easysimd_vminq_s8(a, b);
...
static int
test_easysimd_vminq_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int16_t a[8];
    int16_t b[8];
    int16_t r[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int16x8_t r = easysimd_vminq_s16(a, b);
...
static int
test_easysimd_vminq_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int32_t a[4];
    int32_t b[4];
    int32_t r[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x4_t r = easysimd_vminq_s32(a, b);
...
static int
test_easysimd_x_vminq_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int64_t a[2];
    int64_t b[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int64x2_t r = easysimd_x_vminq_s64(a, b);
...
static int
test_easysimd_vminq_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint8_t a[16];
    uint8_t b[16];
    uint8_t r[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x16_t r = easysimd_vminq_u8(a, b);
...
static int
test_easysimd_vminq_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint16_t a[8];
    uint16_t b[8];
    uint16_t r[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x8_t r = easysimd_vminq_u16(a, b);
...
static int
test_easysimd_vminq_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint32_t a[4];
    uint32_t b[4];
    uint32_t r[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x4_t r = easysimd_vminq_u32(a, b);
...
static int
test_easysimd_x_vminq_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint64_t a[2];
    uint64_t b[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint64x2_t r = easysimd_x_vminq_u64(a, b);
...
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmin_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmin_f64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmin_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmin_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmin_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(x_vmin_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmin_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmin_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmin_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(x_vmin_u64)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vminq_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vminq_f64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vminq_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vminq_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vminq_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(x_vminq_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vminq_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vminq_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vminq_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(x_vminq_u64)
