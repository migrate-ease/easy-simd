#define EASYSIMD_TEST_ARM_NEON_INSN minv

#include "test-neon.h"
#include "../../../easysimd/arm/neon/minv.h"

static int
test_easysimd_vminv_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    ...
    { {            EASYSIMD_MATH_NANF, EASYSIMD_FLOAT32_C(   534.24) },
                 EASYSIMD_MATH_NANF },
    { { EASYSIMD_FLOAT32_C(  -385.00),            EASYSIMD_MATH_NANF },
                 EASYSIMD_MATH_NANF },
    { {            EASYSIMD_MATH_NANF,            EASYSIMD_MATH_NANF },
                 EASYSIMD_MATH_NANF },
    #endif
    { { EASYSIMD_FLOAT32_C(   453.38), EASYSIMD_FLOAT32_C(   453.38) },
      EASYSIMD_FLOAT32_C(   453.38) },
    { { EASYSIMD_FLOAT32_C(  -282.45), EASYSIMD_FLOAT32_C(  -125.43) },
      EASYSIMD_FLOAT32_C(  -282.45) },
    { { EASYSIMD_FLOAT32_C(   -15.54), EASYSIMD_FLOAT32_C(  -221.82) },
      EASYSIMD_FLOAT32_C(  -221.82) },
    { { EASYSIMD_FLOAT32_C(  -502.94), EASYSIMD_FLOAT32_C(  -155.47) },
      EASYSIMD_FLOAT32_C(  -502.94) },
    { { EASYSIMD_FLOAT32_C(  -806.84), EASYSIMD_FLOAT32_C(   615.87) },
      EASYSIMD_FLOAT32_C(  -806.84) }
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float32x2_t a = easysimd_vld1_f32(test_vec[i].a);
    easysimd_float32_t r = easysimd_vminv_f32(a);
...
#else
  fputc('\n', stdout);
  easysimd_float32_t values[8 * 1 * sizeof(easysimd_float32x2_t)];
  easysimd_test_arm_neon_random_f32x2_full(8, 1, values, -1000.0f, 1000.0f, EASYSIMD_TEST_VEC_FLOAT_NAN | EASYSIMD_TEST_VEC_FLOAT_EQUAL | EASYSIMD_TEST_VEC_FLOAT_PAIR);

  for (size_t i = 0 ; i < 8 ; i++) {
    easysimd_float32x2_t a = easysimd_test_arm_neon_random_extract_f32x2(i, 1, 0, values);
    easysimd_float32_t r = easysimd_vminv_f32(a);
...
static int
test_easysimd_vminv_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int8_t a[8];
    int8_t r;
...
static int
test_easysimd_vminv_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int16_t a[4];
    int16_t r;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    int16_t r = easysimd_vminv_s16(a);
...
static int
test_easysimd_vminv_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t a[2];
    int32_t r;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    int32_t r = easysimd_vminv_s32(a);
...
static int
test_easysimd_vminv_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint8_t a[8];
    uint8_t r;
...
static int
test_easysimd_vminv_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint16_t a[4];
    uint16_t r;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    uint16_t r = easysimd_vminv_u16(a);
...
static int
test_easysimd_vminv_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint32_t a[2];
    uint32_t r;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    uint32_t r = easysimd_vminv_u32(a);
...
static int
test_easysimd_vminvq_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    ...
    #if !defined(EASYSIMD_FAST_NANS)
    { {            EASYSIMD_MATH_NANF, EASYSIMD_FLOAT32_C(  -701.57), EASYSIMD_FLOAT32_C(   406.22),            EASYSIMD_MATH_NANF },
                 EASYSIMD_MATH_NANF },
    { {            EASYSIMD_MATH_NANF,            EASYSIMD_MATH_NANF, EASYSIMD_FLOAT32_C(  -103.16), EASYSIMD_FLOAT32_C(  -103.16) },
                 EASYSIMD_MATH_NANF },
    #endif
    { { EASYSIMD_FLOAT32_C(   696.89), EASYSIMD_FLOAT32_C(  -458.92), EASYSIMD_FLOAT32_C(   883.35), EASYSIMD_FLOAT32_C(   910.86) },
      EASYSIMD_FLOAT32_C(  -458.92) },
    { { EASYSIMD_FLOAT32_C(   257.45), EASYSIMD_FLOAT32_C(   520.20), EASYSIMD_FLOAT32_C(  -905.06), EASYSIMD_FLOAT32_C(  -593.51) },
      EASYSIMD_FLOAT32_C(  -905.06) },
    { { EASYSIMD_FLOAT32_C(  -269.91), EASYSIMD_FLOAT32_C(  -858.01), EASYSIMD_FLOAT32_C(   -48.94), EASYSIMD_FLOAT32_C(  -616.54) },
      EASYSIMD_FLOAT32_C(  -858.01) },
    { { EASYSIMD_FLOAT32_C(   719.99), EASYSIMD_FLOAT32_C(  -168.74), EASYSIMD_FLOAT32_C(   719.60), EASYSIMD_FLOAT32_C(  -623.28) },
      EASYSIMD_FLOAT32_C(  -623.28) },
    { { EASYSIMD_FLOAT32_C(   759.29), EASYSIMD_FLOAT32_C(   309.98), EASYSIMD_FLOAT32_C(    52.00), EASYSIMD_FLOAT32_C(   647.84) },
      EASYSIMD_FLOAT32_C(    52.00) },
    { { EASYSIMD_FLOAT32_C(   117.95), EASYSIMD_FLOAT32_C(  -401.59), EASYSIMD_FLOAT32_C(   805.20), EASYSIMD_FLOAT32_C(   531.01) },
      EASYSIMD_FLOAT32_C(  -401.59) }
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float32x4_t a = easysimd_vld1q_f32(test_vec[i].a);
    easysimd_float32_t r = easysimd_vminvq_f32(a);
  ...
  fputc('\n', stdout);
  easysimd_float32_t values[8 * 1 * sizeof(easysimd_float32x2_t)];
  easysimd_test_arm_neon_random_f32x4_full(8, 1, values, -1000.0f, 1000.0f, EASYSIMD_TEST_VEC_FLOAT_NAN | EASYSIMD_TEST_VEC_FLOAT_EQUAL | EASYSIMD_TEST_VEC_FLOAT_PAIR);

  for (size_t i = 0 ; i < 8 ; i++) {
    easysimd_float32x4_t a = easysimd_test_arm_neon_random_extract_f32x4(i, 1, 0, values);
    easysimd_float32_t r = easysimd_vminvq_f32(a);
...
static int
test_easysimd_vminvq_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    ...
    #if !defined(EASYSIMD_FAST_NANS)
    { {             EASYSIMD_MATH_NAN, EASYSIMD_FLOAT64_C(   916.26) },
                  EASYSIMD_MATH_NAN },
    { { EASYSIMD_FLOAT64_C(   280.88),             EASYSIMD_MATH_NAN },
                  EASYSIMD_MATH_NAN },
    { {             EASYSIMD_MATH_NAN,             EASYSIMD_MATH_NAN },
                  EASYSIMD_MATH_NAN },
    #endif
    { { EASYSIMD_FLOAT64_C(  -759.17), EASYSIMD_FLOAT64_C(  -759.17) },
      EASYSIMD_FLOAT64_C(  -759.17) },
    { { EASYSIMD_FLOAT64_C(  -235.01), EASYSIMD_FLOAT64_C(   213.31) },
      EASYSIMD_FLOAT64_C(  -235.01) },
    { { EASYSIMD_FLOAT64_C(  -536.29), EASYSIMD_FLOAT64_C(  -137.31) },
      EASYSIMD_FLOAT64_C(  -536.29) },
    { { EASYSIMD_FLOAT64_C(  -353.98), EASYSIMD_FLOAT64_C(   948.71) },
      EASYSIMD_FLOAT64_C(  -353.98) },
    { { EASYSIMD_FLOAT64_C(   575.38), EASYSIMD_FLOAT64_C(  -153.95) },
      EASYSIMD_FLOAT64_C(  -153.95) }
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float64x2_t a = easysimd_vld1q_f64(test_vec[i].a);
    easysimd_float64_t r = easysimd_vminvq_f64(a);
...
#else
  fputc('\n', stdout);
  easysimd_float64_t values[8 * 1 * sizeof(easysimd_float64x2_t)];
  easysimd_test_arm_neon_random_f64x2_full(8, 1, values, -1000.0, 1000.0, EASYSIMD_TEST_VEC_FLOAT_NAN | EASYSIMD_TEST_VEC_FLOAT_EQUAL | EASYSIMD_TEST_VEC_FLOAT_PAIR);

  for (size_t i = 0 ; i < 8 ; i++) {
    easysimd_float64x2_t a = easysimd_test_arm_neon_random_extract_f64x2(i, 1, 0, values);
    easysimd_float64_t r = easysimd_vminvq_f64(a);
...
static int
test_easysimd_vminvq_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int8_t a[16];
    int8_t r;
...
static int
test_easysimd_vminvq_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int16_t a[8];
    int16_t r;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    int16_t r = easysimd_vminvq_s16(a);
...
static int
test_easysimd_vminvq_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t a[4];
    int32_t r;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    int32_t r = easysimd_vminvq_s32(a);
...
static int
test_easysimd_vminvq_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint8_t a[16];
    uint8_t r;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    uint8_t r = easysimd_vminvq_u8(a);
...
static int
test_easysimd_vminvq_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint16_t a[8];
    uint16_t r;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    uint16_t r = easysimd_vminvq_u16(a);
...
static int
test_easysimd_vminvq_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint32_t a[4];
    uint32_t r;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    uint32_t r = easysimd_vminvq_u32(a);
...
EASYSIMD_TEST_FUNC_LIST_ENTRY(vminv_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vminv_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vminv_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vminv_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vminv_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vminv_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vminv_u32)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vminvq_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vminvq_f64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vminvq_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vminvq_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vminvq_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vminvq_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vminvq_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vminvq_u32)
