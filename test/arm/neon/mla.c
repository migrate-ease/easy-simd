#define EASYSIMD_TEST_ARM_NEON_INSN mla

#include "test-neon.h"
#include "../../../easysimd/arm/neon/mla.h"

static int
test_easysimd_vmla_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    ...
    { { EASYSIMD_FLOAT32_C(316.661133), EASYSIMD_FLOAT32_C(532.098022) },
      { EASYSIMD_FLOAT32_C(620.658325), EASYSIMD_FLOAT32_C(-997.429260) },
      { EASYSIMD_FLOAT32_C(-285.241272), EASYSIMD_FLOAT32_C(-34.532288) },
      { EASYSIMD_FLOAT32_C(-176720.718750), EASYSIMD_FLOAT32_C(34975.613281) } },
    { { EASYSIMD_FLOAT32_C(471.026245), EASYSIMD_FLOAT32_C(750.918213) },
      { EASYSIMD_FLOAT32_C(-25.710571), EASYSIMD_FLOAT32_C(227.714966) },
      { EASYSIMD_FLOAT32_C(-713.672607), EASYSIMD_FLOAT32_C(-277.196289) },
      { EASYSIMD_FLOAT32_C(18819.955078), EASYSIMD_FLOAT32_C(-62370.824219) } },
    { { EASYSIMD_FLOAT32_C(194.214355), EASYSIMD_FLOAT32_C(-492.961609) },
      { EASYSIMD_FLOAT32_C(-13.566528), EASYSIMD_FLOAT32_C(253.638428) },
      { EASYSIMD_FLOAT32_C(459.621704), EASYSIMD_FLOAT32_C(-547.513184) },
      { EASYSIMD_FLOAT32_C(-6041.256348), EASYSIMD_FLOAT32_C(-139363.359375) } },
    { { EASYSIMD_FLOAT32_C(572.033813), EASYSIMD_FLOAT32_C(-487.424255) },
      { EASYSIMD_FLOAT32_C(876.644287), EASYSIMD_FLOAT32_C(-464.728149) },
      { EASYSIMD_FLOAT32_C(-627.000244), EASYSIMD_FLOAT32_C(-604.188477) },
      { EASYSIMD_FLOAT32_C(-549084.125000), EASYSIMD_FLOAT32_C(280295.968750) } },
    { { EASYSIMD_FLOAT32_C(-380.228882), EASYSIMD_FLOAT32_C(-880.954773) },
      { EASYSIMD_FLOAT32_C(-273.911987), EASYSIMD_FLOAT32_C(-60.760437) },
      { EASYSIMD_FLOAT32_C(460.995361), EASYSIMD_FLOAT32_C(-993.405762) },
      { EASYSIMD_FLOAT32_C(-126652.382812), EASYSIMD_FLOAT32_C(59478.816406) } },
    { { EASYSIMD_FLOAT32_C(-200.876343), EASYSIMD_FLOAT32_C(-222.343384) },
      { EASYSIMD_FLOAT32_C(538.692261), EASYSIMD_FLOAT32_C(-580.218018) },
      { EASYSIMD_FLOAT32_C(-219.772644), EASYSIMD_FLOAT32_C(-746.548950) },
      { EASYSIMD_FLOAT32_C(-118590.695312), EASYSIMD_FLOAT32_C(432938.812500) } },
    { { EASYSIMD_FLOAT32_C(385.249634), EASYSIMD_FLOAT32_C(-748.746277) },
      { EASYSIMD_FLOAT32_C(-995.630615), EASYSIMD_FLOAT32_C(-640.460815) },
      { EASYSIMD_FLOAT32_C(478.968628), EASYSIMD_FLOAT32_C(-709.303223) },
      { EASYSIMD_FLOAT32_C(-476490.593750), EASYSIMD_FLOAT32_C(453532.156250) } },
    { { EASYSIMD_FLOAT32_C(82.342896), EASYSIMD_FLOAT32_C(-326.816833) },
      { EASYSIMD_FLOAT32_C(-202.264832), EASYSIMD_FLOAT32_C(-931.223450) },
      { EASYSIMD_FLOAT32_C(926.821655), EASYSIMD_FLOAT32_C(-742.643005) },
      { EASYSIMD_FLOAT32_C(-187381.078125), EASYSIMD_FLOAT32_C(691239.750000) } },
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float32x2_t a, b, c, r;

    a = easysimd_vld1_f32(test_vec[i].a);
    b = easysimd_vld1_f32(test_vec[i].b);
    c = easysimd_vld1_f32(test_vec[i].c);
    r = easysimd_vmla_f32(a, b, c);
...
static int
test_easysimd_vmla_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    ...
    { { EASYSIMD_FLOAT64_C(  -737.86) },
      { EASYSIMD_FLOAT64_C(    54.24) },
      { EASYSIMD_FLOAT64_C(   214.25) },
      { EASYSIMD_FLOAT64_C( 10883.06) } },
    { { EASYSIMD_FLOAT64_C(  -556.90) },
      { EASYSIMD_FLOAT64_C(   -78.19) },
      { EASYSIMD_FLOAT64_C(  -607.99) },
      { EASYSIMD_FLOAT64_C( 46981.84) } },
    { { EASYSIMD_FLOAT64_C(   487.07) },
      { EASYSIMD_FLOAT64_C(   470.32) },
      { EASYSIMD_FLOAT64_C(   -82.83) },
      { EASYSIMD_FLOAT64_C(-38469.54) } },
    { { EASYSIMD_FLOAT64_C(   174.25) },
      { EASYSIMD_FLOAT64_C(  -952.32) },
      { EASYSIMD_FLOAT64_C(   119.45) },
      { EASYSIMD_FLOAT64_C(-113580.37) } },
    { { EASYSIMD_FLOAT64_C(  -537.41) },
      { EASYSIMD_FLOAT64_C(   278.36) },
      { EASYSIMD_FLOAT64_C(   723.14) },
      { EASYSIMD_FLOAT64_C(200755.84) } },
    { { EASYSIMD_FLOAT64_C(   217.52) },
      { EASYSIMD_FLOAT64_C(   318.77) },
      { EASYSIMD_FLOAT64_C(  -673.30) },
      { EASYSIMD_FLOAT64_C(-214410.32) } },
    { { EASYSIMD_FLOAT64_C(  -927.68) },
      { EASYSIMD_FLOAT64_C(  -114.09) },
      { EASYSIMD_FLOAT64_C(   770.14) },
      { EASYSIMD_FLOAT64_C(-88792.95) } },
    { { EASYSIMD_FLOAT64_C(  -953.39) },
      { EASYSIMD_FLOAT64_C(  -237.19) },
      { EASYSIMD_FLOAT64_C(   341.63) },
      { EASYSIMD_FLOAT64_C(-81984.61) } }
  };
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_float64x1_t r = easysimd_vmla_f64(a, b, c);
...
static int
test_easysimd_vmla_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int8_t a[8];
    int8_t b[8];
    int8_t c[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int8x8_t r = easysimd_vmla_s8(a, b, c);
...
static int
test_easysimd_vmla_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int16_t a[4];
    int16_t b[4];
    int16_t c[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int16x4_t r = easysimd_vmla_s16(a, b, c);
...
static int
test_easysimd_vmla_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int32_t a[2];
    int32_t b[2];
    int32_t c[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x2_t r = easysimd_vmla_s32(a, b, c);
...
static int
test_easysimd_vmla_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint8_t a[16];
    uint8_t b[16];
    uint8_t c[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x8_t r = easysimd_vmla_u8(a, b, c);
...
static int
test_easysimd_vmla_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint16_t a[4];
    uint16_t b[4];
    uint16_t c[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x4_t r = easysimd_vmla_u16(a, b, c);
...
static int
test_easysimd_vmla_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint32_t a[2];
    uint32_t b[2];
    uint32_t c[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x2_t r = easysimd_vmla_u32(a, b, c);
...
static int
test_easysimd_vmlaq_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    ...
    { { EASYSIMD_FLOAT32_C(145.140869), EASYSIMD_FLOAT32_C(86.372559), EASYSIMD_FLOAT32_C(588.548218), EASYSIMD_FLOAT32_C(215.169800) },
      { EASYSIMD_FLOAT32_C(440.652344), EASYSIMD_FLOAT32_C(-714.658264), EASYSIMD_FLOAT32_C(-845.502808), EASYSIMD_FLOAT32_C(657.962158) },
      { EASYSIMD_FLOAT32_C(752.153320), EASYSIMD_FLOAT32_C(738.940552), EASYSIMD_FLOAT32_C(-56.434509), EASYSIMD_FLOAT32_C(-510.827606) },
      { EASYSIMD_FLOAT32_C(331583.281250), EASYSIMD_FLOAT32_C(-528003.625000), EASYSIMD_FLOAT32_C(48304.082031), EASYSIMD_FLOAT32_C(-335890.062500) } },
    { { EASYSIMD_FLOAT32_C(204.974365), EASYSIMD_FLOAT32_C(-576.728638), EASYSIMD_FLOAT32_C(89.728027), EASYSIMD_FLOAT32_C(612.498413) },
      { EASYSIMD_FLOAT32_C(-581.968323), EASYSIMD_FLOAT32_C(434.484985), EASYSIMD_FLOAT32_C(-203.843140), EASYSIMD_FLOAT32_C(812.033081) },
      { EASYSIMD_FLOAT32_C(-54.438843), EASYSIMD_FLOAT32_C(-360.203674), EASYSIMD_FLOAT32_C(-623.818970), EASYSIMD_FLOAT32_C(-160.126221) },
      { EASYSIMD_FLOAT32_C(31886.656250), EASYSIMD_FLOAT32_C(-157079.828125), EASYSIMD_FLOAT32_C(127250.945312), EASYSIMD_FLOAT32_C(-129415.289062) } },
    { { EASYSIMD_FLOAT32_C(-430.798706), EASYSIMD_FLOAT32_C(612.035400), EASYSIMD_FLOAT32_C(-285.161377), EASYSIMD_FLOAT32_C(-857.128662) },
      { EASYSIMD_FLOAT32_C(-202.940674), EASYSIMD_FLOAT32_C(-256.752319), EASYSIMD_FLOAT32_C(574.135498), EASYSIMD_FLOAT32_C(942.200195) },
      { EASYSIMD_FLOAT32_C(829.620117), EASYSIMD_FLOAT32_C(162.683838), EASYSIMD_FLOAT32_C(157.370117), EASYSIMD_FLOAT32_C(270.272583) },
      { EASYSIMD_FLOAT32_C(-168794.468750), EASYSIMD_FLOAT32_C(-41157.417969), EASYSIMD_FLOAT32_C(90066.609375), EASYSIMD_FLOAT32_C(253793.750000) } },
    { { EASYSIMD_FLOAT32_C(448.025513), EASYSIMD_FLOAT32_C(311.867310), EASYSIMD_FLOAT32_C(-71.765259), EASYSIMD_FLOAT32_C(200.178955) },
      { EASYSIMD_FLOAT32_C(50.807861), EASYSIMD_FLOAT32_C(871.800171), EASYSIMD_FLOAT32_C(689.351196), EASYSIMD_FLOAT32_C(-744.217712) },
      { EASYSIMD_FLOAT32_C(-704.928345), EASYSIMD_FLOAT32_C(-220.920593), EASYSIMD_FLOAT32_C(868.280640), EASYSIMD_FLOAT32_C(-286.896667) },
      { EASYSIMD_FLOAT32_C(-35367.875000), EASYSIMD_FLOAT32_C(-192286.734375), EASYSIMD_FLOAT32_C(598478.562500), EASYSIMD_FLOAT32_C(213713.750000) } },
    { { EASYSIMD_FLOAT32_C(-786.435486), EASYSIMD_FLOAT32_C(-335.562378), EASYSIMD_FLOAT32_C(-474.863464), EASYSIMD_FLOAT32_C(159.125610) },
      { EASYSIMD_FLOAT32_C(304.234009), EASYSIMD_FLOAT32_C(-98.682495), EASYSIMD_FLOAT32_C(998.999390), EASYSIMD_FLOAT32_C(873.435303) },
      { EASYSIMD_FLOAT32_C(-486.647034), EASYSIMD_FLOAT32_C(-286.161804), EASYSIMD_FLOAT32_C(-983.693298), EASYSIMD_FLOAT32_C(310.412231) },
      { EASYSIMD_FLOAT32_C(-148841.015625), EASYSIMD_FLOAT32_C(27903.597656), EASYSIMD_FLOAT32_C(-983183.875000), EASYSIMD_FLOAT32_C(271284.125000) } },
    { { EASYSIMD_FLOAT32_C(457.085815), EASYSIMD_FLOAT32_C(590.442139), EASYSIMD_FLOAT32_C(252.612549), EASYSIMD_FLOAT32_C(286.706055) },
      { EASYSIMD_FLOAT32_C(-246.873962), EASYSIMD_FLOAT32_C(-590.017212), EASYSIMD_FLOAT32_C(-443.021301), EASYSIMD_FLOAT32_C(-798.848389) },
      { EASYSIMD_FLOAT32_C(721.850098), EASYSIMD_FLOAT32_C(485.213501), EASYSIMD_FLOAT32_C(401.330566), EASYSIMD_FLOAT32_C(-227.341858) },
      { EASYSIMD_FLOAT32_C(-177748.921875), EASYSIMD_FLOAT32_C(-285693.875000), EASYSIMD_FLOAT32_C(-177545.375000), EASYSIMD_FLOAT32_C(181898.375000) } },
    { { EASYSIMD_FLOAT32_C(357.013794), EASYSIMD_FLOAT32_C(90.682007), EASYSIMD_FLOAT32_C(28.440430), EASYSIMD_FLOAT32_C(652.085327) },
      { EASYSIMD_FLOAT32_C(869.761353), EASYSIMD_FLOAT32_C(-103.278809), EASYSIMD_FLOAT32_C(-634.811157), EASYSIMD_FLOAT32_C(-916.674072) },
      { EASYSIMD_FLOAT32_C(561.158813), EASYSIMD_FLOAT32_C(-109.674683), EASYSIMD_FLOAT32_C(242.451660), EASYSIMD_FLOAT32_C(-134.607117) },
      { EASYSIMD_FLOAT32_C(488431.250000), EASYSIMD_FLOAT32_C(11417.751953), EASYSIMD_FLOAT32_C(-153882.578125), EASYSIMD_FLOAT32_C(124042.937500) } },
    { { EASYSIMD_FLOAT32_C(791.642822), EASYSIMD_FLOAT32_C(241.451050), EASYSIMD_FLOAT32_C(-261.171753), EASYSIMD_FLOAT32_C(-695.004150) },
      { EASYSIMD_FLOAT32_C(955.289307), EASYSIMD_FLOAT32_C(-244.864990), EASYSIMD_FLOAT32_C(615.408081), EASYSIMD_FLOAT32_C(412.375122) },
      { EASYSIMD_FLOAT32_C(-654.422729), EASYSIMD_FLOAT32_C(-131.979187), EASYSIMD_FLOAT32_C(-300.918701), EASYSIMD_FLOAT32_C(98.703369) },
      { EASYSIMD_FLOAT32_C(-624371.437500), EASYSIMD_FLOAT32_C(32558.533203), EASYSIMD_FLOAT32_C(-185448.968750), EASYSIMD_FLOAT32_C(40007.808594) } },
  };
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_float32x4_t r = easysimd_vmlaq_f32(a, b, c);
...
static int
test_easysimd_vmlaq_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    ...
    { { EASYSIMD_FLOAT64_C(137.836326), EASYSIMD_FLOAT64_C(180.498224) },
      { EASYSIMD_FLOAT64_C(70.815405), EASYSIMD_FLOAT64_C(-388.999976) },
      { EASYSIMD_FLOAT64_C(-611.056813), EASYSIMD_FLOAT64_C(-662.416708) },
      { EASYSIMD_FLOAT64_C(-43134.399584), EASYSIMD_FLOAT64_C(257860.581526) } },
    { { EASYSIMD_FLOAT64_C(-410.709663), EASYSIMD_FLOAT64_C(-321.801186) },
      { EASYSIMD_FLOAT64_C(20.311225), EASYSIMD_FLOAT64_C(-337.649517) },
      { EASYSIMD_FLOAT64_C(-755.163089), EASYSIMD_FLOAT64_C(32.799101) },
      { EASYSIMD_FLOAT64_C(-15748.996891), EASYSIMD_FLOAT64_C(-11396.401804) } },
    { { EASYSIMD_FLOAT64_C(-790.783079), EASYSIMD_FLOAT64_C(351.759081) },
      { EASYSIMD_FLOAT64_C(914.436994), EASYSIMD_FLOAT64_C(117.928983) },
      { EASYSIMD_FLOAT64_C(-166.522701), EASYSIMD_FLOAT64_C(878.769813) },
      { EASYSIMD_FLOAT64_C(-153065.301121), EASYSIMD_FLOAT64_C(103984.189630) } },
    { { EASYSIMD_FLOAT64_C(-131.289381), EASYSIMD_FLOAT64_C(-355.855969) },
      { EASYSIMD_FLOAT64_C(31.078331), EASYSIMD_FLOAT64_C(58.849271) },
      { EASYSIMD_FLOAT64_C(-20.792446), EASYSIMD_FLOAT64_C(-30.490121) },
      { EASYSIMD_FLOAT64_C(-777.483883), EASYSIMD_FLOAT64_C(-2150.177382) } },
    { { EASYSIMD_FLOAT64_C(869.063754), EASYSIMD_FLOAT64_C(516.089691) },
      { EASYSIMD_FLOAT64_C(-998.833277), EASYSIMD_FLOAT64_C(424.541474) },
      { EASYSIMD_FLOAT64_C(263.351169), EASYSIMD_FLOAT64_C(168.341670) },
      { EASYSIMD_FLOAT64_C(-262174.847521), EASYSIMD_FLOAT64_C(71984.110331) } },
    { { EASYSIMD_FLOAT64_C(546.778995), EASYSIMD_FLOAT64_C(-598.812505) },
      { EASYSIMD_FLOAT64_C(-651.160107), EASYSIMD_FLOAT64_C(-382.405600) },
      { EASYSIMD_FLOAT64_C(12.187520), EASYSIMD_FLOAT64_C(-262.216919) },
      { EASYSIMD_FLOAT64_C(-7389.247558), EASYSIMD_FLOAT64_C(99674.405701) } },
    { { EASYSIMD_FLOAT64_C(-44.822308), EASYSIMD_FLOAT64_C(601.477857) },
      { EASYSIMD_FLOAT64_C(415.981895), EASYSIMD_FLOAT64_C(975.488918) },
      { EASYSIMD_FLOAT64_C(-736.171662), EASYSIMD_FLOAT64_C(660.818807) },
      { EASYSIMD_FLOAT64_C(-306278.905223), EASYSIMD_FLOAT64_C(645222.900518) } },
    { { EASYSIMD_FLOAT64_C(8.288018), EASYSIMD_FLOAT64_C(-526.954741) },
      { EASYSIMD_FLOAT64_C(12.577887), EASYSIMD_FLOAT64_C(-77.274989) },
      { EASYSIMD_FLOAT64_C(590.974242), EASYSIMD_FLOAT64_C(846.055186) },
      { EASYSIMD_FLOAT64_C(7441.495354), EASYSIMD_FLOAT64_C(-65905.859876) } },
  };
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_float64x2_t r = easysimd_vmlaq_f64(a, b, c);
...
static int
test_easysimd_vmlaq_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int8_t a[16];
    int8_t b[16];
    int8_t c[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int8x16_t r = easysimd_vmlaq_s8(a, b, c);
...
static int
test_easysimd_vmlaq_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int16_t a[8];
    int16_t b[8];
    int16_t c[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int16x8_t r = easysimd_vmlaq_s16(a, b, c);
...
static int
test_easysimd_vmlaq_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int32_t a[4];
    int32_t b[4];
    int32_t c[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x4_t r = easysimd_vmlaq_s32(a, b, c);
...
static int
test_easysimd_vmlaq_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint8_t a[16];
    uint8_t b[16];
    uint8_t c[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x16_t r = easysimd_vmlaq_u8(a, b, c);
...
static int
test_easysimd_vmlaq_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint16_t a[8];
    uint16_t b[8];
    uint16_t c[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x8_t r = easysimd_vmlaq_u16(a, b, c);
...
static int
test_easysimd_vmlaq_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint32_t a[4];
    uint32_t b[4];
    uint32_t c[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x4_t r = easysimd_vmlaq_u32(a, b, c);
...
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmla_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmla_f64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmla_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmla_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmla_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmla_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmla_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmla_u32)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vmlaq_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmlaq_f64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmlaq_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmlaq_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmlaq_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmlaq_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmlaq_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmlaq_u32)
