#define EASYSIMD_TEST_ARM_NEON_INSN mla_n

#include "test-neon.h"
#include "../../../easysimd/arm/neon/mla_n.h"

static int
test_easysimd_vmla_n_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    ...
    { { EASYSIMD_FLOAT32_C(  -680.78), EASYSIMD_FLOAT32_C(  -597.80) },
      { EASYSIMD_FLOAT32_C(   774.13), EASYSIMD_FLOAT32_C(  -444.02) },
      EASYSIMD_FLOAT32_C(  -818.28),
      { EASYSIMD_FLOAT32_C(-634135.88), EASYSIMD_FLOAT32_C(362734.88) } },
    { { EASYSIMD_FLOAT32_C(  -946.16), EASYSIMD_FLOAT32_C(   309.30) },
      { EASYSIMD_FLOAT32_C(  -303.37), EASYSIMD_FLOAT32_C(  -304.24) },
      EASYSIMD_FLOAT32_C(  -769.24),
      { EASYSIMD_FLOAT32_C(232418.17), EASYSIMD_FLOAT32_C(234342.86) } },
    { { EASYSIMD_FLOAT32_C(  -293.93), EASYSIMD_FLOAT32_C(   460.64) },
      { EASYSIMD_FLOAT32_C(  -114.31), EASYSIMD_FLOAT32_C(   164.95) },
      EASYSIMD_FLOAT32_C(   732.21),
      { EASYSIMD_FLOAT32_C(-83992.86), EASYSIMD_FLOAT32_C(121238.68) } },
    { { EASYSIMD_FLOAT32_C(  -513.27), EASYSIMD_FLOAT32_C(  -298.77) },
      { EASYSIMD_FLOAT32_C(    31.87), EASYSIMD_FLOAT32_C(   -63.24) },
      EASYSIMD_FLOAT32_C(   777.71),
      { EASYSIMD_FLOAT32_C( 24272.35), EASYSIMD_FLOAT32_C(-49481.15) } },
    { { EASYSIMD_FLOAT32_C(   -30.10), EASYSIMD_FLOAT32_C(  -408.99) },
      { EASYSIMD_FLOAT32_C(  -446.43), EASYSIMD_FLOAT32_C(   878.35) },
      EASYSIMD_FLOAT32_C(   581.74),
      { EASYSIMD_FLOAT32_C(-259736.27), EASYSIMD_FLOAT32_C(510562.31) } },
    { { EASYSIMD_FLOAT32_C(   861.55), EASYSIMD_FLOAT32_C(  -880.45) },
      { EASYSIMD_FLOAT32_C(  -856.08), EASYSIMD_FLOAT32_C(  -537.88) },
      EASYSIMD_FLOAT32_C(   393.17),
      { EASYSIMD_FLOAT32_C(-335723.44), EASYSIMD_FLOAT32_C(-212358.73) } },
    { { EASYSIMD_FLOAT32_C(   174.89), EASYSIMD_FLOAT32_C(  -218.67) },
      { EASYSIMD_FLOAT32_C(   795.36), EASYSIMD_FLOAT32_C(   -50.98) },
      EASYSIMD_FLOAT32_C(   337.31),
      { EASYSIMD_FLOAT32_C(268457.75), EASYSIMD_FLOAT32_C(-17414.73) } },
    { { EASYSIMD_FLOAT32_C(   977.08), EASYSIMD_FLOAT32_C(     2.85) },
      { EASYSIMD_FLOAT32_C(  -353.39), EASYSIMD_FLOAT32_C(  -326.28) },
      EASYSIMD_FLOAT32_C(   698.61),
      { EASYSIMD_FLOAT32_C(-245904.72), EASYSIMD_FLOAT32_C(-227939.62) } },
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_float32x2_t r = easysimd_vmla_n_f32(a, b, c);
...
static int
test_easysimd_vmla_n_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int16_t a[4];
    int16_t b[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int16x4_t r = easysimd_vmla_n_s16(a, b, c);
...
static int
test_easysimd_vmla_n_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t a[2];
    int32_t b[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x2_t r = easysimd_vmla_n_s32(a, b, c);
...
static int
test_easysimd_vmla_n_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint16_t a[4];
    uint16_t b[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x4_t r = easysimd_vmla_n_u16(a, b, c);
...
static int
test_easysimd_vmla_n_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint32_t a[2];
    uint32_t b[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x2_t r = easysimd_vmla_n_u32(a, b, c);
...
static int
test_easysimd_vmlaq_n_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    ...
    { { EASYSIMD_FLOAT32_C(  -565.27), EASYSIMD_FLOAT32_C(  -578.48), EASYSIMD_FLOAT32_C(   923.27), EASYSIMD_FLOAT32_C(  -735.63) },
      { EASYSIMD_FLOAT32_C(  -721.39), EASYSIMD_FLOAT32_C(   999.71), EASYSIMD_FLOAT32_C(  -670.81), EASYSIMD_FLOAT32_C(  -721.24) },
      EASYSIMD_FLOAT32_C(   987.68),
      { EASYSIMD_FLOAT32_C(-713067.75), EASYSIMD_FLOAT32_C(986815.06), EASYSIMD_FLOAT32_C(-661622.38), EASYSIMD_FLOAT32_C(-713089.94) } },
    { { EASYSIMD_FLOAT32_C(  -575.56), EASYSIMD_FLOAT32_C(   755.06), EASYSIMD_FLOAT32_C(  -177.83), EASYSIMD_FLOAT32_C(  -498.94) },
      { EASYSIMD_FLOAT32_C(  -117.24), EASYSIMD_FLOAT32_C(   -43.95), EASYSIMD_FLOAT32_C(   115.50), EASYSIMD_FLOAT32_C(   776.41) },
      EASYSIMD_FLOAT32_C(  -808.82),
      { EASYSIMD_FLOAT32_C( 94250.49), EASYSIMD_FLOAT32_C( 36302.70), EASYSIMD_FLOAT32_C(-93596.54), EASYSIMD_FLOAT32_C(-628474.88) } },
    { { EASYSIMD_FLOAT32_C(   -35.98), EASYSIMD_FLOAT32_C(   -41.82), EASYSIMD_FLOAT32_C(   249.53), EASYSIMD_FLOAT32_C(  -482.80) },
      { EASYSIMD_FLOAT32_C(   691.32), EASYSIMD_FLOAT32_C(   488.86), EASYSIMD_FLOAT32_C(   795.66), EASYSIMD_FLOAT32_C(   785.88) },
      EASYSIMD_FLOAT32_C(    36.60),
      { EASYSIMD_FLOAT32_C( 25266.33), EASYSIMD_FLOAT32_C( 17850.46), EASYSIMD_FLOAT32_C( 29370.68), EASYSIMD_FLOAT32_C( 28280.41) } },
    { { EASYSIMD_FLOAT32_C(   325.74), EASYSIMD_FLOAT32_C(  -867.74), EASYSIMD_FLOAT32_C(  -719.43), EASYSIMD_FLOAT32_C(   295.15) },
      { EASYSIMD_FLOAT32_C(  -433.01), EASYSIMD_FLOAT32_C(  -297.91), EASYSIMD_FLOAT32_C(   218.42), EASYSIMD_FLOAT32_C(  -168.64) },
      EASYSIMD_FLOAT32_C(   -19.30),
      { EASYSIMD_FLOAT32_C(  8682.83), EASYSIMD_FLOAT32_C(  4881.92), EASYSIMD_FLOAT32_C( -4934.94), EASYSIMD_FLOAT32_C(  3549.90) } },
    { { EASYSIMD_FLOAT32_C(   218.13), EASYSIMD_FLOAT32_C(   160.55), EASYSIMD_FLOAT32_C(   259.47), EASYSIMD_FLOAT32_C(   205.82) },
      { EASYSIMD_FLOAT32_C(   585.00), EASYSIMD_FLOAT32_C(    14.53), EASYSIMD_FLOAT32_C(  -972.01), EASYSIMD_FLOAT32_C(  -913.95) },
      EASYSIMD_FLOAT32_C(   897.29),
      { EASYSIMD_FLOAT32_C(525132.75), EASYSIMD_FLOAT32_C( 13198.17), EASYSIMD_FLOAT32_C(-871915.31), EASYSIMD_FLOAT32_C(-819872.38) } },
    { { EASYSIMD_FLOAT32_C(   -15.96), EASYSIMD_FLOAT32_C(   201.56), EASYSIMD_FLOAT32_C(   673.70), EASYSIMD_FLOAT32_C(   175.22) },
      { EASYSIMD_FLOAT32_C(  -834.43), EASYSIMD_FLOAT32_C(  -368.13), EASYSIMD_FLOAT32_C(  -575.24), EASYSIMD_FLOAT32_C(  -317.23) },
      EASYSIMD_FLOAT32_C(  -676.81),
      { EASYSIMD_FLOAT32_C(564734.62), EASYSIMD_FLOAT32_C(249355.62), EASYSIMD_FLOAT32_C(390001.88), EASYSIMD_FLOAT32_C(214879.66) } },
    { { EASYSIMD_FLOAT32_C(   913.62), EASYSIMD_FLOAT32_C(  -521.58), EASYSIMD_FLOAT32_C(  -890.93), EASYSIMD_FLOAT32_C(   -49.78) },
      { EASYSIMD_FLOAT32_C(   804.17), EASYSIMD_FLOAT32_C(  -758.67), EASYSIMD_FLOAT32_C(   230.79), EASYSIMD_FLOAT32_C(    99.32) },
      EASYSIMD_FLOAT32_C(  -191.67),
      { EASYSIMD_FLOAT32_C(-153221.64), EASYSIMD_FLOAT32_C(144892.70), EASYSIMD_FLOAT32_C(-45126.45), EASYSIMD_FLOAT32_C(-19086.44) } },
    { { EASYSIMD_FLOAT32_C(   932.88), EASYSIMD_FLOAT32_C(  -682.26), EASYSIMD_FLOAT32_C(   639.69), EASYSIMD_FLOAT32_C(   -86.42) },
      { EASYSIMD_FLOAT32_C(   535.88), EASYSIMD_FLOAT32_C(  -199.76), EASYSIMD_FLOAT32_C(  -826.95), EASYSIMD_FLOAT32_C(  -258.30) },
      EASYSIMD_FLOAT32_C(  -614.76),
      { EASYSIMD_FLOAT32_C(-328504.72), EASYSIMD_FLOAT32_C(122122.20), EASYSIMD_FLOAT32_C(509015.50), EASYSIMD_FLOAT32_C(158706.08) } },
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_float32 c = test_vec[i].c;
    easysimd_float32x4_t r = easysimd_vmlaq_n_f32(a, b, c);
...
static int
test_easysimd_vmlaq_n_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int16_t a[8];
    int16_t b[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    int16_t c = test_vec[i].c;
    easysimd_int16x8_t r = easysimd_vmlaq_n_s16(a, b, c);
...
static int
test_easysimd_vmlaq_n_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t a[4];
    int32_t b[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    int32_t c = test_vec[i].c;
    easysimd_int32x4_t r = easysimd_vmlaq_n_s32(a, b, c);
...
static int
test_easysimd_vmlaq_n_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint16_t a[8];
    uint16_t b[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    uint16_t c = test_vec[i].c;
    easysimd_uint16x8_t r = easysimd_vmlaq_n_u16(a, b, c);
...
static int
test_easysimd_vmlaq_n_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint32_t a[4];
    uint32_t b[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    uint32_t c = test_vec[i].c;
    easysimd_uint32x4_t r = easysimd_vmlaq_n_u32(a, b, c);
...
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmla_n_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmla_n_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmla_n_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmla_n_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmla_n_u32)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vmlaq_n_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmlaq_n_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmlaq_n_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmlaq_n_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmlaq_n_u32)
