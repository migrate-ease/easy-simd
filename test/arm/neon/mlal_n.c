#define EASYSIMD_TEST_ARM_NEON_INSN mlal_n

#include "test-neon.h"
#include "../../../easysimd/arm/neon/mlal_n.h"

static int
test_easysimd_vmlal_n_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t a[4];
    int16_t b[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x4_t r = easysimd_vmlal_n_s16(a, b, c);
...
static int
test_easysimd_vmlal_n_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int64_t a[2];
    int32_t b[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int64x2_t r = easysimd_vmlal_n_s32(a, b, c);
...
static int
test_easysimd_vmlal_n_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint32_t a[4];
    uint16_t b[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x4_t r = easysimd_vmlal_n_u16(a, b, c);
...
static int
test_easysimd_vmlal_n_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint64_t a[2];
    uint32_t b[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint64x2_t r = easysimd_vmlal_n_u32(a, b, c);
...
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmlal_n_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmlal_n_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmlal_n_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmlal_n_u32)
