#define EASYSIMD_TEST_ARM_NEON_INSN mls

#include "test-neon.h"
#include "../../../easysimd/arm/neon/mls.h"

static int
test_easysimd_vmls_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    ...
    { { EASYSIMD_FLOAT32_C(  -365.18), EASYSIMD_FLOAT32_C(   555.85) },
      { EASYSIMD_FLOAT32_C(   342.95), EASYSIMD_FLOAT32_C(   560.35) },
      { EASYSIMD_FLOAT32_C(   990.43), EASYSIMD_FLOAT32_C(   963.21) },
      { EASYSIMD_FLOAT32_C(-340033.16), EASYSIMD_FLOAT32_C(-539178.81) } },
    { { EASYSIMD_FLOAT32_C(  -502.01), EASYSIMD_FLOAT32_C(   894.84) },
      { EASYSIMD_FLOAT32_C(   131.14), EASYSIMD_FLOAT32_C(   977.90) },
      { EASYSIMD_FLOAT32_C(   151.65), EASYSIMD_FLOAT32_C(   607.45) },
      { EASYSIMD_FLOAT32_C(-20389.39), EASYSIMD_FLOAT32_C(-593130.56) } },
    { { EASYSIMD_FLOAT32_C(  -426.49), EASYSIMD_FLOAT32_C(   736.48) },
      { EASYSIMD_FLOAT32_C(  -938.18), EASYSIMD_FLOAT32_C(  -397.50) },
      { EASYSIMD_FLOAT32_C(    44.80), EASYSIMD_FLOAT32_C(   850.55) },
      { EASYSIMD_FLOAT32_C( 41603.98), EASYSIMD_FLOAT32_C(338830.09) } },
    { { EASYSIMD_FLOAT32_C(  -738.35), EASYSIMD_FLOAT32_C(   630.15) },
      { EASYSIMD_FLOAT32_C(   820.68), EASYSIMD_FLOAT32_C(  -844.89) },
      { EASYSIMD_FLOAT32_C(   328.00), EASYSIMD_FLOAT32_C(   133.56) },
      { EASYSIMD_FLOAT32_C(-269921.38), EASYSIMD_FLOAT32_C(113473.66) } },
    { { EASYSIMD_FLOAT32_C(   660.82), EASYSIMD_FLOAT32_C(  -833.42) },
      { EASYSIMD_FLOAT32_C(   240.76), EASYSIMD_FLOAT32_C(  -548.85) },
      { EASYSIMD_FLOAT32_C(  -272.61), EASYSIMD_FLOAT32_C(   897.78) },
      { EASYSIMD_FLOAT32_C( 66294.40), EASYSIMD_FLOAT32_C(491913.16) } },
    { { EASYSIMD_FLOAT32_C(  -760.18), EASYSIMD_FLOAT32_C(   362.21) },
      { EASYSIMD_FLOAT32_C(   453.62), EASYSIMD_FLOAT32_C(   582.76) },
      { EASYSIMD_FLOAT32_C(   -77.44), EASYSIMD_FLOAT32_C(   444.05) },
      { EASYSIMD_FLOAT32_C( 34368.15), EASYSIMD_FLOAT32_C(-258412.38) } },
    { { EASYSIMD_FLOAT32_C(   545.98), EASYSIMD_FLOAT32_C(   420.55) },
      { EASYSIMD_FLOAT32_C(   338.90), EASYSIMD_FLOAT32_C(  -322.88) },
      { EASYSIMD_FLOAT32_C(   398.44), EASYSIMD_FLOAT32_C(  -509.46) },
      { EASYSIMD_FLOAT32_C(-134485.33), EASYSIMD_FLOAT32_C(-164073.89) } },
    { { EASYSIMD_FLOAT32_C(  -715.43), EASYSIMD_FLOAT32_C(   971.95) },
      { EASYSIMD_FLOAT32_C(  -772.98), EASYSIMD_FLOAT32_C(  -653.61) },
      { EASYSIMD_FLOAT32_C(  -425.55), EASYSIMD_FLOAT32_C(   271.82) },
      { EASYSIMD_FLOAT32_C(-329657.06), EASYSIMD_FLOAT32_C(178636.22) } }
  };
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_float32x2_t r = easysimd_vmls_f32(a, b, c);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_float32x2_t c = easysimd_test_arm_neon_random_f32x2(-1000.0, 1000.0);
    easysimd_float32x2_t r = easysimd_vmls_f32(a, b, c);
...
static int
test_easysimd_vmls_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    ...
    { { EASYSIMD_FLOAT64_C(   662.20) },
      { EASYSIMD_FLOAT64_C(   614.22) },
      { EASYSIMD_FLOAT64_C(  -568.69) },
      { EASYSIMD_FLOAT64_C(349962.97) } },
    { { EASYSIMD_FLOAT64_C(   237.85) },
      { EASYSIMD_FLOAT64_C(    33.93) },
      { EASYSIMD_FLOAT64_C(    22.08) },
      { EASYSIMD_FLOAT64_C(  -511.32) } },
    { { EASYSIMD_FLOAT64_C(   254.37) },
      { EASYSIMD_FLOAT64_C(  -543.96) },
      { EASYSIMD_FLOAT64_C(    92.53) },
      { EASYSIMD_FLOAT64_C( 50586.99) } },
    { { EASYSIMD_FLOAT64_C(   461.60) },
      { EASYSIMD_FLOAT64_C(  -604.69) },
      { EASYSIMD_FLOAT64_C(  -522.66) },
      { EASYSIMD_FLOAT64_C(-315585.68) } },
    { { EASYSIMD_FLOAT64_C(  -338.41) },
      { EASYSIMD_FLOAT64_C(   863.96) },
      { EASYSIMD_FLOAT64_C(   948.15) },
      { EASYSIMD_FLOAT64_C(-819502.08) } },
    { { EASYSIMD_FLOAT64_C(   524.72) },
      { EASYSIMD_FLOAT64_C(  -156.65) },
      { EASYSIMD_FLOAT64_C(   673.47) },
      { EASYSIMD_FLOAT64_C(106023.80) } },
    { { EASYSIMD_FLOAT64_C(  -712.19) },
      { EASYSIMD_FLOAT64_C(   -87.29) },
      { EASYSIMD_FLOAT64_C(   443.43) },
      { EASYSIMD_FLOAT64_C( 37994.81) } },
    { { EASYSIMD_FLOAT64_C(   673.85) },
      { EASYSIMD_FLOAT64_C(   112.89) },
      { EASYSIMD_FLOAT64_C(  -243.00) },
      { EASYSIMD_FLOAT64_C( 28106.12) } }
  };
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_float64x1_t r = easysimd_vmls_f64(a, b, c);
...
static int
test_easysimd_vmls_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int8_t a[8];
    int8_t b[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int8x8_t r = easysimd_vmls_s8(a, b, c);
...
static int
test_easysimd_vmls_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int16_t a[4];
    int16_t b[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int16x4_t r = easysimd_vmls_s16(a, b, c);
...
static int
test_easysimd_vmls_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t a[2];
    int32_t b[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x2_t r = easysimd_vmls_s32(a, b, c);
...
static int
test_easysimd_vmls_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint8_t a[8];
    uint8_t b[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x8_t r = easysimd_vmls_u8(a, b, c);
...
static int
test_easysimd_vmls_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint16_t a[4];
    uint16_t b[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x4_t r = easysimd_vmls_u16(a, b, c);
...
static int
test_easysimd_vmls_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint32_t a[2];
    uint32_t b[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x2_t r = easysimd_vmls_u32(a, b, c);
...
static int
test_easysimd_vmlsq_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    ...
    { { EASYSIMD_FLOAT32_C(   596.92), EASYSIMD_FLOAT32_C(  -413.27), EASYSIMD_FLOAT32_C(   717.20), EASYSIMD_FLOAT32_C(  -915.06) },
      { EASYSIMD_FLOAT32_C(  -486.72), EASYSIMD_FLOAT32_C(   408.94), EASYSIMD_FLOAT32_C(  -871.24), EASYSIMD_FLOAT32_C(   518.77) },
      { EASYSIMD_FLOAT32_C(   984.39), EASYSIMD_FLOAT32_C(  -416.38), EASYSIMD_FLOAT32_C(   953.84), EASYSIMD_FLOAT32_C(  -338.43) },
      { EASYSIMD_FLOAT32_C(479719.22), EASYSIMD_FLOAT32_C(169861.17), EASYSIMD_FLOAT32_C(831740.75), EASYSIMD_FLOAT32_C(174652.27) } },
    { { EASYSIMD_FLOAT32_C(  -409.52), EASYSIMD_FLOAT32_C(  -800.89), EASYSIMD_FLOAT32_C(   109.19), EASYSIMD_FLOAT32_C(    12.08) },
      { EASYSIMD_FLOAT32_C(   528.53), EASYSIMD_FLOAT32_C(  -884.21), EASYSIMD_FLOAT32_C(  -913.46), EASYSIMD_FLOAT32_C(   551.48) },
      { EASYSIMD_FLOAT32_C(  -761.40), EASYSIMD_FLOAT32_C(  -258.52), EASYSIMD_FLOAT32_C(   301.97), EASYSIMD_FLOAT32_C(  -198.07) },
      { EASYSIMD_FLOAT32_C(402013.25), EASYSIMD_FLOAT32_C(-229386.86), EASYSIMD_FLOAT32_C(275946.72), EASYSIMD_FLOAT32_C(109243.72) } },
    { { EASYSIMD_FLOAT32_C(  -503.83), EASYSIMD_FLOAT32_C(    16.75), EASYSIMD_FLOAT32_C(  -286.53), EASYSIMD_FLOAT32_C(    -6.86) },
      { EASYSIMD_FLOAT32_C(   487.42), EASYSIMD_FLOAT32_C(  -978.12), EASYSIMD_FLOAT32_C(   184.61), EASYSIMD_FLOAT32_C(    84.33) },
      { EASYSIMD_FLOAT32_C(  -391.38), EASYSIMD_FLOAT32_C(   -98.19), EASYSIMD_FLOAT32_C(   169.27), EASYSIMD_FLOAT32_C(   121.90) },
      { EASYSIMD_FLOAT32_C(190262.62), EASYSIMD_FLOAT32_C(-96024.85), EASYSIMD_FLOAT32_C(-31535.46), EASYSIMD_FLOAT32_C(-10286.69) } },
    { { EASYSIMD_FLOAT32_C(  -689.25), EASYSIMD_FLOAT32_C(   298.04), EASYSIMD_FLOAT32_C(  -359.33), EASYSIMD_FLOAT32_C(  -704.86) },
      { EASYSIMD_FLOAT32_C(   881.65), EASYSIMD_FLOAT32_C(  -405.49), EASYSIMD_FLOAT32_C(   -43.29), EASYSIMD_FLOAT32_C(  -527.87) },
      { EASYSIMD_FLOAT32_C(  -206.39), EASYSIMD_FLOAT32_C(  -934.10), EASYSIMD_FLOAT32_C(   484.22), EASYSIMD_FLOAT32_C(  -677.86) },
      { EASYSIMD_FLOAT32_C(181274.50), EASYSIMD_FLOAT32_C(-378470.16), EASYSIMD_FLOAT32_C( 20602.55), EASYSIMD_FLOAT32_C(-358526.81) } },
    { { EASYSIMD_FLOAT32_C(  -818.31), EASYSIMD_FLOAT32_C(   570.75), EASYSIMD_FLOAT32_C(   873.62), EASYSIMD_FLOAT32_C(  -579.71) },
      { EASYSIMD_FLOAT32_C(  -687.77), EASYSIMD_FLOAT32_C(   175.59), EASYSIMD_FLOAT32_C(   222.23), EASYSIMD_FLOAT32_C(  -191.61) },
      { EASYSIMD_FLOAT32_C(  -807.66), EASYSIMD_FLOAT32_C(   935.69), EASYSIMD_FLOAT32_C(   801.53), EASYSIMD_FLOAT32_C(   679.76) },
      { EASYSIMD_FLOAT32_C(-556302.62), EASYSIMD_FLOAT32_C(-163727.05), EASYSIMD_FLOAT32_C(-177250.39), EASYSIMD_FLOAT32_C(129669.10) } },
    { { EASYSIMD_FLOAT32_C(   957.58), EASYSIMD_FLOAT32_C(   -13.85), EASYSIMD_FLOAT32_C(  -235.91), EASYSIMD_FLOAT32_C(  -433.81) },
      { EASYSIMD_FLOAT32_C(   887.96), EASYSIMD_FLOAT32_C(   933.36), EASYSIMD_FLOAT32_C(   688.09), EASYSIMD_FLOAT32_C(  -801.30) },
      { EASYSIMD_FLOAT32_C(   231.40), EASYSIMD_FLOAT32_C(  -671.24), EASYSIMD_FLOAT32_C(  -506.16), EASYSIMD_FLOAT32_C(   113.05) },
      { EASYSIMD_FLOAT32_C(-204516.36), EASYSIMD_FLOAT32_C(626494.69), EASYSIMD_FLOAT32_C(348047.75), EASYSIMD_FLOAT32_C( 90153.16) } },
    { { EASYSIMD_FLOAT32_C(   -76.73), EASYSIMD_FLOAT32_C(   450.55), EASYSIMD_FLOAT32_C(   585.19), EASYSIMD_FLOAT32_C(   716.88) },
      { EASYSIMD_FLOAT32_C(   516.45), EASYSIMD_FLOAT32_C(    69.40), EASYSIMD_FLOAT32_C(  -960.98), EASYSIMD_FLOAT32_C(   698.14) },
      { EASYSIMD_FLOAT32_C(  -359.85), EASYSIMD_FLOAT32_C(   912.64), EASYSIMD_FLOAT32_C(  -881.57), EASYSIMD_FLOAT32_C(   -47.62) },
      { EASYSIMD_FLOAT32_C(185767.81), EASYSIMD_FLOAT32_C(-62886.67), EASYSIMD_FLOAT32_C(-846585.94), EASYSIMD_FLOAT32_C( 33962.30) } },
    { { EASYSIMD_FLOAT32_C(    88.23), EASYSIMD_FLOAT32_C(   340.65), EASYSIMD_FLOAT32_C(   760.78), EASYSIMD_FLOAT32_C(   280.57) },
      { EASYSIMD_FLOAT32_C(   276.34), EASYSIMD_FLOAT32_C(   562.31), EASYSIMD_FLOAT32_C(   -39.67), EASYSIMD_FLOAT32_C(   233.92) },
      { EASYSIMD_FLOAT32_C(  -451.55), EASYSIMD_FLOAT32_C(   724.42), EASYSIMD_FLOAT32_C(   800.11), EASYSIMD_FLOAT32_C(  -563.59) },
      { EASYSIMD_FLOAT32_C(124869.55), EASYSIMD_FLOAT32_C(-407007.94), EASYSIMD_FLOAT32_C( 32501.14), EASYSIMD_FLOAT32_C(132115.55) } }
  };
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_float32x4_t r = easysimd_vmlsq_f32(a, b, c);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_float32x4_t c = easysimd_test_arm_neon_random_f32x4(-1000.0, 1000.0);
    easysimd_float32x4_t r = easysimd_vmlsq_f32(a, b, c);
...
static int
test_easysimd_vmlsq_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    ...
    { { EASYSIMD_FLOAT64_C(   657.78), EASYSIMD_FLOAT64_C(   488.21) },
      { EASYSIMD_FLOAT64_C(  -364.89), EASYSIMD_FLOAT64_C(  -110.82) },
      { EASYSIMD_FLOAT64_C(   816.97), EASYSIMD_FLOAT64_C(   128.95) },
      { EASYSIMD_FLOAT64_C(298761.96), EASYSIMD_FLOAT64_C( 14778.45) } },
    { { EASYSIMD_FLOAT64_C(  -997.76), EASYSIMD_FLOAT64_C(  -259.76) },
      { EASYSIMD_FLOAT64_C(  -420.50), EASYSIMD_FLOAT64_C(   587.42) },
      { EASYSIMD_FLOAT64_C(  -542.88), EASYSIMD_FLOAT64_C(  -904.05) },
      { EASYSIMD_FLOAT64_C(-229278.80), EASYSIMD_FLOAT64_C(530797.29) } },
    { { EASYSIMD_FLOAT64_C(  -343.18), EASYSIMD_FLOAT64_C(  -503.86) },
      { EASYSIMD_FLOAT64_C(   794.08), EASYSIMD_FLOAT64_C(   296.98) },
      { EASYSIMD_FLOAT64_C(  -591.22), EASYSIMD_FLOAT64_C(   912.51) },
      { EASYSIMD_FLOAT64_C(469132.80), EASYSIMD_FLOAT64_C(-271501.08) } },
    { { EASYSIMD_FLOAT64_C(  -750.64), EASYSIMD_FLOAT64_C(   497.01) },
      { EASYSIMD_FLOAT64_C(   253.16), EASYSIMD_FLOAT64_C(  -989.86) },
      { EASYSIMD_FLOAT64_C(  -222.42), EASYSIMD_FLOAT64_C(  -470.49) },
      { EASYSIMD_FLOAT64_C( 55557.21), EASYSIMD_FLOAT64_C(-465222.22) } },
    { { EASYSIMD_FLOAT64_C(   572.44), EASYSIMD_FLOAT64_C(   737.91) },
      { EASYSIMD_FLOAT64_C(   763.43), EASYSIMD_FLOAT64_C(  -879.10) },
      { EASYSIMD_FLOAT64_C(   462.33), EASYSIMD_FLOAT64_C(   563.54) },
      { EASYSIMD_FLOAT64_C(-352384.15), EASYSIMD_FLOAT64_C(496145.92) } },
    { { EASYSIMD_FLOAT64_C(  -442.69), EASYSIMD_FLOAT64_C(   120.11) },
      { EASYSIMD_FLOAT64_C(    51.75), EASYSIMD_FLOAT64_C(   192.42) },
      { EASYSIMD_FLOAT64_C(  -990.71), EASYSIMD_FLOAT64_C(  -131.28) },
      { EASYSIMD_FLOAT64_C( 50826.55), EASYSIMD_FLOAT64_C( 25381.01) } },
    { { EASYSIMD_FLOAT64_C(  -678.63), EASYSIMD_FLOAT64_C(  -988.47) },
      { EASYSIMD_FLOAT64_C(   608.96), EASYSIMD_FLOAT64_C(   -99.13) },
      { EASYSIMD_FLOAT64_C(   598.95), EASYSIMD_FLOAT64_C(  -933.92) },
      { EASYSIMD_FLOAT64_C(-365415.22), EASYSIMD_FLOAT64_C(-93567.96) } },
    { { EASYSIMD_FLOAT64_C(    -3.18), EASYSIMD_FLOAT64_C(  -744.22) },
      { EASYSIMD_FLOAT64_C(  -437.78), EASYSIMD_FLOAT64_C(  -209.09) },
      { EASYSIMD_FLOAT64_C(   552.75), EASYSIMD_FLOAT64_C(   -29.00) },
      { EASYSIMD_FLOAT64_C(241979.71), EASYSIMD_FLOAT64_C( -6807.83) } }
  };
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_float64x2_t r = easysimd_vmlsq_f64(a, b, c);
...
static int
test_easysimd_vmlsq_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int8_t a[16];
    int8_t b[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int8x16_t r = easysimd_vmlsq_s8(a, b, c);
...
static int
test_easysimd_vmlsq_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int16_t a[8];
    int16_t b[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int16x8_t r = easysimd_vmlsq_s16(a, b, c);
...
static int
test_easysimd_vmlsq_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t a[4];
    int32_t b[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x4_t r = easysimd_vmlsq_s32(a, b, c);
...
static int
test_easysimd_vmlsq_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint8_t a[16];
    uint8_t b[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x16_t r = easysimd_vmlsq_u8(a, b, c);
...
static int
test_easysimd_vmlsq_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint16_t a[8];
    uint16_t b[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x8_t r = easysimd_vmlsq_u16(a, b, c);
...
static int
test_easysimd_vmlsq_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint32_t a[4];
    uint32_t b[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x4_t r = easysimd_vmlsq_u32(a, b, c);
...
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmls_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmls_f64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmls_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmls_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmls_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmls_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmls_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmls_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmlsq_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmlsq_f64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmlsq_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmlsq_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmlsq_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmlsq_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmlsq_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmlsq_u32)
