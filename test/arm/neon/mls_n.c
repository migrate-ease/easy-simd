#define EASYSIMD_TEST_ARM_NEON_INSN mls_n

#include "test-neon.h"
#include "../../../easysimd/arm/neon/mls_n.h"

static int
test_easysimd_vmls_n_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    ...
    { { EASYSIMD_FLOAT32_C(  -647.13), EASYSIMD_FLOAT32_C(   366.97) },
      { EASYSIMD_FLOAT32_C(   527.74), EASYSIMD_FLOAT32_C(   503.00) },
      EASYSIMD_FLOAT32_C(   833.05),
      { EASYSIMD_FLOAT32_C(-440280.91), EASYSIMD_FLOAT32_C(-418657.19) } },
    { { EASYSIMD_FLOAT32_C(   812.52), EASYSIMD_FLOAT32_C(  -705.38) },
      { EASYSIMD_FLOAT32_C(   240.26), EASYSIMD_FLOAT32_C(  -162.82) },
      EASYSIMD_FLOAT32_C(  -435.62),
      { EASYSIMD_FLOAT32_C(105474.58), EASYSIMD_FLOAT32_C(-71633.03) } },
    { { EASYSIMD_FLOAT32_C(   542.21), EASYSIMD_FLOAT32_C(  -924.21) },
      { EASYSIMD_FLOAT32_C(   795.16), EASYSIMD_FLOAT32_C(  -886.10) },
      EASYSIMD_FLOAT32_C(   343.92),
      { EASYSIMD_FLOAT32_C(-272929.22), EASYSIMD_FLOAT32_C(303823.28) } },
    { { EASYSIMD_FLOAT32_C(    27.23), EASYSIMD_FLOAT32_C(  -901.56) },
      { EASYSIMD_FLOAT32_C(  -640.14), EASYSIMD_FLOAT32_C(  -584.65) },
      EASYSIMD_FLOAT32_C(   126.02),
      { EASYSIMD_FLOAT32_C( 80697.67), EASYSIMD_FLOAT32_C( 72776.03) } },
    { { EASYSIMD_FLOAT32_C(   958.88), EASYSIMD_FLOAT32_C(  -573.62) },
      { EASYSIMD_FLOAT32_C(  -928.01), EASYSIMD_FLOAT32_C(   687.70) },
      EASYSIMD_FLOAT32_C(   -84.58),
      { EASYSIMD_FLOAT32_C(-77532.20), EASYSIMD_FLOAT32_C( 57592.05) } },
    { { EASYSIMD_FLOAT32_C(   252.63), EASYSIMD_FLOAT32_C(  -744.64) },
      { EASYSIMD_FLOAT32_C(   832.67), EASYSIMD_FLOAT32_C(  -922.69) },
      EASYSIMD_FLOAT32_C(  -514.34),
      { EASYSIMD_FLOAT32_C(428528.12), EASYSIMD_FLOAT32_C(-475321.03) } },
    { { EASYSIMD_FLOAT32_C(  -765.80), EASYSIMD_FLOAT32_C(  -569.82) },
      { EASYSIMD_FLOAT32_C(   852.63), EASYSIMD_FLOAT32_C(   761.94) },
      EASYSIMD_FLOAT32_C(   933.18),
      { EASYSIMD_FLOAT32_C(-796423.06), EASYSIMD_FLOAT32_C(-711597.00) } },
    { { EASYSIMD_FLOAT32_C(   685.68), EASYSIMD_FLOAT32_C(   574.46) },
      { EASYSIMD_FLOAT32_C(  -772.20), EASYSIMD_FLOAT32_C(   -74.06) },
      EASYSIMD_FLOAT32_C(  -588.35),
      { EASYSIMD_FLOAT32_C(-453638.16), EASYSIMD_FLOAT32_C(-42998.74) } }
  };
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_float32x2_t r = easysimd_vmls_n_f32(a, b, c);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_float32 c = easysimd_test_codegen_random_f32(-1000.0f, 1000.0f);
    easysimd_float32x2_t r = easysimd_vmls_n_f32(a, b, c);
...
static int
test_easysimd_vmls_n_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int16_t a[4];
    int16_t b[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int16x4_t r = easysimd_vmls_n_s16(a, b, c);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    int16_t c = easysimd_test_codegen_random_i16();
    easysimd_int16x4_t r = easysimd_vmls_n_s16(a, b, c);
    ...
    easysimd_test_codegen_write_i16(2, c, EASYSIMD_TEST_VEC_POS_MIDDLE);
...
static int
test_easysimd_vmls_n_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t a[2];
    int32_t b[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x2_t r = easysimd_vmls_n_s32(a, b, c);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    int32_t c = easysimd_test_codegen_random_i32();
    easysimd_int32x2_t r = easysimd_vmls_n_s32(a, b, c);
    ...
    easysimd_test_codegen_write_i32(2, c, EASYSIMD_TEST_VEC_POS_MIDDLE);
...
static int
test_easysimd_vmls_n_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint16_t a[4];
    uint16_t b[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x4_t r = easysimd_vmls_n_u16(a, b, c);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    uint16_t c = easysimd_test_codegen_random_u16();
    easysimd_uint16x4_t r = easysimd_vmls_n_u16(a, b, c);
    ...
    easysimd_test_codegen_write_u16(2, c, EASYSIMD_TEST_VEC_POS_MIDDLE);
...
static int
test_easysimd_vmls_n_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint32_t a[2];
    uint32_t b[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x2_t r = easysimd_vmls_n_u32(a, b, c);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    uint32_t c = easysimd_test_codegen_random_u32();
    easysimd_uint32x2_t r = easysimd_vmls_n_u32(a, b, c);
    ...
    easysimd_test_codegen_write_u32(2, c, EASYSIMD_TEST_VEC_POS_MIDDLE);
...
static int
test_easysimd_vmlsq_n_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    ...
    { { EASYSIMD_FLOAT32_C(  -610.67), EASYSIMD_FLOAT32_C(  -418.32), EASYSIMD_FLOAT32_C(   241.04), EASYSIMD_FLOAT32_C(  -742.03) },
      { EASYSIMD_FLOAT32_C(   299.89), EASYSIMD_FLOAT32_C(   809.28), EASYSIMD_FLOAT32_C(   909.30), EASYSIMD_FLOAT32_C(  -915.75) },
      EASYSIMD_FLOAT32_C(  -135.47),
      { EASYSIMD_FLOAT32_C( 40015.43), EASYSIMD_FLOAT32_C(109214.84), EASYSIMD_FLOAT32_C(123423.91), EASYSIMD_FLOAT32_C(-124798.69) } },
    { { EASYSIMD_FLOAT32_C(   356.62), EASYSIMD_FLOAT32_C(  -395.86), EASYSIMD_FLOAT32_C(   488.21), EASYSIMD_FLOAT32_C(   856.70) },
      { EASYSIMD_FLOAT32_C(   660.83), EASYSIMD_FLOAT32_C(   136.39), EASYSIMD_FLOAT32_C(  -671.61), EASYSIMD_FLOAT32_C(   269.07) },
      EASYSIMD_FLOAT32_C(  -547.11),
      { EASYSIMD_FLOAT32_C(361903.31), EASYSIMD_FLOAT32_C( 74224.47), EASYSIMD_FLOAT32_C(-366956.31), EASYSIMD_FLOAT32_C(148067.59) } },
    { { EASYSIMD_FLOAT32_C(   205.06), EASYSIMD_FLOAT32_C(   798.89), EASYSIMD_FLOAT32_C(   952.13), EASYSIMD_FLOAT32_C(   281.01) },
      { EASYSIMD_FLOAT32_C(   151.61), EASYSIMD_FLOAT32_C(   903.69), EASYSIMD_FLOAT32_C(  -949.31), EASYSIMD_FLOAT32_C(   576.79) },
      EASYSIMD_FLOAT32_C(   114.60),
      { EASYSIMD_FLOAT32_C(-17169.45), EASYSIMD_FLOAT32_C(-102763.98), EASYSIMD_FLOAT32_C(109743.05), EASYSIMD_FLOAT32_C(-65819.12) } },
    { { EASYSIMD_FLOAT32_C(   529.72), EASYSIMD_FLOAT32_C(   899.70), EASYSIMD_FLOAT32_C(  -645.73), EASYSIMD_FLOAT32_C(  -185.54) },
      { EASYSIMD_FLOAT32_C(  -710.98), EASYSIMD_FLOAT32_C(   -64.06), EASYSIMD_FLOAT32_C(  -944.50), EASYSIMD_FLOAT32_C(  -453.01) },
      EASYSIMD_FLOAT32_C(  -764.17),
      { EASYSIMD_FLOAT32_C(-542779.81), EASYSIMD_FLOAT32_C(-48053.03), EASYSIMD_FLOAT32_C(-722404.31), EASYSIMD_FLOAT32_C(-346362.19) } },
    { { EASYSIMD_FLOAT32_C(   864.78), EASYSIMD_FLOAT32_C(  -543.71), EASYSIMD_FLOAT32_C(  -679.92), EASYSIMD_FLOAT32_C(  -270.68) },
      { EASYSIMD_FLOAT32_C(   812.92), EASYSIMD_FLOAT32_C(   -75.78), EASYSIMD_FLOAT32_C(  -782.47), EASYSIMD_FLOAT32_C(   669.62) },
      EASYSIMD_FLOAT32_C(  -414.96),
      { EASYSIMD_FLOAT32_C(338194.06), EASYSIMD_FLOAT32_C(-31989.38), EASYSIMD_FLOAT32_C(-325373.62), EASYSIMD_FLOAT32_C(277594.81) } },
    { { EASYSIMD_FLOAT32_C(   353.92), EASYSIMD_FLOAT32_C(   998.00), EASYSIMD_FLOAT32_C(   854.11), EASYSIMD_FLOAT32_C(   806.81) },
      { EASYSIMD_FLOAT32_C(   203.06), EASYSIMD_FLOAT32_C(   653.00), EASYSIMD_FLOAT32_C(   758.94), EASYSIMD_FLOAT32_C(  -515.93) },
      EASYSIMD_FLOAT32_C(  -195.39),
      { EASYSIMD_FLOAT32_C( 40029.82), EASYSIMD_FLOAT32_C(128587.67), EASYSIMD_FLOAT32_C(149143.39), EASYSIMD_FLOAT32_C(-100000.75) } },
    { { EASYSIMD_FLOAT32_C(   662.63), EASYSIMD_FLOAT32_C(  -465.25), EASYSIMD_FLOAT32_C(  -618.60), EASYSIMD_FLOAT32_C(  -222.77) },
      { EASYSIMD_FLOAT32_C(  -935.53), EASYSIMD_FLOAT32_C(  -718.90), EASYSIMD_FLOAT32_C(   131.50), EASYSIMD_FLOAT32_C(  -121.07) },
      EASYSIMD_FLOAT32_C(  -429.88),
      { EASYSIMD_FLOAT32_C(-401503.03), EASYSIMD_FLOAT32_C(-309506.00), EASYSIMD_FLOAT32_C( 55910.62), EASYSIMD_FLOAT32_C(-52268.34) } },
    { { EASYSIMD_FLOAT32_C(  -932.56), EASYSIMD_FLOAT32_C(   -65.57), EASYSIMD_FLOAT32_C(   117.12), EASYSIMD_FLOAT32_C(  -696.73) },
      { EASYSIMD_FLOAT32_C(  -200.78), EASYSIMD_FLOAT32_C(   573.41), EASYSIMD_FLOAT32_C(  -376.65), EASYSIMD_FLOAT32_C(   528.53) },
      EASYSIMD_FLOAT32_C(   386.33),
      { EASYSIMD_FLOAT32_C( 76634.77), EASYSIMD_FLOAT32_C(-221591.03), EASYSIMD_FLOAT32_C(145628.31), EASYSIMD_FLOAT32_C(-204883.73) } }
  };
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_float32 c = test_vec[i].c;
    easysimd_float32x4_t r = easysimd_vmlsq_n_f32(a, b, c);
...
static int
test_easysimd_vmlsq_n_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int16_t a[8];
    int16_t b[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    int16_t c = test_vec[i].c;
    easysimd_int16x8_t r = easysimd_vmlsq_n_s16(a, b, c);
...
static int
test_easysimd_vmlsq_n_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t a[4];
    int32_t b[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    int32_t c = test_vec[i].c;
    easysimd_int32x4_t r = easysimd_vmlsq_n_s32(a, b, c);
...
static int
test_easysimd_vmlsq_n_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint16_t a[8];
    uint16_t b[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    uint16_t c = test_vec[i].c;
    easysimd_uint16x8_t r = easysimd_vmlsq_n_u16(a, b, c);
...
static int
test_easysimd_vmlsq_n_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint32_t a[4];
    uint32_t b[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    uint32_t c = test_vec[i].c;
    easysimd_uint32x4_t r = easysimd_vmlsq_n_u32(a, b, c);
...
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmls_n_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmls_n_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmls_n_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmls_n_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmls_n_u32)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vmlsq_n_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmlsq_n_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmlsq_n_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmlsq_n_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmlsq_n_u32)
