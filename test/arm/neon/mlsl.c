#define EASYSIMD_TEST_ARM_NEON_INSN mlsl

#include "test-neon.h"
#include "../../../easysimd/arm/neon/mlsl.h"

static int
test_easysimd_vmlsl_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int16_t a[8];
    int8_t b[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int16x8_t r = easysimd_vmlsl_s8(a, b, c);
...
static int
test_easysimd_vmlsl_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t a[8];
    int16_t b[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x4_t r = easysimd_vmlsl_s16(a, b, c);
...
static int
test_easysimd_vmlsl_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int64_t a[8];
    int32_t b[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int64x2_t r = easysimd_vmlsl_s32(a, b, c);
...
static int
test_easysimd_vmlsl_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint16_t a[8];
    uint8_t b[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x8_t r = easysimd_vmlsl_u8(a, b, c);
...
static int
test_easysimd_vmlsl_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint32_t a[8];
    uint16_t b[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x4_t r = easysimd_vmlsl_u16(a, b, c);
...
static int
test_easysimd_vmlsl_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint64_t a[8];
    uint32_t b[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint64x2_t r = easysimd_vmlsl_u32(a, b, c);
...
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmlsl_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmlsl_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmlsl_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmlsl_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmlsl_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmlsl_u32)
