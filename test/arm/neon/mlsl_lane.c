...
#define EASYSIMD_TEST_ARM_NEON_INSN mlsl_lane

#include "test-neon.h"
#include "../../../easysimd/arm/neon/mlsl_lane.h"

static int
test_easysimd_vmlsl_lane_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t a[4];
    int16_t b[4];
    ...
    r = easysimd_vmlsl_lane_s16(a, b, v, 2);
    ...
    r = easysimd_vmlsl_lane_s16(a, b, v, 1);
    ...
    r = easysimd_vmlsl_lane_s16(a, b, v, 0);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    EASYSIMD_CONSTIFY_4_(easysimd_vmlsl_lane_s16, r, (HEDLEY_UNREACHABLE(), easysimd_vdupq_n_s32(0)), lane, a, b, v);
...
static int
test_easysimd_vmlsl_lane_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int64_t a[2];
    int32_t b[2];
    ...
    r = easysimd_vmlsl_lane_s32(a, b, v, 1);
    ...
    r = easysimd_vmlsl_lane_s32(a, b, v, 0);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    EASYSIMD_CONSTIFY_2_(easysimd_vmlsl_lane_s32, r, (HEDLEY_UNREACHABLE(), easysimd_vdupq_n_s64(0)), lane, a, b, v);
...
static int
test_easysimd_vmlsl_lane_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint32_t a[4];
    uint16_t b[4];
    ...
    r = easysimd_vmlsl_lane_u16(a, b, v, 3);
    ...
    r = easysimd_vmlsl_lane_u16(a, b, v, 0);
    ...
    r = easysimd_vmlsl_lane_u16(a, b, v, 2);
    ...
    r = easysimd_vmlsl_lane_u16(a, b, v, 1);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    EASYSIMD_CONSTIFY_4_(easysimd_vmlsl_lane_u16, r, (HEDLEY_UNREACHABLE(), easysimd_vdupq_n_u32(0)), lane, a, b, v);
...
static int
test_easysimd_vmlsl_lane_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint64_t a[2];
    uint32_t b[2];
    ...
    r = easysimd_vmlsl_lane_u32(a, b, v, 0);
    ...
    r = easysimd_vmlsl_lane_u32(a, b, v, 1);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    EASYSIMD_CONSTIFY_2_(easysimd_vmlsl_lane_u32, r, (HEDLEY_UNREACHABLE(), easysimd_vdupq_n_u64(0)), lane, a, b, v);
...
static int
test_easysimd_vmlsl_laneq_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t a[4];
    int16_t b[4];
    ...
    r = easysimd_vmlsl_laneq_s16(a, b, v, 2);
    easysimd_test_arm_neon_assert_equal_i32x4(r, easysimd_vld1q_s32(test_vec[0].r));

    a = easysimd_vld1q_s32(test_vec[1].a);
    b = easysimd_vld1_s16(test_vec[1].b);
    v = easysimd_vld1q_s16(test_vec[1].v);
    r = easysimd_vmlsl_laneq_s16(a, b, v, 4);
    easysimd_test_arm_neon_assert_equal_i32x4(r, easysimd_vld1q_s32(test_vec[1].r));
    ...
    r = easysimd_vmlsl_laneq_s16(a, b, v, 3);
    easysimd_test_arm_neon_assert_equal_i32x4(r, easysimd_vld1q_s32(test_vec[5].r));
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    EASYSIMD_CONSTIFY_8_(easysimd_vmlsl_laneq_s16, r, (HEDLEY_UNREACHABLE(), easysimd_vdupq_n_s32(0)), lane, a, b, v);
...
static int
test_easysimd_vmlsl_laneq_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int64_t a[2];
    int32_t b[2];
    ...
    r = easysimd_vmlsl_laneq_s32(a, b, v, 2);
    easysimd_test_arm_neon_assert_equal_i64x2(r, easysimd_vld1q_s64(test_vec[0].r));

    a = easysimd_vld1q_s64(test_vec[1].a);
    b = easysimd_vld1_s32(test_vec[1].b);
    v = easysimd_vld1q_s32(test_vec[1].v);
    r = easysimd_vmlsl_laneq_s32(a, b, v, 0);
    easysimd_test_arm_neon_assert_equal_i64x2(r, easysimd_vld1q_s64(test_vec[1].r));

    a = easysimd_vld1q_s64(test_vec[2].a);
    b = easysimd_vld1_s32(test_vec[2].b);
    v = easysimd_vld1q_s32(test_vec[2].v);
    r = easysimd_vmlsl_laneq_s32(a, b, v, 3);
    easysimd_test_arm_neon_assert_equal_i64x2(r, easysimd_vld1q_s64(test_vec[2].r));
    ...
    r = easysimd_vmlsl_laneq_s32(a, b, v, 1);
    easysimd_test_arm_neon_assert_equal_i64x2(r, easysimd_vld1q_s64(test_vec[5].r));
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    EASYSIMD_CONSTIFY_4_(easysimd_vmlsl_laneq_s32, r, (HEDLEY_UNREACHABLE(), easysimd_vdupq_n_s64(0)), lane, a, b, v);
...
static int
test_easysimd_vmlsl_laneq_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint32_t a[4];
    uint16_t b[4];
    ...
    r = easysimd_vmlsl_laneq_u16(a, b, v, 0);
    easysimd_test_arm_neon_assert_equal_u32x4(r, easysimd_vld1q_u32(test_vec[0].r));

    a = easysimd_vld1q_u32(test_vec[1].a);
    b = easysimd_vld1_u16(test_vec[1].b);
    v = easysimd_vld1q_u16(test_vec[1].v);
    r = easysimd_vmlsl_laneq_u16(a, b, v, 4);
    easysimd_test_arm_neon_assert_equal_u32x4(r, easysimd_vld1q_u32(test_vec[1].r));

    a = easysimd_vld1q_u32(test_vec[2].a);
    b = easysimd_vld1_u16(test_vec[2].b);
    v = easysimd_vld1q_u16(test_vec[2].v);
    r = easysimd_vmlsl_laneq_u16(a, b, v, 6);
    easysimd_test_arm_neon_assert_equal_u32x4(r, easysimd_vld1q_u32(test_vec[2].r));
    ...
    r = easysimd_vmlsl_laneq_u16(a, b, v, 5);
    easysimd_test_arm_neon_assert_equal_u32x4(r, easysimd_vld1q_u32(test_vec[5].r));

    a = easysimd_vld1q_u32(test_vec[6].a);
    b = easysimd_vld1_u16(test_vec[6].b);
    v = easysimd_vld1q_u16(test_vec[6].v);
    r = easysimd_vmlsl_laneq_u16(a, b, v, 2);
    easysimd_test_arm_neon_assert_equal_u32x4(r, easysimd_vld1q_u32(test_vec[6].r));
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    EASYSIMD_CONSTIFY_8_(easysimd_vmlsl_laneq_u16, r, (HEDLEY_UNREACHABLE(), easysimd_vdupq_n_u32(0)), lane, a, b, v);
...
static int
test_easysimd_vmlsl_laneq_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint64_t a[2];
    uint32_t b[2];
    ...
    r = easysimd_vmlsl_laneq_u32(a, b, v, 3);
    easysimd_test_arm_neon_assert_equal_u64x2(r, easysimd_vld1q_u64(test_vec[0].r));
    ...
    r = easysimd_vmlsl_laneq_u32(a, b, v, 1);
    easysimd_test_arm_neon_assert_equal_u64x2(r, easysimd_vld1q_u64(test_vec[2].r));
    ...
    r = easysimd_vmlsl_laneq_u32(a, b, v, 0);
    easysimd_test_arm_neon_assert_equal_u64x2(r, easysimd_vld1q_u64(test_vec[7].r));
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    EASYSIMD_CONSTIFY_4_(easysimd_vmlsl_laneq_u32, r, (HEDLEY_UNREACHABLE(), easysimd_vdupq_n_u64(0)), lane, a, b, v);
...
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmlsl_lane_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmlsl_lane_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmlsl_lane_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmlsl_lane_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmlsl_laneq_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmlsl_laneq_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmlsl_laneq_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmlsl_laneq_u32)
