#define EASYSIMD_TEST_ARM_NEON_INSN movn_high

#include "test-neon.h"
#include "../../../easysimd/arm/neon/movn_high.h"

static int
test_easysimd_vmovn_high_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int8_t r[8];
    int16_t a[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int8x16_t res = easysimd_vmovn_high_s16(r, a);

    easysimd_test_arm_neon_assert_equal_i8x16(res, easysimd_vld1q_s8(test_vec[i].res));
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_test_arm_neon_write_i8x16(2, res, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
#endif
}
...
static int
test_easysimd_vmovn_high_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int16_t r[4];
    int32_t a[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int16x8_t res = easysimd_vmovn_high_s32(r, a);

    easysimd_test_arm_neon_assert_equal_i16x8(res, easysimd_vld1q_s16(test_vec[i].res));
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_test_arm_neon_write_i16x8(2, res, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
#endif
}
...
static int
test_easysimd_vmovn_high_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t r[2];
    int64_t a[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x4_t res = easysimd_vmovn_high_s64(r, a);

    easysimd_test_arm_neon_assert_equal_i32x4(res, easysimd_vld1q_s32(test_vec[i].res));
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_test_arm_neon_write_i32x4(2, res, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
#endif
}
...
static int
test_easysimd_vmovn_high_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint8_t r[8];
    uint16_t a[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x16_t res = easysimd_vmovn_high_u16(r, a);

    easysimd_test_arm_neon_assert_equal_u8x16(res, easysimd_vld1q_u8(test_vec[i].res));
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_test_arm_neon_write_u8x16(2, res, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
#endif
}
...
static int
test_easysimd_vmovn_high_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint16_t r[4];
    uint32_t a[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x8_t res = easysimd_vmovn_high_u32(r, a);

    easysimd_test_arm_neon_assert_equal_u16x8(res, easysimd_vld1q_u16(test_vec[i].res));
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_test_arm_neon_write_u16x8(2, res, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
#endif
}
...
static int
test_easysimd_vmovn_high_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint32_t r[2];
    uint64_t a[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x4_t res = easysimd_vmovn_high_u64(r, a);

    easysimd_test_arm_neon_assert_equal_u32x4(res, easysimd_vld1q_u32(test_vec[i].res));
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_test_arm_neon_write_u32x4(2, res, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
#endif
}
...
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmovn_high_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmovn_high_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmovn_high_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmovn_high_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmovn_high_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmovn_high_u64)
