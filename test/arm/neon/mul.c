#define EASYSIMD_TEST_ARM_NEON_INSN mul

#include "test-neon.h"
#include "../../../easysimd/arm/neon/mul.h"

static int
test_easysimd_vmul_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    easysimd_float32 a[2];
    easysimd_float32 b[2];
    easysimd_float32 r[2];
  } test_vec[] = {
    { { EASYSIMD_FLOAT32_C(  -984.85), EASYSIMD_FLOAT32_C(   239.90) },
      { EASYSIMD_FLOAT32_C(  -108.56), EASYSIMD_FLOAT32_C(   891.83) },
      { EASYSIMD_FLOAT32_C(106915.31), EASYSIMD_FLOAT32_C(213950.02) } },
    { { EASYSIMD_FLOAT32_C(   288.24), EASYSIMD_FLOAT32_C(  -869.25) },
      { EASYSIMD_FLOAT32_C(  -156.82), EASYSIMD_FLOAT32_C(   921.87) },
      { EASYSIMD_FLOAT32_C(-45201.80), EASYSIMD_FLOAT32_C(-801335.50) } },
    { { EASYSIMD_FLOAT32_C(  -879.78), EASYSIMD_FLOAT32_C(  -268.41) },
      { EASYSIMD_FLOAT32_C(  -165.21), EASYSIMD_FLOAT32_C(  -936.42) },
      { EASYSIMD_FLOAT32_C(145348.47), EASYSIMD_FLOAT32_C(251344.48) } },
    { { EASYSIMD_FLOAT32_C(   385.59), EASYSIMD_FLOAT32_C(  -229.84) },
      { EASYSIMD_FLOAT32_C(   996.35), EASYSIMD_FLOAT32_C(  -804.89) },
      { EASYSIMD_FLOAT32_C(384182.59), EASYSIMD_FLOAT32_C(184995.92) } },
    { { EASYSIMD_FLOAT32_C(   339.75), EASYSIMD_FLOAT32_C(  -605.97) },
      { EASYSIMD_FLOAT32_C(   882.89), EASYSIMD_FLOAT32_C(   300.48) },
      { EASYSIMD_FLOAT32_C(299961.88), EASYSIMD_FLOAT32_C(-182081.86) } },
    { { EASYSIMD_FLOAT32_C(  -227.17), EASYSIMD_FLOAT32_C(   998.92) },
      { EASYSIMD_FLOAT32_C(  -867.68), EASYSIMD_FLOAT32_C(   668.07) },
      { EASYSIMD_FLOAT32_C(197110.86), EASYSIMD_FLOAT32_C(667348.50) } },
    { { EASYSIMD_FLOAT32_C(   105.88), EASYSIMD_FLOAT32_C(  -369.44) },
      { EASYSIMD_FLOAT32_C(   748.88), EASYSIMD_FLOAT32_C(   812.67) },
      { EASYSIMD_FLOAT32_C( 79291.41), EASYSIMD_FLOAT32_C(-300232.81) } },
    { { EASYSIMD_FLOAT32_C(  -814.69), EASYSIMD_FLOAT32_C(   -31.04) },
      { EASYSIMD_FLOAT32_C(  -710.62), EASYSIMD_FLOAT32_C(  -799.54) },
      { EASYSIMD_FLOAT32_C(578935.00), EASYSIMD_FLOAT32_C( 24817.72) } }
  };
...
static int
test_easysimd_vmul_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    easysimd_float64 a[1];
    easysimd_float64 b[1];
    easysimd_float64 r[1];
  } test_vec[] = {
    { { EASYSIMD_FLOAT64_C(-859.012888) },
      { EASYSIMD_FLOAT64_C(808.899130) },
      { EASYSIMD_FLOAT64_C(-694854.777259) } },
    { { EASYSIMD_FLOAT64_C(-512.686665) },
      { EASYSIMD_FLOAT64_C(364.360016) },
      { EASYSIMD_FLOAT64_C(-186802.521685) } },
    { { EASYSIMD_FLOAT64_C(429.047777) },
      { EASYSIMD_FLOAT64_C(643.143308) },
      { EASYSIMD_FLOAT64_C(275939.206701) } },
    { { EASYSIMD_FLOAT64_C(515.485107) },
      { EASYSIMD_FLOAT64_C(158.472572) },
      { EASYSIMD_FLOAT64_C(81690.250725) } },
    { { EASYSIMD_FLOAT64_C(-433.956881) },
      { EASYSIMD_FLOAT64_C(78.045774) },
      { EASYSIMD_FLOAT64_C(-33868.500567) } },
    { { EASYSIMD_FLOAT64_C(-998.339714) },
      { EASYSIMD_FLOAT64_C(751.053657) },
      { EASYSIMD_FLOAT64_C(-749806.693756) } },
    { { EASYSIMD_FLOAT64_C(735.460464) },
      { EASYSIMD_FLOAT64_C(670.199813) },
      { EASYSIMD_FLOAT64_C(492905.465423) } },
    { { EASYSIMD_FLOAT64_C(190.192630) },
      { EASYSIMD_FLOAT64_C(-439.362447) },
      { EASYSIMD_FLOAT64_C(-83563.499287) } },
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float64x1_t a = easysimd_vld1_f64(test_vec[i].a);
    easysimd_float64x1_t b = easysimd_vld1_f64(test_vec[i].b);
    easysimd_float64x1_t r = easysimd_vmul_f64(a, b);
...
static int
test_easysimd_vmul_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int8_t a[8];
    int8_t b[8];
    int8_t r[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int8x8_t r = easysimd_vmul_s8(a, b);
...
static int
test_easysimd_vmul_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int16_t a[4];
    int16_t b[4];
    int16_t r[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int16x4_t r = easysimd_vmul_s16(a, b);
...
static int
test_easysimd_vmul_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int32_t a[2];
    int32_t b[2];
    int32_t r[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x2_t r = easysimd_vmul_s32(a, b);
...
static int
test_easysimd_x_vmul_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int64_t a[1];
    int64_t b[1];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int64x1_t r = easysimd_x_vmul_s64(a, b);
...
static int
test_easysimd_vmul_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint8_t a[16];
    uint8_t b[16];
    uint8_t r[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x8_t r = easysimd_vmul_u8(a, b);
...
static int
test_easysimd_vmul_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint16_t a[4];
    uint16_t b[4];
    uint16_t r[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x4_t r = easysimd_vmul_u16(a, b);
...
static int
test_easysimd_vmul_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint32_t a[2];
    uint32_t b[2];
    uint32_t r[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x2_t r = easysimd_vmul_u32(a, b);
...
static int
test_easysimd_x_vmul_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint64_t a[1];
    uint64_t b[1];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint64x1_t r = easysimd_x_vmul_u64(a, b);
...
static int
test_easysimd_vmulq_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    easysimd_float32 a[4];
    easysimd_float32 b[4];
    easysimd_float32 r[4];
  } test_vec[] = {
    { { EASYSIMD_FLOAT32_C(-875.908447), EASYSIMD_FLOAT32_C(-952.067810), EASYSIMD_FLOAT32_C(-835.896851), EASYSIMD_FLOAT32_C(-332.003418) },
      { EASYSIMD_FLOAT32_C(-353.433044), EASYSIMD_FLOAT32_C(411.022461), EASYSIMD_FLOAT32_C(-878.854858), EASYSIMD_FLOAT32_C(965.658569) },
      { EASYSIMD_FLOAT32_C(309575.000000), EASYSIMD_FLOAT32_C(-391321.250000), EASYSIMD_FLOAT32_C(734632.000000), EASYSIMD_FLOAT32_C(-320601.937500) } },
    { { EASYSIMD_FLOAT32_C(-818.029663), EASYSIMD_FLOAT32_C(-58.492615), EASYSIMD_FLOAT32_C(-314.083435), EASYSIMD_FLOAT32_C(-471.082703) },
      { EASYSIMD_FLOAT32_C(100.064087), EASYSIMD_FLOAT32_C(-957.928711), EASYSIMD_FLOAT32_C(680.392578), EASYSIMD_FLOAT32_C(301.457642) },
      { EASYSIMD_FLOAT32_C(-81855.390625), EASYSIMD_FLOAT32_C(56031.753906), EASYSIMD_FLOAT32_C(-213700.031250), EASYSIMD_FLOAT32_C(-142011.484375) } },
    { { EASYSIMD_FLOAT32_C(143.138428), EASYSIMD_FLOAT32_C(-445.185791), EASYSIMD_FLOAT32_C(108.660034), EASYSIMD_FLOAT32_C(-105.336975) },
      { EASYSIMD_FLOAT32_C(-543.193237), EASYSIMD_FLOAT32_C(437.742188), EASYSIMD_FLOAT32_C(569.496582), EASYSIMD_FLOAT32_C(-743.131836) },
      { EASYSIMD_FLOAT32_C(-77751.828125), EASYSIMD_FLOAT32_C(-194876.609375), EASYSIMD_FLOAT32_C(61881.519531), EASYSIMD_FLOAT32_C(78279.257812) } },
    { { EASYSIMD_FLOAT32_C(-259.595825), EASYSIMD_FLOAT32_C(409.617432), EASYSIMD_FLOAT32_C(718.381958), EASYSIMD_FLOAT32_C(310.151978) },
      { EASYSIMD_FLOAT32_C(521.223389), EASYSIMD_FLOAT32_C(-42.746582), EASYSIMD_FLOAT32_C(-267.409790), EASYSIMD_FLOAT32_C(645.314941) },
      { EASYSIMD_FLOAT32_C(-135307.421875), EASYSIMD_FLOAT32_C(-17509.746094), EASYSIMD_FLOAT32_C(-192102.375000), EASYSIMD_FLOAT32_C(200145.703125) } },
    { { EASYSIMD_FLOAT32_C(5.185669), EASYSIMD_FLOAT32_C(-103.306641), EASYSIMD_FLOAT32_C(-686.688354), EASYSIMD_FLOAT32_C(651.752686) },
      { EASYSIMD_FLOAT32_C(-692.284058), EASYSIMD_FLOAT32_C(-565.543213), EASYSIMD_FLOAT32_C(617.411255), EASYSIMD_FLOAT32_C(-510.313782) },
      { EASYSIMD_FLOAT32_C(-3589.956055), EASYSIMD_FLOAT32_C(58424.371094), EASYSIMD_FLOAT32_C(-423969.125000), EASYSIMD_FLOAT32_C(-332598.375000) } },
    { { EASYSIMD_FLOAT32_C(375.964233), EASYSIMD_FLOAT32_C(-696.671997), EASYSIMD_FLOAT32_C(18.603516), EASYSIMD_FLOAT32_C(-523.971558) },
      { EASYSIMD_FLOAT32_C(-654.600769), EASYSIMD_FLOAT32_C(-301.003845), EASYSIMD_FLOAT32_C(777.486084), EASYSIMD_FLOAT32_C(488.537720) },
      { EASYSIMD_FLOAT32_C(-246106.468750), EASYSIMD_FLOAT32_C(209700.953125), EASYSIMD_FLOAT32_C(14463.974609), EASYSIMD_FLOAT32_C(-255979.875000) } },
    { { EASYSIMD_FLOAT32_C(253.810303), EASYSIMD_FLOAT32_C(-113.853699), EASYSIMD_FLOAT32_C(-616.799194), EASYSIMD_FLOAT32_C(710.617065) },
      { EASYSIMD_FLOAT32_C(-676.111450), EASYSIMD_FLOAT32_C(952.697266), EASYSIMD_FLOAT32_C(967.485229), EASYSIMD_FLOAT32_C(64.292725) },
      { EASYSIMD_FLOAT32_C(-171604.046875), EASYSIMD_FLOAT32_C(-108468.109375), EASYSIMD_FLOAT32_C(-596744.125000), EASYSIMD_FLOAT32_C(45687.507812) } },
    { { EASYSIMD_FLOAT32_C(362.314941), EASYSIMD_FLOAT32_C(685.867310), EASYSIMD_FLOAT32_C(-625.555176), EASYSIMD_FLOAT32_C(-116.461548) },
      { EASYSIMD_FLOAT32_C(-356.879150), EASYSIMD_FLOAT32_C(107.035034), EASYSIMD_FLOAT32_C(-471.146545), EASYSIMD_FLOAT32_C(648.306519) },
      { EASYSIMD_FLOAT32_C(-129302.648438), EASYSIMD_FLOAT32_C(73411.828125), EASYSIMD_FLOAT32_C(294728.156250), EASYSIMD_FLOAT32_C(-75502.781250) } },
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float32x4_t a = easysimd_vld1q_f32(test_vec[i].a);
    easysimd_float32x4_t b = easysimd_vld1q_f32(test_vec[i].b);
    easysimd_float32x4_t r = easysimd_vmulq_f32(a, b);
...
static int
test_easysimd_vmulq_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    easysimd_float64 a[2];
    easysimd_float64 b[2];
    easysimd_float64 r[2];
  } test_vec[] = {
    { { EASYSIMD_FLOAT64_C(-110.548430), EASYSIMD_FLOAT64_C(608.512841) },
      { EASYSIMD_FLOAT64_C(736.040173), EASYSIMD_FLOAT64_C(-280.442189) },
      { EASYSIMD_FLOAT64_C(-81368.085325), EASYSIMD_FLOAT64_C(-170652.673215) } },
    { { EASYSIMD_FLOAT64_C(-149.158503), EASYSIMD_FLOAT64_C(-505.167299) },
      { EASYSIMD_FLOAT64_C(-802.637817), EASYSIMD_FLOAT64_C(-512.437647) },
      { EASYSIMD_FLOAT64_C(119720.254897), EASYSIMD_FLOAT64_C(258866.741888) } },
    { { EASYSIMD_FLOAT64_C(-15.761167), EASYSIMD_FLOAT64_C(-532.799363) },
      { EASYSIMD_FLOAT64_C(-516.739889), EASYSIMD_FLOAT64_C(-825.864527) },
      { EASYSIMD_FLOAT64_C(8144.423830), EASYSIMD_FLOAT64_C(440020.093999) } },
    { { EASYSIMD_FLOAT64_C(-142.146788), EASYSIMD_FLOAT64_C(-460.594133) },
      { EASYSIMD_FLOAT64_C(887.546627), EASYSIMD_FLOAT64_C(-409.867550) },
      { EASYSIMD_FLOAT64_C(-126161.902322), EASYSIMD_FLOAT64_C(188782.588915) } },
    { { EASYSIMD_FLOAT64_C(-230.600942), EASYSIMD_FLOAT64_C(-52.274368) },
      { EASYSIMD_FLOAT64_C(150.986619), EASYSIMD_FLOAT64_C(67.500747) },
      { EASYSIMD_FLOAT64_C(-34817.656482), EASYSIMD_FLOAT64_C(-3528.558923) } },
    { { EASYSIMD_FLOAT64_C(389.471275), EASYSIMD_FLOAT64_C(-747.723748) },
      { EASYSIMD_FLOAT64_C(-950.827661), EASYSIMD_FLOAT64_C(917.085530) },
      { EASYSIMD_FLOAT64_C(-370320.061840), EASYSIMD_FLOAT64_C(-685726.629746) } },
    { { EASYSIMD_FLOAT64_C(352.081057), EASYSIMD_FLOAT64_C(409.278147) },
      { EASYSIMD_FLOAT64_C(684.852159), EASYSIMD_FLOAT64_C(-854.134726) },
      { EASYSIMD_FLOAT64_C(241123.472398), EASYSIMD_FLOAT64_C(-349578.677755) } },
    { { EASYSIMD_FLOAT64_C(-169.233569), EASYSIMD_FLOAT64_C(-633.363110) },
      { EASYSIMD_FLOAT64_C(-43.526636), EASYSIMD_FLOAT64_C(720.218002) },
      { EASYSIMD_FLOAT64_C(7366.167936), EASYSIMD_FLOAT64_C(-456159.513343) } },
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float64x2_t a = easysimd_vld1q_f64(test_vec[i].a);
    easysimd_float64x2_t b = easysimd_vld1q_f64(test_vec[i].b);
    easysimd_float64x2_t r = easysimd_vmulq_f64(a, b);
...
static int
test_easysimd_vmulq_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int8_t a[16];
    int8_t b[16];
    int8_t r[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int8x16_t r = easysimd_vmulq_s8(a, b);
...
static int
test_easysimd_vmulq_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int16_t a[8];
    int16_t b[8];
    int16_t r[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int16x8_t r = easysimd_vmulq_s16(a, b);
...
static int
test_easysimd_vmulq_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int32_t a[4];
    int32_t b[4];
    int32_t r[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x4_t r = easysimd_vmulq_s32(a, b);
...
static int
test_easysimd_x_vmulq_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int64_t a[2];
    int64_t b[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int64x2_t r = easysimd_x_vmulq_s64(a, b);
...
static int
test_easysimd_vmulq_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint8_t a[16];
    uint8_t b[16];
    uint8_t r[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x16_t r = easysimd_vmulq_u8(a, b);
...
static int
test_easysimd_vmulq_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint16_t a[8];
    uint16_t b[8];
    uint16_t r[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x8_t r = easysimd_vmulq_u16(a, b);
...
static int
test_easysimd_vmulq_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint32_t a[4];
    uint32_t b[4];
    uint32_t r[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x4_t r = easysimd_vmulq_u32(a, b);
...
static int
test_easysimd_x_vmulq_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint64_t a[2];
    uint64_t b[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint64x2_t r = easysimd_x_vmulq_u64(a, b);
...
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmul_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmul_f64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmul_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmul_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmul_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(x_vmul_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmul_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmul_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmul_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(x_vmul_u64)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vmulq_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmulq_f64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmulq_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmulq_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmulq_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(x_vmulq_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmulq_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmulq_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmulq_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(x_vmulq_u64)
