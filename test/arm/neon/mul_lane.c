#define EASYSIMD_TEST_ARM_NEON_INSN mul_lane

#include "test-neon.h"
#include "../../../easysimd/arm/neon/mul_lane.h"
#include "../../../easysimd/arm/neon/dup_n.h"

HEDLEY_DIAGNOSTIC_PUSH
EASYSIMD_DIAGNOSTIC_DISABLE_UNREACHABLE_

static int
test_easysimd_vmul_lane_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    ...
    { { EASYSIMD_FLOAT32_C(  -773.99), EASYSIMD_FLOAT32_C(   962.49) },
      { EASYSIMD_FLOAT32_C(  -531.26), EASYSIMD_FLOAT32_C(   540.16) },
       INT8_C(   1),
      { EASYSIMD_FLOAT32_C(-418078.41), EASYSIMD_FLOAT32_C(519898.56) } },
    { { EASYSIMD_FLOAT32_C(  -409.93), EASYSIMD_FLOAT32_C(   510.04) },
      { EASYSIMD_FLOAT32_C(  -659.02), EASYSIMD_FLOAT32_C(   102.89) },
       INT8_C(   1),
      { EASYSIMD_FLOAT32_C(-42177.70), EASYSIMD_FLOAT32_C( 52478.02) } },
    { { EASYSIMD_FLOAT32_C(  -999.99), EASYSIMD_FLOAT32_C(  -702.78) },
      { EASYSIMD_FLOAT32_C(  -114.76), EASYSIMD_FLOAT32_C(   327.24) },
       INT8_C(   1),
      { EASYSIMD_FLOAT32_C(-327236.72), EASYSIMD_FLOAT32_C(-229977.73) } },
    { { EASYSIMD_FLOAT32_C(   302.70), EASYSIMD_FLOAT32_C(  -977.40) },
      { EASYSIMD_FLOAT32_C(    45.80), EASYSIMD_FLOAT32_C(   892.47) },
       INT8_C(   1),
      { EASYSIMD_FLOAT32_C(270150.66), EASYSIMD_FLOAT32_C(-872300.19) } },
    { { EASYSIMD_FLOAT32_C(   306.93), EASYSIMD_FLOAT32_C(   371.14) },
      { EASYSIMD_FLOAT32_C(   546.46), EASYSIMD_FLOAT32_C(   323.18) },
       INT8_C(   1),
      { EASYSIMD_FLOAT32_C( 99193.63), EASYSIMD_FLOAT32_C(119945.02) } },
    { { EASYSIMD_FLOAT32_C(   148.94), EASYSIMD_FLOAT32_C(   -38.81) },
      { EASYSIMD_FLOAT32_C(  -107.93), EASYSIMD_FLOAT32_C(  -920.00) },
       INT8_C(   0),
      { EASYSIMD_FLOAT32_C(-16075.09), EASYSIMD_FLOAT32_C(  4188.76) } },
    { { EASYSIMD_FLOAT32_C(  -268.22), EASYSIMD_FLOAT32_C(  -693.98) },
      { EASYSIMD_FLOAT32_C(  -987.79), EASYSIMD_FLOAT32_C(   200.52) },
       INT8_C(   1),
      { EASYSIMD_FLOAT32_C(-53783.48), EASYSIMD_FLOAT32_C(-139156.88) } },
    { { EASYSIMD_FLOAT32_C(   646.59), EASYSIMD_FLOAT32_C(   790.59) },
      { EASYSIMD_FLOAT32_C(   356.21), EASYSIMD_FLOAT32_C(   987.57) },
       INT8_C(   0),
      { EASYSIMD_FLOAT32_C(230321.83), EASYSIMD_FLOAT32_C(281616.06) } }
  };
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    EASYSIMD_CONSTIFY_2_(easysimd_vmul_lane_f32, r, (HEDLEY_UNREACHABLE(), easysimd_vdup_n_f32(EASYSIMD_FLOAT32_C(0.0))), test_vec[i].lane, a, b);
  ...
  fputc('\n', stdout);
  for (int i = 0 ; i < 8 ; i++) {
    easysimd_float32x2_t a = easysimd_test_arm_neon_random_f32x2(-1000.0, 1000.0);
    easysimd_float32x2_t b = easysimd_test_arm_neon_random_f32x2(-1000.0, 1000.0);
    int lane = easysimd_test_codegen_random_i8() & 1;

    easysimd_float32x2_t r;
    EASYSIMD_CONSTIFY_2_(easysimd_vmul_lane_f32, r, (HEDLEY_UNREACHABLE(), easysimd_vdup_n_f32(EASYSIMD_FLOAT32_C(0.0))), lane, a, b);
    ...
    easysimd_test_codegen_write_i8(2, HEDLEY_STATIC_CAST(int8_t, lane), EASYSIMD_TEST_VEC_POS_MIDDLE);
...
static int
test_easysimd_vmul_lane_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    ...
    { { EASYSIMD_FLOAT64_C(   361.11) },
      { EASYSIMD_FLOAT64_C(  -650.09) },
      { EASYSIMD_FLOAT64_C(-234754.00) } },
    { { EASYSIMD_FLOAT64_C(    96.20) },
      { EASYSIMD_FLOAT64_C(   967.05) },
      { EASYSIMD_FLOAT64_C( 93030.21) } },
    { { EASYSIMD_FLOAT64_C(   -44.02) },
      { EASYSIMD_FLOAT64_C(   966.32) },
      { EASYSIMD_FLOAT64_C(-42537.41) } },
    { { EASYSIMD_FLOAT64_C(   207.91) },
      { EASYSIMD_FLOAT64_C(   922.18) },
      { EASYSIMD_FLOAT64_C(191730.44) } },
    { { EASYSIMD_FLOAT64_C(   263.40) },
      { EASYSIMD_FLOAT64_C(  -535.20) },
      { EASYSIMD_FLOAT64_C(-140971.68) } },
    { { EASYSIMD_FLOAT64_C(  -474.15) },
      { EASYSIMD_FLOAT64_C(   105.73) },
      { EASYSIMD_FLOAT64_C(-50131.88) } },
    { { EASYSIMD_FLOAT64_C(  -684.09) },
      { EASYSIMD_FLOAT64_C(  -137.80) },
      { EASYSIMD_FLOAT64_C( 94267.60) } },
    { { EASYSIMD_FLOAT64_C(   842.76) },
      { EASYSIMD_FLOAT64_C(  -239.29) },
      { EASYSIMD_FLOAT64_C(-201664.04) } }
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float64x1_t a = easysimd_vld1_f64(test_vec[i].a);
    easysimd_float64x1_t b = easysimd_vld1_f64(test_vec[i].b);
    easysimd_float64x1_t r = easysimd_vmul_lane_f64(a, b, 0);
...
static int
test_easysimd_vmul_lane_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int16_t a[4];
    int16_t b[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    EASYSIMD_CONSTIFY_4_(easysimd_vmul_lane_s16, r, (HEDLEY_UNREACHABLE(), easysimd_vdup_n_s16(INT16_C(0))), test_vec[i].lane, a, b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    int lane = easysimd_test_codegen_random_i8() & 3;

    easysimd_int16x4_t r;
    EASYSIMD_CONSTIFY_4_(easysimd_vmul_lane_s16, r, (HEDLEY_UNREACHABLE(), easysimd_vdup_n_s16(INT16_C(0))), lane, a, b);
...
static int
test_easysimd_vmul_lane_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t a[2];
    int32_t b[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    EASYSIMD_CONSTIFY_2_(easysimd_vmul_lane_s32, r, (HEDLEY_UNREACHABLE(), easysimd_vdup_n_s32(INT32_C(0))), test_vec[i].lane, a, b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_int32x2_t r;
    EASYSIMD_CONSTIFY_2_(easysimd_vmul_lane_s32, r, (HEDLEY_UNREACHABLE(), easysimd_vdup_n_s32(INT32_C(0))), lane, a, b);
...
static int
test_easysimd_vmul_lane_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint16_t a[4];
    uint16_t b[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    EASYSIMD_CONSTIFY_4_(easysimd_vmul_lane_u16, r, (HEDLEY_UNREACHABLE(), easysimd_vdup_n_u16(INT16_C(0))), test_vec[i].lane, a, b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_uint16x4_t r;
    EASYSIMD_CONSTIFY_4_(easysimd_vmul_lane_u16, r, (HEDLEY_UNREACHABLE(), easysimd_vdup_n_u16(UINT16_C(0))), lane, a, b);
...
static int
test_easysimd_vmul_lane_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint32_t a[2];
    uint32_t b[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    EASYSIMD_CONSTIFY_2_(easysimd_vmul_lane_u32, r, (HEDLEY_UNREACHABLE(), easysimd_vdup_n_u32(UINT32_C(0))), test_vec[i].lane, a, b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_uint32x2_t r;
    EASYSIMD_CONSTIFY_2_(easysimd_vmul_lane_u32, r, (HEDLEY_UNREACHABLE(), easysimd_vdup_n_u32(UINT32_C(0))), lane, a, b);
...
static int
test_easysimd_vmul_laneq_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int16_t a[4];
    int16_t b[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int16x4_t r;
    EASYSIMD_CONSTIFY_8_(easysimd_vmul_laneq_s16, r, (HEDLEY_UNREACHABLE(), easysimd_vdup_n_s16(INT16_C(0))), test_vec[i].lane, a, b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    int lane = easysimd_test_codegen_random_i8() & 7;

    easysimd_int16x4_t r;
    EASYSIMD_CONSTIFY_8_(easysimd_vmul_laneq_s16, r, (HEDLEY_UNREACHABLE(), easysimd_vdup_n_s16(INT16_C(0))), lane, a, b);
...
static int
test_easysimd_vmul_laneq_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t a[2];
    int32_t b[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x2_t r;
    EASYSIMD_CONSTIFY_4_(easysimd_vmul_laneq_s32, r, (HEDLEY_UNREACHABLE(), easysimd_vdup_n_s32(INT32_C(0))), test_vec[i].lane, a, b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_int32x2_t r;
    EASYSIMD_CONSTIFY_4_(easysimd_vmul_laneq_s32, r, (HEDLEY_UNREACHABLE(), easysimd_vdup_n_s32(INT32_C(0))), lane, a, b);
...
static int
test_easysimd_vmul_laneq_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint16_t a[4];
    uint16_t b[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x4_t r;
    EASYSIMD_CONSTIFY_8_(easysimd_vmul_laneq_u16, r, (HEDLEY_UNREACHABLE(), easysimd_vdup_n_u16(INT16_C(0))), test_vec[i].lane, a, b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_uint16x4_t r;
    EASYSIMD_CONSTIFY_8_(easysimd_vmul_laneq_u16, r, (HEDLEY_UNREACHABLE(), easysimd_vdup_n_u16(UINT16_C(0))), lane, a, b);
...
static int
test_easysimd_vmul_laneq_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint32_t a[2];
    uint32_t b[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x2_t r;
    EASYSIMD_CONSTIFY_4_(easysimd_vmul_laneq_u32, r, (HEDLEY_UNREACHABLE(), easysimd_vdup_n_u32(UINT32_C(0))), test_vec[i].lane, a, b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_uint32x2_t r;
    EASYSIMD_CONSTIFY_4_(easysimd_vmul_laneq_u32, r, (HEDLEY_UNREACHABLE(), easysimd_vdup_n_u32(UINT32_C(0))), lane, a, b);
...
static int
test_easysimd_vmulq_lane_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    ...
    { { EASYSIMD_FLOAT32_C(   213.13), EASYSIMD_FLOAT32_C(   981.87), EASYSIMD_FLOAT32_C(   831.27), EASYSIMD_FLOAT32_C(   118.60) },
      { EASYSIMD_FLOAT32_C(  -324.54), EASYSIMD_FLOAT32_C(   912.98) },
       INT8_C(   0),
      { EASYSIMD_FLOAT32_C(-69169.21), EASYSIMD_FLOAT32_C(-318656.09), EASYSIMD_FLOAT32_C(-269780.38), EASYSIMD_FLOAT32_C(-38490.45) } },
    { { EASYSIMD_FLOAT32_C(   398.02), EASYSIMD_FLOAT32_C(    -7.67), EASYSIMD_FLOAT32_C(   260.87), EASYSIMD_FLOAT32_C(   702.83) },
      { EASYSIMD_FLOAT32_C(   333.84), EASYSIMD_FLOAT32_C(   873.07) },
       INT8_C(   1),
      { EASYSIMD_FLOAT32_C(347499.31), EASYSIMD_FLOAT32_C( -6696.45), EASYSIMD_FLOAT32_C(227757.77), EASYSIMD_FLOAT32_C(613619.81) } },
    { { EASYSIMD_FLOAT32_C(  -354.62), EASYSIMD_FLOAT32_C(   438.98), EASYSIMD_FLOAT32_C(    27.69), EASYSIMD_FLOAT32_C(  -892.52) },
      { EASYSIMD_FLOAT32_C(   356.02), EASYSIMD_FLOAT32_C(  -450.46) },
       INT8_C(   0),
      { EASYSIMD_FLOAT32_C(-126251.80), EASYSIMD_FLOAT32_C(156285.66), EASYSIMD_FLOAT32_C(  9858.19), EASYSIMD_FLOAT32_C(-317754.97) } },
    { { EASYSIMD_FLOAT32_C(  -796.85), EASYSIMD_FLOAT32_C(   254.52), EASYSIMD_FLOAT32_C(   640.39), EASYSIMD_FLOAT32_C(   497.52) },
      { EASYSIMD_FLOAT32_C(   257.72), EASYSIMD_FLOAT32_C(    -9.95) },
       INT8_C(   1),
      { EASYSIMD_FLOAT32_C(  7928.66), EASYSIMD_FLOAT32_C( -2532.47), EASYSIMD_FLOAT32_C( -6371.88), EASYSIMD_FLOAT32_C( -4950.32) } },
    { { EASYSIMD_FLOAT32_C(  -951.01), EASYSIMD_FLOAT32_C(  -981.56), EASYSIMD_FLOAT32_C(    34.30), EASYSIMD_FLOAT32_C(   262.12) },
      { EASYSIMD_FLOAT32_C(  -999.70), EASYSIMD_FLOAT32_C(  -134.44) },
       INT8_C(   0),
      { EASYSIMD_FLOAT32_C(950724.69), EASYSIMD_FLOAT32_C(981265.56), EASYSIMD_FLOAT32_C(-34289.71), EASYSIMD_FLOAT32_C(-262041.36) } },
    { { EASYSIMD_FLOAT32_C(  -324.23), EASYSIMD_FLOAT32_C(  -221.45), EASYSIMD_FLOAT32_C(   748.19), EASYSIMD_FLOAT32_C(  -926.22) },
      { EASYSIMD_FLOAT32_C(   770.88), EASYSIMD_FLOAT32_C(     9.06) },
       INT8_C(   1),
      { EASYSIMD_FLOAT32_C( -2937.52), EASYSIMD_FLOAT32_C( -2006.34), EASYSIMD_FLOAT32_C(  6778.60), EASYSIMD_FLOAT32_C( -8391.55) } },
    { { EASYSIMD_FLOAT32_C(   104.72), EASYSIMD_FLOAT32_C(  -117.86), EASYSIMD_FLOAT32_C(  -296.55), EASYSIMD_FLOAT32_C(   750.10) },
      { EASYSIMD_FLOAT32_C(  -678.89), EASYSIMD_FLOAT32_C(   731.14) },
       INT8_C(   1),
      { EASYSIMD_FLOAT32_C( 76564.98), EASYSIMD_FLOAT32_C(-86172.16), EASYSIMD_FLOAT32_C(-216819.56), EASYSIMD_FLOAT32_C(548428.12) } },
    { { EASYSIMD_FLOAT32_C(   677.13), EASYSIMD_FLOAT32_C(  -719.32), EASYSIMD_FLOAT32_C(  -444.57), EASYSIMD_FLOAT32_C(   880.28) },
      { EASYSIMD_FLOAT32_C(   535.19), EASYSIMD_FLOAT32_C(  -804.18) },
       INT8_C(   0),
      { EASYSIMD_FLOAT32_C(362393.22), EASYSIMD_FLOAT32_C(-384972.88), EASYSIMD_FLOAT32_C(-237929.42), EASYSIMD_FLOAT32_C(471117.06) } }
  };
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    EASYSIMD_CONSTIFY_2_(easysimd_vmulq_lane_f32, r, (HEDLEY_UNREACHABLE(), easysimd_vdupq_n_f32(EASYSIMD_FLOAT32_C(0.0))), test_vec[i].lane, a, b);
  ...
  fputc('\n', stdout);
  for (int i = 0 ; i < 8 ; i++) {
    easysimd_float32x4_t a = easysimd_test_arm_neon_random_f32x4(-1000.0, 1000.0);
    easysimd_float32x2_t b = easysimd_test_arm_neon_random_f32x2(-1000.0, 1000.0);
    int lane = easysimd_test_codegen_random_i8() & 1;

    easysimd_float32x4_t r;
    EASYSIMD_CONSTIFY_2_(easysimd_vmulq_lane_f32, r, (HEDLEY_UNREACHABLE(), easysimd_vdupq_n_f32(EASYSIMD_FLOAT32_C(0.0))), lane, a, b);
...
static int
test_easysimd_vmulq_lane_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    ...
    { { EASYSIMD_FLOAT64_C(  -207.09), EASYSIMD_FLOAT64_C(   185.86) },
      { EASYSIMD_FLOAT64_C(   705.49) },
      { EASYSIMD_FLOAT64_C(-146099.92), EASYSIMD_FLOAT64_C(131122.37) } },
    { { EASYSIMD_FLOAT64_C(  -158.10), EASYSIMD_FLOAT64_C(   204.30) },
      { EASYSIMD_FLOAT64_C(  -260.21) },
      { EASYSIMD_FLOAT64_C( 41139.20), EASYSIMD_FLOAT64_C(-53160.90) } },
    { { EASYSIMD_FLOAT64_C(  -895.97), EASYSIMD_FLOAT64_C(   204.60) },
      { EASYSIMD_FLOAT64_C(   605.35) },
      { EASYSIMD_FLOAT64_C(-542375.44), EASYSIMD_FLOAT64_C(123854.61) } },
    { { EASYSIMD_FLOAT64_C(  -515.25), EASYSIMD_FLOAT64_C(   880.37) },
      { EASYSIMD_FLOAT64_C(  -616.10) },
      { EASYSIMD_FLOAT64_C(317445.53), EASYSIMD_FLOAT64_C(-542395.96) } },
    { { EASYSIMD_FLOAT64_C(  -767.06), EASYSIMD_FLOAT64_C(   954.16) },
      { EASYSIMD_FLOAT64_C(  -845.22) },
      { EASYSIMD_FLOAT64_C(648334.45), EASYSIMD_FLOAT64_C(-806475.12) } },
    { { EASYSIMD_FLOAT64_C(   242.00), EASYSIMD_FLOAT64_C(   730.77) },
      { EASYSIMD_FLOAT64_C(   259.50) },
      { EASYSIMD_FLOAT64_C( 62799.00), EASYSIMD_FLOAT64_C(189634.82) } },
    { { EASYSIMD_FLOAT64_C(  -875.86), EASYSIMD_FLOAT64_C(  -565.78) },
      { EASYSIMD_FLOAT64_C(     9.60) },
      { EASYSIMD_FLOAT64_C( -8408.26), EASYSIMD_FLOAT64_C( -5431.49) } },
    { { EASYSIMD_FLOAT64_C(  -554.75), EASYSIMD_FLOAT64_C(  -834.64) },
      { EASYSIMD_FLOAT64_C(  -132.82) },
      { EASYSIMD_FLOAT64_C( 73681.89), EASYSIMD_FLOAT64_C(110856.88) } }
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float64x2_t a = easysimd_vld1q_f64(test_vec[i].a);
    easysimd_float64x1_t b = easysimd_vld1_f64(test_vec[i].b);
    easysimd_float64x2_t r = easysimd_vmulq_lane_f64(a, b, 0);
...
static int
test_easysimd_vmulq_lane_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int16_t a[8];
    int16_t b[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    EASYSIMD_CONSTIFY_4_(easysimd_vmulq_lane_s16, r, (HEDLEY_UNREACHABLE(), easysimd_vdupq_n_s16(INT16_C(0))), test_vec[i].lane, a, b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_int16x8_t r;
    EASYSIMD_CONSTIFY_4_(easysimd_vmulq_lane_s16, r, (HEDLEY_UNREACHABLE(), easysimd_vdupq_n_s16(INT16_C(0))), lane, a, b);
...
static int
test_easysimd_vmulq_lane_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t a[4];
    int32_t b[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    EASYSIMD_CONSTIFY_2_(easysimd_vmulq_lane_s32, r, (HEDLEY_UNREACHABLE(), easysimd_vdupq_n_s32(INT32_C(0))), test_vec[i].lane, a, b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_int32x4_t r;
    EASYSIMD_CONSTIFY_2_(easysimd_vmulq_lane_s32, r, (HEDLEY_UNREACHABLE(), easysimd_vdupq_n_s32(INT32_C(0))), lane, a, b);
...
static int
test_easysimd_vmulq_lane_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint16_t a[8];
    uint16_t b[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    EASYSIMD_CONSTIFY_4_(easysimd_vmulq_lane_u16, r, (HEDLEY_UNREACHABLE(), easysimd_vdupq_n_u16(INT16_C(0))), test_vec[i].lane, a, b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_uint16x8_t r;
    EASYSIMD_CONSTIFY_4_(easysimd_vmulq_lane_u16, r, (HEDLEY_UNREACHABLE(), easysimd_vdupq_n_u16(UINT16_C(0))), lane, a, b);
...
static int
test_easysimd_vmulq_lane_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint32_t a[4];
    uint32_t b[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    EASYSIMD_CONSTIFY_2_(easysimd_vmulq_lane_u32, r, (HEDLEY_UNREACHABLE(), easysimd_vdupq_n_u32(UINT32_C(0))), test_vec[i].lane, a, b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_uint32x4_t r;
    EASYSIMD_CONSTIFY_2_(easysimd_vmulq_lane_u32, r, (HEDLEY_UNREACHABLE(), easysimd_vdupq_n_u32(UINT32_C(0))), lane, a, b);
...
static int
test_easysimd_vmulq_laneq_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    easysimd_float32 a[4];
    ...
    { { EASYSIMD_FLOAT32_C(  -483.10), EASYSIMD_FLOAT32_C(   841.64), EASYSIMD_FLOAT32_C(   832.87), EASYSIMD_FLOAT32_C(   478.63) },
      { EASYSIMD_FLOAT32_C(   684.27), EASYSIMD_FLOAT32_C(  -437.87), EASYSIMD_FLOAT32_C(   138.75), EASYSIMD_FLOAT32_C(   -36.57) },
       INT8_C(   0),
      { EASYSIMD_FLOAT32_C(-330570.84), EASYSIMD_FLOAT32_C(575909.00), EASYSIMD_FLOAT32_C(569907.94), EASYSIMD_FLOAT32_C(327512.16) } },
    { { EASYSIMD_FLOAT32_C(   141.10), EASYSIMD_FLOAT32_C(   936.51), EASYSIMD_FLOAT32_C(  -996.31), EASYSIMD_FLOAT32_C(   809.04) },
      { EASYSIMD_FLOAT32_C(  -520.77), EASYSIMD_FLOAT32_C(  -383.63), EASYSIMD_FLOAT32_C(   396.57), EASYSIMD_FLOAT32_C(  -505.39) },
       INT8_C(   0),
      { EASYSIMD_FLOAT32_C(-73480.66), EASYSIMD_FLOAT32_C(-487706.34), EASYSIMD_FLOAT32_C(518848.38), EASYSIMD_FLOAT32_C(-421323.75) } },
    { { EASYSIMD_FLOAT32_C(   757.82), EASYSIMD_FLOAT32_C(  -769.31), EASYSIMD_FLOAT32_C(   479.87), EASYSIMD_FLOAT32_C(    27.24) },
      { EASYSIMD_FLOAT32_C(    87.58), EASYSIMD_FLOAT32_C(  -325.93), EASYSIMD_FLOAT32_C(  -147.19), EASYSIMD_FLOAT32_C(   630.99) },
       INT8_C(   1),
      { EASYSIMD_FLOAT32_C(-246996.27), EASYSIMD_FLOAT32_C(250741.20), EASYSIMD_FLOAT32_C(-156404.03), EASYSIMD_FLOAT32_C( -8878.33) } },
    { { EASYSIMD_FLOAT32_C(   921.82), EASYSIMD_FLOAT32_C(    48.37), EASYSIMD_FLOAT32_C(  -130.34), EASYSIMD_FLOAT32_C(   806.30) },
      { EASYSIMD_FLOAT32_C(   565.26), EASYSIMD_FLOAT32_C(  -288.70), EASYSIMD_FLOAT32_C(   639.18), EASYSIMD_FLOAT32_C(    43.89) },
       INT8_C(   3),
      { EASYSIMD_FLOAT32_C( 40458.68), EASYSIMD_FLOAT32_C(  2122.96), EASYSIMD_FLOAT32_C( -5720.62), EASYSIMD_FLOAT32_C( 35388.51) } },
    { { EASYSIMD_FLOAT32_C(  -798.70), EASYSIMD_FLOAT32_C(  -817.36), EASYSIMD_FLOAT32_C(   359.00), EASYSIMD_FLOAT32_C(   117.01) },
      { EASYSIMD_FLOAT32_C(   323.75), EASYSIMD_FLOAT32_C(   295.51), EASYSIMD_FLOAT32_C(   120.71), EASYSIMD_FLOAT32_C(   132.79) },
       INT8_C(   3),
      { EASYSIMD_FLOAT32_C(-106059.37), EASYSIMD_FLOAT32_C(-108537.23), EASYSIMD_FLOAT32_C( 47671.61), EASYSIMD_FLOAT32_C( 15537.76) } },
    { { EASYSIMD_FLOAT32_C(   737.08), EASYSIMD_FLOAT32_C(  -470.63), EASYSIMD_FLOAT32_C(  -730.64), EASYSIMD_FLOAT32_C(    79.42) },
      { EASYSIMD_FLOAT32_C(  -712.82), EASYSIMD_FLOAT32_C(  -499.95), EASYSIMD_FLOAT32_C(  -440.71), EASYSIMD_FLOAT32_C(   314.43) },
       INT8_C(   1),
      { EASYSIMD_FLOAT32_C(-368503.16), EASYSIMD_FLOAT32_C(235291.48), EASYSIMD_FLOAT32_C(365283.47), EASYSIMD_FLOAT32_C(-39706.03) } },
    { { EASYSIMD_FLOAT32_C(   233.36), EASYSIMD_FLOAT32_C(  -832.76), EASYSIMD_FLOAT32_C(   218.62), EASYSIMD_FLOAT32_C(   442.88) },
      { EASYSIMD_FLOAT32_C(  -910.95), EASYSIMD_FLOAT32_C(  -733.02), EASYSIMD_FLOAT32_C(  -687.47), EASYSIMD_FLOAT32_C(   895.36) },
       INT8_C(   1),
      { EASYSIMD_FLOAT32_C(-171057.55), EASYSIMD_FLOAT32_C(610429.75), EASYSIMD_FLOAT32_C(-160252.83), EASYSIMD_FLOAT32_C(-324639.91) } },
    { { EASYSIMD_FLOAT32_C(    23.84), EASYSIMD_FLOAT32_C(   534.54), EASYSIMD_FLOAT32_C(  -123.86), EASYSIMD_FLOAT32_C(   419.41) },
      { EASYSIMD_FLOAT32_C(   735.84), EASYSIMD_FLOAT32_C(    58.79), EASYSIMD_FLOAT32_C(  -221.60), EASYSIMD_FLOAT32_C(  -147.15) },
       INT8_C(   1),
      { EASYSIMD_FLOAT32_C(  1401.55), EASYSIMD_FLOAT32_C( 31425.61), EASYSIMD_FLOAT32_C( -7281.73), EASYSIMD_FLOAT32_C( 24657.12) } }
  };
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_float32x4_t r;
    EASYSIMD_CONSTIFY_4_(easysimd_vmulq_laneq_f32, r, (HEDLEY_UNREACHABLE(), easysimd_vdupq_n_f32(EASYSIMD_FLOAT32_C(0.0))), test_vec[i].lane, a, b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    easysimd_float32x4_t a = easysimd_test_arm_neon_random_f32x4(-1000.0, 1000.0);
    easysimd_float32x4_t b = easysimd_test_arm_neon_random_f32x4(-1000.0, 1000.0);
    int lane = easysimd_test_codegen_random_i8() & 3;

    easysimd_float32x4_t r;
    EASYSIMD_CONSTIFY_4_(easysimd_vmulq_laneq_f32, r, (HEDLEY_UNREACHABLE(), easysimd_vdupq_n_f32(EASYSIMD_FLOAT32_C(0.0))), lane, a, b);
...
static int
test_easysimd_vmulq_laneq_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    easysimd_float64 a[2];
    ...
    { { EASYSIMD_FLOAT64_C(    -8.30), EASYSIMD_FLOAT64_C(    39.42) },
      { EASYSIMD_FLOAT64_C(  -145.93), EASYSIMD_FLOAT64_C(  -489.21) },
       INT8_C(   0),
      { EASYSIMD_FLOAT64_C(  1211.22), EASYSIMD_FLOAT64_C( -5752.56) } },
    { { EASYSIMD_FLOAT64_C(  -947.61), EASYSIMD_FLOAT64_C(   662.96) },
      { EASYSIMD_FLOAT64_C(   341.51), EASYSIMD_FLOAT64_C(   581.12) },
       INT8_C(   1),
      { EASYSIMD_FLOAT64_C(-550675.12), EASYSIMD_FLOAT64_C(385259.32) } },
    { { EASYSIMD_FLOAT64_C(   777.29), EASYSIMD_FLOAT64_C(   252.16) },
      { EASYSIMD_FLOAT64_C(   955.20), EASYSIMD_FLOAT64_C(  -332.93) },
       INT8_C(   1),
      { EASYSIMD_FLOAT64_C(-258783.16), EASYSIMD_FLOAT64_C(-83951.63) } },
    { { EASYSIMD_FLOAT64_C(   446.81), EASYSIMD_FLOAT64_C(  -501.58) },
      { EASYSIMD_FLOAT64_C(  -807.53), EASYSIMD_FLOAT64_C(  -797.54) },
       INT8_C(   0),
      { EASYSIMD_FLOAT64_C(-360812.48), EASYSIMD_FLOAT64_C(405040.90) } },
    { { EASYSIMD_FLOAT64_C(   357.00), EASYSIMD_FLOAT64_C(  -144.04) },
      { EASYSIMD_FLOAT64_C(   968.23), EASYSIMD_FLOAT64_C(  -970.92) },
       INT8_C(   0),
      { EASYSIMD_FLOAT64_C(345658.11), EASYSIMD_FLOAT64_C(-139463.85) } },
    { { EASYSIMD_FLOAT64_C(   974.60), EASYSIMD_FLOAT64_C(    51.96) },
      { EASYSIMD_FLOAT64_C(   988.71), EASYSIMD_FLOAT64_C(   292.59) },
       INT8_C(   0),
      { EASYSIMD_FLOAT64_C(963596.77), EASYSIMD_FLOAT64_C( 51373.37) } },
    { { EASYSIMD_FLOAT64_C(  -177.10), EASYSIMD_FLOAT64_C(  -715.71) },
      { EASYSIMD_FLOAT64_C(  -172.78), EASYSIMD_FLOAT64_C(   676.97) },
       INT8_C(   1),
      { EASYSIMD_FLOAT64_C(-119891.39), EASYSIMD_FLOAT64_C(-484514.20) } },
    { { EASYSIMD_FLOAT64_C(  -585.24), EASYSIMD_FLOAT64_C(   729.36) },
      { EASYSIMD_FLOAT64_C(  -541.96), EASYSIMD_FLOAT64_C(   756.27) },
       INT8_C(   1),
      { EASYSIMD_FLOAT64_C(-442599.45), EASYSIMD_FLOAT64_C(551593.09) } }
  };
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    EASYSIMD_CONSTIFY_2_(easysimd_vmulq_laneq_f64, r, (HEDLEY_UNREACHABLE(), easysimd_vdupq_n_f64(EASYSIMD_FLOAT64_C(0.0))), test_vec[i].lane, a, b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_float64x2_t r;
    EASYSIMD_CONSTIFY_2_(easysimd_vmulq_laneq_f64, r, (HEDLEY_UNREACHABLE(), easysimd_vdupq_n_f64(EASYSIMD_FLOAT64_C(0.0))), lane, a, b);
...
static int
test_easysimd_vmulq_laneq_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int16_t a[8];
    int16_t b[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int16x8_t r;
    EASYSIMD_CONSTIFY_8_(easysimd_vmulq_laneq_s16, r, (HEDLEY_UNREACHABLE(), easysimd_vdupq_n_s16(INT16_C(0))), test_vec[i].lane, a, b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_int16x8_t r;
    EASYSIMD_CONSTIFY_8_(easysimd_vmulq_laneq_s16, r, (HEDLEY_UNREACHABLE(), easysimd_vdupq_n_s16(INT16_C(0))), lane, a, b);
...
static int
test_easysimd_vmulq_laneq_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t a[4];
    int32_t b[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x4_t r;
    EASYSIMD_CONSTIFY_4_(easysimd_vmulq_laneq_s32, r, (HEDLEY_UNREACHABLE(), easysimd_vdupq_n_s32(INT32_C(0))), test_vec[i].lane, a, b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_int32x4_t r;
    EASYSIMD_CONSTIFY_4_(easysimd_vmulq_laneq_s32, r, (HEDLEY_UNREACHABLE(), easysimd_vdupq_n_s32(INT32_C(0))), lane, a, b);
...
static int
test_easysimd_vmulq_laneq_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint16_t a[8];
    uint16_t b[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x8_t r;
    EASYSIMD_CONSTIFY_8_(easysimd_vmulq_laneq_u16, r, (HEDLEY_UNREACHABLE(), easysimd_vdupq_n_u16(INT16_C(0))), test_vec[i].lane, a, b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_uint16x8_t r;
    EASYSIMD_CONSTIFY_8_(easysimd_vmulq_laneq_u16, r, (HEDLEY_UNREACHABLE(), easysimd_vdupq_n_u16(UINT16_C(0))), lane, a, b);
...
static int
test_easysimd_vmulq_laneq_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint32_t a[4];
    uint32_t b[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x4_t r;
    EASYSIMD_CONSTIFY_4_(easysimd_vmulq_laneq_u32, r, (HEDLEY_UNREACHABLE(), easysimd_vdupq_n_u32(UINT32_C(0))), test_vec[i].lane, a, b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_uint32x4_t r;
    EASYSIMD_CONSTIFY_4_(easysimd_vmulq_laneq_u32, r, (HEDLEY_UNREACHABLE(), easysimd_vdupq_n_u32(UINT32_C(0))), lane, a, b);
...
static int
test_easysimd_vmuld_lane_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    ...
    { EASYSIMD_FLOAT64_C(   701.55),
      { EASYSIMD_FLOAT64_C(   763.69) },
      EASYSIMD_FLOAT64_C(535766.72) },
    { EASYSIMD_FLOAT64_C(  -207.75),
      { EASYSIMD_FLOAT64_C(  -252.26) },
      EASYSIMD_FLOAT64_C( 52407.01) },
    { EASYSIMD_FLOAT64_C(   258.78),
      { EASYSIMD_FLOAT64_C(   426.42) },
      EASYSIMD_FLOAT64_C(110348.97) },
    { EASYSIMD_FLOAT64_C(  -228.36),
      { EASYSIMD_FLOAT64_C(   601.45) },
      EASYSIMD_FLOAT64_C(-137347.12) },
    { EASYSIMD_FLOAT64_C(   257.18),
      { EASYSIMD_FLOAT64_C(   100.91) },
      EASYSIMD_FLOAT64_C( 25952.03) },
    { EASYSIMD_FLOAT64_C(  -786.84),
      { EASYSIMD_FLOAT64_C(  -162.95) },
      EASYSIMD_FLOAT64_C(128215.58) },
    { EASYSIMD_FLOAT64_C(  -602.83),
      { EASYSIMD_FLOAT64_C(   531.21) },
      EASYSIMD_FLOAT64_C(-320229.32) },
    { EASYSIMD_FLOAT64_C(   286.53),
      { EASYSIMD_FLOAT64_C(   607.95) },
      EASYSIMD_FLOAT64_C(174195.91) }
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float64_t r = easysimd_vmuld_lane_f64(test_vec[i].a, easysimd_vld1_f64(test_vec[i].b), 0);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_float64_t r = easysimd_vmuld_lane_f64(a, b, 0);
...
static int
test_easysimd_vmuld_laneq_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    easysimd_float64_t a;
    ...
    { EASYSIMD_FLOAT64_C(  -966.64),
      { EASYSIMD_FLOAT64_C(   703.89), EASYSIMD_FLOAT64_C(  -629.15) },
       INT8_C(   0),
      EASYSIMD_FLOAT64_C(-680408.23) },
    { EASYSIMD_FLOAT64_C(  -363.33),
      { EASYSIMD_FLOAT64_C(  -559.71), EASYSIMD_FLOAT64_C(  -456.98) },
       INT8_C(   1),
      EASYSIMD_FLOAT64_C(166034.54) },
    { EASYSIMD_FLOAT64_C(  -605.56),
      { EASYSIMD_FLOAT64_C(  -750.10), EASYSIMD_FLOAT64_C(     3.29) },
       INT8_C(   0),
      EASYSIMD_FLOAT64_C(454230.56) },
    { EASYSIMD_FLOAT64_C(  -653.37),
      { EASYSIMD_FLOAT64_C(  -480.38), EASYSIMD_FLOAT64_C(   279.75) },
       INT8_C(   1),
      EASYSIMD_FLOAT64_C(-182780.26) },
    { EASYSIMD_FLOAT64_C(  -832.94),
      { EASYSIMD_FLOAT64_C(   271.64), EASYSIMD_FLOAT64_C(  -658.01) },
       INT8_C(   0),
      EASYSIMD_FLOAT64_C(-226259.82) },
    { EASYSIMD_FLOAT64_C(  -530.95),
      { EASYSIMD_FLOAT64_C(   366.84), EASYSIMD_FLOAT64_C(   230.32) },
       INT8_C(   1),
      EASYSIMD_FLOAT64_C(-122288.40) },
    { EASYSIMD_FLOAT64_C(   710.66),
      { EASYSIMD_FLOAT64_C(   453.17), EASYSIMD_FLOAT64_C(   153.31) },
       INT8_C(   0),
      EASYSIMD_FLOAT64_C(322049.79) },
    { EASYSIMD_FLOAT64_C(   325.93),
      { EASYSIMD_FLOAT64_C(   880.39), EASYSIMD_FLOAT64_C(   -35.41) },
       INT8_C(   1),
      EASYSIMD_FLOAT64_C(-11541.18) }
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float64_t r;
    easysimd_float64x2_t b = easysimd_vld1q_f64(test_vec[i].b);
    EASYSIMD_CONSTIFY_2_(easysimd_vmuld_laneq_f64, r, (HEDLEY_UNREACHABLE(), r), test_vec[i].lane, test_vec[i].a, b);
    easysimd_assert_equal_f64(r, test_vec[i].r, 1);
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_float64_t r;
    EASYSIMD_CONSTIFY_2_(easysimd_vmuld_laneq_f64, r, (HEDLEY_UNREACHABLE(), r), lanes[i], a, b);

    easysimd_test_codegen_write_f64(2, a, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_arm_neon_write_f64x2(2, b, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_codegen_write_i8(2, HEDLEY_STATIC_CAST(int8_t, lanes[i]), EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_codegen_write_f64(2, r, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
#endif
...
static int
test_easysimd_vmuls_lane_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    ...
    { EASYSIMD_FLOAT32_C(   114.36),
      { EASYSIMD_FLOAT32_C(   411.22), EASYSIMD_FLOAT32_C(   916.69) },
       INT8_C(   0),
      EASYSIMD_FLOAT32_C( 47027.12) },
    { EASYSIMD_FLOAT32_C(   700.21),
      { EASYSIMD_FLOAT32_C(  -898.84), EASYSIMD_FLOAT32_C(  -718.55) },
       INT8_C(   1),
      EASYSIMD_FLOAT32_C(-503135.91) },
    { EASYSIMD_FLOAT32_C(  -369.32),
      { EASYSIMD_FLOAT32_C(  -865.48), EASYSIMD_FLOAT32_C(   985.34) },
       INT8_C(   0),
      EASYSIMD_FLOAT32_C(319639.06) },
    { EASYSIMD_FLOAT32_C(     1.52),
      { EASYSIMD_FLOAT32_C(  -228.81), EASYSIMD_FLOAT32_C(  -574.37) },
       INT8_C(   1),
      EASYSIMD_FLOAT32_C(  -873.04) },
    { EASYSIMD_FLOAT32_C(   544.55),
      { EASYSIMD_FLOAT32_C(   165.63), EASYSIMD_FLOAT32_C(  -324.47) },
       INT8_C(   0),
      EASYSIMD_FLOAT32_C( 90193.82) },
    { EASYSIMD_FLOAT32_C(  -452.16),
      { EASYSIMD_FLOAT32_C(   512.26), EASYSIMD_FLOAT32_C(   195.14) },
       INT8_C(   1),
      EASYSIMD_FLOAT32_C(-88234.50) },
    { EASYSIMD_FLOAT32_C(   827.58),
      { EASYSIMD_FLOAT32_C(   679.32), EASYSIMD_FLOAT32_C(  -533.22) },
       INT8_C(   0),
      EASYSIMD_FLOAT32_C(562191.69) },
    { EASYSIMD_FLOAT32_C(  -830.42),
      { EASYSIMD_FLOAT32_C(  -851.63), EASYSIMD_FLOAT32_C(   833.63) },
       INT8_C(   1),
      EASYSIMD_FLOAT32_C(-692263.00) }
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float32x2_t b = easysimd_vld1_f32(test_vec[i].b);
    easysimd_float32_t r;
    EASYSIMD_CONSTIFY_2_(easysimd_vmuls_lane_f32, r, (HEDLEY_UNREACHABLE(), r), test_vec[i].lane, test_vec[i].a, b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_float32_t r;
    EASYSIMD_CONSTIFY_2_(easysimd_vmuls_lane_f32, r, (HEDLEY_UNREACHABLE(), r), lanes[i], a, b);
...
static int
test_easysimd_vmuls_laneq_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    easysimd_float32_t a;
    ...
    { EASYSIMD_FLOAT32_C(   399.90),
      { EASYSIMD_FLOAT32_C(   859.03), EASYSIMD_FLOAT32_C(   286.79), EASYSIMD_FLOAT32_C(  -446.80), EASYSIMD_FLOAT32_C(   184.96) },
       INT8_C(   0),
      EASYSIMD_FLOAT32_C(343526.09) },
    { EASYSIMD_FLOAT32_C(   167.18),
      { EASYSIMD_FLOAT32_C(   517.79), EASYSIMD_FLOAT32_C(  -700.69), EASYSIMD_FLOAT32_C(  -421.60), EASYSIMD_FLOAT32_C(   434.49) },
       INT8_C(   1),
      EASYSIMD_FLOAT32_C(-117141.35) },
    { EASYSIMD_FLOAT32_C(   999.53),
      { EASYSIMD_FLOAT32_C(  -320.44), EASYSIMD_FLOAT32_C(   715.94), EASYSIMD_FLOAT32_C(  -369.79), EASYSIMD_FLOAT32_C(  -185.93) },
       INT8_C(   0),
      EASYSIMD_FLOAT32_C(-320289.41) },
    { EASYSIMD_FLOAT32_C(   701.28),
      { EASYSIMD_FLOAT32_C(   631.73), EASYSIMD_FLOAT32_C(   585.26), EASYSIMD_FLOAT32_C(  -873.09), EASYSIMD_FLOAT32_C(   176.28) },
       INT8_C(   1),
      EASYSIMD_FLOAT32_C(410431.16) },
    { EASYSIMD_FLOAT32_C(  -249.11),
      { EASYSIMD_FLOAT32_C(  -197.56), EASYSIMD_FLOAT32_C(   724.11), EASYSIMD_FLOAT32_C(  -736.85), EASYSIMD_FLOAT32_C(   997.59) },
       INT8_C(   0),
      EASYSIMD_FLOAT32_C( 49214.17) },
    { EASYSIMD_FLOAT32_C(   551.70),
      { EASYSIMD_FLOAT32_C(   942.47), EASYSIMD_FLOAT32_C(  -535.63), EASYSIMD_FLOAT32_C(   721.27), EASYSIMD_FLOAT32_C(  -909.16) },
       INT8_C(   1),
      EASYSIMD_FLOAT32_C(-295507.09) },
    { EASYSIMD_FLOAT32_C(  -702.00),
      { EASYSIMD_FLOAT32_C(   121.17), EASYSIMD_FLOAT32_C(   949.86), EASYSIMD_FLOAT32_C(   584.79), EASYSIMD_FLOAT32_C(   674.37) },
       INT8_C(   0),
      EASYSIMD_FLOAT32_C(-85061.34) },
    { EASYSIMD_FLOAT32_C(   134.82),
      { EASYSIMD_FLOAT32_C(  -248.03), EASYSIMD_FLOAT32_C(   192.17), EASYSIMD_FLOAT32_C(   434.13), EASYSIMD_FLOAT32_C(   330.37) },
       INT8_C(   1),
      EASYSIMD_FLOAT32_C( 25908.36) }
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float32x4_t b = easysimd_vld1q_f32(test_vec[i].b);
    easysimd_float32_t r;
    EASYSIMD_CONSTIFY_4_(easysimd_vmuls_laneq_f32, r, (HEDLEY_UNREACHABLE(), r), test_vec[i].lane, test_vec[i].a, b);
    easysimd_assert_equal_f32(r, test_vec[i].r, 1);
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_float32_t r;
    EASYSIMD_CONSTIFY_4_(easysimd_vmuls_laneq_f32, r, (HEDLEY_UNREACHABLE(), r), lanes[i], a, b);
...
static int
test_easysimd_vmul_laneq_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    easysimd_float32 a[2];
    easysimd_float32 b[4];
    ...
    { { EASYSIMD_FLOAT32_C(  -450.23), EASYSIMD_FLOAT32_C(   250.17) },
      { EASYSIMD_FLOAT32_C(  -637.45), EASYSIMD_FLOAT32_C(  -230.90), EASYSIMD_FLOAT32_C(   241.82), EASYSIMD_FLOAT32_C(   684.35) },
       INT8_C(   2),
      { EASYSIMD_FLOAT32_C(-108874.62), EASYSIMD_FLOAT32_C( 60496.11) } },
    { { EASYSIMD_FLOAT32_C(  -527.99), EASYSIMD_FLOAT32_C(   169.94) },
      { EASYSIMD_FLOAT32_C(  -242.42), EASYSIMD_FLOAT32_C(   315.71), EASYSIMD_FLOAT32_C(   591.47), EASYSIMD_FLOAT32_C(   461.07) },
       INT8_C(   2),
      { EASYSIMD_FLOAT32_C(-312290.22), EASYSIMD_FLOAT32_C(100514.41) } },
    { { EASYSIMD_FLOAT32_C(   282.28), EASYSIMD_FLOAT32_C(  -679.21) },
      { EASYSIMD_FLOAT32_C(    -7.25), EASYSIMD_FLOAT32_C(   965.48), EASYSIMD_FLOAT32_C(  -996.40), EASYSIMD_FLOAT32_C(   494.36) },
       INT8_C(   2),
      { EASYSIMD_FLOAT32_C(-281263.81), EASYSIMD_FLOAT32_C(676764.88) } },
    { { EASYSIMD_FLOAT32_C(  -776.91), EASYSIMD_FLOAT32_C(   857.04) },
      { EASYSIMD_FLOAT32_C(   724.13), EASYSIMD_FLOAT32_C(  -786.43), EASYSIMD_FLOAT32_C(  -311.62), EASYSIMD_FLOAT32_C(  -105.35) },
       INT8_C(   1),
      { EASYSIMD_FLOAT32_C(610985.31), EASYSIMD_FLOAT32_C(-674001.94) } },
    { { EASYSIMD_FLOAT32_C(   551.51), EASYSIMD_FLOAT32_C(   956.48) },
      { EASYSIMD_FLOAT32_C(    44.53), EASYSIMD_FLOAT32_C(  -898.71), EASYSIMD_FLOAT32_C(   206.65), EASYSIMD_FLOAT32_C(   407.07) },
       INT8_C(   1),
      { EASYSIMD_FLOAT32_C(-495647.56), EASYSIMD_FLOAT32_C(-859598.12) } },
    { { EASYSIMD_FLOAT32_C(  -551.53), EASYSIMD_FLOAT32_C(    91.43) },
      { EASYSIMD_FLOAT32_C(  -422.60), EASYSIMD_FLOAT32_C(   -79.51), EASYSIMD_FLOAT32_C(  -738.63), EASYSIMD_FLOAT32_C(   334.98) },
       INT8_C(   1),
      { EASYSIMD_FLOAT32_C( 43852.15), EASYSIMD_FLOAT32_C( -7269.60) } },
    { { EASYSIMD_FLOAT32_C(   852.83), EASYSIMD_FLOAT32_C(  -203.95) },
      { EASYSIMD_FLOAT32_C(   817.55), EASYSIMD_FLOAT32_C(   135.11), EASYSIMD_FLOAT32_C(   116.84), EASYSIMD_FLOAT32_C(  -189.70) },
       INT8_C(   1),
      { EASYSIMD_FLOAT32_C(115225.87), EASYSIMD_FLOAT32_C(-27555.68) } },
    { { EASYSIMD_FLOAT32_C(   120.44), EASYSIMD_FLOAT32_C(  -695.35) },
      { EASYSIMD_FLOAT32_C(   723.25), EASYSIMD_FLOAT32_C(   343.53), EASYSIMD_FLOAT32_C(  -838.30), EASYSIMD_FLOAT32_C(   447.37) },
       INT8_C(   2),
      { EASYSIMD_FLOAT32_C(-100964.85), EASYSIMD_FLOAT32_C(582911.88) } }
  };
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_float32x2_t r;
    EASYSIMD_CONSTIFY_4_(easysimd_vmul_laneq_f32, r, (HEDLEY_UNREACHABLE(), easysimd_vdup_n_f32(EASYSIMD_FLOAT32_C(0.0))), test_vec[i].lane, a, b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_float32x2_t r;
    EASYSIMD_CONSTIFY_4_(easysimd_vmul_laneq_f32, r, (HEDLEY_UNREACHABLE(), easysimd_vdup_n_f32(EASYSIMD_FLOAT32_C(0.0))), lane, a, b);
...
static int
test_easysimd_vmul_laneq_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    easysimd_float64 a[1];
    easysimd_float64 b[2];
    ...
    { { EASYSIMD_FLOAT64_C(  -149.93) },
      { EASYSIMD_FLOAT64_C(  -657.97), EASYSIMD_FLOAT64_C(  -689.39) },
       INT8_C(   1),
      { EASYSIMD_FLOAT64_C(103360.24) } },
    { { EASYSIMD_FLOAT64_C(  -701.49) },
      { EASYSIMD_FLOAT64_C(   355.13), EASYSIMD_FLOAT64_C(  -497.12) },
       INT8_C(   0),
      { EASYSIMD_FLOAT64_C(-249120.14) } },
    { { EASYSIMD_FLOAT64_C(  -237.80) },
      { EASYSIMD_FLOAT64_C(   373.27), EASYSIMD_FLOAT64_C(   953.64) },
       INT8_C(   1),
      { EASYSIMD_FLOAT64_C(-226775.59) } },
    { { EASYSIMD_FLOAT64_C(   950.67) },
      { EASYSIMD_FLOAT64_C(  -125.88), EASYSIMD_FLOAT64_C(  -885.00) },
       INT8_C(   0),
      { EASYSIMD_FLOAT64_C(-119670.34) } },
    { { EASYSIMD_FLOAT64_C(   110.32) },
      { EASYSIMD_FLOAT64_C(   967.83), EASYSIMD_FLOAT64_C(  -918.30) },
       INT8_C(   0),
      { EASYSIMD_FLOAT64_C(106771.01) } },
    { { EASYSIMD_FLOAT64_C(   102.94) },
      { EASYSIMD_FLOAT64_C(   198.54), EASYSIMD_FLOAT64_C(   738.16) },
       INT8_C(   0),
      { EASYSIMD_FLOAT64_C( 20437.71) } },
    { { EASYSIMD_FLOAT64_C(  -681.01) },
      { EASYSIMD_FLOAT64_C(  -957.18), EASYSIMD_FLOAT64_C(   926.77) },
       INT8_C(   0),
      { EASYSIMD_FLOAT64_C(651849.15) } },
    { { EASYSIMD_FLOAT64_C(  -795.48) },
      { EASYSIMD_FLOAT64_C(   374.15), EASYSIMD_FLOAT64_C(   219.63) },
       INT8_C(   0),
      { EASYSIMD_FLOAT64_C(-297628.84) } }
  };
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    EASYSIMD_CONSTIFY_2_(easysimd_vmul_laneq_f64, r, (HEDLEY_UNREACHABLE(), easysimd_vdup_n_f64(EASYSIMD_FLOAT64_C(0.0))), test_vec[i].lane, a, b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_float64x1_t r;
    EASYSIMD_CONSTIFY_2_(easysimd_vmul_laneq_f64, r, (HEDLEY_UNREACHABLE(), easysimd_vdup_n_f64(EASYSIMD_FLOAT64_C(0.0))), lane, a, b);
...
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmul_lane_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmul_lane_f64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmul_lane_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmul_lane_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmul_lane_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmul_lane_u32)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vmul_laneq_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmul_laneq_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmul_laneq_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmul_laneq_u32)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vmulq_lane_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmulq_lane_f64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmulq_lane_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmulq_lane_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmulq_lane_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmulq_lane_u32)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vmulq_laneq_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmulq_laneq_f64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmulq_laneq_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmulq_laneq_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmulq_laneq_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmulq_laneq_u32)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vmuld_lane_f64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmuld_laneq_f64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmuls_lane_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmuls_laneq_f32)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vmul_laneq_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmul_laneq_f64)
