#define EASYSIMD_TEST_ARM_NEON_INSN mul_n

#include "test-neon.h"
#include "../../../easysimd/arm/neon/mul_n.h"

static int
test_easysimd_vmul_n_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    ...
    { { EASYSIMD_FLOAT32_C(  -322.57), EASYSIMD_FLOAT32_C(   102.45) },
      EASYSIMD_FLOAT32_C(   338.06),
      { EASYSIMD_FLOAT32_C(-109048.02), EASYSIMD_FLOAT32_C( 34634.25) } },
    { { EASYSIMD_FLOAT32_C(   826.06), EASYSIMD_FLOAT32_C(    35.18) },
      EASYSIMD_FLOAT32_C(   -55.56),
      { EASYSIMD_FLOAT32_C(-45895.89), EASYSIMD_FLOAT32_C( -1954.60) } },
    { { EASYSIMD_FLOAT32_C(   331.09), EASYSIMD_FLOAT32_C(    34.30) },
      EASYSIMD_FLOAT32_C(   -93.48),
      { EASYSIMD_FLOAT32_C(-30950.29), EASYSIMD_FLOAT32_C( -3206.36) } },
    { { EASYSIMD_FLOAT32_C(  -539.02), EASYSIMD_FLOAT32_C(  -424.49) },
      EASYSIMD_FLOAT32_C(   433.22),
      { EASYSIMD_FLOAT32_C(-233514.25), EASYSIMD_FLOAT32_C(-183897.55) } },
    { { EASYSIMD_FLOAT32_C(  -259.56), EASYSIMD_FLOAT32_C(  -381.86) },
      EASYSIMD_FLOAT32_C(  -747.65),
      { EASYSIMD_FLOAT32_C(194060.03), EASYSIMD_FLOAT32_C(285497.62) } },
    { { EASYSIMD_FLOAT32_C(  -602.55), EASYSIMD_FLOAT32_C(   464.29) },
      EASYSIMD_FLOAT32_C(   164.24),
      { EASYSIMD_FLOAT32_C(-98962.81), EASYSIMD_FLOAT32_C( 76254.99) } },
    { { EASYSIMD_FLOAT32_C(  -454.97), EASYSIMD_FLOAT32_C(  -825.36) },
      EASYSIMD_FLOAT32_C(   -63.46),
      { EASYSIMD_FLOAT32_C( 28872.40), EASYSIMD_FLOAT32_C( 52377.34) } },
    { { EASYSIMD_FLOAT32_C(  -885.16), EASYSIMD_FLOAT32_C(  -707.21) },
      EASYSIMD_FLOAT32_C(   474.46),
      { EASYSIMD_FLOAT32_C(-419973.00), EASYSIMD_FLOAT32_C(-335542.88) } },
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_float32x2_t r = easysimd_vmul_n_f32(a, b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_float32 b = easysimd_test_codegen_random_f32(-1000.0f, 1000.0f);
    easysimd_float32x2_t r = easysimd_vmul_n_f32(a, b);
...
static int
test_easysimd_vmul_n_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    ...
    { { EASYSIMD_FLOAT64_C(     8.29) },
      EASYSIMD_FLOAT64_C(   136.66),
      { EASYSIMD_FLOAT64_C(  1132.91) } },
    { { EASYSIMD_FLOAT64_C(   594.35) },
      EASYSIMD_FLOAT64_C(   690.12),
      { EASYSIMD_FLOAT64_C(410172.82) } },
    { { EASYSIMD_FLOAT64_C(   410.65) },
      EASYSIMD_FLOAT64_C(  -245.50),
      { EASYSIMD_FLOAT64_C(-100814.57) } },
    { { EASYSIMD_FLOAT64_C(  -390.11) },
      EASYSIMD_FLOAT64_C(  -996.89),
      { EASYSIMD_FLOAT64_C(388896.76) } },
    { { EASYSIMD_FLOAT64_C(  -725.18) },
      EASYSIMD_FLOAT64_C(   771.24),
      { EASYSIMD_FLOAT64_C(-559287.82) } },
    { { EASYSIMD_FLOAT64_C(  -382.17) },
      EASYSIMD_FLOAT64_C(    80.74),
      { EASYSIMD_FLOAT64_C(-30856.41) } },
    { { EASYSIMD_FLOAT64_C(    57.06) },
      EASYSIMD_FLOAT64_C(   152.89),
      { EASYSIMD_FLOAT64_C(  8723.90) } },
    { { EASYSIMD_FLOAT64_C(  -971.23) },
      EASYSIMD_FLOAT64_C(   806.94),
      { EASYSIMD_FLOAT64_C(-783724.34) } },
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_float64x1_t r = easysimd_vmul_n_f64(a, b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_float64 b = easysimd_test_codegen_random_f64(-1000.0f, 1000.0f);
    easysimd_float64x1_t r = easysimd_vmul_n_f64(a, b);
...
static int
test_easysimd_vmul_n_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int16_t a[4];
    int16_t b;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int16x4_t r = easysimd_vmul_n_s16(a, b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    int16_t b = easysimd_test_codegen_random_i16();
    easysimd_int16x4_t r = easysimd_vmul_n_s16(a, b);
...
static int
test_easysimd_vmul_n_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t a[2];
    int32_t b;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x2_t r = easysimd_vmul_n_s32(a, b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    int32_t b = easysimd_test_codegen_random_i32();
    easysimd_int32x2_t r = easysimd_vmul_n_s32(a, b);
...
static int
test_easysimd_vmul_n_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint16_t a[4];
    uint16_t b;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x4_t r = easysimd_vmul_n_u16(a, b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    uint16_t b = easysimd_test_codegen_random_u16();
    easysimd_uint16x4_t r = easysimd_vmul_n_u16(a, b);

    easysimd_test_arm_neon_write_u16x4(2, a, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_codegen_write_u16(2, b, EASYSIMD_TEST_VEC_POS_MIDDLE);
...
static int
test_easysimd_vmul_n_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint32_t a[2];
    uint32_t b;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x2_t r = easysimd_vmul_n_u32(a, b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    uint32_t b = easysimd_test_codegen_random_u32();
    easysimd_uint32x2_t r = easysimd_vmul_n_u32(a, b);

    easysimd_test_arm_neon_write_u32x2(2, a, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_codegen_write_u32(2, b, EASYSIMD_TEST_VEC_POS_MIDDLE);
...
static int
test_easysimd_vmulq_n_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    ...
    { { EASYSIMD_FLOAT32_C(   715.05), EASYSIMD_FLOAT32_C(  -716.07), EASYSIMD_FLOAT32_C(  -502.73), EASYSIMD_FLOAT32_C(   871.00) },
      EASYSIMD_FLOAT32_C(   429.18),
      { EASYSIMD_FLOAT32_C(306885.16), EASYSIMD_FLOAT32_C(-307322.91), EASYSIMD_FLOAT32_C(-215761.66), EASYSIMD_FLOAT32_C(373815.78) } },
    { { EASYSIMD_FLOAT32_C(  -532.27), EASYSIMD_FLOAT32_C(  -766.37), EASYSIMD_FLOAT32_C(  -989.32), EASYSIMD_FLOAT32_C(   215.47) },
      EASYSIMD_FLOAT32_C(   230.94),
      { EASYSIMD_FLOAT32_C(-122922.44), EASYSIMD_FLOAT32_C(-176985.48), EASYSIMD_FLOAT32_C(-228473.56), EASYSIMD_FLOAT32_C( 49760.64) } },
    { { EASYSIMD_FLOAT32_C(  -948.09), EASYSIMD_FLOAT32_C(  -787.27), EASYSIMD_FLOAT32_C(  -800.69), EASYSIMD_FLOAT32_C(  -447.45) },
      EASYSIMD_FLOAT32_C(    14.29),
      { EASYSIMD_FLOAT32_C(-13548.21), EASYSIMD_FLOAT32_C(-11250.09), EASYSIMD_FLOAT32_C(-11441.86), EASYSIMD_FLOAT32_C( -6394.06) } },
    { { EASYSIMD_FLOAT32_C(  -572.66), EASYSIMD_FLOAT32_C(   567.13), EASYSIMD_FLOAT32_C(  -909.19), EASYSIMD_FLOAT32_C(   166.79) },
      EASYSIMD_FLOAT32_C(  -610.23),
      { EASYSIMD_FLOAT32_C(349454.28), EASYSIMD_FLOAT32_C(-346079.72), EASYSIMD_FLOAT32_C(554815.00), EASYSIMD_FLOAT32_C(-101780.26) } },
    { { EASYSIMD_FLOAT32_C(   231.91), EASYSIMD_FLOAT32_C(   484.47), EASYSIMD_FLOAT32_C(   543.89), EASYSIMD_FLOAT32_C(   817.92) },
      EASYSIMD_FLOAT32_C(  -700.44),
      { EASYSIMD_FLOAT32_C(-162439.05), EASYSIMD_FLOAT32_C(-339342.16), EASYSIMD_FLOAT32_C(-380962.31), EASYSIMD_FLOAT32_C(-572903.88) } },
    { { EASYSIMD_FLOAT32_C(   709.18), EASYSIMD_FLOAT32_C(    81.85), EASYSIMD_FLOAT32_C(  -425.91), EASYSIMD_FLOAT32_C(   317.14) },
      EASYSIMD_FLOAT32_C(   890.53),
      { EASYSIMD_FLOAT32_C(631546.06), EASYSIMD_FLOAT32_C( 72889.88), EASYSIMD_FLOAT32_C(-379285.66), EASYSIMD_FLOAT32_C(282422.72) } },
    { { EASYSIMD_FLOAT32_C(   108.81), EASYSIMD_FLOAT32_C(    32.18), EASYSIMD_FLOAT32_C(  -825.54), EASYSIMD_FLOAT32_C(   606.08) },
      EASYSIMD_FLOAT32_C(   -96.81),
      { EASYSIMD_FLOAT32_C(-10533.90), EASYSIMD_FLOAT32_C( -3115.35), EASYSIMD_FLOAT32_C( 79920.52), EASYSIMD_FLOAT32_C(-58674.61) } },
    { { EASYSIMD_FLOAT32_C(   603.63), EASYSIMD_FLOAT32_C(  -926.19), EASYSIMD_FLOAT32_C(   136.81), EASYSIMD_FLOAT32_C(   614.31) },
      EASYSIMD_FLOAT32_C(   289.28),
      { EASYSIMD_FLOAT32_C(174618.09), EASYSIMD_FLOAT32_C(-267928.25), EASYSIMD_FLOAT32_C( 39576.39), EASYSIMD_FLOAT32_C(177707.59) } },
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_float32 b = test_vec[i].b;
    easysimd_float32x4_t r = easysimd_vmulq_n_f32(a, b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_float32 b = easysimd_test_codegen_random_f32(-1000.0f, 1000.0);
    easysimd_float32x4_t r = easysimd_vmulq_n_f32(a, b);
...
static int
test_easysimd_vmulq_n_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    ...
    { { EASYSIMD_FLOAT64_C(  -876.34), EASYSIMD_FLOAT64_C(  -946.04) },
      EASYSIMD_FLOAT64_C(  -921.46),
      { EASYSIMD_FLOAT64_C(807512.26), EASYSIMD_FLOAT64_C(871738.02) } },
    { { EASYSIMD_FLOAT64_C(  -297.61), EASYSIMD_FLOAT64_C(   953.41) },
      EASYSIMD_FLOAT64_C(  -273.22),
      { EASYSIMD_FLOAT64_C( 81313.00), EASYSIMD_FLOAT64_C(-260490.68) } },
    { { EASYSIMD_FLOAT64_C(  -449.19), EASYSIMD_FLOAT64_C(   633.81) },
      EASYSIMD_FLOAT64_C(  -282.52),
      { EASYSIMD_FLOAT64_C(126905.16), EASYSIMD_FLOAT64_C(-179064.00) } },
    { { EASYSIMD_FLOAT64_C(    17.47), EASYSIMD_FLOAT64_C(   267.43) },
      EASYSIMD_FLOAT64_C(  -863.41),
      { EASYSIMD_FLOAT64_C(-15083.77), EASYSIMD_FLOAT64_C(-230901.74) } },
    { { EASYSIMD_FLOAT64_C(  -236.05), EASYSIMD_FLOAT64_C(   920.75) },
      EASYSIMD_FLOAT64_C(  -470.13),
      { EASYSIMD_FLOAT64_C(110974.19), EASYSIMD_FLOAT64_C(-432872.20) } },
    { { EASYSIMD_FLOAT64_C(  -667.31), EASYSIMD_FLOAT64_C(   277.78) },
      EASYSIMD_FLOAT64_C(    38.32),
      { EASYSIMD_FLOAT64_C(-25571.32), EASYSIMD_FLOAT64_C( 10644.53) } },
    { { EASYSIMD_FLOAT64_C(   502.96), EASYSIMD_FLOAT64_C(  -260.05) },
      EASYSIMD_FLOAT64_C(   348.52),
      { EASYSIMD_FLOAT64_C(175291.62), EASYSIMD_FLOAT64_C(-90632.63) } },
    { { EASYSIMD_FLOAT64_C(   -87.91), EASYSIMD_FLOAT64_C(  -360.14) },
      EASYSIMD_FLOAT64_C(   845.79),
      { EASYSIMD_FLOAT64_C(-74353.40), EASYSIMD_FLOAT64_C(-304602.81) } },
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_float64 b = test_vec[i].b;
    easysimd_float64x2_t r = easysimd_vmulq_n_f64(a, b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_float64 b = easysimd_test_codegen_random_f64(-1000.0, 1000.0);
    easysimd_float64x2_t r = easysimd_vmulq_n_f64(a, b);
...
static int
test_easysimd_vmulq_n_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int16_t a[8];
    int16_t b;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    int16_t b = test_vec[i].b;
    easysimd_int16x8_t r = easysimd_vmulq_n_s16(a, b);
...
static int
test_easysimd_vmulq_n_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t a[4];
    int32_t b;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    int32_t b = test_vec[i].b;
    easysimd_int32x4_t r = easysimd_vmulq_n_s32(a, b);
...
static int
test_easysimd_vmulq_n_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint16_t a[8];
    uint16_t b;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    uint16_t b = test_vec[i].b;
    easysimd_uint16x8_t r = easysimd_vmulq_n_u16(a, b);
...
static int
test_easysimd_vmulq_n_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint32_t a[4];
    uint32_t b;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    uint32_t b = test_vec[i].b;
    easysimd_uint32x4_t r = easysimd_vmulq_n_u32(a, b);
...
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmul_n_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmul_n_f64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmul_n_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmul_n_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmul_n_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmul_n_u32)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vmulq_n_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmulq_n_f64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmulq_n_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmulq_n_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmulq_n_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmulq_n_u32)
