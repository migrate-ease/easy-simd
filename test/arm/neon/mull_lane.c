...
#define EASYSIMD_TEST_ARM_NEON_INSN mull_lane

#include "test-neon.h"
#include "../../../easysimd/arm/neon/mull_lane.h"

static int
test_easysimd_vmull_lane_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int16_t a[4];
    int16_t v[4];
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    EASYSIMD_CONSTIFY_4_(easysimd_vmull_lane_s16, r, (HEDLEY_UNREACHABLE(), easysimd_vdupq_n_s32(0)), lane, a, v);
...
static int
test_easysimd_vmull_lane_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t a[2];
    int32_t v[2];
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    EASYSIMD_CONSTIFY_2_(easysimd_vmull_lane_s32, r, (HEDLEY_UNREACHABLE(), easysimd_vdupq_n_s64(0)), lane, a, v);
...
static int
test_easysimd_vmull_lane_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint16_t a[4];
    uint16_t v[4];
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    EASYSIMD_CONSTIFY_4_(easysimd_vmull_lane_u16, r, (HEDLEY_UNREACHABLE(), easysimd_vdupq_n_u32(0)), lane, a, v);
...
static int
test_easysimd_vmull_lane_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint32_t a[2];
    uint32_t v[2];
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    EASYSIMD_CONSTIFY_2_(easysimd_vmull_lane_u32, r, (HEDLEY_UNREACHABLE(), easysimd_vdupq_n_u64(0)), lane, a, v);
...
static int
test_easysimd_vmull_laneq_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int16_t a[4];
    int16_t v[8];
  ...
  r = easysimd_vmull_laneq_s16(a, v, 1);
  easysimd_test_arm_neon_assert_equal_i32x4(r, easysimd_vld1q_s32(test_vec[6].r));
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    EASYSIMD_CONSTIFY_8_(easysimd_vmull_laneq_s16, r, (HEDLEY_UNREACHABLE(), easysimd_vdupq_n_s32(0)), lane, a, v);
...
static int
test_easysimd_vmull_laneq_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t a[2];
    int32_t v[4];
    ...
    r = easysimd_vmull_laneq_s32(a, v, 3);
    easysimd_test_arm_neon_assert_equal_i64x2(r, easysimd_vld1q_s64(test_vec[2].r));
    ...
    r = easysimd_vmull_laneq_s32(a, v, 2);
    easysimd_test_arm_neon_assert_equal_i64x2(r, easysimd_vld1q_s64(test_vec[4].r));
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    EASYSIMD_CONSTIFY_4_(easysimd_vmull_laneq_s32, r, (HEDLEY_UNREACHABLE(), easysimd_vdupq_n_s64(0)), lane, a, v);
...
static int
test_easysimd_vmull_laneq_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint16_t a[4];
    uint16_t v[8];
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    EASYSIMD_CONSTIFY_8_(easysimd_vmull_laneq_u16, r, (HEDLEY_UNREACHABLE(), easysimd_vdupq_n_u32(0)), lane, a, v);
...
static int
test_easysimd_vmull_laneq_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint32_t a[2];
    uint32_t v[4];
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    EASYSIMD_CONSTIFY_4_(easysimd_vmull_laneq_u32, r, (HEDLEY_UNREACHABLE(), easysimd_vdupq_n_u64(0)), lane, a, v);
...
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmull_lane_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmull_lane_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmull_lane_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmull_lane_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmull_laneq_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmull_laneq_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmull_laneq_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vmull_laneq_u32)
