#define EASYSIMD_TEST_ARM_NEON_INSN neg

#include "test-neon.h"
#include "../../../easysimd/arm/neon/neg.h"

static int
test_easysimd_vneg_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    easysimd_float32 a[2];
    easysimd_float32 r[2];
  } test_vec[] = {
    { { EASYSIMD_FLOAT32_C(   716.64), EASYSIMD_FLOAT32_C(  -987.31) },
      { EASYSIMD_FLOAT32_C(  -716.64), EASYSIMD_FLOAT32_C(   987.31) } },
    { { EASYSIMD_FLOAT32_C(   -83.05), EASYSIMD_FLOAT32_C(  -486.69) },
      { EASYSIMD_FLOAT32_C(    83.05), EASYSIMD_FLOAT32_C(   486.69) } },
    { { EASYSIMD_FLOAT32_C(    36.35), EASYSIMD_FLOAT32_C(   515.69) },
      { EASYSIMD_FLOAT32_C(   -36.35), EASYSIMD_FLOAT32_C(  -515.69) } },
    { { EASYSIMD_FLOAT32_C(  -864.35), EASYSIMD_FLOAT32_C(   418.22) },
      { EASYSIMD_FLOAT32_C(   864.35), EASYSIMD_FLOAT32_C(  -418.22) } },
    { { EASYSIMD_FLOAT32_C(  -825.75), EASYSIMD_FLOAT32_C(  -563.01) },
      { EASYSIMD_FLOAT32_C(   825.75), EASYSIMD_FLOAT32_C(   563.01) } },
    { { EASYSIMD_FLOAT32_C(  -635.51), EASYSIMD_FLOAT32_C(  -778.46) },
      { EASYSIMD_FLOAT32_C(   635.51), EASYSIMD_FLOAT32_C(   778.46) } },
    { { EASYSIMD_FLOAT32_C(   755.42), EASYSIMD_FLOAT32_C(   443.43) },
      { EASYSIMD_FLOAT32_C(  -755.42), EASYSIMD_FLOAT32_C(  -443.43) } },
    { { EASYSIMD_FLOAT32_C(  -286.48), EASYSIMD_FLOAT32_C(  -693.77) },
      { EASYSIMD_FLOAT32_C(   286.48), EASYSIMD_FLOAT32_C(   693.77) } }
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float32x2_t a = easysimd_vld1_f32(test_vec[i].a);
    easysimd_float32x2_t r = easysimd_vneg_f32(a);
...
static int
test_easysimd_vneg_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    easysimd_float64 a[1];
    easysimd_float64 r[1];
  } test_vec[] = {
    { { EASYSIMD_FLOAT64_C(   -67.79) },
      { EASYSIMD_FLOAT64_C(    67.79) } },
    { { EASYSIMD_FLOAT64_C(  -759.84) },
      { EASYSIMD_FLOAT64_C(   759.84) } },
    { { EASYSIMD_FLOAT64_C(   497.94) },
      { EASYSIMD_FLOAT64_C(  -497.94) } },
    { { EASYSIMD_FLOAT64_C(   813.37) },
      { EASYSIMD_FLOAT64_C(  -813.37) } },
    { { EASYSIMD_FLOAT64_C(  -277.49) },
      { EASYSIMD_FLOAT64_C(   277.49) } },
    { { EASYSIMD_FLOAT64_C(   513.19) },
      { EASYSIMD_FLOAT64_C(  -513.19) } },
    { { EASYSIMD_FLOAT64_C(  -893.67) },
      { EASYSIMD_FLOAT64_C(   893.67) } },
    { { EASYSIMD_FLOAT64_C(   120.57) },
      { EASYSIMD_FLOAT64_C(  -120.57) } }
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float64x1_t a = easysimd_vld1_f64(test_vec[i].a);
    easysimd_float64x1_t r = easysimd_vneg_f64(a);
...
static int
test_easysimd_vneg_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int8_t a[8];
    int8_t r[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int8x8_t r = easysimd_vneg_s8(a);
...
static int
test_easysimd_vneg_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int16_t a[4];
    int16_t r[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int16x4_t r = easysimd_vneg_s16(a);
...
static int
test_easysimd_vneg_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t a[2];
    int32_t r[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x2_t r = easysimd_vneg_s32(a);
...
static int
test_easysimd_vneg_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int64_t a[1];
    int64_t r[1];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int64x1_t r = easysimd_vneg_s64(a);
...
static int
test_easysimd_vnegq_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    easysimd_float32 a[4];
    easysimd_float32 r[4];
  } test_vec[] = {
    { { EASYSIMD_FLOAT32_C(   804.42), EASYSIMD_FLOAT32_C(  -601.06), EASYSIMD_FLOAT32_C(  -462.25), EASYSIMD_FLOAT32_C(  -337.95) },
      { EASYSIMD_FLOAT32_C(  -804.42), EASYSIMD_FLOAT32_C(   601.06), EASYSIMD_FLOAT32_C(   462.25), EASYSIMD_FLOAT32_C(   337.95) } },
    { { EASYSIMD_FLOAT32_C(  -866.80), EASYSIMD_FLOAT32_C(  -244.09), EASYSIMD_FLOAT32_C(   711.44), EASYSIMD_FLOAT32_C(   906.78) },
      { EASYSIMD_FLOAT32_C(   866.80), EASYSIMD_FLOAT32_C(   244.09), EASYSIMD_FLOAT32_C(  -711.44), EASYSIMD_FLOAT32_C(  -906.78) } },
    { { EASYSIMD_FLOAT32_C(  -339.26), EASYSIMD_FLOAT32_C(  -922.22), EASYSIMD_FLOAT32_C(  -188.81), EASYSIMD_FLOAT32_C(   579.99) },
      { EASYSIMD_FLOAT32_C(   339.26), EASYSIMD_FLOAT32_C(   922.22), EASYSIMD_FLOAT32_C(   188.81), EASYSIMD_FLOAT32_C(  -579.99) } },
    { { EASYSIMD_FLOAT32_C(  -134.89), EASYSIMD_FLOAT32_C(  -740.85), EASYSIMD_FLOAT32_C(  -696.51), EASYSIMD_FLOAT32_C(   -24.34) },
      { EASYSIMD_FLOAT32_C(   134.89), EASYSIMD_FLOAT32_C(   740.85), EASYSIMD_FLOAT32_C(   696.51), EASYSIMD_FLOAT32_C(    24.34) } },
    { { EASYSIMD_FLOAT32_C(   818.56), EASYSIMD_FLOAT32_C(   209.57), EASYSIMD_FLOAT32_C(   842.16), EASYSIMD_FLOAT32_C(   742.03) },
      { EASYSIMD_FLOAT32_C(  -818.56), EASYSIMD_FLOAT32_C(  -209.57), EASYSIMD_FLOAT32_C(  -842.16), EASYSIMD_FLOAT32_C(  -742.03) } },
    { { EASYSIMD_FLOAT32_C(    92.41), EASYSIMD_FLOAT32_C(  -593.00), EASYSIMD_FLOAT32_C(   705.50), EASYSIMD_FLOAT32_C(  -603.00) },
      { EASYSIMD_FLOAT32_C(   -92.41), EASYSIMD_FLOAT32_C(   593.00), EASYSIMD_FLOAT32_C(  -705.50), EASYSIMD_FLOAT32_C(   603.00) } },
    { { EASYSIMD_FLOAT32_C(  -438.51), EASYSIMD_FLOAT32_C(   671.01), EASYSIMD_FLOAT32_C(  -393.07), EASYSIMD_FLOAT32_C(   195.29) },
      { EASYSIMD_FLOAT32_C(   438.51), EASYSIMD_FLOAT32_C(  -671.01), EASYSIMD_FLOAT32_C(   393.07), EASYSIMD_FLOAT32_C(  -195.29) } },
    { { EASYSIMD_FLOAT32_C(   829.18), EASYSIMD_FLOAT32_C(   342.47), EASYSIMD_FLOAT32_C(   267.28), EASYSIMD_FLOAT32_C(   633.59) },
      { EASYSIMD_FLOAT32_C(  -829.18), EASYSIMD_FLOAT32_C(  -342.47), EASYSIMD_FLOAT32_C(  -267.28), EASYSIMD_FLOAT32_C(  -633.59) } }
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float32x4_t a = easysimd_vld1q_f32(test_vec[i].a);
    easysimd_float32x4_t r = easysimd_vnegq_f32(a);
...
static int
test_easysimd_vnegq_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    easysimd_float64 a[2];
    easysimd_float64 r[2];
  } test_vec[] = {
    { { EASYSIMD_FLOAT64_C(    29.13), EASYSIMD_FLOAT64_C(  -879.83) },
      { EASYSIMD_FLOAT64_C(   -29.13), EASYSIMD_FLOAT64_C(   879.83) } },
    { { EASYSIMD_FLOAT64_C(   870.39), EASYSIMD_FLOAT64_C(  -154.06) },
      { EASYSIMD_FLOAT64_C(  -870.39), EASYSIMD_FLOAT64_C(   154.06) } },
    { { EASYSIMD_FLOAT64_C(  -918.42), EASYSIMD_FLOAT64_C(   809.31) },
      { EASYSIMD_FLOAT64_C(   918.42), EASYSIMD_FLOAT64_C(  -809.31) } },
    { { EASYSIMD_FLOAT64_C(   998.46), EASYSIMD_FLOAT64_C(   -21.80) },
      { EASYSIMD_FLOAT64_C(  -998.46), EASYSIMD_FLOAT64_C(    21.80) } },
    { { EASYSIMD_FLOAT64_C(  -937.13), EASYSIMD_FLOAT64_C(  -287.08) },
      { EASYSIMD_FLOAT64_C(   937.13), EASYSIMD_FLOAT64_C(   287.08) } },
    { { EASYSIMD_FLOAT64_C(   803.74), EASYSIMD_FLOAT64_C(  -923.43) },
      { EASYSIMD_FLOAT64_C(  -803.74), EASYSIMD_FLOAT64_C(   923.43) } },
    { { EASYSIMD_FLOAT64_C(  -658.03), EASYSIMD_FLOAT64_C(   943.52) },
      { EASYSIMD_FLOAT64_C(   658.03), EASYSIMD_FLOAT64_C(  -943.52) } },
    { { EASYSIMD_FLOAT64_C(   715.86), EASYSIMD_FLOAT64_C(  -973.82) },
      { EASYSIMD_FLOAT64_C(  -715.86), EASYSIMD_FLOAT64_C(   973.82) } }
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float64x2_t a = easysimd_vld1q_f64(test_vec[i].a);
    easysimd_float64x2_t r = easysimd_vnegq_f64(a);
...
static int
test_easysimd_vnegq_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int8_t a[16];
    int8_t r[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int8x16_t r = easysimd_vnegq_s8(a);
...
static int
test_easysimd_vnegq_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int16_t a[8];
    int16_t r[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int16x8_t r = easysimd_vnegq_s16(a);
...
static int
test_easysimd_vnegq_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t a[4];
    int32_t r[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x4_t r = easysimd_vnegq_s32(a);
...
static int
test_easysimd_vnegq_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int64_t a[2];
    int64_t r[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int64x2_t r = easysimd_vnegq_s64(a);
...
EASYSIMD_TEST_FUNC_LIST_ENTRY(vneg_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vneg_f64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vneg_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vneg_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vneg_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vneg_s64)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vnegq_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vnegq_f64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vnegq_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vnegq_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vnegq_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vnegq_s64)
