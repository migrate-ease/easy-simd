#define EASYSIMD_TEST_ARM_NEON_INSN padal

#include "test-neon.h"
#include "../../../easysimd/arm/neon/padal.h"

static int
test_easysimd_vpadal_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int16_t a[4];
    int8_t b[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int16x4_t r = easysimd_vpadal_s8(a, b);
...
static int
test_easysimd_vpadal_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t a[2];
    int16_t b[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x2_t r = easysimd_vpadal_s16(a, b);
...
static int
test_easysimd_vpadal_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int64_t a[1];
    int32_t b[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int64x1_t r = easysimd_vpadal_s32(a, b);
...
static int
test_easysimd_vpadal_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint16_t a[4];
    uint8_t b[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x4_t r = easysimd_vpadal_u8(a, b);
...
static int
test_easysimd_vpadal_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint32_t a[2];
    uint16_t b[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x2_t r = easysimd_vpadal_u16(a, b);
...
static int
test_easysimd_vpadal_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint64_t a[1];
    uint32_t b[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint64x1_t r = easysimd_vpadal_u32(a, b);
...
static int
test_easysimd_vpadalq_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int16_t a[8];
    int8_t b[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int16x8_t r = easysimd_vpadalq_s8(a, b);
...
static int
test_easysimd_vpadalq_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t a[4];
    int16_t b[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x4_t r = easysimd_vpadalq_s16(a, b);
...
static int
test_easysimd_vpadalq_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int64_t a[2];
    int32_t b[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int64x2_t r = easysimd_vpadalq_s32(a, b);
...
static int
test_easysimd_vpadalq_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint16_t a[8];
    uint8_t b[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x8_t r = easysimd_vpadalq_u8(a, b);
...
static int
test_easysimd_vpadalq_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint32_t a[4];
    uint16_t b[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x4_t r = easysimd_vpadalq_u16(a, b);
...
static int
test_easysimd_vpadalq_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint64_t a[2];
    uint32_t b[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint64x2_t r = easysimd_vpadalq_u32(a, b);
...
EASYSIMD_TEST_FUNC_LIST_ENTRY(vpadal_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vpadal_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vpadal_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vpadal_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vpadal_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vpadal_u32)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vpadalq_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vpadalq_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vpadalq_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vpadalq_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vpadalq_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vpadalq_u32)
