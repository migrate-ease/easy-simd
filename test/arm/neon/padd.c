#define EASYSIMD_TEST_ARM_NEON_INSN padd

#include "test-neon.h"
#include "../../../easysimd/arm/neon/padd.h"

static int
test_easysimd_vpadd_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    easysimd_float32 a[2];
    easysimd_float32 b[2];
    easysimd_float32 r[2];
  } test_vec[] = {
    { { EASYSIMD_FLOAT32_C(   364.07), EASYSIMD_FLOAT32_C(  -805.98) },
      { EASYSIMD_FLOAT32_C(   541.55), EASYSIMD_FLOAT32_C(  -507.67) },
      { EASYSIMD_FLOAT32_C(  -441.91), EASYSIMD_FLOAT32_C(    33.88) } },
    { { EASYSIMD_FLOAT32_C(  -210.05), EASYSIMD_FLOAT32_C(   950.23) },
      { EASYSIMD_FLOAT32_C(   -73.21), EASYSIMD_FLOAT32_C(  -858.69) },
      { EASYSIMD_FLOAT32_C(   740.18), EASYSIMD_FLOAT32_C(  -931.90) } },
    { { EASYSIMD_FLOAT32_C(   289.47), EASYSIMD_FLOAT32_C(   222.50) },
      { EASYSIMD_FLOAT32_C(  -617.39), EASYSIMD_FLOAT32_C(    38.06) },
      { EASYSIMD_FLOAT32_C(   511.98), EASYSIMD_FLOAT32_C(  -579.33) } },
    { { EASYSIMD_FLOAT32_C(  -385.12), EASYSIMD_FLOAT32_C(  -947.12) },
      { EASYSIMD_FLOAT32_C(  -383.15), EASYSIMD_FLOAT32_C(  -390.83) },
      { EASYSIMD_FLOAT32_C( -1332.24), EASYSIMD_FLOAT32_C(  -773.98) } },
    { { EASYSIMD_FLOAT32_C(   787.35), EASYSIMD_FLOAT32_C(   150.74) },
      { EASYSIMD_FLOAT32_C(   -44.15), EASYSIMD_FLOAT32_C(   -31.92) },
      { EASYSIMD_FLOAT32_C(   938.08), EASYSIMD_FLOAT32_C(   -76.07) } },
    { { EASYSIMD_FLOAT32_C(   608.96), EASYSIMD_FLOAT32_C(  -994.50) },
      { EASYSIMD_FLOAT32_C(  -198.21), EASYSIMD_FLOAT32_C(  -284.71) },
      { EASYSIMD_FLOAT32_C(  -385.53), EASYSIMD_FLOAT32_C(  -482.92) } },
    { { EASYSIMD_FLOAT32_C(   116.75), EASYSIMD_FLOAT32_C(   296.49) },
      { EASYSIMD_FLOAT32_C(  -579.72), EASYSIMD_FLOAT32_C(  -346.53) },
      { EASYSIMD_FLOAT32_C(   413.24), EASYSIMD_FLOAT32_C(  -926.24) } },
    { { EASYSIMD_FLOAT32_C(  -405.05), EASYSIMD_FLOAT32_C(   579.35) },
      { EASYSIMD_FLOAT32_C(   172.94), EASYSIMD_FLOAT32_C(   959.02) },
      { EASYSIMD_FLOAT32_C(   174.30), EASYSIMD_FLOAT32_C(  1131.96) } },
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float32x2_t a = easysimd_vld1_f32(test_vec[i].a);
    easysimd_float32x2_t b = easysimd_vld1_f32(test_vec[i].b);
    easysimd_float32x2_t r = easysimd_vpadd_f32(a, b);
...
static int
test_easysimd_vpadd_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int8_t a[8];
    int8_t b[8];
    int8_t r[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int8x8_t r = easysimd_vpadd_s8(a, b);
...
static int
test_easysimd_vpadd_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int16_t a[4];
    int16_t b[4];
    int16_t r[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int16x4_t r = easysimd_vpadd_s16(a, b);
...
static int
test_easysimd_vpadd_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int32_t a[2];
    int32_t b[2];
    int32_t r[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x2_t r = easysimd_vpadd_s32(a, b);
...
static int
test_easysimd_vpadd_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint8_t a[16];
    uint8_t b[16];
    uint8_t r[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x8_t r = easysimd_vpadd_u8(a, b);
...
static int
test_easysimd_vpadd_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint16_t a[4];
    uint16_t b[4];
    uint16_t r[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x4_t r = easysimd_vpadd_u16(a, b);
...
static int
test_easysimd_vpadd_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint32_t a[2];
    uint32_t b[2];
    uint32_t r[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x2_t r = easysimd_vpadd_u32(a, b);
...
static int
test_easysimd_vpaddq_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    easysimd_float32 a[4];
    easysimd_float32 b[4];
    easysimd_float32 r[4];
  } test_vec[] = {
    { { EASYSIMD_FLOAT32_C(   288.42), EASYSIMD_FLOAT32_C(   -21.02), EASYSIMD_FLOAT32_C(  -974.95), EASYSIMD_FLOAT32_C(  -192.40) },
      { EASYSIMD_FLOAT32_C(  -577.52), EASYSIMD_FLOAT32_C(   442.97), EASYSIMD_FLOAT32_C(  -440.24), EASYSIMD_FLOAT32_C(   115.18) },
      { EASYSIMD_FLOAT32_C(   267.40), EASYSIMD_FLOAT32_C( -1167.35), EASYSIMD_FLOAT32_C(  -134.54), EASYSIMD_FLOAT32_C(  -325.05) } },
    { { EASYSIMD_FLOAT32_C(     7.02), EASYSIMD_FLOAT32_C(  -617.77), EASYSIMD_FLOAT32_C(   477.82), EASYSIMD_FLOAT32_C(   908.71) },
      { EASYSIMD_FLOAT32_C(  -987.94), EASYSIMD_FLOAT32_C(  -606.22), EASYSIMD_FLOAT32_C(  -272.93), EASYSIMD_FLOAT32_C(  -275.00) },
      { EASYSIMD_FLOAT32_C(  -610.74), EASYSIMD_FLOAT32_C(  1386.53), EASYSIMD_FLOAT32_C( -1594.16), EASYSIMD_FLOAT32_C(  -547.94) } },
    { { EASYSIMD_FLOAT32_C(   -93.25), EASYSIMD_FLOAT32_C(   892.97), EASYSIMD_FLOAT32_C(  -408.68), EASYSIMD_FLOAT32_C(   -20.37) },
      { EASYSIMD_FLOAT32_C(  -622.02), EASYSIMD_FLOAT32_C(  -239.70), EASYSIMD_FLOAT32_C(   793.71), EASYSIMD_FLOAT32_C(  -983.86) },
      { EASYSIMD_FLOAT32_C(   799.72), EASYSIMD_FLOAT32_C(  -429.06), EASYSIMD_FLOAT32_C(  -861.72), EASYSIMD_FLOAT32_C(  -190.15) } },
    { { EASYSIMD_FLOAT32_C(  -339.96), EASYSIMD_FLOAT32_C(   415.18), EASYSIMD_FLOAT32_C(   196.04), EASYSIMD_FLOAT32_C(  -159.70) },
      { EASYSIMD_FLOAT32_C(   128.82), EASYSIMD_FLOAT32_C(   843.81), EASYSIMD_FLOAT32_C(   217.86), EASYSIMD_FLOAT32_C(  -582.76) },
      { EASYSIMD_FLOAT32_C(    75.21), EASYSIMD_FLOAT32_C(    36.34), EASYSIMD_FLOAT32_C(   972.63), EASYSIMD_FLOAT32_C(  -364.90) } },
    { { EASYSIMD_FLOAT32_C(  -177.21), EASYSIMD_FLOAT32_C(   242.90), EASYSIMD_FLOAT32_C(   224.84), EASYSIMD_FLOAT32_C(   245.28) },
      { EASYSIMD_FLOAT32_C(  -314.13), EASYSIMD_FLOAT32_C(   784.61), EASYSIMD_FLOAT32_C(  -639.54), EASYSIMD_FLOAT32_C(   692.90) },
      { EASYSIMD_FLOAT32_C(    65.70), EASYSIMD_FLOAT32_C(   470.12), EASYSIMD_FLOAT32_C(   470.48), EASYSIMD_FLOAT32_C(    53.36) } },
    { { EASYSIMD_FLOAT32_C(  -833.16), EASYSIMD_FLOAT32_C(   838.28), EASYSIMD_FLOAT32_C(   601.61), EASYSIMD_FLOAT32_C(  -821.10) },
      { EASYSIMD_FLOAT32_C(  -767.94), EASYSIMD_FLOAT32_C(  -671.32), EASYSIMD_FLOAT32_C(   -96.10), EASYSIMD_FLOAT32_C(   138.81) },
      { EASYSIMD_FLOAT32_C(     5.12), EASYSIMD_FLOAT32_C(  -219.49), EASYSIMD_FLOAT32_C( -1439.26), EASYSIMD_FLOAT32_C(    42.71) } },
    { { EASYSIMD_FLOAT32_C(  -778.36), EASYSIMD_FLOAT32_C(   495.21), EASYSIMD_FLOAT32_C(  -881.56), EASYSIMD_FLOAT32_C(  -400.38) },
      { EASYSIMD_FLOAT32_C(  -744.48), EASYSIMD_FLOAT32_C(   912.15), EASYSIMD_FLOAT32_C(  -384.24), EASYSIMD_FLOAT32_C(   -84.44) },
      { EASYSIMD_FLOAT32_C(  -283.14), EASYSIMD_FLOAT32_C( -1281.94), EASYSIMD_FLOAT32_C(   167.67), EASYSIMD_FLOAT32_C(  -468.68) } },
    { { EASYSIMD_FLOAT32_C(   327.32), EASYSIMD_FLOAT32_C(   811.80), EASYSIMD_FLOAT32_C(   755.86), EASYSIMD_FLOAT32_C(  -543.86) },
      { EASYSIMD_FLOAT32_C(   655.62), EASYSIMD_FLOAT32_C(   -26.28), EASYSIMD_FLOAT32_C(  -126.62), EASYSIMD_FLOAT32_C(  -521.59) },
      { EASYSIMD_FLOAT32_C(  1139.13), EASYSIMD_FLOAT32_C(   212.00), EASYSIMD_FLOAT32_C(   629.33), EASYSIMD_FLOAT32_C(  -648.21) } },
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float32x4_t a = easysimd_vld1q_f32(test_vec[i].a);
    easysimd_float32x4_t b = easysimd_vld1q_f32(test_vec[i].b);
    easysimd_float32x4_t r = easysimd_vpaddq_f32(a, b);
...
static int
test_easysimd_vpaddq_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    easysimd_float64 a[2];
    easysimd_float64 b[2];
    easysimd_float64 r[2];
  } test_vec[] = {
    { { EASYSIMD_FLOAT64_C(  -304.59), EASYSIMD_FLOAT64_C(   738.24) },
      { EASYSIMD_FLOAT64_C(  -491.10), EASYSIMD_FLOAT64_C(    20.25) },
      { EASYSIMD_FLOAT64_C(   433.66), EASYSIMD_FLOAT64_C(  -470.85) } },
    { { EASYSIMD_FLOAT64_C(    46.86), EASYSIMD_FLOAT64_C(  -650.53) },
      { EASYSIMD_FLOAT64_C(   209.27), EASYSIMD_FLOAT64_C(   722.54) },
      { EASYSIMD_FLOAT64_C(  -603.67), EASYSIMD_FLOAT64_C(   931.81) } },
    { { EASYSIMD_FLOAT64_C(  -507.52), EASYSIMD_FLOAT64_C(    40.12) },
      { EASYSIMD_FLOAT64_C(   676.59), EASYSIMD_FLOAT64_C(   843.37) },
      { EASYSIMD_FLOAT64_C(  -467.40), EASYSIMD_FLOAT64_C(  1519.96) } },
    { { EASYSIMD_FLOAT64_C(  -613.61), EASYSIMD_FLOAT64_C(   272.81) },
      { EASYSIMD_FLOAT64_C(   650.30), EASYSIMD_FLOAT64_C(   222.96) },
      { EASYSIMD_FLOAT64_C(  -340.80), EASYSIMD_FLOAT64_C(   873.26) } },
    { { EASYSIMD_FLOAT64_C(   615.20), EASYSIMD_FLOAT64_C(  -394.78) },
      { EASYSIMD_FLOAT64_C(   469.07), EASYSIMD_FLOAT64_C(    54.35) },
      { EASYSIMD_FLOAT64_C(   220.41), EASYSIMD_FLOAT64_C(   523.42) } },
    { { EASYSIMD_FLOAT64_C(  -172.64), EASYSIMD_FLOAT64_C(   682.30) },
      { EASYSIMD_FLOAT64_C(  -786.74), EASYSIMD_FLOAT64_C(   236.37) },
      { EASYSIMD_FLOAT64_C(   509.66), EASYSIMD_FLOAT64_C(  -550.37) } },
    { { EASYSIMD_FLOAT64_C(   915.30), EASYSIMD_FLOAT64_C(   782.55) },
      { EASYSIMD_FLOAT64_C(   199.30), EASYSIMD_FLOAT64_C(  -594.15) },
      { EASYSIMD_FLOAT64_C(  1697.85), EASYSIMD_FLOAT64_C(  -394.85) } },
    { { EASYSIMD_FLOAT64_C(   264.00), EASYSIMD_FLOAT64_C(  -410.11) },
      { EASYSIMD_FLOAT64_C(  -427.51), EASYSIMD_FLOAT64_C(   959.41) },
      { EASYSIMD_FLOAT64_C(  -146.12), EASYSIMD_FLOAT64_C(   531.90) } },
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float64x2_t a = easysimd_vld1q_f64(test_vec[i].a);
    easysimd_float64x2_t b = easysimd_vld1q_f64(test_vec[i].b);
    easysimd_float64x2_t r = easysimd_vpaddq_f64(a, b);
...
static int
test_easysimd_vpaddq_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int8_t a[16];
    int8_t b[16];
    int8_t r[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int8x16_t r = easysimd_vpaddq_s8(a, b);
...
static int
test_easysimd_vpaddq_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int16_t a[8];
    int16_t b[8];
    int16_t r[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int16x8_t r = easysimd_vpaddq_s16(a, b);
...
static int
test_easysimd_vpaddq_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int32_t a[4];
    int32_t b[4];
    int32_t r[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x4_t r = easysimd_vpaddq_s32(a, b);
...
static int
test_easysimd_vpaddq_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int64_t a[2];
    int64_t b[2];
    int64_t r[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int64x2_t r = easysimd_vpaddq_s64(a, b);
...
static int
test_easysimd_vpaddq_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint8_t a[16];
    uint8_t b[16];
    uint8_t r[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x16_t r = easysimd_vpaddq_u8(a, b);
...
static int
test_easysimd_vpaddq_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint16_t a[8];
    uint16_t b[8];
    uint16_t r[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x8_t r = easysimd_vpaddq_u16(a, b);
...
static int
test_easysimd_vpaddq_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint32_t a[4];
    uint32_t b[4];
    uint32_t r[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x4_t r = easysimd_vpaddq_u32(a, b);
...
static int
test_easysimd_vpaddq_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint64_t a[2];
    uint64_t b[2];
    uint64_t r[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint64x2_t r = easysimd_vpaddq_u64(a, b);
...
static int
test_easysimd_vpaddd_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int64_t a[2];
    int64_t r;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_int64x2_t a = easysimd_vld1q_s64(test_vec[i].a);
    int64_t r = easysimd_vpaddd_s64(a);
...
static int
test_easysimd_vpaddd_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint64_t a[2];
    uint64_t r;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint64x2_t a = easysimd_vld1q_u64(test_vec[i].a);
    uint64_t r = easysimd_vpaddd_u64(a);
...
static int
test_easysimd_vpaddd_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    easysimd_float64_t a[2];
    easysimd_float64_t r;
  } test_vec[] = {
    { { EASYSIMD_FLOAT64_C(   734.68), EASYSIMD_FLOAT64_C(     0.95) },
      EASYSIMD_FLOAT64_C(   735.63) },
    { { EASYSIMD_FLOAT64_C(  -409.20), EASYSIMD_FLOAT64_C(  -823.56) },
      EASYSIMD_FLOAT64_C( -1232.76) },
    { { EASYSIMD_FLOAT64_C(   816.17), EASYSIMD_FLOAT64_C(   848.79) },
      EASYSIMD_FLOAT64_C(  1664.96) },
    { { EASYSIMD_FLOAT64_C(  -343.37), EASYSIMD_FLOAT64_C(   338.43) },
      EASYSIMD_FLOAT64_C(    -4.94) },
    { { EASYSIMD_FLOAT64_C(   575.98), EASYSIMD_FLOAT64_C(   110.52) },
      EASYSIMD_FLOAT64_C(   686.50) },
    { { EASYSIMD_FLOAT64_C(  -137.98), EASYSIMD_FLOAT64_C(   461.14) },
      EASYSIMD_FLOAT64_C(   323.16) },
    { { EASYSIMD_FLOAT64_C(   222.72), EASYSIMD_FLOAT64_C(   206.53) },
      EASYSIMD_FLOAT64_C(   429.25) },
    { { EASYSIMD_FLOAT64_C(   495.96), EASYSIMD_FLOAT64_C(   343.99) },
      EASYSIMD_FLOAT64_C(   839.95) }
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float64x2_t a = easysimd_vld1q_f64(test_vec[i].a);
    easysimd_float64_t r = easysimd_vpaddd_f64(a);
...
static int
test_easysimd_vpadds_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    easysimd_float32_t a[2];
    easysimd_float32_t r;
  } test_vec[] = {
    { { EASYSIMD_FLOAT32_C(  -699.29), EASYSIMD_FLOAT32_C(   413.96) },
     EASYSIMD_FLOAT32_C(  -285.33) },
   { { EASYSIMD_FLOAT32_C(  -422.06), EASYSIMD_FLOAT32_C(   994.22) },
     EASYSIMD_FLOAT32_C(   572.16) },
   { { EASYSIMD_FLOAT32_C(  -850.43), EASYSIMD_FLOAT32_C(   944.36) },
     EASYSIMD_FLOAT32_C(    93.93) },
   { { EASYSIMD_FLOAT32_C(   451.20), EASYSIMD_FLOAT32_C(   627.33) },
     EASYSIMD_FLOAT32_C(  1078.53) },
   { { EASYSIMD_FLOAT32_C(   638.52), EASYSIMD_FLOAT32_C(   775.57) },
     EASYSIMD_FLOAT32_C(  1414.09) },
   { { EASYSIMD_FLOAT32_C(   409.26), EASYSIMD_FLOAT32_C(   998.59) },
     EASYSIMD_FLOAT32_C(  1407.85) },
   { { EASYSIMD_FLOAT32_C(    -9.19), EASYSIMD_FLOAT32_C(  -725.56) },
     EASYSIMD_FLOAT32_C(  -734.75) },
   { { EASYSIMD_FLOAT32_C(   224.23), EASYSIMD_FLOAT32_C(  -650.86) },
     EASYSIMD_FLOAT32_C(  -426.63) }
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float32x2_t a = easysimd_vld1_f32(test_vec[i].a);
    easysimd_float32_t r = easysimd_vpadds_f32(a);
...
EASYSIMD_TEST_FUNC_LIST_ENTRY(vpadd_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vpadd_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vpadd_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vpadd_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vpadd_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vpadd_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vpadd_u32)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vpaddq_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vpaddq_f64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vpaddq_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vpaddq_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vpaddq_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vpaddq_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vpaddq_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vpaddq_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vpaddq_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vpaddq_u64)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vpaddd_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vpaddd_u64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vpaddd_f64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vpadds_f32)
