#define EASYSIMD_TEST_ARM_NEON_INSN paddl

#include "test-neon.h"
#include <easysimd/arm/neon/paddl.h>

static int
test_easysimd_vpaddl_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int8_t a[8];
    int16_t r[4];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int16x4_t r = easysimd_vpaddl_s8(a);
...
static int
test_easysimd_vpaddl_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int16_t a[4];
    int32_t r[2];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x2_t r = easysimd_vpaddl_s16(a);
...
static int
test_easysimd_vpaddl_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int32_t a[2];
    int64_t r[1];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int64x1_t r = easysimd_vpaddl_s32(a);
...
static int
test_easysimd_vpaddl_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint8_t a[8];
    uint16_t r[4];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x4_t r = easysimd_vpaddl_u8(a);
...
static int
test_easysimd_vpaddl_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint16_t a[4];
    uint32_t r[2];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x2_t r = easysimd_vpaddl_u16(a);
...
static int
test_easysimd_vpaddl_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint32_t a[2];
    uint64_t r[1];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint64x1_t r = easysimd_vpaddl_u32(a);
...
static int
test_easysimd_vpaddlq_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int8_t a[16];
    int16_t r[8];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int16x8_t r = easysimd_vpaddlq_s8(a);
...
static int
test_easysimd_vpaddlq_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int16_t a[8];
    int32_t r[4];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x4_t r = easysimd_vpaddlq_s16(a);
...
static int
test_easysimd_vpaddlq_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int32_t a[4];
    int64_t r[2];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int64x2_t r = easysimd_vpaddlq_s32(a);
...
static int
test_easysimd_vpaddlq_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint8_t a[16];
    uint16_t r[8];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x8_t r = easysimd_vpaddlq_u8(a);
...
static int
test_easysimd_vpaddlq_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint16_t a[8];
    uint32_t r[4];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x4_t r = easysimd_vpaddlq_u16(a);
...
static int
test_easysimd_vpaddlq_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint32_t a[4];
    uint64_t r[2];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint64x2_t r = easysimd_vpaddlq_u32(a);
...
EASYSIMD_TEST_FUNC_LIST_ENTRY(vpaddl_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vpaddl_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vpaddl_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vpaddl_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vpaddl_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vpaddl_u32)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vpaddlq_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vpaddlq_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vpaddlq_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vpaddlq_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vpaddlq_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vpaddlq_u32)
