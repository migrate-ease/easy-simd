#define EASYSIMD_TEST_ARM_NEON_INSN pmax

#include "test-neon.h"
#include "../../../easysimd/arm/neon/pmax.h"

static int
test_easysimd_vpmax_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    easysimd_float32 a[2];
    easysimd_float32 b[2];
    easysimd_float32 r[2];
  } test_vec[] = {
    { { EASYSIMD_FLOAT32_C(   316.14), EASYSIMD_FLOAT32_C(  -317.76) },
      { EASYSIMD_FLOAT32_C(  -999.28), EASYSIMD_FLOAT32_C(  -769.83) },
      { EASYSIMD_FLOAT32_C(   316.14), EASYSIMD_FLOAT32_C(  -769.83) } },
    { { EASYSIMD_FLOAT32_C(   563.53), EASYSIMD_FLOAT32_C(   317.30) },
      { EASYSIMD_FLOAT32_C(   849.20), EASYSIMD_FLOAT32_C(  -796.72) },
      { EASYSIMD_FLOAT32_C(   563.53), EASYSIMD_FLOAT32_C(   849.20) } },
    { { EASYSIMD_FLOAT32_C(   615.10), EASYSIMD_FLOAT32_C(   119.52) },
      { EASYSIMD_FLOAT32_C(   458.60), EASYSIMD_FLOAT32_C(   696.42) },
      { EASYSIMD_FLOAT32_C(   615.10), EASYSIMD_FLOAT32_C(   696.42) } },
    { { EASYSIMD_FLOAT32_C(  -342.74), EASYSIMD_FLOAT32_C(    78.42) },
      { EASYSIMD_FLOAT32_C(   362.08), EASYSIMD_FLOAT32_C(  -518.00) },
      { EASYSIMD_FLOAT32_C(    78.42), EASYSIMD_FLOAT32_C(   362.08) } },
    { { EASYSIMD_FLOAT32_C(  -470.51), EASYSIMD_FLOAT32_C(  -628.98) },
      { EASYSIMD_FLOAT32_C(   627.75), EASYSIMD_FLOAT32_C(  -933.75) },
      { EASYSIMD_FLOAT32_C(  -470.51), EASYSIMD_FLOAT32_C(   627.75) } },
    { { EASYSIMD_FLOAT32_C(  -180.94), EASYSIMD_FLOAT32_C(   801.21) },
      { EASYSIMD_FLOAT32_C(   206.11), EASYSIMD_FLOAT32_C(  -537.70) },
      { EASYSIMD_FLOAT32_C(   801.21), EASYSIMD_FLOAT32_C(   206.11) } },
    { { EASYSIMD_FLOAT32_C(  -275.82), EASYSIMD_FLOAT32_C(  -533.06) },
      { EASYSIMD_FLOAT32_C(    77.91), EASYSIMD_FLOAT32_C(   887.40) },
      { EASYSIMD_FLOAT32_C(  -275.82), EASYSIMD_FLOAT32_C(   887.40) } },
    { { EASYSIMD_FLOAT32_C(   896.99), EASYSIMD_FLOAT32_C(  -718.48) },
      { EASYSIMD_FLOAT32_C(  -622.01), EASYSIMD_FLOAT32_C(   213.13) },
      { EASYSIMD_FLOAT32_C(   896.99), EASYSIMD_FLOAT32_C(   213.13) } },
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float32x2_t a = easysimd_vld1_f32(test_vec[i].a);
    easysimd_float32x2_t b = easysimd_vld1_f32(test_vec[i].b);
    easysimd_float32x2_t r = easysimd_vpmax_f32(a, b);
...
static int
test_easysimd_vpmax_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int8_t a[8];
    int8_t b[8];
    int8_t r[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int8x8_t r = easysimd_vpmax_s8(a, b);
...
static int
test_easysimd_vpmax_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int16_t a[4];
    int16_t b[4];
    int16_t r[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int16x4_t r = easysimd_vpmax_s16(a, b);
...
static int
test_easysimd_vpmax_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int32_t a[2];
    int32_t b[2];
    int32_t r[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x2_t r = easysimd_vpmax_s32(a, b);
...
static int
test_easysimd_vpmax_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint8_t a[8];
    uint8_t b[8];
    uint8_t r[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x8_t r = easysimd_vpmax_u8(a, b);
...
static int
test_easysimd_vpmax_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint16_t a[4];
    uint16_t b[4];
    uint16_t r[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x4_t r = easysimd_vpmax_u16(a, b);
...
static int
test_easysimd_vpmax_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint32_t a[2];
    uint32_t b[2];
    uint32_t r[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x2_t r = easysimd_vpmax_u32(a, b);
...
static int
test_easysimd_vpmaxq_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    easysimd_float32 a[4];
    easysimd_float32 b[4];
    easysimd_float32 r[4];
  } test_vec[] = {
    { { EASYSIMD_FLOAT32_C(  -402.07), EASYSIMD_FLOAT32_C(  -666.37), EASYSIMD_FLOAT32_C(   362.68), EASYSIMD_FLOAT32_C(  -326.71) },
      { EASYSIMD_FLOAT32_C(   454.85), EASYSIMD_FLOAT32_C(  -121.62), EASYSIMD_FLOAT32_C(   430.43), EASYSIMD_FLOAT32_C(   746.87) },
      { EASYSIMD_FLOAT32_C(  -402.07), EASYSIMD_FLOAT32_C(   362.68), EASYSIMD_FLOAT32_C(   454.85), EASYSIMD_FLOAT32_C(   746.87) } },
    { { EASYSIMD_FLOAT32_C(    33.52), EASYSIMD_FLOAT32_C(  -284.09), EASYSIMD_FLOAT32_C(  -166.25), EASYSIMD_FLOAT32_C(   480.19) },
      { EASYSIMD_FLOAT32_C(   -49.24), EASYSIMD_FLOAT32_C(   564.50), EASYSIMD_FLOAT32_C(   852.14), EASYSIMD_FLOAT32_C(  -390.08) },
      { EASYSIMD_FLOAT32_C(    33.52), EASYSIMD_FLOAT32_C(   480.19), EASYSIMD_FLOAT32_C(   564.50), EASYSIMD_FLOAT32_C(   852.14) } },
    { { EASYSIMD_FLOAT32_C(  -339.81), EASYSIMD_FLOAT32_C(   223.10), EASYSIMD_FLOAT32_C(  -267.43), EASYSIMD_FLOAT32_C(   -98.08) },
      { EASYSIMD_FLOAT32_C(   315.18), EASYSIMD_FLOAT32_C(  -621.58), EASYSIMD_FLOAT32_C(  -833.21), EASYSIMD_FLOAT32_C(     0.90) },
      { EASYSIMD_FLOAT32_C(   223.10), EASYSIMD_FLOAT32_C(   -98.08), EASYSIMD_FLOAT32_C(   315.18), EASYSIMD_FLOAT32_C(     0.90) } },
    { { EASYSIMD_FLOAT32_C(   737.95), EASYSIMD_FLOAT32_C(   329.19), EASYSIMD_FLOAT32_C(   372.64), EASYSIMD_FLOAT32_C(   555.32) },
      { EASYSIMD_FLOAT32_C(   563.00), EASYSIMD_FLOAT32_C(  -123.50), EASYSIMD_FLOAT32_C(  -962.40), EASYSIMD_FLOAT32_C(  -839.07) },
      { EASYSIMD_FLOAT32_C(   737.95), EASYSIMD_FLOAT32_C(   555.32), EASYSIMD_FLOAT32_C(   563.00), EASYSIMD_FLOAT32_C(  -839.07) } },
    { { EASYSIMD_FLOAT32_C(   210.13), EASYSIMD_FLOAT32_C(   400.28), EASYSIMD_FLOAT32_C(  -165.78), EASYSIMD_FLOAT32_C(  -335.02) },
      { EASYSIMD_FLOAT32_C(  -721.33), EASYSIMD_FLOAT32_C(  -735.34), EASYSIMD_FLOAT32_C(  -588.15), EASYSIMD_FLOAT32_C(   312.18) },
      { EASYSIMD_FLOAT32_C(   400.28), EASYSIMD_FLOAT32_C(  -165.78), EASYSIMD_FLOAT32_C(  -721.33), EASYSIMD_FLOAT32_C(   312.18) } },
    { { EASYSIMD_FLOAT32_C(   -19.43), EASYSIMD_FLOAT32_C(   245.59), EASYSIMD_FLOAT32_C(  -207.63), EASYSIMD_FLOAT32_C(   931.34) },
      { EASYSIMD_FLOAT32_C(  -189.91), EASYSIMD_FLOAT32_C(  -355.49), EASYSIMD_FLOAT32_C(  -458.75), EASYSIMD_FLOAT32_C(   470.28) },
      { EASYSIMD_FLOAT32_C(   245.59), EASYSIMD_FLOAT32_C(   931.34), EASYSIMD_FLOAT32_C(  -189.91), EASYSIMD_FLOAT32_C(   470.28) } },
    { { EASYSIMD_FLOAT32_C(   867.60), EASYSIMD_FLOAT32_C(   273.82), EASYSIMD_FLOAT32_C(  -627.81), EASYSIMD_FLOAT32_C(   182.78) },
      { EASYSIMD_FLOAT32_C(   652.24), EASYSIMD_FLOAT32_C(  -461.02), EASYSIMD_FLOAT32_C(  -816.31), EASYSIMD_FLOAT32_C(   390.19) },
      { EASYSIMD_FLOAT32_C(   867.60), EASYSIMD_FLOAT32_C(   182.78), EASYSIMD_FLOAT32_C(   652.24), EASYSIMD_FLOAT32_C(   390.19) } },
    { { EASYSIMD_FLOAT32_C(   868.17), EASYSIMD_FLOAT32_C(   556.33), EASYSIMD_FLOAT32_C(   -54.49), EASYSIMD_FLOAT32_C(   431.18) },
      { EASYSIMD_FLOAT32_C(  -567.17), EASYSIMD_FLOAT32_C(   -16.88), EASYSIMD_FLOAT32_C(   592.11), EASYSIMD_FLOAT32_C(   642.95) },
      { EASYSIMD_FLOAT32_C(   868.17), EASYSIMD_FLOAT32_C(   431.18), EASYSIMD_FLOAT32_C(   -16.88), EASYSIMD_FLOAT32_C(   642.95) } },
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float32x4_t a = easysimd_vld1q_f32(test_vec[i].a);
    easysimd_float32x4_t b = easysimd_vld1q_f32(test_vec[i].b);
    easysimd_float32x4_t r = easysimd_vpmaxq_f32(a, b);
...
static int
test_easysimd_vpmaxq_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    easysimd_float64 a[2];
    easysimd_float64 b[2];
    easysimd_float64 r[2];
  } test_vec[] = {
    { { EASYSIMD_FLOAT64_C(   521.70), EASYSIMD_FLOAT64_C(   828.15) },
      { EASYSIMD_FLOAT64_C(   535.14), EASYSIMD_FLOAT64_C(   480.15) },
      { EASYSIMD_FLOAT64_C(   828.15), EASYSIMD_FLOAT64_C(   535.14) } },
    { { EASYSIMD_FLOAT64_C(  -518.98), EASYSIMD_FLOAT64_C(  -210.96) },
      { EASYSIMD_FLOAT64_C(  -930.38), EASYSIMD_FLOAT64_C(   215.97) },
      { EASYSIMD_FLOAT64_C(  -210.96), EASYSIMD_FLOAT64_C(   215.97) } },
    { { EASYSIMD_FLOAT64_C(    91.20), EASYSIMD_FLOAT64_C(   348.64) },
      { EASYSIMD_FLOAT64_C(  -290.21), EASYSIMD_FLOAT64_C(    54.45) },
      { EASYSIMD_FLOAT64_C(   348.64), EASYSIMD_FLOAT64_C(    54.45) } },
    { { EASYSIMD_FLOAT64_C(  -405.44), EASYSIMD_FLOAT64_C(  -790.85) },
      { EASYSIMD_FLOAT64_C(   151.68), EASYSIMD_FLOAT64_C(    31.01) },
      { EASYSIMD_FLOAT64_C(  -405.44), EASYSIMD_FLOAT64_C(   151.68) } },
    { { EASYSIMD_FLOAT64_C(  -850.04), EASYSIMD_FLOAT64_C(  -183.10) },
      { EASYSIMD_FLOAT64_C(   893.21), EASYSIMD_FLOAT64_C(   481.08) },
      { EASYSIMD_FLOAT64_C(  -183.10), EASYSIMD_FLOAT64_C(   893.21) } },
    { { EASYSIMD_FLOAT64_C(  -361.59), EASYSIMD_FLOAT64_C(     9.07) },
      { EASYSIMD_FLOAT64_C(   399.01), EASYSIMD_FLOAT64_C(  -896.67) },
      { EASYSIMD_FLOAT64_C(     9.07), EASYSIMD_FLOAT64_C(   399.01) } },
    { { EASYSIMD_FLOAT64_C(  -108.96), EASYSIMD_FLOAT64_C(   271.20) },
      { EASYSIMD_FLOAT64_C(   839.25), EASYSIMD_FLOAT64_C(   679.65) },
      { EASYSIMD_FLOAT64_C(   271.20), EASYSIMD_FLOAT64_C(   839.25) } },
    { { EASYSIMD_FLOAT64_C(   406.65), EASYSIMD_FLOAT64_C(  -664.11) },
      { EASYSIMD_FLOAT64_C(   733.62), EASYSIMD_FLOAT64_C(   -71.65) },
      { EASYSIMD_FLOAT64_C(   406.65), EASYSIMD_FLOAT64_C(   733.62) } },
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float64x2_t a = easysimd_vld1q_f64(test_vec[i].a);
    easysimd_float64x2_t b = easysimd_vld1q_f64(test_vec[i].b);
    easysimd_float64x2_t r = easysimd_vpmaxq_f64(a, b);
...
static int
test_easysimd_vpmaxq_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int8_t a[16];
    int8_t b[16];
    int8_t r[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int8x16_t r = easysimd_vpmaxq_s8(a, b);
...
static int
test_easysimd_vpmaxq_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int16_t a[8];
    int16_t b[8];
    int16_t r[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int16x8_t r = easysimd_vpmaxq_s16(a, b);
...
static int
test_easysimd_vpmaxq_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int32_t a[4];
    int32_t b[4];
    int32_t r[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x4_t r = easysimd_vpmaxq_s32(a, b);
...
static int
test_easysimd_vpmaxq_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint8_t a[16];
    uint8_t b[16];
    uint8_t r[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x16_t r = easysimd_vpmaxq_u8(a, b);
...
static int
test_easysimd_vpmaxq_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint16_t a[8];
    uint16_t b[8];
    uint16_t r[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x8_t r = easysimd_vpmaxq_u16(a, b);
...
static int
test_easysimd_vpmaxq_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint32_t a[4];
    uint32_t b[4];
    uint32_t r[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x4_t r = easysimd_vpmaxq_u32(a, b);
...
static int
test_easysimd_vpmaxs_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    easysimd_float32_t a[2];
    easysimd_float32_t r;
  } test_vec[] = {
    { { EASYSIMD_FLOAT32_C(  -687.34), EASYSIMD_FLOAT32_C(   938.41) },
      EASYSIMD_FLOAT32_C(   938.41) },
    { { EASYSIMD_FLOAT32_C(   -90.80), EASYSIMD_FLOAT32_C(  -528.65) },
      EASYSIMD_FLOAT32_C(   -90.80) },
    { { EASYSIMD_FLOAT32_C(    11.38), EASYSIMD_FLOAT32_C(  -376.09) },
      EASYSIMD_FLOAT32_C(    11.38) },
    { { EASYSIMD_FLOAT32_C(  -136.34), EASYSIMD_FLOAT32_C(  -804.70) },
      EASYSIMD_FLOAT32_C(  -136.34) },
    { { EASYSIMD_FLOAT32_C(  -475.42), EASYSIMD_FLOAT32_C(   955.92) },
      EASYSIMD_FLOAT32_C(   955.92) },
    { { EASYSIMD_FLOAT32_C(   141.16), EASYSIMD_FLOAT32_C(   -77.29) },
      EASYSIMD_FLOAT32_C(   141.16) },
    { { EASYSIMD_FLOAT32_C(    47.83), EASYSIMD_FLOAT32_C(  -559.34) },
      EASYSIMD_FLOAT32_C(    47.83) },
    { { EASYSIMD_FLOAT32_C(  -732.12), EASYSIMD_FLOAT32_C(   -31.68) },
      EASYSIMD_FLOAT32_C(   -31.68) }
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float32x2_t a = easysimd_vld1_f32(test_vec[i].a);
    easysimd_float32_t r = easysimd_vpmaxs_f32(a);
...
static int
test_easysimd_vpmaxqd_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    easysimd_float64_t a[2];
    easysimd_float64_t r;
  } test_vec[] = {
    { { EASYSIMD_FLOAT64_C(  -940.00), EASYSIMD_FLOAT64_C(  -494.34) },
     EASYSIMD_FLOAT64_C(  -494.34) },
   { { EASYSIMD_FLOAT64_C(   -57.78), EASYSIMD_FLOAT64_C(   832.21) },
     EASYSIMD_FLOAT64_C(   832.21) },
   { { EASYSIMD_FLOAT64_C(  -973.99), EASYSIMD_FLOAT64_C(   101.27) },
     EASYSIMD_FLOAT64_C(   101.27) },
   { { EASYSIMD_FLOAT64_C(   184.50), EASYSIMD_FLOAT64_C(  -100.67) },
     EASYSIMD_FLOAT64_C(   184.50) },
   { { EASYSIMD_FLOAT64_C(  -792.79), EASYSIMD_FLOAT64_C(  -153.04) },
     EASYSIMD_FLOAT64_C(  -153.04) },
   { { EASYSIMD_FLOAT64_C(   317.69), EASYSIMD_FLOAT64_C(   455.59) },
     EASYSIMD_FLOAT64_C(   455.59) },
   { { EASYSIMD_FLOAT64_C(   152.31), EASYSIMD_FLOAT64_C(   547.52) },
     EASYSIMD_FLOAT64_C(   547.52) },
   { { EASYSIMD_FLOAT64_C(  -519.99), EASYSIMD_FLOAT64_C(   948.41) },
     EASYSIMD_FLOAT64_C(   948.41) }
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float64x2_t a = easysimd_vld1q_f64(test_vec[i].a);
    easysimd_float64_t r = easysimd_vpmaxqd_f64(a);
...
EASYSIMD_TEST_FUNC_LIST_ENTRY(vpmax_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vpmax_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vpmax_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vpmax_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vpmax_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vpmax_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vpmax_u32)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vpmaxq_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vpmaxq_f64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vpmaxq_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vpmaxq_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vpmaxq_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vpmaxq_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vpmaxq_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vpmaxq_u32)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vpmaxs_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vpmaxqd_f64)
