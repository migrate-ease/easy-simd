#define EASYSIMD_TEST_ARM_NEON_INSN pmin

#include "test-neon.h"
#include "../../../easysimd/arm/neon/pmin.h"

static int
test_easysimd_vpmin_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    easysimd_float32 a[2];
    easysimd_float32 b[2];
    easysimd_float32 r[2];
  } test_vec[] = {
    { { EASYSIMD_FLOAT32_C(  -823.14), EASYSIMD_FLOAT32_C(   128.93) },
      { EASYSIMD_FLOAT32_C(   -79.23), EASYSIMD_FLOAT32_C(   181.88) },
      { EASYSIMD_FLOAT32_C(  -823.14), EASYSIMD_FLOAT32_C(   -79.23) } },
    { { EASYSIMD_FLOAT32_C(   342.60), EASYSIMD_FLOAT32_C(   371.59) },
      { EASYSIMD_FLOAT32_C(   649.79), EASYSIMD_FLOAT32_C(   595.53) },
      { EASYSIMD_FLOAT32_C(   342.60), EASYSIMD_FLOAT32_C(   595.53) } },
    { { EASYSIMD_FLOAT32_C(   270.06), EASYSIMD_FLOAT32_C(  -842.97) },
      { EASYSIMD_FLOAT32_C(  -961.22), EASYSIMD_FLOAT32_C(  -328.85) },
      { EASYSIMD_FLOAT32_C(  -842.97), EASYSIMD_FLOAT32_C(  -961.22) } },
    { { EASYSIMD_FLOAT32_C(  -201.57), EASYSIMD_FLOAT32_C(   793.30) },
      { EASYSIMD_FLOAT32_C(  -461.86), EASYSIMD_FLOAT32_C(  -809.27) },
      { EASYSIMD_FLOAT32_C(  -201.57), EASYSIMD_FLOAT32_C(  -809.27) } },
    { { EASYSIMD_FLOAT32_C(  -247.56), EASYSIMD_FLOAT32_C(  -943.60) },
      { EASYSIMD_FLOAT32_C(   440.83), EASYSIMD_FLOAT32_C(   190.31) },
      { EASYSIMD_FLOAT32_C(  -943.60), EASYSIMD_FLOAT32_C(   190.31) } },
    { { EASYSIMD_FLOAT32_C(  -830.78), EASYSIMD_FLOAT32_C(  -101.36) },
      { EASYSIMD_FLOAT32_C(  -658.42), EASYSIMD_FLOAT32_C(   551.40) },
      { EASYSIMD_FLOAT32_C(  -830.78), EASYSIMD_FLOAT32_C(  -658.42) } },
    { { EASYSIMD_FLOAT32_C(  -949.01), EASYSIMD_FLOAT32_C(  -839.90) },
      { EASYSIMD_FLOAT32_C(   498.39), EASYSIMD_FLOAT32_C(   411.31) },
      { EASYSIMD_FLOAT32_C(  -949.01), EASYSIMD_FLOAT32_C(   411.31) } },
    { { EASYSIMD_FLOAT32_C(   115.69), EASYSIMD_FLOAT32_C(  -563.88) },
      { EASYSIMD_FLOAT32_C(    32.11), EASYSIMD_FLOAT32_C(   292.55) },
      { EASYSIMD_FLOAT32_C(  -563.88), EASYSIMD_FLOAT32_C(    32.11) } }
  };
...
static int
test_easysimd_vpmin_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int8_t a[8];
    int8_t b[8];
    int8_t r[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int8x8_t r = easysimd_vpmin_s8(a, b);
...
static int
test_easysimd_vpmin_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int16_t a[4];
    int16_t b[4];
    int16_t r[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int16x4_t r = easysimd_vpmin_s16(a, b);
...
static int
test_easysimd_vpmin_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int32_t a[2];
    int32_t b[2];
    int32_t r[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x2_t r = easysimd_vpmin_s32(a, b);
...
static int
test_easysimd_vpmin_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint8_t a[16];
    uint8_t b[16];
    uint8_t r[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x8_t r = easysimd_vpmin_u8(a, b);
...
static int
test_easysimd_vpmin_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint16_t a[4];
    uint16_t b[4];
    uint16_t r[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x4_t r = easysimd_vpmin_u16(a, b);
...
static int
test_easysimd_vpmin_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint32_t a[2];
    uint32_t b[2];
    uint32_t r[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x2_t r = easysimd_vpmin_u32(a, b);
...
static int
test_easysimd_vpminq_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    easysimd_float32 a[4];
    easysimd_float32 b[4];
    easysimd_float32 r[4];
  } test_vec[] = {
    { { EASYSIMD_FLOAT32_C(   680.38), EASYSIMD_FLOAT32_C(  -211.23), EASYSIMD_FLOAT32_C(   566.20), EASYSIMD_FLOAT32_C(   596.88) },
      { EASYSIMD_FLOAT32_C(   823.29), EASYSIMD_FLOAT32_C(  -604.90), EASYSIMD_FLOAT32_C(  -329.55), EASYSIMD_FLOAT32_C(   536.46) },
      { EASYSIMD_FLOAT32_C(  -211.23), EASYSIMD_FLOAT32_C(   566.20), EASYSIMD_FLOAT32_C(  -604.90), EASYSIMD_FLOAT32_C(  -329.55) } },
    { { EASYSIMD_FLOAT32_C(  -444.45), EASYSIMD_FLOAT32_C(   107.94), EASYSIMD_FLOAT32_C(   -45.21), EASYSIMD_FLOAT32_C(   257.74) },
      { EASYSIMD_FLOAT32_C(  -270.43), EASYSIMD_FLOAT32_C(    26.80), EASYSIMD_FLOAT32_C(   904.46), EASYSIMD_FLOAT32_C(   832.39) },
      { EASYSIMD_FLOAT32_C(  -444.45), EASYSIMD_FLOAT32_C(   -45.21), EASYSIMD_FLOAT32_C(  -270.43), EASYSIMD_FLOAT32_C(   832.39) } },
    { { EASYSIMD_FLOAT32_C(   271.42), EASYSIMD_FLOAT32_C(   434.59), EASYSIMD_FLOAT32_C(  -716.79), EASYSIMD_FLOAT32_C(   213.94) },
      { EASYSIMD_FLOAT32_C(  -967.40), EASYSIMD_FLOAT32_C(  -514.23), EASYSIMD_FLOAT32_C(  -725.54), EASYSIMD_FLOAT32_C(   608.35) },
      { EASYSIMD_FLOAT32_C(   271.42), EASYSIMD_FLOAT32_C(  -716.79), EASYSIMD_FLOAT32_C(  -967.40), EASYSIMD_FLOAT32_C(  -725.54) } },
    { { EASYSIMD_FLOAT32_C(  -686.64), EASYSIMD_FLOAT32_C(  -198.11), EASYSIMD_FLOAT32_C(  -740.42), EASYSIMD_FLOAT32_C(  -782.38) },
      { EASYSIMD_FLOAT32_C(   997.85), EASYSIMD_FLOAT32_C(  -563.49), EASYSIMD_FLOAT32_C(    25.86), EASYSIMD_FLOAT32_C(   678.22) },
      { EASYSIMD_FLOAT32_C(  -686.64), EASYSIMD_FLOAT32_C(  -782.38), EASYSIMD_FLOAT32_C(  -563.49), EASYSIMD_FLOAT32_C(    25.86) } },
    { { EASYSIMD_FLOAT32_C(   225.28), EASYSIMD_FLOAT32_C(  -407.94), EASYSIMD_FLOAT32_C(   275.10), EASYSIMD_FLOAT32_C(    48.57) },
      { EASYSIMD_FLOAT32_C(   -12.83), EASYSIMD_FLOAT32_C(   945.55), EASYSIMD_FLOAT32_C(  -414.97), EASYSIMD_FLOAT32_C(   542.72) },
      { EASYSIMD_FLOAT32_C(  -407.94), EASYSIMD_FLOAT32_C(    48.57), EASYSIMD_FLOAT32_C(   -12.83), EASYSIMD_FLOAT32_C(  -414.97) } },
    { { EASYSIMD_FLOAT32_C(    53.49), EASYSIMD_FLOAT32_C(   539.83), EASYSIMD_FLOAT32_C(  -199.54), EASYSIMD_FLOAT32_C(   783.06) },
      { EASYSIMD_FLOAT32_C(  -433.37), EASYSIMD_FLOAT32_C(  -295.08), EASYSIMD_FLOAT32_C(   615.45), EASYSIMD_FLOAT32_C(   838.05) },
      { EASYSIMD_FLOAT32_C(    53.49), EASYSIMD_FLOAT32_C(  -199.54), EASYSIMD_FLOAT32_C(  -433.37), EASYSIMD_FLOAT32_C(   615.45) } },
    { { EASYSIMD_FLOAT32_C(  -860.49), EASYSIMD_FLOAT32_C(   898.65), EASYSIMD_FLOAT32_C(    51.99), EASYSIMD_FLOAT32_C(  -827.89) },
      { EASYSIMD_FLOAT32_C(  -615.57), EASYSIMD_FLOAT32_C(   326.45), EASYSIMD_FLOAT32_C(   780.47), EASYSIMD_FLOAT32_C(  -302.21) },
      { EASYSIMD_FLOAT32_C(  -860.49), EASYSIMD_FLOAT32_C(  -827.89), EASYSIMD_FLOAT32_C(  -615.57), EASYSIMD_FLOAT32_C(  -302.21) } },
    { { EASYSIMD_FLOAT32_C(  -871.66), EASYSIMD_FLOAT32_C(  -959.95), EASYSIMD_FLOAT32_C(   -84.60), EASYSIMD_FLOAT32_C(  -873.81) },
      { EASYSIMD_FLOAT32_C(  -523.44), EASYSIMD_FLOAT32_C(   941.27), EASYSIMD_FLOAT32_C(   804.42), EASYSIMD_FLOAT32_C(   701.84) },
      { EASYSIMD_FLOAT32_C(  -959.95), EASYSIMD_FLOAT32_C(  -873.81), EASYSIMD_FLOAT32_C(  -523.44), EASYSIMD_FLOAT32_C(   701.84) } }
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float32x4_t a = easysimd_vld1q_f32(test_vec[i].a);
    easysimd_float32x4_t b = easysimd_vld1q_f32(test_vec[i].b);
    easysimd_float32x4_t r = easysimd_vpminq_f32(a, b);
...
static int
test_easysimd_vpminq_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    easysimd_float64 a[2];
    easysimd_float64 b[2];
    easysimd_float64 r[2];
  } test_vec[] = {
    { { EASYSIMD_FLOAT64_C(   680.38), EASYSIMD_FLOAT64_C(  -211.23) },
      { EASYSIMD_FLOAT64_C(   566.20), EASYSIMD_FLOAT64_C(   596.88) },
      { EASYSIMD_FLOAT64_C(  -211.23), EASYSIMD_FLOAT64_C(   566.20) } },
    { { EASYSIMD_FLOAT64_C(   823.29), EASYSIMD_FLOAT64_C(  -604.90) },
      { EASYSIMD_FLOAT64_C(  -329.55), EASYSIMD_FLOAT64_C(   536.46) },
      { EASYSIMD_FLOAT64_C(  -604.90), EASYSIMD_FLOAT64_C(  -329.55) } },
    { { EASYSIMD_FLOAT64_C(  -444.45), EASYSIMD_FLOAT64_C(   107.94) },
      { EASYSIMD_FLOAT64_C(   -45.21), EASYSIMD_FLOAT64_C(   257.74) },
      { EASYSIMD_FLOAT64_C(  -444.45), EASYSIMD_FLOAT64_C(   -45.21) } },
    { { EASYSIMD_FLOAT64_C(  -270.43), EASYSIMD_FLOAT64_C(    26.80) },
      { EASYSIMD_FLOAT64_C(   904.46), EASYSIMD_FLOAT64_C(   832.39) },
      { EASYSIMD_FLOAT64_C(  -270.43), EASYSIMD_FLOAT64_C(   832.39) } },
    { { EASYSIMD_FLOAT64_C(   271.42), EASYSIMD_FLOAT64_C(   434.59) },
      { EASYSIMD_FLOAT64_C(  -716.79), EASYSIMD_FLOAT64_C(   213.94) },
      { EASYSIMD_FLOAT64_C(   271.42), EASYSIMD_FLOAT64_C(  -716.79) } },
    { { EASYSIMD_FLOAT64_C(  -967.40), EASYSIMD_FLOAT64_C(  -514.23) },
      { EASYSIMD_FLOAT64_C(  -725.54), EASYSIMD_FLOAT64_C(   608.35) },
      { EASYSIMD_FLOAT64_C(  -967.40), EASYSIMD_FLOAT64_C(  -725.54) } },
    { { EASYSIMD_FLOAT64_C(  -686.64), EASYSIMD_FLOAT64_C(  -198.11) },
      { EASYSIMD_FLOAT64_C(  -740.42), EASYSIMD_FLOAT64_C(  -782.38) },
      { EASYSIMD_FLOAT64_C(  -686.64), EASYSIMD_FLOAT64_C(  -782.38) } },
    { { EASYSIMD_FLOAT64_C(   997.85), EASYSIMD_FLOAT64_C(  -563.49) },
      { EASYSIMD_FLOAT64_C(    25.86), EASYSIMD_FLOAT64_C(   678.22) },
      { EASYSIMD_FLOAT64_C(  -563.49), EASYSIMD_FLOAT64_C(    25.86) } }
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float64x2_t a = easysimd_vld1q_f64(test_vec[i].a);
    easysimd_float64x2_t b = easysimd_vld1q_f64(test_vec[i].b);
    easysimd_float64x2_t r = easysimd_vpminq_f64(a, b);
...
static int
test_easysimd_vpminq_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int8_t a[16];
    int8_t b[16];
    int8_t r[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int8x16_t r = easysimd_vpminq_s8(a, b);
...
static int
test_easysimd_vpminq_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int16_t a[8];
    int16_t b[8];
    int16_t r[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int16x8_t r = easysimd_vpminq_s16(a, b);
...
static int
test_easysimd_vpminq_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int32_t a[4];
    int32_t b[4];
    int32_t r[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x4_t r = easysimd_vpminq_s32(a, b);
...
static int
test_easysimd_vpminq_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint8_t a[16];
    uint8_t b[16];
    uint8_t r[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x16_t r = easysimd_vpminq_u8(a, b);
...
static int
test_easysimd_vpminq_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint16_t a[8];
    uint16_t b[8];
    uint16_t r[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x8_t r = easysimd_vpminq_u16(a, b);
...
static int
test_easysimd_vpminq_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint32_t a[4];
    uint32_t b[4];
    uint32_t r[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x4_t r = easysimd_vpminq_u32(a, b);
...
static int
test_easysimd_vpmins_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    easysimd_float32_t a[2];
    easysimd_float32_t r;
  } test_vec[] = {
    { { EASYSIMD_FLOAT32_C(    -3.71), EASYSIMD_FLOAT32_C(   987.98) },
      EASYSIMD_FLOAT32_C(    -3.71) },
    { { EASYSIMD_FLOAT32_C(    71.28), EASYSIMD_FLOAT32_C(   -73.22) },
      EASYSIMD_FLOAT32_C(   -73.22) },
    { { EASYSIMD_FLOAT32_C(   662.47), EASYSIMD_FLOAT32_C(   798.12) },
      EASYSIMD_FLOAT32_C(   662.47) },
    { { EASYSIMD_FLOAT32_C(   748.29), EASYSIMD_FLOAT32_C(   429.24) },
      EASYSIMD_FLOAT32_C(   429.24) },
    { { EASYSIMD_FLOAT32_C(  -135.59), EASYSIMD_FLOAT32_C(  -818.02) },
      EASYSIMD_FLOAT32_C(  -818.02) },
    { { EASYSIMD_FLOAT32_C(  -586.79), EASYSIMD_FLOAT32_C(   204.77) },
      EASYSIMD_FLOAT32_C(  -586.79) },
    { { EASYSIMD_FLOAT32_C(  -567.78), EASYSIMD_FLOAT32_C(   738.70) },
      EASYSIMD_FLOAT32_C(  -567.78) },
    { { EASYSIMD_FLOAT32_C(   138.50), EASYSIMD_FLOAT32_C(   654.90) },
      EASYSIMD_FLOAT32_C(   138.50) }
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float32x2_t a = easysimd_vld1_f32(test_vec[i].a);
    easysimd_float32_t r = easysimd_vpmins_f32(a);
...
static int
test_easysimd_vpminqd_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    easysimd_float64_t a[2];
    easysimd_float64_t r;
  } test_vec[] = {
    { { EASYSIMD_FLOAT64_C(  -817.36), EASYSIMD_FLOAT64_C(  -203.90) },
      EASYSIMD_FLOAT64_C(  -817.36) },
    { { EASYSIMD_FLOAT64_C(   453.34), EASYSIMD_FLOAT64_C(  -713.33) },
      EASYSIMD_FLOAT64_C(  -713.33) },
    { { EASYSIMD_FLOAT64_C(  -881.31), EASYSIMD_FLOAT64_C(   -11.11) },
      EASYSIMD_FLOAT64_C(  -881.31) },
    { { EASYSIMD_FLOAT64_C(  -205.40), EASYSIMD_FLOAT64_C(    31.04) },
      EASYSIMD_FLOAT64_C(  -205.40) },
    { { EASYSIMD_FLOAT64_C(   693.81), EASYSIMD_FLOAT64_C(  -888.36) },
      EASYSIMD_FLOAT64_C(  -888.36) },
    { { EASYSIMD_FLOAT64_C(   531.32), EASYSIMD_FLOAT64_C(   786.68) },
      EASYSIMD_FLOAT64_C(   531.32) },
    { { EASYSIMD_FLOAT64_C(   904.99), EASYSIMD_FLOAT64_C(   576.97) },
      EASYSIMD_FLOAT64_C(   576.97) },
    { { EASYSIMD_FLOAT64_C(   -71.56), EASYSIMD_FLOAT64_C(   548.42) },
      EASYSIMD_FLOAT64_C(   -71.56) }
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float64x2_t a = easysimd_vld1q_f64(test_vec[i].a);
    easysimd_float64_t r = easysimd_vpminqd_f64(a);
...
EASYSIMD_TEST_FUNC_LIST_ENTRY(vpmin_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vpmin_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vpmin_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vpmin_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vpmin_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vpmin_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vpmin_u32)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vpminq_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vpminq_f64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vpminq_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vpminq_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vpminq_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vpminq_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vpminq_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vpminq_u32)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vpmins_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vpminqd_f64)
