#define EASYSIMD_TEST_ARM_NEON_INSN qabs

#include "test-neon.h"

#include "../../../easysimd/arm/neon/qabs.h"
#include "../../../easysimd/arm/neon/set_lane.h"

static int
test_easysimd_vqabsb_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int8_t a;
    int8_t r;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    int8_t r = easysimd_vqabsb_s8(test_vec[i].a);
...
static int
test_easysimd_vqabsh_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int16_t a;
    int16_t r;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    int16_t r = easysimd_vqabsh_s16(test_vec[i].a);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    int16_t r = easysimd_vqabsh_s16(a);
...
static int
test_easysimd_vqabss_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t a;
    int32_t r;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    int32_t r = easysimd_vqabss_s32(test_vec[i].a);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    int32_t r = easysimd_vqabss_s32(a);
...
static int
test_easysimd_vqabsd_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int64_t a;
    int64_t r;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    int64_t r = easysimd_vqabsd_s64(test_vec[i].a);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    int64_t r = easysimd_vqabsd_s64(a);
...
static int
test_easysimd_vqabs_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int8_t a[8];
    int8_t r[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int8x8_t r = easysimd_vqabs_s8(a);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    if (i == 0)
      a = easysimd_vset_lane_s8(INT8_MIN, a, 0);
    easysimd_int8x8_t r = easysimd_vqabs_s8(a);
...
static int
test_easysimd_vqabs_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int16_t a[4];
    int16_t r[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int16x4_t r = easysimd_vqabs_s16(a);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    if (i == 0)
      a = easysimd_vset_lane_s16(INT16_MIN, a, 0);
    easysimd_int16x4_t r = easysimd_vqabs_s16(a);
...
static int
test_easysimd_vqabs_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t a[2];
    int32_t r[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x2_t r = easysimd_vqabs_s32(a);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    if (i == 0)
      a = easysimd_vset_lane_s32(INT32_MIN, a, 0);
    easysimd_int32x2_t r = easysimd_vqabs_s32(a);
...
static int
test_easysimd_vqabs_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int64_t a[1];
    int64_t r[1];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int64x1_t r = easysimd_vqabs_s64(a);
...
static int
test_easysimd_vqabsq_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int8_t a[16];
    int8_t r[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int8x16_t r = easysimd_vqabsq_s8(a);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    if (i == 0)
      a = easysimd_vsetq_lane_s8(INT8_MIN, a, 0);
    easysimd_int8x16_t r = easysimd_vqabsq_s8(a);
...
static int
test_easysimd_vqabsq_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int16_t a[8];
    int16_t r[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int16x8_t r = easysimd_vqabsq_s16(a);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    if (i == 0)
      a = easysimd_vsetq_lane_s16(INT16_MIN, a, 0);
    easysimd_int16x8_t r = easysimd_vqabsq_s16(a);
...
static int
test_easysimd_vqabsq_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t a[4];
    int32_t r[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x4_t r = easysimd_vqabsq_s32(a);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    if (i == 0)
      a = easysimd_vsetq_lane_s32(INT32_MIN, a, 0);
    easysimd_int32x4_t r = easysimd_vqabsq_s32(a);
...
static int
test_easysimd_vqabsq_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int64_t a[2];
    int64_t r[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int64x2_t r = easysimd_vqabsq_s64(a);
...
EASYSIMD_TEST_FUNC_LIST_ENTRY(vqabsb_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vqabsh_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vqabss_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vqabsd_s64)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vqabs_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vqabs_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vqabs_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vqabs_s64)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vqabsq_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vqabsq_s16)
#if (!defined(__clang__))
EASYSIMD_TEST_FUNC_LIST_ENTRY(vqabsq_s32)
#endif
EASYSIMD_TEST_FUNC_LIST_ENTRY(vqabsq_s64)
