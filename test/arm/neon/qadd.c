#define EASYSIMD_TEST_ARM_NEON_INSN qadd

#include "test-neon.h"
#include "../../../easysimd/arm/neon/qadd.h"

static int
test_easysimd_vqaddb_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int8_t a;
    int8_t b;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    int8_t r = easysimd_vqaddb_s8(test_vec[i].a, test_vec[i].b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    int8_t r = easysimd_vqaddb_s8(a, b);
...
static int
test_easysimd_vqaddh_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int16_t a;
    int16_t b;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    int16_t r = easysimd_vqaddh_s16(test_vec[i].a, test_vec[i].b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    int16_t r = easysimd_vqaddh_s16(a, b);
...
static int
test_easysimd_vqadds_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t a;
    int32_t b;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    int32_t r = easysimd_vqadds_s32(test_vec[i].a, test_vec[i].b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    int32_t r = easysimd_vqadds_s32(a, b);
...
static int
test_easysimd_vqaddd_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int64_t a;
    int64_t b;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    int64_t r = easysimd_vqaddd_s64(test_vec[i].a, test_vec[i].b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    int64_t r = easysimd_vqaddd_s64(a, b);
...
static int
test_easysimd_vqaddb_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint8_t a;
    uint8_t b;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    uint8_t r = easysimd_vqaddb_u8(test_vec[i].a, test_vec[i].b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    uint8_t r = easysimd_vqaddb_u8(a, b);
...
static int
test_easysimd_vqaddh_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint16_t a;
    uint16_t b;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    uint16_t r = easysimd_vqaddh_u16(test_vec[i].a, test_vec[i].b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    uint16_t r = easysimd_vqaddh_u16(a, b);
...
static int
test_easysimd_vqadds_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint32_t a;
    uint32_t b;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    uint32_t r = easysimd_vqadds_u32(test_vec[i].a, test_vec[i].b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    uint32_t r = easysimd_vqadds_u32(a, b);
...
static int
test_easysimd_vqaddd_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint64_t a;
    uint64_t b;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    uint64_t r = easysimd_vqaddd_u64(test_vec[i].a, test_vec[i].b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    uint64_t r = easysimd_vqaddd_u64(a, b);
...
static int
test_easysimd_vqadd_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int8_t a[8];
    int8_t b[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int8x8_t r = easysimd_vqadd_s8(a, b);
...
static int
test_easysimd_vqadd_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int16_t a[4];
    int16_t b[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int16x4_t r = easysimd_vqadd_s16(a, b);
...
static int
test_easysimd_vqadd_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t a[2];
    int32_t b[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x2_t r = easysimd_vqadd_s32(a, b);
...
static int
test_easysimd_vqadd_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int64_t a[1];
    int64_t b[1];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int64x1_t r = easysimd_vqadd_s64(a, b);
...
static int
test_easysimd_vqadd_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint8_t a[8];
    uint8_t b[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x8_t r = easysimd_vqadd_u8(a, b);
...
static int
test_easysimd_vqadd_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint16_t a[4];
    uint16_t b[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x4_t r = easysimd_vqadd_u16(a, b);
...
static int
test_easysimd_vqadd_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint32_t a[2];
    uint32_t b[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x2_t r = easysimd_vqadd_u32(a, b);
...
static int
test_easysimd_vqadd_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint64_t a[1];
    uint64_t b[1];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint64x1_t r = easysimd_vqadd_u64(a, b);
...
static int
test_easysimd_vqaddq_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int8_t a[16];
    int8_t b[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int8x16_t r = easysimd_vqaddq_s8(a, b);
...
static int
test_easysimd_vqaddq_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int16_t a[8];
    int16_t b[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int16x8_t r = easysimd_vqaddq_s16(a, b);
...
static int
test_easysimd_vqaddq_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t a[4];
    int32_t b[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x4_t r = easysimd_vqaddq_s32(a, b);
...
static int
test_easysimd_vqaddq_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int64_t a[2];
    int64_t b[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int64x2_t r = easysimd_vqaddq_s64(a, b);
...
static int
test_easysimd_vqaddq_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint8_t a[16];
    uint8_t b[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x16_t r = easysimd_vqaddq_u8(a, b);
...
static int
test_easysimd_vqaddq_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint16_t a[8];
    uint16_t b[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x8_t r = easysimd_vqaddq_u16(a, b);
...
static int
test_easysimd_vqaddq_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint32_t a[4];
    uint32_t b[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x4_t r = easysimd_vqaddq_u32(a, b);
...
static int
test_easysimd_vqaddq_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint64_t a[2];
    uint64_t b[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint64x2_t r = easysimd_vqaddq_u64(a, b);
...
EASYSIMD_TEST_FUNC_LIST_ENTRY(vqaddb_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vqaddh_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vqadds_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vqaddd_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vqaddb_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vqaddh_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vqadds_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vqaddd_u64)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vqadd_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vqadd_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vqadd_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vqadd_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vqadd_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vqadd_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vqadd_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vqadd_u64)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vqaddq_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vqaddq_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vqaddq_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vqaddq_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vqaddq_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vqaddq_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vqaddq_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vqaddq_u64)
