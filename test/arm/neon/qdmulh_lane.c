#define EASYSIMD_TEST_ARM_NEON_INSN qdmulh_lane

#include "test-neon.h"
#include "../../../easysimd/arm/neon/qdmulh_lane.h"

static int
test_easysimd_vqdmulh_lane_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int16_t a[4];
    int16_t v[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int16x4_t r0 = easysimd_vqdmulh_lane_s16(a, v, 0);
    easysimd_int16x4_t r1 = easysimd_vqdmulh_lane_s16(a, v, 1);
    easysimd_int16x4_t r2 = easysimd_vqdmulh_lane_s16(a, v, 2);
    easysimd_int16x4_t r3 = easysimd_vqdmulh_lane_s16(a, v, 3);

    easysimd_test_arm_neon_assert_equal_i16x4(r0, easysimd_vld1_s16(test_vec[i].r0));
    easysimd_test_arm_neon_assert_equal_i16x4(r1, easysimd_vld1_s16(test_vec[i].r1));
    easysimd_test_arm_neon_assert_equal_i16x4(r2, easysimd_vld1_s16(test_vec[i].r2));
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_test_arm_neon_write_i16x4(2, r0, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_i16x4(2, r1, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_i16x4(2, r2, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_i16x4(2, r3, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
#endif
}
...
static int
test_easysimd_vqdmulh_lane_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t a[2];
    int32_t v[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x2_t r0 = easysimd_vqdmulh_lane_s32(a, v, 0);
    easysimd_int32x2_t r1 = easysimd_vqdmulh_lane_s32(a, v, 1);

    easysimd_test_arm_neon_assert_equal_i32x2(r0, easysimd_vld1_s32(test_vec[i].r0));
    easysimd_test_arm_neon_assert_equal_i32x2(r1, easysimd_vld1_s32(test_vec[i].r1));
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_test_arm_neon_write_i32x2(2, r0, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_i32x2(2, r1, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
#endif
}
...
static int
test_easysimd_vqdmulhq_lane_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int16_t a[8];
    int16_t v[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int16x4_t v = easysimd_vld1_s16(test_vec[i].v);
    easysimd_int16x8_t r0 = easysimd_vqdmulhq_lane_s16(a, v, 0);
    easysimd_int16x8_t r1 = easysimd_vqdmulhq_lane_s16(a, v, 1);
    easysimd_int16x8_t r2 = easysimd_vqdmulhq_lane_s16(a, v, 2);
    easysimd_int16x8_t r3 = easysimd_vqdmulhq_lane_s16(a, v, 3);

    easysimd_test_arm_neon_assert_equal_i16x8(r0, easysimd_vld1q_s16(test_vec[i].r0));
    easysimd_test_arm_neon_assert_equal_i16x8(r1, easysimd_vld1q_s16(test_vec[i].r1));
    easysimd_test_arm_neon_assert_equal_i16x8(r2, easysimd_vld1q_s16(test_vec[i].r2));
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_test_arm_neon_write_i16x4(2, v, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_i16x8(2, r0, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_i16x8(2, r1, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_i16x8(2, r2, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_i16x8(2, r3, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
#endif
}
...
static int
test_easysimd_vqdmulhq_lane_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t a[4];
    int32_t v[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x2_t v = easysimd_vld1_s32(test_vec[i].v);
    easysimd_int32x4_t r0 = easysimd_vqdmulhq_lane_s32(a, v, 0);
    easysimd_int32x4_t r1 = easysimd_vqdmulhq_lane_s32(a, v, 1);

    easysimd_test_arm_neon_assert_equal_i32x4(r0, easysimd_vld1q_s32(test_vec[i].r0));
    easysimd_test_arm_neon_assert_equal_i32x4(r1, easysimd_vld1q_s32(test_vec[i].r1));
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_test_arm_neon_write_i32x2(2, v, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_i32x4(2, r0, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_i32x4(2, r1, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
#endif
}
...
static int
test_easysimd_vqdmulh_laneq_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int16_t a[4];
    int16_t v[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int16x4_t r0 = easysimd_vqdmulh_laneq_s16(a, v, 0);
    easysimd_int16x4_t r1 = easysimd_vqdmulh_laneq_s16(a, v, 1);
    easysimd_int16x4_t r2 = easysimd_vqdmulh_laneq_s16(a, v, 2);
    easysimd_int16x4_t r3 = easysimd_vqdmulh_laneq_s16(a, v, 3);
    easysimd_int16x4_t r4 = easysimd_vqdmulh_laneq_s16(a, v, 4);
    easysimd_int16x4_t r5 = easysimd_vqdmulh_laneq_s16(a, v, 5);
    easysimd_int16x4_t r6 = easysimd_vqdmulh_laneq_s16(a, v, 6);
    easysimd_int16x4_t r7 = easysimd_vqdmulh_laneq_s16(a, v, 7);

    easysimd_test_arm_neon_assert_equal_i16x4(r0, easysimd_vld1_s16(test_vec[i].r0));
    easysimd_test_arm_neon_assert_equal_i16x4(r1, easysimd_vld1_s16(test_vec[i].r1));
    easysimd_test_arm_neon_assert_equal_i16x4(r2, easysimd_vld1_s16(test_vec[i].r2));
    easysimd_test_arm_neon_assert_equal_i16x4(r3, easysimd_vld1_s16(test_vec[i].r3));
    easysimd_test_arm_neon_assert_equal_i16x4(r4, easysimd_vld1_s16(test_vec[i].r4));
    easysimd_test_arm_neon_assert_equal_i16x4(r5, easysimd_vld1_s16(test_vec[i].r5));
    easysimd_test_arm_neon_assert_equal_i16x4(r6, easysimd_vld1_s16(test_vec[i].r6));
    easysimd_test_arm_neon_assert_equal_i16x4(r7, easysimd_vld1_s16(test_vec[i].r7));
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_test_arm_neon_write_i16x4(2, r4, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_i16x4(2, r5, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_i16x4(2, r6, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_i16x4(2, r7, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
#endif
}
...
static int
test_easysimd_vqdmulh_laneq_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t a[2];
    int32_t v[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x2_t r0 = easysimd_vqdmulh_laneq_s32(a, v, 0);
    easysimd_int32x2_t r1 = easysimd_vqdmulh_laneq_s32(a, v, 1);
    easysimd_int32x2_t r2 = easysimd_vqdmulh_laneq_s32(a, v, 2);
    easysimd_int32x2_t r3 = easysimd_vqdmulh_laneq_s32(a, v, 3);

    easysimd_test_arm_neon_assert_equal_i32x2(r0, easysimd_vld1_s32(test_vec[i].r0));
    easysimd_test_arm_neon_assert_equal_i32x2(r1, easysimd_vld1_s32(test_vec[i].r1));
    easysimd_test_arm_neon_assert_equal_i32x2(r2, easysimd_vld1_s32(test_vec[i].r2));
    easysimd_test_arm_neon_assert_equal_i32x2(r3, easysimd_vld1_s32(test_vec[i].r3));
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_test_arm_neon_write_i32x2(2, r0, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_i32x2(2, r1, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_i32x2(2, r2, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_i32x2(2, r3, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
#endif
}
...
static int
test_easysimd_vqdmulhq_laneq_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int16_t a[8];
    int16_t v[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_int16x8_t a = easysimd_vld1q_s16(test_vec[i].a);
    easysimd_int16x8_t v = easysimd_vld1q_s16(test_vec[i].v);
    easysimd_int16x8_t r0 = easysimd_vqdmulhq_laneq_s16(a, v, 0);
    easysimd_int16x8_t r1 = easysimd_vqdmulhq_laneq_s16(a, v, 1);
    easysimd_int16x8_t r2 = easysimd_vqdmulhq_laneq_s16(a, v, 2);
    easysimd_int16x8_t r3 = easysimd_vqdmulhq_laneq_s16(a, v, 3);
    easysimd_int16x8_t r4 = easysimd_vqdmulhq_laneq_s16(a, v, 4);
    easysimd_int16x8_t r5 = easysimd_vqdmulhq_laneq_s16(a, v, 5);
    easysimd_int16x8_t r6 = easysimd_vqdmulhq_laneq_s16(a, v, 6);
    easysimd_int16x8_t r7 = easysimd_vqdmulhq_laneq_s16(a, v, 7);

    easysimd_test_arm_neon_assert_equal_i16x8(r0, easysimd_vld1q_s16(test_vec[i].r0));
    easysimd_test_arm_neon_assert_equal_i16x8(r1, easysimd_vld1q_s16(test_vec[i].r1));
    easysimd_test_arm_neon_assert_equal_i16x8(r2, easysimd_vld1q_s16(test_vec[i].r2));
    easysimd_test_arm_neon_assert_equal_i16x8(r3, easysimd_vld1q_s16(test_vec[i].r3));
    easysimd_test_arm_neon_assert_equal_i16x8(r4, easysimd_vld1q_s16(test_vec[i].r4));
    easysimd_test_arm_neon_assert_equal_i16x8(r5, easysimd_vld1q_s16(test_vec[i].r5));
    easysimd_test_arm_neon_assert_equal_i16x8(r6, easysimd_vld1q_s16(test_vec[i].r6));
    easysimd_test_arm_neon_assert_equal_i16x8(r7, easysimd_vld1q_s16(test_vec[i].r7));
  }
...
static int
test_easysimd_vqdmulhq_laneq_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t a[4];
    int32_t v[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_int32x4_t a = easysimd_vld1q_s32(test_vec[i].a);
    easysimd_int32x4_t v = easysimd_vld1q_s32(test_vec[i].v);
    easysimd_int32x4_t r0 = easysimd_vqdmulhq_laneq_s32(a, v, 0);
    easysimd_int32x4_t r1 = easysimd_vqdmulhq_laneq_s32(a, v, 1);
    easysimd_int32x4_t r2 = easysimd_vqdmulhq_laneq_s32(a, v, 2);
    easysimd_int32x4_t r3 = easysimd_vqdmulhq_laneq_s32(a, v, 3);

    easysimd_test_arm_neon_assert_equal_i32x4(r0, easysimd_vld1q_s32(test_vec[i].r0));
    easysimd_test_arm_neon_assert_equal_i32x4(r1, easysimd_vld1q_s32(test_vec[i].r1));
    easysimd_test_arm_neon_assert_equal_i32x4(r2, easysimd_vld1q_s32(test_vec[i].r2));
    easysimd_test_arm_neon_assert_equal_i32x4(r3, easysimd_vld1q_s32(test_vec[i].r3));
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_test_arm_neon_write_i32x4(2, v, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_i32x4(2, r0, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_i32x4(2, r1, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_i32x4(2, r2, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_i32x4(2, r3, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
#endif
}
...
static int
test_easysimd_vqdmulhs_lane_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t a;
    int32_t v[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x2_t v = easysimd_vld1_s32(test_vec[i].v);
    int32_t r0 = easysimd_vqdmulhs_lane_s32(a, v, 0);
    int32_t r1 = easysimd_vqdmulhs_lane_s32(a, v, 1);

    easysimd_assert_equal_i32(r0, test_vec[i].r0);
    easysimd_assert_equal_i32(r1, test_vec[i].r1);
  }
...
static int
test_easysimd_vqdmulhs_laneq_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t a;
    int32_t v[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    int32_t a = test_vec[i].a;
    easysimd_int32x4_t v = easysimd_vld1q_s32(test_vec[i].v);
    int32_t r0 = easysimd_vqdmulhs_laneq_s32(a, v, 0);
    int32_t r1 = easysimd_vqdmulhs_laneq_s32(a, v, 1);
...
EASYSIMD_TEST_FUNC_LIST_ENTRY(vqdmulh_lane_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vqdmulh_lane_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vqdmulhq_lane_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vqdmulhq_lane_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vqdmulh_laneq_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vqdmulh_laneq_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vqdmulhq_laneq_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vqdmulhq_laneq_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vqdmulhs_lane_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vqdmulhs_laneq_s32)
