...
#include "test/test.h"
#define EASYSIMD_TEST_ARM_NEON_INSN qrdmulh_lane

#include "test-neon.h"
#include "../../../easysimd/arm/neon/qrdmulh_lane.h"

static int
test_easysimd_vqrdmulh_lane_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int16_t  a[4];
    int16_t  v[4];
  ...
  easysimd_int16x4_t a, v, r;

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    a = easysimd_vld1_s16(test_vec[i].a);
    v = easysimd_vld1_s16(test_vec[i].v);

    r = easysimd_vqrdmulh_lane_s16(a, v, 0);
    easysimd_test_arm_neon_assert_equal_i16x4(r, easysimd_vld1_s16(test_vec[i].r0));

    r = easysimd_vqrdmulh_lane_s16(a, v, 1);
    easysimd_test_arm_neon_assert_equal_i16x4(r, easysimd_vld1_s16(test_vec[i].r1));

    r = easysimd_vqrdmulh_lane_s16(a, v, 2);
    easysimd_test_arm_neon_assert_equal_i16x4(r, easysimd_vld1_s16(test_vec[i].r2));

    r = easysimd_vqrdmulh_lane_s16(a, v, 3);
    easysimd_test_arm_neon_assert_equal_i16x4(r, easysimd_vld1_s16(test_vec[i].r3));
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    for (int j = 0 ; j < 4 ; j++) {
      EASYSIMD_CONSTIFY_4_(easysimd_vqrdmulh_lane_s16, r, (HEDLEY_UNREACHABLE(), easysimd_vdup_n_s16(0)), j, a, v);
      easysimd_test_arm_neon_write_i16x4(2, r, (j == 3) ? EASYSIMD_TEST_VEC_POS_LAST : EASYSIMD_TEST_VEC_POS_MIDDLE);
    }
  }
  return 1;
#endif
...
static int
test_easysimd_vqrdmulh_lane_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t  a[2];
    int32_t  v[2];
  ...
  easysimd_int32x2_t a, v, r;

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    a = easysimd_vld1_s32(test_vec[i].a);
    v = easysimd_vld1_s32(test_vec[i].v);

    r = easysimd_vqrdmulh_lane_s32(a, v, 0);
    easysimd_test_arm_neon_assert_equal_i32x2(r, easysimd_vld1_s32(test_vec[i].r0));

    r = easysimd_vqrdmulh_lane_s32(a, v, 1);
    easysimd_test_arm_neon_assert_equal_i32x2(r, easysimd_vld1_s32(test_vec[i].r1));
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    for (int j = 0 ; j < 2 ; j++) {
      EASYSIMD_CONSTIFY_2_(easysimd_vqrdmulh_lane_s32, r, (HEDLEY_UNREACHABLE(), easysimd_vdup_n_s32(0)), j, a, v);
      easysimd_test_arm_neon_write_i32x2(2, r, (j == 1) ? EASYSIMD_TEST_VEC_POS_LAST : EASYSIMD_TEST_VEC_POS_MIDDLE);
    }
  }
  return 1;
#endif
...
static int
test_easysimd_vqrdmulhq_lane_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int16_t  a[8];
    int16_t  v[4];
  ...
  easysimd_int16x8_t a, r;
  easysimd_int16x4_t v;

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    a = easysimd_vld1q_s16(test_vec[i].a);
    v = easysimd_vld1_s16(test_vec[i].v);

    r = easysimd_vqrdmulhq_lane_s16(a, v, 0);
    easysimd_test_arm_neon_assert_equal_i16x8(r, easysimd_vld1q_s16(test_vec[i].r0));

    r = easysimd_vqrdmulhq_lane_s16(a, v, 1);
    easysimd_test_arm_neon_assert_equal_i16x8(r, easysimd_vld1q_s16(test_vec[i].r1));

    r = easysimd_vqrdmulhq_lane_s16(a, v, 2);
    easysimd_test_arm_neon_assert_equal_i16x8(r, easysimd_vld1q_s16(test_vec[i].r2));

    r = easysimd_vqrdmulhq_lane_s16(a, v, 3);
    easysimd_test_arm_neon_assert_equal_i16x8(r, easysimd_vld1q_s16(test_vec[i].r3));
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    for (int j = 0 ; j < 4 ; j++) {
      EASYSIMD_CONSTIFY_4_(easysimd_vqrdmulhq_lane_s16, r, (HEDLEY_UNREACHABLE(), easysimd_vdupq_n_s16(0)), j, a, v);
      easysimd_test_arm_neon_write_i16x8(2, r, (j == 3) ? EASYSIMD_TEST_VEC_POS_LAST : EASYSIMD_TEST_VEC_POS_MIDDLE);
    }
  }
  return 1;
#endif
...
static int
test_easysimd_vqrdmulhq_lane_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t  a[4];
    int32_t  v[2];
  ...
  easysimd_int32x2_t v;

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    a = easysimd_vld1q_s32(test_vec[i].a);
    v = easysimd_vld1_s32(test_vec[i].v);

    r = easysimd_vqrdmulhq_lane_s32(a, v, 0);
    easysimd_test_arm_neon_assert_equal_i32x4(r, easysimd_vld1q_s32(test_vec[i].r0));

    r = easysimd_vqrdmulhq_lane_s32(a, v, 1);
    easysimd_test_arm_neon_assert_equal_i32x4(r, easysimd_vld1q_s32(test_vec[i].r1));
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    for (int j = 0 ; j < 2 ; j++) {
      EASYSIMD_CONSTIFY_2_(easysimd_vqrdmulhq_lane_s32, r, (HEDLEY_UNREACHABLE(), easysimd_vdupq_n_s32(0)), j, a, v);
      easysimd_test_arm_neon_write_i32x4(2, r, (j == 1) ? EASYSIMD_TEST_VEC_POS_LAST : EASYSIMD_TEST_VEC_POS_MIDDLE);
    }
  }
  return 1;
#endif
...
static int
test_easysimd_vqrdmulh_laneq_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int16_t  a[4];
    int16_t  v[8];
  ...
  easysimd_int16x4_t a, r;
  easysimd_int16x8_t v;

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    a = easysimd_vld1_s16(test_vec[i].a);
    v = easysimd_vld1q_s16(test_vec[i].v);

    r = easysimd_vqrdmulh_laneq_s16(a, v, 0);
    easysimd_test_arm_neon_assert_equal_i16x4(r, easysimd_vld1_s16(test_vec[i].r0));

    r = easysimd_vqrdmulh_laneq_s16(a, v, 1);
    easysimd_test_arm_neon_assert_equal_i16x4(r, easysimd_vld1_s16(test_vec[i].r1));

    r = easysimd_vqrdmulh_laneq_s16(a, v, 2);
    easysimd_test_arm_neon_assert_equal_i16x4(r, easysimd_vld1_s16(test_vec[i].r2));

    r = easysimd_vqrdmulh_laneq_s16(a, v, 3);
    easysimd_test_arm_neon_assert_equal_i16x4(r, easysimd_vld1_s16(test_vec[i].r3));

    r = easysimd_vqrdmulh_laneq_s16(a, v, 4);
    easysimd_test_arm_neon_assert_equal_i16x4(r, easysimd_vld1_s16(test_vec[i].r4));

    r = easysimd_vqrdmulh_laneq_s16(a, v, 5);
    easysimd_test_arm_neon_assert_equal_i16x4(r, easysimd_vld1_s16(test_vec[i].r5));

    r = easysimd_vqrdmulh_laneq_s16(a, v, 6);
    easysimd_test_arm_neon_assert_equal_i16x4(r, easysimd_vld1_s16(test_vec[i].r6));

    r = easysimd_vqrdmulh_laneq_s16(a, v, 7);
    easysimd_test_arm_neon_assert_equal_i16x4(r, easysimd_vld1_s16(test_vec[i].r7));
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    for (int j = 0 ; j < 8 ; j++) {
      EASYSIMD_CONSTIFY_8_(easysimd_vqrdmulh_laneq_s16, r, (HEDLEY_UNREACHABLE(), easysimd_vdup_n_s16(0)), j, a, v);
      easysimd_test_arm_neon_write_i16x4(2, r, (j == 7) ? EASYSIMD_TEST_VEC_POS_LAST : EASYSIMD_TEST_VEC_POS_MIDDLE);
    }
  }
  return 1;
#endif
...
static int
test_easysimd_vqrdmulh_laneq_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t  a[2];
    int32_t  v[4];
  ...
  easysimd_int32x2_t a, r;
  easysimd_int32x4_t v;

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    a = easysimd_vld1_s32(test_vec[i].a);
    v = easysimd_vld1q_s32(test_vec[i].v);

    r = easysimd_vqrdmulh_laneq_s32(a, v, 0);
    easysimd_test_arm_neon_assert_equal_i32x2(r, easysimd_vld1_s32(test_vec[i].r0));

    r = easysimd_vqrdmulh_laneq_s32(a, v, 1);
    easysimd_test_arm_neon_assert_equal_i32x2(r, easysimd_vld1_s32(test_vec[i].r1));

    r = easysimd_vqrdmulh_laneq_s32(a, v, 2);
    easysimd_test_arm_neon_assert_equal_i32x2(r, easysimd_vld1_s32(test_vec[i].r2));

    r = easysimd_vqrdmulh_laneq_s32(a, v, 3);
    easysimd_test_arm_neon_assert_equal_i32x2(r, easysimd_vld1_s32(test_vec[i].r3));
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    for (int j = 0 ; j < 4 ; j++) {
      EASYSIMD_CONSTIFY_4_(easysimd_vqrdmulh_laneq_s32, r, (HEDLEY_UNREACHABLE(), easysimd_vdup_n_s32(0)), j, a, v);
      easysimd_test_arm_neon_write_i32x2(2, r, (j == 3) ? EASYSIMD_TEST_VEC_POS_LAST : EASYSIMD_TEST_VEC_POS_MIDDLE);
    }
  }
  return 1;
#endif
...
static int
test_easysimd_vqrdmulhq_laneq_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int16_t  a[8];
    int16_t  v[8];
  ...
  easysimd_int16x8_t a, v, r;

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    a = easysimd_vld1q_s16(test_vec[i].a);
    v = easysimd_vld1q_s16(test_vec[i].v);

    r = easysimd_vqrdmulhq_laneq_s16(a, v, 0);
    easysimd_test_arm_neon_assert_equal_i16x8(r, easysimd_vld1q_s16(test_vec[i].r0));

    r = easysimd_vqrdmulhq_laneq_s16(a, v, 1);
    easysimd_test_arm_neon_assert_equal_i16x8(r, easysimd_vld1q_s16(test_vec[i].r1));

    r = easysimd_vqrdmulhq_laneq_s16(a, v, 2);
    easysimd_test_arm_neon_assert_equal_i16x8(r, easysimd_vld1q_s16(test_vec[i].r2));

    r = easysimd_vqrdmulhq_laneq_s16(a, v, 3);
    easysimd_test_arm_neon_assert_equal_i16x8(r, easysimd_vld1q_s16(test_vec[i].r3));

    r = easysimd_vqrdmulhq_laneq_s16(a, v, 4);
    easysimd_test_arm_neon_assert_equal_i16x8(r, easysimd_vld1q_s16(test_vec[i].r4));

    r = easysimd_vqrdmulhq_laneq_s16(a, v, 5);
    easysimd_test_arm_neon_assert_equal_i16x8(r, easysimd_vld1q_s16(test_vec[i].r5));

    r = easysimd_vqrdmulhq_laneq_s16(a, v, 6);
    easysimd_test_arm_neon_assert_equal_i16x8(r, easysimd_vld1q_s16(test_vec[i].r6));

    r = easysimd_vqrdmulhq_laneq_s16(a, v, 7);
    easysimd_test_arm_neon_assert_equal_i16x8(r, easysimd_vld1q_s16(test_vec[i].r7));
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    for (int j = 0 ; j < 8 ; j++) {
      EASYSIMD_CONSTIFY_8_(easysimd_vqrdmulhq_laneq_s16, r, (HEDLEY_UNREACHABLE(), easysimd_vdupq_n_s16(0)), j, a, v);
      easysimd_test_arm_neon_write_i16x8(2, r, (j == 7) ? EASYSIMD_TEST_VEC_POS_LAST : EASYSIMD_TEST_VEC_POS_MIDDLE);
    }
  }
  return 1;
#endif
...
static int
test_easysimd_vqrdmulhq_laneq_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t  a[4];
    int32_t  v[4];
  ...
  easysimd_int32x4_t a, v, r;

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    a = easysimd_vld1q_s32(test_vec[i].a);
    v = easysimd_vld1q_s32(test_vec[i].v);

    r = easysimd_vqrdmulhq_laneq_s32(a, v, 0);
    easysimd_test_arm_neon_assert_equal_i32x4(r, easysimd_vld1q_s32(test_vec[i].r0));

    r = easysimd_vqrdmulhq_laneq_s32(a, v, 1);
    easysimd_test_arm_neon_assert_equal_i32x4(r, easysimd_vld1q_s32(test_vec[i].r1));

    r = easysimd_vqrdmulhq_laneq_s32(a, v, 2);
    easysimd_test_arm_neon_assert_equal_i32x4(r, easysimd_vld1q_s32(test_vec[i].r2));

    r = easysimd_vqrdmulhq_laneq_s32(a, v, 3);
    easysimd_test_arm_neon_assert_equal_i32x4(r, easysimd_vld1q_s32(test_vec[i].r3));
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    for (int j = 0 ; j < 4 ; j++) {
      EASYSIMD_CONSTIFY_4_(easysimd_vqrdmulhq_laneq_s32, r, (HEDLEY_UNREACHABLE(), easysimd_vdupq_n_s32(0)), j, a, v);
      easysimd_test_arm_neon_write_i32x4(2, r, (j == 3) ? EASYSIMD_TEST_VEC_POS_LAST : EASYSIMD_TEST_VEC_POS_MIDDLE);
    }
  }
  return 1;
#endif
...
static int
test_easysimd_vqrdmulhs_lane_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t  a;
    int32_t  v[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    int32_t r = easysimd_vqrdmulhs_lane_s32(test_vec[i].a, v, 0);
    easysimd_assert_equal_i32(r, test_vec[i].r0);

    r = easysimd_vqrdmulhs_lane_s32(test_vec[i].a, v, 1);
    easysimd_assert_equal_i32(r, test_vec[i].r1);
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_int32x2_t v = easysimd_test_arm_neon_random_i32x2();
    int32_t r0 = easysimd_vqrdmulhs_lane_s32(a, v, 0);
    int32_t r1 = easysimd_vqrdmulhs_lane_s32(a, v, 1);

    easysimd_test_codegen_write_i32(2, a, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_arm_neon_write_i32x2(2, v, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_codegen_write_i32(2, r0, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_codegen_write_i32(2, r1, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
#endif
}
...
static int
test_easysimd_vqrdmulhs_laneq_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t  a;
    int32_t  v[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    int32_t r = easysimd_vqrdmulhs_laneq_s32(test_vec[i].a, v, 0);
    easysimd_assert_equal_i32(r, test_vec[i].r0);
    r = easysimd_vqrdmulhs_laneq_s32(test_vec[i].a, v, 1);
    easysimd_assert_equal_i32(r, test_vec[i].r1);
    r = easysimd_vqrdmulhs_laneq_s32(test_vec[i].a, v, 2);
    easysimd_assert_equal_i32(r, test_vec[i].r2);
    r = easysimd_vqrdmulhs_laneq_s32(test_vec[i].a, v, 3);
    easysimd_assert_equal_i32(r, test_vec[i].r3);
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    int32_t a = easysimd_test_codegen_random_i32();
    easysimd_int32x4_t v = easysimd_test_arm_neon_random_i32x4();
    int32_t r0 = easysimd_vqrdmulhs_laneq_s32(a, v, 0);
    int32_t r1 = easysimd_vqrdmulhs_laneq_s32(a, v, 1);
    int32_t r2 = easysimd_vqrdmulhs_laneq_s32(a, v, 2);
    int32_t r3 = easysimd_vqrdmulhs_laneq_s32(a, v, 3);

    easysimd_test_codegen_write_i32(2, a, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_arm_neon_write_i32x4(2, v, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_codegen_write_i32(2, r0, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_codegen_write_i32(2, r1, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_codegen_write_i32(2, r2, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_codegen_write_i32(2, r3, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
#endif
}
...
EASYSIMD_TEST_FUNC_LIST_ENTRY(vqrdmulh_lane_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vqrdmulh_lane_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vqrdmulhq_lane_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vqrdmulhq_lane_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vqrdmulh_laneq_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vqrdmulh_laneq_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vqrdmulhq_laneq_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vqrdmulhq_laneq_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vqrdmulhs_lane_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vqrdmulhs_laneq_s32)
