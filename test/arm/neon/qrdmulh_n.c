#define EASYSIMD_TEST_ARM_NEON_INSN qrdmulh_n

#include "test-neon.h"
#include "../../../easysimd/arm/neon/qrdmulh_n.h"

static int
test_easysimd_vqrdmulh_n_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int16_t a[4];
    int16_t b;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int16x4_t r = easysimd_vqrdmulh_n_s16(a, b);
...
static int
test_easysimd_vqrdmulh_n_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t a[2];
    int32_t b;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x2_t r = easysimd_vqrdmulh_n_s32(a, b);
...
static int
test_easysimd_vqrdmulhq_n_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int16_t a[8];
    int16_t b;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    int16_t b = test_vec[i].b;
    easysimd_int16x8_t r = easysimd_vqrdmulhq_n_s16(a, b);
...
static int
test_easysimd_vqrdmulhq_n_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t a[4];
    int32_t b;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    int32_t b = test_vec[i].b;
    easysimd_int32x4_t r = easysimd_vqrdmulhq_n_s32(a, b);
...
EASYSIMD_TEST_FUNC_LIST_ENTRY(vqrdmulh_n_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vqrdmulh_n_s32)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vqrdmulhq_n_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vqrdmulhq_n_s32)
