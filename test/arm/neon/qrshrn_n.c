#define EASYSIMD_TEST_ARM_NEON_INSN qrshrn_n

#include "test-neon.h"
#include "../../../easysimd/arm/neon/qrshrn_n.h"

static int
test_easysimd_vqrshrn_n_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int16_t a[8];
    int8_t r1[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int8x8_t r1 = easysimd_vqrshrn_n_s16(a, 1);
    easysimd_int8x8_t r3 = easysimd_vqrshrn_n_s16(a, 3);
    easysimd_int8x8_t r5 = easysimd_vqrshrn_n_s16(a, 5);
    easysimd_int8x8_t r6 = easysimd_vqrshrn_n_s16(a, 6);
    easysimd_int8x8_t r8 = easysimd_vqrshrn_n_s16(a, 8);
...
static int
test_easysimd_vqrshrn_n_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t a[4];
    int16_t r3[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int16x4_t r3 = easysimd_vqrshrn_n_s32(a, 3);
    easysimd_int16x4_t r6 = easysimd_vqrshrn_n_s32(a, 6);
    easysimd_int16x4_t r10 = easysimd_vqrshrn_n_s32(a, 10);
    easysimd_int16x4_t r13 = easysimd_vqrshrn_n_s32(a, 13);
    easysimd_int16x4_t r16 = easysimd_vqrshrn_n_s32(a, 16);
...
static int
test_easysimd_vqrshrn_n_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int64_t a[2];
    int32_t r6[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x2_t r6 = easysimd_vqrshrn_n_s64(a, 6);
    easysimd_int32x2_t r13 = easysimd_vqrshrn_n_s64(a, 13);
    easysimd_int32x2_t r19 = easysimd_vqrshrn_n_s64(a, 19);
    easysimd_int32x2_t r26 = easysimd_vqrshrn_n_s64(a, 26);
    easysimd_int32x2_t r32 = easysimd_vqrshrn_n_s64(a, 32);
...
static int
test_easysimd_vqrshrn_n_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint16_t a[8];
    uint8_t r1[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x8_t r1 = easysimd_vqrshrn_n_u16(a, 1);
    easysimd_uint8x8_t r3 = easysimd_vqrshrn_n_u16(a, 3);
    easysimd_uint8x8_t r5 = easysimd_vqrshrn_n_u16(a, 5);
    easysimd_uint8x8_t r6 = easysimd_vqrshrn_n_u16(a, 6);
    easysimd_uint8x8_t r8 = easysimd_vqrshrn_n_u16(a, 8);
...
static int
test_easysimd_vqrshrn_n_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint32_t a[4];
    uint16_t r3[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x4_t r3 = easysimd_vqrshrn_n_u32(a, 3);
    easysimd_uint16x4_t r6 = easysimd_vqrshrn_n_u32(a, 6);
    easysimd_uint16x4_t r10 = easysimd_vqrshrn_n_u32(a, 10);
    easysimd_uint16x4_t r13 = easysimd_vqrshrn_n_u32(a, 13);
    easysimd_uint16x4_t r16 = easysimd_vqrshrn_n_u32(a, 16);
...
static int
test_easysimd_vqrshrn_n_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint64_t a[2];
    uint32_t r6[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x2_t r6 = easysimd_vqrshrn_n_u64(a, 6);
    easysimd_uint32x2_t r13 = easysimd_vqrshrn_n_u64(a, 13);
    easysimd_uint32x2_t r19 = easysimd_vqrshrn_n_u64(a, 19);
    easysimd_uint32x2_t r26 = easysimd_vqrshrn_n_u64(a, 26);
    easysimd_uint32x2_t r32 = easysimd_vqrshrn_n_u64(a, 32);
...
static int
test_easysimd_vqrshrns_n_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t a;
    int16_t r3;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    int16_t r3 = easysimd_vqrshrns_n_s32(test_vec[i].a, 3);
    int16_t r6 = easysimd_vqrshrns_n_s32(test_vec[i].a, 6);
    int16_t r10 = easysimd_vqrshrns_n_s32(test_vec[i].a, 10);
    int16_t r13 = easysimd_vqrshrns_n_s32(test_vec[i].a, 13);
    int16_t r16 = easysimd_vqrshrns_n_s32(test_vec[i].a, 16);

    easysimd_assert_equal_i16(r3, test_vec[i].r3);
    easysimd_assert_equal_i16(r6, test_vec[i].r6);
    easysimd_assert_equal_i16(r10, test_vec[i].r10);
    easysimd_assert_equal_i16(r13, test_vec[i].r13);
    easysimd_assert_equal_i16(r16, test_vec[i].r16);
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    int16_t r3 = easysimd_vqrshrns_n_s32(a, 3);
    int16_t r6 = easysimd_vqrshrns_n_s32(a, 6);
    int16_t r10 = easysimd_vqrshrns_n_s32(a, 10);
    int16_t r13 = easysimd_vqrshrns_n_s32(a, 13);
    int16_t r16 = easysimd_vqrshrns_n_s32(a, 16);

    easysimd_test_codegen_write_i32(2, a, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_codegen_write_i16(2, r3, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_codegen_write_i16(2, r6, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_codegen_write_i16(2, r10, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_codegen_write_i16(2, r13, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_codegen_write_i16(2, r16, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
#endif
}
...
static int
test_easysimd_vqrshrns_n_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint32_t a;
    uint16_t r3;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    uint16_t r3 = easysimd_vqrshrns_n_u32(test_vec[i].a, 3);
    uint16_t r6 = easysimd_vqrshrns_n_u32(test_vec[i].a, 6);
    uint16_t r10 = easysimd_vqrshrns_n_u32(test_vec[i].a, 10);
    uint16_t r13 = easysimd_vqrshrns_n_u32(test_vec[i].a, 13);
    uint16_t r16 = easysimd_vqrshrns_n_u32(test_vec[i].a, 16);

    easysimd_assert_equal_u16(r3, test_vec[i].r3);
    easysimd_assert_equal_u16(r6, test_vec[i].r6);
    easysimd_assert_equal_u16(r10, test_vec[i].r10);
    easysimd_assert_equal_u16(r13, test_vec[i].r13);
    easysimd_assert_equal_u16(r16, test_vec[i].r16);
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    uint16_t r3 = easysimd_vqrshrns_n_u32(a, 3);
    uint16_t r6 = easysimd_vqrshrns_n_u32(a, 6);
    uint16_t r13 = easysimd_vqrshrns_n_u32(a, 13);
    uint16_t r10 = easysimd_vqrshrns_n_u32(a, 10);
    uint16_t r16 = easysimd_vqrshrns_n_u32(a, 16);

    easysimd_test_codegen_write_u32(2, a, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_codegen_write_u16(2, r3, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_codegen_write_u16(2, r6, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_codegen_write_u16(2, r10, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_codegen_write_u16(2, r13, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_codegen_write_u16(2, r16, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
#endif
}
...
static int
test_easysimd_vqrshrnd_n_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int64_t a;
    int32_t r6;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    int32_t r6 = easysimd_vqrshrnd_n_s64(test_vec[i].a, 6);
    int32_t r13 = easysimd_vqrshrnd_n_s64(test_vec[i].a, 13);
    int32_t r19 = easysimd_vqrshrnd_n_s64(test_vec[i].a, 19);
    int32_t r26 = easysimd_vqrshrnd_n_s64(test_vec[i].a, 26);
    int32_t r32 = easysimd_vqrshrnd_n_s64(test_vec[i].a, 32);

    easysimd_assert_equal_i64(r6, test_vec[i].r6);
    easysimd_assert_equal_i32(r19, test_vec[i].r19);
    easysimd_assert_equal_i32(r13, test_vec[i].r13);
    easysimd_assert_equal_i32(r26, test_vec[i].r26);
    easysimd_assert_equal_i32(r32, test_vec[i].r32);
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    int32_t r6 = easysimd_vqrshrnd_n_s64(a, 6);
    int32_t r13 = easysimd_vqrshrnd_n_s64(a, 13);
    int32_t r19 = easysimd_vqrshrnd_n_s64(a, 19);
    int32_t r26 = easysimd_vqrshrnd_n_s64(a, 26);
    int32_t r32 = easysimd_vqrshrnd_n_s64(a, 32);

    easysimd_test_codegen_write_i64(2, a, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_codegen_write_i32(2, r6, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_codegen_write_i32(2, r13, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_codegen_write_i32(2, r19, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_codegen_write_i32(2, r26, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_codegen_write_i32(2, r32, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
#endif
}
...
static int
test_easysimd_vqrshrnd_n_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint64_t a;
    uint32_t r6;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    uint32_t r6 = easysimd_vqrshrnd_n_u64(test_vec[i].a, 6);
    uint32_t r13 = easysimd_vqrshrnd_n_u64(test_vec[i].a, 13);
    uint32_t r19 = easysimd_vqrshrnd_n_u64(test_vec[i].a, 19);
    uint32_t r26 = easysimd_vqrshrnd_n_u64(test_vec[i].a, 26);
    uint32_t r32 = easysimd_vqrshrnd_n_u64(test_vec[i].a, 32);

    easysimd_assert_equal_u64(r6, test_vec[i].r6);
    easysimd_assert_equal_u32(r19, test_vec[i].r19);
    easysimd_assert_equal_u32(r13, test_vec[i].r13);
    easysimd_assert_equal_u32(r26, test_vec[i].r26);
    easysimd_assert_equal_u32(r32, test_vec[i].r32);
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    uint32_t r6 = easysimd_vqrshrnd_n_u64(a, 6);
    uint32_t r13 = easysimd_vqrshrnd_n_u64(a, 13);
    uint32_t r19 = easysimd_vqrshrnd_n_u64(a, 19);
    uint32_t r26 = easysimd_vqrshrnd_n_u64(a, 26);
    uint32_t r32 = easysimd_vqrshrnd_n_u64(a, 32);

    easysimd_test_codegen_write_u64(2, a, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_codegen_write_u32(2, r6, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_codegen_write_u32(2, r13, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_codegen_write_u32(2, r19, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_codegen_write_u32(2, r26, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_codegen_write_u32(2, r32, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
#endif
}
...
EASYSIMD_TEST_FUNC_LIST_ENTRY(vqrshrn_n_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vqrshrn_n_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vqrshrn_n_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vqrshrn_n_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vqrshrn_n_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vqrshrn_n_u64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vqrshrns_n_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vqrshrns_n_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vqrshrnd_n_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vqrshrnd_n_u64)
