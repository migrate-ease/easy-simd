...
#define EASYSIMD_TEST_ARM_NEON_INSN qrshrun_n

#include "test-neon.h"
#include "../../../easysimd/arm/neon/qrshrun_n.h"

static int
test_easysimd_vqrshrun_n_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int16_t a[8];
    uint8_t r1[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x8_t r1 = easysimd_vqrshrun_n_s16(a, 1);
    easysimd_uint8x8_t r3 = easysimd_vqrshrun_n_s16(a, 3);
    easysimd_uint8x8_t r5 = easysimd_vqrshrun_n_s16(a, 5);
    easysimd_uint8x8_t r6 = easysimd_vqrshrun_n_s16(a, 6);
    easysimd_uint8x8_t r8 = easysimd_vqrshrun_n_s16(a, 8);
...
static int
test_easysimd_vqrshrun_n_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t a[4];
    uint16_t r3[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x4_t r3 = easysimd_vqrshrun_n_s32(a, 3);
    easysimd_uint16x4_t r6 = easysimd_vqrshrun_n_s32(a, 6);
    easysimd_uint16x4_t r10 = easysimd_vqrshrun_n_s32(a, 10);
    easysimd_uint16x4_t r13 = easysimd_vqrshrun_n_s32(a, 13);
    easysimd_uint16x4_t r16 = easysimd_vqrshrun_n_s32(a, 16);
...
static int
test_easysimd_vqrshrun_n_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int64_t a[2];
    uint32_t r6[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x2_t r6 = easysimd_vqrshrun_n_s64(a, 6);
    easysimd_uint32x2_t r13 = easysimd_vqrshrun_n_s64(a, 13);
    easysimd_uint32x2_t r19 = easysimd_vqrshrun_n_s64(a, 19);
    easysimd_uint32x2_t r26 = easysimd_vqrshrun_n_s64(a, 26);
    easysimd_uint32x2_t r32 = easysimd_vqrshrun_n_s64(a, 32);
...
static int
test_easysimd_vqrshrund_n_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int64_t a;
    uint32_t r6;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    uint32_t r6 = HEDLEY_STATIC_CAST(uint32_t, easysimd_vqrshrund_n_s64(test_vec[i].a, 6));
    uint32_t r13 = HEDLEY_STATIC_CAST(uint32_t, easysimd_vqrshrund_n_s64(test_vec[i].a, 13));
    uint32_t r19 = HEDLEY_STATIC_CAST(uint32_t, easysimd_vqrshrund_n_s64(test_vec[i].a, 19));
    uint32_t r26 = HEDLEY_STATIC_CAST(uint32_t, easysimd_vqrshrund_n_s64(test_vec[i].a, 26));
    uint32_t r32 = HEDLEY_STATIC_CAST(uint32_t, easysimd_vqrshrund_n_s64(test_vec[i].a, 32));
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    uint32_t r6 = HEDLEY_STATIC_CAST(uint32_t, easysimd_vqrshrund_n_s64(a, 6));
    uint32_t r13 = HEDLEY_STATIC_CAST(uint32_t, easysimd_vqrshrund_n_s64(a, 13));
    uint32_t r19 = HEDLEY_STATIC_CAST(uint32_t, easysimd_vqrshrund_n_s64(a, 19));
    uint32_t r26 = HEDLEY_STATIC_CAST(uint32_t, easysimd_vqrshrund_n_s64(a, 26));
    uint32_t r32 = HEDLEY_STATIC_CAST(uint32_t, easysimd_vqrshrund_n_s64(a, 32));
...
static int
test_easysimd_vqrshruns_n_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t a;
    uint16_t r6;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    uint16_t r6 = HEDLEY_STATIC_CAST(uint16_t, easysimd_vqrshrund_n_s64(test_vec[i].a, 6));
    uint16_t r8 = HEDLEY_STATIC_CAST(uint16_t, easysimd_vqrshrund_n_s64(test_vec[i].a, 8));
    uint16_t r10 = HEDLEY_STATIC_CAST(uint16_t, easysimd_vqrshrund_n_s64(test_vec[i].a, 10));
    uint16_t r12 = HEDLEY_STATIC_CAST(uint16_t, easysimd_vqrshrund_n_s64(test_vec[i].a, 12));
    uint16_t r16 = HEDLEY_STATIC_CAST(uint16_t, easysimd_vqrshrund_n_s64(test_vec[i].a, 16));

    easysimd_assert_equal_u16(r6, test_vec[i].r6);
    easysimd_assert_equal_u16(r8, test_vec[i].r8);
    easysimd_assert_equal_u16(r10, test_vec[i].r10);
    easysimd_assert_equal_u16(r12, test_vec[i].r12);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    uint16_t r6 = HEDLEY_STATIC_CAST(uint16_t, easysimd_vqrshrund_n_s64(a, 6));
    uint16_t r8 = HEDLEY_STATIC_CAST(uint16_t, easysimd_vqrshrund_n_s64(a, 8));
    uint16_t r10 = HEDLEY_STATIC_CAST(uint16_t, easysimd_vqrshrund_n_s64(a, 10));
    uint16_t r12 = HEDLEY_STATIC_CAST(uint16_t, easysimd_vqrshrund_n_s64(a, 12));
    uint16_t r16 = HEDLEY_STATIC_CAST(uint16_t, easysimd_vqrshrund_n_s64(a, 16));
    ...
    easysimd_test_codegen_write_u16(2, r8, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_codegen_write_u16(2, r10, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_codegen_write_u16(2, r12, EASYSIMD_TEST_VEC_POS_MIDDLE);
...
EASYSIMD_TEST_FUNC_LIST_ENTRY(vqrshrun_n_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vqrshrun_n_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vqrshrun_n_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vqrshrund_n_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vqrshruns_n_s32)
