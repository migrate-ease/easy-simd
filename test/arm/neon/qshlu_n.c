#define EASYSIMD_TEST_ARM_NEON_INSN qshlu_n

#include "test-neon.h"
#include "../../../easysimd/arm/neon/qshlu_n.h"

HEDLEY_DIAGNOSTIC_PUSH
EASYSIMD_DIAGNOSTIC_DISABLE_UNREACHABLE_

static int
test_easysimd_vqshlu_n_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int8_t a[8];
    const int n;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    EASYSIMD_CONSTIFY_8_(easysimd_vqshlu_n_s8, r, (HEDLEY_UNREACHABLE(), r), test_vec[i].n, a);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_uint8x8_t r;
    EASYSIMD_CONSTIFY_8_(easysimd_vqshlu_n_s8, r, (HEDLEY_UNREACHABLE(), r), n[i], a);

    easysimd_test_arm_neon_write_i8x8(2, a, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_codegen_write_i32(2, n[i], EASYSIMD_TEST_VEC_POS_MIDDLE);
...
static int
test_easysimd_vqshlu_n_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int16_t a[4];
    uint16_t r0[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x4_t r0 = easysimd_vqshlu_n_s16(a, 0);
    easysimd_uint16x4_t r2 = easysimd_vqshlu_n_s16(a, 2);
    easysimd_uint16x4_t r5 = easysimd_vqshlu_n_s16(a, 5);
    easysimd_uint16x4_t r9 = easysimd_vqshlu_n_s16(a, 9);
    easysimd_uint16x4_t r10 = easysimd_vqshlu_n_s16(a, 10);
    easysimd_uint16x4_t r13 = easysimd_vqshlu_n_s16(a, 13);
    easysimd_uint16x4_t r15 = easysimd_vqshlu_n_s16(a, 15);

    easysimd_test_arm_neon_assert_equal_u16x4(r0, easysimd_vld1_u16(test_vec[i].r0));
    easysimd_test_arm_neon_assert_equal_u16x4(r2, easysimd_vld1_u16(test_vec[i].r2));
    easysimd_test_arm_neon_assert_equal_u16x4(r5, easysimd_vld1_u16(test_vec[i].r5));
    easysimd_test_arm_neon_assert_equal_u16x4(r9, easysimd_vld1_u16(test_vec[i].r9));
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_test_arm_neon_write_u16x4(2, r0, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_u16x4(2, r2, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_u16x4(2, r5, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_u16x4(2, r9, EASYSIMD_TEST_VEC_POS_MIDDLE);
    ...
    easysimd_test_arm_neon_write_u16x4(2, r15, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
#endif
}
...
static int
test_easysimd_vqshlu_n_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t a[2];
    uint32_t r0[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x2_t r0 = easysimd_vqshlu_n_s32(a, 0);
    easysimd_uint32x2_t r4 = easysimd_vqshlu_n_s32(a, 4);
    easysimd_uint32x2_t r10 = easysimd_vqshlu_n_s32(a, 10);
    easysimd_uint32x2_t r15 = easysimd_vqshlu_n_s32(a, 15);
    easysimd_uint32x2_t r23 = easysimd_vqshlu_n_s32(a, 23);
    easysimd_uint32x2_t r28 = easysimd_vqshlu_n_s32(a, 28);
    easysimd_uint32x2_t r31 = easysimd_vqshlu_n_s32(a, 31);

    easysimd_test_arm_neon_assert_equal_u32x2(r0, easysimd_vld1_u32(test_vec[i].r0));
    easysimd_test_arm_neon_assert_equal_u32x2(r4, easysimd_vld1_u32(test_vec[i].r4));
    easysimd_test_arm_neon_assert_equal_u32x2(r10, easysimd_vld1_u32(test_vec[i].r10));
    easysimd_test_arm_neon_assert_equal_u32x2(r15, easysimd_vld1_u32(test_vec[i].r15));
    easysimd_test_arm_neon_assert_equal_u32x2(r23, easysimd_vld1_u32(test_vec[i].r23));
    easysimd_test_arm_neon_assert_equal_u32x2(r28, easysimd_vld1_u32(test_vec[i].r28));
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_test_arm_neon_write_u32x2(2, r0, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_u32x2(2, r4, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_u32x2(2, r10, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_u32x2(2, r15, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_u32x2(2, r23, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_u32x2(2, r28, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_u32x2(2, r31, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
#endif
}
...
static int
test_easysimd_vqshlu_n_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int64_t a[1];
    uint64_t r0[1];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint64x1_t r0 = easysimd_vqshlu_n_s64(a, 0);
    easysimd_uint64x1_t r3 = easysimd_vqshlu_n_s64(a, 3);
    easysimd_uint64x1_t r12 = easysimd_vqshlu_n_s64(a, 12);
    easysimd_uint64x1_t r27 = easysimd_vqshlu_n_s64(a, 27);
    easysimd_uint64x1_t r35 = easysimd_vqshlu_n_s64(a, 35);
    easysimd_uint64x1_t r48 = easysimd_vqshlu_n_s64(a, 48);
    easysimd_uint64x1_t r63 = easysimd_vqshlu_n_s64(a, 63);

    easysimd_test_arm_neon_assert_equal_u64x1(r0, easysimd_vld1_u64(test_vec[i].r0));
    easysimd_test_arm_neon_assert_equal_u64x1(r3, easysimd_vld1_u64(test_vec[i].r3));
    easysimd_test_arm_neon_assert_equal_u64x1(r12, easysimd_vld1_u64(test_vec[i].r12));
    easysimd_test_arm_neon_assert_equal_u64x1(r27, easysimd_vld1_u64(test_vec[i].r27));
    easysimd_test_arm_neon_assert_equal_u64x1(r35, easysimd_vld1_u64(test_vec[i].r35));
    easysimd_test_arm_neon_assert_equal_u64x1(r48, easysimd_vld1_u64(test_vec[i].r48));
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_test_arm_neon_write_u64x1(2, r0, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_u64x1(2, r3, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_u64x1(2, r12, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_u64x1(2, r27, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_u64x1(2, r35, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_u64x1(2, r48, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_u64x1(2, r63, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
#endif
}
...
static int
test_easysimd_vqshluq_n_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int8_t a[16];
    const int n;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    EASYSIMD_CONSTIFY_8_(easysimd_vqshluq_n_s8, r, (HEDLEY_UNREACHABLE(), r), test_vec[i].n, a);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_uint8x16_t r;
    EASYSIMD_CONSTIFY_8_(easysimd_vqshluq_n_s8, r, (HEDLEY_UNREACHABLE(), r), n[i], a);
...
static int
test_easysimd_vqshluq_n_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int16_t a[8];
    uint16_t r0[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x8_t r0 = easysimd_vqshluq_n_s16(a, 0);
    easysimd_uint16x8_t r2 = easysimd_vqshluq_n_s16(a, 2);
    easysimd_uint16x8_t r5 = easysimd_vqshluq_n_s16(a, 5);
    easysimd_uint16x8_t r9 = easysimd_vqshluq_n_s16(a, 9);
    easysimd_uint16x8_t r10 = easysimd_vqshluq_n_s16(a, 10);
    easysimd_uint16x8_t r13 = easysimd_vqshluq_n_s16(a, 13);
    easysimd_uint16x8_t r15 = easysimd_vqshluq_n_s16(a, 15);

    easysimd_test_arm_neon_assert_equal_u16x8(r0, easysimd_vld1q_u16(test_vec[i].r0));
    easysimd_test_arm_neon_assert_equal_u16x8(r2, easysimd_vld1q_u16(test_vec[i].r2));
    easysimd_test_arm_neon_assert_equal_u16x8(r5, easysimd_vld1q_u16(test_vec[i].r5));
    easysimd_test_arm_neon_assert_equal_u16x8(r9, easysimd_vld1q_u16(test_vec[i].r9));
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_test_arm_neon_write_u16x8(2, r0, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_u16x8(2, r2, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_u16x8(2, r5, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_u16x8(2, r9, EASYSIMD_TEST_VEC_POS_MIDDLE);
    ...
    easysimd_test_arm_neon_write_u16x8(2, r15, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
#endif
}
...
static int
test_easysimd_vqshluq_n_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t a[4];
    uint32_t r0[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x4_t r0 = easysimd_vqshluq_n_s32(a, 0);
    easysimd_uint32x4_t r4 = easysimd_vqshluq_n_s32(a, 4);
    easysimd_uint32x4_t r10 = easysimd_vqshluq_n_s32(a, 10);
    easysimd_uint32x4_t r15 = easysimd_vqshluq_n_s32(a, 15);
    easysimd_uint32x4_t r23 = easysimd_vqshluq_n_s32(a, 23);
    easysimd_uint32x4_t r28 = easysimd_vqshluq_n_s32(a, 28);
    easysimd_uint32x4_t r31 = easysimd_vqshluq_n_s32(a, 31);

    easysimd_test_arm_neon_assert_equal_u32x4(r0, easysimd_vld1q_u32(test_vec[i].r0));
    easysimd_test_arm_neon_assert_equal_u32x4(r4, easysimd_vld1q_u32(test_vec[i].r4));
    easysimd_test_arm_neon_assert_equal_u32x4(r10, easysimd_vld1q_u32(test_vec[i].r10));
    easysimd_test_arm_neon_assert_equal_u32x4(r15, easysimd_vld1q_u32(test_vec[i].r15));
    easysimd_test_arm_neon_assert_equal_u32x4(r23, easysimd_vld1q_u32(test_vec[i].r23));
    easysimd_test_arm_neon_assert_equal_u32x4(r28, easysimd_vld1q_u32(test_vec[i].r28));
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_test_arm_neon_write_u32x4(2, r0, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_u32x4(2, r4, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_u32x4(2, r10, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_u32x4(2, r15, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_u32x4(2, r23, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_u32x4(2, r28, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_u32x4(2, r31, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
#endif
}
...
static int
test_easysimd_vqshluq_n_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int64_t a[2];
    uint64_t r0[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint64x2_t r0 = easysimd_vqshluq_n_s64(a, 0);
    easysimd_uint64x2_t r3 = easysimd_vqshluq_n_s64(a, 3);
    easysimd_uint64x2_t r12 = easysimd_vqshluq_n_s64(a, 12);
    easysimd_uint64x2_t r27 = easysimd_vqshluq_n_s64(a, 27);
    easysimd_uint64x2_t r35 = easysimd_vqshluq_n_s64(a, 35);
    easysimd_uint64x2_t r48 = easysimd_vqshluq_n_s64(a, 48);
    easysimd_uint64x2_t r63 = easysimd_vqshluq_n_s64(a, 63);

    easysimd_test_arm_neon_assert_equal_u64x2(r0, easysimd_vld1q_u64(test_vec[i].r0));
    easysimd_test_arm_neon_assert_equal_u64x2(r3, easysimd_vld1q_u64(test_vec[i].r3));
    easysimd_test_arm_neon_assert_equal_u64x2(r12, easysimd_vld1q_u64(test_vec[i].r12));
    easysimd_test_arm_neon_assert_equal_u64x2(r27, easysimd_vld1q_u64(test_vec[i].r27));
    easysimd_test_arm_neon_assert_equal_u64x2(r35, easysimd_vld1q_u64(test_vec[i].r35));
    easysimd_test_arm_neon_assert_equal_u64x2(r48, easysimd_vld1q_u64(test_vec[i].r48));
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_test_arm_neon_write_u64x2(2, r0, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_u64x2(2, r3, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_u64x2(2, r12, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_u64x2(2, r27, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_u64x2(2, r35, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_u64x2(2, r48, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_u64x2(2, r63, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
#endif
}
...
EASYSIMD_TEST_FUNC_LIST_ENTRY(vqshlu_n_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vqshlu_n_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vqshlu_n_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vqshlu_n_s64)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vqshluq_n_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vqshluq_n_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vqshluq_n_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vqshluq_n_s64)
