#define EASYSIMD_TEST_ARM_NEON_INSN qshrun_n

#include "test-neon.h"
#include "../../../easysimd/arm/neon/qshrun_n.h"

static int
test_easysimd_vqshrun_n_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int16_t a[8];
    uint8_t r1[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x8_t r1 = easysimd_vqshrun_n_s16(a, 1);
    easysimd_uint8x8_t r3 = easysimd_vqshrun_n_s16(a, 3);
    easysimd_uint8x8_t r5 = easysimd_vqshrun_n_s16(a, 5);
    easysimd_uint8x8_t r6 = easysimd_vqshrun_n_s16(a, 6);
    easysimd_uint8x8_t r8 = easysimd_vqshrun_n_s16(a, 8);
...
static int
test_easysimd_vqshrun_n_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t a[4];
    uint16_t r3[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x4_t r3 = easysimd_vqshrun_n_s32(a, 3);
    easysimd_uint16x4_t r6 = easysimd_vqshrun_n_s32(a, 6);
    easysimd_uint16x4_t r10 = easysimd_vqshrun_n_s32(a, 10);
    easysimd_uint16x4_t r13 = easysimd_vqshrun_n_s32(a, 13);
    easysimd_uint16x4_t r16 = easysimd_vqshrun_n_s32(a, 16);
...
static int
test_easysimd_vqshrun_n_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int64_t a[2];
    uint32_t r6[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x2_t r6 = easysimd_vqshrun_n_s64(a, 6);
    easysimd_uint32x2_t r13 = easysimd_vqshrun_n_s64(a, 13);
    easysimd_uint32x2_t r19 = easysimd_vqshrun_n_s64(a, 19);
    easysimd_uint32x2_t r26 = easysimd_vqshrun_n_s64(a, 26);
    easysimd_uint32x2_t r32 = easysimd_vqshrun_n_s64(a, 32);
...
static int
test_easysimd_vqshruns_n_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t a;
    uint16_t r3;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    uint16_t r3 = easysimd_vqshruns_n_s32(test_vec[i].a, 3);
    uint16_t r6 = easysimd_vqshruns_n_s32(test_vec[i].a, 6);
    uint16_t r10 = easysimd_vqshruns_n_s32(test_vec[i].a, 10);
    uint16_t r13 = easysimd_vqshruns_n_s32(test_vec[i].a, 13);
    uint16_t r16 = easysimd_vqshruns_n_s32(test_vec[i].a, 16);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    uint16_t r3 = easysimd_vqshruns_n_s32(a, 3);
    uint16_t r6 = easysimd_vqshruns_n_s32(a, 6);
    uint16_t r10 = easysimd_vqshruns_n_s32(a, 10);
    uint16_t r13 = easysimd_vqshruns_n_s32(a, 13);
    uint16_t r16 = easysimd_vqshruns_n_s32(a, 16);
...
static int
test_easysimd_vqshrund_n_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int64_t a;
    uint32_t r6;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    uint32_t r6 = easysimd_vqshrund_n_s64(test_vec[i].a, 6);
    uint32_t r13 = easysimd_vqshrund_n_s64(test_vec[i].a, 13);
    uint32_t r19 = easysimd_vqshrund_n_s64(test_vec[i].a, 19);
    uint32_t r26 = easysimd_vqshrund_n_s64(test_vec[i].a, 26);
    uint32_t r32 = easysimd_vqshrund_n_s64(test_vec[i].a, 32);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    uint32_t r6 = easysimd_vqshrund_n_s64(a, 6);
    uint32_t r13 = easysimd_vqshrund_n_s64(a, 13);
    uint32_t r19 = easysimd_vqshrund_n_s64(a, 19);
    uint32_t r26 = easysimd_vqshrund_n_s64(a, 26);
    uint32_t r32 = easysimd_vqshrund_n_s64(a, 32);
...
EASYSIMD_TEST_FUNC_LIST_ENTRY(vqshrun_n_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vqshrun_n_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vqshrun_n_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vqshruns_n_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vqshrund_n_s64)
