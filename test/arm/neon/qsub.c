#define EASYSIMD_TEST_ARM_NEON_INSN qsub

#include "test-neon.h"
#include "../../../easysimd/arm/neon/qsub.h"

static int
test_easysimd_vqsubb_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int8_t a;
    int8_t b;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    int8_t r = easysimd_vqsubb_s8(test_vec[i].a, test_vec[i].b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    int8_t b = easysimd_test_codegen_random_i8();
    int8_t r = easysimd_vqsubb_s8(a, b);
...
static int
test_easysimd_vqsubh_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int16_t a;
    int16_t b;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    int16_t r = easysimd_vqsubh_s16(test_vec[i].a, test_vec[i].b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    int16_t r = easysimd_vqsubh_s16(a, b);
...
static int
test_easysimd_vqsubs_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t a;
    int32_t b;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    int32_t r = easysimd_vqsubs_s32(test_vec[i].a, test_vec[i].b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    int32_t r = easysimd_vqsubs_s32(a, b);
...
static int
test_easysimd_vqsubd_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int64_t a;
    int64_t b;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    int64_t r = easysimd_vqsubd_s64(test_vec[i].a, test_vec[i].b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    int64_t r = easysimd_vqsubd_s64(a, b);
...
static int
test_easysimd_vqsubb_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint8_t a;
    uint8_t b;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    uint8_t r = easysimd_vqsubb_u8(test_vec[i].a, test_vec[i].b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    uint8_t b = easysimd_test_codegen_random_u8();
    uint8_t r = easysimd_vqsubb_u8(a, b);

    easysimd_test_codegen_write_u8(2, a, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_codegen_write_u8(2, b, EASYSIMD_TEST_VEC_POS_MIDDLE);
...
static int
test_easysimd_vqsubh_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint16_t a;
    uint16_t b;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    uint16_t r = easysimd_vqsubh_u16(test_vec[i].a, test_vec[i].b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    uint16_t r = easysimd_vqsubh_u16(a, b);
...
static int
test_easysimd_vqsubs_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint32_t a;
    uint32_t b;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    uint32_t r = easysimd_vqsubs_u32(test_vec[i].a, test_vec[i].b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    uint32_t r = easysimd_vqsubs_u32(a, b);
...
static int
test_easysimd_vqsubd_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint64_t a;
    uint64_t b;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    uint64_t r = easysimd_vqsubd_u64(test_vec[i].a, test_vec[i].b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    uint64_t r = easysimd_vqsubd_u64(a, b);
...
static int
test_easysimd_vqsub_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int8_t a[8];
    int8_t b[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int8x8_t r = easysimd_vqsub_s8(a, b);
...
static int
test_easysimd_vqsub_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int16_t a[4];
    int16_t b[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int16x4_t r = easysimd_vqsub_s16(a, b);
...
static int
test_easysimd_vqsub_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t a[2];
    int32_t b[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x2_t r = easysimd_vqsub_s32(a, b);
...
static int
test_easysimd_vqsub_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int64_t a[1];
    int64_t b[1];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int64x1_t r = easysimd_vqsub_s64(a, b);
...
static int
test_easysimd_vqsub_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint8_t a[8];
    uint8_t b[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x8_t r = easysimd_vqsub_u8(a, b);
...
static int
test_easysimd_vqsub_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint16_t a[4];
    uint16_t b[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x4_t r = easysimd_vqsub_u16(a, b);
...
static int
test_easysimd_vqsub_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint32_t a[2];
    uint32_t b[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x2_t r = easysimd_vqsub_u32(a, b);
...
static int
test_easysimd_vqsub_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint64_t a[1];
    uint64_t b[1];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint64x1_t r = easysimd_vqsub_u64(a, b);
...
static int
test_easysimd_vqsubq_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int8_t a[16];
    int8_t b[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int8x16_t r = easysimd_vqsubq_s8(a, b);
...
static int
test_easysimd_vqsubq_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int16_t a[8];
    int16_t b[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int16x8_t r = easysimd_vqsubq_s16(a, b);
...
static int
test_easysimd_vqsubq_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t a[4];
    int32_t b[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x4_t r = easysimd_vqsubq_s32(a, b);
...
static int
test_easysimd_vqsubq_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int64_t a[2];
    int64_t b[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int64x2_t r = easysimd_vqsubq_s64(a, b);
...
static int
test_easysimd_vqsubq_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint8_t a[16];
    uint8_t b[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x16_t r = easysimd_vqsubq_u8(a, b);
...
static int
test_easysimd_vqsubq_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint16_t a[8];
    uint16_t b[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x8_t r = easysimd_vqsubq_u16(a, b);
...
static int
test_easysimd_vqsubq_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint32_t a[4];
    uint32_t b[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x4_t r = easysimd_vqsubq_u32(a, b);
...
static int
test_easysimd_vqsubq_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint64_t a[2];
    uint64_t b[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint64x2_t r = easysimd_vqsubq_u64(a, b);
...
EASYSIMD_TEST_FUNC_LIST_ENTRY(vqsubb_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vqsubh_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vqsubs_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vqsubd_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vqsubb_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vqsubh_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vqsubs_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vqsubd_u64)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vqsub_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vqsub_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vqsub_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vqsub_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vqsub_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vqsub_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vqsub_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vqsub_u64)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vqsubq_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vqsubq_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vqsubq_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vqsubq_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vqsubq_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vqsubq_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vqsubq_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vqsubq_u64)
