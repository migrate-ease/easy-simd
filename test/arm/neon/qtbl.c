#define EASYSIMD_TEST_ARM_NEON_INSN qtbl

#include "test-neon.h"

/* Check that both of these work */
#if defined(__cplusplus)
  #include "../../../easysimd/arm/neon/qtbl.h"
#else
...
static int
test_easysimd_vqtbl1_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  struct {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int8x8_t r = easysimd_vqtbl1_s8(t, idx);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_int8x8_t r = easysimd_vqtbl1_s8(t, idx);
    easysimd_test_arm_neon_write_i8x16(2, t, EASYSIMD_TEST_VEC_POS_FIRST);
...
static int
test_easysimd_vqtbl1_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  struct {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x8_t idx = easysimd_vld1_u8(test_vec[i].idx);
    easysimd_uint8x8_t r = easysimd_vqtbl1_u8(t, idx);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_test_arm_neon_write_u8x16(2, t, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_arm_neon_write_u8x8(2, idx, EASYSIMD_TEST_VEC_POS_MIDDLE);
...
static int
test_easysimd_vqtbl2_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  struct {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x8_t idx = easysimd_vld1_u8(test_vec[i].idx);
    easysimd_int8x8_t r = easysimd_vqtbl2_s8(t, idx);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_int8x8_t r = easysimd_vqtbl2_s8(t, idx);
    easysimd_test_arm_neon_write_i8x16x2(2, t, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_arm_neon_write_u8x8(2, idx, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_i8x8(2, r, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
...
static int
test_easysimd_vqtbl2_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  struct {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x8_t idx = easysimd_vld1_u8(test_vec[i].idx);
    easysimd_uint8x8_t r = easysimd_vqtbl2_u8(t, idx);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_test_arm_neon_write_u8x16x2(2, t, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_arm_neon_write_u8x8(2, idx, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_u8x8(2, r, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
...
static int
test_easysimd_vqtbl3_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  struct {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x8_t idx = easysimd_vld1_u8(test_vec[i].idx);
    easysimd_int8x8_t r = easysimd_vqtbl3_s8(t, idx);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_int8x8_t r = easysimd_vqtbl3_s8(t, idx);
    easysimd_test_arm_neon_write_i8x16x3(2, t, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_arm_neon_write_u8x8(2, idx, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_i8x8(2, r, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
...
static int
test_easysimd_vqtbl3_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  struct {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x8_t idx = easysimd_vld1_u8(test_vec[i].idx);
    easysimd_uint8x8_t r = easysimd_vqtbl3_u8(t, idx);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_test_arm_neon_write_u8x16x3(2, t, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_arm_neon_write_u8x8(2, idx, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_u8x8(2, r, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
...
static int
test_easysimd_vqtbl4_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  struct {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x8_t idx = easysimd_vld1_u8(test_vec[i].idx);
    easysimd_int8x8_t r = easysimd_vqtbl4_s8(t, idx);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_int8x8_t r = easysimd_vqtbl4_s8(t, idx);
    easysimd_test_arm_neon_write_i8x16x4(2, t, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_arm_neon_write_u8x8(2, idx, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_i8x8(2, r, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
...
static int
test_easysimd_vqtbl4_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  struct {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x8_t idx = easysimd_vld1_u8(test_vec[i].idx);
    easysimd_uint8x8_t r = easysimd_vqtbl4_u8(t, idx);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_test_arm_neon_write_u8x16x4(2, t, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_arm_neon_write_u8x8(2, idx, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_u8x8(2, r, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
...
static int
test_easysimd_vqtbl1q_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  struct {
    EASYSIMD_ALIGN_TO_16 int8_t t[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int8x16_t r = easysimd_vqtbl1q_s8(t, idx);
...
static int
test_easysimd_vqtbl1q_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  struct {
    EASYSIMD_ALIGN_TO_16 uint8_t t[16];
    EASYSIMD_ALIGN_TO_16 uint8_t idx[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint8x16_t t = easysimd_vld1q_u8(test_vec[i].t);
    easysimd_uint8x16_t idx = easysimd_vld1q_u8(test_vec[i].idx);
    easysimd_uint8x16_t r = easysimd_vqtbl1q_u8(t, idx);
...
static int
test_easysimd_vqtbl2q_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  struct {
    EASYSIMD_ALIGN_TO_16 int8_t t[2][16];
    EASYSIMD_ALIGN_TO_16 uint8_t idx[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    t.val[1] = easysimd_vld1q_s8(test_vec[i].t[1]);
    easysimd_uint8x16_t idx = easysimd_vld1q_u8(test_vec[i].idx);
    easysimd_int8x16_t r = easysimd_vqtbl2q_s8(t, idx);
...
static int
test_easysimd_vqtbl2q_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  struct {
    EASYSIMD_ALIGN_TO_16 uint8_t t[2][16];
    EASYSIMD_ALIGN_TO_16 uint8_t idx[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    t.val[1] = easysimd_vld1q_u8(test_vec[i].t[1]);
    easysimd_uint8x16_t idx = easysimd_vld1q_u8(test_vec[i].idx);
    easysimd_uint8x16_t r = easysimd_vqtbl2q_u8(t, idx);
...
static int
test_easysimd_vqtbl3q_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  struct {
    EASYSIMD_ALIGN_TO_16 int8_t t[3][16];
    EASYSIMD_ALIGN_TO_16 uint8_t idx[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    t.val[2] = easysimd_vld1q_s8(test_vec[i].t[2]);
    easysimd_uint8x16_t idx = easysimd_vld1q_u8(test_vec[i].idx);
    easysimd_int8x16_t r = easysimd_vqtbl3q_s8(t, idx);
...
static int
test_easysimd_vqtbl3q_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  struct {
    EASYSIMD_ALIGN_TO_16 uint8_t t[3][16];
    EASYSIMD_ALIGN_TO_16 uint8_t idx[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    t.val[2] = easysimd_vld1q_u8(test_vec[i].t[2]);
    easysimd_uint8x16_t idx = easysimd_vld1q_u8(test_vec[i].idx);
    easysimd_uint8x16_t r = easysimd_vqtbl3q_u8(t, idx);
...
static int
test_easysimd_vqtbl4q_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  struct {
    EASYSIMD_ALIGN_TO_16 int8_t t[4][16];
    EASYSIMD_ALIGN_TO_16 uint8_t idx[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    t.val[3] = easysimd_vld1q_s8(test_vec[i].t[3]);
    easysimd_uint8x16_t idx = easysimd_vld1q_u8(test_vec[i].idx);
    easysimd_int8x16_t r = easysimd_vqtbl4q_s8(t, idx);
...
static int
test_easysimd_vqtbl4q_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  struct {
    EASYSIMD_ALIGN_TO_16 uint8_t t[4][16];
    EASYSIMD_ALIGN_TO_16 uint8_t idx[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    t.val[3] = easysimd_vld1q_u8(test_vec[i].t[3]);
    easysimd_uint8x16_t idx = easysimd_vld1q_u8(test_vec[i].idx);
    easysimd_uint8x16_t r = easysimd_vqtbl4q_u8(t, idx);
...
EASYSIMD_TEST_FUNC_LIST_ENTRY(vqtbl1_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vqtbl1_u8)
#if !defined(EASYSIMD_BUG_INTEL_857088)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(vqtbl2_s8)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(vqtbl2_u8)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(vqtbl3_s8)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(vqtbl3_u8)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(vqtbl4_s8)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(vqtbl4_u8)
#endif /* !defined(EASYSIMD_BUG_INTEL_857088) */

EASYSIMD_TEST_FUNC_LIST_ENTRY(vqtbl1q_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vqtbl1q_u8)
#if !defined(EASYSIMD_BUG_INTEL_857088)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(vqtbl2q_s8)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(vqtbl2q_u8)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(vqtbl3q_s8)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(vqtbl3q_u8)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(vqtbl4q_s8)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(vqtbl4q_u8)
#endif /* !defined(EASYSIMD_BUG_INTEL_857088) */
