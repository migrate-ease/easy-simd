#define EASYSIMD_TEST_ARM_NEON_INSN reinterpret

#include "test-neon.h"
#include "../../../easysimd/arm/neon/reinterpret.h"

static int
test_easysimd_vreinterpret_f32_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int8_t a[8];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_float32x2_t r = easysimd_vreinterpret_f32_s8(a);
    easysimd_float32x2_private r_ = easysimd_float32x2_to_private(r);

    easysimd_assert_equal_i(0, easysimd_memcmp(&r_, &a_, sizeof(r_)));
  }
...
static int
test_easysimd_vreinterpret_f64_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int8_t a[8];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_int8x8_t a = easysimd_vld1_s8(test_vec[i].a);
    easysimd_int8x8_private a_ = easysimd_int8x8_to_private(a);
    easysimd_float64x1_t r = easysimd_vreinterpret_f64_s8(a);
    easysimd_float64x1_private r_ = easysimd_float64x1_to_private(r);
...
static int
test_easysimd_vreinterpret_s16_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int8_t a[8];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_int8x8_t a = easysimd_vld1_s8(test_vec[i].a);
    easysimd_int8x8_private a_ = easysimd_int8x8_to_private(a);
    easysimd_int16x4_t r = easysimd_vreinterpret_s16_s8(a);
    easysimd_int16x4_private r_ = easysimd_int16x4_to_private(r);
...
static int
test_easysimd_vreinterpret_s32_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int8_t a[8];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_int8x8_t a = easysimd_vld1_s8(test_vec[i].a);
    easysimd_int8x8_private a_ = easysimd_int8x8_to_private(a);
    easysimd_int32x2_t r = easysimd_vreinterpret_s32_s8(a);
...
static int
test_easysimd_vreinterpret_s64_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int8_t a[8];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_int8x8_t a = easysimd_vld1_s8(test_vec[i].a);
    easysimd_int8x8_private a_ = easysimd_int8x8_to_private(a);
    easysimd_int64x1_t r = easysimd_vreinterpret_s64_s8(a);
    easysimd_int64x1_private r_ = easysimd_int64x1_to_private(r);
...
static int
test_easysimd_vreinterpret_u8_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int8_t a[8];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_int8x8_t a = easysimd_vld1_s8(test_vec[i].a);
    easysimd_int8x8_private a_ = easysimd_int8x8_to_private(a);
    easysimd_uint8x8_t r = easysimd_vreinterpret_u8_s8(a);
    easysimd_uint8x8_private r_ = easysimd_uint8x8_to_private(r);
...
static int
test_easysimd_vreinterpret_u16_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int8_t a[8];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_int8x8_t a = easysimd_vld1_s8(test_vec[i].a);
    easysimd_int8x8_private a_ = easysimd_int8x8_to_private(a);
    easysimd_uint16x4_t r = easysimd_vreinterpret_u16_s8(a);
    easysimd_uint16x4_private r_ = easysimd_uint16x4_to_private(r);
    easysimd_assert_equal_i(0, easysimd_memcmp(&r_, &a_, sizeof(r_)));
  }
...
static int
test_easysimd_vreinterpret_u32_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int8_t a[8];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_int8x8_t a = easysimd_vld1_s8(test_vec[i].a);
    easysimd_int8x8_private a_ = easysimd_int8x8_to_private(a);
    easysimd_uint32x2_t r = easysimd_vreinterpret_u32_s8(a);
...
static int
test_easysimd_vreinterpret_u64_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int8_t a[8];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_int8x8_t a = easysimd_vld1_s8(test_vec[i].a);
    easysimd_int8x8_private a_ = easysimd_int8x8_to_private(a);
    easysimd_uint64x1_t r = easysimd_vreinterpret_u64_s8(a);
    easysimd_uint64x1_private r_ = easysimd_uint64x1_to_private(r);
    easysimd_assert_equal_i(0, easysimd_memcmp(&r_, &a_, sizeof(r_)));
  }
...
static int
test_easysimd_vreinterpretq_f32_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int8_t a[16];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_float32x4_t r = easysimd_vreinterpretq_f32_s8(a);
    easysimd_float32x4_private r_ = easysimd_float32x4_to_private(r);
    easysimd_assert_equal_i(0, easysimd_memcmp(&r_, &a_, sizeof(r_)));
  }
...
static int
test_easysimd_vreinterpretq_f64_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int8_t a[16];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_int8x16_t a = easysimd_vld1q_s8(test_vec[i].a);
    easysimd_int8x16_private a_ = easysimd_int8x16_to_private(a);
    easysimd_float64x2_t r = easysimd_vreinterpretq_f64_s8(a);
    easysimd_float64x2_private r_ = easysimd_float64x2_to_private(r);
...
static int
test_easysimd_vreinterpretq_s16_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int8_t a[16];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_int8x16_t a = easysimd_vld1q_s8(test_vec[i].a);
    easysimd_int8x16_private a_ = easysimd_int8x16_to_private(a);
    easysimd_int16x8_t r = easysimd_vreinterpretq_s16_s8(a);
    easysimd_int16x8_private r_ = easysimd_int16x8_to_private(r);
...
static int
test_easysimd_vreinterpretq_s32_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int8_t a[16];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_int8x16_t a = easysimd_vld1q_s8(test_vec[i].a);
    easysimd_int8x16_private a_ = easysimd_int8x16_to_private(a);
    easysimd_int32x4_t r = easysimd_vreinterpretq_s32_s8(a);
...
static int
test_easysimd_vreinterpretq_s64_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int8_t a[16];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_int8x16_t a = easysimd_vld1q_s8(test_vec[i].a);
    easysimd_int8x16_private a_ = easysimd_int8x16_to_private(a);
    easysimd_int64x2_t r = easysimd_vreinterpretq_s64_s8(a);
    easysimd_int64x2_private r_ = easysimd_int64x2_to_private(r);
    easysimd_assert_equal_i(0, easysimd_memcmp(&r_, &a_, sizeof(r_)));
  }
...
static int
test_easysimd_vreinterpretq_u8_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int8_t a[16];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_int8x16_t a = easysimd_vld1q_s8(test_vec[i].a);
    easysimd_int8x16_private a_ = easysimd_int8x16_to_private(a);
    easysimd_uint8x16_t r = easysimd_vreinterpretq_u8_s8(a);
    easysimd_uint8x16_private r_ = easysimd_uint8x16_to_private(r);
...
static int
test_easysimd_vreinterpretq_u16_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int8_t a[16];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_int8x16_t a = easysimd_vld1q_s8(test_vec[i].a);
    easysimd_int8x16_private a_ = easysimd_int8x16_to_private(a);
    easysimd_uint16x8_t r = easysimd_vreinterpretq_u16_s8(a);
    easysimd_uint16x8_private r_ = easysimd_uint16x8_to_private(r);
    easysimd_assert_equal_i(0, easysimd_memcmp(&r_, &a_, sizeof(r_)));
  }
...
static int
test_easysimd_vreinterpretq_u32_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int8_t a[16];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_int8x16_t a = easysimd_vld1q_s8(test_vec[i].a);
    easysimd_int8x16_private a_ = easysimd_int8x16_to_private(a);
    easysimd_uint32x4_t r = easysimd_vreinterpretq_u32_s8(a);
...
static int
test_easysimd_vreinterpretq_u64_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int8_t a[16];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_int8x16_t a = easysimd_vld1q_s8(test_vec[i].a);
    easysimd_int8x16_private a_ = easysimd_int8x16_to_private(a);
    easysimd_uint64x2_t r = easysimd_vreinterpretq_u64_s8(a);
    easysimd_uint64x2_private r_ = easysimd_uint64x2_to_private(r);
    easysimd_assert_equal_i(0, easysimd_memcmp(&r_, &a_, sizeof(r_)));
  }
...
static int
test_easysimd_vreinterpret_f32_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int16_t a[4];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_float32x2_t r = easysimd_vreinterpret_f32_s16(a);
    easysimd_float32x2_private r_ = easysimd_float32x2_to_private(r);
...
static int
test_easysimd_vreinterpret_f64_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int16_t a[4];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_int16x4_t a = easysimd_vld1_s16(test_vec[i].a);
    easysimd_int16x4_private a_ = easysimd_int16x4_to_private(a);
    easysimd_float64x1_t r = easysimd_vreinterpret_f64_s16(a);
    easysimd_float64x1_private r_ = easysimd_float64x1_to_private(r);
...
static int
test_easysimd_vreinterpret_s8_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int16_t a[4];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_int16x4_t a = easysimd_vld1_s16(test_vec[i].a);
    easysimd_int16x4_private a_ = easysimd_int16x4_to_private(a);
    easysimd_int8x8_t r = easysimd_vreinterpret_s8_s16(a);
    easysimd_int8x8_private r_ = easysimd_int8x8_to_private(r);
...
static int
test_easysimd_vreinterpret_s32_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int16_t a[4];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_int16x4_t a = easysimd_vld1_s16(test_vec[i].a);
    easysimd_int16x4_private a_ = easysimd_int16x4_to_private(a);
    easysimd_int32x2_t r = easysimd_vreinterpret_s32_s16(a);
    easysimd_int32x2_private r_ = easysimd_int32x2_to_private(r);
...
static int
test_easysimd_vreinterpret_s64_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int16_t a[4];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_int16x4_t a = easysimd_vld1_s16(test_vec[i].a);
    easysimd_int16x4_private a_ = easysimd_int16x4_to_private(a);
    easysimd_int64x1_t r = easysimd_vreinterpret_s64_s16(a);
    easysimd_int64x1_private r_ = easysimd_int64x1_to_private(r);
...
static int
test_easysimd_vreinterpret_u8_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int16_t a[4];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_int16x4_t a = easysimd_vld1_s16(test_vec[i].a);
    easysimd_int16x4_private a_ = easysimd_int16x4_to_private(a);
    easysimd_uint8x8_t r = easysimd_vreinterpret_u8_s16(a);
    easysimd_uint8x8_private r_ = easysimd_uint8x8_to_private(r);
...
static int
test_easysimd_vreinterpret_u16_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int16_t a[4];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_int16x4_t a = easysimd_vld1_s16(test_vec[i].a);
    easysimd_int16x4_private a_ = easysimd_int16x4_to_private(a);
    easysimd_uint16x4_t r = easysimd_vreinterpret_u16_s16(a);
    easysimd_uint16x4_private r_ = easysimd_uint16x4_to_private(r);
    easysimd_assert_equal_i(0, easysimd_memcmp(&r_, &a_, sizeof(r_)));
  }
...
static int
test_easysimd_vreinterpret_u32_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int16_t a[4];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_int16x4_t a = easysimd_vld1_s16(test_vec[i].a);
    easysimd_int16x4_private a_ = easysimd_int16x4_to_private(a);
    easysimd_uint32x2_t r = easysimd_vreinterpret_u32_s16(a);
    easysimd_uint32x2_private r_ = easysimd_uint32x2_to_private(r);
    easysimd_assert_equal_i(0, easysimd_memcmp(&r_, &a_, sizeof(r_)));
  }
...
static int
test_easysimd_vreinterpret_u64_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int16_t a[4];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_int16x4_t a = easysimd_vld1_s16(test_vec[i].a);
    easysimd_int16x4_private a_ = easysimd_int16x4_to_private(a);
    easysimd_uint64x1_t r = easysimd_vreinterpret_u64_s16(a);
    easysimd_uint64x1_private r_ = easysimd_uint64x1_to_private(r);
    easysimd_assert_equal_i(0, easysimd_memcmp(&r_, &a_, sizeof(r_)));
  }
...
static int
test_easysimd_vreinterpretq_f32_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int16_t a[8];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_float32x4_t r = easysimd_vreinterpretq_f32_s16(a);
    easysimd_float32x4_private r_ = easysimd_float32x4_to_private(r);
    easysimd_assert_equal_i(0, easysimd_memcmp(&r_, &a_, sizeof(r_)));
  }
...
static int
test_easysimd_vreinterpretq_f64_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int16_t a[8];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_int16x8_t a = easysimd_vld1q_s16(test_vec[i].a);
    easysimd_int16x8_private a_ = easysimd_int16x8_to_private(a);
    easysimd_float64x2_t r = easysimd_vreinterpretq_f64_s16(a);
    easysimd_float64x2_private r_ = easysimd_float64x2_to_private(r);
...
static int
test_easysimd_vreinterpretq_s8_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int16_t a[8];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_int16x8_t a = easysimd_vld1q_s16(test_vec[i].a);
    easysimd_int16x8_private a_ = easysimd_int16x8_to_private(a);
    easysimd_int8x16_t r = easysimd_vreinterpretq_s8_s16(a);
    easysimd_int8x16_private r_ = easysimd_int8x16_to_private(r);
...
static int
test_easysimd_vreinterpretq_s32_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int16_t a[8];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_int16x8_t a = easysimd_vld1q_s16(test_vec[i].a);
    easysimd_int16x8_private a_ = easysimd_int16x8_to_private(a);
    easysimd_int32x4_t r = easysimd_vreinterpretq_s32_s16(a);
    easysimd_int32x4_private r_ = easysimd_int32x4_to_private(r);
    easysimd_assert_equal_i(0, easysimd_memcmp(&r_, &a_, sizeof(r_)));
  }
...
static int
test_easysimd_vreinterpretq_s64_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int16_t a[8];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_int16x8_t a = easysimd_vld1q_s16(test_vec[i].a);
    easysimd_int16x8_private a_ = easysimd_int16x8_to_private(a);
    easysimd_int64x2_t r = easysimd_vreinterpretq_s64_s16(a);
    easysimd_int64x2_private r_ = easysimd_int64x2_to_private(r);
    easysimd_assert_equal_i(0, easysimd_memcmp(&r_, &a_, sizeof(r_)));
  }
...
static int
test_easysimd_vreinterpretq_u8_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int16_t a[8];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_int16x8_t a = easysimd_vld1q_s16(test_vec[i].a);
    easysimd_int16x8_private a_ = easysimd_int16x8_to_private(a);
    easysimd_uint8x16_t r = easysimd_vreinterpretq_u8_s16(a);
    easysimd_uint8x16_private r_ = easysimd_uint8x16_to_private(r);
...
static int
test_easysimd_vreinterpretq_u16_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int16_t a[8];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_int16x8_t a = easysimd_vld1q_s16(test_vec[i].a);
    easysimd_int16x8_private a_ = easysimd_int16x8_to_private(a);
    easysimd_uint16x8_t r = easysimd_vreinterpretq_u16_s16(a);
    easysimd_uint16x8_private r_ = easysimd_uint16x8_to_private(r);
    easysimd_assert_equal_i(0, easysimd_memcmp(&r_, &a_, sizeof(r_)));
  }
...
static int
test_easysimd_vreinterpretq_u32_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int16_t a[8];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_int16x8_t a = easysimd_vld1q_s16(test_vec[i].a);
    easysimd_int16x8_private a_ = easysimd_int16x8_to_private(a);
    easysimd_uint32x4_t r = easysimd_vreinterpretq_u32_s16(a);
    easysimd_uint32x4_private r_ = easysimd_uint32x4_to_private(r);
...
static int
test_easysimd_vreinterpretq_u64_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int16_t a[8];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_int16x8_t a = easysimd_vld1q_s16(test_vec[i].a);
    easysimd_int16x8_private a_ = easysimd_int16x8_to_private(a);
    easysimd_uint64x2_t r = easysimd_vreinterpretq_u64_s16(a);
    easysimd_uint64x2_private r_ = easysimd_uint64x2_to_private(r);
    easysimd_assert_equal_i(0, easysimd_memcmp(&r_, &a_, sizeof(r_)));
  }
...
static int
test_easysimd_vreinterpret_f32_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int32_t a[2];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_float32x2_t r = easysimd_vreinterpret_f32_s32(a);
    easysimd_float32x2_private r_ = easysimd_float32x2_to_private(r);
...
static int
test_easysimd_vreinterpret_f64_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int32_t a[2];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_int32x2_t a = easysimd_vld1_s32(test_vec[i].a);
    easysimd_int32x2_private a_ = easysimd_int32x2_to_private(a);
    easysimd_float64x1_t r = easysimd_vreinterpret_f64_s32(a);
    easysimd_float64x1_private r_ = easysimd_float64x1_to_private(r);
...
static int
test_easysimd_vreinterpret_s8_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int32_t a[2];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_int32x2_t a = easysimd_vld1_s32(test_vec[i].a);
    easysimd_int32x2_private a_ = easysimd_int32x2_to_private(a);
    easysimd_int8x8_t r = easysimd_vreinterpret_s8_s32(a);
    easysimd_int8x8_private r_ = easysimd_int8x8_to_private(r);
...
static int
test_easysimd_vreinterpret_s16_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int32_t a[2];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_int32x2_t a = easysimd_vld1_s32(test_vec[i].a);
    easysimd_int32x2_private a_ = easysimd_int32x2_to_private(a);
    easysimd_int16x4_t r = easysimd_vreinterpret_s16_s32(a);
    easysimd_int16x4_private r_ = easysimd_int16x4_to_private(r);
...
static int
test_easysimd_vreinterpret_s64_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int32_t a[2];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_int32x2_t a = easysimd_vld1_s32(test_vec[i].a);
    easysimd_int32x2_private a_ = easysimd_int32x2_to_private(a);
    easysimd_int64x1_t r = easysimd_vreinterpret_s64_s32(a);
    easysimd_int64x1_private r_ = easysimd_int64x1_to_private(r);
...
static int
test_easysimd_vreinterpret_u8_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int32_t a[2];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_int32x2_t a = easysimd_vld1_s32(test_vec[i].a);
    easysimd_int32x2_private a_ = easysimd_int32x2_to_private(a);
    easysimd_uint8x8_t r = easysimd_vreinterpret_u8_s32(a);
    easysimd_uint8x8_private r_ = easysimd_uint8x8_to_private(r);
...
static int
test_easysimd_vreinterpret_u16_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int32_t a[2];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_int32x2_t a = easysimd_vld1_s32(test_vec[i].a);
    easysimd_int32x2_private a_ = easysimd_int32x2_to_private(a);
    easysimd_uint16x4_t r = easysimd_vreinterpret_u16_s32(a);
    easysimd_uint16x4_private r_ = easysimd_uint16x4_to_private(r);
    easysimd_assert_equal_i(0, easysimd_memcmp(&r_, &a_, sizeof(r_)));
  }
...
static int
test_easysimd_vreinterpret_u32_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int32_t a[2];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_int32x2_t a = easysimd_vld1_s32(test_vec[i].a);
    easysimd_int32x2_private a_ = easysimd_int32x2_to_private(a);
    easysimd_uint32x2_t r = easysimd_vreinterpret_u32_s32(a);
    easysimd_uint32x2_private r_ = easysimd_uint32x2_to_private(r);
    easysimd_assert_equal_i(0, easysimd_memcmp(&r_, &a_, sizeof(r_)));
  }
...
static int
test_easysimd_vreinterpret_u64_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int32_t a[2];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_int32x2_t a = easysimd_vld1_s32(test_vec[i].a);
    easysimd_int32x2_private a_ = easysimd_int32x2_to_private(a);
    easysimd_uint64x1_t r = easysimd_vreinterpret_u64_s32(a);
    easysimd_uint64x1_private r_ = easysimd_uint64x1_to_private(r);
    easysimd_assert_equal_i(0, easysimd_memcmp(&r_, &a_, sizeof(r_)));
  }
...
static int
test_easysimd_vreinterpretq_f32_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int32_t a[4];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_float32x4_t r = easysimd_vreinterpretq_f32_s32(a);
    easysimd_float32x4_private r_ = easysimd_float32x4_to_private(r);
    easysimd_assert_equal_i(0, easysimd_memcmp(&r_, &a_, sizeof(r_)));
  }
...
static int
test_easysimd_vreinterpretq_f64_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int32_t a[4];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_int32x4_t a = easysimd_vld1q_s32(test_vec[i].a);
    easysimd_int32x4_private a_ = easysimd_int32x4_to_private(a);
    easysimd_float64x2_t r = easysimd_vreinterpretq_f64_s32(a);
    easysimd_float64x2_private r_ = easysimd_float64x2_to_private(r);
...
static int
test_easysimd_vreinterpretq_s8_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int32_t a[4];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_int32x4_t a = easysimd_vld1q_s32(test_vec[i].a);
    easysimd_int32x4_private a_ = easysimd_int32x4_to_private(a);
    easysimd_int8x16_t r = easysimd_vreinterpretq_s8_s32(a);
    easysimd_int8x16_private r_ = easysimd_int8x16_to_private(r);
...
static int
test_easysimd_vreinterpretq_s16_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int32_t a[4];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_int32x4_t a = easysimd_vld1q_s32(test_vec[i].a);
    easysimd_int32x4_private a_ = easysimd_int32x4_to_private(a);
    easysimd_int16x8_t r = easysimd_vreinterpretq_s16_s32(a);
    easysimd_int16x8_private r_ = easysimd_int16x8_to_private(r);
...
static int
test_easysimd_vreinterpretq_s64_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int32_t a[4];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_int32x4_t a = easysimd_vld1q_s32(test_vec[i].a);
    easysimd_int32x4_private a_ = easysimd_int32x4_to_private(a);
    easysimd_int64x2_t r = easysimd_vreinterpretq_s64_s32(a);
    easysimd_int64x2_private r_ = easysimd_int64x2_to_private(r);
    easysimd_assert_equal_i(0, easysimd_memcmp(&r_, &a_, sizeof(r_)));
  }
...
static int
test_easysimd_vreinterpretq_u8_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int32_t a[4];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_int32x4_t a = easysimd_vld1q_s32(test_vec[i].a);
    easysimd_int32x4_private a_ = easysimd_int32x4_to_private(a);
    easysimd_uint8x16_t r = easysimd_vreinterpretq_u8_s32(a);
    easysimd_uint8x16_private r_ = easysimd_uint8x16_to_private(r);
...
static int
test_easysimd_vreinterpretq_u16_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int32_t a[4];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_int32x4_t a = easysimd_vld1q_s32(test_vec[i].a);
    easysimd_int32x4_private a_ = easysimd_int32x4_to_private(a);
    easysimd_uint16x8_t r = easysimd_vreinterpretq_u16_s32(a);
    easysimd_uint16x8_private r_ = easysimd_uint16x8_to_private(r);
    easysimd_assert_equal_i(0, easysimd_memcmp(&r_, &a_, sizeof(r_)));
  }
...
static int
test_easysimd_vreinterpretq_u32_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int32_t a[4];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_int32x4_t a = easysimd_vld1q_s32(test_vec[i].a);
    easysimd_int32x4_private a_ = easysimd_int32x4_to_private(a);
    easysimd_uint32x4_t r = easysimd_vreinterpretq_u32_s32(a);
    easysimd_uint32x4_private r_ = easysimd_uint32x4_to_private(r);
...
static int
test_easysimd_vreinterpretq_u64_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int32_t a[4];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_int32x4_t a = easysimd_vld1q_s32(test_vec[i].a);
    easysimd_int32x4_private a_ = easysimd_int32x4_to_private(a);
    easysimd_uint64x2_t r = easysimd_vreinterpretq_u64_s32(a);
    easysimd_uint64x2_private r_ = easysimd_uint64x2_to_private(r);
    easysimd_assert_equal_i(0, easysimd_memcmp(&r_, &a_, sizeof(r_)));
  }
...
static int
test_easysimd_vreinterpret_f32_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int64_t a[1];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_float32x2_t r = easysimd_vreinterpret_f32_s64(a);
    easysimd_float32x2_private r_ = easysimd_float32x2_to_private(r);
...
static int
test_easysimd_vreinterpret_f64_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int64_t a[1];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_int64x1_t a = easysimd_vld1_s64(test_vec[i].a);
    easysimd_int64x1_private a_ = easysimd_int64x1_to_private(a);
    easysimd_float64x1_t r = easysimd_vreinterpret_f64_s64(a);
    easysimd_float64x1_private r_ = easysimd_float64x1_to_private(r);
...
static int
test_easysimd_vreinterpret_s8_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int64_t a[1];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_int64x1_t a = easysimd_vld1_s64(test_vec[i].a);
    easysimd_int64x1_private a_ = easysimd_int64x1_to_private(a);
    easysimd_int8x8_t r = easysimd_vreinterpret_s8_s64(a);
    easysimd_int8x8_private r_ = easysimd_int8x8_to_private(r);
...
static int
test_easysimd_vreinterpret_s16_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int64_t a[1];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_int64x1_t a = easysimd_vld1_s64(test_vec[i].a);
    easysimd_int64x1_private a_ = easysimd_int64x1_to_private(a);
    easysimd_int16x4_t r = easysimd_vreinterpret_s16_s64(a);
    easysimd_int16x4_private r_ = easysimd_int16x4_to_private(r);
...
static int
test_easysimd_vreinterpret_s32_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int64_t a[1];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_int64x1_t a = easysimd_vld1_s64(test_vec[i].a);
    easysimd_int64x1_private a_ = easysimd_int64x1_to_private(a);
    easysimd_int32x2_t r = easysimd_vreinterpret_s32_s64(a);
    easysimd_int32x2_private r_ = easysimd_int32x2_to_private(r);
...
static int
test_easysimd_vreinterpret_u8_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int64_t a[1];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_int64x1_t a = easysimd_vld1_s64(test_vec[i].a);
    easysimd_int64x1_private a_ = easysimd_int64x1_to_private(a);
    easysimd_uint8x8_t r = easysimd_vreinterpret_u8_s64(a);
    easysimd_uint8x8_private r_ = easysimd_uint8x8_to_private(r);
...
static int
test_easysimd_vreinterpret_u16_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int64_t a[1];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_int64x1_t a = easysimd_vld1_s64(test_vec[i].a);
    easysimd_int64x1_private a_ = easysimd_int64x1_to_private(a);
    easysimd_uint16x4_t r = easysimd_vreinterpret_u16_s64(a);
    easysimd_uint16x4_private r_ = easysimd_uint16x4_to_private(r);
    easysimd_assert_equal_i(0, easysimd_memcmp(&r_, &a_, sizeof(r_)));
  }
...
static int
test_easysimd_vreinterpret_u32_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int64_t a[1];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_int64x1_t a = easysimd_vld1_s64(test_vec[i].a);
    easysimd_int64x1_private a_ = easysimd_int64x1_to_private(a);
    easysimd_uint32x2_t r = easysimd_vreinterpret_u32_s64(a);
    easysimd_uint32x2_private r_ = easysimd_uint32x2_to_private(r);
    easysimd_assert_equal_i(0, easysimd_memcmp(&r_, &a_, sizeof(r_)));
  }
...
static int
test_easysimd_vreinterpret_u64_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int64_t a[1];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_int64x1_t a = easysimd_vld1_s64(test_vec[i].a);
    easysimd_int64x1_private a_ = easysimd_int64x1_to_private(a);
    easysimd_uint64x1_t r = easysimd_vreinterpret_u64_s64(a);
    easysimd_uint64x1_private r_ = easysimd_uint64x1_to_private(r);
    easysimd_assert_equal_i(0, easysimd_memcmp(&r_, &a_, sizeof(r_)));
  }
...
static int
test_easysimd_vreinterpretq_f32_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int64_t a[2];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_float32x4_t r = easysimd_vreinterpretq_f32_s64(a);
    easysimd_float32x4_private r_ = easysimd_float32x4_to_private(r);
    easysimd_assert_equal_i(0, easysimd_memcmp(&r_, &a_, sizeof(r_)));
  }
...
static int
test_easysimd_vreinterpretq_f64_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int64_t a[2];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_int64x2_t a = easysimd_vld1q_s64(test_vec[i].a);
    easysimd_int64x2_private a_ = easysimd_int64x2_to_private(a);
    easysimd_float64x2_t r = easysimd_vreinterpretq_f64_s64(a);
    easysimd_float64x2_private r_ = easysimd_float64x2_to_private(r);
...
static int
test_easysimd_vreinterpretq_s8_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int64_t a[2];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_int64x2_t a = easysimd_vld1q_s64(test_vec[i].a);
    easysimd_int64x2_private a_ = easysimd_int64x2_to_private(a);
    easysimd_int8x16_t r = easysimd_vreinterpretq_s8_s64(a);
    easysimd_int8x16_private r_ = easysimd_int8x16_to_private(r);
...
static int
test_easysimd_vreinterpretq_s16_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int64_t a[2];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_int64x2_t a = easysimd_vld1q_s64(test_vec[i].a);
    easysimd_int64x2_private a_ = easysimd_int64x2_to_private(a);
    easysimd_int16x8_t r = easysimd_vreinterpretq_s16_s64(a);
    easysimd_int16x8_private r_ = easysimd_int16x8_to_private(r);
...
static int
test_easysimd_vreinterpretq_s32_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int64_t a[2];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_int64x2_t a = easysimd_vld1q_s64(test_vec[i].a);
    easysimd_int64x2_private a_ = easysimd_int64x2_to_private(a);
    easysimd_int32x4_t r = easysimd_vreinterpretq_s32_s64(a);
    easysimd_int32x4_private r_ = easysimd_int32x4_to_private(r);
    easysimd_assert_equal_i(0, easysimd_memcmp(&r_, &a_, sizeof(r_)));
  }
...
static int
test_easysimd_vreinterpretq_u8_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int64_t a[2];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_int64x2_t a = easysimd_vld1q_s64(test_vec[i].a);
    easysimd_int64x2_private a_ = easysimd_int64x2_to_private(a);
    easysimd_uint8x16_t r = easysimd_vreinterpretq_u8_s64(a);
    easysimd_uint8x16_private r_ = easysimd_uint8x16_to_private(r);
...
static int
test_easysimd_vreinterpretq_u16_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int64_t a[2];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_int64x2_t a = easysimd_vld1q_s64(test_vec[i].a);
    easysimd_int64x2_private a_ = easysimd_int64x2_to_private(a);
    easysimd_uint16x8_t r = easysimd_vreinterpretq_u16_s64(a);
    easysimd_uint16x8_private r_ = easysimd_uint16x8_to_private(r);
    easysimd_assert_equal_i(0, easysimd_memcmp(&r_, &a_, sizeof(r_)));
  }
...
static int
test_easysimd_vreinterpretq_u32_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int64_t a[2];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_int64x2_t a = easysimd_vld1q_s64(test_vec[i].a);
    easysimd_int64x2_private a_ = easysimd_int64x2_to_private(a);
    easysimd_uint32x4_t r = easysimd_vreinterpretq_u32_s64(a);
    easysimd_uint32x4_private r_ = easysimd_uint32x4_to_private(r);
...
static int
test_easysimd_vreinterpretq_u64_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int64_t a[2];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_int64x2_t a = easysimd_vld1q_s64(test_vec[i].a);
    easysimd_int64x2_private a_ = easysimd_int64x2_to_private(a);
    easysimd_uint64x2_t r = easysimd_vreinterpretq_u64_s64(a);
    easysimd_uint64x2_private r_ = easysimd_uint64x2_to_private(r);
    easysimd_assert_equal_i(0, easysimd_memcmp(&r_, &a_, sizeof(r_)));
  }
...
static int
test_easysimd_vreinterpret_f32_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint8_t a[8];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_float32x2_t r = easysimd_vreinterpret_f32_u8(a);
    easysimd_float32x2_private r_ = easysimd_float32x2_to_private(r);
...
static int
test_easysimd_vreinterpret_f64_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint8_t a[8];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint8x8_t a = easysimd_vld1_u8(test_vec[i].a);
    easysimd_uint8x8_private a_ = easysimd_uint8x8_to_private(a);
    easysimd_float64x1_t r = easysimd_vreinterpret_f64_u8(a);
    easysimd_float64x1_private r_ = easysimd_float64x1_to_private(r);
...
static int
test_easysimd_vreinterpret_s8_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint8_t a[8];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint8x8_t a = easysimd_vld1_u8(test_vec[i].a);
    easysimd_uint8x8_private a_ = easysimd_uint8x8_to_private(a);
    easysimd_int8x8_t r = easysimd_vreinterpret_s8_u8(a);
    easysimd_int8x8_private r_ = easysimd_int8x8_to_private(r);
...
static int
test_easysimd_vreinterpret_s16_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint8_t a[8];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint8x8_t a = easysimd_vld1_u8(test_vec[i].a);
    easysimd_uint8x8_private a_ = easysimd_uint8x8_to_private(a);
    easysimd_int16x4_t r = easysimd_vreinterpret_s16_u8(a);
    easysimd_int16x4_private r_ = easysimd_int16x4_to_private(r);
...
static int
test_easysimd_vreinterpret_s32_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint8_t a[8];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint8x8_t a = easysimd_vld1_u8(test_vec[i].a);
    easysimd_uint8x8_private a_ = easysimd_uint8x8_to_private(a);
    easysimd_int32x2_t r = easysimd_vreinterpret_s32_u8(a);
    easysimd_int32x2_private r_ = easysimd_int32x2_to_private(r);
...
static int
test_easysimd_vreinterpret_s64_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint8_t a[8];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint8x8_t a = easysimd_vld1_u8(test_vec[i].a);
    easysimd_uint8x8_private a_ = easysimd_uint8x8_to_private(a);
    easysimd_int64x1_t r = easysimd_vreinterpret_s64_u8(a);
    easysimd_int64x1_private r_ = easysimd_int64x1_to_private(r);
...
static int
test_easysimd_vreinterpret_u16_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint8_t a[8];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint8x8_t a = easysimd_vld1_u8(test_vec[i].a);
    easysimd_uint8x8_private a_ = easysimd_uint8x8_to_private(a);
    easysimd_uint16x4_t r = easysimd_vreinterpret_u16_u8(a);
    easysimd_uint16x4_private r_ = easysimd_uint16x4_to_private(r);
    easysimd_assert_equal_i(0, easysimd_memcmp(&r_, &a_, sizeof(r_)));
  }
...
static int
test_easysimd_vreinterpret_u32_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint8_t a[8];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint8x8_t a = easysimd_vld1_u8(test_vec[i].a);
    easysimd_uint8x8_private a_ = easysimd_uint8x8_to_private(a);
    easysimd_uint32x2_t r = easysimd_vreinterpret_u32_u8(a);
    easysimd_uint32x2_private r_ = easysimd_uint32x2_to_private(r);
    easysimd_assert_equal_i(0, easysimd_memcmp(&r_, &a_, sizeof(r_)));
  }
...
static int
test_easysimd_vreinterpret_u64_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint8_t a[8];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint8x8_t a = easysimd_vld1_u8(test_vec[i].a);
    easysimd_uint8x8_private a_ = easysimd_uint8x8_to_private(a);
    easysimd_uint64x1_t r = easysimd_vreinterpret_u64_u8(a);
    easysimd_uint64x1_private r_ = easysimd_uint64x1_to_private(r);
    easysimd_assert_equal_i(0, easysimd_memcmp(&r_, &a_, sizeof(r_)));
  }
...
static int
test_easysimd_vreinterpretq_f32_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint8_t a[16];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_float32x4_t r = easysimd_vreinterpretq_f32_u8(a);
    easysimd_float32x4_private r_ = easysimd_float32x4_to_private(r);
    easysimd_assert_equal_i(0, easysimd_memcmp(&r_, &a_, sizeof(r_)));
  }
...
static int
test_easysimd_vreinterpretq_f64_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint8_t a[16];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint8x16_t a = easysimd_vld1q_u8(test_vec[i].a);
    easysimd_uint8x16_private a_ = easysimd_uint8x16_to_private(a);
    easysimd_float64x2_t r = easysimd_vreinterpretq_f64_u8(a);
    easysimd_float64x2_private r_ = easysimd_float64x2_to_private(r);
...
static int
test_easysimd_vreinterpretq_s8_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint8_t a[16];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint8x16_t a = easysimd_vld1q_u8(test_vec[i].a);
    easysimd_uint8x16_private a_ = easysimd_uint8x16_to_private(a);
    easysimd_int8x16_t r = easysimd_vreinterpretq_s8_u8(a);
    easysimd_int8x16_private r_ = easysimd_int8x16_to_private(r);
...
static int
test_easysimd_vreinterpretq_s16_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint8_t a[16];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint8x16_t a = easysimd_vld1q_u8(test_vec[i].a);
    easysimd_uint8x16_private a_ = easysimd_uint8x16_to_private(a);
    easysimd_int16x8_t r = easysimd_vreinterpretq_s16_u8(a);
    easysimd_int16x8_private r_ = easysimd_int16x8_to_private(r);
...
static int
test_easysimd_vreinterpretq_s32_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint8_t a[16];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint8x16_t a = easysimd_vld1q_u8(test_vec[i].a);
    easysimd_uint8x16_private a_ = easysimd_uint8x16_to_private(a);
    easysimd_int32x4_t r = easysimd_vreinterpretq_s32_u8(a);
    easysimd_int32x4_private r_ = easysimd_int32x4_to_private(r);
    easysimd_assert_equal_i(0, easysimd_memcmp(&r_, &a_, sizeof(r_)));
  }
...
static int
test_easysimd_vreinterpretq_s64_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint8_t a[16];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint8x16_t a = easysimd_vld1q_u8(test_vec[i].a);
    easysimd_uint8x16_private a_ = easysimd_uint8x16_to_private(a);
    easysimd_int64x2_t r = easysimd_vreinterpretq_s64_u8(a);
    easysimd_int64x2_private r_ = easysimd_int64x2_to_private(r);
    easysimd_assert_equal_i(0, easysimd_memcmp(&r_, &a_, sizeof(r_)));
  }
...
static int
test_easysimd_vreinterpretq_u16_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint8_t a[16];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint8x16_t a = easysimd_vld1q_u8(test_vec[i].a);
    easysimd_uint8x16_private a_ = easysimd_uint8x16_to_private(a);
    easysimd_uint16x8_t r = easysimd_vreinterpretq_u16_u8(a);
    easysimd_uint16x8_private r_ = easysimd_uint16x8_to_private(r);
    easysimd_assert_equal_i(0, easysimd_memcmp(&r_, &a_, sizeof(r_)));
  }
...
static int
test_easysimd_vreinterpretq_u32_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint8_t a[16];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint8x16_t a = easysimd_vld1q_u8(test_vec[i].a);
    easysimd_uint8x16_private a_ = easysimd_uint8x16_to_private(a);
    easysimd_uint32x4_t r = easysimd_vreinterpretq_u32_u8(a);
    easysimd_uint32x4_private r_ = easysimd_uint32x4_to_private(r);
...
static int
test_easysimd_vreinterpretq_u64_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint8_t a[16];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint8x16_t a = easysimd_vld1q_u8(test_vec[i].a);
    easysimd_uint8x16_private a_ = easysimd_uint8x16_to_private(a);
    easysimd_uint64x2_t r = easysimd_vreinterpretq_u64_u8(a);
    easysimd_uint64x2_private r_ = easysimd_uint64x2_to_private(r);
    easysimd_assert_equal_i(0, easysimd_memcmp(&r_, &a_, sizeof(r_)));
  }
...
static int
test_easysimd_vreinterpret_f32_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint16_t a[4];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_float32x2_t r = easysimd_vreinterpret_f32_u16(a);
    easysimd_float32x2_private r_ = easysimd_float32x2_to_private(r);
...
static int
test_easysimd_vreinterpret_f64_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint16_t a[4];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint16x4_t a = easysimd_vld1_u16(test_vec[i].a);
    easysimd_uint16x4_private a_ = easysimd_uint16x4_to_private(a);
    easysimd_float64x1_t r = easysimd_vreinterpret_f64_u16(a);
    easysimd_float64x1_private r_ = easysimd_float64x1_to_private(r);
...
static int
test_easysimd_vreinterpret_s8_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint16_t a[4];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint16x4_t a = easysimd_vld1_u16(test_vec[i].a);
    easysimd_uint16x4_private a_ = easysimd_uint16x4_to_private(a);
    easysimd_int8x8_t r = easysimd_vreinterpret_s8_u16(a);
    easysimd_int8x8_private r_ = easysimd_int8x8_to_private(r);
...
static int
test_easysimd_vreinterpret_s16_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint16_t a[4];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint16x4_t a = easysimd_vld1_u16(test_vec[i].a);
    easysimd_uint16x4_private a_ = easysimd_uint16x4_to_private(a);
    easysimd_int16x4_t r = easysimd_vreinterpret_s16_u16(a);
    easysimd_int16x4_private r_ = easysimd_int16x4_to_private(r);
...
static int
test_easysimd_vreinterpret_s32_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint16_t a[4];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint16x4_t a = easysimd_vld1_u16(test_vec[i].a);
    easysimd_uint16x4_private a_ = easysimd_uint16x4_to_private(a);
    easysimd_int32x2_t r = easysimd_vreinterpret_s32_u16(a);
    easysimd_int32x2_private r_ = easysimd_int32x2_to_private(r);
...
static int
test_easysimd_vreinterpret_s64_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint16_t a[4];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint16x4_t a = easysimd_vld1_u16(test_vec[i].a);
    easysimd_uint16x4_private a_ = easysimd_uint16x4_to_private(a);
    easysimd_int64x1_t r = easysimd_vreinterpret_s64_u16(a);
    easysimd_int64x1_private r_ = easysimd_int64x1_to_private(r);
...
static int
test_easysimd_vreinterpret_u8_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint16_t a[4];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint16x4_t a = easysimd_vld1_u16(test_vec[i].a);
    easysimd_uint16x4_private a_ = easysimd_uint16x4_to_private(a);
    easysimd_uint8x8_t r = easysimd_vreinterpret_u8_u16(a);
    easysimd_uint8x8_private r_ = easysimd_uint8x8_to_private(r);
...
static int
test_easysimd_vreinterpret_u32_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint16_t a[4];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint16x4_t a = easysimd_vld1_u16(test_vec[i].a);
    easysimd_uint16x4_private a_ = easysimd_uint16x4_to_private(a);
    easysimd_uint32x2_t r = easysimd_vreinterpret_u32_u16(a);
    easysimd_uint32x2_private r_ = easysimd_uint32x2_to_private(r);
    easysimd_assert_equal_i(0, easysimd_memcmp(&r_, &a_, sizeof(r_)));
  }
...
static int
test_easysimd_vreinterpret_u64_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint16_t a[4];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint16x4_t a = easysimd_vld1_u16(test_vec[i].a);
    easysimd_uint16x4_private a_ = easysimd_uint16x4_to_private(a);
    easysimd_uint64x1_t r = easysimd_vreinterpret_u64_u16(a);
    easysimd_uint64x1_private r_ = easysimd_uint64x1_to_private(r);
    easysimd_assert_equal_i(0, easysimd_memcmp(&r_, &a_, sizeof(r_)));
  }
...
static int
test_easysimd_vreinterpretq_f32_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint16_t a[8];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_float32x4_t r = easysimd_vreinterpretq_f32_u16(a);
    easysimd_float32x4_private r_ = easysimd_float32x4_to_private(r);
    easysimd_assert_equal_i(0, easysimd_memcmp(&r_, &a_, sizeof(r_)));
  }
...
static int
test_easysimd_vreinterpretq_f64_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint16_t a[8];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint16x8_t a = easysimd_vld1q_u16(test_vec[i].a);
    easysimd_uint16x8_private a_ = easysimd_uint16x8_to_private(a);
    easysimd_float64x2_t r = easysimd_vreinterpretq_f64_u16(a);
    easysimd_float64x2_private r_ = easysimd_float64x2_to_private(r);
...
static int
test_easysimd_vreinterpretq_s8_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint16_t a[8];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint16x8_t a = easysimd_vld1q_u16(test_vec[i].a);
    easysimd_uint16x8_private a_ = easysimd_uint16x8_to_private(a);
    easysimd_int8x16_t r = easysimd_vreinterpretq_s8_u16(a);
    easysimd_int8x16_private r_ = easysimd_int8x16_to_private(r);
...
static int
test_easysimd_vreinterpretq_s16_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint16_t a[8];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint16x8_t a = easysimd_vld1q_u16(test_vec[i].a);
    easysimd_uint16x8_private a_ = easysimd_uint16x8_to_private(a);
    easysimd_int16x8_t r = easysimd_vreinterpretq_s16_u16(a);
    easysimd_int16x8_private r_ = easysimd_int16x8_to_private(r);
...
static int
test_easysimd_vreinterpretq_s32_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint16_t a[8];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint16x8_t a = easysimd_vld1q_u16(test_vec[i].a);
    easysimd_uint16x8_private a_ = easysimd_uint16x8_to_private(a);
    easysimd_int32x4_t r = easysimd_vreinterpretq_s32_u16(a);
    easysimd_int32x4_private r_ = easysimd_int32x4_to_private(r);
    easysimd_assert_equal_i(0, easysimd_memcmp(&r_, &a_, sizeof(r_)));
  }
...
static int
test_easysimd_vreinterpretq_s64_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint16_t a[8];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint16x8_t a = easysimd_vld1q_u16(test_vec[i].a);
    easysimd_uint16x8_private a_ = easysimd_uint16x8_to_private(a);
    easysimd_int64x2_t r = easysimd_vreinterpretq_s64_u16(a);
    easysimd_int64x2_private r_ = easysimd_int64x2_to_private(r);
    easysimd_assert_equal_i(0, easysimd_memcmp(&r_, &a_, sizeof(r_)));
  }
...
static int
test_easysimd_vreinterpretq_u8_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint16_t a[8];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint16x8_t a = easysimd_vld1q_u16(test_vec[i].a);
    easysimd_uint16x8_private a_ = easysimd_uint16x8_to_private(a);
    easysimd_uint8x16_t r = easysimd_vreinterpretq_u8_u16(a);
    easysimd_uint8x16_private r_ = easysimd_uint8x16_to_private(r);
...
static int
test_easysimd_vreinterpretq_u32_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint16_t a[8];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint16x8_t a = easysimd_vld1q_u16(test_vec[i].a);
    easysimd_uint16x8_private a_ = easysimd_uint16x8_to_private(a);
    easysimd_uint32x4_t r = easysimd_vreinterpretq_u32_u16(a);
    easysimd_uint32x4_private r_ = easysimd_uint32x4_to_private(r);
...
static int
test_easysimd_vreinterpretq_u64_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint16_t a[8];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint16x8_t a = easysimd_vld1q_u16(test_vec[i].a);
    easysimd_uint16x8_private a_ = easysimd_uint16x8_to_private(a);
    easysimd_uint64x2_t r = easysimd_vreinterpretq_u64_u16(a);
    easysimd_uint64x2_private r_ = easysimd_uint64x2_to_private(r);
    easysimd_assert_equal_i(0, easysimd_memcmp(&r_, &a_, sizeof(r_)));
  }
...
static int
test_easysimd_vreinterpret_f16_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint16_t a[4];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint16x4_t a = easysimd_vld1_u16(test_vec[i].a);
    easysimd_uint16x4_private a_ = easysimd_uint16x4_to_private(a);
    easysimd_float16x4_t r = easysimd_vreinterpret_f16_u16(a);
    easysimd_float16x4_private r_ = easysimd_float16x4_to_private(r);
...
static int
test_easysimd_vreinterpret_f32_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint32_t a[2];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_float32x2_t r = easysimd_vreinterpret_f32_u32(a);
    easysimd_float32x2_private r_ = easysimd_float32x2_to_private(r);
...
static int
test_easysimd_vreinterpret_f64_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint32_t a[2];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint32x2_t a = easysimd_vld1_u32(test_vec[i].a);
    easysimd_uint32x2_private a_ = easysimd_uint32x2_to_private(a);
    easysimd_float64x1_t r = easysimd_vreinterpret_f64_u32(a);
    easysimd_float64x1_private r_ = easysimd_float64x1_to_private(r);
...
static int
test_easysimd_vreinterpret_s8_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint32_t a[2];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint32x2_t a = easysimd_vld1_u32(test_vec[i].a);
    easysimd_uint32x2_private a_ = easysimd_uint32x2_to_private(a);
    easysimd_int8x8_t r = easysimd_vreinterpret_s8_u32(a);
    easysimd_int8x8_private r_ = easysimd_int8x8_to_private(r);
...
static int
test_easysimd_vreinterpret_s16_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint32_t a[2];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint32x2_t a = easysimd_vld1_u32(test_vec[i].a);
    easysimd_uint32x2_private a_ = easysimd_uint32x2_to_private(a);
    easysimd_int16x4_t r = easysimd_vreinterpret_s16_u32(a);
    easysimd_int16x4_private r_ = easysimd_int16x4_to_private(r);
...
static int
test_easysimd_vreinterpret_s32_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint32_t a[2];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint32x2_t a = easysimd_vld1_u32(test_vec[i].a);
    easysimd_uint32x2_private a_ = easysimd_uint32x2_to_private(a);
    easysimd_int32x2_t r = easysimd_vreinterpret_s32_u32(a);
    easysimd_int32x2_private r_ = easysimd_int32x2_to_private(r);
...
static int
test_easysimd_vreinterpret_s64_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint32_t a[2];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint32x2_t a = easysimd_vld1_u32(test_vec[i].a);
    easysimd_uint32x2_private a_ = easysimd_uint32x2_to_private(a);
    easysimd_int64x1_t r = easysimd_vreinterpret_s64_u32(a);
    easysimd_int64x1_private r_ = easysimd_int64x1_to_private(r);
...
static int
test_easysimd_vreinterpret_u8_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint32_t a[2];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint32x2_t a = easysimd_vld1_u32(test_vec[i].a);
    easysimd_uint32x2_private a_ = easysimd_uint32x2_to_private(a);
    easysimd_uint8x8_t r = easysimd_vreinterpret_u8_u32(a);
    easysimd_uint8x8_private r_ = easysimd_uint8x8_to_private(r);
...
static int
test_easysimd_vreinterpret_u16_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint32_t a[2];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint32x2_t a = easysimd_vld1_u32(test_vec[i].a);
    easysimd_uint32x2_private a_ = easysimd_uint32x2_to_private(a);
    easysimd_uint16x4_t r = easysimd_vreinterpret_u16_u32(a);
    easysimd_uint16x4_private r_ = easysimd_uint16x4_to_private(r);
    easysimd_assert_equal_i(0, easysimd_memcmp(&r_, &a_, sizeof(r_)));
  }
...
static int
test_easysimd_vreinterpret_u64_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint32_t a[2];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint32x2_t a = easysimd_vld1_u32(test_vec[i].a);
    easysimd_uint32x2_private a_ = easysimd_uint32x2_to_private(a);
    easysimd_uint64x1_t r = easysimd_vreinterpret_u64_u32(a);
    easysimd_uint64x1_private r_ = easysimd_uint64x1_to_private(r);
    easysimd_assert_equal_i(0, easysimd_memcmp(&r_, &a_, sizeof(r_)));
  }
...
static int
test_easysimd_vreinterpretq_f16_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint16_t a[8];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint16x8_t a = easysimd_vld1q_u16(test_vec[i].a);
    easysimd_uint16x8_private a_ = easysimd_uint16x8_to_private(a);
    easysimd_float16x8_t r = easysimd_vreinterpretq_f16_u16(a);
    easysimd_float16x8_private r_ = easysimd_float16x8_to_private(r);
...
static int
test_easysimd_vreinterpretq_f32_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint32_t a[4];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_float32x4_t r = easysimd_vreinterpretq_f32_u32(a);
    easysimd_float32x4_private r_ = easysimd_float32x4_to_private(r);
    easysimd_assert_equal_i(0, easysimd_memcmp(&r_, &a_, sizeof(r_)));
  }
...
static int
test_easysimd_vreinterpretq_f64_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint32_t a[4];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint32x4_t a = easysimd_vld1q_u32(test_vec[i].a);
    easysimd_uint32x4_private a_ = easysimd_uint32x4_to_private(a);
    easysimd_float64x2_t r = easysimd_vreinterpretq_f64_u32(a);
    easysimd_float64x2_private r_ = easysimd_float64x2_to_private(r);
...
static int
test_easysimd_vreinterpretq_s8_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint32_t a[4];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint32x4_t a = easysimd_vld1q_u32(test_vec[i].a);
    easysimd_uint32x4_private a_ = easysimd_uint32x4_to_private(a);
    easysimd_int8x16_t r = easysimd_vreinterpretq_s8_u32(a);
    easysimd_int8x16_private r_ = easysimd_int8x16_to_private(r);
...
static int
test_easysimd_vreinterpretq_s16_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint32_t a[4];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint32x4_t a = easysimd_vld1q_u32(test_vec[i].a);
    easysimd_uint32x4_private a_ = easysimd_uint32x4_to_private(a);
    easysimd_int16x8_t r = easysimd_vreinterpretq_s16_u32(a);
    easysimd_int16x8_private r_ = easysimd_int16x8_to_private(r);
...
static int
test_easysimd_vreinterpretq_s32_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint32_t a[4];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint32x4_t a = easysimd_vld1q_u32(test_vec[i].a);
    easysimd_uint32x4_private a_ = easysimd_uint32x4_to_private(a);
    easysimd_int32x4_t r = easysimd_vreinterpretq_s32_u32(a);
    easysimd_int32x4_private r_ = easysimd_int32x4_to_private(r);
    easysimd_assert_equal_i(0, easysimd_memcmp(&r_, &a_, sizeof(r_)));
  }
...
static int
test_easysimd_vreinterpretq_s64_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint32_t a[4];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint32x4_t a = easysimd_vld1q_u32(test_vec[i].a);
    easysimd_uint32x4_private a_ = easysimd_uint32x4_to_private(a);
    easysimd_int64x2_t r = easysimd_vreinterpretq_s64_u32(a);
    easysimd_int64x2_private r_ = easysimd_int64x2_to_private(r);
    easysimd_assert_equal_i(0, easysimd_memcmp(&r_, &a_, sizeof(r_)));
  }
...
static int
test_easysimd_vreinterpretq_u8_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint32_t a[4];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint32x4_t a = easysimd_vld1q_u32(test_vec[i].a);
    easysimd_uint32x4_private a_ = easysimd_uint32x4_to_private(a);
    easysimd_uint8x16_t r = easysimd_vreinterpretq_u8_u32(a);
    easysimd_uint8x16_private r_ = easysimd_uint8x16_to_private(r);
...
static int
test_easysimd_vreinterpretq_u16_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint32_t a[4];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint32x4_t a = easysimd_vld1q_u32(test_vec[i].a);
    easysimd_uint32x4_private a_ = easysimd_uint32x4_to_private(a);
    easysimd_uint16x8_t r = easysimd_vreinterpretq_u16_u32(a);
    easysimd_uint16x8_private r_ = easysimd_uint16x8_to_private(r);
    easysimd_assert_equal_i(0, easysimd_memcmp(&r_, &a_, sizeof(r_)));
  }
...
static int
test_easysimd_vreinterpretq_u64_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint32_t a[4];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint32x4_t a = easysimd_vld1q_u32(test_vec[i].a);
    easysimd_uint32x4_private a_ = easysimd_uint32x4_to_private(a);
    easysimd_uint64x2_t r = easysimd_vreinterpretq_u64_u32(a);
    easysimd_uint64x2_private r_ = easysimd_uint64x2_to_private(r);
    easysimd_assert_equal_i(0, easysimd_memcmp(&r_, &a_, sizeof(r_)));
  }
...
static int
test_easysimd_vreinterpret_f32_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint64_t a[1];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_float32x2_t r = easysimd_vreinterpret_f32_u64(a);
    easysimd_float32x2_private r_ = easysimd_float32x2_to_private(r);
...
static int
test_easysimd_vreinterpret_f64_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint64_t a[1];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint64x1_t a = easysimd_vld1_u64(test_vec[i].a);
    easysimd_uint64x1_private a_ = easysimd_uint64x1_to_private(a);
    easysimd_float64x1_t r = easysimd_vreinterpret_f64_u64(a);
    easysimd_float64x1_private r_ = easysimd_float64x1_to_private(r);
...
static int
test_easysimd_vreinterpret_s8_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint64_t a[1];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint64x1_t a = easysimd_vld1_u64(test_vec[i].a);
    easysimd_uint64x1_private a_ = easysimd_uint64x1_to_private(a);
    easysimd_int8x8_t r = easysimd_vreinterpret_s8_u64(a);
    easysimd_int8x8_private r_ = easysimd_int8x8_to_private(r);
...
static int
test_easysimd_vreinterpret_s16_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint64_t a[1];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint64x1_t a = easysimd_vld1_u64(test_vec[i].a);
    easysimd_uint64x1_private a_ = easysimd_uint64x1_to_private(a);
    easysimd_int16x4_t r = easysimd_vreinterpret_s16_u64(a);
    easysimd_int16x4_private r_ = easysimd_int16x4_to_private(r);
...
static int
test_easysimd_vreinterpret_s32_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint64_t a[1];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint64x1_t a = easysimd_vld1_u64(test_vec[i].a);
    easysimd_uint64x1_private a_ = easysimd_uint64x1_to_private(a);
    easysimd_int32x2_t r = easysimd_vreinterpret_s32_u64(a);
    easysimd_int32x2_private r_ = easysimd_int32x2_to_private(r);
...
static int
test_easysimd_vreinterpret_s64_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint64_t a[1];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint64x1_t a = easysimd_vld1_u64(test_vec[i].a);
    easysimd_uint64x1_private a_ = easysimd_uint64x1_to_private(a);
    easysimd_int64x1_t r = easysimd_vreinterpret_s64_u64(a);
    easysimd_int64x1_private r_ = easysimd_int64x1_to_private(r);
...
static int
test_easysimd_vreinterpret_u8_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint64_t a[1];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint64x1_t a = easysimd_vld1_u64(test_vec[i].a);
    easysimd_uint64x1_private a_ = easysimd_uint64x1_to_private(a);
    easysimd_uint8x8_t r = easysimd_vreinterpret_u8_u64(a);
    easysimd_uint8x8_private r_ = easysimd_uint8x8_to_private(r);
...
static int
test_easysimd_vreinterpret_u16_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint64_t a[1];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint64x1_t a = easysimd_vld1_u64(test_vec[i].a);
    easysimd_uint64x1_private a_ = easysimd_uint64x1_to_private(a);
    easysimd_uint16x4_t r = easysimd_vreinterpret_u16_u64(a);
    easysimd_uint16x4_private r_ = easysimd_uint16x4_to_private(r);
    easysimd_assert_equal_i(0, easysimd_memcmp(&r_, &a_, sizeof(r_)));
  }
...
static int
test_easysimd_vreinterpret_u32_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint64_t a[1];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint64x1_t a = easysimd_vld1_u64(test_vec[i].a);
    easysimd_uint64x1_private a_ = easysimd_uint64x1_to_private(a);
    easysimd_uint32x2_t r = easysimd_vreinterpret_u32_u64(a);
    easysimd_uint32x2_private r_ = easysimd_uint32x2_to_private(r);
    easysimd_assert_equal_i(0, easysimd_memcmp(&r_, &a_, sizeof(r_)));
  }
...
static int
test_easysimd_vreinterpretq_f32_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint64_t a[2];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_float32x4_t r = easysimd_vreinterpretq_f32_u64(a);
    easysimd_float32x4_private r_ = easysimd_float32x4_to_private(r);
    easysimd_assert_equal_i(0, easysimd_memcmp(&r_, &a_, sizeof(r_)));
  }
...
static int
test_easysimd_vreinterpretq_f64_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint64_t a[2];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint64x2_t a = easysimd_vld1q_u64(test_vec[i].a);
    easysimd_uint64x2_private a_ = easysimd_uint64x2_to_private(a);
    easysimd_float64x2_t r = easysimd_vreinterpretq_f64_u64(a);
    easysimd_float64x2_private r_ = easysimd_float64x2_to_private(r);
...
static int
test_easysimd_vreinterpretq_s8_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint64_t a[2];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint64x2_t a = easysimd_vld1q_u64(test_vec[i].a);
    easysimd_uint64x2_private a_ = easysimd_uint64x2_to_private(a);
    easysimd_int8x16_t r = easysimd_vreinterpretq_s8_u64(a);
    easysimd_int8x16_private r_ = easysimd_int8x16_to_private(r);
...
static int
test_easysimd_vreinterpretq_s16_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint64_t a[2];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint64x2_t a = easysimd_vld1q_u64(test_vec[i].a);
    easysimd_uint64x2_private a_ = easysimd_uint64x2_to_private(a);
    easysimd_int16x8_t r = easysimd_vreinterpretq_s16_u64(a);
    easysimd_int16x8_private r_ = easysimd_int16x8_to_private(r);
...
static int
test_easysimd_vreinterpretq_s32_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint64_t a[2];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint64x2_t a = easysimd_vld1q_u64(test_vec[i].a);
    easysimd_uint64x2_private a_ = easysimd_uint64x2_to_private(a);
    easysimd_int32x4_t r = easysimd_vreinterpretq_s32_u64(a);
    easysimd_int32x4_private r_ = easysimd_int32x4_to_private(r);
    easysimd_assert_equal_i(0, easysimd_memcmp(&r_, &a_, sizeof(r_)));
  }
...
static int
test_easysimd_vreinterpretq_s64_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint64_t a[2];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint64x2_t a = easysimd_vld1q_u64(test_vec[i].a);
    easysimd_uint64x2_private a_ = easysimd_uint64x2_to_private(a);
    easysimd_int64x2_t r = easysimd_vreinterpretq_s64_u64(a);
    easysimd_int64x2_private r_ = easysimd_int64x2_to_private(r);
    easysimd_assert_equal_i(0, easysimd_memcmp(&r_, &a_, sizeof(r_)));
  }
...
static int
test_easysimd_vreinterpretq_u8_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint64_t a[2];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint64x2_t a = easysimd_vld1q_u64(test_vec[i].a);
    easysimd_uint64x2_private a_ = easysimd_uint64x2_to_private(a);
    easysimd_uint8x16_t r = easysimd_vreinterpretq_u8_u64(a);
    easysimd_uint8x16_private r_ = easysimd_uint8x16_to_private(r);
...
static int
test_easysimd_vreinterpretq_u16_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint64_t a[2];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint64x2_t a = easysimd_vld1q_u64(test_vec[i].a);
    easysimd_uint64x2_private a_ = easysimd_uint64x2_to_private(a);
    easysimd_uint16x8_t r = easysimd_vreinterpretq_u16_u64(a);
    easysimd_uint16x8_private r_ = easysimd_uint16x8_to_private(r);
    easysimd_assert_equal_i(0, easysimd_memcmp(&r_, &a_, sizeof(r_)));
  }
...
static int
test_easysimd_vreinterpretq_u32_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint64_t a[2];
  } test_vec[] = {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint64x2_t a = easysimd_vld1q_u64(test_vec[i].a);
    easysimd_uint64x2_private a_ = easysimd_uint64x2_to_private(a);
    easysimd_uint32x4_t r = easysimd_vreinterpretq_u32_u64(a);
    easysimd_uint32x4_private r_ = easysimd_uint32x4_to_private(r);
...
static int
test_easysimd_vreinterpret_f64_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    easysimd_float32 a[2];
  } test_vec[] = {
    { { EASYSIMD_FLOAT32_C(   640.27), EASYSIMD_FLOAT32_C(  -585.88) },
 },
    { { EASYSIMD_FLOAT32_C(   495.02), EASYSIMD_FLOAT32_C(  -454.59) },
 },
    { { EASYSIMD_FLOAT32_C(  -794.50), EASYSIMD_FLOAT32_C(  -757.76) },
 },
    { { EASYSIMD_FLOAT32_C(  -987.01), EASYSIMD_FLOAT32_C(  -967.63) },
 },
    { { EASYSIMD_FLOAT32_C(   776.12), EASYSIMD_FLOAT32_C(  -392.25) },
 },
    { { EASYSIMD_FLOAT32_C(   488.06), EASYSIMD_FLOAT32_C(  -965.22) },
 },
    { { EASYSIMD_FLOAT32_C(  -118.01), EASYSIMD_FLOAT32_C(    15.16) },
 },
    { { EASYSIMD_FLOAT32_C(  -392.02), EASYSIMD_FLOAT32_C(    26.20) },
 },
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_float64x1_t r = easysimd_vreinterpret_f64_f32(a);
    easysimd_float64x1_private r_ = easysimd_float64x1_to_private(r);
...
static int
test_easysimd_vreinterpret_s8_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    easysimd_float32 a[2];
  } test_vec[] = {
    { { EASYSIMD_FLOAT32_C(  -587.63), EASYSIMD_FLOAT32_C(   585.48) },
 },
    { { EASYSIMD_FLOAT32_C(  -661.12), EASYSIMD_FLOAT32_C(  -256.06) },
 },
    { { EASYSIMD_FLOAT32_C(   118.35), EASYSIMD_FLOAT32_C(   805.41) },
 },
    { { EASYSIMD_FLOAT32_C(   505.78), EASYSIMD_FLOAT32_C(  -965.54) },
 },
    { { EASYSIMD_FLOAT32_C(  -758.58), EASYSIMD_FLOAT32_C(   899.30) },
 },
    { { EASYSIMD_FLOAT32_C(  -523.55), EASYSIMD_FLOAT32_C(   -97.39) },
 },
    { { EASYSIMD_FLOAT32_C(  -615.32), EASYSIMD_FLOAT32_C(  -397.40) },
 },
    { { EASYSIMD_FLOAT32_C(  -120.59), EASYSIMD_FLOAT32_C(   913.00) },
 },
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float32x2_t a = easysimd_vld1_f32(test_vec[i].a);
    easysimd_float32x2_private a_ = easysimd_float32x2_to_private(a);
    easysimd_int8x8_t r = easysimd_vreinterpret_s8_f32(a);
    easysimd_int8x8_private r_ = easysimd_int8x8_to_private(r);
...
static int
test_easysimd_vreinterpret_s16_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    easysimd_float32 a[2];
  } test_vec[] = {
    { { EASYSIMD_FLOAT32_C(   965.56), EASYSIMD_FLOAT32_C(   406.80) },
 },
    { { EASYSIMD_FLOAT32_C(  -967.05), EASYSIMD_FLOAT32_C(  -359.28) },
 },
    { { EASYSIMD_FLOAT32_C(   -12.20), EASYSIMD_FLOAT32_C(   830.53) },
 },
    { { EASYSIMD_FLOAT32_C(  -617.07), EASYSIMD_FLOAT32_C(   419.80) },
 },
    { { EASYSIMD_FLOAT32_C(  -178.92), EASYSIMD_FLOAT32_C(   378.69) },
 },
    { { EASYSIMD_FLOAT32_C(   707.86), EASYSIMD_FLOAT32_C(   990.09) },
 },
    { { EASYSIMD_FLOAT32_C(    19.78), EASYSIMD_FLOAT32_C(  -485.54) },
 },
    { { EASYSIMD_FLOAT32_C(     4.31), EASYSIMD_FLOAT32_C(    85.98) },
 },
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float32x2_t a = easysimd_vld1_f32(test_vec[i].a);
    easysimd_float32x2_private a_ = easysimd_float32x2_to_private(a);
    easysimd_int16x4_t r = easysimd_vreinterpret_s16_f32(a);
    easysimd_int16x4_private r_ = easysimd_int16x4_to_private(r);
...
static int
test_easysimd_vreinterpret_s32_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    easysimd_float32 a[2];
  } test_vec[] = {
    { { EASYSIMD_FLOAT32_C(   795.77), EASYSIMD_FLOAT32_C(   550.43) },
 },
    { { EASYSIMD_FLOAT32_C(   -83.89), EASYSIMD_FLOAT32_C(   973.87) },
 },
    { { EASYSIMD_FLOAT32_C(   261.17), EASYSIMD_FLOAT32_C(   160.88) },
 },
    { { EASYSIMD_FLOAT32_C(  -625.84), EASYSIMD_FLOAT32_C(   282.41) },
 },
    { { EASYSIMD_FLOAT32_C(   796.67), EASYSIMD_FLOAT32_C(  -170.27) },
 },
    { { EASYSIMD_FLOAT32_C(   520.80), EASYSIMD_FLOAT32_C(   944.18) },
 },
    { { EASYSIMD_FLOAT32_C(   -80.46), EASYSIMD_FLOAT32_C(   719.27) },
 },
    { { EASYSIMD_FLOAT32_C(   319.33), EASYSIMD_FLOAT32_C(  -849.20) },
 },
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float32x2_t a = easysimd_vld1_f32(test_vec[i].a);
    easysimd_float32x2_private a_ = easysimd_float32x2_to_private(a);
    easysimd_int32x2_t r = easysimd_vreinterpret_s32_f32(a);
    easysimd_int32x2_private r_ = easysimd_int32x2_to_private(r);
...
static int
test_easysimd_vreinterpret_s64_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    easysimd_float32 a[2];
  } test_vec[] = {
    { { EASYSIMD_FLOAT32_C(   516.10), EASYSIMD_FLOAT32_C(  -198.61) },
 },
    { { EASYSIMD_FLOAT32_C(  -669.75), EASYSIMD_FLOAT32_C(  -733.34) },
 },
    { { EASYSIMD_FLOAT32_C(    -1.26), EASYSIMD_FLOAT32_C(   -21.15) },
 },
    { { EASYSIMD_FLOAT32_C(   991.35), EASYSIMD_FLOAT32_C(   -65.88) },
 },
    { { EASYSIMD_FLOAT32_C(   207.04), EASYSIMD_FLOAT32_C(  -249.79) },
 },
    { { EASYSIMD_FLOAT32_C(  -595.20), EASYSIMD_FLOAT32_C(   987.70) },
 },
    { { EASYSIMD_FLOAT32_C(  -316.55), EASYSIMD_FLOAT32_C(   458.49) },
 },
    { { EASYSIMD_FLOAT32_C(   515.32), EASYSIMD_FLOAT32_C(  -268.29) },
 },
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float32x2_t a = easysimd_vld1_f32(test_vec[i].a);
    easysimd_float32x2_private a_ = easysimd_float32x2_to_private(a);
    easysimd_int64x1_t r = easysimd_vreinterpret_s64_f32(a);
    easysimd_int64x1_private r_ = easysimd_int64x1_to_private(r);
...
static int
test_easysimd_vreinterpret_u8_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    easysimd_float32 a[2];
  } test_vec[] = {
    { { EASYSIMD_FLOAT32_C(  -703.61), EASYSIMD_FLOAT32_C(  -199.03) },
 },
    { { EASYSIMD_FLOAT32_C(  -275.51), EASYSIMD_FLOAT32_C(  -704.61) },
 },
    { { EASYSIMD_FLOAT32_C(   166.82), EASYSIMD_FLOAT32_C(    78.78) },
 },
    { { EASYSIMD_FLOAT32_C(   393.16), EASYSIMD_FLOAT32_C(   135.85) },
 },
    { { EASYSIMD_FLOAT32_C(  -375.89), EASYSIMD_FLOAT32_C(  -388.41) },
 },
    { { EASYSIMD_FLOAT32_C(   975.54), EASYSIMD_FLOAT32_C(    66.77) },
 },
    { { EASYSIMD_FLOAT32_C(  -130.34), EASYSIMD_FLOAT32_C(  -425.75) },
 },
    { { EASYSIMD_FLOAT32_C(    31.57), EASYSIMD_FLOAT32_C(   530.63) },
 },
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float32x2_t a = easysimd_vld1_f32(test_vec[i].a);
    easysimd_float32x2_private a_ = easysimd_float32x2_to_private(a);
    easysimd_uint8x8_t r = easysimd_vreinterpret_u8_f32(a);
    easysimd_uint8x8_private r_ = easysimd_uint8x8_to_private(r);
...
static int
test_easysimd_vreinterpret_u16_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    easysimd_float32 a[2];
  } test_vec[] = {
    { { EASYSIMD_FLOAT32_C(   679.90), EASYSIMD_FLOAT32_C(   888.01) },
 },
    { { EASYSIMD_FLOAT32_C(   262.65), EASYSIMD_FLOAT32_C(   704.41) },
 },
    { { EASYSIMD_FLOAT32_C(  -705.92), EASYSIMD_FLOAT32_C(  -576.78) },
 },
    { { EASYSIMD_FLOAT32_C(   514.37), EASYSIMD_FLOAT32_C(  -767.53) },
 },
    { { EASYSIMD_FLOAT32_C(   476.11), EASYSIMD_FLOAT32_C(  -765.14) },
 },
    { { EASYSIMD_FLOAT32_C(   623.02), EASYSIMD_FLOAT32_C(  -915.78) },
 },
    { { EASYSIMD_FLOAT32_C(  -765.19), EASYSIMD_FLOAT32_C(  -713.01) },
 },
    { { EASYSIMD_FLOAT32_C(   118.88), EASYSIMD_FLOAT32_C(   271.57) },
 },
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float32x2_t a = easysimd_vld1_f32(test_vec[i].a);
    easysimd_float32x2_private a_ = easysimd_float32x2_to_private(a);
    easysimd_uint16x4_t r = easysimd_vreinterpret_u16_f32(a);
    easysimd_uint16x4_private r_ = easysimd_uint16x4_to_private(r);
    easysimd_assert_equal_i(0, easysimd_memcmp(&r_, &a_, sizeof(r_)));
  }
...
static int
test_easysimd_vreinterpret_u16_f16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    easysimd_float16 a[4];
  } test_vec[] = {
     {{ EASYSIMD_FLOAT16_VALUE(  -937.50), EASYSIMD_FLOAT16_VALUE(   311.75), EASYSIMD_FLOAT16_VALUE(   -23.30), EASYSIMD_FLOAT16_VALUE(   600.50) }},
     {{ EASYSIMD_FLOAT16_VALUE(   438.25), EASYSIMD_FLOAT16_VALUE(   -31.77), EASYSIMD_FLOAT16_VALUE(  -916.50), EASYSIMD_FLOAT16_VALUE(   172.62) }},
     {{ EASYSIMD_FLOAT16_VALUE(  -668.50), EASYSIMD_FLOAT16_VALUE(   294.75), EASYSIMD_FLOAT16_VALUE(   -77.69), EASYSIMD_FLOAT16_VALUE(  -135.62) }},
     {{ EASYSIMD_FLOAT16_VALUE(  -130.88), EASYSIMD_FLOAT16_VALUE(   569.00), EASYSIMD_FLOAT16_VALUE(  -618.50), EASYSIMD_FLOAT16_VALUE(  -238.50) }},
     {{ EASYSIMD_FLOAT16_VALUE(  -396.00), EASYSIMD_FLOAT16_VALUE(  -605.50), EASYSIMD_FLOAT16_VALUE(  -576.50), EASYSIMD_FLOAT16_VALUE(     8.46) }},
     {{ EASYSIMD_FLOAT16_VALUE(   902.00), EASYSIMD_FLOAT16_VALUE(   283.50), EASYSIMD_FLOAT16_VALUE(  -336.75), EASYSIMD_FLOAT16_VALUE(   741.00) }},
     {{ EASYSIMD_FLOAT16_VALUE(  -499.00), EASYSIMD_FLOAT16_VALUE(   515.00), EASYSIMD_FLOAT16_VALUE(  -923.50), EASYSIMD_FLOAT16_VALUE(   880.00) }},
     {{ EASYSIMD_FLOAT16_VALUE(   410.75), EASYSIMD_FLOAT16_VALUE(   970.50), EASYSIMD_FLOAT16_VALUE(  -704.50), EASYSIMD_FLOAT16_VALUE(   473.25) }}
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float16x4_t a = easysimd_vld1_f16(test_vec[i].a);
    easysimd_float16x4_private a_ = easysimd_float16x4_to_private(a);
    easysimd_uint16x4_t r = easysimd_vreinterpret_u16_f16(a);
    easysimd_uint16x4_private r_ = easysimd_uint16x4_to_private(r);
    easysimd_assert_equal_i(0, easysimd_memcmp(&r_, &a_, sizeof(r_)));
  }
...
static int
test_easysimd_vreinterpret_u32_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    easysimd_float32 a[2];
  } test_vec[] = {
    { { EASYSIMD_FLOAT32_C(   661.50), EASYSIMD_FLOAT32_C(  -338.84) },
 },
    { { EASYSIMD_FLOAT32_C(   472.10), EASYSIMD_FLOAT32_C(  -850.16) },
 },
    { { EASYSIMD_FLOAT32_C(   915.36), EASYSIMD_FLOAT32_C(  -912.72) },
 },
    { { EASYSIMD_FLOAT32_C(   252.30), EASYSIMD_FLOAT32_C(   744.88) },
 },
    { { EASYSIMD_FLOAT32_C(   220.69), EASYSIMD_FLOAT32_C(  -108.88) },
 },
    { { EASYSIMD_FLOAT32_C(  -892.39), EASYSIMD_FLOAT32_C(   442.34) },
 },
    { { EASYSIMD_FLOAT32_C(  -537.40), EASYSIMD_FLOAT32_C(  -490.27) },
 },
    { { EASYSIMD_FLOAT32_C(  -224.54), EASYSIMD_FLOAT32_C(   427.88) },
 },
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float32x2_t a = easysimd_vld1_f32(test_vec[i].a);
    easysimd_float32x2_private a_ = easysimd_float32x2_to_private(a);
    easysimd_uint32x2_t r = easysimd_vreinterpret_u32_f32(a);
    easysimd_uint32x2_private r_ = easysimd_uint32x2_to_private(r);
    easysimd_assert_equal_i(0, easysimd_memcmp(&r_, &a_, sizeof(r_)));
  }
...
static int
test_easysimd_vreinterpret_u64_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    easysimd_float32 a[2];
  } test_vec[] = {
    { { EASYSIMD_FLOAT32_C(  -519.07), EASYSIMD_FLOAT32_C(  -844.22) },
 },
    { { EASYSIMD_FLOAT32_C(  -231.95), EASYSIMD_FLOAT32_C(  -916.84) },
 },
    { { EASYSIMD_FLOAT32_C(   514.42), EASYSIMD_FLOAT32_C(  -429.97) },
 },
    { { EASYSIMD_FLOAT32_C(   411.33), EASYSIMD_FLOAT32_C(  -473.13) },
 },
    { { EASYSIMD_FLOAT32_C(   825.45), EASYSIMD_FLOAT32_C(  -559.04) },
 },
    { { EASYSIMD_FLOAT32_C(    33.66), EASYSIMD_FLOAT32_C(  -851.23) },
 },
    { { EASYSIMD_FLOAT32_C(  -750.80), EASYSIMD_FLOAT32_C(   708.79) },
 },
    { { EASYSIMD_FLOAT32_C(    71.84), EASYSIMD_FLOAT32_C(   585.91) },
 },
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float32x2_t a = easysimd_vld1_f32(test_vec[i].a);
    easysimd_float32x2_private a_ = easysimd_float32x2_to_private(a);
    easysimd_uint64x1_t r = easysimd_vreinterpret_u64_f32(a);
    easysimd_uint64x1_private r_ = easysimd_uint64x1_to_private(r);
    easysimd_assert_equal_i(0, easysimd_memcmp(&r_, &a_, sizeof(r_)));
  }
...
static int
test_easysimd_vreinterpretq_f64_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    easysimd_float32 a[4];
  } test_vec[] = {
    { { EASYSIMD_FLOAT32_C(  -811.50), EASYSIMD_FLOAT32_C(   514.96), EASYSIMD_FLOAT32_C(  -136.00), EASYSIMD_FLOAT32_C(  -141.79) },
 },
    { { EASYSIMD_FLOAT32_C(    61.02), EASYSIMD_FLOAT32_C(   477.62), EASYSIMD_FLOAT32_C(   148.51), EASYSIMD_FLOAT32_C(   991.88) },
 },
    { { EASYSIMD_FLOAT32_C(  -930.50), EASYSIMD_FLOAT32_C(   415.23), EASYSIMD_FLOAT32_C(  -261.81), EASYSIMD_FLOAT32_C(   239.22) },
 },
    { { EASYSIMD_FLOAT32_C(  -235.74), EASYSIMD_FLOAT32_C(  -683.57), EASYSIMD_FLOAT32_C(   -77.80), EASYSIMD_FLOAT32_C(   884.34) },
 },
    { { EASYSIMD_FLOAT32_C(  -663.55), EASYSIMD_FLOAT32_C(   620.01), EASYSIMD_FLOAT32_C(  -701.35), EASYSIMD_FLOAT32_C(   534.67) },
 },
    { { EASYSIMD_FLOAT32_C(   -55.34), EASYSIMD_FLOAT32_C(   286.47), EASYSIMD_FLOAT32_C(  -242.86), EASYSIMD_FLOAT32_C(  -763.34) },
 },
    { { EASYSIMD_FLOAT32_C(   995.87), EASYSIMD_FLOAT32_C(   465.38), EASYSIMD_FLOAT32_C(   128.46), EASYSIMD_FLOAT32_C(  -623.09) },
 },
    { { EASYSIMD_FLOAT32_C(   144.58), EASYSIMD_FLOAT32_C(   923.36), EASYSIMD_FLOAT32_C(  -420.92), EASYSIMD_FLOAT32_C(   333.08) },
 },
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_float64x2_t r = easysimd_vreinterpretq_f64_f32(a);
    easysimd_float64x2_private r_ = easysimd_float64x2_to_private(r);
...
static int
test_easysimd_vreinterpretq_s8_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    easysimd_float32 a[4];
  } test_vec[] = {
    { { EASYSIMD_FLOAT32_C(  -715.28), EASYSIMD_FLOAT32_C(    33.48), EASYSIMD_FLOAT32_C(   229.63), EASYSIMD_FLOAT32_C(  -742.42) },
 },
    { { EASYSIMD_FLOAT32_C(   472.64), EASYSIMD_FLOAT32_C(  -446.37), EASYSIMD_FLOAT32_C(   664.03), EASYSIMD_FLOAT32_C(    26.76) },
 },
    { { EASYSIMD_FLOAT32_C(  -329.58), EASYSIMD_FLOAT32_C(   330.64), EASYSIMD_FLOAT32_C(  -243.69), EASYSIMD_FLOAT32_C(  -277.14) },
 },
    { { EASYSIMD_FLOAT32_C(   610.24), EASYSIMD_FLOAT32_C(   639.80), EASYSIMD_FLOAT32_C(  -784.18), EASYSIMD_FLOAT32_C(  -365.62) },
 },
    { { EASYSIMD_FLOAT32_C(   114.54), EASYSIMD_FLOAT32_C(  -652.97), EASYSIMD_FLOAT32_C(  -379.89), EASYSIMD_FLOAT32_C(  -610.92) },
 },
    { { EASYSIMD_FLOAT32_C(   952.14), EASYSIMD_FLOAT32_C(  -538.54), EASYSIMD_FLOAT32_C(  -682.53), EASYSIMD_FLOAT32_C(   242.56) },
 },
    { { EASYSIMD_FLOAT32_C(  -333.51), EASYSIMD_FLOAT32_C(   450.97), EASYSIMD_FLOAT32_C(  -236.98), EASYSIMD_FLOAT32_C(    47.06) },
 },
    { { EASYSIMD_FLOAT32_C(    18.38), EASYSIMD_FLOAT32_C(   953.45), EASYSIMD_FLOAT32_C(   221.44), EASYSIMD_FLOAT32_C(   303.10) },
 },
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float32x4_t a = easysimd_vld1q_f32(test_vec[i].a);
    easysimd_float32x4_private a_ = easysimd_float32x4_to_private(a);
    easysimd_int8x16_t r = easysimd_vreinterpretq_s8_f32(a);
    easysimd_int8x16_private r_ = easysimd_int8x16_to_private(r);
...
static int
test_easysimd_vreinterpretq_s16_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    easysimd_float32 a[4];
  } test_vec[] = {
    { { EASYSIMD_FLOAT32_C(  -765.62), EASYSIMD_FLOAT32_C(   361.08), EASYSIMD_FLOAT32_C(   970.49), EASYSIMD_FLOAT32_C(   464.20) },
 },
    { { EASYSIMD_FLOAT32_C(  -945.27), EASYSIMD_FLOAT32_C(   -68.63), EASYSIMD_FLOAT32_C(   229.51), EASYSIMD_FLOAT32_C(  -351.34) },
 },
    { { EASYSIMD_FLOAT32_C(   542.83), EASYSIMD_FLOAT32_C(  -123.36), EASYSIMD_FLOAT32_C(   927.83), EASYSIMD_FLOAT32_C(  -243.91) },
 },
    { { EASYSIMD_FLOAT32_C(  -330.95), EASYSIMD_FLOAT32_C(   461.31), EASYSIMD_FLOAT32_C(   836.57), EASYSIMD_FLOAT32_C(    92.21) },
 },
    { { EASYSIMD_FLOAT32_C(  -186.44), EASYSIMD_FLOAT32_C(  -562.27), EASYSIMD_FLOAT32_C(  -320.25), EASYSIMD_FLOAT32_C(  -379.25) },
 },
    { { EASYSIMD_FLOAT32_C(   306.79), EASYSIMD_FLOAT32_C(  -832.12), EASYSIMD_FLOAT32_C(   438.15), EASYSIMD_FLOAT32_C(  -467.18) },
 },
    { { EASYSIMD_FLOAT32_C(  -657.92), EASYSIMD_FLOAT32_C(  -254.81), EASYSIMD_FLOAT32_C(   831.78), EASYSIMD_FLOAT32_C(   236.89) },
 },
    { { EASYSIMD_FLOAT32_C(   865.09), EASYSIMD_FLOAT32_C(   532.74), EASYSIMD_FLOAT32_C(  -968.34), EASYSIMD_FLOAT32_C(  -900.54) },
 },
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float32x4_t a = easysimd_vld1q_f32(test_vec[i].a);
    easysimd_float32x4_private a_ = easysimd_float32x4_to_private(a);
    easysimd_int16x8_t r = easysimd_vreinterpretq_s16_f32(a);
    easysimd_int16x8_private r_ = easysimd_int16x8_to_private(r);
...
static int
test_easysimd_vreinterpretq_s32_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    easysimd_float32 a[4];
  } test_vec[] = {
    { { EASYSIMD_FLOAT32_C(  -932.02), EASYSIMD_FLOAT32_C(  -132.75), EASYSIMD_FLOAT32_C(  -699.06), EASYSIMD_FLOAT32_C(  -679.87) },
 },
    { { EASYSIMD_FLOAT32_C(  -936.24), EASYSIMD_FLOAT32_C(   610.41), EASYSIMD_FLOAT32_C(  -391.45), EASYSIMD_FLOAT32_C(   201.79) },
 },
    { { EASYSIMD_FLOAT32_C(  -432.76), EASYSIMD_FLOAT32_C(   405.49), EASYSIMD_FLOAT32_C(   203.70), EASYSIMD_FLOAT32_C(  -940.94) },
 },
    { { EASYSIMD_FLOAT32_C(  -913.18), EASYSIMD_FLOAT32_C(   765.98), EASYSIMD_FLOAT32_C(  -413.09), EASYSIMD_FLOAT32_C(  -839.58) },
 },
    { { EASYSIMD_FLOAT32_C(   525.54), EASYSIMD_FLOAT32_C(  -423.97), EASYSIMD_FLOAT32_C(  -466.96), EASYSIMD_FLOAT32_C(   911.94) },
 },
    { { EASYSIMD_FLOAT32_C(   614.98), EASYSIMD_FLOAT32_C(   805.06), EASYSIMD_FLOAT32_C(  -958.00), EASYSIMD_FLOAT32_C(  -950.16) },
 },
    { { EASYSIMD_FLOAT32_C(  -656.23), EASYSIMD_FLOAT32_C(    55.72), EASYSIMD_FLOAT32_C(   110.93), EASYSIMD_FLOAT32_C(   458.68) },
 },
    { { EASYSIMD_FLOAT32_C(  -160.98), EASYSIMD_FLOAT32_C(   817.98), EASYSIMD_FLOAT32_C(   396.81), EASYSIMD_FLOAT32_C(   -92.99) },
 },
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float32x4_t a = easysimd_vld1q_f32(test_vec[i].a);
    easysimd_float32x4_private a_ = easysimd_float32x4_to_private(a);
    easysimd_int32x4_t r = easysimd_vreinterpretq_s32_f32(a);
    easysimd_int32x4_private r_ = easysimd_int32x4_to_private(r);
    easysimd_assert_equal_i(0, easysimd_memcmp(&r_, &a_, sizeof(r_)));
  }
...
static int
test_easysimd_vreinterpretq_s64_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    easysimd_float32 a[4];
  } test_vec[] = {
    { { EASYSIMD_FLOAT32_C(   518.36), EASYSIMD_FLOAT32_C(  -882.32), EASYSIMD_FLOAT32_C(   -73.64), EASYSIMD_FLOAT32_C(   749.12) },
 },
    { { EASYSIMD_FLOAT32_C(  -496.02), EASYSIMD_FLOAT32_C(  -306.74), EASYSIMD_FLOAT32_C(  -922.59), EASYSIMD_FLOAT32_C(   847.19) },
 },
    { { EASYSIMD_FLOAT32_C(   777.17), EASYSIMD_FLOAT32_C(   196.12), EASYSIMD_FLOAT32_C(  -547.27), EASYSIMD_FLOAT32_C(  -497.25) },
 },
    { { EASYSIMD_FLOAT32_C(  -324.90), EASYSIMD_FLOAT32_C(  -358.94), EASYSIMD_FLOAT32_C(  -741.14), EASYSIMD_FLOAT32_C(  -164.39) },
 },
    { { EASYSIMD_FLOAT32_C(  -823.67), EASYSIMD_FLOAT32_C(  -347.30), EASYSIMD_FLOAT32_C(   683.23), EASYSIMD_FLOAT32_C(  -581.31) },
 },
    { { EASYSIMD_FLOAT32_C(  -908.06), EASYSIMD_FLOAT32_C(   681.07), EASYSIMD_FLOAT32_C(  -895.66), EASYSIMD_FLOAT32_C(   -13.27) },
 },
    { { EASYSIMD_FLOAT32_C(    38.57), EASYSIMD_FLOAT32_C(  -801.68), EASYSIMD_FLOAT32_C(  -141.46), EASYSIMD_FLOAT32_C(   275.72) },
 },
    { { EASYSIMD_FLOAT32_C(  -841.66), EASYSIMD_FLOAT32_C(  -993.81), EASYSIMD_FLOAT32_C(  -416.02), EASYSIMD_FLOAT32_C(   676.69) },
 },
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float32x4_t a = easysimd_vld1q_f32(test_vec[i].a);
    easysimd_float32x4_private a_ = easysimd_float32x4_to_private(a);
    easysimd_int64x2_t r = easysimd_vreinterpretq_s64_f32(a);
    easysimd_int64x2_private r_ = easysimd_int64x2_to_private(r);
    easysimd_assert_equal_i(0, easysimd_memcmp(&r_, &a_, sizeof(r_)));
  }
...
static int
test_easysimd_vreinterpretq_u8_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    easysimd_float32 a[4];
  } test_vec[] = {
    { { EASYSIMD_FLOAT32_C(   666.23), EASYSIMD_FLOAT32_C(  -544.03), EASYSIMD_FLOAT32_C(   130.05), EASYSIMD_FLOAT32_C(  -777.18) },
 },
    { { EASYSIMD_FLOAT32_C(   521.70), EASYSIMD_FLOAT32_C(    33.98), EASYSIMD_FLOAT32_C(  -958.60), EASYSIMD_FLOAT32_C(  -408.56) },
 },
    { { EASYSIMD_FLOAT32_C(   396.34), EASYSIMD_FLOAT32_C(  -364.03), EASYSIMD_FLOAT32_C(   719.77), EASYSIMD_FLOAT32_C(   483.05) },
 },
    { { EASYSIMD_FLOAT32_C(   307.42), EASYSIMD_FLOAT32_C(   916.12), EASYSIMD_FLOAT32_C(  -506.50), EASYSIMD_FLOAT32_C(   167.94) },
 },
    { { EASYSIMD_FLOAT32_C(   796.69), EASYSIMD_FLOAT32_C(  -227.61), EASYSIMD_FLOAT32_C(   168.78), EASYSIMD_FLOAT32_C(   769.87) },
 },
    { { EASYSIMD_FLOAT32_C(   237.37), EASYSIMD_FLOAT32_C(  -942.90), EASYSIMD_FLOAT32_C(   126.56), EASYSIMD_FLOAT32_C(   -99.19) },
 },
    { { EASYSIMD_FLOAT32_C(   684.50), EASYSIMD_FLOAT32_C(   809.18), EASYSIMD_FLOAT32_C(   523.87), EASYSIMD_FLOAT32_C(   945.93) },
 },
    { { EASYSIMD_FLOAT32_C(   492.61), EASYSIMD_FLOAT32_C(   718.52), EASYSIMD_FLOAT32_C(  -237.77), EASYSIMD_FLOAT32_C(   158.83) },
 },
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float32x4_t a = easysimd_vld1q_f32(test_vec[i].a);
    easysimd_float32x4_private a_ = easysimd_float32x4_to_private(a);
    easysimd_uint8x16_t r = easysimd_vreinterpretq_u8_f32(a);
    easysimd_uint8x16_private r_ = easysimd_uint8x16_to_private(r);
...
static int
test_easysimd_vreinterpretq_u16_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    easysimd_float32 a[4];
  } test_vec[] = {
    { { EASYSIMD_FLOAT32_C(  -555.05), EASYSIMD_FLOAT32_C(   929.17), EASYSIMD_FLOAT32_C(  -878.30), EASYSIMD_FLOAT32_C(   403.08) },
 },
    { { EASYSIMD_FLOAT32_C(  -814.23), EASYSIMD_FLOAT32_C(    72.21), EASYSIMD_FLOAT32_C(  -782.92), EASYSIMD_FLOAT32_C(  -545.57) },
 },
    { { EASYSIMD_FLOAT32_C(  -150.39), EASYSIMD_FLOAT32_C(  -981.73), EASYSIMD_FLOAT32_C(   393.48), EASYSIMD_FLOAT32_C(  -162.45) },
 },
    { { EASYSIMD_FLOAT32_C(  -204.82), EASYSIMD_FLOAT32_C(  -148.81), EASYSIMD_FLOAT32_C(   -48.01), EASYSIMD_FLOAT32_C(  -385.48) },
 },
    { { EASYSIMD_FLOAT32_C(  -745.95), EASYSIMD_FLOAT32_C(   651.42), EASYSIMD_FLOAT32_C(   885.60), EASYSIMD_FLOAT32_C(   882.69) },
 },
    { { EASYSIMD_FLOAT32_C(   987.57), EASYSIMD_FLOAT32_C(  -664.87), EASYSIMD_FLOAT32_C(  -294.19), EASYSIMD_FLOAT32_C(   570.81) },
 },
    { { EASYSIMD_FLOAT32_C(  -549.84), EASYSIMD_FLOAT32_C(   623.57), EASYSIMD_FLOAT32_C(  -114.75), EASYSIMD_FLOAT32_C(  -564.92) },
 },
    { { EASYSIMD_FLOAT32_C(   165.89), EASYSIMD_FLOAT32_C(  -376.09), EASYSIMD_FLOAT32_C(   997.79), EASYSIMD_FLOAT32_C(   610.84) },
 },
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float32x4_t a = easysimd_vld1q_f32(test_vec[i].a);
    easysimd_float32x4_private a_ = easysimd_float32x4_to_private(a);
    easysimd_uint16x8_t r = easysimd_vreinterpretq_u16_f32(a);
    easysimd_uint16x8_private r_ = easysimd_uint16x8_to_private(r);
    easysimd_assert_equal_i(0, easysimd_memcmp(&r_, &a_, sizeof(r_)));
  }
...
static int
test_easysimd_vreinterpretq_u16_f16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    easysimd_float16 a[8];
  } test_vec[] = {
     { { EASYSIMD_FLOAT16_VALUE(   615.50), EASYSIMD_FLOAT16_VALUE(  -978.50), EASYSIMD_FLOAT16_VALUE(  -561.50), EASYSIMD_FLOAT16_VALUE(   508.50),
        EASYSIMD_FLOAT16_VALUE(  -968.00), EASYSIMD_FLOAT16_VALUE(  -316.25), EASYSIMD_FLOAT16_VALUE(  -961.50), EASYSIMD_FLOAT16_VALUE(   786.50) } },
    { { EASYSIMD_FLOAT16_VALUE(   968.50), EASYSIMD_FLOAT16_VALUE(  -779.50), EASYSIMD_FLOAT16_VALUE(    -0.40), EASYSIMD_FLOAT16_VALUE(   486.00),
        EASYSIMD_FLOAT16_VALUE(   819.00), EASYSIMD_FLOAT16_VALUE(   807.00), EASYSIMD_FLOAT16_VALUE(  -690.00), EASYSIMD_FLOAT16_VALUE(  -245.50) } },
    { { EASYSIMD_FLOAT16_VALUE(  -341.50), EASYSIMD_FLOAT16_VALUE(  -184.50), EASYSIMD_FLOAT16_VALUE(   865.50), EASYSIMD_FLOAT16_VALUE(   213.38),
        EASYSIMD_FLOAT16_VALUE(   627.50), EASYSIMD_FLOAT16_VALUE(  -115.00), EASYSIMD_FLOAT16_VALUE(  -649.50), EASYSIMD_FLOAT16_VALUE(     0.66) } },
    { { EASYSIMD_FLOAT16_VALUE(  -466.00), EASYSIMD_FLOAT16_VALUE(   230.25), EASYSIMD_FLOAT16_VALUE(   358.50), EASYSIMD_FLOAT16_VALUE(  -979.50),
        EASYSIMD_FLOAT16_VALUE(   474.25), EASYSIMD_FLOAT16_VALUE(   796.00), EASYSIMD_FLOAT16_VALUE(   782.00), EASYSIMD_FLOAT16_VALUE(    89.62) } },
    { { EASYSIMD_FLOAT16_VALUE(   817.50), EASYSIMD_FLOAT16_VALUE(  -779.50), EASYSIMD_FLOAT16_VALUE(  -402.00), EASYSIMD_FLOAT16_VALUE(   849.50),
        EASYSIMD_FLOAT16_VALUE(   -95.62), EASYSIMD_FLOAT16_VALUE(  -363.50), EASYSIMD_FLOAT16_VALUE(   636.00), EASYSIMD_FLOAT16_VALUE(  -127.19) } },
    { { EASYSIMD_FLOAT16_VALUE(  -142.88), EASYSIMD_FLOAT16_VALUE(  -364.50), EASYSIMD_FLOAT16_VALUE(  -641.00), EASYSIMD_FLOAT16_VALUE(  -324.00),
        EASYSIMD_FLOAT16_VALUE(  -558.00), EASYSIMD_FLOAT16_VALUE(  -331.25), EASYSIMD_FLOAT16_VALUE(   430.50), EASYSIMD_FLOAT16_VALUE(   100.62) } },
    { { EASYSIMD_FLOAT16_VALUE(   484.25), EASYSIMD_FLOAT16_VALUE(   296.00), EASYSIMD_FLOAT16_VALUE(  -686.00), EASYSIMD_FLOAT16_VALUE(   111.56),
        EASYSIMD_FLOAT16_VALUE(  -819.00), EASYSIMD_FLOAT16_VALUE(  -335.50), EASYSIMD_FLOAT16_VALUE(  -888.00), EASYSIMD_FLOAT16_VALUE(  -284.75) } },
    { { EASYSIMD_FLOAT16_VALUE(   894.50), EASYSIMD_FLOAT16_VALUE(   470.75), EASYSIMD_FLOAT16_VALUE(  -264.25), EASYSIMD_FLOAT16_VALUE(   369.00),
        EASYSIMD_FLOAT16_VALUE(   266.75), EASYSIMD_FLOAT16_VALUE(  -482.00), EASYSIMD_FLOAT16_VALUE(  -541.50), EASYSIMD_FLOAT16_VALUE(    84.12) } }
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float16x8_t a = easysimd_vld1q_f16(test_vec[i].a);
    easysimd_float16x8_private a_ = easysimd_float16x8_to_private(a);
    easysimd_uint16x8_t r = easysimd_vreinterpretq_u16_f16(a);
    easysimd_uint16x8_private r_ = easysimd_uint16x8_to_private(r);
    easysimd_assert_equal_i(0, easysimd_memcmp(&r_, &a_, sizeof(r_)));
  }
...
static int
test_easysimd_vreinterpretq_u32_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    easysimd_float32 a[4];
  } test_vec[] = {
    { { EASYSIMD_FLOAT32_C(  -639.27), EASYSIMD_FLOAT32_C(     2.23), EASYSIMD_FLOAT32_C(  -265.16), EASYSIMD_FLOAT32_C(  -362.94) },
 },
    { { EASYSIMD_FLOAT32_C(  -445.88), EASYSIMD_FLOAT32_C(   968.53), EASYSIMD_FLOAT32_C(   312.26), EASYSIMD_FLOAT32_C(   936.91) },
 },
    { { EASYSIMD_FLOAT32_C(  -465.40), EASYSIMD_FLOAT32_C(   -23.17), EASYSIMD_FLOAT32_C(   673.23), EASYSIMD_FLOAT32_C(  -603.22) },
 },
    { { EASYSIMD_FLOAT32_C(  -429.30), EASYSIMD_FLOAT32_C(   406.19), EASYSIMD_FLOAT32_C(   726.96), EASYSIMD_FLOAT32_C(  -436.99) },
 },
    { { EASYSIMD_FLOAT32_C(    52.93), EASYSIMD_FLOAT32_C(  -904.72), EASYSIMD_FLOAT32_C(   225.27), EASYSIMD_FLOAT32_C(   -62.92) },
 },
    { { EASYSIMD_FLOAT32_C(  -719.26), EASYSIMD_FLOAT32_C(    97.89), EASYSIMD_FLOAT32_C(  -808.00), EASYSIMD_FLOAT32_C(   701.29) },
 },
    { { EASYSIMD_FLOAT32_C(   151.65), EASYSIMD_FLOAT32_C(   842.19), EASYSIMD_FLOAT32_C(   331.08), EASYSIMD_FLOAT32_C(   329.68) },
 },
    { { EASYSIMD_FLOAT32_C(   304.95), EASYSIMD_FLOAT32_C(   771.15), EASYSIMD_FLOAT32_C(   630.46), EASYSIMD_FLOAT32_C(   665.69) },
 },
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float32x4_t a = easysimd_vld1q_f32(test_vec[i].a);
    easysimd_float32x4_private a_ = easysimd_float32x4_to_private(a);
    easysimd_uint32x4_t r = easysimd_vreinterpretq_u32_f32(a);
    easysimd_uint32x4_private r_ = easysimd_uint32x4_to_private(r);
...
static int
test_easysimd_vreinterpretq_u64_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    easysimd_float32 a[4];
  } test_vec[] = {
    { { EASYSIMD_FLOAT32_C(   231.72), EASYSIMD_FLOAT32_C(   123.26), EASYSIMD_FLOAT32_C(  -786.91), EASYSIMD_FLOAT32_C(  -138.95) },
 },
    { { EASYSIMD_FLOAT32_C(   166.21), EASYSIMD_FLOAT32_C(   199.26), EASYSIMD_FLOAT32_C(  -881.03), EASYSIMD_FLOAT32_C(   363.41) },
 },
    { { EASYSIMD_FLOAT32_C(  -208.25), EASYSIMD_FLOAT32_C(  -126.94), EASYSIMD_FLOAT32_C(  -663.57), EASYSIMD_FLOAT32_C(  -651.99) },
 },
    { { EASYSIMD_FLOAT32_C(  -722.64), EASYSIMD_FLOAT32_C(  -951.85), EASYSIMD_FLOAT32_C(   -94.46), EASYSIMD_FLOAT32_C(   924.65) },
 },
    { { EASYSIMD_FLOAT32_C(   896.69), EASYSIMD_FLOAT32_C(    -6.54), EASYSIMD_FLOAT32_C(  -785.89), EASYSIMD_FLOAT32_C(  -806.08) },
 },
    { { EASYSIMD_FLOAT32_C(  -595.88), EASYSIMD_FLOAT32_C(   347.71), EASYSIMD_FLOAT32_C(   118.81), EASYSIMD_FLOAT32_C(  -850.69) },
 },
    { { EASYSIMD_FLOAT32_C(  -873.62), EASYSIMD_FLOAT32_C(   679.36), EASYSIMD_FLOAT32_C(   461.45), EASYSIMD_FLOAT32_C(  -429.35) },
 },
    { { EASYSIMD_FLOAT32_C(  -437.13), EASYSIMD_FLOAT32_C(  -811.02), EASYSIMD_FLOAT32_C(   684.01), EASYSIMD_FLOAT32_C(   794.59) },
 },
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float32x4_t a = easysimd_vld1q_f32(test_vec[i].a);
    easysimd_float32x4_private a_ = easysimd_float32x4_to_private(a);
    easysimd_uint64x2_t r = easysimd_vreinterpretq_u64_f32(a);
    easysimd_uint64x2_private r_ = easysimd_uint64x2_to_private(r);
    easysimd_assert_equal_i(0, easysimd_memcmp(&r_, &a_, sizeof(r_)));
  }
...
static int
test_easysimd_vreinterpret_f32_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    easysimd_float64 a[1];
  } test_vec[] = {
    { { EASYSIMD_FLOAT64_C(    28.67) },
 },
    { { EASYSIMD_FLOAT64_C(   473.75) },
 },
    { { EASYSIMD_FLOAT64_C(   415.56) },
 },
    { { EASYSIMD_FLOAT64_C(   753.78) },
 },
    { { EASYSIMD_FLOAT64_C(   619.03) },
 },
    { { EASYSIMD_FLOAT64_C(   870.52) },
 },
    { { EASYSIMD_FLOAT64_C(  -321.27) },
 },
    { { EASYSIMD_FLOAT64_C(  -568.79) },
 },
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_float32x2_t r = easysimd_vreinterpret_f32_f64(a);
    easysimd_float32x2_private r_ = easysimd_float32x2_to_private(r);
...
static int
test_easysimd_vreinterpret_s8_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    easysimd_float64 a[1];
  } test_vec[] = {
    { { EASYSIMD_FLOAT64_C(   -39.43) },
 },
    { { EASYSIMD_FLOAT64_C(   241.14) },
 },
    { { EASYSIMD_FLOAT64_C(   480.99) },
 },
    { { EASYSIMD_FLOAT64_C(   763.77) },
 },
    { { EASYSIMD_FLOAT64_C(   486.92) },
 },
    { { EASYSIMD_FLOAT64_C(   -31.94) },
 },
    { { EASYSIMD_FLOAT64_C(   873.55) },
 },
    { { EASYSIMD_FLOAT64_C(   804.51) },
 },
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float64x1_t a = easysimd_vld1_f64(test_vec[i].a);
    easysimd_float64x1_private a_ = easysimd_float64x1_to_private(a);
    easysimd_int8x8_t r = easysimd_vreinterpret_s8_f64(a);
    easysimd_int8x8_private r_ = easysimd_int8x8_to_private(r);
...
static int
test_easysimd_vreinterpret_s16_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    easysimd_float64 a[1];
  } test_vec[] = {
    { { EASYSIMD_FLOAT64_C(   937.89) },
 },
    { { EASYSIMD_FLOAT64_C(  -770.55) },
 },
    { { EASYSIMD_FLOAT64_C(   954.11) },
 },
    { { EASYSIMD_FLOAT64_C(  -761.79) },
 },
    { { EASYSIMD_FLOAT64_C(  -483.85) },
 },
    { { EASYSIMD_FLOAT64_C(  -722.69) },
 },
    { { EASYSIMD_FLOAT64_C(    63.26) },
 },
    { { EASYSIMD_FLOAT64_C(   347.83) },
 },
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float64x1_t a = easysimd_vld1_f64(test_vec[i].a);
    easysimd_float64x1_private a_ = easysimd_float64x1_to_private(a);
    easysimd_int16x4_t r = easysimd_vreinterpret_s16_f64(a);
    easysimd_int16x4_private r_ = easysimd_int16x4_to_private(r);
...
static int
test_easysimd_vreinterpret_s32_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    easysimd_float64 a[1];
  } test_vec[] = {
    { { EASYSIMD_FLOAT64_C(  -321.48) },
 },
    { { EASYSIMD_FLOAT64_C(   239.70) },
 },
    { { EASYSIMD_FLOAT64_C(  -593.78) },
 },
    { { EASYSIMD_FLOAT64_C(  -961.46) },
 },
    { { EASYSIMD_FLOAT64_C(  -714.06) },
 },
    { { EASYSIMD_FLOAT64_C(   876.41) },
 },
    { { EASYSIMD_FLOAT64_C(   192.37) },
 },
    { { EASYSIMD_FLOAT64_C(   113.12) },
 },
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float64x1_t a = easysimd_vld1_f64(test_vec[i].a);
    easysimd_float64x1_private a_ = easysimd_float64x1_to_private(a);
    easysimd_int32x2_t r = easysimd_vreinterpret_s32_f64(a);
    easysimd_int32x2_private r_ = easysimd_int32x2_to_private(r);
...
static int
test_easysimd_vreinterpret_s64_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    easysimd_float64 a[1];
  } test_vec[] = {
    { { EASYSIMD_FLOAT64_C(  -679.32) },
 },
    { { EASYSIMD_FLOAT64_C(   926.71) },
 },
    { { EASYSIMD_FLOAT64_C(   780.61) },
 },
    { { EASYSIMD_FLOAT64_C(   116.09) },
 },
    { { EASYSIMD_FLOAT64_C(   481.72) },
 },
    { { EASYSIMD_FLOAT64_C(  -377.58) },
 },
    { { EASYSIMD_FLOAT64_C(  -976.13) },
 },
    { { EASYSIMD_FLOAT64_C(  -213.49) },
 },
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float64x1_t a = easysimd_vld1_f64(test_vec[i].a);
    easysimd_float64x1_private a_ = easysimd_float64x1_to_private(a);
    easysimd_int64x1_t r = easysimd_vreinterpret_s64_f64(a);
    easysimd_int64x1_private r_ = easysimd_int64x1_to_private(r);
...
static int
test_easysimd_vreinterpret_u8_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    easysimd_float64 a[1];
  } test_vec[] = {
    { { EASYSIMD_FLOAT64_C(   642.50) },
 },
    { { EASYSIMD_FLOAT64_C(   -99.78) },
 },
    { { EASYSIMD_FLOAT64_C(   942.91) },
 },
    { { EASYSIMD_FLOAT64_C(  -784.51) },
 },
    { { EASYSIMD_FLOAT64_C(    20.18) },
 },
    { { EASYSIMD_FLOAT64_C(   600.51) },
 },
    { { EASYSIMD_FLOAT64_C(  -214.07) },
 },
    { { EASYSIMD_FLOAT64_C(  -775.71) },
 },
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float64x1_t a = easysimd_vld1_f64(test_vec[i].a);
    easysimd_float64x1_private a_ = easysimd_float64x1_to_private(a);
    easysimd_uint8x8_t r = easysimd_vreinterpret_u8_f64(a);
    easysimd_uint8x8_private r_ = easysimd_uint8x8_to_private(r);
...
static int
test_easysimd_vreinterpret_u16_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    easysimd_float64 a[1];
  } test_vec[] = {
    { { EASYSIMD_FLOAT64_C(  -646.34) },
 },
    { { EASYSIMD_FLOAT64_C(   355.80) },
 },
    { { EASYSIMD_FLOAT64_C(   -63.18) },
 },
    { { EASYSIMD_FLOAT64_C(   300.54) },
 },
    { { EASYSIMD_FLOAT64_C(  -572.37) },
 },
    { { EASYSIMD_FLOAT64_C(  -193.89) },
 },
    { { EASYSIMD_FLOAT64_C(  -662.99) },
 },
    { { EASYSIMD_FLOAT64_C(    16.90) },
 },
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float64x1_t a = easysimd_vld1_f64(test_vec[i].a);
    easysimd_float64x1_private a_ = easysimd_float64x1_to_private(a);
    easysimd_uint16x4_t r = easysimd_vreinterpret_u16_f64(a);
    easysimd_uint16x4_private r_ = easysimd_uint16x4_to_private(r);
    easysimd_assert_equal_i(0, easysimd_memcmp(&r_, &a_, sizeof(r_)));
  }
...
static int
test_easysimd_vreinterpret_u32_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    easysimd_float64 a[1];
  } test_vec[] = {
    { { EASYSIMD_FLOAT64_C(  -775.04) },
 },
    { { EASYSIMD_FLOAT64_C(   -75.64) },
 },
    { { EASYSIMD_FLOAT64_C(  -833.77) },
 },
    { { EASYSIMD_FLOAT64_C(   676.43) },
 },
    { { EASYSIMD_FLOAT64_C(  -944.49) },
 },
    { { EASYSIMD_FLOAT64_C(  -660.68) },
 },
    { { EASYSIMD_FLOAT64_C(   634.14) },
 },
    { { EASYSIMD_FLOAT64_C(   224.28) },
 },
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float64x1_t a = easysimd_vld1_f64(test_vec[i].a);
    easysimd_float64x1_private a_ = easysimd_float64x1_to_private(a);
    easysimd_uint32x2_t r = easysimd_vreinterpret_u32_f64(a);
    easysimd_uint32x2_private r_ = easysimd_uint32x2_to_private(r);
    easysimd_assert_equal_i(0, easysimd_memcmp(&r_, &a_, sizeof(r_)));
  }
...
static int
test_easysimd_vreinterpret_u64_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    easysimd_float64 a[1];
  } test_vec[] = {
    { { EASYSIMD_FLOAT64_C(   417.49) },
 },
    { { EASYSIMD_FLOAT64_C(  -757.56) },
 },
    { { EASYSIMD_FLOAT64_C(  -880.56) },
 },
    { { EASYSIMD_FLOAT64_C(   795.04) },
 },
    { { EASYSIMD_FLOAT64_C(  -500.89) },
 },
    { { EASYSIMD_FLOAT64_C(  -877.89) },
 },
    { { EASYSIMD_FLOAT64_C(   559.74) },
 },
    { { EASYSIMD_FLOAT64_C(   235.55) },
 },
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float64x1_t a = easysimd_vld1_f64(test_vec[i].a);
    easysimd_float64x1_private a_ = easysimd_float64x1_to_private(a);
    easysimd_uint64x1_t r = easysimd_vreinterpret_u64_f64(a);
    easysimd_uint64x1_private r_ = easysimd_uint64x1_to_private(r);
    easysimd_assert_equal_i(0, easysimd_memcmp(&r_, &a_, sizeof(r_)));
  }
...
static int
test_easysimd_vreinterpretq_f32_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    easysimd_float64 a[2];
  } test_vec[] = {
    { { EASYSIMD_FLOAT64_C(  -143.25), EASYSIMD_FLOAT64_C(   834.85) },
 },
    { { EASYSIMD_FLOAT64_C(  -261.67), EASYSIMD_FLOAT64_C(  -140.07) },
 },
    { { EASYSIMD_FLOAT64_C(   513.01), EASYSIMD_FLOAT64_C(  -658.64) },
 },
    { { EASYSIMD_FLOAT64_C(  -687.83), EASYSIMD_FLOAT64_C(   764.02) },
 },
    { { EASYSIMD_FLOAT64_C(  -465.12), EASYSIMD_FLOAT64_C(  -765.44) },
 },
    { { EASYSIMD_FLOAT64_C(   433.84), EASYSIMD_FLOAT64_C(  -259.91) },
 },
    { { EASYSIMD_FLOAT64_C(  -578.38), EASYSIMD_FLOAT64_C(   507.83) },
 },
    { { EASYSIMD_FLOAT64_C(   973.67), EASYSIMD_FLOAT64_C(   -82.78) },
 },
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_float32x4_t r = easysimd_vreinterpretq_f32_f64(a);
    easysimd_float32x4_private r_ = easysimd_float32x4_to_private(r);
    easysimd_assert_equal_i(0, easysimd_memcmp(&r_, &a_, sizeof(r_)));
  }
...
static int
test_easysimd_vreinterpretq_s8_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    easysimd_float64 a[2];
  } test_vec[] = {
    { { EASYSIMD_FLOAT64_C(   458.52), EASYSIMD_FLOAT64_C(   987.27) },
 },
    { { EASYSIMD_FLOAT64_C(  -744.09), EASYSIMD_FLOAT64_C(  -287.82) },
 },
    { { EASYSIMD_FLOAT64_C(  -721.99), EASYSIMD_FLOAT64_C(   994.43) },
 },
    { { EASYSIMD_FLOAT64_C(   754.99), EASYSIMD_FLOAT64_C(  -258.36) },
 },
    { { EASYSIMD_FLOAT64_C(   866.04), EASYSIMD_FLOAT64_C(  -587.02) },
 },
    { { EASYSIMD_FLOAT64_C(  -745.20), EASYSIMD_FLOAT64_C(   415.92) },
 },
    { { EASYSIMD_FLOAT64_C(  -203.46), EASYSIMD_FLOAT64_C(   889.41) },
 },
    { { EASYSIMD_FLOAT64_C(   665.61), EASYSIMD_FLOAT64_C(    69.19) },
 },
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float64x2_t a = easysimd_vld1q_f64(test_vec[i].a);
    easysimd_float64x2_private a_ = easysimd_float64x2_to_private(a);
    easysimd_int8x16_t r = easysimd_vreinterpretq_s8_f64(a);
    easysimd_int8x16_private r_ = easysimd_int8x16_to_private(r);
...
static int
test_easysimd_vreinterpretq_s16_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    easysimd_float64 a[2];
  } test_vec[] = {
    { { EASYSIMD_FLOAT64_C(    94.42), EASYSIMD_FLOAT64_C(   818.93) },
 },
    { { EASYSIMD_FLOAT64_C(  -692.67), EASYSIMD_FLOAT64_C(   786.34) },
 },
    { { EASYSIMD_FLOAT64_C(   928.43), EASYSIMD_FLOAT64_C(  -189.58) },
 },
    { { EASYSIMD_FLOAT64_C(  -918.60), EASYSIMD_FLOAT64_C(   199.44) },
 },
    { { EASYSIMD_FLOAT64_C(   503.38), EASYSIMD_FLOAT64_C(   887.65) },
 },
    { { EASYSIMD_FLOAT64_C(  -468.72), EASYSIMD_FLOAT64_C(  -389.59) },
 },
    { { EASYSIMD_FLOAT64_C(   846.67), EASYSIMD_FLOAT64_C(  -751.14) },
 },
    { { EASYSIMD_FLOAT64_C(  -515.92), EASYSIMD_FLOAT64_C(   180.13) },
 },
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float64x2_t a = easysimd_vld1q_f64(test_vec[i].a);
    easysimd_float64x2_private a_ = easysimd_float64x2_to_private(a);
    easysimd_int16x8_t r = easysimd_vreinterpretq_s16_f64(a);
    easysimd_int16x8_private r_ = easysimd_int16x8_to_private(r);
...
static int
test_easysimd_vreinterpretq_s32_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    easysimd_float64 a[2];
  } test_vec[] = {
    { { EASYSIMD_FLOAT64_C(   528.55), EASYSIMD_FLOAT64_C(   688.78) },
 },
    { { EASYSIMD_FLOAT64_C(   610.11), EASYSIMD_FLOAT64_C(   611.13) },
 },
    { { EASYSIMD_FLOAT64_C(  -578.07), EASYSIMD_FLOAT64_C(   982.36) },
 },
    { { EASYSIMD_FLOAT64_C(   364.66), EASYSIMD_FLOAT64_C(  -506.04) },
 },
    { { EASYSIMD_FLOAT64_C(  -873.02), EASYSIMD_FLOAT64_C(   793.52) },
 },
    { { EASYSIMD_FLOAT64_C(   431.73), EASYSIMD_FLOAT64_C(  -420.86) },
 },
    { { EASYSIMD_FLOAT64_C(  -966.64), EASYSIMD_FLOAT64_C(   749.49) },
 },
    { { EASYSIMD_FLOAT64_C(   468.95), EASYSIMD_FLOAT64_C(   678.54) },
 },
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float64x2_t a = easysimd_vld1q_f64(test_vec[i].a);
    easysimd_float64x2_private a_ = easysimd_float64x2_to_private(a);
    easysimd_int32x4_t r = easysimd_vreinterpretq_s32_f64(a);
    easysimd_int32x4_private r_ = easysimd_int32x4_to_private(r);
    easysimd_assert_equal_i(0, easysimd_memcmp(&r_, &a_, sizeof(r_)));
  }
...
static int
test_easysimd_vreinterpretq_s64_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    easysimd_float64 a[2];
  } test_vec[] = {
    { { EASYSIMD_FLOAT64_C(   499.96), EASYSIMD_FLOAT64_C(   483.36) },
 },
    { { EASYSIMD_FLOAT64_C(  -570.97), EASYSIMD_FLOAT64_C(  -986.77) },
 },
    { { EASYSIMD_FLOAT64_C(   388.29), EASYSIMD_FLOAT64_C(  -157.42) },
 },
    { { EASYSIMD_FLOAT64_C(  -500.62), EASYSIMD_FLOAT64_C(  -196.54) },
 },
    { { EASYSIMD_FLOAT64_C(  -186.43), EASYSIMD_FLOAT64_C(   777.44) },
 },
    { { EASYSIMD_FLOAT64_C(  -393.24), EASYSIMD_FLOAT64_C(  -993.29) },
 },
    { { EASYSIMD_FLOAT64_C(   813.36), EASYSIMD_FLOAT64_C(   797.87) },
 },
    { { EASYSIMD_FLOAT64_C(   890.64), EASYSIMD_FLOAT64_C(   177.04) },
 },
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float64x2_t a = easysimd_vld1q_f64(test_vec[i].a);
    easysimd_float64x2_private a_ = easysimd_float64x2_to_private(a);
    easysimd_int64x2_t r = easysimd_vreinterpretq_s64_f64(a);
    easysimd_int64x2_private r_ = easysimd_int64x2_to_private(r);
    easysimd_assert_equal_i(0, easysimd_memcmp(&r_, &a_, sizeof(r_)));
  }
...
static int
test_easysimd_vreinterpretq_u8_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    easysimd_float64 a[2];
  } test_vec[] = {
    { { EASYSIMD_FLOAT64_C(   774.17), EASYSIMD_FLOAT64_C(  -982.31) },
 },
    { { EASYSIMD_FLOAT64_C(   150.95), EASYSIMD_FLOAT64_C(   568.12) },
 },
    { { EASYSIMD_FLOAT64_C(  -697.86), EASYSIMD_FLOAT64_C(  -585.35) },
 },
    { { EASYSIMD_FLOAT64_C(  -726.09), EASYSIMD_FLOAT64_C(  -258.24) },
 },
    { { EASYSIMD_FLOAT64_C(   225.96), EASYSIMD_FLOAT64_C(   612.94) },
 },
    { { EASYSIMD_FLOAT64_C(   513.18), EASYSIMD_FLOAT64_C(   503.15) },
 },
    { { EASYSIMD_FLOAT64_C(   963.82), EASYSIMD_FLOAT64_C(   -77.66) },
 },
    { { EASYSIMD_FLOAT64_C(  -796.08), EASYSIMD_FLOAT64_C(     2.44) },
 },
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float64x2_t a = easysimd_vld1q_f64(test_vec[i].a);
    easysimd_float64x2_private a_ = easysimd_float64x2_to_private(a);
    easysimd_uint8x16_t r = easysimd_vreinterpretq_u8_f64(a);
    easysimd_uint8x16_private r_ = easysimd_uint8x16_to_private(r);
...
static int
test_easysimd_vreinterpretq_u16_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    easysimd_float64 a[2];
  } test_vec[] = {
    { { EASYSIMD_FLOAT64_C(   366.50), EASYSIMD_FLOAT64_C(  -291.14) },
 },
    { { EASYSIMD_FLOAT64_C(  -469.92), EASYSIMD_FLOAT64_C(  -958.99) },
 },
    { { EASYSIMD_FLOAT64_C(  -979.93), EASYSIMD_FLOAT64_C(  -904.00) },
 },
    { { EASYSIMD_FLOAT64_C(  -442.71), EASYSIMD_FLOAT64_C(  -363.03) },
 },
    { { EASYSIMD_FLOAT64_C(  -172.73), EASYSIMD_FLOAT64_C(    76.80) },
 },
    { { EASYSIMD_FLOAT64_C(   876.29), EASYSIMD_FLOAT64_C(  -629.97) },
 },
    { { EASYSIMD_FLOAT64_C(   360.30), EASYSIMD_FLOAT64_C(   944.37) },
 },
    { { EASYSIMD_FLOAT64_C(  -412.04), EASYSIMD_FLOAT64_C(   375.13) },
 },
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float64x2_t a = easysimd_vld1q_f64(test_vec[i].a);
    easysimd_float64x2_private a_ = easysimd_float64x2_to_private(a);
    easysimd_uint16x8_t r = easysimd_vreinterpretq_u16_f64(a);
    easysimd_uint16x8_private r_ = easysimd_uint16x8_to_private(r);
    easysimd_assert_equal_i(0, easysimd_memcmp(&r_, &a_, sizeof(r_)));
  }
...
static int
test_easysimd_vreinterpretq_u32_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    easysimd_float64 a[2];
  } test_vec[] = {
    { { EASYSIMD_FLOAT64_C(  -625.30), EASYSIMD_FLOAT64_C(  -492.95) },
 },
    { { EASYSIMD_FLOAT64_C(   940.16), EASYSIMD_FLOAT64_C(   246.25) },
 },
    { { EASYSIMD_FLOAT64_C(  -129.68), EASYSIMD_FLOAT64_C(   -65.50) },
 },
    { { EASYSIMD_FLOAT64_C(  -587.78), EASYSIMD_FLOAT64_C(  -371.92) },
 },
    { { EASYSIMD_FLOAT64_C(   254.10), EASYSIMD_FLOAT64_C(   929.33) },
 },
    { { EASYSIMD_FLOAT64_C(   369.23), EASYSIMD_FLOAT64_C(  -348.00) },
 },
    { { EASYSIMD_FLOAT64_C(   551.76), EASYSIMD_FLOAT64_C(   388.09) },
 },
    { { EASYSIMD_FLOAT64_C(  -849.56), EASYSIMD_FLOAT64_C(   541.39) },
 },
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float64x2_t a = easysimd_vld1q_f64(test_vec[i].a);
    easysimd_float64x2_private a_ = easysimd_float64x2_to_private(a);
    easysimd_uint32x4_t r = easysimd_vreinterpretq_u32_f64(a);
    easysimd_uint32x4_private r_ = easysimd_uint32x4_to_private(r);
...
static int
test_easysimd_vreinterpretq_u64_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    easysimd_float64 a[2];
  } test_vec[] = {
    { { EASYSIMD_FLOAT64_C(   261.11), EASYSIMD_FLOAT64_C(   328.35) },
    },
    { { EASYSIMD_FLOAT64_C(   953.99), EASYSIMD_FLOAT64_C(   268.54) },
    },
    { { EASYSIMD_FLOAT64_C(   860.91), EASYSIMD_FLOAT64_C(   685.66) },
    },
    { { EASYSIMD_FLOAT64_C(  -379.72), EASYSIMD_FLOAT64_C(   849.19) },
    },
    { { EASYSIMD_FLOAT64_C(  -182.32), EASYSIMD_FLOAT64_C(   565.54) },
    },
    { { EASYSIMD_FLOAT64_C(   593.89), EASYSIMD_FLOAT64_C(   988.09) },
    },
    { { EASYSIMD_FLOAT64_C(   564.35), EASYSIMD_FLOAT64_C(   771.05) },
    },
    { { EASYSIMD_FLOAT64_C(  -993.11), EASYSIMD_FLOAT64_C(  -315.73) },
    },
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float64x2_t a = easysimd_vld1q_f64(test_vec[i].a);
    easysimd_float64x2_private a_ = easysimd_float64x2_to_private(a);
    easysimd_uint64x2_t r = easysimd_vreinterpretq_u64_f64(a);
    easysimd_uint64x2_private r_ = easysimd_uint64x2_to_private(r);
    easysimd_assert_equal_i(0, easysimd_memcmp(&r_, &a_, sizeof(r_)));
  }
...
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpret_f32_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpret_f64_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpret_s16_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpret_s32_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpret_s64_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpret_u8_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpret_u16_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpret_u32_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpret_u64_s8)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpretq_f32_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpretq_f64_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpretq_s16_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpretq_s32_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpretq_s64_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpretq_u8_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpretq_u16_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpretq_u32_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpretq_u64_s8)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpret_f32_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpret_f64_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpret_s8_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpret_s32_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpret_s64_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpret_u8_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpret_u16_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpret_u32_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpret_u64_s16)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpretq_f32_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpretq_f64_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpretq_s8_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpretq_s32_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpretq_s64_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpretq_u8_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpretq_u16_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpretq_u32_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpretq_u64_s16)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpret_f32_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpret_f64_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpret_s8_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpret_s16_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpret_s64_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpret_u8_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpret_u16_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpret_u32_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpret_u64_s32)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpretq_f32_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpretq_f64_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpretq_s8_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpretq_s16_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpretq_s64_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpretq_u8_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpretq_u16_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpretq_u32_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpretq_u64_s32)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpret_f32_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpret_f64_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpret_s8_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpret_s16_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpret_s32_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpret_u8_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpret_u16_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpret_u32_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpret_u64_s64)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpretq_f32_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpretq_f64_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpretq_s8_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpretq_s16_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpretq_s32_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpretq_u8_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpretq_u16_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpretq_u32_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpretq_u64_s64)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpret_f32_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpret_f64_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpret_s8_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpret_s16_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpret_s32_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpret_s64_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpret_u16_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpret_u32_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpret_u64_u8)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpretq_f32_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpretq_f64_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpretq_s8_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpretq_s16_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpretq_s32_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpretq_s64_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpretq_u16_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpretq_u32_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpretq_u64_u8)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpret_f32_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpret_f64_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpret_s8_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpret_s16_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpret_s32_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpret_s64_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpret_u8_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpret_u32_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpret_u64_u16)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpretq_f32_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpretq_f64_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpretq_s8_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpretq_s16_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpretq_s32_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpretq_s64_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpretq_u8_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpretq_u32_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpretq_u64_u16)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpret_f16_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpret_f32_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpret_f64_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpret_s8_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpret_s16_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpret_s32_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpret_s64_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpret_u8_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpret_u16_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpret_u64_u32)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpretq_f16_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpretq_f32_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpretq_f64_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpretq_s8_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpretq_s16_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpretq_s32_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpretq_s64_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpretq_u8_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpretq_u16_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpretq_u64_u32)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpret_f32_u64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpret_f64_u64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpret_s8_u64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpret_s16_u64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpret_s32_u64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpret_s64_u64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpret_u8_u64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpret_u16_u64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpret_u32_u64)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpretq_f32_u64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpretq_f64_u64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpretq_s8_u64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpretq_s16_u64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpretq_s32_u64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpretq_s64_u64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpretq_u8_u64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpretq_u16_u64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpretq_u32_u64)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpret_f64_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpret_s8_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpret_s16_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpret_s32_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpret_s64_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpret_u8_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpret_u16_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpret_u16_f16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpret_u32_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpret_u64_f32)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpretq_f64_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpretq_s8_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpretq_s16_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpretq_s32_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpretq_s64_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpretq_u8_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpretq_u16_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpretq_u16_f16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpretq_u32_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpretq_u64_f32)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpret_f32_f64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpret_s8_f64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpret_s16_f64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpret_s32_f64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpret_s64_f64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpret_u8_f64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpret_u16_f64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpret_u32_f64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpret_u64_f64)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpretq_f32_f64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpretq_s8_f64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpretq_s16_f64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpretq_s32_f64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpretq_s64_f64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpretq_u8_f64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpretq_u16_f64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpretq_u32_f64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vreinterpretq_u64_f64)
