#define EASYSIMD_TEST_ARM_NEON_INSN rev64

#include "test-neon.h"

/* Check that both of these work */
#if defined(__cplusplus)
  #include "../../../easysimd/arm/neon/rev64.h"
#else
...
static int
test_easysimd_vrev64_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int8_t a[8];
    int8_t r[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int8x8_t r = easysimd_vrev64_s8(a);
...
static int
test_easysimd_vrev64_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int16_t a[4];
    int16_t r[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int16x4_t r = easysimd_vrev64_s16(a);
...
static int
test_easysimd_vrev64_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t a[2];
    int32_t r[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x2_t r = easysimd_vrev64_s32(a);
...
static int
test_easysimd_vrev64_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint8_t a[8];
    uint8_t r[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x8_t r = easysimd_vrev64_u8(a);
...
static int
test_easysimd_vrev64_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint16_t a[4];
    uint16_t r[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x4_t r = easysimd_vrev64_u16(a);
...
static int
test_easysimd_vrev64_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint32_t a[2];
    uint32_t r[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x2_t r = easysimd_vrev64_u32(a);
...
static int
test_easysimd_vrev64_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    easysimd_float32 a[2];
    easysimd_float32 r[2];
  } test_vec[] = {
    { { EASYSIMD_FLOAT32_C(   197.38), EASYSIMD_FLOAT32_C(  -984.96) },
      { EASYSIMD_FLOAT32_C(  -984.96), EASYSIMD_FLOAT32_C(   197.38) } },
    { { EASYSIMD_FLOAT32_C(   987.38), EASYSIMD_FLOAT32_C(   664.23) },
      { EASYSIMD_FLOAT32_C(   664.23), EASYSIMD_FLOAT32_C(   987.38) } },
    { { EASYSIMD_FLOAT32_C(   830.72), EASYSIMD_FLOAT32_C(  -164.98) },
      { EASYSIMD_FLOAT32_C(  -164.98), EASYSIMD_FLOAT32_C(   830.72) } },
    { { EASYSIMD_FLOAT32_C(   120.71), EASYSIMD_FLOAT32_C(  -223.00) },
      { EASYSIMD_FLOAT32_C(  -223.00), EASYSIMD_FLOAT32_C(   120.71) } },
    { { EASYSIMD_FLOAT32_C(   907.59), EASYSIMD_FLOAT32_C(     9.60) },
      { EASYSIMD_FLOAT32_C(     9.60), EASYSIMD_FLOAT32_C(   907.59) } },
    { { EASYSIMD_FLOAT32_C(   135.79), EASYSIMD_FLOAT32_C(   135.93) },
      { EASYSIMD_FLOAT32_C(   135.93), EASYSIMD_FLOAT32_C(   135.79) } },
    { { EASYSIMD_FLOAT32_C(  -918.57), EASYSIMD_FLOAT32_C(  -483.52) },
      { EASYSIMD_FLOAT32_C(  -483.52), EASYSIMD_FLOAT32_C(  -918.57) } },
    { { EASYSIMD_FLOAT32_C(  -308.42), EASYSIMD_FLOAT32_C(   475.73) },
      { EASYSIMD_FLOAT32_C(   475.73), EASYSIMD_FLOAT32_C(  -308.42) } },
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float32x2_t a = easysimd_vld1_f32(test_vec[i].a);
    easysimd_float32x2_t r = easysimd_vrev64_f32(a);
...
static int
test_easysimd_vrev64q_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int8_t a[16];
    int8_t r[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int8x16_t r = easysimd_vrev64q_s8(a);
...
static int
test_easysimd_vrev64q_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int16_t a[8];
    int16_t r[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int16x8_t r = easysimd_vrev64q_s16(a);
...
static int
test_easysimd_vrev64q_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t a[4];
    int32_t r[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x4_t r = easysimd_vrev64q_s32(a);
...
static int
test_easysimd_vrev64q_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint8_t a[16];
    uint8_t r[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x16_t r = easysimd_vrev64q_u8(a);
...
static int
test_easysimd_vrev64q_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint16_t a[8];
    uint16_t r[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x8_t r = easysimd_vrev64q_u16(a);
...
static int
test_easysimd_vrev64q_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint32_t a[4];
    uint32_t r[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x4_t r = easysimd_vrev64q_u32(a);
...
static int
test_easysimd_vrev64q_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    easysimd_float32 a[4];
    easysimd_float32 r[4];
  } test_vec[] = {
    { { EASYSIMD_FLOAT32_C(  -324.81), EASYSIMD_FLOAT32_C(  -870.47), EASYSIMD_FLOAT32_C(   342.98), EASYSIMD_FLOAT32_C(  -492.44) },
      { EASYSIMD_FLOAT32_C(  -870.47), EASYSIMD_FLOAT32_C(  -324.81), EASYSIMD_FLOAT32_C(  -492.44), EASYSIMD_FLOAT32_C(   342.98) } },
    { { EASYSIMD_FLOAT32_C(  -289.18), EASYSIMD_FLOAT32_C(  -318.73), EASYSIMD_FLOAT32_C(  -927.82), EASYSIMD_FLOAT32_C(   328.84) },
      { EASYSIMD_FLOAT32_C(  -318.73), EASYSIMD_FLOAT32_C(  -289.18), EASYSIMD_FLOAT32_C(   328.84), EASYSIMD_FLOAT32_C(  -927.82) } },
    { { EASYSIMD_FLOAT32_C(  -870.55), EASYSIMD_FLOAT32_C(  -305.56), EASYSIMD_FLOAT32_C(   -62.60), EASYSIMD_FLOAT32_C(  -509.92) },
      { EASYSIMD_FLOAT32_C(  -305.56), EASYSIMD_FLOAT32_C(  -870.55), EASYSIMD_FLOAT32_C(  -509.92), EASYSIMD_FLOAT32_C(   -62.60) } },
    { { EASYSIMD_FLOAT32_C(    55.68), EASYSIMD_FLOAT32_C(   856.66), EASYSIMD_FLOAT32_C(  -934.25), EASYSIMD_FLOAT32_C(   336.42) },
      { EASYSIMD_FLOAT32_C(   856.66), EASYSIMD_FLOAT32_C(    55.68), EASYSIMD_FLOAT32_C(   336.42), EASYSIMD_FLOAT32_C(  -934.25) } },
    { { EASYSIMD_FLOAT32_C(   501.43), EASYSIMD_FLOAT32_C(  -571.21), EASYSIMD_FLOAT32_C(  -251.52), EASYSIMD_FLOAT32_C(   672.13) },
      { EASYSIMD_FLOAT32_C(  -571.21), EASYSIMD_FLOAT32_C(   501.43), EASYSIMD_FLOAT32_C(   672.13), EASYSIMD_FLOAT32_C(  -251.52) } },
    { { EASYSIMD_FLOAT32_C(   844.20), EASYSIMD_FLOAT32_C(    87.76), EASYSIMD_FLOAT32_C(   609.29), EASYSIMD_FLOAT32_C(   856.58) },
      { EASYSIMD_FLOAT32_C(    87.76), EASYSIMD_FLOAT32_C(   844.20), EASYSIMD_FLOAT32_C(   856.58), EASYSIMD_FLOAT32_C(   609.29) } },
    { { EASYSIMD_FLOAT32_C(  -229.44), EASYSIMD_FLOAT32_C(  -640.32), EASYSIMD_FLOAT32_C(  -844.07), EASYSIMD_FLOAT32_C(   466.08) },
      { EASYSIMD_FLOAT32_C(  -640.32), EASYSIMD_FLOAT32_C(  -229.44), EASYSIMD_FLOAT32_C(   466.08), EASYSIMD_FLOAT32_C(  -844.07) } },
    { { EASYSIMD_FLOAT32_C(   517.84), EASYSIMD_FLOAT32_C(   101.16), EASYSIMD_FLOAT32_C(   322.38), EASYSIMD_FLOAT32_C(  -806.97) },
      { EASYSIMD_FLOAT32_C(   101.16), EASYSIMD_FLOAT32_C(   517.84), EASYSIMD_FLOAT32_C(  -806.97), EASYSIMD_FLOAT32_C(   322.38) } },
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float32x4_t a = easysimd_vld1q_f32(test_vec[i].a);
    easysimd_float32x4_t r = easysimd_vrev64q_f32(a);
...
EASYSIMD_TEST_FUNC_LIST_ENTRY(vrev64_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vrev64_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vrev64_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vrev64_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vrev64_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vrev64_u32)
//EASYSIMD_TEST_FUNC_LIST_ENTRY(vrev64_f16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vrev64_f32)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vrev64q_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vrev64q_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vrev64q_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vrev64q_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vrev64q_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vrev64q_u32)
//EASYSIMD_TEST_FUNC_LIST_ENTRY(vrev64q_f16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vrev64q_f32)
