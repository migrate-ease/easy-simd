#define EASYSIMD_TEST_ARM_NEON_INSN rshl

#include "test-neon.h"

/* Check that both of these work */
#if defined(__cplusplus)
  #include "../../../easysimd/arm/neon/rshl.h"
#else
...
static int
test_easysimd_vrshl_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  struct {
    int8_t a[8];
    int8_t b[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int8x8_t r = easysimd_vrshl_s8(a, b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    for (size_t j = 0 ; j < (sizeof(b_.values) / sizeof(b_.values[0])) ; j++) {
      if (probability(PROBABILITY)) {
        while (easysimd_math_abs(b_.values[j]) > 8) {
          b_.values[j] >>= 1;
        }
      }
    }
...
static int
test_easysimd_vrshl_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  struct {
    int16_t a[4];
    int16_t b[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int16x4_t r = easysimd_vrshl_s16(a, b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    for (size_t j = 0 ; j < (sizeof(b_.values) / sizeof(b_.values[0])) ; j++) {
      if (probability(PROBABILITY)) {
        while (easysimd_math_abs(b_.values[j]) > 16) {
          b_.values[j] >>= 1;
        }
      }
    }
...
static int
test_easysimd_vrshl_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  struct {
    int32_t a[2];
    int32_t b[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x2_t r = easysimd_vrshl_s32(a, b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    for (size_t j = 0 ; j < (sizeof(b_.values) / sizeof(b_.values[0])) ; j++) {
      if (probability(PROBABILITY)) {
        while (easysimd_math_abs(b_.values[j]) > 32) {
          b_.values[j] >>= 1;
        }
      }
    }
...
static int
test_easysimd_vrshl_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  struct {
    int64_t a[1];
    int64_t b[1];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int64x1_t r = easysimd_vrshl_s64(a, b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    for (size_t j = 0 ; j < (sizeof(b_.values) / sizeof(b_.values[0])) ; j++) {
      if (probability(PROBABILITY)) {
        while (easysimd_math_llabs(b_.values[j]) > 64) {
          b_.values[j] >>= 1;
        }
      }
    }
...
static int
test_easysimd_vrshl_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  struct {
    uint8_t a[8];
    int8_t b[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int8x8_t b = easysimd_vld1_s8(test_vec[i].b);
    easysimd_uint8x8_t r = easysimd_vrshl_u8(a, b);
...
static int
test_easysimd_vrshl_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  struct {
    uint16_t a[4];
    int16_t b[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int16x4_t b = easysimd_vld1_s16(test_vec[i].b);
    easysimd_uint16x4_t r = easysimd_vrshl_u16(a, b);
...
static int
test_easysimd_vrshl_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  struct {
    uint32_t a[2];
    int32_t b[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x2_t b = easysimd_vld1_s32(test_vec[i].b);
    easysimd_uint32x2_t r = easysimd_vrshl_u32(a, b);
...
static int
test_easysimd_vrshl_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  struct {
    uint64_t a[1];
    int64_t b[1];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int64x1_t b = easysimd_vld1_s64(test_vec[i].b);
    easysimd_uint64x1_t r = easysimd_vrshl_u64(a, b);
...
static int
test_easysimd_vrshlq_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  struct {
    int8_t a[16];
    int8_t b[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int8x16_t r = easysimd_vrshlq_s8(a, b);
...
static int
test_easysimd_vrshlq_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  struct {
    int16_t a[8];
    int16_t b[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int16x8_t r = easysimd_vrshlq_s16(a, b);
...
static int
test_easysimd_vrshlq_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  struct {
    int32_t a[4];
    int32_t b[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x4_t r = easysimd_vrshlq_s32(a, b);
...
static int
test_easysimd_vrshlq_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  struct {
    int64_t a[2];
    int64_t b[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int64x2_t r = easysimd_vrshlq_s64(a, b);
...
static int
test_easysimd_vrshlq_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  struct {
    uint8_t a[16];
    int8_t b[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int8x16_t b = easysimd_vld1q_s8(test_vec[i].b);
    easysimd_uint8x16_t r = easysimd_vrshlq_u8(a, b);
...
static int
test_easysimd_vrshlq_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  struct {
    uint16_t a[8];
    int16_t b[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int16x8_t b = easysimd_vld1q_s16(test_vec[i].b);
    easysimd_uint16x8_t r = easysimd_vrshlq_u16(a, b);
...
static int
test_easysimd_vrshlq_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  struct {
    uint32_t a[4];
    int32_t b[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x4_t b = easysimd_vld1q_s32(test_vec[i].b);
    easysimd_uint32x4_t r = easysimd_vrshlq_u32(a, b);
...
static int
test_easysimd_vrshlq_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  struct {
    uint64_t a[2];
    int64_t b[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int64x2_t b = easysimd_vld1q_s64(test_vec[i].b);
    easysimd_uint64x2_t r = easysimd_vrshlq_u64(a, b);
...
static int
test_easysimd_vrshld_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  struct {
    int64_t a;
    int64_t b;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    int64_t r = easysimd_vrshld_s64(test_vec[i].a, test_vec[i].b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    int64_t r = easysimd_vrshld_s64(a, b);
...
EASYSIMD_TEST_FUNC_LIST_ENTRY(vrshl_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vrshl_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vrshl_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vrshl_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vrshl_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vrshl_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vrshl_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vrshl_u64)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vrshlq_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vrshlq_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vrshlq_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vrshlq_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vrshlq_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vrshlq_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vrshlq_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vrshlq_u64)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vrshld_s64)
