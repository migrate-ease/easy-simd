#define EASYSIMD_TEST_ARM_NEON_INSN rshr_n

#include "test-neon.h"

/* Check that both of these work */
#if defined(__cplusplus)
  #include "../../../easysimd/arm/neon/rshr_n.h"
#else
  #include "../../../easysimd/arm/neon.h"
#endif

static int
test_easysimd_vrshr_n_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int8_t a[8];
    int8_t r1[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int8x8_t r1 = easysimd_vrshr_n_s8(a, 1);
    easysimd_int8x8_t r3 = easysimd_vrshr_n_s8(a, 3);
    easysimd_int8x8_t r5 = easysimd_vrshr_n_s8(a, 5);
    easysimd_int8x8_t r6 = easysimd_vrshr_n_s8(a, 6);
    easysimd_int8x8_t r8 = easysimd_vrshr_n_s8(a, 8);

    easysimd_test_arm_neon_assert_equal_i8x8(r1, easysimd_vld1_s8(test_vec[i].r1));
    easysimd_test_arm_neon_assert_equal_i8x8(r3, easysimd_vld1_s8(test_vec[i].r3));
    easysimd_test_arm_neon_assert_equal_i8x8(r5, easysimd_vld1_s8(test_vec[i].r5));
    easysimd_test_arm_neon_assert_equal_i8x8(r6, easysimd_vld1_s8(test_vec[i].r6));
    easysimd_test_arm_neon_assert_equal_i8x8(r8, easysimd_vld1_s8(test_vec[i].r8));
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_test_arm_neon_write_i8x8(2, r1, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_i8x8(2, r3, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_i8x8(2, r5, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_i8x8(2, r6, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_i8x8(2, r8, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
#endif
}
...
static int
test_easysimd_vrshr_n_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int16_t a[4];
    int16_t r3[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int16x4_t r3 = easysimd_vrshr_n_s16(a, 3);
    easysimd_int16x4_t r6 = easysimd_vrshr_n_s16(a, 6);
    easysimd_int16x4_t r10 = easysimd_vrshr_n_s16(a, 10);
    easysimd_int16x4_t r13 = easysimd_vrshr_n_s16(a, 13);
    easysimd_int16x4_t r16 = easysimd_vrshr_n_s16(a, 16);

    easysimd_test_arm_neon_assert_equal_i16x4(r3, easysimd_vld1_s16(test_vec[i].r3));
    easysimd_test_arm_neon_assert_equal_i16x4(r6, easysimd_vld1_s16(test_vec[i].r6));
    easysimd_test_arm_neon_assert_equal_i16x4(r10, easysimd_vld1_s16(test_vec[i].r10));
    easysimd_test_arm_neon_assert_equal_i16x4(r13, easysimd_vld1_s16(test_vec[i].r13));
    easysimd_test_arm_neon_assert_equal_i16x4(r16, easysimd_vld1_s16(test_vec[i].r16));
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_test_arm_neon_write_i16x4(2, r3, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_i16x4(2, r6, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_i16x4(2, r10, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_i16x4(2, r13, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_i16x4(2, r16, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
#endif
}
...
static int
test_easysimd_vrshr_n_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t a[2];
    int32_t r6[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x2_t r6 = easysimd_vrshr_n_s32(a, 6);
    easysimd_int32x2_t r13 = easysimd_vrshr_n_s32(a, 13);
    easysimd_int32x2_t r19 = easysimd_vrshr_n_s32(a, 19);
    easysimd_int32x2_t r26 = easysimd_vrshr_n_s32(a, 26);
    easysimd_int32x2_t r32 = easysimd_vrshr_n_s32(a, 32);

    easysimd_test_arm_neon_assert_equal_i32x2(r6, easysimd_vld1_s32(test_vec[i].r6));
    easysimd_test_arm_neon_assert_equal_i32x2(r13, easysimd_vld1_s32(test_vec[i].r13));
    easysimd_test_arm_neon_assert_equal_i32x2(r19, easysimd_vld1_s32(test_vec[i].r19));
    easysimd_test_arm_neon_assert_equal_i32x2(r26, easysimd_vld1_s32(test_vec[i].r26));
    easysimd_test_arm_neon_assert_equal_i32x2(r32, easysimd_vld1_s32(test_vec[i].r32));
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_test_arm_neon_write_i32x2(2, r6, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_i32x2(2, r13, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_i32x2(2, r19, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_i32x2(2, r26, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_i32x2(2, r32, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
#endif
}
...
static int
test_easysimd_vrshr_n_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int64_t a[1];
    int64_t r13[1];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int64x1_t r13 = easysimd_vrshr_n_s64(a, 13);
    easysimd_int64x1_t r26 = easysimd_vrshr_n_s64(a, 26);
    easysimd_int64x1_t r39 = easysimd_vrshr_n_s64(a, 39);
    easysimd_int64x1_t r52 = easysimd_vrshr_n_s64(a, 52);
    easysimd_int64x1_t r64 = easysimd_vrshr_n_s64(a, 64);

    easysimd_test_arm_neon_assert_equal_i64x1(r13, easysimd_vld1_s64(test_vec[i].r13));
    easysimd_test_arm_neon_assert_equal_i64x1(r26, easysimd_vld1_s64(test_vec[i].r26));
    easysimd_test_arm_neon_assert_equal_i64x1(r39, easysimd_vld1_s64(test_vec[i].r39));
    easysimd_test_arm_neon_assert_equal_i64x1(r52, easysimd_vld1_s64(test_vec[i].r52));
    easysimd_test_arm_neon_assert_equal_i64x1(r64, easysimd_vld1_s64(test_vec[i].r64));
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_test_arm_neon_write_i64x1(2, r13, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_i64x1(2, r26, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_i64x1(2, r39, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_i64x1(2, r52, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_i64x1(2, r64, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
#endif
}
...
static int
test_easysimd_vrshr_n_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint8_t a[8];
    uint8_t r1[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x8_t r1 = easysimd_vrshr_n_u8(a, 1);
    easysimd_uint8x8_t r3 = easysimd_vrshr_n_u8(a, 3);
    easysimd_uint8x8_t r5 = easysimd_vrshr_n_u8(a, 5);
    easysimd_uint8x8_t r6 = easysimd_vrshr_n_u8(a, 6);
    easysimd_uint8x8_t r8 = easysimd_vrshr_n_u8(a, 8);

    easysimd_test_arm_neon_assert_equal_u8x8(r1, easysimd_vld1_u8(test_vec[i].r1));
    easysimd_test_arm_neon_assert_equal_u8x8(r3, easysimd_vld1_u8(test_vec[i].r3));
    easysimd_test_arm_neon_assert_equal_u8x8(r5, easysimd_vld1_u8(test_vec[i].r5));
    easysimd_test_arm_neon_assert_equal_u8x8(r6, easysimd_vld1_u8(test_vec[i].r6));
    easysimd_test_arm_neon_assert_equal_u8x8(r8, easysimd_vld1_u8(test_vec[i].r8));
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_test_arm_neon_write_u8x8(2, r1, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_u8x8(2, r3, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_u8x8(2, r5, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_u8x8(2, r6, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_u8x8(2, r8, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
#endif
}
...
static int
test_easysimd_vrshr_n_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint16_t a[4];
    uint16_t r3[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x4_t r3 = easysimd_vrshr_n_u16(a, 3);
    easysimd_uint16x4_t r6 = easysimd_vrshr_n_u16(a, 6);
    easysimd_uint16x4_t r10 = easysimd_vrshr_n_u16(a, 10);
    easysimd_uint16x4_t r13 = easysimd_vrshr_n_u16(a, 13);
    easysimd_uint16x4_t r16 = easysimd_vrshr_n_u16(a, 16);

    easysimd_test_arm_neon_assert_equal_u16x4(r3, easysimd_vld1_u16(test_vec[i].r3));
    easysimd_test_arm_neon_assert_equal_u16x4(r6, easysimd_vld1_u16(test_vec[i].r6));
    easysimd_test_arm_neon_assert_equal_u16x4(r10, easysimd_vld1_u16(test_vec[i].r10));
    easysimd_test_arm_neon_assert_equal_u16x4(r13, easysimd_vld1_u16(test_vec[i].r13));
    easysimd_test_arm_neon_assert_equal_u16x4(r16, easysimd_vld1_u16(test_vec[i].r16));
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_test_arm_neon_write_u16x4(2, r3, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_u16x4(2, r6, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_u16x4(2, r10, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_u16x4(2, r13, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_u16x4(2, r16, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
#endif
}
...
static int
test_easysimd_vrshr_n_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint32_t a[2];
    uint32_t r6[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x2_t r6 = easysimd_vrshr_n_u32(a, 6);
    easysimd_uint32x2_t r13 = easysimd_vrshr_n_u32(a, 13);
    easysimd_uint32x2_t r19 = easysimd_vrshr_n_u32(a, 19);
    easysimd_uint32x2_t r26 = easysimd_vrshr_n_u32(a, 26);
    easysimd_uint32x2_t r32 = easysimd_vrshr_n_u32(a, 32);

    easysimd_test_arm_neon_assert_equal_u32x2(r6, easysimd_vld1_u32(test_vec[i].r6));
    easysimd_test_arm_neon_assert_equal_u32x2(r13, easysimd_vld1_u32(test_vec[i].r13));
    easysimd_test_arm_neon_assert_equal_u32x2(r19, easysimd_vld1_u32(test_vec[i].r19));
    easysimd_test_arm_neon_assert_equal_u32x2(r26, easysimd_vld1_u32(test_vec[i].r26));
    easysimd_test_arm_neon_assert_equal_u32x2(r32, easysimd_vld1_u32(test_vec[i].r32));
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_test_arm_neon_write_u32x2(2, r6, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_u32x2(2, r13, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_u32x2(2, r19, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_u32x2(2, r26, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_u32x2(2, r32, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
#endif
}
...
static int
test_easysimd_vrshr_n_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint64_t a[1];
    uint64_t r13[1];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint64x1_t r13 = easysimd_vrshr_n_u64(a, 13);
    easysimd_uint64x1_t r26 = easysimd_vrshr_n_u64(a, 26);
    easysimd_uint64x1_t r39 = easysimd_vrshr_n_u64(a, 39);
    easysimd_uint64x1_t r52 = easysimd_vrshr_n_u64(a, 52);
    easysimd_uint64x1_t r64 = easysimd_vrshr_n_u64(a, 64);

    easysimd_test_arm_neon_assert_equal_u64x1(r13, easysimd_vld1_u64(test_vec[i].r13));
    easysimd_test_arm_neon_assert_equal_u64x1(r26, easysimd_vld1_u64(test_vec[i].r26));
    easysimd_test_arm_neon_assert_equal_u64x1(r39, easysimd_vld1_u64(test_vec[i].r39));
    easysimd_test_arm_neon_assert_equal_u64x1(r52, easysimd_vld1_u64(test_vec[i].r52));
    easysimd_test_arm_neon_assert_equal_u64x1(r64, easysimd_vld1_u64(test_vec[i].r64));
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_test_arm_neon_write_u64x1(2, r13, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_u64x1(2, r26, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_u64x1(2, r39, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_u64x1(2, r52, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_u64x1(2, r64, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
#endif
}
...
static int
test_easysimd_vrshrq_n_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int8_t a[16];
    int8_t r1[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int8x16_t r1 = easysimd_vrshrq_n_s8(a, 1);
    easysimd_int8x16_t r3 = easysimd_vrshrq_n_s8(a, 3);
    easysimd_int8x16_t r5 = easysimd_vrshrq_n_s8(a, 5);
    easysimd_int8x16_t r6 = easysimd_vrshrq_n_s8(a, 6);
    easysimd_int8x16_t r8 = easysimd_vrshrq_n_s8(a, 8);

    easysimd_test_arm_neon_assert_equal_i8x16(r1, easysimd_vld1q_s8(test_vec[i].r1));
    easysimd_test_arm_neon_assert_equal_i8x16(r3, easysimd_vld1q_s8(test_vec[i].r3));
    easysimd_test_arm_neon_assert_equal_i8x16(r5, easysimd_vld1q_s8(test_vec[i].r5));
    easysimd_test_arm_neon_assert_equal_i8x16(r6, easysimd_vld1q_s8(test_vec[i].r6));
    easysimd_test_arm_neon_assert_equal_i8x16(r8, easysimd_vld1q_s8(test_vec[i].r8));
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_test_arm_neon_write_i8x16(2, r1, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_i8x16(2, r3, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_i8x16(2, r5, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_i8x16(2, r6, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_i8x16(2, r8, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
#endif
}
...
static int
test_easysimd_vrshrq_n_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int16_t a[8];
    int16_t r3[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int16x8_t r3 = easysimd_vrshrq_n_s16(a, 3);
    easysimd_int16x8_t r6 = easysimd_vrshrq_n_s16(a, 6);
    easysimd_int16x8_t r10 = easysimd_vrshrq_n_s16(a, 10);
    easysimd_int16x8_t r13 = easysimd_vrshrq_n_s16(a, 13);
    easysimd_int16x8_t r16 = easysimd_vrshrq_n_s16(a, 16);

    easysimd_test_arm_neon_assert_equal_i16x8(r3, easysimd_vld1q_s16(test_vec[i].r3));
    easysimd_test_arm_neon_assert_equal_i16x8(r6, easysimd_vld1q_s16(test_vec[i].r6));
    easysimd_test_arm_neon_assert_equal_i16x8(r10, easysimd_vld1q_s16(test_vec[i].r10));
    easysimd_test_arm_neon_assert_equal_i16x8(r13, easysimd_vld1q_s16(test_vec[i].r13));
    easysimd_test_arm_neon_assert_equal_i16x8(r16, easysimd_vld1q_s16(test_vec[i].r16));
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_test_arm_neon_write_i16x8(2, r3, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_i16x8(2, r6, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_i16x8(2, r10, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_i16x8(2, r13, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_i16x8(2, r16, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
#endif
}
...
static int
test_easysimd_vrshrq_n_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t a[4];
    int32_t r6[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x4_t r6 = easysimd_vrshrq_n_s32(a, 6);
    easysimd_int32x4_t r13 = easysimd_vrshrq_n_s32(a, 13);
    easysimd_int32x4_t r19 = easysimd_vrshrq_n_s32(a, 19);
    easysimd_int32x4_t r26 = easysimd_vrshrq_n_s32(a, 26);
    easysimd_int32x4_t r32 = easysimd_vrshrq_n_s32(a, 32);

    easysimd_test_arm_neon_assert_equal_i32x4(r6, easysimd_vld1q_s32(test_vec[i].r6));
    easysimd_test_arm_neon_assert_equal_i32x4(r13, easysimd_vld1q_s32(test_vec[i].r13));
    easysimd_test_arm_neon_assert_equal_i32x4(r19, easysimd_vld1q_s32(test_vec[i].r19));
    easysimd_test_arm_neon_assert_equal_i32x4(r26, easysimd_vld1q_s32(test_vec[i].r26));
    easysimd_test_arm_neon_assert_equal_i32x4(r32, easysimd_vld1q_s32(test_vec[i].r32));
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_test_arm_neon_write_i32x4(2, r6, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_i32x4(2, r13, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_i32x4(2, r19, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_i32x4(2, r26, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_i32x4(2, r32, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
#endif
}
...
static int
test_easysimd_vrshrq_n_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int64_t a[2];
    int64_t r13[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int64x2_t r13 = easysimd_vrshrq_n_s64(a, 13);
    easysimd_int64x2_t r26 = easysimd_vrshrq_n_s64(a, 26);
    easysimd_int64x2_t r39 = easysimd_vrshrq_n_s64(a, 39);
    easysimd_int64x2_t r52 = easysimd_vrshrq_n_s64(a, 52);
    easysimd_int64x2_t r64 = easysimd_vrshrq_n_s64(a, 64);

    easysimd_test_arm_neon_assert_equal_i64x2(r13, easysimd_vld1q_s64(test_vec[i].r13));
    easysimd_test_arm_neon_assert_equal_i64x2(r26, easysimd_vld1q_s64(test_vec[i].r26));
    easysimd_test_arm_neon_assert_equal_i64x2(r39, easysimd_vld1q_s64(test_vec[i].r39));
    easysimd_test_arm_neon_assert_equal_i64x2(r52, easysimd_vld1q_s64(test_vec[i].r52));
    easysimd_test_arm_neon_assert_equal_i64x2(r64, easysimd_vld1q_s64(test_vec[i].r64));
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_test_arm_neon_write_i64x2(2, r13, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_i64x2(2, r26, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_i64x2(2, r39, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_i64x2(2, r52, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_i64x2(2, r64, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
#endif
}
...
static int
test_easysimd_vrshrq_n_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint8_t a[16];
    uint8_t r1[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x16_t r1 = easysimd_vrshrq_n_u8(a, 1);
    easysimd_uint8x16_t r3 = easysimd_vrshrq_n_u8(a, 3);
    easysimd_uint8x16_t r5 = easysimd_vrshrq_n_u8(a, 5);
    easysimd_uint8x16_t r6 = easysimd_vrshrq_n_u8(a, 6);
    easysimd_uint8x16_t r8 = easysimd_vrshrq_n_u8(a, 8);

    easysimd_test_arm_neon_assert_equal_u8x16(r1, easysimd_vld1q_u8(test_vec[i].r1));
    easysimd_test_arm_neon_assert_equal_u8x16(r3, easysimd_vld1q_u8(test_vec[i].r3));
    easysimd_test_arm_neon_assert_equal_u8x16(r5, easysimd_vld1q_u8(test_vec[i].r5));
    easysimd_test_arm_neon_assert_equal_u8x16(r6, easysimd_vld1q_u8(test_vec[i].r6));
    easysimd_test_arm_neon_assert_equal_u8x16(r8, easysimd_vld1q_u8(test_vec[i].r8));
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_test_arm_neon_write_u8x16(2, r1, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_u8x16(2, r3, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_u8x16(2, r5, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_u8x16(2, r6, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_u8x16(2, r8, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
#endif
}
...
static int
test_easysimd_vrshrq_n_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint16_t a[8];
    uint16_t r3[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x8_t r3 = easysimd_vrshrq_n_u16(a, 3);
    easysimd_uint16x8_t r6 = easysimd_vrshrq_n_u16(a, 6);
    easysimd_uint16x8_t r10 = easysimd_vrshrq_n_u16(a, 10);
    easysimd_uint16x8_t r13 = easysimd_vrshrq_n_u16(a, 13);
    easysimd_uint16x8_t r16 = easysimd_vrshrq_n_u16(a, 16);

    easysimd_test_arm_neon_assert_equal_u16x8(r3, easysimd_vld1q_u16(test_vec[i].r3));
    easysimd_test_arm_neon_assert_equal_u16x8(r6, easysimd_vld1q_u16(test_vec[i].r6));
    easysimd_test_arm_neon_assert_equal_u16x8(r10, easysimd_vld1q_u16(test_vec[i].r10));
    easysimd_test_arm_neon_assert_equal_u16x8(r13, easysimd_vld1q_u16(test_vec[i].r13));
    easysimd_test_arm_neon_assert_equal_u16x8(r16, easysimd_vld1q_u16(test_vec[i].r16));
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_test_arm_neon_write_u16x8(2, r3, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_u16x8(2, r6, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_u16x8(2, r10, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_u16x8(2, r13, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_u16x8(2, r16, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
#endif
}
...
static int
test_easysimd_vrshrq_n_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint32_t a[4];
    uint32_t r6[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x4_t r6 = easysimd_vrshrq_n_u32(a, 6);
    easysimd_uint32x4_t r13 = easysimd_vrshrq_n_u32(a, 13);
    easysimd_uint32x4_t r19 = easysimd_vrshrq_n_u32(a, 19);
    easysimd_uint32x4_t r26 = easysimd_vrshrq_n_u32(a, 26);
    easysimd_uint32x4_t r32 = easysimd_vrshrq_n_u32(a, 32);

    easysimd_test_arm_neon_assert_equal_u32x4(r6, easysimd_vld1q_u32(test_vec[i].r6));
    easysimd_test_arm_neon_assert_equal_u32x4(r13, easysimd_vld1q_u32(test_vec[i].r13));
    easysimd_test_arm_neon_assert_equal_u32x4(r19, easysimd_vld1q_u32(test_vec[i].r19));
    easysimd_test_arm_neon_assert_equal_u32x4(r26, easysimd_vld1q_u32(test_vec[i].r26));
    easysimd_test_arm_neon_assert_equal_u32x4(r32, easysimd_vld1q_u32(test_vec[i].r32));
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_test_arm_neon_write_u32x4(2, r6, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_u32x4(2, r13, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_u32x4(2, r19, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_u32x4(2, r26, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_u32x4(2, r32, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
#endif
}
...
static int
test_easysimd_vrshrq_n_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint64_t a[2];
    uint64_t r13[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint64x2_t r13 = easysimd_vrshrq_n_u64(a, 13);
    easysimd_uint64x2_t r26 = easysimd_vrshrq_n_u64(a, 26);
    easysimd_uint64x2_t r39 = easysimd_vrshrq_n_u64(a, 39);
    easysimd_uint64x2_t r52 = easysimd_vrshrq_n_u64(a, 52);
    easysimd_uint64x2_t r64 = easysimd_vrshrq_n_u64(a, 64);

    easysimd_test_arm_neon_assert_equal_u64x2(r13, easysimd_vld1q_u64(test_vec[i].r13));
    easysimd_test_arm_neon_assert_equal_u64x2(r26, easysimd_vld1q_u64(test_vec[i].r26));
    easysimd_test_arm_neon_assert_equal_u64x2(r39, easysimd_vld1q_u64(test_vec[i].r39));
    easysimd_test_arm_neon_assert_equal_u64x2(r52, easysimd_vld1q_u64(test_vec[i].r52));
    easysimd_test_arm_neon_assert_equal_u64x2(r64, easysimd_vld1q_u64(test_vec[i].r64));
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_test_arm_neon_write_u64x2(2, r13, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_u64x2(2, r26, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_u64x2(2, r39, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_u64x2(2, r52, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_u64x2(2, r64, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
#endif
}
...
static int
test_easysimd_vrshrd_n_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int64_t a;
    int64_t r13;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    int64_t r13 = easysimd_vrshrd_n_s64(test_vec[i].a, 13);
    int64_t r26 = easysimd_vrshrd_n_s64(test_vec[i].a, 26);
    int64_t r39 = easysimd_vrshrd_n_s64(test_vec[i].a, 39);
    int64_t r52 = easysimd_vrshrd_n_s64(test_vec[i].a, 52);
    int64_t r64 = easysimd_vrshrd_n_s64(test_vec[i].a, 64);

    easysimd_assert_equal_i64(r13, test_vec[i].r13);
    easysimd_assert_equal_i64(r26, test_vec[i].r26);
    easysimd_assert_equal_i64(r39, test_vec[i].r39);
    easysimd_assert_equal_i64(r52, test_vec[i].r52);
    easysimd_assert_equal_i64(r64, test_vec[i].r64);
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    int64_t r13 = easysimd_vrshrd_n_s64(a, 13);
    int64_t r26 = easysimd_vrshrd_n_s64(a, 26);
    int64_t r39 = easysimd_vrshrd_n_s64(a, 39);
    int64_t r52 = easysimd_vrshrd_n_s64(a, 52);
    int64_t r64 = easysimd_vrshrd_n_s64(a, 64);

    easysimd_test_codegen_write_i64(2, a, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_codegen_write_i64(2, r13, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_codegen_write_i64(2, r26, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_codegen_write_i64(2, r39, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_codegen_write_i64(2, r52, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_codegen_write_i64(2, r64, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
#endif
}
...
static int
test_easysimd_vrshrd_n_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint64_t a;
    uint64_t r13;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    uint64_t r13 = easysimd_vrshrd_n_u64(test_vec[i].a, 13);
    uint64_t r26 = easysimd_vrshrd_n_u64(test_vec[i].a, 26);
    uint64_t r39 = easysimd_vrshrd_n_u64(test_vec[i].a, 39);
    uint64_t r52 = easysimd_vrshrd_n_u64(test_vec[i].a, 52);
    uint64_t r64 = easysimd_vrshrd_n_u64(test_vec[i].a, 64);

    easysimd_assert_equal_u64(r13, test_vec[i].r13);
    easysimd_assert_equal_u64(r26, test_vec[i].r26);
    easysimd_assert_equal_u64(r39, test_vec[i].r39);
    easysimd_assert_equal_u64(r52, test_vec[i].r52);
    easysimd_assert_equal_u64(r64, test_vec[i].r64);
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    uint64_t r13 = easysimd_vrshrd_n_u64(a, 13);
    uint64_t r26 = easysimd_vrshrd_n_u64(a, 26);
    uint64_t r39 = easysimd_vrshrd_n_u64(a, 39);
    uint64_t r52 = easysimd_vrshrd_n_u64(a, 52);
    uint64_t r64 = easysimd_vrshrd_n_u64(a, 64);

    easysimd_test_codegen_write_u64(2, a, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_codegen_write_u64(2, r13, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_codegen_write_u64(2, r26, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_codegen_write_u64(2, r39, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_codegen_write_u64(2, r52, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_codegen_write_u64(2, r64, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
#endif
}
...
EASYSIMD_TEST_FUNC_LIST_ENTRY(vrshr_n_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vrshr_n_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vrshr_n_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vrshr_n_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vrshr_n_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vrshr_n_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vrshr_n_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vrshr_n_u64)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vrshrq_n_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vrshrq_n_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vrshrq_n_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vrshrq_n_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vrshrq_n_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vrshrq_n_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vrshrq_n_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vrshrq_n_u64)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vrshrd_n_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vrshrd_n_u64)
