#define EASYSIMD_TEST_ARM_NEON_INSN rsra_n

#include <test/arm/neon/test-neon.h>

/* Check that both of these work */
#if defined(__cplusplus)
  #include "../../../easysimd/arm/neon/rsra_n.h"
#else
  #include "../../../easysimd/arm/neon.h"
#endif

static int
test_easysimd_vrsra_n_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int8_t a[8];
    int8_t b[8];
    int8_t r1[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int8x8_t r1 = easysimd_vrsra_n_s8(a, b, 1);
    easysimd_int8x8_t r3 = easysimd_vrsra_n_s8(a, b, 3);
    easysimd_int8x8_t r5 = easysimd_vrsra_n_s8(a, b, 5);
    easysimd_int8x8_t r6 = easysimd_vrsra_n_s8(a, b, 6);
    easysimd_int8x8_t r8 = easysimd_vrsra_n_s8(a, b, 8);
...
static int
test_easysimd_vrsra_n_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int16_t a[4];
    int16_t b[4];
    int16_t r3[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int16x4_t r3 = easysimd_vrsra_n_s16(a, b, 3);
    easysimd_int16x4_t r6 = easysimd_vrsra_n_s16(a, b, 6);
    easysimd_int16x4_t r10 = easysimd_vrsra_n_s16(a, b, 10);
    easysimd_int16x4_t r13 = easysimd_vrsra_n_s16(a, b, 13);
    easysimd_int16x4_t r16 = easysimd_vrsra_n_s16(a, b, 16);
...
static int
test_easysimd_vrsra_n_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int32_t a[2];
    int32_t b[2];
    int32_t r6[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x2_t r6 = easysimd_vrsra_n_s32(a, b, 6);
    easysimd_int32x2_t r13 = easysimd_vrsra_n_s32(a, b, 13);
    easysimd_int32x2_t r19 = easysimd_vrsra_n_s32(a, b, 19);
    easysimd_int32x2_t r26 = easysimd_vrsra_n_s32(a, b, 26);
    easysimd_int32x2_t r32 = easysimd_vrsra_n_s32(a, b, 32);
...
static int
test_easysimd_vrsra_n_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int64_t a[1];
    int64_t b[1];
    int64_t r13[1];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int64x1_t r13 = easysimd_vrsra_n_s64(a, b, 13);
    easysimd_int64x1_t r26 = easysimd_vrsra_n_s64(a, b, 26);
    easysimd_int64x1_t r39 = easysimd_vrsra_n_s64(a, b, 39);
    easysimd_int64x1_t r52 = easysimd_vrsra_n_s64(a, b, 52);
    easysimd_int64x1_t r64 = easysimd_vrsra_n_s64(a, b, 64);
...
static int
test_easysimd_vrsra_n_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint8_t a[8];
    uint8_t b[8];
    uint8_t r1[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x8_t r1 = easysimd_vrsra_n_u8(a, b, 1);
    easysimd_uint8x8_t r3 = easysimd_vrsra_n_u8(a, b, 3);
    easysimd_uint8x8_t r5 = easysimd_vrsra_n_u8(a, b, 5);
    easysimd_uint8x8_t r6 = easysimd_vrsra_n_u8(a, b, 6);
    easysimd_uint8x8_t r8 = easysimd_vrsra_n_u8(a, b, 8);
...
static int
test_easysimd_vrsra_n_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint16_t a[4];
    uint16_t b[4];
    uint16_t r3[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x4_t r3 = easysimd_vrsra_n_u16(a, b, 3);
    easysimd_uint16x4_t r6 = easysimd_vrsra_n_u16(a, b, 6);
    easysimd_uint16x4_t r10 = easysimd_vrsra_n_u16(a, b, 10);
    easysimd_uint16x4_t r13 = easysimd_vrsra_n_u16(a, b, 13);
    easysimd_uint16x4_t r16 = easysimd_vrsra_n_u16(a, b, 16);
...
static int
test_easysimd_vrsra_n_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint32_t a[2];
    uint32_t b[2];
    uint32_t r6[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x2_t r6 = easysimd_vrsra_n_u32(a, b, 6);
    easysimd_uint32x2_t r13 = easysimd_vrsra_n_u32(a, b, 13);
    easysimd_uint32x2_t r19 = easysimd_vrsra_n_u32(a, b, 19);
    easysimd_uint32x2_t r26 = easysimd_vrsra_n_u32(a, b, 26);
    easysimd_uint32x2_t r32 = easysimd_vrsra_n_u32(a, b, 32);
...
static int
test_easysimd_vrsra_n_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint64_t a[1];
    uint64_t b[1];
    uint64_t r13[1];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint64x1_t r13 = easysimd_vrsra_n_u64(a, b, 13);
    easysimd_uint64x1_t r26 = easysimd_vrsra_n_u64(a, b, 26);
    easysimd_uint64x1_t r39 = easysimd_vrsra_n_u64(a, b, 39);
    easysimd_uint64x1_t r52 = easysimd_vrsra_n_u64(a, b, 52);
    easysimd_uint64x1_t r64 = easysimd_vrsra_n_u64(a, b, 64);
...
static int
test_easysimd_vrsraq_n_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int8_t a[16];
    int8_t b[16];
    int8_t r1[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int8x16_t r1 = easysimd_vrsraq_n_s8(a, b, 1);
    easysimd_int8x16_t r3 = easysimd_vrsraq_n_s8(a, b, 3);
    easysimd_int8x16_t r5 = easysimd_vrsraq_n_s8(a, b, 5);
    easysimd_int8x16_t r6 = easysimd_vrsraq_n_s8(a, b, 6);
    easysimd_int8x16_t r8 = easysimd_vrsraq_n_s8(a, b, 8);
...
static int
test_easysimd_vrsraq_n_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int16_t a[8];
    int16_t b[8];
    int16_t r3[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int16x8_t r3 = easysimd_vrsraq_n_s16(a, b, 3);
    easysimd_int16x8_t r6 = easysimd_vrsraq_n_s16(a, b, 6);
    easysimd_int16x8_t r10 = easysimd_vrsraq_n_s16(a, b, 10);
    easysimd_int16x8_t r13 = easysimd_vrsraq_n_s16(a, b, 13);
    easysimd_int16x8_t r16 = easysimd_vrsraq_n_s16(a, b, 16);
...
static int
test_easysimd_vrsraq_n_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int32_t a[4];
    int32_t b[4];
    int32_t r6[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x4_t r6 = easysimd_vrsraq_n_s32(a, b, 6);
    easysimd_int32x4_t r13 = easysimd_vrsraq_n_s32(a, b, 13);
    easysimd_int32x4_t r19 = easysimd_vrsraq_n_s32(a, b, 19);
    easysimd_int32x4_t r26 = easysimd_vrsraq_n_s32(a, b, 26);
    easysimd_int32x4_t r32 = easysimd_vrsraq_n_s32(a, b, 32);
...
static int
test_easysimd_vrsraq_n_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int64_t a[2];
    int64_t b[2];
    int64_t r13[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int64x2_t r13 = easysimd_vrsraq_n_s64(a, b, 13);
    easysimd_int64x2_t r26 = easysimd_vrsraq_n_s64(a, b, 26);
    easysimd_int64x2_t r39 = easysimd_vrsraq_n_s64(a, b, 39);
    easysimd_int64x2_t r52 = easysimd_vrsraq_n_s64(a, b, 52);
    easysimd_int64x2_t r64 = easysimd_vrsraq_n_s64(a, b, 64);
...
static int
test_easysimd_vrsraq_n_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint8_t a[16];
    uint8_t b[16];
    uint8_t r1[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x16_t r1 = easysimd_vrsraq_n_u8(a, b, 1);
    easysimd_uint8x16_t r3 = easysimd_vrsraq_n_u8(a, b, 3);
    easysimd_uint8x16_t r5 = easysimd_vrsraq_n_u8(a, b, 5);
    easysimd_uint8x16_t r6 = easysimd_vrsraq_n_u8(a, b, 6);
    easysimd_uint8x16_t r8 = easysimd_vrsraq_n_u8(a, b, 8);
...
static int
test_easysimd_vrsraq_n_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint16_t a[8];
    uint16_t b[8];
    uint16_t r3[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x8_t r3 = easysimd_vrsraq_n_u16(a, b, 3);
    easysimd_uint16x8_t r6 = easysimd_vrsraq_n_u16(a, b, 6);
    easysimd_uint16x8_t r10 = easysimd_vrsraq_n_u16(a, b, 10);
    easysimd_uint16x8_t r13 = easysimd_vrsraq_n_u16(a, b, 13);
    easysimd_uint16x8_t r16 = easysimd_vrsraq_n_u16(a, b, 16);
...
static int
test_easysimd_vrsraq_n_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint32_t a[4];
    uint32_t b[4];
    uint32_t r6[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x4_t r6 = easysimd_vrsraq_n_u32(a, b, 6);
    easysimd_uint32x4_t r13 = easysimd_vrsraq_n_u32(a, b, 13);
    easysimd_uint32x4_t r19 = easysimd_vrsraq_n_u32(a, b, 19);
    easysimd_uint32x4_t r26 = easysimd_vrsraq_n_u32(a, b, 26);
    easysimd_uint32x4_t r32 = easysimd_vrsraq_n_u32(a, b, 32);
...
static int
test_easysimd_vrsraq_n_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint64_t a[2];
    uint64_t b[2];
    uint64_t r13[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint64x2_t r13 = easysimd_vrsraq_n_u64(a, b, 13);
    easysimd_uint64x2_t r26 = easysimd_vrsraq_n_u64(a, b, 26);
    easysimd_uint64x2_t r39 = easysimd_vrsraq_n_u64(a, b, 39);
    easysimd_uint64x2_t r52 = easysimd_vrsraq_n_u64(a, b, 52);
    easysimd_uint64x2_t r64 = easysimd_vrsraq_n_u64(a, b, 64);
...
static int
test_easysimd_vrsrad_n_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
  #if 1
    struct {
      int64_t a;
      int64_t b;
    ...
    for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
      int64_t r13 = easysimd_vrsrad_n_s64(test_vec[i].a, test_vec[i].b, 13);
      int64_t r26 = easysimd_vrsrad_n_s64(test_vec[i].a, test_vec[i].b, 26);
      int64_t r39 = easysimd_vrsrad_n_s64(test_vec[i].a, test_vec[i].b, 39);
      int64_t r52 = easysimd_vrsrad_n_s64(test_vec[i].a, test_vec[i].b, 52);
      int64_t r64 = easysimd_vrsrad_n_s64(test_vec[i].a, test_vec[i].b, 64);
    ...
    for (int i = 0 ; i < 8 ; i++) {
      ...
      int64_t r13 = easysimd_vrsrad_n_s64(a, b, 13);
      int64_t r26 = easysimd_vrsrad_n_s64(a, b, 26);
      int64_t r39 = easysimd_vrsrad_n_s64(a, b, 39);
      int64_t r52 = easysimd_vrsrad_n_s64(a, b, 52);
      int64_t r64 = easysimd_vrsrad_n_s64(a, b, 64);
...
static int
test_easysimd_vrsrad_n_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
  #if 1
    struct {
      uint64_t a;
      uint64_t b;
    ...
    for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
      uint64_t r13 = easysimd_vrsrad_n_u64(test_vec[i].a, test_vec[i].b, 13);
      uint64_t r26 = easysimd_vrsrad_n_u64(test_vec[i].a, test_vec[i].b, 26);
      uint64_t r39 = easysimd_vrsrad_n_u64(test_vec[i].a, test_vec[i].b, 39);
      uint64_t r52 = easysimd_vrsrad_n_u64(test_vec[i].a, test_vec[i].b, 52);
      uint64_t r64 = easysimd_vrsrad_n_u64(test_vec[i].a, test_vec[i].b, 64);
    ...
    for (int i = 0 ; i < 8 ; i++) {
      ...
      uint64_t r13 = easysimd_vrsrad_n_u64(a, b, 13);
      uint64_t r26 = easysimd_vrsrad_n_u64(a, b, 26);
      uint64_t r39 = easysimd_vrsrad_n_u64(a, b, 39);
      uint64_t r52 = easysimd_vrsrad_n_u64(a, b, 52);
      uint64_t r64 = easysimd_vrsrad_n_u64(a, b, 64);
...
EASYSIMD_TEST_FUNC_LIST_ENTRY(vrsra_n_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vrsra_n_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vrsra_n_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vrsra_n_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vrsra_n_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vrsra_n_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vrsra_n_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vrsra_n_u64)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vrsraq_n_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vrsraq_n_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vrsraq_n_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vrsraq_n_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vrsraq_n_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vrsraq_n_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vrsraq_n_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vrsraq_n_u64)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vrsrad_n_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vrsrad_n_u64)
