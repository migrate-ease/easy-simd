#define EASYSIMD_TEST_ARM_NEON_INSN set_lane

#include "test-neon.h"
#include "../../../easysimd/arm/neon/set_lane.h"

HEDLEY_DIAGNOSTIC_PUSH
EASYSIMD_DIAGNOSTIC_DISABLE_UNREACHABLE_

static int
test_easysimd_vset_lane_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    easysimd_float32 a;
    easysimd_float32 v[2];
    easysimd_float32 r[2];
    int lane;
  } test_vec[] = {
    { EASYSIMD_FLOAT32_C(  -373.45),
      { EASYSIMD_FLOAT32_C(   -29.14), EASYSIMD_FLOAT32_C(  -643.20) },
      { EASYSIMD_FLOAT32_C(  -373.45), EASYSIMD_FLOAT32_C(  -643.20) },
       INT32_C(           0) },
    { EASYSIMD_FLOAT32_C(  -393.25),
      { EASYSIMD_FLOAT32_C(   559.43), EASYSIMD_FLOAT32_C(   188.28) },
      { EASYSIMD_FLOAT32_C(   559.43), EASYSIMD_FLOAT32_C(  -393.25) },
       INT32_C(           1) },
    { EASYSIMD_FLOAT32_C(  -417.57),
      { EASYSIMD_FLOAT32_C(  -310.73), EASYSIMD_FLOAT32_C(  -403.05) },
      { EASYSIMD_FLOAT32_C(  -417.57), EASYSIMD_FLOAT32_C(  -403.05) },
       INT32_C(           0) },
    { EASYSIMD_FLOAT32_C(   648.73),
      { EASYSIMD_FLOAT32_C(  -615.41), EASYSIMD_FLOAT32_C(  -429.89) },
      { EASYSIMD_FLOAT32_C(  -615.41), EASYSIMD_FLOAT32_C(   648.73) },
       INT32_C(           1) },
    { EASYSIMD_FLOAT32_C(  -883.49),
      { EASYSIMD_FLOAT32_C(   683.52), EASYSIMD_FLOAT32_C(  -808.37) },
      { EASYSIMD_FLOAT32_C(  -883.49), EASYSIMD_FLOAT32_C(  -808.37) },
       INT32_C(           0) },
    { EASYSIMD_FLOAT32_C(  -958.79),
      { EASYSIMD_FLOAT32_C(  -189.00), EASYSIMD_FLOAT32_C(  -443.44) },
      { EASYSIMD_FLOAT32_C(  -189.00), EASYSIMD_FLOAT32_C(  -958.79) },
       INT32_C(           1) },
    { EASYSIMD_FLOAT32_C(  -384.49),
      { EASYSIMD_FLOAT32_C(  -569.39), EASYSIMD_FLOAT32_C(    61.86) },
      { EASYSIMD_FLOAT32_C(  -384.49), EASYSIMD_FLOAT32_C(    61.86) },
       INT32_C(           0) },
    { EASYSIMD_FLOAT32_C(  -147.57),
      { EASYSIMD_FLOAT32_C(  -852.16), EASYSIMD_FLOAT32_C(   891.56) },
      { EASYSIMD_FLOAT32_C(  -852.16), EASYSIMD_FLOAT32_C(  -147.57) },
       INT32_C(           1) },
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    EASYSIMD_CONSTIFY_2_(easysimd_vset_lane_f32, r, (HEDLEY_UNREACHABLE(), v), lane, a, v);
...
static int
test_easysimd_vset_lane_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    easysimd_float64 a;
    easysimd_float64 v[1];
    easysimd_float64 r[1];
  } test_vec[] = {
    { EASYSIMD_FLOAT64_C(  -818.08),
      { EASYSIMD_FLOAT64_C(  -697.80) },
      { EASYSIMD_FLOAT64_C(  -818.08) } },
    { EASYSIMD_FLOAT64_C(   601.34),
      { EASYSIMD_FLOAT64_C(   459.90) },
      { EASYSIMD_FLOAT64_C(   601.34) } },
    { EASYSIMD_FLOAT64_C(   447.26),
      { EASYSIMD_FLOAT64_C(  -758.22) },
      { EASYSIMD_FLOAT64_C(   447.26) } },
    { EASYSIMD_FLOAT64_C(   101.07),
      { EASYSIMD_FLOAT64_C(    15.34) },
      { EASYSIMD_FLOAT64_C(   101.07) } },
    { EASYSIMD_FLOAT64_C(    79.96),
      { EASYSIMD_FLOAT64_C(   259.71) },
      { EASYSIMD_FLOAT64_C(    79.96) } },
    { EASYSIMD_FLOAT64_C(  -390.89),
      { EASYSIMD_FLOAT64_C(   316.98) },
      { EASYSIMD_FLOAT64_C(  -390.89) } },
    { EASYSIMD_FLOAT64_C(   966.83),
      { EASYSIMD_FLOAT64_C(   767.40) },
      { EASYSIMD_FLOAT64_C(   966.83) } },
    { EASYSIMD_FLOAT64_C(  -253.76),
      { EASYSIMD_FLOAT64_C(  -391.61) },
      { EASYSIMD_FLOAT64_C(  -253.76) } }
  };
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_float64x1_t r = easysimd_vset_lane_f64(a, v, 0);
...
static int
test_easysimd_vset_lane_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int8_t a;
    int8_t v[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int8x8_t v = easysimd_vld1_s8(test_vec[i].v);
    int lane = test_vec[i].lane;
    easysimd_int8x8_t r;
    EASYSIMD_CONSTIFY_8_(easysimd_vset_lane_s8, r, (HEDLEY_UNREACHABLE(), v), lane, a, v);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_int8x8_t v = easysimd_test_arm_neon_random_i8x8();
    int lane = lanes[i];
    easysimd_int8x8_t r;
    EASYSIMD_CONSTIFY_8_(easysimd_vset_lane_s8, r, (HEDLEY_UNREACHABLE(), v), lane, a, v);

    easysimd_test_codegen_write_i8(2, a, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_arm_neon_write_i8x8(2, v, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_i8x8(2, r, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_codegen_write_i32(2, lane, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
#endif
...
static int
test_easysimd_vset_lane_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int16_t a;
    int16_t v[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int16x4_t v = easysimd_vld1_s16(test_vec[i].v);
    int lane = test_vec[i].lane;
    easysimd_int16x4_t r;
    EASYSIMD_CONSTIFY_4_(easysimd_vset_lane_s16, r, (HEDLEY_UNREACHABLE(), v), lane, a, v);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_int16x4_t v = easysimd_test_arm_neon_random_i16x4();
    int lane = lanes[i];
    easysimd_int16x4_t r;
    EASYSIMD_CONSTIFY_4_(easysimd_vset_lane_s16, r, (HEDLEY_UNREACHABLE(), v), lane, a, v);

    easysimd_test_codegen_write_i16(2, a, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_arm_neon_write_i16x4(2, v, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_i16x4(2, r, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_codegen_write_i32(2, lane, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
#endif
...
static int
test_easysimd_vset_lane_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t a;
    int32_t v[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x2_t v = easysimd_vld1_s32(test_vec[i].v);
    int lane = test_vec[i].lane;
    easysimd_int32x2_t r;
    EASYSIMD_CONSTIFY_2_(easysimd_vset_lane_s32, r, (HEDLEY_UNREACHABLE(), v), lane, a, v);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_int32x2_t v = easysimd_test_arm_neon_random_i32x2();
    int lane = lanes[i];
    easysimd_int32x2_t r;
    EASYSIMD_CONSTIFY_2_(easysimd_vset_lane_s32, r, (HEDLEY_UNREACHABLE(), v), lane, a, v);

    easysimd_test_codegen_write_i32(2, a, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_arm_neon_write_i32x2(2, v, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_i32x2(2, r, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_codegen_write_i32(2, lane, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
#endif
...
static int
test_easysimd_vset_lane_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int64_t a;
    int64_t v[1];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int64x1_t v = easysimd_vld1_s64(test_vec[i].v);
    easysimd_int64x1_t r = easysimd_vset_lane_s64(a, v, 0);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_int64x1_t v = easysimd_test_arm_neon_random_i64x1();
    easysimd_int64x1_t r = easysimd_vset_lane_s64(a, v, 0);

    easysimd_test_codegen_write_i64(2, a, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_arm_neon_write_i64x1(2, v, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_i64x1(2, r, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_codegen_write_i32(2, lane, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
#endif
...
static int
test_easysimd_vset_lane_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint8_t a;
    uint8_t v[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x8_t v = easysimd_vld1_u8(test_vec[i].v);
    int lane = test_vec[i].lane;
    easysimd_uint8x8_t r;
    EASYSIMD_CONSTIFY_8_(easysimd_vset_lane_u8, r, (HEDLEY_UNREACHABLE(), v), lane, a, v);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_uint8x8_t v = easysimd_test_arm_neon_random_u8x8();
    int lane = lanes[i];
    easysimd_uint8x8_t r;
    EASYSIMD_CONSTIFY_8_(easysimd_vset_lane_u8, r, (HEDLEY_UNREACHABLE(), v), lane, a, v);

    easysimd_test_codegen_write_u8(2, a, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_arm_neon_write_u8x8(2, v, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_u8x8(2, r, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_codegen_write_i32(2, lane, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
#endif
...
static int
test_easysimd_vset_lane_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint16_t a;
    uint16_t v[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x4_t v = easysimd_vld1_u16(test_vec[i].v);
    int lane = test_vec[i].lane;
    easysimd_uint16x4_t r;
    EASYSIMD_CONSTIFY_4_(easysimd_vset_lane_u16, r, (HEDLEY_UNREACHABLE(), v), lane, a, v);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_uint16x4_t v = easysimd_test_arm_neon_random_u16x4();
    int lane = lanes[i];
    easysimd_uint16x4_t r;
    EASYSIMD_CONSTIFY_4_(easysimd_vset_lane_u16, r, (HEDLEY_UNREACHABLE(), v), lane, a, v);

    easysimd_test_codegen_write_u16(2, a, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_arm_neon_write_u16x4(2, v, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_u16x4(2, r, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_codegen_write_i32(2, lane, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
#endif
...
static int
test_easysimd_vset_lane_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint32_t a;
    uint32_t v[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x2_t v = easysimd_vld1_u32(test_vec[i].v);
    int lane = test_vec[i].lane;
    easysimd_uint32x2_t r;
    EASYSIMD_CONSTIFY_2_(easysimd_vset_lane_u32, r, (HEDLEY_UNREACHABLE(), v), lane, a, v);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_uint32x2_t v = easysimd_test_arm_neon_random_u32x2();
    int lane = lanes[i];
    easysimd_uint32x2_t r;
    EASYSIMD_CONSTIFY_2_(easysimd_vset_lane_u32, r, (HEDLEY_UNREACHABLE(), v), lane, a, v);

    easysimd_test_codegen_write_u32(2, a, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_arm_neon_write_u32x2(2, v, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_u32x2(2, r, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_codegen_write_i32(2, lane, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
#endif
...
static int
test_easysimd_vset_lane_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint64_t a;
    uint64_t v[1];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint64x1_t v = easysimd_vld1_u64(test_vec[i].v);
    easysimd_uint64x1_t r = easysimd_vset_lane_u64(a, v, 0);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_uint64x1_t v = easysimd_test_arm_neon_random_u64x1();
    easysimd_uint64x1_t r = easysimd_vset_lane_u64(a, v, 0);

    easysimd_test_codegen_write_u64(2, a, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_arm_neon_write_u64x1(2, v, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_u64x1(2, r, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_codegen_write_i32(2, lane, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
#endif
...
static int
test_easysimd_vsetq_lane_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    easysimd_float32 a;
    easysimd_float32 v[4];
    easysimd_float32 r[4];
    int lane;
  } test_vec[] = {
    { EASYSIMD_FLOAT32_C(   571.97),
      { EASYSIMD_FLOAT32_C(  -685.65), EASYSIMD_FLOAT32_C(   527.31), EASYSIMD_FLOAT32_C(   563.52), EASYSIMD_FLOAT32_C(  -329.90) },
      { EASYSIMD_FLOAT32_C(   571.97), EASYSIMD_FLOAT32_C(   527.31), EASYSIMD_FLOAT32_C(   563.52), EASYSIMD_FLOAT32_C(  -329.90) },
       INT32_C(           0) },
    { EASYSIMD_FLOAT32_C(  -413.88),
      { EASYSIMD_FLOAT32_C(   284.95), EASYSIMD_FLOAT32_C(  -150.39), EASYSIMD_FLOAT32_C(  -996.77), EASYSIMD_FLOAT32_C(  -669.25) },
      { EASYSIMD_FLOAT32_C(   284.95), EASYSIMD_FLOAT32_C(  -413.88), EASYSIMD_FLOAT32_C(  -996.77), EASYSIMD_FLOAT32_C(  -669.25) },
       INT32_C(           1) },
    { EASYSIMD_FLOAT32_C(   -28.31),
      { EASYSIMD_FLOAT32_C(  -917.74), EASYSIMD_FLOAT32_C(   704.61), EASYSIMD_FLOAT32_C(  -331.98), EASYSIMD_FLOAT32_C(   790.85) },
      { EASYSIMD_FLOAT32_C(  -917.74), EASYSIMD_FLOAT32_C(   704.61), EASYSIMD_FLOAT32_C(   -28.31), EASYSIMD_FLOAT32_C(   790.85) },
       INT32_C(           2) },
    { EASYSIMD_FLOAT32_C(  -568.07),
      { EASYSIMD_FLOAT32_C(   411.05), EASYSIMD_FLOAT32_C(  -327.15), EASYSIMD_FLOAT32_C(  -816.35), EASYSIMD_FLOAT32_C(  -260.46) },
      { EASYSIMD_FLOAT32_C(   411.05), EASYSIMD_FLOAT32_C(  -327.15), EASYSIMD_FLOAT32_C(  -816.35), EASYSIMD_FLOAT32_C(  -568.07) },
       INT32_C(           3) },
    { EASYSIMD_FLOAT32_C(  -649.49),
      { EASYSIMD_FLOAT32_C(   712.24), EASYSIMD_FLOAT32_C(  -363.52), EASYSIMD_FLOAT32_C(  -141.46), EASYSIMD_FLOAT32_C(  -532.55) },
      { EASYSIMD_FLOAT32_C(  -649.49), EASYSIMD_FLOAT32_C(  -363.52), EASYSIMD_FLOAT32_C(  -141.46), EASYSIMD_FLOAT32_C(  -532.55) },
       INT32_C(           0) },
    { EASYSIMD_FLOAT32_C(  -673.98),
      { EASYSIMD_FLOAT32_C(  -328.33), EASYSIMD_FLOAT32_C(  -599.26), EASYSIMD_FLOAT32_C(   253.06), EASYSIMD_FLOAT32_C(    22.83) },
      { EASYSIMD_FLOAT32_C(  -328.33), EASYSIMD_FLOAT32_C(  -673.98), EASYSIMD_FLOAT32_C(   253.06), EASYSIMD_FLOAT32_C(    22.83) },
       INT32_C(           1) },
    { EASYSIMD_FLOAT32_C(  -654.71),
      { EASYSIMD_FLOAT32_C(  -174.97), EASYSIMD_FLOAT32_C(   337.18), EASYSIMD_FLOAT32_C(   872.60), EASYSIMD_FLOAT32_C(  -611.45) },
      { EASYSIMD_FLOAT32_C(  -174.97), EASYSIMD_FLOAT32_C(   337.18), EASYSIMD_FLOAT32_C(  -654.71), EASYSIMD_FLOAT32_C(  -611.45) },
       INT32_C(           2) },
    { EASYSIMD_FLOAT32_C(  -992.72),
      { EASYSIMD_FLOAT32_C(  -541.28), EASYSIMD_FLOAT32_C(   673.50), EASYSIMD_FLOAT32_C(  -143.10), EASYSIMD_FLOAT32_C(  -538.05) },
      { EASYSIMD_FLOAT32_C(  -541.28), EASYSIMD_FLOAT32_C(   673.50), EASYSIMD_FLOAT32_C(  -143.10), EASYSIMD_FLOAT32_C(  -992.72) },
       INT32_C(           3) },
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    EASYSIMD_CONSTIFY_4_(easysimd_vsetq_lane_f32, r, (HEDLEY_UNREACHABLE(), v), lane, a, v);
...
static int
test_easysimd_vsetq_lane_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    easysimd_float64 a;
    easysimd_float64 v[2];
    easysimd_float64 r[2];
    int lane;
  } test_vec[] = {
    { EASYSIMD_FLOAT64_C(   293.82),
      { EASYSIMD_FLOAT64_C(   297.03), EASYSIMD_FLOAT64_C(   420.15) },
      { EASYSIMD_FLOAT64_C(   293.82), EASYSIMD_FLOAT64_C(   420.15) },
       INT32_C(           0) },
    { EASYSIMD_FLOAT64_C(  -258.58),
      { EASYSIMD_FLOAT64_C(   -13.57), EASYSIMD_FLOAT64_C(  -351.16) },
      { EASYSIMD_FLOAT64_C(   -13.57), EASYSIMD_FLOAT64_C(  -258.58) },
       INT32_C(           1) },
    { EASYSIMD_FLOAT64_C(   926.74),
      { EASYSIMD_FLOAT64_C(   398.53), EASYSIMD_FLOAT64_C(   288.03) },
      { EASYSIMD_FLOAT64_C(   926.74), EASYSIMD_FLOAT64_C(   288.03) },
       INT32_C(           0) },
    { EASYSIMD_FLOAT64_C(   471.78),
      { EASYSIMD_FLOAT64_C(    53.12), EASYSIMD_FLOAT64_C(    54.20) },
      { EASYSIMD_FLOAT64_C(    53.12), EASYSIMD_FLOAT64_C(   471.78) },
       INT32_C(           1) },
    { EASYSIMD_FLOAT64_C(  -866.38),
      { EASYSIMD_FLOAT64_C(  -780.75), EASYSIMD_FLOAT64_C(   -71.08) },
      { EASYSIMD_FLOAT64_C(  -866.38), EASYSIMD_FLOAT64_C(   -71.08) },
       INT32_C(           0) },
    { EASYSIMD_FLOAT64_C(   629.85),
      { EASYSIMD_FLOAT64_C(  -883.80), EASYSIMD_FLOAT64_C(   -25.61) },
      { EASYSIMD_FLOAT64_C(  -883.80), EASYSIMD_FLOAT64_C(   629.85) },
       INT32_C(           1) },
    { EASYSIMD_FLOAT64_C(  -974.10),
      { EASYSIMD_FLOAT64_C(   564.55), EASYSIMD_FLOAT64_C(   339.50) },
      { EASYSIMD_FLOAT64_C(  -974.10), EASYSIMD_FLOAT64_C(   339.50) },
       INT32_C(           0) },
    { EASYSIMD_FLOAT64_C(  -659.40),
      { EASYSIMD_FLOAT64_C(   273.60), EASYSIMD_FLOAT64_C(  -218.27) },
      { EASYSIMD_FLOAT64_C(   273.60), EASYSIMD_FLOAT64_C(  -659.40) },
       INT32_C(           1) },
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    EASYSIMD_CONSTIFY_2_(easysimd_vsetq_lane_f64, r, (HEDLEY_UNREACHABLE(), v), lane, a, v);
...
static int
test_easysimd_vsetq_lane_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int8_t a;
    int8_t v[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    int8_t a = test_vec[i].a;
    easysimd_int8x16_t v = easysimd_vld1q_s8(test_vec[i].v);
    int lane = test_vec[i].lane;
    easysimd_int8x16_t r;
    EASYSIMD_CONSTIFY_16_(easysimd_vsetq_lane_s8, r, (HEDLEY_UNREACHABLE(), v), lane, a, v);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    int8_t a = easysimd_test_codegen_random_i8();
    easysimd_int8x16_t v = easysimd_test_arm_neon_random_i8x16();
    int lane = lanes[i];
    easysimd_int8x16_t r;
    EASYSIMD_CONSTIFY_16_(easysimd_vsetq_lane_s8, r, (HEDLEY_UNREACHABLE(), v), lane, a, v);

    easysimd_test_codegen_write_i8(2, a, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_arm_neon_write_i8x16(2, v, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_i8x16(2, r, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_codegen_write_i32(2, lane, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
#endif
...
static int
test_easysimd_vsetq_lane_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int16_t a;
    int16_t v[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    int16_t a = test_vec[i].a;
    easysimd_int16x8_t v = easysimd_vld1q_s16(test_vec[i].v);
    int lane = test_vec[i].lane;
    easysimd_int16x8_t r;
    EASYSIMD_CONSTIFY_8_(easysimd_vsetq_lane_s16, r, (HEDLEY_UNREACHABLE(), v), lane, a, v);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    int16_t a = easysimd_test_codegen_random_i16();
    easysimd_int16x8_t v = easysimd_test_arm_neon_random_i16x8();
    int lane = lanes[i];
    easysimd_int16x8_t r;
    EASYSIMD_CONSTIFY_8_(easysimd_vsetq_lane_s16, r, (HEDLEY_UNREACHABLE(), v), lane, a, v);

    easysimd_test_codegen_write_i16(2, a, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_arm_neon_write_i16x8(2, v, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_i16x8(2, r, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_codegen_write_i32(2, lane, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
#endif
...
static int
test_easysimd_vsetq_lane_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t a;
    int32_t v[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    int32_t a = test_vec[i].a;
    easysimd_int32x4_t v = easysimd_vld1q_s32(test_vec[i].v);
    int lane = test_vec[i].lane;
    easysimd_int32x4_t r;
    EASYSIMD_CONSTIFY_4_(easysimd_vsetq_lane_s32, r, (HEDLEY_UNREACHABLE(), v), lane, a, v);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    int32_t a = easysimd_test_codegen_random_i32();
    easysimd_int32x4_t v = easysimd_test_arm_neon_random_i32x4();
    int lane = lanes[i];
    easysimd_int32x4_t r;
    EASYSIMD_CONSTIFY_4_(easysimd_vsetq_lane_s32, r, (HEDLEY_UNREACHABLE(), v), lane, a, v);

    easysimd_test_codegen_write_i32(2, a, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_arm_neon_write_i32x4(2, v, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_i32x4(2, r, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_codegen_write_i32(2, lane, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
#endif
...
static int
test_easysimd_vsetq_lane_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int64_t a;
    int64_t v[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    int64_t a = test_vec[i].a;
    easysimd_int64x2_t v = easysimd_vld1q_s64(test_vec[i].v);
    int lane = test_vec[i].lane;
    easysimd_int64x2_t r;
    EASYSIMD_CONSTIFY_2_(easysimd_vsetq_lane_s64, r, (HEDLEY_UNREACHABLE(), v), lane, a, v);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    int64_t a = easysimd_test_codegen_random_i64();
    easysimd_int64x2_t v = easysimd_test_arm_neon_random_i64x2();
    int lane = lanes[i];
    easysimd_int64x2_t r;
    EASYSIMD_CONSTIFY_2_(easysimd_vsetq_lane_s64, r, (HEDLEY_UNREACHABLE(), v), lane, a, v);

    easysimd_test_codegen_write_i64(2, a, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_arm_neon_write_i64x2(2, v, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_i64x2(2, r, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_codegen_write_i32(2, lane, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
#endif
...
static int
test_easysimd_vsetq_lane_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint8_t a;
    uint8_t v[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    uint8_t a = test_vec[i].a;
    easysimd_uint8x16_t v = easysimd_vld1q_u8(test_vec[i].v);
    int lane = test_vec[i].lane;
    easysimd_uint8x16_t r;
    EASYSIMD_CONSTIFY_16_(easysimd_vsetq_lane_u8, r, (HEDLEY_UNREACHABLE(), v), lane, a, v);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    uint8_t a = easysimd_test_codegen_random_u8();
    easysimd_uint8x16_t v = easysimd_test_arm_neon_random_u8x16();
    int lane = lanes[i];
    easysimd_uint8x16_t r;
    EASYSIMD_CONSTIFY_16_(easysimd_vsetq_lane_u8, r, (HEDLEY_UNREACHABLE(), v), lane, a, v);

    easysimd_test_codegen_write_u8(2, a, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_arm_neon_write_u8x16(2, v, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_u8x16(2, r, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_codegen_write_i32(2, lane, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
#endif
...
static int
test_easysimd_vsetq_lane_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint16_t a;
    uint16_t v[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    uint16_t a = test_vec[i].a;
    easysimd_uint16x8_t v = easysimd_vld1q_u16(test_vec[i].v);
    int lane = test_vec[i].lane;
    easysimd_uint16x8_t r;
    EASYSIMD_CONSTIFY_8_(easysimd_vsetq_lane_u16, r, (HEDLEY_UNREACHABLE(), v), lane, a, v);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    uint16_t a = easysimd_test_codegen_random_u16();
    easysimd_uint16x8_t v = easysimd_test_arm_neon_random_u16x8();
    int lane = lanes[i];
    easysimd_uint16x8_t r;
    EASYSIMD_CONSTIFY_8_(easysimd_vsetq_lane_u16, r, (HEDLEY_UNREACHABLE(), v), lane, a, v);

    easysimd_test_codegen_write_u16(2, a, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_arm_neon_write_u16x8(2, v, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_u16x8(2, r, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_codegen_write_i32(2, lane, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
#endif
...
static int
test_easysimd_vsetq_lane_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint32_t a;
    uint32_t v[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    uint32_t a = test_vec[i].a;
    easysimd_uint32x4_t v = easysimd_vld1q_u32(test_vec[i].v);
    int lane = test_vec[i].lane;
    easysimd_uint32x4_t r;
    EASYSIMD_CONSTIFY_4_(easysimd_vsetq_lane_u32, r, (HEDLEY_UNREACHABLE(), v), lane, a, v);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    uint32_t a = easysimd_test_codegen_random_u32();
    easysimd_uint32x4_t v = easysimd_test_arm_neon_random_u32x4();
    int lane = lanes[i];
    easysimd_uint32x4_t r;
    EASYSIMD_CONSTIFY_4_(easysimd_vsetq_lane_u32, r, (HEDLEY_UNREACHABLE(), v), lane, a, v);

    easysimd_test_codegen_write_u32(2, a, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_arm_neon_write_u32x4(2, v, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_u32x4(2, r, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_codegen_write_i32(2, lane, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
#endif
...
static int
test_easysimd_vsetq_lane_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint64_t a;
    uint64_t v[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    uint64_t a = test_vec[i].a;
    easysimd_uint64x2_t v = easysimd_vld1q_u64(test_vec[i].v);
    int lane = test_vec[i].lane;
    easysimd_uint64x2_t r;
    EASYSIMD_CONSTIFY_2_(easysimd_vsetq_lane_u64, r, (HEDLEY_UNREACHABLE(), v), lane, a, v);
  ...
  int lanes[] = { 0, 1, 0, 1, 0, 1, 0, 1 };
    uint64_t a = easysimd_test_codegen_random_u64();
    easysimd_uint64x2_t v = easysimd_test_arm_neon_random_u64x2();
    int lane = lanes[i];
    easysimd_uint64x2_t r;
    EASYSIMD_CONSTIFY_2_(easysimd_vsetq_lane_u64, r, (HEDLEY_UNREACHABLE(), v), lane, a, v);

    easysimd_test_codegen_write_u64(2, a, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_arm_neon_write_u64x2(2, v, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_u64x2(2, r, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_codegen_write_i32(2, lane, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
#endif
...
EASYSIMD_TEST_FUNC_LIST_ENTRY(vset_lane_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vset_lane_f64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vset_lane_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vset_lane_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vset_lane_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vset_lane_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vset_lane_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vset_lane_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vset_lane_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vset_lane_u64)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vsetq_lane_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vsetq_lane_f64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vsetq_lane_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vsetq_lane_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vsetq_lane_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vsetq_lane_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vsetq_lane_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vsetq_lane_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vsetq_lane_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vsetq_lane_u64)
