#define EASYSIMD_TEST_ARM_NEON_INSN shl

#include "test-neon.h"
#include "../../../easysimd/arm/neon/shl.h"

static int
test_easysimd_vshl_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int8_t a[8];
    int8_t b[8];
    int8_t r[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int8x8_t r = easysimd_vshl_s8(a, b);
...
static int
test_easysimd_vshl_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int16_t a[4];
    int16_t b[4];
    int16_t r[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int16x4_t r = easysimd_vshl_s16(a, b);
...
static int
test_easysimd_vshl_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int32_t a[2];
    int32_t b[2];
    int32_t r[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x2_t r = easysimd_vshl_s32(a, b);
...
static int
test_easysimd_vshl_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int64_t a[1];
    int64_t b[1];
    int64_t r[1];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int64x1_t r = easysimd_vshl_s64(a, b);
...
static int
test_easysimd_vshl_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint8_t a[8];
    int8_t b[8];
    uint8_t r[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int8x8_t b = easysimd_vld1_s8(test_vec[i].b);
    easysimd_uint8x8_t r = easysimd_vshl_u8(a, b);
...
static int
test_easysimd_vshl_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint16_t a[4];
    int16_t b[4];
    uint16_t r[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int16x4_t b = easysimd_vld1_s16(test_vec[i].b);
    easysimd_uint16x4_t r = easysimd_vshl_u16(a, b);
...
static int
test_easysimd_vshl_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint32_t a[2];
    int32_t b[2];
    uint32_t r[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x2_t b = easysimd_vld1_s32(test_vec[i].b);
    easysimd_uint32x2_t r = easysimd_vshl_u32(a, b);
...
static int
test_easysimd_vshl_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint64_t a[1];
    int64_t b[1];
    uint64_t r[1];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int64x1_t b = easysimd_vld1_s64(test_vec[i].b);
    easysimd_uint64x1_t r = easysimd_vshl_u64(a, b);
...
static int
test_easysimd_vshlq_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int8_t a[16];
    int8_t b[16];
    int8_t r[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int8x16_t r = easysimd_vshlq_s8(a, b);
...
static int
test_easysimd_vshlq_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int16_t a[8];
    int16_t b[8];
    int16_t r[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int16x8_t r = easysimd_vshlq_s16(a, b);
...
static int
test_easysimd_vshlq_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int32_t a[4];
    int32_t b[4];
    int32_t r[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x4_t r = easysimd_vshlq_s32(a, b);
...
static int
test_easysimd_vshlq_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int64_t a[2];
    int64_t b[2];
    int64_t r[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int64x2_t r = easysimd_vshlq_s64(a, b);
...
static int
test_easysimd_vshlq_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint8_t a[16];
    int8_t b[16];
    uint8_t r[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int8x16_t b = easysimd_vld1q_s8(test_vec[i].b);
    easysimd_uint8x16_t r = easysimd_vshlq_u8(a, b);
...
static int
test_easysimd_vshlq_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint16_t a[8];
    int16_t b[8];
    uint16_t r[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int16x8_t b = easysimd_vld1q_s16(test_vec[i].b);
    easysimd_uint16x8_t r = easysimd_vshlq_u16(a, b);
...
static int
test_easysimd_vshlq_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint32_t a[4];
    int32_t b[4];
    uint32_t r[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x4_t b = easysimd_vld1q_s32(test_vec[i].b);
    easysimd_uint32x4_t r = easysimd_vshlq_u32(a, b);
...
static int
test_easysimd_vshlq_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint64_t a[2];
    int64_t b[2];
    uint64_t r[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int64x2_t b = easysimd_vld1q_s64(test_vec[i].b);
    easysimd_uint64x2_t r = easysimd_vshlq_u64(a, b);
...
EASYSIMD_TEST_FUNC_LIST_ENTRY(vshl_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vshl_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vshl_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vshl_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vshl_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vshl_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vshl_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vshl_u64)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vshlq_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vshlq_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vshlq_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vshlq_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vshlq_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vshlq_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vshlq_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vshlq_u64)
