#define EASYSIMD_TEST_ARM_NEON_INSN shl_n

#include "test-neon.h"
#include "../../../easysimd/arm/neon/shl_n.h"

static int
test_easysimd_vshl_n_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int8_t a[8];
    int8_t r1[8];
    int8_t r3[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int8x8_t r1 = easysimd_vshl_n_s8(a, 1);
    easysimd_int8x8_t r3 = easysimd_vshl_n_s8(a, 3);
    easysimd_int8x8_t r5 = easysimd_vshl_n_s8(a, 5);
    easysimd_int8x8_t r6 = easysimd_vshl_n_s8(a, 6);
    easysimd_int8x8_t r7 = easysimd_vshl_n_s8(a, 7);
    ...
    easysimd_test_arm_neon_assert_equal_i8x8(r7, easysimd_vld1_s8(test_vec[i].r7));
  }
...
static int
test_easysimd_vshl_n_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int16_t a[4];
    int16_t r3[4];
    int16_t r6[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int16x4_t r3 = easysimd_vshl_n_s16(a, 3);
    easysimd_int16x4_t r6 = easysimd_vshl_n_s16(a, 6);
    easysimd_int16x4_t r10 = easysimd_vshl_n_s16(a, 10);
    easysimd_int16x4_t r13 = easysimd_vshl_n_s16(a, 13);
    easysimd_int16x4_t r15 = easysimd_vshl_n_s16(a, 15);
    ...
    easysimd_test_arm_neon_assert_equal_i16x4(r15, easysimd_vld1_s16(test_vec[i].r15));
  }
...
static int
test_easysimd_vshl_n_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int32_t a[2];
    int32_t r6[2];
    int32_t r13[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x2_t r6 = easysimd_vshl_n_s32(a, 6);
    easysimd_int32x2_t r13 = easysimd_vshl_n_s32(a, 13);
    easysimd_int32x2_t r19 = easysimd_vshl_n_s32(a, 19);
    easysimd_int32x2_t r26 = easysimd_vshl_n_s32(a, 26);
    easysimd_int32x2_t r31 = easysimd_vshl_n_s32(a, 31);
    ...
    easysimd_test_arm_neon_assert_equal_i32x2(r31, easysimd_vld1_s32(test_vec[i].r31));
  }
...
static int
test_easysimd_vshl_n_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int64_t a[1];
    int64_t r13[1];
    int64_t r26[1];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int64x1_t r13 = easysimd_vshl_n_s64(a, 13);
    easysimd_int64x1_t r26 = easysimd_vshl_n_s64(a, 26);
    easysimd_int64x1_t r39 = easysimd_vshl_n_s64(a, 39);
    easysimd_int64x1_t r52 = easysimd_vshl_n_s64(a, 52);
    easysimd_int64x1_t r63 = easysimd_vshl_n_s64(a, 63);
    ...
    easysimd_test_arm_neon_assert_equal_i64x1(r63, easysimd_vld1_s64(test_vec[i].r63));
  }
...
static int
test_easysimd_vshl_n_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint8_t a[8];
    uint8_t r1[8];
    uint8_t r3[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x8_t r1 = easysimd_vshl_n_u8(a, 1);
    easysimd_uint8x8_t r3 = easysimd_vshl_n_u8(a, 3);
    easysimd_uint8x8_t r5 = easysimd_vshl_n_u8(a, 5);
    easysimd_uint8x8_t r6 = easysimd_vshl_n_u8(a, 6);
    easysimd_uint8x8_t r7 = easysimd_vshl_n_u8(a, 7);
    ...
    easysimd_test_arm_neon_assert_equal_u8x8(r7, easysimd_vld1_u8(test_vec[i].r7));
  }
...
static int
test_easysimd_vshl_n_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint16_t a[4];
    uint16_t r3[4];
    uint16_t r6[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x4_t r3 = easysimd_vshl_n_u16(a, 3);
    easysimd_uint16x4_t r6 = easysimd_vshl_n_u16(a, 6);
    easysimd_uint16x4_t r10 = easysimd_vshl_n_u16(a, 10);
    easysimd_uint16x4_t r13 = easysimd_vshl_n_u16(a, 13);
    easysimd_uint16x4_t r15 = easysimd_vshl_n_u16(a, 15);
    ...
    easysimd_test_arm_neon_assert_equal_u16x4(r15, easysimd_vld1_u16(test_vec[i].r15));
  }
...
static int
test_easysimd_vshl_n_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint32_t a[2];
    uint32_t r6[2];
    uint32_t r13[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x2_t r6 = easysimd_vshl_n_u32(a, 6);
    easysimd_uint32x2_t r13 = easysimd_vshl_n_u32(a, 13);
    easysimd_uint32x2_t r19 = easysimd_vshl_n_u32(a, 19);
    easysimd_uint32x2_t r26 = easysimd_vshl_n_u32(a, 26);
    easysimd_uint32x2_t r31 = easysimd_vshl_n_u32(a, 31);
    ...
    easysimd_test_arm_neon_assert_equal_u32x2(r31, easysimd_vld1_u32(test_vec[i].r31));
  }
...
static int
test_easysimd_vshl_n_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint64_t a[1];
    uint64_t r13[1];
    uint64_t r26[1];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint64x1_t r13 = easysimd_vshl_n_u64(a, 13);
    easysimd_uint64x1_t r26 = easysimd_vshl_n_u64(a, 26);
    easysimd_uint64x1_t r39 = easysimd_vshl_n_u64(a, 39);
    easysimd_uint64x1_t r52 = easysimd_vshl_n_u64(a, 52);
    easysimd_uint64x1_t r63 = easysimd_vshl_n_u64(a, 63);
    ...
    easysimd_test_arm_neon_assert_equal_u64x1(r63, easysimd_vld1_u64(test_vec[i].r63));
  }
...
static int
test_easysimd_vshlq_n_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int8_t a[16];
    int8_t r1[16];
    int8_t r3[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int8x16_t r1 = easysimd_vshlq_n_s8(a, 1);
    easysimd_int8x16_t r3 = easysimd_vshlq_n_s8(a, 3);
    easysimd_int8x16_t r5 = easysimd_vshlq_n_s8(a, 5);
    easysimd_int8x16_t r6 = easysimd_vshlq_n_s8(a, 6);
    easysimd_int8x16_t r7 = easysimd_vshlq_n_s8(a, 7);
    ...
    easysimd_test_arm_neon_assert_equal_i8x16(r7, easysimd_vld1q_s8(test_vec[i].r7));
  }
...
static int
test_easysimd_vshlq_n_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int16_t a[8];
    int16_t r3[8];
    int16_t r6[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int16x8_t r3 = easysimd_vshlq_n_s16(a, 3);
    easysimd_int16x8_t r6 = easysimd_vshlq_n_s16(a, 6);
    easysimd_int16x8_t r10 = easysimd_vshlq_n_s16(a, 10);
    easysimd_int16x8_t r13 = easysimd_vshlq_n_s16(a, 13);
    easysimd_int16x8_t r15 = easysimd_vshlq_n_s16(a, 15);
    ...
    easysimd_test_arm_neon_assert_equal_i16x8(r15, easysimd_vld1q_s16(test_vec[i].r15));
  }
...
static int
test_easysimd_vshlq_n_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int32_t a[4];
    int32_t r6[4];
    int32_t r13[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x4_t r6 = easysimd_vshlq_n_s32(a, 6);
    easysimd_int32x4_t r13 = easysimd_vshlq_n_s32(a, 13);
    easysimd_int32x4_t r19 = easysimd_vshlq_n_s32(a, 19);
    easysimd_int32x4_t r26 = easysimd_vshlq_n_s32(a, 26);
    easysimd_int32x4_t r31 = easysimd_vshlq_n_s32(a, 31);
    ...
    easysimd_test_arm_neon_assert_equal_i32x4(r31, easysimd_vld1q_s32(test_vec[i].r31));
  }
...
static int
test_easysimd_vshlq_n_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int64_t a[2];
    int64_t r13[2];
    int64_t r26[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int64x2_t r13 = easysimd_vshlq_n_s64(a, 13);
    easysimd_int64x2_t r26 = easysimd_vshlq_n_s64(a, 26);
    easysimd_int64x2_t r39 = easysimd_vshlq_n_s64(a, 39);
    easysimd_int64x2_t r52 = easysimd_vshlq_n_s64(a, 52);
    easysimd_int64x2_t r63 = easysimd_vshlq_n_s64(a, 63);
    ...
    easysimd_test_arm_neon_assert_equal_i64x2(r63, easysimd_vld1q_s64(test_vec[i].r63));
  }
...
static int
test_easysimd_vshlq_n_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint8_t a[16];
    uint8_t r1[16];
    uint8_t r3[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x16_t r1 = easysimd_vshlq_n_u8(a, 1);
    easysimd_uint8x16_t r3 = easysimd_vshlq_n_u8(a, 3);
    easysimd_uint8x16_t r5 = easysimd_vshlq_n_u8(a, 5);
    easysimd_uint8x16_t r6 = easysimd_vshlq_n_u8(a, 6);
    easysimd_uint8x16_t r7 = easysimd_vshlq_n_u8(a, 7);
    ...
    easysimd_test_arm_neon_assert_equal_u8x16(r7, easysimd_vld1q_u8(test_vec[i].r7));
  }
...
static int
test_easysimd_vshlq_n_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint16_t a[8];
    uint16_t r3[8];
    uint16_t r6[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x8_t r3 = easysimd_vshlq_n_u16(a, 3);
    easysimd_uint16x8_t r6 = easysimd_vshlq_n_u16(a, 6);
    easysimd_uint16x8_t r10 = easysimd_vshlq_n_u16(a, 10);
    easysimd_uint16x8_t r13 = easysimd_vshlq_n_u16(a, 13);
    easysimd_uint16x8_t r15 = easysimd_vshlq_n_u16(a, 15);
    ...
    easysimd_test_arm_neon_assert_equal_u16x8(r15, easysimd_vld1q_u16(test_vec[i].r15));
  }
...
static int
test_easysimd_vshlq_n_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint32_t a[4];
    uint32_t r6[4];
    uint32_t r13[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x4_t r6 = easysimd_vshlq_n_u32(a, 6);
    easysimd_uint32x4_t r13 = easysimd_vshlq_n_u32(a, 13);
    easysimd_uint32x4_t r19 = easysimd_vshlq_n_u32(a, 19);
    easysimd_uint32x4_t r26 = easysimd_vshlq_n_u32(a, 26);
    easysimd_uint32x4_t r31 = easysimd_vshlq_n_u32(a, 31);
    ...
    easysimd_test_arm_neon_assert_equal_u32x4(r31, easysimd_vld1q_u32(test_vec[i].r31));
  }
...
static int
test_easysimd_vshlq_n_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint64_t a[2];
    uint64_t r13[2];
    uint64_t r26[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint64x2_t r13 = easysimd_vshlq_n_u64(a, 13);
    easysimd_uint64x2_t r26 = easysimd_vshlq_n_u64(a, 26);
    easysimd_uint64x2_t r39 = easysimd_vshlq_n_u64(a, 39);
    easysimd_uint64x2_t r52 = easysimd_vshlq_n_u64(a, 52);
    easysimd_uint64x2_t r63 = easysimd_vshlq_n_u64(a, 63);
    ...
    easysimd_test_arm_neon_assert_equal_u64x2(r63, easysimd_vld1q_u64(test_vec[i].r63));
  }
...
EASYSIMD_TEST_FUNC_LIST_ENTRY(vshl_n_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vshl_n_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vshl_n_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vshl_n_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vshl_n_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vshl_n_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vshl_n_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vshl_n_u64)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vshlq_n_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vshlq_n_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vshlq_n_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vshlq_n_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vshlq_n_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vshlq_n_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vshlq_n_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vshlq_n_u64)
