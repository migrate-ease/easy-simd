#define EASYSIMD_TEST_ARM_NEON_INSN shll_n

#include "test-neon.h"
#include "../../../easysimd/arm/neon/shll_n.h"
#include "../../../easysimd/arm/neon/dup_n.h"

static int
test_easysimd_vshll_n_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int8_t a[8];
    int16_t r1[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int16x8_t r1 = easysimd_vshll_n_s8(a, 1);
    easysimd_int16x8_t r3 = easysimd_vshll_n_s8(a, 3);
    easysimd_int16x8_t r5 = easysimd_vshll_n_s8(a, 5);
    easysimd_int16x8_t r6 = easysimd_vshll_n_s8(a, 6);
    easysimd_int16x8_t r7 = easysimd_vshll_n_s8(a, 7);
  ...
  for (int i = 1 ; i < 8 ; i++) {
    ...
    easysimd_test_arm_neon_write_i16x8(2, r5, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_i16x8(2, r6, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_i16x8(2, r7, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
#endif
}
...
static int
test_easysimd_vshll_n_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int16_t a[4];
    int32_t r3[4];
  ...
  for (size_t i = 1 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x4_t r3 = easysimd_vshll_n_s16(a, 3);
    easysimd_int32x4_t r6 = easysimd_vshll_n_s16(a, 6);
    easysimd_int32x4_t r10 = easysimd_vshll_n_s16(a, 10);
    easysimd_int32x4_t r13 = easysimd_vshll_n_s16(a, 13);
    easysimd_int32x4_t r15 = easysimd_vshll_n_s16(a, 15);
    ...
    easysimd_test_arm_neon_assert_equal_i32x4(r10, easysimd_vld1q_s32(test_vec[i].r10));
    easysimd_test_arm_neon_assert_equal_i32x4(r13, easysimd_vld1q_s32(test_vec[i].r13));
    easysimd_test_arm_neon_assert_equal_i32x4(r15, easysimd_vld1q_s32(test_vec[i].r15));
  }
  ...
  for (int i = 1 ; i < 8 ; i++) {
    ...
    easysimd_test_arm_neon_write_i32x4(2, r3, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_i32x4(2, r6, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_i32x4(2, r10, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_i32x4(2, r13, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_i32x4(2, r15, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
#endif
}
...
static int
test_easysimd_vshll_n_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t a[2];
    int64_t r6[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int64x2_t r6 = easysimd_vshll_n_s32(a, 6);
    easysimd_int64x2_t r13 = easysimd_vshll_n_s32(a, 13);
    easysimd_int64x2_t r19 = easysimd_vshll_n_s32(a, 19);
    easysimd_int64x2_t r26 = easysimd_vshll_n_s32(a, 26);
    easysimd_int64x2_t r31 = easysimd_vshll_n_s32(a, 31);

    easysimd_test_arm_neon_assert_equal_i64x2(r6, easysimd_vld1q_s64(test_vec[i].r6));
    easysimd_test_arm_neon_assert_equal_i64x2(r13, easysimd_vld1q_s64(test_vec[i].r13));
    easysimd_test_arm_neon_assert_equal_i64x2(r19, easysimd_vld1q_s64(test_vec[i].r19));
    easysimd_test_arm_neon_assert_equal_i64x2(r26, easysimd_vld1q_s64(test_vec[i].r26));
    easysimd_test_arm_neon_assert_equal_i64x2(r31, easysimd_vld1q_s64(test_vec[i].r31));
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_test_arm_neon_write_i64x2(2, r6, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_i64x2(2, r13, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_i64x2(2, r19, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_i64x2(2, r26, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_i64x2(2, r31, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
#endif
}
...
static int
test_easysimd_vshll_n_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint8_t a[8];
    uint16_t r1[8];
  ...
  for (size_t i = 1 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x8_t r1 = easysimd_vshll_n_u8(a, 1);
    easysimd_uint16x8_t r3 = easysimd_vshll_n_u8(a, 3);
    easysimd_uint16x8_t r5 = easysimd_vshll_n_u8(a, 5);
    easysimd_uint16x8_t r6 = easysimd_vshll_n_u8(a, 6);
    easysimd_uint16x8_t r7 = easysimd_vshll_n_u8(a, 7);

    easysimd_test_arm_neon_assert_equal_u16x8(r1, easysimd_vld1q_u16(test_vec[i].r1));
    ...
    easysimd_test_arm_neon_assert_equal_u16x8(r7, easysimd_vld1q_u16(test_vec[i].r7));
  }
  ...
  for (int i = 1 ; i < 8 ; i++) {
    ...
    easysimd_test_arm_neon_write_u16x8(2, r1, EASYSIMD_TEST_VEC_POS_MIDDLE);
    ...
    easysimd_test_arm_neon_write_u16x8(2, r7, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
#endif
}
...
static int
test_easysimd_vshll_n_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint16_t a[4];
    uint32_t r3[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x4_t r3 = easysimd_vshll_n_u16(a, 3);
    easysimd_uint32x4_t r6 = easysimd_vshll_n_u16(a, 6);
    easysimd_uint32x4_t r10 = easysimd_vshll_n_u16(a, 10);
    easysimd_uint32x4_t r13 = easysimd_vshll_n_u16(a, 13);
    easysimd_uint32x4_t r15 = easysimd_vshll_n_u16(a, 15);

    easysimd_test_arm_neon_assert_equal_u32x4(r3, easysimd_vld1q_u32(test_vec[i].r3));
  ...
  for (int i = 1 ; i < 8 ; i++) {
    ...
    easysimd_test_arm_neon_write_u32x4(2, r3, EASYSIMD_TEST_VEC_POS_MIDDLE);
    ...
    easysimd_test_arm_neon_write_u32x4(2, r15, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
#endif
}
...
static int
test_easysimd_vshll_n_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint32_t a[2];
    uint64_t r6[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint64x2_t r6 = easysimd_vshll_n_u32(a, 6);
    easysimd_uint64x2_t r13 = easysimd_vshll_n_u32(a, 13);
    easysimd_uint64x2_t r19 = easysimd_vshll_n_u32(a, 19);
    easysimd_uint64x2_t r26 = easysimd_vshll_n_u32(a, 26);
    easysimd_uint64x2_t r31 = easysimd_vshll_n_u32(a, 31);

    easysimd_test_arm_neon_write_u32x2(2, a, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_arm_neon_write_u64x2(2, r6, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_u64x2(2, r13, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_u64x2(2, r19, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_u64x2(2, r26, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_u64x2(2, r31, EASYSIMD_TEST_VEC_POS_LAST);
  }
...
EASYSIMD_TEST_FUNC_LIST_ENTRY(vshll_n_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vshll_n_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vshll_n_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vshll_n_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vshll_n_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vshll_n_u32)
