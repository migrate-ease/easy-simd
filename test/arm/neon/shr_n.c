#define EASYSIMD_TEST_ARM_NEON_INSN shr_n

#include "test-neon.h"
#include "../../../easysimd/arm/neon/shr_n.h"

static int
test_easysimd_vshr_n_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int8_t a[8];
    int8_t r1[8];
    int8_t r3[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int8x8_t r1 = easysimd_vshr_n_s8(a, 1);
    easysimd_int8x8_t r3 = easysimd_vshr_n_s8(a, 3);
    easysimd_int8x8_t r5 = easysimd_vshr_n_s8(a, 5);
    easysimd_int8x8_t r6 = easysimd_vshr_n_s8(a, 6);
    easysimd_int8x8_t r8 = easysimd_vshr_n_s8(a, 8);
...
static int
test_easysimd_vshr_n_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int16_t a[4];
    int16_t r3[4];
    int16_t r6[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int16x4_t r3 = easysimd_vshr_n_s16(a, 3);
    easysimd_int16x4_t r6 = easysimd_vshr_n_s16(a, 6);
    easysimd_int16x4_t r10 = easysimd_vshr_n_s16(a, 10);
    easysimd_int16x4_t r13 = easysimd_vshr_n_s16(a, 13);
    easysimd_int16x4_t r16 = easysimd_vshr_n_s16(a, 16);
...
static int
test_easysimd_vshr_n_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int32_t a[2];
    int32_t r6[2];
    int32_t r13[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x2_t r6 = easysimd_vshr_n_s32(a, 6);
    easysimd_int32x2_t r13 = easysimd_vshr_n_s32(a, 13);
    easysimd_int32x2_t r19 = easysimd_vshr_n_s32(a, 19);
    easysimd_int32x2_t r26 = easysimd_vshr_n_s32(a, 26);
    easysimd_int32x2_t r32 = easysimd_vshr_n_s32(a, 32);
...
static int
test_easysimd_vshr_n_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int64_t a[1];
    int64_t r13[1];
    int64_t r26[1];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int64x1_t r13 = easysimd_vshr_n_s64(a, 13);
    easysimd_int64x1_t r26 = easysimd_vshr_n_s64(a, 26);
    easysimd_int64x1_t r39 = easysimd_vshr_n_s64(a, 39);
    easysimd_int64x1_t r52 = easysimd_vshr_n_s64(a, 52);
    easysimd_int64x1_t r64 = easysimd_vshr_n_s64(a, 64);
...
static int
test_easysimd_vshr_n_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint8_t a[8];
    uint8_t r1[8];
    uint8_t r3[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x8_t r1 = easysimd_vshr_n_u8(a, 1);
    easysimd_uint8x8_t r3 = easysimd_vshr_n_u8(a, 3);
    easysimd_uint8x8_t r5 = easysimd_vshr_n_u8(a, 5);
    easysimd_uint8x8_t r6 = easysimd_vshr_n_u8(a, 6);
    easysimd_uint8x8_t r8 = easysimd_vshr_n_u8(a, 8);
...
static int
test_easysimd_vshr_n_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint16_t a[4];
    uint16_t r3[4];
    uint16_t r6[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x4_t r3 = easysimd_vshr_n_u16(a, 3);
    easysimd_uint16x4_t r6 = easysimd_vshr_n_u16(a, 6);
    easysimd_uint16x4_t r10 = easysimd_vshr_n_u16(a, 10);
    easysimd_uint16x4_t r13 = easysimd_vshr_n_u16(a, 13);
    easysimd_uint16x4_t r16 = easysimd_vshr_n_u16(a, 16);
...
static int
test_easysimd_vshr_n_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint32_t a[2];
    uint32_t r6[2];
    uint32_t r13[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x2_t r6 = easysimd_vshr_n_u32(a, 6);
    easysimd_uint32x2_t r13 = easysimd_vshr_n_u32(a, 13);
    easysimd_uint32x2_t r19 = easysimd_vshr_n_u32(a, 19);
    easysimd_uint32x2_t r26 = easysimd_vshr_n_u32(a, 26);
    easysimd_uint32x2_t r32 = easysimd_vshr_n_u32(a, 32);
...
static int
test_easysimd_vshr_n_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint64_t a[1];
    uint64_t r13[1];
    uint64_t r26[1];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint64x1_t r13 = easysimd_vshr_n_u64(a, 13);
    easysimd_uint64x1_t r26 = easysimd_vshr_n_u64(a, 26);
    easysimd_uint64x1_t r39 = easysimd_vshr_n_u64(a, 39);
    easysimd_uint64x1_t r52 = easysimd_vshr_n_u64(a, 52);
    easysimd_uint64x1_t r64 = easysimd_vshr_n_u64(a, 64);
...
static int
test_easysimd_vshrq_n_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int8_t a[16];
    int8_t r1[16];
    int8_t r3[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int8x16_t r1 = easysimd_vshrq_n_s8(a, 1);
    easysimd_int8x16_t r3 = easysimd_vshrq_n_s8(a, 3);
    easysimd_int8x16_t r5 = easysimd_vshrq_n_s8(a, 5);
    easysimd_int8x16_t r6 = easysimd_vshrq_n_s8(a, 6);
    easysimd_int8x16_t r8 = easysimd_vshrq_n_s8(a, 8);
...
static int
test_easysimd_vshrq_n_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int16_t a[8];
    int16_t r3[8];
    int16_t r6[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int16x8_t r3 = easysimd_vshrq_n_s16(a, 3);
    easysimd_int16x8_t r6 = easysimd_vshrq_n_s16(a, 6);
    easysimd_int16x8_t r10 = easysimd_vshrq_n_s16(a, 10);
    easysimd_int16x8_t r13 = easysimd_vshrq_n_s16(a, 13);
    easysimd_int16x8_t r16 = easysimd_vshrq_n_s16(a, 16);
...
static int
test_easysimd_vshrq_n_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int32_t a[4];
    int32_t r6[4];
    int32_t r13[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x4_t r6 = easysimd_vshrq_n_s32(a, 6);
    easysimd_int32x4_t r13 = easysimd_vshrq_n_s32(a, 13);
    easysimd_int32x4_t r19 = easysimd_vshrq_n_s32(a, 19);
    easysimd_int32x4_t r26 = easysimd_vshrq_n_s32(a, 26);
    easysimd_int32x4_t r32 = easysimd_vshrq_n_s32(a, 32);
...
static int
test_easysimd_vshrq_n_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int64_t a[2];
    int64_t r13[2];
    int64_t r26[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int64x2_t r13 = easysimd_vshrq_n_s64(a, 13);
    easysimd_int64x2_t r26 = easysimd_vshrq_n_s64(a, 26);
    easysimd_int64x2_t r39 = easysimd_vshrq_n_s64(a, 39);
    easysimd_int64x2_t r52 = easysimd_vshrq_n_s64(a, 52);
    easysimd_int64x2_t r64 = easysimd_vshrq_n_s64(a, 64);
...
static int
test_easysimd_vshrq_n_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint8_t a[16];
    uint8_t r1[16];
    uint8_t r3[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x16_t r1 = easysimd_vshrq_n_u8(a, 1);
    easysimd_uint8x16_t r3 = easysimd_vshrq_n_u8(a, 3);
    easysimd_uint8x16_t r5 = easysimd_vshrq_n_u8(a, 5);
    easysimd_uint8x16_t r6 = easysimd_vshrq_n_u8(a, 6);
    easysimd_uint8x16_t r8 = easysimd_vshrq_n_u8(a, 8);
...
static int
test_easysimd_vshrq_n_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint16_t a[8];
    uint16_t r3[8];
    uint16_t r6[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x8_t r3 = easysimd_vshrq_n_u16(a, 3);
    easysimd_uint16x8_t r6 = easysimd_vshrq_n_u16(a, 6);
    easysimd_uint16x8_t r10 = easysimd_vshrq_n_u16(a, 10);
    easysimd_uint16x8_t r13 = easysimd_vshrq_n_u16(a, 13);
    easysimd_uint16x8_t r16 = easysimd_vshrq_n_u16(a, 16);
...
static int
test_easysimd_vshrq_n_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint32_t a[4];
    uint32_t r6[4];
    uint32_t r13[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x4_t r6 = easysimd_vshrq_n_u32(a, 6);
    easysimd_uint32x4_t r13 = easysimd_vshrq_n_u32(a, 13);
    easysimd_uint32x4_t r19 = easysimd_vshrq_n_u32(a, 19);
    easysimd_uint32x4_t r26 = easysimd_vshrq_n_u32(a, 26);
    easysimd_uint32x4_t r32 = easysimd_vshrq_n_u32(a, 32);
...
static int
test_easysimd_vshrq_n_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint64_t a[2];
    uint64_t r13[2];
    uint64_t r26[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint64x2_t r13 = easysimd_vshrq_n_u64(a, 13);
    easysimd_uint64x2_t r26 = easysimd_vshrq_n_u64(a, 26);
    easysimd_uint64x2_t r39 = easysimd_vshrq_n_u64(a, 39);
    easysimd_uint64x2_t r52 = easysimd_vshrq_n_u64(a, 52);
    easysimd_uint64x2_t r64 = easysimd_vshrq_n_u64(a, 64);
...
static int
test_easysimd_vshrd_n_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int64_t a;
    int64_t r1;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    int64_t r1 = easysimd_vshrd_n_s64(test_vec[i].a, 1);
    int64_t r13 = easysimd_vshrd_n_s64(test_vec[i].a, 13);
    int64_t r23 = easysimd_vshrd_n_s64(test_vec[i].a, 23);
    int64_t r37 = easysimd_vshrd_n_s64(test_vec[i].a, 37);
    int64_t r46 = easysimd_vshrd_n_s64(test_vec[i].a, 46);
    int64_t r55 = easysimd_vshrd_n_s64(test_vec[i].a, 55);
    int64_t r64 = easysimd_vshrd_n_s64(test_vec[i].a, 64);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    int64_t r1 = easysimd_vshrd_n_s64(a, 1);
    int64_t r13 = easysimd_vshrd_n_s64(a, 13);
    int64_t r23 = easysimd_vshrd_n_s64(a, 23);
    int64_t r37 = easysimd_vshrd_n_s64(a, 37);
    int64_t r46 = easysimd_vshrd_n_s64(a, 46);
    int64_t r55 = easysimd_vshrd_n_s64(a, 55);
    int64_t r64 = easysimd_vshrd_n_s64(a, 64);
...
static int
test_easysimd_vshrd_n_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint64_t a;
    uint64_t r1;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    uint64_t r1 = easysimd_vshrd_n_u64(test_vec[i].a, 1);
    uint64_t r13 = easysimd_vshrd_n_u64(test_vec[i].a, 13);
    uint64_t r23 = easysimd_vshrd_n_u64(test_vec[i].a, 23);
    uint64_t r37 = easysimd_vshrd_n_u64(test_vec[i].a, 37);
    uint64_t r46 = easysimd_vshrd_n_u64(test_vec[i].a, 46);
    uint64_t r55 = easysimd_vshrd_n_u64(test_vec[i].a, 55);
    uint64_t r64 = easysimd_vshrd_n_u64(test_vec[i].a, 64);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    uint64_t r1 = easysimd_vshrd_n_u64(a, 1);
    uint64_t r13 = easysimd_vshrd_n_u64(a, 13);
    uint64_t r23 = easysimd_vshrd_n_u64(a, 23);
    uint64_t r37 = easysimd_vshrd_n_u64(a, 37);
    uint64_t r46 = easysimd_vshrd_n_u64(a, 46);
    uint64_t r55 = easysimd_vshrd_n_u64(a, 55);
    uint64_t r64 = easysimd_vshrd_n_u64(a, 64);
...
EASYSIMD_TEST_FUNC_LIST_ENTRY(vshr_n_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vshr_n_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vshr_n_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vshr_n_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vshr_n_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vshr_n_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vshr_n_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vshr_n_u64)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vshrq_n_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vshrq_n_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vshrq_n_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vshrq_n_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vshrq_n_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vshrq_n_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vshrq_n_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vshrq_n_u64)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vshrd_n_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vshrd_n_u64)
