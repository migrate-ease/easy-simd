#define EASYSIMD_TEST_ARM_NEON_INSN shrn_n

#include "test-neon.h"
#include "../../../easysimd/arm/neon/shrn_n.h"

static int
test_easysimd_vshrn_n_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  struct {
    int16_t a[8];
    int8_t r1[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int8x8_t r1 = easysimd_vshrn_n_s16(a, 1);
    easysimd_int8x8_t r3 = easysimd_vshrn_n_s16(a, 3);
    easysimd_int8x8_t r5 = easysimd_vshrn_n_s16(a, 5);
    easysimd_int8x8_t r6 = easysimd_vshrn_n_s16(a, 6);
    easysimd_int8x8_t r8 = easysimd_vshrn_n_s16(a, 8);
...
static int
test_easysimd_vshrn_n_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  struct {
    int32_t a[4];
    int16_t r3[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int16x4_t r3 = easysimd_vshrn_n_s32(a, 3);
    easysimd_int16x4_t r6 = easysimd_vshrn_n_s32(a, 6);
    easysimd_int16x4_t r10 = easysimd_vshrn_n_s32(a, 10);
    easysimd_int16x4_t r13 = easysimd_vshrn_n_s32(a, 13);
    easysimd_int16x4_t r16 = easysimd_vshrn_n_s32(a, 16);
...
static int
test_easysimd_vshrn_n_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  struct {
    int64_t a[2];
    int32_t r6[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x2_t r6 = easysimd_vshrn_n_s64(a, 6);
    easysimd_int32x2_t r13 = easysimd_vshrn_n_s64(a, 13);
    easysimd_int32x2_t r19 = easysimd_vshrn_n_s64(a, 19);
    easysimd_int32x2_t r26 = easysimd_vshrn_n_s64(a, 26);
    easysimd_int32x2_t r32 = easysimd_vshrn_n_s64(a, 32);
...
static int
test_easysimd_vshrn_n_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  struct {
    uint16_t a[8];
    uint8_t r1[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x8_t r1 = easysimd_vshrn_n_u16(a, 1);
    easysimd_uint8x8_t r3 = easysimd_vshrn_n_u16(a, 3);
    easysimd_uint8x8_t r5 = easysimd_vshrn_n_u16(a, 5);
    easysimd_uint8x8_t r6 = easysimd_vshrn_n_u16(a, 6);
    easysimd_uint8x8_t r8 = easysimd_vshrn_n_u16(a, 8);
...
static int
test_easysimd_vshrn_n_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  struct {
    uint32_t a[4];
    uint16_t r3[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x4_t r3 = easysimd_vshrn_n_u32(a, 3);
    easysimd_uint16x4_t r6 = easysimd_vshrn_n_u32(a, 6);
    easysimd_uint16x4_t r10 = easysimd_vshrn_n_u32(a, 10);
    easysimd_uint16x4_t r13 = easysimd_vshrn_n_u32(a, 13);
    easysimd_uint16x4_t r16 = easysimd_vshrn_n_u32(a, 16);
  ...
  for (int i = 0 ; i < 8; i++) {
    ...
    easysimd_uint16x4_t r = easysimd_vshrn_n_u32(a, 3);
    easysimd_uint16x4_t r6 = easysimd_vshrn_n_u32(a, 6);
    easysimd_uint16x4_t r10 = easysimd_vshrn_n_u32(a, 10);
    easysimd_uint16x4_t r13 = easysimd_vshrn_n_u32(a, 13);
    easysimd_uint16x4_t r16 = easysimd_vshrn_n_u32(a, 16);
...
static int
test_easysimd_vshrn_n_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  struct {
    uint64_t a[2];
    uint32_t r6[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x2_t r6 = easysimd_vshrn_n_u64(a, 6);
    easysimd_uint32x2_t r13 = easysimd_vshrn_n_u64(a, 13);
    easysimd_uint32x2_t r19 = easysimd_vshrn_n_u64(a, 19);
    easysimd_uint32x2_t r26 = easysimd_vshrn_n_u64(a, 26);
    easysimd_uint32x2_t r32 = easysimd_vshrn_n_u64(a, 32);
...
EASYSIMD_TEST_FUNC_LIST_ENTRY(vshrn_n_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vshrn_n_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vshrn_n_s64)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vshrn_n_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vshrn_n_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vshrn_n_u64)
