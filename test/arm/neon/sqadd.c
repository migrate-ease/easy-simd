#define EASYSIMD_TEST_ARM_NEON_INSN sqadd

#include "test-neon.h"
#include "../../../easysimd/arm/neon/sqadd.h"

static int
test_easysimd_vsqaddb_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint8_t a;
    int8_t b;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    uint8_t r = easysimd_vsqaddb_u8(test_vec[i].a, test_vec[i].b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    uint8_t r = easysimd_vsqaddb_u8(a, b);
...
static int
test_easysimd_vsqaddh_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint16_t a;
    int16_t b;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    uint16_t r = easysimd_vsqaddh_u16(test_vec[i].a, test_vec[i].b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    uint16_t r = easysimd_vsqaddh_u16(a, b);
...
static int
test_easysimd_vsqadds_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint32_t a;
    int32_t b;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    uint32_t r = easysimd_vsqadds_u32(test_vec[i].a, test_vec[i].b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    uint32_t r = easysimd_vsqadds_u32(a, b);
...
static int
test_easysimd_vsqaddd_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint64_t a;
    int64_t b;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    uint64_t r = easysimd_vsqaddd_u64(test_vec[i].a, test_vec[i].b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    uint64_t r = easysimd_vsqaddd_u64(a, b);
...
static int
test_easysimd_vsqadd_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint8_t a[8];
    int8_t b[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x8_t r = easysimd_vsqadd_u8(a, b);
...
static int
test_easysimd_vsqadd_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint16_t a[4];
    int16_t b[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x4_t r = easysimd_vsqadd_u16(a, b);
...
static int
test_easysimd_vsqadd_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint32_t a[2];
    int32_t b[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x2_t r = easysimd_vsqadd_u32(a, b);
...
static int
test_easysimd_vsqadd_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint64_t a[1];
    int64_t b[1];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint64x1_t r = easysimd_vsqadd_u64(a, b);
...
static int
test_easysimd_vsqaddq_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint8_t a[16];
    int8_t b[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x16_t r = easysimd_vsqaddq_u8(a, b);
...
static int
test_easysimd_vsqaddq_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint16_t a[8];
    int16_t b[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x8_t r = easysimd_vsqaddq_u16(a, b);
...
static int
test_easysimd_vsqaddq_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint32_t a[4];
    int32_t b[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x4_t r = easysimd_vsqaddq_u32(a, b);
...
static int
test_easysimd_vsqaddq_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint64_t a[2];
    int64_t b[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint64x2_t r = easysimd_vsqaddq_u64(a, b);
...
EASYSIMD_TEST_FUNC_LIST_ENTRY(vsqaddb_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vsqaddh_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vsqadds_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vsqaddd_u64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vsqadd_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vsqadd_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vsqadd_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vsqadd_u64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vsqaddq_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vsqaddq_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vsqaddq_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vsqaddq_u64)
