#define EASYSIMD_TEST_ARM_NEON_INSN st1_lane

#include "test-neon.h"
#include "../../../easysimd/arm/neon/st1_lane.h"

HEDLEY_DIAGNOSTIC_PUSH
EASYSIMD_DIAGNOSTIC_DISABLE_UNREACHABLE_

static int
test_easysimd_vst1_lane_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    easysimd_float32 a;
    easysimd_float32 val[2];
    int lane;
  } test_vec[] = {
    { EASYSIMD_FLOAT32_C(   758.86),
      { EASYSIMD_FLOAT32_C(   758.86), EASYSIMD_FLOAT32_C(   425.86) },
       INT32_C(           0) },
    { EASYSIMD_FLOAT32_C(  -723.17),
      { EASYSIMD_FLOAT32_C(  -381.17), EASYSIMD_FLOAT32_C(  -723.17) },
       INT32_C(           1) },
    { EASYSIMD_FLOAT32_C(  -445.02),
      { EASYSIMD_FLOAT32_C(  -445.02), EASYSIMD_FLOAT32_C(  -699.72) },
       INT32_C(           0) },
    { EASYSIMD_FLOAT32_C(  -700.54),
      { EASYSIMD_FLOAT32_C(  -207.44), EASYSIMD_FLOAT32_C(  -700.54) },
       INT32_C(           1) },
    { EASYSIMD_FLOAT32_C(  -873.60),
      { EASYSIMD_FLOAT32_C(  -873.60), EASYSIMD_FLOAT32_C(  -557.72) },
       INT32_C(           0) },
    { EASYSIMD_FLOAT32_C(   122.92),
      { EASYSIMD_FLOAT32_C(   178.64), EASYSIMD_FLOAT32_C(   122.92) },
       INT32_C(           1) },
    { EASYSIMD_FLOAT32_C(   972.30),
      { EASYSIMD_FLOAT32_C(   972.30), EASYSIMD_FLOAT32_C(   277.03) },
       INT32_C(           0) },
    { EASYSIMD_FLOAT32_C(    73.76),
      { EASYSIMD_FLOAT32_C(   826.05), EASYSIMD_FLOAT32_C(    73.76) },
       INT32_C(           1) },

  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float32x2_t val = easysimd_vld1_f32(test_vec[i].val);
    easysimd_float32 a;
    EASYSIMD_CONSTIFY_2_NO_RESULT_(easysimd_vst1_lane_f32, HEDLEY_UNREACHABLE(), test_vec[i].lane, &a, val);

    easysimd_assert_equal_f32(a, test_vec[i].a, 1);
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    easysimd_float32 a;
    easysimd_float32x2_t val = easysimd_test_arm_neon_random_f32x2(-1000.0f, 1000.0f);
    easysimd_vst1_lane_f32(&a, val, lanes[i]);

    easysimd_test_codegen_write_f32(2, a, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_arm_neon_write_f32x2(2, val, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_codegen_write_i32(2, lanes[i], EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
#endif
}
...
static int
test_easysimd_vst1_lane_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    easysimd_float64 a;
    easysimd_float64 val[1];
  } test_vec[] = {
    { EASYSIMD_FLOAT64_C(  -672.00),
      { EASYSIMD_FLOAT64_C(  -672.00) } },
    { EASYSIMD_FLOAT64_C(   684.22),
      { EASYSIMD_FLOAT64_C(   684.22) } },
    { EASYSIMD_FLOAT64_C(   -14.73),
      { EASYSIMD_FLOAT64_C(   -14.73) } },
    { EASYSIMD_FLOAT64_C(  -277.48),
      { EASYSIMD_FLOAT64_C(  -277.48) } },
    { EASYSIMD_FLOAT64_C(  -464.79),
      { EASYSIMD_FLOAT64_C(  -464.79) } },
    { EASYSIMD_FLOAT64_C(  -299.87),
      { EASYSIMD_FLOAT64_C(  -299.87) } },
    { EASYSIMD_FLOAT64_C(  -770.81),
      { EASYSIMD_FLOAT64_C(  -770.81) } },
    { EASYSIMD_FLOAT64_C(  -134.46),
      { EASYSIMD_FLOAT64_C(  -134.46) } },

  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float64x1_t val = easysimd_vld1_f64(test_vec[i].val);
    easysimd_float64 a;
    easysimd_vst1_lane_f64(&a, val, 0);

    easysimd_assert_equal_f64(a, test_vec[i].a, 1);
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    easysimd_float64 a;
    easysimd_float64x1_t val = easysimd_test_arm_neon_random_f64x1(-1000.0, 1000.0);
    easysimd_vst1_lane_f64(&a, val, 0);
    int lane = 0;

    easysimd_test_codegen_write_f64(2, a, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_arm_neon_write_f64x1(2, val, EASYSIMD_TEST_VEC_POS_MIDDLE);
...
static int
test_easysimd_vst1_lane_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int8_t a;
    int8_t val[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    int8_t a;
    easysimd_int8x8_t val = easysimd_vld1_s8(test_vec[i].val);
    EASYSIMD_CONSTIFY_8_NO_RESULT_(easysimd_vst1_lane_s8, HEDLEY_UNREACHABLE(), test_vec[i].lane, &a, val);

    easysimd_assert_equal_i8(a, test_vec[i].a);
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    int8_t a;
    easysimd_int8x8_t val = easysimd_test_arm_neon_random_i8x8();
    const int lane = lanes[i];
    easysimd_vst1_lane_s8(&a, val, lane);

    easysimd_test_codegen_write_i8(2, a, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_arm_neon_write_i8x8(2, val, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_codegen_write_i32(2, lane, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
#endif
...
static int
test_easysimd_vst1_lane_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int16_t a;
    int16_t val[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_int16x4_t val = easysimd_vld1_s16(test_vec[i].val);
    int16_t a;
    EASYSIMD_CONSTIFY_4_NO_RESULT_(easysimd_vst1_lane_s16, HEDLEY_UNREACHABLE(), test_vec[i].lane, &a, val);
    easysimd_assert_equal_i16(a, test_vec[i].a);
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    int16_t a;
    easysimd_int16x4_t val = easysimd_test_arm_neon_random_i16x4();
    const int lane = lanes[i];
    easysimd_vst1_lane_s16(&a, val, lane);

    easysimd_test_codegen_write_i16(2, a, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_arm_neon_write_i16x4(2, val, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_codegen_write_i32(2, lane, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
#endif
...
static int
test_easysimd_vst1_lane_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t a;
    int32_t val[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_int32x2_t val = easysimd_vld1_s32(test_vec[i].val);
    int32_t a;
    EASYSIMD_CONSTIFY_2_NO_RESULT_(easysimd_vst1_lane_s32, HEDLEY_UNREACHABLE(), test_vec[i].lane, &a, val);
    easysimd_assert_equal_i32(a, test_vec[i].a);
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    int32_t a;
    easysimd_int32x2_t val = easysimd_test_arm_neon_random_i32x2();
    const int lane = lanes[i];
    easysimd_vst1_lane_s32(&a, val, lane);

    easysimd_test_codegen_write_i32(2, a, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_arm_neon_write_i32x2(2, val, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_codegen_write_i32(2, lane, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
#endif
...
static int
test_easysimd_vst1_lane_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int64_t a;
    int64_t val[1];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_int64x1_t val = easysimd_vld1_s64(test_vec[i].val);
    int64_t a;
    easysimd_vst1_lane_s64(&a, val, 0);
    easysimd_assert_equal_i64(a, test_vec[i].a);
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    int64_t a;
    easysimd_int64x1_t val = easysimd_test_arm_neon_random_i64x1();
    const int lane = lanes[i];
    easysimd_vst1_lane_s64(&a, val, lane);

    easysimd_test_codegen_write_i64(2, a, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_arm_neon_write_i64x1(2, val, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_codegen_write_i32(2, lane, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
#endif
...
static int
test_easysimd_vst1_lane_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint8_t a;
    uint8_t val[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint8x8_t val = easysimd_vld1_u8(test_vec[i].val);
    uint8_t a;
    EASYSIMD_CONSTIFY_8_NO_RESULT_(easysimd_vst1_lane_u8, HEDLEY_UNREACHABLE(), test_vec[i].lane, &a, val);
    easysimd_assert_equal_u8(a, test_vec[i].a);
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    uint8_t a;
    easysimd_uint8x8_t val = easysimd_test_arm_neon_random_u8x8();
    const uint lane = lanes[i];
    easysimd_vst1_lane_u8(&a, val, lane);

    easysimd_test_codegen_write_u8(2, a, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_arm_neon_write_u8x8(2, val, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_codegen_write_i32(2, lane, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
#endif
...
static int
test_easysimd_vst1_lane_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint16_t a;
    uint16_t val[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint16x4_t val = easysimd_vld1_u16(test_vec[i].val);
    uint16_t a;
    EASYSIMD_CONSTIFY_4_NO_RESULT_(easysimd_vst1_lane_u16, HEDLEY_UNREACHABLE(), test_vec[i].lane, &a, val);
    easysimd_assert_equal_u16(a, test_vec[i].a);
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    uint16_t a;
    easysimd_uint16x4_t val = easysimd_test_arm_neon_random_u16x4();
    const uint lane = lanes[i];
    easysimd_vst1_lane_u16(&a, val, lane);

    easysimd_test_codegen_write_u16(2, a, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_arm_neon_write_u16x4(2, val, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_codegen_write_i32(2, lane, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
#endif
...
static int
test_easysimd_vst1_lane_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint32_t a;
    uint32_t val[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint32x2_t val = easysimd_vld1_u32(test_vec[i].val);
    uint32_t a;
    EASYSIMD_CONSTIFY_2_NO_RESULT_(easysimd_vst1_lane_u32, HEDLEY_UNREACHABLE(), test_vec[i].lane, &a, val);
    easysimd_assert_equal_u32(a, test_vec[i].a);
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    uint32_t a;
    easysimd_uint32x2_t val = easysimd_test_arm_neon_random_u32x2();
    const uint lane = lanes[i];
    easysimd_vst1_lane_u32(&a, val, lane);

    easysimd_test_codegen_write_u32(2, a, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_arm_neon_write_u32x2(2, val, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_codegen_write_i32(2, lane, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
#endif
...
static int
test_easysimd_vst1_lane_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint64_t a;
    uint64_t val[1];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint64x1_t val = easysimd_vld1_u64(test_vec[i].val);
    uint64_t a;
    easysimd_vst1_lane_u64(&a, val, 0);
    easysimd_assert_equal_u64(a, test_vec[i].a);
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    uint64_t a;
    easysimd_uint64x1_t val = easysimd_test_arm_neon_random_u64x1();
    easysimd_vst1_lane_u64(&a, val, 0);

    easysimd_test_codegen_write_u64(2, a, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_arm_neon_write_u64x1(2, val, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_codegen_write_i32(2, 0, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
#endif
}
...
static int
test_easysimd_vst1q_lane_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    easysimd_float32 a;
    easysimd_float32 val[4];
    int lane;
  } test_vec[] = {
    { EASYSIMD_FLOAT32_C(   455.33),
      { EASYSIMD_FLOAT32_C(   455.33), EASYSIMD_FLOAT32_C(  -829.93), EASYSIMD_FLOAT32_C(   456.39), EASYSIMD_FLOAT32_C(   -14.07) },
       INT32_C(           0) },
    { EASYSIMD_FLOAT32_C(   915.54),
      { EASYSIMD_FLOAT32_C(   138.27), EASYSIMD_FLOAT32_C(   915.54), EASYSIMD_FLOAT32_C(  -484.19), EASYSIMD_FLOAT32_C(  -949.94) },
       INT32_C(           1) },
    { EASYSIMD_FLOAT32_C(  -971.20),
      { EASYSIMD_FLOAT32_C(   540.73), EASYSIMD_FLOAT32_C(   942.66), EASYSIMD_FLOAT32_C(  -971.20), EASYSIMD_FLOAT32_C(    91.92) },
       INT32_C(           2) },
    { EASYSIMD_FLOAT32_C(  -278.01),
      { EASYSIMD_FLOAT32_C(  -834.19), EASYSIMD_FLOAT32_C(   557.12), EASYSIMD_FLOAT32_C(  -444.80), EASYSIMD_FLOAT32_C(  -278.01) },
       INT32_C(           3) },
    { EASYSIMD_FLOAT32_C(   -88.43),
      { EASYSIMD_FLOAT32_C(   -88.43), EASYSIMD_FLOAT32_C(  -162.64), EASYSIMD_FLOAT32_C(   136.08), EASYSIMD_FLOAT32_C(   284.45) },
       INT32_C(           0) },
    { EASYSIMD_FLOAT32_C(   -56.88),
      { EASYSIMD_FLOAT32_C(   241.27), EASYSIMD_FLOAT32_C(   -56.88), EASYSIMD_FLOAT32_C(    -1.53), EASYSIMD_FLOAT32_C(  -841.12) },
       INT32_C(           1) },
    { EASYSIMD_FLOAT32_C(   514.21),
      { EASYSIMD_FLOAT32_C(  -687.80), EASYSIMD_FLOAT32_C(  -889.79), EASYSIMD_FLOAT32_C(   514.21), EASYSIMD_FLOAT32_C(  -216.22) },
       INT32_C(           2) },
    { EASYSIMD_FLOAT32_C(  -681.62),
      { EASYSIMD_FLOAT32_C(  -136.95), EASYSIMD_FLOAT32_C(   169.15), EASYSIMD_FLOAT32_C(  -293.70), EASYSIMD_FLOAT32_C(  -681.62) },
       INT32_C(           3) },

  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float32x4_t val = easysimd_vld1q_f32(test_vec[i].val);
    easysimd_float32 a;
    EASYSIMD_CONSTIFY_4_NO_RESULT_(easysimd_vst1q_lane_f32, HEDLEY_UNREACHABLE(), test_vec[i].lane, &a, val);
    easysimd_assert_equal_f32(a, test_vec[i].a, 1);
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    easysimd_float32 a;
    easysimd_float32x4_t val = easysimd_test_arm_neon_random_f32x4(-1000.0, 1000.0);
    const uint lane = lanes[i];
    easysimd_vst1q_lane_f32(&a, val, lane);

    easysimd_test_codegen_write_f32(2, a, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_arm_neon_write_f32x4(2, val, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_codegen_write_i32(2, lane, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
#endif
...
static int
test_easysimd_vst1q_lane_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    easysimd_float64 a;
    easysimd_float64 val[2];
    int lane;
  } test_vec[] = {
    { EASYSIMD_FLOAT64_C(   521.90),
      { EASYSIMD_FLOAT64_C(   521.90), EASYSIMD_FLOAT64_C(  -472.06) },
       INT32_C(           0) },
    { EASYSIMD_FLOAT64_C(  -745.36),
      { EASYSIMD_FLOAT64_C(  -586.76), EASYSIMD_FLOAT64_C(  -745.36) },
       INT32_C(           1) },
    { EASYSIMD_FLOAT64_C(   833.21),
      { EASYSIMD_FLOAT64_C(   833.21), EASYSIMD_FLOAT64_C(  -230.32) },
       INT32_C(           0) },
    { EASYSIMD_FLOAT64_C(   228.92),
      { EASYSIMD_FLOAT64_C(   948.92), EASYSIMD_FLOAT64_C(   228.92) },
       INT32_C(           1) },
    { EASYSIMD_FLOAT64_C(   102.77),
      { EASYSIMD_FLOAT64_C(   102.77), EASYSIMD_FLOAT64_C(    74.33) },
       INT32_C(           0) },
    { EASYSIMD_FLOAT64_C(   972.13),
      { EASYSIMD_FLOAT64_C(   437.97), EASYSIMD_FLOAT64_C(   972.13) },
       INT32_C(           1) },
    { EASYSIMD_FLOAT64_C(   896.14),
      { EASYSIMD_FLOAT64_C(   896.14), EASYSIMD_FLOAT64_C(    91.47) },
       INT32_C(           0) },
    { EASYSIMD_FLOAT64_C(  -462.82),
      { EASYSIMD_FLOAT64_C(  -392.14), EASYSIMD_FLOAT64_C(  -462.82) },
       INT32_C(           1) },

  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float64x2_t val = easysimd_vld1q_f64(test_vec[i].val);
    easysimd_float64 a;
    EASYSIMD_CONSTIFY_2_NO_RESULT_(easysimd_vst1q_lane_f64, HEDLEY_UNREACHABLE(), test_vec[i].lane, &a, val);
    easysimd_assert_equal_f64(a, test_vec[i].a, 1);
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    easysimd_float64 a;
    easysimd_float64x2_t val = easysimd_test_arm_neon_random_f64x2(-1000.0, 1000.0);
    const uint lane = lanes[i];
    easysimd_vst1q_lane_f64(&a, val, lane);

    easysimd_test_codegen_write_f64(2, a, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_arm_neon_write_f64x2(2, val, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_codegen_write_i32(2, lane, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
#endif
...
static int
test_easysimd_vst1q_lane_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int8_t a;
    int8_t val[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_int8x16_t val = easysimd_vld1q_s8(test_vec[i].val);
    int8_t a;
    EASYSIMD_CONSTIFY_16_NO_RESULT_(easysimd_vst1q_lane_s8, HEDLEY_UNREACHABLE(), test_vec[i].lane, &a, val);
    easysimd_assert_equal_i8(a, test_vec[i].a);
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    int8_t a;
    easysimd_int8x16_t val = easysimd_test_arm_neon_random_i8x16();
    const uint lane = lanes[i];
    easysimd_vst1q_lane_s8(&a, val, lane);

    easysimd_test_codegen_write_i8(2, a, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_arm_neon_write_i8x16(2, val, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_codegen_write_i32(2, lane, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
#endif
...
static int
test_easysimd_vst1q_lane_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int16_t a;
    int16_t val[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_int16x8_t val = easysimd_vld1q_s16(test_vec[i].val);
    int16_t a;
    EASYSIMD_CONSTIFY_8_NO_RESULT_(easysimd_vst1q_lane_s16, HEDLEY_UNREACHABLE(), test_vec[i].lane, &a, val);
    easysimd_assert_equal_i16(a, test_vec[i].a);
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    int16_t a;
    easysimd_int16x8_t val = easysimd_test_arm_neon_random_i16x8();
    const uint lane = lanes[i];
    easysimd_vst1q_lane_s16(&a, val, lane);

    easysimd_test_codegen_write_i16(2, a, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_arm_neon_write_i16x8(2, val, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_codegen_write_i32(2, lane, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
#endif
...
static int
test_easysimd_vst1q_lane_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t a;
    int32_t val[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_int32x4_t val = easysimd_vld1q_s32(test_vec[i].val);
    int32_t a;
    EASYSIMD_CONSTIFY_4_NO_RESULT_(easysimd_vst1q_lane_s32, HEDLEY_UNREACHABLE(), test_vec[i].lane, &a, val);
    easysimd_assert_equal_i32(a, test_vec[i].a);
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    int32_t a;
    easysimd_int32x4_t val = easysimd_test_arm_neon_random_i32x4();
    const uint lane = lanes[i];
    easysimd_vst1q_lane_s32(&a, val, lane);

    easysimd_test_codegen_write_i32(2, a, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_arm_neon_write_i32x4(2, val, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_codegen_write_i32(2, lane, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
#endif
...
static int
test_easysimd_vst1q_lane_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int64_t a;
    int64_t val[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_int64x2_t val = easysimd_vld1q_s64(test_vec[i].val);
    int64_t a;
    EASYSIMD_CONSTIFY_2_NO_RESULT_(easysimd_vst1q_lane_s64, HEDLEY_UNREACHABLE(), test_vec[i].lane, &a, val);
    easysimd_assert_equal_i64(a, test_vec[i].a);
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    int64_t a;
    easysimd_int64x2_t val = easysimd_test_arm_neon_random_i64x2();
    const uint lane = lanes[i];
    easysimd_vst1q_lane_s64(&a, val, lane);

    easysimd_test_codegen_write_i64(2, a, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_arm_neon_write_i64x2(2, val, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_codegen_write_i32(2, lane, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
#endif
...
static int
test_easysimd_vst1q_lane_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint8_t a;
    uint8_t val[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint8x16_t val = easysimd_vld1q_u8(test_vec[i].val);
    uint8_t a;
    EASYSIMD_CONSTIFY_16_NO_RESULT_(easysimd_vst1q_lane_u8, HEDLEY_UNREACHABLE(), test_vec[i].lane, &a, val);
    easysimd_assert_equal_u8(a, test_vec[i].a);
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    uint8_t a;
    easysimd_uint8x16_t val = easysimd_test_arm_neon_random_u8x16();
    const uint lane = lanes[i];
    easysimd_vst1q_lane_u8(&a, val, lane);

    easysimd_test_codegen_write_u8(2, a, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_arm_neon_write_u8x16(2, val, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_codegen_write_i32(2, lane, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
#endif
...
static int
test_easysimd_vst1q_lane_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint16_t a;
    uint16_t val[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint16x8_t val = easysimd_vld1q_u16(test_vec[i].val);
    uint16_t a;
    EASYSIMD_CONSTIFY_8_NO_RESULT_(easysimd_vst1q_lane_u16, HEDLEY_UNREACHABLE(), test_vec[i].lane, &a, val);
    easysimd_assert_equal_u16(a, test_vec[i].a);
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    uint16_t a;
    easysimd_uint16x8_t val = easysimd_test_arm_neon_random_u16x8();
    const uint lane = lanes[i];
    easysimd_vst1q_lane_u16(&a, val, lane);

    easysimd_test_codegen_write_u16(2, a, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_arm_neon_write_u16x8(2, val, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_codegen_write_i32(2, lane, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
#endif
...
static int
test_easysimd_vst1q_lane_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint32_t a;
    uint32_t val[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint32x4_t val = easysimd_vld1q_u32(test_vec[i].val);
    uint32_t a;
    EASYSIMD_CONSTIFY_4_NO_RESULT_(easysimd_vst1q_lane_u32, HEDLEY_UNREACHABLE(), test_vec[i].lane, &a, val);
    easysimd_assert_equal_u32(a, test_vec[i].a);
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    uint32_t a;
    easysimd_uint32x4_t val = easysimd_test_arm_neon_random_u32x4();
    const uint lane = lanes[i];
    easysimd_vst1q_lane_u32(&a, val, lane);

    easysimd_test_codegen_write_u32(2, a, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_arm_neon_write_u32x4(2, val, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_codegen_write_i32(2, lane, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
#endif
...
static int
test_easysimd_vst1q_lane_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint64_t a;
    uint64_t val[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint64x2_t val = easysimd_vld1q_u64(test_vec[i].val);
    uint64_t a;
    EASYSIMD_CONSTIFY_2_NO_RESULT_(easysimd_vst1q_lane_u64, HEDLEY_UNREACHABLE(), test_vec[i].lane, &a, val);
    easysimd_assert_equal_u64(a, test_vec[i].a);
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    uint64_t a;
    easysimd_uint64x2_t val = easysimd_test_arm_neon_random_u64x2();
    const uint lane = lanes[i];
    easysimd_vst1q_lane_u64(&a, val, lane);

    easysimd_test_codegen_write_u64(2, a, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_arm_neon_write_u64x2(2, val, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_codegen_write_i32(2, lane, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
#endif
...
EASYSIMD_TEST_FUNC_LIST_ENTRY(vst1_lane_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vst1_lane_f64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vst1_lane_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vst1_lane_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vst1_lane_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vst1_lane_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vst1_lane_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vst1_lane_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vst1_lane_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vst1_lane_u64)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vst1q_lane_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vst1q_lane_f64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vst1q_lane_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vst1q_lane_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vst1q_lane_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vst1q_lane_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vst1q_lane_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vst1q_lane_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vst1q_lane_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vst1q_lane_u64)
