...
#include "test/test.h"
#define EASYSIMD_TEST_ARM_NEON_INSN st2
#include "test-neon.h"
#include "../../../easysimd/arm/neon/st2.h"

#if !defined(EASYSIMD_BUG_INTEL_857088)

static int
test_easysimd_vst2_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    ...
    { { EASYSIMD_FLOAT32_C(    16.58), EASYSIMD_FLOAT32_C(  -833.98) },
      { EASYSIMD_FLOAT32_C(   104.15), EASYSIMD_FLOAT32_C(  -390.57) },
      { EASYSIMD_FLOAT32_C(    16.58), EASYSIMD_FLOAT32_C(   104.15), EASYSIMD_FLOAT32_C(  -833.98), EASYSIMD_FLOAT32_C(  -390.57) } },
    { { EASYSIMD_FLOAT32_C(  -490.85), EASYSIMD_FLOAT32_C(   -58.75) },
      { EASYSIMD_FLOAT32_C(   959.78), EASYSIMD_FLOAT32_C(   101.04) },
      { EASYSIMD_FLOAT32_C(  -490.85), EASYSIMD_FLOAT32_C(   959.78), EASYSIMD_FLOAT32_C(   -58.75), EASYSIMD_FLOAT32_C(   101.04) } },
    { { EASYSIMD_FLOAT32_C(  -997.46), EASYSIMD_FLOAT32_C(   256.92) },
      { EASYSIMD_FLOAT32_C(   188.22), EASYSIMD_FLOAT32_C(  -745.54) },
      { EASYSIMD_FLOAT32_C(  -997.46), EASYSIMD_FLOAT32_C(   188.22), EASYSIMD_FLOAT32_C(   256.92), EASYSIMD_FLOAT32_C(  -745.54) } },
    { { EASYSIMD_FLOAT32_C(   -96.17), EASYSIMD_FLOAT32_C(   503.93) },
      { EASYSIMD_FLOAT32_C(  -366.65), EASYSIMD_FLOAT32_C(   363.77) },
      { EASYSIMD_FLOAT32_C(   -96.17), EASYSIMD_FLOAT32_C(  -366.65), EASYSIMD_FLOAT32_C(   503.93), EASYSIMD_FLOAT32_C(   363.77) } },
    { { EASYSIMD_FLOAT32_C(   624.56), EASYSIMD_FLOAT32_C(   975.47) },
      { EASYSIMD_FLOAT32_C(  -418.14), EASYSIMD_FLOAT32_C(  -827.91) },
      { EASYSIMD_FLOAT32_C(   624.56), EASYSIMD_FLOAT32_C(  -418.14), EASYSIMD_FLOAT32_C(   975.47), EASYSIMD_FLOAT32_C(  -827.91) } },
    { { EASYSIMD_FLOAT32_C(   877.41), EASYSIMD_FLOAT32_C(    17.43) },
      { EASYSIMD_FLOAT32_C(   269.24), EASYSIMD_FLOAT32_C(   712.61) },
      { EASYSIMD_FLOAT32_C(   877.41), EASYSIMD_FLOAT32_C(   269.24), EASYSIMD_FLOAT32_C(    17.43), EASYSIMD_FLOAT32_C(   712.61) } },
    { { EASYSIMD_FLOAT32_C(  -244.13), EASYSIMD_FLOAT32_C(  -617.42) },
      { EASYSIMD_FLOAT32_C(   500.72), EASYSIMD_FLOAT32_C(  -493.36) },
      { EASYSIMD_FLOAT32_C(  -244.13), EASYSIMD_FLOAT32_C(   500.72), EASYSIMD_FLOAT32_C(  -617.42), EASYSIMD_FLOAT32_C(  -493.36) } },
    { { EASYSIMD_FLOAT32_C(  -230.20), EASYSIMD_FLOAT32_C(   102.18) },
      { EASYSIMD_FLOAT32_C(   293.56), EASYSIMD_FLOAT32_C(   786.38) },
      { EASYSIMD_FLOAT32_C(  -230.20), EASYSIMD_FLOAT32_C(   293.56), EASYSIMD_FLOAT32_C(   102.18), EASYSIMD_FLOAT32_C(   786.38) } },
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float32x2x2_t r_ = { { easysimd_vld1_f32(test_vec[i].r0),
                                 easysimd_vld1_f32(test_vec[i].r1) } };

    easysimd_float32 a_[4];
    easysimd_vst2_f32(a_, r_);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_float32 buf[4];
    easysimd_vst2_f32(buf, c);

    easysimd_test_codegen_write_vf32(2, sizeof(buf) / sizeof(buf[0]), buf,
                                  EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
#endif
}
...
static int
test_easysimd_vst2_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    ...
    { { EASYSIMD_FLOAT64_C(   392.49) },
      { EASYSIMD_FLOAT64_C(   204.55) },
      { EASYSIMD_FLOAT64_C(   392.49), EASYSIMD_FLOAT64_C(   204.55) } },
    { { EASYSIMD_FLOAT64_C(   727.16) },
      { EASYSIMD_FLOAT64_C(   738.24) },
      { EASYSIMD_FLOAT64_C(   727.16), EASYSIMD_FLOAT64_C(   738.24) } },
    { { EASYSIMD_FLOAT64_C(   987.55) },
      { EASYSIMD_FLOAT64_C(  -537.01) },
      { EASYSIMD_FLOAT64_C(   987.55), EASYSIMD_FLOAT64_C(  -537.01) } },
    { { EASYSIMD_FLOAT64_C(   727.60) },
      { EASYSIMD_FLOAT64_C(  -348.79) },
      { EASYSIMD_FLOAT64_C(   727.60), EASYSIMD_FLOAT64_C(  -348.79) } },
    { { EASYSIMD_FLOAT64_C(  -739.96) },
      { EASYSIMD_FLOAT64_C(  -473.84) },
      { EASYSIMD_FLOAT64_C(  -739.96), EASYSIMD_FLOAT64_C(  -473.84) } },
    { { EASYSIMD_FLOAT64_C(   -82.16) },
      { EASYSIMD_FLOAT64_C(  -848.99) },
      { EASYSIMD_FLOAT64_C(   -82.16), EASYSIMD_FLOAT64_C(  -848.99) } },
    { { EASYSIMD_FLOAT64_C(  -651.42) },
      { EASYSIMD_FLOAT64_C(  -148.81) },
      { EASYSIMD_FLOAT64_C(  -651.42), EASYSIMD_FLOAT64_C(  -148.81) } },
    { { EASYSIMD_FLOAT64_C(  -782.36) },
      { EASYSIMD_FLOAT64_C(  -642.06) },
      { EASYSIMD_FLOAT64_C(  -782.36), EASYSIMD_FLOAT64_C(  -642.06) } }
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float64x1x2_t r_ = { { easysimd_vld1_f64(test_vec[i].r0),
                                 easysimd_vld1_f64(test_vec[i].r1) } };

    easysimd_float64 a_[2];
    easysimd_vst2_f64(a_, r_);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_float64 buf[2];
    easysimd_vst2_f64(buf, c);

    easysimd_test_codegen_write_vf64(2, sizeof(buf) / sizeof(buf[0]), buf,
                                  EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
#endif
...
static int
test_easysimd_vst2_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int8_t r0[8];
    int8_t r1[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_int8x8x2_t r_ = { { easysimd_vld1_s8(test_vec[i].r0),
                              easysimd_vld1_s8(test_vec[i].r1) } };

    int8_t a_[16];
    easysimd_vst2_s8(a_, r_);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    int8_t buf[16];
    easysimd_vst2_s8(buf, c);

    easysimd_test_codegen_write_vi8(2, sizeof(buf) / sizeof(buf[0]), buf,
                                 EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
#endif
...
static int
test_easysimd_vst2_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int16_t r0[4];
    int16_t r1[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_int16x4x2_t r_ = { { easysimd_vld1_s16(test_vec[i].r0),
                               easysimd_vld1_s16(test_vec[i].r1) } };

    int16_t a_[8];
    easysimd_vst2_s16(a_, r_);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    int16_t buf[8];
    easysimd_vst2_s16(buf, c);

    easysimd_test_codegen_write_vi16(2, sizeof(buf) / sizeof(buf[0]), buf,
                                  EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
#endif
...
static int
test_easysimd_vst2_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t r0[2];
    int32_t r1[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_int32x2x2_t r_ = { { easysimd_vld1_s32(test_vec[i].r0),
                               easysimd_vld1_s32(test_vec[i].r1) } };

    int32_t a_[4];
    easysimd_vst2_s32(a_, r_);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    int32_t buf[4];
    easysimd_vst2_s32(buf, c);

    easysimd_test_codegen_write_vi32(2, sizeof(buf) / sizeof(buf[0]), buf,
                                  EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
#endif
...
static int
test_easysimd_vst2_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int64_t r0[1];
    int64_t r1[1];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_int64x1x2_t r_ = { { easysimd_vld1_s64(test_vec[i].r0),
                               easysimd_vld1_s64(test_vec[i].r1) } };

    int64_t a_[2];
    easysimd_vst2_s64(a_, r_);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    int64_t buf[2];
    easysimd_vst2_s64(buf, c);

    easysimd_test_codegen_write_vi64(2, sizeof(buf) / sizeof(buf[0]), buf,
                                  EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
#endif
...
static int
test_easysimd_vst2_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint8_t r0[8];
    uint8_t r1[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint8x8x2_t r_ = { { easysimd_vld1_u8(test_vec[i].r0),
                               easysimd_vld1_u8(test_vec[i].r1) } };

    uint8_t a_[16];
    easysimd_vst2_u8(a_, r_);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    uint8_t buf[16];
    easysimd_vst2_u8(buf, c);

    easysimd_test_codegen_write_vu8(2, sizeof(buf) / sizeof(buf[0]), buf,
                                 EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
#endif
...
static int
test_easysimd_vst2_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint16_t r0[4];
    uint16_t r1[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint16x4x2_t r_ = { { easysimd_vld1_u16(test_vec[i].r0),
                                easysimd_vld1_u16(test_vec[i].r1) } };

    uint16_t a_[8];
    easysimd_vst2_u16(a_, r_);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    uint16_t buf[8];
    easysimd_vst2_u16(buf, c);

    easysimd_test_codegen_write_vu16(2, sizeof(buf) / sizeof(buf[0]), buf,
                                  EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
#endif
...
static int
test_easysimd_vst2_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint32_t r0[2];
    uint32_t r1[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint32x2x2_t r_ = { { easysimd_vld1_u32(test_vec[i].r0),
                                easysimd_vld1_u32(test_vec[i].r1) } };

    uint32_t a_[4];
    easysimd_vst2_u32(a_, r_);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    uint32_t buf[4];
    easysimd_vst2_u32(buf, c);

    easysimd_test_codegen_write_vu32(2, sizeof(buf) / sizeof(buf[0]), buf,
                                  EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
#endif
...
static int
test_easysimd_vst2_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint64_t r0[1];
    uint64_t r1[1];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint64x1x2_t r_ = { { easysimd_vld1_u64(test_vec[i].r0),
                               easysimd_vld1_u64(test_vec[i].r1) } };

    uint64_t a_[2];
    easysimd_vst2_u64(a_, r_);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    uint64_t buf[2];
    easysimd_vst2_u64(buf, c);

    easysimd_test_codegen_write_vu64(2, sizeof(buf) / sizeof(buf[0]), buf,
                                  EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
#endif
...
static int
test_easysimd_vst2q_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    ...
    { { EASYSIMD_FLOAT32_C(   423.81), EASYSIMD_FLOAT32_C(  -124.71), EASYSIMD_FLOAT32_C(   516.24), EASYSIMD_FLOAT32_C(  -556.87) },
      { EASYSIMD_FLOAT32_C(  -912.68), EASYSIMD_FLOAT32_C(   430.93), EASYSIMD_FLOAT32_C(  -749.76), EASYSIMD_FLOAT32_C(   580.03) },
      { EASYSIMD_FLOAT32_C(   423.81), EASYSIMD_FLOAT32_C(  -912.68), EASYSIMD_FLOAT32_C(  -124.71), EASYSIMD_FLOAT32_C(   430.93),
        EASYSIMD_FLOAT32_C(   516.24), EASYSIMD_FLOAT32_C(  -749.76), EASYSIMD_FLOAT32_C(  -556.87), EASYSIMD_FLOAT32_C(   580.03) } },
    { { EASYSIMD_FLOAT32_C(  -326.15), EASYSIMD_FLOAT32_C(  -517.81), EASYSIMD_FLOAT32_C(   402.04), EASYSIMD_FLOAT32_C(  -647.44) },
      { EASYSIMD_FLOAT32_C(  -648.95), EASYSIMD_FLOAT32_C(   211.81), EASYSIMD_FLOAT32_C(   771.88), EASYSIMD_FLOAT32_C(   212.81) },
      { EASYSIMD_FLOAT32_C(  -326.15), EASYSIMD_FLOAT32_C(  -648.95), EASYSIMD_FLOAT32_C(  -517.81), EASYSIMD_FLOAT32_C(   211.81),
        EASYSIMD_FLOAT32_C(   402.04), EASYSIMD_FLOAT32_C(   771.88), EASYSIMD_FLOAT32_C(  -647.44), EASYSIMD_FLOAT32_C(   212.81) } },
    { { EASYSIMD_FLOAT32_C(    47.52), EASYSIMD_FLOAT32_C(   289.92), EASYSIMD_FLOAT32_C(   340.43), EASYSIMD_FLOAT32_C(  -471.48) },
      { EASYSIMD_FLOAT32_C(  -880.10), EASYSIMD_FLOAT32_C(   -75.95), EASYSIMD_FLOAT32_C(  -630.49), EASYSIMD_FLOAT32_C(   244.57) },
      { EASYSIMD_FLOAT32_C(    47.52), EASYSIMD_FLOAT32_C(  -880.10), EASYSIMD_FLOAT32_C(   289.92), EASYSIMD_FLOAT32_C(   -75.95),
        EASYSIMD_FLOAT32_C(   340.43), EASYSIMD_FLOAT32_C(  -630.49), EASYSIMD_FLOAT32_C(  -471.48), EASYSIMD_FLOAT32_C(   244.57) } },
    { { EASYSIMD_FLOAT32_C(   582.67), EASYSIMD_FLOAT32_C(   160.87), EASYSIMD_FLOAT32_C(  -192.06), EASYSIMD_FLOAT32_C(   463.37) },
      { EASYSIMD_FLOAT32_C(  -193.22), EASYSIMD_FLOAT32_C(   368.17), EASYSIMD_FLOAT32_C(   886.93), EASYSIMD_FLOAT32_C(  -769.41) },
      { EASYSIMD_FLOAT32_C(   582.67), EASYSIMD_FLOAT32_C(  -193.22), EASYSIMD_FLOAT32_C(   160.87), EASYSIMD_FLOAT32_C(   368.17),
        EASYSIMD_FLOAT32_C(  -192.06), EASYSIMD_FLOAT32_C(   886.93), EASYSIMD_FLOAT32_C(   463.37), EASYSIMD_FLOAT32_C(  -769.41) } },
    { { EASYSIMD_FLOAT32_C(  -756.54), EASYSIMD_FLOAT32_C(   403.17), EASYSIMD_FLOAT32_C(  -326.28), EASYSIMD_FLOAT32_C(  -669.22) },
      { EASYSIMD_FLOAT32_C(  -165.90), EASYSIMD_FLOAT32_C(   -76.04), EASYSIMD_FLOAT32_C(   910.81), EASYSIMD_FLOAT32_C(   507.95) },
      { EASYSIMD_FLOAT32_C(  -756.54), EASYSIMD_FLOAT32_C(  -165.90), EASYSIMD_FLOAT32_C(   403.17), EASYSIMD_FLOAT32_C(   -76.04),
        EASYSIMD_FLOAT32_C(  -326.28), EASYSIMD_FLOAT32_C(   910.81), EASYSIMD_FLOAT32_C(  -669.22), EASYSIMD_FLOAT32_C(   507.95) } },
    { { EASYSIMD_FLOAT32_C(   406.16), EASYSIMD_FLOAT32_C(   312.85), EASYSIMD_FLOAT32_C(   860.51), EASYSIMD_FLOAT32_C(   757.21) },
      { EASYSIMD_FLOAT32_C(  -475.34), EASYSIMD_FLOAT32_C(   632.40), EASYSIMD_FLOAT32_C(   -29.99), EASYSIMD_FLOAT32_C(   572.19) },
      { EASYSIMD_FLOAT32_C(   406.16), EASYSIMD_FLOAT32_C(  -475.34), EASYSIMD_FLOAT32_C(   312.85), EASYSIMD_FLOAT32_C(   632.40),
        EASYSIMD_FLOAT32_C(   860.51), EASYSIMD_FLOAT32_C(   -29.99), EASYSIMD_FLOAT32_C(   757.21), EASYSIMD_FLOAT32_C(   572.19) } },
    { { EASYSIMD_FLOAT32_C(   -77.68), EASYSIMD_FLOAT32_C(  -689.55), EASYSIMD_FLOAT32_C(  -899.30), EASYSIMD_FLOAT32_C(    42.23) },
      { EASYSIMD_FLOAT32_C(   234.49), EASYSIMD_FLOAT32_C(  -529.79), EASYSIMD_FLOAT32_C(  -713.20), EASYSIMD_FLOAT32_C(  -182.84) },
      { EASYSIMD_FLOAT32_C(   -77.68), EASYSIMD_FLOAT32_C(   234.49), EASYSIMD_FLOAT32_C(  -689.55), EASYSIMD_FLOAT32_C(  -529.79),
        EASYSIMD_FLOAT32_C(  -899.30), EASYSIMD_FLOAT32_C(  -713.20), EASYSIMD_FLOAT32_C(    42.23), EASYSIMD_FLOAT32_C(  -182.84) } },
    { { EASYSIMD_FLOAT32_C(   631.08), EASYSIMD_FLOAT32_C(    94.74), EASYSIMD_FLOAT32_C(  -719.47), EASYSIMD_FLOAT32_C(  -562.14) },
      { EASYSIMD_FLOAT32_C(  -537.09), EASYSIMD_FLOAT32_C(  -832.54), EASYSIMD_FLOAT32_C(  -331.55), EASYSIMD_FLOAT32_C(  -293.63) },
      { EASYSIMD_FLOAT32_C(   631.08), EASYSIMD_FLOAT32_C(  -537.09), EASYSIMD_FLOAT32_C(    94.74), EASYSIMD_FLOAT32_C(  -832.54),
        EASYSIMD_FLOAT32_C(  -719.47), EASYSIMD_FLOAT32_C(  -331.55), EASYSIMD_FLOAT32_C(  -562.14), EASYSIMD_FLOAT32_C(  -293.63) } },
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float32x4x2_t r_ = { { easysimd_vld1q_f32(test_vec[i].r0),
                                 easysimd_vld1q_f32(test_vec[i].r1) } };

    easysimd_float32 a_[8];
    easysimd_vst2q_f32(a_, r_);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_float32 buf[8];
    easysimd_vst2q_f32(buf, c);
...
static int
test_easysimd_vst2q_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    ...
    { { EASYSIMD_FLOAT64_C(   773.26), EASYSIMD_FLOAT64_C(   508.70) },
      { EASYSIMD_FLOAT64_C(  -400.17), EASYSIMD_FLOAT64_C(   386.84) },
      { EASYSIMD_FLOAT64_C(   773.26), EASYSIMD_FLOAT64_C(  -400.17), EASYSIMD_FLOAT64_C(   508.70), EASYSIMD_FLOAT64_C(   386.84) } },
    { { EASYSIMD_FLOAT64_C(  -216.30), EASYSIMD_FLOAT64_C(  -930.29) },
      { EASYSIMD_FLOAT64_C(   128.42), EASYSIMD_FLOAT64_C(  -901.09) },
      { EASYSIMD_FLOAT64_C(  -216.30), EASYSIMD_FLOAT64_C(   128.42), EASYSIMD_FLOAT64_C(  -930.29), EASYSIMD_FLOAT64_C(  -901.09) } },
    { { EASYSIMD_FLOAT64_C(   560.58), EASYSIMD_FLOAT64_C(  -592.22) },
      { EASYSIMD_FLOAT64_C(  -591.77), EASYSIMD_FLOAT64_C(    51.46) },
      { EASYSIMD_FLOAT64_C(   560.58), EASYSIMD_FLOAT64_C(  -591.77), EASYSIMD_FLOAT64_C(  -592.22), EASYSIMD_FLOAT64_C(    51.46) } },
    { { EASYSIMD_FLOAT64_C(  -393.97), EASYSIMD_FLOAT64_C(   150.15) },
      { EASYSIMD_FLOAT64_C(  -862.47), EASYSIMD_FLOAT64_C(  -343.60) },
      { EASYSIMD_FLOAT64_C(  -393.97), EASYSIMD_FLOAT64_C(  -862.47), EASYSIMD_FLOAT64_C(   150.15), EASYSIMD_FLOAT64_C(  -343.60) } },
    { { EASYSIMD_FLOAT64_C(   750.40), EASYSIMD_FLOAT64_C(   373.85) },
      { EASYSIMD_FLOAT64_C(    56.86), EASYSIMD_FLOAT64_C(  -709.04) },
      { EASYSIMD_FLOAT64_C(   750.40), EASYSIMD_FLOAT64_C(    56.86), EASYSIMD_FLOAT64_C(   373.85), EASYSIMD_FLOAT64_C(  -709.04) } },
    { { EASYSIMD_FLOAT64_C(  -350.28), EASYSIMD_FLOAT64_C(  -848.47) },
      { EASYSIMD_FLOAT64_C(   -16.93), EASYSIMD_FLOAT64_C(  -124.16) },
      { EASYSIMD_FLOAT64_C(  -350.28), EASYSIMD_FLOAT64_C(   -16.93), EASYSIMD_FLOAT64_C(  -848.47), EASYSIMD_FLOAT64_C(  -124.16) } },
    { { EASYSIMD_FLOAT64_C(   348.09), EASYSIMD_FLOAT64_C(   770.67) },
      { EASYSIMD_FLOAT64_C(  -435.48), EASYSIMD_FLOAT64_C(   628.39) },
      { EASYSIMD_FLOAT64_C(   348.09), EASYSIMD_FLOAT64_C(  -435.48), EASYSIMD_FLOAT64_C(   770.67), EASYSIMD_FLOAT64_C(   628.39) } },
    { { EASYSIMD_FLOAT64_C(    89.72), EASYSIMD_FLOAT64_C(  -857.28) },
      { EASYSIMD_FLOAT64_C(  -943.86), EASYSIMD_FLOAT64_C(  -137.01) },
      { EASYSIMD_FLOAT64_C(    89.72), EASYSIMD_FLOAT64_C(  -943.86), EASYSIMD_FLOAT64_C(  -857.28), EASYSIMD_FLOAT64_C(  -137.01) } }
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float64x2x2_t r_ = { { easysimd_vld1q_f64(test_vec[i].r0),
                                 easysimd_vld1q_f64(test_vec[i].r1) } };

    easysimd_float64 a_[4];
    easysimd_vst2q_f64(a_, r_);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_float64 buf[4];
    easysimd_vst2q_f64(buf, c);
...
static int
test_easysimd_vst2q_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int8_t r0[16];
    int8_t r1[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_int8x16x2_t r_ = { { easysimd_vld1q_s8(test_vec[i].r0),
                               easysimd_vld1q_s8(test_vec[i].r1) } };

    int8_t a_[32];
    easysimd_vst2q_s8(a_, r_);
...
static int
test_easysimd_vst2q_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int16_t r0[8];
    int16_t r1[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_int16x8x2_t r_ = { { easysimd_vld1q_s16(test_vec[i].r0),
                               easysimd_vld1q_s16(test_vec[i].r1) } };

    int16_t a_[16];
    easysimd_vst2q_s16(a_, r_);
...
static int
test_easysimd_vst2q_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t r0[4];
    int32_t r1[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_int32x4x2_t r_ = { { easysimd_vld1q_s32(test_vec[i].r0),
                               easysimd_vld1q_s32(test_vec[i].r1) } };

    int32_t a_[8];
    easysimd_vst2q_s32(a_, r_);
...
static int
test_easysimd_vst2q_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int64_t r0[2];
    int64_t r1[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_int64x2x2_t r_ = { { easysimd_vld1q_s64(test_vec[i].r0),
                               easysimd_vld1q_s64(test_vec[i].r1) } };

    int64_t a_[8];
    easysimd_vst2q_s64(a_, r_);
...
static int
test_easysimd_vst2q_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint8_t r0[16];
    uint8_t r1[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint8x16x2_t r_ = { { easysimd_vld1q_u8(test_vec[i].r0),
                                easysimd_vld1q_u8(test_vec[i].r1) } };

    uint8_t a_[32];
    easysimd_vst2q_u8(a_, r_);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    uint8_t buf[32];
    easysimd_vst2q_u8(buf, c);

    easysimd_test_codegen_write_vu8(2, 32, buf, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
#endif
}
...
static int
test_easysimd_vst2q_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint16_t r0[8];
    uint16_t r1[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint16x8x2_t r_ = { { easysimd_vld1q_u16(test_vec[i].r0),
                               easysimd_vld1q_u16(test_vec[i].r1) } };

    uint16_t a_[16];
    easysimd_vst2q_u16(a_, r_);
...
static int
test_easysimd_vst2q_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint32_t r0[4];
    uint32_t r1[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint32x4x2_t r_ = { { easysimd_vld1q_u32(test_vec[i].r0),
                                easysimd_vld1q_u32(test_vec[i].r1) } };

    uint32_t a_[8];
    easysimd_vst2q_u32(a_, r_);
...
static int
test_easysimd_vst2q_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint64_t r0[2];
    uint64_t r1[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint64x2x2_t r_ = { { easysimd_vld1q_u64(test_vec[i].r0),
                               easysimd_vld1q_u64(test_vec[i].r1) } };

    uint64_t a_[8];
    easysimd_vst2q_u64(a_, r_);
...
#if !defined(EASYSIMD_BUG_INTEL_857088)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vst2_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vst2_f64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vst2_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vst2_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vst2_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vst2_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vst2_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vst2_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vst2_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vst2_u64)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vst2q_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vst2q_f64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vst2q_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vst2q_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vst2q_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vst2q_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vst2q_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vst2q_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vst2q_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vst2q_u64)
#endif /* !defined(EASYSIMD_BUG_INTEL_857088) */
