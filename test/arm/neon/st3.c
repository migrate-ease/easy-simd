#define EASYSIMD_TEST_ARM_NEON_INSN st3

#include "test-neon.h"
#include "../../../easysimd/arm/neon/st3.h"
#include "../../../easysimd/arm/neon/ld3.h"
...
static int
test_easysimd_vst3_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    easysimd_float32 r0[2];
    easysimd_float32 r1[2];
    easysimd_float32 r2[2];
    easysimd_float32 a[6];
  } test_vec[] = {
    { { EASYSIMD_FLOAT32_C(   966.95), EASYSIMD_FLOAT32_C(  -826.32) },
      { EASYSIMD_FLOAT32_C(  -900.75), EASYSIMD_FLOAT32_C(   795.70) },
      { EASYSIMD_FLOAT32_C(  -772.41), EASYSIMD_FLOAT32_C(   343.84) },
      {
      EASYSIMD_FLOAT32_C(   966.95),
      EASYSIMD_FLOAT32_C(  -900.75),
      EASYSIMD_FLOAT32_C(  -772.41),
      EASYSIMD_FLOAT32_C(  -826.32),
      EASYSIMD_FLOAT32_C(   795.70),
      EASYSIMD_FLOAT32_C(   343.84),
      }
    },
    { { EASYSIMD_FLOAT32_C(  -783.51), EASYSIMD_FLOAT32_C(   493.54) },
      { EASYSIMD_FLOAT32_C(  -971.39), EASYSIMD_FLOAT32_C(   895.53) },
      { EASYSIMD_FLOAT32_C(   208.75), EASYSIMD_FLOAT32_C(   253.35) },
      {
      EASYSIMD_FLOAT32_C(  -783.51),
      EASYSIMD_FLOAT32_C(  -971.39),
      EASYSIMD_FLOAT32_C(   208.75),
      EASYSIMD_FLOAT32_C(   493.54),
      EASYSIMD_FLOAT32_C(   895.53),
      EASYSIMD_FLOAT32_C(   253.35),
      }
    },
    { { EASYSIMD_FLOAT32_C(   867.44), EASYSIMD_FLOAT32_C(   363.06) },
      { EASYSIMD_FLOAT32_C(   749.57), EASYSIMD_FLOAT32_C(  -109.51) },
      { EASYSIMD_FLOAT32_C(   -81.12), EASYSIMD_FLOAT32_C(  -786.46) },
      {
      EASYSIMD_FLOAT32_C(   867.44),
      EASYSIMD_FLOAT32_C(   749.57),
      EASYSIMD_FLOAT32_C(   -81.12),
      EASYSIMD_FLOAT32_C(   363.06),
      EASYSIMD_FLOAT32_C(  -109.51),
      EASYSIMD_FLOAT32_C(  -786.46),
      }
    },
    { { EASYSIMD_FLOAT32_C(   687.74), EASYSIMD_FLOAT32_C(  -617.77) },
      { EASYSIMD_FLOAT32_C(   482.69), EASYSIMD_FLOAT32_C(   219.53) },
      { EASYSIMD_FLOAT32_C(   980.32), EASYSIMD_FLOAT32_C(  -243.91) },
      {
      EASYSIMD_FLOAT32_C(   687.74),
      EASYSIMD_FLOAT32_C(   482.69),
      EASYSIMD_FLOAT32_C(   980.32),
      EASYSIMD_FLOAT32_C(  -617.77),
      EASYSIMD_FLOAT32_C(   219.53),
      EASYSIMD_FLOAT32_C(  -243.91),
      }
    },
    { { EASYSIMD_FLOAT32_C(  -516.59), EASYSIMD_FLOAT32_C(  -483.00) },
      { EASYSIMD_FLOAT32_C(   444.86), EASYSIMD_FLOAT32_C(   663.90) },
      { EASYSIMD_FLOAT32_C(   259.84), EASYSIMD_FLOAT32_C(  -602.70) },
      {
      EASYSIMD_FLOAT32_C(  -516.59),
      EASYSIMD_FLOAT32_C(   444.86),
      EASYSIMD_FLOAT32_C(   259.84),
      EASYSIMD_FLOAT32_C(  -483.00),
      EASYSIMD_FLOAT32_C(   663.90),
      EASYSIMD_FLOAT32_C(  -602.70),
      }
    },
    { { EASYSIMD_FLOAT32_C(   -83.32), EASYSIMD_FLOAT32_C(   226.79) },
      { EASYSIMD_FLOAT32_C(  -429.02), EASYSIMD_FLOAT32_C(    15.93) },
      { EASYSIMD_FLOAT32_C(    22.49), EASYSIMD_FLOAT32_C(  -201.43) },
      {
      EASYSIMD_FLOAT32_C(   -83.32),
      EASYSIMD_FLOAT32_C(  -429.02),
      EASYSIMD_FLOAT32_C(    22.49),
      EASYSIMD_FLOAT32_C(   226.79),
      EASYSIMD_FLOAT32_C(    15.93),
      EASYSIMD_FLOAT32_C(  -201.43),
      }
    },
    { { EASYSIMD_FLOAT32_C(  -640.23), EASYSIMD_FLOAT32_C(   238.98) },
      { EASYSIMD_FLOAT32_C(  -707.89), EASYSIMD_FLOAT32_C(  -611.62) },
      { EASYSIMD_FLOAT32_C(   134.51), EASYSIMD_FLOAT32_C(   500.86) },
      {
      EASYSIMD_FLOAT32_C(  -640.23),
      EASYSIMD_FLOAT32_C(  -707.89),
      EASYSIMD_FLOAT32_C(   134.51),
      EASYSIMD_FLOAT32_C(   238.98),
      EASYSIMD_FLOAT32_C(  -611.62),
      EASYSIMD_FLOAT32_C(   500.86),
      }
    },
    { { EASYSIMD_FLOAT32_C(   641.73), EASYSIMD_FLOAT32_C(     1.95) },
      { EASYSIMD_FLOAT32_C(  -136.08), EASYSIMD_FLOAT32_C(   391.30) },
      { EASYSIMD_FLOAT32_C(   892.44), EASYSIMD_FLOAT32_C(   782.80) },
      {
      EASYSIMD_FLOAT32_C(   641.73),
      EASYSIMD_FLOAT32_C(  -136.08),
      EASYSIMD_FLOAT32_C(   892.44),
      EASYSIMD_FLOAT32_C(     1.95),
      EASYSIMD_FLOAT32_C(   391.30),
      EASYSIMD_FLOAT32_C(   782.80),
      }
    },
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_float32x2x3_t a = { { a0, a1, a2 } };
...
static int
test_easysimd_vst3_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    easysimd_float64 r0[1];
    easysimd_float64 r1[1];
    easysimd_float64 r2[1];
    easysimd_float64 a[3];
  } test_vec[] = {
    { { EASYSIMD_FLOAT64_C(  -319.19) },
      { EASYSIMD_FLOAT64_C(   569.35) },
      { EASYSIMD_FLOAT64_C(  -226.94) },
      {
      EASYSIMD_FLOAT64_C(  -319.19),
      EASYSIMD_FLOAT64_C(   569.35),
      EASYSIMD_FLOAT64_C(  -226.94),
    ...
    { { EASYSIMD_FLOAT64_C(   -79.23) },
      { EASYSIMD_FLOAT64_C(  -856.19) },
      { EASYSIMD_FLOAT64_C(   982.37) },
      {
      EASYSIMD_FLOAT64_C(   -79.23),
      EASYSIMD_FLOAT64_C(  -856.19),
      EASYSIMD_FLOAT64_C(   982.37),
    ...
    { { EASYSIMD_FLOAT64_C(  -330.57) },
      { EASYSIMD_FLOAT64_C(   730.79) },
      { EASYSIMD_FLOAT64_C(  -392.36) },
      {
      EASYSIMD_FLOAT64_C(  -330.57),
      EASYSIMD_FLOAT64_C(   730.79),
      EASYSIMD_FLOAT64_C(  -392.36),
    ...
    { { EASYSIMD_FLOAT64_C(  -114.08) },
      { EASYSIMD_FLOAT64_C(  -298.63) },
      { EASYSIMD_FLOAT64_C(   209.96) },
      {
      EASYSIMD_FLOAT64_C(  -114.08),
      EASYSIMD_FLOAT64_C(  -298.63),
      EASYSIMD_FLOAT64_C(   209.96),
    ...
    { { EASYSIMD_FLOAT64_C(  -867.54) },
      { EASYSIMD_FLOAT64_C(  -281.79) },
      { EASYSIMD_FLOAT64_C(   780.67) },
      {
      EASYSIMD_FLOAT64_C(  -867.54),
      EASYSIMD_FLOAT64_C(  -281.79),
      EASYSIMD_FLOAT64_C(   780.67),
    ...
    { { EASYSIMD_FLOAT64_C(   665.37) },
      { EASYSIMD_FLOAT64_C(   109.67) },
      { EASYSIMD_FLOAT64_C(   882.86) },
      {
      EASYSIMD_FLOAT64_C(   665.37),
      EASYSIMD_FLOAT64_C(   109.67),
      EASYSIMD_FLOAT64_C(   882.86),
    ...
    { { EASYSIMD_FLOAT64_C(    -7.69) },
      { EASYSIMD_FLOAT64_C(  -441.62) },
      { EASYSIMD_FLOAT64_C(   205.44) },
      {
      EASYSIMD_FLOAT64_C(    -7.69),
      EASYSIMD_FLOAT64_C(  -441.62),
      EASYSIMD_FLOAT64_C(   205.44),
    ...
    { { EASYSIMD_FLOAT64_C(   761.86) },
      { EASYSIMD_FLOAT64_C(   259.74) },
      { EASYSIMD_FLOAT64_C(   953.99) },
      {
      EASYSIMD_FLOAT64_C(   761.86),
      EASYSIMD_FLOAT64_C(   259.74),
      EASYSIMD_FLOAT64_C(   953.99),
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float64x1x3_t r_ = { { easysimd_vld1_f64(test_vec[i].r0),
                                 easysimd_vld1_f64(test_vec[i].r1),
                                 easysimd_vld1_f64(test_vec[i].r2), } };

    easysimd_float64_t a_[3];
    easysimd_vst3_f64(a_, r_);
    easysimd_assert_equal_i(0, easysimd_memcmp(a_, test_vec[i].a, sizeof(test_vec[i].a)));

    r_ = easysimd_vld3_f64(a_);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_float64x1x3_t a = { { a0, a1, a2 } };
    ...
    easysimd_float64_t buf[3];
    easysimd_vst3_f64(buf, a);
...
static int
test_easysimd_vst3_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int8_t r0[8];
    int8_t r1[8];
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_int8x8x3_t a = { { a0, a1, a2 } };
...
static int
test_easysimd_vst3_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int16_t r0[4];
    int16_t r1[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_int16x4x3_t r_ = { { easysimd_vld1_s16(test_vec[i].r0),
                               easysimd_vld1_s16(test_vec[i].r1),
                               easysimd_vld1_s16(test_vec[i].r2), } };

    int16_t a_[12];
    easysimd_vst3_s16(a_, r_);
    easysimd_assert_equal_i(0, easysimd_memcmp(a_, test_vec[i].a, sizeof(test_vec[i].a)));

    r_ = easysimd_vld3_s16(a_);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_int16x4x3_t a = { { a0, a1, a2 } };
...
static int
test_easysimd_vst3_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t r0[2];
    int32_t r1[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_int32x2x3_t r_ = { { easysimd_vld1_s32(test_vec[i].r0),
                               easysimd_vld1_s32(test_vec[i].r1),
                               easysimd_vld1_s32(test_vec[i].r2), } };

    int32_t a_[6];
    easysimd_vst3_s32(a_, r_);
    easysimd_assert_equal_i(0, easysimd_memcmp(a_, test_vec[i].a, sizeof(test_vec[i].a)));

    r_ = easysimd_vld3_s32(a_);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_int32x2x3_t a = { { a0, a1, a2 } };
...
static int
test_easysimd_vst3_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int64_t r0[1];
    int64_t r1[1];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_int64x1x3_t r_ = { { easysimd_vld1_s64(test_vec[i].r0),
                               easysimd_vld1_s64(test_vec[i].r1),
                               easysimd_vld1_s64(test_vec[i].r2), } };

    int64_t a_[3];
    easysimd_vst3_s64(a_, r_);
    easysimd_assert_equal_i(0, easysimd_memcmp(a_, test_vec[i].a, sizeof(test_vec[i].a)));

    r_ = easysimd_vld3_s64(a_);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_int64x1x3_t a = { { a0, a1, a2 } };
...
static int
test_easysimd_vst3_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint8_t r0[8];
    uint8_t r1[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint8x8x3_t r_ = { { easysimd_vld1_u8(test_vec[i].r0),
                               easysimd_vld1_u8(test_vec[i].r1),
                               easysimd_vld1_u8(test_vec[i].r2), } };

    uint8_t a_[24];
    easysimd_vst3_u8(a_, r_);
    easysimd_assert_equal_i(0, easysimd_memcmp(a_, test_vec[i].a, sizeof(test_vec[i].a)));

    r_ = easysimd_vld3_u8(a_);
  ...
  for (size_t i = 0 ; i < 8 ; i++) {
    ...
    easysimd_uint8x8x3_t a = { { a0, a1, a2 } };
...
static int
test_easysimd_vst3_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint16_t r0[4];
    uint16_t r1[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint16x4x3_t r_ = { { easysimd_vld1_u16(test_vec[i].r0),
                                easysimd_vld1_u16(test_vec[i].r1),
                                easysimd_vld1_u16(test_vec[i].r2), } };

    uint16_t a_[12];
    easysimd_vst3_u16(a_, r_);
    easysimd_assert_equal_i(0, easysimd_memcmp(a_, test_vec[i].a, sizeof(test_vec[i].a)));

    r_ = easysimd_vld3_u16(a_);
  ...
  for (size_t i = 0 ; i < 8 ; i++) {
    ...
    easysimd_uint16x4x3_t a = { { a0, a1, a2 } };
...
static int
test_easysimd_vst3_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint32_t r0[2];
    uint32_t r1[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint32x2x3_t r_ = { { easysimd_vld1_u32(test_vec[i].r0),
                                easysimd_vld1_u32(test_vec[i].r1),
                                easysimd_vld1_u32(test_vec[i].r2), } };

    uint32_t a_[6];
    easysimd_vst3_u32(a_, r_);
    easysimd_assert_equal_i(0, easysimd_memcmp(a_, test_vec[i].a, sizeof(test_vec[i].a)));

    r_ = easysimd_vld3_u32(a_);
  ...
  for (size_t i = 0 ; i < 8 ; i++) {
    ...
    easysimd_uint32x2x3_t a = { { a0, a1, a2 } };
...
static int
test_easysimd_vst3_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint64_t r0[1];
    uint64_t r1[1];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint64x1x3_t r_ = { { easysimd_vld1_u64(test_vec[i].r0),
                                easysimd_vld1_u64(test_vec[i].r1),
                                easysimd_vld1_u64(test_vec[i].r2), } };

    uint64_t a_[3];
    easysimd_vst3_u64(a_, r_);
    easysimd_assert_equal_i(0, easysimd_memcmp(a_, test_vec[i].a, sizeof(test_vec[i].a)));

    r_ = easysimd_vld3_u64(a_);
  ...
  for (size_t i = 0 ; i < 8 ; i++) {
    ...
    easysimd_uint64x1x3_t a = { { a0, a1, a2 } };
...
static int
test_easysimd_vst3q_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    easysimd_float32 r0[4];
    easysimd_float32 r1[4];
    easysimd_float32 r2[4];
    easysimd_float32 a[12];
  } test_vec[] = {
    { { EASYSIMD_FLOAT32_C(  -985.78), EASYSIMD_FLOAT32_C(  -181.56), EASYSIMD_FLOAT32_C(  -910.82), EASYSIMD_FLOAT32_C(  -732.91) },
      { EASYSIMD_FLOAT32_C(  -353.18), EASYSIMD_FLOAT32_C(  -450.78), EASYSIMD_FLOAT32_C(   -83.42), EASYSIMD_FLOAT32_C(  -225.91) },
      { EASYSIMD_FLOAT32_C(  -974.60), EASYSIMD_FLOAT32_C(  -205.59), EASYSIMD_FLOAT32_C(  -350.99), EASYSIMD_FLOAT32_C(  -219.80) },
      {
      EASYSIMD_FLOAT32_C(  -985.78),
      EASYSIMD_FLOAT32_C(  -353.18),
      EASYSIMD_FLOAT32_C(  -974.60),
      EASYSIMD_FLOAT32_C(  -181.56),
      EASYSIMD_FLOAT32_C(  -450.78),
      EASYSIMD_FLOAT32_C(  -205.59),
      EASYSIMD_FLOAT32_C(  -910.82),
      EASYSIMD_FLOAT32_C(   -83.42),
      EASYSIMD_FLOAT32_C(  -350.99),
      EASYSIMD_FLOAT32_C(  -732.91),
      EASYSIMD_FLOAT32_C(  -225.91),
      EASYSIMD_FLOAT32_C(  -219.80),
      }
    },
    { { EASYSIMD_FLOAT32_C(   583.13), EASYSIMD_FLOAT32_C(   717.32), EASYSIMD_FLOAT32_C(  -138.31), EASYSIMD_FLOAT32_C(   428.23) },
      { EASYSIMD_FLOAT32_C(   -15.12), EASYSIMD_FLOAT32_C(  -349.44), EASYSIMD_FLOAT32_C(   838.60), EASYSIMD_FLOAT32_C(   645.26) },
      { EASYSIMD_FLOAT32_C(   917.57), EASYSIMD_FLOAT32_C(  -862.79), EASYSIMD_FLOAT32_C(   403.85), EASYSIMD_FLOAT32_C(   196.39) },
      {
      EASYSIMD_FLOAT32_C(   583.13),
      EASYSIMD_FLOAT32_C(   -15.12),
      EASYSIMD_FLOAT32_C(   917.57),
      EASYSIMD_FLOAT32_C(   717.32),
      EASYSIMD_FLOAT32_C(  -349.44),
      EASYSIMD_FLOAT32_C(  -862.79),
      EASYSIMD_FLOAT32_C(  -138.31),
      EASYSIMD_FLOAT32_C(   838.60),
      EASYSIMD_FLOAT32_C(   403.85),
      EASYSIMD_FLOAT32_C(   428.23),
      EASYSIMD_FLOAT32_C(   645.26),
      EASYSIMD_FLOAT32_C(   196.39),
      }
    },
    { { EASYSIMD_FLOAT32_C(  -768.47), EASYSIMD_FLOAT32_C(  -949.16), EASYSIMD_FLOAT32_C(    42.85), EASYSIMD_FLOAT32_C(  -252.64) },
      { EASYSIMD_FLOAT32_C(  -690.55), EASYSIMD_FLOAT32_C(  -771.86), EASYSIMD_FLOAT32_C(  -903.80), EASYSIMD_FLOAT32_C(  -676.33) },
      { EASYSIMD_FLOAT32_C(    46.58), EASYSIMD_FLOAT32_C(  -814.62), EASYSIMD_FLOAT32_C(  -409.24), EASYSIMD_FLOAT32_C(   693.40) },
      {
      EASYSIMD_FLOAT32_C(  -768.47),
      EASYSIMD_FLOAT32_C(  -690.55),
      EASYSIMD_FLOAT32_C(    46.58),
      EASYSIMD_FLOAT32_C(  -949.16),
      EASYSIMD_FLOAT32_C(  -771.86),
      EASYSIMD_FLOAT32_C(  -814.62),
      EASYSIMD_FLOAT32_C(    42.85),
      EASYSIMD_FLOAT32_C(  -903.80),
      EASYSIMD_FLOAT32_C(  -409.24),
      EASYSIMD_FLOAT32_C(  -252.64),
      EASYSIMD_FLOAT32_C(  -676.33),
      EASYSIMD_FLOAT32_C(   693.40),
      }
    },
    { { EASYSIMD_FLOAT32_C(  -265.40), EASYSIMD_FLOAT32_C(   507.34), EASYSIMD_FLOAT32_C(  -532.51), EASYSIMD_FLOAT32_C(  -240.00) },
      { EASYSIMD_FLOAT32_C(  -698.24), EASYSIMD_FLOAT32_C(   116.50), EASYSIMD_FLOAT32_C(   540.20), EASYSIMD_FLOAT32_C(   884.89) },
      { EASYSIMD_FLOAT32_C(  -166.18), EASYSIMD_FLOAT32_C(  -598.11), EASYSIMD_FLOAT32_C(   313.12), EASYSIMD_FLOAT32_C(   818.70) },
      {
      EASYSIMD_FLOAT32_C(  -265.40),
      EASYSIMD_FLOAT32_C(  -698.24),
      EASYSIMD_FLOAT32_C(  -166.18),
      EASYSIMD_FLOAT32_C(   507.34),
      EASYSIMD_FLOAT32_C(   116.50),
      EASYSIMD_FLOAT32_C(  -598.11),
      EASYSIMD_FLOAT32_C(  -532.51),
      EASYSIMD_FLOAT32_C(   540.20),
      EASYSIMD_FLOAT32_C(   313.12),
      EASYSIMD_FLOAT32_C(  -240.00),
      EASYSIMD_FLOAT32_C(   884.89),
      EASYSIMD_FLOAT32_C(   818.70),
      }
    },
    { { EASYSIMD_FLOAT32_C(    52.45), EASYSIMD_FLOAT32_C(   151.71), EASYSIMD_FLOAT32_C(   463.96), EASYSIMD_FLOAT32_C(   -29.98) },
      { EASYSIMD_FLOAT32_C(   288.92), EASYSIMD_FLOAT32_C(  -132.19), EASYSIMD_FLOAT32_C(  -833.58), EASYSIMD_FLOAT32_C(   520.45) },
      { EASYSIMD_FLOAT32_C(   -81.36), EASYSIMD_FLOAT32_C(   209.27), EASYSIMD_FLOAT32_C(  -732.19), EASYSIMD_FLOAT32_C(   228.09) },
      {
      EASYSIMD_FLOAT32_C(    52.45),
      EASYSIMD_FLOAT32_C(   288.92),
      EASYSIMD_FLOAT32_C(   -81.36),
      EASYSIMD_FLOAT32_C(   151.71),
      EASYSIMD_FLOAT32_C(  -132.19),
      EASYSIMD_FLOAT32_C(   209.27),
      EASYSIMD_FLOAT32_C(   463.96),
      EASYSIMD_FLOAT32_C(  -833.58),
      EASYSIMD_FLOAT32_C(  -732.19),
      EASYSIMD_FLOAT32_C(   -29.98),
      EASYSIMD_FLOAT32_C(   520.45),
      EASYSIMD_FLOAT32_C(   228.09),
      }
    },
    { { EASYSIMD_FLOAT32_C(   437.41), EASYSIMD_FLOAT32_C(  -635.99), EASYSIMD_FLOAT32_C(   551.76), EASYSIMD_FLOAT32_C(  -516.01) },
      { EASYSIMD_FLOAT32_C(  -450.62), EASYSIMD_FLOAT32_C(  -857.48), EASYSIMD_FLOAT32_C(  -822.60), EASYSIMD_FLOAT32_C(   283.98) },
      { EASYSIMD_FLOAT32_C(   649.87), EASYSIMD_FLOAT32_C(  -355.11), EASYSIMD_FLOAT32_C(  -956.02), EASYSIMD_FLOAT32_C(   951.62) },
      {
      EASYSIMD_FLOAT32_C(   437.41),
      EASYSIMD_FLOAT32_C(  -450.62),
      EASYSIMD_FLOAT32_C(   649.87),
      EASYSIMD_FLOAT32_C(  -635.99),
      EASYSIMD_FLOAT32_C(  -857.48),
      EASYSIMD_FLOAT32_C(  -355.11),
      EASYSIMD_FLOAT32_C(   551.76),
      EASYSIMD_FLOAT32_C(  -822.60),
      EASYSIMD_FLOAT32_C(  -956.02),
      EASYSIMD_FLOAT32_C(  -516.01),
      EASYSIMD_FLOAT32_C(   283.98),
      EASYSIMD_FLOAT32_C(   951.62),
      }
    },
    { { EASYSIMD_FLOAT32_C(   761.38), EASYSIMD_FLOAT32_C(   584.18), EASYSIMD_FLOAT32_C(   836.51), EASYSIMD_FLOAT32_C(  -404.80) },
      { EASYSIMD_FLOAT32_C(   986.07), EASYSIMD_FLOAT32_C(   149.63), EASYSIMD_FLOAT32_C(  -586.10), EASYSIMD_FLOAT32_C(    38.52) },
      { EASYSIMD_FLOAT32_C(  -698.66), EASYSIMD_FLOAT32_C(   877.86), EASYSIMD_FLOAT32_C(  -991.46), EASYSIMD_FLOAT32_C(   590.26) },
      {
      EASYSIMD_FLOAT32_C(   761.38),
      EASYSIMD_FLOAT32_C(   986.07),
      EASYSIMD_FLOAT32_C(  -698.66),
      EASYSIMD_FLOAT32_C(   584.18),
      EASYSIMD_FLOAT32_C(   149.63),
      EASYSIMD_FLOAT32_C(   877.86),
      EASYSIMD_FLOAT32_C(   836.51),
      EASYSIMD_FLOAT32_C(  -586.10),
      EASYSIMD_FLOAT32_C(  -991.46),
      EASYSIMD_FLOAT32_C(  -404.80),
      EASYSIMD_FLOAT32_C(    38.52),
      EASYSIMD_FLOAT32_C(   590.26),
      }
    },
    { { EASYSIMD_FLOAT32_C(  -254.33), EASYSIMD_FLOAT32_C(  -825.04), EASYSIMD_FLOAT32_C(   110.71), EASYSIMD_FLOAT32_C(   664.31) },
      { EASYSIMD_FLOAT32_C(   384.23), EASYSIMD_FLOAT32_C(   378.52), EASYSIMD_FLOAT32_C(  -107.59), EASYSIMD_FLOAT32_C(  -178.36) },
      { EASYSIMD_FLOAT32_C(   742.53), EASYSIMD_FLOAT32_C(  -555.83), EASYSIMD_FLOAT32_C(   305.63), EASYSIMD_FLOAT32_C(  -708.09) },
      {
      EASYSIMD_FLOAT32_C(  -254.33),
      EASYSIMD_FLOAT32_C(   384.23),
      EASYSIMD_FLOAT32_C(   742.53),
      EASYSIMD_FLOAT32_C(  -825.04),
      EASYSIMD_FLOAT32_C(   378.52),
      EASYSIMD_FLOAT32_C(  -555.83),
      EASYSIMD_FLOAT32_C(   110.71),
      EASYSIMD_FLOAT32_C(  -107.59),
      EASYSIMD_FLOAT32_C(   305.63),
      EASYSIMD_FLOAT32_C(   664.31),
      EASYSIMD_FLOAT32_C(  -178.36),
      EASYSIMD_FLOAT32_C(  -708.09),
      }
    },
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float32x4x3_t r_ = { { easysimd_vld1q_f32(test_vec[i].r0),
                                 easysimd_vld1q_f32(test_vec[i].r1),
                                 easysimd_vld1q_f32(test_vec[i].r2), } };

    easysimd_float32 a_[12];
    easysimd_vst3q_f32(a_, r_);
    easysimd_assert_equal_i(0, easysimd_memcmp(a_, test_vec[i].a, sizeof(test_vec[i].a)));

    r_ = easysimd_vld3q_f32(a_);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_float32x4x3_t a = { { a0, a1, a2 } };
...
static int
test_easysimd_vst3q_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    easysimd_float64 r0[2];
    easysimd_float64 r1[2];
    easysimd_float64 r2[2];
    easysimd_float64 a[6];
  } test_vec[] = {
    { { EASYSIMD_FLOAT64_C(   758.07), EASYSIMD_FLOAT64_C(    84.29) },
      { EASYSIMD_FLOAT64_C(  -600.63), EASYSIMD_FLOAT64_C(  -472.51) },
      { EASYSIMD_FLOAT64_C(   725.40), EASYSIMD_FLOAT64_C(   903.42) },
      {
      EASYSIMD_FLOAT64_C(   758.07),
      EASYSIMD_FLOAT64_C(  -600.63),
      EASYSIMD_FLOAT64_C(   725.40),
      EASYSIMD_FLOAT64_C(    84.29),
      EASYSIMD_FLOAT64_C(  -472.51),
      EASYSIMD_FLOAT64_C(   903.42),
      }
    },
    { { EASYSIMD_FLOAT64_C(  -564.41), EASYSIMD_FLOAT64_C(  -453.39) },
      { EASYSIMD_FLOAT64_C(  -311.50), EASYSIMD_FLOAT64_C(  -928.88) },
      { EASYSIMD_FLOAT64_C(   670.94), EASYSIMD_FLOAT64_C(  -991.23) },
      {
      EASYSIMD_FLOAT64_C(  -564.41),
      EASYSIMD_FLOAT64_C(  -311.50),
      EASYSIMD_FLOAT64_C(   670.94),
      EASYSIMD_FLOAT64_C(  -453.39),
      EASYSIMD_FLOAT64_C(  -928.88),
      EASYSIMD_FLOAT64_C(  -991.23),
      }
    },
    { { EASYSIMD_FLOAT64_C(   354.81), EASYSIMD_FLOAT64_C(   507.91) },
      { EASYSIMD_FLOAT64_C(    71.00), EASYSIMD_FLOAT64_C(   659.02) },
      { EASYSIMD_FLOAT64_C(   105.92), EASYSIMD_FLOAT64_C(   373.60) },
      {
      EASYSIMD_FLOAT64_C(   354.81),
      EASYSIMD_FLOAT64_C(    71.00),
      EASYSIMD_FLOAT64_C(   105.92),
      EASYSIMD_FLOAT64_C(   507.91),
      EASYSIMD_FLOAT64_C(   659.02),
      EASYSIMD_FLOAT64_C(   373.60),
      }
    },
    { { EASYSIMD_FLOAT64_C(  -261.08), EASYSIMD_FLOAT64_C(  -713.36) },
      { EASYSIMD_FLOAT64_C(   -70.21), EASYSIMD_FLOAT64_C(   417.30) },
      { EASYSIMD_FLOAT64_C(  -815.10), EASYSIMD_FLOAT64_C(   451.49) },
      {
      EASYSIMD_FLOAT64_C(  -261.08),
      EASYSIMD_FLOAT64_C(   -70.21),
      EASYSIMD_FLOAT64_C(  -815.10),
      EASYSIMD_FLOAT64_C(  -713.36),
      EASYSIMD_FLOAT64_C(   417.30),
      EASYSIMD_FLOAT64_C(   451.49),
      }
    },
    { { EASYSIMD_FLOAT64_C(   701.42), EASYSIMD_FLOAT64_C(  -485.46) },
      { EASYSIMD_FLOAT64_C(  -486.64), EASYSIMD_FLOAT64_C(   421.84) },
      { EASYSIMD_FLOAT64_C(  -955.83), EASYSIMD_FLOAT64_C(  -150.69) },
      {
      EASYSIMD_FLOAT64_C(   701.42),
      EASYSIMD_FLOAT64_C(  -486.64),
      EASYSIMD_FLOAT64_C(  -955.83),
      EASYSIMD_FLOAT64_C(  -485.46),
      EASYSIMD_FLOAT64_C(   421.84),
      EASYSIMD_FLOAT64_C(  -150.69),
      }
    },
    { { EASYSIMD_FLOAT64_C(   498.32), EASYSIMD_FLOAT64_C(   802.24) },
      { EASYSIMD_FLOAT64_C(   933.60), EASYSIMD_FLOAT64_C(   897.69) },
      { EASYSIMD_FLOAT64_C(  -670.27), EASYSIMD_FLOAT64_C(   659.00) },
      {
      EASYSIMD_FLOAT64_C(   498.32),
      EASYSIMD_FLOAT64_C(   933.60),
      EASYSIMD_FLOAT64_C(  -670.27),
      EASYSIMD_FLOAT64_C(   802.24),
      EASYSIMD_FLOAT64_C(   897.69),
      EASYSIMD_FLOAT64_C(   659.00),
      }
    },
    { { EASYSIMD_FLOAT64_C(   801.12), EASYSIMD_FLOAT64_C(  -234.68) },
      { EASYSIMD_FLOAT64_C(  -794.39), EASYSIMD_FLOAT64_C(  -510.38) },
      { EASYSIMD_FLOAT64_C(  -163.56), EASYSIMD_FLOAT64_C(   876.55) },
      {
      EASYSIMD_FLOAT64_C(   801.12),
      EASYSIMD_FLOAT64_C(  -794.39),
      EASYSIMD_FLOAT64_C(  -163.56),
      EASYSIMD_FLOAT64_C(  -234.68),
      EASYSIMD_FLOAT64_C(  -510.38),
      EASYSIMD_FLOAT64_C(   876.55),
      }
    },
    { { EASYSIMD_FLOAT64_C(  -501.62), EASYSIMD_FLOAT64_C(  -808.75) },
      { EASYSIMD_FLOAT64_C(   384.46), EASYSIMD_FLOAT64_C(   569.38) },
      { EASYSIMD_FLOAT64_C(   850.27), EASYSIMD_FLOAT64_C(  -509.62) },
      {
      EASYSIMD_FLOAT64_C(  -501.62),
      EASYSIMD_FLOAT64_C(   384.46),
      EASYSIMD_FLOAT64_C(   850.27),
      EASYSIMD_FLOAT64_C(  -808.75),
      EASYSIMD_FLOAT64_C(   569.38),
      EASYSIMD_FLOAT64_C(  -509.62),
      }
    },
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float64x2x3_t r_ = { { easysimd_vld1q_f64(test_vec[i].r0),
                                 easysimd_vld1q_f64(test_vec[i].r1),
                                 easysimd_vld1q_f64(test_vec[i].r2), } };

    easysimd_float64_t a_[6];
    easysimd_vst3q_f64(a_, r_);
    easysimd_assert_equal_i(0, easysimd_memcmp(a_, test_vec[i].a, sizeof(test_vec[i].a)));

    r_ = easysimd_vld3q_f64(a_);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_float64x2x3_t a = { { a0, a1, a2 } };
...
static int
test_easysimd_vst3q_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int8_t r0[16];
    int8_t r1[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_int8x16x3_t r_ = { { easysimd_vld1q_s8(test_vec[i].r0),
                               easysimd_vld1q_s8(test_vec[i].r1),
                               easysimd_vld1q_s8(test_vec[i].r2), } };

    int8_t a_[48];
    easysimd_vst3q_s8(a_, r_);
    easysimd_assert_equal_i(0, easysimd_memcmp(a_, test_vec[i].a, sizeof(test_vec[i].a)));

    r_ = easysimd_vld3q_s8(a_);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_int8x16x3_t a = { { a0, a1, a2 } };
...
static int
test_easysimd_vst3q_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int16_t r0[8];
    int16_t r1[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_int16x8x3_t r_ = { { easysimd_vld1q_s16(test_vec[i].r0),
                               easysimd_vld1q_s16(test_vec[i].r1),
                               easysimd_vld1q_s16(test_vec[i].r2), } };

    int16_t a_[24];
    easysimd_vst3q_s16(a_, r_);
    easysimd_assert_equal_i(0, easysimd_memcmp(a_, test_vec[i].a, sizeof(test_vec[i].a)));

    r_ = easysimd_vld3q_s16(a_);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_int16x8x3_t a = { { a0, a1, a2 } };
...
static int
test_easysimd_vst3q_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t r0[4];
    int32_t r1[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_int32x4x3_t r_ = { { easysimd_vld1q_s32(test_vec[i].r0),
                               easysimd_vld1q_s32(test_vec[i].r1),
                               easysimd_vld1q_s32(test_vec[i].r2), } };

    int32_t a_[12];
    easysimd_vst3q_s32(a_, r_);
    easysimd_assert_equal_i(0, easysimd_memcmp(a_, test_vec[i].a, sizeof(test_vec[i].a)));

    r_ = easysimd_vld3q_s32(a_);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_int32x4x3_t a = { { a0, a1, a2 } };
...
static int
test_easysimd_vst3q_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int64_t r0[2];
    int64_t r1[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_int64x2x3_t r_ = { { easysimd_vld1q_s64(test_vec[i].r0),
                               easysimd_vld1q_s64(test_vec[i].r1),
                               easysimd_vld1q_s64(test_vec[i].r2), } };

    int64_t a_[6];
    easysimd_vst3q_s64(a_, r_);
    easysimd_assert_equal_i(0, easysimd_memcmp(a_, test_vec[i].a, sizeof(test_vec[i].a)));

    r_ = easysimd_vld3q_s64(a_);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_int64x2x3_t a = { { a0, a1, a2 } };
...
static int
test_easysimd_vst3q_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint8_t r0[16];
    uint8_t r1[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint8x16x3_t r_ = { { easysimd_vld1q_u8(test_vec[i].r0),
                                easysimd_vld1q_u8(test_vec[i].r1),
                                easysimd_vld1q_u8(test_vec[i].r2), } };

    uint8_t a_[48];
    easysimd_vst3q_u8(a_, r_);
    easysimd_assert_equal_i(0, easysimd_memcmp(a_, test_vec[i].a, sizeof(test_vec[i].a)));

    r_ = easysimd_vld3q_u8(a_);
  ...
  for (size_t i = 0 ; i < 8 ; i++) {
    ...
    easysimd_uint8x16x3_t a = { { a0, a1, a2 } };
...
static int
test_easysimd_vst3q_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint16_t r0[8];
    uint16_t r1[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint16x8x3_t r_ = { { easysimd_vld1q_u16(test_vec[i].r0),
                                easysimd_vld1q_u16(test_vec[i].r1),
                                easysimd_vld1q_u16(test_vec[i].r2), } };

    uint16_t a_[24];
    easysimd_vst3q_u16(a_, r_);
    easysimd_assert_equal_i(0, easysimd_memcmp(a_, test_vec[i].a, sizeof(test_vec[i].a)));

    r_ = easysimd_vld3q_u16(a_);
  ...
  for (size_t i = 0 ; i < 8 ; i++) {
    ...
    easysimd_uint16x8x3_t a = { { a0, a1, a2 } };
...
static int
test_easysimd_vst3q_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint32_t r0[4];
    uint32_t r1[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint32x4x3_t r_ = { { easysimd_vld1q_u32(test_vec[i].r0),
                                easysimd_vld1q_u32(test_vec[i].r1),
                                easysimd_vld1q_u32(test_vec[i].r2), } };

    uint32_t a_[12];
    easysimd_vst3q_u32(a_, r_);
    easysimd_assert_equal_i(0, easysimd_memcmp(a_, test_vec[i].a, sizeof(test_vec[i].a)));

    r_ = easysimd_vld3q_u32(a_);
  ...
  for (size_t i = 0 ; i < 8 ; i++) {
    ...
    easysimd_uint32x4x3_t a = { { a0, a1, a2 } };
...
static int
test_easysimd_vst3q_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint64_t r0[2];
    uint64_t r1[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint64x2x3_t r_ = { { easysimd_vld1q_u64(test_vec[i].r0),
                                easysimd_vld1q_u64(test_vec[i].r1),
                                easysimd_vld1q_u64(test_vec[i].r2), } };

    uint64_t a_[6];
    easysimd_vst3q_u64(a_, r_);
    easysimd_assert_equal_i(0, easysimd_memcmp(a_, test_vec[i].a, sizeof(test_vec[i].a)));

    r_ = easysimd_vld3q_u64(a_);
  ...
  for (size_t i = 0 ; i < 8 ; i++) {
    ...
    easysimd_uint64x2x3_t a = { { a0, a1, a2 } };
...
#if !defined(EASYSIMD_BUG_INTEL_857088)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vst3_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vst3_f64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vst3_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vst3_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vst3_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vst3_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vst3_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vst3_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vst3_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vst3_u64)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vst3q_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vst3q_f64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vst3q_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vst3q_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vst3q_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vst3q_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vst3q_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vst3q_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vst3q_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vst3q_u64)
#endif /* !defined(EASYSIMD_BUG_INTEL_857088) */
