#define EASYSIMD_TEST_ARM_NEON_INSN st4

#include "test-neon.h"
#include "../../../easysimd/arm/neon/st4.h"
#include "../../../easysimd/arm/neon/ld4.h"
#include "../../../easysimd/arm/neon/get_lane.h"
...
static int
test_easysimd_vst4_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    easysimd_float32 r0[2];
    easysimd_float32 r1[2];
    easysimd_float32 r2[2];
    easysimd_float32 r3[2];
    easysimd_float32 a[8];
  } test_vec[] = {
    { { EASYSIMD_FLOAT32_C(    77.38), EASYSIMD_FLOAT32_C(   677.34) },
      { EASYSIMD_FLOAT32_C(  -113.63), EASYSIMD_FLOAT32_C(  -677.73) },
      { EASYSIMD_FLOAT32_C(  -489.72), EASYSIMD_FLOAT32_C(   841.42) },
      { EASYSIMD_FLOAT32_C(   -32.02), EASYSIMD_FLOAT32_C(   794.35) },
      {
      EASYSIMD_FLOAT32_C(    77.38),
      EASYSIMD_FLOAT32_C(  -113.63),
      EASYSIMD_FLOAT32_C(  -489.72),
      EASYSIMD_FLOAT32_C(   -32.02),
      EASYSIMD_FLOAT32_C(   677.34),
      EASYSIMD_FLOAT32_C(  -677.73),
      EASYSIMD_FLOAT32_C(   841.42),
      EASYSIMD_FLOAT32_C(   794.35),
      }
    },
    { { EASYSIMD_FLOAT32_C(  -290.22), EASYSIMD_FLOAT32_C(  -690.11) },
      { EASYSIMD_FLOAT32_C(  -998.58), EASYSIMD_FLOAT32_C(  -130.70) },
      { EASYSIMD_FLOAT32_C(  -215.14), EASYSIMD_FLOAT32_C(   735.01) },
      { EASYSIMD_FLOAT32_C(   247.54), EASYSIMD_FLOAT32_C(    37.32) },
      {
      EASYSIMD_FLOAT32_C(  -290.22),
      EASYSIMD_FLOAT32_C(  -998.58),
      EASYSIMD_FLOAT32_C(  -215.14),
      EASYSIMD_FLOAT32_C(   247.54),
      EASYSIMD_FLOAT32_C(  -690.11),
      EASYSIMD_FLOAT32_C(  -130.70),
      EASYSIMD_FLOAT32_C(   735.01),
      EASYSIMD_FLOAT32_C(    37.32),
      }
    },
    { { EASYSIMD_FLOAT32_C(   469.24), EASYSIMD_FLOAT32_C(   265.50) },
      { EASYSIMD_FLOAT32_C(   319.83), EASYSIMD_FLOAT32_C(  -183.68) },
      { EASYSIMD_FLOAT32_C(  -305.25), EASYSIMD_FLOAT32_C(  -951.48) },
      { EASYSIMD_FLOAT32_C(   557.71), EASYSIMD_FLOAT32_C(  -797.73) },
      {
      EASYSIMD_FLOAT32_C(   469.24),
      EASYSIMD_FLOAT32_C(   319.83),
      EASYSIMD_FLOAT32_C(  -305.25),
      EASYSIMD_FLOAT32_C(   557.71),
      EASYSIMD_FLOAT32_C(   265.50),
      EASYSIMD_FLOAT32_C(  -183.68),
      EASYSIMD_FLOAT32_C(  -951.48),
      EASYSIMD_FLOAT32_C(  -797.73),
      }
    },
    { { EASYSIMD_FLOAT32_C(   453.48), EASYSIMD_FLOAT32_C(  -751.30) },
      { EASYSIMD_FLOAT32_C(  -461.55), EASYSIMD_FLOAT32_C(  -927.67) },
      { EASYSIMD_FLOAT32_C(  -520.41), EASYSIMD_FLOAT32_C(   745.85) },
      { EASYSIMD_FLOAT32_C(  -100.92), EASYSIMD_FLOAT32_C(   556.97) },
      {
      EASYSIMD_FLOAT32_C(   453.48),
      EASYSIMD_FLOAT32_C(  -461.55),
      EASYSIMD_FLOAT32_C(  -520.41),
      EASYSIMD_FLOAT32_C(  -100.92),
      EASYSIMD_FLOAT32_C(  -751.30),
      EASYSIMD_FLOAT32_C(  -927.67),
      EASYSIMD_FLOAT32_C(   745.85),
      EASYSIMD_FLOAT32_C(   556.97),
      }
    },
    { { EASYSIMD_FLOAT32_C(   423.19), EASYSIMD_FLOAT32_C(   785.44) },
      { EASYSIMD_FLOAT32_C(   879.23), EASYSIMD_FLOAT32_C(   933.48) },
      { EASYSIMD_FLOAT32_C(   626.86), EASYSIMD_FLOAT32_C(  -152.79) },
      { EASYSIMD_FLOAT32_C(   727.83), EASYSIMD_FLOAT32_C(  -663.36) },
      {
      EASYSIMD_FLOAT32_C(   423.19),
      EASYSIMD_FLOAT32_C(   879.23),
      EASYSIMD_FLOAT32_C(   626.86),
      EASYSIMD_FLOAT32_C(   727.83),
      EASYSIMD_FLOAT32_C(   785.44),
      EASYSIMD_FLOAT32_C(   933.48),
      EASYSIMD_FLOAT32_C(  -152.79),
      EASYSIMD_FLOAT32_C(  -663.36),
      }
    },
    { { EASYSIMD_FLOAT32_C(   157.09), EASYSIMD_FLOAT32_C(   729.25) },
      { EASYSIMD_FLOAT32_C(   205.94), EASYSIMD_FLOAT32_C(   941.95) },
      { EASYSIMD_FLOAT32_C(   464.26), EASYSIMD_FLOAT32_C(  -546.52) },
      { EASYSIMD_FLOAT32_C(   -20.73), EASYSIMD_FLOAT32_C(   -66.51) },
      {
      EASYSIMD_FLOAT32_C(   157.09),
      EASYSIMD_FLOAT32_C(   205.94),
      EASYSIMD_FLOAT32_C(   464.26),
      EASYSIMD_FLOAT32_C(   -20.73),
      EASYSIMD_FLOAT32_C(   729.25),
      EASYSIMD_FLOAT32_C(   941.95),
      EASYSIMD_FLOAT32_C(  -546.52),
      EASYSIMD_FLOAT32_C(   -66.51),
      }
    },
    { { EASYSIMD_FLOAT32_C(   718.98), EASYSIMD_FLOAT32_C(  -700.91) },
      { EASYSIMD_FLOAT32_C(   749.81), EASYSIMD_FLOAT32_C(  -586.28) },
      { EASYSIMD_FLOAT32_C(  -652.38), EASYSIMD_FLOAT32_C(   307.52) },
      { EASYSIMD_FLOAT32_C(  -384.00), EASYSIMD_FLOAT32_C(   801.10) },
      {
      EASYSIMD_FLOAT32_C(   718.98),
      EASYSIMD_FLOAT32_C(   749.81),
      EASYSIMD_FLOAT32_C(  -652.38),
      EASYSIMD_FLOAT32_C(  -384.00),
      EASYSIMD_FLOAT32_C(  -700.91),
      EASYSIMD_FLOAT32_C(  -586.28),
      EASYSIMD_FLOAT32_C(   307.52),
      EASYSIMD_FLOAT32_C(   801.10),
      }
    },
    { { EASYSIMD_FLOAT32_C(   556.22), EASYSIMD_FLOAT32_C(   154.44) },
      { EASYSIMD_FLOAT32_C(   873.42), EASYSIMD_FLOAT32_C(  -964.19) },
      { EASYSIMD_FLOAT32_C(   -99.70), EASYSIMD_FLOAT32_C(  -227.50) },
      { EASYSIMD_FLOAT32_C(   592.78), EASYSIMD_FLOAT32_C(  -676.51) },
      {
      EASYSIMD_FLOAT32_C(   556.22),
      EASYSIMD_FLOAT32_C(   873.42),
      EASYSIMD_FLOAT32_C(   -99.70),
      EASYSIMD_FLOAT32_C(   592.78),
      EASYSIMD_FLOAT32_C(   154.44),
      EASYSIMD_FLOAT32_C(  -964.19),
      EASYSIMD_FLOAT32_C(  -227.50),
      EASYSIMD_FLOAT32_C(  -676.51),
      }
    },
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float32x2x4_t r_ = { { easysimd_vld1_f32(test_vec[i].r0),
                                 easysimd_vld1_f32(test_vec[i].r1),
                                 easysimd_vld1_f32(test_vec[i].r2),
                                 easysimd_vld1_f32(test_vec[i].r3), } };

    easysimd_float32 a_[8];
    easysimd_vst4_f32(a_, r_);
    easysimd_assert_equal_i(0, easysimd_memcmp(a_, test_vec[i].a, sizeof(test_vec[i].a)));

    r_ = easysimd_vld4_f32(a_);
    easysimd_test_arm_neon_assert_equal_f32x2(r_.val[0], easysimd_vld1_f32(test_vec[i].r0), 1);
    easysimd_test_arm_neon_assert_equal_f32x2(r_.val[1], easysimd_vld1_f32(test_vec[i].r1), 1);
    easysimd_test_arm_neon_assert_equal_f32x2(r_.val[2], easysimd_vld1_f32(test_vec[i].r2), 1);
    easysimd_test_arm_neon_assert_equal_f32x2(r_.val[3], easysimd_vld1_f32(test_vec[i].r3), 1);
  }
  ...
  fputc('\n', stdout);
  for (int i = 0 ; i < 8 ; i++) {
    easysimd_float32x2_t a0 = easysimd_test_arm_neon_random_f32x2(-1000.0f, 1000.0f);
    easysimd_float32x2_t a1 = easysimd_test_arm_neon_random_f32x2(-1000.0f, 1000.0f);
    easysimd_float32x2_t a2 = easysimd_test_arm_neon_random_f32x2(-1000.0f, 1000.0f);
    easysimd_float32x2_t a3 = easysimd_test_arm_neon_random_f32x2(-1000.0f, 1000.0f);
    easysimd_float32x2x4_t a = { { a0, a1, a2, a3 } };
    easysimd_test_arm_neon_write_f32x2(2, a0, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_arm_neon_write_f32x2(2, a1, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_f32x2(2, a2, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_f32x2(2, a3, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_float32_t buf[8];
    easysimd_vst4_f32(buf, a);

    printf("      {\n");
    for (size_t j = 0; j < (sizeof(buf) / sizeof(buf[0])) ; j++) {
      easysimd_test_codegen_write_f32(2, buf[j], EASYSIMD_TEST_VEC_POS_MIDDLE);
    }
    printf("      }\n    },\n");
  }
  return 1;
...
static int
test_easysimd_vst4_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    easysimd_float64 r0[1];
    easysimd_float64 r1[1];
    easysimd_float64 r2[1];
    easysimd_float64 r3[1];
    easysimd_float64 a[4];
  } test_vec[] = {
    { { EASYSIMD_FLOAT64_C(   624.60) },
      { EASYSIMD_FLOAT64_C(   658.33) },
      { EASYSIMD_FLOAT64_C(   990.90) },
      { EASYSIMD_FLOAT64_C(  -345.25) },
      {
      EASYSIMD_FLOAT64_C(   624.60),
      EASYSIMD_FLOAT64_C(   658.33),
      EASYSIMD_FLOAT64_C(   990.90),
    ...
    { { EASYSIMD_FLOAT64_C(   563.48) },
      { EASYSIMD_FLOAT64_C(   508.25) },
      { EASYSIMD_FLOAT64_C(   888.63) },
      { EASYSIMD_FLOAT64_C(  -575.04) },
      {
      EASYSIMD_FLOAT64_C(   563.48),
      EASYSIMD_FLOAT64_C(   508.25),
      EASYSIMD_FLOAT64_C(   888.63),
    ...
    { { EASYSIMD_FLOAT64_C(  -646.15) },
      { EASYSIMD_FLOAT64_C(   389.76) },
      { EASYSIMD_FLOAT64_C(   742.88) },
      { EASYSIMD_FLOAT64_C(  -788.98) },
      {
      EASYSIMD_FLOAT64_C(  -646.15),
      EASYSIMD_FLOAT64_C(   389.76),
      EASYSIMD_FLOAT64_C(   742.88),
    ...
    { { EASYSIMD_FLOAT64_C(   856.06) },
      { EASYSIMD_FLOAT64_C(   722.96) },
      { EASYSIMD_FLOAT64_C(  -525.80) },
      { EASYSIMD_FLOAT64_C(  -581.83) },
      {
      EASYSIMD_FLOAT64_C(   856.06),
      EASYSIMD_FLOAT64_C(   722.96),
      EASYSIMD_FLOAT64_C(  -525.80),
    ...
    { { EASYSIMD_FLOAT64_C(   936.61) },
      { EASYSIMD_FLOAT64_C(  -287.02) },
      { EASYSIMD_FLOAT64_C(   260.93) },
      { EASYSIMD_FLOAT64_C(   698.72) },
      {
      EASYSIMD_FLOAT64_C(   936.61),
      EASYSIMD_FLOAT64_C(  -287.02),
      EASYSIMD_FLOAT64_C(   260.93),
    ...
    { { EASYSIMD_FLOAT64_C(  -737.87) },
      { EASYSIMD_FLOAT64_C(   387.05) },
      { EASYSIMD_FLOAT64_C(   511.74) },
      { EASYSIMD_FLOAT64_C(  -545.62) },
      {
      EASYSIMD_FLOAT64_C(  -737.87),
      EASYSIMD_FLOAT64_C(   387.05),
      EASYSIMD_FLOAT64_C(   511.74),
    ...
    { { EASYSIMD_FLOAT64_C(  -116.76) },
      { EASYSIMD_FLOAT64_C(   449.01) },
      { EASYSIMD_FLOAT64_C(   535.14) },
      { EASYSIMD_FLOAT64_C(   592.89) },
      {
      EASYSIMD_FLOAT64_C(  -116.76),
      EASYSIMD_FLOAT64_C(   449.01),
      EASYSIMD_FLOAT64_C(   535.14),
    ...
    { { EASYSIMD_FLOAT64_C(  -783.83) },
      { EASYSIMD_FLOAT64_C(   958.98) },
      { EASYSIMD_FLOAT64_C(  -896.71) },
      { EASYSIMD_FLOAT64_C(   840.77) },
      {
      EASYSIMD_FLOAT64_C(  -783.83),
      EASYSIMD_FLOAT64_C(   958.98),
      EASYSIMD_FLOAT64_C(  -896.71),
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float64x1x4_t r_ = { { easysimd_vld1_f64(test_vec[i].r0),
                                 easysimd_vld1_f64(test_vec[i].r1),
                                 easysimd_vld1_f64(test_vec[i].r2),
                                 easysimd_vld1_f64(test_vec[i].r3), } };

    easysimd_float64_t a_[4];
    easysimd_vst4_f64(a_, r_);
    easysimd_assert_equal_i(0, easysimd_memcmp(a_, test_vec[i].a, sizeof(test_vec[i].a)));

    r_ = easysimd_vld4_f64(a_);
    easysimd_test_arm_neon_assert_equal_f64x1(r_.val[0], easysimd_vld1_f64(test_vec[i].r0), 1);
    easysimd_test_arm_neon_assert_equal_f64x1(r_.val[1], easysimd_vld1_f64(test_vec[i].r1), 1);
    easysimd_test_arm_neon_assert_equal_f64x1(r_.val[2], easysimd_vld1_f64(test_vec[i].r2), 1);
    easysimd_test_arm_neon_assert_equal_f64x1(r_.val[3], easysimd_vld1_f64(test_vec[i].r3), 1);
  }
  ...
  fputc('\n', stdout);
  for (int i = 0 ; i < 8 ; i++) {
    easysimd_float64x1_t a0 = easysimd_test_arm_neon_random_f64x1(-1000.0f, 1000.0f);
    easysimd_float64x1_t a1 = easysimd_test_arm_neon_random_f64x1(-1000.0f, 1000.0f);
    easysimd_float64x1_t a2 = easysimd_test_arm_neon_random_f64x1(-1000.0f, 1000.0f);
    easysimd_float64x1_t a3 = easysimd_test_arm_neon_random_f64x1(-1000.0f, 1000.0f);
    easysimd_float64x1x4_t a = { { a0, a1, a2, a3 } };
    easysimd_test_arm_neon_write_f64x1(2, a0, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_arm_neon_write_f64x1(2, a1, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_f64x1(2, a2, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_f64x1(2, a3, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_float64_t buf[4];
    easysimd_vst4_f64(buf, a);

    printf("      {\n");
    for (size_t j = 0; j < (sizeof(buf) / sizeof(buf[0])) ; j++) {
      easysimd_test_codegen_write_f64(2, buf[j], EASYSIMD_TEST_VEC_POS_MIDDLE);
    }
    printf("      }\n    },\n");
  }
  return 1;
...
static int
test_easysimd_vst4_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int8_t r0[8];
    int8_t r1[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_int8x8x4_t r_ = { { easysimd_vld1_s8(test_vec[i].r0),
                              easysimd_vld1_s8(test_vec[i].r1),
                              easysimd_vld1_s8(test_vec[i].r2),
                              easysimd_vld1_s8(test_vec[i].r3), } };
    int8_t a_[32];
    easysimd_vst4_s8(a_, r_);
    easysimd_assert_equal_i(0, easysimd_memcmp(a_, test_vec[i].a, sizeof(a_)));

    r_ = easysimd_vld4_s8(a_);
    easysimd_test_arm_neon_assert_equal_i8x8(r_.val[0], easysimd_vld1_s8(test_vec[i].r0));
    easysimd_test_arm_neon_assert_equal_i8x8(r_.val[1], easysimd_vld1_s8(test_vec[i].r1));
    easysimd_test_arm_neon_assert_equal_i8x8(r_.val[2], easysimd_vld1_s8(test_vec[i].r2));
  }
  ...
  fputc('\n', stdout);
  for (int i = 0 ; i < 8 ; i++) {
    easysimd_int8x8_t a0 = easysimd_test_arm_neon_random_i8x8();
    easysimd_int8x8_t a1 = easysimd_test_arm_neon_random_i8x8();
    easysimd_int8x8_t a2 = easysimd_test_arm_neon_random_i8x8();
    easysimd_int8x8_t a3 = easysimd_test_arm_neon_random_i8x8();
    easysimd_int8x8x4_t a = { { a0, a1, a2, a3 } };
    easysimd_test_arm_neon_write_i8x8(2, a0, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_arm_neon_write_i8x8(2, a1, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_i8x8(2, a2, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_i8x8(2, a3, EASYSIMD_TEST_VEC_POS_MIDDLE);
    int8_t buf[32];
    easysimd_vst4_s8(buf, a);

    printf("      {\n");
    for (size_t j = 0; j < (sizeof(buf) / sizeof(buf[0])) ; j++) {
      easysimd_test_codegen_write_i8(2, buf[j], EASYSIMD_TEST_VEC_POS_MIDDLE);
    }
    printf("      }\n    },\n");
  }
  return 1;
...
static int
test_easysimd_vst4_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int16_t r0[4];
    int16_t r1[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_int16x4x4_t r_ = { { easysimd_vld1_s16(test_vec[i].r0),
                               easysimd_vld1_s16(test_vec[i].r1),
                               easysimd_vld1_s16(test_vec[i].r2),
                               easysimd_vld1_s16(test_vec[i].r3), } };

    int16_t a_[16];
    easysimd_vst4_s16(a_, r_);
    easysimd_assert_equal_i(0, easysimd_memcmp(a_, test_vec[i].a, sizeof(test_vec[i].a)));

    r_ = easysimd_vld4_s16(a_);
    easysimd_test_arm_neon_assert_equal_i16x4(r_.val[0], easysimd_vld1_s16(test_vec[i].r0));
    easysimd_test_arm_neon_assert_equal_i16x4(r_.val[1], easysimd_vld1_s16(test_vec[i].r1));
    easysimd_test_arm_neon_assert_equal_i16x4(r_.val[2], easysimd_vld1_s16(test_vec[i].r2));
  }
  ...
  fputc('\n', stdout);
  for (int i = 0 ; i < 8 ; i++) {
    easysimd_int16x4_t a0 = easysimd_test_arm_neon_random_i16x4();
    easysimd_int16x4_t a1 = easysimd_test_arm_neon_random_i16x4();
    easysimd_int16x4_t a2 = easysimd_test_arm_neon_random_i16x4();
    easysimd_int16x4_t a3 = easysimd_test_arm_neon_random_i16x4();
    easysimd_int16x4x4_t a = { { a0, a1, a2, a3 } };
    easysimd_test_arm_neon_write_i16x4(2, a0, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_arm_neon_write_i16x4(2, a1, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_i16x4(2, a2, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_i16x4(2, a3, EASYSIMD_TEST_VEC_POS_MIDDLE);
    int16_t buf[16];
    easysimd_vst4_s16(buf, a);

    printf("      {\n");
    for (size_t j = 0; j < (sizeof(buf) / sizeof(buf[0])) ; j++) {
      easysimd_test_codegen_write_i16(2, buf[j], EASYSIMD_TEST_VEC_POS_MIDDLE);
    }
    printf("      }\n    },\n");
  }
  return 1;
...
static int
test_easysimd_vst4_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t r0[2];
    int32_t r1[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_int32x2x4_t r_ = { { easysimd_vld1_s32(test_vec[i].r0),
                               easysimd_vld1_s32(test_vec[i].r1),
                               easysimd_vld1_s32(test_vec[i].r2),
                               easysimd_vld1_s32(test_vec[i].r3), } };

    int32_t a_[8];
    easysimd_vst4_s32(a_, r_);
    easysimd_assert_equal_i(0, easysimd_memcmp(a_, test_vec[i].a, sizeof(test_vec[i].a)));

    r_ = easysimd_vld4_s32(a_);
    easysimd_test_arm_neon_assert_equal_i32x2(r_.val[0], easysimd_vld1_s32(test_vec[i].r0));
    easysimd_test_arm_neon_assert_equal_i32x2(r_.val[1], easysimd_vld1_s32(test_vec[i].r1));
    easysimd_test_arm_neon_assert_equal_i32x2(r_.val[2], easysimd_vld1_s32(test_vec[i].r2));
  }
  ...
  fputc('\n', stdout);
  for (int i = 0 ; i < 8 ; i++) {
    easysimd_int32x2_t a0 = easysimd_test_arm_neon_random_i32x2();
    easysimd_int32x2_t a1 = easysimd_test_arm_neon_random_i32x2();
    easysimd_int32x2_t a2 = easysimd_test_arm_neon_random_i32x2();
    easysimd_int32x2_t a3 = easysimd_test_arm_neon_random_i32x2();
    easysimd_int32x2x4_t a = { { a0, a1, a2, a3 } };
    easysimd_test_arm_neon_write_i32x2(2, a0, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_arm_neon_write_i32x2(2, a1, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_i32x2(2, a2, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_i32x2(2, a3, EASYSIMD_TEST_VEC_POS_MIDDLE);
    int32_t buf[8];
    easysimd_vst4_s32(buf, a);

    printf("      {\n");
    for (size_t j = 0; j < (sizeof(buf) / sizeof(buf[0])) ; j++) {
      easysimd_test_codegen_write_i32(2, buf[j], EASYSIMD_TEST_VEC_POS_MIDDLE);
    }
    printf("      }\n    },\n");
  }
  return 1;
...
static int
test_easysimd_vst4_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int64_t r0[1];
    int64_t r1[1];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_int64x1x4_t r_ = { { easysimd_vld1_s64(test_vec[i].r0),
                               easysimd_vld1_s64(test_vec[i].r1),
                               easysimd_vld1_s64(test_vec[i].r2),
                               easysimd_vld1_s64(test_vec[i].r3), } };

    int64_t a_[4];
    easysimd_vst4_s64(a_, r_);
    easysimd_assert_equal_i(0, easysimd_memcmp(a_, test_vec[i].a, sizeof(test_vec[i].a)));

    r_ = easysimd_vld4_s64(a_);
    easysimd_test_arm_neon_assert_equal_i64x1(r_.val[0], easysimd_vld1_s64(test_vec[i].r0));
    easysimd_test_arm_neon_assert_equal_i64x1(r_.val[1], easysimd_vld1_s64(test_vec[i].r1));
    easysimd_test_arm_neon_assert_equal_i64x1(r_.val[2], easysimd_vld1_s64(test_vec[i].r2));
  }
  ...
  fputc('\n', stdout);
  for (int i = 0 ; i < 8 ; i++) {
    easysimd_int64x1_t a0 = easysimd_test_arm_neon_random_i64x1();
    easysimd_int64x1_t a1 = easysimd_test_arm_neon_random_i64x1();
    easysimd_int64x1_t a2 = easysimd_test_arm_neon_random_i64x1();
    easysimd_int64x1_t a3 = easysimd_test_arm_neon_random_i64x1();
    easysimd_int64x1x4_t a = { { a0, a1, a2, a3 } };
    easysimd_test_arm_neon_write_i64x1(2, a0, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_arm_neon_write_i64x1(2, a1, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_i64x1(2, a2, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_i64x1(2, a3, EASYSIMD_TEST_VEC_POS_MIDDLE);
    int64_t buf[4];
    easysimd_vst4_s64(buf, a);

    printf("      {\n");
    for (size_t j = 0; j < (sizeof(buf) / sizeof(buf[0])) ; j++) {
      easysimd_test_codegen_write_i64(2, buf[j], EASYSIMD_TEST_VEC_POS_MIDDLE);
    }
    printf("      }\n    },\n");
  }
  return 1;
...
static int
test_easysimd_vst4_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint8_t r0[8];
    uint8_t r1[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint8x8x4_t r_ = { { easysimd_vld1_u8(test_vec[i].r0),
                               easysimd_vld1_u8(test_vec[i].r1),
                               easysimd_vld1_u8(test_vec[i].r2),
                               easysimd_vld1_u8(test_vec[i].r3), } };

    uint8_t a_[32];
    easysimd_vst4_u8(a_, r_);
    easysimd_assert_equal_i(0, easysimd_memcmp(a_, test_vec[i].a, sizeof(test_vec[i].a)));

    r_ = easysimd_vld4_u8(a_);
    easysimd_test_arm_neon_assert_equal_u8x8(r_.val[0], easysimd_vld1_u8(test_vec[i].r0));
    easysimd_test_arm_neon_assert_equal_u8x8(r_.val[1], easysimd_vld1_u8(test_vec[i].r1));
    easysimd_test_arm_neon_assert_equal_u8x8(r_.val[2], easysimd_vld1_u8(test_vec[i].r2));
  }
  ...
  for (size_t i = 0 ; i < 8 ; i++) {
    easysimd_uint8x8_t a0 = easysimd_test_arm_neon_random_u8x8();
    easysimd_uint8x8_t a1 = easysimd_test_arm_neon_random_u8x8();
    easysimd_uint8x8_t a2 = easysimd_test_arm_neon_random_u8x8();
    easysimd_uint8x8_t a3 = easysimd_test_arm_neon_random_u8x8();
    easysimd_uint8x8x4_t a = { { a0, a1, a2, a3 } };
    easysimd_test_arm_neon_write_u8x8(2, a0, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_arm_neon_write_u8x8(2, a1, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_u8x8(2, a2, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_u8x8(2, a3, EASYSIMD_TEST_VEC_POS_MIDDLE);
    uint8_t buf[32];
    easysimd_vst4_u8(buf, a);

    printf("      {\n");
    for (size_t j = 0; j < (sizeof(buf) / sizeof(buf[0])) ; j++) {
      easysimd_test_codegen_write_u8(2, buf[j], EASYSIMD_TEST_VEC_POS_MIDDLE);
    }
    printf("      }\n    },\n");
  }
  return 1;
...
static int
test_easysimd_vst4_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint16_t r0[4];
    uint16_t r1[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint16x4x4_t r_ = { { easysimd_vld1_u16(test_vec[i].r0),
                                easysimd_vld1_u16(test_vec[i].r1),
                                easysimd_vld1_u16(test_vec[i].r2),
                                easysimd_vld1_u16(test_vec[i].r3), } };

    uint16_t a_[16];
    easysimd_vst4_u16(a_, r_);
    easysimd_assert_equal_i(0, easysimd_memcmp(a_, test_vec[i].a, sizeof(test_vec[i].a)));

    r_ = easysimd_vld4_u16(a_);
    easysimd_test_arm_neon_assert_equal_u16x4(r_.val[0], easysimd_vld1_u16(test_vec[i].r0));
    easysimd_test_arm_neon_assert_equal_u16x4(r_.val[1], easysimd_vld1_u16(test_vec[i].r1));
    easysimd_test_arm_neon_assert_equal_u16x4(r_.val[2], easysimd_vld1_u16(test_vec[i].r2));
  }
  ...
  fputc('\n', stdout);
  for (size_t i = 0 ; i < 8 ; i++) {
    easysimd_uint16x4_t a0 = easysimd_test_arm_neon_random_u16x4();
    easysimd_uint16x4_t a1 = easysimd_test_arm_neon_random_u16x4();
    easysimd_uint16x4_t a2 = easysimd_test_arm_neon_random_u16x4();
    easysimd_uint16x4_t a3 = easysimd_test_arm_neon_random_u16x4();
    easysimd_uint16x4x4_t a = { { a0, a1, a2, a3 } };
    easysimd_test_arm_neon_write_u16x4(2, a0, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_arm_neon_write_u16x4(2, a1, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_u16x4(2, a2, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_u16x4(2, a3, EASYSIMD_TEST_VEC_POS_MIDDLE);
    uint16_t buf[16];
    easysimd_vst4_u16(buf, a);

    printf("      {\n");
    for (size_t j = 0; j < (sizeof(buf) / sizeof(buf[0])) ; j++) {
      easysimd_test_codegen_write_u16(2, buf[j], EASYSIMD_TEST_VEC_POS_MIDDLE);
    }
    printf("      }\n    },\n");
  }
  return 1;
...
static int
test_easysimd_vst4_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint32_t r0[2];
    uint32_t r1[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint32x2x4_t r_ = { { easysimd_vld1_u32(test_vec[i].r0),
                                easysimd_vld1_u32(test_vec[i].r1),
                                easysimd_vld1_u32(test_vec[i].r2),
                                easysimd_vld1_u32(test_vec[i].r3), } };

    uint32_t a_[8];
    easysimd_vst4_u32(a_, r_);
    easysimd_assert_equal_i(0, easysimd_memcmp(a_, test_vec[i].a, sizeof(test_vec[i].a)));

    r_ = easysimd_vld4_u32(a_);
    easysimd_test_arm_neon_assert_equal_u32x2(r_.val[0], easysimd_vld1_u32(test_vec[i].r0));
    easysimd_test_arm_neon_assert_equal_u32x2(r_.val[1], easysimd_vld1_u32(test_vec[i].r1));
    easysimd_test_arm_neon_assert_equal_u32x2(r_.val[2], easysimd_vld1_u32(test_vec[i].r2));
  }
  ...
  fputc('\n', stdout);
  for (size_t i = 0 ; i < 8 ; i++) {
    easysimd_uint32x2_t a0 = easysimd_test_arm_neon_random_u32x2();
    easysimd_uint32x2_t a1 = easysimd_test_arm_neon_random_u32x2();
    easysimd_uint32x2_t a2 = easysimd_test_arm_neon_random_u32x2();
    easysimd_uint32x2_t a3 = easysimd_test_arm_neon_random_u32x2();
    easysimd_uint32x2x4_t a = { { a0, a1, a2, a3 } };
    easysimd_test_arm_neon_write_u32x2(2, a0, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_arm_neon_write_u32x2(2, a1, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_u32x2(2, a2, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_u32x2(2, a3, EASYSIMD_TEST_VEC_POS_MIDDLE);
    uint32_t buf[8];
    easysimd_vst4_u32(buf, a);

    printf("      {\n");
    for (size_t j = 0; j < (sizeof(buf) / sizeof(buf[0])) ; j++) {
      easysimd_test_codegen_write_u32(2, buf[j], EASYSIMD_TEST_VEC_POS_MIDDLE);
    }
    printf("      }\n    },\n");
  }
  return 1;
...
static int
test_easysimd_vst4_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint64_t r0[1];
    uint64_t r1[1];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint64x1x4_t r_ = { { easysimd_vld1_u64(test_vec[i].r0),
                                easysimd_vld1_u64(test_vec[i].r1),
                                easysimd_vld1_u64(test_vec[i].r2),
                                easysimd_vld1_u64(test_vec[i].r3), } };

    uint64_t a_[4];
    easysimd_vst4_u64(a_, r_);
    easysimd_assert_equal_i(0, easysimd_memcmp(a_, test_vec[i].a, sizeof(test_vec[i].a)));

    r_ = easysimd_vld4_u64(a_);
    easysimd_test_arm_neon_assert_equal_u64x1(r_.val[0], easysimd_vld1_u64(test_vec[i].r0));
    easysimd_test_arm_neon_assert_equal_u64x1(r_.val[1], easysimd_vld1_u64(test_vec[i].r1));
    easysimd_test_arm_neon_assert_equal_u64x1(r_.val[2], easysimd_vld1_u64(test_vec[i].r2));
  }
  ...
  fputc('\n', stdout);
  for (size_t i = 0 ; i < 8 ; i++) {
    easysimd_uint64x1_t a0 = easysimd_test_arm_neon_random_u64x1();
    easysimd_uint64x1_t a1 = easysimd_test_arm_neon_random_u64x1();
    easysimd_uint64x1_t a2 = easysimd_test_arm_neon_random_u64x1();
    easysimd_uint64x1_t a3 = easysimd_test_arm_neon_random_u64x1();
    easysimd_uint64x1x4_t a = { { a0, a1, a2, a3 } };
    easysimd_test_arm_neon_write_u64x1(2, a0, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_arm_neon_write_u64x1(2, a1, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_u64x1(2, a2, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_u64x1(2, a3, EASYSIMD_TEST_VEC_POS_MIDDLE);
    uint64_t buf[4];
    easysimd_vst4_u64(buf, a);

    printf("      {\n");
    for (size_t j = 0; j < (sizeof(buf) / sizeof(buf[0])) ; j++) {
      easysimd_test_codegen_write_u64(2, buf[j], EASYSIMD_TEST_VEC_POS_MIDDLE);
    }
    printf("      }\n    },\n");
  }
  return 1;
...
static int
test_easysimd_vst4q_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    easysimd_float32 r0[4];
    easysimd_float32 r1[4];
    easysimd_float32 r2[4];
    easysimd_float32 r3[4];
    easysimd_float32 a[16];
  } test_vec[] = {
    { { EASYSIMD_FLOAT32_C(  -988.70), EASYSIMD_FLOAT32_C(   709.53), EASYSIMD_FLOAT32_C(  -895.28), EASYSIMD_FLOAT32_C(  -307.54) },
      { EASYSIMD_FLOAT32_C(  -137.31), EASYSIMD_FLOAT32_C(   947.38), EASYSIMD_FLOAT32_C(   965.29), EASYSIMD_FLOAT32_C(  -533.59) },
      { EASYSIMD_FLOAT32_C(  -896.71), EASYSIMD_FLOAT32_C(   365.46), EASYSIMD_FLOAT32_C(  -161.98), EASYSIMD_FLOAT32_C(   -31.53) },
      { EASYSIMD_FLOAT32_C(  -334.29), EASYSIMD_FLOAT32_C(  -613.71), EASYSIMD_FLOAT32_C(   414.87), EASYSIMD_FLOAT32_C(  -872.42) },
      {
      EASYSIMD_FLOAT32_C(  -988.70),
      EASYSIMD_FLOAT32_C(  -137.31),
      EASYSIMD_FLOAT32_C(  -896.71),
      EASYSIMD_FLOAT32_C(  -334.29),
      EASYSIMD_FLOAT32_C(   709.53),
      EASYSIMD_FLOAT32_C(   947.38),
      EASYSIMD_FLOAT32_C(   365.46),
      EASYSIMD_FLOAT32_C(  -613.71),
      EASYSIMD_FLOAT32_C(  -895.28),
      EASYSIMD_FLOAT32_C(   965.29),
      EASYSIMD_FLOAT32_C(  -161.98),
      EASYSIMD_FLOAT32_C(   414.87),
      EASYSIMD_FLOAT32_C(  -307.54),
      EASYSIMD_FLOAT32_C(  -533.59),
      EASYSIMD_FLOAT32_C(   -31.53),
      EASYSIMD_FLOAT32_C(  -872.42),
      }
    },
    { { EASYSIMD_FLOAT32_C(  -175.89), EASYSIMD_FLOAT32_C(   -87.40), EASYSIMD_FLOAT32_C(  -428.46), EASYSIMD_FLOAT32_C(  -598.83) },
      { EASYSIMD_FLOAT32_C(  -917.69), EASYSIMD_FLOAT32_C(  -293.34), EASYSIMD_FLOAT32_C(   593.88), EASYSIMD_FLOAT32_C(  -196.10) },
      { EASYSIMD_FLOAT32_C(   921.26), EASYSIMD_FLOAT32_C(   218.55), EASYSIMD_FLOAT32_C(  -799.38), EASYSIMD_FLOAT32_C(  -616.04) },
      { EASYSIMD_FLOAT32_C(   227.38), EASYSIMD_FLOAT32_C(   356.05), EASYSIMD_FLOAT32_C(   155.96), EASYSIMD_FLOAT32_C(   238.69) },
      {
      EASYSIMD_FLOAT32_C(  -175.89),
      EASYSIMD_FLOAT32_C(  -917.69),
      EASYSIMD_FLOAT32_C(   921.26),
      EASYSIMD_FLOAT32_C(   227.38),
      EASYSIMD_FLOAT32_C(   -87.40),
      EASYSIMD_FLOAT32_C(  -293.34),
      EASYSIMD_FLOAT32_C(   218.55),
      EASYSIMD_FLOAT32_C(   356.05),
      EASYSIMD_FLOAT32_C(  -428.46),
      EASYSIMD_FLOAT32_C(   593.88),
      EASYSIMD_FLOAT32_C(  -799.38),
      EASYSIMD_FLOAT32_C(   155.96),
      EASYSIMD_FLOAT32_C(  -598.83),
      EASYSIMD_FLOAT32_C(  -196.10),
      EASYSIMD_FLOAT32_C(  -616.04),
      EASYSIMD_FLOAT32_C(   238.69),
      }
    },
    { { EASYSIMD_FLOAT32_C(    65.58), EASYSIMD_FLOAT32_C(   260.68), EASYSIMD_FLOAT32_C(   931.15), EASYSIMD_FLOAT32_C(   928.27) },
      { EASYSIMD_FLOAT32_C(   208.06), EASYSIMD_FLOAT32_C(   896.44), EASYSIMD_FLOAT32_C(  -605.32), EASYSIMD_FLOAT32_C(   311.35) },
      { EASYSIMD_FLOAT32_C(   261.91), EASYSIMD_FLOAT32_C(   232.70), EASYSIMD_FLOAT32_C(  -720.18), EASYSIMD_FLOAT32_C(   927.62) },
      { EASYSIMD_FLOAT32_C(   618.99), EASYSIMD_FLOAT32_C(   694.69), EASYSIMD_FLOAT32_C(  -944.80), EASYSIMD_FLOAT32_C(  -556.90) },
      {
      EASYSIMD_FLOAT32_C(    65.58),
      EASYSIMD_FLOAT32_C(   208.06),
      EASYSIMD_FLOAT32_C(   261.91),
      EASYSIMD_FLOAT32_C(   618.99),
      EASYSIMD_FLOAT32_C(   260.68),
      EASYSIMD_FLOAT32_C(   896.44),
      EASYSIMD_FLOAT32_C(   232.70),
      EASYSIMD_FLOAT32_C(   694.69),
      EASYSIMD_FLOAT32_C(   931.15),
      EASYSIMD_FLOAT32_C(  -605.32),
      EASYSIMD_FLOAT32_C(  -720.18),
      EASYSIMD_FLOAT32_C(  -944.80),
      EASYSIMD_FLOAT32_C(   928.27),
      EASYSIMD_FLOAT32_C(   311.35),
      EASYSIMD_FLOAT32_C(   927.62),
      EASYSIMD_FLOAT32_C(  -556.90),
      }
    },
    { { EASYSIMD_FLOAT32_C(  -392.71), EASYSIMD_FLOAT32_C(  -373.26), EASYSIMD_FLOAT32_C(  -155.73), EASYSIMD_FLOAT32_C(  -310.40) },
      { EASYSIMD_FLOAT32_C(   333.40), EASYSIMD_FLOAT32_C(  -561.84), EASYSIMD_FLOAT32_C(   493.50), EASYSIMD_FLOAT32_C(   254.66) },
      { EASYSIMD_FLOAT32_C(   656.70), EASYSIMD_FLOAT32_C(   694.12), EASYSIMD_FLOAT32_C(   638.62), EASYSIMD_FLOAT32_C(  -115.91) },
      { EASYSIMD_FLOAT32_C(    50.17), EASYSIMD_FLOAT32_C(  -205.42), EASYSIMD_FLOAT32_C(  -877.23), EASYSIMD_FLOAT32_C(  -884.25) },
      {
      EASYSIMD_FLOAT32_C(  -392.71),
      EASYSIMD_FLOAT32_C(   333.40),
      EASYSIMD_FLOAT32_C(   656.70),
      EASYSIMD_FLOAT32_C(    50.17),
      EASYSIMD_FLOAT32_C(  -373.26),
      EASYSIMD_FLOAT32_C(  -561.84),
      EASYSIMD_FLOAT32_C(   694.12),
      EASYSIMD_FLOAT32_C(  -205.42),
      EASYSIMD_FLOAT32_C(  -155.73),
      EASYSIMD_FLOAT32_C(   493.50),
      EASYSIMD_FLOAT32_C(   638.62),
      EASYSIMD_FLOAT32_C(  -877.23),
      EASYSIMD_FLOAT32_C(  -310.40),
      EASYSIMD_FLOAT32_C(   254.66),
      EASYSIMD_FLOAT32_C(  -115.91),
      EASYSIMD_FLOAT32_C(  -884.25),
      }
    },
    { { EASYSIMD_FLOAT32_C(  -944.74), EASYSIMD_FLOAT32_C(  -946.08), EASYSIMD_FLOAT32_C(  -955.97), EASYSIMD_FLOAT32_C(   263.32) },
      { EASYSIMD_FLOAT32_C(   950.37), EASYSIMD_FLOAT32_C(  -561.29), EASYSIMD_FLOAT32_C(  -425.33), EASYSIMD_FLOAT32_C(   212.28) },
      { EASYSIMD_FLOAT32_C(   671.41), EASYSIMD_FLOAT32_C(  -145.51), EASYSIMD_FLOAT32_C(   139.89), EASYSIMD_FLOAT32_C(   290.40) },
      { EASYSIMD_FLOAT32_C(  -450.81), EASYSIMD_FLOAT32_C(   195.09), EASYSIMD_FLOAT32_C(   733.51), EASYSIMD_FLOAT32_C(   156.48) },
      {
      EASYSIMD_FLOAT32_C(  -944.74),
      EASYSIMD_FLOAT32_C(   950.37),
      EASYSIMD_FLOAT32_C(   671.41),
      EASYSIMD_FLOAT32_C(  -450.81),
      EASYSIMD_FLOAT32_C(  -946.08),
      EASYSIMD_FLOAT32_C(  -561.29),
      EASYSIMD_FLOAT32_C(  -145.51),
      EASYSIMD_FLOAT32_C(   195.09),
      EASYSIMD_FLOAT32_C(  -955.97),
      EASYSIMD_FLOAT32_C(  -425.33),
      EASYSIMD_FLOAT32_C(   139.89),
      EASYSIMD_FLOAT32_C(   733.51),
      EASYSIMD_FLOAT32_C(   263.32),
      EASYSIMD_FLOAT32_C(   212.28),
      EASYSIMD_FLOAT32_C(   290.40),
      EASYSIMD_FLOAT32_C(   156.48),
      }
    },
    { { EASYSIMD_FLOAT32_C(   821.83), EASYSIMD_FLOAT32_C(  -422.22), EASYSIMD_FLOAT32_C(   846.08), EASYSIMD_FLOAT32_C(   155.24) },
      { EASYSIMD_FLOAT32_C(    15.94), EASYSIMD_FLOAT32_C(   339.58), EASYSIMD_FLOAT32_C(  -590.10), EASYSIMD_FLOAT32_C(  -327.36) },
      { EASYSIMD_FLOAT32_C(    33.70), EASYSIMD_FLOAT32_C(  -951.48), EASYSIMD_FLOAT32_C(   556.72), EASYSIMD_FLOAT32_C(  -916.13) },
      { EASYSIMD_FLOAT32_C(  -156.90), EASYSIMD_FLOAT32_C(   679.50), EASYSIMD_FLOAT32_C(  -800.38), EASYSIMD_FLOAT32_C(  -101.64) },
      {
      EASYSIMD_FLOAT32_C(   821.83),
      EASYSIMD_FLOAT32_C(    15.94),
      EASYSIMD_FLOAT32_C(    33.70),
      EASYSIMD_FLOAT32_C(  -156.90),
      EASYSIMD_FLOAT32_C(  -422.22),
      EASYSIMD_FLOAT32_C(   339.58),
      EASYSIMD_FLOAT32_C(  -951.48),
      EASYSIMD_FLOAT32_C(   679.50),
      EASYSIMD_FLOAT32_C(   846.08),
      EASYSIMD_FLOAT32_C(  -590.10),
      EASYSIMD_FLOAT32_C(   556.72),
      EASYSIMD_FLOAT32_C(  -800.38),
      EASYSIMD_FLOAT32_C(   155.24),
      EASYSIMD_FLOAT32_C(  -327.36),
      EASYSIMD_FLOAT32_C(  -916.13),
      EASYSIMD_FLOAT32_C(  -101.64),
      }
    },
    { { EASYSIMD_FLOAT32_C(   733.42), EASYSIMD_FLOAT32_C(  -756.36), EASYSIMD_FLOAT32_C(  -838.32), EASYSIMD_FLOAT32_C(   683.79) },
      { EASYSIMD_FLOAT32_C(  -317.65), EASYSIMD_FLOAT32_C(  -263.65), EASYSIMD_FLOAT32_C(  -103.93), EASYSIMD_FLOAT32_C(  -646.24) },
      { EASYSIMD_FLOAT32_C(   590.85), EASYSIMD_FLOAT32_C(  -964.04), EASYSIMD_FLOAT32_C(   644.16), EASYSIMD_FLOAT32_C(  -859.96) },
      { EASYSIMD_FLOAT32_C(   231.05), EASYSIMD_FLOAT32_C(   377.67), EASYSIMD_FLOAT32_C(   296.52), EASYSIMD_FLOAT32_C(    52.89) },
      {
      EASYSIMD_FLOAT32_C(   733.42),
      EASYSIMD_FLOAT32_C(  -317.65),
      EASYSIMD_FLOAT32_C(   590.85),
      EASYSIMD_FLOAT32_C(   231.05),
      EASYSIMD_FLOAT32_C(  -756.36),
      EASYSIMD_FLOAT32_C(  -263.65),
      EASYSIMD_FLOAT32_C(  -964.04),
      EASYSIMD_FLOAT32_C(   377.67),
      EASYSIMD_FLOAT32_C(  -838.32),
      EASYSIMD_FLOAT32_C(  -103.93),
      EASYSIMD_FLOAT32_C(   644.16),
      EASYSIMD_FLOAT32_C(   296.52),
      EASYSIMD_FLOAT32_C(   683.79),
      EASYSIMD_FLOAT32_C(  -646.24),
      EASYSIMD_FLOAT32_C(  -859.96),
      EASYSIMD_FLOAT32_C(    52.89),
      }
    },
    { { EASYSIMD_FLOAT32_C(   955.45), EASYSIMD_FLOAT32_C(   142.60), EASYSIMD_FLOAT32_C(  -791.88), EASYSIMD_FLOAT32_C(   -28.62) },
      { EASYSIMD_FLOAT32_C(  -517.82), EASYSIMD_FLOAT32_C(  -381.98), EASYSIMD_FLOAT32_C(   644.02), EASYSIMD_FLOAT32_C(   515.88) },
      { EASYSIMD_FLOAT32_C(  -333.46), EASYSIMD_FLOAT32_C(   200.74), EASYSIMD_FLOAT32_C(   599.74), EASYSIMD_FLOAT32_C(   509.64) },
      { EASYSIMD_FLOAT32_C(  -119.76), EASYSIMD_FLOAT32_C(   799.36), EASYSIMD_FLOAT32_C(  -592.00), EASYSIMD_FLOAT32_C(  -386.34) },
      {
      EASYSIMD_FLOAT32_C(   955.45),
      EASYSIMD_FLOAT32_C(  -517.82),
      EASYSIMD_FLOAT32_C(  -333.46),
      EASYSIMD_FLOAT32_C(  -119.76),
      EASYSIMD_FLOAT32_C(   142.60),
      EASYSIMD_FLOAT32_C(  -381.98),
      EASYSIMD_FLOAT32_C(   200.74),
      EASYSIMD_FLOAT32_C(   799.36),
      EASYSIMD_FLOAT32_C(  -791.88),
      EASYSIMD_FLOAT32_C(   644.02),
      EASYSIMD_FLOAT32_C(   599.74),
      EASYSIMD_FLOAT32_C(  -592.00),
      EASYSIMD_FLOAT32_C(   -28.62),
      EASYSIMD_FLOAT32_C(   515.88),
      EASYSIMD_FLOAT32_C(   509.64),
      EASYSIMD_FLOAT32_C(  -386.34),
      }
    },
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float32x4x4_t r_ = { { easysimd_vld1q_f32(test_vec[i].r0),
                                 easysimd_vld1q_f32(test_vec[i].r1),
                                 easysimd_vld1q_f32(test_vec[i].r2),
                                 easysimd_vld1q_f32(test_vec[i].r3), } };

    easysimd_float32 a_[16];
    easysimd_vst4q_f32(a_, r_);
    easysimd_assert_equal_i(0, easysimd_memcmp(a_, test_vec[i].a, sizeof(test_vec[i].a)));

    r_ = easysimd_vld4q_f32(a_);
    easysimd_test_arm_neon_assert_equal_f32x4(r_.val[0], easysimd_vld1q_f32(test_vec[i].r0), 1);
    easysimd_test_arm_neon_assert_equal_f32x4(r_.val[1], easysimd_vld1q_f32(test_vec[i].r1), 1);
    easysimd_test_arm_neon_assert_equal_f32x4(r_.val[2], easysimd_vld1q_f32(test_vec[i].r2), 1);
    easysimd_test_arm_neon_assert_equal_f32x4(r_.val[3], easysimd_vld1q_f32(test_vec[i].r3), 1);
  }
  ...
  fputc('\n', stdout);
  for (int i = 0 ; i < 8 ; i++) {
    easysimd_float32x4_t a0 = easysimd_test_arm_neon_random_f32x4(-1000.0f, 1000.0f);
    easysimd_float32x4_t a1 = easysimd_test_arm_neon_random_f32x4(-1000.0f, 1000.0f);
    easysimd_float32x4_t a2 = easysimd_test_arm_neon_random_f32x4(-1000.0f, 1000.0f);
    easysimd_float32x4_t a3 = easysimd_test_arm_neon_random_f32x4(-1000.0f, 1000.0f);
    easysimd_float32x4x4_t a = { { a0, a1, a2, a3 } };
    easysimd_test_arm_neon_write_f32x4(2, a0, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_arm_neon_write_f32x4(2, a1, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_f32x4(2, a2, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_f32x4(2, a3, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_float32_t buf[16];
    easysimd_vst4q_f32(buf, a);
...
static int
test_easysimd_vst4q_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    easysimd_float64 r0[2];
    easysimd_float64 r1[2];
    easysimd_float64 r2[2];
    easysimd_float64 r3[2];
    easysimd_float64 a[8];
  } test_vec[] = {
    { { EASYSIMD_FLOAT64_C(  -818.28), EASYSIMD_FLOAT64_C(   -30.31) },
      { EASYSIMD_FLOAT64_C(   709.73), EASYSIMD_FLOAT64_C(  -485.43) },
      { EASYSIMD_FLOAT64_C(   859.77), EASYSIMD_FLOAT64_C(  -908.87) },
      { EASYSIMD_FLOAT64_C(   467.51), EASYSIMD_FLOAT64_C(   159.39) },
      {
      EASYSIMD_FLOAT64_C(  -818.28),
      EASYSIMD_FLOAT64_C(   709.73),
      EASYSIMD_FLOAT64_C(   859.77),
      EASYSIMD_FLOAT64_C(   467.51),
      EASYSIMD_FLOAT64_C(   -30.31),
      EASYSIMD_FLOAT64_C(  -485.43),
      EASYSIMD_FLOAT64_C(  -908.87),
      EASYSIMD_FLOAT64_C(   159.39),
      }
    },
    { { EASYSIMD_FLOAT64_C(  -267.86), EASYSIMD_FLOAT64_C(  -945.08) },
      { EASYSIMD_FLOAT64_C(   703.56), EASYSIMD_FLOAT64_C(  -499.98) },
      { EASYSIMD_FLOAT64_C(   229.30), EASYSIMD_FLOAT64_C(  -572.30) },
      { EASYSIMD_FLOAT64_C(   838.48), EASYSIMD_FLOAT64_C(  -276.60) },
      {
      EASYSIMD_FLOAT64_C(  -267.86),
      EASYSIMD_FLOAT64_C(   703.56),
      EASYSIMD_FLOAT64_C(   229.30),
      EASYSIMD_FLOAT64_C(   838.48),
      EASYSIMD_FLOAT64_C(  -945.08),
      EASYSIMD_FLOAT64_C(  -499.98),
      EASYSIMD_FLOAT64_C(  -572.30),
      EASYSIMD_FLOAT64_C(  -276.60),
      }
    },
    { { EASYSIMD_FLOAT64_C(   417.49), EASYSIMD_FLOAT64_C(   -54.87) },
      { EASYSIMD_FLOAT64_C(    57.43), EASYSIMD_FLOAT64_C(   286.91) },
      { EASYSIMD_FLOAT64_C(  -186.44), EASYSIMD_FLOAT64_C(   308.53) },
      { EASYSIMD_FLOAT64_C(   898.55), EASYSIMD_FLOAT64_C(  -632.39) },
      {
      EASYSIMD_FLOAT64_C(   417.49),
      EASYSIMD_FLOAT64_C(    57.43),
      EASYSIMD_FLOAT64_C(  -186.44),
      EASYSIMD_FLOAT64_C(   898.55),
      EASYSIMD_FLOAT64_C(   -54.87),
      EASYSIMD_FLOAT64_C(   286.91),
      EASYSIMD_FLOAT64_C(   308.53),
      EASYSIMD_FLOAT64_C(  -632.39),
      }
    },
    { { EASYSIMD_FLOAT64_C(   104.89), EASYSIMD_FLOAT64_C(  -475.34) },
      { EASYSIMD_FLOAT64_C(   -11.27), EASYSIMD_FLOAT64_C(   402.75) },
      { EASYSIMD_FLOAT64_C(  -840.97), EASYSIMD_FLOAT64_C(  -286.94) },
      { EASYSIMD_FLOAT64_C(  -305.37), EASYSIMD_FLOAT64_C(  -659.25) },
      {
      EASYSIMD_FLOAT64_C(   104.89),
      EASYSIMD_FLOAT64_C(   -11.27),
      EASYSIMD_FLOAT64_C(  -840.97),
      EASYSIMD_FLOAT64_C(  -305.37),
      EASYSIMD_FLOAT64_C(  -475.34),
      EASYSIMD_FLOAT64_C(   402.75),
      EASYSIMD_FLOAT64_C(  -286.94),
      EASYSIMD_FLOAT64_C(  -659.25),
      }
    },
    { { EASYSIMD_FLOAT64_C(   682.75), EASYSIMD_FLOAT64_C(  -595.64) },
      { EASYSIMD_FLOAT64_C(  -144.67), EASYSIMD_FLOAT64_C(   542.52) },
      { EASYSIMD_FLOAT64_C(  -504.51), EASYSIMD_FLOAT64_C(  -677.16) },
      { EASYSIMD_FLOAT64_C(  -298.09), EASYSIMD_FLOAT64_C(   227.63) },
      {
      EASYSIMD_FLOAT64_C(   682.75),
      EASYSIMD_FLOAT64_C(  -144.67),
      EASYSIMD_FLOAT64_C(  -504.51),
      EASYSIMD_FLOAT64_C(  -298.09),
      EASYSIMD_FLOAT64_C(  -595.64),
      EASYSIMD_FLOAT64_C(   542.52),
      EASYSIMD_FLOAT64_C(  -677.16),
      EASYSIMD_FLOAT64_C(   227.63),
      }
    },
    { { EASYSIMD_FLOAT64_C(  -622.24), EASYSIMD_FLOAT64_C(  -594.53) },
      { EASYSIMD_FLOAT64_C(   727.66), EASYSIMD_FLOAT64_C(   607.06) },
      { EASYSIMD_FLOAT64_C(  -166.83), EASYSIMD_FLOAT64_C(   566.14) },
      { EASYSIMD_FLOAT64_C(  -669.54), EASYSIMD_FLOAT64_C(  -749.34) },
      {
      EASYSIMD_FLOAT64_C(  -622.24),
      EASYSIMD_FLOAT64_C(   727.66),
      EASYSIMD_FLOAT64_C(  -166.83),
      EASYSIMD_FLOAT64_C(  -669.54),
      EASYSIMD_FLOAT64_C(  -594.53),
      EASYSIMD_FLOAT64_C(   607.06),
      EASYSIMD_FLOAT64_C(   566.14),
      EASYSIMD_FLOAT64_C(  -749.34),
      }
    },
    { { EASYSIMD_FLOAT64_C(  -488.73), EASYSIMD_FLOAT64_C(   387.89) },
      { EASYSIMD_FLOAT64_C(   537.58), EASYSIMD_FLOAT64_C(   324.83) },
      { EASYSIMD_FLOAT64_C(  -303.58), EASYSIMD_FLOAT64_C(   436.13) },
      { EASYSIMD_FLOAT64_C(   692.45), EASYSIMD_FLOAT64_C(   801.32) },
      {
      EASYSIMD_FLOAT64_C(  -488.73),
      EASYSIMD_FLOAT64_C(   537.58),
      EASYSIMD_FLOAT64_C(  -303.58),
      EASYSIMD_FLOAT64_C(   692.45),
      EASYSIMD_FLOAT64_C(   387.89),
      EASYSIMD_FLOAT64_C(   324.83),
      EASYSIMD_FLOAT64_C(   436.13),
      EASYSIMD_FLOAT64_C(   801.32),
      }
    },
    { { EASYSIMD_FLOAT64_C(   960.79), EASYSIMD_FLOAT64_C(  -318.82) },
      { EASYSIMD_FLOAT64_C(   204.07), EASYSIMD_FLOAT64_C(  -880.18) },
      { EASYSIMD_FLOAT64_C(   394.24), EASYSIMD_FLOAT64_C(   898.70) },
      { EASYSIMD_FLOAT64_C(  -539.42), EASYSIMD_FLOAT64_C(    76.99) },
      {
      EASYSIMD_FLOAT64_C(   960.79),
      EASYSIMD_FLOAT64_C(   204.07),
      EASYSIMD_FLOAT64_C(   394.24),
      EASYSIMD_FLOAT64_C(  -539.42),
      EASYSIMD_FLOAT64_C(  -318.82),
      EASYSIMD_FLOAT64_C(  -880.18),
      EASYSIMD_FLOAT64_C(   898.70),
      EASYSIMD_FLOAT64_C(    76.99),
      }
    },
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float64x2x4_t r_ = { { easysimd_vld1q_f64(test_vec[i].r0),
                                 easysimd_vld1q_f64(test_vec[i].r1),
                                 easysimd_vld1q_f64(test_vec[i].r2),
                                 easysimd_vld1q_f64(test_vec[i].r3), } };

    easysimd_float64_t a_[8];
    easysimd_vst4q_f64(a_, r_);
    easysimd_assert_equal_i(0, easysimd_memcmp(a_, test_vec[i].a, sizeof(test_vec[i].a)));

    r_ = easysimd_vld4q_f64(a_);
    easysimd_test_arm_neon_assert_equal_f64x2(r_.val[0], easysimd_vld1q_f64(test_vec[i].r0), 1);
    easysimd_test_arm_neon_assert_equal_f64x2(r_.val[1], easysimd_vld1q_f64(test_vec[i].r1), 1);
    easysimd_test_arm_neon_assert_equal_f64x2(r_.val[2], easysimd_vld1q_f64(test_vec[i].r2), 1);
    easysimd_test_arm_neon_assert_equal_f64x2(r_.val[3], easysimd_vld1q_f64(test_vec[i].r3), 1);
  }
  ...
  fputc('\n', stdout);
  for (int i = 0 ; i < 8 ; i++) {
    easysimd_float64x2_t a0 = easysimd_test_arm_neon_random_f64x2(-1000.0f, 1000.0f);
    easysimd_float64x2_t a1 = easysimd_test_arm_neon_random_f64x2(-1000.0f, 1000.0f);
    easysimd_float64x2_t a2 = easysimd_test_arm_neon_random_f64x2(-1000.0f, 1000.0f);
    easysimd_float64x2_t a3 = easysimd_test_arm_neon_random_f64x2(-1000.0f, 1000.0f);
    easysimd_float64x2x4_t a = { { a0, a1, a2, a3 } };
    easysimd_test_arm_neon_write_f64x2(2, a0, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_arm_neon_write_f64x2(2, a1, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_f64x2(2, a2, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_f64x2(2, a3, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_float64_t buf[8];
    easysimd_vst4q_f64(buf, a);
...
static int
test_easysimd_vst4q_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int8_t r0[16];
    int8_t r1[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_int8x16x4_t r_ = { { easysimd_vld1q_s8(test_vec[i].r0),
                               easysimd_vld1q_s8(test_vec[i].r1),
                               easysimd_vld1q_s8(test_vec[i].r2),
                               easysimd_vld1q_s8(test_vec[i].r3), } };

    int8_t a_[64];
    easysimd_vst4q_s8(a_, r_);
    easysimd_assert_equal_i(0, easysimd_memcmp(a_, test_vec[i].a, sizeof(test_vec[i].a)));

    r_ = easysimd_vld4q_s8(a_);
    easysimd_test_arm_neon_assert_equal_i8x16(r_.val[0], easysimd_vld1q_s8(test_vec[i].r0));
    easysimd_test_arm_neon_assert_equal_i8x16(r_.val[1], easysimd_vld1q_s8(test_vec[i].r1));
    easysimd_test_arm_neon_assert_equal_i8x16(r_.val[2], easysimd_vld1q_s8(test_vec[i].r2));
  }
  ...
  fputc('\n', stdout);
  for (int i = 0 ; i < 8 ; i++) {
    easysimd_int8x16_t a0 = easysimd_test_arm_neon_random_i8x16();
    easysimd_int8x16_t a1 = easysimd_test_arm_neon_random_i8x16();
    easysimd_int8x16_t a2 = easysimd_test_arm_neon_random_i8x16();
    easysimd_int8x16_t a3 = easysimd_test_arm_neon_random_i8x16();
    easysimd_int8x16x4_t a = { { a0, a1, a2, a3 } };
    easysimd_test_arm_neon_write_i8x16(2, a0, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_arm_neon_write_i8x16(2, a1, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_i8x16(2, a2, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_i8x16(2, a3, EASYSIMD_TEST_VEC_POS_MIDDLE);
    int8_t buf[64];
    easysimd_vst4q_s8(buf, a);
...
static int
test_easysimd_vst4q_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int16_t r0[8];
    int16_t r1[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_int16x8x4_t r_ = { { easysimd_vld1q_s16(test_vec[i].r0),
                               easysimd_vld1q_s16(test_vec[i].r1),
                               easysimd_vld1q_s16(test_vec[i].r2),
                               easysimd_vld1q_s16(test_vec[i].r3), } };

    int16_t a_[32];
    easysimd_vst4q_s16(a_, r_);
    easysimd_assert_equal_i(0, easysimd_memcmp(a_, test_vec[i].a, sizeof(test_vec[i].a)));

    r_ = easysimd_vld4q_s16(a_);
    easysimd_test_arm_neon_assert_equal_i16x8(r_.val[0], easysimd_vld1q_s16(test_vec[i].r0));
    easysimd_test_arm_neon_assert_equal_i16x8(r_.val[1], easysimd_vld1q_s16(test_vec[i].r1));
    easysimd_test_arm_neon_assert_equal_i16x8(r_.val[2], easysimd_vld1q_s16(test_vec[i].r2));
  }
  ...
  fputc('\n', stdout);
  for (int i = 0 ; i < 8 ; i++) {
    easysimd_int16x8_t a0 = easysimd_test_arm_neon_random_i16x8();
    easysimd_int16x8_t a1 = easysimd_test_arm_neon_random_i16x8();
    easysimd_int16x8_t a2 = easysimd_test_arm_neon_random_i16x8();
    easysimd_int16x8_t a3 = easysimd_test_arm_neon_random_i16x8();
    easysimd_int16x8x4_t a = { { a0, a1, a2, a3 } };
    easysimd_test_arm_neon_write_i16x8(2, a0, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_arm_neon_write_i16x8(2, a1, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_i16x8(2, a2, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_i16x8(2, a3, EASYSIMD_TEST_VEC_POS_MIDDLE);
    int16_t buf[32];
    easysimd_vst4q_s16(buf, a);
...
static int
test_easysimd_vst4q_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t r0[4];
    int32_t r1[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_int32x4x4_t r_ = { { easysimd_vld1q_s32(test_vec[i].r0),
                               easysimd_vld1q_s32(test_vec[i].r1),
                               easysimd_vld1q_s32(test_vec[i].r2),
                               easysimd_vld1q_s32(test_vec[i].r3), } };

    int32_t a_[16];
    easysimd_vst4q_s32(a_, r_);
    easysimd_assert_equal_i(0, easysimd_memcmp(a_, test_vec[i].a, sizeof(test_vec[i].a)));

    r_ = easysimd_vld4q_s32(a_);
    easysimd_test_arm_neon_assert_equal_i32x4(r_.val[0], easysimd_vld1q_s32(test_vec[i].r0));
    easysimd_test_arm_neon_assert_equal_i32x4(r_.val[1], easysimd_vld1q_s32(test_vec[i].r1));
    easysimd_test_arm_neon_assert_equal_i32x4(r_.val[2], easysimd_vld1q_s32(test_vec[i].r2));
  }
  ...
  fputc('\n', stdout);
  for (int i = 0 ; i < 8 ; i++) {
    easysimd_int32x4_t a0 = easysimd_test_arm_neon_random_i32x4();
    easysimd_int32x4_t a1 = easysimd_test_arm_neon_random_i32x4();
    easysimd_int32x4_t a2 = easysimd_test_arm_neon_random_i32x4();
    easysimd_int32x4_t a3 = easysimd_test_arm_neon_random_i32x4();
    easysimd_int32x4x4_t a = { { a0, a1, a2, a3 } };
    easysimd_test_arm_neon_write_i32x4(2, a0, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_arm_neon_write_i32x4(2, a1, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_i32x4(2, a2, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_i32x4(2, a3, EASYSIMD_TEST_VEC_POS_MIDDLE);
    int32_t buf[16];
    easysimd_vst4q_s32(buf, a);
...
static int
test_easysimd_vst4q_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int64_t r0[2];
    int64_t r1[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_int64x2x4_t r_ = { { easysimd_vld1q_s64(test_vec[i].r0),
                               easysimd_vld1q_s64(test_vec[i].r1),
                               easysimd_vld1q_s64(test_vec[i].r2),
                               easysimd_vld1q_s64(test_vec[i].r3), } };

    int64_t a_[8];
    easysimd_vst4q_s64(a_, r_);
    easysimd_assert_equal_i(0, easysimd_memcmp(a_, test_vec[i].a, sizeof(test_vec[i].a)));

    r_ = easysimd_vld4q_s64(a_);
    easysimd_test_arm_neon_assert_equal_i64x2(r_.val[0], easysimd_vld1q_s64(test_vec[i].r0));
    easysimd_test_arm_neon_assert_equal_i64x2(r_.val[1], easysimd_vld1q_s64(test_vec[i].r1));
    easysimd_test_arm_neon_assert_equal_i64x2(r_.val[2], easysimd_vld1q_s64(test_vec[i].r2));
  }
  ...
  fputc('\n', stdout);
  for (int i = 0 ; i < 8 ; i++) {
    easysimd_int64x2_t a0 = easysimd_test_arm_neon_random_i64x2();
    easysimd_int64x2_t a1 = easysimd_test_arm_neon_random_i64x2();
    easysimd_int64x2_t a2 = easysimd_test_arm_neon_random_i64x2();
    easysimd_int64x2_t a3 = easysimd_test_arm_neon_random_i64x2();
    easysimd_int64x2x4_t a = { { a0, a1, a2, a3 } };
    easysimd_test_arm_neon_write_i64x2(2, a0, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_arm_neon_write_i64x2(2, a1, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_i64x2(2, a2, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_i64x2(2, a3, EASYSIMD_TEST_VEC_POS_MIDDLE);
    int64_t buf[8];
    easysimd_vst4q_s64(buf, a);
...
static int
test_easysimd_vst4q_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint8_t r0[16];
    uint8_t r1[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint8x16x4_t r_ = { { easysimd_vld1q_u8(test_vec[i].r0),
                                easysimd_vld1q_u8(test_vec[i].r1),
                                easysimd_vld1q_u8(test_vec[i].r2),
                                easysimd_vld1q_u8(test_vec[i].r3), } };

    uint8_t a_[64];
    easysimd_vst4q_u8(a_, r_);
    easysimd_assert_equal_i(0, easysimd_memcmp(a_, test_vec[i].a, sizeof(test_vec[i].a)));

    r_ = easysimd_vld4q_u8(a_);
    easysimd_test_arm_neon_assert_equal_u8x16(r_.val[0], easysimd_vld1q_u8(test_vec[i].r0));
    easysimd_test_arm_neon_assert_equal_u8x16(r_.val[1], easysimd_vld1q_u8(test_vec[i].r1));
    easysimd_test_arm_neon_assert_equal_u8x16(r_.val[2], easysimd_vld1q_u8(test_vec[i].r2));
  }
  ...
  fputc('\n', stdout);
  for (size_t i = 0 ; i < 8 ; i++) {
    easysimd_uint8x16_t a0 = easysimd_test_arm_neon_random_u8x16();
    easysimd_uint8x16_t a1 = easysimd_test_arm_neon_random_u8x16();
    easysimd_uint8x16_t a2 = easysimd_test_arm_neon_random_u8x16();
    easysimd_uint8x16_t a3 = easysimd_test_arm_neon_random_u8x16();
    easysimd_uint8x16x4_t a = { { a0, a1, a2, a3 } };
    easysimd_test_arm_neon_write_u8x16(2, a0, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_arm_neon_write_u8x16(2, a1, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_u8x16(2, a2, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_u8x16(2, a3, EASYSIMD_TEST_VEC_POS_MIDDLE);
    uint8_t buf[64];
    easysimd_vst4q_u8(buf, a);
...
static int
test_easysimd_vst4q_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint16_t r0[8];
    uint16_t r1[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint16x8x4_t r_ = { { easysimd_vld1q_u16(test_vec[i].r0),
                                easysimd_vld1q_u16(test_vec[i].r1),
                                easysimd_vld1q_u16(test_vec[i].r2),
                                easysimd_vld1q_u16(test_vec[i].r3), } };

    uint16_t a_[32];
    easysimd_vst4q_u16(a_, r_);
    easysimd_assert_equal_i(0, easysimd_memcmp(a_, test_vec[i].a, sizeof(test_vec[i].a)));

    r_ = easysimd_vld4q_u16(a_);
    easysimd_test_arm_neon_assert_equal_u16x8(r_.val[0], easysimd_vld1q_u16(test_vec[i].r0));
    easysimd_test_arm_neon_assert_equal_u16x8(r_.val[1], easysimd_vld1q_u16(test_vec[i].r1));
    easysimd_test_arm_neon_assert_equal_u16x8(r_.val[2], easysimd_vld1q_u16(test_vec[i].r2));
  }
  ...
  fputc('\n', stdout);
  for (size_t i = 0 ; i < 8 ; i++) {
    easysimd_uint16x8_t a0 = easysimd_test_arm_neon_random_u16x8();
    easysimd_uint16x8_t a1 = easysimd_test_arm_neon_random_u16x8();
    easysimd_uint16x8_t a2 = easysimd_test_arm_neon_random_u16x8();
    easysimd_uint16x8_t a3 = easysimd_test_arm_neon_random_u16x8();
    easysimd_uint16x8x4_t a = { { a0, a1, a2, a3 } };
    easysimd_test_arm_neon_write_u16x8(2, a0, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_arm_neon_write_u16x8(2, a1, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_u16x8(2, a2, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_u16x8(2, a3, EASYSIMD_TEST_VEC_POS_MIDDLE);
    uint16_t buf[32];
    easysimd_vst4q_u16(buf, a);
...
static int
test_easysimd_vst4q_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint32_t r0[4];
    uint32_t r1[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint32x4x4_t r_ = { { easysimd_vld1q_u32(test_vec[i].r0),
                                easysimd_vld1q_u32(test_vec[i].r1),
                                easysimd_vld1q_u32(test_vec[i].r2),
                                easysimd_vld1q_u32(test_vec[i].r3), } };

    uint32_t a_[16];
    easysimd_vst4q_u32(a_, r_);
    easysimd_assert_equal_i(0, easysimd_memcmp(a_, test_vec[i].a, sizeof(test_vec[i].a)));

    r_ = easysimd_vld4q_u32(a_);
    easysimd_test_arm_neon_assert_equal_u32x4(r_.val[0], easysimd_vld1q_u32(test_vec[i].r0));
    easysimd_test_arm_neon_assert_equal_u32x4(r_.val[1], easysimd_vld1q_u32(test_vec[i].r1));
    easysimd_test_arm_neon_assert_equal_u32x4(r_.val[2], easysimd_vld1q_u32(test_vec[i].r2));
  }
  ...
  fputc('\n', stdout);
  for (size_t i = 0 ; i < 8 ; i++) {
    easysimd_uint32x4_t a0 = easysimd_test_arm_neon_random_u32x4();
    easysimd_uint32x4_t a1 = easysimd_test_arm_neon_random_u32x4();
    easysimd_uint32x4_t a2 = easysimd_test_arm_neon_random_u32x4();
    easysimd_uint32x4_t a3 = easysimd_test_arm_neon_random_u32x4();
    easysimd_uint32x4x4_t a = { { a0, a1, a2, a3 } };
    easysimd_test_arm_neon_write_u32x4(2, a0, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_arm_neon_write_u32x4(2, a1, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_u32x4(2, a2, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_u32x4(2, a3, EASYSIMD_TEST_VEC_POS_MIDDLE);
    uint32_t buf[16];
    easysimd_vst4q_u32(buf, a);
...
static int
test_easysimd_vst4q_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint64_t r0[2];
    uint64_t r1[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint64x2x4_t r_ = { { easysimd_vld1q_u64(test_vec[i].r0),
                                easysimd_vld1q_u64(test_vec[i].r1),
                                easysimd_vld1q_u64(test_vec[i].r2),
                                easysimd_vld1q_u64(test_vec[i].r3), } };

    uint64_t a_[8];
    easysimd_vst4q_u64(a_, r_);
    easysimd_assert_equal_i(0, easysimd_memcmp(a_, test_vec[i].a, sizeof(test_vec[i].a)));

    r_ = easysimd_vld4q_u64(a_);
    easysimd_test_arm_neon_assert_equal_u64x2(r_.val[0], easysimd_vld1q_u64(test_vec[i].r0));
    easysimd_test_arm_neon_assert_equal_u64x2(r_.val[1], easysimd_vld1q_u64(test_vec[i].r1));
    easysimd_test_arm_neon_assert_equal_u64x2(r_.val[2], easysimd_vld1q_u64(test_vec[i].r2));
  }
  ...
  fputc('\n', stdout);
  for (size_t i = 0 ; i < 8 ; i++) {
    easysimd_uint64x2_t a0 = easysimd_test_arm_neon_random_u64x2();
    easysimd_uint64x2_t a1 = easysimd_test_arm_neon_random_u64x2();
    easysimd_uint64x2_t a2 = easysimd_test_arm_neon_random_u64x2();
    easysimd_uint64x2_t a3 = easysimd_test_arm_neon_random_u64x2();
    easysimd_uint64x2x4_t a = { { a0, a1, a2, a3 } };
    easysimd_test_arm_neon_write_u64x2(2, a0, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_arm_neon_write_u64x2(2, a1, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_u64x2(2, a2, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_u64x2(2, a3, EASYSIMD_TEST_VEC_POS_MIDDLE);
    uint64_t buf[8];
    easysimd_vst4q_u64(buf, a);
...
#if !defined(EASYSIMD_BUG_INTEL_857088)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vst4_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vst4_f64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vst4_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vst4_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vst4_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vst4_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vst4_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vst4_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vst4_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vst4_u64)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vst4q_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vst4q_f64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vst4q_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vst4q_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vst4q_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vst4q_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vst4q_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vst4q_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vst4q_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vst4q_u64)
#endif /* !defined(EASYSIMD_BUG_INTEL_857088) */
