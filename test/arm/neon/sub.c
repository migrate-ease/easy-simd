#define EASYSIMD_TEST_ARM_NEON_INSN sub

#include "test-neon.h"
#include "../../../easysimd/arm/neon/sub.h"

static int
test_easysimd_vsub_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    easysimd_float32 a[2];
    easysimd_float32 b[2];
    easysimd_float32 r[2];
  } test_vec[] = {
    { { EASYSIMD_FLOAT32_C(   360.99), EASYSIMD_FLOAT32_C(   722.92) },
      { EASYSIMD_FLOAT32_C(   682.14), EASYSIMD_FLOAT32_C(   426.96) },
      { EASYSIMD_FLOAT32_C(  -321.15), EASYSIMD_FLOAT32_C(   295.96) } },
    { { EASYSIMD_FLOAT32_C(   -11.59), EASYSIMD_FLOAT32_C(   342.55) },
      { EASYSIMD_FLOAT32_C(   590.06), EASYSIMD_FLOAT32_C(   965.15) },
      { EASYSIMD_FLOAT32_C(  -601.65), EASYSIMD_FLOAT32_C(  -622.60) } },
    { { EASYSIMD_FLOAT32_C(   547.91), EASYSIMD_FLOAT32_C(  -219.14) },
      { EASYSIMD_FLOAT32_C(  -886.88), EASYSIMD_FLOAT32_C(   282.47) },
      { EASYSIMD_FLOAT32_C(  1434.79), EASYSIMD_FLOAT32_C(  -501.61) } },
    { { EASYSIMD_FLOAT32_C(    13.06), EASYSIMD_FLOAT32_C(   946.64) },
      { EASYSIMD_FLOAT32_C(   963.27), EASYSIMD_FLOAT32_C(   959.34) },
      { EASYSIMD_FLOAT32_C(  -950.22), EASYSIMD_FLOAT32_C(   -12.70) } },
    { { EASYSIMD_FLOAT32_C(   829.13), EASYSIMD_FLOAT32_C(  -382.80) },
      { EASYSIMD_FLOAT32_C(  -854.14), EASYSIMD_FLOAT32_C(   146.76) },
      { EASYSIMD_FLOAT32_C(  1683.27), EASYSIMD_FLOAT32_C(  -529.55) } },
    { { EASYSIMD_FLOAT32_C(    73.22), EASYSIMD_FLOAT32_C(  -493.34) },
      { EASYSIMD_FLOAT32_C(   912.86), EASYSIMD_FLOAT32_C(   976.77) },
      { EASYSIMD_FLOAT32_C(  -839.64), EASYSIMD_FLOAT32_C( -1470.11) } },
    { { EASYSIMD_FLOAT32_C(   314.03), EASYSIMD_FLOAT32_C(  -507.33) },
      { EASYSIMD_FLOAT32_C(   923.09), EASYSIMD_FLOAT32_C(  -827.02) },
      { EASYSIMD_FLOAT32_C(  -609.06), EASYSIMD_FLOAT32_C(   319.69) } },
    { { EASYSIMD_FLOAT32_C(  -988.72), EASYSIMD_FLOAT32_C(  -917.98) },
      { EASYSIMD_FLOAT32_C(  -195.14), EASYSIMD_FLOAT32_C(   372.28) },
      { EASYSIMD_FLOAT32_C(  -793.58), EASYSIMD_FLOAT32_C( -1290.26) } }
  };  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float32x2_t a, b, r;

    a = easysimd_vld1_f32(test_vec[i].a);
    b = easysimd_vld1_f32(test_vec[i].b);
    r = easysimd_vsub_f32(a, b);
...
static int
test_easysimd_vsub_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    easysimd_float64 a[1];
    easysimd_float64 b[1];
    easysimd_float64 r[1];
  } test_vec[] = {
    { { EASYSIMD_FLOAT64_C(  -464.36) },
      { EASYSIMD_FLOAT64_C(   759.96) },
      { EASYSIMD_FLOAT64_C( -1224.33) } },
    { { EASYSIMD_FLOAT64_C(   959.10) },
      { EASYSIMD_FLOAT64_C(   297.97) },
      { EASYSIMD_FLOAT64_C(   661.13) } },
    { { EASYSIMD_FLOAT64_C(   736.45) },
      { EASYSIMD_FLOAT64_C(  -164.58) },
      { EASYSIMD_FLOAT64_C(   901.03) } },
    { { EASYSIMD_FLOAT64_C(   849.22) },
      { EASYSIMD_FLOAT64_C(   985.27) },
      { EASYSIMD_FLOAT64_C(  -136.05) } },
    { { EASYSIMD_FLOAT64_C(   917.24) },
      { EASYSIMD_FLOAT64_C(   640.75) },
      { EASYSIMD_FLOAT64_C(   276.49) } },
    { { EASYSIMD_FLOAT64_C(   422.18) },
      { EASYSIMD_FLOAT64_C(   767.10) },
      { EASYSIMD_FLOAT64_C(  -344.92) } },
    { { EASYSIMD_FLOAT64_C(  -365.38) },
      { EASYSIMD_FLOAT64_C(   691.56) },
      { EASYSIMD_FLOAT64_C( -1056.93) } },
    { { EASYSIMD_FLOAT64_C(   655.10) },
      { EASYSIMD_FLOAT64_C(   559.29) },
      { EASYSIMD_FLOAT64_C(    95.82) } }
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float64x1_t a = easysimd_vld1_f64(test_vec[i].a);
    easysimd_float64x1_t b = easysimd_vld1_f64(test_vec[i].b);
    easysimd_float64x1_t r = easysimd_vsub_f64(a, b);
...
static int
test_easysimd_vsub_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int8_t a[8];
    int8_t b[8];
    int8_t r[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int8x8_t r = easysimd_vsub_s8(a, b);
...
static int
test_easysimd_vsub_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int16_t a[4];
    int16_t b[4];
    int16_t r[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int16x4_t r = easysimd_vsub_s16(a, b);
...
static int
test_easysimd_vsub_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int32_t a[2];
    int32_t b[2];
    int32_t r[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x2_t r = easysimd_vsub_s32(a, b);
...
static int
test_easysimd_vsub_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int64_t a[1];
    int64_t b[1];
    int64_t r[1];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int64x1_t r = easysimd_vsub_s64(a, b);
...
static int
test_easysimd_vsub_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint8_t a[16];
    uint8_t b[16];
    uint8_t r[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x8_t r = easysimd_vsub_u8(a, b);
...
static int
test_easysimd_vsub_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint16_t a[4];
    uint16_t b[4];
    uint16_t r[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x4_t r = easysimd_vsub_u16(a, b);
...
static int
test_easysimd_vsub_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint32_t a[2];
    uint32_t b[2];
    uint32_t r[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x2_t r = easysimd_vsub_u32(a, b);
...
static int
test_easysimd_vsub_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint64_t a[1];
    uint64_t b[1];
    uint64_t r[1];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint64x1_t r = easysimd_vsub_u64(a, b);
...
static int
test_easysimd_vsubq_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    easysimd_float32 a[4];
    easysimd_float32 b[4];
    easysimd_float32 r[4];
  } test_vec[] = {
    { { EASYSIMD_FLOAT32_C(   313.36), EASYSIMD_FLOAT32_C(   130.95), EASYSIMD_FLOAT32_C(   558.01), EASYSIMD_FLOAT32_C(  -224.30) },
      { EASYSIMD_FLOAT32_C(  -431.17), EASYSIMD_FLOAT32_C(  -838.29), EASYSIMD_FLOAT32_C(   973.18), EASYSIMD_FLOAT32_C(  -249.71) },
      { EASYSIMD_FLOAT32_C(   744.52), EASYSIMD_FLOAT32_C(   969.24), EASYSIMD_FLOAT32_C(  -415.17), EASYSIMD_FLOAT32_C(    25.41) } },
    { { EASYSIMD_FLOAT32_C(  -619.93), EASYSIMD_FLOAT32_C(  -195.67), EASYSIMD_FLOAT32_C(   784.76), EASYSIMD_FLOAT32_C(   593.47) },
      { EASYSIMD_FLOAT32_C(  -109.46), EASYSIMD_FLOAT32_C(   -51.93), EASYSIMD_FLOAT32_C(  -685.95), EASYSIMD_FLOAT32_C(    54.63) },
      { EASYSIMD_FLOAT32_C(  -510.46), EASYSIMD_FLOAT32_C(  -143.74), EASYSIMD_FLOAT32_C(  1470.70), EASYSIMD_FLOAT32_C(   538.84) } },
    { { EASYSIMD_FLOAT32_C(   238.71), EASYSIMD_FLOAT32_C(  -726.25), EASYSIMD_FLOAT32_C(  -693.46), EASYSIMD_FLOAT32_C(   265.88) },
      { EASYSIMD_FLOAT32_C(   740.54), EASYSIMD_FLOAT32_C(   826.68), EASYSIMD_FLOAT32_C(  -296.56), EASYSIMD_FLOAT32_C(   -34.22) },
      { EASYSIMD_FLOAT32_C(  -501.83), EASYSIMD_FLOAT32_C( -1552.93), EASYSIMD_FLOAT32_C(  -396.90), EASYSIMD_FLOAT32_C(   300.10) } },
    { { EASYSIMD_FLOAT32_C(   788.21), EASYSIMD_FLOAT32_C(   906.36), EASYSIMD_FLOAT32_C(  -290.22), EASYSIMD_FLOAT32_C(    38.77) },
      { EASYSIMD_FLOAT32_C(   692.11), EASYSIMD_FLOAT32_C(   669.99), EASYSIMD_FLOAT32_C(    83.43), EASYSIMD_FLOAT32_C(     5.46) },
      { EASYSIMD_FLOAT32_C(    96.10), EASYSIMD_FLOAT32_C(   236.38), EASYSIMD_FLOAT32_C(  -373.65), EASYSIMD_FLOAT32_C(    33.31) } },
    { { EASYSIMD_FLOAT32_C(  -199.06), EASYSIMD_FLOAT32_C(  -358.56), EASYSIMD_FLOAT32_C(   781.16), EASYSIMD_FLOAT32_C(   369.77) },
      { EASYSIMD_FLOAT32_C(  -196.85), EASYSIMD_FLOAT32_C(   754.34), EASYSIMD_FLOAT32_C(  -879.94), EASYSIMD_FLOAT32_C(   183.22) },
      { EASYSIMD_FLOAT32_C(    -2.21), EASYSIMD_FLOAT32_C( -1112.90), EASYSIMD_FLOAT32_C(  1661.10), EASYSIMD_FLOAT32_C(   186.55) } },
    { { EASYSIMD_FLOAT32_C(  -441.33), EASYSIMD_FLOAT32_C(   904.82), EASYSIMD_FLOAT32_C(  -223.31), EASYSIMD_FLOAT32_C(   449.20) },
      { EASYSIMD_FLOAT32_C(  -147.11), EASYSIMD_FLOAT32_C(    90.74), EASYSIMD_FLOAT32_C(  -496.16), EASYSIMD_FLOAT32_C(  -908.40) },
      { EASYSIMD_FLOAT32_C(  -294.22), EASYSIMD_FLOAT32_C(   814.08), EASYSIMD_FLOAT32_C(   272.85), EASYSIMD_FLOAT32_C(  1357.61) } },
    { { EASYSIMD_FLOAT32_C(   364.49), EASYSIMD_FLOAT32_C(  -189.62), EASYSIMD_FLOAT32_C(   357.48), EASYSIMD_FLOAT32_C(   105.03) },
      { EASYSIMD_FLOAT32_C(  -362.94), EASYSIMD_FLOAT32_C(  -939.08), EASYSIMD_FLOAT32_C(  -929.19), EASYSIMD_FLOAT32_C(  -574.73) },
      { EASYSIMD_FLOAT32_C(   727.43), EASYSIMD_FLOAT32_C(   749.46), EASYSIMD_FLOAT32_C(  1286.67), EASYSIMD_FLOAT32_C(   679.76) } },
    { { EASYSIMD_FLOAT32_C(   967.28), EASYSIMD_FLOAT32_C(  -219.41), EASYSIMD_FLOAT32_C(   464.05), EASYSIMD_FLOAT32_C(   659.39) },
      { EASYSIMD_FLOAT32_C(  -549.43), EASYSIMD_FLOAT32_C(  -452.53), EASYSIMD_FLOAT32_C(  -335.15), EASYSIMD_FLOAT32_C(   251.51) },
      { EASYSIMD_FLOAT32_C(  1516.71), EASYSIMD_FLOAT32_C(   233.11), EASYSIMD_FLOAT32_C(   799.20), EASYSIMD_FLOAT32_C(   407.88) } }
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float32x4_t a = easysimd_vld1q_f32(test_vec[i].a);
    easysimd_float32x4_t b = easysimd_vld1q_f32(test_vec[i].b);
    easysimd_float32x4_t r = easysimd_vsubq_f32(a, b);
...
static int
test_easysimd_vsubq_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    easysimd_float64 a[2];
    easysimd_float64 b[2];
    easysimd_float64 r[2];
  } test_vec[] = {
    { { EASYSIMD_FLOAT64_C(   188.91), EASYSIMD_FLOAT64_C(  -553.99) },
      { EASYSIMD_FLOAT64_C(  -378.72), EASYSIMD_FLOAT64_C(   992.06) },
      { EASYSIMD_FLOAT64_C(   567.63), EASYSIMD_FLOAT64_C( -1546.05) } },
    { { EASYSIMD_FLOAT64_C(  -799.65), EASYSIMD_FLOAT64_C(  -258.66) },
      { EASYSIMD_FLOAT64_C(   175.28), EASYSIMD_FLOAT64_C(  -240.98) },
      { EASYSIMD_FLOAT64_C(  -974.93), EASYSIMD_FLOAT64_C(   -17.68) } },
    { { EASYSIMD_FLOAT64_C(  -353.84), EASYSIMD_FLOAT64_C(   951.96) },
      { EASYSIMD_FLOAT64_C(  -791.78), EASYSIMD_FLOAT64_C(   499.05) },
      { EASYSIMD_FLOAT64_C(   437.94), EASYSIMD_FLOAT64_C(   452.91) } },
    { { EASYSIMD_FLOAT64_C(    42.70), EASYSIMD_FLOAT64_C(  -287.94) },
      { EASYSIMD_FLOAT64_C(   590.65), EASYSIMD_FLOAT64_C(  -592.80) },
      { EASYSIMD_FLOAT64_C(  -547.94), EASYSIMD_FLOAT64_C(   304.86) } },
    { { EASYSIMD_FLOAT64_C(   522.44), EASYSIMD_FLOAT64_C(   -51.88) },
      { EASYSIMD_FLOAT64_C(   512.22), EASYSIMD_FLOAT64_C(  -840.50) },
      { EASYSIMD_FLOAT64_C(    10.21), EASYSIMD_FLOAT64_C(   788.62) } },
    { { EASYSIMD_FLOAT64_C(     9.04), EASYSIMD_FLOAT64_C(   583.04) },
      { EASYSIMD_FLOAT64_C(  -415.23), EASYSIMD_FLOAT64_C(   -23.68) },
      { EASYSIMD_FLOAT64_C(   424.27), EASYSIMD_FLOAT64_C(   606.72) } },
    { { EASYSIMD_FLOAT64_C(  -636.38), EASYSIMD_FLOAT64_C(  -951.18) },
      { EASYSIMD_FLOAT64_C(  -364.30), EASYSIMD_FLOAT64_C(  -185.81) },
      { EASYSIMD_FLOAT64_C(  -272.08), EASYSIMD_FLOAT64_C(  -765.37) } },
    { { EASYSIMD_FLOAT64_C(  -403.71), EASYSIMD_FLOAT64_C(   300.55) },
      { EASYSIMD_FLOAT64_C(  -934.30), EASYSIMD_FLOAT64_C(   785.21) },
      { EASYSIMD_FLOAT64_C(   530.59), EASYSIMD_FLOAT64_C(  -484.65) } }
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float64x2_t a = easysimd_vld1q_f64(test_vec[i].a);
    easysimd_float64x2_t b = easysimd_vld1q_f64(test_vec[i].b);
    easysimd_float64x2_t r = easysimd_vsubq_f64(a, b);
...
static int
test_easysimd_vsubq_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int8_t a[16];
    int8_t b[16];
    int8_t r[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int8x16_t r = easysimd_vsubq_s8(a, b);
...
static int
test_easysimd_vsubq_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int16_t a[8];
    int16_t b[8];
    int16_t r[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int16x8_t r = easysimd_vsubq_s16(a, b);
...
static int
test_easysimd_vsubq_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int32_t a[4];
    int32_t b[4];
    int32_t r[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x4_t r = easysimd_vsubq_s32(a, b);
...
static int
test_easysimd_vsubq_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int64_t a[2];
    int64_t b[2];
    int64_t r[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int64x2_t r = easysimd_vsubq_s64(a, b);
...
static int
test_easysimd_vsubq_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint8_t a[16];
    uint8_t b[16];
    uint8_t r[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x16_t r = easysimd_vsubq_u8(a, b);
...
static int
test_easysimd_vsubq_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint16_t a[8];
    uint16_t b[8];
    uint16_t r[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x8_t r = easysimd_vsubq_u16(a, b);
...
static int
test_easysimd_vsubq_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint32_t a[4];
    uint32_t b[4];
    uint32_t r[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x4_t r = easysimd_vsubq_u32(a, b);
...
static int
test_easysimd_vsubq_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint64_t a[2];
    uint64_t b[2];
    uint64_t r[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint64x2_t r = easysimd_vsubq_u64(a, b);
...
EASYSIMD_TEST_FUNC_LIST_ENTRY(vsub_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vsub_f64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vsub_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vsub_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vsub_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vsub_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vsub_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vsub_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vsub_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vsub_u64)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vsubq_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vsubq_f64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vsubq_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vsubq_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vsubq_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vsubq_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vsubq_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vsubq_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vsubq_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vsubq_u64)
