#define EASYSIMD_TEST_ARM_NEON_INSN tbl

#include "test-neon.h"

/* Check that both of these work */
#if defined(__cplusplus)
  #include "../../../easysimd/arm/neon/tbl.h"
#else
...
static int
test_easysimd_vtbl1_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  struct {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int8x8_t r = easysimd_vtbl1_s8(a, b);
...
static int
test_easysimd_vtbl1_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  struct {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x8_t r = easysimd_vtbl1_u8(a, b);
...
static int
test_easysimd_vtbl2_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  struct {
    EASYSIMD_ALIGN_TO_16 int8_t a[2][8];
    EASYSIMD_ALIGN_TO_16 int8_t b[8];
    EASYSIMD_ALIGN_TO_16 int8_t r[8];
  } test_vec[] = {
    {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_int8x8x2_t a;
    a.val[0]  = easysimd_vld1_s8(test_vec[i].a[0]);
    a.val[1]  = easysimd_vld1_s8(test_vec[i].a[1]);
    easysimd_int8x8_t b = easysimd_vld1_s8(test_vec[i].b);
    easysimd_int8x8_t r = easysimd_vtbl2_s8(a, b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    easysimd_int8x8x2_t a = easysimd_test_arm_neon_random_i8x8x2();
    easysimd_int8x8_private b_ = easysimd_int8x8_to_private(easysimd_test_arm_neon_random_i8x8());
    ...
    easysimd_int8x8_t r = easysimd_vtbl2_s8(a, b);
    easysimd_test_arm_neon_write_i8x8x2(2, a, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_arm_neon_write_i8x8(2, b, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_i8x8(2, r, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
...
static int
test_easysimd_vtbl2_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  struct {
    EASYSIMD_ALIGN_TO_16 uint8_t a[2][8];
    EASYSIMD_ALIGN_TO_16 uint8_t b[8];
    EASYSIMD_ALIGN_TO_16 uint8_t r[8];
  } test_vec[] = {
    {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint8x8x2_t a;
    a.val[0]  = easysimd_vld1_u8(test_vec[i].a[0]);
    a.val[1]  = easysimd_vld1_u8(test_vec[i].a[1]);
    easysimd_uint8x8_t b = easysimd_vld1_u8(test_vec[i].b);
    easysimd_uint8x8_t r = easysimd_vtbl2_u8(a, b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    easysimd_uint8x8x2_t a = easysimd_test_arm_neon_random_u8x8x2();
    easysimd_uint8x8_private b_ = easysimd_uint8x8_to_private(easysimd_test_arm_neon_random_u8x8());
    ...
    easysimd_test_arm_neon_write_u8x8x2(2, a, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_arm_neon_write_u8x8(2, b, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_u8x8(2, r, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
...
static int
test_easysimd_vtbl3_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  struct {
    EASYSIMD_ALIGN_TO_16 int8_t a[3][8];
    EASYSIMD_ALIGN_TO_16 int8_t b[8];
    EASYSIMD_ALIGN_TO_16 int8_t r[8];
  } test_vec[] = {
    {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_int8x8x3_t a;
    a.val[0]  = easysimd_vld1_s8(test_vec[i].a[0]);
    a.val[1]  = easysimd_vld1_s8(test_vec[i].a[1]);
    a.val[2]  = easysimd_vld1_s8(test_vec[i].a[2]);
    easysimd_int8x8_t b = easysimd_vld1_s8(test_vec[i].b);
    easysimd_int8x8_t r = easysimd_vtbl3_s8(a, b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    easysimd_int8x8x3_t a = easysimd_test_arm_neon_random_i8x8x3();
    easysimd_int8x8_private b_ = easysimd_int8x8_to_private(easysimd_test_arm_neon_random_i8x8());
    ...
    easysimd_int8x8_t r = easysimd_vtbl3_s8(a, b);
    easysimd_test_arm_neon_write_i8x8x3(2, a, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_arm_neon_write_i8x8(2, b, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_i8x8(2, r, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
...
static int
test_easysimd_vtbl3_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  struct {
    EASYSIMD_ALIGN_TO_16 uint8_t a[3][8];
    EASYSIMD_ALIGN_TO_16 uint8_t b[8];
    EASYSIMD_ALIGN_TO_16 uint8_t r[8];
  } test_vec[] = {
    {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint8x8x3_t a;
    a.val[0]  = easysimd_vld1_u8(test_vec[i].a[0]);
    a.val[1]  = easysimd_vld1_u8(test_vec[i].a[1]);
    a.val[2]  = easysimd_vld1_u8(test_vec[i].a[2]);
    easysimd_uint8x8_t b = easysimd_vld1_u8(test_vec[i].b);
    easysimd_uint8x8_t r = easysimd_vtbl3_u8(a, b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    easysimd_uint8x8x3_t a = easysimd_test_arm_neon_random_u8x8x3();
    easysimd_uint8x8_private b_ = easysimd_uint8x8_to_private(easysimd_test_arm_neon_random_u8x8());
    ...
    easysimd_test_arm_neon_write_u8x8x3(2, a, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_arm_neon_write_u8x8(2, b, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_u8x8(2, r, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
...
static int
test_easysimd_vtbl4_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  struct {
    EASYSIMD_ALIGN_TO_16 int8_t a[4][8];
    EASYSIMD_ALIGN_TO_16 int8_t b[8];
    EASYSIMD_ALIGN_TO_16 int8_t r[8];
  } test_vec[] = {
    {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_int8x8x4_t a;
    a.val[0]  = easysimd_vld1_s8(test_vec[i].a[0]);
    a.val[1]  = easysimd_vld1_s8(test_vec[i].a[1]);
    a.val[2]  = easysimd_vld1_s8(test_vec[i].a[2]);
    a.val[3]  = easysimd_vld1_s8(test_vec[i].a[3]);
    easysimd_int8x8_t b = easysimd_vld1_s8(test_vec[i].b);
    easysimd_int8x8_t r = easysimd_vtbl4_s8(a, b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    easysimd_int8x8x4_t a = easysimd_test_arm_neon_random_i8x8x4();
    easysimd_int8x8_private b_ = easysimd_int8x8_to_private(easysimd_test_arm_neon_random_i8x8());
    ...
    easysimd_int8x8_t r = easysimd_vtbl4_s8(a, b);
    easysimd_test_arm_neon_write_i8x8x4(2, a, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_arm_neon_write_i8x8(2, b, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_i8x8(2, r, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
...
static int
test_easysimd_vtbl4_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  struct {
    EASYSIMD_ALIGN_TO_16 uint8_t a[4][8];
    EASYSIMD_ALIGN_TO_16 uint8_t b[8];
    EASYSIMD_ALIGN_TO_16 uint8_t r[8];
  } test_vec[] = {
    {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_uint8x8x4_t a;
    a.val[0]  = easysimd_vld1_u8(test_vec[i].a[0]);
    a.val[1]  = easysimd_vld1_u8(test_vec[i].a[1]);
    a.val[2]  = easysimd_vld1_u8(test_vec[i].a[2]);
    a.val[3]  = easysimd_vld1_u8(test_vec[i].a[3]);
    easysimd_uint8x8_t b = easysimd_vld1_u8(test_vec[i].b);
    easysimd_uint8x8_t r = easysimd_vtbl4_u8(a, b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    easysimd_uint8x8x4_t a = easysimd_test_arm_neon_random_u8x8x4();
    easysimd_uint8x8_private b_ = easysimd_uint8x8_to_private(easysimd_test_arm_neon_random_u8x8());
    ...
    easysimd_test_arm_neon_write_u8x8x4(2, a, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_arm_neon_write_u8x8(2, b, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_arm_neon_write_u8x8(2, r, EASYSIMD_TEST_VEC_POS_LAST);
  }
  return 1;
...
EASYSIMD_TEST_FUNC_LIST_ENTRY(vtbl1_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vtbl1_u8)
#if !defined(EASYSIMD_BUG_INTEL_857088)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(vtbl2_s8)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(vtbl2_u8)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(vtbl3_s8)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(vtbl3_u8)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(vtbl4_s8)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(vtbl4_u8)
#endif /* !defined(EASYSIMD_BUG_INTEL_857088) */
