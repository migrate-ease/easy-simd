#define EASYSIMD_TEST_ARM_NEON_INSN trn

#include <test/arm/neon/test-neon.h>
#include <easysimd/arm/neon/trn.h>

#if !defined(EASYSIMD_BUG_INTEL_857088)

static int
test_easysimd_vtrn_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    easysimd_float32 a[2];
    easysimd_float32 b[2];
    easysimd_float32 r[2][2];
  } test_vec[] = {
    { { EASYSIMD_FLOAT32_C(   394.91), EASYSIMD_FLOAT32_C(   715.66) },
      { EASYSIMD_FLOAT32_C(  -854.42), EASYSIMD_FLOAT32_C(   359.77) },
      {
          { EASYSIMD_FLOAT32_C(   394.91), EASYSIMD_FLOAT32_C(  -854.42) },
          { EASYSIMD_FLOAT32_C(   715.66), EASYSIMD_FLOAT32_C(   359.77) },
      },
    },
    { { EASYSIMD_FLOAT32_C(  -579.97), EASYSIMD_FLOAT32_C(  -698.40) },
      { EASYSIMD_FLOAT32_C(   147.69), EASYSIMD_FLOAT32_C(   533.92) },
      {
          { EASYSIMD_FLOAT32_C(  -579.97), EASYSIMD_FLOAT32_C(   147.69) },
          { EASYSIMD_FLOAT32_C(  -698.40), EASYSIMD_FLOAT32_C(   533.92) },
      },
    },
    { { EASYSIMD_FLOAT32_C(  -647.47), EASYSIMD_FLOAT32_C(   944.41) },
      { EASYSIMD_FLOAT32_C(  -570.83), EASYSIMD_FLOAT32_C(  -698.09) },
      {
          { EASYSIMD_FLOAT32_C(  -647.47), EASYSIMD_FLOAT32_C(  -570.83) },
          { EASYSIMD_FLOAT32_C(   944.41), EASYSIMD_FLOAT32_C(  -698.09) },
      },
    },
    { { EASYSIMD_FLOAT32_C(  -636.98), EASYSIMD_FLOAT32_C(   269.75) },
      { EASYSIMD_FLOAT32_C(   457.30), EASYSIMD_FLOAT32_C(  -517.32) },
      {
          { EASYSIMD_FLOAT32_C(  -636.98), EASYSIMD_FLOAT32_C(   457.30) },
          { EASYSIMD_FLOAT32_C(   269.75), EASYSIMD_FLOAT32_C(  -517.32) },
      },
    },
    { { EASYSIMD_FLOAT32_C(   625.59), EASYSIMD_FLOAT32_C(   316.45) },
      { EASYSIMD_FLOAT32_C(  -969.65), EASYSIMD_FLOAT32_C(   377.99) },
      {
          { EASYSIMD_FLOAT32_C(   625.59), EASYSIMD_FLOAT32_C(  -969.65) },
          { EASYSIMD_FLOAT32_C(   316.45), EASYSIMD_FLOAT32_C(   377.99) },
      },
    },
    { { EASYSIMD_FLOAT32_C(   858.52), EASYSIMD_FLOAT32_C(  -465.14) },
      { EASYSIMD_FLOAT32_C(   468.83), EASYSIMD_FLOAT32_C(   -15.96) },
      {
          { EASYSIMD_FLOAT32_C(   858.52), EASYSIMD_FLOAT32_C(   468.83) },
          { EASYSIMD_FLOAT32_C(  -465.14), EASYSIMD_FLOAT32_C(   -15.96) },
      },
    },
    { { EASYSIMD_FLOAT32_C(   -52.83), EASYSIMD_FLOAT32_C(   881.31) },
      { EASYSIMD_FLOAT32_C(  -110.73), EASYSIMD_FLOAT32_C(   761.20) },
      {
          { EASYSIMD_FLOAT32_C(   -52.83), EASYSIMD_FLOAT32_C(  -110.73) },
          { EASYSIMD_FLOAT32_C(   881.31), EASYSIMD_FLOAT32_C(   761.20) },
      },
    },
    { { EASYSIMD_FLOAT32_C(  -940.87), EASYSIMD_FLOAT32_C(   486.49) },
      { EASYSIMD_FLOAT32_C(   618.70), EASYSIMD_FLOAT32_C(   454.05) },
      {
          { EASYSIMD_FLOAT32_C(  -940.87), EASYSIMD_FLOAT32_C(   618.70) },
          { EASYSIMD_FLOAT32_C(   486.49), EASYSIMD_FLOAT32_C(   454.05) },
      },
    },
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_float32x2x2_t r = easysimd_vtrn_f32(a, b);
...
static int
test_easysimd_vtrn_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int8_t a[8];
    int8_t b[8];
    int8_t r[2][8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int8x8x2_t r = easysimd_vtrn_s8(a, b);
...
static int
test_easysimd_vtrn_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int16_t a[4];
    int16_t b[4];
    int16_t r[2][4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int16x4x2_t r = easysimd_vtrn_s16(a, b);
...
static int
test_easysimd_vtrn_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int32_t a[2];
    int32_t b[2];
    int32_t r[2][2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x2x2_t r = easysimd_vtrn_s32(a, b);
...
static int
test_easysimd_vtrn_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint8_t a[8];
    uint8_t b[8];
    uint8_t r[2][8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x8x2_t r = easysimd_vtrn_u8(a, b);
...
static int
test_easysimd_vtrn_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint16_t a[4];
    uint16_t b[4];
    uint16_t r[2][4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x4x2_t r = easysimd_vtrn_u16(a, b);
...
static int
test_easysimd_vtrn_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint32_t a[2];
    uint32_t b[2];
    uint32_t r[2][2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x2x2_t r = easysimd_vtrn_u32(a, b);
...
static int
test_easysimd_vtrnq_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    easysimd_float32 a[4];
    easysimd_float32 b[4];
    easysimd_float32 r[2][4];
  } test_vec[] = {
    { { EASYSIMD_FLOAT32_C(   -21.16), EASYSIMD_FLOAT32_C(  -415.28), EASYSIMD_FLOAT32_C(   122.64), EASYSIMD_FLOAT32_C(  -871.38) },
      { EASYSIMD_FLOAT32_C(   823.55), EASYSIMD_FLOAT32_C(   479.12), EASYSIMD_FLOAT32_C(  -299.37), EASYSIMD_FLOAT32_C(  -925.94) },
      {
          { EASYSIMD_FLOAT32_C(   -21.16), EASYSIMD_FLOAT32_C(   823.55), EASYSIMD_FLOAT32_C(   122.64), EASYSIMD_FLOAT32_C(  -299.37) },
          { EASYSIMD_FLOAT32_C(  -415.28), EASYSIMD_FLOAT32_C(   479.12), EASYSIMD_FLOAT32_C(  -871.38), EASYSIMD_FLOAT32_C(  -925.94) },
      },
    },
    { { EASYSIMD_FLOAT32_C(  -127.06), EASYSIMD_FLOAT32_C(  -474.56), EASYSIMD_FLOAT32_C(  -700.09), EASYSIMD_FLOAT32_C(   980.65) },
      { EASYSIMD_FLOAT32_C(  -759.85), EASYSIMD_FLOAT32_C(   613.71), EASYSIMD_FLOAT32_C(   336.49), EASYSIMD_FLOAT32_C(   564.00) },
      {
          { EASYSIMD_FLOAT32_C(  -127.06), EASYSIMD_FLOAT32_C(  -759.85), EASYSIMD_FLOAT32_C(  -700.09), EASYSIMD_FLOAT32_C(   336.49) },
          { EASYSIMD_FLOAT32_C(  -474.56), EASYSIMD_FLOAT32_C(   613.71), EASYSIMD_FLOAT32_C(   980.65), EASYSIMD_FLOAT32_C(   564.00) },
      },
    },
    { { EASYSIMD_FLOAT32_C(  -466.35), EASYSIMD_FLOAT32_C(   378.63), EASYSIMD_FLOAT32_C(  -371.33), EASYSIMD_FLOAT32_C(   706.88) },
      { EASYSIMD_FLOAT32_C(   -64.44), EASYSIMD_FLOAT32_C(   420.87), EASYSIMD_FLOAT32_C(  -117.58), EASYSIMD_FLOAT32_C(   403.73) },
      {
          { EASYSIMD_FLOAT32_C(  -466.35), EASYSIMD_FLOAT32_C(   -64.44), EASYSIMD_FLOAT32_C(  -371.33), EASYSIMD_FLOAT32_C(  -117.58) },
          { EASYSIMD_FLOAT32_C(   378.63), EASYSIMD_FLOAT32_C(   420.87), EASYSIMD_FLOAT32_C(   706.88), EASYSIMD_FLOAT32_C(   403.73) },
      },
    },
    { { EASYSIMD_FLOAT32_C(   250.86), EASYSIMD_FLOAT32_C(   812.70), EASYSIMD_FLOAT32_C(   383.33), EASYSIMD_FLOAT32_C(    70.53) },
      { EASYSIMD_FLOAT32_C(  -526.93), EASYSIMD_FLOAT32_C(  -755.27), EASYSIMD_FLOAT32_C(  -138.40), EASYSIMD_FLOAT32_C(   451.91) },
      {
          { EASYSIMD_FLOAT32_C(   250.86), EASYSIMD_FLOAT32_C(  -526.93), EASYSIMD_FLOAT32_C(   383.33), EASYSIMD_FLOAT32_C(  -138.40) },
          { EASYSIMD_FLOAT32_C(   812.70), EASYSIMD_FLOAT32_C(  -755.27), EASYSIMD_FLOAT32_C(    70.53), EASYSIMD_FLOAT32_C(   451.91) },
      },
    },
    { { EASYSIMD_FLOAT32_C(  -170.55), EASYSIMD_FLOAT32_C(   984.25), EASYSIMD_FLOAT32_C(   580.53), EASYSIMD_FLOAT32_C(  -347.00) },
      { EASYSIMD_FLOAT32_C(   463.36), EASYSIMD_FLOAT32_C(  -718.84), EASYSIMD_FLOAT32_C(  -272.94), EASYSIMD_FLOAT32_C(  -663.70) },
      {
          { EASYSIMD_FLOAT32_C(  -170.55), EASYSIMD_FLOAT32_C(   463.36), EASYSIMD_FLOAT32_C(   580.53), EASYSIMD_FLOAT32_C(  -272.94) },
          { EASYSIMD_FLOAT32_C(   984.25), EASYSIMD_FLOAT32_C(  -718.84), EASYSIMD_FLOAT32_C(  -347.00), EASYSIMD_FLOAT32_C(  -663.70) },
      },
    },
    { { EASYSIMD_FLOAT32_C(  -193.40), EASYSIMD_FLOAT32_C(    26.97), EASYSIMD_FLOAT32_C(  -683.05), EASYSIMD_FLOAT32_C(    46.75) },
      { EASYSIMD_FLOAT32_C(  -359.31), EASYSIMD_FLOAT32_C(   653.44), EASYSIMD_FLOAT32_C(  -389.25), EASYSIMD_FLOAT32_C(   174.33) },
      {
          { EASYSIMD_FLOAT32_C(  -193.40), EASYSIMD_FLOAT32_C(  -359.31), EASYSIMD_FLOAT32_C(  -683.05), EASYSIMD_FLOAT32_C(  -389.25) },
          { EASYSIMD_FLOAT32_C(    26.97), EASYSIMD_FLOAT32_C(   653.44), EASYSIMD_FLOAT32_C(    46.75), EASYSIMD_FLOAT32_C(   174.33) },
      },
    },
    { { EASYSIMD_FLOAT32_C(    32.08), EASYSIMD_FLOAT32_C(   239.42), EASYSIMD_FLOAT32_C(  -118.78), EASYSIMD_FLOAT32_C(   967.64) },
      { EASYSIMD_FLOAT32_C(  -339.71), EASYSIMD_FLOAT32_C(   763.63), EASYSIMD_FLOAT32_C(   371.37), EASYSIMD_FLOAT32_C(   911.15) },
      {
          { EASYSIMD_FLOAT32_C(    32.08), EASYSIMD_FLOAT32_C(  -339.71), EASYSIMD_FLOAT32_C(  -118.78), EASYSIMD_FLOAT32_C(   371.37) },
          { EASYSIMD_FLOAT32_C(   239.42), EASYSIMD_FLOAT32_C(   763.63), EASYSIMD_FLOAT32_C(   967.64), EASYSIMD_FLOAT32_C(   911.15) },
      },
    },
    { { EASYSIMD_FLOAT32_C(   576.34), EASYSIMD_FLOAT32_C(  -245.30), EASYSIMD_FLOAT32_C(   -18.32), EASYSIMD_FLOAT32_C(  -950.59) },
      { EASYSIMD_FLOAT32_C(    -0.57), EASYSIMD_FLOAT32_C(   843.29), EASYSIMD_FLOAT32_C(   501.32), EASYSIMD_FLOAT32_C(   828.88) },
      {
          { EASYSIMD_FLOAT32_C(   576.34), EASYSIMD_FLOAT32_C(    -0.57), EASYSIMD_FLOAT32_C(   -18.32), EASYSIMD_FLOAT32_C(   501.32) },
          { EASYSIMD_FLOAT32_C(  -245.30), EASYSIMD_FLOAT32_C(   843.29), EASYSIMD_FLOAT32_C(  -950.59), EASYSIMD_FLOAT32_C(   828.88) },
      },
    },
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_float32x4x2_t r = easysimd_vtrnq_f32(a, b);
...
static int
test_easysimd_vtrnq_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int8_t a[16];
    int8_t b[16];
    int8_t r[2][16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int8x16x2_t r = easysimd_vtrnq_s8(a, b);
...
static int
test_easysimd_vtrnq_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int16_t a[8];
    int16_t b[8];
    int16_t r[2][8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int16x8x2_t r = easysimd_vtrnq_s16(a, b);
...
static int
test_easysimd_vtrnq_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int32_t a[4];
    int32_t b[4];
    int32_t r[2][4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x4x2_t r = easysimd_vtrnq_s32(a, b);
...
static int
test_easysimd_vtrnq_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint8_t a[16];
    uint8_t b[16];
    uint8_t r[2][16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x16x2_t r = easysimd_vtrnq_u8(a, b);
...
static int
test_easysimd_vtrnq_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint16_t a[8];
    uint16_t b[8];
    uint16_t r[2][8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x8x2_t r = easysimd_vtrnq_u16(a, b);
...
static int
test_easysimd_vtrnq_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint32_t a[4];
    uint32_t b[4];
    uint32_t r[2][4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x4x2_t r = easysimd_vtrnq_u32(a, b);
...
#if !defined(EASYSIMD_BUG_INTEL_857088)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vtrn_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vtrn_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vtrn_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vtrn_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vtrn_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vtrn_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vtrn_u32)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vtrnq_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vtrnq_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vtrnq_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vtrnq_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vtrnq_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vtrnq_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vtrnq_u32)
#endif /* !defined(EASYSIMD_BUG_INTEL_857088) */
