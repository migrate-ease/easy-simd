#define EASYSIMD_TEST_ARM_NEON_INSN trn1

#include <test/arm/neon/test-neon.h>
#include <easysimd/arm/neon/trn1.h>

static int
test_easysimd_vtrn1_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    easysimd_float32 a[2];
    easysimd_float32 b[2];
    easysimd_float32 r[2];
  } test_vec[] = {
    { { EASYSIMD_FLOAT32_C(  -734.98), EASYSIMD_FLOAT32_C(   365.45) },
      { EASYSIMD_FLOAT32_C(  -158.72), EASYSIMD_FLOAT32_C(   801.49) },
      { EASYSIMD_FLOAT32_C(  -734.98), EASYSIMD_FLOAT32_C(  -158.72) } },
    { { EASYSIMD_FLOAT32_C(  -244.32), EASYSIMD_FLOAT32_C(   246.47) },
      { EASYSIMD_FLOAT32_C(  -998.98), EASYSIMD_FLOAT32_C(  -876.14) },
      { EASYSIMD_FLOAT32_C(  -244.32), EASYSIMD_FLOAT32_C(  -998.98) } },
    { { EASYSIMD_FLOAT32_C(   821.58), EASYSIMD_FLOAT32_C(   188.36) },
      { EASYSIMD_FLOAT32_C(   526.46), EASYSIMD_FLOAT32_C(   806.12) },
      { EASYSIMD_FLOAT32_C(   821.58), EASYSIMD_FLOAT32_C(   526.46) } },
    { { EASYSIMD_FLOAT32_C(   231.60), EASYSIMD_FLOAT32_C(  -192.02) },
      { EASYSIMD_FLOAT32_C(  -230.26), EASYSIMD_FLOAT32_C(  -950.64) },
      { EASYSIMD_FLOAT32_C(   231.60), EASYSIMD_FLOAT32_C(  -230.26) } },
    { { EASYSIMD_FLOAT32_C(   514.95), EASYSIMD_FLOAT32_C(  -326.95) },
      { EASYSIMD_FLOAT32_C(  -930.10), EASYSIMD_FLOAT32_C(   113.30) },
      { EASYSIMD_FLOAT32_C(   514.95), EASYSIMD_FLOAT32_C(  -930.10) } },
    { { EASYSIMD_FLOAT32_C(   562.02), EASYSIMD_FLOAT32_C(  -958.09) },
      { EASYSIMD_FLOAT32_C(   753.36), EASYSIMD_FLOAT32_C(  -955.88) },
      { EASYSIMD_FLOAT32_C(   562.02), EASYSIMD_FLOAT32_C(   753.36) } },
    { { EASYSIMD_FLOAT32_C(   690.44), EASYSIMD_FLOAT32_C(  -991.78) },
      { EASYSIMD_FLOAT32_C(   276.78), EASYSIMD_FLOAT32_C(   537.69) },
      { EASYSIMD_FLOAT32_C(   690.44), EASYSIMD_FLOAT32_C(   276.78) } },
    { { EASYSIMD_FLOAT32_C(   -86.37), EASYSIMD_FLOAT32_C(  -105.16) },
      { EASYSIMD_FLOAT32_C(   319.11), EASYSIMD_FLOAT32_C(   178.65) },
      { EASYSIMD_FLOAT32_C(   -86.37), EASYSIMD_FLOAT32_C(   319.11) } },
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float32x2_t a = easysimd_vld1_f32(test_vec[i].a);
    easysimd_float32x2_t b = easysimd_vld1_f32(test_vec[i].b);
    easysimd_float32x2_t r = easysimd_vtrn1_f32(a, b);
...
static int
test_easysimd_vtrn1_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int8_t a[8];
    int8_t b[8];
    int8_t r[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int8x8_t r = easysimd_vtrn1_s8(a, b);
...
static int
test_easysimd_vtrn1_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int16_t a[4];
    int16_t b[4];
    int16_t r[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int16x4_t r = easysimd_vtrn1_s16(a, b);
...
static int
test_easysimd_vtrn1_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int32_t a[2];
    int32_t b[2];
    int32_t r[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x2_t r = easysimd_vtrn1_s32(a, b);
...
static int
test_easysimd_vtrn1_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint8_t a[8];
    uint8_t b[8];
    uint8_t r[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x8_t r = easysimd_vtrn1_u8(a, b);
...
static int
test_easysimd_vtrn1_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint16_t a[4];
    uint16_t b[4];
    uint16_t r[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x4_t r = easysimd_vtrn1_u16(a, b);
...
static int
test_easysimd_vtrn1_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint32_t a[2];
    uint32_t b[2];
    uint32_t r[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x2_t r = easysimd_vtrn1_u32(a, b);
...
static int
test_easysimd_vtrn1q_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    easysimd_float32 a[4];
    easysimd_float32 b[4];
    easysimd_float32 r[4];
  } test_vec[] = {
    { { EASYSIMD_FLOAT32_C(  -522.18), EASYSIMD_FLOAT32_C(   365.36), EASYSIMD_FLOAT32_C(  -879.25), EASYSIMD_FLOAT32_C(  -911.32) },
      { EASYSIMD_FLOAT32_C(   508.26), EASYSIMD_FLOAT32_C(   535.56), EASYSIMD_FLOAT32_C(  -927.14), EASYSIMD_FLOAT32_C(  -145.00) },
      { EASYSIMD_FLOAT32_C(  -522.18), EASYSIMD_FLOAT32_C(   508.26), EASYSIMD_FLOAT32_C(  -879.25), EASYSIMD_FLOAT32_C(  -927.14) } },
    { { EASYSIMD_FLOAT32_C(  -644.24), EASYSIMD_FLOAT32_C(   758.58), EASYSIMD_FLOAT32_C(   592.05), EASYSIMD_FLOAT32_C(   670.85) },
      { EASYSIMD_FLOAT32_C(   408.23), EASYSIMD_FLOAT32_C(  -493.59), EASYSIMD_FLOAT32_C(  -660.12), EASYSIMD_FLOAT32_C(   163.68) },
      { EASYSIMD_FLOAT32_C(  -644.24), EASYSIMD_FLOAT32_C(   408.23), EASYSIMD_FLOAT32_C(   592.05), EASYSIMD_FLOAT32_C(  -660.12) } },
    { { EASYSIMD_FLOAT32_C(  -787.94), EASYSIMD_FLOAT32_C(  -882.32), EASYSIMD_FLOAT32_C(   367.24), EASYSIMD_FLOAT32_C(   -16.83) },
      { EASYSIMD_FLOAT32_C(  -482.56), EASYSIMD_FLOAT32_C(   -96.42), EASYSIMD_FLOAT32_C(  -722.75), EASYSIMD_FLOAT32_C(  -446.06) },
      { EASYSIMD_FLOAT32_C(  -787.94), EASYSIMD_FLOAT32_C(  -482.56), EASYSIMD_FLOAT32_C(   367.24), EASYSIMD_FLOAT32_C(  -722.75) } },
    { { EASYSIMD_FLOAT32_C(   -23.04), EASYSIMD_FLOAT32_C(   914.12), EASYSIMD_FLOAT32_C(   495.70), EASYSIMD_FLOAT32_C(   665.01) },
      { EASYSIMD_FLOAT32_C(   292.03), EASYSIMD_FLOAT32_C(  -265.04), EASYSIMD_FLOAT32_C(   537.61), EASYSIMD_FLOAT32_C(   769.84) },
      { EASYSIMD_FLOAT32_C(   -23.04), EASYSIMD_FLOAT32_C(   292.03), EASYSIMD_FLOAT32_C(   495.70), EASYSIMD_FLOAT32_C(   537.61) } },
    { { EASYSIMD_FLOAT32_C(  -899.68), EASYSIMD_FLOAT32_C(   658.36), EASYSIMD_FLOAT32_C(   858.52), EASYSIMD_FLOAT32_C(   608.58) },
      { EASYSIMD_FLOAT32_C(   193.92), EASYSIMD_FLOAT32_C(   931.38), EASYSIMD_FLOAT32_C(  -536.43), EASYSIMD_FLOAT32_C(   549.69) },
      { EASYSIMD_FLOAT32_C(  -899.68), EASYSIMD_FLOAT32_C(   193.92), EASYSIMD_FLOAT32_C(   858.52), EASYSIMD_FLOAT32_C(  -536.43) } },
    { { EASYSIMD_FLOAT32_C(   689.97), EASYSIMD_FLOAT32_C(  -944.37), EASYSIMD_FLOAT32_C(   220.54), EASYSIMD_FLOAT32_C(    98.20) },
      { EASYSIMD_FLOAT32_C(  -437.96), EASYSIMD_FLOAT32_C(   560.42), EASYSIMD_FLOAT32_C(  -738.12), EASYSIMD_FLOAT32_C(  -225.90) },
      { EASYSIMD_FLOAT32_C(   689.97), EASYSIMD_FLOAT32_C(  -437.96), EASYSIMD_FLOAT32_C(   220.54), EASYSIMD_FLOAT32_C(  -738.12) } },
    { { EASYSIMD_FLOAT32_C(   678.09), EASYSIMD_FLOAT32_C(   629.12), EASYSIMD_FLOAT32_C(   757.27), EASYSIMD_FLOAT32_C(  -804.46) },
      { EASYSIMD_FLOAT32_C(  -467.30), EASYSIMD_FLOAT32_C(  -965.48), EASYSIMD_FLOAT32_C(  -250.52), EASYSIMD_FLOAT32_C(   509.67) },
      { EASYSIMD_FLOAT32_C(   678.09), EASYSIMD_FLOAT32_C(  -467.30), EASYSIMD_FLOAT32_C(   757.27), EASYSIMD_FLOAT32_C(  -250.52) } },
    { { EASYSIMD_FLOAT32_C(   948.64), EASYSIMD_FLOAT32_C(  -754.82), EASYSIMD_FLOAT32_C(   174.67), EASYSIMD_FLOAT32_C(   240.67) },
      { EASYSIMD_FLOAT32_C(   -19.85), EASYSIMD_FLOAT32_C(  -287.72), EASYSIMD_FLOAT32_C(    10.52), EASYSIMD_FLOAT32_C(    80.47) },
      { EASYSIMD_FLOAT32_C(   948.64), EASYSIMD_FLOAT32_C(   -19.85), EASYSIMD_FLOAT32_C(   174.67), EASYSIMD_FLOAT32_C(    10.52) } },
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float32x4_t a = easysimd_vld1q_f32(test_vec[i].a);
    easysimd_float32x4_t b = easysimd_vld1q_f32(test_vec[i].b);
    easysimd_float32x4_t r = easysimd_vtrn1q_f32(a, b);
...
static int
test_easysimd_vtrn1q_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    easysimd_float64 a[2];
    easysimd_float64 b[2];
    easysimd_float64 r[2];
  } test_vec[] = {
    { { EASYSIMD_FLOAT64_C(  -499.12), EASYSIMD_FLOAT64_C(  -611.84) },
      { EASYSIMD_FLOAT64_C(   618.92), EASYSIMD_FLOAT64_C(  -353.88) },
      { EASYSIMD_FLOAT64_C(  -499.12), EASYSIMD_FLOAT64_C(   618.92) } },
    { { EASYSIMD_FLOAT64_C(   542.91), EASYSIMD_FLOAT64_C(   443.42) },
      { EASYSIMD_FLOAT64_C(  -774.93), EASYSIMD_FLOAT64_C(   219.66) },
      { EASYSIMD_FLOAT64_C(   542.91), EASYSIMD_FLOAT64_C(  -774.93) } },
    { { EASYSIMD_FLOAT64_C(    43.30), EASYSIMD_FLOAT64_C(   437.28) },
      { EASYSIMD_FLOAT64_C(   412.68), EASYSIMD_FLOAT64_C(  -401.41) },
      { EASYSIMD_FLOAT64_C(    43.30), EASYSIMD_FLOAT64_C(   412.68) } },
    { { EASYSIMD_FLOAT64_C(   823.43), EASYSIMD_FLOAT64_C(   254.13) },
      { EASYSIMD_FLOAT64_C(  -356.45), EASYSIMD_FLOAT64_C(   862.90) },
      { EASYSIMD_FLOAT64_C(   823.43), EASYSIMD_FLOAT64_C(  -356.45) } },
    { { EASYSIMD_FLOAT64_C(   -30.73), EASYSIMD_FLOAT64_C(   631.32) },
      { EASYSIMD_FLOAT64_C(   321.40), EASYSIMD_FLOAT64_C(   984.72) },
      { EASYSIMD_FLOAT64_C(   -30.73), EASYSIMD_FLOAT64_C(   321.40) } },
    { { EASYSIMD_FLOAT64_C(   283.84), EASYSIMD_FLOAT64_C(  -391.31) },
      { EASYSIMD_FLOAT64_C(   957.98), EASYSIMD_FLOAT64_C(   515.26) },
      { EASYSIMD_FLOAT64_C(   283.84), EASYSIMD_FLOAT64_C(   957.98) } },
    { { EASYSIMD_FLOAT64_C(  -327.25), EASYSIMD_FLOAT64_C(  -666.99) },
      { EASYSIMD_FLOAT64_C(  -844.37), EASYSIMD_FLOAT64_C(  -877.10) },
      { EASYSIMD_FLOAT64_C(  -327.25), EASYSIMD_FLOAT64_C(  -844.37) } },
    { { EASYSIMD_FLOAT64_C(   397.41), EASYSIMD_FLOAT64_C(  -596.55) },
      { EASYSIMD_FLOAT64_C(   732.55), EASYSIMD_FLOAT64_C(   898.29) },
      { EASYSIMD_FLOAT64_C(   397.41), EASYSIMD_FLOAT64_C(   732.55) } },
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float64x2_t a = easysimd_vld1q_f64(test_vec[i].a);
    easysimd_float64x2_t b = easysimd_vld1q_f64(test_vec[i].b);
    easysimd_float64x2_t r = easysimd_vtrn1q_f64(a, b);
...
static int
test_easysimd_vtrn1q_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int8_t a[16];
    int8_t b[16];
    int8_t r[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int8x16_t r = easysimd_vtrn1q_s8(a, b);
...
static int
test_easysimd_vtrn1q_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int16_t a[8];
    int16_t b[8];
    int16_t r[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int16x8_t r = easysimd_vtrn1q_s16(a, b);
...
static int
test_easysimd_vtrn1q_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int32_t a[4];
    int32_t b[4];
    int32_t r[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x4_t r = easysimd_vtrn1q_s32(a, b);
...
static int
test_easysimd_vtrn1q_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int64_t a[2];
    int64_t b[2];
    int64_t r[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int64x2_t r = easysimd_vtrn1q_s64(a, b);
...
static int
test_easysimd_vtrn1q_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint8_t a[16];
    uint8_t b[16];
    uint8_t r[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x16_t r = easysimd_vtrn1q_u8(a, b);
...
static int
test_easysimd_vtrn1q_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint16_t a[8];
    uint16_t b[8];
    uint16_t r[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x8_t r = easysimd_vtrn1q_u16(a, b);
...
static int
test_easysimd_vtrn1q_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint32_t a[4];
    uint32_t b[4];
    uint32_t r[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x4_t r = easysimd_vtrn1q_u32(a, b);
...
static int
test_easysimd_vtrn1q_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint64_t a[2];
    uint64_t b[2];
    uint64_t r[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint64x2_t r = easysimd_vtrn1q_u64(a, b);
...
EASYSIMD_TEST_FUNC_LIST_ENTRY(vtrn1_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vtrn1_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vtrn1_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vtrn1_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vtrn1_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vtrn1_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vtrn1_u32)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vtrn1q_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vtrn1q_f64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vtrn1q_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vtrn1q_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vtrn1q_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vtrn1q_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vtrn1q_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vtrn1q_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vtrn1q_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vtrn1q_u64)
