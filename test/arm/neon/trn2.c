#define EASYSIMD_TEST_ARM_NEON_INSN trn2

#include <test/arm/neon/test-neon.h>
#include <easysimd/arm/neon/trn2.h>

static int
test_easysimd_vtrn2_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    easysimd_float32 a[2];
    easysimd_float32 b[2];
    easysimd_float32 r[2];
  } test_vec[] = {
    { { EASYSIMD_FLOAT32_C(    83.42), EASYSIMD_FLOAT32_C(   803.99) },
      { EASYSIMD_FLOAT32_C(   636.36), EASYSIMD_FLOAT32_C(   295.59) },
      { EASYSIMD_FLOAT32_C(   803.99), EASYSIMD_FLOAT32_C(   295.59) } },
    { { EASYSIMD_FLOAT32_C(   877.14), EASYSIMD_FLOAT32_C(  -285.61) },
      { EASYSIMD_FLOAT32_C(   689.26), EASYSIMD_FLOAT32_C(   398.34) },
      { EASYSIMD_FLOAT32_C(  -285.61), EASYSIMD_FLOAT32_C(   398.34) } },
    { { EASYSIMD_FLOAT32_C(  -478.64), EASYSIMD_FLOAT32_C(   -23.77) },
      { EASYSIMD_FLOAT32_C(   747.86), EASYSIMD_FLOAT32_C(   759.56) },
      { EASYSIMD_FLOAT32_C(   -23.77), EASYSIMD_FLOAT32_C(   759.56) } },
    { { EASYSIMD_FLOAT32_C(  -573.98), EASYSIMD_FLOAT32_C(   874.62) },
      { EASYSIMD_FLOAT32_C(   584.77), EASYSIMD_FLOAT32_C(   826.51) },
      { EASYSIMD_FLOAT32_C(   874.62), EASYSIMD_FLOAT32_C(   826.51) } },
    { { EASYSIMD_FLOAT32_C(   -73.10), EASYSIMD_FLOAT32_C(  -203.77) },
      { EASYSIMD_FLOAT32_C(   333.96), EASYSIMD_FLOAT32_C(   -54.11) },
      { EASYSIMD_FLOAT32_C(  -203.77), EASYSIMD_FLOAT32_C(   -54.11) } },
    { { EASYSIMD_FLOAT32_C(   552.91), EASYSIMD_FLOAT32_C(   -34.42) },
      { EASYSIMD_FLOAT32_C(  -526.96), EASYSIMD_FLOAT32_C(  -200.73) },
      { EASYSIMD_FLOAT32_C(   -34.42), EASYSIMD_FLOAT32_C(  -200.73) } },
    { { EASYSIMD_FLOAT32_C(   276.54), EASYSIMD_FLOAT32_C(  -171.29) },
      { EASYSIMD_FLOAT32_C(  -906.91), EASYSIMD_FLOAT32_C(  -286.58) },
      { EASYSIMD_FLOAT32_C(  -171.29), EASYSIMD_FLOAT32_C(  -286.58) } },
    { { EASYSIMD_FLOAT32_C(   665.38), EASYSIMD_FLOAT32_C(   440.56) },
      { EASYSIMD_FLOAT32_C(   826.61), EASYSIMD_FLOAT32_C(  -251.20) },
      { EASYSIMD_FLOAT32_C(   440.56), EASYSIMD_FLOAT32_C(  -251.20) } },
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float32x2_t a = easysimd_vld1_f32(test_vec[i].a);
    easysimd_float32x2_t b = easysimd_vld1_f32(test_vec[i].b);
    easysimd_float32x2_t r = easysimd_vtrn2_f32(a, b);
...
static int
test_easysimd_vtrn2_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int8_t a[8];
    int8_t b[8];
    int8_t r[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int8x8_t r = easysimd_vtrn2_s8(a, b);
...
static int
test_easysimd_vtrn2_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int16_t a[4];
    int16_t b[4];
    int16_t r[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int16x4_t r = easysimd_vtrn2_s16(a, b);
...
static int
test_easysimd_vtrn2_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int32_t a[2];
    int32_t b[2];
    int32_t r[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x2_t r = easysimd_vtrn2_s32(a, b);
...
static int
test_easysimd_vtrn2_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint8_t a[8];
    uint8_t b[8];
    uint8_t r[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x8_t r = easysimd_vtrn2_u8(a, b);
...
static int
test_easysimd_vtrn2_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint16_t a[4];
    uint16_t b[4];
    uint16_t r[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x4_t r = easysimd_vtrn2_u16(a, b);
...
static int
test_easysimd_vtrn2_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint32_t a[2];
    uint32_t b[2];
    uint32_t r[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x2_t r = easysimd_vtrn2_u32(a, b);
...
static int
test_easysimd_vtrn2q_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    easysimd_float32 a[4];
    easysimd_float32 b[4];
    easysimd_float32 r[4];
  } test_vec[] = {
    { { EASYSIMD_FLOAT32_C(  -211.13), EASYSIMD_FLOAT32_C(  -979.06), EASYSIMD_FLOAT32_C(   252.18), EASYSIMD_FLOAT32_C(   585.60) },
      { EASYSIMD_FLOAT32_C(  -353.90), EASYSIMD_FLOAT32_C(  -614.27), EASYSIMD_FLOAT32_C(  -898.32), EASYSIMD_FLOAT32_C(   395.91) },
      { EASYSIMD_FLOAT32_C(  -979.06), EASYSIMD_FLOAT32_C(  -614.27), EASYSIMD_FLOAT32_C(   585.60), EASYSIMD_FLOAT32_C(   395.91) } },
    { { EASYSIMD_FLOAT32_C(   662.54), EASYSIMD_FLOAT32_C(   470.15), EASYSIMD_FLOAT32_C(  -417.90), EASYSIMD_FLOAT32_C(  -256.21) },
      { EASYSIMD_FLOAT32_C(  -510.87), EASYSIMD_FLOAT32_C(   875.70), EASYSIMD_FLOAT32_C(  -440.43), EASYSIMD_FLOAT32_C(   620.00) },
      { EASYSIMD_FLOAT32_C(   470.15), EASYSIMD_FLOAT32_C(   875.70), EASYSIMD_FLOAT32_C(  -256.21), EASYSIMD_FLOAT32_C(   620.00) } },
    { { EASYSIMD_FLOAT32_C(  -175.24), EASYSIMD_FLOAT32_C(   314.73), EASYSIMD_FLOAT32_C(  -141.11), EASYSIMD_FLOAT32_C(  -855.73) },
      { EASYSIMD_FLOAT32_C(  -301.48), EASYSIMD_FLOAT32_C(  -992.19), EASYSIMD_FLOAT32_C(  -362.14), EASYSIMD_FLOAT32_C(  -921.90) },
      { EASYSIMD_FLOAT32_C(   314.73), EASYSIMD_FLOAT32_C(  -992.19), EASYSIMD_FLOAT32_C(  -855.73), EASYSIMD_FLOAT32_C(  -921.90) } },
    { { EASYSIMD_FLOAT32_C(   931.20), EASYSIMD_FLOAT32_C(  -308.80), EASYSIMD_FLOAT32_C(   750.81), EASYSIMD_FLOAT32_C(  -865.99) },
      { EASYSIMD_FLOAT32_C(  -783.84), EASYSIMD_FLOAT32_C(  -467.10), EASYSIMD_FLOAT32_C(  -605.39), EASYSIMD_FLOAT32_C(     5.03) },
      { EASYSIMD_FLOAT32_C(  -308.80), EASYSIMD_FLOAT32_C(  -467.10), EASYSIMD_FLOAT32_C(  -865.99), EASYSIMD_FLOAT32_C(     5.03) } },
    { { EASYSIMD_FLOAT32_C(  -446.16), EASYSIMD_FLOAT32_C(   646.79), EASYSIMD_FLOAT32_C(  -409.36), EASYSIMD_FLOAT32_C(   199.94) },
      { EASYSIMD_FLOAT32_C(  -967.48), EASYSIMD_FLOAT32_C(  -307.68), EASYSIMD_FLOAT32_C(  -404.15), EASYSIMD_FLOAT32_C(   695.06) },
      { EASYSIMD_FLOAT32_C(   646.79), EASYSIMD_FLOAT32_C(  -307.68), EASYSIMD_FLOAT32_C(   199.94), EASYSIMD_FLOAT32_C(   695.06) } },
    { { EASYSIMD_FLOAT32_C(  -837.54), EASYSIMD_FLOAT32_C(   177.95), EASYSIMD_FLOAT32_C(  -561.15), EASYSIMD_FLOAT32_C(  -348.41) },
      { EASYSIMD_FLOAT32_C(    53.65), EASYSIMD_FLOAT32_C(    -1.58), EASYSIMD_FLOAT32_C(  -728.41), EASYSIMD_FLOAT32_C(   878.40) },
      { EASYSIMD_FLOAT32_C(   177.95), EASYSIMD_FLOAT32_C(    -1.58), EASYSIMD_FLOAT32_C(  -348.41), EASYSIMD_FLOAT32_C(   878.40) } },
    { { EASYSIMD_FLOAT32_C(  -686.85), EASYSIMD_FLOAT32_C(   130.48), EASYSIMD_FLOAT32_C(  -977.32), EASYSIMD_FLOAT32_C(    11.67) },
      { EASYSIMD_FLOAT32_C(   138.29), EASYSIMD_FLOAT32_C(  -339.46), EASYSIMD_FLOAT32_C(    89.77), EASYSIMD_FLOAT32_C(    69.49) },
      { EASYSIMD_FLOAT32_C(   130.48), EASYSIMD_FLOAT32_C(  -339.46), EASYSIMD_FLOAT32_C(    11.67), EASYSIMD_FLOAT32_C(    69.49) } },
    { { EASYSIMD_FLOAT32_C(   351.74), EASYSIMD_FLOAT32_C(  -159.41), EASYSIMD_FLOAT32_C(   203.49), EASYSIMD_FLOAT32_C(   567.89) },
      { EASYSIMD_FLOAT32_C(   373.49), EASYSIMD_FLOAT32_C(   598.10), EASYSIMD_FLOAT32_C(  -427.08), EASYSIMD_FLOAT32_C(   927.33) },
      { EASYSIMD_FLOAT32_C(  -159.41), EASYSIMD_FLOAT32_C(   598.10), EASYSIMD_FLOAT32_C(   567.89), EASYSIMD_FLOAT32_C(   927.33) } },
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float32x4_t a = easysimd_vld1q_f32(test_vec[i].a);
    easysimd_float32x4_t b = easysimd_vld1q_f32(test_vec[i].b);
    easysimd_float32x4_t r = easysimd_vtrn2q_f32(a, b);
...
static int
test_easysimd_vtrn2q_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    easysimd_float64 a[2];
    easysimd_float64 b[2];
    easysimd_float64 r[2];
  } test_vec[] = {
    { { EASYSIMD_FLOAT64_C(   808.16), EASYSIMD_FLOAT64_C(   -66.58) },
      { EASYSIMD_FLOAT64_C(   640.72), EASYSIMD_FLOAT64_C(  -179.06) },
      { EASYSIMD_FLOAT64_C(   -66.58), EASYSIMD_FLOAT64_C(  -179.06) } },
    { { EASYSIMD_FLOAT64_C(  -763.23), EASYSIMD_FLOAT64_C(   245.88) },
      { EASYSIMD_FLOAT64_C(    64.27), EASYSIMD_FLOAT64_C(   245.45) },
      { EASYSIMD_FLOAT64_C(   245.88), EASYSIMD_FLOAT64_C(   245.45) } },
    { { EASYSIMD_FLOAT64_C(   533.54), EASYSIMD_FLOAT64_C(  -357.67) },
      { EASYSIMD_FLOAT64_C(  -180.56), EASYSIMD_FLOAT64_C(   -85.73) },
      { EASYSIMD_FLOAT64_C(  -357.67), EASYSIMD_FLOAT64_C(   -85.73) } },
    { { EASYSIMD_FLOAT64_C(   913.02), EASYSIMD_FLOAT64_C(   -45.29) },
      { EASYSIMD_FLOAT64_C(  -710.20), EASYSIMD_FLOAT64_C(   600.50) },
      { EASYSIMD_FLOAT64_C(   -45.29), EASYSIMD_FLOAT64_C(   600.50) } },
    { { EASYSIMD_FLOAT64_C(   103.86), EASYSIMD_FLOAT64_C(   824.18) },
      { EASYSIMD_FLOAT64_C(   417.27), EASYSIMD_FLOAT64_C(   319.73) },
      { EASYSIMD_FLOAT64_C(   824.18), EASYSIMD_FLOAT64_C(   319.73) } },
    { { EASYSIMD_FLOAT64_C(   543.92), EASYSIMD_FLOAT64_C(   468.66) },
      { EASYSIMD_FLOAT64_C(  -370.42), EASYSIMD_FLOAT64_C(  -598.68) },
      { EASYSIMD_FLOAT64_C(   468.66), EASYSIMD_FLOAT64_C(  -598.68) } },
    { { EASYSIMD_FLOAT64_C(  -891.19), EASYSIMD_FLOAT64_C(   383.96) },
      { EASYSIMD_FLOAT64_C(    82.38), EASYSIMD_FLOAT64_C(  -999.44) },
      { EASYSIMD_FLOAT64_C(   383.96), EASYSIMD_FLOAT64_C(  -999.44) } },
    { { EASYSIMD_FLOAT64_C(   899.21), EASYSIMD_FLOAT64_C(  -263.60) },
      { EASYSIMD_FLOAT64_C(  -211.00), EASYSIMD_FLOAT64_C(   707.37) },
      { EASYSIMD_FLOAT64_C(  -263.60), EASYSIMD_FLOAT64_C(   707.37) } },
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float64x2_t a = easysimd_vld1q_f64(test_vec[i].a);
    easysimd_float64x2_t b = easysimd_vld1q_f64(test_vec[i].b);
    easysimd_float64x2_t r = easysimd_vtrn2q_f64(a, b);
...
static int
test_easysimd_vtrn2q_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int8_t a[16];
    int8_t b[16];
    int8_t r[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int8x16_t r = easysimd_vtrn2q_s8(a, b);
...
static int
test_easysimd_vtrn2q_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int16_t a[8];
    int16_t b[8];
    int16_t r[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int16x8_t r = easysimd_vtrn2q_s16(a, b);
...
static int
test_easysimd_vtrn2q_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int32_t a[4];
    int32_t b[4];
    int32_t r[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x4_t r = easysimd_vtrn2q_s32(a, b);
...
static int
test_easysimd_vtrn2q_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int64_t a[2];
    int64_t b[2];
    int64_t r[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int64x2_t r = easysimd_vtrn2q_s64(a, b);
...
static int
test_easysimd_vtrn2q_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint8_t a[16];
    uint8_t b[16];
    uint8_t r[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x16_t r = easysimd_vtrn2q_u8(a, b);
...
static int
test_easysimd_vtrn2q_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint16_t a[8];
    uint16_t b[8];
    uint16_t r[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x8_t r = easysimd_vtrn2q_u16(a, b);
...
static int
test_easysimd_vtrn2q_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint32_t a[4];
    uint32_t b[4];
    uint32_t r[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x4_t r = easysimd_vtrn2q_u32(a, b);
...
static int
test_easysimd_vtrn2q_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint64_t a[2];
    uint64_t b[2];
    uint64_t r[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint64x2_t r = easysimd_vtrn2q_u64(a, b);
...
EASYSIMD_TEST_FUNC_LIST_ENTRY(vtrn2_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vtrn2_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vtrn2_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vtrn2_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vtrn2_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vtrn2_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vtrn2_u32)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vtrn2q_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vtrn2q_f64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vtrn2q_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vtrn2q_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vtrn2q_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vtrn2q_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vtrn2q_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vtrn2q_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vtrn2q_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vtrn2q_u64)
