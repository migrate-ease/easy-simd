#define EASYSIMD_TEST_ARM_NEON_INSN tst

#include "test-neon.h"

/* Check that both of these work */
#if defined(__cplusplus)
  #include "../../../easysimd/arm/neon/tst.h"
#else
  #include "../../../easysimd/arm/neon.h"
#endif

static int
test_easysimd_vtst_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int8_t a[8];
    int8_t b[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x8_t r = easysimd_vtst_s8(a, b);
...
static int
test_easysimd_vtst_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int16_t a[4];
    int16_t b[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x4_t r = easysimd_vtst_s16(a, b);
...
static int
test_easysimd_vtst_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t a[2];
    int32_t b[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x2_t r = easysimd_vtst_s32(a, b);
...
static int
test_easysimd_vtst_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int64_t a[1];
    int64_t b[1];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint64x1_t r = easysimd_vtst_s64(a, b);
...
static int
test_easysimd_vtst_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint8_t a[8];
    uint8_t b[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x8_t r = easysimd_vtst_u8(a, b);
...
static int
test_easysimd_vtst_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint16_t a[4];
    uint16_t b[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x4_t r = easysimd_vtst_u16(a, b);
...
static int
test_easysimd_vtst_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint32_t a[2];
    uint32_t b[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x2_t r = easysimd_vtst_u32(a, b);
...
static int
test_easysimd_vtst_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint64_t a[1];
    uint64_t b[1];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint64x1_t r = easysimd_vtst_u64(a, b);
...
static int
test_easysimd_vtstq_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int8_t a[16];
    int8_t b[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x16_t r = easysimd_vtstq_s8(a, b);
...
static int
test_easysimd_vtstq_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int16_t a[8];
    int16_t b[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x8_t r = easysimd_vtstq_s16(a, b);
...
static int
test_easysimd_vtstq_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t a[4];
    int32_t b[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x4_t r = easysimd_vtstq_s32(a, b);
...
static int
test_easysimd_vtstq_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int64_t a[2];
    int64_t b[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint64x2_t r = easysimd_vtstq_s64(a, b);
...
static int
test_easysimd_vtstq_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint8_t a[16];
    uint8_t b[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x16_t r = easysimd_vtstq_u8(a, b);
...
static int
test_easysimd_vtstq_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint16_t a[8];
    uint16_t b[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x8_t r = easysimd_vtstq_u16(a, b);
...
static int
test_easysimd_vtstq_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint32_t a[4];
    uint32_t b[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x4_t r = easysimd_vtstq_u32(a, b);
...
static int
test_easysimd_vtstq_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint64_t a[2];
    uint64_t b[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint64x2_t r = easysimd_vtstq_u64(a, b);
...
static int
test_easysimd_vtstd_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int64_t a;
    int64_t b;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    uint64_t r = easysimd_vtstd_s64(test_vec[i].a, test_vec[i].b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    uint64_t r = easysimd_vtstd_s64(a, b);
...
static int
test_easysimd_vtstd_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    uint64_t a;
    uint64_t b;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    uint64_t r = easysimd_vtstd_u64(test_vec[i].a, test_vec[i].b);
    easysimd_assert_equal_u64(r, test_vec[i].r);
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    uint64_t r = easysimd_vtstd_u64(a, b);
...
EASYSIMD_TEST_FUNC_LIST_ENTRY(vtst_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vtst_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vtst_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vtst_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vtst_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vtst_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vtst_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vtst_u64)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vtstq_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vtstq_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vtstq_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vtstq_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vtstq_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vtstq_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vtstq_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vtstq_u64)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vtstd_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vtstd_u64)
