#define EASYSIMD_TEST_ARM_NEON_INSN uqadd

#include "test-neon.h"
#include "../../../easysimd/arm/neon/uqadd.h"

static int
test_easysimd_vuqaddb_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int8_t a;
    uint8_t b;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    int8_t r = easysimd_vuqaddb_s8(test_vec[i].a, test_vec[i].b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    int8_t r = easysimd_vuqaddb_s8(a, b);
...
static int
test_easysimd_vuqaddh_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int16_t a;
    uint16_t b;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    int16_t r = easysimd_vuqaddh_s16(test_vec[i].a, test_vec[i].b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    int16_t r = easysimd_vuqaddh_s16(a, b);
...
static int
test_easysimd_vuqadds_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t a;
    uint32_t b;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    int32_t r = easysimd_vuqadds_s32(test_vec[i].a, test_vec[i].b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    int32_t r = easysimd_vuqadds_s32(a, b);
...
static int
test_easysimd_vuqaddd_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int64_t a;
    uint64_t b;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    int64_t r = easysimd_vuqaddd_s64(test_vec[i].a, test_vec[i].b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    int64_t r = easysimd_vuqaddd_s64(a, b);
...
static int
test_easysimd_vuqadd_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int8_t a[8];
    uint8_t b[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int8x8_t r = easysimd_vuqadd_s8(a, b);
...
static int
test_easysimd_vuqadd_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int16_t a[4];
    uint16_t b[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int16x4_t r = easysimd_vuqadd_s16(a, b);
...
static int
test_easysimd_vuqadd_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t a[2];
    uint32_t b[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x2_t r = easysimd_vuqadd_s32(a, b);
...
static int
test_easysimd_vuqadd_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int64_t a[1];
    uint64_t b[1];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int64x1_t r = easysimd_vuqadd_s64(a, b);
...
static int
test_easysimd_vuqaddq_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int8_t a[16];
    uint8_t b[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int8x16_t r = easysimd_vuqaddq_s8(a, b);
...
static int
test_easysimd_vuqaddq_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int16_t a[8];
    uint16_t b[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int16x8_t r = easysimd_vuqaddq_s16(a, b);
...
static int
test_easysimd_vuqaddq_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int32_t a[4];
    uint32_t b[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x4_t r = easysimd_vuqaddq_s32(a, b);
...
static int
test_easysimd_vuqaddq_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    int64_t a[2];
    uint64_t b[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int64x2_t r = easysimd_vuqaddq_s64(a, b);
...
EASYSIMD_TEST_FUNC_LIST_ENTRY(vuqaddb_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vuqaddh_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vuqadds_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vuqaddd_s64)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vuqadd_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vuqadd_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vuqadd_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vuqadd_s64)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vuqaddq_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vuqaddq_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vuqaddq_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vuqaddq_s64)
