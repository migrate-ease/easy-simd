#define EASYSIMD_TEST_ARM_NEON_INSN uzp

#include "test-neon.h"
#include <easysimd/arm/neon/uzp.h>

#if !defined(EASYSIMD_BUG_INTEL_857088)

static int
test_easysimd_vuzp_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    easysimd_float32 a[2];
    easysimd_float32 b[2];
    easysimd_float32 r[2][2];
  } test_vec[] = {
    { { EASYSIMD_FLOAT32_C(   929.29), EASYSIMD_FLOAT32_C(   951.10) },
      { EASYSIMD_FLOAT32_C(   363.77), EASYSIMD_FLOAT32_C(   789.61) },
      {
          { EASYSIMD_FLOAT32_C(   929.29), EASYSIMD_FLOAT32_C(   363.77) },
          { EASYSIMD_FLOAT32_C(   951.10), EASYSIMD_FLOAT32_C(   789.61) },
      },
    },
    { { EASYSIMD_FLOAT32_C(  -759.57), EASYSIMD_FLOAT32_C(   685.98) },
      { EASYSIMD_FLOAT32_C(   841.21), EASYSIMD_FLOAT32_C(   515.20) },
      {
          { EASYSIMD_FLOAT32_C(  -759.57), EASYSIMD_FLOAT32_C(   841.21) },
          { EASYSIMD_FLOAT32_C(   685.98), EASYSIMD_FLOAT32_C(   515.20) },
      },
    },
    { { EASYSIMD_FLOAT32_C(    69.74), EASYSIMD_FLOAT32_C(  -338.66) },
      { EASYSIMD_FLOAT32_C(   456.03), EASYSIMD_FLOAT32_C(  -463.79) },
      {
          { EASYSIMD_FLOAT32_C(    69.74), EASYSIMD_FLOAT32_C(   456.03) },
          { EASYSIMD_FLOAT32_C(  -338.66), EASYSIMD_FLOAT32_C(  -463.79) },
      },
    },
    { { EASYSIMD_FLOAT32_C(  -878.94), EASYSIMD_FLOAT32_C(   168.02) },
      { EASYSIMD_FLOAT32_C(  -767.09), EASYSIMD_FLOAT32_C(   264.02) },
      {
          { EASYSIMD_FLOAT32_C(  -878.94), EASYSIMD_FLOAT32_C(  -767.09) },
          { EASYSIMD_FLOAT32_C(   168.02), EASYSIMD_FLOAT32_C(   264.02) },
      },
    },
    { { EASYSIMD_FLOAT32_C(  -711.03), EASYSIMD_FLOAT32_C(   572.52) },
      { EASYSIMD_FLOAT32_C(   131.81), EASYSIMD_FLOAT32_C(  -844.24) },
      {
          { EASYSIMD_FLOAT32_C(  -711.03), EASYSIMD_FLOAT32_C(   131.81) },
          { EASYSIMD_FLOAT32_C(   572.52), EASYSIMD_FLOAT32_C(  -844.24) },
      },
    },
    { { EASYSIMD_FLOAT32_C(  -898.82), EASYSIMD_FLOAT32_C(  -685.93) },
      { EASYSIMD_FLOAT32_C(  -963.34), EASYSIMD_FLOAT32_C(  -684.35) },
      {
          { EASYSIMD_FLOAT32_C(  -898.82), EASYSIMD_FLOAT32_C(  -963.34) },
          { EASYSIMD_FLOAT32_C(  -685.93), EASYSIMD_FLOAT32_C(  -684.35) },
      },
    },
    { { EASYSIMD_FLOAT32_C(  -332.36), EASYSIMD_FLOAT32_C(   141.67) },
      { EASYSIMD_FLOAT32_C(  -308.83), EASYSIMD_FLOAT32_C(   753.40) },
      {
          { EASYSIMD_FLOAT32_C(  -332.36), EASYSIMD_FLOAT32_C(  -308.83) },
          { EASYSIMD_FLOAT32_C(   141.67), EASYSIMD_FLOAT32_C(   753.40) },
      },
    },
    { { EASYSIMD_FLOAT32_C(   573.65), EASYSIMD_FLOAT32_C(  -669.39) },
      { EASYSIMD_FLOAT32_C(   323.27), EASYSIMD_FLOAT32_C(   502.94) },
      {
          { EASYSIMD_FLOAT32_C(   573.65), EASYSIMD_FLOAT32_C(   323.27) },
          { EASYSIMD_FLOAT32_C(  -669.39), EASYSIMD_FLOAT32_C(   502.94) },
      },
    },
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_float32x2x2_t r = easysimd_vuzp_f32(a, b);

    easysimd_test_arm_neon_assert_equal_f32x2(r.val[0], easysimd_vld1_f32(test_vec[i].r[0]), 1);
    easysimd_test_arm_neon_assert_equal_f32x2(r.val[1], easysimd_vld1_f32(test_vec[i].r[1]), 1);
  }
...
static int
test_easysimd_vuzp_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int8_t a[8];
    int8_t b[8];
    int8_t r[2][8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int8x8x2_t r = easysimd_vuzp_s8(a, b);

    easysimd_test_arm_neon_assert_equal_i8x8(r.val[0], easysimd_vld1_s8(test_vec[i].r[0]));
    easysimd_test_arm_neon_assert_equal_i8x8(r.val[1], easysimd_vld1_s8(test_vec[i].r[1]));
  }
...
static int
test_easysimd_vuzp_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int16_t a[4];
    int16_t b[4];
    int16_t r[2][4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int16x4x2_t r = easysimd_vuzp_s16(a, b);

    easysimd_test_arm_neon_assert_equal_i16x4(r.val[0], easysimd_vld1_s16(test_vec[i].r[0]));
    easysimd_test_arm_neon_assert_equal_i16x4(r.val[1], easysimd_vld1_s16(test_vec[i].r[1]));
  }
...
static int
test_easysimd_vuzp_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int32_t a[2];
    int32_t b[2];
    int32_t r[2][2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x2x2_t r = easysimd_vuzp_s32(a, b);

    easysimd_test_arm_neon_assert_equal_i32x2(r.val[0], easysimd_vld1_s32(test_vec[i].r[0]));
    easysimd_test_arm_neon_assert_equal_i32x2(r.val[1], easysimd_vld1_s32(test_vec[i].r[1]));
  }
...
static int
test_easysimd_vuzp_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint8_t a[8];
    uint8_t b[8];
    uint8_t r[2][8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x8x2_t r = easysimd_vuzp_u8(a, b);

    easysimd_test_arm_neon_assert_equal_u8x8(r.val[0], easysimd_vld1_u8(test_vec[i].r[0]));
    easysimd_test_arm_neon_assert_equal_u8x8(r.val[1], easysimd_vld1_u8(test_vec[i].r[1]));
  }
...
static int
test_easysimd_vuzp_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint16_t a[4];
    uint16_t b[4];
    uint16_t r[2][4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x4x2_t r = easysimd_vuzp_u16(a, b);
    easysimd_test_arm_neon_assert_equal_u16x4(r.val[0], easysimd_vld1_u16(test_vec[i].r[0]));
    easysimd_test_arm_neon_assert_equal_u16x4(r.val[1], easysimd_vld1_u16(test_vec[i].r[1]));
  }
...
static int
test_easysimd_vuzp_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint32_t a[2];
    uint32_t b[2];
    uint32_t r[2][2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x2x2_t r = easysimd_vuzp_u32(a, b);
    easysimd_test_arm_neon_assert_equal_u32x2(r.val[0], easysimd_vld1_u32(test_vec[i].r[0]));
    easysimd_test_arm_neon_assert_equal_u32x2(r.val[1], easysimd_vld1_u32(test_vec[i].r[1]));
  }
...
static int
test_easysimd_vuzpq_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    easysimd_float32 a[4];
    easysimd_float32 b[4];
    easysimd_float32 r[2][4];
  } test_vec[] = {
    { { EASYSIMD_FLOAT32_C(   336.86), EASYSIMD_FLOAT32_C(   940.59), EASYSIMD_FLOAT32_C(   624.20), EASYSIMD_FLOAT32_C(   198.24) },
      { EASYSIMD_FLOAT32_C(  -819.71), EASYSIMD_FLOAT32_C(   812.42), EASYSIMD_FLOAT32_C(  -979.32), EASYSIMD_FLOAT32_C(  -307.51) },
      {
          { EASYSIMD_FLOAT32_C(   336.86), EASYSIMD_FLOAT32_C(   624.20), EASYSIMD_FLOAT32_C(  -819.71), EASYSIMD_FLOAT32_C(  -979.32) },
          { EASYSIMD_FLOAT32_C(   940.59), EASYSIMD_FLOAT32_C(   198.24), EASYSIMD_FLOAT32_C(   812.42), EASYSIMD_FLOAT32_C(  -307.51) },
      },
    },
    { { EASYSIMD_FLOAT32_C(   894.01), EASYSIMD_FLOAT32_C(  -916.74), EASYSIMD_FLOAT32_C(  -332.33), EASYSIMD_FLOAT32_C(     0.85) },
      { EASYSIMD_FLOAT32_C(   121.08), EASYSIMD_FLOAT32_C(   820.47), EASYSIMD_FLOAT32_C(  -541.38), EASYSIMD_FLOAT32_C(   730.98) },
      {
          { EASYSIMD_FLOAT32_C(   894.01), EASYSIMD_FLOAT32_C(  -332.33), EASYSIMD_FLOAT32_C(   121.08), EASYSIMD_FLOAT32_C(  -541.38) },
          { EASYSIMD_FLOAT32_C(  -916.74), EASYSIMD_FLOAT32_C(     0.85), EASYSIMD_FLOAT32_C(   820.47), EASYSIMD_FLOAT32_C(   730.98) },
      },
    },
    { { EASYSIMD_FLOAT32_C(   -88.10), EASYSIMD_FLOAT32_C(  -685.13), EASYSIMD_FLOAT32_C(  -502.77), EASYSIMD_FLOAT32_C(  -970.47) },
      { EASYSIMD_FLOAT32_C(   803.17), EASYSIMD_FLOAT32_C(   233.77), EASYSIMD_FLOAT32_C(   409.34), EASYSIMD_FLOAT32_C(   846.91) },
      {
          { EASYSIMD_FLOAT32_C(   -88.10), EASYSIMD_FLOAT32_C(  -502.77), EASYSIMD_FLOAT32_C(   803.17), EASYSIMD_FLOAT32_C(   409.34) },
          { EASYSIMD_FLOAT32_C(  -685.13), EASYSIMD_FLOAT32_C(  -970.47), EASYSIMD_FLOAT32_C(   233.77), EASYSIMD_FLOAT32_C(   846.91) },
      },
    },
    { { EASYSIMD_FLOAT32_C(   785.89), EASYSIMD_FLOAT32_C(  -295.61), EASYSIMD_FLOAT32_C(   -65.85), EASYSIMD_FLOAT32_C(   708.46) },
      { EASYSIMD_FLOAT32_C(  -432.93), EASYSIMD_FLOAT32_C(   209.38), EASYSIMD_FLOAT32_C(   884.61), EASYSIMD_FLOAT32_C(   903.93) },
      {
          { EASYSIMD_FLOAT32_C(   785.89), EASYSIMD_FLOAT32_C(   -65.85), EASYSIMD_FLOAT32_C(  -432.93), EASYSIMD_FLOAT32_C(   884.61) },
          { EASYSIMD_FLOAT32_C(  -295.61), EASYSIMD_FLOAT32_C(   708.46), EASYSIMD_FLOAT32_C(   209.38), EASYSIMD_FLOAT32_C(   903.93) },
      },
    },
    { { EASYSIMD_FLOAT32_C(   149.97), EASYSIMD_FLOAT32_C(   508.80), EASYSIMD_FLOAT32_C(   102.16), EASYSIMD_FLOAT32_C(   330.26) },
      { EASYSIMD_FLOAT32_C(   321.22), EASYSIMD_FLOAT32_C(   122.85), EASYSIMD_FLOAT32_C(  -977.25), EASYSIMD_FLOAT32_C(   215.24) },
      {
          { EASYSIMD_FLOAT32_C(   149.97), EASYSIMD_FLOAT32_C(   102.16), EASYSIMD_FLOAT32_C(   321.22), EASYSIMD_FLOAT32_C(  -977.25) },
          { EASYSIMD_FLOAT32_C(   508.80), EASYSIMD_FLOAT32_C(   330.26), EASYSIMD_FLOAT32_C(   122.85), EASYSIMD_FLOAT32_C(   215.24) },
      },
    },
    { { EASYSIMD_FLOAT32_C(   206.11), EASYSIMD_FLOAT32_C(  -309.58), EASYSIMD_FLOAT32_C(  -783.92), EASYSIMD_FLOAT32_C(  -672.81) },
      { EASYSIMD_FLOAT32_C(  -489.11), EASYSIMD_FLOAT32_C(  -325.29), EASYSIMD_FLOAT32_C(  -941.84), EASYSIMD_FLOAT32_C(   422.79) },
      {
          { EASYSIMD_FLOAT32_C(   206.11), EASYSIMD_FLOAT32_C(  -783.92), EASYSIMD_FLOAT32_C(  -489.11), EASYSIMD_FLOAT32_C(  -941.84) },
          { EASYSIMD_FLOAT32_C(  -309.58), EASYSIMD_FLOAT32_C(  -672.81), EASYSIMD_FLOAT32_C(  -325.29), EASYSIMD_FLOAT32_C(   422.79) },
      },
    },
    { { EASYSIMD_FLOAT32_C(   -10.42), EASYSIMD_FLOAT32_C(  -444.60), EASYSIMD_FLOAT32_C(   452.32), EASYSIMD_FLOAT32_C(  -207.25) },
      { EASYSIMD_FLOAT32_C(   789.16), EASYSIMD_FLOAT32_C(  -138.34), EASYSIMD_FLOAT32_C(  -360.35), EASYSIMD_FLOAT32_C(   575.05) },
      {
          { EASYSIMD_FLOAT32_C(   -10.42), EASYSIMD_FLOAT32_C(   452.32), EASYSIMD_FLOAT32_C(   789.16), EASYSIMD_FLOAT32_C(  -360.35) },
          { EASYSIMD_FLOAT32_C(  -444.60), EASYSIMD_FLOAT32_C(  -207.25), EASYSIMD_FLOAT32_C(  -138.34), EASYSIMD_FLOAT32_C(   575.05) },
      },
    },
    { { EASYSIMD_FLOAT32_C(   566.05), EASYSIMD_FLOAT32_C(   573.80), EASYSIMD_FLOAT32_C(   283.51), EASYSIMD_FLOAT32_C(  -866.88) },
      { EASYSIMD_FLOAT32_C(  -216.82), EASYSIMD_FLOAT32_C(   168.12), EASYSIMD_FLOAT32_C(  -962.96), EASYSIMD_FLOAT32_C(   933.15) },
      {
          { EASYSIMD_FLOAT32_C(   566.05), EASYSIMD_FLOAT32_C(   283.51), EASYSIMD_FLOAT32_C(  -216.82), EASYSIMD_FLOAT32_C(  -962.96) },
          { EASYSIMD_FLOAT32_C(   573.80), EASYSIMD_FLOAT32_C(  -866.88), EASYSIMD_FLOAT32_C(   168.12), EASYSIMD_FLOAT32_C(   933.15) },
      },
    },
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_float32x4x2_t r = easysimd_vuzpq_f32(a, b);
    easysimd_test_arm_neon_assert_equal_f32x4(r.val[0], easysimd_vld1q_f32(test_vec[i].r[0]), 1);
    easysimd_test_arm_neon_assert_equal_f32x4(r.val[1], easysimd_vld1q_f32(test_vec[i].r[1]), 1);
  }
...
static int
test_easysimd_vuzpq_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int8_t a[16];
    int8_t b[16];
    int8_t r[2][16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int8x16x2_t r = easysimd_vuzpq_s8(a, b);

    easysimd_test_arm_neon_assert_equal_i8x16(r.val[0], easysimd_vld1q_s8(test_vec[i].r[0]));
    easysimd_test_arm_neon_assert_equal_i8x16(r.val[1], easysimd_vld1q_s8(test_vec[i].r[1]));
  }
...
static int
test_easysimd_vuzpq_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int16_t a[8];
    int16_t b[8];
    int16_t r[2][8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int16x8x2_t r = easysimd_vuzpq_s16(a, b);

    easysimd_test_arm_neon_assert_equal_i16x8(r.val[0], easysimd_vld1q_s16(test_vec[i].r[0]));
    easysimd_test_arm_neon_assert_equal_i16x8(r.val[1], easysimd_vld1q_s16(test_vec[i].r[1]));
  }
...
static int
test_easysimd_vuzpq_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int32_t a[4];
    int32_t b[4];
    int32_t r[2][4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x4x2_t r = easysimd_vuzpq_s32(a, b);
    easysimd_test_arm_neon_assert_equal_i32x4(r.val[0], easysimd_vld1q_s32(test_vec[i].r[0]));
    easysimd_test_arm_neon_assert_equal_i32x4(r.val[1], easysimd_vld1q_s32(test_vec[i].r[1]));
  }
...
static int
test_easysimd_vuzpq_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint8_t a[16];
    uint8_t b[16];
    uint8_t r[2][16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x16x2_t r = easysimd_vuzpq_u8(a, b);

    easysimd_test_arm_neon_assert_equal_u8x16(r.val[0], easysimd_vld1q_u8(test_vec[i].r[0]));
    easysimd_test_arm_neon_assert_equal_u8x16(r.val[1], easysimd_vld1q_u8(test_vec[i].r[1]));
  }
...
static int
test_easysimd_vuzpq_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint16_t a[8];
    uint16_t b[8];
    uint16_t r[2][8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x8x2_t r = easysimd_vuzpq_u16(a, b);
    easysimd_test_arm_neon_assert_equal_u16x8(r.val[0], easysimd_vld1q_u16(test_vec[i].r[0]));
    easysimd_test_arm_neon_assert_equal_u16x8(r.val[1], easysimd_vld1q_u16(test_vec[i].r[1]));
  }
...
static int
test_easysimd_vuzpq_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint32_t a[4];
    uint32_t b[4];
    uint32_t r[2][4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x4x2_t r = easysimd_vuzpq_u32(a, b);

    easysimd_test_arm_neon_assert_equal_u32x4(r.val[0], easysimd_vld1q_u32(test_vec[i].r[0]));
    easysimd_test_arm_neon_assert_equal_u32x4(r.val[1], easysimd_vld1q_u32(test_vec[i].r[1]));
  }
...
#if !defined(EASYSIMD_BUG_INTEL_857088)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vuzp_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vuzp_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vuzp_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vuzp_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vuzp_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vuzp_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vuzp_u32)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vuzpq_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vuzpq_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vuzpq_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vuzpq_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vuzpq_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vuzpq_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vuzpq_u32)
#endif /* !defined(EASYSIMD_BUG_INTEL_857088) */
