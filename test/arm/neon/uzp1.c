#define EASYSIMD_TEST_ARM_NEON_INSN uzp1

#include "test-neon.h"
#include "../../../easysimd/arm/neon/uzp1.h"

static int
test_easysimd_vuzp1_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    easysimd_float32 a[2];
    easysimd_float32 b[2];
    easysimd_float32 r[2];
  } test_vec[] = {
    { { EASYSIMD_FLOAT32_C(   188.14), EASYSIMD_FLOAT32_C(   -87.23) },
      { EASYSIMD_FLOAT32_C(  -966.94), EASYSIMD_FLOAT32_C(  -341.57) },
      { EASYSIMD_FLOAT32_C(   188.14), EASYSIMD_FLOAT32_C(  -966.94) } },
    { { EASYSIMD_FLOAT32_C(   682.15), EASYSIMD_FLOAT32_C(  -964.96) },
      { EASYSIMD_FLOAT32_C(   256.02), EASYSIMD_FLOAT32_C(   570.89) },
      { EASYSIMD_FLOAT32_C(   682.15), EASYSIMD_FLOAT32_C(   256.02) } },
    { { EASYSIMD_FLOAT32_C(  -610.16), EASYSIMD_FLOAT32_C(  -498.24) },
      { EASYSIMD_FLOAT32_C(  -566.43), EASYSIMD_FLOAT32_C(  -742.76) },
      { EASYSIMD_FLOAT32_C(  -610.16), EASYSIMD_FLOAT32_C(  -566.43) } },
    { { EASYSIMD_FLOAT32_C(   804.69), EASYSIMD_FLOAT32_C(  -146.31) },
      { EASYSIMD_FLOAT32_C(  -114.26), EASYSIMD_FLOAT32_C(   461.82) },
      { EASYSIMD_FLOAT32_C(   804.69), EASYSIMD_FLOAT32_C(  -114.26) } },
    { { EASYSIMD_FLOAT32_C(  -520.26), EASYSIMD_FLOAT32_C(   290.59) },
      { EASYSIMD_FLOAT32_C(   275.50), EASYSIMD_FLOAT32_C(  -573.98) },
      { EASYSIMD_FLOAT32_C(  -520.26), EASYSIMD_FLOAT32_C(   275.50) } },
    { { EASYSIMD_FLOAT32_C(   376.60), EASYSIMD_FLOAT32_C(   324.13) },
      { EASYSIMD_FLOAT32_C(   478.86), EASYSIMD_FLOAT32_C(   385.76) },
      { EASYSIMD_FLOAT32_C(   376.60), EASYSIMD_FLOAT32_C(   478.86) } },
    { { EASYSIMD_FLOAT32_C(  -299.73), EASYSIMD_FLOAT32_C(   292.94) },
      { EASYSIMD_FLOAT32_C(  -120.55), EASYSIMD_FLOAT32_C(   448.35) },
      { EASYSIMD_FLOAT32_C(  -299.73), EASYSIMD_FLOAT32_C(  -120.55) } },
    { { EASYSIMD_FLOAT32_C(   411.84), EASYSIMD_FLOAT32_C(   757.01) },
      { EASYSIMD_FLOAT32_C(  -355.19), EASYSIMD_FLOAT32_C(  -400.02) },
      { EASYSIMD_FLOAT32_C(   411.84), EASYSIMD_FLOAT32_C(  -355.19) } },
  };
...
static int
test_easysimd_vuzp1_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int8_t a[8];
    int8_t b[8];
    int8_t r[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int8x8_t r = easysimd_vuzp1_s8(a, b);
...
static int
test_easysimd_vuzp1_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int16_t a[4];
    int16_t b[4];
    int16_t r[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int16x4_t r = easysimd_vuzp1_s16(a, b);
...
static int
test_easysimd_vuzp1_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int32_t a[2];
    int32_t b[2];
    int32_t r[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x2_t r = easysimd_vuzp1_s32(a, b);
...
static int
test_easysimd_vuzp1_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint8_t a[8];
    uint8_t b[8];
    uint8_t r[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x8_t r = easysimd_vuzp1_u8(a, b);
...
static int
test_easysimd_vuzp1_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint16_t a[4];
    uint16_t b[4];
    uint16_t r[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x4_t r = easysimd_vuzp1_u16(a, b);
...
static int
test_easysimd_vuzp1_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint32_t a[2];
    uint32_t b[2];
    uint32_t r[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x2_t r = easysimd_vuzp1_u32(a, b);
...
static int
test_easysimd_vuzp1q_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    easysimd_float32 a[4];
    easysimd_float32 b[4];
    easysimd_float32 r[4];
  } test_vec[] = {
    { { EASYSIMD_FLOAT32_C(    44.64), EASYSIMD_FLOAT32_C(  -905.59), EASYSIMD_FLOAT32_C(  -768.48), EASYSIMD_FLOAT32_C(  -818.27) },
      { EASYSIMD_FLOAT32_C(   904.80), EASYSIMD_FLOAT32_C(  -408.01), EASYSIMD_FLOAT32_C(   720.84), EASYSIMD_FLOAT32_C(   882.26) },
      { EASYSIMD_FLOAT32_C(    44.64), EASYSIMD_FLOAT32_C(  -768.48), EASYSIMD_FLOAT32_C(   904.80), EASYSIMD_FLOAT32_C(   720.84) } },
    { { EASYSIMD_FLOAT32_C(  -100.34), EASYSIMD_FLOAT32_C(  -322.81), EASYSIMD_FLOAT32_C(   486.25), EASYSIMD_FLOAT32_C(  -834.82) },
      { EASYSIMD_FLOAT32_C(   981.41), EASYSIMD_FLOAT32_C(  -245.05), EASYSIMD_FLOAT32_C(  -204.05), EASYSIMD_FLOAT32_C(  -317.62) },
      { EASYSIMD_FLOAT32_C(  -100.34), EASYSIMD_FLOAT32_C(   486.25), EASYSIMD_FLOAT32_C(   981.41), EASYSIMD_FLOAT32_C(  -204.05) } },
    { { EASYSIMD_FLOAT32_C(   -41.99), EASYSIMD_FLOAT32_C(   859.14), EASYSIMD_FLOAT32_C(  -108.92), EASYSIMD_FLOAT32_C(   737.09) },
      { EASYSIMD_FLOAT32_C(   401.23), EASYSIMD_FLOAT32_C(    -9.98), EASYSIMD_FLOAT32_C(  -396.63), EASYSIMD_FLOAT32_C(   925.63) },
      { EASYSIMD_FLOAT32_C(   -41.99), EASYSIMD_FLOAT32_C(  -108.92), EASYSIMD_FLOAT32_C(   401.23), EASYSIMD_FLOAT32_C(  -396.63) } },
    { { EASYSIMD_FLOAT32_C(  -768.54), EASYSIMD_FLOAT32_C(   832.74), EASYSIMD_FLOAT32_C(   920.95), EASYSIMD_FLOAT32_C(  -472.96) },
      { EASYSIMD_FLOAT32_C(  -329.25), EASYSIMD_FLOAT32_C(  -890.65), EASYSIMD_FLOAT32_C(  -956.60), EASYSIMD_FLOAT32_C(   715.39) },
      { EASYSIMD_FLOAT32_C(  -768.54), EASYSIMD_FLOAT32_C(   920.95), EASYSIMD_FLOAT32_C(  -329.25), EASYSIMD_FLOAT32_C(  -956.60) } },
    { { EASYSIMD_FLOAT32_C(  -796.25), EASYSIMD_FLOAT32_C(  -725.08), EASYSIMD_FLOAT32_C(   897.12), EASYSIMD_FLOAT32_C(  -891.44) },
      { EASYSIMD_FLOAT32_C(  -133.09), EASYSIMD_FLOAT32_C(   617.96), EASYSIMD_FLOAT32_C(   990.81), EASYSIMD_FLOAT32_C(   766.56) },
      { EASYSIMD_FLOAT32_C(  -796.25), EASYSIMD_FLOAT32_C(   897.12), EASYSIMD_FLOAT32_C(  -133.09), EASYSIMD_FLOAT32_C(   990.81) } },
    { { EASYSIMD_FLOAT32_C(  -704.85), EASYSIMD_FLOAT32_C(   477.06), EASYSIMD_FLOAT32_C(   931.74), EASYSIMD_FLOAT32_C(  -723.44) },
      { EASYSIMD_FLOAT32_C(  -767.99), EASYSIMD_FLOAT32_C(  -272.30), EASYSIMD_FLOAT32_C(   -41.06), EASYSIMD_FLOAT32_C(   190.02) },
      { EASYSIMD_FLOAT32_C(  -704.85), EASYSIMD_FLOAT32_C(   931.74), EASYSIMD_FLOAT32_C(  -767.99), EASYSIMD_FLOAT32_C(   -41.06) } },
    { { EASYSIMD_FLOAT32_C(  -413.17), EASYSIMD_FLOAT32_C(   850.02), EASYSIMD_FLOAT32_C(   -72.89), EASYSIMD_FLOAT32_C(   988.07) },
      { EASYSIMD_FLOAT32_C(  -159.95), EASYSIMD_FLOAT32_C(   530.48), EASYSIMD_FLOAT32_C(   913.70), EASYSIMD_FLOAT32_C(    71.51) },
      { EASYSIMD_FLOAT32_C(  -413.17), EASYSIMD_FLOAT32_C(   -72.89), EASYSIMD_FLOAT32_C(  -159.95), EASYSIMD_FLOAT32_C(   913.70) } },
    { { EASYSIMD_FLOAT32_C(   363.22), EASYSIMD_FLOAT32_C(   834.65), EASYSIMD_FLOAT32_C(   598.55), EASYSIMD_FLOAT32_C(  -966.03) },
      { EASYSIMD_FLOAT32_C(   943.99), EASYSIMD_FLOAT32_C(   641.95), EASYSIMD_FLOAT32_C(   749.36), EASYSIMD_FLOAT32_C(  -852.25) },
      { EASYSIMD_FLOAT32_C(   363.22), EASYSIMD_FLOAT32_C(   598.55), EASYSIMD_FLOAT32_C(   943.99), EASYSIMD_FLOAT32_C(   749.36) } },
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float32x4_t a = easysimd_vld1q_f32(test_vec[i].a);
    easysimd_float32x4_t b = easysimd_vld1q_f32(test_vec[i].b);
    easysimd_float32x4_t r = easysimd_vuzp1q_f32(a, b);
...
static int
test_easysimd_vuzp1q_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    easysimd_float64 a[2];
    easysimd_float64 b[2];
    easysimd_float64 r[2];
  } test_vec[] = {
    { { EASYSIMD_FLOAT64_C(   322.53), EASYSIMD_FLOAT64_C(   856.49) },
      { EASYSIMD_FLOAT64_C(   802.23), EASYSIMD_FLOAT64_C(   452.91) },
      { EASYSIMD_FLOAT64_C(   322.53), EASYSIMD_FLOAT64_C(   802.23) } },
    { { EASYSIMD_FLOAT64_C(   459.71), EASYSIMD_FLOAT64_C(  -770.97) },
      { EASYSIMD_FLOAT64_C(   594.98), EASYSIMD_FLOAT64_C(   107.24) },
      { EASYSIMD_FLOAT64_C(   459.71), EASYSIMD_FLOAT64_C(   594.98) } },
    { { EASYSIMD_FLOAT64_C(   374.90), EASYSIMD_FLOAT64_C(   400.47) },
      { EASYSIMD_FLOAT64_C(   344.98), EASYSIMD_FLOAT64_C(  -972.39) },
      { EASYSIMD_FLOAT64_C(   374.90), EASYSIMD_FLOAT64_C(   344.98) } },
    { { EASYSIMD_FLOAT64_C(  -625.14), EASYSIMD_FLOAT64_C(     7.91) },
      { EASYSIMD_FLOAT64_C(    75.57), EASYSIMD_FLOAT64_C(   770.62) },
      { EASYSIMD_FLOAT64_C(  -625.14), EASYSIMD_FLOAT64_C(    75.57) } },
    { { EASYSIMD_FLOAT64_C(   809.69), EASYSIMD_FLOAT64_C(  -906.73) },
      { EASYSIMD_FLOAT64_C(   321.38), EASYSIMD_FLOAT64_C(  -635.84) },
      { EASYSIMD_FLOAT64_C(   809.69), EASYSIMD_FLOAT64_C(   321.38) } },
    { { EASYSIMD_FLOAT64_C(   759.95), EASYSIMD_FLOAT64_C(   514.69) },
      { EASYSIMD_FLOAT64_C(  -113.83), EASYSIMD_FLOAT64_C(   699.68) },
      { EASYSIMD_FLOAT64_C(   759.95), EASYSIMD_FLOAT64_C(  -113.83) } },
    { { EASYSIMD_FLOAT64_C(   226.46), EASYSIMD_FLOAT64_C(    68.20) },
      { EASYSIMD_FLOAT64_C(   -55.03), EASYSIMD_FLOAT64_C(  -667.20) },
      { EASYSIMD_FLOAT64_C(   226.46), EASYSIMD_FLOAT64_C(   -55.03) } },
    { { EASYSIMD_FLOAT64_C(   435.49), EASYSIMD_FLOAT64_C(  -654.23) },
      { EASYSIMD_FLOAT64_C(  -732.44), EASYSIMD_FLOAT64_C(  -241.98) },
      { EASYSIMD_FLOAT64_C(   435.49), EASYSIMD_FLOAT64_C(  -732.44) } },
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float64x2_t a = easysimd_vld1q_f64(test_vec[i].a);
    easysimd_float64x2_t b = easysimd_vld1q_f64(test_vec[i].b);
    easysimd_float64x2_t r = easysimd_vuzp1q_f64(a, b);
...
static int
test_easysimd_vuzp1q_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int8_t a[16];
    int8_t b[16];
    int8_t r[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int8x16_t r = easysimd_vuzp1q_s8(a, b);
...
static int
test_easysimd_vuzp1q_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int16_t a[8];
    int16_t b[8];
    int16_t r[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int16x8_t r = easysimd_vuzp1q_s16(a, b);
...
static int
test_easysimd_vuzp1q_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int32_t a[4];
    int32_t b[4];
    int32_t r[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x4_t r = easysimd_vuzp1q_s32(a, b);
...
static int
test_easysimd_vuzp1q_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int64_t a[2];
    int64_t b[2];
    int64_t r[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int64x2_t r = easysimd_vuzp1q_s64(a, b);
...
static int
test_easysimd_vuzp1q_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint8_t a[16];
    uint8_t b[16];
    uint8_t r[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x16_t r = easysimd_vuzp1q_u8(a, b);
...
static int
test_easysimd_vuzp1q_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint16_t a[8];
    uint16_t b[8];
    uint16_t r[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x8_t r = easysimd_vuzp1q_u16(a, b);
...
static int
test_easysimd_vuzp1q_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint32_t a[4];
    uint32_t b[4];
    uint32_t r[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x4_t r = easysimd_vuzp1q_u32(a, b);
...
static int
test_easysimd_vuzp1q_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint64_t a[2];
    uint64_t b[2];
    uint64_t r[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint64x2_t r = easysimd_vuzp1q_u64(a, b);
...
EASYSIMD_TEST_FUNC_LIST_ENTRY(vuzp1_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vuzp1_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vuzp1_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vuzp1_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vuzp1_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vuzp1_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vuzp1_u32)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vuzp1q_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vuzp1q_f64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vuzp1q_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vuzp1q_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vuzp1q_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vuzp1q_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vuzp1q_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vuzp1q_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vuzp1q_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vuzp1q_u64)
