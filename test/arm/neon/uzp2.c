#define EASYSIMD_TEST_ARM_NEON_INSN uzp2

#include "test-neon.h"
#include "../../../easysimd/arm/neon/uzp2.h"

static int
test_easysimd_vuzp2_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    easysimd_float32 a[2];
    easysimd_float32 b[2];
    easysimd_float32 r[2];
  } test_vec[] = {
    { { EASYSIMD_FLOAT32_C(   343.73), EASYSIMD_FLOAT32_C(  -384.82) },
      { EASYSIMD_FLOAT32_C(   348.76), EASYSIMD_FLOAT32_C(   874.35) },
      { EASYSIMD_FLOAT32_C(  -384.82), EASYSIMD_FLOAT32_C(   874.35) } },
    { { EASYSIMD_FLOAT32_C(   328.67), EASYSIMD_FLOAT32_C(  -556.62) },
      { EASYSIMD_FLOAT32_C(  -584.13), EASYSIMD_FLOAT32_C(   886.34) },
      { EASYSIMD_FLOAT32_C(  -556.62), EASYSIMD_FLOAT32_C(   886.34) } },
    { { EASYSIMD_FLOAT32_C(  -727.41), EASYSIMD_FLOAT32_C(   622.83) },
      { EASYSIMD_FLOAT32_C(  -328.14), EASYSIMD_FLOAT32_C(   552.33) },
      { EASYSIMD_FLOAT32_C(   622.83), EASYSIMD_FLOAT32_C(   552.33) } },
    { { EASYSIMD_FLOAT32_C(   169.12), EASYSIMD_FLOAT32_C(   762.41) },
      { EASYSIMD_FLOAT32_C(  -165.94), EASYSIMD_FLOAT32_C(   247.93) },
      { EASYSIMD_FLOAT32_C(   762.41), EASYSIMD_FLOAT32_C(   247.93) } },
    { { EASYSIMD_FLOAT32_C(   975.47), EASYSIMD_FLOAT32_C(   559.60) },
      { EASYSIMD_FLOAT32_C(   -75.67), EASYSIMD_FLOAT32_C(   142.37) },
      { EASYSIMD_FLOAT32_C(   559.60), EASYSIMD_FLOAT32_C(   142.37) } },
    { { EASYSIMD_FLOAT32_C(  -342.52), EASYSIMD_FLOAT32_C(  -803.88) },
      { EASYSIMD_FLOAT32_C(  -138.51), EASYSIMD_FLOAT32_C(  -568.39) },
      { EASYSIMD_FLOAT32_C(  -803.88), EASYSIMD_FLOAT32_C(  -568.39) } },
    { { EASYSIMD_FLOAT32_C(   706.38), EASYSIMD_FLOAT32_C(  -329.34) },
      { EASYSIMD_FLOAT32_C(  -697.68), EASYSIMD_FLOAT32_C(   236.14) },
      { EASYSIMD_FLOAT32_C(  -329.34), EASYSIMD_FLOAT32_C(   236.14) } },
    { { EASYSIMD_FLOAT32_C(   537.08), EASYSIMD_FLOAT32_C(   467.12) },
      { EASYSIMD_FLOAT32_C(   923.63), EASYSIMD_FLOAT32_C(  -119.19) },
      { EASYSIMD_FLOAT32_C(   467.12), EASYSIMD_FLOAT32_C(  -119.19) } },
  };
...
static int
test_easysimd_vuzp2_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int8_t a[8];
    int8_t b[8];
    int8_t r[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int8x8_t r = easysimd_vuzp2_s8(a, b);
...
static int
test_easysimd_vuzp2_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int16_t a[4];
    int16_t b[4];
    int16_t r[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int16x4_t r = easysimd_vuzp2_s16(a, b);
...
static int
test_easysimd_vuzp2_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int32_t a[2];
    int32_t b[2];
    int32_t r[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x2_t r = easysimd_vuzp2_s32(a, b);
...
static int
test_easysimd_vuzp2_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint8_t a[8];
    uint8_t b[8];
    uint8_t r[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x8_t r = easysimd_vuzp2_u8(a, b);
...
static int
test_easysimd_vuzp2_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint16_t a[4];
    uint16_t b[4];
    uint16_t r[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x4_t r = easysimd_vuzp2_u16(a, b);
...
static int
test_easysimd_vuzp2_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint32_t a[2];
    uint32_t b[2];
    uint32_t r[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x2_t r = easysimd_vuzp2_u32(a, b);
...
static int
test_easysimd_vuzp2q_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    easysimd_float32 a[4];
    easysimd_float32 b[4];
    easysimd_float32 r[4];
  } test_vec[] = {
    { { EASYSIMD_FLOAT32_C(  -781.39), EASYSIMD_FLOAT32_C(    88.58), EASYSIMD_FLOAT32_C(   100.41), EASYSIMD_FLOAT32_C(   266.53) },
      { EASYSIMD_FLOAT32_C(   803.29), EASYSIMD_FLOAT32_C(  -418.13), EASYSIMD_FLOAT32_C(    24.45), EASYSIMD_FLOAT32_C(   955.27) },
      { EASYSIMD_FLOAT32_C(    88.58), EASYSIMD_FLOAT32_C(   266.53), EASYSIMD_FLOAT32_C(  -418.13), EASYSIMD_FLOAT32_C(   955.27) } },
    { { EASYSIMD_FLOAT32_C(   -28.60), EASYSIMD_FLOAT32_C(  -622.57), EASYSIMD_FLOAT32_C(   870.72), EASYSIMD_FLOAT32_C(   957.13) },
      { EASYSIMD_FLOAT32_C(  -115.95), EASYSIMD_FLOAT32_C(  -205.52), EASYSIMD_FLOAT32_C(  -866.47), EASYSIMD_FLOAT32_C(  -650.57) },
      { EASYSIMD_FLOAT32_C(  -622.57), EASYSIMD_FLOAT32_C(   957.13), EASYSIMD_FLOAT32_C(  -205.52), EASYSIMD_FLOAT32_C(  -650.57) } },
    { { EASYSIMD_FLOAT32_C(   110.44), EASYSIMD_FLOAT32_C(   300.16), EASYSIMD_FLOAT32_C(  -300.84), EASYSIMD_FLOAT32_C(   217.46) },
      { EASYSIMD_FLOAT32_C(  -171.62), EASYSIMD_FLOAT32_C(   375.64), EASYSIMD_FLOAT32_C(   342.58), EASYSIMD_FLOAT32_C(    76.53) },
      { EASYSIMD_FLOAT32_C(   300.16), EASYSIMD_FLOAT32_C(   217.46), EASYSIMD_FLOAT32_C(   375.64), EASYSIMD_FLOAT32_C(    76.53) } },
    { { EASYSIMD_FLOAT32_C(  -412.19), EASYSIMD_FLOAT32_C(  -951.34), EASYSIMD_FLOAT32_C(   730.36), EASYSIMD_FLOAT32_C(   100.26) },
      { EASYSIMD_FLOAT32_C(   107.62), EASYSIMD_FLOAT32_C(   786.75), EASYSIMD_FLOAT32_C(   778.67), EASYSIMD_FLOAT32_C(   326.23) },
      { EASYSIMD_FLOAT32_C(  -951.34), EASYSIMD_FLOAT32_C(   100.26), EASYSIMD_FLOAT32_C(   786.75), EASYSIMD_FLOAT32_C(   326.23) } },
    { { EASYSIMD_FLOAT32_C(  -124.68), EASYSIMD_FLOAT32_C(  -120.92), EASYSIMD_FLOAT32_C(  -407.25), EASYSIMD_FLOAT32_C(  -321.39) },
      { EASYSIMD_FLOAT32_C(   460.95), EASYSIMD_FLOAT32_C(   617.20), EASYSIMD_FLOAT32_C(  -366.12), EASYSIMD_FLOAT32_C(  -567.65) },
      { EASYSIMD_FLOAT32_C(  -120.92), EASYSIMD_FLOAT32_C(  -321.39), EASYSIMD_FLOAT32_C(   617.20), EASYSIMD_FLOAT32_C(  -567.65) } },
    { { EASYSIMD_FLOAT32_C(   994.64), EASYSIMD_FLOAT32_C(  -495.39), EASYSIMD_FLOAT32_C(  -610.52), EASYSIMD_FLOAT32_C(  -121.31) },
      { EASYSIMD_FLOAT32_C(   299.08), EASYSIMD_FLOAT32_C(  -477.00), EASYSIMD_FLOAT32_C(   228.11), EASYSIMD_FLOAT32_C(  -590.48) },
      { EASYSIMD_FLOAT32_C(  -495.39), EASYSIMD_FLOAT32_C(  -121.31), EASYSIMD_FLOAT32_C(  -477.00), EASYSIMD_FLOAT32_C(  -590.48) } },
    { { EASYSIMD_FLOAT32_C(   823.17), EASYSIMD_FLOAT32_C(   927.28), EASYSIMD_FLOAT32_C(   626.99), EASYSIMD_FLOAT32_C(  -348.45) },
      { EASYSIMD_FLOAT32_C(   302.91), EASYSIMD_FLOAT32_C(   -30.44), EASYSIMD_FLOAT32_C(   728.08), EASYSIMD_FLOAT32_C(   890.73) },
      { EASYSIMD_FLOAT32_C(   927.28), EASYSIMD_FLOAT32_C(  -348.45), EASYSIMD_FLOAT32_C(   -30.44), EASYSIMD_FLOAT32_C(   890.73) } },
    { { EASYSIMD_FLOAT32_C(    18.22), EASYSIMD_FLOAT32_C(   458.45), EASYSIMD_FLOAT32_C(    -9.02), EASYSIMD_FLOAT32_C(  -874.16) },
      { EASYSIMD_FLOAT32_C(   245.19), EASYSIMD_FLOAT32_C(  -230.35), EASYSIMD_FLOAT32_C(   452.07), EASYSIMD_FLOAT32_C(  -879.48) },
      { EASYSIMD_FLOAT32_C(   458.45), EASYSIMD_FLOAT32_C(  -874.16), EASYSIMD_FLOAT32_C(  -230.35), EASYSIMD_FLOAT32_C(  -879.48) } },
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float32x4_t a = easysimd_vld1q_f32(test_vec[i].a);
    easysimd_float32x4_t b = easysimd_vld1q_f32(test_vec[i].b);
    easysimd_float32x4_t r = easysimd_vuzp2q_f32(a, b);
...
static int
test_easysimd_vuzp2q_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    easysimd_float64 a[2];
    easysimd_float64 b[2];
    easysimd_float64 r[2];
  } test_vec[] = {
    { { EASYSIMD_FLOAT64_C(  -339.85), EASYSIMD_FLOAT64_C(  -574.12) },
      { EASYSIMD_FLOAT64_C(   477.11), EASYSIMD_FLOAT64_C(   -17.44) },
      { EASYSIMD_FLOAT64_C(  -574.12), EASYSIMD_FLOAT64_C(   -17.44) } },
    { { EASYSIMD_FLOAT64_C(  -819.58), EASYSIMD_FLOAT64_C(  -361.32) },
      { EASYSIMD_FLOAT64_C(  -283.52), EASYSIMD_FLOAT64_C(   -25.85) },
      { EASYSIMD_FLOAT64_C(  -361.32), EASYSIMD_FLOAT64_C(   -25.85) } },
    { { EASYSIMD_FLOAT64_C(   881.34), EASYSIMD_FLOAT64_C(   140.92) },
      { EASYSIMD_FLOAT64_C(  -394.34), EASYSIMD_FLOAT64_C(   314.91) },
      { EASYSIMD_FLOAT64_C(   140.92), EASYSIMD_FLOAT64_C(   314.91) } },
    { { EASYSIMD_FLOAT64_C(  -960.58), EASYSIMD_FLOAT64_C(   916.46) },
      { EASYSIMD_FLOAT64_C(    40.77), EASYSIMD_FLOAT64_C(   550.34) },
      { EASYSIMD_FLOAT64_C(   916.46), EASYSIMD_FLOAT64_C(   550.34) } },
    { { EASYSIMD_FLOAT64_C(   784.55), EASYSIMD_FLOAT64_C(  -320.66) },
      { EASYSIMD_FLOAT64_C(   942.86), EASYSIMD_FLOAT64_C(   541.82) },
      { EASYSIMD_FLOAT64_C(  -320.66), EASYSIMD_FLOAT64_C(   541.82) } },
    { { EASYSIMD_FLOAT64_C(   991.85), EASYSIMD_FLOAT64_C(   533.80) },
      { EASYSIMD_FLOAT64_C(  -388.26), EASYSIMD_FLOAT64_C(   204.04) },
      { EASYSIMD_FLOAT64_C(   533.80), EASYSIMD_FLOAT64_C(   204.04) } },
    { { EASYSIMD_FLOAT64_C(   -77.27), EASYSIMD_FLOAT64_C(   884.24) },
      { EASYSIMD_FLOAT64_C(   202.14), EASYSIMD_FLOAT64_C(   892.43) },
      { EASYSIMD_FLOAT64_C(   884.24), EASYSIMD_FLOAT64_C(   892.43) } },
    { { EASYSIMD_FLOAT64_C(  -326.62), EASYSIMD_FLOAT64_C(  -793.35) },
      { EASYSIMD_FLOAT64_C(  -340.99), EASYSIMD_FLOAT64_C(   333.54) },
      { EASYSIMD_FLOAT64_C(  -793.35), EASYSIMD_FLOAT64_C(   333.54) } },
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float64x2_t a = easysimd_vld1q_f64(test_vec[i].a);
    easysimd_float64x2_t b = easysimd_vld1q_f64(test_vec[i].b);
    easysimd_float64x2_t r = easysimd_vuzp2q_f64(a, b);
...
static int
test_easysimd_vuzp2q_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int8_t a[16];
    int8_t b[16];
    int8_t r[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int8x16_t r = easysimd_vuzp2q_s8(a, b);
...
static int
test_easysimd_vuzp2q_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int16_t a[8];
    int16_t b[8];
    int16_t r[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int16x8_t r = easysimd_vuzp2q_s16(a, b);
...
static int
test_easysimd_vuzp2q_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int32_t a[4];
    int32_t b[4];
    int32_t r[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x4_t r = easysimd_vuzp2q_s32(a, b);
...
static int
test_easysimd_vuzp2q_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int64_t a[2];
    int64_t b[2];
    int64_t r[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int64x2_t r = easysimd_vuzp2q_s64(a, b);
...
static int
test_easysimd_vuzp2q_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint8_t a[16];
    uint8_t b[16];
    uint8_t r[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x16_t r = easysimd_vuzp2q_u8(a, b);
...
static int
test_easysimd_vuzp2q_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint16_t a[8];
    uint16_t b[8];
    uint16_t r[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x8_t r = easysimd_vuzp2q_u16(a, b);
...
static int
test_easysimd_vuzp2q_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint32_t a[4];
    uint32_t b[4];
    uint32_t r[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x4_t r = easysimd_vuzp2q_u32(a, b);
...
static int
test_easysimd_vuzp2q_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint64_t a[2];
    uint64_t b[2];
    uint64_t r[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint64x2_t r = easysimd_vuzp2q_u64(a, b);
...
EASYSIMD_TEST_FUNC_LIST_ENTRY(vuzp2_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vuzp2_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vuzp2_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vuzp2_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vuzp2_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vuzp2_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vuzp2_u32)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vuzp2q_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vuzp2q_f64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vuzp2q_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vuzp2q_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vuzp2q_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vuzp2q_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vuzp2q_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vuzp2q_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vuzp2q_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vuzp2q_u64)
