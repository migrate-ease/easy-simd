#define EASYSIMD_TEST_ARM_NEON_INSN zip

#include <test/arm/neon/test-neon.h>
#include <easysimd/arm/neon/zip.h>

#if !defined(EASYSIMD_BUG_INTEL_857088)

static int
test_easysimd_vzip_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    easysimd_float32 a[2];
    easysimd_float32 b[2];
    easysimd_float32 r[2][2];
  } test_vec[] = {
    { { EASYSIMD_FLOAT32_C(  -358.82), EASYSIMD_FLOAT32_C(    78.84) },
      { EASYSIMD_FLOAT32_C(   983.85), EASYSIMD_FLOAT32_C(  -720.74) },
      {
          { EASYSIMD_FLOAT32_C(  -358.82), EASYSIMD_FLOAT32_C(   983.85) },
          { EASYSIMD_FLOAT32_C(    78.84), EASYSIMD_FLOAT32_C(  -720.74) },
      },
    },
    { { EASYSIMD_FLOAT32_C(   775.76), EASYSIMD_FLOAT32_C(   749.10) },
      { EASYSIMD_FLOAT32_C(  -498.97), EASYSIMD_FLOAT32_C(   508.88) },
      {
          { EASYSIMD_FLOAT32_C(   775.76), EASYSIMD_FLOAT32_C(  -498.97) },
          { EASYSIMD_FLOAT32_C(   749.10), EASYSIMD_FLOAT32_C(   508.88) },
      },
    },
    { { EASYSIMD_FLOAT32_C(  -772.99), EASYSIMD_FLOAT32_C(  -138.42) },
      { EASYSIMD_FLOAT32_C(   768.93), EASYSIMD_FLOAT32_C(  -389.94) },
      {
          { EASYSIMD_FLOAT32_C(  -772.99), EASYSIMD_FLOAT32_C(   768.93) },
          { EASYSIMD_FLOAT32_C(  -138.42), EASYSIMD_FLOAT32_C(  -389.94) },
      },
    },
    { { EASYSIMD_FLOAT32_C(   998.17), EASYSIMD_FLOAT32_C(  -286.00) },
      { EASYSIMD_FLOAT32_C(   648.24), EASYSIMD_FLOAT32_C(  -347.96) },
      {
          { EASYSIMD_FLOAT32_C(   998.17), EASYSIMD_FLOAT32_C(   648.24) },
          { EASYSIMD_FLOAT32_C(  -286.00), EASYSIMD_FLOAT32_C(  -347.96) },
      },
    },
    { { EASYSIMD_FLOAT32_C(  -694.32), EASYSIMD_FLOAT32_C(  -443.35) },
      { EASYSIMD_FLOAT32_C(  -763.65), EASYSIMD_FLOAT32_C(   250.75) },
      {
          { EASYSIMD_FLOAT32_C(  -694.32), EASYSIMD_FLOAT32_C(  -763.65) },
          { EASYSIMD_FLOAT32_C(  -443.35), EASYSIMD_FLOAT32_C(   250.75) },
      },
    },
    { { EASYSIMD_FLOAT32_C(   -26.88), EASYSIMD_FLOAT32_C(  -994.99) },
      { EASYSIMD_FLOAT32_C(   145.10), EASYSIMD_FLOAT32_C(  -814.15) },
      {
          { EASYSIMD_FLOAT32_C(   -26.88), EASYSIMD_FLOAT32_C(   145.10) },
          { EASYSIMD_FLOAT32_C(  -994.99), EASYSIMD_FLOAT32_C(  -814.15) },
      },
    },
    { { EASYSIMD_FLOAT32_C(   982.86), EASYSIMD_FLOAT32_C(  -888.57) },
      { EASYSIMD_FLOAT32_C(  -651.00), EASYSIMD_FLOAT32_C(   623.08) },
      {
          { EASYSIMD_FLOAT32_C(   982.86), EASYSIMD_FLOAT32_C(  -651.00) },
          { EASYSIMD_FLOAT32_C(  -888.57), EASYSIMD_FLOAT32_C(   623.08) },
      },
    },
    { { EASYSIMD_FLOAT32_C(  -237.29), EASYSIMD_FLOAT32_C(    58.52) },
      { EASYSIMD_FLOAT32_C(   -15.19), EASYSIMD_FLOAT32_C(   403.89) },
      {
          { EASYSIMD_FLOAT32_C(  -237.29), EASYSIMD_FLOAT32_C(   -15.19) },
          { EASYSIMD_FLOAT32_C(    58.52), EASYSIMD_FLOAT32_C(   403.89) },
      },
    },
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_float32x2x2_t r = easysimd_vzip_f32(a, b);
...
static int
test_easysimd_vzip_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int8_t a[8];
    int8_t b[8];
    int8_t r[2][8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int8x8x2_t r = easysimd_vzip_s8(a, b);
...
static int
test_easysimd_vzip_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int16_t a[4];
    int16_t b[4];
    int16_t r[2][4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int16x4x2_t r = easysimd_vzip_s16(a, b);
...
static int
test_easysimd_vzip_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int32_t a[2];
    int32_t b[2];
    int32_t r[2][2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x2x2_t r = easysimd_vzip_s32(a, b);
...
static int
test_easysimd_vzip_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint8_t a[8];
    uint8_t b[8];
    uint8_t r[2][8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x8x2_t r = easysimd_vzip_u8(a, b);
...
static int
test_easysimd_vzip_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint16_t a[4];
    uint16_t b[4];
    uint16_t r[2][4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x4x2_t r = easysimd_vzip_u16(a, b);
...
static int
test_easysimd_vzip_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint32_t a[2];
    uint32_t b[2];
    uint32_t r[2][2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x2x2_t r = easysimd_vzip_u32(a, b);
...
static int
test_easysimd_vzipq_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    easysimd_float32 a[4];
    easysimd_float32 b[4];
    easysimd_float32 r[2][4];
  } test_vec[] = {
    { { EASYSIMD_FLOAT32_C(  -748.99), EASYSIMD_FLOAT32_C(  -706.11), EASYSIMD_FLOAT32_C(   869.97), EASYSIMD_FLOAT32_C(   247.18) },
      { EASYSIMD_FLOAT32_C(   281.30), EASYSIMD_FLOAT32_C(  -318.87), EASYSIMD_FLOAT32_C(  -402.07), EASYSIMD_FLOAT32_C(   850.87) },
      {
          { EASYSIMD_FLOAT32_C(  -748.99), EASYSIMD_FLOAT32_C(   281.30), EASYSIMD_FLOAT32_C(  -706.11), EASYSIMD_FLOAT32_C(  -318.87) },
          { EASYSIMD_FLOAT32_C(   869.97), EASYSIMD_FLOAT32_C(  -402.07), EASYSIMD_FLOAT32_C(   247.18), EASYSIMD_FLOAT32_C(   850.87) },
      },
    },
    { { EASYSIMD_FLOAT32_C(  -830.23), EASYSIMD_FLOAT32_C(  -661.11), EASYSIMD_FLOAT32_C(  -631.24), EASYSIMD_FLOAT32_C(   130.32) },
      { EASYSIMD_FLOAT32_C(  -203.49), EASYSIMD_FLOAT32_C(   634.65), EASYSIMD_FLOAT32_C(   396.96), EASYSIMD_FLOAT32_C(   711.13) },
      {
          { EASYSIMD_FLOAT32_C(  -830.23), EASYSIMD_FLOAT32_C(  -203.49), EASYSIMD_FLOAT32_C(  -661.11), EASYSIMD_FLOAT32_C(   634.65) },
          { EASYSIMD_FLOAT32_C(  -631.24), EASYSIMD_FLOAT32_C(   396.96), EASYSIMD_FLOAT32_C(   130.32), EASYSIMD_FLOAT32_C(   711.13) },
      },
    },
    { { EASYSIMD_FLOAT32_C(   282.82), EASYSIMD_FLOAT32_C(   202.09), EASYSIMD_FLOAT32_C(  -453.11), EASYSIMD_FLOAT32_C(   640.01) },
      { EASYSIMD_FLOAT32_C(   822.42), EASYSIMD_FLOAT32_C(   187.30), EASYSIMD_FLOAT32_C(    18.58), EASYSIMD_FLOAT32_C(   809.63) },
      {
          { EASYSIMD_FLOAT32_C(   282.82), EASYSIMD_FLOAT32_C(   822.42), EASYSIMD_FLOAT32_C(   202.09), EASYSIMD_FLOAT32_C(   187.30) },
          { EASYSIMD_FLOAT32_C(  -453.11), EASYSIMD_FLOAT32_C(    18.58), EASYSIMD_FLOAT32_C(   640.01), EASYSIMD_FLOAT32_C(   809.63) },
      },
    },
    { { EASYSIMD_FLOAT32_C(  -225.67), EASYSIMD_FLOAT32_C(   681.44), EASYSIMD_FLOAT32_C(   463.00), EASYSIMD_FLOAT32_C(   309.35) },
      { EASYSIMD_FLOAT32_C(   589.93), EASYSIMD_FLOAT32_C(   877.78), EASYSIMD_FLOAT32_C(   246.23), EASYSIMD_FLOAT32_C(   840.94) },
      {
          { EASYSIMD_FLOAT32_C(  -225.67), EASYSIMD_FLOAT32_C(   589.93), EASYSIMD_FLOAT32_C(   681.44), EASYSIMD_FLOAT32_C(   877.78) },
          { EASYSIMD_FLOAT32_C(   463.00), EASYSIMD_FLOAT32_C(   246.23), EASYSIMD_FLOAT32_C(   309.35), EASYSIMD_FLOAT32_C(   840.94) },
      },
    },
    { { EASYSIMD_FLOAT32_C(  -828.33), EASYSIMD_FLOAT32_C(   116.19), EASYSIMD_FLOAT32_C(    88.12), EASYSIMD_FLOAT32_C(   452.97) },
      { EASYSIMD_FLOAT32_C(   797.32), EASYSIMD_FLOAT32_C(   686.05), EASYSIMD_FLOAT32_C(   303.84), EASYSIMD_FLOAT32_C(   967.09) },
      {
          { EASYSIMD_FLOAT32_C(  -828.33), EASYSIMD_FLOAT32_C(   797.32), EASYSIMD_FLOAT32_C(   116.19), EASYSIMD_FLOAT32_C(   686.05) },
          { EASYSIMD_FLOAT32_C(    88.12), EASYSIMD_FLOAT32_C(   303.84), EASYSIMD_FLOAT32_C(   452.97), EASYSIMD_FLOAT32_C(   967.09) },
      },
    },
    { { EASYSIMD_FLOAT32_C(  -975.06), EASYSIMD_FLOAT32_C(   672.60), EASYSIMD_FLOAT32_C(    97.41), EASYSIMD_FLOAT32_C(  -178.55) },
      { EASYSIMD_FLOAT32_C(   307.24), EASYSIMD_FLOAT32_C(  -505.62), EASYSIMD_FLOAT32_C(  -467.42), EASYSIMD_FLOAT32_C(  -409.94) },
      {
          { EASYSIMD_FLOAT32_C(  -975.06), EASYSIMD_FLOAT32_C(   307.24), EASYSIMD_FLOAT32_C(   672.60), EASYSIMD_FLOAT32_C(  -505.62) },
          { EASYSIMD_FLOAT32_C(    97.41), EASYSIMD_FLOAT32_C(  -467.42), EASYSIMD_FLOAT32_C(  -178.55), EASYSIMD_FLOAT32_C(  -409.94) },
      },
    },
    { { EASYSIMD_FLOAT32_C(   696.47), EASYSIMD_FLOAT32_C(    79.47), EASYSIMD_FLOAT32_C(  -769.92), EASYSIMD_FLOAT32_C(   518.88) },
      { EASYSIMD_FLOAT32_C(  -733.23), EASYSIMD_FLOAT32_C(   248.65), EASYSIMD_FLOAT32_C(   328.52), EASYSIMD_FLOAT32_C(    41.09) },
      {
          { EASYSIMD_FLOAT32_C(   696.47), EASYSIMD_FLOAT32_C(  -733.23), EASYSIMD_FLOAT32_C(    79.47), EASYSIMD_FLOAT32_C(   248.65) },
          { EASYSIMD_FLOAT32_C(  -769.92), EASYSIMD_FLOAT32_C(   328.52), EASYSIMD_FLOAT32_C(   518.88), EASYSIMD_FLOAT32_C(    41.09) },
      },
    },
    { { EASYSIMD_FLOAT32_C(   -69.90), EASYSIMD_FLOAT32_C(  -208.48), EASYSIMD_FLOAT32_C(  -649.56), EASYSIMD_FLOAT32_C(  -479.97) },
      { EASYSIMD_FLOAT32_C(  -330.70), EASYSIMD_FLOAT32_C(   596.67), EASYSIMD_FLOAT32_C(  -639.03), EASYSIMD_FLOAT32_C(  -159.03) },
      {
          { EASYSIMD_FLOAT32_C(   -69.90), EASYSIMD_FLOAT32_C(  -330.70), EASYSIMD_FLOAT32_C(  -208.48), EASYSIMD_FLOAT32_C(   596.67) },
          { EASYSIMD_FLOAT32_C(  -649.56), EASYSIMD_FLOAT32_C(  -639.03), EASYSIMD_FLOAT32_C(  -479.97), EASYSIMD_FLOAT32_C(  -159.03) },
      },
    },
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_float32x4x2_t r = easysimd_vzipq_f32(a, b);
...
static int
test_easysimd_vzipq_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int8_t a[16];
    int8_t b[16];
    int8_t r[2][16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int8x16x2_t r = easysimd_vzipq_s8(a, b);
...
static int
test_easysimd_vzipq_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int16_t a[8];
    int16_t b[8];
    int16_t r[2][8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int16x8x2_t r = easysimd_vzipq_s16(a, b);
...
static int
test_easysimd_vzipq_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int32_t a[4];
    int32_t b[4];
    int32_t r[2][4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x4x2_t r = easysimd_vzipq_s32(a, b);
...
static int
test_easysimd_vzipq_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint8_t a[16];
    uint8_t b[16];
    uint8_t r[2][16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x16x2_t r = easysimd_vzipq_u8(a, b);
...
static int
test_easysimd_vzipq_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint16_t a[8];
    uint16_t b[8];
    uint16_t r[2][8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x8x2_t r = easysimd_vzipq_u16(a, b);
...
static int
test_easysimd_vzipq_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint32_t a[4];
    uint32_t b[4];
    uint32_t r[2][4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x4x2_t r = easysimd_vzipq_u32(a, b);
...
#if !defined(EASYSIMD_BUG_INTEL_857088)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vzip_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vzip_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vzip_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vzip_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vzip_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vzip_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vzip_u32)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vzipq_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vzipq_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vzipq_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vzipq_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vzipq_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vzipq_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vzipq_u32)
#endif /* !defined(EASYSIMD_BUG_INTEL_857088) */
