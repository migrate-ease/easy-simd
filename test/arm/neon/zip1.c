#define EASYSIMD_TEST_ARM_NEON_INSN zip1

#include <test/arm/neon/test-neon.h>
#include <easysimd/arm/neon/zip1.h>

static int
test_easysimd_vzip1_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    easysimd_float32 a[2];
    easysimd_float32 b[2];
    easysimd_float32 r[2];
  } test_vec[] = {
    { { EASYSIMD_FLOAT32_C(  -594.82), EASYSIMD_FLOAT32_C(   -36.31) },
      { EASYSIMD_FLOAT32_C(   -44.16), EASYSIMD_FLOAT32_C(  -416.70) },
      { EASYSIMD_FLOAT32_C(  -594.82), EASYSIMD_FLOAT32_C(   -44.16) } },
    { { EASYSIMD_FLOAT32_C(  -546.79), EASYSIMD_FLOAT32_C(   545.60) },
      { EASYSIMD_FLOAT32_C(  -407.46), EASYSIMD_FLOAT32_C(   803.36) },
      { EASYSIMD_FLOAT32_C(  -546.79), EASYSIMD_FLOAT32_C(  -407.46) } },
    { { EASYSIMD_FLOAT32_C(  -396.25), EASYSIMD_FLOAT32_C(  -289.22) },
      { EASYSIMD_FLOAT32_C(   158.83), EASYSIMD_FLOAT32_C(   797.31) },
      { EASYSIMD_FLOAT32_C(  -396.25), EASYSIMD_FLOAT32_C(   158.83) } },
    { { EASYSIMD_FLOAT32_C(   984.23), EASYSIMD_FLOAT32_C(   -68.91) },
      { EASYSIMD_FLOAT32_C(   830.88), EASYSIMD_FLOAT32_C(  -995.28) },
      { EASYSIMD_FLOAT32_C(   984.23), EASYSIMD_FLOAT32_C(   830.88) } },
    { { EASYSIMD_FLOAT32_C(  -188.76), EASYSIMD_FLOAT32_C(   262.91) },
      { EASYSIMD_FLOAT32_C(   778.87), EASYSIMD_FLOAT32_C(  -450.18) },
      { EASYSIMD_FLOAT32_C(  -188.76), EASYSIMD_FLOAT32_C(   778.87) } },
    { { EASYSIMD_FLOAT32_C(   915.01), EASYSIMD_FLOAT32_C(   593.75) },
      { EASYSIMD_FLOAT32_C(   831.12), EASYSIMD_FLOAT32_C(  -136.74) },
      { EASYSIMD_FLOAT32_C(   915.01), EASYSIMD_FLOAT32_C(   831.12) } },
    { { EASYSIMD_FLOAT32_C(   353.93), EASYSIMD_FLOAT32_C(   120.70) },
      { EASYSIMD_FLOAT32_C(  -711.16), EASYSIMD_FLOAT32_C(  -974.32) },
      { EASYSIMD_FLOAT32_C(   353.93), EASYSIMD_FLOAT32_C(  -711.16) } },
    { { EASYSIMD_FLOAT32_C(  -502.47), EASYSIMD_FLOAT32_C(   570.22) },
      { EASYSIMD_FLOAT32_C(   392.65), EASYSIMD_FLOAT32_C(   -97.29) },
      { EASYSIMD_FLOAT32_C(  -502.47), EASYSIMD_FLOAT32_C(   392.65) } },
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float32x2_t a = easysimd_vld1_f32(test_vec[i].a);
    easysimd_float32x2_t b = easysimd_vld1_f32(test_vec[i].b);
    easysimd_float32x2_t r = easysimd_vzip1_f32(a, b);
...
static int
test_easysimd_vzip1_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int8_t a[8];
    int8_t b[8];
    int8_t r[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int8x8_t r = easysimd_vzip1_s8(a, b);
...
static int
test_easysimd_vzip1_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int16_t a[4];
    int16_t b[4];
    int16_t r[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int16x4_t r = easysimd_vzip1_s16(a, b);
...
static int
test_easysimd_vzip1_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int32_t a[2];
    int32_t b[2];
    int32_t r[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x2_t r = easysimd_vzip1_s32(a, b);
...
static int
test_easysimd_vzip1_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint8_t a[8];
    uint8_t b[8];
    uint8_t r[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x8_t r = easysimd_vzip1_u8(a, b);
...
static int
test_easysimd_vzip1_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint16_t a[4];
    uint16_t b[4];
    uint16_t r[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x4_t r = easysimd_vzip1_u16(a, b);
...
static int
test_easysimd_vzip1_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint32_t a[2];
    uint32_t b[2];
    uint32_t r[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x2_t r = easysimd_vzip1_u32(a, b);
...
static int
test_easysimd_vzip1q_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    easysimd_float32 a[4];
    easysimd_float32 b[4];
    easysimd_float32 r[4];
  } test_vec[] = {
    { { EASYSIMD_FLOAT32_C(   269.04), EASYSIMD_FLOAT32_C(   671.35), EASYSIMD_FLOAT32_C(   766.94), EASYSIMD_FLOAT32_C(  -408.87) },
      { EASYSIMD_FLOAT32_C(  -755.43), EASYSIMD_FLOAT32_C(  -620.83), EASYSIMD_FLOAT32_C(  -105.18), EASYSIMD_FLOAT32_C(   580.87) },
      { EASYSIMD_FLOAT32_C(   269.04), EASYSIMD_FLOAT32_C(  -755.43), EASYSIMD_FLOAT32_C(   671.35), EASYSIMD_FLOAT32_C(  -620.83) } },
    { { EASYSIMD_FLOAT32_C(    -7.35), EASYSIMD_FLOAT32_C(  -641.39), EASYSIMD_FLOAT32_C(  -306.86), EASYSIMD_FLOAT32_C(  -476.86) },
      { EASYSIMD_FLOAT32_C(   983.02), EASYSIMD_FLOAT32_C(   145.77), EASYSIMD_FLOAT32_C(  -393.28), EASYSIMD_FLOAT32_C(  -514.11) },
      { EASYSIMD_FLOAT32_C(    -7.35), EASYSIMD_FLOAT32_C(   983.02), EASYSIMD_FLOAT32_C(  -641.39), EASYSIMD_FLOAT32_C(   145.77) } },
    { { EASYSIMD_FLOAT32_C(   201.77), EASYSIMD_FLOAT32_C(   778.35), EASYSIMD_FLOAT32_C(   479.04), EASYSIMD_FLOAT32_C(  -404.39) },
      { EASYSIMD_FLOAT32_C(   748.07), EASYSIMD_FLOAT32_C(  -591.33), EASYSIMD_FLOAT32_C(   845.51), EASYSIMD_FLOAT32_C(  -130.39) },
      { EASYSIMD_FLOAT32_C(   201.77), EASYSIMD_FLOAT32_C(   748.07), EASYSIMD_FLOAT32_C(   778.35), EASYSIMD_FLOAT32_C(  -591.33) } },
    { { EASYSIMD_FLOAT32_C(   187.46), EASYSIMD_FLOAT32_C(   563.12), EASYSIMD_FLOAT32_C(  -567.04), EASYSIMD_FLOAT32_C(    46.32) },
      { EASYSIMD_FLOAT32_C(   549.79), EASYSIMD_FLOAT32_C(  -703.64), EASYSIMD_FLOAT32_C(   919.82), EASYSIMD_FLOAT32_C(  -181.17) },
      { EASYSIMD_FLOAT32_C(   187.46), EASYSIMD_FLOAT32_C(   549.79), EASYSIMD_FLOAT32_C(   563.12), EASYSIMD_FLOAT32_C(  -703.64) } },
    { { EASYSIMD_FLOAT32_C(   967.71), EASYSIMD_FLOAT32_C(   686.76), EASYSIMD_FLOAT32_C(   409.96), EASYSIMD_FLOAT32_C(  -787.73) },
      { EASYSIMD_FLOAT32_C(  -934.07), EASYSIMD_FLOAT32_C(  -695.22), EASYSIMD_FLOAT32_C(   793.14), EASYSIMD_FLOAT32_C(    58.59) },
      { EASYSIMD_FLOAT32_C(   967.71), EASYSIMD_FLOAT32_C(  -934.07), EASYSIMD_FLOAT32_C(   686.76), EASYSIMD_FLOAT32_C(  -695.22) } },
    { { EASYSIMD_FLOAT32_C(  -336.61), EASYSIMD_FLOAT32_C(  -513.72), EASYSIMD_FLOAT32_C(   581.73), EASYSIMD_FLOAT32_C(  -353.60) },
      { EASYSIMD_FLOAT32_C(   632.05), EASYSIMD_FLOAT32_C(  -811.55), EASYSIMD_FLOAT32_C(   132.29), EASYSIMD_FLOAT32_C(  -166.18) },
      { EASYSIMD_FLOAT32_C(  -336.61), EASYSIMD_FLOAT32_C(   632.05), EASYSIMD_FLOAT32_C(  -513.72), EASYSIMD_FLOAT32_C(  -811.55) } },
    { { EASYSIMD_FLOAT32_C(   966.80), EASYSIMD_FLOAT32_C(  -388.67), EASYSIMD_FLOAT32_C(   429.43), EASYSIMD_FLOAT32_C(   714.87) },
      { EASYSIMD_FLOAT32_C(    20.00), EASYSIMD_FLOAT32_C(   274.94), EASYSIMD_FLOAT32_C(  -415.52), EASYSIMD_FLOAT32_C(  -792.53) },
      { EASYSIMD_FLOAT32_C(   966.80), EASYSIMD_FLOAT32_C(    20.00), EASYSIMD_FLOAT32_C(  -388.67), EASYSIMD_FLOAT32_C(   274.94) } },
    { { EASYSIMD_FLOAT32_C(  -161.95), EASYSIMD_FLOAT32_C(    17.44), EASYSIMD_FLOAT32_C(   253.79), EASYSIMD_FLOAT32_C(  -612.15) },
      { EASYSIMD_FLOAT32_C(   313.79), EASYSIMD_FLOAT32_C(   173.61), EASYSIMD_FLOAT32_C(   206.68), EASYSIMD_FLOAT32_C(   281.50) },
      { EASYSIMD_FLOAT32_C(  -161.95), EASYSIMD_FLOAT32_C(   313.79), EASYSIMD_FLOAT32_C(    17.44), EASYSIMD_FLOAT32_C(   173.61) } },
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float32x4_t a = easysimd_vld1q_f32(test_vec[i].a);
    easysimd_float32x4_t b = easysimd_vld1q_f32(test_vec[i].b);
    easysimd_float32x4_t r = easysimd_vzip1q_f32(a, b);
...
static int
test_easysimd_vzip1q_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int8_t a[16];
    int8_t b[16];
    int8_t r[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int8x16_t r = easysimd_vzip1q_s8(a, b);
...
static int
test_easysimd_vzip1q_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int16_t a[8];
    int16_t b[8];
    int16_t r[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int16x8_t r = easysimd_vzip1q_s16(a, b);
...
static int
test_easysimd_vzip1q_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int32_t a[4];
    int32_t b[4];
    int32_t r[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x4_t r = easysimd_vzip1q_s32(a, b);
...
static int
test_easysimd_vzip1q_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int64_t a[2];
    int64_t b[2];
    int64_t r[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int64x2_t r = easysimd_vzip1q_s64(a, b);
...
static int
test_easysimd_vzip1q_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint8_t a[16];
    uint8_t b[16];
    uint8_t r[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x16_t r = easysimd_vzip1q_u8(a, b);
...
static int
test_easysimd_vzip1q_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint16_t a[8];
    uint16_t b[8];
    uint16_t r[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x8_t r = easysimd_vzip1q_u16(a, b);
...
static int
test_easysimd_vzip1q_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint32_t a[4];
    uint32_t b[4];
    uint32_t r[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x4_t r = easysimd_vzip1q_u32(a, b);
...
static int
test_easysimd_vzip1q_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint64_t a[2];
    uint64_t b[2];
    uint64_t r[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint64x2_t r = easysimd_vzip1q_u64(a, b);
...
EASYSIMD_TEST_FUNC_LIST_ENTRY(vzip1_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vzip1_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vzip1_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vzip1_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vzip1_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vzip1_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vzip1_u32)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vzip1q_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vzip1q_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vzip1q_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vzip1q_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vzip1q_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vzip1q_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vzip1q_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vzip1q_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vzip1q_u64)
