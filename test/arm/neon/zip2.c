#define EASYSIMD_TEST_ARM_NEON_INSN zip2

#include <test/arm/neon/test-neon.h>
#include <easysimd/arm/neon/zip2.h>

static int
test_easysimd_vzip2_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    easysimd_float32 a[2];
    easysimd_float32 b[2];
    easysimd_float32 r[2];
  } test_vec[] = {
    { { EASYSIMD_FLOAT32_C(   -56.55), EASYSIMD_FLOAT32_C(   618.01) },
      { EASYSIMD_FLOAT32_C(   834.26), EASYSIMD_FLOAT32_C(  -509.20) },
      { EASYSIMD_FLOAT32_C(   618.01), EASYSIMD_FLOAT32_C(  -509.20) } },
    { { EASYSIMD_FLOAT32_C(   293.29), EASYSIMD_FLOAT32_C(  -837.93) },
      { EASYSIMD_FLOAT32_C(  -408.68), EASYSIMD_FLOAT32_C(   430.47) },
      { EASYSIMD_FLOAT32_C(  -837.93), EASYSIMD_FLOAT32_C(   430.47) } },
    { { EASYSIMD_FLOAT32_C(   222.04), EASYSIMD_FLOAT32_C(  -192.86) },
      { EASYSIMD_FLOAT32_C(   566.42), EASYSIMD_FLOAT32_C(   826.36) },
      { EASYSIMD_FLOAT32_C(  -192.86), EASYSIMD_FLOAT32_C(   826.36) } },
    { { EASYSIMD_FLOAT32_C(  -395.53), EASYSIMD_FLOAT32_C(   599.03) },
      { EASYSIMD_FLOAT32_C(  -555.41), EASYSIMD_FLOAT32_C(    22.87) },
      { EASYSIMD_FLOAT32_C(   599.03), EASYSIMD_FLOAT32_C(    22.87) } },
    { { EASYSIMD_FLOAT32_C(   968.44), EASYSIMD_FLOAT32_C(    95.81) },
      { EASYSIMD_FLOAT32_C(  -638.58), EASYSIMD_FLOAT32_C(   816.26) },
      { EASYSIMD_FLOAT32_C(    95.81), EASYSIMD_FLOAT32_C(   816.26) } },
    { { EASYSIMD_FLOAT32_C(  -762.51), EASYSIMD_FLOAT32_C(   946.71) },
      { EASYSIMD_FLOAT32_C(  -370.92), EASYSIMD_FLOAT32_C(   887.37) },
      { EASYSIMD_FLOAT32_C(   946.71), EASYSIMD_FLOAT32_C(   887.37) } },
    { { EASYSIMD_FLOAT32_C(  -457.71), EASYSIMD_FLOAT32_C(  -445.84) },
      { EASYSIMD_FLOAT32_C(  -147.78), EASYSIMD_FLOAT32_C(  -754.97) },
      { EASYSIMD_FLOAT32_C(  -445.84), EASYSIMD_FLOAT32_C(  -754.97) } },
    { { EASYSIMD_FLOAT32_C(   814.41), EASYSIMD_FLOAT32_C(   434.23) },
      { EASYSIMD_FLOAT32_C(   418.66), EASYSIMD_FLOAT32_C(  -242.14) },
      { EASYSIMD_FLOAT32_C(   434.23), EASYSIMD_FLOAT32_C(  -242.14) } },
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float32x2_t a = easysimd_vld1_f32(test_vec[i].a);
    easysimd_float32x2_t b = easysimd_vld1_f32(test_vec[i].b);
    easysimd_float32x2_t r = easysimd_vzip2_f32(a, b);
...
static int
test_easysimd_vzip2_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int8_t a[8];
    int8_t b[8];
    int8_t r[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int8x8_t r = easysimd_vzip2_s8(a, b);
...
static int
test_easysimd_vzip2_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int16_t a[4];
    int16_t b[4];
    int16_t r[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int16x4_t r = easysimd_vzip2_s16(a, b);
...
static int
test_easysimd_vzip2_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int32_t a[2];
    int32_t b[2];
    int32_t r[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x2_t r = easysimd_vzip2_s32(a, b);
...
static int
test_easysimd_vzip2_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint8_t a[8];
    uint8_t b[8];
    uint8_t r[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x8_t r = easysimd_vzip2_u8(a, b);
...
static int
test_easysimd_vzip2_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint16_t a[4];
    uint16_t b[4];
    uint16_t r[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x4_t r = easysimd_vzip2_u16(a, b);
...
static int
test_easysimd_vzip2_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint32_t a[2];
    uint32_t b[2];
    uint32_t r[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x2_t r = easysimd_vzip2_u32(a, b);
...
static int
test_easysimd_vzip2q_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    easysimd_float32 a[4];
    easysimd_float32 b[4];
    easysimd_float32 r[4];
  } test_vec[] = {
    { { EASYSIMD_FLOAT32_C(   991.39), EASYSIMD_FLOAT32_C(  -819.33), EASYSIMD_FLOAT32_C(  -284.09), EASYSIMD_FLOAT32_C(  -188.89) },
      { EASYSIMD_FLOAT32_C(  -984.89), EASYSIMD_FLOAT32_C(  -117.35), EASYSIMD_FLOAT32_C(   890.93), EASYSIMD_FLOAT32_C(   277.64) },
      { EASYSIMD_FLOAT32_C(  -284.09), EASYSIMD_FLOAT32_C(   890.93), EASYSIMD_FLOAT32_C(  -188.89), EASYSIMD_FLOAT32_C(   277.64) } },
    { { EASYSIMD_FLOAT32_C(   299.93), EASYSIMD_FLOAT32_C(   132.15), EASYSIMD_FLOAT32_C(  -176.04), EASYSIMD_FLOAT32_C(   602.01) },
      { EASYSIMD_FLOAT32_C(   395.84), EASYSIMD_FLOAT32_C(   482.13), EASYSIMD_FLOAT32_C(   505.78), EASYSIMD_FLOAT32_C(  -624.38) },
      { EASYSIMD_FLOAT32_C(  -176.04), EASYSIMD_FLOAT32_C(   505.78), EASYSIMD_FLOAT32_C(   602.01), EASYSIMD_FLOAT32_C(  -624.38) } },
    { { EASYSIMD_FLOAT32_C(  -485.02), EASYSIMD_FLOAT32_C(   246.12), EASYSIMD_FLOAT32_C(  -226.41), EASYSIMD_FLOAT32_C(  -660.41) },
      { EASYSIMD_FLOAT32_C(   304.88), EASYSIMD_FLOAT32_C(   546.13), EASYSIMD_FLOAT32_C(   742.69), EASYSIMD_FLOAT32_C(  -648.05) },
      { EASYSIMD_FLOAT32_C(  -226.41), EASYSIMD_FLOAT32_C(   742.69), EASYSIMD_FLOAT32_C(  -660.41), EASYSIMD_FLOAT32_C(  -648.05) } },
    { { EASYSIMD_FLOAT32_C(  -973.16), EASYSIMD_FLOAT32_C(   350.44), EASYSIMD_FLOAT32_C(   651.48), EASYSIMD_FLOAT32_C(  -776.37) },
      { EASYSIMD_FLOAT32_C(  -169.18), EASYSIMD_FLOAT32_C(   445.04), EASYSIMD_FLOAT32_C(  -966.52), EASYSIMD_FLOAT32_C(  -177.79) },
      { EASYSIMD_FLOAT32_C(   651.48), EASYSIMD_FLOAT32_C(  -966.52), EASYSIMD_FLOAT32_C(  -776.37), EASYSIMD_FLOAT32_C(  -177.79) } },
    { { EASYSIMD_FLOAT32_C(   625.71), EASYSIMD_FLOAT32_C(  -250.61), EASYSIMD_FLOAT32_C(   633.32), EASYSIMD_FLOAT32_C(   640.82) },
      { EASYSIMD_FLOAT32_C(   632.04), EASYSIMD_FLOAT32_C(   524.25), EASYSIMD_FLOAT32_C(   -81.55), EASYSIMD_FLOAT32_C(   -68.03) },
      { EASYSIMD_FLOAT32_C(   633.32), EASYSIMD_FLOAT32_C(   -81.55), EASYSIMD_FLOAT32_C(   640.82), EASYSIMD_FLOAT32_C(   -68.03) } },
    { { EASYSIMD_FLOAT32_C(  -343.59), EASYSIMD_FLOAT32_C(   742.42), EASYSIMD_FLOAT32_C(  -466.02), EASYSIMD_FLOAT32_C(  -947.75) },
      { EASYSIMD_FLOAT32_C(   224.55), EASYSIMD_FLOAT32_C(  -960.24), EASYSIMD_FLOAT32_C(  -572.13), EASYSIMD_FLOAT32_C(   739.52) },
      { EASYSIMD_FLOAT32_C(  -466.02), EASYSIMD_FLOAT32_C(  -572.13), EASYSIMD_FLOAT32_C(  -947.75), EASYSIMD_FLOAT32_C(   739.52) } },
    { { EASYSIMD_FLOAT32_C(   285.88), EASYSIMD_FLOAT32_C(   201.46), EASYSIMD_FLOAT32_C(  -920.88), EASYSIMD_FLOAT32_C(  -409.24) },
      { EASYSIMD_FLOAT32_C(  -252.40), EASYSIMD_FLOAT32_C(   821.81), EASYSIMD_FLOAT32_C(   -57.30), EASYSIMD_FLOAT32_C(  -225.56) },
      { EASYSIMD_FLOAT32_C(  -920.88), EASYSIMD_FLOAT32_C(   -57.30), EASYSIMD_FLOAT32_C(  -409.24), EASYSIMD_FLOAT32_C(  -225.56) } },
    { { EASYSIMD_FLOAT32_C(   172.25), EASYSIMD_FLOAT32_C(  -405.81), EASYSIMD_FLOAT32_C(    -1.92), EASYSIMD_FLOAT32_C(  -996.93) },
      { EASYSIMD_FLOAT32_C(  -960.77), EASYSIMD_FLOAT32_C(    31.56), EASYSIMD_FLOAT32_C(  -174.72), EASYSIMD_FLOAT32_C(   664.94) },
      { EASYSIMD_FLOAT32_C(    -1.92), EASYSIMD_FLOAT32_C(  -174.72), EASYSIMD_FLOAT32_C(  -996.93), EASYSIMD_FLOAT32_C(   664.94) } },
  };

  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd_float32x4_t a = easysimd_vld1q_f32(test_vec[i].a);
    easysimd_float32x4_t b = easysimd_vld1q_f32(test_vec[i].b);
    easysimd_float32x4_t r = easysimd_vzip2q_f32(a, b);
...
static int
test_easysimd_vzip2q_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int8_t a[16];
    int8_t b[16];
    int8_t r[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int8x16_t r = easysimd_vzip2q_s8(a, b);
...
static int
test_easysimd_vzip2q_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int16_t a[8];
    int16_t b[8];
    int16_t r[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int16x8_t r = easysimd_vzip2q_s16(a, b);
...
static int
test_easysimd_vzip2q_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int32_t a[4];
    int32_t b[4];
    int32_t r[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int32x4_t r = easysimd_vzip2q_s32(a, b);
...
static int
test_easysimd_vzip2q_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    int64_t a[2];
    int64_t b[2];
    int64_t r[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_int64x2_t r = easysimd_vzip2q_s64(a, b);
...
static int
test_easysimd_vzip2q_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint8_t a[16];
    uint8_t b[16];
    uint8_t r[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint8x16_t r = easysimd_vzip2q_u8(a, b);
...
static int
test_easysimd_vzip2q_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint16_t a[8];
    uint16_t b[8];
    uint16_t r[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint16x8_t r = easysimd_vzip2q_u16(a, b);
...
static int
test_easysimd_vzip2q_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint32_t a[4];
    uint32_t b[4];
    uint32_t r[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint32x4_t r = easysimd_vzip2q_u32(a, b);
...
static int
test_easysimd_vzip2q_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint64_t a[2];
    uint64_t b[2];
    uint64_t r[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd_uint64x2_t r = easysimd_vzip2q_u64(a, b);
...
EASYSIMD_TEST_FUNC_LIST_ENTRY(vzip2_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vzip2_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vzip2_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vzip2_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vzip2_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vzip2_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vzip2_u32)

EASYSIMD_TEST_FUNC_LIST_ENTRY(vzip2q_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vzip2q_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vzip2q_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vzip2q_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vzip2q_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vzip2q_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vzip2q_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vzip2q_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(vzip2q_u64)
