#define EASYSIMD_TEST_ARM_SVE_INSN and

#include "test-sve.h"
#include "../../../easysimd/arm/sve/and.h"

#include "../../../easysimd/arm/sve/cmplt.h"
#include "../../../easysimd/arm/sve/dup.h"

static int
test_easysimd_svand_s8_z (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b8(), pg)) {
    ...
    rv = easysimd_svand_s8_z(pv, av, bv);
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b8(), pg)) {
    ...
    ev = easysimd_svand_s8_z(pv, av, bv);
...
static int
test_easysimd_svand_s8_m (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const int8_t p[] =
    {  INT8_C(   0), -INT8_C(   1), -INT8_C(   1),  INT8_C(   0), -INT8_C(   1),  INT8_C(   0),  INT8_C(   0), -INT8_C(   1),
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b8(), pg)) {
    ...
    pv = easysimd_svcmplt_s8(pg, easysimd_svld1_s8(pg, &(p[i])), easysimd_svdup_n_s8(INT8_C(0)));
    rv = easysimd_svand_s8_m(pv, av, bv);
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b8(), pg)) {
    ...
    ev = easysimd_svand_s8_m(pv, av, bv);
...
static int
test_easysimd_svand_n_s8_m (EASYSIMD_MUNIT_TEST_ARGS) {
#if 0
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b8(), pg)) {
    ...
    ev = easysimd_svand_n_s8_m(pv, av, b);
...
static int
test_easysimd_svand_s16_z (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b16(), pg)) {
    ...
    rv = easysimd_svand_s16_z(pv, av, bv);
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b16(), pg)) {
    ...
    ev = easysimd_svand_s16_z(pv, av, bv);
...
static int
test_easysimd_svand_s16_m (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const int16_t p[] =
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b16(), pg)) {
    ...
    pv = easysimd_svcmplt_s16(pg, easysimd_svld1_s16(pg, &(p[i])), easysimd_svdup_n_s16(INT16_C(0)));
    rv = easysimd_svand_s16_m(pv, av, bv);
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b16(), pg)) {
    ...
    ev = easysimd_svand_s16_m(pv, av, bv);
...
static int
test_easysimd_svand_s32_z (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b32(), pg)) {
    ...
    rv = easysimd_svand_s32_z(pv, av, bv);
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b32(), pg)) {
    ...
    ev = easysimd_svand_s32_z(pv, av, bv);
...
static int
test_easysimd_svand_s32_m (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const int32_t p[] =
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b32(), pg)) {
    ...
    pv = easysimd_svcmplt_s32(pg, easysimd_svld1_s32(pg, &(p[i])), easysimd_svdup_n_s32(INT32_C(0)));
    rv = easysimd_svand_s32_m(pv, av, bv);
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b32(), pg)) {
    ...
    ev = easysimd_svand_s32_m(pv, av, bv);
...
static int
test_easysimd_svand_s64_z (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b64(), pg)) {
    ...
    rv = easysimd_svand_s64_z(pv, av, bv);
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b64(), pg)) {
    ...
    ev = easysimd_svand_s64_z(pv, av, bv);
...
static int
test_easysimd_svand_s64_m (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const int64_t p[] =
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b64(), pg)) {
    ...
    pv = easysimd_svcmplt_s64(pg, easysimd_svld1_s64(pg, &(p[i])), easysimd_svdup_n_s64(INT64_C(0)));
    rv = easysimd_svand_s64_m(pv, av, bv);
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b64(), pg)) {
    ...
    ev = easysimd_svand_s64_m(pv, av, bv);
...
static int
test_easysimd_svand_u8_z (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const int8_t p[] =
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b8(), pg)) {
    ...
    pv = easysimd_svcmplt_s8(pg, easysimd_svld1_s8(pg, &(p[i])), easysimd_svdup_n_s8(INT8_C(0)));
    rv = easysimd_svand_u8_z(pv, av, bv);
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b8(), pg)) {
    ...
    ev = easysimd_svand_u8_z(pv, av, bv);
...
static int
test_easysimd_svand_u8_m (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const int8_t p[] =
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b8(), pg)) {
    ...
    pv = easysimd_svcmplt_s8(pg, easysimd_svld1_s8(pg, &(p[i])), easysimd_svdup_n_s8(INT8_C(0)));
    rv = easysimd_svand_u8_m(pv, av, bv);
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b8(), pg)) {
    ...
    ev = easysimd_svand_u8_m(pv, av, bv);
...
static int
test_easysimd_svand_u16_z (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const int16_t p[] =
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b16(), pg)) {
    ...
    pv = easysimd_svcmplt_s16(pg, easysimd_svld1_s16(pg, &(p[i])), easysimd_svdup_n_s16(INT16_C(0)));
    rv = easysimd_svand_u16_z(pv, av, bv);
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b16(), pg)) {
    ...
    ev = easysimd_svand_u16_z(pv, av, bv);
...
static int
test_easysimd_svand_u16_m (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const int16_t p[] =
    {  INT16_C(     0), -INT16_C(     1), -INT16_C(     1), -INT16_C(     1),  INT16_C(     0), -INT16_C(     1),  INT16_C(     0),  INT16_C(     0),
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b16(), pg)) {
    ...
    pv = easysimd_svcmplt_s16(pg, easysimd_svld1_s16(pg, &(p[i])), easysimd_svdup_n_s16(INT16_C(0)));
    rv = easysimd_svand_u16_m(pv, av, bv);
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b16(), pg)) {
    ...
    ev = easysimd_svand_u16_m(pv, av, bv);
...
static int
test_easysimd_svand_u32_z (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const int32_t p[] =
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b32(), pg)) {
    ...
    pv = easysimd_svcmplt_s32(pg, easysimd_svld1_s32(pg, &(p[i])), easysimd_svdup_n_s32(INT32_C(0)));
    rv = easysimd_svand_u32_z(pv, av, bv);
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b32(), pg)) {
    ...
    ev = easysimd_svand_u32_z(pv, av, bv);
...
static int
test_easysimd_svand_u32_m (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const int32_t p[] =
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b32(), pg)) {
    ...
    pv = easysimd_svcmplt_s32(pg, easysimd_svld1_s32(pg, &(p[i])), easysimd_svdup_n_s32(INT32_C(0)));
    rv = easysimd_svand_u32_m(pv, av, bv);
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b32(), pg)) {
    ...
    ev = easysimd_svand_u32_m(pv, av, bv);
...
static int
test_easysimd_svand_u64_z (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const int64_t p[] =
    {  INT64_C(                   0), -INT64_C(                   1),  INT64_C(                   0),  INT64_C(                   0),
       INT64_C(                   0), -INT64_C(                   1),  INT64_C(                   0),  INT64_C(                   0),
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b64(), pg)) {
    ...
    pv = easysimd_svcmplt_s64(pg, easysimd_svld1_s64(pg, &(p[i])), easysimd_svdup_n_s64(INT64_C(0)));
    rv = easysimd_svand_u64_z(pv, av, bv);
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b64(), pg)) {
    ...
    ev = easysimd_svand_u64_z(pv, av, bv);
...
static int
test_easysimd_svand_u64_m (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const int64_t p[] =
    {  INT64_C(                   0), -INT64_C(                   1), -INT64_C(                   1),  INT64_C(                   0),
      -INT64_C(                   1),  INT64_C(                   0),  INT64_C(                   0), -INT64_C(                   1),
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b64(), pg)) {
    ...
    pv = easysimd_svcmplt_s64(pg, easysimd_svld1_s64(pg, &(p[i])), easysimd_svdup_n_s64(INT64_C(0)));
    rv = easysimd_svand_u64_m(pv, av, bv);
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b64(), pg)) {
    ...
    ev = easysimd_svand_u64_m(pv, av, bv);
...
EASYSIMD_TEST_FUNC_LIST_ENTRY(svand_s8_z)
EASYSIMD_TEST_FUNC_LIST_ENTRY(svand_s8_m)
EASYSIMD_TEST_FUNC_LIST_ENTRY(svand_s16_z)
EASYSIMD_TEST_FUNC_LIST_ENTRY(svand_s16_m)
EASYSIMD_TEST_FUNC_LIST_ENTRY(svand_s32_z)
EASYSIMD_TEST_FUNC_LIST_ENTRY(svand_s32_m)
EASYSIMD_TEST_FUNC_LIST_ENTRY(svand_s64_z)
EASYSIMD_TEST_FUNC_LIST_ENTRY(svand_s64_m)
EASYSIMD_TEST_FUNC_LIST_ENTRY(svand_u8_z)
EASYSIMD_TEST_FUNC_LIST_ENTRY(svand_u8_m)
EASYSIMD_TEST_FUNC_LIST_ENTRY(svand_u16_z)
EASYSIMD_TEST_FUNC_LIST_ENTRY(svand_u16_m)
EASYSIMD_TEST_FUNC_LIST_ENTRY(svand_u32_z)
EASYSIMD_TEST_FUNC_LIST_ENTRY(svand_u32_m)
EASYSIMD_TEST_FUNC_LIST_ENTRY(svand_u64_z)
EASYSIMD_TEST_FUNC_LIST_ENTRY(svand_u64_m)
