#define EASYSIMD_TEST_ARM_SVE_INSN cmplt
...
static int
test_easysimd_svcmplt_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b8(), pg)) {
    ...
    ev = easysimd_svcmplt_s8(pv, av, bv);

    easysimd_svst1_s8(pg, &(r[i]), easysimd_svdup_n_s8_z(ev, ~INT8_C(0)));
  ...
  int32_t len = easysimd_test_codegen_random_i16() & ((sizeof(e) / sizeof(e[0])) -1);
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b8(), pg)) {
    ...
    easysimd_svst1_s8(pg, &(e[i]), easysimd_svdup_n_s8_z(ev, ~INT8_C(0)));
...
static int
test_easysimd_svcmplt_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b16(), pg)) {
    ...
    ev = easysimd_svcmplt_s16(pv, av, bv);

    easysimd_svst1_s16(pg, &(r[i]), easysimd_svdup_n_s16_z(ev, ~INT16_C(0)));
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b16(), pg)) {
    ...
    easysimd_svst1_s16(pg, &(e[i]), easysimd_svdup_n_s16_z(ev, ~INT16_C(0)));
...
static int
test_easysimd_svcmplt_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b32(), pg)) {
    ...
    ev = easysimd_svcmplt_s32(pv, av, bv);

    easysimd_svst1_s32(pg, &(r[i]), easysimd_svdup_n_s32_z(ev, ~INT32_C(0)));
  ...
  int32_t len = easysimd_test_codegen_random_i32() & ((sizeof(e) / sizeof(e[0])) -1);
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b32(), pg)) {
    ...
    easysimd_svst1_s32(pg, &(e[i]), easysimd_svdup_n_s32_z(ev, ~INT32_C(0)));
...
static int
test_easysimd_svcmplt_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b64(), pg)) {
    ...
    ev = easysimd_svcmplt_s64(pv, av, bv);

    easysimd_svst1_s64(pg, &(r[i]), easysimd_svdup_n_s64_z(ev, ~INT64_C(0)));
  ...
  int32_t len = easysimd_test_codegen_random_i64() & ((sizeof(e) / sizeof(e[0])) -1);
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b64(), pg)) {
    ...
    easysimd_svst1_s64(pg, &(e[i]), easysimd_svdup_n_s64_z(ev, ~INT64_C(0)));
...
static int
test_easysimd_svcmplt_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const int8_t p[] =
    {  INT8_C(   0),  INT8_C(   0),  INT8_C(   0),  INT8_C(   0), -INT8_C(   1),  INT8_C(   0),  INT8_C(   0),  INT8_C(   0),
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b8(), pg)) {
    ...
    pv = easysimd_svcmplt_s8(pg, easysimd_svld1_s8(pg, &(p[i])), easysimd_svdup_n_s8(0));
    ev = easysimd_svcmplt_u8(pv, av, bv);
...
static int
test_easysimd_svcmplt_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const int16_t p[] =
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b16(), pg)) {
    ...
    pv = easysimd_svcmplt_s16(pg, easysimd_svld1_s16(pg, &(p[i])), easysimd_svdup_n_s16(0));
    ev = easysimd_svcmplt_u16(pv, av, bv);
...
static int
test_easysimd_svcmplt_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const int32_t p[] =
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b32(), pg)) {
    ...
    pv = easysimd_svcmplt_s32(pg, easysimd_svld1_s32(pg, &(p[i])), easysimd_svdup_n_s32(0));
    ev = easysimd_svcmplt_u32(pv, av, bv);
...
static int
test_easysimd_svcmplt_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const int64_t p[] =
    { -INT64_C(                   1), -INT64_C(                   1), -INT64_C(                   1),  INT64_C(                   0),
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b64(), pg)) {
    ...
    pv = easysimd_svcmplt_s64(pg, easysimd_svld1_s64(pg, &(p[i])), easysimd_svdup_n_s64(0));
    ev = easysimd_svcmplt_u64(pv, av, bv);
...
static int
test_easysimd_svcmplt_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const int32_t p[] =
  ...
  static const easysimd_float32 a[] =
    { EASYSIMD_FLOAT32_C(   -91.01), EASYSIMD_FLOAT32_C(   330.29), EASYSIMD_FLOAT32_C(  -472.15), EASYSIMD_FLOAT32_C(  -113.20),
      EASYSIMD_FLOAT32_C(   444.83), EASYSIMD_FLOAT32_C(   564.94), EASYSIMD_FLOAT32_C(   263.04), EASYSIMD_FLOAT32_C(  -643.49),
      EASYSIMD_FLOAT32_C(  -399.55), EASYSIMD_FLOAT32_C(   827.07), EASYSIMD_FLOAT32_C(   860.22), EASYSIMD_FLOAT32_C(   929.73),
      EASYSIMD_FLOAT32_C(  -808.98), EASYSIMD_FLOAT32_C(  -704.70), EASYSIMD_FLOAT32_C(   358.61), EASYSIMD_FLOAT32_C(  -705.77),
      EASYSIMD_FLOAT32_C(   607.37), EASYSIMD_FLOAT32_C(   627.69), EASYSIMD_FLOAT32_C(  -326.02), EASYSIMD_FLOAT32_C(    54.58),
      EASYSIMD_FLOAT32_C(  -739.91), EASYSIMD_FLOAT32_C(   342.01), EASYSIMD_FLOAT32_C(  -844.35), EASYSIMD_FLOAT32_C(   727.20),
      EASYSIMD_FLOAT32_C(   536.80), EASYSIMD_FLOAT32_C(   574.40), EASYSIMD_FLOAT32_C(  -947.97), EASYSIMD_FLOAT32_C(  -537.36),
      EASYSIMD_FLOAT32_C(   712.97), EASYSIMD_FLOAT32_C(   926.59), EASYSIMD_FLOAT32_C(  -299.09), EASYSIMD_FLOAT32_C(  -378.04),
      EASYSIMD_FLOAT32_C(   256.89), EASYSIMD_FLOAT32_C(   228.76), EASYSIMD_FLOAT32_C(   508.76), EASYSIMD_FLOAT32_C(  -298.29),
      EASYSIMD_FLOAT32_C(  -206.31), EASYSIMD_FLOAT32_C(  -228.20), EASYSIMD_FLOAT32_C(    58.22), EASYSIMD_FLOAT32_C(   394.14),
      EASYSIMD_FLOAT32_C(  -401.13), EASYSIMD_FLOAT32_C(   -81.56), EASYSIMD_FLOAT32_C(   323.87), EASYSIMD_FLOAT32_C(  -210.11),
      EASYSIMD_FLOAT32_C(   213.75), EASYSIMD_FLOAT32_C(  -317.52), EASYSIMD_FLOAT32_C(    84.13), EASYSIMD_FLOAT32_C(  -178.88),
      EASYSIMD_FLOAT32_C(  -689.84), EASYSIMD_FLOAT32_C(   758.10), EASYSIMD_FLOAT32_C(   875.70), EASYSIMD_FLOAT32_C(  -429.74),
      EASYSIMD_FLOAT32_C(   100.11), EASYSIMD_FLOAT32_C(  -968.65), EASYSIMD_FLOAT32_C(  -702.55), EASYSIMD_FLOAT32_C(  -363.09),
      EASYSIMD_FLOAT32_C(   605.75), EASYSIMD_FLOAT32_C(  -650.51), EASYSIMD_FLOAT32_C(    99.56), EASYSIMD_FLOAT32_C(   318.72),
      EASYSIMD_FLOAT32_C(  -723.92), EASYSIMD_FLOAT32_C(   800.46), EASYSIMD_FLOAT32_C(   940.68), EASYSIMD_FLOAT32_C(   532.97),
      EASYSIMD_FLOAT32_C(    29.22), EASYSIMD_FLOAT32_C(   449.44), EASYSIMD_FLOAT32_C(  -765.32), EASYSIMD_FLOAT32_C(   822.91),
      EASYSIMD_FLOAT32_C(  -778.76), EASYSIMD_FLOAT32_C(   292.90), EASYSIMD_FLOAT32_C(   217.05), EASYSIMD_FLOAT32_C(  -179.89),
      EASYSIMD_FLOAT32_C(  -788.66), EASYSIMD_FLOAT32_C(  -459.08), EASYSIMD_FLOAT32_C(   610.01), EASYSIMD_FLOAT32_C(   425.09),
      EASYSIMD_FLOAT32_C(   223.39), EASYSIMD_FLOAT32_C(  -305.87), EASYSIMD_FLOAT32_C(  -753.79), EASYSIMD_FLOAT32_C(   533.56),
      EASYSIMD_FLOAT32_C(  -547.77), EASYSIMD_FLOAT32_C(  -878.09), EASYSIMD_FLOAT32_C(  -896.19), EASYSIMD_FLOAT32_C(   552.35),
      EASYSIMD_FLOAT32_C(  -846.74), EASYSIMD_FLOAT32_C(  -598.73), EASYSIMD_FLOAT32_C(  -810.74), EASYSIMD_FLOAT32_C(   759.01),
      EASYSIMD_FLOAT32_C(  -249.25), EASYSIMD_FLOAT32_C(   288.81), EASYSIMD_FLOAT32_C(    77.73), EASYSIMD_FLOAT32_C(    26.83),
      EASYSIMD_FLOAT32_C(    89.28), EASYSIMD_FLOAT32_C(    18.41), EASYSIMD_FLOAT32_C(  -440.20), EASYSIMD_FLOAT32_C(  -881.51),
      EASYSIMD_FLOAT32_C(  -532.14), EASYSIMD_FLOAT32_C(  -205.52), EASYSIMD_FLOAT32_C(   941.40), EASYSIMD_FLOAT32_C(  -310.90),
      EASYSIMD_FLOAT32_C(  -912.61), EASYSIMD_FLOAT32_C(   158.45), EASYSIMD_FLOAT32_C(   509.22), EASYSIMD_FLOAT32_C(  -701.27),
      EASYSIMD_FLOAT32_C(   699.37), EASYSIMD_FLOAT32_C(   119.22), EASYSIMD_FLOAT32_C(   723.82), EASYSIMD_FLOAT32_C(   -77.24),
      EASYSIMD_FLOAT32_C(   813.35), EASYSIMD_FLOAT32_C(   970.03), EASYSIMD_FLOAT32_C(  -543.68), EASYSIMD_FLOAT32_C(  -734.41),
      EASYSIMD_FLOAT32_C(  -908.06), EASYSIMD_FLOAT32_C(  -439.87), EASYSIMD_FLOAT32_C(   817.93), EASYSIMD_FLOAT32_C(  -754.80),
      EASYSIMD_FLOAT32_C(   -38.60), EASYSIMD_FLOAT32_C(  -992.81), EASYSIMD_FLOAT32_C(  -995.79), EASYSIMD_FLOAT32_C(   712.15),
      EASYSIMD_FLOAT32_C(   296.01), EASYSIMD_FLOAT32_C(    81.95), EASYSIMD_FLOAT32_C(  -261.02), EASYSIMD_FLOAT32_C(  -614.72),
      EASYSIMD_FLOAT32_C(  -899.64), EASYSIMD_FLOAT32_C(   298.79), EASYSIMD_FLOAT32_C(  -496.22), EASYSIMD_FLOAT32_C(  -431.78),
      EASYSIMD_FLOAT32_C(  -906.73), EASYSIMD_FLOAT32_C(  -554.82), EASYSIMD_FLOAT32_C(   257.32), EASYSIMD_FLOAT32_C(  -819.34),
      EASYSIMD_FLOAT32_C(   603.63), EASYSIMD_FLOAT32_C(  -233.46), EASYSIMD_FLOAT32_C(  -520.61), EASYSIMD_FLOAT32_C(   303.01),
      EASYSIMD_FLOAT32_C(   885.76), EASYSIMD_FLOAT32_C(  -796.79), EASYSIMD_FLOAT32_C(  -774.23), EASYSIMD_FLOAT32_C(   699.11),
      EASYSIMD_FLOAT32_C(  -826.76), EASYSIMD_FLOAT32_C(  -317.91), EASYSIMD_FLOAT32_C(   964.70), EASYSIMD_FLOAT32_C(  -734.82),
      EASYSIMD_FLOAT32_C(   242.22), EASYSIMD_FLOAT32_C(   782.63), EASYSIMD_FLOAT32_C(  -489.62), EASYSIMD_FLOAT32_C(  -796.38),
      EASYSIMD_FLOAT32_C(   789.82), EASYSIMD_FLOAT32_C(  -485.40), EASYSIMD_FLOAT32_C(   915.77), EASYSIMD_FLOAT32_C(    85.82),
      EASYSIMD_FLOAT32_C(   596.54), EASYSIMD_FLOAT32_C(  -345.25), EASYSIMD_FLOAT32_C(   471.11), EASYSIMD_FLOAT32_C(   696.90),
      EASYSIMD_FLOAT32_C(   953.54), EASYSIMD_FLOAT32_C(   974.88), EASYSIMD_FLOAT32_C(  -734.88), EASYSIMD_FLOAT32_C(  -953.19),
      EASYSIMD_FLOAT32_C(  -579.94), EASYSIMD_FLOAT32_C(   522.44), EASYSIMD_FLOAT32_C(  -772.53), EASYSIMD_FLOAT32_C(  -976.30),
      EASYSIMD_FLOAT32_C(  -711.02), EASYSIMD_FLOAT32_C(  -293.15), EASYSIMD_FLOAT32_C(   326.70), EASYSIMD_FLOAT32_C(  -825.27),
      EASYSIMD_FLOAT32_C(   -89.94), EASYSIMD_FLOAT32_C(   552.47), EASYSIMD_FLOAT32_C(   873.84), EASYSIMD_FLOAT32_C(    83.31),
      EASYSIMD_FLOAT32_C(  -765.44), EASYSIMD_FLOAT32_C(   838.54), EASYSIMD_FLOAT32_C(   348.49), EASYSIMD_FLOAT32_C(   476.79),
      EASYSIMD_FLOAT32_C(   621.17), EASYSIMD_FLOAT32_C(   858.87), EASYSIMD_FLOAT32_C(   680.40), EASYSIMD_FLOAT32_C(   410.98),
      EASYSIMD_FLOAT32_C(  -626.53), EASYSIMD_FLOAT32_C(   596.17), EASYSIMD_FLOAT32_C(  -503.19), EASYSIMD_FLOAT32_C(   970.01) };
  static const easysimd_float32 b[] =
    { EASYSIMD_FLOAT32_C(  -749.08), EASYSIMD_FLOAT32_C(   967.91), EASYSIMD_FLOAT32_C(   666.91), EASYSIMD_FLOAT32_C(  -795.54),
      EASYSIMD_FLOAT32_C(   942.80), EASYSIMD_FLOAT32_C(   932.03), EASYSIMD_FLOAT32_C(  -748.73), EASYSIMD_FLOAT32_C(  -637.14),
      EASYSIMD_FLOAT32_C(   454.47), EASYSIMD_FLOAT32_C(  -521.26), EASYSIMD_FLOAT32_C(  -613.44), EASYSIMD_FLOAT32_C(   743.45),
      EASYSIMD_FLOAT32_C(   185.59), EASYSIMD_FLOAT32_C(   713.26), EASYSIMD_FLOAT32_C(   918.18), EASYSIMD_FLOAT32_C(  -904.34),
      EASYSIMD_FLOAT32_C(   265.74), EASYSIMD_FLOAT32_C(   792.02), EASYSIMD_FLOAT32_C(   178.96), EASYSIMD_FLOAT32_C(   500.30),
      EASYSIMD_FLOAT32_C(   630.56), EASYSIMD_FLOAT32_C(  -472.55), EASYSIMD_FLOAT32_C(   -22.91), EASYSIMD_FLOAT32_C(   251.73),
      EASYSIMD_FLOAT32_C(  -613.68), EASYSIMD_FLOAT32_C(  -342.51), EASYSIMD_FLOAT32_C(  -337.29), EASYSIMD_FLOAT32_C(  -240.21),
      EASYSIMD_FLOAT32_C(  -746.34), EASYSIMD_FLOAT32_C(   159.52), EASYSIMD_FLOAT32_C(  -270.20), EASYSIMD_FLOAT32_C(  -495.41),
      EASYSIMD_FLOAT32_C(   127.44), EASYSIMD_FLOAT32_C(  -603.29), EASYSIMD_FLOAT32_C(  -290.95), EASYSIMD_FLOAT32_C(    70.23),
      EASYSIMD_FLOAT32_C(  -671.25), EASYSIMD_FLOAT32_C(   -39.68), EASYSIMD_FLOAT32_C(   433.09), EASYSIMD_FLOAT32_C(   783.22),
      EASYSIMD_FLOAT32_C(   439.06), EASYSIMD_FLOAT32_C(   819.65), EASYSIMD_FLOAT32_C(   526.66), EASYSIMD_FLOAT32_C(  -375.35),
      EASYSIMD_FLOAT32_C(   532.91), EASYSIMD_FLOAT32_C(   444.85), EASYSIMD_FLOAT32_C(  -279.69), EASYSIMD_FLOAT32_C(  -201.35),
      EASYSIMD_FLOAT32_C(   236.87), EASYSIMD_FLOAT32_C(   899.27), EASYSIMD_FLOAT32_C(  -701.05), EASYSIMD_FLOAT32_C(  -132.57),
      EASYSIMD_FLOAT32_C(  -573.28), EASYSIMD_FLOAT32_C(   276.04), EASYSIMD_FLOAT32_C(  -880.84), EASYSIMD_FLOAT32_C(  -186.96),
      EASYSIMD_FLOAT32_C(   933.53), EASYSIMD_FLOAT32_C(  -218.13), EASYSIMD_FLOAT32_C(   572.83), EASYSIMD_FLOAT32_C(  -812.80),
      EASYSIMD_FLOAT32_C(   941.40), EASYSIMD_FLOAT32_C(  -697.37), EASYSIMD_FLOAT32_C(  -308.22), EASYSIMD_FLOAT32_C(    68.83),
      EASYSIMD_FLOAT32_C(  -300.65), EASYSIMD_FLOAT32_C(   400.83), EASYSIMD_FLOAT32_C(  -860.93), EASYSIMD_FLOAT32_C(    28.09),
      EASYSIMD_FLOAT32_C(  -638.85), EASYSIMD_FLOAT32_C(   572.16), EASYSIMD_FLOAT32_C(  -188.69), EASYSIMD_FLOAT32_C(   800.21),
      EASYSIMD_FLOAT32_C(   391.81), EASYSIMD_FLOAT32_C(  -662.03), EASYSIMD_FLOAT32_C(  -575.14), EASYSIMD_FLOAT32_C(   -75.27),
      EASYSIMD_FLOAT32_C(   782.82), EASYSIMD_FLOAT32_C(   145.16), EASYSIMD_FLOAT32_C(   723.38), EASYSIMD_FLOAT32_C(    19.69),
      EASYSIMD_FLOAT32_C(    44.43), EASYSIMD_FLOAT32_C(  -977.67), EASYSIMD_FLOAT32_C(   887.12), EASYSIMD_FLOAT32_C(   471.15),
      EASYSIMD_FLOAT32_C(   298.38), EASYSIMD_FLOAT32_C(  -993.72), EASYSIMD_FLOAT32_C(  -715.81), EASYSIMD_FLOAT32_C(   231.91),
      EASYSIMD_FLOAT32_C(  -211.84), EASYSIMD_FLOAT32_C(   857.02), EASYSIMD_FLOAT32_C(   419.11), EASYSIMD_FLOAT32_C(  -270.45),
      EASYSIMD_FLOAT32_C(  -840.34), EASYSIMD_FLOAT32_C(  -889.11), EASYSIMD_FLOAT32_C(   798.39), EASYSIMD_FLOAT32_C(  -141.00),
      EASYSIMD_FLOAT32_C(   511.72), EASYSIMD_FLOAT32_C(   937.46), EASYSIMD_FLOAT32_C(   887.09), EASYSIMD_FLOAT32_C(   872.88),
      EASYSIMD_FLOAT32_C(   509.62), EASYSIMD_FLOAT32_C(  -301.60), EASYSIMD_FLOAT32_C(   673.08), EASYSIMD_FLOAT32_C(   -98.57),
      EASYSIMD_FLOAT32_C(    36.38), EASYSIMD_FLOAT32_C(  -902.06), EASYSIMD_FLOAT32_C(   826.16), EASYSIMD_FLOAT32_C(  -180.80),
      EASYSIMD_FLOAT32_C(   243.10), EASYSIMD_FLOAT32_C(   549.54), EASYSIMD_FLOAT32_C(   838.89), EASYSIMD_FLOAT32_C(  -712.47),
      EASYSIMD_FLOAT32_C(   571.87), EASYSIMD_FLOAT32_C(   726.01), EASYSIMD_FLOAT32_C(   758.68), EASYSIMD_FLOAT32_C(  -129.76),
      EASYSIMD_FLOAT32_C(   732.29), EASYSIMD_FLOAT32_C(  -957.12), EASYSIMD_FLOAT32_C(  -897.85), EASYSIMD_FLOAT32_C(  -479.55),
      EASYSIMD_FLOAT32_C(   899.90), EASYSIMD_FLOAT32_C(   521.26), EASYSIMD_FLOAT32_C(   250.00), EASYSIMD_FLOAT32_C(  -940.44),
      EASYSIMD_FLOAT32_C(   632.15), EASYSIMD_FLOAT32_C(    48.39), EASYSIMD_FLOAT32_C(   -81.44), EASYSIMD_FLOAT32_C(   143.88),
      EASYSIMD_FLOAT32_C(   -14.15), EASYSIMD_FLOAT32_C(  -194.35), EASYSIMD_FLOAT32_C(    16.75), EASYSIMD_FLOAT32_C(  -504.54),
      EASYSIMD_FLOAT32_C(   504.06), EASYSIMD_FLOAT32_C(  -310.16), EASYSIMD_FLOAT32_C(   396.89), EASYSIMD_FLOAT32_C(  -459.57),
      EASYSIMD_FLOAT32_C(  -212.22), EASYSIMD_FLOAT32_C(   223.05), EASYSIMD_FLOAT32_C(   359.63), EASYSIMD_FLOAT32_C(  -969.11),
      EASYSIMD_FLOAT32_C(  -227.41), EASYSIMD_FLOAT32_C(   198.52), EASYSIMD_FLOAT32_C(  -681.58), EASYSIMD_FLOAT32_C(  -655.54),
      EASYSIMD_FLOAT32_C(   -75.48), EASYSIMD_FLOAT32_C(  -922.89), EASYSIMD_FLOAT32_C(   214.70), EASYSIMD_FLOAT32_C(  -343.18),
      EASYSIMD_FLOAT32_C(  -880.02), EASYSIMD_FLOAT32_C(   316.85), EASYSIMD_FLOAT32_C(   177.26), EASYSIMD_FLOAT32_C(  -980.12),
      EASYSIMD_FLOAT32_C(  -161.89), EASYSIMD_FLOAT32_C(  -572.73), EASYSIMD_FLOAT32_C(  -920.56), EASYSIMD_FLOAT32_C(  -529.73),
      EASYSIMD_FLOAT32_C(   475.66), EASYSIMD_FLOAT32_C(    -2.01), EASYSIMD_FLOAT32_C(   614.15), EASYSIMD_FLOAT32_C(  -538.49),
      EASYSIMD_FLOAT32_C(   803.65), EASYSIMD_FLOAT32_C(  -369.10), EASYSIMD_FLOAT32_C(   -43.03), EASYSIMD_FLOAT32_C(   307.70),
      EASYSIMD_FLOAT32_C(   320.74), EASYSIMD_FLOAT32_C(  -646.14), EASYSIMD_FLOAT32_C(   848.14), EASYSIMD_FLOAT32_C(  -891.48),
      EASYSIMD_FLOAT32_C(   576.92), EASYSIMD_FLOAT32_C(   207.77), EASYSIMD_FLOAT32_C(  -860.59), EASYSIMD_FLOAT32_C(  -650.50),
      EASYSIMD_FLOAT32_C(  -593.72), EASYSIMD_FLOAT32_C(  -542.17), EASYSIMD_FLOAT32_C(  -306.04), EASYSIMD_FLOAT32_C(   330.81),
      EASYSIMD_FLOAT32_C(  -465.07), EASYSIMD_FLOAT32_C(   908.66), EASYSIMD_FLOAT32_C(   987.62), EASYSIMD_FLOAT32_C(  -345.09),
      EASYSIMD_FLOAT32_C(   225.51), EASYSIMD_FLOAT32_C(   164.89), EASYSIMD_FLOAT32_C(  -325.21), EASYSIMD_FLOAT32_C(  -936.37) };
  static const int32_t e[] =
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b32(), pg)) {
    ...
    pv = easysimd_svcmplt_s32(pg, easysimd_svld1_s32(pg, &(p[i])), easysimd_svdup_n_s32(0));
    ev = easysimd_svcmplt_f32(pv, av, bv);
...
#else
  int32_t p[1024 / sizeof(int32_t)], e[1024 / sizeof(int32_t)];
  easysimd_float32 a[1024 / sizeof(int32_t)], b[1024 / sizeof(int32_t)];
  int32_t len = easysimd_test_codegen_random_i32() & ((sizeof(e) / sizeof(e[0])) - 1);

  fputc('\n', stdout);

  easysimd_test_codegen_random_memory(sizeof(p), HEDLEY_REINTERPRET_CAST(uint8_t*, p));
  easysimd_test_codegen_random_vf32(len, a, EASYSIMD_FLOAT32_C(-1000.0), EASYSIMD_FLOAT32_C(1000.0));
  easysimd_test_codegen_random_vf32(len, b, EASYSIMD_FLOAT32_C(-1000.0), EASYSIMD_FLOAT32_C(1000.0));

  int32_t i = 0;
  easysimd_svbool_t pg = easysimd_svwhilelt_b32_s32(i, len);
  while (easysimd_svptest_first(easysimd_svptrue_b32(), pg)) {
    easysimd_svfloat32_t av, bv;
    easysimd_svbool_t pv, ev;
...
static int
test_easysimd_svcmplt_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const int64_t p[] =
    { -INT64_C(                   1), -INT64_C(                   1), -INT64_C(                   1),  INT64_C(                   0),
      -INT64_C(                   1), -INT64_C(                   1), -INT64_C(                   1),  INT64_C(                   0),
  ...
  static const easysimd_float64 a[] =
    { EASYSIMD_FLOAT64_C(   595.54), EASYSIMD_FLOAT64_C(  -852.85), EASYSIMD_FLOAT64_C(  -318.15), EASYSIMD_FLOAT64_C(  -743.45),
      EASYSIMD_FLOAT64_C(  -558.95), EASYSIMD_FLOAT64_C(   850.28), EASYSIMD_FLOAT64_C(    15.80), EASYSIMD_FLOAT64_C(   420.10),
      EASYSIMD_FLOAT64_C(   530.70), EASYSIMD_FLOAT64_C(   172.92), EASYSIMD_FLOAT64_C(   511.22), EASYSIMD_FLOAT64_C(   971.98),
      EASYSIMD_FLOAT64_C(  -942.14), EASYSIMD_FLOAT64_C(   698.17), EASYSIMD_FLOAT64_C(   647.48), EASYSIMD_FLOAT64_C(  -404.55),
      EASYSIMD_FLOAT64_C(   552.77), EASYSIMD_FLOAT64_C(   359.04), EASYSIMD_FLOAT64_C(   716.51), EASYSIMD_FLOAT64_C(  -464.91),
      EASYSIMD_FLOAT64_C(   331.18), EASYSIMD_FLOAT64_C(  -865.71), EASYSIMD_FLOAT64_C(   159.75), EASYSIMD_FLOAT64_C(  -429.02),
      EASYSIMD_FLOAT64_C(   226.26), EASYSIMD_FLOAT64_C(   -91.05), EASYSIMD_FLOAT64_C(   304.34), EASYSIMD_FLOAT64_C(   600.46),
      EASYSIMD_FLOAT64_C(  -510.32), EASYSIMD_FLOAT64_C(  -392.78), EASYSIMD_FLOAT64_C(  -138.41), EASYSIMD_FLOAT64_C(  -914.78),
      EASYSIMD_FLOAT64_C(  -245.63), EASYSIMD_FLOAT64_C(   543.44), EASYSIMD_FLOAT64_C(  -658.23), EASYSIMD_FLOAT64_C(   195.43),
      EASYSIMD_FLOAT64_C(   393.72), EASYSIMD_FLOAT64_C(   357.57), EASYSIMD_FLOAT64_C(  -384.47), EASYSIMD_FLOAT64_C(   -75.58),
      EASYSIMD_FLOAT64_C(  -469.51), EASYSIMD_FLOAT64_C(  -873.25), EASYSIMD_FLOAT64_C(  -103.60), EASYSIMD_FLOAT64_C(  -411.65),
      EASYSIMD_FLOAT64_C(   824.92), EASYSIMD_FLOAT64_C(  -456.12), EASYSIMD_FLOAT64_C(   183.81), EASYSIMD_FLOAT64_C(   377.69),
      EASYSIMD_FLOAT64_C(   902.92), EASYSIMD_FLOAT64_C(   -99.69), EASYSIMD_FLOAT64_C(   912.78), EASYSIMD_FLOAT64_C(   234.11),
      EASYSIMD_FLOAT64_C(    34.60), EASYSIMD_FLOAT64_C(    72.54), EASYSIMD_FLOAT64_C(   805.09), EASYSIMD_FLOAT64_C(  -739.14),
      EASYSIMD_FLOAT64_C(   981.49), EASYSIMD_FLOAT64_C(   109.43), EASYSIMD_FLOAT64_C(   861.33), EASYSIMD_FLOAT64_C(  -528.83),
      EASYSIMD_FLOAT64_C(   716.64), EASYSIMD_FLOAT64_C(  -277.08), EASYSIMD_FLOAT64_C(  -443.61), EASYSIMD_FLOAT64_C(  -528.99),
      EASYSIMD_FLOAT64_C(  -733.64), EASYSIMD_FLOAT64_C(  -101.84), EASYSIMD_FLOAT64_C(   666.44), EASYSIMD_FLOAT64_C(   660.08),
      EASYSIMD_FLOAT64_C(  -744.27), EASYSIMD_FLOAT64_C(  -718.03), EASYSIMD_FLOAT64_C(  -415.50), EASYSIMD_FLOAT64_C(  -213.78),
      EASYSIMD_FLOAT64_C(  -591.28), EASYSIMD_FLOAT64_C(   480.90), EASYSIMD_FLOAT64_C(   374.58), EASYSIMD_FLOAT64_C(  -766.36),
      EASYSIMD_FLOAT64_C(  -975.21), EASYSIMD_FLOAT64_C(  -441.62), EASYSIMD_FLOAT64_C(   611.33), EASYSIMD_FLOAT64_C(   927.71),
      EASYSIMD_FLOAT64_C(   458.70), EASYSIMD_FLOAT64_C(   524.11), EASYSIMD_FLOAT64_C(   161.82), EASYSIMD_FLOAT64_C(  -506.70) };
  static const easysimd_float64 b[] =
    { EASYSIMD_FLOAT64_C(  -403.35), EASYSIMD_FLOAT64_C(   -33.09), EASYSIMD_FLOAT64_C(  -245.84), EASYSIMD_FLOAT64_C(  -421.86),
      EASYSIMD_FLOAT64_C(  -923.67), EASYSIMD_FLOAT64_C(  -384.51), EASYSIMD_FLOAT64_C(    49.31), EASYSIMD_FLOAT64_C(   792.97),
      EASYSIMD_FLOAT64_C(   338.40), EASYSIMD_FLOAT64_C(   605.70), EASYSIMD_FLOAT64_C(  -736.01), EASYSIMD_FLOAT64_C(   604.77),
      EASYSIMD_FLOAT64_C(  -496.14), EASYSIMD_FLOAT64_C(   930.43), EASYSIMD_FLOAT64_C(   264.85), EASYSIMD_FLOAT64_C(  -240.41),
      EASYSIMD_FLOAT64_C(  -787.60), EASYSIMD_FLOAT64_C(   849.35), EASYSIMD_FLOAT64_C(   545.82), EASYSIMD_FLOAT64_C(  -378.89),
      EASYSIMD_FLOAT64_C(   330.25), EASYSIMD_FLOAT64_C(   -79.60), EASYSIMD_FLOAT64_C(  -145.25), EASYSIMD_FLOAT64_C(   355.04),
      EASYSIMD_FLOAT64_C(   478.78), EASYSIMD_FLOAT64_C(  -533.92), EASYSIMD_FLOAT64_C(   282.75), EASYSIMD_FLOAT64_C(   -62.52),
      EASYSIMD_FLOAT64_C(   990.20), EASYSIMD_FLOAT64_C(  -555.43), EASYSIMD_FLOAT64_C(   430.78), EASYSIMD_FLOAT64_C(  -413.15),
      EASYSIMD_FLOAT64_C(   411.48), EASYSIMD_FLOAT64_C(  -815.06), EASYSIMD_FLOAT64_C(   164.99), EASYSIMD_FLOAT64_C(   487.81),
      EASYSIMD_FLOAT64_C(  -199.58), EASYSIMD_FLOAT64_C(  -785.71), EASYSIMD_FLOAT64_C(   280.79), EASYSIMD_FLOAT64_C(  -861.17),
      EASYSIMD_FLOAT64_C(   820.00), EASYSIMD_FLOAT64_C(   544.78), EASYSIMD_FLOAT64_C(   743.59), EASYSIMD_FLOAT64_C(  -676.14),
      EASYSIMD_FLOAT64_C(   475.20), EASYSIMD_FLOAT64_C(     8.44), EASYSIMD_FLOAT64_C(    83.45), EASYSIMD_FLOAT64_C(   687.60),
      EASYSIMD_FLOAT64_C(  -142.20), EASYSIMD_FLOAT64_C(  -370.73), EASYSIMD_FLOAT64_C(  -691.29), EASYSIMD_FLOAT64_C(  -811.95),
      EASYSIMD_FLOAT64_C(   549.67), EASYSIMD_FLOAT64_C(   163.46), EASYSIMD_FLOAT64_C(   543.09), EASYSIMD_FLOAT64_C(    28.45),
      EASYSIMD_FLOAT64_C(   629.55), EASYSIMD_FLOAT64_C(  -174.15), EASYSIMD_FLOAT64_C(   965.93), EASYSIMD_FLOAT64_C(   619.75),
      EASYSIMD_FLOAT64_C(   270.42), EASYSIMD_FLOAT64_C(   396.70), EASYSIMD_FLOAT64_C(  -793.41), EASYSIMD_FLOAT64_C(  -318.10),
      EASYSIMD_FLOAT64_C(   581.64), EASYSIMD_FLOAT64_C(   371.58), EASYSIMD_FLOAT64_C(  -830.29), EASYSIMD_FLOAT64_C(  -617.94),
      EASYSIMD_FLOAT64_C(   585.87), EASYSIMD_FLOAT64_C(   450.50), EASYSIMD_FLOAT64_C(  -479.11), EASYSIMD_FLOAT64_C(   405.87),
      EASYSIMD_FLOAT64_C(    -4.72), EASYSIMD_FLOAT64_C(  -735.52), EASYSIMD_FLOAT64_C(   729.73), EASYSIMD_FLOAT64_C(  -529.52),
      EASYSIMD_FLOAT64_C(   272.93), EASYSIMD_FLOAT64_C(  -186.82), EASYSIMD_FLOAT64_C(  -841.92), EASYSIMD_FLOAT64_C(  -869.27),
      EASYSIMD_FLOAT64_C(   442.45), EASYSIMD_FLOAT64_C(  -533.21), EASYSIMD_FLOAT64_C(  -681.22), EASYSIMD_FLOAT64_C(    -7.88) };
  static const int64_t e[] =
    {  INT64_C(                   0), -INT64_C(                   1), -INT64_C(                   1),  INT64_C(                   0),
       INT64_C(                   0),  INT64_C(                   0), -INT64_C(                   1),  INT64_C(                   0),
       INT64_C(                   0), -INT64_C(                   1),  INT64_C(                   0),  INT64_C(                   0),
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b64(), pg)) {
    ...
    pv = easysimd_svcmplt_s64(pg, easysimd_svld1_s64(pg, &(p[i])), easysimd_svdup_n_s64(0));
    ev = easysimd_svcmplt_f64(pv, av, bv);
  ...
  return 0;
#else
  easysimd_float64 a[1024 / sizeof(int64_t)], b[1024 / sizeof(int64_t)];
  int64_t p[1024 / sizeof(int64_t)], e[1024 / sizeof(int64_t)];
  int32_t len = easysimd_test_codegen_random_i64() & (sizeof(e) / sizeof(e[0]));

  fputc('\n', stdout);

  easysimd_test_codegen_random_memory(sizeof(p), HEDLEY_REINTERPRET_CAST(uint8_t*, p));
  easysimd_test_codegen_random_vf64(len, a, EASYSIMD_FLOAT64_C(-1000.0), EASYSIMD_FLOAT64_C(1000.0));
  easysimd_test_codegen_random_vf64(len, b, EASYSIMD_FLOAT64_C(-1000.0), EASYSIMD_FLOAT64_C(1000.0));

  int32_t i = 0;
  easysimd_svbool_t pg = easysimd_svwhilelt_b64_s32(i, len);
  while (easysimd_svptest_first(easysimd_svptrue_b64(), pg)) {
    easysimd_svfloat64_t av, bv;
    easysimd_svbool_t pv, ev;
...
EASYSIMD_TEST_FUNC_LIST_ENTRY(svcmplt_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(svcmplt_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(svcmplt_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(svcmplt_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(svcmplt_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(svcmplt_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(svcmplt_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(svcmplt_u64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(svcmplt_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(svcmplt_f64)
