#define EASYSIMD_TEST_ARM_SVE_INSN dup
...
static int
test_easysimd_svdup_n_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b8(), pg)) {
    easysimd_svint8_t rv;

    rv = easysimd_svdup_n_s8(a);
  ...
  len = easysimd_test_codegen_random_i16() & ((sizeof(e) / sizeof(e[0])) - 1);
  a = easysimd_test_codegen_random_i8();

  int32_t i = 0;
  easysimd_svbool_t pg = easysimd_svwhilelt_b8_s32(i, len);
  while (easysimd_svptest_first(easysimd_svptrue_b8(), pg)) {
    easysimd_svint8_t ev;

    ev = easysimd_svdup_n_s8(a);
  ...
  easysimd_test_codegen_write_1i8(1, a);
...
static int
test_easysimd_svdup_n_s8_z (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
...
static int
test_easysimd_svdup_n_s8_m (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const int8_t p[] =
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b8(), pg)) {
    ...
    pv = easysimd_svcmplt_s8(pg, easysimd_svld1_s8(pg, &(p[i])), easysimd_svdup_n_s8(INT8_C(0)));
    rv = easysimd_svdup_n_s8_m(av, pv, b);
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b8(), pg)) {
    ...
    ev = easysimd_svdup_n_s8_m(av, pv, b);
...
static int
test_easysimd_svdup_n_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b16(), pg)) {
    easysimd_svint16_t rv;

    rv = easysimd_svdup_n_s16(a);
  ...
  len = easysimd_test_codegen_random_i16() & ((sizeof(e) / sizeof(e[0])) - 1);
  a = easysimd_test_codegen_random_i16();

  int32_t i = 0;
  easysimd_svbool_t pg = easysimd_svwhilelt_b16_s32(i, len);
  while (easysimd_svptest_first(easysimd_svptrue_b16(), pg)) {
    easysimd_svint16_t ev;

    ev = easysimd_svdup_n_s16(a);
...
static int
test_easysimd_svdup_n_s16_z (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b16(), pg)) {
    ...
    rv = easysimd_svdup_n_s16_z(pv, a);
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b16(), pg)) {
    ...
    ev = easysimd_svdup_n_s16_z(pv, a);
  ...
  easysimd_test_codegen_write_1i16(1, a);
  easysimd_test_codegen_write_1vi16(1, HEDLEY_STATIC_CAST(size_t, len), e);
...
static int
test_easysimd_svdup_n_s16_m (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const int16_t p[] =
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b16(), pg)) {
    ...
    pv = easysimd_svcmplt_s16(pg, easysimd_svld1_s16(pg, &(p[i])), easysimd_svdup_n_s16(INT16_C(0)));
    rv = easysimd_svdup_n_s16_m(av, pv, b);
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b16(), pg)) {
    ...
    ev = easysimd_svdup_n_s16_m(av, pv, b);
...
static int
test_easysimd_svdup_n_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b32(), pg)) {
    easysimd_svint32_t rv;

    rv = easysimd_svdup_n_s32(a);
  ...
  len = easysimd_test_codegen_random_i32() & ((sizeof(e) / sizeof(e[0])) - 1);
  a = easysimd_test_codegen_random_i32();

  int32_t i = 0;
  easysimd_svbool_t pg = easysimd_svwhilelt_b32_s32(i, len);
  while (easysimd_svptest_first(easysimd_svptrue_b32(), pg)) {
    easysimd_svint32_t ev;

    ev = easysimd_svdup_n_s32(a);
...
static int
test_easysimd_svdup_n_s32_z (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b32(), pg)) {
    ...
    rv = easysimd_svdup_n_s32_z(pv, a);
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b32(), pg)) {
    ...
    ev = easysimd_svdup_n_s32_z(pv, a);
  ...
  easysimd_test_codegen_write_1i32(1, a);
  easysimd_test_codegen_write_1vi32(1, HEDLEY_STATIC_CAST(size_t, len), e);
...
static int
test_easysimd_svdup_n_s32_m (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const int32_t p[] =
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b32(), pg)) {
    ...
    pv = easysimd_svcmplt_s32(pg, easysimd_svld1_s32(pg, &(p[i])), easysimd_svdup_n_s32(INT32_C(0)));
    rv = easysimd_svdup_n_s32_m(av, pv, b);
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b32(), pg)) {
    ...
    ev = easysimd_svdup_n_s32_m(av, pv, b);
...
static int
test_easysimd_svdup_n_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b64(), pg)) {
    easysimd_svint64_t rv;

    rv = easysimd_svdup_n_s64(a);
  ...
  len = easysimd_test_codegen_random_i64() & ((sizeof(e) / sizeof(e[0])) - 1);
  a = easysimd_test_codegen_random_i64();

  int64_t i = 0;
  easysimd_svbool_t pg = easysimd_svwhilelt_b64_s32(i, len);
  while (easysimd_svptest_first(easysimd_svptrue_b64(), pg)) {
    easysimd_svint64_t ev;

    ev = easysimd_svdup_n_s64(a);
...
static int
test_easysimd_svdup_n_s64_z (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b64(), pg)) {
    ...
    rv = easysimd_svdup_n_s64_z(pv, a);
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b64(), pg)) {
    ...
    ev = easysimd_svdup_n_s64_z(pv, a);
  ...
  easysimd_test_codegen_write_1i64(1, a);
  easysimd_test_codegen_write_1vi64(1, HEDLEY_STATIC_CAST(size_t, len), e);
...
static int
test_easysimd_svdup_n_s64_m (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const int64_t p[] =
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b64(), pg)) {
    ...
    pv = easysimd_svcmplt_s64(pg, easysimd_svld1_s64(pg, &(p[i])), easysimd_svdup_n_s64(INT64_C(0)));
    rv = easysimd_svdup_n_s64_m(av, pv, b);
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b64(), pg)) {
    ...
    ev = easysimd_svdup_n_s64_m(av, pv, b);
...
static int
test_easysimd_svdup_n_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  ...
  easysimd_svbool_t pg = easysimd_svwhilelt_b8_s32(i, len);
  while (easysimd_svptest_first(easysimd_svptrue_b8(), pg)) {
    easysimd_svuint8_t rv;

    rv = easysimd_svdup_n_u8(a);
  ...
  len = easysimd_test_codegen_random_u16() & ((sizeof(e) / sizeof(e[0])) - 1);
  a = easysimd_test_codegen_random_u8();

  int32_t i = 0;
  easysimd_svbool_t pg = easysimd_svwhilelt_b8_s32(i, len);
  while (easysimd_svptest_first(easysimd_svptrue_b8(), pg)) {
    easysimd_svuint8_t ev;

    ev = easysimd_svdup_n_u8(a);
  ...
  easysimd_test_codegen_write_1u8(1, a);
...
static int
test_easysimd_svdup_n_u8_z (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const int8_t p[] =
...
static int
test_easysimd_svdup_n_u8_m (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const int8_t p[] =
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b8(), pg)) {
    ...
    pv = easysimd_svcmplt_s8(pg, easysimd_svld1_s8(pg, &(p[i])), easysimd_svdup_n_s8(INT8_C(0)));
    rv = easysimd_svdup_n_u8_m(av, pv, b);
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b8(), pg)) {
    ...
    ev = easysimd_svdup_n_u8_m(av, pv, b);
...
static int
test_easysimd_svdup_n_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  ...
  easysimd_svbool_t pg = easysimd_svwhilelt_b16_s32(i, len);
  while (easysimd_svptest_first(easysimd_svptrue_b16(), pg)) {
    easysimd_svuint16_t rv;

    rv = easysimd_svdup_n_u16(a);
  ...
  len = easysimd_test_codegen_random_u16() & ((sizeof(e) / sizeof(e[0])) - 1);
  a = easysimd_test_codegen_random_u16();

  int32_t i = 0;
  easysimd_svbool_t pg = easysimd_svwhilelt_b16_s32(i, len);
  while (easysimd_svptest_first(easysimd_svptrue_b16(), pg)) {
    easysimd_svuint16_t ev;

    ev = easysimd_svdup_n_u16(a);
  ...
  easysimd_test_codegen_write_1u16(1, a);
...
static int
test_easysimd_svdup_n_u16_z (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const int16_t p[] =
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b16(), pg)) {
    ...
    pv = easysimd_svcmplt_s16(pg, easysimd_svld1_s16(pg, &(p[i])), easysimd_svdup_n_s16(INT16_C(0)));
    rv = easysimd_svdup_n_u16_z(pv, a);
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b16(), pg)) {
    ...
    pv = easysimd_svcmplt_s16(pg, easysimd_svld1_s16(pg, &(p[i])), easysimd_svdup_n_s16(0));
    ev = easysimd_svdup_n_u16_z(pv, a);
...
static int
test_easysimd_svdup_n_u16_m (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const int16_t p[] =
    { -INT16_C(     1),  INT16_C(     0),  INT16_C(     0),  INT16_C(     0),  INT16_C(     0), -INT16_C(     1),  INT16_C(     0),  INT16_C(     0),
      -INT16_C(     1), -INT16_C(     1),  INT16_C(     0),  INT16_C(     0), -INT16_C(     1),  INT16_C(     0),  INT16_C(     0),  INT16_C(     0),
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b16(), pg)) {
    ...
    pv = easysimd_svcmplt_s16(pg, easysimd_svld1_s16(pg, &(p[i])), easysimd_svdup_n_s16(INT16_C(0)));
    rv = easysimd_svdup_n_u16_m(av, pv, b);
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b16(), pg)) {
    ...
    ev = easysimd_svdup_n_u16_m(av, pv, b);
...
static int
test_easysimd_svdup_n_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  ...
  easysimd_svbool_t pg = easysimd_svwhilelt_b32_s32(i, len);
  while (easysimd_svptest_first(easysimd_svptrue_b32(), pg)) {
    easysimd_svuint32_t rv;

    rv = easysimd_svdup_n_u32(a);
  ...
  len = easysimd_test_codegen_random_u32() & ((sizeof(e) / sizeof(e[0])) - 1);
  a = easysimd_test_codegen_random_u32();

  int32_t i = 0;
  easysimd_svbool_t pg = easysimd_svwhilelt_b32_s32(i, len);
  while (easysimd_svptest_first(easysimd_svptrue_b32(), pg)) {
    easysimd_svuint32_t ev;

    ev = easysimd_svdup_n_u32(a);
  ...
  easysimd_test_codegen_write_1u32(1, a);
...
static int
test_easysimd_svdup_n_u32_z (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const int32_t p[] =
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b32(), pg)) {
    ...
    pv = easysimd_svcmplt_s32(pg, easysimd_svld1_s32(pg, &(p[i])), easysimd_svdup_n_s32(INT32_C(0)));
    rv = easysimd_svdup_n_u32_z(pv, a);
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b32(), pg)) {
    ...
    pv = easysimd_svcmplt_s32(pg, easysimd_svld1_s32(pg, &(p[i])), easysimd_svdup_n_s32(0));
    ev = easysimd_svdup_n_u32_z(pv, a);
...
static int
test_easysimd_svdup_n_u32_m (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const int32_t p[] =
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b32(), pg)) {
    ...
    pv = easysimd_svcmplt_s32(pg, easysimd_svld1_s32(pg, &(p[i])), easysimd_svdup_n_s32(INT32_C(0)));
    rv = easysimd_svdup_n_u32_m(av, pv, b);
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b32(), pg)) {
    ...
    ev = easysimd_svdup_n_u32_m(av, pv, b);

    easysimd_svst1_u32(pg, &(e[i]), ev);
    easysimd_svst1_s32(pg, &(p[i]), easysimd_svdup_n_s32_z(pv, ~INT64_C(0)));
...
static int
test_easysimd_svdup_n_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  ...
  easysimd_svbool_t pg = easysimd_svwhilelt_b64_s32(i, len);
  while (easysimd_svptest_first(easysimd_svptrue_b64(), pg)) {
    easysimd_svuint64_t rv;

    rv = easysimd_svdup_n_u64(a);
  ...
  len = easysimd_test_codegen_random_u64() & ((sizeof(e) / sizeof(e[0])) - 1);
  a = easysimd_test_codegen_random_u64();

  int64_t i = 0;
  easysimd_svbool_t pg = easysimd_svwhilelt_b64_s32(i, len);
  while (easysimd_svptest_first(easysimd_svptrue_b64(), pg)) {
    easysimd_svuint64_t ev;

    ev = easysimd_svdup_n_u64(a);
  ...
  easysimd_test_codegen_write_1u64(1, a);
...
static int
test_easysimd_svdup_n_u64_z (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const int64_t p[] =
    {  INT64_C(                   0),  INT64_C(                   0),  INT64_C(                   0),  INT64_C(                   0),
       INT64_C(                   0),  INT64_C(                   0),  INT64_C(                   0), -INT64_C(                   1),
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b64(), pg)) {
    ...
    pv = easysimd_svcmplt_s64(pg, easysimd_svld1_s64(pg, &(p[i])), easysimd_svdup_n_s64(INT64_C(0)));
    rv = easysimd_svdup_n_u64_z(pv, a);
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b64(), pg)) {
    ...
    pv = easysimd_svcmplt_s64(pg, easysimd_svld1_s64(pg, &(p[i])), easysimd_svdup_n_s64(0));
    ev = easysimd_svdup_n_u64_z(pv, a);
...
static int
test_easysimd_svdup_n_u64_m (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const int64_t p[] =
    {  INT64_C(                   0),  INT64_C(                   0),  INT64_C(                   0),  INT64_C(                   0),
       INT64_C(                   0), -INT64_C(                   1), -INT64_C(                   1), -INT64_C(                   1),
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b64(), pg)) {
    ...
    pv = easysimd_svcmplt_s64(pg, easysimd_svld1_s64(pg, &(p[i])), easysimd_svdup_n_s64(INT64_C(0)));
    rv = easysimd_svdup_n_u64_m(av, pv, b);
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b64(), pg)) {
    ...
    ev = easysimd_svdup_n_u64_m(av, pv, b);
...
static int
test_easysimd_svdup_n_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const easysimd_float32 a = EASYSIMD_FLOAT32_C(  -509.41);
  static const easysimd_float32 e[] =
    { EASYSIMD_FLOAT32_C(  -509.41), EASYSIMD_FLOAT32_C(  -509.41), EASYSIMD_FLOAT32_C(  -509.41), EASYSIMD_FLOAT32_C(  -509.41),
      EASYSIMD_FLOAT32_C(  -509.41), EASYSIMD_FLOAT32_C(  -509.41), EASYSIMD_FLOAT32_C(  -509.41), EASYSIMD_FLOAT32_C(  -509.41),
      EASYSIMD_FLOAT32_C(  -509.41), EASYSIMD_FLOAT32_C(  -509.41), EASYSIMD_FLOAT32_C(  -509.41), EASYSIMD_FLOAT32_C(  -509.41),
      EASYSIMD_FLOAT32_C(  -509.41), EASYSIMD_FLOAT32_C(  -509.41), EASYSIMD_FLOAT32_C(  -509.41), EASYSIMD_FLOAT32_C(  -509.41),
      EASYSIMD_FLOAT32_C(  -509.41), EASYSIMD_FLOAT32_C(  -509.41), EASYSIMD_FLOAT32_C(  -509.41), EASYSIMD_FLOAT32_C(  -509.41),
      ...
      EASYSIMD_FLOAT32_C(  -509.41), EASYSIMD_FLOAT32_C(  -509.41), EASYSIMD_FLOAT32_C(  -509.41), EASYSIMD_FLOAT32_C(  -509.41),
      EASYSIMD_FLOAT32_C(  -509.41), EASYSIMD_FLOAT32_C(  -509.41), EASYSIMD_FLOAT32_C(  -509.41), EASYSIMD_FLOAT32_C(  -509.41),
      EASYSIMD_FLOAT32_C(  -509.41), EASYSIMD_FLOAT32_C(  -509.41) };
  ...
  easysimd_svbool_t pg = easysimd_svwhilelt_b32_s32(i, len);
  while (easysimd_svptest_first(easysimd_svptrue_b32(), pg)) {
    easysimd_svfloat32_t rv;

    rv = easysimd_svdup_n_f32(a);
  ...
  return 0;
#else
  easysimd_float32 a, e[1024 / sizeof(int32_t)];
  int32_t len;

  fputc('\n', stdout);

  len = easysimd_test_codegen_random_i32() & ((sizeof(e) / sizeof(e[0])) - 1);
  a = easysimd_test_codegen_random_f32(EASYSIMD_FLOAT32_C(-1000.0), EASYSIMD_FLOAT32_C(1000.0));

  int32_t i = 0;
  easysimd_svbool_t pg = easysimd_svwhilelt_b32_s32(i, len);
  while (easysimd_svptest_first(easysimd_svptrue_b32(), pg)) {
    easysimd_svfloat32_t ev;

    ev = easysimd_svdup_n_f32(a);
  ...
  easysimd_test_codegen_write_1f32(1, a);
...
static int
test_easysimd_svdup_n_f32_z (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const int32_t p[] =
  ...
  static const easysimd_float32 a = EASYSIMD_FLOAT32_C(  -105.00);
  static const easysimd_float32 e[] =
    { EASYSIMD_FLOAT32_C(  -105.00), EASYSIMD_FLOAT32_C(  -105.00), EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(     0.00),
      EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(  -105.00), EASYSIMD_FLOAT32_C(  -105.00), EASYSIMD_FLOAT32_C(     0.00),
      EASYSIMD_FLOAT32_C(  -105.00), EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(     0.00),
      EASYSIMD_FLOAT32_C(  -105.00), EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(  -105.00), EASYSIMD_FLOAT32_C(  -105.00),
      EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(  -105.00), EASYSIMD_FLOAT32_C(  -105.00), EASYSIMD_FLOAT32_C(     0.00),
      EASYSIMD_FLOAT32_C(  -105.00), EASYSIMD_FLOAT32_C(  -105.00), EASYSIMD_FLOAT32_C(  -105.00), EASYSIMD_FLOAT32_C(     0.00),
      EASYSIMD_FLOAT32_C(  -105.00), EASYSIMD_FLOAT32_C(  -105.00), EASYSIMD_FLOAT32_C(  -105.00), EASYSIMD_FLOAT32_C(  -105.00),
      EASYSIMD_FLOAT32_C(  -105.00), EASYSIMD_FLOAT32_C(  -105.00), EASYSIMD_FLOAT32_C(  -105.00), EASYSIMD_FLOAT32_C(  -105.00),
      EASYSIMD_FLOAT32_C(  -105.00), EASYSIMD_FLOAT32_C(  -105.00), EASYSIMD_FLOAT32_C(  -105.00), EASYSIMD_FLOAT32_C(  -105.00),
      EASYSIMD_FLOAT32_C(  -105.00), EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(  -105.00), EASYSIMD_FLOAT32_C(  -105.00),
      EASYSIMD_FLOAT32_C(  -105.00), EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(     0.00),
      EASYSIMD_FLOAT32_C(  -105.00), EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(  -105.00), EASYSIMD_FLOAT32_C(     0.00),
      EASYSIMD_FLOAT32_C(  -105.00), EASYSIMD_FLOAT32_C(  -105.00), EASYSIMD_FLOAT32_C(  -105.00), EASYSIMD_FLOAT32_C(  -105.00),
      EASYSIMD_FLOAT32_C(  -105.00), EASYSIMD_FLOAT32_C(  -105.00), EASYSIMD_FLOAT32_C(  -105.00), EASYSIMD_FLOAT32_C(     0.00),
      EASYSIMD_FLOAT32_C(  -105.00), EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(  -105.00),
      EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(  -105.00), EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(  -105.00),
      EASYSIMD_FLOAT32_C(  -105.00), EASYSIMD_FLOAT32_C(  -105.00), EASYSIMD_FLOAT32_C(  -105.00), EASYSIMD_FLOAT32_C(  -105.00),
      EASYSIMD_FLOAT32_C(  -105.00), EASYSIMD_FLOAT32_C(  -105.00), EASYSIMD_FLOAT32_C(  -105.00), EASYSIMD_FLOAT32_C(  -105.00),
      EASYSIMD_FLOAT32_C(  -105.00), EASYSIMD_FLOAT32_C(  -105.00), EASYSIMD_FLOAT32_C(  -105.00), EASYSIMD_FLOAT32_C(  -105.00),
      EASYSIMD_FLOAT32_C(  -105.00), EASYSIMD_FLOAT32_C(  -105.00), EASYSIMD_FLOAT32_C(  -105.00), EASYSIMD_FLOAT32_C(  -105.00),
      EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(  -105.00), EASYSIMD_FLOAT32_C(  -105.00),
      EASYSIMD_FLOAT32_C(  -105.00), EASYSIMD_FLOAT32_C(  -105.00), EASYSIMD_FLOAT32_C(  -105.00), EASYSIMD_FLOAT32_C(  -105.00),
      EASYSIMD_FLOAT32_C(  -105.00), EASYSIMD_FLOAT32_C(  -105.00), EASYSIMD_FLOAT32_C(  -105.00), EASYSIMD_FLOAT32_C(  -105.00),
      EASYSIMD_FLOAT32_C(  -105.00), EASYSIMD_FLOAT32_C(  -105.00), EASYSIMD_FLOAT32_C(  -105.00), EASYSIMD_FLOAT32_C(  -105.00),
      EASYSIMD_FLOAT32_C(  -105.00), EASYSIMD_FLOAT32_C(  -105.00), EASYSIMD_FLOAT32_C(  -105.00), EASYSIMD_FLOAT32_C(  -105.00),
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b32(), pg)) {
    ...
    pv = easysimd_svcmplt_s32(pg, easysimd_svld1_s32(pg, &(p[i])), easysimd_svdup_n_s32(INT32_C(0)));
    rv = easysimd_svdup_n_f32_z(pv, a);
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b32(), pg)) {
    ...
    pv = easysimd_svcmplt_f32(pg, easysimd_svreinterpret_f32_s32(easysimd_svld1_s32(pg, &(p[i]))), easysimd_svdup_n_f32(0));
    ev = easysimd_svdup_n_f32_z(pv, a);
...
static int
test_easysimd_svdup_n_f32_m (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const int32_t p[] =
  ...
  static const easysimd_float32 a[] =
    { EASYSIMD_FLOAT32_C(  -565.61), EASYSIMD_FLOAT32_C(  -379.72), EASYSIMD_FLOAT32_C(   460.37), EASYSIMD_FLOAT32_C(   144.14),
      EASYSIMD_FLOAT32_C(   325.75), EASYSIMD_FLOAT32_C(   626.27), EASYSIMD_FLOAT32_C(  -567.97), EASYSIMD_FLOAT32_C(  -564.20),
      EASYSIMD_FLOAT32_C(     7.88), EASYSIMD_FLOAT32_C(   640.52), EASYSIMD_FLOAT32_C(    20.60), EASYSIMD_FLOAT32_C(  -373.75),
      EASYSIMD_FLOAT32_C(   632.23), EASYSIMD_FLOAT32_C(   427.56), EASYSIMD_FLOAT32_C(   300.92), EASYSIMD_FLOAT32_C(  -589.57),
      EASYSIMD_FLOAT32_C(   164.48), EASYSIMD_FLOAT32_C(  -871.42), EASYSIMD_FLOAT32_C(   866.10), EASYSIMD_FLOAT32_C(   783.63),
      EASYSIMD_FLOAT32_C(   408.25), EASYSIMD_FLOAT32_C(   985.83), EASYSIMD_FLOAT32_C(    31.46), EASYSIMD_FLOAT32_C(  -434.91),
      EASYSIMD_FLOAT32_C(   177.94), EASYSIMD_FLOAT32_C(  -307.00), EASYSIMD_FLOAT32_C(  -552.56), EASYSIMD_FLOAT32_C(   476.04),
      EASYSIMD_FLOAT32_C(   298.30), EASYSIMD_FLOAT32_C(  -458.60), EASYSIMD_FLOAT32_C(   851.10), EASYSIMD_FLOAT32_C(   732.69),
      EASYSIMD_FLOAT32_C(   161.68), EASYSIMD_FLOAT32_C(   311.46), EASYSIMD_FLOAT32_C(  -123.17), EASYSIMD_FLOAT32_C(  -512.57),
      EASYSIMD_FLOAT32_C(   -62.26), EASYSIMD_FLOAT32_C(   308.86), EASYSIMD_FLOAT32_C(   -76.77), EASYSIMD_FLOAT32_C(   945.62),
      EASYSIMD_FLOAT32_C(   -50.62), EASYSIMD_FLOAT32_C(   943.82), EASYSIMD_FLOAT32_C(  -428.13), EASYSIMD_FLOAT32_C(  -418.39),
      EASYSIMD_FLOAT32_C(   371.38), EASYSIMD_FLOAT32_C(   872.79), EASYSIMD_FLOAT32_C(    -7.96), EASYSIMD_FLOAT32_C(  -464.13),
      EASYSIMD_FLOAT32_C(  -998.63), EASYSIMD_FLOAT32_C(  -141.86), EASYSIMD_FLOAT32_C(  -680.50), EASYSIMD_FLOAT32_C(   409.61),
      EASYSIMD_FLOAT32_C(  -156.04), EASYSIMD_FLOAT32_C(   350.96), EASYSIMD_FLOAT32_C(   974.70), EASYSIMD_FLOAT32_C(  -978.09),
      EASYSIMD_FLOAT32_C(  -956.04), EASYSIMD_FLOAT32_C(  -577.86), EASYSIMD_FLOAT32_C(   497.95), EASYSIMD_FLOAT32_C(   342.26),
      EASYSIMD_FLOAT32_C(   -36.46), EASYSIMD_FLOAT32_C(   349.04), EASYSIMD_FLOAT32_C(    74.95), EASYSIMD_FLOAT32_C(  -874.78),
      EASYSIMD_FLOAT32_C(  -339.49), EASYSIMD_FLOAT32_C(   951.79), EASYSIMD_FLOAT32_C(  -387.35), EASYSIMD_FLOAT32_C(   598.24),
      EASYSIMD_FLOAT32_C(   260.64), EASYSIMD_FLOAT32_C(   535.88), EASYSIMD_FLOAT32_C(   543.86), EASYSIMD_FLOAT32_C(  -789.98),
      EASYSIMD_FLOAT32_C(   479.70), EASYSIMD_FLOAT32_C(  -884.27), EASYSIMD_FLOAT32_C(  -208.37), EASYSIMD_FLOAT32_C(  -148.91),
      EASYSIMD_FLOAT32_C(   988.52), EASYSIMD_FLOAT32_C(   783.67), EASYSIMD_FLOAT32_C(   386.96), EASYSIMD_FLOAT32_C(   989.89),
      EASYSIMD_FLOAT32_C(  -358.19), EASYSIMD_FLOAT32_C(   706.46), EASYSIMD_FLOAT32_C(   399.51), EASYSIMD_FLOAT32_C(   485.77),
      EASYSIMD_FLOAT32_C(    57.42), EASYSIMD_FLOAT32_C(   374.21), EASYSIMD_FLOAT32_C(   507.68), EASYSIMD_FLOAT32_C(   101.38),
      EASYSIMD_FLOAT32_C(   796.35), EASYSIMD_FLOAT32_C(     5.62), EASYSIMD_FLOAT32_C(  -556.36), EASYSIMD_FLOAT32_C(  -240.11),
      EASYSIMD_FLOAT32_C(  -645.34), EASYSIMD_FLOAT32_C(   518.60), EASYSIMD_FLOAT32_C(  -114.89), EASYSIMD_FLOAT32_C(    15.17),
      EASYSIMD_FLOAT32_C(   470.38), EASYSIMD_FLOAT32_C(   497.76), EASYSIMD_FLOAT32_C(  -386.59), EASYSIMD_FLOAT32_C(  -268.97),
      EASYSIMD_FLOAT32_C(    33.64), EASYSIMD_FLOAT32_C(  -842.73), EASYSIMD_FLOAT32_C(   -58.95), EASYSIMD_FLOAT32_C(  -486.65),
      EASYSIMD_FLOAT32_C(  -726.99), EASYSIMD_FLOAT32_C(   732.68), EASYSIMD_FLOAT32_C(   364.44), EASYSIMD_FLOAT32_C(  -738.47),
      EASYSIMD_FLOAT32_C(   516.35), EASYSIMD_FLOAT32_C(  -248.61), EASYSIMD_FLOAT32_C(  -748.58), EASYSIMD_FLOAT32_C(  -841.84),
      EASYSIMD_FLOAT32_C(  -542.15), EASYSIMD_FLOAT32_C(   650.93), EASYSIMD_FLOAT32_C(   643.93), EASYSIMD_FLOAT32_C(   515.27),
      EASYSIMD_FLOAT32_C(    25.14), EASYSIMD_FLOAT32_C(   151.61), EASYSIMD_FLOAT32_C(  -383.35), EASYSIMD_FLOAT32_C(  -178.51),
      EASYSIMD_FLOAT32_C(  -842.77), EASYSIMD_FLOAT32_C(    60.29), EASYSIMD_FLOAT32_C(   581.38), EASYSIMD_FLOAT32_C(  -488.10),
      EASYSIMD_FLOAT32_C(  -421.11), EASYSIMD_FLOAT32_C(  -533.51), EASYSIMD_FLOAT32_C(   527.06), EASYSIMD_FLOAT32_C(  -950.73),
      EASYSIMD_FLOAT32_C(   964.25), EASYSIMD_FLOAT32_C(  -859.52) };
  static const easysimd_float32 b = EASYSIMD_FLOAT32_C(  -219.70);
  static const easysimd_float32 e[] =
    { EASYSIMD_FLOAT32_C(  -565.61), EASYSIMD_FLOAT32_C(  -219.70), EASYSIMD_FLOAT32_C(   460.37), EASYSIMD_FLOAT32_C(   144.14),
      EASYSIMD_FLOAT32_C(   325.75), EASYSIMD_FLOAT32_C(   626.27), EASYSIMD_FLOAT32_C(  -567.97), EASYSIMD_FLOAT32_C(  -219.70),
      EASYSIMD_FLOAT32_C(  -219.70), EASYSIMD_FLOAT32_C(  -219.70), EASYSIMD_FLOAT32_C(    20.60), EASYSIMD_FLOAT32_C(  -219.70),
      EASYSIMD_FLOAT32_C(   632.23), EASYSIMD_FLOAT32_C(  -219.70), EASYSIMD_FLOAT32_C(  -219.70), EASYSIMD_FLOAT32_C(  -589.57),
      EASYSIMD_FLOAT32_C(   164.48), EASYSIMD_FLOAT32_C(  -871.42), EASYSIMD_FLOAT32_C(   866.10), EASYSIMD_FLOAT32_C(  -219.70),
      EASYSIMD_FLOAT32_C(  -219.70), EASYSIMD_FLOAT32_C(  -219.70), EASYSIMD_FLOAT32_C(  -219.70), EASYSIMD_FLOAT32_C(  -434.91),
      EASYSIMD_FLOAT32_C(  -219.70), EASYSIMD_FLOAT32_C(  -219.70), EASYSIMD_FLOAT32_C(  -552.56), EASYSIMD_FLOAT32_C(   476.04),
      EASYSIMD_FLOAT32_C(   298.30), EASYSIMD_FLOAT32_C(  -458.60), EASYSIMD_FLOAT32_C(   851.10), EASYSIMD_FLOAT32_C(  -219.70),
      EASYSIMD_FLOAT32_C(   161.68), EASYSIMD_FLOAT32_C(  -219.70), EASYSIMD_FLOAT32_C(  -123.17), EASYSIMD_FLOAT32_C(  -219.70),
      EASYSIMD_FLOAT32_C(  -219.70), EASYSIMD_FLOAT32_C(  -219.70), EASYSIMD_FLOAT32_C(  -219.70), EASYSIMD_FLOAT32_C(   945.62),
      EASYSIMD_FLOAT32_C(  -219.70), EASYSIMD_FLOAT32_C(   943.82), EASYSIMD_FLOAT32_C(  -428.13), EASYSIMD_FLOAT32_C(  -418.39),
      EASYSIMD_FLOAT32_C(   371.38), EASYSIMD_FLOAT32_C(   872.79), EASYSIMD_FLOAT32_C(  -219.70), EASYSIMD_FLOAT32_C(  -219.70),
      EASYSIMD_FLOAT32_C(  -219.70), EASYSIMD_FLOAT32_C(  -141.86), EASYSIMD_FLOAT32_C(  -680.50), EASYSIMD_FLOAT32_C(  -219.70),
      EASYSIMD_FLOAT32_C(  -219.70), EASYSIMD_FLOAT32_C(   350.96), EASYSIMD_FLOAT32_C(   974.70), EASYSIMD_FLOAT32_C(  -219.70),
      EASYSIMD_FLOAT32_C(  -219.70), EASYSIMD_FLOAT32_C(  -219.70), EASYSIMD_FLOAT32_C(   497.95), EASYSIMD_FLOAT32_C(   342.26),
      EASYSIMD_FLOAT32_C(  -219.70), EASYSIMD_FLOAT32_C(   349.04), EASYSIMD_FLOAT32_C(  -219.70), EASYSIMD_FLOAT32_C(  -219.70),
      EASYSIMD_FLOAT32_C(  -219.70), EASYSIMD_FLOAT32_C(  -219.70), EASYSIMD_FLOAT32_C(  -387.35), EASYSIMD_FLOAT32_C(   598.24),
      EASYSIMD_FLOAT32_C(   260.64), EASYSIMD_FLOAT32_C(   535.88), EASYSIMD_FLOAT32_C(   543.86), EASYSIMD_FLOAT32_C(  -789.98),
      EASYSIMD_FLOAT32_C(  -219.70), EASYSIMD_FLOAT32_C(  -884.27), EASYSIMD_FLOAT32_C(  -219.70), EASYSIMD_FLOAT32_C(  -148.91),
      EASYSIMD_FLOAT32_C(  -219.70), EASYSIMD_FLOAT32_C(  -219.70), EASYSIMD_FLOAT32_C(  -219.70), EASYSIMD_FLOAT32_C(   989.89),
      EASYSIMD_FLOAT32_C(  -219.70), EASYSIMD_FLOAT32_C(  -219.70), EASYSIMD_FLOAT32_C(  -219.70), EASYSIMD_FLOAT32_C(  -219.70),
      EASYSIMD_FLOAT32_C(    57.42), EASYSIMD_FLOAT32_C(   374.21), EASYSIMD_FLOAT32_C(   507.68), EASYSIMD_FLOAT32_C(   101.38),
      EASYSIMD_FLOAT32_C(  -219.70), EASYSIMD_FLOAT32_C(     5.62), EASYSIMD_FLOAT32_C(  -556.36), EASYSIMD_FLOAT32_C(  -240.11),
      EASYSIMD_FLOAT32_C(  -645.34), EASYSIMD_FLOAT32_C(  -219.70), EASYSIMD_FLOAT32_C(  -114.89), EASYSIMD_FLOAT32_C(  -219.70),
      EASYSIMD_FLOAT32_C(   470.38), EASYSIMD_FLOAT32_C(  -219.70), EASYSIMD_FLOAT32_C(  -219.70), EASYSIMD_FLOAT32_C(  -268.97),
      EASYSIMD_FLOAT32_C(    33.64), EASYSIMD_FLOAT32_C(  -219.70), EASYSIMD_FLOAT32_C(   -58.95), EASYSIMD_FLOAT32_C(  -219.70),
      EASYSIMD_FLOAT32_C(  -726.99), EASYSIMD_FLOAT32_C(  -219.70), EASYSIMD_FLOAT32_C(   364.44), EASYSIMD_FLOAT32_C(  -738.47),
      EASYSIMD_FLOAT32_C(  -219.70), EASYSIMD_FLOAT32_C(  -248.61), EASYSIMD_FLOAT32_C(  -748.58), EASYSIMD_FLOAT32_C(  -841.84),
      EASYSIMD_FLOAT32_C(  -219.70), EASYSIMD_FLOAT32_C(  -219.70), EASYSIMD_FLOAT32_C(  -219.70), EASYSIMD_FLOAT32_C(  -219.70),
      EASYSIMD_FLOAT32_C(    25.14), EASYSIMD_FLOAT32_C(   151.61), EASYSIMD_FLOAT32_C(  -383.35), EASYSIMD_FLOAT32_C(  -219.70),
      EASYSIMD_FLOAT32_C(  -219.70), EASYSIMD_FLOAT32_C(  -219.70), EASYSIMD_FLOAT32_C(  -219.70), EASYSIMD_FLOAT32_C(  -488.10),
      EASYSIMD_FLOAT32_C(  -421.11), EASYSIMD_FLOAT32_C(  -219.70), EASYSIMD_FLOAT32_C(  -219.70), EASYSIMD_FLOAT32_C(  -219.70),
      EASYSIMD_FLOAT32_C(  -219.70), EASYSIMD_FLOAT32_C(  -859.52) };
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b32(), pg)) {
    ...
    pv = easysimd_svcmplt_s32(pg, easysimd_svld1_s32(pg, &(p[i])), easysimd_svdup_n_s32(INT32_C(0)));
    rv = easysimd_svdup_n_f32_m(av, pv, b);
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b32(), pg)) {
    ...
    ev = easysimd_svdup_n_f32_m(av, pv, b);
...
static int
test_easysimd_svdup_n_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const easysimd_float64 a = EASYSIMD_FLOAT64_C(   562.36);
  static const easysimd_float64 e[] =
    { EASYSIMD_FLOAT64_C(   562.36), EASYSIMD_FLOAT64_C(   562.36), EASYSIMD_FLOAT64_C(   562.36), EASYSIMD_FLOAT64_C(   562.36),
      EASYSIMD_FLOAT64_C(   562.36), EASYSIMD_FLOAT64_C(   562.36), EASYSIMD_FLOAT64_C(   562.36), EASYSIMD_FLOAT64_C(   562.36),
      EASYSIMD_FLOAT64_C(   562.36), EASYSIMD_FLOAT64_C(   562.36), EASYSIMD_FLOAT64_C(   562.36), EASYSIMD_FLOAT64_C(   562.36),
      EASYSIMD_FLOAT64_C(   562.36), EASYSIMD_FLOAT64_C(   562.36), EASYSIMD_FLOAT64_C(   562.36), EASYSIMD_FLOAT64_C(   562.36),
      EASYSIMD_FLOAT64_C(   562.36), EASYSIMD_FLOAT64_C(   562.36), EASYSIMD_FLOAT64_C(   562.36), EASYSIMD_FLOAT64_C(   562.36),
  ...
  easysimd_svbool_t pg = easysimd_svwhilelt_b64_s32(i, len);
  while (easysimd_svptest_first(easysimd_svptrue_b64(), pg)) {
    easysimd_svfloat64_t rv;

    rv = easysimd_svdup_n_f64(a);
  ...
  return 0;
#else
  easysimd_float64 a, e[1024 / sizeof(int64_t)];
  int64_t len;

  fputc('\n', stdout);

  len = easysimd_test_codegen_random_i64() & ((sizeof(e) / sizeof(e[0])) - 1);
  a = easysimd_test_codegen_random_f64(EASYSIMD_FLOAT64_C(-1000.0), EASYSIMD_FLOAT64_C(1000.0));

  int64_t i = 0;
  easysimd_svbool_t pg = easysimd_svwhilelt_b64_s32(i, len);
  while (easysimd_svptest_first(easysimd_svptrue_b64(), pg)) {
    easysimd_svfloat64_t ev;

    ev = easysimd_svdup_n_f64(a);
...
static int
test_easysimd_svdup_n_f64_z (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const int64_t p[] =
    {  INT64_C(                   0),  INT64_C(                   0),  INT64_C(                   0), -INT64_C(                   1),
       INT64_C(                   0),  INT64_C(                   0), -INT64_C(                   1), -INT64_C(                   1),
      ...
      -INT64_C(                   1), -INT64_C(                   1),  INT64_C(                   0), -INT64_C(                   1),
       ...
       INT64_C(                   0), -INT64_C(                   1), -INT64_C(                   1),  INT64_C(                   0),
      -INT64_C(                   1),  INT64_C(                   0),  INT64_C(                   0),  INT64_C(                   0) };
  static const easysimd_float64 a = EASYSIMD_FLOAT64_C(  -983.43);
  static const easysimd_float64 e[] =
    { EASYSIMD_FLOAT64_C(     0.00), EASYSIMD_FLOAT64_C(     0.00), EASYSIMD_FLOAT64_C(     0.00), EASYSIMD_FLOAT64_C(  -983.43),
      EASYSIMD_FLOAT64_C(     0.00), EASYSIMD_FLOAT64_C(     0.00), EASYSIMD_FLOAT64_C(  -983.43), EASYSIMD_FLOAT64_C(  -983.43),
      EASYSIMD_FLOAT64_C(     0.00), EASYSIMD_FLOAT64_C(  -983.43), EASYSIMD_FLOAT64_C(     0.00), EASYSIMD_FLOAT64_C(     0.00),
      EASYSIMD_FLOAT64_C(     0.00), EASYSIMD_FLOAT64_C(     0.00), EASYSIMD_FLOAT64_C(     0.00), EASYSIMD_FLOAT64_C(     0.00),
      EASYSIMD_FLOAT64_C(     0.00), EASYSIMD_FLOAT64_C(     0.00), EASYSIMD_FLOAT64_C(  -983.43), EASYSIMD_FLOAT64_C(     0.00),
      EASYSIMD_FLOAT64_C(     0.00), EASYSIMD_FLOAT64_C(     0.00), EASYSIMD_FLOAT64_C(     0.00), EASYSIMD_FLOAT64_C(     0.00),
      EASYSIMD_FLOAT64_C(     0.00), EASYSIMD_FLOAT64_C(     0.00), EASYSIMD_FLOAT64_C(     0.00), EASYSIMD_FLOAT64_C(     0.00),
      EASYSIMD_FLOAT64_C(     0.00), EASYSIMD_FLOAT64_C(  -983.43), EASYSIMD_FLOAT64_C(  -983.43), EASYSIMD_FLOAT64_C(     0.00),
      EASYSIMD_FLOAT64_C(     0.00), EASYSIMD_FLOAT64_C(     0.00), EASYSIMD_FLOAT64_C(     0.00), EASYSIMD_FLOAT64_C(  -983.43),
      EASYSIMD_FLOAT64_C(     0.00), EASYSIMD_FLOAT64_C(     0.00), EASYSIMD_FLOAT64_C(     0.00), EASYSIMD_FLOAT64_C(     0.00),
      EASYSIMD_FLOAT64_C(     0.00), EASYSIMD_FLOAT64_C(     0.00), EASYSIMD_FLOAT64_C(     0.00), EASYSIMD_FLOAT64_C(     0.00),
      EASYSIMD_FLOAT64_C(     0.00), EASYSIMD_FLOAT64_C(     0.00), EASYSIMD_FLOAT64_C(     0.00), EASYSIMD_FLOAT64_C(     0.00),
      EASYSIMD_FLOAT64_C(     0.00), EASYSIMD_FLOAT64_C(     0.00), EASYSIMD_FLOAT64_C(     0.00), EASYSIMD_FLOAT64_C(     0.00),
      EASYSIMD_FLOAT64_C(     0.00), EASYSIMD_FLOAT64_C(     0.00), EASYSIMD_FLOAT64_C(     0.00), EASYSIMD_FLOAT64_C(     0.00),
      EASYSIMD_FLOAT64_C(  -983.43), EASYSIMD_FLOAT64_C(     0.00), EASYSIMD_FLOAT64_C(  -983.43), EASYSIMD_FLOAT64_C(     0.00),
      EASYSIMD_FLOAT64_C(     0.00), EASYSIMD_FLOAT64_C(     0.00), EASYSIMD_FLOAT64_C(  -983.43), EASYSIMD_FLOAT64_C(     0.00),
      EASYSIMD_FLOAT64_C(  -983.43), EASYSIMD_FLOAT64_C(  -983.43), EASYSIMD_FLOAT64_C(     0.00), EASYSIMD_FLOAT64_C(  -983.43),
      EASYSIMD_FLOAT64_C(     0.00), EASYSIMD_FLOAT64_C(     0.00), EASYSIMD_FLOAT64_C(     0.00), EASYSIMD_FLOAT64_C(     0.00),
      EASYSIMD_FLOAT64_C(     0.00), EASYSIMD_FLOAT64_C(     0.00), EASYSIMD_FLOAT64_C(  -983.43), EASYSIMD_FLOAT64_C(     0.00),
      EASYSIMD_FLOAT64_C(     0.00), EASYSIMD_FLOAT64_C(     0.00), EASYSIMD_FLOAT64_C(     0.00), EASYSIMD_FLOAT64_C(     0.00),
      EASYSIMD_FLOAT64_C(     0.00), EASYSIMD_FLOAT64_C(  -983.43), EASYSIMD_FLOAT64_C(  -983.43), EASYSIMD_FLOAT64_C(     0.00),
      EASYSIMD_FLOAT64_C(  -983.43), EASYSIMD_FLOAT64_C(     0.00), EASYSIMD_FLOAT64_C(     0.00), EASYSIMD_FLOAT64_C(     0.00) };
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b64(), pg)) {
    ...
    pv = easysimd_svcmplt_s64(pg, easysimd_svld1_s64(pg, &(p[i])), easysimd_svdup_n_s64(INT64_C(0)));
    rv = easysimd_svdup_n_f64_z(pv, a);
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b64(), pg)) {
    ...
    pv = easysimd_svcmplt_s64(pg, easysimd_svld1_s64(pg, &(p[i])), easysimd_svdup_n_s64(0));
    ev = easysimd_svdup_n_f64_z(pv, a);
  ...
  easysimd_test_codegen_write_1vi64(1, HEDLEY_STATIC_CAST(size_t, len), p);
  easysimd_test_codegen_write_1f64(1, a);
  easysimd_test_codegen_write_1vf64(1, HEDLEY_STATIC_CAST(size_t, len), e);
...
static int
test_easysimd_svdup_n_f64_m (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const int64_t p[] =
    {  INT64_C(                   0),  INT64_C(                   0), -INT64_C(                   1),  INT64_C(                   0),
      -INT64_C(                   1),  INT64_C(                   0), -INT64_C(                   1),  INT64_C(                   0),
  ...
  static const easysimd_float64 a[] =
    { EASYSIMD_FLOAT64_C(   625.95), EASYSIMD_FLOAT64_C(  -336.50), EASYSIMD_FLOAT64_C(   -44.53), EASYSIMD_FLOAT64_C(   996.85),
      EASYSIMD_FLOAT64_C(  -212.87), EASYSIMD_FLOAT64_C(  -442.74), EASYSIMD_FLOAT64_C(   267.77), EASYSIMD_FLOAT64_C(  -642.53),
      EASYSIMD_FLOAT64_C(  -411.25), EASYSIMD_FLOAT64_C(   508.19), EASYSIMD_FLOAT64_C(  -111.61), EASYSIMD_FLOAT64_C(   922.74),
      EASYSIMD_FLOAT64_C(  -645.51), EASYSIMD_FLOAT64_C(   460.13), EASYSIMD_FLOAT64_C(   534.95), EASYSIMD_FLOAT64_C(  -598.06),
      EASYSIMD_FLOAT64_C(  -800.94), EASYSIMD_FLOAT64_C(  -761.70), EASYSIMD_FLOAT64_C(   145.08), EASYSIMD_FLOAT64_C(   656.88),
      EASYSIMD_FLOAT64_C(   285.41), EASYSIMD_FLOAT64_C(   929.96), EASYSIMD_FLOAT64_C(  -981.70), EASYSIMD_FLOAT64_C(   406.94),
      EASYSIMD_FLOAT64_C(  -647.74), EASYSIMD_FLOAT64_C(    61.80), EASYSIMD_FLOAT64_C(  -219.64), EASYSIMD_FLOAT64_C(  -659.69),
      EASYSIMD_FLOAT64_C(  -750.85), EASYSIMD_FLOAT64_C(    22.10), EASYSIMD_FLOAT64_C(    47.70), EASYSIMD_FLOAT64_C(   875.10),
      EASYSIMD_FLOAT64_C(   685.60), EASYSIMD_FLOAT64_C(  -996.82), EASYSIMD_FLOAT64_C(   871.95), EASYSIMD_FLOAT64_C(  -527.27),
      EASYSIMD_FLOAT64_C(  -439.56), EASYSIMD_FLOAT64_C(   139.72), EASYSIMD_FLOAT64_C(  -169.81), EASYSIMD_FLOAT64_C(   149.18),
      EASYSIMD_FLOAT64_C(  -352.10), EASYSIMD_FLOAT64_C(   718.58), EASYSIMD_FLOAT64_C(    71.93), EASYSIMD_FLOAT64_C(     2.40),
      EASYSIMD_FLOAT64_C(   178.71), EASYSIMD_FLOAT64_C(  -393.12), EASYSIMD_FLOAT64_C(   404.33), EASYSIMD_FLOAT64_C(   377.77),
      EASYSIMD_FLOAT64_C(  -154.83), EASYSIMD_FLOAT64_C(  -450.59), EASYSIMD_FLOAT64_C(    34.65), EASYSIMD_FLOAT64_C(  -869.42),
      EASYSIMD_FLOAT64_C(  -520.63), EASYSIMD_FLOAT64_C(    52.96), EASYSIMD_FLOAT64_C(   537.53), EASYSIMD_FLOAT64_C(  -168.36),
      EASYSIMD_FLOAT64_C(  -885.25), EASYSIMD_FLOAT64_C(  -682.11), EASYSIMD_FLOAT64_C(   171.95), EASYSIMD_FLOAT64_C(  -636.09),
      EASYSIMD_FLOAT64_C(   339.98), EASYSIMD_FLOAT64_C(  -780.35), EASYSIMD_FLOAT64_C(  -760.99), EASYSIMD_FLOAT64_C(    25.58),
      EASYSIMD_FLOAT64_C(  -777.17), EASYSIMD_FLOAT64_C(  -889.04), EASYSIMD_FLOAT64_C(   498.31), EASYSIMD_FLOAT64_C(  -216.73),
      EASYSIMD_FLOAT64_C(   250.68), EASYSIMD_FLOAT64_C(  -671.50), EASYSIMD_FLOAT64_C(   932.45), EASYSIMD_FLOAT64_C(   898.58),
      EASYSIMD_FLOAT64_C(  -952.92), EASYSIMD_FLOAT64_C(     4.38), EASYSIMD_FLOAT64_C(   -99.02), EASYSIMD_FLOAT64_C(   225.79),
      EASYSIMD_FLOAT64_C(   611.25), EASYSIMD_FLOAT64_C(  -694.69), EASYSIMD_FLOAT64_C(  -396.44), EASYSIMD_FLOAT64_C(  -543.58) };
  static const easysimd_float64 b = EASYSIMD_FLOAT64_C(  -145.28);
  static const easysimd_float64 e[] =
    { EASYSIMD_FLOAT64_C(   625.95), EASYSIMD_FLOAT64_C(  -336.50), EASYSIMD_FLOAT64_C(  -145.28), EASYSIMD_FLOAT64_C(   996.85),
      EASYSIMD_FLOAT64_C(  -145.28), EASYSIMD_FLOAT64_C(  -442.74), EASYSIMD_FLOAT64_C(  -145.28), EASYSIMD_FLOAT64_C(  -642.53),
      EASYSIMD_FLOAT64_C(  -145.28), EASYSIMD_FLOAT64_C(   508.19), EASYSIMD_FLOAT64_C(  -145.28), EASYSIMD_FLOAT64_C(  -145.28),
      EASYSIMD_FLOAT64_C(  -145.28), EASYSIMD_FLOAT64_C(  -145.28), EASYSIMD_FLOAT64_C(  -145.28), EASYSIMD_FLOAT64_C(  -145.28),
      EASYSIMD_FLOAT64_C(  -145.28), EASYSIMD_FLOAT64_C(  -145.28), EASYSIMD_FLOAT64_C(  -145.28), EASYSIMD_FLOAT64_C(  -145.28),
      EASYSIMD_FLOAT64_C(   285.41), EASYSIMD_FLOAT64_C(   929.96), EASYSIMD_FLOAT64_C(  -981.70), EASYSIMD_FLOAT64_C(   406.94),
      EASYSIMD_FLOAT64_C(  -145.28), EASYSIMD_FLOAT64_C(    61.80), EASYSIMD_FLOAT64_C(  -219.64), EASYSIMD_FLOAT64_C(  -659.69),
      EASYSIMD_FLOAT64_C(  -145.28), EASYSIMD_FLOAT64_C(  -145.28), EASYSIMD_FLOAT64_C(  -145.28), EASYSIMD_FLOAT64_C(  -145.28),
      EASYSIMD_FLOAT64_C(   685.60), EASYSIMD_FLOAT64_C(  -145.28), EASYSIMD_FLOAT64_C(  -145.28), EASYSIMD_FLOAT64_C(  -145.28),
      EASYSIMD_FLOAT64_C(  -439.56), EASYSIMD_FLOAT64_C(  -145.28), EASYSIMD_FLOAT64_C(  -145.28), EASYSIMD_FLOAT64_C(  -145.28),
      EASYSIMD_FLOAT64_C(  -145.28), EASYSIMD_FLOAT64_C(   718.58), EASYSIMD_FLOAT64_C(  -145.28), EASYSIMD_FLOAT64_C(  -145.28),
      EASYSIMD_FLOAT64_C(  -145.28), EASYSIMD_FLOAT64_C(  -393.12), EASYSIMD_FLOAT64_C(   404.33), EASYSIMD_FLOAT64_C(  -145.28),
      EASYSIMD_FLOAT64_C(  -154.83), EASYSIMD_FLOAT64_C(  -145.28), EASYSIMD_FLOAT64_C(    34.65), EASYSIMD_FLOAT64_C(  -869.42),
      EASYSIMD_FLOAT64_C(  -520.63), EASYSIMD_FLOAT64_C(  -145.28), EASYSIMD_FLOAT64_C(   537.53), EASYSIMD_FLOAT64_C(  -145.28),
      EASYSIMD_FLOAT64_C(  -145.28), EASYSIMD_FLOAT64_C(  -682.11), EASYSIMD_FLOAT64_C(   171.95), EASYSIMD_FLOAT64_C(  -636.09),
      EASYSIMD_FLOAT64_C(   339.98), EASYSIMD_FLOAT64_C(  -780.35), EASYSIMD_FLOAT64_C(  -145.28), EASYSIMD_FLOAT64_C(  -145.28),
      EASYSIMD_FLOAT64_C(  -777.17), EASYSIMD_FLOAT64_C(  -889.04), EASYSIMD_FLOAT64_C(   498.31), EASYSIMD_FLOAT64_C(  -145.28),
      EASYSIMD_FLOAT64_C(   250.68), EASYSIMD_FLOAT64_C(  -145.28), EASYSIMD_FLOAT64_C(   932.45), EASYSIMD_FLOAT64_C(   898.58),
      EASYSIMD_FLOAT64_C(  -952.92), EASYSIMD_FLOAT64_C(     4.38), EASYSIMD_FLOAT64_C(   -99.02), EASYSIMD_FLOAT64_C(   225.79),
      EASYSIMD_FLOAT64_C(  -145.28), EASYSIMD_FLOAT64_C(  -694.69), EASYSIMD_FLOAT64_C(  -145.28), EASYSIMD_FLOAT64_C(  -543.58) };
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b64(), pg)) {
    ...
    pv = easysimd_svcmplt_s64(pg, easysimd_svld1_s64(pg, &(p[i])), easysimd_svdup_n_s64(INT64_C(0)));
    rv = easysimd_svdup_n_f64_m(av, pv, b);
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b64(), pg)) {
    ...
    ev = easysimd_svdup_n_f64_m(av, pv, b);
...
EASYSIMD_TEST_FUNC_LIST_ENTRY(svdup_n_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(svdup_n_s8_z)
EASYSIMD_TEST_FUNC_LIST_ENTRY(svdup_n_s8_m)
EASYSIMD_TEST_FUNC_LIST_ENTRY(svdup_n_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(svdup_n_s16_z)
EASYSIMD_TEST_FUNC_LIST_ENTRY(svdup_n_s16_m)
EASYSIMD_TEST_FUNC_LIST_ENTRY(svdup_n_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(svdup_n_s32_z)
EASYSIMD_TEST_FUNC_LIST_ENTRY(svdup_n_s32_m)
EASYSIMD_TEST_FUNC_LIST_ENTRY(svdup_n_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(svdup_n_s64_z)
EASYSIMD_TEST_FUNC_LIST_ENTRY(svdup_n_s64_m)
EASYSIMD_TEST_FUNC_LIST_ENTRY(svdup_n_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(svdup_n_u8_z)
EASYSIMD_TEST_FUNC_LIST_ENTRY(svdup_n_u8_m)
EASYSIMD_TEST_FUNC_LIST_ENTRY(svdup_n_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(svdup_n_u16_z)
EASYSIMD_TEST_FUNC_LIST_ENTRY(svdup_n_u16_m)
EASYSIMD_TEST_FUNC_LIST_ENTRY(svdup_n_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(svdup_n_u32_z)
EASYSIMD_TEST_FUNC_LIST_ENTRY(svdup_n_u32_m)
EASYSIMD_TEST_FUNC_LIST_ENTRY(svdup_n_u64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(svdup_n_u64_z)
EASYSIMD_TEST_FUNC_LIST_ENTRY(svdup_n_u64_m)
EASYSIMD_TEST_FUNC_LIST_ENTRY(svdup_n_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(svdup_n_f32_z)
EASYSIMD_TEST_FUNC_LIST_ENTRY(svdup_n_f32_m)
EASYSIMD_TEST_FUNC_LIST_ENTRY(svdup_n_f64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(svdup_n_f64_z)
EASYSIMD_TEST_FUNC_LIST_ENTRY(svdup_n_f64_m)
