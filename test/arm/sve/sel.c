#define EASYSIMD_TEST_ARM_SVE_INSN sel

#include "test-sve.h"
#include "../../../easysimd/arm/sve/sel.h"

#include "../../../easysimd/arm/sve/cmplt.h"
#include "../../../easysimd/arm/sve/dup.h"

static int
test_easysimd_x_svsel_s8_z (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b8(), pg)) {
    ...
    rv = easysimd_x_svsel_s8_z(pv, av);
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b8(), pg)) {
    ...
    ev = easysimd_x_svsel_s8_z(pv, av);
...
static int
test_easysimd_svsel_s8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const int8_t p[] =
...
static int
test_easysimd_x_svsel_s16_z (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b16(), pg)) {
    ...
    rv = easysimd_x_svsel_s16_z(pv, av);
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b16(), pg)) {
    ...
    ev = easysimd_x_svsel_s16_z(pv, av);
...
static int
test_easysimd_svsel_s16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const int16_t p[] =
    {  INT16_C(     0), -INT16_C(     1),  INT16_C(     0), -INT16_C(     1), -INT16_C(     1),  INT16_C(     0), -INT16_C(     1), -INT16_C(     1),
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b16(), pg)) {
    ...
    pv = easysimd_svcmplt_s16(pg, easysimd_svld1_s16(pg, &(p[i])), easysimd_svdup_n_s16(INT16_C(0)));
    rv = easysimd_svsel_s16(pv, av, bv);
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b16(), pg)) {
    ...
    ev = easysimd_svsel_s16(pv, av, bv);
...
static int
test_easysimd_x_svsel_s32_z (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b32(), pg)) {
    ...
    rv = easysimd_x_svsel_s32_z(pv, av);
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b32(), pg)) {
    ...
    ev = easysimd_x_svsel_s32_z(pv, av);
...
static int
test_easysimd_svsel_s32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const int32_t p[] =
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b32(), pg)) {
    ...
    pv = easysimd_svcmplt_s32(pg, easysimd_svld1_s32(pg, &(p[i])), easysimd_svdup_n_s32(INT32_C(0)));
    rv = easysimd_svsel_s32(pv, av, bv);
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b32(), pg)) {
    ...
    ev = easysimd_svsel_s32(pv, av, bv);
...
static int
test_easysimd_x_svsel_s64_z (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b64(), pg)) {
    ...
    rv = easysimd_x_svsel_s64_z(pv, av);
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b64(), pg)) {
    ...
    ev = easysimd_x_svsel_s64_z(pv, av);
...
static int
test_easysimd_svsel_s64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const int64_t p[] =
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b64(), pg)) {
    ...
    pv = easysimd_svcmplt_s64(pg, easysimd_svld1_s64(pg, &(p[i])), easysimd_svdup_n_s64(INT64_C(0)));
    rv = easysimd_svsel_s64(pv, av, bv);
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b64(), pg)) {
    ...
    ev = easysimd_svsel_s64(pv, av, bv);
...
static int
test_easysimd_x_svsel_u8_z (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const int8_t p[] =
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b8(), pg)) {
    ...
    pv = easysimd_svcmplt_s8(pg, easysimd_svld1_s8(pg, &(p[i])), easysimd_svdup_n_s8(INT8_C(0)));
    rv = easysimd_x_svsel_u8_z(pv, av);
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b8(), pg)) {
    ...
    ev = easysimd_x_svsel_u8_z(pv, av);
...
static int
test_easysimd_svsel_u8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const int8_t p[] =
    { -INT8_C(   1), -INT8_C(   1),  INT8_C(   0),  INT8_C(   0),  INT8_C(   0), -INT8_C(   1),  INT8_C(   0), -INT8_C(   1),
       INT8_C(   0),  INT8_C(   0), -INT8_C(   1), -INT8_C(   1),  INT8_C(   0), -INT8_C(   1),  INT8_C(   0), -INT8_C(   1),
...
static int
test_easysimd_x_svsel_u16_z (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const int16_t p[] =
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b16(), pg)) {
    ...
    pv = easysimd_svcmplt_s16(pg, easysimd_svld1_s16(pg, &(p[i])), easysimd_svdup_n_s16(INT16_C(0)));
    rv = easysimd_x_svsel_u16_z(pv, av);
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b16(), pg)) {
    ...
    ev = easysimd_x_svsel_u16_z(pv, av);
...
static int
test_easysimd_svsel_u16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const int16_t p[] =
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b16(), pg)) {
    ...
    pv = easysimd_svcmplt_s16(pg, easysimd_svld1_s16(pg, &(p[i])), easysimd_svdup_n_s16(INT16_C(0)));
    rv = easysimd_svsel_u16(pv, av, bv);
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b16(), pg)) {
    ...
    ev = easysimd_svsel_u16(pv, av, bv);
...
static int
test_easysimd_x_svsel_u32_z (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const int32_t p[] =
    { -INT32_C(           1),  INT32_C(           0), -INT32_C(           1),  INT32_C(           0), -INT32_C(           1),  INT32_C(           0), -INT32_C(           1),  INT32_C(           0),
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b32(), pg)) {
    ...
    pv = easysimd_svcmplt_s32(pg, easysimd_svld1_s32(pg, &(p[i])), easysimd_svdup_n_s32(INT32_C(0)));
    rv = easysimd_x_svsel_u32_z(pv, av);
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b32(), pg)) {
    ...
    ev = easysimd_x_svsel_u32_z(pv, av);
...
static int
test_easysimd_svsel_u32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const int32_t p[] =
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b32(), pg)) {
    ...
    pv = easysimd_svcmplt_s32(pg, easysimd_svld1_s32(pg, &(p[i])), easysimd_svdup_n_s32(INT32_C(0)));
    rv = easysimd_svsel_u32(pv, av, bv);
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b32(), pg)) {
    ...
    ev = easysimd_svsel_u32(pv, av, bv);
...
static int
test_easysimd_x_svsel_u64_z (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const int64_t p[] =
    {  INT64_C(                   0), -INT64_C(                   1),  INT64_C(                   0),  INT64_C(                   0),
      -INT64_C(                   1), -INT64_C(                   1),  INT64_C(                   0), -INT64_C(                   1),
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b64(), pg)) {
    ...
    pv = easysimd_svcmplt_s64(pg, easysimd_svld1_s64(pg, &(p[i])), easysimd_svdup_n_s64(INT64_C(0)));
    rv = easysimd_x_svsel_u64_z(pv, av);
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b64(), pg)) {
    ...
    ev = easysimd_x_svsel_u64_z(pv, av);
...
static int
test_easysimd_svsel_u64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const int64_t p[] =
    { -INT64_C(                   1), -INT64_C(                   1), -INT64_C(                   1),  INT64_C(                   0),
       INT64_C(                   0),  INT64_C(                   0),  INT64_C(                   0), -INT64_C(                   1),
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b64(), pg)) {
    ...
    pv = easysimd_svcmplt_s64(pg, easysimd_svld1_s64(pg, &(p[i])), easysimd_svdup_n_s64(INT64_C(0)));
    rv = easysimd_svsel_u64(pv, av, bv);
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b64(), pg)) {
    ...
    ev = easysimd_svsel_u64(pv, av, bv);
...
static int
test_easysimd_x_svsel_f32_z (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const int32_t p[] =
  ...
  static const easysimd_float32 a[] =
    { EASYSIMD_FLOAT32_C(  -882.90), EASYSIMD_FLOAT32_C(  -266.63), EASYSIMD_FLOAT32_C(   -75.12), EASYSIMD_FLOAT32_C(  -146.35),
      EASYSIMD_FLOAT32_C(   549.02), EASYSIMD_FLOAT32_C(  -256.80), EASYSIMD_FLOAT32_C(   427.26), EASYSIMD_FLOAT32_C(   549.77),
      EASYSIMD_FLOAT32_C(   253.23), EASYSIMD_FLOAT32_C(   -36.00), EASYSIMD_FLOAT32_C(   206.96), EASYSIMD_FLOAT32_C(  -873.55),
      EASYSIMD_FLOAT32_C(  -855.12), EASYSIMD_FLOAT32_C(   181.20), EASYSIMD_FLOAT32_C(  -987.95), EASYSIMD_FLOAT32_C(  -688.84),
      EASYSIMD_FLOAT32_C(   978.10), EASYSIMD_FLOAT32_C(   125.12), EASYSIMD_FLOAT32_C(    -2.36), EASYSIMD_FLOAT32_C(   170.72),
      EASYSIMD_FLOAT32_C(  -109.68), EASYSIMD_FLOAT32_C(   787.60), EASYSIMD_FLOAT32_C(   386.76), EASYSIMD_FLOAT32_C(  -317.86),
      EASYSIMD_FLOAT32_C(  -560.16), EASYSIMD_FLOAT32_C(   525.61), EASYSIMD_FLOAT32_C(   811.92), EASYSIMD_FLOAT32_C(  -864.45),
      EASYSIMD_FLOAT32_C(  -550.97), EASYSIMD_FLOAT32_C(  -297.84), EASYSIMD_FLOAT32_C(   259.94), EASYSIMD_FLOAT32_C(  -433.87),
      EASYSIMD_FLOAT32_C(   435.54), EASYSIMD_FLOAT32_C(  -815.17), EASYSIMD_FLOAT32_C(   419.78), EASYSIMD_FLOAT32_C(   -15.45),
      EASYSIMD_FLOAT32_C(   -71.98), EASYSIMD_FLOAT32_C(  -152.96), EASYSIMD_FLOAT32_C(  -465.68), EASYSIMD_FLOAT32_C(  -818.75),
      EASYSIMD_FLOAT32_C(   811.04), EASYSIMD_FLOAT32_C(   741.29), EASYSIMD_FLOAT32_C(  -692.30), EASYSIMD_FLOAT32_C(   955.92),
      EASYSIMD_FLOAT32_C(   -77.51), EASYSIMD_FLOAT32_C(  -680.24), EASYSIMD_FLOAT32_C(  -732.92), EASYSIMD_FLOAT32_C(   -99.41),
      EASYSIMD_FLOAT32_C(   444.88), EASYSIMD_FLOAT32_C(   264.71), EASYSIMD_FLOAT32_C(  -928.69), EASYSIMD_FLOAT32_C(  -664.80),
      EASYSIMD_FLOAT32_C(    52.31), EASYSIMD_FLOAT32_C(   458.08), EASYSIMD_FLOAT32_C(    17.34), EASYSIMD_FLOAT32_C(   492.15),
      EASYSIMD_FLOAT32_C(   -16.31), EASYSIMD_FLOAT32_C(  -170.74), EASYSIMD_FLOAT32_C(   627.70), EASYSIMD_FLOAT32_C(   432.72),
      EASYSIMD_FLOAT32_C(   531.42), EASYSIMD_FLOAT32_C(  -112.36), EASYSIMD_FLOAT32_C(   998.85), EASYSIMD_FLOAT32_C(   -33.04),
      EASYSIMD_FLOAT32_C(    72.47), EASYSIMD_FLOAT32_C(   418.63), EASYSIMD_FLOAT32_C(   951.52), EASYSIMD_FLOAT32_C(  -999.51),
      EASYSIMD_FLOAT32_C(  -734.33), EASYSIMD_FLOAT32_C(  -514.16), EASYSIMD_FLOAT32_C(  -818.26), EASYSIMD_FLOAT32_C(  -923.29),
      EASYSIMD_FLOAT32_C(  -772.88), EASYSIMD_FLOAT32_C(  -510.56), EASYSIMD_FLOAT32_C(  -967.37), EASYSIMD_FLOAT32_C(   149.61),
      EASYSIMD_FLOAT32_C(  -190.80), EASYSIMD_FLOAT32_C(  -700.30), EASYSIMD_FLOAT32_C(  -949.80), EASYSIMD_FLOAT32_C(  -745.93),
      EASYSIMD_FLOAT32_C(   564.41), EASYSIMD_FLOAT32_C(  -878.49), EASYSIMD_FLOAT32_C(  -410.73), EASYSIMD_FLOAT32_C(  -383.28),
      EASYSIMD_FLOAT32_C(   579.59), EASYSIMD_FLOAT32_C(   606.61), EASYSIMD_FLOAT32_C(  -891.13), EASYSIMD_FLOAT32_C(  -436.72),
      EASYSIMD_FLOAT32_C(  -564.13), EASYSIMD_FLOAT32_C(   736.56), EASYSIMD_FLOAT32_C(   996.00), EASYSIMD_FLOAT32_C(   967.30),
      EASYSIMD_FLOAT32_C(  -375.79), EASYSIMD_FLOAT32_C(   994.86), EASYSIMD_FLOAT32_C(   -65.74), EASYSIMD_FLOAT32_C(   696.67),
      EASYSIMD_FLOAT32_C(   413.49), EASYSIMD_FLOAT32_C(  -114.23), EASYSIMD_FLOAT32_C(   697.16), EASYSIMD_FLOAT32_C(   679.16),
      EASYSIMD_FLOAT32_C(   371.61), EASYSIMD_FLOAT32_C(   878.90), EASYSIMD_FLOAT32_C(   755.87), EASYSIMD_FLOAT32_C(   598.73),
      EASYSIMD_FLOAT32_C(  -631.66), EASYSIMD_FLOAT32_C(   788.50), EASYSIMD_FLOAT32_C(  -251.65), EASYSIMD_FLOAT32_C(   177.54),
      EASYSIMD_FLOAT32_C(  -911.80), EASYSIMD_FLOAT32_C(  -201.45), EASYSIMD_FLOAT32_C(   431.61), EASYSIMD_FLOAT32_C(   652.61),
      EASYSIMD_FLOAT32_C(   -79.93), EASYSIMD_FLOAT32_C(  -979.11), EASYSIMD_FLOAT32_C(  -730.66), EASYSIMD_FLOAT32_C(  -500.34),
      EASYSIMD_FLOAT32_C(   627.50), EASYSIMD_FLOAT32_C(  -621.80), EASYSIMD_FLOAT32_C(    62.94), EASYSIMD_FLOAT32_C(  -936.63),
      EASYSIMD_FLOAT32_C(  -885.23), EASYSIMD_FLOAT32_C(    58.94), EASYSIMD_FLOAT32_C(  -969.33), EASYSIMD_FLOAT32_C(  -261.03),
      EASYSIMD_FLOAT32_C(    53.80), EASYSIMD_FLOAT32_C(   -35.07), EASYSIMD_FLOAT32_C(  -564.35), EASYSIMD_FLOAT32_C(  -532.72),
      EASYSIMD_FLOAT32_C(   850.70), EASYSIMD_FLOAT32_C(  -867.19), EASYSIMD_FLOAT32_C(  -853.56), EASYSIMD_FLOAT32_C(   222.31),
      EASYSIMD_FLOAT32_C(  -988.29), EASYSIMD_FLOAT32_C(   902.31), EASYSIMD_FLOAT32_C(  -178.95), EASYSIMD_FLOAT32_C(  -619.95),
      EASYSIMD_FLOAT32_C(   690.81), EASYSIMD_FLOAT32_C(   569.40), EASYSIMD_FLOAT32_C(   557.58), EASYSIMD_FLOAT32_C(   779.01),
      EASYSIMD_FLOAT32_C(  -632.05), EASYSIMD_FLOAT32_C(   -10.80), EASYSIMD_FLOAT32_C(   431.63), EASYSIMD_FLOAT32_C(   288.01),
      EASYSIMD_FLOAT32_C(    10.08), EASYSIMD_FLOAT32_C(   700.96), EASYSIMD_FLOAT32_C(   787.67), EASYSIMD_FLOAT32_C(  -362.42),
      EASYSIMD_FLOAT32_C(  -920.84), EASYSIMD_FLOAT32_C(  -149.39), EASYSIMD_FLOAT32_C(  -299.05), EASYSIMD_FLOAT32_C(  -806.07),
      EASYSIMD_FLOAT32_C(   909.55), EASYSIMD_FLOAT32_C(  -268.38), EASYSIMD_FLOAT32_C(   -67.10), EASYSIMD_FLOAT32_C(   -36.65),
      EASYSIMD_FLOAT32_C(   696.55), EASYSIMD_FLOAT32_C(   368.55), EASYSIMD_FLOAT32_C(   430.63), EASYSIMD_FLOAT32_C(   547.25),
      EASYSIMD_FLOAT32_C(   501.36), EASYSIMD_FLOAT32_C(   577.08) };
  static const easysimd_float32 e[] =
    { EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(   -75.12), EASYSIMD_FLOAT32_C(  -146.35),
      EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(  -256.80), EASYSIMD_FLOAT32_C(   427.26), EASYSIMD_FLOAT32_C(     0.00),
      EASYSIMD_FLOAT32_C(   253.23), EASYSIMD_FLOAT32_C(   -36.00), EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(     0.00),
      EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(   181.20), EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(     0.00),
      EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(     0.00),
      EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(     0.00),
      EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(     0.00),
      EASYSIMD_FLOAT32_C(  -550.97), EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(     0.00),
      EASYSIMD_FLOAT32_C(   435.54), EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(     0.00),
      EASYSIMD_FLOAT32_C(   -71.98), EASYSIMD_FLOAT32_C(  -152.96), EASYSIMD_FLOAT32_C(  -465.68), EASYSIMD_FLOAT32_C(     0.00),
      EASYSIMD_FLOAT32_C(   811.04), EASYSIMD_FLOAT32_C(   741.29), EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(   955.92),
      EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(  -732.92), EASYSIMD_FLOAT32_C(     0.00),
      EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(  -928.69), EASYSIMD_FLOAT32_C(  -664.80),
      EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(    17.34), EASYSIMD_FLOAT32_C(   492.15),
      EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(  -170.74), EASYSIMD_FLOAT32_C(   627.70), EASYSIMD_FLOAT32_C(   432.72),
      EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(     0.00),
      EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(   418.63), EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(     0.00),
      EASYSIMD_FLOAT32_C(  -734.33), EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(  -818.26), EASYSIMD_FLOAT32_C(     0.00),
      EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(  -510.56), EASYSIMD_FLOAT32_C(  -967.37), EASYSIMD_FLOAT32_C(   149.61),
      EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(  -745.93),
      EASYSIMD_FLOAT32_C(   564.41), EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(     0.00),
      EASYSIMD_FLOAT32_C(   579.59), EASYSIMD_FLOAT32_C(   606.61), EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(  -436.72),
      EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(   736.56), EASYSIMD_FLOAT32_C(   996.00), EASYSIMD_FLOAT32_C(     0.00),
      EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(     0.00),
      EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(   697.16), EASYSIMD_FLOAT32_C(   679.16),
      EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(   878.90), EASYSIMD_FLOAT32_C(   755.87), EASYSIMD_FLOAT32_C(   598.73),
      EASYSIMD_FLOAT32_C(  -631.66), EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(  -251.65), EASYSIMD_FLOAT32_C(     0.00),
      EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(  -201.45), EASYSIMD_FLOAT32_C(   431.61), EASYSIMD_FLOAT32_C(     0.00),
      EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(  -979.11), EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(     0.00),
      EASYSIMD_FLOAT32_C(   627.50), EASYSIMD_FLOAT32_C(  -621.80), EASYSIMD_FLOAT32_C(    62.94), EASYSIMD_FLOAT32_C(  -936.63),
      EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(  -261.03),
      EASYSIMD_FLOAT32_C(    53.80), EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(  -564.35), EASYSIMD_FLOAT32_C(     0.00),
      EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(   222.31),
      EASYSIMD_FLOAT32_C(  -988.29), EASYSIMD_FLOAT32_C(   902.31), EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(     0.00),
      EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(     0.00),
      EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(     0.00),
      EASYSIMD_FLOAT32_C(    10.08), EASYSIMD_FLOAT32_C(   700.96), EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(  -362.42),
      EASYSIMD_FLOAT32_C(  -920.84), EASYSIMD_FLOAT32_C(  -149.39), EASYSIMD_FLOAT32_C(  -299.05), EASYSIMD_FLOAT32_C(     0.00),
      EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(  -268.38), EASYSIMD_FLOAT32_C(   -67.10), EASYSIMD_FLOAT32_C(   -36.65),
      EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(   368.55), EASYSIMD_FLOAT32_C(   430.63), EASYSIMD_FLOAT32_C(     0.00),
      EASYSIMD_FLOAT32_C(     0.00), EASYSIMD_FLOAT32_C(   577.08) };
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b32(), pg)) {
    ...
    pv = easysimd_svcmplt_s32(pg, easysimd_svld1_s32(pg, &(p[i])), easysimd_svdup_n_s32(INT32_C(0)));
    rv = easysimd_x_svsel_f32_z(pv, av);
...
#else
  int32_t p[1024 / sizeof(int32_t)];
  easysimd_float32 a[1024 / sizeof(easysimd_float32)], e[1024 / sizeof(easysimd_float32)];
  int32_t len = easysimd_test_arm_sve_random_length(sizeof(e), sizeof(e[0]));
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b32(), pg)) {
    ...
    ev = easysimd_x_svsel_f32_z(pv, av);
...
static int
test_easysimd_svsel_f32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const int32_t p[] =
    {  INT32_C(           0),  INT32_C(           0), -INT32_C(           1), -INT32_C(           1), -INT32_C(           1),  INT32_C(           0),  INT32_C(           0),  INT32_C(           0),
      ...
      -INT32_C(           1) };
  static const easysimd_float32 a[] =
    { EASYSIMD_FLOAT32_C(  -735.75), EASYSIMD_FLOAT32_C(  -985.02), EASYSIMD_FLOAT32_C(   136.17), EASYSIMD_FLOAT32_C(   622.07),
      EASYSIMD_FLOAT32_C(   -92.13), EASYSIMD_FLOAT32_C(  -516.63), EASYSIMD_FLOAT32_C(   499.91), EASYSIMD_FLOAT32_C(  -300.63),
      EASYSIMD_FLOAT32_C(   165.71), EASYSIMD_FLOAT32_C(   827.11), EASYSIMD_FLOAT32_C(  -631.40), EASYSIMD_FLOAT32_C(   387.60),
      EASYSIMD_FLOAT32_C(    71.89), EASYSIMD_FLOAT32_C(  -922.07), EASYSIMD_FLOAT32_C(   887.96), EASYSIMD_FLOAT32_C(  -920.89),
      EASYSIMD_FLOAT32_C(   529.68), EASYSIMD_FLOAT32_C(   608.40), EASYSIMD_FLOAT32_C(   256.92), EASYSIMD_FLOAT32_C(  -120.39),
      EASYSIMD_FLOAT32_C(  -263.14), EASYSIMD_FLOAT32_C(  -248.03), EASYSIMD_FLOAT32_C(  -393.16), EASYSIMD_FLOAT32_C(   -47.82),
      EASYSIMD_FLOAT32_C(  -199.62), EASYSIMD_FLOAT32_C(   415.22), EASYSIMD_FLOAT32_C(  -934.15), EASYSIMD_FLOAT32_C(  -599.91),
      EASYSIMD_FLOAT32_C(  -908.46), EASYSIMD_FLOAT32_C(   186.06), EASYSIMD_FLOAT32_C(  -125.08), EASYSIMD_FLOAT32_C(  -644.20),
      EASYSIMD_FLOAT32_C(   201.05), EASYSIMD_FLOAT32_C(  -988.91), EASYSIMD_FLOAT32_C(   977.87), EASYSIMD_FLOAT32_C(  -891.09),
      EASYSIMD_FLOAT32_C(  -505.53), EASYSIMD_FLOAT32_C(   477.78), EASYSIMD_FLOAT32_C(  -191.72), EASYSIMD_FLOAT32_C(   660.18),
      EASYSIMD_FLOAT32_C(   304.89), EASYSIMD_FLOAT32_C(   176.87), EASYSIMD_FLOAT32_C(    47.77), EASYSIMD_FLOAT32_C(  -623.22),
      EASYSIMD_FLOAT32_C(   254.81), EASYSIMD_FLOAT32_C(   -64.26), EASYSIMD_FLOAT32_C(  -544.11), EASYSIMD_FLOAT32_C(  -215.51),
      EASYSIMD_FLOAT32_C(  -455.86), EASYSIMD_FLOAT32_C(   712.82), EASYSIMD_FLOAT32_C(   664.10), EASYSIMD_FLOAT32_C(   281.00),
      EASYSIMD_FLOAT32_C(  -535.22), EASYSIMD_FLOAT32_C(  -729.06), EASYSIMD_FLOAT32_C(  -766.82), EASYSIMD_FLOAT32_C(   265.16),
      EASYSIMD_FLOAT32_C(   686.16), EASYSIMD_FLOAT32_C(  -700.97), EASYSIMD_FLOAT32_C(   665.25), EASYSIMD_FLOAT32_C(   777.70),
      EASYSIMD_FLOAT32_C(   485.09), EASYSIMD_FLOAT32_C(  -459.83), EASYSIMD_FLOAT32_C(  -866.50), EASYSIMD_FLOAT32_C(  -313.86),
      EASYSIMD_FLOAT32_C(  -448.74), EASYSIMD_FLOAT32_C(  -888.63), EASYSIMD_FLOAT32_C(  -204.95), EASYSIMD_FLOAT32_C(    45.73),
      EASYSIMD_FLOAT32_C(   589.15), EASYSIMD_FLOAT32_C(   603.33), EASYSIMD_FLOAT32_C(  -294.09), EASYSIMD_FLOAT32_C(  -105.96),
      EASYSIMD_FLOAT32_C(  -219.80), EASYSIMD_FLOAT32_C(   753.68), EASYSIMD_FLOAT32_C(   270.83), EASYSIMD_FLOAT32_C(  -964.99),
      EASYSIMD_FLOAT32_C(  -310.58), EASYSIMD_FLOAT32_C(   726.72), EASYSIMD_FLOAT32_C(  -180.50), EASYSIMD_FLOAT32_C(   233.56),
      EASYSIMD_FLOAT32_C(   439.54), EASYSIMD_FLOAT32_C(  -516.40), EASYSIMD_FLOAT32_C(  -485.44), EASYSIMD_FLOAT32_C(   904.32),
      EASYSIMD_FLOAT32_C(  -245.46), EASYSIMD_FLOAT32_C(  -252.26), EASYSIMD_FLOAT32_C(   169.48), EASYSIMD_FLOAT32_C(  -559.29),
      EASYSIMD_FLOAT32_C(    46.77), EASYSIMD_FLOAT32_C(  -165.26), EASYSIMD_FLOAT32_C(  -781.59), EASYSIMD_FLOAT32_C(  -468.14),
      EASYSIMD_FLOAT32_C(   374.91), EASYSIMD_FLOAT32_C(  -648.09), EASYSIMD_FLOAT32_C(   218.00), EASYSIMD_FLOAT32_C(   926.17),
      EASYSIMD_FLOAT32_C(  -536.72), EASYSIMD_FLOAT32_C(  -986.95), EASYSIMD_FLOAT32_C(   -28.10), EASYSIMD_FLOAT32_C(  -947.57),
      EASYSIMD_FLOAT32_C(   616.38), EASYSIMD_FLOAT32_C(   677.81), EASYSIMD_FLOAT32_C(   -53.52), EASYSIMD_FLOAT32_C(  -603.42),
      EASYSIMD_FLOAT32_C(   431.49), EASYSIMD_FLOAT32_C(  -782.70), EASYSIMD_FLOAT32_C(  -568.41), EASYSIMD_FLOAT32_C(  -879.09),
      EASYSIMD_FLOAT32_C(   944.03), EASYSIMD_FLOAT32_C(   251.09), EASYSIMD_FLOAT32_C(   354.47), EASYSIMD_FLOAT32_C(   383.56),
      EASYSIMD_FLOAT32_C(   734.69), EASYSIMD_FLOAT32_C(   869.03), EASYSIMD_FLOAT32_C(   287.88), EASYSIMD_FLOAT32_C(  -510.76),
      EASYSIMD_FLOAT32_C(  -383.23), EASYSIMD_FLOAT32_C(  -542.63), EASYSIMD_FLOAT32_C(   -70.06), EASYSIMD_FLOAT32_C(   663.54),
      EASYSIMD_FLOAT32_C(   292.10), EASYSIMD_FLOAT32_C(   148.35), EASYSIMD_FLOAT32_C(  -804.60), EASYSIMD_FLOAT32_C(  -332.99),
      EASYSIMD_FLOAT32_C(   500.26), EASYSIMD_FLOAT32_C(   413.40), EASYSIMD_FLOAT32_C(  -406.82), EASYSIMD_FLOAT32_C(   963.55),
      EASYSIMD_FLOAT32_C(   426.45), EASYSIMD_FLOAT32_C(   565.08), EASYSIMD_FLOAT32_C(  -984.02), EASYSIMD_FLOAT32_C(    42.83),
      EASYSIMD_FLOAT32_C(   242.89), EASYSIMD_FLOAT32_C(   -37.54), EASYSIMD_FLOAT32_C(   439.41), EASYSIMD_FLOAT32_C(  -325.62),
      EASYSIMD_FLOAT32_C(   179.76), EASYSIMD_FLOAT32_C(   871.00), EASYSIMD_FLOAT32_C(  -204.72), EASYSIMD_FLOAT32_C(   123.79),
      EASYSIMD_FLOAT32_C(   122.09), EASYSIMD_FLOAT32_C(  -850.25), EASYSIMD_FLOAT32_C(  -492.65), EASYSIMD_FLOAT32_C(  -143.21),
      EASYSIMD_FLOAT32_C(  -981.21), EASYSIMD_FLOAT32_C(   795.23), EASYSIMD_FLOAT32_C(   346.02), EASYSIMD_FLOAT32_C(  -364.44),
      EASYSIMD_FLOAT32_C(  -747.40), EASYSIMD_FLOAT32_C(  -724.03), EASYSIMD_FLOAT32_C(  -700.90), EASYSIMD_FLOAT32_C(   544.70),
      EASYSIMD_FLOAT32_C(   424.32), EASYSIMD_FLOAT32_C(  -505.49), EASYSIMD_FLOAT32_C(  -788.29), EASYSIMD_FLOAT32_C(   -75.42),
      EASYSIMD_FLOAT32_C(   907.91), EASYSIMD_FLOAT32_C(  -195.11), EASYSIMD_FLOAT32_C(  -111.87), EASYSIMD_FLOAT32_C(   334.36),
      EASYSIMD_FLOAT32_C(  -630.03), EASYSIMD_FLOAT32_C(   -95.89), EASYSIMD_FLOAT32_C(  -622.81), EASYSIMD_FLOAT32_C(   612.85),
      EASYSIMD_FLOAT32_C(   866.56), EASYSIMD_FLOAT32_C(   816.60), EASYSIMD_FLOAT32_C(  -712.77), EASYSIMD_FLOAT32_C(    46.33),
      EASYSIMD_FLOAT32_C(   687.60), EASYSIMD_FLOAT32_C(    82.51), EASYSIMD_FLOAT32_C(  -829.89), EASYSIMD_FLOAT32_C(  -190.30),
      EASYSIMD_FLOAT32_C(   232.26), EASYSIMD_FLOAT32_C(  -322.54), EASYSIMD_FLOAT32_C(   666.49), EASYSIMD_FLOAT32_C(   251.05),
      EASYSIMD_FLOAT32_C(  -527.30), EASYSIMD_FLOAT32_C(    12.51), EASYSIMD_FLOAT32_C(   886.61), EASYSIMD_FLOAT32_C(  -274.70),
      EASYSIMD_FLOAT32_C(   288.47), EASYSIMD_FLOAT32_C(  -814.29), EASYSIMD_FLOAT32_C(  -730.00), EASYSIMD_FLOAT32_C(  -287.21),
      EASYSIMD_FLOAT32_C(  -319.78), EASYSIMD_FLOAT32_C(  -518.29), EASYSIMD_FLOAT32_C(   637.37), EASYSIMD_FLOAT32_C(  -411.87),
      EASYSIMD_FLOAT32_C(   286.60), EASYSIMD_FLOAT32_C(  -474.50), EASYSIMD_FLOAT32_C(   922.49), EASYSIMD_FLOAT32_C(   656.56),
      EASYSIMD_FLOAT32_C(   429.61), EASYSIMD_FLOAT32_C(  -700.32), EASYSIMD_FLOAT32_C(   269.42), EASYSIMD_FLOAT32_C(   296.17),
      EASYSIMD_FLOAT32_C(  -883.72), EASYSIMD_FLOAT32_C(   556.64), EASYSIMD_FLOAT32_C(  -657.50), EASYSIMD_FLOAT32_C(   803.89),
      EASYSIMD_FLOAT32_C(  -360.84), EASYSIMD_FLOAT32_C(  -487.39), EASYSIMD_FLOAT32_C(  -386.41), EASYSIMD_FLOAT32_C(   871.42),
      EASYSIMD_FLOAT32_C(   190.08), EASYSIMD_FLOAT32_C(  -719.93), EASYSIMD_FLOAT32_C(   122.47), EASYSIMD_FLOAT32_C(   662.78),
      EASYSIMD_FLOAT32_C(   292.58), EASYSIMD_FLOAT32_C(     9.08), EASYSIMD_FLOAT32_C(  -611.92), EASYSIMD_FLOAT32_C(  -418.94),
      EASYSIMD_FLOAT32_C(   194.79), EASYSIMD_FLOAT32_C(  -341.92), EASYSIMD_FLOAT32_C(   293.85), EASYSIMD_FLOAT32_C(   875.01),
      EASYSIMD_FLOAT32_C(   139.79) };
  static const easysimd_float32 b[] =
    { EASYSIMD_FLOAT32_C(   -68.78), EASYSIMD_FLOAT32_C(  -536.86), EASYSIMD_FLOAT32_C(  -573.62), EASYSIMD_FLOAT32_C(   456.73),
      EASYSIMD_FLOAT32_C(  -614.37), EASYSIMD_FLOAT32_C(  -917.05), EASYSIMD_FLOAT32_C(  -113.66), EASYSIMD_FLOAT32_C(  -314.69),
      EASYSIMD_FLOAT32_C(   352.36), EASYSIMD_FLOAT32_C(  -817.49), EASYSIMD_FLOAT32_C(  -198.41), EASYSIMD_FLOAT32_C(   -90.99),
      EASYSIMD_FLOAT32_C(  -474.99), EASYSIMD_FLOAT32_C(  -394.52), EASYSIMD_FLOAT32_C(   548.16), EASYSIMD_FLOAT32_C(    37.62),
      EASYSIMD_FLOAT32_C(   219.07), EASYSIMD_FLOAT32_C(   419.58), EASYSIMD_FLOAT32_C(  -772.30), EASYSIMD_FLOAT32_C(   499.14),
      EASYSIMD_FLOAT32_C(  -457.95), EASYSIMD_FLOAT32_C(   890.47), EASYSIMD_FLOAT32_C(  -208.28), EASYSIMD_FLOAT32_C(   551.13),
      EASYSIMD_FLOAT32_C(  -721.45), EASYSIMD_FLOAT32_C(   372.78), EASYSIMD_FLOAT32_C(  -254.08), EASYSIMD_FLOAT32_C(   -63.37),
      EASYSIMD_FLOAT32_C(  -333.37), EASYSIMD_FLOAT32_C(  -379.08), EASYSIMD_FLOAT32_C(  -923.59), EASYSIMD_FLOAT32_C(   597.85),
      EASYSIMD_FLOAT32_C(    84.06), EASYSIMD_FLOAT32_C(  -497.20), EASYSIMD_FLOAT32_C(    54.58), EASYSIMD_FLOAT32_C(   469.69),
      EASYSIMD_FLOAT32_C(  -414.25), EASYSIMD_FLOAT32_C(   940.92), EASYSIMD_FLOAT32_C(  -845.00), EASYSIMD_FLOAT32_C(   938.11),
      EASYSIMD_FLOAT32_C(  -876.58), EASYSIMD_FLOAT32_C(   -43.41), EASYSIMD_FLOAT32_C(  -152.89), EASYSIMD_FLOAT32_C(  -351.57),
      EASYSIMD_FLOAT32_C(   562.07), EASYSIMD_FLOAT32_C(  -604.72), EASYSIMD_FLOAT32_C(   686.05), EASYSIMD_FLOAT32_C(  -218.86),
      EASYSIMD_FLOAT32_C(   814.86), EASYSIMD_FLOAT32_C(   913.75), EASYSIMD_FLOAT32_C(  -719.71), EASYSIMD_FLOAT32_C(  -643.09),
      EASYSIMD_FLOAT32_C(   804.22), EASYSIMD_FLOAT32_C(    72.01), EASYSIMD_FLOAT32_C(   908.03), EASYSIMD_FLOAT32_C(  -917.23),
      EASYSIMD_FLOAT32_C(  -555.21), EASYSIMD_FLOAT32_C(  -346.05), EASYSIMD_FLOAT32_C(    19.40), EASYSIMD_FLOAT32_C(   111.42),
      EASYSIMD_FLOAT32_C(   274.87), EASYSIMD_FLOAT32_C(    95.82), EASYSIMD_FLOAT32_C(  -290.72), EASYSIMD_FLOAT32_C(  -641.07),
      EASYSIMD_FLOAT32_C(   598.61), EASYSIMD_FLOAT32_C(   763.86), EASYSIMD_FLOAT32_C(   828.62), EASYSIMD_FLOAT32_C(  -815.64),
      EASYSIMD_FLOAT32_C(   704.77), EASYSIMD_FLOAT32_C(   983.62), EASYSIMD_FLOAT32_C(  -877.53), EASYSIMD_FLOAT32_C(   828.20),
      EASYSIMD_FLOAT32_C(   -59.79), EASYSIMD_FLOAT32_C(   -30.42), EASYSIMD_FLOAT32_C(  -523.37), EASYSIMD_FLOAT32_C(  -497.71),
      EASYSIMD_FLOAT32_C(   364.86), EASYSIMD_FLOAT32_C(  -837.32), EASYSIMD_FLOAT32_C(   283.43), EASYSIMD_FLOAT32_C(   179.71),
      EASYSIMD_FLOAT32_C(  -923.57), EASYSIMD_FLOAT32_C(   563.72), EASYSIMD_FLOAT32_C(   536.62), EASYSIMD_FLOAT32_C(   880.65),
      EASYSIMD_FLOAT32_C(  -364.27), EASYSIMD_FLOAT32_C(   444.65), EASYSIMD_FLOAT32_C(   963.43), EASYSIMD_FLOAT32_C(    80.52),
      EASYSIMD_FLOAT32_C(  -901.40), EASYSIMD_FLOAT32_C(   -17.17), EASYSIMD_FLOAT32_C(  -808.06), EASYSIMD_FLOAT32_C(   373.47),
      EASYSIMD_FLOAT32_C(  -921.36), EASYSIMD_FLOAT32_C(   -98.78), EASYSIMD_FLOAT32_C(   732.41), EASYSIMD_FLOAT32_C(   677.26),
      EASYSIMD_FLOAT32_C(  -334.93), EASYSIMD_FLOAT32_C(   561.03), EASYSIMD_FLOAT32_C(   861.62), EASYSIMD_FLOAT32_C(  -630.15),
      EASYSIMD_FLOAT32_C(   544.65), EASYSIMD_FLOAT32_C(   984.08), EASYSIMD_FLOAT32_C(  -801.95), EASYSIMD_FLOAT32_C(  -515.14),
      EASYSIMD_FLOAT32_C(   -46.33), EASYSIMD_FLOAT32_C(  -325.32), EASYSIMD_FLOAT32_C(   -12.85), EASYSIMD_FLOAT32_C(  -681.48),
      EASYSIMD_FLOAT32_C(  -162.64), EASYSIMD_FLOAT32_C(  -729.41), EASYSIMD_FLOAT32_C(   498.24), EASYSIMD_FLOAT32_C(   -86.21),
      EASYSIMD_FLOAT32_C(   834.31), EASYSIMD_FLOAT32_C(    34.86), EASYSIMD_FLOAT32_C(  -205.56), EASYSIMD_FLOAT32_C(  -529.97),
      EASYSIMD_FLOAT32_C(  -520.49), EASYSIMD_FLOAT32_C(  -242.13), EASYSIMD_FLOAT32_C(   550.55), EASYSIMD_FLOAT32_C(  -421.89),
      EASYSIMD_FLOAT32_C(   740.69), EASYSIMD_FLOAT32_C(   742.50), EASYSIMD_FLOAT32_C(   951.58), EASYSIMD_FLOAT32_C(   819.34),
      EASYSIMD_FLOAT32_C(  -356.29), EASYSIMD_FLOAT32_C(   683.99), EASYSIMD_FLOAT32_C(   496.59), EASYSIMD_FLOAT32_C(   308.79),
      EASYSIMD_FLOAT32_C(   245.02), EASYSIMD_FLOAT32_C(   358.21), EASYSIMD_FLOAT32_C(   678.64), EASYSIMD_FLOAT32_C(  -210.33),
      EASYSIMD_FLOAT32_C(   342.29), EASYSIMD_FLOAT32_C(   876.68), EASYSIMD_FLOAT32_C(   274.53), EASYSIMD_FLOAT32_C(  -704.04),
      EASYSIMD_FLOAT32_C(  -448.64), EASYSIMD_FLOAT32_C(  -738.31), EASYSIMD_FLOAT32_C(  -385.52), EASYSIMD_FLOAT32_C(   388.72),
      EASYSIMD_FLOAT32_C(  -467.73), EASYSIMD_FLOAT32_C(  -887.28), EASYSIMD_FLOAT32_C(  -697.49), EASYSIMD_FLOAT32_C(  -633.42),
      EASYSIMD_FLOAT32_C(   147.57), EASYSIMD_FLOAT32_C(    96.95), EASYSIMD_FLOAT32_C(  -163.38), EASYSIMD_FLOAT32_C(   627.08),
      EASYSIMD_FLOAT32_C(   854.81), EASYSIMD_FLOAT32_C(  -612.83), EASYSIMD_FLOAT32_C(  -794.81), EASYSIMD_FLOAT32_C(   595.51),
      EASYSIMD_FLOAT32_C(  -870.33), EASYSIMD_FLOAT32_C(  -843.23), EASYSIMD_FLOAT32_C(   414.84), EASYSIMD_FLOAT32_C(  -226.62),
      EASYSIMD_FLOAT32_C(   840.76), EASYSIMD_FLOAT32_C(   -88.57), EASYSIMD_FLOAT32_C(  -917.83), EASYSIMD_FLOAT32_C(    85.78),
      EASYSIMD_FLOAT32_C(  -730.36), EASYSIMD_FLOAT32_C(   760.80), EASYSIMD_FLOAT32_C(   875.45), EASYSIMD_FLOAT32_C(   611.94),
      EASYSIMD_FLOAT32_C(   637.48), EASYSIMD_FLOAT32_C(   149.98), EASYSIMD_FLOAT32_C(   907.90), EASYSIMD_FLOAT32_C(  -811.16),
      EASYSIMD_FLOAT32_C(   411.67), EASYSIMD_FLOAT32_C(  -477.62), EASYSIMD_FLOAT32_C(   577.56), EASYSIMD_FLOAT32_C(   943.94),
      EASYSIMD_FLOAT32_C(  -364.90), EASYSIMD_FLOAT32_C(   880.07), EASYSIMD_FLOAT32_C(  -689.47), EASYSIMD_FLOAT32_C(   782.67),
      EASYSIMD_FLOAT32_C(   -22.98), EASYSIMD_FLOAT32_C(   147.14), EASYSIMD_FLOAT32_C(   409.75), EASYSIMD_FLOAT32_C(  -168.17),
      EASYSIMD_FLOAT32_C(   534.31), EASYSIMD_FLOAT32_C(   614.94), EASYSIMD_FLOAT32_C(  -572.66), EASYSIMD_FLOAT32_C(   663.98),
      EASYSIMD_FLOAT32_C(   771.71), EASYSIMD_FLOAT32_C(   842.18), EASYSIMD_FLOAT32_C(  -562.64), EASYSIMD_FLOAT32_C(   612.48),
      EASYSIMD_FLOAT32_C(  -246.39), EASYSIMD_FLOAT32_C(  -480.48), EASYSIMD_FLOAT32_C(  -301.75), EASYSIMD_FLOAT32_C(    23.26),
      EASYSIMD_FLOAT32_C(  -719.68), EASYSIMD_FLOAT32_C(  -426.30), EASYSIMD_FLOAT32_C(  -364.80), EASYSIMD_FLOAT32_C(   917.81),
      EASYSIMD_FLOAT32_C(   723.68), EASYSIMD_FLOAT32_C(  -456.91), EASYSIMD_FLOAT32_C(  -893.35), EASYSIMD_FLOAT32_C(   135.36),
      EASYSIMD_FLOAT32_C(    65.47), EASYSIMD_FLOAT32_C(   684.21), EASYSIMD_FLOAT32_C(    79.30), EASYSIMD_FLOAT32_C(   700.57),
      EASYSIMD_FLOAT32_C(   564.28), EASYSIMD_FLOAT32_C(   389.83), EASYSIMD_FLOAT32_C(   483.24), EASYSIMD_FLOAT32_C(  -458.70),
      EASYSIMD_FLOAT32_C(  -463.03), EASYSIMD_FLOAT32_C(  -107.01), EASYSIMD_FLOAT32_C(   373.13), EASYSIMD_FLOAT32_C(  -928.72),
      EASYSIMD_FLOAT32_C(  -492.06), EASYSIMD_FLOAT32_C(   800.47), EASYSIMD_FLOAT32_C(   735.26), EASYSIMD_FLOAT32_C(  -720.35),
      EASYSIMD_FLOAT32_C(   642.65) };
  static const easysimd_float32 e[] =
    { EASYSIMD_FLOAT32_C(   -68.78), EASYSIMD_FLOAT32_C(  -536.86), EASYSIMD_FLOAT32_C(   136.17), EASYSIMD_FLOAT32_C(   622.07),
      EASYSIMD_FLOAT32_C(   -92.13), EASYSIMD_FLOAT32_C(  -917.05), EASYSIMD_FLOAT32_C(  -113.66), EASYSIMD_FLOAT32_C(  -314.69),
      EASYSIMD_FLOAT32_C(   352.36), EASYSIMD_FLOAT32_C(  -817.49), EASYSIMD_FLOAT32_C(  -198.41), EASYSIMD_FLOAT32_C(   387.60),
      EASYSIMD_FLOAT32_C(  -474.99), EASYSIMD_FLOAT32_C(  -922.07), EASYSIMD_FLOAT32_C(   548.16), EASYSIMD_FLOAT32_C(    37.62),
      EASYSIMD_FLOAT32_C(   529.68), EASYSIMD_FLOAT32_C(   608.40), EASYSIMD_FLOAT32_C(  -772.30), EASYSIMD_FLOAT32_C(   499.14),
      EASYSIMD_FLOAT32_C(  -263.14), EASYSIMD_FLOAT32_C(  -248.03), EASYSIMD_FLOAT32_C(  -208.28), EASYSIMD_FLOAT32_C(   551.13),
      EASYSIMD_FLOAT32_C(  -199.62), EASYSIMD_FLOAT32_C(   372.78), EASYSIMD_FLOAT32_C(  -254.08), EASYSIMD_FLOAT32_C(  -599.91),
      EASYSIMD_FLOAT32_C(  -908.46), EASYSIMD_FLOAT32_C(   186.06), EASYSIMD_FLOAT32_C(  -923.59), EASYSIMD_FLOAT32_C(   597.85),
      EASYSIMD_FLOAT32_C(    84.06), EASYSIMD_FLOAT32_C(  -497.20), EASYSIMD_FLOAT32_C(   977.87), EASYSIMD_FLOAT32_C(  -891.09),
      EASYSIMD_FLOAT32_C(  -414.25), EASYSIMD_FLOAT32_C(   477.78), EASYSIMD_FLOAT32_C(  -845.00), EASYSIMD_FLOAT32_C(   660.18),
      EASYSIMD_FLOAT32_C(  -876.58), EASYSIMD_FLOAT32_C(   176.87), EASYSIMD_FLOAT32_C(    47.77), EASYSIMD_FLOAT32_C(  -623.22),
      EASYSIMD_FLOAT32_C(   562.07), EASYSIMD_FLOAT32_C(   -64.26), EASYSIMD_FLOAT32_C(  -544.11), EASYSIMD_FLOAT32_C(  -215.51),
      EASYSIMD_FLOAT32_C(  -455.86), EASYSIMD_FLOAT32_C(   913.75), EASYSIMD_FLOAT32_C(  -719.71), EASYSIMD_FLOAT32_C(   281.00),
      EASYSIMD_FLOAT32_C(  -535.22), EASYSIMD_FLOAT32_C(  -729.06), EASYSIMD_FLOAT32_C(  -766.82), EASYSIMD_FLOAT32_C(  -917.23),
      EASYSIMD_FLOAT32_C(  -555.21), EASYSIMD_FLOAT32_C(  -346.05), EASYSIMD_FLOAT32_C(    19.40), EASYSIMD_FLOAT32_C(   111.42),
      EASYSIMD_FLOAT32_C(   274.87), EASYSIMD_FLOAT32_C(    95.82), EASYSIMD_FLOAT32_C(  -866.50), EASYSIMD_FLOAT32_C(  -313.86),
      EASYSIMD_FLOAT32_C(  -448.74), EASYSIMD_FLOAT32_C(   763.86), EASYSIMD_FLOAT32_C(  -204.95), EASYSIMD_FLOAT32_C(  -815.64),
      EASYSIMD_FLOAT32_C(   704.77), EASYSIMD_FLOAT32_C(   603.33), EASYSIMD_FLOAT32_C(  -294.09), EASYSIMD_FLOAT32_C(   828.20),
      EASYSIMD_FLOAT32_C(  -219.80), EASYSIMD_FLOAT32_C(   -30.42), EASYSIMD_FLOAT32_C(   270.83), EASYSIMD_FLOAT32_C(  -497.71),
      EASYSIMD_FLOAT32_C(   364.86), EASYSIMD_FLOAT32_C(   726.72), EASYSIMD_FLOAT32_C(   283.43), EASYSIMD_FLOAT32_C(   233.56),
      EASYSIMD_FLOAT32_C(   439.54), EASYSIMD_FLOAT32_C(  -516.40), EASYSIMD_FLOAT32_C(   536.62), EASYSIMD_FLOAT32_C(   904.32),
      EASYSIMD_FLOAT32_C(  -245.46), EASYSIMD_FLOAT32_C(  -252.26), EASYSIMD_FLOAT32_C(   169.48), EASYSIMD_FLOAT32_C(    80.52),
      EASYSIMD_FLOAT32_C(  -901.40), EASYSIMD_FLOAT32_C(  -165.26), EASYSIMD_FLOAT32_C(  -781.59), EASYSIMD_FLOAT32_C(   373.47),
      EASYSIMD_FLOAT32_C(  -921.36), EASYSIMD_FLOAT32_C(   -98.78), EASYSIMD_FLOAT32_C(   218.00), EASYSIMD_FLOAT32_C(   677.26),
      EASYSIMD_FLOAT32_C(  -334.93), EASYSIMD_FLOAT32_C(   561.03), EASYSIMD_FLOAT32_C(   -28.10), EASYSIMD_FLOAT32_C(  -947.57),
      EASYSIMD_FLOAT32_C(   616.38), EASYSIMD_FLOAT32_C(   677.81), EASYSIMD_FLOAT32_C(  -801.95), EASYSIMD_FLOAT32_C(  -603.42),
      EASYSIMD_FLOAT32_C(   431.49), EASYSIMD_FLOAT32_C(  -782.70), EASYSIMD_FLOAT32_C(  -568.41), EASYSIMD_FLOAT32_C(  -681.48),
      EASYSIMD_FLOAT32_C(   944.03), EASYSIMD_FLOAT32_C(   251.09), EASYSIMD_FLOAT32_C(   354.47), EASYSIMD_FLOAT32_C(   -86.21),
      EASYSIMD_FLOAT32_C(   734.69), EASYSIMD_FLOAT32_C(    34.86), EASYSIMD_FLOAT32_C(  -205.56), EASYSIMD_FLOAT32_C(  -510.76),
      EASYSIMD_FLOAT32_C(  -383.23), EASYSIMD_FLOAT32_C(  -242.13), EASYSIMD_FLOAT32_C(   550.55), EASYSIMD_FLOAT32_C(   663.54),
      EASYSIMD_FLOAT32_C(   292.10), EASYSIMD_FLOAT32_C(   148.35), EASYSIMD_FLOAT32_C(  -804.60), EASYSIMD_FLOAT32_C(  -332.99),
      EASYSIMD_FLOAT32_C(  -356.29), EASYSIMD_FLOAT32_C(   683.99), EASYSIMD_FLOAT32_C(   496.59), EASYSIMD_FLOAT32_C(   308.79),
      EASYSIMD_FLOAT32_C(   245.02), EASYSIMD_FLOAT32_C(   358.21), EASYSIMD_FLOAT32_C(   678.64), EASYSIMD_FLOAT32_C(  -210.33),
      EASYSIMD_FLOAT32_C(   242.89), EASYSIMD_FLOAT32_C(   -37.54), EASYSIMD_FLOAT32_C(   274.53), EASYSIMD_FLOAT32_C(  -325.62),
      EASYSIMD_FLOAT32_C(   179.76), EASYSIMD_FLOAT32_C(   871.00), EASYSIMD_FLOAT32_C(  -385.52), EASYSIMD_FLOAT32_C(   123.79),
      EASYSIMD_FLOAT32_C(  -467.73), EASYSIMD_FLOAT32_C(  -887.28), EASYSIMD_FLOAT32_C(  -697.49), EASYSIMD_FLOAT32_C(  -143.21),
      EASYSIMD_FLOAT32_C(  -981.21), EASYSIMD_FLOAT32_C(   795.23), EASYSIMD_FLOAT32_C(  -163.38), EASYSIMD_FLOAT32_C(   627.08),
      EASYSIMD_FLOAT32_C(  -747.40), EASYSIMD_FLOAT32_C(  -612.83), EASYSIMD_FLOAT32_C(  -794.81), EASYSIMD_FLOAT32_C(   595.51),
      EASYSIMD_FLOAT32_C(   424.32), EASYSIMD_FLOAT32_C(  -843.23), EASYSIMD_FLOAT32_C(   414.84), EASYSIMD_FLOAT32_C(  -226.62),
      EASYSIMD_FLOAT32_C(   907.91), EASYSIMD_FLOAT32_C(  -195.11), EASYSIMD_FLOAT32_C(  -111.87), EASYSIMD_FLOAT32_C(   334.36),
      EASYSIMD_FLOAT32_C(  -730.36), EASYSIMD_FLOAT32_C(   -95.89), EASYSIMD_FLOAT32_C(   875.45), EASYSIMD_FLOAT32_C(   611.94),
      EASYSIMD_FLOAT32_C(   866.56), EASYSIMD_FLOAT32_C(   816.60), EASYSIMD_FLOAT32_C(  -712.77), EASYSIMD_FLOAT32_C(  -811.16),
      EASYSIMD_FLOAT32_C(   411.67), EASYSIMD_FLOAT32_C(  -477.62), EASYSIMD_FLOAT32_C(  -829.89), EASYSIMD_FLOAT32_C(   943.94),
      EASYSIMD_FLOAT32_C(   232.26), EASYSIMD_FLOAT32_C(   880.07), EASYSIMD_FLOAT32_C(   666.49), EASYSIMD_FLOAT32_C(   251.05),
      EASYSIMD_FLOAT32_C(   -22.98), EASYSIMD_FLOAT32_C(   147.14), EASYSIMD_FLOAT32_C(   409.75), EASYSIMD_FLOAT32_C(  -168.17),
      EASYSIMD_FLOAT32_C(   534.31), EASYSIMD_FLOAT32_C(  -814.29), EASYSIMD_FLOAT32_C(  -572.66), EASYSIMD_FLOAT32_C(   663.98),
      EASYSIMD_FLOAT32_C(   771.71), EASYSIMD_FLOAT32_C(   842.18), EASYSIMD_FLOAT32_C(  -562.64), EASYSIMD_FLOAT32_C(  -411.87),
      EASYSIMD_FLOAT32_C(   286.60), EASYSIMD_FLOAT32_C(  -480.48), EASYSIMD_FLOAT32_C(   922.49), EASYSIMD_FLOAT32_C(   656.56),
      EASYSIMD_FLOAT32_C(   429.61), EASYSIMD_FLOAT32_C(  -700.32), EASYSIMD_FLOAT32_C(   269.42), EASYSIMD_FLOAT32_C(   917.81),
      EASYSIMD_FLOAT32_C(   723.68), EASYSIMD_FLOAT32_C(   556.64), EASYSIMD_FLOAT32_C(  -893.35), EASYSIMD_FLOAT32_C(   803.89),
      EASYSIMD_FLOAT32_C(    65.47), EASYSIMD_FLOAT32_C(   684.21), EASYSIMD_FLOAT32_C(  -386.41), EASYSIMD_FLOAT32_C(   700.57),
      EASYSIMD_FLOAT32_C(   190.08), EASYSIMD_FLOAT32_C(   389.83), EASYSIMD_FLOAT32_C(   483.24), EASYSIMD_FLOAT32_C(   662.78),
      EASYSIMD_FLOAT32_C(  -463.03), EASYSIMD_FLOAT32_C(  -107.01), EASYSIMD_FLOAT32_C(  -611.92), EASYSIMD_FLOAT32_C(  -928.72),
      EASYSIMD_FLOAT32_C(   194.79), EASYSIMD_FLOAT32_C(  -341.92), EASYSIMD_FLOAT32_C(   735.26), EASYSIMD_FLOAT32_C(   875.01),
      EASYSIMD_FLOAT32_C(   139.79) };
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b32(), pg)) {
    ...
    pv = easysimd_svcmplt_s32(pg, easysimd_svld1_s32(pg, &(p[i])), easysimd_svdup_n_s32(INT32_C(0)));
    rv = easysimd_svsel_f32(pv, av, bv);
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b32(), pg)) {
    ...
    ev = easysimd_svsel_f32(pv, av, bv);
...
static int
test_easysimd_x_svsel_f64_z (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const int64_t p[] =
    { -INT64_C(                   1), -INT64_C(                   1),  INT64_C(                   0), -INT64_C(                   1),
      -INT64_C(                   1), -INT64_C(                   1),  INT64_C(                   0),  INT64_C(                   0),
  ...
  static const easysimd_float64 a[] =
    { EASYSIMD_FLOAT64_C(   804.74), EASYSIMD_FLOAT64_C(    14.34), EASYSIMD_FLOAT64_C(   748.42), EASYSIMD_FLOAT64_C(  -349.22),
      EASYSIMD_FLOAT64_C(   636.24), EASYSIMD_FLOAT64_C(  -768.54), EASYSIMD_FLOAT64_C(   871.82), EASYSIMD_FLOAT64_C(   913.02),
      EASYSIMD_FLOAT64_C(   286.35), EASYSIMD_FLOAT64_C(   335.68), EASYSIMD_FLOAT64_C(   358.71), EASYSIMD_FLOAT64_C(  -658.65),
      EASYSIMD_FLOAT64_C(   -34.78), EASYSIMD_FLOAT64_C(   173.13), EASYSIMD_FLOAT64_C(   976.54), EASYSIMD_FLOAT64_C(  -690.38),
      EASYSIMD_FLOAT64_C(  -457.11), EASYSIMD_FLOAT64_C(  -447.26), EASYSIMD_FLOAT64_C(   912.85), EASYSIMD_FLOAT64_C(    -4.98),
      EASYSIMD_FLOAT64_C(  -883.64), EASYSIMD_FLOAT64_C(   576.51), EASYSIMD_FLOAT64_C(  -846.91), EASYSIMD_FLOAT64_C(   179.95),
      EASYSIMD_FLOAT64_C(  -899.24), EASYSIMD_FLOAT64_C(   312.41), EASYSIMD_FLOAT64_C(   -26.22), EASYSIMD_FLOAT64_C(  -404.13),
      EASYSIMD_FLOAT64_C(   -85.15), EASYSIMD_FLOAT64_C(   517.86), EASYSIMD_FLOAT64_C(   577.31), EASYSIMD_FLOAT64_C(  -280.41),
      EASYSIMD_FLOAT64_C(  -467.80), EASYSIMD_FLOAT64_C(   325.73), EASYSIMD_FLOAT64_C(   370.37), EASYSIMD_FLOAT64_C(  -831.56),
      EASYSIMD_FLOAT64_C(   557.19), EASYSIMD_FLOAT64_C(   242.19), EASYSIMD_FLOAT64_C(  -918.54), EASYSIMD_FLOAT64_C(  -156.45),
      EASYSIMD_FLOAT64_C(  -422.13), EASYSIMD_FLOAT64_C(   440.17), EASYSIMD_FLOAT64_C(   184.89), EASYSIMD_FLOAT64_C(   543.08),
      EASYSIMD_FLOAT64_C(  -386.70), EASYSIMD_FLOAT64_C(   161.44), EASYSIMD_FLOAT64_C(   852.70), EASYSIMD_FLOAT64_C(   156.19),
      EASYSIMD_FLOAT64_C(   714.17), EASYSIMD_FLOAT64_C(   765.55), EASYSIMD_FLOAT64_C(  -848.79), EASYSIMD_FLOAT64_C(   830.53),
      EASYSIMD_FLOAT64_C(   342.06), EASYSIMD_FLOAT64_C(  -695.70), EASYSIMD_FLOAT64_C(    10.48), EASYSIMD_FLOAT64_C(   442.82),
      EASYSIMD_FLOAT64_C(   616.72), EASYSIMD_FLOAT64_C(   984.26), EASYSIMD_FLOAT64_C(  -961.30), EASYSIMD_FLOAT64_C(  -468.43),
      EASYSIMD_FLOAT64_C(   502.12), EASYSIMD_FLOAT64_C(   616.01), EASYSIMD_FLOAT64_C(   251.16), EASYSIMD_FLOAT64_C(  -965.68),
      EASYSIMD_FLOAT64_C(   -58.26), EASYSIMD_FLOAT64_C(  -378.47), EASYSIMD_FLOAT64_C(  -797.24) };
  static const easysimd_float64 e[] =
    { EASYSIMD_FLOAT64_C(   804.74), EASYSIMD_FLOAT64_C(    14.34), EASYSIMD_FLOAT64_C(     0.00), EASYSIMD_FLOAT64_C(  -349.22),
      EASYSIMD_FLOAT64_C(   636.24), EASYSIMD_FLOAT64_C(  -768.54), EASYSIMD_FLOAT64_C(     0.00), EASYSIMD_FLOAT64_C(     0.00),
      EASYSIMD_FLOAT64_C(   286.35), EASYSIMD_FLOAT64_C(   335.68), EASYSIMD_FLOAT64_C(     0.00), EASYSIMD_FLOAT64_C(     0.00),
      EASYSIMD_FLOAT64_C(   -34.78), EASYSIMD_FLOAT64_C(   173.13), EASYSIMD_FLOAT64_C(   976.54), EASYSIMD_FLOAT64_C(     0.00),
      EASYSIMD_FLOAT64_C(     0.00), EASYSIMD_FLOAT64_C(  -447.26), EASYSIMD_FLOAT64_C(   912.85), EASYSIMD_FLOAT64_C(     0.00),
      EASYSIMD_FLOAT64_C(     0.00), EASYSIMD_FLOAT64_C(   576.51), EASYSIMD_FLOAT64_C(  -846.91), EASYSIMD_FLOAT64_C(     0.00),
      EASYSIMD_FLOAT64_C(     0.00), EASYSIMD_FLOAT64_C(     0.00), EASYSIMD_FLOAT64_C(     0.00), EASYSIMD_FLOAT64_C(     0.00),
      EASYSIMD_FLOAT64_C(   -85.15), EASYSIMD_FLOAT64_C(   517.86), EASYSIMD_FLOAT64_C(   577.31), EASYSIMD_FLOAT64_C(  -280.41),
      EASYSIMD_FLOAT64_C(     0.00), EASYSIMD_FLOAT64_C(   325.73), EASYSIMD_FLOAT64_C(   370.37), EASYSIMD_FLOAT64_C(     0.00),
      EASYSIMD_FLOAT64_C(   557.19), EASYSIMD_FLOAT64_C(     0.00), EASYSIMD_FLOAT64_C(     0.00), EASYSIMD_FLOAT64_C(     0.00),
      EASYSIMD_FLOAT64_C(  -422.13), EASYSIMD_FLOAT64_C(   440.17), EASYSIMD_FLOAT64_C(     0.00), EASYSIMD_FLOAT64_C(     0.00),
      EASYSIMD_FLOAT64_C(  -386.70), EASYSIMD_FLOAT64_C(     0.00), EASYSIMD_FLOAT64_C(     0.00), EASYSIMD_FLOAT64_C(   156.19),
      EASYSIMD_FLOAT64_C(     0.00), EASYSIMD_FLOAT64_C(   765.55), EASYSIMD_FLOAT64_C(     0.00), EASYSIMD_FLOAT64_C(     0.00),
      EASYSIMD_FLOAT64_C(   342.06), EASYSIMD_FLOAT64_C(  -695.70), EASYSIMD_FLOAT64_C(     0.00), EASYSIMD_FLOAT64_C(   442.82),
      EASYSIMD_FLOAT64_C(   616.72), EASYSIMD_FLOAT64_C(   984.26), EASYSIMD_FLOAT64_C(  -961.30), EASYSIMD_FLOAT64_C(  -468.43),
      EASYSIMD_FLOAT64_C(   502.12), EASYSIMD_FLOAT64_C(     0.00), EASYSIMD_FLOAT64_C(   251.16), EASYSIMD_FLOAT64_C(     0.00),
      EASYSIMD_FLOAT64_C(     0.00), EASYSIMD_FLOAT64_C(     0.00), EASYSIMD_FLOAT64_C(     0.00) };
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b64(), pg)) {
    ...
    pv = easysimd_svcmplt_s64(pg, easysimd_svld1_s64(pg, &(p[i])), easysimd_svdup_n_s64(INT64_C(0)));
    rv = easysimd_x_svsel_f64_z(pv, av);
...
#else
  int64_t p[1024 / sizeof(int64_t)];
  easysimd_float64 a[1024 / sizeof(int64_t)], e[1024 / sizeof(int64_t)];
  int32_t len = easysimd_test_arm_sve_random_length(sizeof(e), sizeof(e[0]));
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b64(), pg)) {
    ...
    ev = easysimd_x_svsel_f64_z(pv, av);
...
static int
test_easysimd_svsel_f64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const int64_t p[] =
    { -INT64_C(                   1),  INT64_C(                   0),  INT64_C(                   0), -INT64_C(                   1),
      -INT64_C(                   1),  INT64_C(                   0), -INT64_C(                   1),  INT64_C(                   0),
      ...
      -INT64_C(                   1), -INT64_C(                   1) };
  static const easysimd_float64 a[] =
    { EASYSIMD_FLOAT64_C(   503.34), EASYSIMD_FLOAT64_C(  -710.32), EASYSIMD_FLOAT64_C(  -539.96), EASYSIMD_FLOAT64_C(  -271.13),
      EASYSIMD_FLOAT64_C(   286.21), EASYSIMD_FLOAT64_C(   413.45), EASYSIMD_FLOAT64_C(   901.45), EASYSIMD_FLOAT64_C(  -683.42),
      EASYSIMD_FLOAT64_C(   818.55), EASYSIMD_FLOAT64_C(   482.11), EASYSIMD_FLOAT64_C(   805.82), EASYSIMD_FLOAT64_C(   830.06),
      EASYSIMD_FLOAT64_C(   801.73), EASYSIMD_FLOAT64_C(  -233.39), EASYSIMD_FLOAT64_C(   681.18), EASYSIMD_FLOAT64_C(   886.50),
      EASYSIMD_FLOAT64_C(  -456.42), EASYSIMD_FLOAT64_C(   823.73), EASYSIMD_FLOAT64_C(  -614.64), EASYSIMD_FLOAT64_C(   480.61),
      EASYSIMD_FLOAT64_C(   107.84), EASYSIMD_FLOAT64_C(   877.09), EASYSIMD_FLOAT64_C(   494.09), EASYSIMD_FLOAT64_C(  -255.57),
      EASYSIMD_FLOAT64_C(    13.34), EASYSIMD_FLOAT64_C(  -789.04), EASYSIMD_FLOAT64_C(   345.69), EASYSIMD_FLOAT64_C(   553.48),
      EASYSIMD_FLOAT64_C(  -219.59), EASYSIMD_FLOAT64_C(   879.74), EASYSIMD_FLOAT64_C(  -374.27), EASYSIMD_FLOAT64_C(  -716.25),
      EASYSIMD_FLOAT64_C(  -830.58), EASYSIMD_FLOAT64_C(    85.76), EASYSIMD_FLOAT64_C(    12.63), EASYSIMD_FLOAT64_C(   455.63),
      EASYSIMD_FLOAT64_C(  -500.78), EASYSIMD_FLOAT64_C(   -85.92), EASYSIMD_FLOAT64_C(   772.21), EASYSIMD_FLOAT64_C(  -682.24),
      EASYSIMD_FLOAT64_C(  -603.81), EASYSIMD_FLOAT64_C(   578.03), EASYSIMD_FLOAT64_C(  -852.18), EASYSIMD_FLOAT64_C(  -802.08),
      EASYSIMD_FLOAT64_C(  -655.36), EASYSIMD_FLOAT64_C(   829.00), EASYSIMD_FLOAT64_C(  -915.58), EASYSIMD_FLOAT64_C(  -111.79),
      EASYSIMD_FLOAT64_C(   652.73), EASYSIMD_FLOAT64_C(  -530.22), EASYSIMD_FLOAT64_C(  -631.18), EASYSIMD_FLOAT64_C(  -239.43),
      EASYSIMD_FLOAT64_C(  -653.13), EASYSIMD_FLOAT64_C(   862.91), EASYSIMD_FLOAT64_C(   505.00), EASYSIMD_FLOAT64_C(   360.20),
      EASYSIMD_FLOAT64_C(  -926.13), EASYSIMD_FLOAT64_C(  -149.31), EASYSIMD_FLOAT64_C(   -86.32), EASYSIMD_FLOAT64_C(  -145.72),
      EASYSIMD_FLOAT64_C(  -269.57), EASYSIMD_FLOAT64_C(   539.41), EASYSIMD_FLOAT64_C(   138.03), EASYSIMD_FLOAT64_C(  -100.15),
      EASYSIMD_FLOAT64_C(  -374.82), EASYSIMD_FLOAT64_C(  -849.34), EASYSIMD_FLOAT64_C(  -644.52), EASYSIMD_FLOAT64_C(   124.39),
      EASYSIMD_FLOAT64_C(    64.74), EASYSIMD_FLOAT64_C(  -872.31), EASYSIMD_FLOAT64_C(   442.15), EASYSIMD_FLOAT64_C(   460.93),
      EASYSIMD_FLOAT64_C(   705.72), EASYSIMD_FLOAT64_C(   589.97), EASYSIMD_FLOAT64_C(   658.85), EASYSIMD_FLOAT64_C(  -949.64),
      EASYSIMD_FLOAT64_C(   418.97), EASYSIMD_FLOAT64_C(   743.26), EASYSIMD_FLOAT64_C(   -61.43), EASYSIMD_FLOAT64_C(    71.70),
      EASYSIMD_FLOAT64_C(  -786.96), EASYSIMD_FLOAT64_C(   307.39), EASYSIMD_FLOAT64_C(   832.27), EASYSIMD_FLOAT64_C(  -440.09),
      EASYSIMD_FLOAT64_C(   170.30), EASYSIMD_FLOAT64_C(   337.27), EASYSIMD_FLOAT64_C(   920.11), EASYSIMD_FLOAT64_C(   244.17),
      EASYSIMD_FLOAT64_C(  -812.04), EASYSIMD_FLOAT64_C(  -166.21), EASYSIMD_FLOAT64_C(  -901.55), EASYSIMD_FLOAT64_C(   -81.61),
      EASYSIMD_FLOAT64_C(  -626.79), EASYSIMD_FLOAT64_C(   236.48), EASYSIMD_FLOAT64_C(   818.24), EASYSIMD_FLOAT64_C(    -1.62),
      EASYSIMD_FLOAT64_C(   387.14), EASYSIMD_FLOAT64_C(  -826.28), EASYSIMD_FLOAT64_C(  -877.23), EASYSIMD_FLOAT64_C(  -548.12),
      EASYSIMD_FLOAT64_C(  -698.59), EASYSIMD_FLOAT64_C(   564.93), EASYSIMD_FLOAT64_C(   912.81), EASYSIMD_FLOAT64_C(  -992.87),
      EASYSIMD_FLOAT64_C(   154.90), EASYSIMD_FLOAT64_C(   571.65) };
  static const easysimd_float64 b[] =
    { EASYSIMD_FLOAT64_C(  -942.51), EASYSIMD_FLOAT64_C(  -426.13), EASYSIMD_FLOAT64_C(   314.92), EASYSIMD_FLOAT64_C(    -3.94),
      EASYSIMD_FLOAT64_C(   645.57), EASYSIMD_FLOAT64_C(   527.96), EASYSIMD_FLOAT64_C(  -696.56), EASYSIMD_FLOAT64_C(   477.84),
      EASYSIMD_FLOAT64_C(  -912.14), EASYSIMD_FLOAT64_C(   473.75), EASYSIMD_FLOAT64_C(  -184.89), EASYSIMD_FLOAT64_C(  -992.03),
      EASYSIMD_FLOAT64_C(  -282.09), EASYSIMD_FLOAT64_C(     3.06), EASYSIMD_FLOAT64_C(  -158.23), EASYSIMD_FLOAT64_C(  -183.64),
      EASYSIMD_FLOAT64_C(   921.45), EASYSIMD_FLOAT64_C(   214.97), EASYSIMD_FLOAT64_C(  -947.16), EASYSIMD_FLOAT64_C(   739.69),
      EASYSIMD_FLOAT64_C(  -786.65), EASYSIMD_FLOAT64_C(   439.99), EASYSIMD_FLOAT64_C(   913.41), EASYSIMD_FLOAT64_C(  -663.87),
      EASYSIMD_FLOAT64_C(   891.86), EASYSIMD_FLOAT64_C(  -785.18), EASYSIMD_FLOAT64_C(   901.06), EASYSIMD_FLOAT64_C(   804.67),
      EASYSIMD_FLOAT64_C(  -778.05), EASYSIMD_FLOAT64_C(    55.96), EASYSIMD_FLOAT64_C(   376.33), EASYSIMD_FLOAT64_C(  -720.56),
      EASYSIMD_FLOAT64_C(   629.82), EASYSIMD_FLOAT64_C(  -308.76), EASYSIMD_FLOAT64_C(   275.49), EASYSIMD_FLOAT64_C(   275.39),
      EASYSIMD_FLOAT64_C(  -780.80), EASYSIMD_FLOAT64_C(   578.94), EASYSIMD_FLOAT64_C(  -246.78), EASYSIMD_FLOAT64_C(  -692.94),
      EASYSIMD_FLOAT64_C(    52.69), EASYSIMD_FLOAT64_C(   568.33), EASYSIMD_FLOAT64_C(  -684.97), EASYSIMD_FLOAT64_C(   770.60),
      EASYSIMD_FLOAT64_C(  -428.60), EASYSIMD_FLOAT64_C(   156.80), EASYSIMD_FLOAT64_C(  -413.04), EASYSIMD_FLOAT64_C(  -507.15),
      EASYSIMD_FLOAT64_C(  -628.23), EASYSIMD_FLOAT64_C(  -360.20), EASYSIMD_FLOAT64_C(  -767.46), EASYSIMD_FLOAT64_C(  -414.87),
      EASYSIMD_FLOAT64_C(  -920.21), EASYSIMD_FLOAT64_C(  -854.05), EASYSIMD_FLOAT64_C(   -78.74), EASYSIMD_FLOAT64_C(   971.66),
      EASYSIMD_FLOAT64_C(  -639.22), EASYSIMD_FLOAT64_C(  -177.69), EASYSIMD_FLOAT64_C(   776.33), EASYSIMD_FLOAT64_C(  -417.27),
      EASYSIMD_FLOAT64_C(   878.27), EASYSIMD_FLOAT64_C(   152.66), EASYSIMD_FLOAT64_C(  -137.83), EASYSIMD_FLOAT64_C(   508.09),
      EASYSIMD_FLOAT64_C(   843.90), EASYSIMD_FLOAT64_C(  -862.34), EASYSIMD_FLOAT64_C(  -216.52), EASYSIMD_FLOAT64_C(  -936.90),
      EASYSIMD_FLOAT64_C(   716.60), EASYSIMD_FLOAT64_C(   536.70), EASYSIMD_FLOAT64_C(  -629.84), EASYSIMD_FLOAT64_C(  -230.71),
      EASYSIMD_FLOAT64_C(   105.04), EASYSIMD_FLOAT64_C(  -314.80), EASYSIMD_FLOAT64_C(  -460.11), EASYSIMD_FLOAT64_C(   676.43),
      EASYSIMD_FLOAT64_C(   842.00), EASYSIMD_FLOAT64_C(   126.85), EASYSIMD_FLOAT64_C(  -830.72), EASYSIMD_FLOAT64_C(  -786.23),
      EASYSIMD_FLOAT64_C(   766.65), EASYSIMD_FLOAT64_C(  -598.18), EASYSIMD_FLOAT64_C(  -201.10), EASYSIMD_FLOAT64_C(   846.44),
      EASYSIMD_FLOAT64_C(  -452.22), EASYSIMD_FLOAT64_C(   720.15), EASYSIMD_FLOAT64_C(   818.10), EASYSIMD_FLOAT64_C(   -91.45),
      EASYSIMD_FLOAT64_C(  -457.53), EASYSIMD_FLOAT64_C(   594.43), EASYSIMD_FLOAT64_C(   491.28), EASYSIMD_FLOAT64_C(  -579.27),
      EASYSIMD_FLOAT64_C(  -252.92), EASYSIMD_FLOAT64_C(  -646.55), EASYSIMD_FLOAT64_C(   928.83), EASYSIMD_FLOAT64_C(  -409.02),
      EASYSIMD_FLOAT64_C(  -508.89), EASYSIMD_FLOAT64_C(  -287.69), EASYSIMD_FLOAT64_C(  -345.92), EASYSIMD_FLOAT64_C(  -792.28),
      EASYSIMD_FLOAT64_C(  -750.99), EASYSIMD_FLOAT64_C(    24.25), EASYSIMD_FLOAT64_C(   -22.99), EASYSIMD_FLOAT64_C(   354.05),
      EASYSIMD_FLOAT64_C(   709.44), EASYSIMD_FLOAT64_C(   516.90) };
  static const easysimd_float64 e[] =
    { EASYSIMD_FLOAT64_C(   503.34), EASYSIMD_FLOAT64_C(  -426.13), EASYSIMD_FLOAT64_C(   314.92), EASYSIMD_FLOAT64_C(  -271.13),
      EASYSIMD_FLOAT64_C(   286.21), EASYSIMD_FLOAT64_C(   527.96), EASYSIMD_FLOAT64_C(   901.45), EASYSIMD_FLOAT64_C(   477.84),
      EASYSIMD_FLOAT64_C(  -912.14), EASYSIMD_FLOAT64_C(   473.75), EASYSIMD_FLOAT64_C(   805.82), EASYSIMD_FLOAT64_C(   830.06),
      EASYSIMD_FLOAT64_C(  -282.09), EASYSIMD_FLOAT64_C(     3.06), EASYSIMD_FLOAT64_C(   681.18), EASYSIMD_FLOAT64_C(  -183.64),
      EASYSIMD_FLOAT64_C(   921.45), EASYSIMD_FLOAT64_C(   823.73), EASYSIMD_FLOAT64_C(  -614.64), EASYSIMD_FLOAT64_C(   739.69),
      EASYSIMD_FLOAT64_C(   107.84), EASYSIMD_FLOAT64_C(   439.99), EASYSIMD_FLOAT64_C(   494.09), EASYSIMD_FLOAT64_C(  -663.87),
      EASYSIMD_FLOAT64_C(    13.34), EASYSIMD_FLOAT64_C(  -789.04), EASYSIMD_FLOAT64_C(   345.69), EASYSIMD_FLOAT64_C(   804.67),
      EASYSIMD_FLOAT64_C(  -778.05), EASYSIMD_FLOAT64_C(    55.96), EASYSIMD_FLOAT64_C(   376.33), EASYSIMD_FLOAT64_C(  -720.56),
      EASYSIMD_FLOAT64_C(   629.82), EASYSIMD_FLOAT64_C(    85.76), EASYSIMD_FLOAT64_C(    12.63), EASYSIMD_FLOAT64_C(   275.39),
      EASYSIMD_FLOAT64_C(  -500.78), EASYSIMD_FLOAT64_C(   578.94), EASYSIMD_FLOAT64_C(   772.21), EASYSIMD_FLOAT64_C(  -682.24),
      EASYSIMD_FLOAT64_C(  -603.81), EASYSIMD_FLOAT64_C(   568.33), EASYSIMD_FLOAT64_C(  -852.18), EASYSIMD_FLOAT64_C(  -802.08),
      EASYSIMD_FLOAT64_C(  -428.60), EASYSIMD_FLOAT64_C(   829.00), EASYSIMD_FLOAT64_C(  -413.04), EASYSIMD_FLOAT64_C(  -507.15),
      EASYSIMD_FLOAT64_C(  -628.23), EASYSIMD_FLOAT64_C(  -530.22), EASYSIMD_FLOAT64_C(  -631.18), EASYSIMD_FLOAT64_C(  -414.87),
      EASYSIMD_FLOAT64_C(  -653.13), EASYSIMD_FLOAT64_C(  -854.05), EASYSIMD_FLOAT64_C(   -78.74), EASYSIMD_FLOAT64_C(   971.66),
      EASYSIMD_FLOAT64_C(  -639.22), EASYSIMD_FLOAT64_C(  -177.69), EASYSIMD_FLOAT64_C(   -86.32), EASYSIMD_FLOAT64_C(  -417.27),
      EASYSIMD_FLOAT64_C(   878.27), EASYSIMD_FLOAT64_C(   152.66), EASYSIMD_FLOAT64_C(   138.03), EASYSIMD_FLOAT64_C(   508.09),
      EASYSIMD_FLOAT64_C(   843.90), EASYSIMD_FLOAT64_C(  -849.34), EASYSIMD_FLOAT64_C(  -644.52), EASYSIMD_FLOAT64_C(   124.39),
      EASYSIMD_FLOAT64_C(    64.74), EASYSIMD_FLOAT64_C(   536.70), EASYSIMD_FLOAT64_C(  -629.84), EASYSIMD_FLOAT64_C(  -230.71),
      EASYSIMD_FLOAT64_C(   705.72), EASYSIMD_FLOAT64_C(   589.97), EASYSIMD_FLOAT64_C(   658.85), EASYSIMD_FLOAT64_C(  -949.64),
      EASYSIMD_FLOAT64_C(   842.00), EASYSIMD_FLOAT64_C(   743.26), EASYSIMD_FLOAT64_C(  -830.72), EASYSIMD_FLOAT64_C(    71.70),
      EASYSIMD_FLOAT64_C(  -786.96), EASYSIMD_FLOAT64_C(  -598.18), EASYSIMD_FLOAT64_C(  -201.10), EASYSIMD_FLOAT64_C(  -440.09),
      EASYSIMD_FLOAT64_C(  -452.22), EASYSIMD_FLOAT64_C(   720.15), EASYSIMD_FLOAT64_C(   818.10), EASYSIMD_FLOAT64_C(   -91.45),
      EASYSIMD_FLOAT64_C(  -457.53), EASYSIMD_FLOAT64_C(   594.43), EASYSIMD_FLOAT64_C(   491.28), EASYSIMD_FLOAT64_C(  -579.27),
      EASYSIMD_FLOAT64_C(  -252.92), EASYSIMD_FLOAT64_C(  -646.55), EASYSIMD_FLOAT64_C(   928.83), EASYSIMD_FLOAT64_C(    -1.62),
      EASYSIMD_FLOAT64_C(  -508.89), EASYSIMD_FLOAT64_C(  -287.69), EASYSIMD_FLOAT64_C(  -345.92), EASYSIMD_FLOAT64_C(  -548.12),
      EASYSIMD_FLOAT64_C(  -750.99), EASYSIMD_FLOAT64_C(    24.25), EASYSIMD_FLOAT64_C(   -22.99), EASYSIMD_FLOAT64_C(  -992.87),
      EASYSIMD_FLOAT64_C(   154.90), EASYSIMD_FLOAT64_C(   571.65) };
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b64(), pg)) {
    ...
    pv = easysimd_svcmplt_s64(pg, easysimd_svld1_s64(pg, &(p[i])), easysimd_svdup_n_s64(INT64_C(0)));
    rv = easysimd_svsel_f64(pv, av, bv);
  ...
  while (easysimd_svptest_first(easysimd_svptrue_b64(), pg)) {
    ...
    ev = easysimd_svsel_f64(pv, av, bv);
...
EASYSIMD_TEST_FUNC_LIST_ENTRY(x_svsel_s8_z)
EASYSIMD_TEST_FUNC_LIST_ENTRY(svsel_s8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(x_svsel_s16_z)
EASYSIMD_TEST_FUNC_LIST_ENTRY(svsel_s16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(x_svsel_s32_z)
EASYSIMD_TEST_FUNC_LIST_ENTRY(svsel_s32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(x_svsel_s64_z)
EASYSIMD_TEST_FUNC_LIST_ENTRY(svsel_s64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(x_svsel_u8_z)
EASYSIMD_TEST_FUNC_LIST_ENTRY(svsel_u8)
EASYSIMD_TEST_FUNC_LIST_ENTRY(x_svsel_u16_z)
EASYSIMD_TEST_FUNC_LIST_ENTRY(svsel_u16)
EASYSIMD_TEST_FUNC_LIST_ENTRY(x_svsel_u32_z)
EASYSIMD_TEST_FUNC_LIST_ENTRY(svsel_u32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(x_svsel_u64_z)
EASYSIMD_TEST_FUNC_LIST_ENTRY(svsel_u64)
EASYSIMD_TEST_FUNC_LIST_ENTRY(x_svsel_f32_z)
EASYSIMD_TEST_FUNC_LIST_ENTRY(svsel_f32)
EASYSIMD_TEST_FUNC_LIST_ENTRY(x_svsel_f64_z)
EASYSIMD_TEST_FUNC_LIST_ENTRY(svsel_f64)
