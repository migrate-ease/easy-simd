#define EASYSIMD_TEST_X86_AVX512_INSN 4dpwssd

#include <test/x86/avx512/test-avx512.h>
#include <easysimd/x86/avx512/4dpwssd.h>

static int
test_easysimd_mm512_4dpwssd_epi32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd__m512i a0 = easysimd_mm512_loadu_epi32(test_vec[i].a0);
    easysimd__m512i a1 = easysimd_mm512_loadu_epi32(test_vec[i].a1);
    easysimd__m512i a2 = easysimd_mm512_loadu_epi32(test_vec[i].a2);
    easysimd__m512i a3 = easysimd_mm512_loadu_epi32(test_vec[i].a3);
    easysimd__m128i b = easysimd_x_mm_loadu_epi32(test_vec[i].b);
    easysimd__m512i r = easysimd_mm512_4dpwssd_epi32(src, a0, a1, a2, a3, &b);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd__m512i a0 = easysimd_test_x86_random_i32x16();
    easysimd__m512i a1 = easysimd_test_x86_random_i32x16();
    easysimd__m512i a2 = easysimd_test_x86_random_i32x16();
    easysimd__m512i a3 = easysimd_test_x86_random_i32x16();
    easysimd__m128i b = easysimd_test_x86_random_i32x4();
    easysimd__m512i r = easysimd_mm512_4dpwssd_epi32(src, a0, a1, a2, a3, &b);

    easysimd_test_x86_write_i32x16(2, src, EASYSIMD_TEST_VEC_POS_FIRST);
    easysimd_test_x86_write_i32x16(2, a0, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_x86_write_i32x16(2, a1, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_x86_write_i32x16(2, a2, EASYSIMD_TEST_VEC_POS_MIDDLE);
    easysimd_test_x86_write_i32x16(2, a3, EASYSIMD_TEST_VEC_POS_MIDDLE);
...
static int
test_easysimd_mm512_mask_4dpwssd_epi32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    const int32_t src[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd__m512i a3 = easysimd_mm512_loadu_epi32(test_vec[i].a3);
    easysimd__m128i b = easysimd_x_mm_loadu_epi32(test_vec[i].b);
    easysimd__m512i r = easysimd_mm512_mask_4dpwssd_epi32(src, test_vec[i].k, a0, a1, a2, a3, &b);
    easysimd_test_x86_assert_equal_i32x16(r, easysimd_mm512_loadu_epi32(test_vec[i].r));
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd__m512i a3 = easysimd_test_x86_random_i32x16();
    easysimd__m128i b = easysimd_test_x86_random_i32x4();
    easysimd__m512i r = easysimd_mm512_mask_4dpwssd_epi32(src, k, a0, a1, a2, a3, &b);
...
static int
test_easysimd_mm512_maskz_4dpwssd_epi32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    const easysimd__mmask16 k;
    const int32_t src[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd__m512i a3 = easysimd_mm512_loadu_epi32(test_vec[i].a3);
    easysimd__m128i b = easysimd_x_mm_loadu_epi32(test_vec[i].b);
    easysimd__m512i r = easysimd_mm512_maskz_4dpwssd_epi32(test_vec[i].k, src, a0, a1, a2, a3, &b);
    easysimd_test_x86_assert_equal_i32x16(r, easysimd_mm512_loadu_epi32(test_vec[i].r));
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd__m512i a3 = easysimd_test_x86_random_i32x16();
    easysimd__m128i b = easysimd_test_x86_random_i32x4();
    easysimd__m512i r = easysimd_mm512_maskz_4dpwssd_epi32(k, src, a0, a1, a2, a3, &b);
...
test_easysimd_mm_dbsad_epu8(EASYSIMD_MUNIT_TEST_ARGS) {
  ...
  static const struct {
    ...
    { { UINT8_C(221), UINT8_C(  6), UINT8_C(172), UINT8_C(192), UINT8_C( 34), UINT8_C(161), UINT8_C(  1), UINT8_C( 71),
        UINT8_C(191), UINT8_C(111), UINT8_C( 84), UINT8_C(230), UINT8_C( 14), UINT8_C(250), UINT8_C( 86), UINT8_C(  6) },
      { UINT8_C(130), UINT8_C( 12), UINT8_C(120), UINT8_C( 34), UINT8_C( 88), UINT8_C(248), UINT8_C( 29), UINT8_C( 27),
        UINT8_C(134), UINT8_C( 80), UINT8_C(158), UINT8_C(100), UINT8_C(177), UINT8_C(198), UINT8_C(236), UINT8_C(142) },
      UINT32_C(        12),
      { UINT16_C(  307), UINT16_C(  476), UINT16_C(  516), UINT16_C(  378), UINT16_C(  392), UINT16_C(  338), UINT16_C(  372), UINT16_C(  328) } },
    { { UINT8_C( 57), UINT8_C( 80), UINT8_C( 53), UINT8_C(249), UINT8_C(192), UINT8_C(137), UINT8_C(223), UINT8_C(206),
        UINT8_C(132), UINT8_C( 53), UINT8_C(212), UINT8_C(  6), UINT8_C( 65), UINT8_C( 76), UINT8_C( 40), UINT8_C(154) },
      { UINT8_C( 69), UINT8_C( 69), UINT8_C(181), UINT8_C(203), UINT8_C(149), UINT8_C( 83), UINT8_C( 47), UINT8_C( 71),
        UINT8_C( 25), UINT8_C( 27), UINT8_C(213), UINT8_C(229), UINT8_C(180), UINT8_C( 36), UINT8_C(211), UINT8_C(237) },
      UINT32_C(        53),
      { UINT16_C(  279), UINT16_C(  177), UINT16_C(  408), UINT16_C(  432), UINT16_C(  297), UINT16_C(  342), UINT16_C(  421), UINT16_C(  235) } },
    { { UINT8_C(146), UINT8_C(197), UINT8_C(  3), UINT8_C( 22), UINT8_C(251), UINT8_C(216), UINT8_C( 29), UINT8_C( 60),
        UINT8_C( 36), UINT8_C( 69), UINT8_C(214), UINT8_C(105), UINT8_C(139), UINT8_C(139), UINT8_C( 52), UINT8_C( 32) },
      { UINT8_C(223), UINT8_C( 99), UINT8_C(103), UINT8_C(248), UINT8_C(127), UINT8_C( 61), UINT8_C(222), UINT8_C( 51),
        UINT8_C( 97), UINT8_C(177), UINT8_C( 32), UINT8_C(214), UINT8_C(186), UINT8_C(  7), UINT8_C( 11), UINT8_C( 77) },
      UINT32_C(        12),
      { UINT16_C(  501), UINT16_C(  550), UINT16_C(  390), UINT16_C(  104), UINT16_C(  471), UINT16_C(  249), UINT16_C(  383), UINT16_C(  311) } },
    { { UINT8_C(231), UINT8_C(128), UINT8_C(  4), UINT8_C( 11), UINT8_C(198), UINT8_C(218), UINT8_C(117), UINT8_C( 81),
        UINT8_C(102), UINT8_C(169), UINT8_C(113), UINT8_C( 69), UINT8_C( 13), UINT8_C(217), UINT8_C( 61), UINT8_C(140) },
      { UINT8_C( 22), UINT8_C( 27), UINT8_C(191), UINT8_C(119), UINT8_C(205), UINT8_C(223), UINT8_C( 78), UINT8_C(135),
        UINT8_C(230), UINT8_C( 89), UINT8_C(212), UINT8_C(179), UINT8_C(104), UINT8_C( 56), UINT8_C(122), UINT8_C( 79) },
      UINT32_C(        56),
      { UINT16_C(  605), UINT16_C(  601), UINT16_C(  227), UINT16_C(  250), UINT16_C(  134), UINT16_C(  174), UINT16_C(  399), UINT16_C(  346) } },
    { { UINT8_C( 89), UINT8_C(208), UINT8_C(207), UINT8_C(191), UINT8_C(121), UINT8_C( 65), UINT8_C(  4), UINT8_C(134),
        UINT8_C( 26), UINT8_C( 65), UINT8_C( 18), UINT8_C( 48), UINT8_C( 93), UINT8_C(209), UINT8_C(167), UINT8_C( 42) },
      { UINT8_C(177), UINT8_C(245), UINT8_C(177), UINT8_C(151), UINT8_C( 79), UINT8_C(134), UINT8_C( 74), UINT8_C(183),
        UINT8_C(190), UINT8_C(197), UINT8_C(  7), UINT8_C(118), UINT8_C( 67), UINT8_C( 98), UINT8_C(245), UINT8_C(156) },
      UINT32_C(        50),
      { UINT16_C(  385), UINT16_C(  412), UINT16_C(  451), UINT16_C(  399), UINT16_C(  409), UINT16_C(  519), UINT16_C(  418), UINT16_C(  308) } },
    { { UINT8_C(  5), UINT8_C( 95), UINT8_C( 50), UINT8_C( 31), UINT8_C(161), UINT8_C( 68), UINT8_C( 79), UINT8_C(254),
        UINT8_C( 22), UINT8_C(247), UINT8_C( 40), UINT8_C(199), UINT8_C(236), UINT8_C(217), UINT8_C( 94), UINT8_C( 59) },
      { UINT8_C( 95), UINT8_C(169), UINT8_C(243), UINT8_C( 29), UINT8_C(110), UINT8_C(250), UINT8_C(148), UINT8_C(177),
        UINT8_C( 92), UINT8_C(137), UINT8_C( 78), UINT8_C(142), UINT8_C( 77), UINT8_C(169), UINT8_C( 57), UINT8_C( 83) },
      UINT32_C(         9),
      { UINT16_C(  504), UINT16_C(  486), UINT16_C(  252), UINT16_C(  274), UINT16_C(  524), UINT16_C(  266), UINT16_C(  306), UINT16_C(  588) } },
    { { UINT8_C(176), UINT8_C(194), UINT8_C(168), UINT8_C(198), UINT8_C(185), UINT8_C(208), UINT8_C(141), UINT8_C(165),
        UINT8_C(169), UINT8_C(235), UINT8_C(225), UINT8_C(  9), UINT8_C(148), UINT8_C(212), UINT8_C( 38), UINT8_C(  2) },
      { UINT8_C(206), UINT8_C(186), UINT8_C(180), UINT8_C( 42), UINT8_C( 67), UINT8_C(  2), UINT8_C(184), UINT8_C(145),
        UINT8_C(171), UINT8_C(241), UINT8_C(228), UINT8_C(180), UINT8_C( 93), UINT8_C( 86), UINT8_C( 94), UINT8_C( 13) },
      UINT32_C(        24),
      { UINT16_C(  206), UINT16_C(  177), UINT16_C(  277), UINT16_C(  343), UINT16_C(  512), UINT16_C(  495), UINT16_C(  455), UINT16_C(  335) } },
    { { UINT8_C(214), UINT8_C( 96), UINT8_C(119), UINT8_C(128), UINT8_C( 75), UINT8_C( 88), UINT8_C(137), UINT8_C(224),
        UINT8_C( 44), UINT8_C(175), UINT8_C(226), UINT8_C(250), UINT8_C(106), UINT8_C(150), UINT8_C( 36), UINT8_C(173) },
      { UINT8_C(152), UINT8_C(220), UINT8_C( 62), UINT8_C( 68), UINT8_C(205), UINT8_C( 34), UINT8_C(248), UINT8_C( 42),
        UINT8_C(121), UINT8_C( 87), UINT8_C( 55), UINT8_C(145), UINT8_C( 93), UINT8_C( 10), UINT8_C( 99), UINT8_C( 52) },
      UINT32_C(        42),
      { UINT16_C(  183), UINT16_C(  201), UINT16_C(  230), UINT16_C(  322), UINT16_C(  441), UINT16_C(  342), UINT16_C(  219), UINT16_C(  336) } },
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    int32_t imm8 = (int32_t)test_vec[i].imm8;
    easysimd__m128i r;
    EASYSIMD_TEST_PERF_WITH_LOOP_START(100000) {
      EASYSIMD_CONSTIFY_64_(easysimd_mm_dbsad_epu8, r, easysimd_mm_setzero_si128(), imm8, a, b);
    } EASYSIMD_TEST_PERF_END("easysimd_mm_dbsad_epu8");
    easysimd_test_x86_assert_equal_u16x8(r, easysimd_mm_loadu_si128(test_vec[i].r));
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    uint32_t imm8 = easysimd_test_codegen_random_u32() & 0x3F;
    easysimd__m128i r;
    EASYSIMD_CONSTIFY_64_(easysimd_mm_dbsad_epu8, r, easysimd_mm_setzero_si128(), imm8, a, b);
    ...
    easysimd_test_x86_write_mmask32(2, imm8, EASYSIMD_TEST_VEC_POS_MIDDLE);
...
test_easysimd_mm256_dbsad_epu8(EASYSIMD_MUNIT_TEST_ARGS) {
  ...
  static const struct {
    ...
    { { UINT8_C(207), UINT8_C( 97), UINT8_C(244), UINT8_C( 46), UINT8_C(151), UINT8_C(169), UINT8_C(106), UINT8_C( 34),
        UINT8_C(214), UINT8_C(225), UINT8_C(141), UINT8_C( 87), UINT8_C(238), UINT8_C(196), UINT8_C( 42), UINT8_C(220),
        UINT8_C(209), UINT8_C(248), UINT8_C(210), UINT8_C( 92), UINT8_C( 17), UINT8_C( 55), UINT8_C( 86), UINT8_C(152),
        UINT8_C(139), UINT8_C(159), UINT8_C(203), UINT8_C(107), UINT8_C( 81), UINT8_C(245), UINT8_C( 78), UINT8_C( 32) },
      { UINT8_C( 86), UINT8_C( 66), UINT8_C( 78), UINT8_C(237), UINT8_C(235), UINT8_C(185), UINT8_C( 16), UINT8_C(194),
        UINT8_C(154), UINT8_C(157), UINT8_C( 25), UINT8_C(136), UINT8_C( 97), UINT8_C( 67), UINT8_C(100), UINT8_C( 50),
        UINT8_C( 60), UINT8_C( 54), UINT8_C(142), UINT8_C( 77), UINT8_C(110), UINT8_C(228), UINT8_C(229), UINT8_C(249),
        UINT8_C(132), UINT8_C(176), UINT8_C(101), UINT8_C(213), UINT8_C(165), UINT8_C(179), UINT8_C(246), UINT8_C(251) },
      UINT32_C(        53),
      { UINT16_C(  492), UINT16_C(  342), UINT16_C(  440), UINT16_C(  206), UINT16_C(  353), UINT16_C(  364), UINT16_C(  482), UINT16_C(  464),
        UINT16_C(  295), UINT16_C(   95), UINT16_C(  506), UINT16_C(  506), UINT16_C(  233), UINT16_C(  222), UINT16_C(  211), UINT16_C(  489) } },
    { { UINT8_C(253), UINT8_C(249), UINT8_C(163), UINT8_C(151), UINT8_C(150), UINT8_C(188), UINT8_C( 31), UINT8_C(247),
        UINT8_C(  0), UINT8_C(131), UINT8_C( 41), UINT8_C( 60), UINT8_C(186), UINT8_C(183), UINT8_C(137), UINT8_C( 40),
        UINT8_C(155), UINT8_C(111), UINT8_C( 33), UINT8_C( 31), UINT8_C( 31), UINT8_C(134), UINT8_C(245), UINT8_C(197),
        UINT8_C( 57), UINT8_C(235), UINT8_C(192), UINT8_C( 47), UINT8_C( 47), UINT8_C(169), UINT8_C( 16), UINT8_C( 45) },
      { UINT8_C(162), UINT8_C(179), UINT8_C(196), UINT8_C( 56), UINT8_C(111), UINT8_C(228), UINT8_C( 47), UINT8_C(111),
        UINT8_C(103), UINT8_C( 88), UINT8_C(171), UINT8_C( 33), UINT8_C( 15), UINT8_C( 53), UINT8_C( 73), UINT8_C(171),
        UINT8_C(164), UINT8_C(107), UINT8_C(202), UINT8_C(195), UINT8_C(241), UINT8_C(191), UINT8_C(136), UINT8_C( 43),
        UINT8_C(170), UINT8_C( 73), UINT8_C( 90), UINT8_C(218), UINT8_C(242), UINT8_C(106), UINT8_C(  7), UINT8_C(149) },
      UINT32_C(        29),
      { UINT16_C(  319), UINT16_C(  415), UINT16_C(  390), UINT16_C(  408), UINT16_C(  265), UINT16_C(  484), UINT16_C(  375), UINT16_C(  294),
        UINT16_C(  281), UINT16_C(  282), UINT16_C(  290), UINT16_C(  449), UINT16_C(  288), UINT16_C(  499), UINT16_C(  425), UINT16_C(  257) } },
    { { UINT8_C(175), UINT8_C(253), UINT8_C(252), UINT8_C( 23), UINT8_C( 85), UINT8_C(167), UINT8_C( 56), UINT8_C(101),
        UINT8_C(220), UINT8_C(130), UINT8_C( 16), UINT8_C(128), UINT8_C(237), UINT8_C(218), UINT8_C( 68), UINT8_C(222),
        UINT8_C(154), UINT8_C(204), UINT8_C(  9), UINT8_C( 68), UINT8_C( 21), UINT8_C( 99), UINT8_C( 30), UINT8_C(  8),
        UINT8_C(205), UINT8_C( 37), UINT8_C(157), UINT8_C(234), UINT8_C(241), UINT8_C(106), UINT8_C(119), UINT8_C(160) },
      { UINT8_C(103), UINT8_C(115), UINT8_C(183), UINT8_C(189), UINT8_C( 26), UINT8_C(240), UINT8_C( 34), UINT8_C(247),
        UINT8_C(114), UINT8_C( 50), UINT8_C(119), UINT8_C( 95), UINT8_C( 12), UINT8_C(187), UINT8_C( 61), UINT8_C(166),
        UINT8_C(136), UINT8_C( 71), UINT8_C(235), UINT8_C(157), UINT8_C(170), UINT8_C(  9), UINT8_C(165), UINT8_C(120),
        UINT8_C( 47), UINT8_C( 66), UINT8_C( 98), UINT8_C( 32), UINT8_C(173), UINT8_C(217), UINT8_C(192), UINT8_C( 20) },
      UINT32_C(        12),
      { UINT16_C(  445), UINT16_C(  204), UINT16_C(  250), UINT16_C(  430), UINT16_C(  360), UINT16_C(  356), UINT16_C(  225), UINT16_C(  249),
        UINT16_C(  466), UINT16_C(  367), UINT16_C(  624), UINT16_C(  581), UINT16_C(  258), UINT16_C(  430), UINT16_C(  163), UINT16_C(  237) } },
    { { UINT8_C(104), UINT8_C(243), UINT8_C( 94), UINT8_C(218), UINT8_C( 37), UINT8_C(213), UINT8_C( 57), UINT8_C( 50),
        UINT8_C(145), UINT8_C(118), UINT8_C(216), UINT8_C( 25), UINT8_C(189), UINT8_C(195), UINT8_C(182), UINT8_C(104),
        UINT8_C(205), UINT8_C( 92), UINT8_C(224), UINT8_C(252), UINT8_C(158), UINT8_C( 66), UINT8_C( 28), UINT8_C( 75),
        UINT8_C( 28), UINT8_C(220), UINT8_C( 96), UINT8_C(104), UINT8_C( 84), UINT8_C( 49), UINT8_C(207), UINT8_C(188) },
      { UINT8_C( 37), UINT8_C( 45), UINT8_C(150), UINT8_C( 74), UINT8_C(  3), UINT8_C(207), UINT8_C(124), UINT8_C(148),
        UINT8_C( 70), UINT8_C( 85), UINT8_C(173), UINT8_C(  3), UINT8_C( 24), UINT8_C( 99), UINT8_C(107), UINT8_C(229),
        UINT8_C(191), UINT8_C( 75), UINT8_C(225), UINT8_C( 94), UINT8_C(142), UINT8_C(253), UINT8_C(169), UINT8_C(170),
        UINT8_C(218), UINT8_C(  9), UINT8_C( 18), UINT8_C( 46), UINT8_C( 59), UINT8_C(226), UINT8_C(235), UINT8_C( 96) },
      UINT32_C(        15),
      { UINT16_C(  248), UINT16_C(  470), UINT16_C(  168), UINT16_C(  480), UINT16_C(  296), UINT16_C(  286), UINT16_C(  364), UINT16_C(  456),
        UINT16_C(  447), UINT16_C(  485), UINT16_C(  289), UINT16_C(  427), UINT16_C(  447), UINT16_C(  141), UINT16_C(  315), UINT16_C(  321) } },
    { { UINT8_C( 81), UINT8_C( 39), UINT8_C(166), UINT8_C(151), UINT8_C(124), UINT8_C( 83), UINT8_C(154), UINT8_C(148),
        UINT8_C(183), UINT8_C(  6), UINT8_C(122), UINT8_C(118), UINT8_C( 81), UINT8_C( 91), UINT8_C(212), UINT8_C(223),
        UINT8_C( 89), UINT8_C(126), UINT8_C(137), UINT8_C( 51), UINT8_C(135), UINT8_C(156), UINT8_C( 97), UINT8_C(194),
        UINT8_C(126), UINT8_C( 76), UINT8_C( 34), UINT8_C(141), UINT8_C(206), UINT8_C(205), UINT8_C(160), UINT8_C( 31) },
      { UINT8_C(244), UINT8_C( 70), UINT8_C(182), UINT8_C(112), UINT8_C(154), UINT8_C( 80), UINT8_C(  4), UINT8_C( 81),
        UINT8_C( 86), UINT8_C(126), UINT8_C(199), UINT8_C(168), UINT8_C(218), UINT8_C(156), UINT8_C(135), UINT8_C( 51),
        UINT8_C( 26), UINT8_C( 17), UINT8_C(102), UINT8_C(161), UINT8_C(173), UINT8_C(199), UINT8_C(100), UINT8_C( 43),
        UINT8_C( 20), UINT8_C(134), UINT8_C(184), UINT8_C(226), UINT8_C( 83), UINT8_C( 88), UINT8_C(  1), UINT8_C( 71) },
      UINT32_C(        31),
      { UINT16_C(  385), UINT16_C(  353), UINT16_C(  115), UINT16_C(  223), UINT16_C(  258), UINT16_C(  272), UINT16_C(  272), UINT16_C(  336),
        UINT16_C(  200), UINT16_C(  224), UINT16_C(  339), UINT16_C(  339), UINT16_C(  334), UINT16_C(  221), UINT16_C(  416), UINT16_C(  556) } },
    { { UINT8_C(  7), UINT8_C(188), UINT8_C(138), UINT8_C( 94), UINT8_C( 58), UINT8_C( 81), UINT8_C(  6), UINT8_C( 20),
        UINT8_C(237), UINT8_C(141), UINT8_C( 71), UINT8_C(  7), UINT8_C(158), UINT8_C(173), UINT8_C(169), UINT8_C( 75),
        UINT8_C(117), UINT8_C( 13), UINT8_C(118), UINT8_C(137), UINT8_C(147), UINT8_C( 47), UINT8_C(107), UINT8_C(231),
        UINT8_C(135), UINT8_C(108), UINT8_C( 46), UINT8_C( 38), UINT8_C( 35), UINT8_C(230), UINT8_C( 95), UINT8_C( 42) },
      { UINT8_C(162), UINT8_C(233), UINT8_C(136), UINT8_C(220), UINT8_C( 59), UINT8_C(142), UINT8_C(241), UINT8_C( 40),
        UINT8_C( 28), UINT8_C( 56), UINT8_C( 48), UINT8_C(186), UINT8_C(230), UINT8_C(217), UINT8_C(  6), UINT8_C( 91),
        UINT8_C(230), UINT8_C(124), UINT8_C(228), UINT8_C(121), UINT8_C(171), UINT8_C( 79), UINT8_C( 96), UINT8_C( 51),
        UINT8_C(187), UINT8_C(143), UINT8_C( 89), UINT8_C(222), UINT8_C(117), UINT8_C(185), UINT8_C(  8), UINT8_C( 23) },
      UINT32_C(        34),
      { UINT16_C(  335), UINT16_C(  305), UINT16_C(  484), UINT16_C(  552), UINT16_C(  496), UINT16_C(  544), UINT16_C(  288), UINT16_C(  164),
        UINT16_C(  314), UINT16_C(  299), UINT16_C(  463), UINT16_C(  278), UINT16_C(  314), UINT16_C(  395), UINT16_C(  279), UINT16_C(  402) } },
    { { UINT8_C( 31), UINT8_C(228), UINT8_C(  6), UINT8_C( 59), UINT8_C( 29), UINT8_C( 54), UINT8_C(246), UINT8_C(  3),
        UINT8_C( 15), UINT8_C(252), UINT8_C( 94), UINT8_C(245), UINT8_C(120), UINT8_C( 66), UINT8_C(110), UINT8_C( 36),
        UINT8_C(145), UINT8_C(207), UINT8_C( 87), UINT8_C( 76), UINT8_C( 94), UINT8_C(176), UINT8_C( 42), UINT8_C(211),
        UINT8_C(105), UINT8_C( 50), UINT8_C(234), UINT8_C( 12), UINT8_C(195), UINT8_C(221), UINT8_C(233), UINT8_C(227) },
      { UINT8_C(194), UINT8_C(239), UINT8_C( 30), UINT8_C(223), UINT8_C( 37), UINT8_C( 20), UINT8_C(226), UINT8_C( 52),
        UINT8_C( 16), UINT8_C( 64), UINT8_C( 41), UINT8_C(137), UINT8_C(130), UINT8_C(152), UINT8_C(173), UINT8_C( 19),
        UINT8_C(103), UINT8_C(  4), UINT8_C( 95), UINT8_C(197), UINT8_C(180), UINT8_C(137), UINT8_C(152), UINT8_C( 30),
        UINT8_C(187), UINT8_C(130), UINT8_C( 42), UINT8_C(127), UINT8_C( 95), UINT8_C( 19), UINT8_C( 98), UINT8_C( 33) },
      UINT32_C(         3),
      { UINT16_C(  382), UINT16_C(  324), UINT16_C(  467), UINT16_C(  184), UINT16_C(  278), UINT16_C(  626), UINT16_C(  534), UINT16_C(  366),
        UINT16_C(  292), UINT16_C(  316), UINT16_C(  415), UINT16_C(  288), UINT16_C(  372), UINT16_C(  274), UINT16_C(  477), UINT16_C(  481) } },
    { { UINT8_C(149), UINT8_C(226), UINT8_C( 93), UINT8_C(165), UINT8_C( 34), UINT8_C(134), UINT8_C( 46), UINT8_C(164),
        UINT8_C( 30), UINT8_C(219), UINT8_C(183), UINT8_C(133), UINT8_C(223), UINT8_C( 22), UINT8_C( 74), UINT8_C(148),
        UINT8_C(159), UINT8_C(226), UINT8_C(178), UINT8_C( 91), UINT8_C(100), UINT8_C(220), UINT8_C(218), UINT8_C(196),
        UINT8_C(239), UINT8_C( 60), UINT8_C(229), UINT8_C(242), UINT8_C(188), UINT8_C(230), UINT8_C( 27), UINT8_C( 81) },
      { UINT8_C(200), UINT8_C(120), UINT8_C(247), UINT8_C(235), UINT8_C(254), UINT8_C( 37), UINT8_C(143), UINT8_C( 29),
        UINT8_C(  1), UINT8_C( 71), UINT8_C(162), UINT8_C(224), UINT8_C( 93), UINT8_C(237), UINT8_C(116), UINT8_C(253),
        UINT8_C(207), UINT8_C( 38), UINT8_C( 88), UINT8_C( 52), UINT8_C(  2), UINT8_C( 50), UINT8_C(248), UINT8_C(242),
        UINT8_C(110), UINT8_C(221), UINT8_C(228), UINT8_C( 42), UINT8_C(195),    UINT8_MAX, UINT8_C(124), UINT8_C(140) },
      UINT32_C(        55),
      { UINT16_C(  178), UINT16_C(  447), UINT16_C(  536), UINT16_C(  369), UINT16_C(  268), UINT16_C(  447), UINT16_C(  492), UINT16_C(  353),
        UINT16_C(  168), UINT16_C(  325), UINT16_C(  466), UINT16_C(  478), UINT16_C(  446), UINT16_C(  204), UINT16_C(  377), UINT16_C(   89) } },
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd__m256i r;
    EASYSIMD_TEST_PERF_WITH_LOOP_START(100000) {
      EASYSIMD_CONSTIFY_64_(easysimd_mm256_dbsad_epu8, r, easysimd_mm256_setzero_si256(), imm8, a, b);
    } EASYSIMD_TEST_PERF_END("_mm256_dbsad_epu8");
    easysimd_test_x86_assert_equal_u16x16(r, easysimd_mm256_loadu_si256(test_vec[i].r));
  }
...
test_easysimd_mm512_dbsad_epu8(EASYSIMD_MUNIT_TEST_ARGS) {
  ...
  static const struct {
    ...
    { { UINT8_C( 46), UINT8_C(143), UINT8_C(164), UINT8_C( 80), UINT8_C(221), UINT8_C(149), UINT8_C( 72), UINT8_C(250),
        UINT8_C(101), UINT8_C(132), UINT8_C( 61), UINT8_C(  5), UINT8_C(107), UINT8_C(193), UINT8_C(220), UINT8_C(163),
        UINT8_C(209), UINT8_C( 31), UINT8_C(231), UINT8_C(142), UINT8_C(112), UINT8_C(  7), UINT8_C( 92), UINT8_C(102),
        UINT8_C(173), UINT8_C(202), UINT8_C( 10), UINT8_C( 42), UINT8_C(171), UINT8_C(241), UINT8_C(  6), UINT8_C(217),
        UINT8_C(128), UINT8_C(170), UINT8_C( 41), UINT8_C( 93), UINT8_C( 64), UINT8_C(113), UINT8_C( 87), UINT8_C(165),
        UINT8_C(245), UINT8_C(148), UINT8_C(170), UINT8_C( 96), UINT8_C( 86), UINT8_C(135), UINT8_C(  4), UINT8_C( 39),
        UINT8_C(166), UINT8_C(235), UINT8_C(181), UINT8_C( 22), UINT8_C(243), UINT8_C( 17), UINT8_C(125), UINT8_C(160),
        UINT8_C(220), UINT8_C(135), UINT8_C(202), UINT8_C(135), UINT8_C(120), UINT8_C(208), UINT8_C( 97), UINT8_C(248) },
      { UINT8_C(123), UINT8_C(138), UINT8_C( 85), UINT8_C(187), UINT8_C(252), UINT8_C(172), UINT8_C( 96), UINT8_C(241),
        UINT8_C( 65), UINT8_C( 10), UINT8_C( 82), UINT8_C(151), UINT8_C(145), UINT8_C( 86), UINT8_C(190), UINT8_C( 56),
        UINT8_C( 65), UINT8_C(116), UINT8_C( 78), UINT8_C( 52), UINT8_C(133), UINT8_C(203), UINT8_C(212), UINT8_C( 97),
        UINT8_C( 82), UINT8_C(158), UINT8_C(233), UINT8_C(202), UINT8_C(111), UINT8_C( 74), UINT8_C(194), UINT8_C(234),
        UINT8_C(212), UINT8_C( 23), UINT8_C(165), UINT8_C(208), UINT8_C(196), UINT8_C(  5), UINT8_C(194), UINT8_C(  5),
        UINT8_C( 15), UINT8_C( 20), UINT8_C(156), UINT8_C(161), UINT8_C(106), UINT8_C( 90), UINT8_C(217), UINT8_C(171),
        UINT8_C(206), UINT8_C( 39), UINT8_C(224), UINT8_C( 84), UINT8_C(243), UINT8_C(180), UINT8_C(181), UINT8_C( 69),
        UINT8_C( 83), UINT8_C(158), UINT8_C( 16), UINT8_C(194), UINT8_C(232), UINT8_C(210), UINT8_C(172), UINT8_C(189) },
      UINT64_C(                  42),
      { UINT16_C(  305), UINT16_C(  125), UINT16_C(  388), UINT16_C(  384), UINT16_C(  325), UINT16_C(  349), UINT16_C(  189), UINT16_C(  274),
        UINT16_C(  316), UINT16_C(  342), UINT16_C(  382), UINT16_C(  362), UINT16_C(  518), UINT16_C(  261), UINT16_C(  261), UINT16_C(  456),
        UINT16_C(  446), UINT16_C(  320), UINT16_C(  357), UINT16_C(  271), UINT16_C(  437), UINT16_C(  358), UINT16_C(  320), UINT16_C(  297),
        UINT16_C(  497), UINT16_C(  301), UINT16_C(  448), UINT16_C(  292), UINT16_C(  405), UINT16_C(  260), UINT16_C(  436), UINT16_C(  158) } },
    { { UINT8_C( 86), UINT8_C( 79), UINT8_C(179), UINT8_C(101), UINT8_C( 99), UINT8_C( 79), UINT8_C(  6), UINT8_C(205),
        UINT8_C(169), UINT8_C(223), UINT8_C(121), UINT8_C(120), UINT8_C(  7), UINT8_C( 89), UINT8_C(204), UINT8_C(250),
        UINT8_C( 13), UINT8_C(129), UINT8_C( 63), UINT8_C( 96), UINT8_C( 32), UINT8_C( 79), UINT8_C( 34), UINT8_C(  8),
        UINT8_C( 34), UINT8_C(206), UINT8_C(197), UINT8_C( 12), UINT8_C( 31), UINT8_C( 83), UINT8_C(186), UINT8_C(117),
        UINT8_C(162), UINT8_C(109), UINT8_C(219), UINT8_C(  6), UINT8_C(188), UINT8_C(225), UINT8_C(211), UINT8_C(101),
        UINT8_C(193), UINT8_C( 76), UINT8_C(221), UINT8_C(200), UINT8_C(165), UINT8_C(169), UINT8_C(194), UINT8_C(179),
        UINT8_C( 43), UINT8_C(  1), UINT8_C( 19), UINT8_C( 75), UINT8_C( 81), UINT8_C( 54), UINT8_C( 83), UINT8_C(115),
        UINT8_C(  4), UINT8_C( 25), UINT8_C(127), UINT8_C( 36), UINT8_C(108), UINT8_C( 57), UINT8_C(153), UINT8_C( 14) },
      { UINT8_C(166), UINT8_C(116), UINT8_C( 20), UINT8_C( 98), UINT8_C( 86), UINT8_C(232), UINT8_C(199), UINT8_C( 23),
        UINT8_C( 52), UINT8_C(165), UINT8_C(223), UINT8_C(218), UINT8_C( 78), UINT8_C(161), UINT8_C(141), UINT8_C(121),
        UINT8_C(162), UINT8_C(160), UINT8_C(196), UINT8_C(243), UINT8_C(214), UINT8_C( 24), UINT8_C(102), UINT8_C(219),
        UINT8_C( 49), UINT8_C(229),    UINT8_MAX, UINT8_C(157), UINT8_C( 30), UINT8_C(152), UINT8_C(171), UINT8_C(196),
        UINT8_C( 13), UINT8_C(192), UINT8_C( 38), UINT8_C( 99), UINT8_C(168), UINT8_C(238), UINT8_C(122), UINT8_C(220),
        UINT8_C(147), UINT8_C( 89), UINT8_C(182), UINT8_C(225), UINT8_C(250), UINT8_C( 67), UINT8_C( 91), UINT8_C(156),
        UINT8_C(228), UINT8_C( 31), UINT8_C(144), UINT8_C(186), UINT8_C( 55), UINT8_C(246), UINT8_C(149), UINT8_C(104),
        UINT8_C(220), UINT8_C(148), UINT8_C(  5), UINT8_C(250), UINT8_C( 45), UINT8_C(177), UINT8_C(191), UINT8_C( 58) },
      UINT64_C(                  49),
      { UINT16_C(  251), UINT16_C(  487), UINT16_C(  405), UINT16_C(  458), UINT16_C(  174), UINT16_C(  136), UINT16_C(  338), UINT16_C(  509),
        UINT16_C(  468), UINT16_C(  260), UINT16_C(  490), UINT16_C(  584), UINT16_C(  268), UINT16_C(  304), UINT16_C(  320), UINT16_C(  349),
        UINT16_C(  446), UINT16_C(   97), UINT16_C(  360), UINT16_C(  326), UINT16_C(  240), UINT16_C(  393), UINT16_C(  281), UINT16_C(  308),
        UINT16_C(  416), UINT16_C(  589), UINT16_C(  347), UINT16_C(  278), UINT16_C(  279), UINT16_C(  600), UINT16_C(  176), UINT16_C(  473) } },
    { { UINT8_C(211), UINT8_C( 23), UINT8_C(245), UINT8_C(102), UINT8_C(112), UINT8_C(172), UINT8_C( 72), UINT8_C(106),
        UINT8_C(239), UINT8_C(163), UINT8_C(  6), UINT8_C(211), UINT8_C(194), UINT8_C(150), UINT8_C(142), UINT8_C(250),
        UINT8_C(141), UINT8_C( 35), UINT8_C( 98), UINT8_C(105), UINT8_C(184), UINT8_C(104), UINT8_C( 99), UINT8_C(229),
        UINT8_C( 25), UINT8_C( 34), UINT8_C( 31), UINT8_C(138), UINT8_C(  8), UINT8_C(188), UINT8_C(163), UINT8_C(219),
        UINT8_C(211), UINT8_C(152), UINT8_C( 66), UINT8_C( 67), UINT8_C( 68), UINT8_C(138), UINT8_C(173), UINT8_C( 52),
        UINT8_C( 45), UINT8_C(179), UINT8_C(  7), UINT8_C(239), UINT8_C( 74), UINT8_C(149), UINT8_C(233), UINT8_C(215),
        UINT8_C(185), UINT8_C( 76), UINT8_C( 64), UINT8_C(113), UINT8_C(180), UINT8_C(163), UINT8_C( 86), UINT8_C(205),
        UINT8_C(198), UINT8_C(117), UINT8_C( 87), UINT8_C(206), UINT8_C( 49), UINT8_C(250), UINT8_C(169), UINT8_C(  4) },
      { UINT8_C(146), UINT8_C(235), UINT8_C( 71), UINT8_C(215), UINT8_C(117), UINT8_C(244), UINT8_C( 11), UINT8_C(162),
        UINT8_C(167), UINT8_C( 18), UINT8_C(146), UINT8_C(241), UINT8_C(168), UINT8_C(123), UINT8_C(200), UINT8_C( 97),
        UINT8_C(199), UINT8_C(  8), UINT8_C(210), UINT8_C(123), UINT8_C(172), UINT8_C( 40), UINT8_C( 72), UINT8_C(114),
        UINT8_C(157), UINT8_C(159), UINT8_C( 64), UINT8_C(206), UINT8_C(153), UINT8_C(233), UINT8_C(210), UINT8_C( 44),
        UINT8_C(213), UINT8_C( 25), UINT8_C(  3), UINT8_C( 74), UINT8_C( 13), UINT8_C( 14), UINT8_C(237), UINT8_C(180),
        UINT8_C( 32), UINT8_C(127), UINT8_C(166), UINT8_C(200), UINT8_C(250), UINT8_C(110), UINT8_C( 41), UINT8_C(194),
        UINT8_C(119), UINT8_C(251), UINT8_C( 61), UINT8_C( 35), UINT8_C( 35), UINT8_C(134), UINT8_C(149), UINT8_C(192),
        UINT8_C( 37), UINT8_C(213), UINT8_C(142), UINT8_C(191), UINT8_C(190), UINT8_C( 96), UINT8_C(235), UINT8_C(147) },
      UINT64_C(                  57),
      { UINT16_C(  609), UINT16_C(  193), UINT16_C(  294), UINT16_C(  149), UINT16_C(  419), UINT16_C(  309), UINT16_C(   78), UINT16_C(  373),
        UINT16_C(   71), UINT16_C(  206), UINT16_C(  250), UINT16_C(  348), UINT16_C(  600), UINT16_C(  458), UINT16_C(  593), UINT16_C(  211),
        UINT16_C(  620), UINT16_C(  431), UINT16_C(  427), UINT16_C(  378), UINT16_C(  353), UINT16_C(  416), UINT16_C(  288), UINT16_C(  604),
        UINT16_C(  372), UINT16_C(  328), UINT16_C(  117), UINT16_C(  328), UINT16_C(  236), UINT16_C(  367), UINT16_C(  586), UINT16_C(  368) } },
    { { UINT8_C(252), UINT8_C(203), UINT8_C( 59), UINT8_C( 28), UINT8_C( 74), UINT8_C(225), UINT8_C(229), UINT8_C( 68),
        UINT8_C( 79), UINT8_C( 14), UINT8_C(  6), UINT8_C(198), UINT8_C( 10), UINT8_C( 68), UINT8_C(233), UINT8_C( 45),
        UINT8_C(202), UINT8_C(126), UINT8_C(238), UINT8_C(239), UINT8_C( 83), UINT8_C(124), UINT8_C(174), UINT8_C( 18),
        UINT8_C(221), UINT8_C(153), UINT8_C(165), UINT8_C( 86), UINT8_C(135), UINT8_C(131), UINT8_C(221), UINT8_C(131),
        UINT8_C( 78), UINT8_C( 24), UINT8_C(160), UINT8_C(152), UINT8_C(249), UINT8_C(133), UINT8_C(221), UINT8_C( 72),
        UINT8_C(147), UINT8_C(227), UINT8_C( 15), UINT8_C(157), UINT8_C( 39), UINT8_C(248), UINT8_C(203), UINT8_C(241),
        UINT8_C(119), UINT8_C(185), UINT8_C(225), UINT8_C(202), UINT8_C( 53), UINT8_C(143), UINT8_C(220), UINT8_C( 18),
        UINT8_C( 41), UINT8_C(130), UINT8_C(105), UINT8_C(176), UINT8_C(  5), UINT8_C( 70), UINT8_C( 52), UINT8_C( 84) },
      { UINT8_C( 94), UINT8_C(212), UINT8_C(236), UINT8_C( 87), UINT8_C( 89), UINT8_C(201), UINT8_C(159), UINT8_C(236),
        UINT8_C(173), UINT8_C(174), UINT8_C(138), UINT8_C(212), UINT8_C(167), UINT8_C( 85), UINT8_C(198), UINT8_C( 30),
        UINT8_C( 14), UINT8_C(167), UINT8_C(232), UINT8_C( 67), UINT8_C( 54), UINT8_C(197), UINT8_C( 86), UINT8_C( 95),
        UINT8_C( 71), UINT8_C(191), UINT8_C( 16), UINT8_C( 76), UINT8_C(  5), UINT8_C( 68), UINT8_C(160), UINT8_C( 99),
        UINT8_C( 24), UINT8_C(141), UINT8_C(186), UINT8_C(113), UINT8_C( 86), UINT8_C( 89), UINT8_C( 93), UINT8_C(  3),
        UINT8_C(  8), UINT8_C(231), UINT8_C(216), UINT8_C(175), UINT8_C( 60), UINT8_C(158), UINT8_C(205), UINT8_C( 74),
        UINT8_C( 69), UINT8_C(181), UINT8_C(142), UINT8_C(123), UINT8_C(122), UINT8_C(228), UINT8_C(219), UINT8_C(193),
        UINT8_C(163), UINT8_C(235), UINT8_C( 14), UINT8_C(168), UINT8_C( 47), UINT8_C(174), UINT8_C( 11), UINT8_C( 71) },
      UINT64_C(                  59),
      { UINT16_C(  344), UINT16_C(  346), UINT16_C(  481), UINT16_C(  221), UINT16_C(  519), UINT16_C(  318), UINT16_C(  532), UINT16_C(  258),
        UINT16_C(  473), UINT16_C(  475), UINT16_C(  378), UINT16_C(   88), UINT16_C(  319), UINT16_C(  298), UINT16_C(  300), UINT16_C(  308),
        UINT16_C(  275), UINT16_C(  491), UINT16_C(  475), UINT16_C(  454), UINT16_C(  429), UINT16_C(  225), UINT16_C(  619), UINT16_C(  376),
        UINT16_C(  428), UINT16_C(  422), UINT16_C(  388), UINT16_C(   57), UINT16_C(  249), UINT16_C(  393), UINT16_C(  121), UINT16_C(  254) } },
    { { UINT8_C( 30), UINT8_C( 21), UINT8_C(149), UINT8_C( 38), UINT8_C(253), UINT8_C(109), UINT8_C(213), UINT8_C( 57),
        UINT8_C( 11), UINT8_C(162), UINT8_C(132), UINT8_C( 80), UINT8_C( 88), UINT8_C( 18), UINT8_C(204), UINT8_C(210),
        UINT8_C(246), UINT8_C(167), UINT8_C(148), UINT8_C(153), UINT8_C(146), UINT8_C(162), UINT8_C( 65), UINT8_C(193),
        UINT8_C( 80), UINT8_C( 76), UINT8_C(  8), UINT8_C(140), UINT8_C( 17), UINT8_C(192), UINT8_C( 30), UINT8_C( 47),
        UINT8_C(213), UINT8_C(179), UINT8_C( 86), UINT8_C(210), UINT8_C( 33), UINT8_C( 43), UINT8_C( 12), UINT8_C( 44),
        UINT8_C(206), UINT8_C(144), UINT8_C(125), UINT8_C( 38), UINT8_C(162), UINT8_C( 73), UINT8_C(248), UINT8_C(152),
        UINT8_C(240), UINT8_C(140), UINT8_C( 49), UINT8_C(130), UINT8_C( 46), UINT8_C(114), UINT8_C( 67), UINT8_C(127),
        UINT8_C(190), UINT8_C( 75), UINT8_C( 11), UINT8_C(207), UINT8_C( 11), UINT8_C( 41), UINT8_C(254), UINT8_C(224) },
      { UINT8_C(220), UINT8_C( 84), UINT8_C(179), UINT8_C(253), UINT8_C(128), UINT8_C(191), UINT8_C( 42), UINT8_C( 78),
        UINT8_C( 79), UINT8_C(167), UINT8_C(116), UINT8_C(241), UINT8_C(240), UINT8_C(108), UINT8_C(137), UINT8_C(224),
        UINT8_C(249), UINT8_C(186), UINT8_C( 98), UINT8_C( 39), UINT8_C( 44), UINT8_C(165), UINT8_C(166), UINT8_C(234),
        UINT8_C(240), UINT8_C(177), UINT8_C(185), UINT8_C(251), UINT8_C(218), UINT8_C(183), UINT8_C(219), UINT8_C(183),
        UINT8_C( 12), UINT8_C(142), UINT8_C(180), UINT8_C(140), UINT8_C( 77), UINT8_C(222), UINT8_C(218), UINT8_C(156),
        UINT8_C(133), UINT8_C( 78), UINT8_C(141), UINT8_C(117), UINT8_C(186), UINT8_C( 22), UINT8_C( 85), UINT8_C(179),
        UINT8_C(208), UINT8_C(183), UINT8_C(219), UINT8_C(252), UINT8_C( 92), UINT8_C(129), UINT8_C(230), UINT8_C( 76),
        UINT8_C( 51), UINT8_C(159), UINT8_C( 71), UINT8_C( 13), UINT8_C( 87), UINT8_C( 35), UINT8_C(196), UINT8_C( 99) },
      UINT64_C(                  49),
      { UINT16_C(  415), UINT16_C(  435), UINT16_C(  276), UINT16_C(  537), UINT16_C(  432), UINT16_C(  354), UINT16_C(  397), UINT16_C(  489),
        UINT16_C(  303), UINT16_C(  264), UINT16_C(  283), UINT16_C(  391), UINT16_C(  499), UINT16_C(  530), UINT16_C(  569), UINT16_C(  430),
        UINT16_C(  365), UINT16_C(  316), UINT16_C(  396), UINT16_C(  420), UINT16_C(  323), UINT16_C(  323), UINT16_C(  429), UINT16_C(  212),
        UINT16_C(  394), UINT16_C(  306), UINT16_C(  419), UINT16_C(  332), UINT16_C(  436), UINT16_C(  365), UINT16_C(  330), UINT16_C(  331) } },
    { { UINT8_C( 87), UINT8_C(201), UINT8_C(155), UINT8_C(221), UINT8_C( 23), UINT8_C( 41), UINT8_C( 82), UINT8_C(209),
        UINT8_C( 63), UINT8_C(168), UINT8_C(133), UINT8_C( 16), UINT8_C( 95), UINT8_C( 96), UINT8_C( 12), UINT8_C(188),
        UINT8_C(225), UINT8_C(243), UINT8_C(  8), UINT8_C( 20), UINT8_C(146), UINT8_C( 80), UINT8_C( 34), UINT8_C(233),
        UINT8_C(115), UINT8_C(230), UINT8_C( 76), UINT8_C( 36), UINT8_C( 95), UINT8_C( 59), UINT8_C( 35), UINT8_C(183),
        UINT8_C(  4), UINT8_C(191), UINT8_C(148), UINT8_C( 27), UINT8_C(232), UINT8_C(230), UINT8_C(237), UINT8_C( 39),
        UINT8_C(142), UINT8_C(114), UINT8_C( 55), UINT8_C(238), UINT8_C(210), UINT8_C( 68), UINT8_C(170), UINT8_C(179),
        UINT8_C( 55), UINT8_C(178), UINT8_C(200), UINT8_C(201), UINT8_C(  2), UINT8_C(234), UINT8_C(179), UINT8_C(117),
        UINT8_C(208),    UINT8_MAX, UINT8_C(154), UINT8_C( 48), UINT8_C( 59), UINT8_C(189), UINT8_C(231), UINT8_C( 63) },
      { UINT8_C(124), UINT8_C(123), UINT8_C( 91), UINT8_C(100), UINT8_C( 97), UINT8_C( 72), UINT8_C(140), UINT8_C(240),
        UINT8_C(186), UINT8_C(195), UINT8_C(222), UINT8_C(140), UINT8_C(  7), UINT8_C(136), UINT8_C( 63), UINT8_C( 62),
        UINT8_C( 58), UINT8_C(  7), UINT8_C(  8), UINT8_C( 61), UINT8_C(241), UINT8_C(187), UINT8_C(178), UINT8_C(194),
        UINT8_C(186), UINT8_C( 76), UINT8_C(242), UINT8_C(245), UINT8_C( 10), UINT8_C(217), UINT8_C( 53), UINT8_C(134),
        UINT8_C( 84), UINT8_C(144), UINT8_C(235), UINT8_C(181), UINT8_C(216), UINT8_C(119), UINT8_C(165), UINT8_C(146),
        UINT8_C( 58), UINT8_C(131), UINT8_C( 30), UINT8_C( 66), UINT8_C( 11), UINT8_C( 93), UINT8_C(128), UINT8_C( 70),
        UINT8_C(101), UINT8_C(136), UINT8_C(131), UINT8_C( 86), UINT8_C( 67), UINT8_C( 53), UINT8_C( 24), UINT8_C(254),
        UINT8_C(130), UINT8_C( 10), UINT8_C(243), UINT8_C(140), UINT8_C(227), UINT8_C( 40), UINT8_C( 18), UINT8_C( 55) },
      UINT64_C(                  56),
      { UINT16_C(  300), UINT16_C(  236), UINT16_C(  245), UINT16_C(  348), UINT16_C(  204), UINT16_C(  357), UINT16_C(  243), UINT16_C(  269),
        UINT16_C(  444), UINT16_C(  672), UINT16_C(  466), UINT16_C(  242), UINT16_C(  239), UINT16_C(  359), UINT16_C(  316), UINT16_C(  243),
        UINT16_C(  368), UINT16_C(  248), UINT16_C(  323), UINT16_C(  338), UINT16_C(  393), UINT16_C(  232), UINT16_C(  205), UINT16_C(  238),
        UINT16_C(  272), UINT16_C(  313), UINT16_C(  433), UINT16_C(  483), UINT16_C(  377), UINT16_C(  557), UINT16_C(  378), UINT16_C(  255) } },
    { { UINT8_C(116), UINT8_C(146), UINT8_C( 34), UINT8_C(175), UINT8_C( 22), UINT8_C( 64), UINT8_C(241), UINT8_C( 33),
        UINT8_C(158), UINT8_C(113), UINT8_C(103), UINT8_C(  3), UINT8_C(250), UINT8_C(234), UINT8_C( 89), UINT8_C( 61),
        UINT8_C( 32), UINT8_C(114), UINT8_C( 59), UINT8_C(162), UINT8_C(124), UINT8_C( 47), UINT8_C( 46), UINT8_C( 96),
        UINT8_C( 87), UINT8_C( 64), UINT8_C(151), UINT8_C( 16), UINT8_C( 62), UINT8_C(132), UINT8_C(160), UINT8_C(178),
        UINT8_C( 23), UINT8_C(195), UINT8_C( 97), UINT8_C( 45), UINT8_C(  3), UINT8_C( 82), UINT8_C( 78), UINT8_C(161),
        UINT8_C(196), UINT8_C(182), UINT8_C(164), UINT8_C(190), UINT8_C(160), UINT8_C(254), UINT8_C(251), UINT8_C(192),
        UINT8_C(112), UINT8_C( 55), UINT8_C( 98), UINT8_C(236), UINT8_C(102), UINT8_C(144), UINT8_C( 76), UINT8_C(189),
        UINT8_C(209), UINT8_C(228), UINT8_C(205), UINT8_C( 15), UINT8_C(104), UINT8_C(110), UINT8_C(193), UINT8_C(127) },
      { UINT8_C( 49), UINT8_C( 35), UINT8_C(172), UINT8_C( 52), UINT8_C(117), UINT8_C(251), UINT8_C(214), UINT8_C( 57),
        UINT8_C(177), UINT8_C(122), UINT8_C(247), UINT8_C( 81), UINT8_C(120), UINT8_C(243), UINT8_C( 18), UINT8_C(232),
        UINT8_C( 42), UINT8_C(116), UINT8_C(213), UINT8_C(144), UINT8_C(  5), UINT8_C( 33), UINT8_C( 77), UINT8_C(214),
        UINT8_C(  5), UINT8_C( 27), UINT8_C(229), UINT8_C(110), UINT8_C(137), UINT8_C(166), UINT8_C(237), UINT8_C(186),
        UINT8_C(201), UINT8_C(154), UINT8_C(238), UINT8_C( 63), UINT8_C(149), UINT8_C(196), UINT8_C(120), UINT8_C( 70),
        UINT8_C( 63), UINT8_C(112), UINT8_C(151), UINT8_C(183), UINT8_C( 99), UINT8_C(169), UINT8_C(160), UINT8_C(141),
        UINT8_C( 30), UINT8_C(117), UINT8_C( 29), UINT8_C( 35), UINT8_C(150), UINT8_C(106), UINT8_C(249), UINT8_C(156),
        UINT8_C(133), UINT8_C(222), UINT8_C( 10), UINT8_C( 14), UINT8_C(132), UINT8_C(247), UINT8_C(200), UINT8_C( 78) },
      UINT64_C(                  17),
      { UINT16_C(  404), UINT16_C(  352), UINT16_C(  393), UINT16_C(  395), UINT16_C(  344), UINT16_C(  286), UINT16_C(  279), UINT16_C(  543),
        UINT16_C(  178), UINT16_C(  313), UINT16_C(  238), UINT16_C(  282), UINT16_C(  385), UINT16_C(  156), UINT16_C(  277), UINT16_C(  321),
        UINT16_C(  175), UINT16_C(  431), UINT16_C(  259), UINT16_C(  339), UINT16_C(  225), UINT16_C(  167), UINT16_C(  312), UINT16_C(  286),
        UINT16_C(  320), UINT16_C(  464), UINT16_C(  277), UINT16_C(  369), UINT16_C(  366), UINT16_C(  188), UINT16_C(  364), UINT16_C(  306) } },
    { { UINT8_C(123), UINT8_C(  5), UINT8_C(108), UINT8_C(186), UINT8_C(117), UINT8_C(  4), UINT8_C(114), UINT8_C(216),
        UINT8_C(173), UINT8_C( 18), UINT8_C(101), UINT8_C(203), UINT8_C(135), UINT8_C(130), UINT8_C(238), UINT8_C( 29),
        UINT8_C(237), UINT8_C(231), UINT8_C(185), UINT8_C(114), UINT8_C(197), UINT8_C(195), UINT8_C(129), UINT8_C( 74),
        UINT8_C(187), UINT8_C( 73), UINT8_C(152), UINT8_C( 76), UINT8_C(  0), UINT8_C( 37), UINT8_C(115), UINT8_C(124),
        UINT8_C( 42), UINT8_C(223), UINT8_C( 54), UINT8_C(160), UINT8_C(227), UINT8_C(168), UINT8_C(120), UINT8_C(145),
        UINT8_C(186), UINT8_C(222), UINT8_C( 92), UINT8_C( 65), UINT8_C( 96), UINT8_C( 75), UINT8_C( 95), UINT8_C( 77),
        UINT8_C( 50), UINT8_C( 24), UINT8_C(192), UINT8_C(248), UINT8_C(220), UINT8_C( 65), UINT8_C( 66), UINT8_C(151),
        UINT8_C(138), UINT8_C(218), UINT8_C(227), UINT8_C(139),    UINT8_MAX, UINT8_C( 86), UINT8_C(  7), UINT8_C( 41) },
      { UINT8_C( 54), UINT8_C( 61), UINT8_C(201), UINT8_C( 25), UINT8_C(230), UINT8_C( 66), UINT8_C(170), UINT8_C(160),
        UINT8_C( 32), UINT8_C(  7), UINT8_C(226), UINT8_C(128), UINT8_C( 82), UINT8_C( 65), UINT8_C(206), UINT8_C(132),
        UINT8_C( 89), UINT8_C(142), UINT8_C(124), UINT8_C( 53), UINT8_C(207), UINT8_C(190), UINT8_C(204), UINT8_C( 89),
        UINT8_C(152), UINT8_C(176), UINT8_C(228), UINT8_C(151), UINT8_C(  6), UINT8_C(235), UINT8_C(193), UINT8_C( 60),
        UINT8_C( 41), UINT8_C(138), UINT8_C( 86), UINT8_C( 15), UINT8_C(204), UINT8_C(  0), UINT8_C(175), UINT8_C(236),
        UINT8_C(  7), UINT8_C(145), UINT8_C(109), UINT8_C( 89), UINT8_C(210), UINT8_C( 59), UINT8_C(222), UINT8_C( 44),
        UINT8_C(201), UINT8_C( 90), UINT8_C( 97), UINT8_C(152), UINT8_C( 25), UINT8_C( 46), UINT8_C(241), UINT8_C(177),
        UINT8_C(222), UINT8_C(214), UINT8_C( 73), UINT8_C(228), UINT8_C(193), UINT8_C( 10), UINT8_C( 33), UINT8_C(234) },
      UINT64_C(                  20),
      { UINT16_C(  379), UINT16_C(  385), UINT16_C(  371), UINT16_C(  412), UINT16_C(  217), UINT16_C(  467), UINT16_C(  281), UINT16_C(  450),
        UINT16_C(  359), UINT16_C(  427), UINT16_C(  409), UINT16_C(  347), UINT16_C(  202), UINT16_C(  210), UINT16_C(  300), UINT16_C(  168),
        UINT16_C(  263), UINT16_C(  316), UINT16_C(  523), UINT16_C(  398), UINT16_C(  494), UINT16_C(  401), UINT16_C(  355), UINT16_C(  226),
        UINT16_C(  408), UINT16_C(  376), UINT16_C(  356), UINT16_C(  218), UINT16_C(  337), UINT16_C(  227), UINT16_C(  348), UINT16_C(  332) } },
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    int32_t imm8 = (int32_t)test_vec[i].imm8;
    EASYSIMD_TEST_PERF_WITH_LOOP_START(100000) {
      EASYSIMD_CONSTIFY_64_(easysimd_mm512_dbsad_epu8, r, easysimd_mm512_setzero_si512(), imm8, a, b);
    } EASYSIMD_TEST_PERF_END("easysimd_mm512_dbsad_epu8");
    easysimd_test_x86_assert_equal_u16x32(r, easysimd_mm512_loadu_si512(test_vec[i].r));
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_test_x86_write_mmask64(2, imm8, EASYSIMD_TEST_VEC_POS_MIDDLE);
...
EASYSIMD_TEST_FUNC_LIST_BEGIN
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm512_4dpwssd_epi32)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm512_mask_4dpwssd_epi32)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm512_maskz_4dpwssd_epi32)
