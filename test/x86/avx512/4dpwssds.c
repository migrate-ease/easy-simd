#define EASYSIMD_TEST_X86_AVX512_INSN 4dpwssds

#include <test/x86/avx512/test-avx512.h>
#include <easysimd/x86/avx512/4dpwssds.h>

static int
test_easysimd_mm512_4dpwssds_epi32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd__m512i r = easysimd_mm512_4dpwssds_epi32(src, a0, a1, a2, a3, &b);
...
static int
test_easysimd_mm512_mask_4dpwssds_epi32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    const int32_t src[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd__m512i a3 = easysimd_mm512_loadu_epi32(test_vec[i].a3);
    easysimd__m128i b = easysimd_x_mm_loadu_epi32(test_vec[i].b);
    easysimd__m512i r = easysimd_mm512_mask_4dpwssds_epi32(src, test_vec[i].k, a0, a1, a2, a3, &b);
    easysimd_test_x86_assert_equal_i32x16(r, easysimd_mm512_loadu_epi32(test_vec[i].r));
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd__m512i a3 = easysimd_test_x86_random_i32x16();
    easysimd__m128i b = easysimd_test_x86_random_i32x4();
    easysimd__m512i r = easysimd_mm512_mask_4dpwssds_epi32(src, k, a0, a1, a2, a3, &b);
...
static int
test_easysimd_mm512_maskz_4dpwssds_epi32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    const easysimd__mmask16 k;
    const int32_t src[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd__m512i a3 = easysimd_mm512_loadu_epi32(test_vec[i].a3);
    easysimd__m128i b = easysimd_x_mm_loadu_epi32(test_vec[i].b);
    easysimd__m512i r = easysimd_mm512_maskz_4dpwssds_epi32(test_vec[i].k, src, a0, a1, a2, a3, &b);
    easysimd_test_x86_assert_equal_i32x16(r, easysimd_mm512_loadu_epi32(test_vec[i].r));
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd__m512i a3 = easysimd_test_x86_random_i32x16();
    easysimd__m128i b = easysimd_test_x86_random_i32x4();
    easysimd__m512i r = easysimd_mm512_maskz_4dpwssds_epi32(k, src, a0, a1, a2, a3, &b);
...
EASYSIMD_TEST_FUNC_LIST_BEGIN
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm512_4dpwssds_epi32)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm512_mask_4dpwssds_epi32)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm512_maskz_4dpwssds_epi32)
