#define EASYSIMD_TEST_X86_AVX512_INSN bitshuffle

#include <test/x86/avx512/test-avx512.h>
#include <easysimd/x86/avx512/bitshuffle.h>

static int
test_easysimd_mm_bitshuffle_epi64_mask (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    const int64_t b[2];
    const int64_t c[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd__m128i c = easysimd_x_mm_loadu_epi64(test_vec[i].c);
    easysimd__mmask16 r = easysimd_mm_bitshuffle_epi64_mask(b, c);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_test_x86_write_i64x2(2, b, EASYSIMD_TEST_VEC_POS_FIRST);
...
static int
test_easysimd_mm_mask_bitshuffle_epi64_mask (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd__m128i b = easysimd_x_mm_loadu_epi64(test_vec[i].b);
    easysimd__m128i c = easysimd_x_mm_loadu_epi64(test_vec[i].c);
    easysimd__mmask16 r = easysimd_mm_mask_bitshuffle_epi64_mask(test_vec[i].k, b, c);
    easysimd_assert_equal_mmask16(r, test_vec[i].r);
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd__m128i b = easysimd_test_x86_random_i64x2();
    easysimd__m128i c = easysimd_test_x86_random_i64x2();
    easysimd__mmask16 r = easysimd_mm_mask_bitshuffle_epi64_mask(k, b, c);
...
static int
test_easysimd_mm256_bitshuffle_epi64_mask (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    const int64_t b[4];
    const int64_t c[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd__m256i c = easysimd_x_mm256_loadu_epi64(test_vec[i].c);
    easysimd__mmask32 r = easysimd_mm256_bitshuffle_epi64_mask(b, c);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_test_x86_write_i64x4(2, b, EASYSIMD_TEST_VEC_POS_FIRST);
...
static int
test_easysimd_mm256_mask_bitshuffle_epi64_mask (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd__m256i b = easysimd_x_mm256_loadu_epi64(test_vec[i].b);
    easysimd__m256i c = easysimd_x_mm256_loadu_epi64(test_vec[i].c);
    easysimd__mmask32 r = easysimd_mm256_mask_bitshuffle_epi64_mask(test_vec[i].k, b, c);
    easysimd_assert_equal_mmask32(r, test_vec[i].r);
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd__m256i b = easysimd_test_x86_random_i64x4();
    easysimd__m256i c = easysimd_test_x86_random_i64x4();
    easysimd__mmask32 r = easysimd_mm256_mask_bitshuffle_epi64_mask(k, b, c);
...
static int
test_easysimd_mm512_bitshuffle_epi64_mask (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    const int64_t b[8];
    const int64_t c[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd__m512i c = easysimd_mm512_loadu_epi64(test_vec[i].c);
    easysimd__mmask64 r = easysimd_mm512_bitshuffle_epi64_mask(b, c);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd_test_x86_write_i64x8(2, b, EASYSIMD_TEST_VEC_POS_FIRST);
...
static int
test_easysimd_mm512_mask_bitshuffle_epi64_mask (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd__m512i b = easysimd_mm512_loadu_epi64(test_vec[i].b);
    easysimd__m512i c = easysimd_mm512_loadu_epi64(test_vec[i].c);
    easysimd__mmask64 r = easysimd_mm512_mask_bitshuffle_epi64_mask(test_vec[i].k, b, c);
    easysimd_assert_equal_mmask64(r, test_vec[i].r);
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd__m512i b = easysimd_test_x86_random_i64x8();
    easysimd__m512i c = easysimd_test_x86_random_i64x8();
    easysimd__mmask64 r = easysimd_mm512_mask_bitshuffle_epi64_mask(k, b, c);
...
EASYSIMD_TEST_FUNC_LIST_BEGIN
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm_bitshuffle_epi64_mask)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm_mask_bitshuffle_epi64_mask)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm256_bitshuffle_epi64_mask)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm256_mask_bitshuffle_epi64_mask)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm512_bitshuffle_epi64_mask)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm512_mask_bitshuffle_epi64_mask)
