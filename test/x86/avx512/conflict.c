#define EASYSIMD_TEST_X86_AVX512_INSN conflict

#include <test/x86/avx512/test-avx512.h>
#include <easysimd/x86/avx512/conflict.h>

static int
test_easysimd_mm_conflict_epi32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    const int32_t a[4];
    const int32_t r[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd__m128i r = easysimd_mm_conflict_epi32(a);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    for (int j = 0 ; j < 4 ; j++) {
      if (easysimd_test_codegen_random_i32() & 1) {
        a_[j] = easysimd_test_codegen_random_i32();
      }
    }
    easysimd__m128i a = easysimd_mm_set_epi32(a_[3], a_[2], a_[1], a_[0]);
    easysimd__m128i r = easysimd_mm_conflict_epi32(a);
...
static int
test_easysimd_mm_mask_conflict_epi32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    const int32_t src[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd__m128i a = easysimd_x_mm_loadu_epi32(test_vec[i].a);
    easysimd__m128i r = easysimd_mm_mask_conflict_epi32(src, test_vec[i].k, a);
    easysimd_test_x86_assert_equal_i32x4(r, easysimd_x_mm_loadu_epi32(test_vec[i].r));
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd__m128i a = easysimd_mm_set_epi32(a_[3], a_[2], a_[1], a_[0]);
    easysimd__m128i r = easysimd_mm_mask_conflict_epi32(src, k, a);
...
static int
test_easysimd_mm_maskz_conflict_epi32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    const easysimd__mmask8 k;
    const int32_t a[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd__m128i a = easysimd_x_mm_loadu_epi32(test_vec[i].a);
    easysimd__m128i r = easysimd_mm_maskz_conflict_epi32(test_vec[i].k, a);
    easysimd_test_x86_assert_equal_i32x4(r, easysimd_x_mm_loadu_epi32(test_vec[i].r));
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd__m128i a = easysimd_mm_set_epi32(a_[3], a_[2], a_[1], a_[0]);
    easysimd__m128i r = easysimd_mm_maskz_conflict_epi32(k, a);
...
static int
test_easysimd_mm256_conflict_epi32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    const int32_t a[8];
    const int32_t r[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd__m256i r = easysimd_mm256_conflict_epi32(a);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd__m256i a = easysimd_mm256_set_epi32(a_[7], a_[6], a_[5], a_[4], a_[3], a_[2], a_[1], a_[0]);
    easysimd__m256i r = easysimd_mm256_conflict_epi32(a);
...
static int
test_easysimd_mm256_mask_conflict_epi32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    const int32_t src[8];
    const easysimd__mmask8 k;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd__m256i a = easysimd_x_mm256_loadu_epi32(test_vec[i].a);
    easysimd__m256i r = easysimd_mm256_mask_conflict_epi32(src, test_vec[i].k, a);
    easysimd_test_x86_assert_equal_i32x8(r, easysimd_x_mm256_loadu_epi32(test_vec[i].r));
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd__m256i a = easysimd_mm256_set_epi32(a_[7], a_[6], a_[5], a_[4], a_[3], a_[2], a_[1], a_[0]);
    easysimd__m256i r = easysimd_mm256_mask_conflict_epi32(src, k, a);
...
static int
test_easysimd_mm256_maskz_conflict_epi32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    const easysimd__mmask8 k;
    const int32_t a[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd__m256i a = easysimd_x_mm256_loadu_epi32(test_vec[i].a);
    easysimd__m256i r = easysimd_mm256_maskz_conflict_epi32(test_vec[i].k, a);
    easysimd_test_x86_assert_equal_i32x8(r, easysimd_x_mm256_loadu_epi32(test_vec[i].r));
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd__m256i a = easysimd_mm256_set_epi32(a_[7], a_[6], a_[5], a_[4], a_[3], a_[2], a_[1], a_[0]);
    easysimd__m256i r = easysimd_mm256_maskz_conflict_epi32(k, a);
...
static int
test_easysimd_mm512_conflict_epi32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    const int32_t a[16];
    const int32_t r[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd__m512i r = easysimd_mm512_conflict_epi32(a);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd__m512i a = easysimd_mm512_set_epi32(a_[15], a_[14], a_[13], a_[12], a_[11], a_[10], a_[9], a_[8], a_[7], a_[6], a_[5], a_[4], a_[3], a_[2], a_[1], a_[0]);
    easysimd__m512i r = easysimd_mm512_conflict_epi32(a);
...
static int
test_easysimd_mm512_mask_conflict_epi32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd__m512i a = easysimd_mm512_loadu_epi32(test_vec[i].a);
    easysimd__m512i r = easysimd_mm512_mask_conflict_epi32(src, test_vec[i].k, a);
    easysimd_test_x86_assert_equal_i32x16(r, easysimd_mm512_loadu_epi32(test_vec[i].r));
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd__m512i a = easysimd_mm512_set_epi32(a_[15], a_[14], a_[13], a_[12], a_[11], a_[10], a_[9], a_[8], a_[7], a_[6], a_[5], a_[4], a_[3], a_[2], a_[1], a_[0]);
    easysimd__m512i r = easysimd_mm512_mask_conflict_epi32(src, k, a);
...
static int
test_easysimd_mm512_maskz_conflict_epi32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    const easysimd__mmask16 k;
    const int32_t a[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd__m512i a = easysimd_mm512_loadu_epi32(test_vec[i].a);
    easysimd__m512i r = easysimd_mm512_maskz_conflict_epi32(test_vec[i].k, a);
    easysimd_test_x86_assert_equal_i32x16(r, easysimd_mm512_loadu_epi32(test_vec[i].r));
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd__m512i a = easysimd_mm512_set_epi32(a_[15], a_[14], a_[13], a_[12], a_[11], a_[10], a_[9], a_[8], a_[7], a_[6], a_[5], a_[4], a_[3], a_[2], a_[1], a_[0]);
    easysimd__m512i r = easysimd_mm512_maskz_conflict_epi32(k, a);
...
static int
test_easysimd_mm_conflict_epi64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    const int64_t a[2];
    const int64_t r[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd__m128i r = easysimd_mm_conflict_epi64(a);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    for (int j = 0 ; j < 2 ; j++) {
      if (easysimd_test_codegen_random_i32() & 1) {
        a_[j] = easysimd_test_codegen_random_i64();
      }
    }
    easysimd__m128i a = easysimd_mm_set_epi64x(a_[1], a_[0]);
    easysimd__m128i r = easysimd_mm_conflict_epi64(a);
...
static int
test_easysimd_mm_mask_conflict_epi64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    const int64_t src[2];
    const easysimd__mmask8 k;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd__m128i a = easysimd_x_mm_loadu_epi64(test_vec[i].a);
    easysimd__m128i r = easysimd_mm_mask_conflict_epi64(src, test_vec[i].k, a);
    easysimd_test_x86_assert_equal_i64x2(r, easysimd_x_mm_loadu_epi64(test_vec[i].r));
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd__m128i a = easysimd_mm_set_epi64x(a_[1], a_[0]);
    easysimd__m128i r = easysimd_mm_mask_conflict_epi64(src, k, a);
...
static int
test_easysimd_mm_maskz_conflict_epi64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    const easysimd__mmask8 k;
    const int64_t a[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd__m128i a = easysimd_x_mm_loadu_epi64(test_vec[i].a);
    easysimd__m128i r = easysimd_mm_maskz_conflict_epi64(test_vec[i].k, a);
    easysimd_test_x86_assert_equal_i64x2(r, easysimd_x_mm_loadu_epi64(test_vec[i].r));
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd__m128i a = easysimd_mm_set_epi64x(a_[1], a_[0]);
    easysimd__m128i r = easysimd_mm_maskz_conflict_epi64(k, a);
...
static int
test_easysimd_mm256_conflict_epi64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    const int64_t a[4];
    const int64_t r[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd__m256i r = easysimd_mm256_conflict_epi64(a);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd__m256i a = easysimd_mm256_set_epi64x(a_[3], a_[2], a_[1], a_[0]);
    easysimd__m256i r = easysimd_mm256_conflict_epi64(a);
...
static int
test_easysimd_mm256_mask_conflict_epi64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    const int64_t src[4];
    const easysimd__mmask8 k;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd__m256i a = easysimd_x_mm256_loadu_epi64(test_vec[i].a);
    easysimd__m256i r = easysimd_mm256_mask_conflict_epi64(src, test_vec[i].k, a);
    easysimd_test_x86_assert_equal_i64x4(r, easysimd_x_mm256_loadu_epi64(test_vec[i].r));
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd__m256i a = easysimd_mm256_set_epi64x(a_[3], a_[2], a_[1], a_[0]);
    easysimd__m256i r = easysimd_mm256_mask_conflict_epi64(src, k, a);
...
static int
test_easysimd_mm256_maskz_conflict_epi64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    const easysimd__mmask8 k;
    const int64_t a[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd__m256i a = easysimd_x_mm256_loadu_epi64(test_vec[i].a);
    easysimd__m256i r = easysimd_mm256_maskz_conflict_epi64(test_vec[i].k, a);
    easysimd_test_x86_assert_equal_i64x4(r, easysimd_x_mm256_loadu_epi64(test_vec[i].r));
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd__m256i a = easysimd_mm256_set_epi64x(a_[3], a_[2], a_[1], a_[0]);
    easysimd__m256i r = easysimd_mm256_maskz_conflict_epi64(k, a);
...
static int
test_easysimd_mm512_conflict_epi64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    const int64_t a[8];
    const int64_t r[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd__m512i r = easysimd_mm512_conflict_epi64(a);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd__m512i a = easysimd_mm512_set_epi64(a_[7], a_[6], a_[5], a_[4], a_[3], a_[2], a_[1], a_[0]);
    easysimd__m512i r = easysimd_mm512_conflict_epi64(a);
...
static int
test_easysimd_mm512_mask_conflict_epi64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    const int64_t src[8];
    const easysimd__mmask8 k;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd__m512i a = easysimd_mm512_loadu_epi64(test_vec[i].a);
    easysimd__m512i r = easysimd_mm512_mask_conflict_epi64(src, test_vec[i].k, a);
    easysimd_test_x86_assert_equal_i64x8(r, easysimd_mm512_loadu_epi64(test_vec[i].r));
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd__m512i a = easysimd_mm512_set_epi64(a_[7], a_[6], a_[5], a_[4], a_[3], a_[2], a_[1], a_[0]);
    easysimd__m512i r = easysimd_mm512_mask_conflict_epi64(src, k, a);
...
static int
test_easysimd_mm512_maskz_conflict_epi64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    const easysimd__mmask8 k;
    const int64_t a[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd__m512i a = easysimd_mm512_loadu_epi64(test_vec[i].a);
    easysimd__m512i r = easysimd_mm512_maskz_conflict_epi64(test_vec[i].k, a);
    easysimd_test_x86_assert_equal_i64x8(r, easysimd_mm512_loadu_epi64(test_vec[i].r));
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd__m512i a = easysimd_mm512_set_epi64(a_[7], a_[6], a_[5], a_[4], a_[3], a_[2], a_[1], a_[0]);
    easysimd__m512i r = easysimd_mm512_maskz_conflict_epi64(k, a);
...
EASYSIMD_TEST_FUNC_LIST_BEGIN
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm_conflict_epi32)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm_mask_conflict_epi32)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm_maskz_conflict_epi32)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm256_conflict_epi32)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm256_mask_conflict_epi32)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm256_maskz_conflict_epi32)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm512_conflict_epi32)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm512_mask_conflict_epi32)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm512_maskz_conflict_epi32)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm_conflict_epi64)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm_mask_conflict_epi64)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm_maskz_conflict_epi64)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm256_conflict_epi64)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm256_mask_conflict_epi64)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm256_maskz_conflict_epi64)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm512_conflict_epi64)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm512_mask_conflict_epi64)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm512_maskz_conflict_epi64)
