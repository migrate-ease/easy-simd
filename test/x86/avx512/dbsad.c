#define EASYSIMD_TEST_X86_AVX512_INSN dbsad

#include <test/x86/avx512/test-avx512.h>
#include <easysimd/x86/avx512/setzero.h>
#include <easysimd/x86/avx512/dbsad.h>

static int
test_easysimd_mm_dbsad_epu8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    const int8_t a[16];
    const int8_t b[16];
  ...
  easysimd__m128i a, b, r;

  a = easysimd_x_mm_loadu_epi8(test_vec[0].a);
  b = easysimd_x_mm_loadu_epi8(test_vec[0].b);
  r = easysimd_mm_dbsad_epu8(a, b, INT32_C(         156));
  easysimd_test_x86_assert_equal_i16x8(r, easysimd_x_mm_loadu_epi64(test_vec[0].r));

  a = easysimd_x_mm_loadu_epi8(test_vec[1].a);
  b = easysimd_x_mm_loadu_epi8(test_vec[1].b);
  r = easysimd_mm_dbsad_epu8(a, b, INT32_C(         162));
  easysimd_test_x86_assert_equal_i16x8(r, easysimd_x_mm_loadu_epi64(test_vec[1].r));

  a = easysimd_x_mm_loadu_epi8(test_vec[2].a);
  b = easysimd_x_mm_loadu_epi8(test_vec[2].b);
  r = easysimd_mm_dbsad_epu8(a, b, INT32_C(          92));
  easysimd_test_x86_assert_equal_i16x8(r, easysimd_x_mm_loadu_epi64(test_vec[2].r));

  a = easysimd_x_mm_loadu_epi8(test_vec[3].a);
  b = easysimd_x_mm_loadu_epi8(test_vec[3].b);
  r = easysimd_mm_dbsad_epu8(a, b, INT32_C(          31));
  easysimd_test_x86_assert_equal_i16x8(r, easysimd_x_mm_loadu_epi64(test_vec[3].r));

  a = easysimd_x_mm_loadu_epi8(test_vec[4].a);
  b = easysimd_x_mm_loadu_epi8(test_vec[4].b);
  r = easysimd_mm_dbsad_epu8(a, b, INT32_C(         239));
  easysimd_test_x86_assert_equal_i16x8(r, easysimd_x_mm_loadu_epi64(test_vec[4].r));

  a = easysimd_x_mm_loadu_epi8(test_vec[5].a);
  b = easysimd_x_mm_loadu_epi8(test_vec[5].b);
  r = easysimd_mm_dbsad_epu8(a, b, INT32_C(           2));
  easysimd_test_x86_assert_equal_i16x8(r, easysimd_x_mm_loadu_epi64(test_vec[5].r));

  a = easysimd_x_mm_loadu_epi8(test_vec[6].a);
  b = easysimd_x_mm_loadu_epi8(test_vec[6].b);
  r = easysimd_mm_dbsad_epu8(a, b, INT32_C(         139));
  easysimd_test_x86_assert_equal_i16x8(r, easysimd_x_mm_loadu_epi64(test_vec[6].r));

  a = easysimd_x_mm_loadu_epi8(test_vec[7].a);
  b = easysimd_x_mm_loadu_epi8(test_vec[7].b);
  r = easysimd_mm_dbsad_epu8(a, b, INT32_C(          30));
  easysimd_test_x86_assert_equal_i16x8(r, easysimd_x_mm_loadu_epi64(test_vec[7].r));
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd__m128i r;
    EASYSIMD_CONSTIFY_256_(easysimd_mm_dbsad_epu8, r, easysimd_mm_setzero_si128(), imm8, a, b);
...
static int
test_easysimd_mm_mask_dbsad_epu8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    const int16_t src[8];
  ...
  src = easysimd_x_mm_loadu_epi16(test_vec[0].src);
  a = easysimd_x_mm_loadu_epi8(test_vec[0].a);
  b = easysimd_x_mm_loadu_epi8(test_vec[0].b);
  r = easysimd_mm_mask_dbsad_epu8(src, test_vec[0].k, a, b, INT32_C(          32));
  easysimd_test_x86_assert_equal_i16x8(r, easysimd_x_mm_loadu_epi16(test_vec[0].r));

  src = easysimd_x_mm_loadu_epi16(test_vec[1].src);
  a = easysimd_x_mm_loadu_epi8(test_vec[1].a);
  b = easysimd_x_mm_loadu_epi8(test_vec[1].b);
  r = easysimd_mm_mask_dbsad_epu8(src, test_vec[1].k, a, b, INT32_C(          91));
  easysimd_test_x86_assert_equal_i16x8(r, easysimd_x_mm_loadu_epi16(test_vec[1].r));

  src = easysimd_x_mm_loadu_epi16(test_vec[2].src);
  a = easysimd_x_mm_loadu_epi8(test_vec[2].a);
  b = easysimd_x_mm_loadu_epi8(test_vec[2].b);
  r = easysimd_mm_mask_dbsad_epu8(src, test_vec[2].k, a, b, INT32_C(          68));
  easysimd_test_x86_assert_equal_i16x8(r, easysimd_x_mm_loadu_epi16(test_vec[2].r));

  src = easysimd_x_mm_loadu_epi16(test_vec[3].src);
  a = easysimd_x_mm_loadu_epi8(test_vec[3].a);
  b = easysimd_x_mm_loadu_epi8(test_vec[3].b);
  r = easysimd_mm_mask_dbsad_epu8(src, test_vec[3].k, a, b, INT32_C(         213));
  easysimd_test_x86_assert_equal_i16x8(r, easysimd_x_mm_loadu_epi16(test_vec[3].r));

  src = easysimd_x_mm_loadu_epi16(test_vec[4].src);
  a = easysimd_x_mm_loadu_epi8(test_vec[4].a);
  b = easysimd_x_mm_loadu_epi8(test_vec[4].b);
  r = easysimd_mm_mask_dbsad_epu8(src, test_vec[4].k, a, b, INT32_C(          68));
  easysimd_test_x86_assert_equal_i16x8(r, easysimd_x_mm_loadu_epi16(test_vec[4].r));

  src = easysimd_x_mm_loadu_epi16(test_vec[5].src);
  a = easysimd_x_mm_loadu_epi8(test_vec[5].a);
  b = easysimd_x_mm_loadu_epi8(test_vec[5].b);
  r = easysimd_mm_mask_dbsad_epu8(src, test_vec[5].k, a, b, INT32_C(         195));
  easysimd_test_x86_assert_equal_i16x8(r, easysimd_x_mm_loadu_epi16(test_vec[5].r));

  src = easysimd_x_mm_loadu_epi16(test_vec[6].src);
  a = easysimd_x_mm_loadu_epi8(test_vec[6].a);
  b = easysimd_x_mm_loadu_epi8(test_vec[6].b);
  r = easysimd_mm_mask_dbsad_epu8(src, test_vec[6].k, a, b, INT32_C(           6));
  easysimd_test_x86_assert_equal_i16x8(r, easysimd_x_mm_loadu_epi16(test_vec[6].r));

  src = easysimd_x_mm_loadu_epi16(test_vec[7].src);
  a = easysimd_x_mm_loadu_epi8(test_vec[7].a);
  b = easysimd_x_mm_loadu_epi8(test_vec[7].b);
  r = easysimd_mm_mask_dbsad_epu8(src, test_vec[7].k, a, b, INT32_C(          24));
  easysimd_test_x86_assert_equal_i16x8(r, easysimd_x_mm_loadu_epi16(test_vec[7].r));
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    int imm8 = easysimd_test_codegen_random_i32() & 255;
    easysimd__m128i r;
    EASYSIMD_CONSTIFY_256_(easysimd_mm_mask_dbsad_epu8, r, easysimd_mm_setzero_si128(), imm8, src, k, a, b);
...
static int
test_easysimd_mm_maskz_dbsad_epu8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    const easysimd__mmask8 k;
    const int8_t a[16];
  ...
  a = easysimd_x_mm_loadu_epi8(test_vec[0].a);
  b = easysimd_x_mm_loadu_epi8(test_vec[0].b);
  r = easysimd_mm_maskz_dbsad_epu8(test_vec[0].k, a, b, INT32_C(         114));
  easysimd_test_x86_assert_equal_i16x8(r, easysimd_x_mm_loadu_epi16(test_vec[0].r));

  a = easysimd_x_mm_loadu_epi8(test_vec[1].a);
  b = easysimd_x_mm_loadu_epi8(test_vec[1].b);
  r = easysimd_mm_maskz_dbsad_epu8(test_vec[1].k, a, b, INT32_C(         210));
  easysimd_test_x86_assert_equal_i16x8(r, easysimd_x_mm_loadu_epi16(test_vec[1].r));

  a = easysimd_x_mm_loadu_epi8(test_vec[2].a);
  b = easysimd_x_mm_loadu_epi8(test_vec[2].b);
  r = easysimd_mm_maskz_dbsad_epu8(test_vec[2].k, a, b, INT32_C(         242));
  easysimd_test_x86_assert_equal_i16x8(r, easysimd_x_mm_loadu_epi16(test_vec[2].r));

  a = easysimd_x_mm_loadu_epi8(test_vec[3].a);
  b = easysimd_x_mm_loadu_epi8(test_vec[3].b);
  r = easysimd_mm_maskz_dbsad_epu8(test_vec[3].k, a, b, INT32_C(          52));
  easysimd_test_x86_assert_equal_i16x8(r, easysimd_x_mm_loadu_epi16(test_vec[3].r));

  a = easysimd_x_mm_loadu_epi8(test_vec[4].a);
  b = easysimd_x_mm_loadu_epi8(test_vec[4].b);
  r = easysimd_mm_maskz_dbsad_epu8(test_vec[4].k, a, b, INT32_C(          20));
  easysimd_test_x86_assert_equal_i16x8(r, easysimd_x_mm_loadu_epi16(test_vec[4].r));

  a = easysimd_x_mm_loadu_epi8(test_vec[5].a);
  b = easysimd_x_mm_loadu_epi8(test_vec[5].b);
  r = easysimd_mm_maskz_dbsad_epu8(test_vec[5].k, a, b, INT32_C(          11));
  easysimd_test_x86_assert_equal_i16x8(r, easysimd_x_mm_loadu_epi16(test_vec[5].r));

  a = easysimd_x_mm_loadu_epi8(test_vec[6].a);
  b = easysimd_x_mm_loadu_epi8(test_vec[6].b);
  r = easysimd_mm_maskz_dbsad_epu8(test_vec[6].k, a, b, INT32_C(          47));
  easysimd_test_x86_assert_equal_i16x8(r, easysimd_x_mm_loadu_epi16(test_vec[6].r));

  a = easysimd_x_mm_loadu_epi8(test_vec[7].a);
  b = easysimd_x_mm_loadu_epi8(test_vec[7].b);
  r = easysimd_mm_maskz_dbsad_epu8(test_vec[7].k, a, b, INT32_C(         151));
  easysimd_test_x86_assert_equal_i16x8(r, easysimd_x_mm_loadu_epi16(test_vec[7].r));
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    int imm8 = easysimd_test_codegen_random_i32() & 255;
    easysimd__m128i r;
    EASYSIMD_CONSTIFY_256_(easysimd_mm_maskz_dbsad_epu8, r, easysimd_mm_setzero_si128(), imm8, k, a, b);
...
static int
test_easysimd_mm256_dbsad_epu8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    const int8_t a[32];
    const int8_t b[32];
  ...
  easysimd__m256i a, b, r;

  a = easysimd_x_mm256_loadu_epi8(test_vec[0].a);
  b = easysimd_x_mm256_loadu_epi8(test_vec[0].b);
  r = easysimd_mm256_dbsad_epu8(a, b, INT32_C(         219));
  easysimd_test_x86_assert_equal_i16x16(r, easysimd_x_mm256_loadu_epi16(test_vec[0].r));

  a = easysimd_x_mm256_loadu_epi8(test_vec[1].a);
  b = easysimd_x_mm256_loadu_epi8(test_vec[1].b);
  r = easysimd_mm256_dbsad_epu8(a, b, INT32_C(         166));
  easysimd_test_x86_assert_equal_i16x16(r, easysimd_x_mm256_loadu_epi16(test_vec[1].r));

  a = easysimd_x_mm256_loadu_epi8(test_vec[2].a);
  b = easysimd_x_mm256_loadu_epi8(test_vec[2].b);
  r = easysimd_mm256_dbsad_epu8(a, b, INT32_C(          74));
  easysimd_test_x86_assert_equal_i16x16(r, easysimd_x_mm256_loadu_epi16(test_vec[2].r));

  a = easysimd_x_mm256_loadu_epi8(test_vec[3].a);
  b = easysimd_x_mm256_loadu_epi8(test_vec[3].b);
  r = easysimd_mm256_dbsad_epu8(a, b, INT32_C(         203));
  easysimd_test_x86_assert_equal_i16x16(r, easysimd_x_mm256_loadu_epi16(test_vec[3].r));

  a = easysimd_x_mm256_loadu_epi8(test_vec[4].a);
  b = easysimd_x_mm256_loadu_epi8(test_vec[4].b);
  r = easysimd_mm256_dbsad_epu8(a, b, INT32_C(         148));
  easysimd_test_x86_assert_equal_i16x16(r, easysimd_x_mm256_loadu_epi16(test_vec[4].r));

  a = easysimd_x_mm256_loadu_epi8(test_vec[5].a);
  b = easysimd_x_mm256_loadu_epi8(test_vec[5].b);
  r = easysimd_mm256_dbsad_epu8(a, b, INT32_C(          22));
  easysimd_test_x86_assert_equal_i16x16(r, easysimd_x_mm256_loadu_epi16(test_vec[5].r));

  a = easysimd_x_mm256_loadu_epi8(test_vec[6].a);
  b = easysimd_x_mm256_loadu_epi8(test_vec[6].b);
  r = easysimd_mm256_dbsad_epu8(a, b, INT32_C(          32));
  easysimd_test_x86_assert_equal_i16x16(r, easysimd_x_mm256_loadu_epi16(test_vec[6].r));

  a = easysimd_x_mm256_loadu_epi8(test_vec[7].a);
  b = easysimd_x_mm256_loadu_epi8(test_vec[7].b);
  r = easysimd_mm256_dbsad_epu8(a, b, INT32_C(         106));
  easysimd_test_x86_assert_equal_i16x16(r, easysimd_x_mm256_loadu_epi16(test_vec[7].r));
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    int imm8 = easysimd_test_codegen_random_i32() & 255;
    easysimd__m256i r;
    EASYSIMD_CONSTIFY_256_(easysimd_mm256_dbsad_epu8, r, easysimd_mm256_setzero_si256(), imm8, a, b);
...
static int
test_easysimd_mm256_mask_dbsad_epu8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
  ...
  src = easysimd_x_mm256_loadu_epi16(test_vec[0].src);
  a = easysimd_x_mm256_loadu_epi8(test_vec[0].a);
  b = easysimd_x_mm256_loadu_epi8(test_vec[0].b);
  r = easysimd_mm256_mask_dbsad_epu8(src, test_vec[0].k, a, b, INT32_C(          47));
  easysimd_test_x86_assert_equal_i16x16(r, easysimd_x_mm256_loadu_epi16(test_vec[0].r));

  src = easysimd_x_mm256_loadu_epi16(test_vec[1].src);
  a = easysimd_x_mm256_loadu_epi8(test_vec[1].a);
  b = easysimd_x_mm256_loadu_epi8(test_vec[1].b);
  r = easysimd_mm256_mask_dbsad_epu8(src, test_vec[1].k, a, b, INT32_C(         168));
  easysimd_test_x86_assert_equal_i16x16(r, easysimd_x_mm256_loadu_epi16(test_vec[1].r));

  src = easysimd_x_mm256_loadu_epi16(test_vec[2].src);
  a = easysimd_x_mm256_loadu_epi8(test_vec[2].a);
  b = easysimd_x_mm256_loadu_epi8(test_vec[2].b);
  r = easysimd_mm256_mask_dbsad_epu8(src, test_vec[2].k, a, b, INT32_C(         233));
  easysimd_test_x86_assert_equal_i16x16(r, easysimd_x_mm256_loadu_epi16(test_vec[2].r));

  src = easysimd_x_mm256_loadu_epi16(test_vec[3].src);
  a = easysimd_x_mm256_loadu_epi8(test_vec[3].a);
  b = easysimd_x_mm256_loadu_epi8(test_vec[3].b);
  r = easysimd_mm256_mask_dbsad_epu8(src, test_vec[3].k, a, b, INT32_C(          60));
  easysimd_test_x86_assert_equal_i16x16(r, easysimd_x_mm256_loadu_epi16(test_vec[3].r));

  src = easysimd_x_mm256_loadu_epi16(test_vec[4].src);
  a = easysimd_x_mm256_loadu_epi8(test_vec[4].a);
  b = easysimd_x_mm256_loadu_epi8(test_vec[4].b);
  r = easysimd_mm256_mask_dbsad_epu8(src, test_vec[4].k, a, b, INT32_C(         214));
  easysimd_test_x86_assert_equal_i16x16(r, easysimd_x_mm256_loadu_epi16(test_vec[4].r));

  src = easysimd_x_mm256_loadu_epi16(test_vec[5].src);
  a = easysimd_x_mm256_loadu_epi8(test_vec[5].a);
  b = easysimd_x_mm256_loadu_epi8(test_vec[5].b);
  r = easysimd_mm256_mask_dbsad_epu8(src, test_vec[5].k, a, b, INT32_C(         112));
  easysimd_test_x86_assert_equal_i16x16(r, easysimd_x_mm256_loadu_epi16(test_vec[5].r));

  src = easysimd_x_mm256_loadu_epi16(test_vec[6].src);
  a = easysimd_x_mm256_loadu_epi8(test_vec[6].a);
  b = easysimd_x_mm256_loadu_epi8(test_vec[6].b);
  r = easysimd_mm256_mask_dbsad_epu8(src, test_vec[6].k, a, b, INT32_C(         217));
  easysimd_test_x86_assert_equal_i16x16(r, easysimd_x_mm256_loadu_epi16(test_vec[6].r));

  src = easysimd_x_mm256_loadu_epi16(test_vec[7].src);
  a = easysimd_x_mm256_loadu_epi8(test_vec[7].a);
  b = easysimd_x_mm256_loadu_epi8(test_vec[7].b);
  r = easysimd_mm256_mask_dbsad_epu8(src, test_vec[7].k, a, b, INT32_C(         253));
  easysimd_test_x86_assert_equal_i16x16(r, easysimd_x_mm256_loadu_epi16(test_vec[7].r));
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    int imm8 = easysimd_test_codegen_random_i32() & 255;
    easysimd__m256i r;
    EASYSIMD_CONSTIFY_256_(easysimd_mm256_mask_dbsad_epu8, r, easysimd_mm256_setzero_si256(), imm8, src, k, a, b);
...
static int
test_easysimd_mm256_maskz_dbsad_epu8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    const easysimd__mmask16 k;
    const int8_t a[32];
  ...
  a = easysimd_x_mm256_loadu_epi8(test_vec[0].a);
  b = easysimd_x_mm256_loadu_epi8(test_vec[0].b);
  r = easysimd_mm256_maskz_dbsad_epu8(test_vec[0].k, a, b, INT32_C(         221));
  easysimd_test_x86_assert_equal_i16x16(r, easysimd_x_mm256_loadu_epi16(test_vec[0].r));

  a = easysimd_x_mm256_loadu_epi8(test_vec[1].a);
  b = easysimd_x_mm256_loadu_epi8(test_vec[1].b);
  r = easysimd_mm256_maskz_dbsad_epu8(test_vec[1].k, a, b, INT32_C(          16));
  easysimd_test_x86_assert_equal_i16x16(r, easysimd_x_mm256_loadu_epi16(test_vec[1].r));

  a = easysimd_x_mm256_loadu_epi8(test_vec[2].a);
  b = easysimd_x_mm256_loadu_epi8(test_vec[2].b);
  r = easysimd_mm256_maskz_dbsad_epu8(test_vec[2].k, a, b, INT32_C(         253));
  easysimd_test_x86_assert_equal_i16x16(r, easysimd_x_mm256_loadu_epi16(test_vec[2].r));

  a = easysimd_x_mm256_loadu_epi8(test_vec[3].a);
  b = easysimd_x_mm256_loadu_epi8(test_vec[3].b);
  r = easysimd_mm256_maskz_dbsad_epu8(test_vec[3].k, a, b, INT32_C(         208));
  easysimd_test_x86_assert_equal_i16x16(r, easysimd_x_mm256_loadu_epi16(test_vec[3].r));

  a = easysimd_x_mm256_loadu_epi8(test_vec[4].a);
  b = easysimd_x_mm256_loadu_epi8(test_vec[4].b);
  r = easysimd_mm256_maskz_dbsad_epu8(test_vec[4].k, a, b, INT32_C(         255));
  easysimd_test_x86_assert_equal_i16x16(r, easysimd_x_mm256_loadu_epi16(test_vec[4].r));

  a = easysimd_x_mm256_loadu_epi8(test_vec[5].a);
  b = easysimd_x_mm256_loadu_epi8(test_vec[5].b);
  r = easysimd_mm256_maskz_dbsad_epu8(test_vec[5].k, a, b, INT32_C(         210));
  easysimd_test_x86_assert_equal_i16x16(r, easysimd_x_mm256_loadu_epi16(test_vec[5].r));

  a = easysimd_x_mm256_loadu_epi8(test_vec[6].a);
  b = easysimd_x_mm256_loadu_epi8(test_vec[6].b);
  r = easysimd_mm256_maskz_dbsad_epu8(test_vec[6].k, a, b, INT32_C(         136));
  easysimd_test_x86_assert_equal_i16x16(r, easysimd_x_mm256_loadu_epi16(test_vec[6].r));

  a = easysimd_x_mm256_loadu_epi8(test_vec[7].a);
  b = easysimd_x_mm256_loadu_epi8(test_vec[7].b);
  r = easysimd_mm256_maskz_dbsad_epu8(test_vec[7].k, a, b, INT32_C(         122));
  easysimd_test_x86_assert_equal_i16x16(r, easysimd_x_mm256_loadu_epi16(test_vec[7].r));
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    int imm8 = easysimd_test_codegen_random_i32() & 255;
    easysimd__m256i r;
    EASYSIMD_CONSTIFY_256_(easysimd_mm256_maskz_dbsad_epu8, r, easysimd_mm256_setzero_si256(), imm8, k, a, b);
...
static int
test_easysimd_mm512_dbsad_epu8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    const int8_t a[64];
    const int8_t b[64];
  ...
  easysimd__m512i a, b, r;

  a = easysimd_mm512_loadu_epi8(test_vec[0].a);
  b = easysimd_mm512_loadu_epi8(test_vec[0].b);
  r = easysimd_mm512_dbsad_epu8(a, b, INT32_C(         226));
  easysimd_test_x86_assert_equal_i16x32(r, easysimd_mm512_loadu_epi16(test_vec[0].r));

  a = easysimd_mm512_loadu_epi8(test_vec[1].a);
  b = easysimd_mm512_loadu_epi8(test_vec[1].b);
  r = easysimd_mm512_dbsad_epu8(a, b, INT32_C(         253));
  easysimd_test_x86_assert_equal_i16x32(r, easysimd_mm512_loadu_epi16(test_vec[1].r));

  a = easysimd_mm512_loadu_epi8(test_vec[2].a);
  b = easysimd_mm512_loadu_epi8(test_vec[2].b);
  r = easysimd_mm512_dbsad_epu8(a, b, INT32_C(         208));
  easysimd_test_x86_assert_equal_i16x32(r, easysimd_mm512_loadu_epi16(test_vec[2].r));

  a = easysimd_mm512_loadu_epi8(test_vec[3].a);
  b = easysimd_mm512_loadu_epi8(test_vec[3].b);
  r = easysimd_mm512_dbsad_epu8(a, b, INT32_C(          84));
  easysimd_test_x86_assert_equal_i16x32(r, easysimd_mm512_loadu_epi16(test_vec[3].r));

  a = easysimd_mm512_loadu_epi8(test_vec[4].a);
  b = easysimd_mm512_loadu_epi8(test_vec[4].b);
  r = easysimd_mm512_dbsad_epu8(a, b, INT32_C(         162));
  easysimd_test_x86_assert_equal_i16x32(r, easysimd_mm512_loadu_epi16(test_vec[4].r));

  a = easysimd_mm512_loadu_epi8(test_vec[5].a);
  b = easysimd_mm512_loadu_epi8(test_vec[5].b);
  r = easysimd_mm512_dbsad_epu8(a, b, INT32_C(          14));
  easysimd_test_x86_assert_equal_i16x32(r, easysimd_mm512_loadu_epi16(test_vec[5].r));

  a = easysimd_mm512_loadu_epi8(test_vec[6].a);
  b = easysimd_mm512_loadu_epi8(test_vec[6].b);
  r = easysimd_mm512_dbsad_epu8(a, b, INT32_C(          81));
  easysimd_test_x86_assert_equal_i16x32(r, easysimd_mm512_loadu_epi16(test_vec[6].r));

  a = easysimd_mm512_loadu_epi8(test_vec[7].a);
  b = easysimd_mm512_loadu_epi8(test_vec[7].b);
  r = easysimd_mm512_dbsad_epu8(a, b, INT32_C(          99));
  easysimd_test_x86_assert_equal_i16x32(r, easysimd_mm512_loadu_epi16(test_vec[7].r));
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    int imm8 = easysimd_test_codegen_random_i32() & 255;
    easysimd__m512i r;
    EASYSIMD_CONSTIFY_256_(easysimd_mm512_dbsad_epu8, r, easysimd_mm512_setzero_si512(), imm8, a, b);
...
static int
test_easysimd_mm512_mask_dbsad_epu8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
  ...
  src = easysimd_mm512_loadu_epi16(test_vec[0].src);
  a = easysimd_mm512_loadu_epi8(test_vec[0].a);
  b = easysimd_mm512_loadu_epi8(test_vec[0].b);
  r = easysimd_mm512_mask_dbsad_epu8(src, test_vec[0].k, a, b, INT32_C(         123));
  easysimd_test_x86_assert_equal_i16x32(r, easysimd_mm512_loadu_epi16(test_vec[0].r));

  src = easysimd_mm512_loadu_epi16(test_vec[1].src);
  a = easysimd_mm512_loadu_epi8(test_vec[1].a);
  b = easysimd_mm512_loadu_epi8(test_vec[1].b);
  r = easysimd_mm512_mask_dbsad_epu8(src, test_vec[1].k, a, b, INT32_C(         171));
  easysimd_test_x86_assert_equal_i16x32(r, easysimd_mm512_loadu_epi16(test_vec[1].r));

  src = easysimd_mm512_loadu_epi16(test_vec[2].src);
  a = easysimd_mm512_loadu_epi8(test_vec[2].a);
  b = easysimd_mm512_loadu_epi8(test_vec[2].b);
  r = easysimd_mm512_mask_dbsad_epu8(src, test_vec[2].k, a, b, INT32_C(         178));
  easysimd_test_x86_assert_equal_i16x32(r, easysimd_mm512_loadu_epi16(test_vec[2].r));

  src = easysimd_mm512_loadu_epi16(test_vec[3].src);
  a = easysimd_mm512_loadu_epi8(test_vec[3].a);
  b = easysimd_mm512_loadu_epi8(test_vec[3].b);
  r = easysimd_mm512_mask_dbsad_epu8(src, test_vec[3].k, a, b, INT32_C(         142));
  easysimd_test_x86_assert_equal_i16x32(r, easysimd_mm512_loadu_epi16(test_vec[3].r));

  src = easysimd_mm512_loadu_epi16(test_vec[4].src);
  a = easysimd_mm512_loadu_epi8(test_vec[4].a);
  b = easysimd_mm512_loadu_epi8(test_vec[4].b);
  r = easysimd_mm512_mask_dbsad_epu8(src, test_vec[4].k, a, b, INT32_C(          28));
  easysimd_test_x86_assert_equal_i16x32(r, easysimd_mm512_loadu_epi16(test_vec[4].r));

  src = easysimd_mm512_loadu_epi16(test_vec[5].src);
  a = easysimd_mm512_loadu_epi8(test_vec[5].a);
  b = easysimd_mm512_loadu_epi8(test_vec[5].b);
  r = easysimd_mm512_mask_dbsad_epu8(src, test_vec[5].k, a, b, INT32_C(         206));
  easysimd_test_x86_assert_equal_i16x32(r, easysimd_mm512_loadu_epi16(test_vec[5].r));

  src = easysimd_mm512_loadu_epi16(test_vec[6].src);
  a = easysimd_mm512_loadu_epi8(test_vec[6].a);
  b = easysimd_mm512_loadu_epi8(test_vec[6].b);
  r = easysimd_mm512_mask_dbsad_epu8(src, test_vec[6].k, a, b, INT32_C(         131));
  easysimd_test_x86_assert_equal_i16x32(r, easysimd_mm512_loadu_epi16(test_vec[6].r));

  src = easysimd_mm512_loadu_epi16(test_vec[7].src);
  a = easysimd_mm512_loadu_epi8(test_vec[7].a);
  b = easysimd_mm512_loadu_epi8(test_vec[7].b);
  r = easysimd_mm512_mask_dbsad_epu8(src, test_vec[7].k, a, b, INT32_C(         212));
  easysimd_test_x86_assert_equal_i16x32(r, easysimd_mm512_loadu_epi16(test_vec[7].r));
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    int imm8 = easysimd_test_codegen_random_i32() & 255;
    easysimd__m512i r;
    EASYSIMD_CONSTIFY_256_(easysimd_mm512_mask_dbsad_epu8, r, easysimd_mm512_setzero_si512(), imm8, src, k, a, b);
...
static int
test_easysimd_mm512_maskz_dbsad_epu8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    const easysimd__mmask32 k;
    const int8_t a[64];
  ...
  a = easysimd_mm512_loadu_epi8(test_vec[0].a);
  b = easysimd_mm512_loadu_epi8(test_vec[0].b);
  r = easysimd_mm512_maskz_dbsad_epu8(test_vec[0].k, a, b, INT32_C(         250));
  easysimd_test_x86_assert_equal_i16x32(r, easysimd_mm512_loadu_epi16(test_vec[0].r));

  a = easysimd_mm512_loadu_epi8(test_vec[1].a);
  b = easysimd_mm512_loadu_epi8(test_vec[1].b);
  r = easysimd_mm512_maskz_dbsad_epu8(test_vec[1].k, a, b, INT32_C(         246));
  easysimd_test_x86_assert_equal_i16x32(r, easysimd_mm512_loadu_epi16(test_vec[1].r));

  a = easysimd_mm512_loadu_epi8(test_vec[2].a);
  b = easysimd_mm512_loadu_epi8(test_vec[2].b);
  r = easysimd_mm512_maskz_dbsad_epu8(test_vec[2].k, a, b, INT32_C(         239));
  easysimd_test_x86_assert_equal_i16x32(r, easysimd_mm512_loadu_epi16(test_vec[2].r));

  a = easysimd_mm512_loadu_epi8(test_vec[3].a);
  b = easysimd_mm512_loadu_epi8(test_vec[3].b);
  r = easysimd_mm512_maskz_dbsad_epu8(test_vec[3].k, a, b, INT32_C(          38));
  easysimd_test_x86_assert_equal_i16x32(r, easysimd_mm512_loadu_epi16(test_vec[3].r));

  a = easysimd_mm512_loadu_epi8(test_vec[4].a);
  b = easysimd_mm512_loadu_epi8(test_vec[4].b);
  r = easysimd_mm512_maskz_dbsad_epu8(test_vec[4].k, a, b, INT32_C(         126));
  easysimd_test_x86_assert_equal_i16x32(r, easysimd_mm512_loadu_epi16(test_vec[4].r));

  a = easysimd_mm512_loadu_epi8(test_vec[5].a);
  b = easysimd_mm512_loadu_epi8(test_vec[5].b);
  r = easysimd_mm512_maskz_dbsad_epu8(test_vec[5].k, a, b, INT32_C(         142));
  easysimd_test_x86_assert_equal_i16x32(r, easysimd_mm512_loadu_epi16(test_vec[5].r));

  a = easysimd_mm512_loadu_epi8(test_vec[6].a);
  b = easysimd_mm512_loadu_epi8(test_vec[6].b);
  r = easysimd_mm512_maskz_dbsad_epu8(test_vec[6].k, a, b, INT32_C(         116));
  easysimd_test_x86_assert_equal_i16x32(r, easysimd_mm512_loadu_epi16(test_vec[6].r));

  a = easysimd_mm512_loadu_epi8(test_vec[7].a);
  b = easysimd_mm512_loadu_epi8(test_vec[7].b);
  r = easysimd_mm512_maskz_dbsad_epu8(test_vec[7].k, a, b, INT32_C(         159));
  easysimd_test_x86_assert_equal_i16x32(r, easysimd_mm512_loadu_epi16(test_vec[7].r));
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    int imm8 = easysimd_test_codegen_random_i32() & 255;
    easysimd__m512i r;
    EASYSIMD_CONSTIFY_256_(easysimd_mm512_maskz_dbsad_epu8, r, easysimd_mm512_setzero_si512(), imm8, k, a, b);
...
EASYSIMD_TEST_FUNC_LIST_BEGIN
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm_dbsad_epu8)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm_mask_dbsad_epu8)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm_maskz_dbsad_epu8)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm256_dbsad_epu8)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm256_mask_dbsad_epu8)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm256_maskz_dbsad_epu8)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm512_dbsad_epu8)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm512_mask_dbsad_epu8)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm512_maskz_dbsad_epu8)
