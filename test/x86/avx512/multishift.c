#define EASYSIMD_TEST_X86_AVX512_INSN multishift

#include <test/x86/avx512/test-avx512.h>
#include <easysimd/x86/avx512/multishift.h>

static int
test_easysimd_mm_multishift_epi64_epi8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    const int8_t a[16];
    const int64_t b[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd__m128i r = easysimd_mm_multishift_epi64_epi8(a, b);
...
static int
test_easysimd_mm_mask_multishift_epi64_epi8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    const int8_t src[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd__m128i r = easysimd_mm_mask_multishift_epi64_epi8(src, test_vec[i].k, a, b);
    easysimd_test_x86_assert_equal_i8x16(r, easysimd_x_mm_loadu_epi8(test_vec[i].r));
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd__m128i a = easysimd_test_x86_random_i8x16();
    easysimd__m128i b = easysimd_test_x86_random_i64x2();
    easysimd__m128i r = easysimd_mm_mask_multishift_epi64_epi8(src, k, a, b);
...
static int
test_easysimd_mm_maskz_multishift_epi64_epi8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    const easysimd__mmask16 k;
    const int8_t a[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd__m128i a = easysimd_x_mm_loadu_epi8(test_vec[i].a);
    easysimd__m128i b = easysimd_x_mm_loadu_epi64(test_vec[i].b);
    easysimd__m128i r = easysimd_mm_maskz_multishift_epi64_epi8(test_vec[i].k, a, b);
    easysimd_test_x86_assert_equal_i8x16(r, easysimd_x_mm_loadu_epi8(test_vec[i].r));
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd__m128i a = easysimd_test_x86_random_i8x16();
    easysimd__m128i b = easysimd_test_x86_random_i64x2();
    easysimd__m128i r = easysimd_mm_maskz_multishift_epi64_epi8(k, a, b);
...
static int
test_easysimd_mm256_multishift_epi64_epi8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    const int8_t a[32];
    const int64_t b[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    EASYSIMD_TEST_PERF_WITH_LOOP_START(100000) {
      r = easysimd_mm256_multishift_epi64_epi8(a, b);
    }
    EASYSIMD_TEST_PERF_END("_mm256_multishift_epi64_epi8 on easysimd");
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd__m256i r = easysimd_mm256_multishift_epi64_epi8(a, b);
...
static int
test_easysimd_mm256_mask_multishift_epi64_epi8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    const int8_t src[32];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd__m256i a = easysimd_x_mm256_loadu_epi8(test_vec[i].a);
    easysimd__m256i b = easysimd_x_mm256_loadu_epi64(test_vec[i].b);
    easysimd__m256i r = easysimd_mm256_mask_multishift_epi64_epi8(src, test_vec[i].k, a, b);
    easysimd_test_x86_assert_equal_i8x32(r, easysimd_x_mm256_loadu_epi8(test_vec[i].r));
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd__m256i a = easysimd_test_x86_random_i8x32();
    easysimd__m256i b = easysimd_test_x86_random_i64x4();
    easysimd__m256i r = easysimd_mm256_mask_multishift_epi64_epi8(src, k, a, b);
...
static int
test_easysimd_mm256_maskz_multishift_epi64_epi8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    const easysimd__mmask32 k;
    const int8_t a[32];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd__m256i a = easysimd_x_mm256_loadu_epi8(test_vec[i].a);
    easysimd__m256i b = easysimd_x_mm256_loadu_epi64(test_vec[i].b);
    easysimd__m256i r = easysimd_mm256_maskz_multishift_epi64_epi8(test_vec[i].k, a, b);
    easysimd_test_x86_assert_equal_i8x32(r, easysimd_x_mm256_loadu_epi8(test_vec[i].r));
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd__m256i a = easysimd_test_x86_random_i8x32();
    easysimd__m256i b = easysimd_test_x86_random_i64x4();
    easysimd__m256i r = easysimd_mm256_maskz_multishift_epi64_epi8(k, a, b);
...
static int
test_easysimd_mm512_multishift_epi64_epi8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    const int8_t a[64];
    const int64_t b[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd__m512i r;
    EASYSIMD_TEST_PERF_WITH_LOOP_START(100000) {
      r = easysimd_mm512_multishift_epi64_epi8(a, b);
    } EASYSIMD_TEST_PERF_END("easysimd_mm512_multishift_epi64_epi8");
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd__m512i r = easysimd_mm512_multishift_epi64_epi8(a, b);
...
static int
test_easysimd_mm512_mask_multishift_epi64_epi8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    const int8_t src[64];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd__m512i a = easysimd_mm512_loadu_epi8(test_vec[i].a);
    easysimd__m512i b = easysimd_mm512_loadu_epi64(test_vec[i].b);
    easysimd__m512i r = easysimd_mm512_mask_multishift_epi64_epi8(src, test_vec[i].k, a, b);
    easysimd_test_x86_assert_equal_i8x64(r, easysimd_mm512_loadu_epi8(test_vec[i].r));
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd__m512i a = easysimd_test_x86_random_i8x64();
    easysimd__m512i b = easysimd_test_x86_random_i64x8();
    easysimd__m512i r = easysimd_mm512_mask_multishift_epi64_epi8(src, k, a, b);
...
static int
test_easysimd_mm512_maskz_multishift_epi64_epi8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    const easysimd__mmask64 k;
    const int8_t a[64];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd__m512i a = easysimd_mm512_loadu_epi8(test_vec[i].a);
    easysimd__m512i b = easysimd_mm512_loadu_epi64(test_vec[i].b);
    easysimd__m512i r = easysimd_mm512_maskz_multishift_epi64_epi8(test_vec[i].k, a, b);
    easysimd_test_x86_assert_equal_i8x64(r, easysimd_mm512_loadu_epi8(test_vec[i].r));
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd__m512i a = easysimd_test_x86_random_i8x64();
    easysimd__m512i b = easysimd_test_x86_random_i64x8();
    easysimd__m512i r = easysimd_mm512_maskz_multishift_epi64_epi8(k, a, b);
...
EASYSIMD_TEST_FUNC_LIST_BEGIN
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm_multishift_epi64_epi8)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm_mask_multishift_epi64_epi8)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm_maskz_multishift_epi64_epi8)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm256_multishift_epi64_epi8)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm256_mask_multishift_epi64_epi8)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm256_maskz_multishift_epi64_epi8)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm512_multishift_epi64_epi8)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm512_mask_multishift_epi64_epi8)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm512_maskz_multishift_epi64_epi8)
