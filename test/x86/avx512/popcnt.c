#define EASYSIMD_TEST_X86_AVX512_INSN popcnt

#include <test/x86/avx512/test-avx512.h>
#include <easysimd/x86/avx512/popcnt.h>

static int
test_easysimd_mm_popcnt_epi8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    const int8_t a[16];
    const int8_t r[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd__m128i r = easysimd_mm_popcnt_epi8(a);
...
static int
test_easysimd_mm_mask_popcnt_epi8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    const int8_t src[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd__m128i r = easysimd_mm_mask_popcnt_epi8(src, test_vec[i].k, a);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd__m128i a = easysimd_test_x86_random_i8x16();
    easysimd__m128i r = easysimd_mm_mask_popcnt_epi8(src, k, a);
...
static int
test_easysimd_mm_maskz_popcnt_epi8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    const easysimd__mmask16 k;
    const int8_t a[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd__m128i a = easysimd_x_mm_loadu_epi8(test_vec[i].a);
    easysimd__m128i r = easysimd_mm_maskz_popcnt_epi8(test_vec[i].k, a);
    easysimd_test_x86_assert_equal_i8x16(r, easysimd_x_mm_loadu_epi8(test_vec[i].r));
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    easysimd__mmask16 k = easysimd_test_x86_random_mmask16();
    easysimd__m128i a = easysimd_test_x86_random_i8x16();
    easysimd__m128i r = easysimd_mm_maskz_popcnt_epi8(k, a);
...
static int
test_easysimd_mm_popcnt_epi16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    const int16_t a[8];
    const int16_t r[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd__m128i r = easysimd_mm_popcnt_epi16(a);
...
static int
test_easysimd_mm_mask_popcnt_epi16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    const int16_t src[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd__m128i r = easysimd_mm_mask_popcnt_epi16(src, test_vec[i].k, a);
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd__m128i a = easysimd_test_x86_random_i16x8();
    easysimd__m128i r = easysimd_mm_mask_popcnt_epi16(src, k, a);
...
static int
test_easysimd_mm_maskz_popcnt_epi16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    const easysimd__mmask8 k;
    const int16_t a[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd__m128i a = easysimd_x_mm_loadu_epi16(test_vec[i].a);
    easysimd__m128i r = easysimd_mm_maskz_popcnt_epi16(test_vec[i].k, a);
    easysimd_test_x86_assert_equal_i16x8(r, easysimd_x_mm_loadu_epi16(test_vec[i].r));
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    easysimd__mmask8 k = easysimd_test_x86_random_mmask8();
    easysimd__m128i a = easysimd_test_x86_random_i16x8();
    easysimd__m128i r = easysimd_mm_maskz_popcnt_epi16(k, a);
...
static int
test_easysimd_mm_popcnt_epi32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    const int32_t a[4];
    const int32_t r[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd__m128i r = easysimd_mm_popcnt_epi32(a);
...
static int
test_easysimd_mm_mask_popcnt_epi32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    const int32_t src[4];
    const easysimd__mmask8 k;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd__m128i a = easysimd_x_mm_loadu_epi32(test_vec[i].a);
    easysimd__m128i r = easysimd_mm_mask_popcnt_epi32(src, test_vec[i].k, a);
    easysimd_test_x86_assert_equal_i32x4(r, easysimd_x_mm_loadu_epi32(test_vec[i].r));
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd__mmask8 k = easysimd_test_x86_random_mmask8();
    easysimd__m128i a = easysimd_test_x86_random_i32x4();
    easysimd__m128i r = easysimd_mm_mask_popcnt_epi32(src, k, a);
...
static int
test_easysimd_mm_maskz_popcnt_epi32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    const easysimd__mmask8 k;
    const int32_t a[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd__m128i a = easysimd_x_mm_loadu_epi32(test_vec[i].a);
    easysimd__m128i r = easysimd_mm_maskz_popcnt_epi32(test_vec[i].k, a);
    easysimd_test_x86_assert_equal_i32x4(r, easysimd_x_mm_loadu_epi32(test_vec[i].r));
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    easysimd__mmask8 k = easysimd_test_x86_random_mmask8();
    easysimd__m128i a = easysimd_test_x86_random_i32x4();
    easysimd__m128i r = easysimd_mm_maskz_popcnt_epi32(k, a);
...
static int
test_easysimd_mm_popcnt_u32(EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint32_t a[4];
    int32_t  r[4];
  } test_vec[8] = {
    { { UINT32_C(1695464278), UINT32_C(2460167705), UINT32_C(2864655467), UINT32_C(1181696016) },
      {  INT32_C(        17),  INT32_C(        14),  INT32_C(        19),  INT32_C(        11) } },
    { { UINT32_C(1120853645), UINT32_C(3500407520), UINT32_C(2376481582), UINT32_C(4257668263) },
      {  INT32_C(        17),  INT32_C(        16),  INT32_C(        17),  INT32_C(        21) } },
    { { UINT32_C(2976044184), UINT32_C(1849885954), UINT32_C(1092092721), UINT32_C(3498542915) },
      {  INT32_C(        14),  INT32_C(        11),  INT32_C(         9),  INT32_C(        14) } },
    { { UINT32_C(1175606886), UINT32_C(2115417680), UINT32_C(2550906097), UINT32_C( 831902105) },
      {  INT32_C(        13),  INT32_C(        16),  INT32_C(        16),  INT32_C(        15) } },
    { { UINT32_C(2833446822), UINT32_C( 773203708), UINT32_C(1819225897), UINT32_C( 473757622) },
      {  INT32_C(        18),  INT32_C(        16),  INT32_C(        18),  INT32_C(        19) } },
    { { UINT32_C(2640531021), UINT32_C(4128995588), UINT32_C(3482199606), UINT32_C(2634032375) },
      {  INT32_C(        17),  INT32_C(        16),  INT32_C(        17),  INT32_C(        14) } },
    { { UINT32_C( 407298587), UINT32_C( 826694664), UINT32_C(1117631883), UINT32_C(4183742892) },
      {  INT32_C(        13),  INT32_C(        11),  INT32_C(        16),  INT32_C(        20) } },
    { { UINT32_C( 748077352), UINT32_C(1898099003), UINT32_C(3477123543), UINT32_C(4033626325) },
      {  INT32_C(        12),  INT32_C(        15),  INT32_C(        17),  INT32_C(        14) } }
  };

  easysimd__m128i_private ret;
  for(size_t i = 0; i < sizeof(test_vec) / sizeof(test_vec[0]); i++){
    for(size_t j = 0; j < sizeof(test_vec[i].a) / sizeof(test_vec[i].a[0]); j++){
      EASYSIMD_TEST_PERF_WITH_LOOP_START(100000) {
        ret.i32[j] = easysimd_mm_popcnt_u32(test_vec[i].a[j]);
      }
      EASYSIMD_TEST_PERF_END("_mm_popcnt_u32 on easysimd-SVE");
    }
    easysimd_assert_m128i_i32(easysimd_x_mm_loadu_epi32(test_vec[i].r), ==, easysimd__m128i_from_private(ret));
  }
...
static int
test_easysimd_mm_popcnt_u64(EASYSIMD_MUNIT_TEST_ARGS) {
  struct {
    uint64_t a[2];
    int64_t  r[2];
  } test_vec[8] = {
    { { UINT64_C( 6623591241687674098), UINT64_C(17477894542918880769) },
      {  INT64_C(                  34),  INT64_C(                  30) } },
    { { UINT64_C(10613721777054188073), UINT64_C( 1196215999693004519) },
      {  INT64_C(                  27),  INT64_C(                  29) } },
    { { UINT64_C( 9366384967227721597), UINT64_C( 9552753128724850467) },
      {  INT64_C(                  29),  INT64_C(                  27) } },
    { { UINT64_C( 2378105363341751988), UINT64_C(11891440531676944345) },
      {  INT64_C(                  30),  INT64_C(                  31) } },
    { { UINT64_C( 7686310058162270633), UINT64_C( 4073677949479047593) },
      {  INT64_C(                  27),  INT64_C(                  22) } },
    { { UINT64_C(10064881829013682002), UINT64_C( 9424214157156284156) },
      {  INT64_C(                  32),  INT64_C(                  28) } },
    { { UINT64_C(18044049391730036665), UINT64_C( 7089939113125508008) },
      {  INT64_C(                  39),  INT64_C(                  31) } },
    { { UINT64_C(12230541480718895230), UINT64_C( 9074074594587786386) },
      {  INT64_C(                  34),  INT64_C(                  36) } },
  };

  for(size_t i = 0; i < sizeof(test_vec) / sizeof(test_vec[0]); i++){
    easysimd__m128i_private ret;
    for(size_t j = 0; j < sizeof(test_vec[i].a) / sizeof(test_vec[i].a[0]); j++){
      int64_t par = test_vec[i].a[j];
      int32_t res;
      EASYSIMD_TEST_PERF_WITH_LOOP_START(100000) {
        res = easysimd_mm_popcnt_u64(par);
      }
      EASYSIMD_TEST_PERF_END("_mm_popcnt_u64 on easysimd");
      ret.i64[j] = (int64_t)res;
    }
    easysimd_assert_m128i_i64(easysimd_x_mm_loadu_epi64(test_vec[i].r), ==, easysimd__m128i_from_private(ret));
  }
...
static int
test_easysimd_mm_popcnt_epi64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    const int64_t a[2];
    const int64_t r[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd__m128i r = easysimd_mm_popcnt_epi64(a);
...
static int
test_easysimd_mm_mask_popcnt_epi64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    const int64_t src[2];
    const easysimd__mmask8 k;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd__m128i a = easysimd_x_mm_loadu_epi64(test_vec[i].a);
    easysimd__m128i r = easysimd_mm_mask_popcnt_epi64(src, test_vec[i].k, a);
    easysimd_test_x86_assert_equal_i64x2(r, easysimd_x_mm_loadu_epi64(test_vec[i].r));
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd__mmask8 k = easysimd_test_x86_random_mmask8();
    easysimd__m128i a = easysimd_test_x86_random_i64x2();
    easysimd__m128i r = easysimd_mm_mask_popcnt_epi64(src, k, a);
...
static int
test_easysimd_mm_maskz_popcnt_epi64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    const easysimd__mmask8 k;
    const int64_t a[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd__m128i a = easysimd_x_mm_loadu_epi64(test_vec[i].a);
    easysimd__m128i r = easysimd_mm_maskz_popcnt_epi64(test_vec[i].k, a);
    easysimd_test_x86_assert_equal_i64x2(r, easysimd_x_mm_loadu_epi64(test_vec[i].r));
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    easysimd__mmask8 k = easysimd_test_x86_random_mmask8();
    easysimd__m128i a = easysimd_test_x86_random_i64x2();
    easysimd__m128i r = easysimd_mm_maskz_popcnt_epi64(k, a);
...
static int
test_easysimd_mm256_popcnt_epi8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    const int8_t a[32];
    const int8_t r[32];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd__m256i r;
    EASYSIMD_TEST_PERF_WITH_LOOP_START(100000) {
      r = easysimd_mm256_popcnt_epi8(a);
    }
    EASYSIMD_TEST_PERF_END("_mm256_popcnt_epi8");
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd__m256i r = easysimd_mm256_popcnt_epi8(a);
...
static int
test_easysimd_mm256_mask_popcnt_epi8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    const int8_t src[32];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd__m256i a = easysimd_x_mm256_loadu_epi8(test_vec[i].a);
    easysimd__m256i r = easysimd_mm256_mask_popcnt_epi8(src, test_vec[i].k, a);
    easysimd_test_x86_assert_equal_i8x32(r, easysimd_x_mm256_loadu_epi8(test_vec[i].r));
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd__m256i a = easysimd_test_x86_random_i8x32();
    easysimd__m256i r = easysimd_mm256_mask_popcnt_epi8(src, k, a);
...
static int
test_easysimd_mm256_maskz_popcnt_epi8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    const easysimd__mmask32 k;
    const int8_t a[32];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd__m256i a = easysimd_x_mm256_loadu_epi8(test_vec[i].a);
    easysimd__m256i r = easysimd_mm256_maskz_popcnt_epi8(test_vec[i].k, a);
    easysimd_test_x86_assert_equal_i8x32(r, easysimd_x_mm256_loadu_epi8(test_vec[i].r));
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    easysimd__mmask32 k = easysimd_test_x86_random_mmask32();
    easysimd__m256i a = easysimd_test_x86_random_i8x32();
    easysimd__m256i r = easysimd_mm256_maskz_popcnt_epi8(k, a);
...
static int
test_easysimd_mm256_popcnt_epi16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    const int16_t a[16];
    const int16_t r[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd__m256i r;
    EASYSIMD_TEST_PERF_WITH_LOOP_START(100000) {
      r = easysimd_mm256_popcnt_epi16(a);
    }
    EASYSIMD_TEST_PERF_END("_mm256_popcnt_epi16");
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd__m256i r = easysimd_mm256_popcnt_epi16(a);
...
static int
test_easysimd_mm256_mask_popcnt_epi16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd__m256i a = easysimd_x_mm256_loadu_epi16(test_vec[i].a);
    easysimd__m256i r = easysimd_mm256_mask_popcnt_epi16(src, test_vec[i].k, a);
    easysimd_test_x86_assert_equal_i16x16(r, easysimd_x_mm256_loadu_epi16(test_vec[i].r));
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd__mmask16 k = easysimd_test_x86_random_mmask16();
    easysimd__m256i a = easysimd_test_x86_random_i16x16();
    easysimd__m256i r = easysimd_mm256_mask_popcnt_epi16(src, k, a);
...
static int
test_easysimd_mm256_maskz_popcnt_epi16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    const easysimd__mmask16 k;
    const int16_t a[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd__m256i a = easysimd_x_mm256_loadu_epi16(test_vec[i].a);
    easysimd__m256i r = easysimd_mm256_maskz_popcnt_epi16(test_vec[i].k, a);
    easysimd_test_x86_assert_equal_i16x16(r, easysimd_x_mm256_loadu_epi16(test_vec[i].r));
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    easysimd__mmask16 k = easysimd_test_x86_random_mmask16();
    easysimd__m256i a = easysimd_test_x86_random_i16x16();
    easysimd__m256i r = easysimd_mm256_maskz_popcnt_epi16(k, a);
...
static int
test_easysimd_mm256_popcnt_epi32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    const int32_t a[8];
    const int32_t r[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd__m256i r;
    EASYSIMD_TEST_PERF_WITH_LOOP_START(100000) {
      r = easysimd_mm256_popcnt_epi32(a);
    }
    EASYSIMD_TEST_PERF_END("_mm256_popcnt_epi32");
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd__m256i r = easysimd_mm256_popcnt_epi32(a);
...
static int
test_easysimd_mm256_mask_popcnt_epi32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    const int32_t src[8];
    const easysimd__mmask8 k;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd__m256i a = easysimd_x_mm256_loadu_epi32(test_vec[i].a);
    easysimd__m256i r = easysimd_mm256_mask_popcnt_epi32(src, k, a);
    easysimd_test_x86_assert_equal_i32x8(r, easysimd_x_mm256_loadu_epi32(test_vec[i].r));
  }
...
static int
test_easysimd_mm256_maskz_popcnt_epi32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    const easysimd__mmask8 k;
    const int32_t a[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd__mmask8 k = test_vec[i].k;
    easysimd__m256i a = easysimd_x_mm256_loadu_epi32(test_vec[i].a);
    easysimd__m256i r = easysimd_mm256_maskz_popcnt_epi32(k, a);
    easysimd_test_x86_assert_equal_i32x8(r, easysimd_x_mm256_loadu_epi32(test_vec[i].r));
  }
...
static int
test_easysimd_mm256_popcnt_epi64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    const int64_t a[4];
    const int64_t r[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd__m256i r;
    EASYSIMD_TEST_PERF_WITH_LOOP_START(100000) {
      r = easysimd_mm256_popcnt_epi64(a);
    }
    EASYSIMD_TEST_PERF_END("_mm256_popcnt_epi64");
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd__m256i r = easysimd_mm256_popcnt_epi64(a);
...
static int
test_easysimd_mm256_mask_popcnt_epi64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    const int64_t src[4];
    const easysimd__mmask8 k;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd__mmask8 k = test_vec[i].k;
    easysimd__m256i a = easysimd_x_mm256_loadu_epi64(test_vec[i].a);
    easysimd__m256i r = easysimd_mm256_mask_popcnt_epi64(src, k, a);
    easysimd_test_x86_assert_equal_i64x4(r, easysimd_x_mm256_loadu_epi64(test_vec[i].r));
  }
...
static int
test_easysimd_mm256_maskz_popcnt_epi64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    const easysimd__mmask8 k;
    const int64_t a[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd__mmask8 k = test_vec[i].k;
    easysimd__m256i a = easysimd_x_mm256_loadu_epi64(test_vec[i].a);
    easysimd__m256i r = easysimd_mm256_maskz_popcnt_epi64(k, a);
    easysimd_test_x86_assert_equal_i64x4(r, easysimd_x_mm256_loadu_epi64(test_vec[i].r));
  }
...
static int
test_easysimd_mm512_popcnt_epi8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    const int8_t a[64];
    const int8_t r[64];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd__m512i r;
    EASYSIMD_TEST_PERF_WITH_LOOP_START(100000) {
      r = easysimd_mm512_popcnt_epi8(a);
    }
    EASYSIMD_TEST_PERF_END("_mm512_popcnt_epi8");
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd__m512i r = easysimd_mm512_popcnt_epi8(a);
...
static int
test_easysimd_mm512_mask_popcnt_epi8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    const int8_t src[64];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd__m512i r;
    EASYSIMD_TEST_PERF_WITH_LOOP_START(100000) {
      r = easysimd_mm512_mask_popcnt_epi8(src, k, a);
    }
    EASYSIMD_TEST_PERF_END("_mm512_mask_popcnt_epi8");
    easysimd_test_x86_assert_equal_i8x64(r, easysimd_mm512_loadu_epi8(test_vec[i].r));
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd__m512i a = easysimd_test_x86_random_i8x64();
    easysimd__m512i r = easysimd_mm512_mask_popcnt_epi8(src, k, a);
...
static int
test_easysimd_mm512_maskz_popcnt_epi8 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    const easysimd__mmask64 k;
    const int8_t a[64];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd__m512i r;
    EASYSIMD_TEST_PERF_WITH_LOOP_START(100000) {
      r = easysimd_mm512_maskz_popcnt_epi8(k, a);
    }
    EASYSIMD_TEST_PERF_END("_mm512_maskz_popcnt_epi8");
    easysimd_test_x86_assert_equal_i8x64(r, easysimd_mm512_loadu_epi8(test_vec[i].r));
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    easysimd__mmask64 k = easysimd_test_x86_random_mmask64();
    easysimd__m512i a = easysimd_test_x86_random_i8x64();
    easysimd__m512i r = easysimd_mm512_maskz_popcnt_epi8(k, a);
...
static int
test_easysimd_mm512_popcnt_epi16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    const int16_t a[32];
    const int16_t r[32];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd__m512i r;
    EASYSIMD_TEST_PERF_WITH_LOOP_START(100000) {
      r = easysimd_mm512_popcnt_epi16(a);
    }
    EASYSIMD_TEST_PERF_END("_mm512_popcnt_epi16");
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd__m512i r = easysimd_mm512_popcnt_epi16(a);
...
static int
test_easysimd_mm512_mask_popcnt_epi16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd__m512i r;
    EASYSIMD_TEST_PERF_WITH_LOOP_START(100000) {
      r = easysimd_mm512_mask_popcnt_epi16(src, k, a);
    }
    EASYSIMD_TEST_PERF_END("_mm512_mask_popcnt_epi16");
    easysimd_test_x86_assert_equal_i16x32(r, easysimd_mm512_loadu_epi16(test_vec[i].r));
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd__mmask32 k = easysimd_test_x86_random_mmask32();
    easysimd__m512i a = easysimd_test_x86_random_i16x32();
    easysimd__m512i r = easysimd_mm512_mask_popcnt_epi16(src, k, a);
...
static int
test_easysimd_mm512_maskz_popcnt_epi16 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    const easysimd__mmask32 k;
    const int16_t a[32];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd__m512i r;
    EASYSIMD_TEST_PERF_WITH_LOOP_START(100000) {
      r = easysimd_mm512_maskz_popcnt_epi16(k, a);
    }
    EASYSIMD_TEST_PERF_END("_mm512_maskz_popcnt_epi16");
    easysimd_test_x86_assert_equal_i16x32(r, easysimd_mm512_loadu_epi16(test_vec[i].r));
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    easysimd__mmask32 k = easysimd_test_x86_random_mmask32();
    easysimd__m512i a = easysimd_test_x86_random_i16x32();
    easysimd__m512i r = easysimd_mm512_maskz_popcnt_epi16(k, a);
...
static int
test_easysimd_mm512_popcnt_epi32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    const int32_t a[16];
    const int32_t r[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd__m512i r;
    EASYSIMD_TEST_PERF_WITH_LOOP_START(100000) {
      r = easysimd_mm512_popcnt_epi32(a);
    }
    EASYSIMD_TEST_PERF_END("_mm512_popcnt_epi32");
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd__m512i r = easysimd_mm512_popcnt_epi32(a);
...
static int
test_easysimd_mm512_mask_popcnt_epi32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd__m512i r;
    EASYSIMD_TEST_PERF_WITH_LOOP_START(100000) {
      r = easysimd_mm512_mask_popcnt_epi32(src, k, a);
    }
    EASYSIMD_TEST_PERF_END("_mm512_mask_popcnt_epi32");
    easysimd_test_x86_assert_equal_i32x16(r, easysimd_mm512_loadu_epi32(test_vec[i].r));
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd__mmask16 k = easysimd_test_x86_random_mmask16();
    easysimd__m512i a = easysimd_test_x86_random_i32x16();
    easysimd__m512i r = easysimd_mm512_mask_popcnt_epi32(src, k, a);
...
static int
test_easysimd_mm512_maskz_popcnt_epi32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    const easysimd__mmask16 k;
    const int32_t a[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd__m512i r;
    EASYSIMD_TEST_PERF_WITH_LOOP_START(100000) {
      r = easysimd_mm512_maskz_popcnt_epi32(k, a);
    }
    EASYSIMD_TEST_PERF_END("_mm512_maskz_popcnt_epi32");
    easysimd_test_x86_assert_equal_i32x16(r, easysimd_mm512_loadu_epi32(test_vec[i].r));
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    easysimd__mmask16 k = easysimd_test_x86_random_mmask16();
    easysimd__m512i a = easysimd_test_x86_random_i32x16();
    easysimd__m512i r = easysimd_mm512_maskz_popcnt_epi32(k, a);
...
static int
test_easysimd_mm512_popcnt_epi64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    const int64_t a[8];
    const int64_t r[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd__m512i r;
    EASYSIMD_TEST_PERF_WITH_LOOP_START(100000) {
      r = easysimd_mm512_popcnt_epi64(a);
    }
    EASYSIMD_TEST_PERF_END("_mm512_popcnt_epi64");
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd__m512i r = easysimd_mm512_popcnt_epi64(a);
...
static int
test_easysimd_mm512_mask_popcnt_epi64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    const int64_t src[8];
    const easysimd__mmask8 k;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd__m512i r;
    EASYSIMD_TEST_PERF_WITH_LOOP_START(100000) {
      r = easysimd_mm512_mask_popcnt_epi64(src, k, a);
    }
    EASYSIMD_TEST_PERF_END("_mm512_mask_popcnt_epi64");
    easysimd_test_x86_assert_equal_i64x8(r, easysimd_mm512_loadu_epi64(test_vec[i].r));
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd__mmask8 k = easysimd_test_x86_random_mmask8();
    easysimd__m512i a = easysimd_test_x86_random_i64x8();
    easysimd__m512i r = easysimd_mm512_mask_popcnt_epi64(src, k, a);
...
static int
test_easysimd_mm512_maskz_popcnt_epi64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    const easysimd__mmask8 k;
    const int64_t a[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd__m512i r;
    EASYSIMD_TEST_PERF_WITH_LOOP_START(100000) {
      r = easysimd_mm512_maskz_popcnt_epi64(k, a);
    }
    EASYSIMD_TEST_PERF_END("_mm512_maskz_popcnt_epi64");
    easysimd_test_x86_assert_equal_i64x8(r, easysimd_mm512_loadu_epi64(test_vec[i].r));
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    easysimd__mmask8 k = easysimd_test_x86_random_mmask8();
    easysimd__m512i a = easysimd_test_x86_random_i64x8();
    easysimd__m512i r = easysimd_mm512_maskz_popcnt_epi64(k, a);
...
EASYSIMD_TEST_FUNC_LIST_BEGIN
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm_popcnt_epi8)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm_mask_popcnt_epi8)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm_maskz_popcnt_epi8)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm_popcnt_epi16)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm_mask_popcnt_epi16)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm_maskz_popcnt_epi16)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm_popcnt_epi32)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm_mask_popcnt_epi32)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm_maskz_popcnt_epi32)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm_popcnt_epi64)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm_popcnt_u32)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm_popcnt_u64)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm_mask_popcnt_epi64)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm_maskz_popcnt_epi64)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm256_popcnt_epi8)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm256_mask_popcnt_epi8)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm256_maskz_popcnt_epi8)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm256_popcnt_epi16)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm256_mask_popcnt_epi16)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm256_maskz_popcnt_epi16)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm256_popcnt_epi32)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm256_mask_popcnt_epi32)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm256_maskz_popcnt_epi32)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm256_popcnt_epi64)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm256_mask_popcnt_epi64)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm256_maskz_popcnt_epi64)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm512_popcnt_epi8)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm512_mask_popcnt_epi8)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm512_maskz_popcnt_epi8)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm512_popcnt_epi16)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm512_mask_popcnt_epi16)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm512_maskz_popcnt_epi16)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm512_popcnt_epi32)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm512_mask_popcnt_epi32)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm512_maskz_popcnt_epi32)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm512_popcnt_epi64)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm512_mask_popcnt_epi64)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm512_maskz_popcnt_epi64)
