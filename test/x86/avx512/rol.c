#define EASYSIMD_TEST_X86_AVX512_INSN rol

#include <test/x86/avx512/test-avx512.h>
#include <easysimd/x86/avx512/rol.h>

static int
test_easysimd_mm_rol_epi32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    const int32_t a[4];
    const int32_t imm8;
  ...
  EASYSIMD_TEST_PERF_WITH_LOOP_START(100000) {
    r = easysimd_mm_rol_epi32(a, INT32_C(         142));
  } EASYSIMD_TEST_PERF_END("easysimd_mm_rol_epi32");
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd__m128i r;
    EASYSIMD_CONSTIFY_256_(easysimd_mm_rol_epi32, r, easysimd_mm_setzero_si128(), imm8, a);
...
static int
test_easysimd_mm_mask_rol_epi32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    const int32_t src[4];
  ...
  a = easysimd_x_mm_loadu_epi32(test_vec[0].a);
  r = easysimd_mm_mask_rol_epi32(src, test_vec[0].k, a, INT32_C(         214));
  easysimd_test_x86_assert_equal_i32x4(r, easysimd_x_mm_loadu_epi32(test_vec[0].r));

  src = easysimd_x_mm_loadu_epi32(test_vec[1].src);
  a = easysimd_x_mm_loadu_epi32(test_vec[1].a);
  r = easysimd_mm_mask_rol_epi32(src, test_vec[1].k, a, INT32_C(         115));
  easysimd_test_x86_assert_equal_i32x4(r, easysimd_x_mm_loadu_epi32(test_vec[1].r));

  src = easysimd_x_mm_loadu_epi32(test_vec[2].src);
  a = easysimd_x_mm_loadu_epi32(test_vec[2].a);
  r = easysimd_mm_mask_rol_epi32(src, test_vec[2].k, a, INT32_C(         223));
  easysimd_test_x86_assert_equal_i32x4(r, easysimd_x_mm_loadu_epi32(test_vec[2].r));

  src = easysimd_x_mm_loadu_epi32(test_vec[3].src);
  a = easysimd_x_mm_loadu_epi32(test_vec[3].a);
  r = easysimd_mm_mask_rol_epi32(src, test_vec[3].k, a, INT32_C(         219));
  easysimd_test_x86_assert_equal_i32x4(r, easysimd_x_mm_loadu_epi32(test_vec[3].r));

  src = easysimd_x_mm_loadu_epi32(test_vec[4].src);
  a = easysimd_x_mm_loadu_epi32(test_vec[4].a);
  r = easysimd_mm_mask_rol_epi32(src, test_vec[4].k, a, INT32_C(         130));
  easysimd_test_x86_assert_equal_i32x4(r, easysimd_x_mm_loadu_epi32(test_vec[4].r));

  src = easysimd_x_mm_loadu_epi32(test_vec[5].src);
  a = easysimd_x_mm_loadu_epi32(test_vec[5].a);
  r = easysimd_mm_mask_rol_epi32(src, test_vec[5].k, a, INT32_C(         229));
  easysimd_test_x86_assert_equal_i32x4(r, easysimd_x_mm_loadu_epi32(test_vec[5].r));

  src = easysimd_x_mm_loadu_epi32(test_vec[6].src);
  a = easysimd_x_mm_loadu_epi32(test_vec[6].a);
  r = easysimd_mm_mask_rol_epi32(src, test_vec[6].k, a, INT32_C(         197));
  easysimd_test_x86_assert_equal_i32x4(r, easysimd_x_mm_loadu_epi32(test_vec[6].r));

  src = easysimd_x_mm_loadu_epi32(test_vec[7].src);
  a = easysimd_x_mm_loadu_epi32(test_vec[7].a);
  EASYSIMD_TEST_PERF_WITH_LOOP_START(100000) {
    r = easysimd_mm_mask_rol_epi32(src, test_vec[7].k, a, INT32_C(          17));
  } EASYSIMD_TEST_PERF_END("easysimd_mm_mask_rol_epi32");
  easysimd_test_x86_assert_equal_i32x4(r, easysimd_x_mm_loadu_epi32(test_vec[7].r));
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    int imm8 = easysimd_test_codegen_random_i32() & 255;
    easysimd__m128i r;
    EASYSIMD_CONSTIFY_256_(easysimd_mm_mask_rol_epi32, r, easysimd_mm_setzero_si128(), imm8, src, k, a);
...
static int
test_easysimd_mm_maskz_rol_epi32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    const easysimd__mmask8 k;
    const int32_t a[4];
  ...
  a = easysimd_x_mm_loadu_epi32(test_vec[0].a);
  r = easysimd_mm_maskz_rol_epi32(test_vec[0].k, a, INT32_C(         218));
  easysimd_test_x86_assert_equal_i32x4(r, easysimd_x_mm_loadu_epi32(test_vec[0].r));

  a = easysimd_x_mm_loadu_epi32(test_vec[1].a);
  r = easysimd_mm_maskz_rol_epi32(test_vec[1].k, a, INT32_C(         255));
  easysimd_test_x86_assert_equal_i32x4(r, easysimd_x_mm_loadu_epi32(test_vec[1].r));

  a = easysimd_x_mm_loadu_epi32(test_vec[2].a);
  r = easysimd_mm_maskz_rol_epi32(test_vec[2].k, a, INT32_C(         250));
  easysimd_test_x86_assert_equal_i32x4(r, easysimd_x_mm_loadu_epi32(test_vec[2].r));

  a = easysimd_x_mm_loadu_epi32(test_vec[3].a);
  r = easysimd_mm_maskz_rol_epi32(test_vec[3].k, a, INT32_C(           9));
  easysimd_test_x86_assert_equal_i32x4(r, easysimd_x_mm_loadu_epi32(test_vec[3].r));

  a = easysimd_x_mm_loadu_epi32(test_vec[4].a);
  r = easysimd_mm_maskz_rol_epi32(test_vec[4].k, a, INT32_C(         110));
  easysimd_test_x86_assert_equal_i32x4(r, easysimd_x_mm_loadu_epi32(test_vec[4].r));

  a = easysimd_x_mm_loadu_epi32(test_vec[5].a);
  r = easysimd_mm_maskz_rol_epi32(test_vec[5].k, a, INT32_C(         159));
  easysimd_test_x86_assert_equal_i32x4(r, easysimd_x_mm_loadu_epi32(test_vec[5].r));

  a = easysimd_x_mm_loadu_epi32(test_vec[6].a);
  r = easysimd_mm_maskz_rol_epi32(test_vec[6].k, a, INT32_C(          16));
  easysimd_test_x86_assert_equal_i32x4(r, easysimd_x_mm_loadu_epi32(test_vec[6].r));

  a = easysimd_x_mm_loadu_epi32(test_vec[7].a);
  EASYSIMD_TEST_PERF_WITH_LOOP_START(100000) {
    r = easysimd_mm_maskz_rol_epi32(test_vec[7].k, a, INT32_C(          22));
  } EASYSIMD_TEST_PERF_END("easysimd_mm_maskz_rol_epi32");
  easysimd_test_x86_assert_equal_i32x4(r, easysimd_x_mm_loadu_epi32(test_vec[7].r));
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    int imm8 = easysimd_test_codegen_random_i32() & 255;
    easysimd__m128i r;
    EASYSIMD_CONSTIFY_256_(easysimd_mm_maskz_rol_epi32, r, easysimd_mm_setzero_si128(), imm8, k, a);
...
static int
test_easysimd_mm256_rol_epi32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    const int32_t a[8];
    const int32_t imm8;
  ...
  r = easysimd_mm256_rol_epi32(a, INT32_C(          62));
  ...
  r = easysimd_mm256_rol_epi32(a, INT32_C(         183));
  ...
  r = easysimd_mm256_rol_epi32(a, INT32_C(          18));
  ...
  r = easysimd_mm256_rol_epi32(a, INT32_C(         129));
  ...
  r = easysimd_mm256_rol_epi32(a, INT32_C(         139));
  ...
  r = easysimd_mm256_rol_epi32(a, INT32_C(           3));
  ...
  r = easysimd_mm256_rol_epi32(a, INT32_C(          59));
  ...
  EASYSIMD_TEST_PERF_WITH_LOOP_START(100000) {
    r = easysimd_mm256_rol_epi32(a, INT32_C(         198));
  } EASYSIMD_TEST_PERF_END("easysimd_mm256_rol_epi32");
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    int imm8 = easysimd_test_codegen_random_i32() & 255;
    easysimd__m256i r;
    EASYSIMD_CONSTIFY_256_(easysimd_mm256_rol_epi32, r, easysimd_mm256_setzero_si256(), imm8, a);
...
static int
test_easysimd_mm256_mask_rol_epi32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    const int32_t src[8];
    const easysimd__mmask8 k;
  ...
  a = easysimd_x_mm256_loadu_epi32(test_vec[0].a);
  r = easysimd_mm256_mask_rol_epi32(src, test_vec[0].k, a, INT32_C(         161));
  easysimd_test_x86_assert_equal_i32x8(r, easysimd_x_mm256_loadu_epi32(test_vec[0].r));

  src = easysimd_x_mm256_loadu_epi32(test_vec[1].src);
  a = easysimd_x_mm256_loadu_epi32(test_vec[1].a);
  r = easysimd_mm256_mask_rol_epi32(src, test_vec[1].k, a, INT32_C(         163));
  easysimd_test_x86_assert_equal_i32x8(r, easysimd_x_mm256_loadu_epi32(test_vec[1].r));

  src = easysimd_x_mm256_loadu_epi32(test_vec[2].src);
  a = easysimd_x_mm256_loadu_epi32(test_vec[2].a);
  r = easysimd_mm256_mask_rol_epi32(src, test_vec[2].k, a, INT32_C(          94));
  easysimd_test_x86_assert_equal_i32x8(r, easysimd_x_mm256_loadu_epi32(test_vec[2].r));

  src = easysimd_x_mm256_loadu_epi32(test_vec[3].src);
  a = easysimd_x_mm256_loadu_epi32(test_vec[3].a);
  r = easysimd_mm256_mask_rol_epi32(src, test_vec[3].k, a, INT32_C(           5));
  easysimd_test_x86_assert_equal_i32x8(r, easysimd_x_mm256_loadu_epi32(test_vec[3].r));

  src = easysimd_x_mm256_loadu_epi32(test_vec[4].src);
  a = easysimd_x_mm256_loadu_epi32(test_vec[4].a);
  r = easysimd_mm256_mask_rol_epi32(src, test_vec[4].k, a, INT32_C(         152));
  easysimd_test_x86_assert_equal_i32x8(r, easysimd_x_mm256_loadu_epi32(test_vec[4].r));

  src = easysimd_x_mm256_loadu_epi32(test_vec[5].src);
  a = easysimd_x_mm256_loadu_epi32(test_vec[5].a);
  r = easysimd_mm256_mask_rol_epi32(src, test_vec[5].k, a, INT32_C(          33));
  easysimd_test_x86_assert_equal_i32x8(r, easysimd_x_mm256_loadu_epi32(test_vec[5].r));

  src = easysimd_x_mm256_loadu_epi32(test_vec[6].src);
  a = easysimd_x_mm256_loadu_epi32(test_vec[6].a);
  r = easysimd_mm256_mask_rol_epi32(src, test_vec[6].k, a, INT32_C(          12));
  easysimd_test_x86_assert_equal_i32x8(r, easysimd_x_mm256_loadu_epi32(test_vec[6].r));

  src = easysimd_x_mm256_loadu_epi32(test_vec[7].src);
  a = easysimd_x_mm256_loadu_epi32(test_vec[7].a);
  EASYSIMD_TEST_PERF_WITH_LOOP_START(100000) {
    r = easysimd_mm256_mask_rol_epi32(src, test_vec[7].k, a, INT32_C(         108));
  } EASYSIMD_TEST_PERF_END("easysimd_mm256_mask_rol_epi32");
  easysimd_test_x86_assert_equal_i32x8(r, easysimd_x_mm256_loadu_epi32(test_vec[7].r));
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    int imm8 = easysimd_test_codegen_random_i32() & 255;
    easysimd__m256i r;
    EASYSIMD_CONSTIFY_256_(easysimd_mm256_mask_rol_epi32, r, easysimd_mm256_setzero_si256(), imm8, src, k, a);
...
static int
test_easysimd_mm256_maskz_rol_epi32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    const easysimd__mmask8 k;
    const int32_t a[8];
  ...
  a = easysimd_x_mm256_loadu_epi32(test_vec[0].a);
  r = easysimd_mm256_maskz_rol_epi32(test_vec[0].k, a, INT32_C(         160));
  easysimd_test_x86_assert_equal_i32x8(r, easysimd_x_mm256_loadu_epi32(test_vec[0].r));

  a = easysimd_x_mm256_loadu_epi32(test_vec[1].a);
  r = easysimd_mm256_maskz_rol_epi32(test_vec[1].k, a, INT32_C(         172));
  easysimd_test_x86_assert_equal_i32x8(r, easysimd_x_mm256_loadu_epi32(test_vec[1].r));

  a = easysimd_x_mm256_loadu_epi32(test_vec[2].a);
  r = easysimd_mm256_maskz_rol_epi32(test_vec[2].k, a, INT32_C(          69));
  easysimd_test_x86_assert_equal_i32x8(r, easysimd_x_mm256_loadu_epi32(test_vec[2].r));

  a = easysimd_x_mm256_loadu_epi32(test_vec[3].a);
  r = easysimd_mm256_maskz_rol_epi32(test_vec[3].k, a, INT32_C(         181));
  easysimd_test_x86_assert_equal_i32x8(r, easysimd_x_mm256_loadu_epi32(test_vec[3].r));

  a = easysimd_x_mm256_loadu_epi32(test_vec[4].a);
  r = easysimd_mm256_maskz_rol_epi32(test_vec[4].k, a, INT32_C(         113));
  easysimd_test_x86_assert_equal_i32x8(r, easysimd_x_mm256_loadu_epi32(test_vec[4].r));

  a = easysimd_x_mm256_loadu_epi32(test_vec[5].a);
  r = easysimd_mm256_maskz_rol_epi32(test_vec[5].k, a, INT32_C(         121));
  easysimd_test_x86_assert_equal_i32x8(r, easysimd_x_mm256_loadu_epi32(test_vec[5].r));

  a = easysimd_x_mm256_loadu_epi32(test_vec[6].a);
  r = easysimd_mm256_maskz_rol_epi32(test_vec[6].k, a, INT32_C(          79));
  easysimd_test_x86_assert_equal_i32x8(r, easysimd_x_mm256_loadu_epi32(test_vec[6].r));

  a = easysimd_x_mm256_loadu_epi32(test_vec[7].a);
  EASYSIMD_TEST_PERF_WITH_LOOP_START(100000) {
    r = easysimd_mm256_maskz_rol_epi32(test_vec[7].k, a, INT32_C(          60));
  } EASYSIMD_TEST_PERF_END("easysimd_mm256_maskz_rol_epi32");
  easysimd_test_x86_assert_equal_i32x8(r, easysimd_x_mm256_loadu_epi32(test_vec[7].r));
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    int imm8 = easysimd_test_codegen_random_i32() & 255;
    easysimd__m256i r;
    EASYSIMD_CONSTIFY_256_(easysimd_mm256_maskz_rol_epi32, r, easysimd_mm256_setzero_si256(), imm8, k, a);
...
static int
test_easysimd_mm512_rol_epi32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    const int32_t a[16];
    const int32_t imm8;
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    int imm8 = easysimd_test_codegen_random_i32() & 255;
    easysimd__m512i r;
    EASYSIMD_CONSTIFY_256_(easysimd_mm512_rol_epi32, r, easysimd_mm512_setzero_si512(), imm8, a);
...
static int
test_easysimd_mm512_mask_rol_epi32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
  ...
  a = easysimd_mm512_loadu_epi32(test_vec[0].a);
  r = easysimd_mm512_mask_rol_epi32(src, test_vec[0].k, a, INT32_C(         130));
  easysimd_test_x86_assert_equal_i32x16(r, easysimd_mm512_loadu_epi32(test_vec[0].r));

  src = easysimd_mm512_loadu_epi32(test_vec[1].src);
  a = easysimd_mm512_loadu_epi32(test_vec[1].a);
  r = easysimd_mm512_mask_rol_epi32(src, test_vec[1].k, a, INT32_C(         168));
  easysimd_test_x86_assert_equal_i32x16(r, easysimd_mm512_loadu_epi32(test_vec[1].r));

  src = easysimd_mm512_loadu_epi32(test_vec[2].src);
  a = easysimd_mm512_loadu_epi32(test_vec[2].a);
  r = easysimd_mm512_mask_rol_epi32(src, test_vec[2].k, a, INT32_C(          84));
  easysimd_test_x86_assert_equal_i32x16(r, easysimd_mm512_loadu_epi32(test_vec[2].r));

  src = easysimd_mm512_loadu_epi32(test_vec[3].src);
  a = easysimd_mm512_loadu_epi32(test_vec[3].a);
  r = easysimd_mm512_mask_rol_epi32(src, test_vec[3].k, a, INT32_C(           9));
  easysimd_test_x86_assert_equal_i32x16(r, easysimd_mm512_loadu_epi32(test_vec[3].r));

  src = easysimd_mm512_loadu_epi32(test_vec[4].src);
  a = easysimd_mm512_loadu_epi32(test_vec[4].a);
  r = easysimd_mm512_mask_rol_epi32(src, test_vec[4].k, a, INT32_C(          29));
  easysimd_test_x86_assert_equal_i32x16(r, easysimd_mm512_loadu_epi32(test_vec[4].r));

  src = easysimd_mm512_loadu_epi32(test_vec[5].src);
  a = easysimd_mm512_loadu_epi32(test_vec[5].a);
  r = easysimd_mm512_mask_rol_epi32(src, test_vec[5].k, a, INT32_C(         198));
  easysimd_test_x86_assert_equal_i32x16(r, easysimd_mm512_loadu_epi32(test_vec[5].r));

  src = easysimd_mm512_loadu_epi32(test_vec[6].src);
  a = easysimd_mm512_loadu_epi32(test_vec[6].a);
  r = easysimd_mm512_mask_rol_epi32(src, test_vec[6].k, a, INT32_C(          17));
  easysimd_test_x86_assert_equal_i32x16(r, easysimd_mm512_loadu_epi32(test_vec[6].r));

  src = easysimd_mm512_loadu_epi32(test_vec[7].src);
  a = easysimd_mm512_loadu_epi32(test_vec[7].a);
  EASYSIMD_TEST_PERF_WITH_LOOP_START(100000) {
    r = easysimd_mm512_mask_rol_epi32(src, test_vec[7].k, a, INT32_C(          85));
  } EASYSIMD_TEST_PERF_END("easysimd_mm512_mask_rol_epi32");
  easysimd_test_x86_assert_equal_i32x16(r, easysimd_mm512_loadu_epi32(test_vec[7].r));
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    int imm8 = easysimd_test_codegen_random_i32() & 255;
    easysimd__m512i r;
    EASYSIMD_CONSTIFY_256_(easysimd_mm512_mask_rol_epi32, r, easysimd_mm512_setzero_si512(), imm8, src, k, a);
...
static int
test_easysimd_mm512_maskz_rol_epi32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    const easysimd__mmask16 k;
    const int32_t a[16];
  ...
  a = easysimd_mm512_loadu_epi32(test_vec[0].a);
  r = easysimd_mm512_maskz_rol_epi32(test_vec[0].k, a, INT32_C(          56));
  easysimd_test_x86_assert_equal_i32x16(r, easysimd_mm512_loadu_epi32(test_vec[0].r));

  a = easysimd_mm512_loadu_epi32(test_vec[1].a);
  r = easysimd_mm512_maskz_rol_epi32(test_vec[1].k, a, INT32_C(         182));
  easysimd_test_x86_assert_equal_i32x16(r, easysimd_mm512_loadu_epi32(test_vec[1].r));

  a = easysimd_mm512_loadu_epi32(test_vec[2].a);
  r = easysimd_mm512_maskz_rol_epi32(test_vec[2].k, a, INT32_C(          19));
  easysimd_test_x86_assert_equal_i32x16(r, easysimd_mm512_loadu_epi32(test_vec[2].r));

  a = easysimd_mm512_loadu_epi32(test_vec[3].a);
  r = easysimd_mm512_maskz_rol_epi32(test_vec[3].k, a, INT32_C(         130));
  easysimd_test_x86_assert_equal_i32x16(r, easysimd_mm512_loadu_epi32(test_vec[3].r));

  a = easysimd_mm512_loadu_epi32(test_vec[4].a);
  r = easysimd_mm512_maskz_rol_epi32(test_vec[4].k, a, INT32_C(          49));
  easysimd_test_x86_assert_equal_i32x16(r, easysimd_mm512_loadu_epi32(test_vec[4].r));

  a = easysimd_mm512_loadu_epi32(test_vec[5].a);
  r = easysimd_mm512_maskz_rol_epi32(test_vec[5].k, a, INT32_C(         140));
  easysimd_test_x86_assert_equal_i32x16(r, easysimd_mm512_loadu_epi32(test_vec[5].r));

  a = easysimd_mm512_loadu_epi32(test_vec[6].a);
  r = easysimd_mm512_maskz_rol_epi32(test_vec[6].k, a, INT32_C(          83));
  easysimd_test_x86_assert_equal_i32x16(r, easysimd_mm512_loadu_epi32(test_vec[6].r));

  a = easysimd_mm512_loadu_epi32(test_vec[7].a);
  EASYSIMD_TEST_PERF_WITH_LOOP_START(100000) {
    r = easysimd_mm512_maskz_rol_epi32(test_vec[7].k, a, INT32_C(         184));
  } EASYSIMD_TEST_PERF_END("easysimd_mm512_maskz_rol_epi32");
  easysimd_test_x86_assert_equal_i32x16(r, easysimd_mm512_loadu_epi32(test_vec[7].r));
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    int imm8 = easysimd_test_codegen_random_i32() & 255;
    easysimd__m512i r;
    EASYSIMD_CONSTIFY_256_(easysimd_mm512_maskz_rol_epi32, r, easysimd_mm512_setzero_si512(), imm8, k, a);
...
static int
test_easysimd_mm_rol_epi64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    const int64_t a[2];
    const int32_t imm8;
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    int imm8 = easysimd_test_codegen_random_i32() & 255;
    easysimd__m128i r;
    EASYSIMD_CONSTIFY_256_(easysimd_mm_rol_epi64, r, easysimd_mm_setzero_si128(), imm8, a);
...
static int
test_easysimd_mm_mask_rol_epi64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    const int64_t src[2];
    const easysimd__mmask8 k;
  ...
  a = easysimd_x_mm_loadu_epi64(test_vec[0].a);
  r = easysimd_mm_mask_rol_epi64(src, test_vec[0].k, a, INT32_C(         169));
  easysimd_test_x86_assert_equal_i64x2(r, easysimd_x_mm_loadu_epi64(test_vec[0].r));

  src = easysimd_x_mm_loadu_epi64(test_vec[1].src);
  a = easysimd_x_mm_loadu_epi64(test_vec[1].a);
  r = easysimd_mm_mask_rol_epi64(src, test_vec[1].k, a, INT32_C(         164));
  easysimd_test_x86_assert_equal_i64x2(r, easysimd_x_mm_loadu_epi64(test_vec[1].r));

  src = easysimd_x_mm_loadu_epi64(test_vec[2].src);
  a = easysimd_x_mm_loadu_epi64(test_vec[2].a);
  r = easysimd_mm_mask_rol_epi64(src, test_vec[2].k, a, INT32_C(          39));
  easysimd_test_x86_assert_equal_i64x2(r, easysimd_x_mm_loadu_epi64(test_vec[2].r));

  src = easysimd_x_mm_loadu_epi64(test_vec[3].src);
  a = easysimd_x_mm_loadu_epi64(test_vec[3].a);
  r = easysimd_mm_mask_rol_epi64(src, test_vec[3].k, a, INT32_C(          54));
  easysimd_test_x86_assert_equal_i64x2(r, easysimd_x_mm_loadu_epi64(test_vec[3].r));

  src = easysimd_x_mm_loadu_epi64(test_vec[4].src);
  a = easysimd_x_mm_loadu_epi64(test_vec[4].a);
  r = easysimd_mm_mask_rol_epi64(src, test_vec[4].k, a, INT32_C(         167));
  easysimd_test_x86_assert_equal_i64x2(r, easysimd_x_mm_loadu_epi64(test_vec[4].r));

  src = easysimd_x_mm_loadu_epi64(test_vec[5].src);
  a = easysimd_x_mm_loadu_epi64(test_vec[5].a);
  r = easysimd_mm_mask_rol_epi64(src, test_vec[5].k, a, INT32_C(         134));
  easysimd_test_x86_assert_equal_i64x2(r, easysimd_x_mm_loadu_epi64(test_vec[5].r));

  src = easysimd_x_mm_loadu_epi64(test_vec[6].src);
  a = easysimd_x_mm_loadu_epi64(test_vec[6].a);
  r = easysimd_mm_mask_rol_epi64(src, test_vec[6].k, a, INT32_C(         232));
  easysimd_test_x86_assert_equal_i64x2(r, easysimd_x_mm_loadu_epi64(test_vec[6].r));

  src = easysimd_x_mm_loadu_epi64(test_vec[7].src);
  a = easysimd_x_mm_loadu_epi64(test_vec[7].a);
  EASYSIMD_TEST_PERF_WITH_LOOP_START(100000) {
    r = easysimd_mm_mask_rol_epi64(src, test_vec[7].k, a, INT32_C(          63));
  } EASYSIMD_TEST_PERF_END("easysimd_mm_mask_rol_epi64");
  easysimd_test_x86_assert_equal_i64x2(r, easysimd_x_mm_loadu_epi64(test_vec[7].r));
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    int imm8 = easysimd_test_codegen_random_i32() & 255;
    easysimd__m128i r;
    EASYSIMD_CONSTIFY_256_(easysimd_mm_mask_rol_epi64, r, easysimd_mm_setzero_si128(), imm8, src, k, a);
...
static int
test_easysimd_mm_maskz_rol_epi64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    const easysimd__mmask8 k;
    const int64_t a[2];
  ...
  a = easysimd_x_mm_loadu_epi64(test_vec[0].a);
  r = easysimd_mm_maskz_rol_epi64(test_vec[0].k, a, INT32_C(          64));
  easysimd_test_x86_assert_equal_i64x2(r, easysimd_x_mm_loadu_epi64(test_vec[0].r));

  a = easysimd_x_mm_loadu_epi64(test_vec[1].a);
  r = easysimd_mm_maskz_rol_epi64(test_vec[1].k, a, INT32_C(         234));
  easysimd_test_x86_assert_equal_i64x2(r, easysimd_x_mm_loadu_epi64(test_vec[1].r));

  a = easysimd_x_mm_loadu_epi64(test_vec[2].a);
  r = easysimd_mm_maskz_rol_epi64(test_vec[2].k, a, INT32_C(         227));
  easysimd_test_x86_assert_equal_i64x2(r, easysimd_x_mm_loadu_epi64(test_vec[2].r));

  a = easysimd_x_mm_loadu_epi64(test_vec[3].a);
  r = easysimd_mm_maskz_rol_epi64(test_vec[3].k, a, INT32_C(          37));
  easysimd_test_x86_assert_equal_i64x2(r, easysimd_x_mm_loadu_epi64(test_vec[3].r));

  a = easysimd_x_mm_loadu_epi64(test_vec[4].a);
  r = easysimd_mm_maskz_rol_epi64(test_vec[4].k, a, INT32_C(          21));
  easysimd_test_x86_assert_equal_i64x2(r, easysimd_x_mm_loadu_epi64(test_vec[4].r));

  a = easysimd_x_mm_loadu_epi64(test_vec[5].a);
  r = easysimd_mm_maskz_rol_epi64(test_vec[5].k, a, INT32_C(         148));
  easysimd_test_x86_assert_equal_i64x2(r, easysimd_x_mm_loadu_epi64(test_vec[5].r));

  a = easysimd_x_mm_loadu_epi64(test_vec[6].a);
  r = easysimd_mm_maskz_rol_epi64(test_vec[6].k, a, INT32_C(          36));
  easysimd_test_x86_assert_equal_i64x2(r, easysimd_x_mm_loadu_epi64(test_vec[6].r));

  a = easysimd_x_mm_loadu_epi64(test_vec[7].a);
  EASYSIMD_TEST_PERF_WITH_LOOP_START(100000) {
    r = easysimd_mm_maskz_rol_epi64(test_vec[7].k, a, INT32_C(         254));
  } EASYSIMD_TEST_PERF_END("easysimd_mm_maskz_rol_epi64");
  easysimd_test_x86_assert_equal_i64x2(r, easysimd_x_mm_loadu_epi64(test_vec[7].r));
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    int imm8 = easysimd_test_codegen_random_i32() & 255;
    easysimd__m128i r;
    EASYSIMD_CONSTIFY_256_(easysimd_mm_maskz_rol_epi64, r, easysimd_mm_setzero_si128(), imm8, k, a);
...
static int
test_easysimd_mm256_rol_epi64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    const int64_t a[4];
    const int32_t imm8;
  ...
  r = easysimd_mm256_rol_epi64(a, INT32_C(         221));
  ...
  r = easysimd_mm256_rol_epi64(a, INT32_C(          42));
  ...
  r = easysimd_mm256_rol_epi64(a, INT32_C(         196));
  ...
  r = easysimd_mm256_rol_epi64(a, INT32_C(         194));
  ...
  r = easysimd_mm256_rol_epi64(a, INT32_C(           6));
  ...
  r = easysimd_mm256_rol_epi64(a, INT32_C(         166));
  ...
  r = easysimd_mm256_rol_epi64(a, INT32_C(         195));
  ...
  EASYSIMD_TEST_PERF_WITH_LOOP_START(100000) {
    r = easysimd_mm256_rol_epi64(a, INT32_C(          54));
  } EASYSIMD_TEST_PERF_END("easysimd_mm256_rol_epi64");
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    int imm8 = easysimd_test_codegen_random_i32() & 255;
    easysimd__m256i r;
    EASYSIMD_CONSTIFY_256_(easysimd_mm256_rol_epi64, r, easysimd_mm256_setzero_si256(), imm8, a);
...
static int
test_easysimd_mm256_mask_rol_epi64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    const int64_t src[4];
    const easysimd__mmask8 k;
  ...
  a = easysimd_x_mm256_loadu_epi64(test_vec[0].a);
  r = easysimd_mm256_mask_rol_epi64(src, test_vec[0].k, a, INT32_C(           7));
  easysimd_test_x86_assert_equal_i64x4(r, easysimd_x_mm256_loadu_epi64(test_vec[0].r));

  src = easysimd_x_mm256_loadu_epi64(test_vec[1].src);
  a = easysimd_x_mm256_loadu_epi64(test_vec[1].a);
  r = easysimd_mm256_mask_rol_epi64(src, test_vec[1].k, a, INT32_C(          55));
  easysimd_test_x86_assert_equal_i64x4(r, easysimd_x_mm256_loadu_epi64(test_vec[1].r));

  src = easysimd_x_mm256_loadu_epi64(test_vec[2].src);
  a = easysimd_x_mm256_loadu_epi64(test_vec[2].a);
  r = easysimd_mm256_mask_rol_epi64(src, test_vec[2].k, a, INT32_C(         202));
  easysimd_test_x86_assert_equal_i64x4(r, easysimd_x_mm256_loadu_epi64(test_vec[2].r));

  src = easysimd_x_mm256_loadu_epi64(test_vec[3].src);
  a = easysimd_x_mm256_loadu_epi64(test_vec[3].a);
  r = easysimd_mm256_mask_rol_epi64(src, test_vec[3].k, a, INT32_C(           4));
  easysimd_test_x86_assert_equal_i64x4(r, easysimd_x_mm256_loadu_epi64(test_vec[3].r));

  src = easysimd_x_mm256_loadu_epi64(test_vec[4].src);
  a = easysimd_x_mm256_loadu_epi64(test_vec[4].a);
  r = easysimd_mm256_mask_rol_epi64(src, test_vec[4].k, a, INT32_C(          31));
  easysimd_test_x86_assert_equal_i64x4(r, easysimd_x_mm256_loadu_epi64(test_vec[4].r));

  src = easysimd_x_mm256_loadu_epi64(test_vec[5].src);
  a = easysimd_x_mm256_loadu_epi64(test_vec[5].a);
  r = easysimd_mm256_mask_rol_epi64(src, test_vec[5].k, a, INT32_C(          63));
  easysimd_test_x86_assert_equal_i64x4(r, easysimd_x_mm256_loadu_epi64(test_vec[5].r));

  src = easysimd_x_mm256_loadu_epi64(test_vec[6].src);
  a = easysimd_x_mm256_loadu_epi64(test_vec[6].a);
  r = easysimd_mm256_mask_rol_epi64(src, test_vec[6].k, a, INT32_C(          63));
  easysimd_test_x86_assert_equal_i64x4(r, easysimd_x_mm256_loadu_epi64(test_vec[6].r));

  src = easysimd_x_mm256_loadu_epi64(test_vec[7].src);
  a = easysimd_x_mm256_loadu_epi64(test_vec[7].a);
  EASYSIMD_TEST_PERF_WITH_LOOP_START(100000) {
    r = easysimd_mm256_mask_rol_epi64(src, test_vec[7].k, a, INT32_C(         194));
  } EASYSIMD_TEST_PERF_END("easysimd_mm256_mask_rol_epi64");
  easysimd_test_x86_assert_equal_i64x4(r, easysimd_x_mm256_loadu_epi64(test_vec[7].r));
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    int imm8 = easysimd_test_codegen_random_i32() & 255;
    easysimd__m256i r;
    EASYSIMD_CONSTIFY_256_(easysimd_mm256_mask_rol_epi64, r, easysimd_mm256_setzero_si256(), imm8, src, k, a);
...
static int
test_easysimd_mm256_maskz_rol_epi64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    const easysimd__mmask8 k;
    const int64_t a[4];
  ...
  a = easysimd_x_mm256_loadu_epi64(test_vec[0].a);
  r = easysimd_mm256_maskz_rol_epi64(test_vec[0].k, a, INT32_C(         205));
  easysimd_test_x86_assert_equal_i64x4(r, easysimd_x_mm256_loadu_epi64(test_vec[0].r));

  a = easysimd_x_mm256_loadu_epi64(test_vec[1].a);
  r = easysimd_mm256_maskz_rol_epi64(test_vec[1].k, a, INT32_C(         132));
  easysimd_test_x86_assert_equal_i64x4(r, easysimd_x_mm256_loadu_epi64(test_vec[1].r));

  a = easysimd_x_mm256_loadu_epi64(test_vec[2].a);
  r = easysimd_mm256_maskz_rol_epi64(test_vec[2].k, a, INT32_C(         229));
  easysimd_test_x86_assert_equal_i64x4(r, easysimd_x_mm256_loadu_epi64(test_vec[2].r));

  a = easysimd_x_mm256_loadu_epi64(test_vec[3].a);
  r = easysimd_mm256_maskz_rol_epi64(test_vec[3].k, a, INT32_C(          42));
  easysimd_test_x86_assert_equal_i64x4(r, easysimd_x_mm256_loadu_epi64(test_vec[3].r));

  a = easysimd_x_mm256_loadu_epi64(test_vec[4].a);
  r = easysimd_mm256_maskz_rol_epi64(test_vec[4].k, a, INT32_C(         254));
  easysimd_test_x86_assert_equal_i64x4(r, easysimd_x_mm256_loadu_epi64(test_vec[4].r));

  a = easysimd_x_mm256_loadu_epi64(test_vec[5].a);
  r = easysimd_mm256_maskz_rol_epi64(test_vec[5].k, a, INT32_C(          30));
  easysimd_test_x86_assert_equal_i64x4(r, easysimd_x_mm256_loadu_epi64(test_vec[5].r));

  a = easysimd_x_mm256_loadu_epi64(test_vec[6].a);
  r = easysimd_mm256_maskz_rol_epi64(test_vec[6].k, a, INT32_C(         198));
  easysimd_test_x86_assert_equal_i64x4(r, easysimd_x_mm256_loadu_epi64(test_vec[6].r));

  a = easysimd_x_mm256_loadu_epi64(test_vec[7].a);
  EASYSIMD_TEST_PERF_WITH_LOOP_START(100000) {
    r = easysimd_mm256_maskz_rol_epi64(test_vec[7].k, a, INT32_C(         235));
  } EASYSIMD_TEST_PERF_END("easysimd_mm256_maskz_rol_epi64");
  easysimd_test_x86_assert_equal_i64x4(r, easysimd_x_mm256_loadu_epi64(test_vec[7].r));
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    int imm8 = easysimd_test_codegen_random_i32() & 255;
    easysimd__m256i r;
    EASYSIMD_CONSTIFY_256_(easysimd_mm256_maskz_rol_epi64, r, easysimd_mm256_setzero_si256(), imm8, k, a);
...
static int
test_easysimd_mm512_rol_epi64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    const int64_t a[8];
    const int32_t imm8;
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    int imm8 = easysimd_test_codegen_random_i32() & 255;
    easysimd__m512i r;
    EASYSIMD_CONSTIFY_256_(easysimd_mm512_rol_epi64, r, easysimd_mm512_setzero_si512(), imm8, a);
...
static int
test_easysimd_mm512_mask_rol_epi64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    const int64_t src[8];
    const easysimd__mmask8 k;
  ...
  a = easysimd_mm512_loadu_epi64(test_vec[0].a);
  r = easysimd_mm512_mask_rol_epi64(src, test_vec[0].k, a, INT32_C(         114));
  easysimd_test_x86_assert_equal_i64x8(r, easysimd_mm512_loadu_epi64(test_vec[0].r));

  src = easysimd_mm512_loadu_epi64(test_vec[1].src);
  a = easysimd_mm512_loadu_epi64(test_vec[1].a);
  r = easysimd_mm512_mask_rol_epi64(src, test_vec[1].k, a, INT32_C(         215));
  easysimd_test_x86_assert_equal_i64x8(r, easysimd_mm512_loadu_epi64(test_vec[1].r));

  src = easysimd_mm512_loadu_epi64(test_vec[2].src);
  a = easysimd_mm512_loadu_epi64(test_vec[2].a);
  r = easysimd_mm512_mask_rol_epi64(src, test_vec[2].k, a, INT32_C(         252));
  easysimd_test_x86_assert_equal_i64x8(r, easysimd_mm512_loadu_epi64(test_vec[2].r));

  src = easysimd_mm512_loadu_epi64(test_vec[3].src);
  a = easysimd_mm512_loadu_epi64(test_vec[3].a);
  r = easysimd_mm512_mask_rol_epi64(src, test_vec[3].k, a, INT32_C(         119));
  easysimd_test_x86_assert_equal_i64x8(r, easysimd_mm512_loadu_epi64(test_vec[3].r));

  src = easysimd_mm512_loadu_epi64(test_vec[4].src);
  a = easysimd_mm512_loadu_epi64(test_vec[4].a);
  r = easysimd_mm512_mask_rol_epi64(src, test_vec[4].k, a, INT32_C(         140));
  easysimd_test_x86_assert_equal_i64x8(r, easysimd_mm512_loadu_epi64(test_vec[4].r));

  src = easysimd_mm512_loadu_epi64(test_vec[5].src);
  a = easysimd_mm512_loadu_epi64(test_vec[5].a);
  r = easysimd_mm512_mask_rol_epi64(src, test_vec[5].k, a, INT32_C(           4));
  easysimd_test_x86_assert_equal_i64x8(r, easysimd_mm512_loadu_epi64(test_vec[5].r));

  src = easysimd_mm512_loadu_epi64(test_vec[6].src);
  a = easysimd_mm512_loadu_epi64(test_vec[6].a);
  r = easysimd_mm512_mask_rol_epi64(src, test_vec[6].k, a, INT32_C(         136));
  easysimd_test_x86_assert_equal_i64x8(r, easysimd_mm512_loadu_epi64(test_vec[6].r));

  src = easysimd_mm512_loadu_epi64(test_vec[7].src);
  a = easysimd_mm512_loadu_epi64(test_vec[7].a);
  EASYSIMD_TEST_PERF_WITH_LOOP_START(100000) {
    r = easysimd_mm512_mask_rol_epi64(src, test_vec[7].k, a, INT32_C(         120));
  } EASYSIMD_TEST_PERF_END("easysimd_mm512_mask_rol_epi64");
  easysimd_test_x86_assert_equal_i64x8(r, easysimd_mm512_loadu_epi64(test_vec[7].r));
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    int imm8 = easysimd_test_codegen_random_i32() & 255;
    easysimd__m512i r;
    EASYSIMD_CONSTIFY_256_(easysimd_mm512_mask_rol_epi64, r, easysimd_mm512_setzero_si512(), imm8, src, k, a);
...
static int
test_easysimd_mm512_maskz_rol_epi64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    const easysimd__mmask8 k;
    const int64_t a[8];
  ...
  a = easysimd_mm512_loadu_epi64(test_vec[0].a);
  r = easysimd_mm512_maskz_rol_epi64(test_vec[0].k, a, INT32_C(          89));
  easysimd_test_x86_assert_equal_i64x8(r, easysimd_mm512_loadu_epi64(test_vec[0].r));

  a = easysimd_mm512_loadu_epi64(test_vec[1].a);
  r = easysimd_mm512_maskz_rol_epi64(test_vec[1].k, a, INT32_C(         232));
  easysimd_test_x86_assert_equal_i64x8(r, easysimd_mm512_loadu_epi64(test_vec[1].r));

  a = easysimd_mm512_loadu_epi64(test_vec[2].a);
  r = easysimd_mm512_maskz_rol_epi64(test_vec[2].k, a, INT32_C(         105));
  easysimd_test_x86_assert_equal_i64x8(r, easysimd_mm512_loadu_epi64(test_vec[2].r));

  a = easysimd_mm512_loadu_epi64(test_vec[3].a);
  r = easysimd_mm512_maskz_rol_epi64(test_vec[3].k, a, INT32_C(          71));
  easysimd_test_x86_assert_equal_i64x8(r, easysimd_mm512_loadu_epi64(test_vec[3].r));

  a = easysimd_mm512_loadu_epi64(test_vec[4].a);
  r = easysimd_mm512_maskz_rol_epi64(test_vec[4].k, a, INT32_C(         246));
  easysimd_test_x86_assert_equal_i64x8(r, easysimd_mm512_loadu_epi64(test_vec[4].r));

  a = easysimd_mm512_loadu_epi64(test_vec[5].a);
  r = easysimd_mm512_maskz_rol_epi64(test_vec[5].k, a, INT32_C(         103));
  easysimd_test_x86_assert_equal_i64x8(r, easysimd_mm512_loadu_epi64(test_vec[5].r));

  a = easysimd_mm512_loadu_epi64(test_vec[6].a);
  r = easysimd_mm512_maskz_rol_epi64(test_vec[6].k, a, INT32_C(         211));
  easysimd_test_x86_assert_equal_i64x8(r, easysimd_mm512_loadu_epi64(test_vec[6].r));

  a = easysimd_mm512_loadu_epi64(test_vec[7].a);
  EASYSIMD_TEST_PERF_WITH_LOOP_START(100000) {
    r = easysimd_mm512_maskz_rol_epi64(test_vec[7].k, a, INT32_C(         228));
  } EASYSIMD_TEST_PERF_END("easysimd_mm512_maskz_rol_epi64");
  easysimd_test_x86_assert_equal_i64x8(r, easysimd_mm512_loadu_epi64(test_vec[7].r));
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    int imm8 = easysimd_test_codegen_random_i32() & 255;
    easysimd__m512i r;
    EASYSIMD_CONSTIFY_256_(easysimd_mm512_maskz_rol_epi64, r, easysimd_mm512_setzero_si512(), imm8, k, a);
...
EASYSIMD_TEST_FUNC_LIST_BEGIN
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm_rol_epi32)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm_mask_rol_epi32)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm_maskz_rol_epi32)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm256_rol_epi32)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm256_mask_rol_epi32)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm256_maskz_rol_epi32)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm512_rol_epi32)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm512_mask_rol_epi32)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm512_maskz_rol_epi32)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm_rol_epi64)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm_mask_rol_epi64)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm_maskz_rol_epi64)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm256_rol_epi64)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm256_mask_rol_epi64)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm256_maskz_rol_epi64)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm512_rol_epi64)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm512_mask_rol_epi64)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm512_maskz_rol_epi64)
