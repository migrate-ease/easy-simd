#define EASYSIMD_TEST_X86_AVX512_INSN rolv

#include <test/x86/avx512/test-avx512.h>
#include <easysimd/x86/avx512/rolv.h>

static int
test_easysimd_mm_rolv_epi32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    const int32_t a[4];
    const int32_t b[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    EASYSIMD_TEST_PERF_WITH_LOOP_START(100000) {
      r = easysimd_mm_rolv_epi32(a, b);
    } EASYSIMD_TEST_PERF_END("easysimd_mm_rolv_epi32");
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd__m128i r = easysimd_mm_rolv_epi32(a, b);
...
static int
test_easysimd_mm_mask_rolv_epi32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    const int32_t src[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd__m128i a = easysimd_x_mm_loadu_epi32(test_vec[i].a);
    easysimd__m128i b = easysimd_x_mm_loadu_epi32(test_vec[i].b);
    easysimd__m128i r = easysimd_mm_mask_rolv_epi32(src, test_vec[i].k, a, b);
    easysimd_test_x86_assert_equal_i32x4(r, easysimd_x_mm_loadu_epi32(test_vec[i].r));
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd__m128i a = easysimd_test_x86_random_i32x4();
    easysimd__m128i b = easysimd_test_x86_random_i32x4();
    easysimd__m128i r = easysimd_mm_mask_rolv_epi32(src, k, a, b);
...
static int
test_easysimd_mm_maskz_rolv_epi32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    const easysimd__mmask8 k;
    const int32_t a[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd__m128i a = easysimd_x_mm_loadu_epi32(test_vec[i].a);
    easysimd__m128i b = easysimd_x_mm_loadu_epi32(test_vec[i].b);
    easysimd__m128i r = easysimd_mm_maskz_rolv_epi32(test_vec[i].k, a, b);
    easysimd_test_x86_assert_equal_i32x4(r, easysimd_x_mm_loadu_epi32(test_vec[i].r));
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd__m128i a = easysimd_test_x86_random_i32x4();
    easysimd__m128i b = easysimd_test_x86_random_i32x4();
    easysimd__m128i r = easysimd_mm_maskz_rolv_epi32(k, a, b);
...
static int
test_easysimd_mm256_rolv_epi32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    const int32_t a[8];
    const int32_t b[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd__m256i r = easysimd_mm256_rolv_epi32(a, b);
...
static int
test_easysimd_mm256_mask_rolv_epi32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    const int32_t src[8];
    const easysimd__mmask8 k;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd__m256i a = easysimd_x_mm256_loadu_epi32(test_vec[i].a);
    easysimd__m256i b = easysimd_x_mm256_loadu_epi32(test_vec[i].b);
    easysimd__m256i r = easysimd_mm256_mask_rolv_epi32(src, k, a, b);
    easysimd_test_x86_assert_equal_i32x8(r, easysimd_x_mm256_loadu_epi32(test_vec[i].r));
  }
...
static int
test_easysimd_mm256_maskz_rolv_epi32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    const easysimd__mmask8 k;
    const int32_t a[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd__m256i a = easysimd_x_mm256_loadu_epi32(test_vec[i].a);
    easysimd__m256i b = easysimd_x_mm256_loadu_epi32(test_vec[i].b);
    easysimd__m256i r = easysimd_mm256_maskz_rolv_epi32(k, a, b);
    easysimd_test_x86_assert_equal_i32x8(r, easysimd_x_mm256_loadu_epi32(test_vec[i].r));
  }
...
static int
test_easysimd_mm512_rolv_epi32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    const int32_t a[16];
    const int32_t b[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd__m512i r = easysimd_mm512_rolv_epi32(a, b);
...
static int
test_easysimd_mm512_mask_rolv_epi32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd__m512i a = easysimd_mm512_loadu_epi32(test_vec[i].a);
    easysimd__m512i b = easysimd_mm512_loadu_epi32(test_vec[i].b);
    easysimd__m512i r = easysimd_mm512_mask_rolv_epi32(src, test_vec[i].k, a, b);
    easysimd_test_x86_assert_equal_i32x16(r, easysimd_mm512_loadu_epi32(test_vec[i].r));
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd__m512i a = easysimd_test_x86_random_i32x16();
    easysimd__m512i b = easysimd_test_x86_random_i32x16();
    easysimd__m512i r = easysimd_mm512_mask_rolv_epi32(src, k, a, b);
...
static int
test_easysimd_mm512_maskz_rolv_epi32 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    const easysimd__mmask16 k;
    const int32_t a[16];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd__m512i a = easysimd_mm512_loadu_epi32(test_vec[i].a);
    easysimd__m512i b = easysimd_mm512_loadu_epi32(test_vec[i].b);
    easysimd__m512i r = easysimd_mm512_maskz_rolv_epi32(test_vec[i].k, a, b);
    easysimd_test_x86_assert_equal_i32x16(r, easysimd_mm512_loadu_epi32(test_vec[i].r));
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd__m512i a = easysimd_test_x86_random_i32x16();
    easysimd__m512i b = easysimd_test_x86_random_i32x16();
    easysimd__m512i r = easysimd_mm512_maskz_rolv_epi32(k, a, b);
...
static int
test_easysimd_mm_rolv_epi64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    const int64_t a[2];
    const int64_t b[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd__m128i r = easysimd_mm_rolv_epi64(a, b);
...
static int
test_easysimd_mm_mask_rolv_epi64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    const int64_t src[2];
    const easysimd__mmask8 k;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd__m128i a = easysimd_x_mm_loadu_epi64(test_vec[i].a);
    easysimd__m128i b = easysimd_x_mm_loadu_epi64(test_vec[i].b);
    easysimd__m128i r = easysimd_mm_mask_rolv_epi64(src, test_vec[i].k, a, b);
    easysimd_test_x86_assert_equal_i64x2(r, easysimd_x_mm_loadu_epi64(test_vec[i].r));
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd__m128i a = easysimd_test_x86_random_i64x2();
    easysimd__m128i b = easysimd_test_x86_random_i64x2();
    easysimd__m128i r = easysimd_mm_mask_rolv_epi64(src, k, a, b);
...
static int
test_easysimd_mm_maskz_rolv_epi64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    const easysimd__mmask8 k;
    const int64_t a[2];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd__m128i a = easysimd_x_mm_loadu_epi64(test_vec[i].a);
    easysimd__m128i b = easysimd_x_mm_loadu_epi64(test_vec[i].b);
    easysimd__m128i r = easysimd_mm_maskz_rolv_epi64(test_vec[i].k, a, b);
    easysimd_test_x86_assert_equal_i64x2(r, easysimd_x_mm_loadu_epi64(test_vec[i].r));
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd__m128i a = easysimd_test_x86_random_i64x2();
    easysimd__m128i b = easysimd_test_x86_random_i64x2();
    easysimd__m128i r = easysimd_mm_maskz_rolv_epi64(k, a, b);
...
static int
test_easysimd_mm256_rolv_epi64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    const int64_t a[4];
    const int64_t b[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd__m256i r = easysimd_mm256_rolv_epi64(a, b);
...
static int
test_easysimd_mm256_mask_rolv_epi64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    const int64_t src[4];
    const easysimd__mmask8 k;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd__m256i a = easysimd_x_mm256_loadu_epi64(test_vec[i].a);
    easysimd__m256i b = easysimd_x_mm256_loadu_epi64(test_vec[i].b);
    easysimd__m256i r = easysimd_mm256_mask_rolv_epi64(src, test_vec[i].k, a, b);
    easysimd_test_x86_assert_equal_i64x4(r, easysimd_x_mm256_loadu_epi64(test_vec[i].r));
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd__m256i a = easysimd_test_x86_random_i64x4();
    easysimd__m256i b = easysimd_test_x86_random_i64x4();
    easysimd__m256i r = easysimd_mm256_mask_rolv_epi64(src, k, a, b);
...
static int
test_easysimd_mm256_maskz_rolv_epi64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    const easysimd__mmask8 k;
    const int64_t a[4];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd__m256i a = easysimd_x_mm256_loadu_epi64(test_vec[i].a);
    easysimd__m256i b = easysimd_x_mm256_loadu_epi64(test_vec[i].b);
    easysimd__m256i r = easysimd_mm256_maskz_rolv_epi64(test_vec[i].k, a, b);
    easysimd_test_x86_assert_equal_i64x4(r, easysimd_x_mm256_loadu_epi64(test_vec[i].r));
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd__m256i a = easysimd_test_x86_random_i64x4();
    easysimd__m256i b = easysimd_test_x86_random_i64x4();
    easysimd__m256i r = easysimd_mm256_maskz_rolv_epi64(k, a, b);
...
static int
test_easysimd_mm512_rolv_epi64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    const int64_t a[8];
    const int64_t b[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd__m512i r = easysimd_mm512_rolv_epi64(a, b);
...
static int
test_easysimd_mm512_mask_rolv_epi64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    const int64_t src[8];
    const easysimd__mmask8 k;
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    ...
    easysimd__m512i a = easysimd_mm512_loadu_epi64(test_vec[i].a);
    easysimd__m512i b = easysimd_mm512_loadu_epi64(test_vec[i].b);
    easysimd__m512i r = easysimd_mm512_mask_rolv_epi64(src, test_vec[i].k, a, b);
    easysimd_test_x86_assert_equal_i64x8(r, easysimd_mm512_loadu_epi64(test_vec[i].r));
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd__m512i a = easysimd_test_x86_random_i64x8();
    easysimd__m512i b = easysimd_test_x86_random_i64x8();
    easysimd__m512i r = easysimd_mm512_mask_rolv_epi64(src, k, a, b);
...
static int
test_easysimd_mm512_maskz_rolv_epi64 (EASYSIMD_MUNIT_TEST_ARGS) {
#if 1
  static const struct {
    const easysimd__mmask8 k;
    const int64_t a[8];
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    easysimd__m512i a = easysimd_mm512_loadu_epi64(test_vec[i].a);
    easysimd__m512i b = easysimd_mm512_loadu_epi64(test_vec[i].b);
    easysimd__m512i r = easysimd_mm512_maskz_rolv_epi64(test_vec[i].k, a, b);
    easysimd_test_x86_assert_equal_i64x8(r, easysimd_mm512_loadu_epi64(test_vec[i].r));
  }
  ...
  for (int i = 0 ; i < 8 ; i++) {
    ...
    easysimd__m512i a = easysimd_test_x86_random_i64x8();
    easysimd__m512i b = easysimd_test_x86_random_i64x8();
    easysimd__m512i r = easysimd_mm512_maskz_rolv_epi64(k, a, b);
...
EASYSIMD_TEST_FUNC_LIST_BEGIN
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm_rolv_epi32)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm_mask_rolv_epi32)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm_maskz_rolv_epi32)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm256_rolv_epi32)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm256_mask_rolv_epi32)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm256_maskz_rolv_epi32)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm512_rolv_epi32)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm512_mask_rolv_epi32)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm512_maskz_rolv_epi32)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm_rolv_epi64)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm_mask_rolv_epi64)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm_maskz_rolv_epi64)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm256_rolv_epi64)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm256_mask_rolv_epi64)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm256_maskz_rolv_epi64)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm512_rolv_epi64)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm512_mask_rolv_epi64)
  EASYSIMD_TEST_FUNC_LIST_ENTRY(mm512_maskz_rolv_epi64)
